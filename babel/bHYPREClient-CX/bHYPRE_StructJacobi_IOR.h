...
#define included_bHYPRE_StructJacobi_IOR_h
...
struct bHYPRE_StructJacobi__sepv;
...
struct bHYPRE_StructJacobi__sepv {
  ...
  /* Methods introduced in bHYPRE.StructJacobi-v1.0.0 */
  struct bHYPRE_StructJacobi__object* (*f_Create)(
...
struct bHYPRE_StructJacobi__epv {
  /* Implicit builtin methods */
  /* 0 */
  void* (*f__cast)(
...
struct bHYPRE_StructJacobi__controls {
  int     use_hooks;
};
/*
...
struct bHYPRE_StructJacobi__object {
  ...
  struct bHYPRE_StructJacobi__epv* d_epv;
  void*                            d_data;
};

struct bHYPRE_StructJacobi__external {
  struct bHYPRE_StructJacobi__object*
...
const struct bHYPRE_StructJacobi__external*
bHYPRE_StructJacobi__externals(void);

extern struct bHYPRE_StructJacobi__object*
bHYPRE_StructJacobi__new(void* ddata,struct sidl_BaseInterface__object ** _ex);

extern struct bHYPRE_StructJacobi__sepv*
