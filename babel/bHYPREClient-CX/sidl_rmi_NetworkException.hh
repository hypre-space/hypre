// 
// File:          sidl_rmi_NetworkException.hh
...
#define included_sidl_rmi_NetworkException_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::sidl::rmi::NetworkException >;
  }
...
namespace ucxx { 
  namespace sidl { 
    namespace rmi { 
       ...
       */
      class NetworkException: public virtual ::ucxx::sidl::io::IOException {
    ...
    public:
      ...
      // static constructor
      static ::ucxx::sidl::rmi::NetworkException _create();
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::sidl::rmi::NetworkException > {
      typedef array< ::ucxx::sidl::rmi::NetworkException > cxx_array_t;
      typedef ::ucxx::sidl::rmi::NetworkException cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::sidl::rmi::NetworkException > > 
        iterator;
      typedef const_array_iter< array_traits< 
        ::ucxx::sidl::rmi::NetworkException > > const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::sidl::rmi::NetworkException >: public interface_array< 
      array_traits< ::ucxx::sidl::rmi::NetworkException > > {
    public:
      typedef interface_array< array_traits< 
        ::ucxx::sidl::rmi::NetworkException > > Base;
      typedef array_traits< ::ucxx::sidl::rmi::NetworkException >::cxx_array_t  
        cxx_array_t;
      typedef array_traits< ::ucxx::sidl::rmi::NetworkException >::cxx_item_t   
        cxx_item_t;
      typedef array_traits< ::ucxx::sidl::rmi::NetworkException >::ior_array_t  
        ior_array_t;
      typedef array_traits< ::ucxx::sidl::rmi::NetworkException 
        >::ior_array_internal_t ior_array_internal_t;
      typedef array_traits< ::ucxx::sidl::rmi::NetworkException >::ior_item_t   
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::sidl::rmi::NetworkException >&src) : 
        Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::sidl::rmi::NetworkException >&
      operator =( const array< ::ucxx::sidl::rmi::NetworkException >&rhs ) { 
