...

{
  ...
  struct sidl_rmi_ServerInfo__object* _local_si = (struct 
    ...
    ::sidl::rmi::ServerInfo::_cast((void*)(si._get_ior()));
  ...
  if (_local_si) {
    struct sidl_BaseInterface__object *throwaway_exception;  
    (_local_si->d_epv->f_deleteRef)(_local_si->d_object, &throwaway_exception);
  }
...
sidl::rmi::ServerRegistry::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_ServerRegistry__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::ServerRegistry::ServerRegistry ( const ::sidl::rmi::ServerRegistry& 
  original ) {
  d_self = ::sidl::rmi::ServerRegistry::_cast(original._get_ior());
...
sidl::rmi::ServerRegistry::operator=( const ::sidl::rmi::ServerRegistry& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::ServerRegistry::_cast(rhs._get_ior());
