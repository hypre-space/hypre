...
extern void bHYPRE_StructGrid__init(
  struct bHYPRE_StructGrid__object* self, void* ddata, struct 
...
extern void bHYPRE_StructGrid__getEPVs(
  ...
  struct bHYPRE_StructGrid__epv **s_arg_epv__bhypre_structgrid,struct 
    bHYPRE_StructGrid__epv **s_arg_epv_hooks__bhypre_structgrid);
  extern void bHYPRE_StructGrid__fini(
    struct bHYPRE_StructGrid__object* self, struct sidl_BaseInterface__object 
      ** _ex);
  ...
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_StructGrid_fcast_bHYPRE_MPICommunicator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_StructGrid__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_StructGrid__object* 
    skel_bHYPRE_StructGrid_fcast_bHYPRE_StructGrid(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_BaseClass__object* skel_bHYPRE_StructGrid_fconnect_sidl_BaseClass(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* skel_bHYPRE_StructGrid_fcast_sidl_BaseClass(
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_StructGrid_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_ClassInfo__object* skel_bHYPRE_StructGrid_fconnect_sidl_ClassInfo(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* skel_bHYPRE_StructGrid_fcast_sidl_ClassInfo(
    void *bi, struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_StructGrid_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
