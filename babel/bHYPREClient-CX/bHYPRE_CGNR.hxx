...
#define included_bHYPRE_CGNR_hxx
...
namespace bHYPRE { 
  ...
  public:
    typedef struct bHYPRE_CGNR__object ior_t;
    typedef struct bHYPRE_CGNR__external ext_t;
    ...
    // RMI constructor
    static ::bHYPRE::CGNR _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::CGNR _connect( /*in*/ const std::string& url ) { 
    ...
    // copy constructor
    CGNR ( const CGNR& original );

    // assignment operator
    CGNR& operator= ( const CGNR& rhs );
    ...
    static inline const char * type_name() throw () { return "bHYPRE.CGNR";}

    static struct bHYPRE_CGNR__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::CGNR > {
    typedef array< ::bHYPRE::CGNR > cxx_array_t;
    typedef ::bHYPRE::CGNR cxx_item_t;
    typedef struct bHYPRE_CGNR__array ior_array_t;
    typedef sidl_interface__array ior_array_internal_t;
    typedef struct bHYPRE_CGNR__object ior_item_t;
    typedef cxx_item_t value_type;
    typedef value_type reference;
    typedef value_type* pointer;
    typedef const value_type const_reference;
    typedef const value_type* const_pointer;
    typedef array_iter< array_traits< ::bHYPRE::CGNR > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::CGNR > > const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::CGNR >: public interface_array< array_traits< 
    ::bHYPRE::CGNR > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::CGNR > > Base;
    typedef array_traits< ::bHYPRE::CGNR >::cxx_array_t          cxx_array_t;
    typedef array_traits< ::bHYPRE::CGNR >::cxx_item_t           cxx_item_t;
    typedef array_traits< ::bHYPRE::CGNR >::ior_array_t          ior_array_t;
    typedef array_traits< ::bHYPRE::CGNR >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::CGNR >::ior_item_t           ior_item_t;

    /**
     * conversion from ior to C++ class
     * (constructor/casting operator)
     */
    array( struct bHYPRE_CGNR__array* src = 0) : Base(src) {}

    /**
     * copy constructor
     */
    array( const array< ::bHYPRE::CGNR >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::CGNR >&
    operator =( const array< ::bHYPRE::CGNR >&rhs ) { 
