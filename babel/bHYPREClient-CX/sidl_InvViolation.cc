...
#ifndef included_sidl_InvViolation_hh
#include "sidl_InvViolation.hh"
#endif
 ...
 */
bool
ucxx::sidl::InvViolation::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()
...
ucxx::sidl::InvViolation::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::sidl::InvViolation::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::sidl::InvViolation::getClassInfo(  )
throw ()
 ...
 */
::std::string
ucxx::sidl::InvViolation::getNote(  )
throw ()
 ...
 */
void
ucxx::sidl::InvViolation::setNote( /* in */const ::std::string& message )
throw ()
 ...
 */
::std::string
ucxx::sidl::InvViolation::getTrace(  )
throw ()
 ...
 */
void
ucxx::sidl::InvViolation::add( /* in */const ::std::string& traceline )
throw ()
 ...
 */
void
ucxx::sidl::InvViolation::add( /* in */const ::std::string& filename,
...
// static constructor
::ucxx::sidl::InvViolation
ucxx::sidl::InvViolation::_create() {
  ::ucxx::sidl::InvViolation self( (*_get_ext()->createObject)(), false );
  return self;
}

// copy constructor
ucxx::sidl::InvViolation::InvViolation ( const ::ucxx::sidl::InvViolation& 
  original ) {
  d_self = original._cast("sidl.InvViolation");
...
// assignment operator
::ucxx::sidl::InvViolation&
ucxx::sidl::InvViolation::operator=( const ::ucxx::sidl::InvViolation& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("sidl.InvViolation");
...
ucxx::sidl::InvViolation::InvViolation ( ::ucxx::sidl::InvViolation::ior_t* ior 
  ) 
...
void* ucxx::sidl::InvViolation::_cast(const char* type) const
{
...
// Static data type
const ::ucxx::sidl::InvViolation::ext_t * ucxx::sidl::InvViolation::s_ext = 0;

// private static method to get static data type
const ::ucxx::sidl::InvViolation::ext_t *
ucxx::sidl::InvViolation::_get_ext()
