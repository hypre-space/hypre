...
#define included_sidl_PostViolation_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::sidl::PostViolation >;
  }
...
namespace ucxx { 
  namespace sidl { 
     ...
     */
    class PostViolation: public virtual ::ucxx::sidl::SIDLException {
  ...
  public:
    ...
    // static constructor
    static ::ucxx::sidl::PostViolation _create();
    ...
    static inline const char * type_name() { return "sidl.PostViolation";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::sidl::PostViolation > {
      typedef array< ::ucxx::sidl::PostViolation > cxx_array_t;
      typedef ::ucxx::sidl::PostViolation cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::sidl::PostViolation > > 
        iterator;
      typedef const_array_iter< array_traits< ::ucxx::sidl::PostViolation > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::sidl::PostViolation >: public interface_array< 
      array_traits< ::ucxx::sidl::PostViolation > > {
    public:
      typedef interface_array< array_traits< ::ucxx::sidl::PostViolation > > 
        Base;
      typedef array_traits< ::ucxx::sidl::PostViolation >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::sidl::PostViolation >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::sidl::PostViolation >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::sidl::PostViolation >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::sidl::PostViolation >::ior_item_t           
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::sidl::PostViolation >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::sidl::PostViolation >&
      operator =( const array< ::ucxx::sidl::PostViolation >&rhs ) { 
