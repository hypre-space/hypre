...
#define included_bHYPRE_GMRES_hh
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     * 
     */
    class GMRES: public virtual ::ucxx::bHYPRE::PreconditionedSolver,
  ...
  public:
    typedef struct bHYPRE_GMRES__object ior_t;
    typedef struct bHYPRE_GMRES__external ext_t;
    ...
    // static constructor
    static ::ucxx::bHYPRE::GMRES _create();

    // default destructor
    virtual ~GMRES () { }

    // copy constructor
    GMRES ( const GMRES& original );

    // assignment operator
    GMRES& operator= ( const GMRES& rhs );

    // conversion from ior to C++ class
    GMRES ( GMRES::ior_t* ior );
    ...
    static inline const char * type_name() { return "bHYPRE.GMRES";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::GMRES > {
      typedef array< ::ucxx::bHYPRE::GMRES > cxx_array_t;
      typedef ::ucxx::bHYPRE::GMRES cxx_item_t;
      typedef struct bHYPRE_GMRES__array ior_array_t;
      typedef sidl_interface__array ior_array_internal_t;
      typedef struct bHYPRE_GMRES__object ior_item_t;
      typedef cxx_item_t value_type;
      typedef value_type reference;
      typedef value_type* pointer;
      typedef const value_type const_reference;
      typedef const value_type* const_pointer;
      typedef array_iter< array_traits< ::ucxx::bHYPRE::GMRES > > iterator;
      typedef const_array_iter< array_traits< ::ucxx::bHYPRE::GMRES > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::GMRES >: public interface_array< array_traits< 
      ::ucxx::bHYPRE::GMRES > > {
    public:
      typedef interface_array< array_traits< ::ucxx::bHYPRE::GMRES > > Base;
      typedef array_traits< ::ucxx::bHYPRE::GMRES >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::GMRES >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::GMRES >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::GMRES >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::GMRES >::ior_item_t           
        ior_item_t;
       ...
       */
      array( struct bHYPRE_GMRES__array* src = 0) : Base(src) {}

      /**
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::GMRES >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::GMRES >&
      operator =( const array< ::ucxx::bHYPRE::GMRES >&rhs ) { 
