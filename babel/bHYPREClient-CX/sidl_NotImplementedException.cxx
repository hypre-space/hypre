// 
// File:          sidl_NotImplementedException.cxx
...
void
sidl::NotImplementedException::throwException0(
...
sidl::NotImplementedException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::NotImplementedException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::NotImplementedException
sidl::NotImplementedException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_NotImplementedException__remoteCreate( url.c_str(), 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::NotImplementedException( ior_self, false );
}

// remote connector
::sidl::NotImplementedException
sidl::NotImplementedException::_connect(const std::string& url, const bool ar ) 
  {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_NotImplementedException__remoteConnect( url.c_str(), 
...
// copy constructor
sidl::NotImplementedException::NotImplementedException ( const 
  ::sidl::NotImplementedException& original ) {
  d_self = (struct sidl_NotImplementedException__object*) 
    original.::sidl::NotImplementedException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::NotImplementedException&
sidl::NotImplementedException::operator=( const 
  ::sidl::NotImplementedException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct sidl_NotImplementedException__object*) 
      rhs.::sidl::NotImplementedException::_get_ior();
    if(d_self) {
...
sidl::NotImplementedException::NotImplementedException ( 
  ::sidl::NotImplementedException::ior_t* ior ) 
...
sidl::NotImplementedException::NotImplementedException ( 
  ::sidl::NotImplementedException::ior_t* ior, bool isWeak ) : 
...
void ::sidl::NotImplementedException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::NotImplementedException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::NotImplementedException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_NotImplementedException__object*) 
    ::sidl::NotImplementedException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::NotImplementedException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_NotImplementedException__object* 
  sidl::NotImplementedException::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.NotImplementedException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::NotImplementedException::ext_t * 
  sidl::NotImplementedException::s_ext = 0;

// private static method to get static data type
const ::sidl::NotImplementedException::ext_t *
sidl::NotImplementedException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_NotImplementedException__externals();
  }
  return s_ext;
}
