...
sidl::NotImplementedException::_create(const std::string& url) {
  ...
  ior_self = sidl_NotImplementedException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
// remote connector 2
::sidl::NotImplementedException
sidl::NotImplementedException::_connect(const std::string& url,
  const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
...
sidl::NotImplementedException::NotImplementedException ( const 
  ...
  d_self = ::sidl::NotImplementedException::_cast(original._get_ior());
...
sidl::NotImplementedException::operator=( const 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::NotImplementedException::_cast(rhs._get_ior());
