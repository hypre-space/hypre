...
void
sidl::CastException::throwException0(
...
// static constructor
::sidl::CastException
sidl::CastException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::CastException self( (*_get_ext()->createObject)(NULL,&_exception), 
    false );
  if (_exception) {
...
// remote constructor
::sidl::CastException
sidl::CastException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_CastException__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::CastException( ior_self, false );
}

// remote connector
::sidl::CastException
sidl::CastException::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_CastException__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
// copy constructor
sidl::CastException::CastException ( const ::sidl::CastException& original ) {
  d_self = (struct sidl_CastException__object*) 
    original.::sidl::CastException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::CastException&
sidl::CastException::operator=( const ::sidl::CastException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct sidl_CastException__object*) 
      rhs.::sidl::CastException::_get_ior();
    if(d_self) {
...
sidl::CastException::CastException ( ::sidl::CastException::ior_t* ior ) 
...
sidl::CastException::CastException ( ::sidl::CastException::ior_t* ior, bool 
  isWeak ) : 
...
void ::sidl::CastException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::CastException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::CastException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_CastException__object*) 
    ::sidl::CastException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::CastException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_CastException__object* sidl::CastException::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.CastException", (
      void*)sidl_CastException__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.CastException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::CastException::ext_t * sidl::CastException::s_ext = 0;

// private static method to get static data type
const ::sidl::CastException::ext_t *
sidl::CastException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_CastException__externals();
  }
  return s_ext;
}
