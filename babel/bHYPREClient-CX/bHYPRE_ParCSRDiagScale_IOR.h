...
struct bHYPRE_ParCSRDiagScale__controls {
  int     use_hooks;
};
/*
...
bHYPRE_ParCSRDiagScale__new(void* ddata,struct sidl_BaseInterface__object ** 
  _ex);
...
extern void bHYPRE_ParCSRDiagScale__init(
  struct bHYPRE_ParCSRDiagScale__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void bHYPRE_ParCSRDiagScale__getEPVs(
  ...
  struct bHYPRE_ParCSRDiagScale__epv **s_arg_epv__bhypre_parcsrdiagscale,struct 
    bHYPRE_ParCSRDiagScale__epv **s_arg_epv_hooks__bhypre_parcsrdiagscale);
  extern void bHYPRE_ParCSRDiagScale__fini(
    struct bHYPRE_ParCSRDiagScale__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void bHYPRE_ParCSRDiagScale__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct bHYPRE_IJParCSRMatrix__object* 
    skel_bHYPRE_ParCSRDiagScale_fcast_bHYPRE_IJParCSRMatrix(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_MPICommunicator__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_ParCSRDiagScale_fcast_bHYPRE_MPICommunicator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Operator__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_ParCSRDiagScale_fcast_bHYPRE_Operator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_ParCSRDiagScale__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_ParCSRDiagScale__object* 
    skel_bHYPRE_ParCSRDiagScale_fcast_bHYPRE_ParCSRDiagScale(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct bHYPRE_Solver__object* 
    skel_bHYPRE_ParCSRDiagScale_fconnect_bHYPRE_Solver(const char* url, 
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Vector__object* 
    skel_bHYPRE_ParCSRDiagScale_fconnect_bHYPRE_Vector(const char* url, 
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseClass__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* 
    skel_bHYPRE_ParCSRDiagScale_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_ParCSRDiagScale_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_bHYPRE_ParCSRDiagScale_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_ParCSRDiagScale_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct bHYPRE_ParCSRDiagScale__remote{
    int d_refcount;
