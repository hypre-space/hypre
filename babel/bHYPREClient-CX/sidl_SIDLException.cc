...
// 
// babel-version = 0.10.12
// xml-url       = /home/painter/babel-0.10.12/bin/.././share/repository/sidl.SIDLException-v0.9.3.xml
// 
 ...
 */
bool
ucxx::sidl::SIDLException::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()
...
ucxx::sidl::SIDLException::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::sidl::SIDLException::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::sidl::SIDLException::getClassInfo(  )
throw ()
 ...
 */
::std::string
ucxx::sidl::SIDLException::getNote(  )
throw ()
 ...
 */
void
ucxx::sidl::SIDLException::setNote( /* in */const ::std::string& message )
throw ()
 ...
 */
::std::string
ucxx::sidl::SIDLException::getTrace(  )
throw ()
 ...
 */
void
ucxx::sidl::SIDLException::add( /* in */const ::std::string& traceline )
throw ()
 ...
 */
void
ucxx::sidl::SIDLException::add( /* in */const ::std::string& filename,
...
// static constructor
::ucxx::sidl::SIDLException
ucxx::sidl::SIDLException::_create() {
  ::ucxx::sidl::SIDLException self( (*_get_ext()->createObject)(), false );
  return self;
}

// copy constructor
ucxx::sidl::SIDLException::SIDLException ( const ::ucxx::sidl::SIDLException& 
  original ) {
  d_self = original._cast("sidl.SIDLException");
...
// assignment operator
::ucxx::sidl::SIDLException&
ucxx::sidl::SIDLException::operator=( const ::ucxx::sidl::SIDLException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("sidl.SIDLException");
...
ucxx::sidl::SIDLException::SIDLException ( ::ucxx::sidl::SIDLException::ior_t* 
  ior ) 
...
void* ucxx::sidl::SIDLException::_cast(const char* type) const
{
...
// Static data type
const ::ucxx::sidl::SIDLException::ext_t * ucxx::sidl::SIDLException::s_ext = 0;

// private static method to get static data type
const ::ucxx::sidl::SIDLException::ext_t *
ucxx::sidl::SIDLException::_get_ext()
