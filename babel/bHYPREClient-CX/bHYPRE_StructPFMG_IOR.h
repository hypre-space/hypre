...
struct bHYPRE_StructPFMG__controls {
  int     use_hooks;
};
/*
...
extern void bHYPRE_StructPFMG__init(
  struct bHYPRE_StructPFMG__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void bHYPRE_StructPFMG__getEPVs(
  ...
  struct bHYPRE_StructPFMG__epv **s_arg_epv__bhypre_structpfmg,
    struct bHYPRE_StructPFMG__epv **s_arg_epv_hooks__bhypre_structpfmg);
  ...
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_StructPFMG_fconnect_bHYPRE_Operator(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_StructPFMG_fcast_bHYPRE_Operator(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_Solver__object* 
    skel_bHYPRE_StructPFMG_fconnect_bHYPRE_Solver(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_StructMatrix__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_StructMatrix__object* 
    skel_bHYPRE_StructPFMG_fcast_bHYPRE_StructMatrix(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_StructPFMG__object* 
    skel_bHYPRE_StructPFMG_fconnect_bHYPRE_StructPFMG(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_StructPFMG__object* 
    skel_bHYPRE_StructPFMG_fcast_bHYPRE_StructPFMG(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_Vector__object* 
    skel_bHYPRE_StructPFMG_fconnect_bHYPRE_Vector(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Vector__object* skel_bHYPRE_StructPFMG_fcast_bHYPRE_Vector(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_BaseClass__object* 
    skel_bHYPRE_StructPFMG_fconnect_sidl_BaseClass(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* 
    skel_bHYPRE_StructPFMG_fcast_sidl_BaseClass(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct sidl_BaseInterface__object* 
    skel_bHYPRE_StructPFMG_fconnect_sidl_BaseInterface(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_StructPFMG_fcast_sidl_BaseInterface(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct sidl_ClassInfo__object* 
    skel_bHYPRE_StructPFMG_fconnect_sidl_ClassInfo(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_bHYPRE_StructPFMG_fcast_sidl_ClassInfo(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_StructPFMG__remote{
    int d_refcount;
