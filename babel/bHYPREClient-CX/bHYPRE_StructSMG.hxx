...
#define included_bHYPRE_StructSMG_hxx
...
namespace bHYPRE { 
  ...
  public:
    ...
    // RMI constructor
    static ::bHYPRE::StructSMG _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::StructSMG _connect( /*in*/ const std::string& url ) 
      { 
    ...
    static struct bHYPRE_StructSMG__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::StructSMG > {
    typedef array< ::bHYPRE::StructSMG > cxx_array_t;
    typedef ::bHYPRE::StructSMG cxx_item_t;
    ...
    typedef array_iter< array_traits< ::bHYPRE::StructSMG > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::StructSMG > > 
      const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::StructSMG >: public interface_array< array_traits< 
    ::bHYPRE::StructSMG > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::StructSMG > > Base;
    typedef array_traits< ::bHYPRE::StructSMG >::cxx_array_t          
      cxx_array_t;
    typedef array_traits< ::bHYPRE::StructSMG >::cxx_item_t           
      cxx_item_t;
    typedef array_traits< ::bHYPRE::StructSMG >::ior_array_t          
      ior_array_t;
    typedef array_traits< ::bHYPRE::StructSMG >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::StructSMG >::ior_item_t           
      ior_item_t;
     ...
     * copy constructor
     */
    array( const array< ::bHYPRE::StructSMG >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::StructSMG >&
    operator =( const array< ::bHYPRE::StructSMG >&rhs ) { 
