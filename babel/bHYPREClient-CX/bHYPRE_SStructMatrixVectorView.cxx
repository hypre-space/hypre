...
/* #define HAVE_LOCKED_STATIC_GLOBALS (1) */
  ...
  static char* remote_bHYPRE__SStructMatrixVectorView__getURL(
    struct bHYPRE__SStructMatrixVectorView__object* self, sidl_BaseInterface* 
      _ex)
  {
...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_SStructMatrixVectorView__object*) 
    ::bHYPRE::SStructMatrixVectorView::_get_ior();
  struct sidl_BaseInterface__object* _local_A;
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_GetObject))(loc_self->d_object, /* out */ 
    &_local_A, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
...
bHYPRE::SStructMatrixVectorView::_connect(const std::string& url, const bool ar 
  ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
...
bHYPRE::SStructMatrixVectorView::SStructMatrixVectorView ( const 
  ...
  d_self = (struct bHYPRE_SStructMatrixVectorView__object*) 
    original.::bHYPRE::SStructMatrixVectorView::_get_ior();
  bHYPRE_SStructMatrixVectorView_IORCache = (ior_t*) d_self;
  if(d_self) {
    addRef();
  }
...
bHYPRE::SStructMatrixVectorView::operator=( const 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_SStructMatrixVectorView__object*) 
      rhs.::bHYPRE::SStructMatrixVectorView::_get_ior();
    bHYPRE_SStructMatrixVectorView_IORCache = (ior_t*) d_self;
    if(d_self) {
      addRef();
    }
