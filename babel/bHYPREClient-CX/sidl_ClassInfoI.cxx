...
sidl::ClassInfoI::_create() {
  ...
  ::sidl::ClassInfoI self( (*_get_ext()->createObject)(NULL,&_exception),
    false );
  if (_exception) {
    void *_p;
    if ( (_p = (*(_exception->d_epv->f__cast))(_exception->d_object,
...
sidl::ClassInfoI::_create(const std::string& url) {
  ...
  ior_self = sidl_ClassInfoI__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::ClassInfoI::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
  ior_self = sidl_ClassInfoI__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
    ; //TODO: handle exception
  }
  return ::sidl::ClassInfoI( ior_self, false );
...
sidl::ClassInfoI::ClassInfoI ( const ::sidl::ClassInfoI& original ) {
  d_self = ::sidl::ClassInfoI::_cast(original._get_ior());
...
sidl::ClassInfoI::operator=( const ::sidl::ClassInfoI& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::ClassInfoI::_cast(rhs._get_ior());
