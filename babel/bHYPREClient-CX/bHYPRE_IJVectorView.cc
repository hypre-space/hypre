 ...
 */
bool
ucxx::bHYPRE::IJVectorView::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()

{
  ...
  ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
    ...
    sidl_BaseInterface__object * > (d_self))->d_object, "bHYPRE.IJVectorView");
...
ucxx::bHYPRE::IJVectorView::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::bHYPRE::IJVectorView::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::bHYPRE::IJVectorView::getClassInfo(  )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::SetCommunicator( /* in 
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::SetValues( /* in */int32_t nvalues,
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::SetValues( /* in rarray[nvalues] 
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::AddToValues( /* in */int32_t nvalues,
  /* in rarray[nvalues] */int32_t* indices,
  /* in rarray[nvalues] */double* values )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::AddToValues( /* in rarray[nvalues] 
  */::ucxx::sidl::array<int32_t> indices,
  /* in rarray[nvalues] */::ucxx::sidl::array<double> values )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::GetValues( /* in */int32_t nvalues,
  /* in rarray[nvalues] */int32_t* indices,
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::GetValues( /* in rarray[nvalues] 
  */::ucxx::sidl::array<int32_t> indices,
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::Print( /* in */const ::std::string& filename )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::IJVectorView::Read( /* in */const ::std::string& filename,
...
// copy constructor
ucxx::bHYPRE::IJVectorView::IJVectorView ( const ::ucxx::bHYPRE::IJVectorView& 
  original ) {
  d_self = original._cast("bHYPRE.IJVectorView");
...
// assignment operator
::ucxx::bHYPRE::IJVectorView&
ucxx::bHYPRE::IJVectorView::operator=( const ::ucxx::bHYPRE::IJVectorView& rhs 
  ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("bHYPRE.IJVectorView");
...
ucxx::bHYPRE::IJVectorView::IJVectorView ( ::ucxx::bHYPRE::IJVectorView::ior_t* 
  ior ) 
...
void* ucxx::bHYPRE::IJVectorView::_cast(const char* type) const
{
