// 
// File:          sidl_rmi_NetworkException.cc
...
// 
// babel-version = 0.10.12
// xml-url       = /home/painter/babel/share/babel-0.10.12/repository/sidl.rmi.NetworkException-v0.9.3.xml
// 
 ...
 */
bool
ucxx::sidl::rmi::NetworkException::isSame( /* in */::ucxx::sidl::BaseInterface 
  iobj )
throw ()
...
ucxx::sidl::rmi::NetworkException::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::sidl::rmi::NetworkException::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::sidl::rmi::NetworkException::getClassInfo(  )
throw ()
 ...
 */
::std::string
ucxx::sidl::rmi::NetworkException::getNote(  )
throw ()
 ...
 */
void
ucxx::sidl::rmi::NetworkException::setNote( /* in */const ::std::string& 
  message )
throw ()
 ...
 */
::std::string
ucxx::sidl::rmi::NetworkException::getTrace(  )
throw ()
 ...
 */
void
ucxx::sidl::rmi::NetworkException::add( /* in */const ::std::string& traceline )
throw ()
 ...
 */
void
ucxx::sidl::rmi::NetworkException::add( /* in */const ::std::string& filename,
...
ucxx::sidl::rmi::NetworkException::_create() {
  ::ucxx::sidl::rmi::NetworkException self( (*_get_ext()->createObject)(),
    false );
  return self;
}

// copy constructor
ucxx::sidl::rmi::NetworkException::NetworkException ( const 
  ::ucxx::sidl::rmi::NetworkException& original ) {
  d_self = original._cast("sidl.rmi.NetworkException");
...
// assignment operator
::ucxx::sidl::rmi::NetworkException&
ucxx::sidl::rmi::NetworkException::operator=( const 
  ::ucxx::sidl::rmi::NetworkException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("sidl.rmi.NetworkException");
...
ucxx::sidl::rmi::NetworkException::NetworkException ( 
  ::ucxx::sidl::rmi::NetworkException::ior_t* ior ) 
...
ucxx::sidl::rmi::NetworkException::NetworkException ( 
  ::ucxx::sidl::rmi::NetworkException::ior_t* ior, bool isWeak ) : 
StubBase(reinterpret_cast< void*>(ior), isWeak){ 
}

// protected method that implements casting
void* ucxx::sidl::rmi::NetworkException::_cast(const char* type) const
{
...
// Static data type
const ::ucxx::sidl::rmi::NetworkException::ext_t * 
  ucxx::sidl::rmi::NetworkException::s_ext = 0;

// private static method to get static data type
const ::ucxx::sidl::rmi::NetworkException::ext_t *
ucxx::sidl::rmi::NetworkException::_get_ext()
