...
#define included_bHYPRE_StructPFMG_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::bHYPRE::StructPFMG >;
  }
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     * 
     */
    class StructPFMG: public virtual ::ucxx::bHYPRE::Solver,
  ...
  public:
    ...
    // static constructor
    static ::ucxx::bHYPRE::StructPFMG _create();
    ...
    static inline const char * type_name() { return "bHYPRE.StructPFMG";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::StructPFMG > {
      typedef array< ::ucxx::bHYPRE::StructPFMG > cxx_array_t;
      typedef ::ucxx::bHYPRE::StructPFMG cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::bHYPRE::StructPFMG > > iterator;
      typedef const_array_iter< array_traits< ::ucxx::bHYPRE::StructPFMG > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::StructPFMG >: public interface_array< 
      array_traits< ::ucxx::bHYPRE::StructPFMG > > {
    public:
      typedef interface_array< array_traits< ::ucxx::bHYPRE::StructPFMG > > 
        Base;
      typedef array_traits< ::ucxx::bHYPRE::StructPFMG >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::StructPFMG >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::StructPFMG >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::StructPFMG >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::StructPFMG >::ior_item_t           
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::StructPFMG >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::StructPFMG >&
      operator =( const array< ::ucxx::bHYPRE::StructPFMG >&rhs ) { 
