...
#ifndef included_bHYPRE_GMRES_hxx
#include "bHYPRE_GMRES.hxx"
#endif
...
/* #define HAVE_LOCKED_STATIC_GLOBALS (1) */
    ...
    const char* name, sidl_BaseInterface* _ex)
  {
    ...
    *_ex = NULL; /* default to no exception */
    ...
    if ((*self->d_epv->f_isType)(self,name, _ex)) {
      ...
      cast =  (*func)(((struct bHYPRE_GMRES__remote*)self->d_data)->d_ih, _ex);
    }
  ...
  static char* remote_bHYPRE_GMRES__getURL(
    struct bHYPRE_GMRES__object* self, sidl_BaseInterface* _ex)
  {
    struct sidl_rmi_InstanceHandle__object *conn = ((struct 
      bHYPRE_GMRES__remote*)self->d_data)->d_ih;
    *_ex = NULL;
    if(conn != NULL) {
  ...
  static void remote_bHYPRE_GMRES__raddRef(
    struct bHYPRE_GMRES__object* self,sidl_BaseInterface* _ex)
  {
  ...
  static void
  remote_bHYPRE_GMRES__set_hooks(
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES._set_hooks.", &throwaway_exception);
  ...
  static void remote_bHYPRE_GMRES__exec(
    struct bHYPRE_GMRES__object* self,const char* methodName,
    ...
    /* out */ struct sidl_BaseInterface__object* *_ex)
  {
    ...
    *_ex = NULL;
    {
      struct bHYPRE_GMRES__remote* r_obj = (struct 
        bHYPRE_GMRES__remote*)self->d_data;
      LOCK_STATIC_GLOBALS;
      r_obj->d_refcount++;
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.isSame.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.isType.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.getClassInfo.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetPreconditioner.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
  ...
  static int32_t
  remote_bHYPRE_GMRES_GetPreconditioner(
    /* in */ struct bHYPRE_GMRES__object* self ,
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.GetPreconditioner.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.Clone.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetOperator.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetTolerance.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetMaxIterations.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetLogging.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetPrintLevel.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.GetNumIterations.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.GetRelResidualNorm.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetCommunicator.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.Destroy.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetIntParameter.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetDoubleParameter.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetStringParameter.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetIntArray1Parameter.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetIntArray2Parameter.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetDoubleArray1Parameter.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.SetDoubleArray2Parameter.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.GetIntValue.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.GetDoubleValue.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.Setup.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.Apply.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
    ...
    *_ex = NULL;
    {
      ...
      if(_be != NULL) {
        sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.GMRES.ApplyAdjoint.", &throwaway_exception);
        *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
          &throwaway_exception);
        goto EXIT;
      }
  ...
  static void bHYPRE_GMRES__init_remote_epv(void)
  {
    ...
    epv->f__raddRef                      = remote_bHYPRE_GMRES__raddRef;
    epv->f__isRemote                     = remote_bHYPRE_GMRES__isRemote;
    epv->f__set_hooks                    = remote_bHYPRE_GMRES__set_hooks;
    epv->f__ctor                         = NULL;
    epv->f__ctor2                        = NULL;
    epv->f__dtor                         = NULL;
    ...
    epv->f_GetPreconditioner             = 
      remote_bHYPRE_GMRES_GetPreconditioner;
    epv->f_Clone                         = remote_bHYPRE_GMRES_Clone;
    ...
    epv->f_Destroy                       = remote_bHYPRE_GMRES_Destroy;
  ...
  bHYPRE_GMRES__remoteConnect(const char *url, sidl_bool ar,
    sidl_BaseInterface *_ex)
  {
    struct bHYPRE_GMRES__object* self;
    ...
    struct bHYPRE_GMRES__remote* r_obj;
    ...
    *_ex = NULL;
    ...
    if(objectID) {
      ...
      return bHYPRE_GMRES__rmicast(bi,_ex);SIDL_CHECK(*_ex);
    }
    ...
    r_obj =
      (struct bHYPRE_GMRES__remote*) malloc(
        sizeof(struct bHYPRE_GMRES__remote));
  ...
  static struct bHYPRE_GMRES__object*
  bHYPRE_GMRES__remoteCreate(const char *url, sidl_BaseInterface *_ex)
  {
    ...
    sidl_rmi_InstanceHandle instance = 
      sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.GMRES",
      _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct bHYPRE_GMRES__object*) malloc(
  ...
  bHYPRE_GMRES__rmicast(
    ...
    sidl_BaseInterface* _ex)
  {
    struct bHYPRE_GMRES__object* cast = NULL;

    *_ex = NULL;
    if(!connect_loaded) {
      sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.GMRES",
        (void*)bHYPRE_GMRES__IHConnect, _ex);
      connect_loaded = 1;
    }
    if (obj != NULL) {
      struct sidl_BaseInterface__object* base = (struct 
        sidl_BaseInterface__object*) obj;
      cast = (struct bHYPRE_GMRES__object*) (*base->d_epv->f__cast)(
        base->d_object,
        "bHYPRE.GMRES", _ex); SIDL_CHECK(*_ex);
    }
  ...
  {
    return bHYPRE_GMRES__remoteConnect(url, ar, _ex);
  }
 ...
 */
::bHYPRE::GMRES
bHYPRE::GMRES::Create( /* in */::bHYPRE::MPICommunicator mpi_comm,
  /* in */::bHYPRE::Operator A )

{
  ::bHYPRE::GMRES _result;
  ...
  _result = ::bHYPRE::GMRES( ( _get_sepv()->f_Create)( /* in */ _local_mpi_comm,
 ...
 */
int32_t
bHYPRE::GMRES::SetPreconditioner( /* in */::bHYPRE::Solver s )
 ...
 */
int32_t
bHYPRE::GMRES::GetPreconditioner( /* out */::bHYPRE::Solver& s )
 ...
 */
int32_t
bHYPRE::GMRES::Clone( /* out */::bHYPRE::PreconditionedSolver& x )
 ...
 */
int32_t
bHYPRE::GMRES::SetOperator( /* in */::bHYPRE::Operator A )
 ...
 */
int32_t
bHYPRE::GMRES::SetTolerance( /* in */double tolerance )
 ...
 */
int32_t
bHYPRE::GMRES::SetMaxIterations( /* in */int32_t max_iterations )
 ...
 */
int32_t
bHYPRE::GMRES::SetLogging( /* in */int32_t level )
 ...
 */
int32_t
bHYPRE::GMRES::SetPrintLevel( /* in */int32_t level )
 ...
 */
int32_t
bHYPRE::GMRES::GetNumIterations( /* out */int32_t& num_iterations )
 ...
 */
int32_t
bHYPRE::GMRES::GetRelResidualNorm( /* out */double& norm )
 ...
 */
int32_t
bHYPRE::GMRES::SetCommunicator( /* in */::bHYPRE::MPICommunicator mpi_comm )
 ...
 */
int32_t
bHYPRE::GMRES::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
 ...
 */
int32_t
bHYPRE::GMRES::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
 ...
 */
int32_t
bHYPRE::GMRES::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::GMRES::SetIntArray1Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::GMRES::SetIntArray2Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::GMRES::SetDoubleArray1Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::GMRES::SetDoubleArray2Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::GMRES::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
 ...
 */
int32_t
bHYPRE::GMRES::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
 ...
 */
int32_t
bHYPRE::GMRES::Setup( /* in */::bHYPRE::Vector b, /* in */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::GMRES::Apply( /* in */::bHYPRE::Vector b,
 ...
 */
int32_t
bHYPRE::GMRES::ApplyAdjoint( /* in */::bHYPRE::Vector b,
  /* inout */::bHYPRE::Vector& x )
...
// static constructor
::bHYPRE::GMRES
bHYPRE::GMRES::_create() {
  struct sidl_BaseInterface__object * _exception, *_throwaway;
  ::bHYPRE::GMRES self( (*_get_ext()->createObject)(NULL,&_exception), false );
  if (_exception) {
    void *_p;
    if ( (_p = (*(_exception->d_epv->f__cast))(_exception->d_object,
...
::bHYPRE::GMRES::ior_t*
bHYPRE::GMRES::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *throwaway_exception;
...
// remote constructor
::bHYPRE::GMRES
bHYPRE::GMRES::_create(const std::string& url) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
  ior_self = bHYPRE_GMRES__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
    ; //TODO: handle exception
  }
  return ::bHYPRE::GMRES( ior_self, false );
}

// remote connector 2
::bHYPRE::GMRES
bHYPRE::GMRES::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
  ior_self = bHYPRE_GMRES__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
    ; //TODO: handle exception
  }
  return ::bHYPRE::GMRES( ior_self, false );
...
// copy constructor
bHYPRE::GMRES::GMRES ( const ::bHYPRE::GMRES& original ) {
  d_self = ::bHYPRE::GMRES::_cast(original._get_ior());
  d_weak_reference = false;
}

// assignment operator
::bHYPRE::GMRES&
bHYPRE::GMRES::operator=( const ::bHYPRE::GMRES& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = ::bHYPRE::GMRES::_cast(rhs._get_ior());
...
bHYPRE::GMRES::GMRES ( ::bHYPRE::GMRES::ior_t* ior ) 
   : StubBase(reinterpret_cast< void*>(ior)) { }

// Alternate constructor: does not call addRef()
// (sets d_weak_reference=isWeak)
// For internal use by Impls (fixes bug#275)
bHYPRE::GMRES::GMRES ( ::bHYPRE::GMRES::ior_t* ior, bool isWeak ) : 
StubBase(reinterpret_cast< void*>(ior), isWeak){ 
}

// exec has special argument passing to avoid #include circularities
void ::bHYPRE::GMRES::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::bHYPRE::GMRES::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
void
bHYPRE::GMRES::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
 ...
 */
void
bHYPRE::GMRES::_set_hooks_static( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct bHYPRE_GMRES__object* bHYPRE::GMRES::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.GMRES",
      (void*)bHYPRE_GMRES__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object,
      "bHYPRE.GMRES", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::bHYPRE::GMRES::ext_t * bHYPRE::GMRES::s_ext = 0;

// private static method to get static data type
const ::bHYPRE::GMRES::ext_t *
bHYPRE::GMRES::_get_ext()
...
#endif
    sidl_checkIORVersion("bHYPRE.GMRES", s_ext->d_ior_major_version,
