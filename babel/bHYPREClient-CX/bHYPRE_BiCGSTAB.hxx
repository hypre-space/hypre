...
#ifndef included_bHYPRE_BiCGSTAB_hxx
#define included_bHYPRE_BiCGSTAB_hxx
...
namespace bHYPRE { 
  ...
  public:
    typedef struct bHYPRE_BiCGSTAB__object ior_t;
    typedef struct bHYPRE_BiCGSTAB__external ext_t;
    ...
    // RMI constructor
    static ::bHYPRE::BiCGSTAB _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::BiCGSTAB _connect( /*in*/ const std::string& url ) 
      { 
    ...
    // copy constructor
    BiCGSTAB ( const BiCGSTAB& original );

    // assignment operator
    BiCGSTAB& operator= ( const BiCGSTAB& rhs );
    ...
    static inline const char * type_name() throw () { return "bHYPRE.BiCGSTAB";}

    static struct bHYPRE_BiCGSTAB__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::BiCGSTAB > {
    typedef array< ::bHYPRE::BiCGSTAB > cxx_array_t;
    typedef ::bHYPRE::BiCGSTAB cxx_item_t;
    typedef struct bHYPRE_BiCGSTAB__array ior_array_t;
    typedef sidl_interface__array ior_array_internal_t;
    typedef struct bHYPRE_BiCGSTAB__object ior_item_t;
    typedef cxx_item_t value_type;
    typedef value_type reference;
    typedef value_type* pointer;
    typedef const value_type const_reference;
    typedef const value_type* const_pointer;
    typedef array_iter< array_traits< ::bHYPRE::BiCGSTAB > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::BiCGSTAB > > 
      const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::BiCGSTAB >: public interface_array< array_traits< 
    ::bHYPRE::BiCGSTAB > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::BiCGSTAB > > Base;
    typedef array_traits< ::bHYPRE::BiCGSTAB >::cxx_array_t          
      cxx_array_t;
    typedef array_traits< ::bHYPRE::BiCGSTAB >::cxx_item_t           cxx_item_t;
    typedef array_traits< ::bHYPRE::BiCGSTAB >::ior_array_t          
      ior_array_t;
    typedef array_traits< ::bHYPRE::BiCGSTAB >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::BiCGSTAB >::ior_item_t           ior_item_t;

    /**
     * conversion from ior to C++ class
     * (constructor/casting operator)
     */
    array( struct bHYPRE_BiCGSTAB__array* src = 0) : Base(src) {}

    /**
     * copy constructor
     */
    array( const array< ::bHYPRE::BiCGSTAB >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::BiCGSTAB >&
    operator =( const array< ::bHYPRE::BiCGSTAB >&rhs ) { 
