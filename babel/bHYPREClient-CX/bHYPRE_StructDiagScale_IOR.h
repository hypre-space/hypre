/*
 * File:          bHYPRE_StructDiagScale_IOR.h
 * Symbol:        bHYPRE.StructDiagScale-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Description:   Intermediate Object Representation for bHYPRE.StructDiagScale
 * 
...
#define included_bHYPRE_StructDiagScale_IOR_h
...
struct bHYPRE_StructDiagScale__sepv;
...
struct bHYPRE_StructDiagScale__sepv {
  ...
  /* Methods introduced in bHYPRE.StructDiagScale-v1.0.0 */
  struct bHYPRE_StructDiagScale__object* (*f_Create)(
...
struct bHYPRE_StructDiagScale__epv {
  /* Implicit builtin methods */
  /* 0 */
  void* (*f__cast)(
...
struct bHYPRE_StructDiagScale__controls {
  int     use_hooks;
};
/*
...
struct bHYPRE_StructDiagScale__object {
  ...
  struct bHYPRE_StructDiagScale__epv* d_epv;
  void*                               d_data;
};

struct bHYPRE_StructDiagScale__external {
  struct bHYPRE_StructDiagScale__object*
...
const struct bHYPRE_StructDiagScale__external*
bHYPRE_StructDiagScale__externals(void);

extern struct bHYPRE_StructDiagScale__object*
bHYPRE_StructDiagScale__new(void* ddata,
  struct sidl_BaseInterface__object ** _ex);

extern struct bHYPRE_StructDiagScale__sepv*
bHYPRE_StructDiagScale__statics(void);

extern void bHYPRE_StructDiagScale__init(
  struct bHYPRE_StructDiagScale__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void bHYPRE_StructDiagScale__getEPVs(
  ...
  struct bHYPRE_StructDiagScale__epv **s_arg_epv__bhypre_structdiagscale,
    struct bHYPRE_StructDiagScale__epv 
    **s_arg_epv_hooks__bhypre_structdiagscale);
  extern void bHYPRE_StructDiagScale__fini(
    struct bHYPRE_StructDiagScale__object* self,
      struct sidl_BaseInterface__object ** _ex);
  extern void bHYPRE_StructDiagScale__IOR_version(int32_t *major,
    int32_t *minor);
  ...
  struct bHYPRE_Solver__object* 
    skel_bHYPRE_StructDiagScale_fconnect_bHYPRE_Solver(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Solver__object* 
    skel_bHYPRE_StructDiagScale_fcast_bHYPRE_Solver(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Vector__object* 
    skel_bHYPRE_StructDiagScale_fconnect_bHYPRE_Vector(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Vector__object* 
    skel_bHYPRE_StructDiagScale_fcast_bHYPRE_Vector(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseClass__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* 
    skel_bHYPRE_StructDiagScale_fcast_sidl_BaseClass(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_bHYPRE_StructDiagScale_fcast_sidl_ClassInfo(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_StructDiagScale__remote{
    int d_refcount;
