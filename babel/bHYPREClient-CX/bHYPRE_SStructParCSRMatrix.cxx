...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_SStructParCSRMatrix__object*) 
    ::bHYPRE::SStructParCSRMatrix::_get_ior();
  struct bHYPRE_SStructGraph__object* _local_graph = (struct 
    bHYPRE_SStructGraph__object*) graph.::bHYPRE::SStructGraph::_get_ior();
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
 ...
 */
int32_t
bHYPRE::SStructParCSRMatrix::SetValues( /* in */int32_t part, /* in rarray[dim] 
...

{
  ...
  _result = (*(loc_self->d_epv->f_SetValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ index_tmp, /* in */ var, /* in rarray[nentries] */ 
...

{
  ...
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_SetValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ index._get_ior(), /* in */ var, /* in rarray[nentries] */ 
 ...
 */
int32_t
bHYPRE::SStructParCSRMatrix::SetBoxValues( /* in */int32_t part, /* in 
...

{
  ...
  _result = (*(loc_self->d_epv->f_SetBoxValues))(loc_self, /* in */ part, /* in 
    ...
    /* in */ var, /* in rarray[nentries] */ entries._get_ior(), /* in 
 ...
 */
int32_t
bHYPRE::SStructParCSRMatrix::AddToValues( /* in */int32_t part, /* in 
  rarray[dim] */int32_t* index, /* in */int32_t dim, /* in */int32_t var, /* in 
  */int32_t nentries, /* in rarray[nentries] */int32_t* entries, /* in 
  rarray[nentries] */double* values )
...
bHYPRE::SStructParCSRMatrix::AddToValues( /* in */int32_t part, /* in 
  ...
  rarray[nentries] */::sidl::array<int32_t> entries, /* in rarray[nentries] 
  */::sidl::array<double> values )
 ...
 */
int32_t
bHYPRE::SStructParCSRMatrix::AddToBoxValues( /* in */int32_t part, /* in 
  rarray[dim] */int32_t* ilower, /* in rarray[dim] */int32_t* iupper, /* in 
  */int32_t dim, /* in */int32_t var, /* in */int32_t nentries, /* in 
  rarray[nentries] */int32_t* entries, /* in rarray[nvalues] */double* values, 
  /* in */int32_t nvalues )
 ...
 */
int32_t
bHYPRE::SStructParCSRMatrix::SetSymmetric( /* in */int32_t part, /* in 
  */int32_t var, /* in */int32_t to_var, /* in */int32_t symmetric )

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_SetSymmetric))(loc_self, /* in */ part, /* in 
    */ var, /* in */ to_var, /* in */ symmetric, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
...
bHYPRE::SStructParCSRMatrix::SetIntArray1Parameter( /* in */const 
  ::std::string& name, /* in rarray[nvalues] */int32_t* value, /* in */int32_t 
  nvalues )
...
bHYPRE::SStructParCSRMatrix::SetIntArray2Parameter( /* in */const 
  ::std::string& name, /* in array<int,2,column-major> */::sidl::array<int32_t> 
  value )
 ...
 */
int32_t
bHYPRE::SStructParCSRMatrix::Setup( /* in */::bHYPRE::Vector b, /* in 
  */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::SStructParCSRMatrix::Apply( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
 ...
 */
int32_t
bHYPRE::SStructParCSRMatrix::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::SStructParCSRMatrix::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::SStructParCSRMatrix::ior_t* returnValue = (*_get_ext(
...
bHYPRE::SStructParCSRMatrix::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_SStructParCSRMatrix__remoteCreate( url.c_str(), &_exception 
    );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::SStructParCSRMatrix::SStructParCSRMatrix ( const 
  ...
  d_self = (struct bHYPRE_SStructParCSRMatrix__object*) 
    original.::bHYPRE::SStructParCSRMatrix::_get_ior();
  if(d_self) {

    bHYPRE_SStructMatrixView_IORCache = &((*reinterpret_cast< ior_t*>(
      d_self)).d_bhypre_sstructmatrixview);
...
bHYPRE::SStructParCSRMatrix::operator=( const ::bHYPRE::SStructParCSRMatrix& 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_SStructParCSRMatrix__object*) 
      rhs.::bHYPRE::SStructParCSRMatrix::_get_ior();
    if(d_self) {
...
struct bHYPRE_SStructParCSRMatrix__object* bHYPRE::SStructParCSRMatrix::_cast(
  const void* src)
{
  ior_t* cast = NULL;
...
#else
    s_ext = (struct bHYPRE_SStructParCSRMatrix__external*)sidl_dynamicLoadIOR(
