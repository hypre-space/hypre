 ...
 */
::sidl::DLL
sidl::Loader::loadLibrary( /* in */const ::std::string& uri, /* in */bool 
  loadGlobally, /* in */bool loadLazy )
...

{
  ...
  struct sidl_DLL__object* _local_dll = (struct sidl_DLL__object*) 
    dll.::sidl::DLL::_get_ior();
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
 ...
 */
::sidl::DLL
sidl::Loader::findLibrary( /* in */const ::std::string& sidl_name, /* in 
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  ( _get_sepv()->f_addSearchPath)( /* in */ path_fragment.c_str(), &_exception 
    );
  /*dispatch to ior*/
  if (_exception != 0 ) {
...
sidl::Loader::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_Loader__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
sidl::Loader::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_Loader__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
sidl::Loader::Loader ( const ::sidl::Loader& original ) {
  d_self = (struct sidl_Loader__object*) original.::sidl::Loader::_get_ior();
  if(d_self) {
...
sidl::Loader::operator=( const ::sidl::Loader& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct sidl_Loader__object*) rhs.::sidl::Loader::_get_ior();
    if(d_self) {
...
{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_Loader__object*) 
    ::sidl::Loader::_get_ior();
  char * _local_result;
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
