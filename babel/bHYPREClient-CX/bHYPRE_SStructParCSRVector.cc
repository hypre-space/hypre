// 
// File:          bHYPRE_SStructParCSRVector.cc
 ...
 */
::ucxx::bHYPRE::SStructParCSRVector
ucxx::bHYPRE::SStructParCSRVector::Create( /* in 
  */::ucxx::bHYPRE::MPICommunicator mpi_comm,
  /* in */::ucxx::bHYPRE::SStructGrid grid )
throw ()

{
  ::ucxx::bHYPRE::SStructParCSRVector _result;
  ...
  _result = ::ucxx::bHYPRE::SStructParCSRVector( ( _get_sepv()->f_Create)( /* 
    in */ _local_mpi_comm, /* in */ _local_grid ), false);
  /*dispatch to ior*/
 ...
 */
bool
ucxx::bHYPRE::SStructParCSRVector::isSame( /* in */::ucxx::sidl::BaseInterface 
  iobj )
throw ()
...
ucxx::bHYPRE::SStructParCSRVector::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::bHYPRE::SStructParCSRVector::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::bHYPRE::SStructParCSRVector::getClassInfo(  )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::SetCommunicator( /* in 
  */::ucxx::bHYPRE::MPICommunicator mpi_comm )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::GetObject( /* out 
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::SetGrid( /* in */::ucxx::bHYPRE::SStructGrid 
  grid )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::SetValues( /* in */int32_t part,
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::SetBoxValues( /* in */int32_t part,
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::AddToValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* index, /* in */int32_t dim, /* in */int32_t var,
  /* in */double value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::AddToBoxValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* ilower, /* in rarray[dim] */int32_t* iupper,
  /* in */int32_t dim, /* in */int32_t var,
  /* in rarray[nvalues] */double* values, /* in */int32_t nvalues )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::GetValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* index, /* in */int32_t dim, /* in */int32_t var,
  /* out */double& value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::GetBoxValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* ilower, /* in rarray[dim] */int32_t* iupper,
  /* in */int32_t dim, /* in */int32_t var,
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::Print( /* in */const ::std::string& filename,
  /* in */int32_t all )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::Copy( /* in */::ucxx::bHYPRE::Vector x )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::Clone( /* out */::ucxx::bHYPRE::Vector& x )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::Dot( /* in */::ucxx::bHYPRE::Vector x,
  /* out */double& d )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructParCSRVector::Axpy( /* in */double a,
...
// static constructor
::ucxx::bHYPRE::SStructParCSRVector
ucxx::bHYPRE::SStructParCSRVector::_create() {
  ::ucxx::bHYPRE::SStructParCSRVector self( (*_get_ext()->createObject)(),
    false );
  return self;
}

// copy constructor
ucxx::bHYPRE::SStructParCSRVector::SStructParCSRVector ( const 
  ::ucxx::bHYPRE::SStructParCSRVector& original ) {
  d_self = original._cast("bHYPRE.SStructParCSRVector");
...
// assignment operator
::ucxx::bHYPRE::SStructParCSRVector&
ucxx::bHYPRE::SStructParCSRVector::operator=( const 
  ::ucxx::bHYPRE::SStructParCSRVector& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("bHYPRE.SStructParCSRVector");
...
ucxx::bHYPRE::SStructParCSRVector::SStructParCSRVector ( 
  ::ucxx::bHYPRE::SStructParCSRVector::ior_t* ior ) 
...
ucxx::bHYPRE::SStructParCSRVector::SStructParCSRVector ( 
  ::ucxx::bHYPRE::SStructParCSRVector::ior_t* ior, bool isWeak ) : 
StubBase(reinterpret_cast< void*>(ior), isWeak){ 
}

// protected method that implements casting
void* ucxx::bHYPRE::SStructParCSRVector::_cast(const char* type) const
{
...
// Static data type
const ::ucxx::bHYPRE::SStructParCSRVector::ext_t * 
  ucxx::bHYPRE::SStructParCSRVector::s_ext = 0;

// private static method to get static data type
const ::ucxx::bHYPRE::SStructParCSRVector::ext_t *
ucxx::bHYPRE::SStructParCSRVector::_get_ext()
