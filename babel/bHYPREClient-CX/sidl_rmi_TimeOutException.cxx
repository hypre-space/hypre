// 
// File:          sidl_rmi_TimeOutException.cxx
...
#ifndef included_sidl_rmi_TimeOutException_hxx
#include "sidl_rmi_TimeOutException.hxx"
#endif
...
void
sidl::rmi::TimeOutException::throwException0(
...
sidl::rmi::TimeOutException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::rmi::TimeOutException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::rmi::TimeOutException
sidl::rmi::TimeOutException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_TimeOutException__remoteCreate( url.c_str(), &_exception 
    );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::rmi::TimeOutException( ior_self, false );
}

// remote connector
::sidl::rmi::TimeOutException
sidl::rmi::TimeOutException::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_TimeOutException__remoteConnect( url.c_str(), 
...
// copy constructor
sidl::rmi::TimeOutException::TimeOutException ( const 
  ::sidl::rmi::TimeOutException& original ) {
  d_self = (struct sidl_rmi_TimeOutException__object*) 
    original.::sidl::rmi::TimeOutException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::rmi::TimeOutException&
sidl::rmi::TimeOutException::operator=( const ::sidl::rmi::TimeOutException& 
  rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct sidl_rmi_TimeOutException__object*) 
      rhs.::sidl::rmi::TimeOutException::_get_ior();
    if(d_self) {
...
sidl::rmi::TimeOutException::TimeOutException ( 
  ::sidl::rmi::TimeOutException::ior_t* ior ) 
...
sidl::rmi::TimeOutException::TimeOutException ( 
  ::sidl::rmi::TimeOutException::ior_t* ior, bool isWeak ) : 
...
void ::sidl::rmi::TimeOutException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::rmi::TimeOutException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::rmi::TimeOutException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_rmi_TimeOutException__object*) 
    ::sidl::rmi::TimeOutException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::rmi::TimeOutException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_rmi_TimeOutException__object* sidl::rmi::TimeOutException::_cast(
  const void* src)
{
  ior_t* cast = NULL;
  ...
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.rmi.TimeOutException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::rmi::TimeOutException::ext_t * sidl::rmi::TimeOutException::s_ext 
  = 0;

// private static method to get static data type
const ::sidl::rmi::TimeOutException::ext_t *
sidl::rmi::TimeOutException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_rmi_TimeOutException__externals();
  }
  return s_ext;
}
