...
sidl::rmi::TimeOutException::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_TimeOutException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::TimeOutException::TimeOutException ( const 
  ...
  d_self = ::sidl::rmi::TimeOutException::_cast(original._get_ior());
...
sidl::rmi::TimeOutException::operator=( const ::sidl::rmi::TimeOutException& 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::TimeOutException::_cast(rhs._get_ior());
...
struct sidl_rmi_TimeOutException__object* 
  sidl::rmi::TimeOutException::_cast(const void* src)
{
  ior_t* cast = NULL;
