...
#define included_sidl_Finder_hxx
...
namespace sidl { 
   ...
   */
  class Finder: public virtual ::sidl::BaseInterface {
  ...
  public:
    typedef struct sidl_Finder__object ior_t;
    typedef struct sidl_Finder__external ext_t;
    ...
    // copy constructor
    Finder ( const Finder& original );

    // assignment operator
    Finder& operator= ( const Finder& rhs );

    // conversion from ior to C++ class
    Finder ( Finder::ior_t* ior );
    ...
    static inline const char * type_name() throw () { return "sidl.Finder";}

    static struct sidl_Finder__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::sidl::Finder > {
    typedef array< ::sidl::Finder > cxx_array_t;
    typedef ::sidl::Finder cxx_item_t;
    typedef struct sidl_Finder__array ior_array_t;
    typedef sidl_interface__array ior_array_internal_t;
    typedef struct sidl_Finder__object ior_item_t;
    typedef cxx_item_t value_type;
    typedef value_type reference;
    typedef value_type* pointer;
    typedef const value_type const_reference;
    typedef const value_type* const_pointer;
    typedef array_iter< array_traits< ::sidl::Finder > > iterator;
    typedef const_array_iter< array_traits< ::sidl::Finder > > const_iterator;
  };

  // array specialization
  template<>
  class array< ::sidl::Finder >: public interface_array< array_traits< 
    ::sidl::Finder > > {
  public:
    typedef interface_array< array_traits< ::sidl::Finder > > Base;
    typedef array_traits< ::sidl::Finder >::cxx_array_t          cxx_array_t;
    typedef array_traits< ::sidl::Finder >::cxx_item_t           cxx_item_t;
    typedef array_traits< ::sidl::Finder >::ior_array_t          ior_array_t;
    typedef array_traits< ::sidl::Finder >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::sidl::Finder >::ior_item_t           ior_item_t;

    /**
     * conversion from ior to C++ class
     * (constructor/casting operator)
     */
    array( struct sidl_Finder__array* src = 0) : Base(src) {}

    /**
     * copy constructor
     */
    array( const array< ::sidl::Finder >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::sidl::Finder >&
    operator =( const array< ::sidl::Finder >&rhs ) { 
