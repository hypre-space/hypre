...
// 
// babel-version = 0.10.12
// xml-url       = /home/painter/babel/share/babel-0.10.12/repository/sidl.BaseException-v0.9.3.xml
// 

#ifndef included_sidl_BaseException_hh
#define included_sidl_BaseException_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::sidl::BaseException >;
  }
...
namespace ucxx { 
  namespace sidl { 
     ...
     * traces.
     */
    class BaseException: public virtual ::ucxx::sidl::BaseInterface {
  ...
  public:
    ...
    static inline const char * type_name() { return "sidl.BaseException";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::sidl::BaseException > {
      typedef array< ::ucxx::sidl::BaseException > cxx_array_t;
      typedef ::ucxx::sidl::BaseException cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::sidl::BaseException > > 
        iterator;
      typedef const_array_iter< array_traits< ::ucxx::sidl::BaseException > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::sidl::BaseException >: public interface_array< 
      array_traits< ::ucxx::sidl::BaseException > > {
    public:
      typedef interface_array< array_traits< ::ucxx::sidl::BaseException > > 
        Base;
      typedef array_traits< ::ucxx::sidl::BaseException >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::sidl::BaseException >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::sidl::BaseException >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::sidl::BaseException >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::sidl::BaseException >::ior_item_t           
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::sidl::BaseException >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::sidl::BaseException >&
      operator =( const array< ::ucxx::sidl::BaseException >&rhs ) { 
