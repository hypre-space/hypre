 ...
 */
int32_t
bHYPRE::Euclid::SetParameters( /* in */int32_t argc,
 ...
 */
int32_t
bHYPRE::Euclid::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
 ...
 */
int32_t
bHYPRE::Euclid::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
 ...
 */
int32_t
bHYPRE::Euclid::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::Euclid::SetIntArray1Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::Euclid::SetIntArray2Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::Euclid::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
 ...
 */
int32_t
bHYPRE::Euclid::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
 ...
 */
int32_t
bHYPRE::Euclid::Apply( /* in */::bHYPRE::Vector b,
 ...
 */
int32_t
bHYPRE::Euclid::ApplyAdjoint( /* in */::bHYPRE::Vector b,
  /* inout */::bHYPRE::Vector& x )
...
bHYPRE::Euclid::_create(const std::string& url) {
  ...
  ior_self = bHYPRE_Euclid__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
bHYPRE::Euclid::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
  ior_self = bHYPRE_Euclid__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
    ; //TODO: handle exception
  }
  return ::bHYPRE::Euclid( ior_self, false );
...
bHYPRE::Euclid::Euclid ( const ::bHYPRE::Euclid& original ) {
  d_self = ::bHYPRE::Euclid::_cast(original._get_ior());
...
bHYPRE::Euclid::operator=( const ::bHYPRE::Euclid& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::Euclid::_cast(rhs._get_ior());
...
#else
    s_ext = (struct 
      bHYPRE_Euclid__external*)sidl_dynamicLoadIOR("bHYPRE.Euclid",
