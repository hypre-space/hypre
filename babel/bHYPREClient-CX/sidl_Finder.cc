 ...
 */
bool
ucxx::sidl::Finder::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()
...
ucxx::sidl::Finder::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::sidl::Finder::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::DLL
ucxx::sidl::Finder::findLibrary( /* in */const ::std::string& sidl_name,
...

{
  ...
  ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
    ...
    sidl_BaseInterface__object * > (d_self))->d_object, "sidl.Finder");
  /*pack args to dispatch to ior*/
  _result = ::ucxx::sidl::DLL( 
    (*(loc_self->d_epv->f_findLibrary))(loc_self->d_object,
 ...
 */
void
ucxx::sidl::Finder::setSearchPath( /* in */const ::std::string& path_name )
throw ()
 ...
 */
::std::string
ucxx::sidl::Finder::getSearchPath(  )
throw ()
 ...
 */
void
ucxx::sidl::Finder::addSearchPath( /* in */const ::std::string& path_fragment )
throw ()
...
// copy constructor
ucxx::sidl::Finder::Finder ( const ::ucxx::sidl::Finder& original ) {
  d_self = original._cast("sidl.Finder");
...
// assignment operator
::ucxx::sidl::Finder&
ucxx::sidl::Finder::operator=( const ::ucxx::sidl::Finder& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("sidl.Finder");
...
ucxx::sidl::Finder::Finder ( ::ucxx::sidl::Finder::ior_t* ior ) 
   : StubBase(reinterpret_cast< void*>(ior)) { }

// Alternate constructor: does not call addRef()
// (sets d_weak_reference=isWeak)
// For internal use by Impls (fixes bug#275)
ucxx::sidl::Finder::Finder ( ::ucxx::sidl::Finder::ior_t* ior, bool isWeak ) : 
StubBase(reinterpret_cast< void*>(ior), isWeak){ 
}

// protected method that implements casting
void* ucxx::sidl::Finder::_cast(const char* type) const
{
