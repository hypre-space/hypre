...
STUBHDRS = bHYPRE.hxx bHYPRE_BiCGSTAB.hxx bHYPRE_BoomerAMG.hxx                \
  ...
  bHYPRE_StructVectorView.hxx bHYPRE_Vector.hxx sidl.hxx sidl_BaseClass.hxx   \
  sidl_BaseException.hxx sidl_BaseInterface.hxx sidl_CastException.hxx        \
  sidl_ClassInfo.hxx sidl_ClassInfoI.hxx sidl_DFinder.hxx sidl_DLL.hxx        \
  sidl_Finder.hxx sidl_InvViolation.hxx sidl_LangSpecificException.hxx        \
  sidl_Loader.hxx sidl_MemoryAllocationException.hxx                          \
  sidl_NotImplementedException.hxx sidl_PostViolation.hxx                     \
  sidl_PreViolation.hxx sidl_Resolve.hxx sidl_RuntimeException.hxx            \
  sidl_SIDLException.hxx sidl_Scope.hxx sidl_io.hxx sidl_io_Deserializer.hxx  \
  sidl_io_IOException.hxx sidl_io_Serializable.hxx sidl_io_Serializer.hxx     \
  sidl_rmi.hxx sidl_rmi_BindException.hxx sidl_rmi_Call.hxx                   \
  sidl_rmi_ConnectException.hxx sidl_rmi_ConnectRegistry.hxx                  \
  sidl_rmi_InstanceHandle.hxx sidl_rmi_InstanceRegistry.hxx                   \
  sidl_rmi_Invocation.hxx sidl_rmi_MalformedURLException.hxx                  \
  sidl_rmi_NetworkException.hxx sidl_rmi_NoRouteToHostException.hxx           \
  sidl_rmi_NoServerException.hxx sidl_rmi_ObjectDoesNotExistException.hxx     \
  sidl_rmi_ProtocolException.hxx sidl_rmi_ProtocolFactory.hxx                 \
  sidl_rmi_Response.hxx sidl_rmi_Return.hxx sidl_rmi_ServerInfo.hxx           \
  sidl_rmi_ServerRegistry.hxx sidl_rmi_Ticket.hxx sidl_rmi_TicketBook.hxx     \
  sidl_rmi_TimeOutException.hxx sidl_rmi_UnexpectedCloseException.hxx         \
  sidl_rmi_UnknownHostException.hxx
