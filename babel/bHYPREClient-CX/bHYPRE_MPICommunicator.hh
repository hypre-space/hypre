// 
// File:          bHYPRE_MPICommunicator.hh
...
#define included_bHYPRE_MPICommunicator_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::bHYPRE::MPICommunicator >;
  }
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     * 
     */
    class MPICommunicator: public virtual ::ucxx::sidl::BaseClass {
  ...
  public:
     ...
     */
    static ::ucxx::bHYPRE::MPICommunicator
    CreateC (
      /* in */void* mpi_comm
    )
    throw () 
  ...
  public:
    ...
    // static constructor
    static ::ucxx::bHYPRE::MPICommunicator _create();
    ...
    static inline const char * type_name() { return "bHYPRE.MPICommunicator";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::MPICommunicator > {
      typedef array< ::ucxx::bHYPRE::MPICommunicator > cxx_array_t;
      typedef ::ucxx::bHYPRE::MPICommunicator cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::bHYPRE::MPICommunicator > > 
        iterator;
      typedef const_array_iter< array_traits< ::ucxx::bHYPRE::MPICommunicator > 
        > const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::MPICommunicator >: public interface_array< 
      array_traits< ::ucxx::bHYPRE::MPICommunicator > > {
    public:
      typedef interface_array< array_traits< ::ucxx::bHYPRE::MPICommunicator > 
        > Base;
      typedef array_traits< ::ucxx::bHYPRE::MPICommunicator >::cxx_array_t      
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::MPICommunicator >::cxx_item_t       
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::MPICommunicator >::ior_array_t      
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::MPICommunicator 
        >::ior_array_internal_t ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::MPICommunicator >::ior_item_t       
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::MPICommunicator >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::MPICommunicator >&
      operator =( const array< ::ucxx::bHYPRE::MPICommunicator >&rhs ) { 
