// 
// File:          bHYPRE_CoefficientAccess.cc
 ...
 */
bool
ucxx::bHYPRE::CoefficientAccess::isSame( /* in */::ucxx::sidl::BaseInterface 
  iobj )
throw ()
...
ucxx::bHYPRE::CoefficientAccess::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::bHYPRE::CoefficientAccess::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::bHYPRE::CoefficientAccess::getClassInfo(  )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::CoefficientAccess::GetRow( /* in */int32_t row,
...
// copy constructor
ucxx::bHYPRE::CoefficientAccess::CoefficientAccess ( const 
  ::ucxx::bHYPRE::CoefficientAccess& original ) {
  d_self = original._cast("bHYPRE.CoefficientAccess");
...
// assignment operator
::ucxx::bHYPRE::CoefficientAccess&
ucxx::bHYPRE::CoefficientAccess::operator=( const 
  ::ucxx::bHYPRE::CoefficientAccess& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("bHYPRE.CoefficientAccess");
...
ucxx::bHYPRE::CoefficientAccess::CoefficientAccess ( 
  ::ucxx::bHYPRE::CoefficientAccess::ior_t* ior ) 
...
ucxx::bHYPRE::CoefficientAccess::CoefficientAccess ( 
  ::ucxx::bHYPRE::CoefficientAccess::ior_t* ior, bool isWeak ) : 
StubBase(reinterpret_cast< void*>(ior), isWeak){ 
}

// protected method that implements casting
void* ucxx::bHYPRE::CoefficientAccess::_cast(const char* type) const
{
