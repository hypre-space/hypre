...
sidl_BaseException_addLine(_be, "Exception unserialized from sidl._Finder.addSearchPath.", &throwaway_exception);
  ...
  static void sidl__Finder__init_remote_epv(void)
  {
    ...
    e1->f_getClassInfo  = (struct sidl_ClassInfo__object* (*)(void*,struct 
      sidl_BaseInterface__object **)) epv->f_getClassInfo;
    e1->f_findLibrary   = (struct sidl_DLL__object* (*)(void*,const char*,const 
  ...
  sidl_Finder__remoteConnect(const char *url, sidl_bool ar, sidl_BaseInterface 
    *_ex)
  {
    struct sidl__Finder__object* self;
  ...
  static struct sidl_Finder__object*
  sidl_Finder__IHConnect(sidl_rmi_InstanceHandle instance, sidl_BaseInterface 
    *_ex)
  {
    struct sidl__Finder__object* self;
 ...
 */
::sidl::DLL
sidl::Finder::findLibrary( /* in */const ::std::string& sidl_name, /* in 
  */const ::std::string& target, /* in */::sidl::Scope lScope, /* in 
  */::sidl::Resolve lResolve )

{
  ::sidl::DLL _result;
  ior_t* const loc_self = (struct sidl_Finder__object*) 
    ::sidl::Finder::_get_ior();
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = ::sidl::DLL( (*(loc_self->d_epv->f_findLibrary))(loc_self->d_object,
    /* in */ sidl_name.c_str(), /* in */ target.c_str(), /* in */ (enum 
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  (*(loc_self->d_epv->f_setSearchPath))(loc_self->d_object, /* in */ 
    path_name.c_str(), &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  (*(loc_self->d_epv->f_addSearchPath))(loc_self->d_object, /* in */ 
    path_fragment.c_str(), &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
...
sidl::Finder::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_Finder__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
sidl::Finder::Finder ( const ::sidl::Finder& original ) {
  d_self = (struct sidl_Finder__object*) original.::sidl::Finder::_get_ior();
  sidl_Finder_IORCache = (ior_t*) d_self;
  if(d_self) {
    addRef();
  }
...
sidl::Finder::operator=( const ::sidl::Finder& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct sidl_Finder__object*) rhs.::sidl::Finder::_get_ior();
    sidl_Finder_IORCache = (ior_t*) d_self;
    if(d_self) {
      addRef();
    }
