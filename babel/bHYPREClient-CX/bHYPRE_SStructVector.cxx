 ...
 */
int32_t
bHYPRE::SStructVector::SetValues( /* in */int32_t part,
 ...
 */
int32_t
bHYPRE::SStructVector::SetBoxValues( /* in */int32_t part,
 ...
 */
int32_t
bHYPRE::SStructVector::AddToValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* index, /* in */int32_t dim, /* in */int32_t var,
  /* in */double value )
 ...
 */
int32_t
bHYPRE::SStructVector::AddToBoxValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* ilower, /* in rarray[dim] */int32_t* iupper,
  /* in */int32_t dim, /* in */int32_t var,
  /* in rarray[nvalues] */double* values, /* in */int32_t nvalues )
 ...
 */
int32_t
bHYPRE::SStructVector::GetValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* index, /* in */int32_t dim, /* in */int32_t var,
  /* out */double& value )
 ...
 */
int32_t
bHYPRE::SStructVector::GetBoxValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* ilower, /* in rarray[dim] */int32_t* iupper,
  /* in */int32_t dim, /* in */int32_t var,
 ...
 */
int32_t
bHYPRE::SStructVector::Print( /* in */const ::std::string& filename,
  /* in */int32_t all )
...
bHYPRE::SStructVector::_create(const std::string& url) {
  ...
  ior_self = bHYPRE_SStructVector__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
bHYPRE::SStructVector::SStructVector ( const ::bHYPRE::SStructVector& original 
  ...
  d_self = ::bHYPRE::SStructVector::_cast(original._get_ior());
...
bHYPRE::SStructVector::operator=( const ::bHYPRE::SStructVector& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::SStructVector::_cast(rhs._get_ior());
