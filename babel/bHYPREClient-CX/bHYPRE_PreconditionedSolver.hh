// 
// File:          bHYPRE_PreconditionedSolver.hh
...
#define included_bHYPRE_PreconditionedSolver_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::bHYPRE::PreconditionedSolver >;
  }
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     */
    class PreconditionedSolver: public virtual ::ucxx::bHYPRE::Solver {
  ...
  public:
    ...
    throw () 
    {
      ...
      ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
        ...
        "bHYPRE.PreconditionedSolver");
      /*pack args to dispatch to ior*/
      _result = (*(loc_self->d_epv->f_SetTolerance))(loc_self->d_object,
        /* in */ tolerance );
      /*dispatch to ior*/
      /*unpack results and cleanup*/
      return _result;
    ...
    throw () 
    {
      ...
      ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
        ...
        "bHYPRE.PreconditionedSolver");
      /*pack args to dispatch to ior*/
      _result = (*(loc_self->d_epv->f_SetMaxIterations))(loc_self->d_object,
        /* in */ max_iterations );
      /*dispatch to ior*/
      /*unpack results and cleanup*/
      return _result;
    ...
    throw () 
    {
      ...
      ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
        ...
        "bHYPRE.PreconditionedSolver");
      /*pack args to dispatch to ior*/
      _result = (*(loc_self->d_epv->f_SetLogging))(loc_self->d_object,
        /* in */ level );
      /*dispatch to ior*/
      /*unpack results and cleanup*/
      return _result;
    ...
    throw () 
    {
      ...
      ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
        ...
        "bHYPRE.PreconditionedSolver");
      /*pack args to dispatch to ior*/
      _result = (*(loc_self->d_epv->f_SetPrintLevel))(loc_self->d_object,
        /* in */ level );
      /*dispatch to ior*/
      /*unpack results and cleanup*/
      return _result;
    ...
    throw () 
    {
      ...
      ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
        ...
        "bHYPRE.PreconditionedSolver");
      /*pack args to dispatch to ior*/
      _result = (*(loc_self->d_epv->f_GetNumIterations))(loc_self->d_object,
        /* out */ &num_iterations );
      /*dispatch to ior*/
      /*unpack results and cleanup*/
      return _result;
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::PreconditionedSolver > {
      typedef array< ::ucxx::bHYPRE::PreconditionedSolver > cxx_array_t;
      typedef ::ucxx::bHYPRE::PreconditionedSolver cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::bHYPRE::PreconditionedSolver > 
        > iterator;
      typedef const_array_iter< array_traits< 
        ::ucxx::bHYPRE::PreconditionedSolver > > const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::PreconditionedSolver >: public 
      interface_array< array_traits< ::ucxx::bHYPRE::PreconditionedSolver > > {
    public:
      typedef interface_array< array_traits< 
        ::ucxx::bHYPRE::PreconditionedSolver > > Base;
      typedef array_traits< ::ucxx::bHYPRE::PreconditionedSolver >::cxx_array_t 
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::PreconditionedSolver >::cxx_item_t  
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::PreconditionedSolver >::ior_array_t 
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::PreconditionedSolver 
        >::ior_array_internal_t ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::PreconditionedSolver >::ior_item_t  
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::PreconditionedSolver >&src) : 
        Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::PreconditionedSolver >&
      operator =( const array< ::ucxx::bHYPRE::PreconditionedSolver >&rhs ) { 
