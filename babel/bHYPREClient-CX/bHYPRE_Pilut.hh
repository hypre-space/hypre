...
#define included_bHYPRE_Pilut_hh
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     * 
     */
    class Pilut: public virtual ::ucxx::bHYPRE::Solver,
  ...
  public:
    typedef struct bHYPRE_Pilut__object ior_t;
    typedef struct bHYPRE_Pilut__external ext_t;
    ...
    // static constructor
    static ::ucxx::bHYPRE::Pilut _create();

    // default destructor
    virtual ~Pilut () { }

    // copy constructor
    Pilut ( const Pilut& original );

    // assignment operator
    Pilut& operator= ( const Pilut& rhs );

    // conversion from ior to C++ class
    Pilut ( Pilut::ior_t* ior );
    ...
    static inline const char * type_name() { return "bHYPRE.Pilut";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::Pilut > {
      typedef array< ::ucxx::bHYPRE::Pilut > cxx_array_t;
      typedef ::ucxx::bHYPRE::Pilut cxx_item_t;
      typedef struct bHYPRE_Pilut__array ior_array_t;
      typedef sidl_interface__array ior_array_internal_t;
      typedef struct bHYPRE_Pilut__object ior_item_t;
      typedef cxx_item_t value_type;
      typedef value_type reference;
      typedef value_type* pointer;
      typedef const value_type const_reference;
      typedef const value_type* const_pointer;
      typedef array_iter< array_traits< ::ucxx::bHYPRE::Pilut > > iterator;
      typedef const_array_iter< array_traits< ::ucxx::bHYPRE::Pilut > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::Pilut >: public interface_array< array_traits< 
      ::ucxx::bHYPRE::Pilut > > {
    public:
      typedef interface_array< array_traits< ::ucxx::bHYPRE::Pilut > > Base;
      typedef array_traits< ::ucxx::bHYPRE::Pilut >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::Pilut >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::Pilut >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::Pilut >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::Pilut >::ior_item_t           
        ior_item_t;
       ...
       */
      array( struct bHYPRE_Pilut__array* src = 0) : Base(src) {}

      /**
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::Pilut >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::Pilut >&
      operator =( const array< ::ucxx::bHYPRE::Pilut >&rhs ) { 
