 ...
 */
void
sidl::SIDLException::add( /* in */const ::std::string& filename,
...
sidl::SIDLException::_create(const std::string& url) {
  ...
  ior_self = sidl_SIDLException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::SIDLException::SIDLException ( const ::sidl::SIDLException& original ) {
  d_self = ::sidl::SIDLException::_cast(original._get_ior());
...
sidl::SIDLException::operator=( const ::sidl::SIDLException& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::SIDLException::_cast(rhs._get_ior());
