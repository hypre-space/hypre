...
#define included_bHYPRE_GMRES_hxx
...
namespace bHYPRE { 
  ...
  public:
    ...
    // RMI constructor
    static ::bHYPRE::GMRES _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::GMRES _connect( /*in*/ const std::string& url ) { 
    ...
    static inline const char * type_name() throw () { return "bHYPRE.GMRES";}

    static struct bHYPRE_GMRES__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::GMRES > {
    typedef array< ::bHYPRE::GMRES > cxx_array_t;
    typedef ::bHYPRE::GMRES cxx_item_t;
    ...
    typedef array_iter< array_traits< ::bHYPRE::GMRES > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::GMRES > > const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::GMRES >: public interface_array< array_traits< 
    ::bHYPRE::GMRES > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::GMRES > > Base;
    typedef array_traits< ::bHYPRE::GMRES >::cxx_array_t          cxx_array_t;
    typedef array_traits< ::bHYPRE::GMRES >::cxx_item_t           cxx_item_t;
    typedef array_traits< ::bHYPRE::GMRES >::ior_array_t          ior_array_t;
    typedef array_traits< ::bHYPRE::GMRES >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::GMRES >::ior_item_t           ior_item_t;
     ...
     * copy constructor
     */
    array( const array< ::bHYPRE::GMRES >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::GMRES >&
    operator =( const array< ::bHYPRE::GMRES >&rhs ) { 
