// 
// File:          bHYPRE_SStructMatrixView.cc
 ...
 */
bool
ucxx::bHYPRE::SStructMatrixView::isSame( /* in */::ucxx::sidl::BaseInterface 
  iobj )
throw ()
...
ucxx::bHYPRE::SStructMatrixView::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::bHYPRE::SStructMatrixView::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::bHYPRE::SStructMatrixView::getClassInfo(  )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructMatrixView::SetCommunicator( /* in 
 ...
 */
int32_t
ucxx::bHYPRE::SStructMatrixView::GetObject( /* out 
 ...
 */
int32_t
ucxx::bHYPRE::SStructMatrixView::SetGraph( /* in */::ucxx::bHYPRE::SStructGraph 
  graph )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructMatrixView::SetValues( /* in */int32_t part,
 ...
 */
int32_t
ucxx::bHYPRE::SStructMatrixView::SetBoxValues( /* in */int32_t part,
 ...
 */
int32_t
ucxx::bHYPRE::SStructMatrixView::AddToValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* index, /* in */int32_t dim, /* in */int32_t var,
  /* in */int32_t nentries, /* in rarray[nentries] */int32_t* entries,
  /* in rarray[nentries] */double* values )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::SStructMatrixView::AddToBoxValues( /* in */int32_t part,
  /* in rarray[dim] */int32_t* ilower, /* in rarray[dim] */int32_t* iupper,
  /* in */int32_t dim, /* in */int32_t var, /* in */int32_t nentries,
  /* in rarray[nentries] */int32_t* entries,
  /* in rarray[nvalues] */double* values, /* in */int32_t nvalues )
 ...
 */
int32_t
ucxx::bHYPRE::SStructMatrixView::Print( /* in */const ::std::string& filename,
  /* in */int32_t all )
throw ()
...
// copy constructor
ucxx::bHYPRE::SStructMatrixView::SStructMatrixView ( const 
  ::ucxx::bHYPRE::SStructMatrixView& original ) {
  d_self = original._cast("bHYPRE.SStructMatrixView");
...
// assignment operator
::ucxx::bHYPRE::SStructMatrixView&
ucxx::bHYPRE::SStructMatrixView::operator=( const 
  ::ucxx::bHYPRE::SStructMatrixView& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("bHYPRE.SStructMatrixView");
...
ucxx::bHYPRE::SStructMatrixView::SStructMatrixView ( 
  ::ucxx::bHYPRE::SStructMatrixView::ior_t* ior ) 
...
ucxx::bHYPRE::SStructMatrixView::SStructMatrixView ( 
  ::ucxx::bHYPRE::SStructMatrixView::ior_t* ior, bool isWeak ) : 
StubBase(reinterpret_cast< void*>(ior), isWeak){ 
}

// protected method that implements casting
void* ucxx::bHYPRE::SStructMatrixView::_cast(const char* type) const
{
