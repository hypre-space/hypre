...
#define included_bHYPRE_Pilut_hxx
...
namespace bHYPRE { 
  ...
  public:
    ...
    // RMI constructor
    static ::bHYPRE::Pilut _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::Pilut _connect( /*in*/ const std::string& url ) { 
    ...
    static inline const char * type_name() throw () { return "bHYPRE.Pilut";}

    static struct bHYPRE_Pilut__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::Pilut > {
    typedef array< ::bHYPRE::Pilut > cxx_array_t;
    typedef ::bHYPRE::Pilut cxx_item_t;
    ...
    typedef array_iter< array_traits< ::bHYPRE::Pilut > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::Pilut > > const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::Pilut >: public interface_array< array_traits< 
    ::bHYPRE::Pilut > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::Pilut > > Base;
    typedef array_traits< ::bHYPRE::Pilut >::cxx_array_t          cxx_array_t;
    typedef array_traits< ::bHYPRE::Pilut >::cxx_item_t           cxx_item_t;
    typedef array_traits< ::bHYPRE::Pilut >::ior_array_t          ior_array_t;
    typedef array_traits< ::bHYPRE::Pilut >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::Pilut >::ior_item_t           ior_item_t;
     ...
     * copy constructor
     */
    array( const array< ::bHYPRE::Pilut >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::Pilut >&
    operator =( const array< ::bHYPRE::Pilut >&rhs ) { 
