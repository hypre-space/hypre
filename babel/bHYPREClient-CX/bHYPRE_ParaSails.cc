 ...
 */
::ucxx::bHYPRE::ParaSails
ucxx::bHYPRE::ParaSails::Create( /* in */::ucxx::bHYPRE::MPICommunicator 
  mpi_comm, /* in */::ucxx::bHYPRE::IJParCSRMatrix A )
throw ()

{
  ::ucxx::bHYPRE::ParaSails _result;
  ...
  _result = ::ucxx::bHYPRE::ParaSails( ( _get_sepv()->f_Create)( /* in */ 
 ...
 */
bool
ucxx::bHYPRE::ParaSails::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()
...
ucxx::bHYPRE::ParaSails::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::bHYPRE::ParaSails::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::bHYPRE::ParaSails::getClassInfo(  )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetCommunicator( /* in 
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetIntArray1Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetIntArray2Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetDoubleArray1Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetDoubleArray2Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::Setup( /* in */::ucxx::bHYPRE::Vector b,
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::Apply( /* in */::ucxx::bHYPRE::Vector b,
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::ApplyAdjoint( /* in */::ucxx::bHYPRE::Vector b,
  /* inout */::ucxx::bHYPRE::Vector& x )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::ParaSails::SetOperator( /* in */::ucxx::bHYPRE::Operator A )
throw ()
...
// static constructor
::ucxx::bHYPRE::ParaSails
ucxx::bHYPRE::ParaSails::_create() {
  ::ucxx::bHYPRE::ParaSails self( (*_get_ext()->createObject)(), false );
  return self;
}

// copy constructor
ucxx::bHYPRE::ParaSails::ParaSails ( const ::ucxx::bHYPRE::ParaSails& original 
  ) {
  d_self = original._cast("bHYPRE.ParaSails");
...
// assignment operator
::ucxx::bHYPRE::ParaSails&
ucxx::bHYPRE::ParaSails::operator=( const ::ucxx::bHYPRE::ParaSails& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("bHYPRE.ParaSails");
...
ucxx::bHYPRE::ParaSails::ParaSails ( ::ucxx::bHYPRE::ParaSails::ior_t* ior ) 
...
void* ucxx::bHYPRE::ParaSails::_cast(const char* type) const
{
...
// Static data type
const ::ucxx::bHYPRE::ParaSails::ext_t * ucxx::bHYPRE::ParaSails::s_ext = 0;

// private static method to get static data type
const ::ucxx::bHYPRE::ParaSails::ext_t *
ucxx::bHYPRE::ParaSails::_get_ext()
