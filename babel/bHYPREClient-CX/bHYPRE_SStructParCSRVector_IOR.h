...
struct bHYPRE_SStructParCSRVector__controls {
  int     use_hooks;
};
/*
...
bHYPRE_SStructParCSRVector__new(void* ddata,struct sidl_BaseInterface__object 
  ** _ex);
...
extern void bHYPRE_SStructParCSRVector__init(
  struct bHYPRE_SStructParCSRVector__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void bHYPRE_SStructParCSRVector__getEPVs(
  ...
  struct bHYPRE_SStructParCSRVector__epv 
    **s_arg_epv__bhypre_sstructparcsrvector,struct 
    bHYPRE_SStructParCSRVector__epv 
    **s_arg_epv_hooks__bhypre_sstructparcsrvector);
  extern void bHYPRE_SStructParCSRVector__fini(
    struct bHYPRE_SStructParCSRVector__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void bHYPRE_SStructParCSRVector__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct bHYPRE_MatrixVectorView__object* 
    skel_bHYPRE_SStructParCSRVector_fconnect_bHYPRE_MatrixVectorView(const 
  ...
  struct bHYPRE_ProblemDefinition__object* 
    skel_bHYPRE_SStructParCSRVector_fconnect_bHYPRE_ProblemDefinition(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_ProblemDefinition__object* 
  ...
  struct bHYPRE_SStructGrid__object* 
    skel_bHYPRE_SStructParCSRVector_fcast_bHYPRE_SStructGrid(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct bHYPRE_SStructMatrixVectorView__object* 
    skel_bHYPRE_SStructParCSRVector_fconnect_bHYPRE_SStructMatrixVectorView(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_SStructMatrixVectorView__object* 
    skel_bHYPRE_SStructParCSRVector_fcast_bHYPRE_SStructMatrixVectorView(void 
  ...
  struct bHYPRE_SStructVectorView__object* 
    skel_bHYPRE_SStructParCSRVector_fconnect_bHYPRE_SStructVectorView(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_SStructVectorView__object* 
  ...
  struct bHYPRE_Vector__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Vector__object* 
    skel_bHYPRE_SStructParCSRVector_fcast_bHYPRE_Vector(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseClass__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* 
    skel_bHYPRE_SStructParCSRVector_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_SStructParCSRVector_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_bHYPRE_SStructParCSRVector_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_SStructParCSRVector__remote{
    int d_refcount;
