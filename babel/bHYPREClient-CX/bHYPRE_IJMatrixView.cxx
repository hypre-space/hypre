 ...
 */
int32_t
bHYPRE::IJMatrixView::SetLocalRange( /* in */int32_t ilower,
  /* in */int32_t iupper, /* in */int32_t jlower, /* in */int32_t jupper )

{
  int32_t _result;
  ior_t* const loc_self = (ior_t*) 
    ::bHYPRE::IJMatrixView::_cast((void*)(_get_ior()));
 ...
 */
int32_t
bHYPRE::IJMatrixView::SetValues( /* in */int32_t nrows,
 ...
 */
int32_t
bHYPRE::IJMatrixView::AddToValues( /* in */int32_t nrows,
  /* in rarray[nrows] */int32_t* ncols, /* in rarray[nrows] */int32_t* rows,
  /* in rarray[nnonzeros] */int32_t* cols,
  /* in rarray[nnonzeros] */double* values, /* in */int32_t nnonzeros )
 ...
 */
int32_t
bHYPRE::IJMatrixView::GetLocalRange( /* out */int32_t& ilower,
...

{
  ...
  _result = (*(loc_self->d_epv->f_GetLocalRange))(loc_self->d_object,
    /* out */ &ilower, /* out */ &iupper, /* out */ &jlower, /* out */ &jupper,
    &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
 ...
 */
int32_t
bHYPRE::IJMatrixView::GetRowCounts( /* in */int32_t nrows,
 ...
 */
int32_t
bHYPRE::IJMatrixView::GetValues( /* in */int32_t nrows,
  /* in rarray[nrows] */int32_t* ncols, /* in rarray[nrows] */int32_t* rows,
  /* in rarray[nnonzeros] */int32_t* cols,
 ...
 */
int32_t
bHYPRE::IJMatrixView::SetRowSizes( /* in rarray[nrows] */int32_t* sizes,
  /* in */int32_t nrows )
 ...
 */
int32_t
bHYPRE::IJMatrixView::Read( /* in */const ::std::string& filename,
...
bHYPRE::IJMatrixView::IJMatrixView ( const ::bHYPRE::IJMatrixView& original ) {
  d_self = ::bHYPRE::IJMatrixView::_cast(original._get_ior());
...
bHYPRE::IJMatrixView::operator=( const ::bHYPRE::IJMatrixView& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::IJMatrixView::_cast(rhs._get_ior());
