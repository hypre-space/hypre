 ...
 */
int32_t
bHYPRE::BiCGSTAB::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
 ...
 */
int32_t
bHYPRE::BiCGSTAB::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
 ...
 */
int32_t
bHYPRE::BiCGSTAB::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::BiCGSTAB::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
 ...
 */
int32_t
bHYPRE::BiCGSTAB::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
 ...
 */
int32_t
bHYPRE::BiCGSTAB::Setup( /* in */::bHYPRE::Vector b,
  /* in */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::BiCGSTAB::Apply( /* in */::bHYPRE::Vector b,
 ...
 */
int32_t
bHYPRE::BiCGSTAB::ApplyAdjoint( /* in */::bHYPRE::Vector b,
  /* inout */::bHYPRE::Vector& x )
...
bHYPRE::BiCGSTAB::_create() {
  ...
  ::bHYPRE::BiCGSTAB self( (*_get_ext()->createObject)(NULL,&_exception),
    false );
  if (_exception) {
    void *_p;
    if ( (_p = (*(_exception->d_epv->f__cast))(_exception->d_object,
...
bHYPRE::BiCGSTAB::_create(const std::string& url) {
  ...
  ior_self = bHYPRE_BiCGSTAB__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
bHYPRE::BiCGSTAB::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
  ior_self = bHYPRE_BiCGSTAB__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
    ; //TODO: handle exception
  }
  return ::bHYPRE::BiCGSTAB( ior_self, false );
...
bHYPRE::BiCGSTAB::BiCGSTAB ( const ::bHYPRE::BiCGSTAB& original ) {
  d_self = ::bHYPRE::BiCGSTAB::_cast(original._get_ior());
...
bHYPRE::BiCGSTAB::operator=( const ::bHYPRE::BiCGSTAB& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::BiCGSTAB::_cast(rhs._get_ior());
