// 
// File:          bHYPRE_ProblemDefinition.cc
 ...
 */
bool
ucxx::bHYPRE::ProblemDefinition::isSame( /* in */::ucxx::sidl::BaseInterface 
  iobj )
throw ()
...
ucxx::bHYPRE::ProblemDefinition::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::bHYPRE::ProblemDefinition::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::bHYPRE::ProblemDefinition::getClassInfo(  )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::ProblemDefinition::SetCommunicator( /* in 
...
// copy constructor
ucxx::bHYPRE::ProblemDefinition::ProblemDefinition ( const 
  ::ucxx::bHYPRE::ProblemDefinition& original ) {
  d_self = original._cast("bHYPRE.ProblemDefinition");
...
// assignment operator
::ucxx::bHYPRE::ProblemDefinition&
ucxx::bHYPRE::ProblemDefinition::operator=( const 
  ::ucxx::bHYPRE::ProblemDefinition& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("bHYPRE.ProblemDefinition");
...
ucxx::bHYPRE::ProblemDefinition::ProblemDefinition ( 
  ::ucxx::bHYPRE::ProblemDefinition::ior_t* ior ) 
...
ucxx::bHYPRE::ProblemDefinition::ProblemDefinition ( 
  ::ucxx::bHYPRE::ProblemDefinition::ior_t* ior, bool isWeak ) : 
StubBase(reinterpret_cast< void*>(ior), isWeak){ 
}

// protected method that implements casting
void* ucxx::bHYPRE::ProblemDefinition::_cast(const char* type) const
{
