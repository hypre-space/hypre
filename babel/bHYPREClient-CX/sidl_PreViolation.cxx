...
void
sidl::PreViolation::throwException0(
...
// static constructor
::sidl::PreViolation
sidl::PreViolation::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::PreViolation self( (*_get_ext()->createObject)(NULL,&_exception), 
    false );
  if (_exception) {
...
// remote constructor
::sidl::PreViolation
sidl::PreViolation::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_PreViolation__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::PreViolation( ior_self, false );
}

// remote connector
::sidl::PreViolation
sidl::PreViolation::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_PreViolation__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
// copy constructor
sidl::PreViolation::PreViolation ( const ::sidl::PreViolation& original ) {
  d_self = (struct sidl_PreViolation__object*) 
    original.::sidl::PreViolation::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::PreViolation&
sidl::PreViolation::operator=( const ::sidl::PreViolation& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct sidl_PreViolation__object*) 
      rhs.::sidl::PreViolation::_get_ior();
    if(d_self) {
...
sidl::PreViolation::PreViolation ( ::sidl::PreViolation::ior_t* ior ) 
...
sidl::PreViolation::PreViolation ( ::sidl::PreViolation::ior_t* ior, bool 
  isWeak ) : 
...
void ::sidl::PreViolation::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::PreViolation::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::PreViolation::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_PreViolation__object*) 
    ::sidl::PreViolation::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::PreViolation::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_PreViolation__object* sidl::PreViolation::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.PreViolation", (
      void*)sidl_PreViolation__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.PreViolation", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::PreViolation::ext_t * sidl::PreViolation::s_ext = 0;

// private static method to get static data type
const ::sidl::PreViolation::ext_t *
sidl::PreViolation::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_PreViolation__externals();
  }
  return s_ext;
}
