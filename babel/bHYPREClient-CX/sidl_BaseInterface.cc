 ...
 */
bool
ucxx::sidl::BaseInterface::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()

{
  ...
  ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
    ...
    sidl_BaseInterface__object * > (d_self))->d_object, "sidl.BaseInterface");
...
ucxx::sidl::BaseInterface::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::sidl::BaseInterface::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::sidl::BaseInterface::getClassInfo(  )
throw ()
...
// copy constructor
ucxx::sidl::BaseInterface::BaseInterface ( const ::ucxx::sidl::BaseInterface& 
  original ) {
  d_self = original._cast("sidl.BaseInterface");
...
// assignment operator
::ucxx::sidl::BaseInterface&
ucxx::sidl::BaseInterface::operator=( const ::ucxx::sidl::BaseInterface& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("sidl.BaseInterface");
...
ucxx::sidl::BaseInterface::BaseInterface ( ::ucxx::sidl::BaseInterface::ior_t* 
  ior ) 
...
void* ucxx::sidl::BaseInterface::_cast(const char* type) const
{
