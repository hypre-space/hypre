...
#ifndef included_bHYPRE_ParaSails_hxx
#include "bHYPRE_ParaSails.hxx"
#endif
    ...
    const char* name, sidl_BaseInterface* _ex)
  {
    ...
    *_ex = NULL; /* default to no exception */
    ...
    if (!cmp0) {
      ...
      if (!cmp1) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = ((struct bHYPRE_ParaSails__object*)self);
        return cast;
      }
      else if (cmp1 < 0) {
...
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.ApplyAdjoint.", &throwaway_exception);
  ...
  bHYPRE_ParaSails__remoteCreate(const char *url, sidl_BaseInterface *_ex)
  {
    ...
    sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
      url, "bHYPRE.ParaSails", _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct bHYPRE_ParaSails__object*) malloc(
        sizeof(struct bHYPRE_ParaSails__object));
...
void
bHYPRE::ParaSails::throwException0(
 ...
 */
::bHYPRE::ParaSails
bHYPRE::ParaSails::Create( /* in */::bHYPRE::MPICommunicator mpi_comm, /* in 
  */::bHYPRE::IJParCSRMatrix A )

{
  ::bHYPRE::ParaSails _result;
  ...
  _result = ::bHYPRE::ParaSails( ( _get_sepv()->f_Create)( /* in */ 
 ...
 */
int32_t
bHYPRE::ParaSails::SetOperator( /* in */::bHYPRE::Operator A )

{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_ParaSails__object*) 
    ::bHYPRE::ParaSails::_get_ior();
 ...
 */
int32_t
bHYPRE::ParaSails::SetTolerance( /* in */double tolerance )
 ...
 */
int32_t
bHYPRE::ParaSails::SetMaxIterations( /* in */int32_t max_iterations )
 ...
 */
int32_t
bHYPRE::ParaSails::SetLogging( /* in */int32_t level )
 ...
 */
int32_t
bHYPRE::ParaSails::SetPrintLevel( /* in */int32_t level )
 ...
 */
int32_t
bHYPRE::ParaSails::GetNumIterations( /* out */int32_t& num_iterations )
 ...
 */
int32_t
bHYPRE::ParaSails::GetRelResidualNorm( /* out */double& norm )
 ...
 */
int32_t
bHYPRE::ParaSails::SetCommunicator( /* in */::bHYPRE::MPICommunicator mpi_comm )
 ...
 */
int32_t
bHYPRE::ParaSails::SetIntParameter( /* in */const ::std::string& name, /* in 
  */int32_t value )
 ...
 */
int32_t
bHYPRE::ParaSails::SetDoubleParameter( /* in */const ::std::string& name, /* in 
  */double value )
 ...
 */
int32_t
bHYPRE::ParaSails::SetStringParameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::ParaSails::SetIntArray1Parameter( /* in */const ::std::string& name, /* 
 ...
 */
int32_t
bHYPRE::ParaSails::SetIntArray2Parameter( /* in */const ::std::string& name, /* 
 ...
 */
int32_t
bHYPRE::ParaSails::SetDoubleArray1Parameter( /* in */const ::std::string& name, 
 ...
 */
int32_t
bHYPRE::ParaSails::SetDoubleArray2Parameter( /* in */const ::std::string& name, 
 ...
 */
int32_t
bHYPRE::ParaSails::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::ParaSails::GetDoubleValue( /* in */const ::std::string& name, /* out 
  */double& value )
 ...
 */
int32_t
bHYPRE::ParaSails::Setup( /* in */::bHYPRE::Vector b, /* in */::bHYPRE::Vector 
  x )
 ...
 */
int32_t
bHYPRE::ParaSails::Apply( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
 ...
 */
int32_t
bHYPRE::ParaSails::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
// static constructor
::bHYPRE::ParaSails
bHYPRE::ParaSails::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::bHYPRE::ParaSails self( (*_get_ext()->createObject)(NULL,&_exception), 
    false );
  if (_exception) {
    throwException0(_exception);
  }
...
::bHYPRE::ParaSails::ior_t*
bHYPRE::ParaSails::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::ParaSails::ior_t* returnValue = (*_get_ext()->createObject)(
...
// remote constructor
::bHYPRE::ParaSails
bHYPRE::ParaSails::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_ParaSails__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::bHYPRE::ParaSails( ior_self, false );
}

// remote connector
::bHYPRE::ParaSails
bHYPRE::ParaSails::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_ParaSails__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
// copy constructor
bHYPRE::ParaSails::ParaSails ( const ::bHYPRE::ParaSails& original ) {
  d_self = (struct bHYPRE_ParaSails__object*) 
    original.::bHYPRE::ParaSails::_get_ior();
  if(d_self) {
...
// assignment operator
::bHYPRE::ParaSails&
bHYPRE::ParaSails::operator=( const ::bHYPRE::ParaSails& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct bHYPRE_ParaSails__object*) 
      rhs.::bHYPRE::ParaSails::_get_ior();
    if(d_self) {
...
bHYPRE::ParaSails::ParaSails ( ::bHYPRE::ParaSails::ior_t* ior ) 
...
bHYPRE::ParaSails::ParaSails ( ::bHYPRE::ParaSails::ior_t* ior, bool isWeak ) : 
...
void ::bHYPRE::ParaSails::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::bHYPRE::ParaSails::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
void
bHYPRE::ParaSails::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
 ...
 */
void
bHYPRE::ParaSails::_set_hooks_static( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct bHYPRE_ParaSails__object* bHYPRE::ParaSails::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.ParaSails", (
      void*)bHYPRE_ParaSails__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "bHYPRE.ParaSails", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::bHYPRE::ParaSails::ext_t * bHYPRE::ParaSails::s_ext = 0;

// private static method to get static data type
const ::bHYPRE::ParaSails::ext_t *
bHYPRE::ParaSails::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
#ifdef SIDL_STATIC_LIBRARY
    s_ext = bHYPRE_ParaSails__externals();
#else
    s_ext = (struct bHYPRE_ParaSails__external*)sidl_dynamicLoadIOR(
      "bHYPRE.ParaSails","bHYPRE_ParaSails__externals") ;
#endif
    sidl_checkIORVersion("bHYPRE.ParaSails", s_ext->d_ior_major_version, 
