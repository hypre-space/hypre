...

{
  ...
  ior_t* const loc_self = (ior_t*) 
    ::bHYPRE::StructVectorView::_cast((void*)(_get_ior()));
...

{
  ...
  _result = (*(loc_self->d_epv->f_SetValue))(loc_self->d_object,
    /* in rarray[dim] */ grid_index_tmp, /* in */ value, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...

{
  ...
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_SetValue))(loc_self->d_object,
    /* in rarray[dim] */ grid_index._get_ior(), /* in */ value, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::StructVectorView::StructVectorView ( const ::bHYPRE::StructVectorView& 
  original ) {
  d_self = ::bHYPRE::StructVectorView::_cast(original._get_ior());
...
bHYPRE::StructVectorView::operator=( const ::bHYPRE::StructVectorView& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::StructVectorView::_cast(rhs._get_ior());
