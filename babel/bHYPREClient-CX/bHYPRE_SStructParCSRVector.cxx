...
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.SStructParCSRVector.Axpy.", &throwaway_exception);
  ...
  static void bHYPRE_SStructParCSRVector__init_remote_epv(void)
  {
    ...
    e4->f_Axpy         = (int32_t (*)(void*,double,struct 
...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_SStructParCSRVector__object*) 
    ::bHYPRE::SStructParCSRVector::_get_ior();
  struct bHYPRE_SStructGrid__object* _local_grid = (struct 
    bHYPRE_SStructGrid__object*) grid.::bHYPRE::SStructGrid::_get_ior();
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
 ...
 */
int32_t
bHYPRE::SStructParCSRVector::SetValues( /* in */int32_t part, /* in rarray[dim] 
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_SetValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ index_tmp, /* in */ var, /* in */ value, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
...

{
  ...
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_SetValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ index._get_ior(), /* in */ var, /* in */ value, &_exception 
    );
  /*dispatch to ior*/
  if (_exception != 0 ) {
 ...
 */
int32_t
bHYPRE::SStructParCSRVector::SetBoxValues( /* in */int32_t part, /* in 
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_SetBoxValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ ilower_tmp, /* in rarray[dim] */ iupper_tmp, /* in */ var, 
...

{
  ...
  _result = (*(loc_self->d_epv->f_SetBoxValues))(loc_self, /* in */ part, /* in 
    ...
    /* in */ var, /* in rarray[nvalues] */ values._get_ior(), &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
 ...
 */
int32_t
bHYPRE::SStructParCSRVector::AddToValues( /* in */int32_t part, /* in 
  rarray[dim] */int32_t* index, /* in */int32_t dim, /* in */int32_t var, /* in 
  */double value )

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_AddToValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ index_tmp, /* in */ var, /* in */ value, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    sidl__array_deleteRef((struct sidl__array *)index_tmp);
...
int32_t
bHYPRE::SStructParCSRVector::AddToValues( /* in */int32_t part, /* in 
  rarray[dim] */::sidl::array<int32_t> index, /* in */int32_t var, /* in 
  */double value )
 ...
 */
int32_t
bHYPRE::SStructParCSRVector::AddToBoxValues( /* in */int32_t part, /* in 
  rarray[dim] */int32_t* ilower, /* in rarray[dim] */int32_t* iupper, /* in 
  */int32_t dim, /* in */int32_t var, /* in rarray[nvalues] */double* values, 
  /* in */int32_t nvalues )

{
  ...
  _result = (*(loc_self->d_epv->f_AddToBoxValues))(loc_self, /* in */ part, /* 
    in rarray[dim] */ ilower_tmp, /* in rarray[dim] */ iupper_tmp, /* in */ var,
    /* in rarray[nvalues] */ values_tmp, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    sidl__array_deleteRef((struct sidl__array *)ilower_tmp);
 ...
 */
int32_t
bHYPRE::SStructParCSRVector::GetValues( /* in */int32_t part, /* in rarray[dim] 
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_GetValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ index_tmp, /* in */ var, /* out */ &value, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    sidl__array_deleteRef((struct sidl__array *)index_tmp);
...

{
  ...
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_GetValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ index._get_ior(), /* in */ var, /* out */ &value, 
    &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
 ...
 */
int32_t
bHYPRE::SStructParCSRVector::GetBoxValues( /* in */int32_t part, /* in 
  rarray[dim] */int32_t* ilower, /* in rarray[dim] */int32_t* iupper, /* in 
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_GetBoxValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ ilower_tmp, /* in rarray[dim] */ iupper_tmp, /* in */ var, 
...

{
  ...
  _result = (*(loc_self->d_epv->f_GetBoxValues))(loc_self, /* in */ part, /* in 
    rarray[dim] */ ilower._get_ior(), /* in rarray[dim] */ iupper._get_ior(), 
    /* in */ var, /* inout rarray[nvalues] */ &_local_values, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
 ...
 */
void
bHYPRE::SStructParCSRVector::Destroy(  )
 ...
 */
int32_t
bHYPRE::SStructParCSRVector::Dot( /* in */::bHYPRE::Vector x, /* out */double& 
  d )
 ...
 */
int32_t
bHYPRE::SStructParCSRVector::Axpy( /* in */double a, /* in */::bHYPRE::Vector x 
  )
...
bHYPRE::SStructParCSRVector::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::SStructParCSRVector::ior_t* returnValue = (*_get_ext(
...
bHYPRE::SStructParCSRVector::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_SStructParCSRVector__remoteCreate( url.c_str(), &_exception 
    );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::SStructParCSRVector::SStructParCSRVector ( const 
  ...
  d_self = (struct bHYPRE_SStructParCSRVector__object*) 
    original.::bHYPRE::SStructParCSRVector::_get_ior();
  if(d_self) {

    bHYPRE_SStructMatrixVectorView_IORCache = &((*reinterpret_cast< ior_t*>(
      d_self)).d_bhypre_sstructmatrixvectorview);
    ...
    bHYPRE_SStructVectorView_IORCache = &((*reinterpret_cast< ior_t*>(
      d_self)).d_bhypre_sstructvectorview);
...
bHYPRE::SStructParCSRVector::operator=( const ::bHYPRE::SStructParCSRVector& 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_SStructParCSRVector__object*) 
      rhs.::bHYPRE::SStructParCSRVector::_get_ior();
    if(d_self) {
...
struct bHYPRE_SStructParCSRVector__object* bHYPRE::SStructParCSRVector::_cast(
  const void* src)
{
  ior_t* cast = NULL;
...
#else
    s_ext = (struct bHYPRE_SStructParCSRVector__external*)sidl_dynamicLoadIOR(
      "bHYPRE.SStructParCSRVector","bHYPRE_SStructParCSRVector__externals") ;
#endif
    sidl_checkIORVersion("bHYPRE.SStructParCSRVector", 
      s_ext->d_ior_major_version, s_ext->d_ior_minor_version, 1, 0);
  }
  return s_ext;
}
