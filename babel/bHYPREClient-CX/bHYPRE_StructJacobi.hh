...
#define included_bHYPRE_StructJacobi_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::bHYPRE::StructJacobi >;
  }
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     * 
     */
    class StructJacobi: public virtual ::ucxx::bHYPRE::Solver,
  ...
  public:
     ...
     */
    static ::ucxx::bHYPRE::StructJacobi
    Create (
  ...
  public:
    ...
    // static constructor
    static ::ucxx::bHYPRE::StructJacobi _create();
    ...
    static inline const char * type_name() { return "bHYPRE.StructJacobi";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::StructJacobi > {
      typedef array< ::ucxx::bHYPRE::StructJacobi > cxx_array_t;
      typedef ::ucxx::bHYPRE::StructJacobi cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::bHYPRE::StructJacobi > > 
        iterator;
      typedef const_array_iter< array_traits< ::ucxx::bHYPRE::StructJacobi > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::StructJacobi >: public interface_array< 
      array_traits< ::ucxx::bHYPRE::StructJacobi > > {
    public:
      typedef interface_array< array_traits< ::ucxx::bHYPRE::StructJacobi > > 
        Base;
      typedef array_traits< ::ucxx::bHYPRE::StructJacobi >::cxx_array_t         
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::StructJacobi >::cxx_item_t          
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::StructJacobi >::ior_array_t         
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::StructJacobi 
        >::ior_array_internal_t ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::StructJacobi >::ior_item_t          
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::StructJacobi >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::StructJacobi >&
      operator =( const array< ::ucxx::bHYPRE::StructJacobi >&rhs ) { 
