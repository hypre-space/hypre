// 
// File:          bHYPRE_SStructParCSRMatrix.hxx
...
#define included_bHYPRE_SStructParCSRMatrix_hxx
...
namespace bHYPRE { 
  ...
  class SStructParCSRMatrix;
} // end namespace bHYPRE

// Some compilers need to define array template before the specializations
namespace sidl {
  template<>
  class array< ::bHYPRE::SStructParCSRMatrix >;
}
// 
...
namespace bHYPRE { 
   ...
   */
  class SStructParCSRMatrix: public virtual ::bHYPRE::Operator,
  ...
  public:
     ...
     */
    static ::bHYPRE::SStructParCSRMatrix
    Create (
  ...
  public:
    typedef struct bHYPRE_SStructParCSRMatrix__object ior_t;
    typedef struct bHYPRE_SStructParCSRMatrix__external ext_t;
    typedef struct bHYPRE_SStructParCSRMatrix__sepv sepv_t;

    // default constructor
    SStructParCSRMatrix() { }

    // static constructor
    static ::bHYPRE::SStructParCSRMatrix _create();

    // RMI constructor
    static ::bHYPRE::SStructParCSRMatrix _create( /*in*/ const std::string& url 
      );

    // RMI connect
    static inline ::bHYPRE::SStructParCSRMatrix _connect( /*in*/ const 
      std::string& url ) { 
      return _connect(url, true);
    }

    // RMI connect 2
    static ::bHYPRE::SStructParCSRMatrix _connect( /*in*/ const std::string& 
      url, /*in*/ const bool ar  );

    // default destructor
    virtual ~SStructParCSRMatrix () { }

    // copy constructor
    SStructParCSRMatrix ( const SStructParCSRMatrix& original );

    // assignment operator
    SStructParCSRMatrix& operator= ( const SStructParCSRMatrix& rhs );
    ...
    SStructParCSRMatrix ( SStructParCSRMatrix::ior_t* ior );

    // Alternate constructor: does not call addRef()
    // (sets d_weak_reference=isWeak)
    // For internal use by Impls (fixes bug#275)
    SStructParCSRMatrix ( SStructParCSRMatrix::ior_t* ior, bool isWeak );
    ...
    static struct bHYPRE_SStructParCSRMatrix__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::SStructParCSRMatrix > {
    typedef array< ::bHYPRE::SStructParCSRMatrix > cxx_array_t;
    typedef ::bHYPRE::SStructParCSRMatrix cxx_item_t;
    typedef struct bHYPRE_SStructParCSRMatrix__array ior_array_t;
    typedef sidl_interface__array ior_array_internal_t;
    typedef struct bHYPRE_SStructParCSRMatrix__object ior_item_t;
    typedef cxx_item_t value_type;
    typedef value_type reference;
    typedef value_type* pointer;
    typedef const value_type const_reference;
    typedef const value_type* const_pointer;
    typedef array_iter< array_traits< ::bHYPRE::SStructParCSRMatrix > > 
      iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::SStructParCSRMatrix > > 
      const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::SStructParCSRMatrix >: public interface_array< 
    array_traits< ::bHYPRE::SStructParCSRMatrix > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::SStructParCSRMatrix > > 
      Base;
    typedef array_traits< ::bHYPRE::SStructParCSRMatrix >::cxx_array_t          
      cxx_array_t;
    typedef array_traits< ::bHYPRE::SStructParCSRMatrix >::cxx_item_t           
      cxx_item_t;
    typedef array_traits< ::bHYPRE::SStructParCSRMatrix >::ior_array_t          
      ior_array_t;
    typedef array_traits< ::bHYPRE::SStructParCSRMatrix >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::SStructParCSRMatrix >::ior_item_t           
      ior_item_t;
     ...
     */
    array( struct bHYPRE_SStructParCSRMatrix__array* src = 0) : Base(src) {}

    /**
     * copy constructor
     */
    array( const array< ::bHYPRE::SStructParCSRMatrix >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::SStructParCSRMatrix >&
    operator =( const array< ::bHYPRE::SStructParCSRMatrix >&rhs ) { 
