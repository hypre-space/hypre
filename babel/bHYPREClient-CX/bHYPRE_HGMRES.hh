...
#define included_bHYPRE_HGMRES_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::bHYPRE::HGMRES >;
  }
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     */
    class HGMRES: public virtual ::ucxx::bHYPRE::PreconditionedSolver,
  ...
  public:
    ...
    // static constructor
    static ::ucxx::bHYPRE::HGMRES _create();
    ...
    static inline const char * type_name() { return "bHYPRE.HGMRES";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::HGMRES > {
      typedef array< ::ucxx::bHYPRE::HGMRES > cxx_array_t;
      typedef ::ucxx::bHYPRE::HGMRES cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::bHYPRE::HGMRES > > iterator;
      typedef const_array_iter< array_traits< ::ucxx::bHYPRE::HGMRES > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::HGMRES >: public interface_array< 
      array_traits< ::ucxx::bHYPRE::HGMRES > > {
    public:
      typedef interface_array< array_traits< ::ucxx::bHYPRE::HGMRES > > Base;
      typedef array_traits< ::ucxx::bHYPRE::HGMRES >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::HGMRES >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::HGMRES >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::HGMRES >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::HGMRES >::ior_item_t           
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::HGMRES >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::HGMRES >&
      operator =( const array< ::ucxx::bHYPRE::HGMRES >&rhs ) { 
