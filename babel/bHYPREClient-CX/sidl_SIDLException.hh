...
#define included_sidl_SIDLException_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::sidl::SIDLException >;
  }
...
namespace ucxx { 
  namespace sidl { 
     ...
     */
    class SIDLException: public virtual ::ucxx::sidl::BaseClass,
      public virtual ::ucxx::sidl::BaseException {
  ...
  public:
    ...
    // static constructor
    static ::ucxx::sidl::SIDLException _create();
    ...
    static inline const char * type_name() { return "sidl.SIDLException";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::sidl::SIDLException > {
      typedef array< ::ucxx::sidl::SIDLException > cxx_array_t;
      typedef ::ucxx::sidl::SIDLException cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::sidl::SIDLException > > 
        iterator;
      typedef const_array_iter< array_traits< ::ucxx::sidl::SIDLException > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::sidl::SIDLException >: public interface_array< 
      array_traits< ::ucxx::sidl::SIDLException > > {
    public:
      typedef interface_array< array_traits< ::ucxx::sidl::SIDLException > > 
        Base;
      typedef array_traits< ::ucxx::sidl::SIDLException >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::sidl::SIDLException >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::sidl::SIDLException >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::sidl::SIDLException >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::sidl::SIDLException >::ior_item_t           
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::sidl::SIDLException >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::sidl::SIDLException >&
      operator =( const array< ::ucxx::sidl::SIDLException >&rhs ) { 
