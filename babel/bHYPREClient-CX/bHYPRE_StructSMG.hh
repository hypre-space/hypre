...
#define included_bHYPRE_StructSMG_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::bHYPRE::StructSMG >;
  }
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     * 
     */
    class StructSMG: public virtual ::ucxx::bHYPRE::Solver,
  ...
  public:
    typedef struct bHYPRE_StructSMG__object ior_t;
    typedef struct bHYPRE_StructSMG__external ext_t;
    ...
    // static constructor
    static ::ucxx::bHYPRE::StructSMG _create();

    // default destructor
    virtual ~StructSMG () { }

    // copy constructor
    StructSMG ( const StructSMG& original );

    // assignment operator
    StructSMG& operator= ( const StructSMG& rhs );

    // conversion from ior to C++ class
    StructSMG ( StructSMG::ior_t* ior );
    ...
    static inline const char * type_name() { return "bHYPRE.StructSMG";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::StructSMG > {
      typedef array< ::ucxx::bHYPRE::StructSMG > cxx_array_t;
      typedef ::ucxx::bHYPRE::StructSMG cxx_item_t;
      typedef struct bHYPRE_StructSMG__array ior_array_t;
      typedef sidl_interface__array ior_array_internal_t;
      typedef struct bHYPRE_StructSMG__object ior_item_t;
      typedef cxx_item_t value_type;
      typedef value_type reference;
      typedef value_type* pointer;
      typedef const value_type const_reference;
      typedef const value_type* const_pointer;
      typedef array_iter< array_traits< ::ucxx::bHYPRE::StructSMG > > iterator;
      typedef const_array_iter< array_traits< ::ucxx::bHYPRE::StructSMG > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::StructSMG >: public interface_array< 
      array_traits< ::ucxx::bHYPRE::StructSMG > > {
    public:
      typedef interface_array< array_traits< ::ucxx::bHYPRE::StructSMG > > Base;
      typedef array_traits< ::ucxx::bHYPRE::StructSMG >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::StructSMG >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::StructSMG >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::StructSMG >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::StructSMG >::ior_item_t           
        ior_item_t;
       ...
       */
      array( struct bHYPRE_StructSMG__array* src = 0) : Base(src) {}

      /**
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::StructSMG >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::StructSMG >&
      operator =( const array< ::ucxx::bHYPRE::StructSMG >&rhs ) { 
