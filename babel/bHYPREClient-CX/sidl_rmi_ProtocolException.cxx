...
sidl::rmi::ProtocolException::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_ProtocolException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::ProtocolException::ProtocolException ( const 
  ...
  d_self = ::sidl::rmi::ProtocolException::_cast(original._get_ior());
...
sidl::rmi::ProtocolException::operator=( const ::sidl::rmi::ProtocolException& 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::ProtocolException::_cast(rhs._get_ior());
...
struct sidl_rmi_ProtocolException__object* 
  sidl::rmi::ProtocolException::_cast(const void* src)
{
  ior_t* cast = NULL;
