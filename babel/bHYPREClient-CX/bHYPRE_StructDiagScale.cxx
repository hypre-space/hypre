...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_StructDiagScale__object*) 
    ::bHYPRE::StructDiagScale::_get_ior();
 ...
 */
int32_t
bHYPRE::StructDiagScale::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::StructDiagScale::Setup( /* in */::bHYPRE::Vector b, /* in 
  */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::StructDiagScale::Apply( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
 ...
 */
int32_t
bHYPRE::StructDiagScale::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::StructDiagScale::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::StructDiagScale::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::StructDiagScale::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_StructDiagScale__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::StructDiagScale::StructDiagScale ( const ::bHYPRE::StructDiagScale& 
  original ) {
  d_self = (struct bHYPRE_StructDiagScale__object*) 
    original.::bHYPRE::StructDiagScale::_get_ior();
  if(d_self) {
...
bHYPRE::StructDiagScale::operator=( const ::bHYPRE::StructDiagScale& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_StructDiagScale__object*) 
      rhs.::bHYPRE::StructDiagScale::_get_ior();
    if(d_self) {
...
#else
    s_ext = (struct bHYPRE_StructDiagScale__external*)sidl_dynamicLoadIOR(
