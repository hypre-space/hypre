...
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi._InstanceHandle.close.", &throwaway_exception);
  ...
  static void sidl_rmi__InstanceHandle__init_remote_epv(void)
  {
    ...
    e1->f_createInvocation = (struct sidl_rmi_Invocation__object* (*)(void*,
      const char*,
      struct sidl_BaseInterface__object **)) epv->f_createInvocation;
 ...
 */
bool
sidl::rmi::InstanceHandle::initCreate( /* in */const ::std::string& url,
  /* in */const ::std::string& typeName )

{
  bool _result;
  ior_t* const loc_self = (ior_t*) 
    ::sidl::rmi::InstanceHandle::_cast((void*)(_get_ior()));
 ...
 */
bool
sidl::rmi::InstanceHandle::initConnect( /* in */const ::std::string& url,
  /* in */bool ar )

{
  ...
  _local_result = (*(loc_self->d_epv->f_initConnect))(loc_self->d_object,
    /* in */ url.c_str(), /* in */ _local_ar, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = ::sidl::io::Serializable( 
    (*(loc_self->d_epv->f_initUnserialize))(loc_self->d_object,
...
sidl::rmi::InstanceHandle::InstanceHandle ( const ::sidl::rmi::InstanceHandle& 
  original ) {
  d_self = ::sidl::rmi::InstanceHandle::_cast(original._get_ior());
...
sidl::rmi::InstanceHandle::operator=( const ::sidl::rmi::InstanceHandle& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::InstanceHandle::_cast(rhs._get_ior());
