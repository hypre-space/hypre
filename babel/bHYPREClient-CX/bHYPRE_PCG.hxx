...
#define included_bHYPRE_PCG_hxx
...
namespace bHYPRE { 
   ...
   */
  class PCG: public virtual ::bHYPRE::PreconditionedSolver, public virtual 
    ::sidl::BaseClass {
  ...
  public:
    typedef struct bHYPRE_PCG__object ior_t;
    typedef struct bHYPRE_PCG__external ext_t;
    typedef struct bHYPRE_PCG__sepv sepv_t;
    ...
    // static constructor
    static ::bHYPRE::PCG _create();

    // RMI constructor
    static ::bHYPRE::PCG _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::PCG _connect( /*in*/ const std::string& url ) { 
      return _connect(url, true);
    }

    // RMI connect 2
    static ::bHYPRE::PCG _connect( /*in*/ const std::string& url, /*in*/ const 
      bool ar  );
    ...
    static inline const char * type_name() throw () { return "bHYPRE.PCG";}

    static struct bHYPRE_PCG__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::PCG > {
    typedef array< ::bHYPRE::PCG > cxx_array_t;
    typedef ::bHYPRE::PCG cxx_item_t;
    typedef struct bHYPRE_PCG__array ior_array_t;
    typedef sidl_interface__array ior_array_internal_t;
    typedef struct bHYPRE_PCG__object ior_item_t;
    typedef cxx_item_t value_type;
    typedef value_type reference;
    typedef value_type* pointer;
    typedef const value_type const_reference;
    typedef const value_type* const_pointer;
    typedef array_iter< array_traits< ::bHYPRE::PCG > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::PCG > > const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::PCG >: public interface_array< array_traits< 
    ::bHYPRE::PCG > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::PCG > > Base;
    typedef array_traits< ::bHYPRE::PCG >::cxx_array_t          cxx_array_t;
    typedef array_traits< ::bHYPRE::PCG >::cxx_item_t           cxx_item_t;
    typedef array_traits< ::bHYPRE::PCG >::ior_array_t          ior_array_t;
    typedef array_traits< ::bHYPRE::PCG >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::PCG >::ior_item_t           ior_item_t;

    /**
     * conversion from ior to C++ class
     * (constructor/casting operator)
     */
    array( struct bHYPRE_PCG__array* src = 0) : Base(src) {}

    /**
     * copy constructor
     */
    array( const array< ::bHYPRE::PCG >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::PCG >&
    operator =( const array< ::bHYPRE::PCG >&rhs ) { 
