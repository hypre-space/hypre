...
sidl::rmi::UnknownHostException::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_UnknownHostException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
// remote connector 2
::sidl::rmi::UnknownHostException
sidl::rmi::UnknownHostException::_connect(const std::string& url,
  const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
...
sidl::rmi::UnknownHostException::UnknownHostException ( const 
  ...
  d_self = ::sidl::rmi::UnknownHostException::_cast(original._get_ior());
...
sidl::rmi::UnknownHostException::operator=( const 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::UnknownHostException::_cast(rhs._get_ior());
