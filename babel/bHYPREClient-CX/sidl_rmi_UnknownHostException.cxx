// 
// File:          sidl_rmi_UnknownHostException.cxx
...
#include "sidl_rmi_UnknownHostException.hxx"
#endif
...
void
sidl::rmi::UnknownHostException::throwException0(
...
sidl::rmi::UnknownHostException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::rmi::UnknownHostException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::rmi::UnknownHostException
sidl::rmi::UnknownHostException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_UnknownHostException__remoteCreate( url.c_str(), 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::rmi::UnknownHostException( ior_self, false );
}

// remote connector
::sidl::rmi::UnknownHostException
sidl::rmi::UnknownHostException::_connect(const std::string& url, const bool ar 
  ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_UnknownHostException__remoteConnect( url.c_str(), 
...
// copy constructor
sidl::rmi::UnknownHostException::UnknownHostException ( const 
  ::sidl::rmi::UnknownHostException& original ) {
  d_self = (struct sidl_rmi_UnknownHostException__object*) 
    original.::sidl::rmi::UnknownHostException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::rmi::UnknownHostException&
sidl::rmi::UnknownHostException::operator=( const 
  ::sidl::rmi::UnknownHostException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct sidl_rmi_UnknownHostException__object*) 
      rhs.::sidl::rmi::UnknownHostException::_get_ior();
    if(d_self) {
...
sidl::rmi::UnknownHostException::UnknownHostException ( 
  ::sidl::rmi::UnknownHostException::ior_t* ior ) 
...
sidl::rmi::UnknownHostException::UnknownHostException ( 
  ::sidl::rmi::UnknownHostException::ior_t* ior, bool isWeak ) : 
...
void ::sidl::rmi::UnknownHostException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::rmi::UnknownHostException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::rmi::UnknownHostException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_rmi_UnknownHostException__object*) 
    ::sidl::rmi::UnknownHostException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::rmi::UnknownHostException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_rmi_UnknownHostException__object* 
  sidl::rmi::UnknownHostException::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.UnknownHostException", (
      void*)sidl_rmi_UnknownHostException__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.rmi.UnknownHostException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::rmi::UnknownHostException::ext_t * 
  sidl::rmi::UnknownHostException::s_ext = 0;

// private static method to get static data type
const ::sidl::rmi::UnknownHostException::ext_t *
sidl::rmi::UnknownHostException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_rmi_UnknownHostException__externals();
  }
  return s_ext;
}
