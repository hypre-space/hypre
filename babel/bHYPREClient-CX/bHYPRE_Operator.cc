 ...
 */
bool
ucxx::bHYPRE::Operator::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()

{
  ...
  ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
    ...
    sidl_BaseInterface__object * > (d_self))->d_object, "bHYPRE.Operator");
...
ucxx::bHYPRE::Operator::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::bHYPRE::Operator::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::bHYPRE::Operator::getClassInfo(  )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::Operator::SetCommunicator( /* in 
 ...
 */
int32_t
ucxx::bHYPRE::Operator::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::Operator::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::Operator::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
ucxx::bHYPRE::Operator::SetIntArray1Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::Operator::SetIntArray2Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::Operator::SetDoubleArray1Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::Operator::SetDoubleArray2Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::Operator::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::Operator::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::Operator::Setup( /* in */::ucxx::bHYPRE::Vector b,
 ...
 */
int32_t
ucxx::bHYPRE::Operator::Apply( /* in */::ucxx::bHYPRE::Vector b,
 ...
 */
int32_t
ucxx::bHYPRE::Operator::ApplyAdjoint( /* in */::ucxx::bHYPRE::Vector b,
  /* inout */::ucxx::bHYPRE::Vector& x )
throw ()
...
// copy constructor
ucxx::bHYPRE::Operator::Operator ( const ::ucxx::bHYPRE::Operator& original ) {
  d_self = original._cast("bHYPRE.Operator");
...
// assignment operator
::ucxx::bHYPRE::Operator&
ucxx::bHYPRE::Operator::operator=( const ::ucxx::bHYPRE::Operator& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("bHYPRE.Operator");
...
ucxx::bHYPRE::Operator::Operator ( ::ucxx::bHYPRE::Operator::ior_t* ior ) 
...
void* ucxx::bHYPRE::Operator::_cast(const char* type) const
{
