  ...
  namespace io { 
    ...
    public:
      ...
      inline ior_t* _get_ior() const throw() {
        if(!sidl_io_Deserializer_IORCache) { 
          sidl_io_Deserializer_IORCache = ::sidl::io::Deserializer::_cast((
            void*)d_self);
          if (sidl_io_Deserializer_IORCache) {
            struct sidl_BaseInterface__object *throwaway_exception;
            (sidl_io_Deserializer_IORCache->d_epv->f_deleteRef)(
              sidl_io_Deserializer_IORCache->d_object, &throwaway_exception);  
          }  
        }
        return sidl_io_Deserializer_IORCache;
      }
    ...
    protected:
      mutable ior_t* sidl_io_Deserializer_IORCache;
