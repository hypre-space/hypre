...
#define included_bHYPRE_Hybrid_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::bHYPRE::Hybrid >;
  }
...
namespace ucxx { 
  namespace bHYPRE { 
     ...
     * 
     */
    class Hybrid: public virtual ::ucxx::bHYPRE::Solver,
  ...
  public:
    ...
    int32_t
    GetFirstSolver (
      /* out */::ucxx::bHYPRE::PreconditionedSolver& FirstSolver
    )
    throw () 
    ;
    ...
    int32_t
    GetSecondSolver (
      /* out */::ucxx::bHYPRE::PreconditionedSolver& SecondSolver
    )
    throw () 
    ;
  ...
  public:
    ...
    // static constructor
    static ::ucxx::bHYPRE::Hybrid _create();
    ...
    static inline const char * type_name() { return "bHYPRE.Hybrid";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::bHYPRE::Hybrid > {
      typedef array< ::ucxx::bHYPRE::Hybrid > cxx_array_t;
      typedef ::ucxx::bHYPRE::Hybrid cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::bHYPRE::Hybrid > > iterator;
      typedef const_array_iter< array_traits< ::ucxx::bHYPRE::Hybrid > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::bHYPRE::Hybrid >: public interface_array< 
      array_traits< ::ucxx::bHYPRE::Hybrid > > {
    public:
      typedef interface_array< array_traits< ::ucxx::bHYPRE::Hybrid > > Base;
      typedef array_traits< ::ucxx::bHYPRE::Hybrid >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::bHYPRE::Hybrid >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::bHYPRE::Hybrid >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::bHYPRE::Hybrid >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::bHYPRE::Hybrid >::ior_item_t           
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::bHYPRE::Hybrid >&src) : Base(src) {}

      /**
       * assignment
       */
      array< ::ucxx::bHYPRE::Hybrid >&
      operator =( const array< ::ucxx::bHYPRE::Hybrid >&rhs ) { 
