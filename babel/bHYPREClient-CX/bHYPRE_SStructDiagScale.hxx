...
#define included_bHYPRE_SStructDiagScale_hxx
...
namespace bHYPRE { 
  ...
  class SStructDiagScale;
} // end namespace bHYPRE

// Some compilers need to define array template before the specializations
namespace sidl {
  template<>
  class array< ::bHYPRE::SStructDiagScale >;
}
// 
...
namespace bHYPRE { 
  ...
  public:
    typedef struct bHYPRE_SStructDiagScale__object ior_t;
    typedef struct bHYPRE_SStructDiagScale__external ext_t;
    ...
    // RMI constructor
    static ::bHYPRE::SStructDiagScale _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::SStructDiagScale _connect( /*in*/ const 
      std::string& url ) { 
    ...
    // default destructor
    virtual ~SStructDiagScale () { }

    // copy constructor
    SStructDiagScale ( const SStructDiagScale& original );

    // assignment operator
    SStructDiagScale& operator= ( const SStructDiagScale& rhs );
    ...
    SStructDiagScale ( SStructDiagScale::ior_t* ior );
    ...
    static struct bHYPRE_SStructDiagScale__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::SStructDiagScale > {
    typedef array< ::bHYPRE::SStructDiagScale > cxx_array_t;
    typedef ::bHYPRE::SStructDiagScale cxx_item_t;
    typedef struct bHYPRE_SStructDiagScale__array ior_array_t;
    typedef sidl_interface__array ior_array_internal_t;
    typedef struct bHYPRE_SStructDiagScale__object ior_item_t;
    typedef cxx_item_t value_type;
    typedef value_type reference;
    typedef value_type* pointer;
    typedef const value_type const_reference;
    typedef const value_type* const_pointer;
    typedef array_iter< array_traits< ::bHYPRE::SStructDiagScale > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::SStructDiagScale > > 
      const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::SStructDiagScale >: public interface_array< 
    array_traits< ::bHYPRE::SStructDiagScale > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::SStructDiagScale > > Base;
    typedef array_traits< ::bHYPRE::SStructDiagScale >::cxx_array_t          
      cxx_array_t;
    typedef array_traits< ::bHYPRE::SStructDiagScale >::cxx_item_t           
      cxx_item_t;
    typedef array_traits< ::bHYPRE::SStructDiagScale >::ior_array_t          
      ior_array_t;
    typedef array_traits< ::bHYPRE::SStructDiagScale >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::SStructDiagScale >::ior_item_t           
      ior_item_t;
     ...
     */
    array( struct bHYPRE_SStructDiagScale__array* src = 0) : Base(src) {}

    /**
     * copy constructor
     */
    array( const array< ::bHYPRE::SStructDiagScale >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::SStructDiagScale >&
    operator =( const array< ::bHYPRE::SStructDiagScale >&rhs ) { 
