...
// 
// babel-version = 0.10.12
// xml-url       = /home/painter/babel/share/babel-0.10.12/repository/sidl.BaseInterface-v0.9.3.xml
// 

#ifndef included_sidl_BaseInterface_hh
#define included_sidl_BaseInterface_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::sidl::BaseInterface >;
  }
...
namespace ucxx { 
  namespace sidl { 
     ...
     */
    class BaseInterface: public virtual ::ucxx::sidl::StubBase {
  ...
  public:
    ...
    static inline const char * type_name() { return "sidl.BaseInterface";}
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::sidl::BaseInterface > {
      typedef array< ::ucxx::sidl::BaseInterface > cxx_array_t;
      typedef ::ucxx::sidl::BaseInterface cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::sidl::BaseInterface > > 
        iterator;
      typedef const_array_iter< array_traits< ::ucxx::sidl::BaseInterface > > 
        const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::sidl::BaseInterface >: public interface_array< 
      array_traits< ::ucxx::sidl::BaseInterface > > {
    public:
      typedef interface_array< array_traits< ::ucxx::sidl::BaseInterface > > 
        Base;
      typedef array_traits< ::ucxx::sidl::BaseInterface >::cxx_array_t          
        cxx_array_t;
      typedef array_traits< ::ucxx::sidl::BaseInterface >::cxx_item_t           
        cxx_item_t;
      typedef array_traits< ::ucxx::sidl::BaseInterface >::ior_array_t          
        ior_array_t;
      typedef array_traits< ::ucxx::sidl::BaseInterface >::ior_array_internal_t 
        ior_array_internal_t;
      typedef array_traits< ::ucxx::sidl::BaseInterface >::ior_item_t           
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::sidl::BaseInterface >&src) : Base(src) {}
       ...
       */
      array< ::ucxx::sidl::BaseInterface >&
      operator =( const array< ::ucxx::sidl::BaseInterface >&rhs ) { 
