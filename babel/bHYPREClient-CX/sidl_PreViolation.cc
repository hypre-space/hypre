 ...
 */
bool
ucxx::sidl::PreViolation::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()
...
ucxx::sidl::PreViolation::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::sidl::PreViolation::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::sidl::PreViolation::getClassInfo(  )
throw ()
 ...
 */
::std::string
ucxx::sidl::PreViolation::getNote(  )
throw ()
 ...
 */
void
ucxx::sidl::PreViolation::setNote( /* in */const ::std::string& message )
throw ()
 ...
 */
::std::string
ucxx::sidl::PreViolation::getTrace(  )
throw ()
 ...
 */
void
ucxx::sidl::PreViolation::add( /* in */const ::std::string& traceline )
throw ()
 ...
 */
void
ucxx::sidl::PreViolation::add( /* in */const ::std::string& filename,
...
// static constructor
::ucxx::sidl::PreViolation
ucxx::sidl::PreViolation::_create() {
  ::ucxx::sidl::PreViolation self( (*_get_ext()->createObject)(), false );
  return self;
}

// copy constructor
ucxx::sidl::PreViolation::PreViolation ( const ::ucxx::sidl::PreViolation& 
  original ) {
  d_self = original._cast("sidl.PreViolation");
...
// assignment operator
::ucxx::sidl::PreViolation&
ucxx::sidl::PreViolation::operator=( const ::ucxx::sidl::PreViolation& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("sidl.PreViolation");
...
ucxx::sidl::PreViolation::PreViolation ( ::ucxx::sidl::PreViolation::ior_t* ior 
  ) 
...
void* ucxx::sidl::PreViolation::_cast(const char* type) const
{
...
// Static data type
const ::ucxx::sidl::PreViolation::ext_t * ucxx::sidl::PreViolation::s_ext = 0;

// private static method to get static data type
const ::ucxx::sidl::PreViolation::ext_t *
ucxx::sidl::PreViolation::_get_ext()
