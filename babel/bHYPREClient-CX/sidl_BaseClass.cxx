...
sidl::BaseClass::_create() {
  ...
  ::sidl::BaseClass self( (*_get_ext()->createObject)(NULL,&_exception),
    false );
  if (_exception) {
    void *_p;
    if ( (_p = (*(_exception->d_epv->f__cast))(_exception->d_object,
...
sidl::BaseClass::_create(const std::string& url) {
  ...
  ior_self = sidl_BaseClass__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::BaseClass::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
  ior_self = sidl_BaseClass__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
    ; //TODO: handle exception
  }
  return ::sidl::BaseClass( ior_self, false );
...
sidl::BaseClass::BaseClass ( const ::sidl::BaseClass& original ) {
  d_self = ::sidl::BaseClass::_cast(original._get_ior());
...
sidl::BaseClass::operator=( const ::sidl::BaseClass& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::BaseClass::_cast(rhs._get_ior());
