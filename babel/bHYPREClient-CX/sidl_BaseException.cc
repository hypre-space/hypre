 ...
 */
bool
ucxx::sidl::BaseException::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()

{
  ...
  ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
    ...
    sidl_BaseInterface__object * > (d_self))->d_object, "sidl.BaseException");
...
ucxx::sidl::BaseException::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::sidl::BaseException::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::sidl::BaseException::getClassInfo(  )
throw ()
 ...
 */
::std::string
ucxx::sidl::BaseException::getNote(  )
throw ()
 ...
 */
void
ucxx::sidl::BaseException::setNote( /* in */const ::std::string& message )
throw ()

{
  ...
  ior_t* loc_self = (ior_t*)((reinterpret_cast< struct 
    ...
    sidl_BaseInterface__object * > (d_self))->d_object, "sidl.BaseException");
  /*pack args to dispatch to ior*/
  (*(loc_self->d_epv->f_setNote))(loc_self->d_object,
    /* in */ message.c_str() );
  /*dispatch to ior*/
  /*unpack results and cleanup*/
}
 ...
 */
::std::string
ucxx::sidl::BaseException::getTrace(  )
throw ()
 ...
 */
void
ucxx::sidl::BaseException::add( /* in */const ::std::string& traceline )
throw ()
 ...
 */
void
ucxx::sidl::BaseException::add( /* in */const ::std::string& filename,
...
// copy constructor
ucxx::sidl::BaseException::BaseException ( const ::ucxx::sidl::BaseException& 
  original ) {
  d_self = original._cast("sidl.BaseException");
...
ucxx::sidl::BaseException::operator=( const ::ucxx::sidl::BaseException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("sidl.BaseException");
...
ucxx::sidl::BaseException::BaseException ( ::ucxx::sidl::BaseException::ior_t* 
  ior ) 
...
void* ucxx::sidl::BaseException::_cast(const char* type) const
{
