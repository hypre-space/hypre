 ...
 */
::ucxx::bHYPRE::HGMRES
ucxx::bHYPRE::HGMRES::Create( /* in */::ucxx::bHYPRE::MPICommunicator mpi_comm )
throw ()

{
  ::ucxx::bHYPRE::HGMRES _result;
  struct bHYPRE_MPICommunicator__object* _local_mpi_comm = mpi_comm._get_ior();
  /*pack args to dispatch to ior*/
  _result = ::ucxx::bHYPRE::HGMRES( ( _get_sepv()->f_Create)( /* in */ 
 ...
 */
bool
ucxx::bHYPRE::HGMRES::isSame( /* in */::ucxx::sidl::BaseInterface iobj )
throw ()
...
ucxx::bHYPRE::HGMRES::queryInt( /* in */const ::std::string& name )
throw ()
 ...
 */
bool
ucxx::bHYPRE::HGMRES::isType( /* in */const ::std::string& name )
throw ()
 ...
 */
::ucxx::sidl::ClassInfo
ucxx::bHYPRE::HGMRES::getClassInfo(  )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetCommunicator( /* in */::ucxx::bHYPRE::MPICommunicator 
  mpi_comm )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetIntArray1Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetIntArray2Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetDoubleArray1Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetDoubleArray2Parameter( /* in */const ::std::string& 
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::Setup( /* in */::ucxx::bHYPRE::Vector b,
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::Apply( /* in */::ucxx::bHYPRE::Vector b,
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::ApplyAdjoint( /* in */::ucxx::bHYPRE::Vector b,
  /* inout */::ucxx::bHYPRE::Vector& x )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetOperator( /* in */::ucxx::bHYPRE::Operator A )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::SetPreconditioner( /* in */::ucxx::bHYPRE::Solver s )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::GetPreconditioner( /* out */::ucxx::bHYPRE::Solver& s )
throw ()
 ...
 */
int32_t
ucxx::bHYPRE::HGMRES::Clone( /* out */::ucxx::bHYPRE::PreconditionedSolver& x )
throw ()
...
// static constructor
::ucxx::bHYPRE::HGMRES
ucxx::bHYPRE::HGMRES::_create() {
  ::ucxx::bHYPRE::HGMRES self( (*_get_ext()->createObject)(), false );
  return self;
}

// copy constructor
ucxx::bHYPRE::HGMRES::HGMRES ( const ::ucxx::bHYPRE::HGMRES& original ) {
  d_self = original._cast("bHYPRE.HGMRES");
...
// assignment operator
::ucxx::bHYPRE::HGMRES&
ucxx::bHYPRE::HGMRES::operator=( const ::ucxx::bHYPRE::HGMRES& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = rhs._cast("bHYPRE.HGMRES");
...
ucxx::bHYPRE::HGMRES::HGMRES ( ::ucxx::bHYPRE::HGMRES::ior_t* ior ) 
...
void* ucxx::bHYPRE::HGMRES::_cast(const char* type) const
{
...
// Static data type
const ::ucxx::bHYPRE::HGMRES::ext_t * ucxx::bHYPRE::HGMRES::s_ext = 0;

// private static method to get static data type
const ::ucxx::bHYPRE::HGMRES::ext_t *
ucxx::bHYPRE::HGMRES::_get_ext()
