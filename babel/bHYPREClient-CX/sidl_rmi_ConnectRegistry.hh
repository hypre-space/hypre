// 
// File:          sidl_rmi_ConnectRegistry.hh
...
#ifndef included_sidl_rmi_ConnectRegistry_hh
#define included_sidl_rmi_ConnectRegistry_hh
...
namespace ucxx {
  namespace sidl {
    template<>
    class array< ::ucxx::sidl::rmi::ConnectRegistry >;
  }
...
namespace ucxx { 
  namespace sidl { 
    namespace rmi { 
       ...
       */
      class ConnectRegistry: public virtual ::ucxx::sidl::BaseClass {
    ...
    public:
      ...
      // static constructor
      static ::ucxx::sidl::rmi::ConnectRegistry _create();
...
namespace ucxx {
  namespace sidl {
    ...
    template<>
    struct array_traits< ::ucxx::sidl::rmi::ConnectRegistry > {
      typedef array< ::ucxx::sidl::rmi::ConnectRegistry > cxx_array_t;
      typedef ::ucxx::sidl::rmi::ConnectRegistry cxx_item_t;
      ...
      typedef array_iter< array_traits< ::ucxx::sidl::rmi::ConnectRegistry > > 
        iterator;
      typedef const_array_iter< array_traits< 
        ::ucxx::sidl::rmi::ConnectRegistry > > const_iterator;
    };

    // array specialization
    template<>
    class array< ::ucxx::sidl::rmi::ConnectRegistry >: public interface_array< 
      array_traits< ::ucxx::sidl::rmi::ConnectRegistry > > {
    public:
      typedef interface_array< array_traits< ::ucxx::sidl::rmi::ConnectRegistry 
        > > Base;
      typedef array_traits< ::ucxx::sidl::rmi::ConnectRegistry >::cxx_array_t   
        cxx_array_t;
      typedef array_traits< ::ucxx::sidl::rmi::ConnectRegistry >::cxx_item_t    
        cxx_item_t;
      typedef array_traits< ::ucxx::sidl::rmi::ConnectRegistry >::ior_array_t   
        ior_array_t;
      typedef array_traits< ::ucxx::sidl::rmi::ConnectRegistry 
        >::ior_array_internal_t ior_array_internal_t;
      typedef array_traits< ::ucxx::sidl::rmi::ConnectRegistry >::ior_item_t    
        ior_item_t;
       ...
       * copy constructor
       */
      array( const array< ::ucxx::sidl::rmi::ConnectRegistry >&src) : Base(src) 
        {}

      /**
       * assignment
       */
      array< ::ucxx::sidl::rmi::ConnectRegistry >&
      operator =( const array< ::ucxx::sidl::rmi::ConnectRegistry >&rhs ) { 
