...
struct bHYPRE_Operator__object* 
  skel_bHYPRE_StructJacobi_fconnect_bHYPRE_Operator(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_StructJacobi_fconnect_bHYPRE_Operator(url, ar, _ex);
}

struct bHYPRE_Operator__object* skel_bHYPRE_StructJacobi_fcast_bHYPRE_Operator(
...
struct sidl_BaseClass__object* skel_bHYPRE_StructJacobi_fconnect_sidl_BaseClass(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
...
struct sidl_ClassInfo__object* skel_bHYPRE_StructJacobi_fconnect_sidl_ClassInfo(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
