...
static const struct bHYPRE_Euclid__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_Euclid__external* _loadIOR(void)
/*
...

{
  ...
  _externals = bHYPRE_Euclid__externals();
#else
  _externals = (struct 
...
bHYPRE_Euclid
bHYPRE_Euclid__create()
{
  return (*(_getExternals()->createObject))();
}

static bHYPRE_Euclid bHYPRE_Euclid__remote(const char* url,
...
{
  return bHYPRE_Euclid__remote(url, _ex);
}
...
bHYPRE_Euclid
bHYPRE_Euclid__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_Euclid__remoteConnect(url, _ex);
}
...
bHYPRE_Euclid__cast(
  void* obj)
{
  bHYPRE_Euclid cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.Euclid",
      (void*)bHYPRE_Euclid__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_Euclid) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.Euclid");
  }
...
bHYPRE_Euclid__sexec(
        ...
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_Euclid__smethod s_methods[] = {
    { "Create", bHYPRE_Euclid_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_Euclid__smethod);
  if (methodName) {
...
bHYPRE_Euclid__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_Euclid__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
bHYPRE_Euclid__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_Euclid__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct bHYPRE_Euclid__array*)sidl_interface__array_create1d(len);
}
...
bHYPRE_Euclid__array_create1dInit(
  ...
  bHYPRE_Euclid* data)
{
  return (struct bHYPRE_Euclid__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct bHYPRE_Euclid__array*)sidl_interface__array_create2dCol(m, n);
}

struct bHYPRE_Euclid__array*
bHYPRE_Euclid__array_create2dRow(int32_t m, int32_t n)
{
  return (struct bHYPRE_Euclid__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_Euclid__array*)sidl_interface__array_borrow(
...
{
  return (struct bHYPRE_Euclid__array*)
...
const char* name)
{
  ...
  else if(bHYPRE_Euclid_isType(self, name)) {
...
remote_bHYPRE_Euclid_addRef(
  /* in */ struct bHYPRE_Euclid__object* self /* TLD */)
{
  ...
  /* inout */ char** argv)
{
  ...
  /* pack in and inout arguments */
  sidl_rmi_Invocation_packInt( _inv, "argc", argc, _ex2);
  sidl_rmi_Invocation_packString( _inv, "argv", *argv, _ex2);
  ...
  /* unpack out and inout arguments */
  sidl_rmi_Response_unpackString( _rsvp, "argv", argv, _ex2);
...
static void bHYPRE_Euclid__init_remote_epv(void)
{
  ...
  epv->f_queryInt                      = remote_bHYPRE_Euclid_queryInt;
...
static struct bHYPRE_Euclid__object*
bHYPRE_Euclid__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_Euclid__object* self;
...
static struct bHYPRE_Euclid__object*
bHYPRE_Euclid__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_Euclid__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.Euclid", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_Euclid__object*) malloc(
      sizeof(struct bHYPRE_Euclid__object));
