...
static const struct bHYPRE_BiCGSTAB__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_BiCGSTAB__external* _loadIOR(void)
/*
...

{
  ...
  _externals = bHYPRE_BiCGSTAB__externals();
#else
  _externals = (struct 
...
bHYPRE_BiCGSTAB
bHYPRE_BiCGSTAB__create()
{
  return (*(_getExternals()->createObject))();
}

static bHYPRE_BiCGSTAB bHYPRE_BiCGSTAB__remote(const char* url,
...
{
  return bHYPRE_BiCGSTAB__remote(url, _ex);
}
...
bHYPRE_BiCGSTAB
bHYPRE_BiCGSTAB__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_BiCGSTAB__remoteConnect(url, _ex);
}
...
void
bHYPRE_BiCGSTAB_Create__sexec(
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  bHYPRE_MPICommunicator mpi_comm;
  bHYPRE_Operator A;
  bHYPRE_BiCGSTAB _retval;
...
bHYPRE_BiCGSTAB__cast(
  void* obj)
{
  bHYPRE_BiCGSTAB cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.BiCGSTAB",
      (void*)bHYPRE_BiCGSTAB__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_BiCGSTAB) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.BiCGSTAB");
  }
...
struct bHYPRE_BiCGSTAB__smethod {
  const char *d_name;
...
bHYPRE_BiCGSTAB__sexec(
        ...
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_BiCGSTAB__smethod s_methods[] = {
    { "Create", bHYPRE_BiCGSTAB_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_BiCGSTAB__smethod);
  if (methodName) {
...
bHYPRE_BiCGSTAB__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_BiCGSTAB__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
bHYPRE_BiCGSTAB__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_BiCGSTAB__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct bHYPRE_BiCGSTAB__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct bHYPRE_BiCGSTAB__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct bHYPRE_BiCGSTAB__array*)sidl_interface__array_create2dCol(m,
    n);
}
...
{
  return (struct bHYPRE_BiCGSTAB__array*)sidl_interface__array_create2dRow(m,
    n);
}
...
{
  return (struct bHYPRE_BiCGSTAB__array*)sidl_interface__array_borrow(
...
{
  return (struct bHYPRE_BiCGSTAB__array*)
...
const char* name)
{
  ...
  else if(bHYPRE_BiCGSTAB_isType(self, name)) {
...
remote_bHYPRE_BiCGSTAB_addRef(
  /* in */ struct bHYPRE_BiCGSTAB__object* self /* TLD */)
{
...
remote_bHYPRE_BiCGSTAB_queryInt(
  /* in */ struct bHYPRE_BiCGSTAB__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void bHYPRE_BiCGSTAB__init_remote_epv(void)
{
  ...
  epv->f_queryInt                      = remote_bHYPRE_BiCGSTAB_queryInt;
...
static struct bHYPRE_BiCGSTAB__object*
bHYPRE_BiCGSTAB__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_BiCGSTAB__object* self;
...
static struct bHYPRE_BiCGSTAB__object*
bHYPRE_BiCGSTAB__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_BiCGSTAB__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.BiCGSTAB", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_BiCGSTAB__object*) malloc(
      sizeof(struct bHYPRE_BiCGSTAB__object));
