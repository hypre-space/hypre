...
static void
bHYPRE_IdentitySolver_queryInt__exec(
        struct bHYPRE_IdentitySolver__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
...
bHYPRE_IdentitySolver_SetCommunicator__exec(
  ...
  mpi_comm = 
    skel_bHYPRE_IdentitySolver_fconnect_bHYPRE_MPICommunicator(mpi_comm_str,
    _ex2);
...
ior_bHYPRE_IdentitySolver__exec(
  ...
  static const struct bHYPRE_IdentitySolver__method  s_methods[] = {
    ...
    { "queryInt", bHYPRE_IdentitySolver_queryInt__exec }
  };
  int i, cmp, l = 0;
 ...
 */
  ...
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* 
    (*)(struct bHYPRE_IdentitySolver__object*)) s1->d_epv->f_getClassInfo;
