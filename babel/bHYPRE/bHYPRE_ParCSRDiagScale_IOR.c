...
bHYPRE_ParCSRDiagScale_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str,
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = 
    skel_bHYPRE_ParCSRDiagScale_fconnect_bHYPRE_MPICommunicator(mpi_comm_str,
 ...
 */
  ...
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_ParCSRDiagScale__object*,const char*,
...
void bHYPRE_ParCSRDiagScale__getEPVs(
  ...
  struct bHYPRE_ParCSRDiagScale__epv **s_arg_epv__bhypre_parcsrdiagscale,
...
struct bHYPRE_ParCSRDiagScale__object*
bHYPRE_ParCSRDiagScale__new(void* ddata,
  struct sidl_BaseInterface__object ** _ex)
{
  struct bHYPRE_ParCSRDiagScale__object* self =
