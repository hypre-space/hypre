...
bHYPRE_Euclid_SetOperator__exec(
  ...
  A = skel_bHYPRE_Euclid_fconnect_bHYPRE_Operator(A_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_Euclid_Setup__exec(
  ...
  b = skel_bHYPRE_Euclid_fconnect_bHYPRE_Vector(b_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  x = skel_bHYPRE_Euclid_fconnect_bHYPRE_Vector(x_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_Euclid_Apply__exec(
  ...
  b = skel_bHYPRE_Euclid_fconnect_bHYPRE_Vector(b_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  *x = skel_bHYPRE_Euclid_fconnect_bHYPRE_Vector(x_str, FALSE,
    _ex);SIDL_CHECK(*_ex);
 ...
 */
  ...
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_Euclid__object*,const char*,
...
void bHYPRE_Euclid__getEPVs(
  ...
  struct bHYPRE_Euclid__epv **s_arg_epv__bhypre_euclid,
    struct bHYPRE_Euclid__epv **s_arg_epv_hooks__bhypre_euclid)
{
  LOCK_STATIC_GLOBALS;
