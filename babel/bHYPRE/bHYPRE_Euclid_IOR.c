...
bHYPRE_Euclid_SetParameters__exec(
  ...
  sidl_BaseInterface *_ex2 = &_ex;
  /* unpack in and inout argments */
  sidl_io_Deserializer_unpackInt( inArgs, "argc", &argc, _ex2);
  sidl_io_Deserializer_unpackString( inArgs, "argv", argv, _ex2);
  ...
  /* pack out and inout argments */
  sidl_io_Serializer_packString( outArgs, "argv", *argv, _ex2);
...
ior_bHYPRE_Euclid__exec(
  ...
  static const struct bHYPRE_Euclid__method  s_methods[] = {
    ...
    { "queryInt", bHYPRE_Euclid_queryInt__exec }
  };
  int i, cmp, l = 0;
...
static void bHYPRE_Euclid__init_epv(
  struct bHYPRE_Euclid__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                        = (void (*)(struct 
    bHYPRE_Euclid__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                     = (void (*)(struct 
    bHYPRE_Euclid__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_Euclid__object*,
    struct sidl_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                      = (struct sidl_BaseInterface__object* 
    (*)(struct bHYPRE_Euclid__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_Euclid__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* 
    (*)(struct bHYPRE_Euclid__object*)) s1->d_epv->f_getClassInfo;
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.Euclid");
...
static void
initMetadata(struct bHYPRE_Euclid__object* self)
{
  if (self) {
