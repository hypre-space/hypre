...
static struct bHYPRE_StructStencil__epv  s_new_epv_hooks__bhypre_structstencil;
static struct bHYPRE_StructStencil__sepv s_stc_epv_hooks__bhypre_structstencil;
...
static void
bHYPRE_StructStencil_Destroy__exec(
...
bHYPRE_StructStencil_isSame__exec(
  ...
  iobj = skel_bHYPRE_StructStencil_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
static void ior_bHYPRE_StructStencil__set_hooks_static(
...
static void ior_bHYPRE_StructStencil__set_hooks(
  struct bHYPRE_StructStencil__object* self,
  int on, struct sidl_BaseInterface__object **_ex ) { 
  *_ex = NULL;
  /*
...
static void ior_bHYPRE_StructStencil__delete(
  struct bHYPRE_StructStencil__object* self, struct sidl_BaseInterface__object 
    **_ex)
{
  *_ex = NULL; /* default to no exception */
  bHYPRE_StructStencil__fini(self,_ex);
...
ior_bHYPRE_StructStencil__exec(
  ...
  static const struct bHYPRE_StructStencil__method  s_methods[] = {
    { "Destroy", bHYPRE_StructStencil_Destroy__exec },
...
static void bHYPRE_StructStencil__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct bHYPRE_StructStencil__epv*  hepv = 
    &s_new_epv_hooks__bhypre_structstencil;
  ...
  epv->f__raddRef                 = ior_bHYPRE_StructStencil__raddRef;
  epv->f__isRemote                = ior_bHYPRE_StructStencil__isRemote;
  epv->f__set_hooks               = ior_bHYPRE_StructStencil__set_hooks;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_Destroy                  = NULL;
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    bHYPRE_StructStencil__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    bHYPRE_StructStencil__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  ...
  memcpy((void*)hepv, epv, sizeof(struct bHYPRE_StructStencil__epv));
...
static void bHYPRE_StructStencil__init_sepv(void)
{
  ...
  struct bHYPRE_StructStencil__sepv* hs = 
    &s_stc_epv_hooks__bhypre_structstencil;

  s->f__set_hooks_static                 = 
    ior_bHYPRE_StructStencil__set_hooks_static;
  s->f_Create         = NULL;

  bHYPRE_StructStencil__set_sepv(s);

  memcpy((void*)hs, s, sizeof(struct bHYPRE_StructStencil__sepv));

  ior_bHYPRE_StructStencil__set_hooks_static(FALSE, &throwaway_exception);
  s_static_initialized = 1;
  ior_bHYPRE_StructStencil__ensure_load_called();
}

void bHYPRE_StructStencil__getEPVs(
  ...
  struct bHYPRE_StructStencil__epv **s_arg_epv__bhypre_structstencil,struct 
    bHYPRE_StructStencil__epv **s_arg_epv_hooks__bhypre_structstencil)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    bHYPRE_StructStencil__init_epv();
  }
  ...
  *s_arg_epv__bhypre_structstencil = &s_new_epv__bhypre_structstencil;
  *s_arg_epv_hooks__bhypre_structstencil = 
    &s_new_epv_hooks__bhypre_structstencil;
}
/*
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.StructStencil",_ex);
...
static void
initMetadata(struct bHYPRE_StructStencil__object* self, sidl_BaseInterface* _ex)
{
...
bHYPRE_StructStencil__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  bHYPRE_StructStencil__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_bHYPRE_StructStencil__set_hooks(s0, FALSE, _ex);
