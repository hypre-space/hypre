...
bHYPRE_BoomerAMG_SetLevelRelaxWt__exec(
  ...
  sidl_rmi_Call_unpackDouble( inArgs, "relax_wt", &relax_wt, _ex);SIDL_CHECK(
    *_ex);
...
bHYPRE_BoomerAMG_InitGridRelaxation__exec(
  ...
  sidl_rmi_Call_unpackInt( inArgs, "coarsen_type", &coarsen_type, 
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackInt( inArgs, "max_levels", &max_levels, _ex);SIDL_CHECK(
    *_ex);
...
bHYPRE_BoomerAMG_Setup__exec(
  ...
  b = skel_bHYPRE_BoomerAMG_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  x = skel_bHYPRE_BoomerAMG_fconnect_bHYPRE_Vector(x_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
...
static void ior_bHYPRE_BoomerAMG__delete(
  struct bHYPRE_BoomerAMG__object* self, struct sidl_BaseInterface__object 
    **_ex)
{
  *_ex = NULL; /* default to no exception */
 ...
 */
  ...
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_BoomerAMG__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_BoomerAMG__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* (*)(
    struct bHYPRE_BoomerAMG__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
...
void bHYPRE_BoomerAMG__getEPVs(
  ...
  struct bHYPRE_BoomerAMG__epv **s_arg_epv__bhypre_boomeramg,struct 
    bHYPRE_BoomerAMG__epv **s_arg_epv_hooks__bhypre_boomeramg)
{
  LOCK_STATIC_GLOBALS;
