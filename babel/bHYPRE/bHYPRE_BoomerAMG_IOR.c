  ...
  struct bHYPRE_BoomerAMG__object* self)
{
  ...
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = (void (*)(struct bHYPRE_BoomerAMG__object*)) 
    s1->d_epv->f_addRef;
  epv->f_deleteRef               = (void (*)(struct bHYPRE_BoomerAMG__object*)) 
...
static int32_t
remote_bHYPRE_BoomerAMG_SetIntArrayParameter(
  struct bHYPRE_BoomerAMG__object* self,
  const char* name,
...
static int32_t
remote_bHYPRE_BoomerAMG_SetDoubleArrayParameter(
  struct bHYPRE_BoomerAMG__object* self,
  const char* name,
...
static void bHYPRE_BoomerAMG__init_remote_epv(void)
{
  ...
  epv->f_SetIntArrayParameter    = remote_bHYPRE_BoomerAMG_SetIntArrayParameter;
