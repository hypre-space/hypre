...

{
  ...
  sidl_checkIORVersion("bHYPRE.StructPFMG", _externals->d_ior_major_version,
...
static bHYPRE_StructPFMG bHYPRE_StructPFMG__remoteCreate(const char* url,
...
{
  return bHYPRE_StructPFMG__remoteCreate(url, _ex);
}
...
{
  return bHYPRE_StructPFMG__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.StructPFMG",
      (void*)bHYPRE_StructPFMG__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
void
bHYPRE_StructPFMG__set_hooks_static(
  int32_t on,
...
bHYPRE_StructPFMG__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_StructPFMG__isRemote(self,_ex);
}
