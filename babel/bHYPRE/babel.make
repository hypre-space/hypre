IMPLHDRS = bHYPRE_BiCGSTAB_Impl.h bHYPRE_BoomerAMG_Impl.h bHYPRE_CGNR_Impl.h  \
  bHYPRE_ErrorHandler_Impl.h bHYPRE_Euclid_Impl.h bHYPRE_GMRES_Impl.h         \
  bHYPRE_HGMRES_Impl.h bHYPRE_HPCG_Impl.h bHYPRE_Hybrid_Impl.h                \
  bHYPRE_IJParCSRMatrix_Impl.h bHYPRE_IJParCSRVector_Impl.h                   \
  bHYPRE_IdentitySolver_Impl.h bHYPRE_MPICommunicator_Impl.h                  \
  bHYPRE_PCG_Impl.h bHYPRE_ParCSRDiagScale_Impl.h bHYPRE_ParaSails_Impl.h     \
  bHYPRE_Pilut_Impl.h bHYPRE_SStructDiagScale_Impl.h                          \
  bHYPRE_SStructGraph_Impl.h bHYPRE_SStructGrid_Impl.h                        \
  bHYPRE_SStructMatrix_Impl.h bHYPRE_SStructParCSRMatrix_Impl.h               \
  bHYPRE_SStructParCSRVector_Impl.h bHYPRE_SStructSplit_Impl.h                \
  bHYPRE_SStructStencil_Impl.h bHYPRE_SStructVector_Impl.h                    \
  bHYPRE_Schwarz_Impl.h bHYPRE_StructDiagScale_Impl.h                         \
  bHYPRE_StructGrid_Impl.h bHYPRE_StructJacobi_Impl.h                         \
...
IMPLSRCS = bHYPRE_BiCGSTAB_Impl.c bHYPRE_BoomerAMG_Impl.c bHYPRE_CGNR_Impl.c  \
  bHYPRE_ErrorHandler_Impl.c bHYPRE_Euclid_Impl.c bHYPRE_GMRES_Impl.c         \
  bHYPRE_HGMRES_Impl.c bHYPRE_HPCG_Impl.c bHYPRE_Hybrid_Impl.c                \
  bHYPRE_IJParCSRMatrix_Impl.c bHYPRE_IJParCSRVector_Impl.c                   \
  bHYPRE_IdentitySolver_Impl.c bHYPRE_MPICommunicator_Impl.c                  \
  bHYPRE_PCG_Impl.c bHYPRE_ParCSRDiagScale_Impl.c bHYPRE_ParaSails_Impl.c     \
  bHYPRE_Pilut_Impl.c bHYPRE_SStructDiagScale_Impl.c                          \
  bHYPRE_SStructGraph_Impl.c bHYPRE_SStructGrid_Impl.c                        \
  bHYPRE_SStructMatrix_Impl.c bHYPRE_SStructParCSRMatrix_Impl.c               \
  bHYPRE_SStructParCSRVector_Impl.c bHYPRE_SStructSplit_Impl.c                \
  bHYPRE_SStructStencil_Impl.c bHYPRE_SStructVector_Impl.c                    \
  bHYPRE_Schwarz_Impl.c bHYPRE_StructDiagScale_Impl.c                         \
  bHYPRE_StructGrid_Impl.c bHYPRE_StructJacobi_Impl.c                         \
...
IORSRCS = bHYPRE_BiCGSTAB_IOR.c bHYPRE_BoomerAMG_IOR.c bHYPRE_CGNR_IOR.c      \
  bHYPRE_ErrorHandler_IOR.c bHYPRE_Euclid_IOR.c bHYPRE_GMRES_IOR.c            \
  bHYPRE_HGMRES_IOR.c bHYPRE_HPCG_IOR.c bHYPRE_Hybrid_IOR.c                   \
  ...
  bHYPRE_SStructSplit_IOR.c bHYPRE_SStructStencil_IOR.c                       \
  bHYPRE_SStructVector_IOR.c bHYPRE_Schwarz_IOR.c                             \
  bHYPRE_StructDiagScale_IOR.c bHYPRE_StructGrid_IOR.c                        \
  bHYPRE_StructJacobi_IOR.c bHYPRE_StructMatrix_IOR.c bHYPRE_StructPFMG_IOR.c \
...
SKELSRCS = bHYPRE_BiCGSTAB_Skel.c bHYPRE_BoomerAMG_Skel.c bHYPRE_CGNR_Skel.c  \
  bHYPRE_ErrorHandler_Skel.c bHYPRE_Euclid_Skel.c bHYPRE_GMRES_Skel.c         \
  bHYPRE_HGMRES_Skel.c bHYPRE_HPCG_Skel.c bHYPRE_Hybrid_Skel.c                \
  bHYPRE_IJParCSRMatrix_Skel.c bHYPRE_IJParCSRVector_Skel.c                   \
  bHYPRE_IdentitySolver_Skel.c bHYPRE_MPICommunicator_Skel.c                  \
  bHYPRE_PCG_Skel.c bHYPRE_ParCSRDiagScale_Skel.c bHYPRE_ParaSails_Skel.c     \
  bHYPRE_Pilut_Skel.c bHYPRE_SStructDiagScale_Skel.c                          \
  bHYPRE_SStructGraph_Skel.c bHYPRE_SStructGrid_Skel.c                        \
  bHYPRE_SStructMatrix_Skel.c bHYPRE_SStructParCSRMatrix_Skel.c               \
  bHYPRE_SStructParCSRVector_Skel.c bHYPRE_SStructSplit_Skel.c                \
  bHYPRE_SStructStencil_Skel.c bHYPRE_SStructVector_Skel.c                    \
  bHYPRE_Schwarz_Skel.c bHYPRE_StructDiagScale_Skel.c                         \
  bHYPRE_StructGrid_Skel.c bHYPRE_StructJacobi_Skel.c                         \
