...
#else
  _externals = (struct bHYPRE_SStructGrid__external*)sidl_dynamicLoadIOR(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  ...
  _result = (*self->d_epv->f_SetNeighborBox)(
    self,
    part,
    ilower_tmp,
    iupper_tmp,
...
bHYPRE_SStructGrid__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_SStructGrid__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
bHYPRE_SStructGrid__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_SStructGrid__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct bHYPRE_SStructGrid__array*)sidl_interface__array_create1dInit(
