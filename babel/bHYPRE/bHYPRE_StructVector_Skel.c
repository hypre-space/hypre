...
struct bHYPRE_StructGrid__object* 
  skel_bHYPRE_StructVector_fcast_bHYPRE_StructGrid(void* bi, sidl_BaseInterface 
  *_ex) { 
...
struct sidl_BaseClass__object* skel_bHYPRE_StructVector_fconnect_sidl_BaseClass(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
...
struct sidl_ClassInfo__object* skel_bHYPRE_StructVector_fconnect_sidl_ClassInfo(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
