...
static struct bHYPRE_SStructVector__epv s_new__bhypre_sstructvector;
static struct bHYPRE_SStructVector__epv s_rem__bhypre_sstructvector;
  ...
  struct bHYPRE_SStructVector__object* self)
{
  ...
  struct bHYPRE_SStructVector__epv*      epv = &s_new__bhypre_sstructvector;
  ...
  epv->f__ctor           = NULL;
  epv->f__dtor           = NULL;
  epv->f_addRef          = (void (*)(struct bHYPRE_SStructVector__object*)) 
    s1->d_epv->f_addRef;
  epv->f_deleteRef       = (void (*)(struct bHYPRE_SStructVector__object*)) 
    s1->d_epv->f_deleteRef;
  epv->f_isSame          = (sidl_bool (*)(struct bHYPRE_SStructVector__object*,
    struct sidl_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt        = (struct sidl_BaseInterface__object* (*)(struct 
    bHYPRE_SStructVector__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType          = (sidl_bool (*)(struct bHYPRE_SStructVector__object*,
  ...
  struct bHYPRE_SStructVector__object* self)
{
  ...
  s0->d_epv                             = &s_new__bhypre_sstructvector;
...
{
  struct bHYPRE_SStructVector__epv*      epv = &s_rem__bhypre_sstructvector;
...
bHYPRE_SStructVector__remote(const char *url)
{
  ...
  s0->d_epv  = &s_rem__bhypre_sstructvector;
