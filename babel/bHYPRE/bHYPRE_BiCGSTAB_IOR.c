...
static struct bHYPRE_BiCGSTAB__epv  s_new_epv_hooks__bhypre_bicgstab;
static struct bHYPRE_BiCGSTAB__sepv s_stc_epv_hooks__bhypre_bicgstab;
...
bHYPRE_BiCGSTAB_isSame__exec(
  ...
  iobj = skel_bHYPRE_BiCGSTAB_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_BiCGSTAB_SetPreconditioner__exec(
  ...
  s = skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Solver(s_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
...
bHYPRE_BiCGSTAB_SetOperator__exec(
  ...
  A = skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Operator(A_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_BiCGSTAB_Setup__exec(
  ...
  b = skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  x = skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Vector(x_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
...
bHYPRE_BiCGSTAB_Apply__exec(
  ...
  b = skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  *x = skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Vector(x_str, FALSE, 
    _ex);SIDL_CHECK(*_ex);
...
static void ior_bHYPRE_BiCGSTAB__set_hooks_static(
...
static void ior_bHYPRE_BiCGSTAB__set_hooks(
  struct bHYPRE_BiCGSTAB__object* self,
  int on, struct sidl_BaseInterface__object **_ex ) { 
  *_ex = NULL;
  /*
...
static void ior_bHYPRE_BiCGSTAB__delete(
  struct bHYPRE_BiCGSTAB__object* self, struct sidl_BaseInterface__object **_ex)
{
  *_ex = NULL; /* default to no exception */
  bHYPRE_BiCGSTAB__fini(self,_ex);
...
ior_bHYPRE_BiCGSTAB__exec(
  ...
  static const struct bHYPRE_BiCGSTAB__method  s_methods[] = {
    ...
    { "Destroy", bHYPRE_BiCGSTAB_Destroy__exec },
...
static void bHYPRE_BiCGSTAB__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct bHYPRE_BiCGSTAB__epv*             hepv = 
    &s_new_epv_hooks__bhypre_bicgstab;
  ...
  epv->f__raddRef                      = ior_bHYPRE_BiCGSTAB__raddRef;
  epv->f__isRemote                     = ior_bHYPRE_BiCGSTAB__isRemote;
  epv->f__set_hooks                    = ior_bHYPRE_BiCGSTAB__set_hooks;
  epv->f__ctor                         = NULL;
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  epv->f_addRef                        = (void (*)(struct 
    bHYPRE_BiCGSTAB__object*,struct sidl_BaseInterface__object **)) 
    s1->f_addRef;
  epv->f_deleteRef                     = (void (*)(struct 
    bHYPRE_BiCGSTAB__object*,struct sidl_BaseInterface__object **)) 
    s1->f_deleteRef;
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_BiCGSTAB__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_BiCGSTAB__object*,const char*,struct sidl_BaseInterface__object **)) 
    s1->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* (*)(
    struct bHYPRE_BiCGSTAB__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
  ...
  memcpy((void*)hepv, epv, sizeof(struct bHYPRE_BiCGSTAB__epv));
...
static void bHYPRE_BiCGSTAB__init_sepv(void)
{
  ...
  struct bHYPRE_BiCGSTAB__sepv* hs = &s_stc_epv_hooks__bhypre_bicgstab;

  s->f__set_hooks_static            = ior_bHYPRE_BiCGSTAB__set_hooks_static;
  s->f_Create         = NULL;

  bHYPRE_BiCGSTAB__set_sepv(s);

  memcpy((void*)hs, s, sizeof(struct bHYPRE_BiCGSTAB__sepv));

  ior_bHYPRE_BiCGSTAB__set_hooks_static(FALSE, &throwaway_exception);
  s_static_initialized = 1;
  ior_bHYPRE_BiCGSTAB__ensure_load_called();
}

void bHYPRE_BiCGSTAB__getEPVs(
  ...
  struct bHYPRE_BiCGSTAB__epv **s_arg_epv__bhypre_bicgstab,struct 
    bHYPRE_BiCGSTAB__epv **s_arg_epv_hooks__bhypre_bicgstab)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    bHYPRE_BiCGSTAB__init_epv();
  }
  ...
  *s_arg_epv__bhypre_bicgstab = &s_new_epv__bhypre_bicgstab;
  *s_arg_epv_hooks__bhypre_bicgstab = &s_new_epv_hooks__bhypre_bicgstab;
}
/*
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.BiCGSTAB",_ex);
...
static void
initMetadata(struct bHYPRE_BiCGSTAB__object* self, sidl_BaseInterface* _ex)
{
...
bHYPRE_BiCGSTAB__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  bHYPRE_BiCGSTAB__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_bHYPRE_BiCGSTAB__set_hooks(s0, FALSE, _ex);
