...
ior_bHYPRE_Pilut__exec(
  ...
  static const struct bHYPRE_Pilut__method  s_methods[] = {
    ...
    { "queryInt", bHYPRE_Pilut_queryInt__exec }
  };
  int i, cmp, l = 0;
 ...
 */
  ...
  epv->f_addRef                        = (void (*)(struct 
    bHYPRE_Pilut__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                     = (void (*)(struct 
    bHYPRE_Pilut__object*)) s1->d_epv->f_deleteRef;
  ...
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_Pilut__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* 
    (*)(struct bHYPRE_Pilut__object*)) s1->d_epv->f_getClassInfo;
