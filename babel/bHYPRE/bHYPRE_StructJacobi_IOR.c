...
static void
bHYPRE_StructJacobi_queryInt__exec(
        struct bHYPRE_StructJacobi__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
...
bHYPRE_StructJacobi_SetCommunicator__exec(
  ...
  mpi_comm = 
    skel_bHYPRE_StructJacobi_fconnect_bHYPRE_MPICommunicator(mpi_comm_str,
    _ex2);
  ...
  const char* name)
{
  ...
  if (!strcmp(name, "bHYPRE.StructJacobi")) {
    cast = (void*) s0;
...
static void ior_bHYPRE_StructJacobi__delete(
  struct bHYPRE_StructJacobi__object* self)
{
  bHYPRE_StructJacobi__fini(self);
...
ior_bHYPRE_StructJacobi__exec(
  ...
  static const struct bHYPRE_StructJacobi__method  s_methods[] = {
    ...
    { "queryInt", bHYPRE_StructJacobi_queryInt__exec }
  };
  int i, cmp, l = 0;
...
static void bHYPRE_StructJacobi__init_epv(
  struct bHYPRE_StructJacobi__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                        = (void (*)(struct 
    bHYPRE_StructJacobi__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                     = (void (*)(struct 
    bHYPRE_StructJacobi__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_StructJacobi__object*,
    struct sidl_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                      = (struct sidl_BaseInterface__object* 
    (*)(struct bHYPRE_StructJacobi__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_StructJacobi__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* 
    (*)(struct bHYPRE_StructJacobi__object*)) s1->d_epv->f_getClassInfo;
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.StructJacobi");
...
static void
initMetadata(struct bHYPRE_StructJacobi__object* self)
{
  if (self) {
...
bHYPRE_StructJacobi__new(void)
{
  ...
  bHYPRE_StructJacobi__init(self);
  initMetadata(self);
  return self;
}
  ...
  struct bHYPRE_StructJacobi__object* self)
{
  ...
  if (!s_method_initialized) {
    bHYPRE_StructJacobi__init_epv(s0);
  }
  UNLOCK_STATIC_GLOBALS;
