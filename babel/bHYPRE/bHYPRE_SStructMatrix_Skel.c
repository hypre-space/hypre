...
struct bHYPRE_SStruct_MatrixVectorView__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_SStructMatrix_fconnect_bHYPRE_SStruct_MatrixVectorView(url,
    _ex);
}

char* skel_bHYPRE_SStructMatrix_fgetURL_bHYPRE_SStruct_MatrixVectorView(struct 
  bHYPRE_SStruct_MatrixVectorView__object* obj) { 
  return impl_bHYPRE_SStructMatrix_fgetURL_bHYPRE_SStruct_MatrixVectorView(obj);
}

struct bHYPRE_SStructMatrixView__object* 
  skel_bHYPRE_SStructMatrix_fconnect_bHYPRE_SStructMatrixView(char* url,
  sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_SStructMatrix_fconnect_bHYPRE_SStructMatrixView(url, _ex);
}

char* skel_bHYPRE_SStructMatrix_fgetURL_bHYPRE_SStructMatrixView(struct 
  bHYPRE_SStructMatrixView__object* obj) { 
  return impl_bHYPRE_SStructMatrix_fgetURL_bHYPRE_SStructMatrixView(obj);
}

struct bHYPRE_MPICommunicator__object* 
  skel_bHYPRE_SStructMatrix_fconnect_bHYPRE_MPICommunicator(char* url,
  sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_SStructMatrix_fconnect_bHYPRE_MPICommunicator(url, _ex);
}

char* skel_bHYPRE_SStructMatrix_fgetURL_bHYPRE_MPICommunicator(struct 
  bHYPRE_MPICommunicator__object* obj) { 
  return impl_bHYPRE_SStructMatrix_fgetURL_bHYPRE_MPICommunicator(obj);
}
...
struct bHYPRE_MatrixVectorView__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_SStructMatrix_fconnect_bHYPRE_MatrixVectorView(url, _ex);
}

char* skel_bHYPRE_SStructMatrix_fgetURL_bHYPRE_MatrixVectorView(struct 
  bHYPRE_MatrixVectorView__object* obj) { 
  return impl_bHYPRE_SStructMatrix_fgetURL_bHYPRE_MatrixVectorView(obj);
}
