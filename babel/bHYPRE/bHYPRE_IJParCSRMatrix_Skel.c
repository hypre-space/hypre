...
bHYPRE_IJParCSRMatrix__set_epv(struct bHYPRE_IJParCSRMatrix__epv *epv)
{
  ...
  epv->f_SetDiagOffdSizes = impl_bHYPRE_IJParCSRMatrix_SetDiagOffdSizes;
  ...
  epv->f_SetIntArrayParameter = impl_bHYPRE_IJParCSRMatrix_SetIntArrayParameter;
  ...
  epv->f_SetValues = impl_bHYPRE_IJParCSRMatrix_SetValues;
  epv->f_AddToValues = impl_bHYPRE_IJParCSRMatrix_AddToValues;
  epv->f_GetLocalRange = impl_bHYPRE_IJParCSRMatrix_GetLocalRange;
  epv->f_GetRowCounts = impl_bHYPRE_IJParCSRMatrix_GetRowCounts;
  epv->f_GetValues = impl_bHYPRE_IJParCSRMatrix_GetValues;
  epv->f_SetRowSizes = impl_bHYPRE_IJParCSRMatrix_SetRowSizes;
  epv->f_Print = impl_bHYPRE_IJParCSRMatrix_Print;
  epv->f_Read = impl_bHYPRE_IJParCSRMatrix_Read;
  epv->f_GetRow = impl_bHYPRE_IJParCSRMatrix_GetRow;
}
