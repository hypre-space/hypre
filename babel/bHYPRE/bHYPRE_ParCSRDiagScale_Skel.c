...
struct bHYPRE_MPICommunicator__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_ParCSRDiagScale_fconnect_bHYPRE_MPICommunicator(url, _ex);
}

char* skel_bHYPRE_ParCSRDiagScale_fgetURL_bHYPRE_MPICommunicator(struct 
  bHYPRE_MPICommunicator__object* obj) { 
  return impl_bHYPRE_ParCSRDiagScale_fgetURL_bHYPRE_MPICommunicator(obj);
}
...
struct bHYPRE_IJParCSRMatrix__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_ParCSRDiagScale_fconnect_bHYPRE_IJParCSRMatrix(url, _ex);
}

char* skel_bHYPRE_ParCSRDiagScale_fgetURL_bHYPRE_IJParCSRMatrix(struct 
  bHYPRE_IJParCSRMatrix__object* obj) { 
  return impl_bHYPRE_ParCSRDiagScale_fgetURL_bHYPRE_IJParCSRMatrix(obj);
}
