...
extern struct bHYPRE_Operator__object* 
  ...
  sidl_BaseInterface *_ex);
extern struct bHYPRE_Operator__object* 
  impl_bHYPRE_StructSMG_fcast_bHYPRE_Operator(void* bi, sidl_BaseInterface* 
  _ex);
extern struct bHYPRE_Solver__object* 
  impl_bHYPRE_StructSMG_fconnect_bHYPRE_Solver(const char* url, sidl_bool ar, 
  sidl_BaseInterface *_ex);
extern struct bHYPRE_Solver__object* impl_bHYPRE_StructSMG_fcast_bHYPRE_Solver(
...
extern struct bHYPRE_StructSMG__object* 
  ...
  sidl_BaseInterface *_ex);
extern struct bHYPRE_StructSMG__object* 
  impl_bHYPRE_StructSMG_fcast_bHYPRE_StructSMG(void* bi, sidl_BaseInterface* 
  _ex);
extern struct bHYPRE_Vector__object* 
  impl_bHYPRE_StructSMG_fconnect_bHYPRE_Vector(const char* url, sidl_bool ar, 
  sidl_BaseInterface *_ex);
extern struct bHYPRE_Vector__object* impl_bHYPRE_StructSMG_fcast_bHYPRE_Vector(
  void* bi, sidl_BaseInterface* _ex);
...
struct bHYPRE_Operator__object* skel_bHYPRE_StructSMG_fconnect_bHYPRE_Operator(
...
struct bHYPRE_StructMatrix__object* 
  skel_bHYPRE_StructSMG_fconnect_bHYPRE_StructMatrix(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_StructSMG_fconnect_bHYPRE_StructMatrix(url, ar, _ex);
}

struct bHYPRE_StructMatrix__object* 
  skel_bHYPRE_StructSMG_fcast_bHYPRE_StructMatrix(void* bi, sidl_BaseInterface 
  *_ex) { 
...
struct sidl_BaseInterface__object* 
  skel_bHYPRE_StructSMG_fconnect_sidl_BaseInterface(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex) { 
  return impl_bHYPRE_StructSMG_fconnect_sidl_BaseInterface(url, ar, _ex);
}

struct sidl_BaseInterface__object* 
  skel_bHYPRE_StructSMG_fcast_sidl_BaseInterface(void* bi, sidl_BaseInterface 
  *_ex) { 
