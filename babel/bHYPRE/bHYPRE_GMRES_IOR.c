...
static int32_t
remote_bHYPRE_GMRES_SetIntArrayParameter(
  struct bHYPRE_GMRES__object* self,
  const char* name,
...
static int32_t
remote_bHYPRE_GMRES_SetDoubleArrayParameter(
  struct bHYPRE_GMRES__object* self,
  const char* name,
...
static void bHYPRE_GMRES__init_remote_epv(void)
{
  ...
  epv->f_SetIntArrayParameter    = remote_bHYPRE_GMRES_SetIntArrayParameter;
  epv->f_SetDoubleArrayParameter = remote_bHYPRE_GMRES_SetDoubleArrayParameter;
