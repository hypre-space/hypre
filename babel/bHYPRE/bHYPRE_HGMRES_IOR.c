...
bHYPRE_HGMRES_SetPreconditioner__exec(
        ...
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  struct bHYPRE_Solver__object* s = 0;
  int32_t _retval = 0;
  sidl_BaseInterface _ex   = NULL;
  sidl_BaseInterface *_ex2 = &_ex;
  /* unpack in and inout argments */
...
bHYPRE_HGMRES_GetPreconditioner__exec(
        ...
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  struct bHYPRE_Solver__object* s_tmp = 0;
...
bHYPRE_HGMRES_Clone__exec(
        ...
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  struct bHYPRE_PreconditionedSolver__object* x_tmp = 0;
...
ior_bHYPRE_HGMRES__exec(
  ...
  static const struct bHYPRE_HGMRES__method  s_methods[] = {
    ...
    { "queryInt", bHYPRE_HGMRES_queryInt__exec }
  };
  int i, cmp, l = 0;
...
static void bHYPRE_HGMRES__init_epv(
  struct bHYPRE_HGMRES__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                        = (void (*)(struct 
    bHYPRE_HGMRES__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                     = (void (*)(struct 
    bHYPRE_HGMRES__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_HGMRES__object*,
    struct sidl_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                      = (struct sidl_BaseInterface__object* 
    (*)(struct bHYPRE_HGMRES__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_HGMRES__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* 
    (*)(struct bHYPRE_HGMRES__object*)) s1->d_epv->f_getClassInfo;
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.HGMRES");
...
static void
initMetadata(struct bHYPRE_HGMRES__object* self)
{
  if (self) {
