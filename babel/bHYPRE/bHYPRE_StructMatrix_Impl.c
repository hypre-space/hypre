...
#undef __FUNC__
#define __FUNC__ "impl_bHYPRE_StructMatrix_SetIntArrayParameter"

int32_t
impl_bHYPRE_StructMatrix_SetIntArrayParameter(
  bHYPRE_StructMatrix self, const char* name, struct SIDL_int__array* value)
{
  /* DO-NOT-DELETE splicer.begin(bHYPRE.StructMatrix.SetIntArrayParameter) */
  /* Insert the implementation of the SetIntArrayParameter method here... */
   return 1;
  /* DO-NOT-DELETE splicer.end(bHYPRE.StructMatrix.SetIntArrayParameter) */
}
...
#undef __FUNC__
#define __FUNC__ "impl_bHYPRE_StructMatrix_SetDoubleArrayParameter"

int32_t
impl_bHYPRE_StructMatrix_SetDoubleArrayParameter(
  bHYPRE_StructMatrix self, const char* name, struct SIDL_double__array* value)
{
  /* DO-NOT-DELETE splicer.begin(bHYPRE.StructMatrix.SetDoubleArrayParameter) */
  /* Insert the implementation of the SetDoubleArrayParameter method here... */
   return 1;
  /* DO-NOT-DELETE splicer.end(bHYPRE.StructMatrix.SetDoubleArrayParameter) */
}
