...
#undef __FUNC__
#define __FUNC__ "impl_bHYPRE_SStructMatrix_SetIntArrayParameter"

int32_t
impl_bHYPRE_SStructMatrix_SetIntArrayParameter(
  bHYPRE_SStructMatrix self, const char* name, struct SIDL_int__array* value)
{
  /* DO-NOT-DELETE splicer.begin(bHYPRE.SStructMatrix.SetIntArrayParameter) */
  /* Insert the implementation of the SetIntArrayParameter method here... */
  /* DO-NOT-DELETE splicer.end(bHYPRE.SStructMatrix.SetIntArrayParameter) */
}
...
#undef __FUNC__
#define __FUNC__ "impl_bHYPRE_SStructMatrix_SetDoubleArrayParameter"
...
{
  /* DO-NOT-DELETE splicer.begin(bHYPRE.SStructMatrix.SetDoubleArrayParameter) */
  /* Insert the implementation of the SetDoubleArrayParameter method here... */
  /* DO-NOT-DELETE splicer.end(bHYPRE.SStructMatrix.SetDoubleArrayParameter) */
}
