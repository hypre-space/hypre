...
bHYPRE_StructMatrix_SetCommunicator__exec(
  ...
  mpi_comm = 
    skel_bHYPRE_StructMatrix_fconnect_bHYPRE_MPICommunicator(mpi_comm_str,
    _ex2);
...
bHYPRE_StructMatrix_SetValues__exec(
  ...
  struct sidl_int__array* stencil_indices = 0;
...
bHYPRE_StructMatrix_SetConstantEntries__exec(
        ...
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  struct sidl_int__array* stencil_constant_points = 0;
  int32_t _retval = 0;
  sidl_BaseInterface _ex   = NULL;
  sidl_BaseInterface *_ex2 = &_ex;
  /* unpack in and inout argments */
