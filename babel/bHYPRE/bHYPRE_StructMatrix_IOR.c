...
bHYPRE_StructMatrix_SetConstantEntries__exec(
  ...
  sidl_rmi_Call_unpackIntArray( inArgs, "stencil_constant_points", 
    &stencil_constant_points,sidl_column_major_order,1,TRUE, _ex);SIDL_CHECK(
    *_ex);
...
bHYPRE_StructMatrix_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str, 
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = skel_bHYPRE_StructMatrix_fconnect_bHYPRE_MPICommunicator(
...
ior_bHYPRE_StructMatrix__exec(
  ...
  static const struct bHYPRE_StructMatrix__method  s_methods[] = {
    ...
    { "SetIntArray1Parameter", bHYPRE_StructMatrix_SetIntArray1Parameter__exec 
      },
    { "SetIntArray2Parameter", bHYPRE_StructMatrix_SetIntArray2Parameter__exec 
      },
 ...
 */
  ...
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_StructMatrix__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_StructMatrix__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* (*)(
    struct bHYPRE_StructMatrix__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
  epv->f_SetGrid                       = NULL;
