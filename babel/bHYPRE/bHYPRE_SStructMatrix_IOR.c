...
static void
bHYPRE_SStructMatrix_queryInt__exec(
        struct bHYPRE_SStructMatrix__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
...
bHYPRE_SStructMatrix_SetValues__exec(
  ...
  int32_t var = 0;
  struct sidl_int__array* entries = 0;
...
static void ior_bHYPRE_SStructMatrix__delete(
  struct bHYPRE_SStructMatrix__object* self)
{
  bHYPRE_SStructMatrix__fini(self);
...
ior_bHYPRE_SStructMatrix__exec(
  ...
  static const struct bHYPRE_SStructMatrix__method  s_methods[] = {
    ...
    { "queryInt", bHYPRE_SStructMatrix_queryInt__exec }
  };
  int i, cmp, l = 0;
...
static void bHYPRE_SStructMatrix__init_epv(
  struct bHYPRE_SStructMatrix__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                        = (void (*)(struct 
    bHYPRE_SStructMatrix__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                     = (void (*)(struct 
    bHYPRE_SStructMatrix__object*)) s1->d_epv->f_deleteRef;
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.SStructMatrix");
...
static void
initMetadata(struct bHYPRE_SStructMatrix__object* self)
{
  if (self) {
...
bHYPRE_SStructMatrix__new(void)
{
  ...
  bHYPRE_SStructMatrix__init(self);
  initMetadata(self);
  return self;
}
  ...
  struct bHYPRE_SStructMatrix__object* self)
{
  ...
  if (!s_method_initialized) {
    bHYPRE_SStructMatrix__init_epv(s0);
  }
  UNLOCK_STATIC_GLOBALS;
