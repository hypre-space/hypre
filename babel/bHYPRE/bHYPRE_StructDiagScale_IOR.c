...
bHYPRE_StructDiagScale_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str,
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = 
    skel_bHYPRE_StructDiagScale_fconnect_bHYPRE_MPICommunicator(mpi_comm_str,
 ...
 */
  ...
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_StructDiagScale__object*,const char*,
...
static void
initMetadata(struct bHYPRE_StructDiagScale__object* self,
