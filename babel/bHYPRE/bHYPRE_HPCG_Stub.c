...
static const struct bHYPRE_HPCG__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_HPCG__external* _loadIOR(void)
/*
...

{
  ...
  _externals = bHYPRE_HPCG__externals();
#else
  _externals = (struct bHYPRE_HPCG__external*)sidl_dynamicLoadIOR("bHYPRE.HPCG",
...
static bHYPRE_HPCG bHYPRE_HPCG__remote(const char* url,
...
{
  return bHYPRE_HPCG__remote(url, _ex);
}
...
bHYPRE_HPCG
bHYPRE_HPCG__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_HPCG__remoteConnect(url, _ex);
}
...
bHYPRE_HPCG__cast(
  void* obj)
{
  bHYPRE_HPCG cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.HPCG",
      (void*)bHYPRE_HPCG__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_HPCG) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.HPCG");
  }
...
bHYPRE_HPCG__sexec(
        ...
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_HPCG__smethod s_methods[] = {
    { "Create", bHYPRE_HPCG_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_HPCG__smethod);
  if (methodName) {
...
bHYPRE_HPCG__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_HPCG__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
bHYPRE_HPCG__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_HPCG__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct bHYPRE_HPCG__array*)sidl_interface__array_create1d(len);
}
...
bHYPRE_HPCG__array_create1dInit(
  ...
  bHYPRE_HPCG* data)
{
  return (struct bHYPRE_HPCG__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct bHYPRE_HPCG__array*)sidl_interface__array_create2dCol(m, n);
}

struct bHYPRE_HPCG__array*
bHYPRE_HPCG__array_create2dRow(int32_t m, int32_t n)
{
  return (struct bHYPRE_HPCG__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_HPCG__array*)sidl_interface__array_borrow(
...
{
  return (struct bHYPRE_HPCG__array*)
...
const char* name)
{
  ...
  else if(bHYPRE_HPCG_isType(self, name)) {
...
remote_bHYPRE_HPCG_addRef(
  /* in */ struct bHYPRE_HPCG__object* self /* TLD */)
{
...
static void bHYPRE_HPCG__init_remote_epv(void)
{
  ...
  epv->f_queryInt                      = remote_bHYPRE_HPCG_queryInt;
...
static struct bHYPRE_HPCG__object*
bHYPRE_HPCG__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_HPCG__object* self;
...
static struct bHYPRE_HPCG__object*
bHYPRE_HPCG__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_HPCG__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.HPCG", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_HPCG__object*) malloc(
      sizeof(struct bHYPRE_HPCG__object));
