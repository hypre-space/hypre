...
static bHYPRE_ParCSRDiagScale bHYPRE_ParCSRDiagScale__remote(const char* url,
...
{
  return bHYPRE_ParCSRDiagScale__remote(url, _ex);
}

static struct bHYPRE_ParCSRDiagScale__object* 
  bHYPRE_ParCSRDiagScale__remoteConnect(const char* url,
  sidl_BaseInterface *_ex);
static struct bHYPRE_ParCSRDiagScale__object* 
...
{
  return bHYPRE_ParCSRDiagScale__remoteConnect(url, _ex);
}
...
void
bHYPRE_ParCSRDiagScale_Create__sexec(
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.ParCSRDiagScale",
      (void*)bHYPRE_ParCSRDiagScale__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
struct bHYPRE_ParCSRDiagScale__smethod {
  const char *d_name;
...
void
bHYPRE_ParCSRDiagScale__sexec(
        const char* methodName,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_ParCSRDiagScale__smethod s_methods[] = {
    { "Create", bHYPRE_ParCSRDiagScale_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_ParCSRDiagScale__smethod);
  if (methodName) {
...
const char* name)
{
  ...
  else if(bHYPRE_ParCSRDiagScale_isType(self, name)) {
...
remote_bHYPRE_ParCSRDiagScale_addRef(
  /* in */ struct bHYPRE_ParCSRDiagScale__object* self /* TLD */)
{
...
static struct bHYPRE_ParCSRDiagScale__object*
bHYPRE_ParCSRDiagScale__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_ParCSRDiagScale__object* self;
...
static struct bHYPRE_ParCSRDiagScale__object*
bHYPRE_ParCSRDiagScale__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_ParCSRDiagScale__object* self;
