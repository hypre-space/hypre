...
static const struct bHYPRE_ParCSRDiagScale__external *_externals = NULL;
/*
...

{
  ...
  _externals = bHYPRE_ParCSRDiagScale__externals();
#else
  _externals = (struct bHYPRE_ParCSRDiagScale__external*)sidl_dynamicLoadIOR(
    "bHYPRE.ParCSRDiagScale","bHYPRE_ParCSRDiagScale__externals") ;
  sidl_checkIORVersion("bHYPRE.ParCSRDiagScale", 
...
static bHYPRE_ParCSRDiagScale bHYPRE_ParCSRDiagScale__remoteCreate(const char* 
...
bHYPRE_ParCSRDiagScale
bHYPRE_ParCSRDiagScale__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_ParCSRDiagScale__remoteCreate(url, _ex);
}

static struct bHYPRE_ParCSRDiagScale__object* 
  bHYPRE_ParCSRDiagScale__remoteConnect(const char* url, sidl_bool ar, 
  sidl_BaseInterface *_ex);
static struct bHYPRE_ParCSRDiagScale__object* bHYPRE_ParCSRDiagScale__IHConnect(
...
bHYPRE_ParCSRDiagScale
bHYPRE_ParCSRDiagScale__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_ParCSRDiagScale__remoteConnect(url, TRUE, _ex);
}
...
{
  bHYPRE_ParCSRDiagScale _result;
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.ParCSRDiagScale", (
      void*)bHYPRE_ParCSRDiagScale__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
void
bHYPRE_ParCSRDiagScale__set_hooks_static(
  int32_t on,
...
SIDL_C_INLINE_DEFN
void
bHYPRE_ParCSRDiagScale__set_hooks(
  /* in */ bHYPRE_ParCSRDiagScale self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
bHYPRE_ParCSRDiagScale__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_ParCSRDiagScale__isRemote(self,_ex);
}
...
bHYPRE_ParCSRDiagScale__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_ParCSRDiagScale__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
bHYPRE_ParCSRDiagScale__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_ParCSRDiagScale__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct bHYPRE_ParCSRDiagScale__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct 
    bHYPRE_ParCSRDiagScale__array*)sidl_interface__array_create1dInit(len, (
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    if (!cmp1) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = ((struct bHYPRE_ParCSRDiagScale__object*)self);
      return cast;
    }
    else if (cmp1 < 0) {
...
bHYPRE_ParCSRDiagScale__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "bHYPRE.ParCSRDiagScale", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_ParCSRDiagScale__object*) malloc(
      sizeof(struct bHYPRE_ParCSRDiagScale__object));
