...
bHYPRE_PCG_SetOperator__exec(
  ...
  A = skel_bHYPRE_PCG_fconnect_bHYPRE_Operator(A_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_PCG_Apply__exec(
  ...
  b = skel_bHYPRE_PCG_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  *x = skel_bHYPRE_PCG_fconnect_bHYPRE_Vector(x_str, FALSE,
    _ex);SIDL_CHECK(*_ex);
 ...
 */
  ...
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_PCG__object*,struct sidl_BaseInterface__object*,
    struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_PCG__object*,const char*,
