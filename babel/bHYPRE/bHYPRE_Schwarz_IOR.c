...
bHYPRE_Schwarz_SetOperator__exec(
  ...
  A = skel_bHYPRE_Schwarz_fconnect_bHYPRE_Operator(A_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_Schwarz_Setup__exec(
  ...
  b = skel_bHYPRE_Schwarz_fconnect_bHYPRE_Vector(b_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  x = skel_bHYPRE_Schwarz_fconnect_bHYPRE_Vector(x_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_Schwarz_Apply__exec(
  ...
  b = skel_bHYPRE_Schwarz_fconnect_bHYPRE_Vector(b_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  *x = skel_bHYPRE_Schwarz_fconnect_bHYPRE_Vector(x_str, FALSE,
    _ex);SIDL_CHECK(*_ex);
 ...
 */
  ...
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_Schwarz__object*,const char*,
