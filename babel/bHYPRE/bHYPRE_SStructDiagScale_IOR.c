...
static void
bHYPRE_SStructDiagScale_queryInt__exec(
        struct bHYPRE_SStructDiagScale__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  ...
  const char* name)
{
  ...
  if (!strcmp(name, "bHYPRE.SStructDiagScale")) {
    cast = (void*) s0;
...
static void ior_bHYPRE_SStructDiagScale__delete(
  struct bHYPRE_SStructDiagScale__object* self)
{
  bHYPRE_SStructDiagScale__fini(self);
...
ior_bHYPRE_SStructDiagScale__exec(
  ...
  static const struct bHYPRE_SStructDiagScale__method  s_methods[] = {
    ...
    { "queryInt", bHYPRE_SStructDiagScale_queryInt__exec }
  };
  int i, cmp, l = 0;
...
static void bHYPRE_SStructDiagScale__init_epv(
  struct bHYPRE_SStructDiagScale__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                        = (void (*)(struct 
    bHYPRE_SStructDiagScale__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                     = (void (*)(struct 
    bHYPRE_SStructDiagScale__object*)) s1->d_epv->f_deleteRef;
  ...
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_SStructDiagScale__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* 
    (*)(struct bHYPRE_SStructDiagScale__object*)) s1->d_epv->f_getClassInfo;
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.SStructDiagScale");
  ...
  struct bHYPRE_SStructDiagScale__object* self)
{
  ...
  if (!s_method_initialized) {
    bHYPRE_SStructDiagScale__init_epv(s0);
  }
  UNLOCK_STATIC_GLOBALS;
