...
bHYPRE_SStructDiagScale_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str,
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = 
    skel_bHYPRE_SStructDiagScale_fconnect_bHYPRE_MPICommunicator(mpi_comm_str,
    TRUE, _ex);SIDL_CHECK(*_ex);
 ...
 */
  ...
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_SStructDiagScale__object*,const char*,
...
static void
initMetadata(struct bHYPRE_SStructDiagScale__object* self,
