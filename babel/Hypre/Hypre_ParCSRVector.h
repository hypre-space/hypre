 ...
 */
void
Hypre_ParCSRVector__array_addReference(struct Hypre_ParCSRVector__array* array);
 ...
 */
void
Hypre_ParCSRVector__array_deleteReference(struct Hypre_ParCSRVector__array* 
  array);
