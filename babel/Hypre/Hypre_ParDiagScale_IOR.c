...
static void* Hypre_ParDiagScale__cast(
...
static void Hypre_ParDiagScale__delete(
  struct Hypre_ParDiagScale__object* self)
{
  ...
  struct Hypre_ParDiagScale__object* self)
{
  ...
  epv->f__cast                   = Hypre_ParDiagScale__cast;
  epv->f__delete                 = Hypre_ParDiagScale__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_Apply                   = NULL;
  ...
  epv->f_addReference            = (void (*)(struct 
    Hypre_ParDiagScale__object*)) s1->d_epv->f_addReference;
  epv->f_deleteReference         = (void (*)(struct 
    Hypre_ParDiagScale__object*)) s1->d_epv->f_deleteReference;
  epv->f_isInstanceOf            = (SIDL_bool (*)(struct 
    Hypre_ParDiagScale__object*,const char*)) s1->d_epv->f_isInstanceOf;
...
struct Hypre_ParDiagScale__array {
  struct Hypre_ParDiagScale__object** d_firstElement;
  int32_t                             *d_lower;
  int32_t                             *d_upper;
  int32_t                             *d_stride;
...
static struct Hypre_ParDiagScale__array*
newArray(int32_t dimen, const int32_t lower[], const int32_t upper[]) {
  static const size_t arraySize = sizeof(struct Hypre_ParDiagScale__array)
    + (sizeof(int32_t) - (sizeof(struct Hypre_ParDiagScale__array)
    % sizeof(int32_t))) % sizeof(int32_t);
  struct Hypre_ParDiagScale__array *result =
    (struct Hypre_ParDiagScale__array *)
...
struct Hypre_ParDiagScale__array*
Hypre_ParDiagScale__iorarray_create(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  int32_t size=1, i;
  struct Hypre_ParDiagScale__array *result = newArray(dimen, lower, upper);
  for(i = 0; i < dimen; ++i) {
    result->d_stride[i] = size;
    size *= (1 + upper[i] - lower[i]);
  }
  size *= sizeof(struct Hypre_ParDiagScale__object*);
  result->d_firstElement = (struct Hypre_ParDiagScale__object**)
    malloc(size);
...
struct Hypre_ParDiagScale__array*
Hypre_ParDiagScale__iorarray_borrow(
...
void
Hypre_ParDiagScale__iorarray_destroy(
  struct Hypre_ParDiagScale__array* array)
{
  if (array) {
    ...
    if (!(array->d_borrowed)) {
      if (dimen > 0) {
        int32_t size = 1;
        struct Hypre_ParDiagScale__object** start = array->d_firstElement;
        struct Hypre_ParDiagScale__object** end;
        if (dimen > 1) {
    ...
    memset(array, 0, sizeof(struct Hypre_ParDiagScale__array)
...
struct Hypre_ParDiagScale__object*
Hypre_ParDiagScale__iorarray_get(
  const struct Hypre_ParDiagScale__array* array,
  const int32_t                           indices[])
{
  struct Hypre_ParDiagScale__object** result = NULL;
...
void
Hypre_ParDiagScale__iorarray_set(
  struct Hypre_ParDiagScale__array*  array,
  const int32_t                      indices[],
...
struct Hypre_ParDiagScale__object*
Hypre_ParDiagScale__iorarray_get4(
  const struct Hypre_ParDiagScale__array* array,
  int32_t                                 i1,
  int32_t                                 i2,
  int32_t                                 i3,
...
void
Hypre_ParDiagScale__iorarray_set4(
  struct Hypre_ParDiagScale__array*  array,
  int32_t                            i1,
  int32_t                            i2,
  int32_t                            i3,
...
int32_t
Hypre_ParDiagScale__iorarray_dimen(const struct Hypre_ParDiagScale__array 
  *array)
{
...
int32_t
Hypre_ParDiagScale__iorarray_lower(const struct Hypre_ParDiagScale__array 
  *array, int32_t ind)
{
...
int32_t
Hypre_ParDiagScale__iorarray_upper(const struct Hypre_ParDiagScale__array 
  *array, int32_t ind)
{
  return (array && (ind < array->d_dimen) && (ind >= 0))
    ? array->d_upper[ind] : -1;
...
s_externalEntryPoints = {
  ...
  Hypre_ParDiagScale__iorarray_borrow,
  Hypre_ParDiagScale__iorarray_destroy,
  Hypre_ParDiagScale__iorarray_dimen,
  Hypre_ParDiagScale__iorarray_lower,
  Hypre_ParDiagScale__iorarray_upper,
  Hypre_ParDiagScale__iorarray_get,
  Hypre_ParDiagScale__iorarray_get4,
  Hypre_ParDiagScale__iorarray_set,
  Hypre_ParDiagScale__iorarray_set4
...
static void
remote_Hypre_ParDiagScale_addReference(
  struct Hypre_ParDiagScale__object* self)
{
}
...
static void
remote_Hypre_ParDiagScale_deleteReference(
  struct Hypre_ParDiagScale__object* self)
{
}
...
static SIDL_bool
remote_Hypre_ParDiagScale_isInstanceOf(
  struct Hypre_ParDiagScale__object* self,
  const char* name)
{
  return 0;
...
remote_Hypre_ParDiagScale_queryInterface(
  struct Hypre_ParDiagScale__object* self,
  const char* name)
{
...
static void Hypre_ParDiagScale__init_remote_epv(void)
{
  ...
  epv->f_addReference            = remote_Hypre_ParDiagScale_addReference;
  epv->f_deleteReference         = remote_Hypre_ParDiagScale_deleteReference;
  epv->f_isInstanceOf            = remote_Hypre_ParDiagScale_isInstanceOf;
  epv->f_isSame                  = remote_Hypre_ParDiagScale_isSame;
  epv->f_queryInterface          = remote_Hypre_ParDiagScale_queryInterface;
