...
impl_Hypre_ParAMG_GetDoubleValue(
  Hypre_ParAMG self, const char* name, double* value)
{
...
impl_Hypre_ParAMG_GetIntValue(
  Hypre_ParAMG self, const char* name, int32_t* value)
{
  ...
  Hypre_ParAMG self, const char* name, int32_t value)
{
  ...
  /* Insert the implementation of the SetIntParameter method here... */
   ...
   else if ( strcmp(name,"SmoothType")==0 || strcmp(name,"Smooth Type")==0 ) {
      HYPRE_BoomerAMGSetSmoothType( solver, value );
   }
   else if ( strcmp(name,"SmoothNumLevels")==0 || strcmp(name,"Smooth Num Levels")==0 ) {
      HYPRE_BoomerAMGSetSmoothNumLevels( solver, value );
   }
   else if ( strcmp(name,"SmoothNumSweeps")==0 || strcmp(name,"Smooth Num Sweeps")==0 ) {
      HYPRE_BoomerAMGSetSmoothNumSweeps( solver, value );
   }
...
impl_Hypre_ParAMG_SetStringParameter(
  Hypre_ParAMG self, const char* name, const char* value)
{
...
impl_Hypre_ParAMG_SetIntArrayParameter(
  Hypre_ParAMG self, const char* name, struct SIDL_int__array* value)
{
...
/* strides don't seem to be supported in babel 0.6:   int stride = SIDL_int__array_stride( value, 0 );
   ...
   if ( strcmp(name,"NumGridSweeps")==0 || strcmp(name,"Num Grid Sweeps")==0 ||
      ...
      assert("SmoothOption is obsolete"==0);
   }
...
impl_Hypre_ParAMG_SetDoubleArrayParameter(
  Hypre_ParAMG self, const char* name, struct SIDL_double__array* value)
{
...
impl_Hypre_ParAMG_SetOperator(
  Hypre_ParAMG self, Hypre_Operator A)
{
...
impl_Hypre_ParAMG_GetResidual(
  Hypre_ParAMG self, Hypre_Vector* r)
{
...
impl_Hypre_ParAMG_SetLogging(
  Hypre_ParAMG self, int32_t level)
{
