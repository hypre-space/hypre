  ...
  struct Hypre_StructMatrix__object* self)
{
  ...
  epv->f_Setup           = NULL;
  epv->f_addReference    = (void (*)(struct Hypre_StructMatrix__object*)) 
    s1->d_epv->f_addReference;
  epv->f_deleteReference = (void (*)(struct Hypre_StructMatrix__object*)) 
    s1->d_epv->f_deleteReference;
  epv->f_isInstanceOf    = (SIDL_bool (*)(struct Hypre_StructMatrix__object*,
    const char*)) s1->d_epv->f_isInstanceOf;
  epv->f_isSame          = (SIDL_bool (*)(struct Hypre_StructMatrix__object*,
    struct SIDL_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInterface  = (struct SIDL_BaseInterface__object* (*)(struct 
    Hypre_StructMatrix__object*,const char*)) s1->d_epv->f_queryInterface;
...
struct Hypre_StructMatrix__array {
  struct Hypre_StructMatrix__object** d_firstElement;
  int32_t                             *d_lower;
  int32_t                             *d_upper;
  int32_t                             *d_stride;
...
static struct Hypre_StructMatrix__array*
newArray(int32_t dimen, const int32_t lower[], const int32_t upper[]) {
  static const size_t arraySize = sizeof(struct Hypre_StructMatrix__array)
    + (sizeof(int32_t) - (sizeof(struct Hypre_StructMatrix__array)
    % sizeof(int32_t))) % sizeof(int32_t);
  struct Hypre_StructMatrix__array *result =
    (struct Hypre_StructMatrix__array *)
...
{
  int32_t size=1, i;
  struct Hypre_StructMatrix__array *result = newArray(dimen, lower, upper);
  for(i = 0; i < dimen; ++i) {
    result->d_stride[i] = size;
    size *= (1 + upper[i] - lower[i]);
  }
  size *= sizeof(struct Hypre_StructMatrix__object*);
  result->d_firstElement = (struct Hypre_StructMatrix__object**)
    malloc(size);
  ...
  struct Hypre_StructMatrix__array* array)
{
  if (array) {
    ...
    if (!(array->d_borrowed)) {
      if (dimen > 0) {
        int32_t size = 1;
        struct Hypre_StructMatrix__object** start = array->d_firstElement;
        struct Hypre_StructMatrix__object** end;
        if (dimen > 1) {
    ...
    memset(array, 0, sizeof(struct Hypre_StructMatrix__array)
...
{
  struct Hypre_StructMatrix__object** result = NULL;
...
s_externalEntryPoints = {
  ...
  Hypre_StructMatrix__iorarray_borrow,
  Hypre_StructMatrix__iorarray_destroy,
  Hypre_StructMatrix__iorarray_dimen,
  Hypre_StructMatrix__iorarray_lower,
  Hypre_StructMatrix__iorarray_upper,
  Hypre_StructMatrix__iorarray_get,
  Hypre_StructMatrix__iorarray_get4,
  Hypre_StructMatrix__iorarray_set,
  Hypre_StructMatrix__iorarray_set4
...
static int32_t
remote_Hypre_StructMatrix_SetParameter(
  struct Hypre_StructMatrix__object* self,
  const char* name,
  double value)
{
...
static void Hypre_StructMatrix__init_remote_epv(void)
{
  ...
  epv->f_SetParameter    = remote_Hypre_StructMatrix_SetParameter;
