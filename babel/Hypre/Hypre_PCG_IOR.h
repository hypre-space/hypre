 ...
 * Generated:     20021001 09:48:47 PDT
...
struct Hypre_PCG__external {
  ...
  int32_t
  (*getDimen)(const struct Hypre_PCG__array *array);

  int32_t
  (*getLower)(const struct Hypre_PCG__array *array, int32_t ind);

  int32_t
  (*getUpper)(const struct Hypre_PCG__array *array, int32_t ind);
