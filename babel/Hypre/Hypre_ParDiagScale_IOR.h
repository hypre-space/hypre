...
struct Hypre_ParDiagScale__epv {
  ...
  int32_t (*f_SetPrintLevel)(
    struct Hypre_ParDiagScale__object* self,
    int32_t level);
  /* Methods introduced in Hypre.ParDiagScale-v0.1.5 */
};
...
struct Hypre_ParDiagScale__external {
  ...
  int32_t
  (*getDimen)(const struct Hypre_ParDiagScale__array *array);

  int32_t
  (*getLower)(const struct Hypre_ParDiagScale__array *array, int32_t ind);

  int32_t
  (*getUpper)(const struct Hypre_ParDiagScale__array *array, int32_t ind);
