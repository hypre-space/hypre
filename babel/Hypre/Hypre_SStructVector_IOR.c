/*
 * File:          Hypre_SStructVector_IOR.c
...
static struct Hypre_SStructVector__epv s_new__hypre_sstructvector;
static struct Hypre_SStructVector__epv s_rem__hypre_sstructvector;
...
extern void Hypre_SStructVector__set_epv(
  struct Hypre_SStructVector__epv* epv);

/*
 * CAST: dynamic type casting support.
 */

static void* ior_Hypre_SStructVector__cast(
  struct Hypre_SStructVector__object* self,
  const char* name)
{
  void* cast = NULL;

  struct Hypre_SStructVector__object* s0 = self;
  struct SIDL_BaseClass__object*      s1 = &s0->d_sidl_baseclass;

  if (!strcmp(name, "Hypre.SStructVector")) {
    cast = (void*) s0;
...
static void ior_Hypre_SStructVector__delete(
  struct Hypre_SStructVector__object* self)
{
  Hypre_SStructVector__fini(self);
  memset((void*)self, 0, sizeof(struct Hypre_SStructVector__object));
  free((void*) self);
}
...
static void Hypre_SStructVector__init_epv(
  struct Hypre_SStructVector__object* self)
{
  struct Hypre_SStructVector__object* s0 = self;
  struct SIDL_BaseClass__object*      s1 = &s0->d_sidl_baseclass;

  struct Hypre_SStructVector__epv*      epv = &s_new__hypre_sstructvector;
  ...
  epv->f__cast           = ior_Hypre_SStructVector__cast;
  epv->f__delete         = ior_Hypre_SStructVector__delete;
  epv->f__ctor           = NULL;
  epv->f__dtor           = NULL;
  epv->f_addRef          = (void (*)(struct Hypre_SStructVector__object*)) 
    s1->d_epv->f_addRef;
  epv->f_deleteRef       = (void (*)(struct Hypre_SStructVector__object*)) 
    s1->d_epv->f_deleteRef;
  epv->f_isSame          = (SIDL_bool (*)(struct Hypre_SStructVector__object*,
    struct SIDL_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt        = (struct SIDL_BaseInterface__object* (*)(struct 
    Hypre_SStructVector__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType          = (SIDL_bool (*)(struct Hypre_SStructVector__object*,
    const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo    = (struct SIDL_ClassInfo__object* (*)(struct 
    Hypre_SStructVector__object*)) s1->d_epv->f_getClassInfo;
  ...
  Hypre_SStructVector__set_epv(epv);
...
initClassInfo(SIDL_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      SIDL_ClassInfoI_setName(impl, "Hypre.SStructVector");
...
static void
initMetadata(struct Hypre_SStructVector__object* self)
{
  if (self) {
...
{
  struct Hypre_SStructVector__object* self =
    (struct Hypre_SStructVector__object*) malloc(
      sizeof(struct Hypre_SStructVector__object));
  Hypre_SStructVector__init(self);
  initMetadata(self);
  return self;
}
...
void Hypre_SStructVector__init(
  struct Hypre_SStructVector__object* self)
{
  struct Hypre_SStructVector__object* s0 = self;
  struct SIDL_BaseClass__object*      s1 = &s0->d_sidl_baseclass;
  ...
  if (!s_method_initialized) {
    Hypre_SStructVector__init_epv(s0);
  }
  ...
  s0->d_epv                            = &s_new__hypre_sstructvector;
...
void Hypre_SStructVector__fini(
  struct Hypre_SStructVector__object* self)
{
  struct Hypre_SStructVector__object* s0 = self;
  struct SIDL_BaseClass__object*      s1 = &s0->d_sidl_baseclass;
...
void
Hypre_SStructVector__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}
static const struct Hypre_SStructVector__external
s_externalEntryPoints = {
  Hypre_SStructVector__new,
  Hypre_SStructVector__remote,
};
...
static void* remote_Hypre_SStructVector__cast(
  struct Hypre_SStructVector__object* self,
  const char* name)
{
  return NULL;
...
static void remote_Hypre_SStructVector__delete(
  struct Hypre_SStructVector__object* self)
{
  free((void*) self);
}
...
static void
remote_Hypre_SStructVector_addRef(
  struct Hypre_SStructVector__object* self)
{
}
...
static void
remote_Hypre_SStructVector_deleteRef(
  struct Hypre_SStructVector__object* self)
{
}
...
static SIDL_bool
remote_Hypre_SStructVector_isSame(
  struct Hypre_SStructVector__object* self,
...
remote_Hypre_SStructVector_queryInt(
  struct Hypre_SStructVector__object* self,
  const char* name)
{
...
static SIDL_bool
remote_Hypre_SStructVector_isType(
  struct Hypre_SStructVector__object* self,
  const char* name)
{
  return 0;
...
remote_Hypre_SStructVector_getClassInfo(
  struct Hypre_SStructVector__object* self)
{
...
static int32_t
remote_Hypre_SStructVector_SetCommunicator(
  struct Hypre_SStructVector__object* self,
  void* mpi_comm)
{
  return 0;
...
static int32_t
remote_Hypre_SStructVector_Initialize(
  struct Hypre_SStructVector__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_SStructVector_Assemble(
  struct Hypre_SStructVector__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_SStructVector_GetObject(
  struct Hypre_SStructVector__object* self,
...
static int32_t
remote_Hypre_SStructVector_SetGrid(
  struct Hypre_SStructVector__object* self,
...
static int32_t
remote_Hypre_SStructVector_SetValues(
  struct Hypre_SStructVector__object* self,
  int32_t part,
...
static int32_t
remote_Hypre_SStructVector_SetBoxValues(
  struct Hypre_SStructVector__object* self,
  int32_t part,
...
static int32_t
remote_Hypre_SStructVector_AddToValues(
  struct Hypre_SStructVector__object* self,
  int32_t part,
  struct SIDL_int__array* index,
  int32_t var,
...
static int32_t
remote_Hypre_SStructVector_AddToBoxValues(
  struct Hypre_SStructVector__object* self,
  int32_t part,
  struct SIDL_int__array* ilower,
  struct SIDL_int__array* iupper,
...
static int32_t
remote_Hypre_SStructVector_Gather(
  struct Hypre_SStructVector__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_SStructVector_GetValues(
  struct Hypre_SStructVector__object* self,
  int32_t part,
  struct SIDL_int__array* index,
  int32_t var,
...
static int32_t
remote_Hypre_SStructVector_GetBoxValues(
  struct Hypre_SStructVector__object* self,
  int32_t part,
  struct SIDL_int__array* ilower,
  struct SIDL_int__array* iupper,
...
static int32_t
remote_Hypre_SStructVector_SetComplex(
  struct Hypre_SStructVector__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_SStructVector_Print(
  struct Hypre_SStructVector__object* self,
  const char* filename,
  int32_t all)
{
...
static int32_t
remote_Hypre_SStructVector_Clear(
  struct Hypre_SStructVector__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_SStructVector_Copy(
  struct Hypre_SStructVector__object* self,
...
static int32_t
remote_Hypre_SStructVector_Clone(
  struct Hypre_SStructVector__object* self,
  struct Hypre_Vector__object** x)
{
  return 0;
...
static int32_t
remote_Hypre_SStructVector_Scale(
  struct Hypre_SStructVector__object* self,
  double a)
{
  return 0;
...
static int32_t
remote_Hypre_SStructVector_Dot(
  struct Hypre_SStructVector__object* self,
  struct Hypre_Vector__object* x,
  double* d)
{
...
static int32_t
remote_Hypre_SStructVector_Axpy(
  struct Hypre_SStructVector__object* self,
  double a,
  struct Hypre_Vector__object* x)
{
...
static void Hypre_SStructVector__init_remote_epv(void)
{
  struct Hypre_SStructVector__epv*      epv = &s_rem__hypre_sstructvector;
  ...
  epv->f__cast           = remote_Hypre_SStructVector__cast;
  epv->f__delete         = remote_Hypre_SStructVector__delete;
  epv->f__ctor           = NULL;
  epv->f__dtor           = NULL;
  epv->f_addRef          = remote_Hypre_SStructVector_addRef;
  epv->f_deleteRef       = remote_Hypre_SStructVector_deleteRef;
  epv->f_isSame          = remote_Hypre_SStructVector_isSame;
  epv->f_queryInt        = remote_Hypre_SStructVector_queryInt;
  epv->f_isType          = remote_Hypre_SStructVector_isType;
  epv->f_getClassInfo    = remote_Hypre_SStructVector_getClassInfo;
  epv->f_SetCommunicator = remote_Hypre_SStructVector_SetCommunicator;
  epv->f_Initialize      = remote_Hypre_SStructVector_Initialize;
  epv->f_Assemble        = remote_Hypre_SStructVector_Assemble;
  epv->f_GetObject       = remote_Hypre_SStructVector_GetObject;
  epv->f_SetGrid         = remote_Hypre_SStructVector_SetGrid;
  epv->f_SetValues       = remote_Hypre_SStructVector_SetValues;
  epv->f_SetBoxValues    = remote_Hypre_SStructVector_SetBoxValues;
  epv->f_AddToValues     = remote_Hypre_SStructVector_AddToValues;
  epv->f_AddToBoxValues  = remote_Hypre_SStructVector_AddToBoxValues;
  epv->f_Gather          = remote_Hypre_SStructVector_Gather;
  epv->f_GetValues       = remote_Hypre_SStructVector_GetValues;
  epv->f_GetBoxValues    = remote_Hypre_SStructVector_GetBoxValues;
  epv->f_SetComplex      = remote_Hypre_SStructVector_SetComplex;
  epv->f_Print           = remote_Hypre_SStructVector_Print;
  epv->f_Clear           = remote_Hypre_SStructVector_Clear;
  epv->f_Copy            = remote_Hypre_SStructVector_Copy;
  epv->f_Clone           = remote_Hypre_SStructVector_Clone;
  epv->f_Scale           = remote_Hypre_SStructVector_Scale;
  epv->f_Dot             = remote_Hypre_SStructVector_Dot;
  epv->f_Axpy            = remote_Hypre_SStructVector_Axpy;
...
Hypre_SStructVector__remote(const char *url)
{
  ...
  if (!s_remote_initialized) {
    Hypre_SStructVector__init_remote_epv();
  }
  ...
  s0->d_epv  = &s_rem__hypre_sstructvector;
