  ...
  Hypre_PCG self, const char* name, double value)
{
  ...
  /* Insert the implementation of the SetDoubleParameter method here... */
   ...
   if ( strcmp(name,"Absolute Tol Factor")==0 )
   {
      data -> atolf = value;
   }
   else if ( strcmp(name,"Convergence Factor Tol")==0 )
   {
...
impl_Hypre_PCG_Setup(
  Hypre_PCG self, Hypre_Vector b, Hypre_Vector x)
{
  ...
  /* Insert the implementation of the Setup method here... */
   ...
   if ( data -> vector_type == NULL )
   {
       ...
       * vector.  So we are ready to create the Hypre PCG object. */
...
#undef __FUNC__
#define __FUNC__ "impl_Hypre_PCG_SetTolerance"

int32_t
impl_Hypre_PCG_SetTolerance(
  Hypre_PCG self, double tolerance)
{
  /* DO-NOT-DELETE splicer.begin(Hypre.PCG.SetTolerance) */
  ...
  /* DO-NOT-DELETE splicer.end(Hypre.PCG.SetTolerance) */
}
...
#undef __FUNC__
#define __FUNC__ "impl_Hypre_PCG_SetMaxIterations"

int32_t
impl_Hypre_PCG_SetMaxIterations(
  Hypre_PCG self, int32_t max_iterations)
{
  /* DO-NOT-DELETE splicer.begin(Hypre.PCG.SetMaxIterations) */
  ...
  /* DO-NOT-DELETE splicer.end(Hypre.PCG.SetMaxIterations) */
}
...
#undef __FUNC__
#define __FUNC__ "impl_Hypre_PCG_GetNumIterations"

int32_t
impl_Hypre_PCG_GetNumIterations(
  Hypre_PCG self, int32_t* num_iterations)
{
  /* DO-NOT-DELETE splicer.begin(Hypre.PCG.GetNumIterations) */
  ...
  /* DO-NOT-DELETE splicer.end(Hypre.PCG.GetNumIterations) */
}
...
#undef __FUNC__
#define __FUNC__ "impl_Hypre_PCG_GetRelResidualNorm"

int32_t
impl_Hypre_PCG_GetRelResidualNorm(
  Hypre_PCG self, double* norm)
{
  /* DO-NOT-DELETE splicer.begin(Hypre.PCG.GetRelResidualNorm) */
  ...
  /* DO-NOT-DELETE splicer.end(Hypre.PCG.GetRelResidualNorm) */
}
