/*
 * File:          Hypre_ParCSRDiagScale_IOR.c
...
static struct Hypre_ParCSRDiagScale__epv s_new__hypre_parcsrdiagscale;
static struct Hypre_ParCSRDiagScale__epv s_rem__hypre_parcsrdiagscale;
...
extern void Hypre_ParCSRDiagScale__set_epv(
  struct Hypre_ParCSRDiagScale__epv* epv);

/*
 * CAST: dynamic type casting support.
 */

static void* ior_Hypre_ParCSRDiagScale__cast(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name)
{
  void* cast = NULL;

  struct Hypre_ParCSRDiagScale__object* s0 = self;
  struct SIDL_BaseClass__object*        s1 = &s0->d_sidl_baseclass;

  if (!strcmp(name, "Hypre.ParCSRDiagScale")) {
    cast = (void*) s0;
...
static void ior_Hypre_ParCSRDiagScale__delete(
  struct Hypre_ParCSRDiagScale__object* self)
{
  Hypre_ParCSRDiagScale__fini(self);
  memset((void*)self, 0, sizeof(struct Hypre_ParCSRDiagScale__object));
  free((void*) self);
}
...
static void Hypre_ParCSRDiagScale__init_epv(
  struct Hypre_ParCSRDiagScale__object* self)
{
  struct Hypre_ParCSRDiagScale__object* s0 = self;
  struct SIDL_BaseClass__object*        s1 = &s0->d_sidl_baseclass;

  struct Hypre_ParCSRDiagScale__epv* epv = &s_new__hypre_parcsrdiagscale;
  ...
  epv->f__cast                   = ior_Hypre_ParCSRDiagScale__cast;
  epv->f__delete                 = ior_Hypre_ParCSRDiagScale__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = (void (*)(struct 
    Hypre_ParCSRDiagScale__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef               = (void (*)(struct 
    Hypre_ParCSRDiagScale__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                  = (SIDL_bool (*)(struct 
    Hypre_ParCSRDiagScale__object*,
  ...
  epv->f_isType                  = (SIDL_bool (*)(struct 
    Hypre_ParCSRDiagScale__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo            = (struct SIDL_ClassInfo__object* (*)(struct 
    Hypre_ParCSRDiagScale__object*)) s1->d_epv->f_getClassInfo;
  ...
  Hypre_ParCSRDiagScale__set_epv(epv);
...
initClassInfo(SIDL_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      SIDL_ClassInfoI_setName(impl, "Hypre.ParCSRDiagScale");
...
static void
initMetadata(struct Hypre_ParCSRDiagScale__object* self)
{
  if (self) {
...
{
  struct Hypre_ParCSRDiagScale__object* self =
    (struct Hypre_ParCSRDiagScale__object*) malloc(
      sizeof(struct Hypre_ParCSRDiagScale__object));
  Hypre_ParCSRDiagScale__init(self);
  initMetadata(self);
  return self;
}
...
void Hypre_ParCSRDiagScale__init(
  struct Hypre_ParCSRDiagScale__object* self)
{
  struct Hypre_ParCSRDiagScale__object* s0 = self;
  struct SIDL_BaseClass__object*        s1 = &s0->d_sidl_baseclass;
  ...
  if (!s_method_initialized) {
    Hypre_ParCSRDiagScale__init_epv(s0);
  }
  ...
  s0->d_epv                  = &s_new__hypre_parcsrdiagscale;
...
void Hypre_ParCSRDiagScale__fini(
  struct Hypre_ParCSRDiagScale__object* self)
{
  struct Hypre_ParCSRDiagScale__object* s0 = self;
  struct SIDL_BaseClass__object*        s1 = &s0->d_sidl_baseclass;
...
void
Hypre_ParCSRDiagScale__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}
static const struct Hypre_ParCSRDiagScale__external
s_externalEntryPoints = {
  Hypre_ParCSRDiagScale__new,
  Hypre_ParCSRDiagScale__remote,
};
...
static void* remote_Hypre_ParCSRDiagScale__cast(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name)
{
  return NULL;
...
static void remote_Hypre_ParCSRDiagScale__delete(
  struct Hypre_ParCSRDiagScale__object* self)
{
  free((void*) self);
}
...
static void
remote_Hypre_ParCSRDiagScale_addRef(
  struct Hypre_ParCSRDiagScale__object* self)
{
}
...
static void
remote_Hypre_ParCSRDiagScale_deleteRef(
  struct Hypre_ParCSRDiagScale__object* self)
{
}
...
static SIDL_bool
remote_Hypre_ParCSRDiagScale_isSame(
  struct Hypre_ParCSRDiagScale__object* self,
...
remote_Hypre_ParCSRDiagScale_queryInt(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name)
{
...
static SIDL_bool
remote_Hypre_ParCSRDiagScale_isType(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name)
{
  return 0;
...
remote_Hypre_ParCSRDiagScale_getClassInfo(
  struct Hypre_ParCSRDiagScale__object* self)
{
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetCommunicator(
  struct Hypre_ParCSRDiagScale__object* self,
  void* mpi_comm)
{
  return 0;
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetIntParameter(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name,
  int32_t value)
{
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetDoubleParameter(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name,
  double value)
{
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetStringParameter(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name,
  const char* value)
{
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetIntArrayParameter(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name,
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetDoubleArrayParameter(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name,
...
static int32_t
remote_Hypre_ParCSRDiagScale_GetIntValue(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name,
  int32_t* value)
{
...
static int32_t
remote_Hypre_ParCSRDiagScale_GetDoubleValue(
  struct Hypre_ParCSRDiagScale__object* self,
  const char* name,
  double* value)
{
...
static int32_t
remote_Hypre_ParCSRDiagScale_Setup(
  struct Hypre_ParCSRDiagScale__object* self,
...
static int32_t
remote_Hypre_ParCSRDiagScale_Apply(
  struct Hypre_ParCSRDiagScale__object* self,
  struct Hypre_Vector__object* b,
  struct Hypre_Vector__object** x)
{
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetOperator(
  struct Hypre_ParCSRDiagScale__object* self,
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetTolerance(
  struct Hypre_ParCSRDiagScale__object* self,
  double tolerance)
{
  return 0;
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetMaxIterations(
  struct Hypre_ParCSRDiagScale__object* self,
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetLogging(
  struct Hypre_ParCSRDiagScale__object* self,
  int32_t level)
{
  return 0;
...
static int32_t
remote_Hypre_ParCSRDiagScale_SetPrintLevel(
  struct Hypre_ParCSRDiagScale__object* self,
  int32_t level)
{
  return 0;
...
static int32_t
remote_Hypre_ParCSRDiagScale_GetNumIterations(
  struct Hypre_ParCSRDiagScale__object* self,
...
static int32_t
remote_Hypre_ParCSRDiagScale_GetRelResidualNorm(
  struct Hypre_ParCSRDiagScale__object* self,
  double* norm)
{
  return 0;
...
static void Hypre_ParCSRDiagScale__init_remote_epv(void)
{
  struct Hypre_ParCSRDiagScale__epv* epv = &s_rem__hypre_parcsrdiagscale;
  ...
  epv->f__cast                   = remote_Hypre_ParCSRDiagScale__cast;
  epv->f__delete                 = remote_Hypre_ParCSRDiagScale__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = remote_Hypre_ParCSRDiagScale_addRef;
  epv->f_deleteRef               = remote_Hypre_ParCSRDiagScale_deleteRef;
  epv->f_isSame                  = remote_Hypre_ParCSRDiagScale_isSame;
  epv->f_queryInt                = remote_Hypre_ParCSRDiagScale_queryInt;
  epv->f_isType                  = remote_Hypre_ParCSRDiagScale_isType;
  epv->f_getClassInfo            = remote_Hypre_ParCSRDiagScale_getClassInfo;
  epv->f_SetCommunicator         = remote_Hypre_ParCSRDiagScale_SetCommunicator;
  epv->f_SetIntParameter         = remote_Hypre_ParCSRDiagScale_SetIntParameter;
  ...
  epv->f_SetDoubleArrayParameter = 
    remote_Hypre_ParCSRDiagScale_SetDoubleArrayParameter;
  epv->f_GetIntValue             = remote_Hypre_ParCSRDiagScale_GetIntValue;
  epv->f_GetDoubleValue          = remote_Hypre_ParCSRDiagScale_GetDoubleValue;
  epv->f_Setup                   = remote_Hypre_ParCSRDiagScale_Setup;
  epv->f_Apply                   = remote_Hypre_ParCSRDiagScale_Apply;
  epv->f_SetOperator             = remote_Hypre_ParCSRDiagScale_SetOperator;
  epv->f_SetTolerance            = remote_Hypre_ParCSRDiagScale_SetTolerance;
  epv->f_SetMaxIterations        = 
    remote_Hypre_ParCSRDiagScale_SetMaxIterations;
  epv->f_SetLogging              = remote_Hypre_ParCSRDiagScale_SetLogging;
  epv->f_SetPrintLevel           = remote_Hypre_ParCSRDiagScale_SetPrintLevel;
...
Hypre_ParCSRDiagScale__remote(const char *url)
{
  ...
  if (!s_remote_initialized) {
    Hypre_ParCSRDiagScale__init_remote_epv();
  }
  ...
  s0->d_epv  = &s_rem__hypre_parcsrdiagscale;
