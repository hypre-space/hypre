...
#ifndef included_Hypre_StructSMG_IOR_h
#define included_Hypre_StructSMG_IOR_h
...
struct Hypre_StructSMG__epv {
  ...
  int32_t (*f_SetPrintLevel)(
    struct Hypre_StructSMG__object* self,
    int32_t level);
  /* Methods introduced in Hypre.StructSMG-v0.1.5 */
};
...
struct Hypre_StructSMG__object {
  ...
  struct Hypre_StructSMG__epv*  d_epv;
  void*                         d_data;
};
...
struct Hypre_StructSMG__array*
Hypre_StructSMG__iorarray_create(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[]);
...
struct Hypre_StructSMG__array*
Hypre_StructSMG__iorarray_borrow(
...
void
Hypre_StructSMG__iorarray_destroy(
...
int32_t
Hypre_StructSMG__iorarray_dimen(const struct Hypre_StructSMG__array *array);
...
int32_t
Hypre_StructSMG__iorarray_lower(const struct Hypre_StructSMG__array *array,
  int32_t ind);
...
int32_t
Hypre_StructSMG__iorarray_upper(const struct Hypre_StructSMG__array *array,
  int32_t ind);
...
struct Hypre_StructSMG__object*
Hypre_StructSMG__iorarray_get4(
...
void
Hypre_StructSMG__iorarray_set4(
  struct Hypre_StructSMG__array*  array,
  int32_t                         i1,
  int32_t                         i2,
  int32_t                         i3,
...
void
Hypre_StructSMG__iorarray_set(
  struct Hypre_StructSMG__array*  array,
  const int32_t                   indices[],
  struct Hypre_StructSMG__object* value);

struct Hypre_StructSMG__external {
  struct Hypre_StructSMG__object*
  (*createObject)(void);
  ...
  int32_t
  (*getDimen)(const struct Hypre_StructSMG__array *array);

  int32_t
  (*getLower)(const struct Hypre_StructSMG__array *array, int32_t ind);

  int32_t
  (*getUpper)(const struct Hypre_StructSMG__array *array, int32_t ind);
