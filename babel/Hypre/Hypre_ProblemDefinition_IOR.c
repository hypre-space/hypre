...
struct Hypre_ProblemDefinition__array {
  struct Hypre_ProblemDefinition__object** d_firstElement;
  int32_t                                  *d_lower;
  int32_t                                  *d_upper;
  int32_t                                  *d_stride;
...
static struct Hypre_ProblemDefinition__array*
newArray(int32_t dimen, const int32_t lower[], const int32_t upper[]) {
  static const size_t arraySize = sizeof(struct Hypre_ProblemDefinition__array)
    + (sizeof(int32_t) - (sizeof(struct Hypre_ProblemDefinition__array)
    % sizeof(int32_t))) % sizeof(int32_t);
  struct Hypre_ProblemDefinition__array *result =
    (struct Hypre_ProblemDefinition__array *)
...
{
  int32_t size=1, i;
  struct Hypre_ProblemDefinition__array *result = newArray(dimen, lower, upper);
  for(i = 0; i < dimen; ++i) {
    result->d_stride[i] = size;
    size *= (1 + upper[i] - lower[i]);
  }
  size *= sizeof(struct Hypre_ProblemDefinition__object*);
  result->d_firstElement = (struct Hypre_ProblemDefinition__object**)
    malloc(size);
  ...
  struct Hypre_ProblemDefinition__array* array)
{
  if (array) {
    ...
    if (!(array->d_borrowed)) {
      if (dimen > 0) {
        int32_t size = 1;
        struct Hypre_ProblemDefinition__object** start = array->d_firstElement;
        struct Hypre_ProblemDefinition__object** end;
        if (dimen > 1) {
    ...
    memset(array, 0, sizeof(struct Hypre_ProblemDefinition__array)
...
{
  struct Hypre_ProblemDefinition__object** result = NULL;
...
static const struct Hypre_ProblemDefinition__external
s_externalEntryPoints = {
  Hypre_ProblemDefinition__iorarray_create,
  Hypre_ProblemDefinition__iorarray_borrow,
  Hypre_ProblemDefinition__iorarray_destroy,
  Hypre_ProblemDefinition__iorarray_dimen,
  Hypre_ProblemDefinition__iorarray_lower,
  Hypre_ProblemDefinition__iorarray_upper,
  Hypre_ProblemDefinition__iorarray_get,
  Hypre_ProblemDefinition__iorarray_get4,
  Hypre_ProblemDefinition__iorarray_set,
  Hypre_ProblemDefinition__iorarray_set4
...
static void
remote_Hypre_ProblemDefinition_addReference(
  void* self)
{
}
...
static void
remote_Hypre_ProblemDefinition_deleteReference(
  void* self)
{
}
...
static SIDL_bool
remote_Hypre_ProblemDefinition_isInstanceOf(
  void* self,
  const char* name)
{
  return 0;
...
remote_Hypre_ProblemDefinition_queryInterface(
  void* self,
  const char* name)
{
...
static void Hypre_ProblemDefinition__init_remote_epv(void)
{
  ...
  epv->f_addReference    = remote_Hypre_ProblemDefinition_addReference;
  epv->f_deleteReference = remote_Hypre_ProblemDefinition_deleteReference;
  epv->f_isInstanceOf    = remote_Hypre_ProblemDefinition_isInstanceOf;
  epv->f_isSame          = remote_Hypre_ProblemDefinition_isSame;
  epv->f_queryInterface  = remote_Hypre_ProblemDefinition_queryInterface;
