...
static const struct Hypre_Pilut__external* _loadIOR(void)
/*
...

{
  ...
  if (!_ior) {
    fputs("Babel: unable to load the implementation for Hypre.Pilut; please set SIDL_DLL_PATH\n", stderr);
    exit(-1);
  }
#endif
  return _ior;
...
Hypre_Pilut__array_createCol(int32_t        dimen,
                             ...
                             const int32_t upper[])
{
  return (struct Hypre_Pilut__array*)SIDL_interface__array_createCol(dimen,
    lower, upper);
}
...
Hypre_Pilut__array_createRow(int32_t        dimen,
                             ...
                             const int32_t upper[])
{
  return (struct Hypre_Pilut__array*)SIDL_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct Hypre_Pilut__array*)SIDL_interface__array_create1d(len);
}
...
{
  return (struct Hypre_Pilut__array*)SIDL_interface__array_create2dCol(m, n);
}
...
{
  return (struct Hypre_Pilut__array*)SIDL_interface__array_create2dRow(m, n);
}
...
{
  return (struct Hypre_Pilut__array*)SIDL_interface__array_borrow(
...
{
  return (struct Hypre_Pilut__array*)
 ...
 */
void
Hypre_Pilut__array_addReference(struct Hypre_Pilut__array* array)
{
 ...
 */
void
Hypre_Pilut__array_deleteReference(struct Hypre_Pilut__array* array)
{
