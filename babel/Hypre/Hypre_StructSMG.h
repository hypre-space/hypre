...
#define included_Hypre_StructSMG_h
...
typedef struct Hypre_StructSMG__object* Hypre_StructSMG;
...
#define Hypre_StructSMG__array_get1(a,i1) \
  Hypre_StructSMG__array_get4(a,i1,0,0,0)

#define Hypre_StructSMG__array_get2(a,i1,i2) \
  Hypre_StructSMG__array_get4(a,i1,i2,0,0)

#define Hypre_StructSMG__array_get3(a,i1,i2,i3) \
  Hypre_StructSMG__array_get4(a,i1,i2,i3,0)

#define Hypre_StructSMG__array_set1(a,i1,v) \
  Hypre_StructSMG__array_set4(a,i1,0,0,0,v)

#define Hypre_StructSMG__array_set2(a,i1,i2,v) \
  Hypre_StructSMG__array_set4(a,i1,i2,0,0,v)

#define Hypre_StructSMG__array_set3(a,i1,i2,i3,v) \
  Hypre_StructSMG__array_set4(a,i1,i2,i3,0,v)
