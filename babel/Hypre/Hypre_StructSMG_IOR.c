...
static void* Hypre_StructSMG__cast(
...
static void Hypre_StructSMG__delete(
  struct Hypre_StructSMG__object* self)
{
  ...
  struct Hypre_StructSMG__object* self)
{
  ...
  epv->f__cast           = Hypre_StructSMG__cast;
  epv->f__delete         = Hypre_StructSMG__delete;
  epv->f__ctor           = NULL;
  epv->f__dtor           = NULL;
  epv->f_Apply           = NULL;
  ...
  epv->f_Setup           = NULL;
  epv->f_addReference    = (void (*)(struct Hypre_StructSMG__object*)) 
    s1->d_epv->f_addReference;
  epv->f_deleteReference = (void (*)(struct Hypre_StructSMG__object*)) 
    s1->d_epv->f_deleteReference;
  epv->f_isInstanceOf    = (SIDL_bool (*)(struct Hypre_StructSMG__object*,
    const char*)) s1->d_epv->f_isInstanceOf;
  epv->f_isSame          = (SIDL_bool (*)(struct Hypre_StructSMG__object*,
    struct SIDL_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInterface  = (struct SIDL_BaseInterface__object* (*)(struct 
    Hypre_StructSMG__object*,const char*)) s1->d_epv->f_queryInterface;
...
struct Hypre_StructSMG__array {
  struct Hypre_StructSMG__object** d_firstElement;
  int32_t                          *d_lower;
  int32_t                          *d_upper;
  int32_t                          *d_stride;
...
static struct Hypre_StructSMG__array*
newArray(int32_t dimen, const int32_t lower[], const int32_t upper[]) {
  static const size_t arraySize = sizeof(struct Hypre_StructSMG__array)
    + (sizeof(int32_t) - (sizeof(struct Hypre_StructSMG__array)
    % sizeof(int32_t))) % sizeof(int32_t);
  struct Hypre_StructSMG__array *result =
    (struct Hypre_StructSMG__array *)
...
{
  int32_t size=1, i;
  struct Hypre_StructSMG__array *result = newArray(dimen, lower, upper);
  for(i = 0; i < dimen; ++i) {
    result->d_stride[i] = size;
    size *= (1 + upper[i] - lower[i]);
  }
  size *= sizeof(struct Hypre_StructSMG__object*);
  result->d_firstElement = (struct Hypre_StructSMG__object**)
    malloc(size);
  ...
  struct Hypre_StructSMG__array* array)
{
  if (array) {
    ...
    if (!(array->d_borrowed)) {
      if (dimen > 0) {
        int32_t size = 1;
        struct Hypre_StructSMG__object** start = array->d_firstElement;
        struct Hypre_StructSMG__object** end;
        if (dimen > 1) {
    ...
    memset(array, 0, sizeof(struct Hypre_StructSMG__array)
...
{
  struct Hypre_StructSMG__object** result = NULL;
...
s_externalEntryPoints = {
  ...
  Hypre_StructSMG__iorarray_borrow,
  Hypre_StructSMG__iorarray_destroy,
  Hypre_StructSMG__iorarray_dimen,
  Hypre_StructSMG__iorarray_lower,
  Hypre_StructSMG__iorarray_upper,
  Hypre_StructSMG__iorarray_get,
  Hypre_StructSMG__iorarray_get4,
  Hypre_StructSMG__iorarray_set,
  Hypre_StructSMG__iorarray_set4
...
static int32_t
remote_Hypre_StructSMG_SetParameter(
  struct Hypre_StructSMG__object* self,
  const char* name,
  double value)
{
...
static void
remote_Hypre_StructSMG_addReference(
  struct Hypre_StructSMG__object* self)
{
}
...
static void
remote_Hypre_StructSMG_deleteReference(
  struct Hypre_StructSMG__object* self)
{
}
...
static SIDL_bool
remote_Hypre_StructSMG_isInstanceOf(
  struct Hypre_StructSMG__object* self,
  const char* name)
{
  return 0;
...
remote_Hypre_StructSMG_queryInterface(
  struct Hypre_StructSMG__object* self,
  const char* name)
{
...
static void Hypre_StructSMG__init_remote_epv(void)
{
  ...
  epv->f_SetParameter    = remote_Hypre_StructSMG_SetParameter;
  epv->f_Setup           = remote_Hypre_StructSMG_Setup;
  epv->f_addReference    = remote_Hypre_StructSMG_addReference;
  epv->f_deleteReference = remote_Hypre_StructSMG_deleteReference;
  epv->f_isInstanceOf    = remote_Hypre_StructSMG_isInstanceOf;
  epv->f_isSame          = remote_Hypre_StructSMG_isSame;
  epv->f_queryInterface  = remote_Hypre_StructSMG_queryInterface;
