 ...
 */
void
Hypre_ParDiagScale__array_addReference(struct Hypre_ParDiagScale__array* array);
 ...
 */
void
Hypre_ParDiagScale__array_deleteReference(struct Hypre_ParDiagScale__array* 
  array);
