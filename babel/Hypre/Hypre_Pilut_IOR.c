...
static void* ior_Hypre_Pilut__cast(
...
static void ior_Hypre_Pilut__delete(
  struct Hypre_Pilut__object* self)
{
  ...
  struct Hypre_Pilut__object* self)
{
  ...
  epv->f__cast                   = ior_Hypre_Pilut__cast;
  epv->f__delete                 = ior_Hypre_Pilut__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = (void (*)(struct Hypre_Pilut__object*)) 
    s1->d_epv->f_addRef;
  epv->f_deleteRef               = (void (*)(struct Hypre_Pilut__object*)) 
  ...
  epv->f_queryInt                = (struct SIDL_BaseInterface__object* 
    (*)(struct Hypre_Pilut__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                  = (SIDL_bool (*)(struct Hypre_Pilut__object*,
    const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo            = (struct SIDL_ClassInfo__object* (*)(struct 
    Hypre_Pilut__object*)) s1->d_epv->f_getClassInfo;
...
initClassInfo(SIDL_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      SIDL_ClassInfoI_setName(impl, "Hypre.Pilut");
...
static void
initMetadata(struct Hypre_Pilut__object* self)
{
  if (self) {
...
void
Hypre_Pilut__IOR_version(int32_t *major, int32_t *minor)
{
...
remote_Hypre_Pilut_getClassInfo(
  struct Hypre_Pilut__object* self)
{
...
static int32_t
remote_Hypre_Pilut_SetTolerance(
  struct Hypre_Pilut__object* self,
  double tolerance)
{
  return 0;
...
static int32_t
remote_Hypre_Pilut_SetMaxIterations(
  struct Hypre_Pilut__object* self,
...
static int32_t
remote_Hypre_Pilut_GetNumIterations(
  struct Hypre_Pilut__object* self,
...
static int32_t
remote_Hypre_Pilut_GetRelResidualNorm(
  struct Hypre_Pilut__object* self,
  double* norm)
{
  return 0;
...
static void Hypre_Pilut__init_remote_epv(void)
{
  ...
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = remote_Hypre_Pilut_addRef;
  epv->f_deleteRef               = remote_Hypre_Pilut_deleteRef;
  epv->f_isSame                  = remote_Hypre_Pilut_isSame;
  epv->f_queryInt                = remote_Hypre_Pilut_queryInt;
  epv->f_isType                  = remote_Hypre_Pilut_isType;
  epv->f_getClassInfo            = remote_Hypre_Pilut_getClassInfo;
  ...
  epv->f_SetTolerance            = remote_Hypre_Pilut_SetTolerance;
  epv->f_SetMaxIterations        = remote_Hypre_Pilut_SetMaxIterations;
  epv->f_SetLogging              = remote_Hypre_Pilut_SetLogging;
  epv->f_SetPrintLevel           = remote_Hypre_Pilut_SetPrintLevel;
  epv->f_GetNumIterations        = remote_Hypre_Pilut_GetNumIterations;
  epv->f_GetRelResidualNorm      = remote_Hypre_Pilut_GetRelResidualNorm;
