...
struct Hypre_StructVector__external {
  ...
  int32_t
  (*getDimen)(const struct Hypre_StructVector__array *array);

  int32_t
  (*getLower)(const struct Hypre_StructVector__array *array, int32_t ind);

  int32_t
  (*getUpper)(const struct Hypre_StructVector__array *array, int32_t ind);
