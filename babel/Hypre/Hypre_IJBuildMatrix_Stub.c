...
{
  return (struct 
    Hypre_IJBuildMatrix__array*)SIDL_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    Hypre_IJBuildMatrix__array*)SIDL_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    Hypre_IJBuildMatrix__array*)SIDL_interface__array_create1d(len);
}
...
{
  return (struct 
    Hypre_IJBuildMatrix__array*)SIDL_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    Hypre_IJBuildMatrix__array*)SIDL_interface__array_create2dRow(m, n);
}
...
{
  return (struct Hypre_IJBuildMatrix__array*)SIDL_interface__array_borrow(
...
{
  return (struct Hypre_IJBuildMatrix__array*)
