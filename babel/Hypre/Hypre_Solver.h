 ...
 */
int32_t
Hypre_Solver__array_lower(const struct Hypre_Solver__array *array, int32_t ind);

/**
 * Return the upper bounds of the array.
 */
int32_t
Hypre_Solver__array_upper(const struct Hypre_Solver__array *array, int32_t ind);

/**
 * Return an array element (int[] indices).
 */
struct Hypre_Solver__object*
Hypre_Solver__array_get(
...
#define Hypre_Solver__array_get1(a,i1) \
  Hypre_Solver__array_get4(a,i1,0,0,0)

#define Hypre_Solver__array_get2(a,i1,i2) \
  Hypre_Solver__array_get4(a,i1,i2,0,0)

#define Hypre_Solver__array_get3(a,i1,i2,i3) \
  Hypre_Solver__array_get4(a,i1,i2,i3,0)

#define Hypre_Solver__array_set1(a,i1,v) \
  Hypre_Solver__array_set4(a,i1,0,0,0,v)

#define Hypre_Solver__array_set2(a,i1,i2,v) \
  Hypre_Solver__array_set4(a,i1,i2,0,0,v)

#define Hypre_Solver__array_set3(a,i1,i2,i3,v) \
  Hypre_Solver__array_set4(a,i1,i2,i3,0,v)
