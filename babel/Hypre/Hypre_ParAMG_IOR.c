  ...
  struct Hypre_ParAMG__object* self)
{
  ...
  epv->f_queryInterface  = (struct SIDL_BaseInterface__object* (*)(struct 
    Hypre_ParAMG__object*,const char*)) s1->d_epv->f_queryInterface;
  ...
  e1->f_Apply           = (int32_t (*)(void*,struct Hypre_Vector__object*,
    struct Hypre_Vector__object**)) epv->f_Apply;
...
static int32_t
remote_Hypre_ParAMG_SetParameter(
  struct Hypre_ParAMG__object* self,
  const char* name,
  double value)
{
...
static void Hypre_ParAMG__init_remote_epv(void)
{
  ...
  epv->f_SetParameter    = remote_Hypre_ParAMG_SetParameter;
