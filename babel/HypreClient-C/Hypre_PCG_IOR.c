...
static int32_t
remote_Hypre_PCG_SetMaxIterations(
  struct Hypre_PCG__object* self,
...
static int32_t
remote_Hypre_PCG_GetNumIterations(
  struct Hypre_PCG__object* self,
...
static int32_t
remote_Hypre_PCG_GetRelResidualNorm(
  struct Hypre_PCG__object* self,
  double* norm)
{
  return 0;
...
static void Hypre_PCG__init_remote_epv(void)
{
  ...
  epv->f_SetTolerance            = remote_Hypre_PCG_SetTolerance;
  epv->f_SetMaxIterations        = remote_Hypre_PCG_SetMaxIterations;
  epv->f_SetLogging              = remote_Hypre_PCG_SetLogging;
  epv->f_SetPrintLevel           = remote_Hypre_PCG_SetPrintLevel;
  epv->f_GetNumIterations        = remote_Hypre_PCG_GetNumIterations;
  epv->f_GetRelResidualNorm      = remote_Hypre_PCG_GetRelResidualNorm;
