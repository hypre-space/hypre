/*
 * File:          Hypre_StructBuildMatrix_IOR.h
...
#ifndef included_Hypre_StructBuildMatrix_IOR_h
#define included_Hypre_StructBuildMatrix_IOR_h
...
extern struct Hypre_StructBuildMatrix__object*
...
struct Hypre_StructBuildMatrix__epv {
  ...
  /* Methods introduced in Hypre.StructBuildMatrix-v0.1.7 */
  int32_t (*f_SetGrid)(
    void* self,
...
struct Hypre_StructBuildMatrix__object {
  struct Hypre_StructBuildMatrix__epv* d_epv;
  void*                                d_object;
};
