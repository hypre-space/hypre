/*
 * File:          Hypre_StructBuildMatrix_Stub.c
...
#include "Hypre_StructBuildMatrix.h"
...
Hypre_StructBuildMatrix__cast(
  void* obj)
{
  Hypre_StructBuildMatrix cast = NULL;

  if (obj != NULL) {
    SIDL_BaseInterface base = (SIDL_BaseInterface) obj;
    cast = (Hypre_StructBuildMatrix) (*base->d_epv->f__cast)(
      base->d_object,
      "Hypre.StructBuildMatrix");
  }
...
{
  return (struct 
    Hypre_StructBuildMatrix__array*)SIDL_interface__array_createCol(dimen,
    lower, upper);
}
...
{
  return (struct 
    Hypre_StructBuildMatrix__array*)SIDL_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct 
    Hypre_StructBuildMatrix__array*)SIDL_interface__array_create1d(len);
}
...
{
  return (struct 
    Hypre_StructBuildMatrix__array*)SIDL_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    Hypre_StructBuildMatrix__array*)SIDL_interface__array_create2dRow(m, n);
}
...
{
  return (struct Hypre_StructBuildMatrix__array*)SIDL_interface__array_borrow(
...
Hypre_StructBuildMatrix__array_smartCopy(struct Hypre_StructBuildMatrix__array 
  *array)
{
  return (struct Hypre_StructBuildMatrix__array*)
...
Hypre_StructBuildMatrix__array_get1(const struct 
  Hypre_StructBuildMatrix__array* array,
                                    const int32_t i1)
{
  return (Hypre_StructBuildMatrix)
