...
static const struct Hypre_SStructGrid__external* _loadIOR(void)
/*
...

{
  ...
  if (!_ior) {
    fputs("Babel: unable to load the implementation for Hypre.SStructGrid; please set SIDL_DLL_PATH\n", stderr);
    exit(-1);
  }
#endif
  return _ior;
...
Hypre_SStructGrid__cast(
  void* obj)
{
  Hypre_SStructGrid cast = NULL;

  if (obj != NULL) {
    SIDL_BaseInterface base = (SIDL_BaseInterface) obj;
    cast = (Hypre_SStructGrid) (*base->d_epv->f__cast)(
      base->d_object,
      "Hypre.SStructGrid");
  }
...
{
  return (struct 
    Hypre_SStructGrid__array*)SIDL_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    Hypre_SStructGrid__array*)SIDL_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct Hypre_SStructGrid__array*)SIDL_interface__array_create1d(len);
}
...
{
  return (struct Hypre_SStructGrid__array*)SIDL_interface__array_create2dCol(m,
    n);
}
...
{
  return (struct Hypre_SStructGrid__array*)SIDL_interface__array_create2dRow(m,
    n);
}
...
{
  return (struct Hypre_SStructGrid__array*)SIDL_interface__array_borrow(
...
{
  return (struct Hypre_SStructGrid__array*)
