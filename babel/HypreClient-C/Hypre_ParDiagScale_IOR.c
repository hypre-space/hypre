...
static struct Hypre_ParDiagScale__epv s_new__hypre_pardiagscale;
static struct Hypre_ParDiagScale__epv s_rem__hypre_pardiagscale;
...
extern void Hypre_ParDiagScale__set_epv(
  struct Hypre_ParDiagScale__epv* epv);

/*
 * CAST: dynamic type casting support.
 */

static void* ior_Hypre_ParDiagScale__cast(
  struct Hypre_ParDiagScale__object* self,
  const char* name)
{
  void* cast = NULL;

  struct Hypre_ParDiagScale__object* s0 = self;
  struct SIDL_BaseClass__object*     s1 = &s0->d_sidl_baseclass;

  if (!strcmp(name, "Hypre.ParDiagScale")) {
    cast = (void*) s0;
...
static void ior_Hypre_ParDiagScale__delete(
  struct Hypre_ParDiagScale__object* self)
{
  Hypre_ParDiagScale__fini(self);
  memset((void*)self, 0, sizeof(struct Hypre_ParDiagScale__object));
  free((void*) self);
}
...
static void Hypre_ParDiagScale__init_epv(
  struct Hypre_ParDiagScale__object* self)
{
  struct Hypre_ParDiagScale__object* s0 = self;
  struct SIDL_BaseClass__object*     s1 = &s0->d_sidl_baseclass;

  struct Hypre_ParDiagScale__epv* epv = &s_new__hypre_pardiagscale;
  ...
  epv->f__cast                   = ior_Hypre_ParDiagScale__cast;
  epv->f__delete                 = ior_Hypre_ParDiagScale__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = (void (*)(struct 
    Hypre_ParDiagScale__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef               = (void (*)(struct 
    Hypre_ParDiagScale__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                  = (SIDL_bool (*)(struct 
    Hypre_ParDiagScale__object*,
    struct SIDL_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                = (struct SIDL_BaseInterface__object* 
    (*)(struct Hypre_ParDiagScale__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                  = (SIDL_bool (*)(struct 
    Hypre_ParDiagScale__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo            = (struct SIDL_ClassInfo__object* (*)(struct 
    Hypre_ParDiagScale__object*)) s1->d_epv->f_getClassInfo;
  ...
  Hypre_ParDiagScale__set_epv(epv);
...
initClassInfo(SIDL_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      SIDL_ClassInfoI_setName(impl, "Hypre.ParDiagScale");
...
static void
initMetadata(struct Hypre_ParDiagScale__object* self)
{
  if (self) {
...
{
  struct Hypre_ParDiagScale__object* self =
    (struct Hypre_ParDiagScale__object*) malloc(
      sizeof(struct Hypre_ParDiagScale__object));
  Hypre_ParDiagScale__init(self);
  initMetadata(self);
  return self;
}
  ...
  struct Hypre_ParDiagScale__object* self)
{
  ...
  if (!s_method_initialized) {
    Hypre_ParDiagScale__init_epv(s0);
  }
  ...
  s0->d_epv                  = &s_new__hypre_pardiagscale;
...
void
Hypre_ParDiagScale__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}
static const struct Hypre_ParDiagScale__external
s_externalEntryPoints = {
  Hypre_ParDiagScale__new,
  Hypre_ParDiagScale__remote,
};
...
static void* remote_Hypre_ParDiagScale__cast(
  struct Hypre_ParDiagScale__object* self,
  const char* name)
{
  return NULL;
...
static void remote_Hypre_ParDiagScale__delete(
  struct Hypre_ParDiagScale__object* self)
{
  free((void*) self);
}
...
static void
remote_Hypre_ParDiagScale_addRef(
  struct Hypre_ParDiagScale__object* self)
{
}
...
static void
remote_Hypre_ParDiagScale_deleteRef(
  struct Hypre_ParDiagScale__object* self)
{
}
...
static SIDL_bool
remote_Hypre_ParDiagScale_isSame(
  struct Hypre_ParDiagScale__object* self,
...
remote_Hypre_ParDiagScale_queryInt(
  struct Hypre_ParDiagScale__object* self,
  const char* name)
{
...
static SIDL_bool
remote_Hypre_ParDiagScale_isType(
  struct Hypre_ParDiagScale__object* self,
  const char* name)
{
  return 0;
...
remote_Hypre_ParDiagScale_getClassInfo(
  struct Hypre_ParDiagScale__object* self)
{
...
static int32_t
remote_Hypre_ParDiagScale_SetCommunicator(
  struct Hypre_ParDiagScale__object* self,
  void* comm)
{
  return 0;
...
static int32_t
remote_Hypre_ParDiagScale_GetDoubleValue(
  struct Hypre_ParDiagScale__object* self,
  const char* name,
  double* value)
{
...
static int32_t
remote_Hypre_ParDiagScale_GetIntValue(
  struct Hypre_ParDiagScale__object* self,
  const char* name,
  int32_t* value)
{
...
static int32_t
remote_Hypre_ParDiagScale_SetDoubleParameter(
  struct Hypre_ParDiagScale__object* self,
  const char* name,
  double value)
{
...
static int32_t
remote_Hypre_ParDiagScale_SetIntParameter(
  struct Hypre_ParDiagScale__object* self,
  const char* name,
  int32_t value)
{
...
static int32_t
remote_Hypre_ParDiagScale_SetStringParameter(
  struct Hypre_ParDiagScale__object* self,
  const char* name,
  const char* value)
{
...
static int32_t
remote_Hypre_ParDiagScale_SetIntArrayParameter(
  struct Hypre_ParDiagScale__object* self,
  const char* name,
...
static int32_t
remote_Hypre_ParDiagScale_SetDoubleArrayParameter(
  struct Hypre_ParDiagScale__object* self,
  const char* name,
...
static int32_t
remote_Hypre_ParDiagScale_Setup(
  struct Hypre_ParDiagScale__object* self,
...
static int32_t
remote_Hypre_ParDiagScale_Apply(
  struct Hypre_ParDiagScale__object* self,
  struct Hypre_Vector__object* b,
  struct Hypre_Vector__object** x)
{
...
static int32_t
remote_Hypre_ParDiagScale_SetOperator(
  struct Hypre_ParDiagScale__object* self,
...
static int32_t
remote_Hypre_ParDiagScale_GetResidual(
  struct Hypre_ParDiagScale__object* self,
...
static int32_t
remote_Hypre_ParDiagScale_SetLogging(
  struct Hypre_ParDiagScale__object* self,
  int32_t level)
{
  return 0;
...
static int32_t
remote_Hypre_ParDiagScale_SetPrintLevel(
  struct Hypre_ParDiagScale__object* self,
  int32_t level)
{
  return 0;
...
static void Hypre_ParDiagScale__init_remote_epv(void)
{
  struct Hypre_ParDiagScale__epv* epv = &s_rem__hypre_pardiagscale;
  ...
  epv->f__cast                   = remote_Hypre_ParDiagScale__cast;
  epv->f__delete                 = remote_Hypre_ParDiagScale__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = remote_Hypre_ParDiagScale_addRef;
  epv->f_deleteRef               = remote_Hypre_ParDiagScale_deleteRef;
  epv->f_isSame                  = remote_Hypre_ParDiagScale_isSame;
  epv->f_queryInt                = remote_Hypre_ParDiagScale_queryInt;
  epv->f_isType                  = remote_Hypre_ParDiagScale_isType;
  epv->f_getClassInfo            = remote_Hypre_ParDiagScale_getClassInfo;
  epv->f_SetCommunicator         = remote_Hypre_ParDiagScale_SetCommunicator;
  epv->f_GetDoubleValue          = remote_Hypre_ParDiagScale_GetDoubleValue;
  epv->f_GetIntValue             = remote_Hypre_ParDiagScale_GetIntValue;
  epv->f_SetDoubleParameter      = remote_Hypre_ParDiagScale_SetDoubleParameter;
  epv->f_SetIntParameter         = remote_Hypre_ParDiagScale_SetIntParameter;
  epv->f_SetStringParameter      = remote_Hypre_ParDiagScale_SetStringParameter;
  epv->f_SetIntArrayParameter    = 
    remote_Hypre_ParDiagScale_SetIntArrayParameter;
  epv->f_SetDoubleArrayParameter = 
    remote_Hypre_ParDiagScale_SetDoubleArrayParameter;
  epv->f_Setup                   = remote_Hypre_ParDiagScale_Setup;
  epv->f_Apply                   = remote_Hypre_ParDiagScale_Apply;
  epv->f_SetOperator             = remote_Hypre_ParDiagScale_SetOperator;
  epv->f_GetResidual             = remote_Hypre_ParDiagScale_GetResidual;
  epv->f_SetLogging              = remote_Hypre_ParDiagScale_SetLogging;
  epv->f_SetPrintLevel           = remote_Hypre_ParDiagScale_SetPrintLevel;
...
Hypre_ParDiagScale__remote(const char *url)
{
  ...
  if (!s_remote_initialized) {
    Hypre_ParDiagScale__init_remote_epv();
  }
  ...
  s0->d_epv  = &s_rem__hypre_pardiagscale;
