...
SIDL_ClassInfo
Hypre_StructStencil_getClassInfo(
  Hypre_StructStencil self)
{
 ...
 */
void
Hypre_StructStencil__array_addRef(struct Hypre_StructStencil__array* array)
{
 ...
 */
void
Hypre_StructStencil__array_deleteRef(struct Hypre_StructStencil__array* array)
{
