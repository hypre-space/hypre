/*
 * File:          Hypre_IJParCSRMatrix_IOR.c
...
static struct Hypre_IJParCSRMatrix__epv s_new__hypre_ijparcsrmatrix;
static struct Hypre_IJParCSRMatrix__epv s_rem__hypre_ijparcsrmatrix;
...
extern void Hypre_IJParCSRMatrix__set_epv(
  struct Hypre_IJParCSRMatrix__epv* epv);

/*
 * CAST: dynamic type casting support.
 */

static void* ior_Hypre_IJParCSRMatrix__cast(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name)
{
  void* cast = NULL;

  struct Hypre_IJParCSRMatrix__object* s0 = self;
  struct SIDL_BaseClass__object*       s1 = &s0->d_sidl_baseclass;

  if (!strcmp(name, "Hypre.IJParCSRMatrix")) {
    cast = (void*) s0;
...
static void ior_Hypre_IJParCSRMatrix__delete(
  struct Hypre_IJParCSRMatrix__object* self)
{
  Hypre_IJParCSRMatrix__fini(self);
  memset((void*)self, 0, sizeof(struct Hypre_IJParCSRMatrix__object));
  free((void*) self);
}
...
static void Hypre_IJParCSRMatrix__init_epv(
  struct Hypre_IJParCSRMatrix__object* self)
{
  struct Hypre_IJParCSRMatrix__object* s0 = self;
  struct SIDL_BaseClass__object*       s1 = &s0->d_sidl_baseclass;

  struct Hypre_IJParCSRMatrix__epv*    epv = &s_new__hypre_ijparcsrmatrix;
  ...
  epv->f__cast                   = ior_Hypre_IJParCSRMatrix__cast;
  epv->f__delete                 = ior_Hypre_IJParCSRMatrix__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = (void (*)(struct 
    Hypre_IJParCSRMatrix__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef               = (void (*)(struct 
    Hypre_IJParCSRMatrix__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                  = (SIDL_bool (*)(struct 
    Hypre_IJParCSRMatrix__object*,
  ...
  epv->f_isType                  = (SIDL_bool (*)(struct 
    Hypre_IJParCSRMatrix__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo            = (struct SIDL_ClassInfo__object* (*)(struct 
    Hypre_IJParCSRMatrix__object*)) s1->d_epv->f_getClassInfo;
  ...
  Hypre_IJParCSRMatrix__set_epv(epv);
...
initClassInfo(SIDL_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      SIDL_ClassInfoI_setName(impl, "Hypre.IJParCSRMatrix");
...
static void
initMetadata(struct Hypre_IJParCSRMatrix__object* self)
{
  if (self) {
...
{
  struct Hypre_IJParCSRMatrix__object* self =
    (struct Hypre_IJParCSRMatrix__object*) malloc(
      sizeof(struct Hypre_IJParCSRMatrix__object));
  Hypre_IJParCSRMatrix__init(self);
  initMetadata(self);
  return self;
}
...
void Hypre_IJParCSRMatrix__init(
  struct Hypre_IJParCSRMatrix__object* self)
{
  struct Hypre_IJParCSRMatrix__object* s0 = self;
  struct SIDL_BaseClass__object*       s1 = &s0->d_sidl_baseclass;
  ...
  if (!s_method_initialized) {
    Hypre_IJParCSRMatrix__init_epv(s0);
  }
  ...
  s0->d_epv                           = &s_new__hypre_ijparcsrmatrix;
...
void Hypre_IJParCSRMatrix__fini(
  struct Hypre_IJParCSRMatrix__object* self)
{
  struct Hypre_IJParCSRMatrix__object* s0 = self;
  struct SIDL_BaseClass__object*       s1 = &s0->d_sidl_baseclass;
...
void
Hypre_IJParCSRMatrix__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}
static const struct Hypre_IJParCSRMatrix__external
s_externalEntryPoints = {
  Hypre_IJParCSRMatrix__new,
  Hypre_IJParCSRMatrix__remote,
};
...
static void* remote_Hypre_IJParCSRMatrix__cast(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name)
{
  return NULL;
...
static void remote_Hypre_IJParCSRMatrix__delete(
  struct Hypre_IJParCSRMatrix__object* self)
{
  free((void*) self);
}
...
static void
remote_Hypre_IJParCSRMatrix_addRef(
  struct Hypre_IJParCSRMatrix__object* self)
{
}
...
static void
remote_Hypre_IJParCSRMatrix_deleteRef(
  struct Hypre_IJParCSRMatrix__object* self)
{
}
...
static SIDL_bool
remote_Hypre_IJParCSRMatrix_isSame(
  struct Hypre_IJParCSRMatrix__object* self,
...
remote_Hypre_IJParCSRMatrix_queryInt(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name)
{
...
static SIDL_bool
remote_Hypre_IJParCSRMatrix_isType(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name)
{
  return 0;
...
remote_Hypre_IJParCSRMatrix_getClassInfo(
  struct Hypre_IJParCSRMatrix__object* self)
{
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetDiagOffdSizes(
  struct Hypre_IJParCSRMatrix__object* self,
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetCommunicator(
  struct Hypre_IJParCSRMatrix__object* self,
  void* mpi_comm)
{
  return 0;
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetIntParameter(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name,
  int32_t value)
{
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetDoubleParameter(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name,
  double value)
{
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetStringParameter(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name,
  const char* value)
{
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetIntArrayParameter(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name,
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetDoubleArrayParameter(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name,
...
static int32_t
remote_Hypre_IJParCSRMatrix_GetIntValue(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name,
  int32_t* value)
{
...
static int32_t
remote_Hypre_IJParCSRMatrix_GetDoubleValue(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* name,
  double* value)
{
...
static int32_t
remote_Hypre_IJParCSRMatrix_Setup(
  struct Hypre_IJParCSRMatrix__object* self,
...
static int32_t
remote_Hypre_IJParCSRMatrix_Apply(
  struct Hypre_IJParCSRMatrix__object* self,
  struct Hypre_Vector__object* b,
  struct Hypre_Vector__object** x)
{
...
static int32_t
remote_Hypre_IJParCSRMatrix_Initialize(
  struct Hypre_IJParCSRMatrix__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_IJParCSRMatrix_Assemble(
  struct Hypre_IJParCSRMatrix__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_IJParCSRMatrix_GetObject(
  struct Hypre_IJParCSRMatrix__object* self,
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetLocalRange(
  struct Hypre_IJParCSRMatrix__object* self,
  int32_t ilower,
  int32_t iupper,
  int32_t jlower,
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetValues(
  struct Hypre_IJParCSRMatrix__object* self,
  int32_t nrows,
...
static int32_t
remote_Hypre_IJParCSRMatrix_AddToValues(
  struct Hypre_IJParCSRMatrix__object* self,
  int32_t nrows,
  struct SIDL_int__array* ncols,
  struct SIDL_int__array* rows,
...
static int32_t
remote_Hypre_IJParCSRMatrix_GetLocalRange(
  struct Hypre_IJParCSRMatrix__object* self,
  int32_t* ilower,
  int32_t* iupper,
  int32_t* jlower,
...
static int32_t
remote_Hypre_IJParCSRMatrix_GetRowCounts(
  struct Hypre_IJParCSRMatrix__object* self,
  int32_t nrows,
  struct SIDL_int__array* rows,
  struct SIDL_int__array** ncols)
...
static int32_t
remote_Hypre_IJParCSRMatrix_GetValues(
  struct Hypre_IJParCSRMatrix__object* self,
  int32_t nrows,
  struct SIDL_int__array* ncols,
  struct SIDL_int__array* rows,
...
static int32_t
remote_Hypre_IJParCSRMatrix_SetRowSizes(
  struct Hypre_IJParCSRMatrix__object* self,
...
static int32_t
remote_Hypre_IJParCSRMatrix_Print(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* filename)
{
  return 0;
...
static int32_t
remote_Hypre_IJParCSRMatrix_Read(
  struct Hypre_IJParCSRMatrix__object* self,
  const char* filename,
  void* comm)
{
...
static int32_t
remote_Hypre_IJParCSRMatrix_GetRow(
  struct Hypre_IJParCSRMatrix__object* self,
  int32_t row,
  int32_t* size,
...
static void Hypre_IJParCSRMatrix__init_remote_epv(void)
{
  struct Hypre_IJParCSRMatrix__epv*    epv = &s_rem__hypre_ijparcsrmatrix;
  ...
  epv->f__cast                   = remote_Hypre_IJParCSRMatrix__cast;
  epv->f__delete                 = remote_Hypre_IJParCSRMatrix__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = remote_Hypre_IJParCSRMatrix_addRef;
  epv->f_deleteRef               = remote_Hypre_IJParCSRMatrix_deleteRef;
  epv->f_isSame                  = remote_Hypre_IJParCSRMatrix_isSame;
  epv->f_queryInt                = remote_Hypre_IJParCSRMatrix_queryInt;
  epv->f_isType                  = remote_Hypre_IJParCSRMatrix_isType;
  epv->f_getClassInfo            = remote_Hypre_IJParCSRMatrix_getClassInfo;
  epv->f_SetDiagOffdSizes        = remote_Hypre_IJParCSRMatrix_SetDiagOffdSizes;
  epv->f_SetCommunicator         = remote_Hypre_IJParCSRMatrix_SetCommunicator;
  epv->f_SetIntParameter         = remote_Hypre_IJParCSRMatrix_SetIntParameter;
  ...
  epv->f_SetDoubleArrayParameter = 
    remote_Hypre_IJParCSRMatrix_SetDoubleArrayParameter;
  epv->f_GetIntValue             = remote_Hypre_IJParCSRMatrix_GetIntValue;
  epv->f_GetDoubleValue          = remote_Hypre_IJParCSRMatrix_GetDoubleValue;
  epv->f_Setup                   = remote_Hypre_IJParCSRMatrix_Setup;
  epv->f_Apply                   = remote_Hypre_IJParCSRMatrix_Apply;
  epv->f_Initialize              = remote_Hypre_IJParCSRMatrix_Initialize;
  epv->f_Assemble                = remote_Hypre_IJParCSRMatrix_Assemble;
  epv->f_GetObject               = remote_Hypre_IJParCSRMatrix_GetObject;
  epv->f_SetLocalRange           = remote_Hypre_IJParCSRMatrix_SetLocalRange;
  epv->f_SetValues               = remote_Hypre_IJParCSRMatrix_SetValues;
  epv->f_AddToValues             = remote_Hypre_IJParCSRMatrix_AddToValues;
  epv->f_GetLocalRange           = remote_Hypre_IJParCSRMatrix_GetLocalRange;
  epv->f_GetRowCounts            = remote_Hypre_IJParCSRMatrix_GetRowCounts;
  epv->f_GetValues               = remote_Hypre_IJParCSRMatrix_GetValues;
  epv->f_SetRowSizes             = remote_Hypre_IJParCSRMatrix_SetRowSizes;
  epv->f_Print                   = remote_Hypre_IJParCSRMatrix_Print;
  epv->f_Read                    = remote_Hypre_IJParCSRMatrix_Read;
  epv->f_GetRow                  = remote_Hypre_IJParCSRMatrix_GetRow;
...
Hypre_IJParCSRMatrix__remote(const char *url)
{
  ...
  if (!s_remote_initialized) {
    Hypre_IJParCSRMatrix__init_remote_epv();
  }
  ...
  s0->d_epv  = &s_rem__hypre_ijparcsrmatrix;
