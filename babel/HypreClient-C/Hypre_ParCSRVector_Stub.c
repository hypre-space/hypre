 ...
 * Generated:     20030121 14:39:20 PST
...
static const struct Hypre_ParCSRVector__external* _loadIOR(void)
/*
...

{
  ...
  if (!_ior) {
    fputs("Babel: unable to load the implementation for Hypre.ParCSRVector; please set SIDL_DLL_PATH\n", stderr);
    exit(-1);
  }
#endif
  return _ior;
...
{
  return (struct 
    Hypre_ParCSRVector__array*)SIDL_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    Hypre_ParCSRVector__array*)SIDL_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct Hypre_ParCSRVector__array*)SIDL_interface__array_create1d(len);
}
...
{
  return (struct Hypre_ParCSRVector__array*)SIDL_interface__array_create2dCol(m,
    n);
}
...
{
  return (struct Hypre_ParCSRVector__array*)SIDL_interface__array_create2dRow(m,
    n);
}
...
{
  return (struct Hypre_ParCSRVector__array*)SIDL_interface__array_borrow(
...
{
  return (struct Hypre_ParCSRVector__array*)
