...
interface bHYPRE_SStructSplit__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(mpi_comm, A, retval, exception)
    ...
    !  out bHYPRE.SStructSplit retval
    type(bHYPRE_SStructSplit_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructSplit_Create_m
    call bHYPRE_SStructSplit_Create_m(mpi_comm, A, retval, exception)
  ...
  recursive subroutine SetOperator_s(self, A, retval, exception)
    implicit none
    !  in bHYPRE.SStructSplit self
    type(bHYPRE_SStructSplit_t) , intent(in) :: self
    !  in bHYPRE.Operator A
    type(bHYPRE_Operator_t) , intent(in) :: A
    !  out int retval
    ...
    external bHYPRE_SStructSplit_SetOperator_m
    call bHYPRE_SStructSplit_SetOperator_m(self, A, retval, exception)
  ...
  recursive subroutine SetTolerance_s(self, tolerance, retval, exception)
    ...
    external bHYPRE_SStructSplit_SetTolerance_m
    call bHYPRE_SStructSplit_SetTolerance_m(self, tolerance, retval,           &
      exception)
  ...
  recursive subroutine SetMaxIterations_s(self, max_iterations, retval,        &
    ...
    external bHYPRE_SStructSplit_SetMaxIterations_m
    call bHYPRE_SStructSplit_SetMaxIterations_m(self, max_iterations, retval,  &
      exception)
  ...
  recursive subroutine SetLogging_s(self, level, retval, exception)
    ...
    external bHYPRE_SStructSplit_SetLogging_m
    call bHYPRE_SStructSplit_SetLogging_m(self, level, retval, exception)
  ...
  recursive subroutine SetPrintLevel_s(self, level, retval, exception)
    ...
    external bHYPRE_SStructSplit_SetPrintLevel_m
    call bHYPRE_SStructSplit_SetPrintLevel_m(self, level, retval, exception)
  ...
  recursive subroutine GetNumIterations_s(self, num_iterations, retval,        &
    ...
    external bHYPRE_SStructSplit_GetNumIterations_m
    call bHYPRE_SStructSplit_GetNumIterations_m(self, num_iterations, retval,  &
      exception)
  ...
  recursive subroutine GetRelResidualNorm_s(self, norm, retval, exception)
    ...
    external bHYPRE_SStructSplit_GetRelResidualNorm_m
    call bHYPRE_SStructSplit_GetRelResidualNorm_m(self, norm, retval,          &
      exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_SStructSplit_SetCommunicator_m
    call bHYPRE_SStructSplit_SetCommunicator_m(self, mpi_comm, retval,         &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_SStructSplit_Destroy_m
    call bHYPRE_SStructSplit_Destroy_m(self, exception)
  ...
  recursive subroutine SetIntParameter_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructSplit_SetIntParameter_m
    call bHYPRE_SStructSplit_SetIntParameter_m(self, name, value, retval,      &
      exception)
  ...
  recursive subroutine SetDoubleParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_SStructSplit_SetDoubleParameter_m
    call bHYPRE_SStructSplit_SetDoubleParameter_m(self, name, value, retval,   &
      exception)
  ...
  recursive subroutine SetStringParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_SStructSplit_SetStringParameter_m
    call bHYPRE_SStructSplit_SetStringParameter_m(self, name, value, retval,   &
      exception)
  ...
  recursive subroutine SetIntArray1Parameter_1s(self, name, value, retval,     &
    ...
    external bHYPRE_SStructSplit_SetIntArray1Parameter_a
    call bHYPRE_SStructSplit_SetIntArray1Parameter_a(self, name, value,        &
      retval, exception)
  ...
  recursive subroutine SetIntArray1Parameter_2s(self, name, value, retval,     &
    ...
    external bHYPRE_SStructSplit_SetIntArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_SStructSplit_SetIntArray1Parameter_m(self, name, value,        &
  ...
  recursive subroutine SetIntArray2Parameter_s(self, name, value, retval,      &
    ...
    external bHYPRE_SStructSplit_SetIntArray2Parameter_m
    call bHYPRE_SStructSplit_SetIntArray2Parameter_m(self, name, value,        &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_1s(self, name, value, retval,  &
    ...
    external bHYPRE_SStructSplit_SetDoubleArray1Parameter_a
    call bHYPRE_SStructSplit_SetDoubleArray1Parameter_a(self, name, value,     &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_2s(self, name, value, retval,  &
    ...
    external bHYPRE_SStructSplit_SetDoubleArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_SStructSplit_SetDoubleArray1Parameter_m(self, name, value,     &
      nvalues, retval, exception)
  ...
  recursive subroutine SetDoubleArray2Parameter_s(self, name, value, retval,   &
    ...
    external bHYPRE_SStructSplit_SetDoubleArray2Parameter_m
    call bHYPRE_SStructSplit_SetDoubleArray2Parameter_m(self, name, value,     &
      retval, exception)
  ...
  recursive subroutine GetIntValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructSplit_GetIntValue_m
    call bHYPRE_SStructSplit_GetIntValue_m(self, name, value, retval,          &
      exception)
  ...
  recursive subroutine GetDoubleValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructSplit_GetDoubleValue_m
    call bHYPRE_SStructSplit_GetDoubleValue_m(self, name, value, retval,       &
      exception)
  ...
  recursive subroutine Setup_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructSplit_Setup_m
    call bHYPRE_SStructSplit_Setup_m(self, b, x, retval, exception)
  ...
  recursive subroutine Apply_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructSplit_Apply_m
    call bHYPRE_SStructSplit_Apply_m(self, b, x, retval, exception)
  ...
  recursive subroutine ApplyAdjoint_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructSplit_ApplyAdjoint_m
    call bHYPRE_SStructSplit_ApplyAdjoint_m(self, b, x, retval, exception)
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_SStructSplit_newLocal_m
    call bHYPRE_SStructSplit_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    implicit none
    !  out bHYPRE.SStructSplit self
    type(bHYPRE_SStructSplit_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructSplit_newRemote_m
    call bHYPRE_SStructSplit_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_SStructSplit_rConnect_m
    call bHYPRE_SStructSplit_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_SStructSplit_addRef_m
    call bHYPRE_SStructSplit_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_SStructSplit_deleteRef_m
    call bHYPRE_SStructSplit_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_SStructSplit_isSame_m
    call bHYPRE_SStructSplit_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_SStructSplit_isType_m
    call bHYPRE_SStructSplit_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_SStructSplit_getClassInfo_m
    call bHYPRE_SStructSplit_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.SStructSplit
  ! to bHYPRE.Operator.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_SStructSplit_t), intent(in) :: oldType
  ...
  ! to bHYPRE.SStructSplit.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_Operator_t), intent(in) :: oldType
    type(bHYPRE_SStructSplit_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_SStructSplit__cast_m

    call bHYPRE_SStructSplit__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_SStructSplit__exec_m
    call bHYPRE_SStructSplit__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_SStructSplit__getURL_m
    call bHYPRE_SStructSplit__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_SStructSplit__isRemote_m
    call bHYPRE_SStructSplit__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_SStructSplit__isLocal_m
    call bHYPRE_SStructSplit__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_SStructSplit__set_hooks_m
    call bHYPRE_SStructSplit__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_SStructSplit__set_hooks_static_m
    call bHYPRE_SStructSplit__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_SStructSplit_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_SStructSplit_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_SStructSplit

module bHYPRE_SStructSplit_array
  use sidl
  use bHYPRE_SStructSplit_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructSns95go528r_p, &
    castbHYPRE_SStructSm8jjpqovf7_p, &
    castbHYPRE_SStructS7cu098dxw9_p, &
    castbHYPRE_SStructSoacwt60a7c_p, &
    castbHYPRE_SStructS4s7yxka7s5_p, &
    castbHYPRE_SStructSbn1q8di_8f_p, &
    castbHYPRE_SStructSzv0ekmhmwe_p
interface cast
  module procedure &
    castbHYPRE_SStructSns95go528r_p, &
    castbHYPRE_SStructSm8jjpqovf7_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_1d), intent(out) :: array
    external SS_ary_createColtq1hyv2ljdfj7_m
    call SS_ary_createColtq1hyv2ljdfj7_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_SStructSplit_1d), intent(out) :: array
    external SS_ary_createRowxzd_t0bp84q07_m
    call SS_ary_createRowxzd_t0bp84q07_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_SStructSplit_1d), intent(out) :: array
    external SSt_ary_create1dvf6nl_vew7b1v_m
    call SSt_ary_create1dvf6nl_vew7b1v_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructSplit_1d), intent(in) :: src
    type(bHYPRE_SStructSplit_1d), intent(in) :: dest
    external SStruct_ary_copyzrh0juxbw3ibh_m
    call SStruct_ary_copyzrh0juxbw3ibh_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: src
    type(bHYPRE_SStructSplit_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurexe312z4xlnvus_m
    call SStru_ary_ensurexe312z4xlnvus_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external SStruc_ary_slice3dlz2wletnun2_m
    call SStruc_ary_slice3dlz2wletnun2_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructSplit_t), intent(out) :: value
    external SStructS_ary_get5nycaxxu9rl0a_m
    call SStructS_ary_get5nycaxxu9rl0a_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructSplit_t), intent(in) :: value
    external SStructS_ary_sett_qnpy_4ftah9_m
    call SStructS_ary_sett_qnpy_4ftah9_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_SStructSplit_t), intent(out) :: value
    external SStruct_ary_get1l_v_u0i1yfr1e_m
    call SStruct_ary_get1l_v_u0i1yfr1e_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_SStructSplit_t), intent(in) :: value
    external SStruct_ary_set1vgn3xh6olngik_m
    call SStruct_ary_set1vgn3xh6olngik_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructSplit_1d), intent(in) :: src
    type(bHYPRE_SStructSplit_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyfl266a3p4iprg_m
    dim = 1
    call SS_ary_smartCopyfl266a3p4iprg_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    external ary_isColumnOrder241bi5bcpm4r_m
    call ary_isColumnOrder241bi5bcpm4r_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    external S_ary_isRowOrder9_xnbztfqp8sx_m
    call S_ary_isRowOrder9_xnbztfqp8sx_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    external SStruc_ary_dimenzdfjfwgtrav4f_m
    call SStruc_ary_dimenzdfjfwgtrav4f_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stridei_wrr6yl9k8id_m
    call SStru_ary_stridei_wrr6yl9k8id_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerc9e68kecxws6r_m
    call SStruc_ary_lowerc9e68kecxws6r_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergmdexs57ah7g5_m
    call SStruc_ary_uppergmdexs57ah7g5_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length2qvb2vuvq2n6f_m
    call SStru_ary_length2qvb2vuvq2n6f_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    external SStru_ary_addRefybswypm0_8549_m
    call SStru_ary_addRefybswypm0_8549_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_SStructSplit_1d), intent(in)  :: array
    external SS_ary_deleteRefcv1av5mc3nq_6_m
    call SS_ary_deleteRefcv1av5mc3nq_6_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_2d), intent(out) :: array
    external SS_ary_createColtq1hyv2ljdfj7_m
    call SS_ary_createColtq1hyv2ljdfj7_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_2d), intent(out) :: array
    external SS_ary_createRowxzd_t0bp84q07_m
    call SS_ary_createRowxzd_t0bp84q07_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructSplit_2d), intent(out) :: array
    external ary_create2dCol4lir15wb08hzjf_m
    call ary_create2dCol4lir15wb08hzjf_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructSplit_2d), intent(out) :: array
    external ary_create2dRow40t6il476y9vn2_m
    call ary_create2dRow40t6il476y9vn2_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructSplit_2d), intent(in) :: src
    type(bHYPRE_SStructSplit_2d), intent(in) :: dest
    external SStruct_ary_copyzrh0juxbw3ibh_m
    call SStruct_ary_copyzrh0juxbw3ibh_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructSplit_2d), intent(in)  :: src
    type(bHYPRE_SStructSplit_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurexe312z4xlnvus_m
    call SStru_ary_ensurexe312z4xlnvus_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice3dlz2wletnun2_m
    call SStruc_ary_slice3dlz2wletnun2_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructSplit_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_SStructSplit_t), intent(out) :: value
    external SStruct_ary_get2kxvppxgm95778_m
    call SStruct_ary_get2kxvppxgm95778_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_SStructSplit_t), intent(in) :: value
    external SStruct_ary_set2__vli1baedoa3_m
    call SStruct_ary_set2__vli1baedoa3_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructSplit_2d), intent(in) :: src
    type(bHYPRE_SStructSplit_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyfl266a3p4iprg_m
    dim = 2
    call SS_ary_smartCopyfl266a3p4iprg_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_SStructSplit_2d), intent(in)  :: array
    external ary_isColumnOrder241bi5bcpm4r_m
    call ary_isColumnOrder241bi5bcpm4r_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_SStructSplit_2d), intent(in)  :: array
    external S_ary_isRowOrder9_xnbztfqp8sx_m
    call S_ary_isRowOrder9_xnbztfqp8sx_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_SStructSplit_2d), intent(in)  :: array
    external SStruc_ary_dimenzdfjfwgtrav4f_m
    call SStruc_ary_dimenzdfjfwgtrav4f_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stridei_wrr6yl9k8id_m
    call SStru_ary_stridei_wrr6yl9k8id_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerc9e68kecxws6r_m
    call SStruc_ary_lowerc9e68kecxws6r_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergmdexs57ah7g5_m
    call SStruc_ary_uppergmdexs57ah7g5_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length2qvb2vuvq2n6f_m
    call SStru_ary_length2qvb2vuvq2n6f_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_3d), intent(out) :: array
    external SS_ary_createColtq1hyv2ljdfj7_m
    call SS_ary_createColtq1hyv2ljdfj7_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_3d), intent(out) :: array
    external SS_ary_createRowxzd_t0bp84q07_m
    call SS_ary_createRowxzd_t0bp84q07_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructSplit_3d), intent(in) :: src
    type(bHYPRE_SStructSplit_3d), intent(in) :: dest
    external SStruct_ary_copyzrh0juxbw3ibh_m
    call SStruct_ary_copyzrh0juxbw3ibh_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructSplit_3d), intent(in)  :: src
    type(bHYPRE_SStructSplit_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurexe312z4xlnvus_m
    call SStru_ary_ensurexe312z4xlnvus_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice3dlz2wletnun2_m
    call SStruc_ary_slice3dlz2wletnun2_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructSplit_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_SStructSplit_t), intent(out) :: value
    external SStruct_ary_get37ffmtvkrhh9v3_m
    call SStruct_ary_get37ffmtvkrhh9v3_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_SStructSplit_t), intent(in) :: value
    external SStruct_ary_set36u8xrllxaqdh1_m
    call SStruct_ary_set36u8xrllxaqdh1_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructSplit_3d), intent(in) :: src
    type(bHYPRE_SStructSplit_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyfl266a3p4iprg_m
    dim = 3
    call SS_ary_smartCopyfl266a3p4iprg_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_SStructSplit_3d), intent(in)  :: array
    external ary_isColumnOrder241bi5bcpm4r_m
    call ary_isColumnOrder241bi5bcpm4r_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_SStructSplit_3d), intent(in)  :: array
    external S_ary_isRowOrder9_xnbztfqp8sx_m
    call S_ary_isRowOrder9_xnbztfqp8sx_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_SStructSplit_3d), intent(in)  :: array
    external SStruc_ary_dimenzdfjfwgtrav4f_m
    call SStruc_ary_dimenzdfjfwgtrav4f_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stridei_wrr6yl9k8id_m
    call SStru_ary_stridei_wrr6yl9k8id_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerc9e68kecxws6r_m
    call SStruc_ary_lowerc9e68kecxws6r_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergmdexs57ah7g5_m
    call SStruc_ary_uppergmdexs57ah7g5_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length2qvb2vuvq2n6f_m
    call SStru_ary_length2qvb2vuvq2n6f_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_4d), intent(out) :: array
    external SS_ary_createColtq1hyv2ljdfj7_m
    call SS_ary_createColtq1hyv2ljdfj7_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_4d), intent(out) :: array
    external SS_ary_createRowxzd_t0bp84q07_m
    call SS_ary_createRowxzd_t0bp84q07_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructSplit_4d), intent(in) :: src
    type(bHYPRE_SStructSplit_4d), intent(in) :: dest
    external SStruct_ary_copyzrh0juxbw3ibh_m
    call SStruct_ary_copyzrh0juxbw3ibh_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructSplit_4d), intent(in)  :: src
    type(bHYPRE_SStructSplit_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurexe312z4xlnvus_m
    call SStru_ary_ensurexe312z4xlnvus_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice3dlz2wletnun2_m
    call SStruc_ary_slice3dlz2wletnun2_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructSplit_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_SStructSplit_t), intent(out) :: value
    external SStruct_ary_get48dpwi_gzcf58b_m
    call SStruct_ary_get48dpwi_gzcf58b_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_SStructSplit_t), intent(in) :: value
    external SStruct_ary_set4bu__fd0nwrr_y_m
    call SStruct_ary_set4bu__fd0nwrr_y_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructSplit_4d), intent(in) :: src
    type(bHYPRE_SStructSplit_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyfl266a3p4iprg_m
    dim = 4
    call SS_ary_smartCopyfl266a3p4iprg_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_SStructSplit_4d), intent(in)  :: array
    external ary_isColumnOrder241bi5bcpm4r_m
    call ary_isColumnOrder241bi5bcpm4r_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_SStructSplit_4d), intent(in)  :: array
    external S_ary_isRowOrder9_xnbztfqp8sx_m
    call S_ary_isRowOrder9_xnbztfqp8sx_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_SStructSplit_4d), intent(in)  :: array
    external SStruc_ary_dimenzdfjfwgtrav4f_m
    call SStruc_ary_dimenzdfjfwgtrav4f_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stridei_wrr6yl9k8id_m
    call SStru_ary_stridei_wrr6yl9k8id_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerc9e68kecxws6r_m
    call SStruc_ary_lowerc9e68kecxws6r_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergmdexs57ah7g5_m
    call SStruc_ary_uppergmdexs57ah7g5_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length2qvb2vuvq2n6f_m
    call SStru_ary_length2qvb2vuvq2n6f_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_5d), intent(out) :: array
    external SS_ary_createColtq1hyv2ljdfj7_m
    call SS_ary_createColtq1hyv2ljdfj7_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_5d), intent(out) :: array
    external SS_ary_createRowxzd_t0bp84q07_m
    call SS_ary_createRowxzd_t0bp84q07_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructSplit_5d), intent(in) :: src
    type(bHYPRE_SStructSplit_5d), intent(in) :: dest
    external SStruct_ary_copyzrh0juxbw3ibh_m
    call SStruct_ary_copyzrh0juxbw3ibh_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructSplit_5d), intent(in)  :: src
    type(bHYPRE_SStructSplit_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurexe312z4xlnvus_m
    call SStru_ary_ensurexe312z4xlnvus_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice3dlz2wletnun2_m
    call SStruc_ary_slice3dlz2wletnun2_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructSplit_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_SStructSplit_t), intent(out) :: value
    external SStruct_ary_get5mrqihgafo6jv4_m
    call SStruct_ary_get5mrqihgafo6jv4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_SStructSplit_t), intent(in) :: value
    external SStruct_ary_set5af0u1__g8b8vo_m
    call SStruct_ary_set5af0u1__g8b8vo_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructSplit_5d), intent(in) :: src
    type(bHYPRE_SStructSplit_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyfl266a3p4iprg_m
    dim = 5
    call SS_ary_smartCopyfl266a3p4iprg_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_SStructSplit_5d), intent(in)  :: array
    external ary_isColumnOrder241bi5bcpm4r_m
    call ary_isColumnOrder241bi5bcpm4r_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_SStructSplit_5d), intent(in)  :: array
    external S_ary_isRowOrder9_xnbztfqp8sx_m
    call S_ary_isRowOrder9_xnbztfqp8sx_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_SStructSplit_5d), intent(in)  :: array
    external SStruc_ary_dimenzdfjfwgtrav4f_m
    call SStruc_ary_dimenzdfjfwgtrav4f_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stridei_wrr6yl9k8id_m
    call SStru_ary_stridei_wrr6yl9k8id_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerc9e68kecxws6r_m
    call SStruc_ary_lowerc9e68kecxws6r_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergmdexs57ah7g5_m
    call SStruc_ary_uppergmdexs57ah7g5_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length2qvb2vuvq2n6f_m
    call SStru_ary_length2qvb2vuvq2n6f_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_6d), intent(out) :: array
    external SS_ary_createColtq1hyv2ljdfj7_m
    call SS_ary_createColtq1hyv2ljdfj7_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_6d), intent(out) :: array
    external SS_ary_createRowxzd_t0bp84q07_m
    call SS_ary_createRowxzd_t0bp84q07_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructSplit_6d), intent(in) :: src
    type(bHYPRE_SStructSplit_6d), intent(in) :: dest
    external SStruct_ary_copyzrh0juxbw3ibh_m
    call SStruct_ary_copyzrh0juxbw3ibh_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructSplit_6d), intent(in)  :: src
    type(bHYPRE_SStructSplit_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurexe312z4xlnvus_m
    call SStru_ary_ensurexe312z4xlnvus_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice3dlz2wletnun2_m
    call SStruc_ary_slice3dlz2wletnun2_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructSplit_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_SStructSplit_t), intent(out) :: value
    external SStruct_ary_get6uilj10l1lfrk__m
    call SStruct_ary_get6uilj10l1lfrk__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_SStructSplit_t), intent(in) :: value
    external SStruct_ary_set6myi8blonumkgv_m
    call SStruct_ary_set6myi8blonumkgv_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructSplit_6d), intent(in) :: src
    type(bHYPRE_SStructSplit_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyfl266a3p4iprg_m
    dim = 6
    call SS_ary_smartCopyfl266a3p4iprg_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_SStructSplit_6d), intent(in)  :: array
    external ary_isColumnOrder241bi5bcpm4r_m
    call ary_isColumnOrder241bi5bcpm4r_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_SStructSplit_6d), intent(in)  :: array
    external S_ary_isRowOrder9_xnbztfqp8sx_m
    call S_ary_isRowOrder9_xnbztfqp8sx_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_SStructSplit_6d), intent(in)  :: array
    external SStruc_ary_dimenzdfjfwgtrav4f_m
    call SStruc_ary_dimenzdfjfwgtrav4f_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stridei_wrr6yl9k8id_m
    call SStru_ary_stridei_wrr6yl9k8id_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerc9e68kecxws6r_m
    call SStruc_ary_lowerc9e68kecxws6r_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergmdexs57ah7g5_m
    call SStruc_ary_uppergmdexs57ah7g5_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length2qvb2vuvq2n6f_m
    call SStru_ary_length2qvb2vuvq2n6f_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_7d), intent(out) :: array
    external SS_ary_createColtq1hyv2ljdfj7_m
    call SS_ary_createColtq1hyv2ljdfj7_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructSplit_7d), intent(out) :: array
    external SS_ary_createRowxzd_t0bp84q07_m
    call SS_ary_createRowxzd_t0bp84q07_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructSplit_7d), intent(in) :: src
    type(bHYPRE_SStructSplit_7d), intent(in) :: dest
    external SStruct_ary_copyzrh0juxbw3ibh_m
    call SStruct_ary_copyzrh0juxbw3ibh_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructSplit_7d), intent(in)  :: src
    type(bHYPRE_SStructSplit_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurexe312z4xlnvus_m
    call SStru_ary_ensurexe312z4xlnvus_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice3dlz2wletnun2_m
    call SStruc_ary_slice3dlz2wletnun2_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructSplit_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_SStructSplit_t), intent(out) :: value
    external SStruct_ary_get7_nqo7xvcnmqlx_m
    call SStruct_ary_get7_nqo7xvcnmqlx_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_SStructSplit_t), intent(in) :: value
    external SStruct_ary_set76qyw1pxo___uz_m
    call SStruct_ary_set76qyw1pxo___uz_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructSplit_7d), intent(in) :: src
    type(bHYPRE_SStructSplit_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyfl266a3p4iprg_m
    dim = 7
    call SS_ary_smartCopyfl266a3p4iprg_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_SStructSplit_7d), intent(in)  :: array
    external ary_isColumnOrder241bi5bcpm4r_m
    call ary_isColumnOrder241bi5bcpm4r_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_SStructSplit_7d), intent(in)  :: array
    external S_ary_isRowOrder9_xnbztfqp8sx_m
    call S_ary_isRowOrder9_xnbztfqp8sx_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_SStructSplit_7d), intent(in)  :: array
    external SStruc_ary_dimenzdfjfwgtrav4f_m
    call SStruc_ary_dimenzdfjfwgtrav4f_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stridei_wrr6yl9k8id_m
    call SStru_ary_stridei_wrr6yl9k8id_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerc9e68kecxws6r_m
    call SStruc_ary_lowerc9e68kecxws6r_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergmdexs57ah7g5_m
    call SStruc_ary_uppergmdexs57ah7g5_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length2qvb2vuvq2n6f_m
    call SStru_ary_length2qvb2vuvq2n6f_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_SStructSns95go528r_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructSplit_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructSns95go528r_p

  subroutine castbHYPRE_SStructSm8jjpqovf7_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructSplit_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructSm8jjpqovf7_p

  subroutine castbHYPRE_SStructS7cu098dxw9_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructSplit_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructS7cu098dxw9_p

  subroutine castbHYPRE_SStructSoacwt60a7c_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructSplit_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructSoacwt60a7c_p

  subroutine castbHYPRE_SStructS4s7yxka7s5_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructSplit_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructS4s7yxka7s5_p

  subroutine castbHYPRE_SStructSbn1q8di_8f_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructSplit_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructSbn1q8di_8f_p

  subroutine castbHYPRE_SStructSzv0ekmhmwe_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructSplit_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructSzv0ekmhmwe_p


end module bHYPRE_SStructSplit_array
