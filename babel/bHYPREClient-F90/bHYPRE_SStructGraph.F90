...
module bHYPRE_SStructGraph

  use sidl
  use bHYPRE_SStructStencil_type
  ...
  interface Create
    ...
    private :: SetCommGrid_s


  interface SetCommGrid
    module procedure SetCommGrid_s
  end interface
  ...
  interface SetStencil
    ...
    private :: AddEntries_1s, &
    AddEntries_2s


  interface AddEntries
    module procedure AddEntries_1s, &
    AddEntries_2s
  end interface
  ...
  interface bHYPRE_SStructGraph__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(mpi_comm, grid, retval, exception)
    ...
    !  out bHYPRE.SStructGraph retval
    type(bHYPRE_SStructGraph_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructGraph_Create_m
    call bHYPRE_SStructGraph_Create_m(mpi_comm, grid, retval, exception)

  end subroutine Create_s


  recursive subroutine SetCommGrid_s(self, mpi_comm, grid, retval, exception)
    implicit none
    !  in bHYPRE.SStructGraph self
    type(bHYPRE_SStructGraph_t) , intent(in) :: self
    !  in bHYPRE.MPICommunicator mpi_comm
    type(bHYPRE_MPICommunicator_t) , intent(in) :: mpi_comm
    !  in bHYPRE.SStructGrid grid
    type(bHYPRE_SStructGrid_t) , intent(in) :: grid
    ...
    external bHYPRE_SStructGraph_SetCommGrid_m
    call bHYPRE_SStructGraph_SetCommGrid_m(self, mpi_comm, grid, retval,       &
      exception)

  end subroutine SetCommGrid_s


  recursive subroutine SetStencil_s(self, part, var, stencil, retval,          &
    exception)
    implicit none
    !  in bHYPRE.SStructGraph self
    type(bHYPRE_SStructGraph_t) , intent(in) :: self
    ...
    type(bHYPRE_SStructStencil_t) , intent(in) :: stencil
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructGraph_SetStencil_m
    call bHYPRE_SStructGraph_SetStencil_m(self, part, var, stencil, retval,    &
      exception)

  end subroutine SetStencil_s


  recursive subroutine AddEntries_1s(self, part, index, var, to_part,          &
    to_index, to_var, retval, exception)
    implicit none
    !  in bHYPRE.SStructGraph self
    type(bHYPRE_SStructGraph_t) , intent(in) :: self
    !  in int part
    ...
    integer (kind=sidl_int) , intent(in) :: var
    !  in int to_part
    integer (kind=sidl_int) , intent(in) :: to_part
    !  in array<int,column-major> to_index
    type(sidl_int_1d) , intent(in) :: to_index
    !  in int to_var
    ...
    external bHYPRE_SStructGraph_AddEntries_a
    call bHYPRE_SStructGraph_AddEntries_a(self, part, index, var, to_part,     &
      to_index, to_var, retval, exception)

  end subroutine AddEntries_1s

  recursive subroutine AddEntries_2s(self, part, index, var, to_part,          &
    to_index, to_var, retval, exception)
    implicit none
    !  in bHYPRE.SStructGraph self
    type(bHYPRE_SStructGraph_t) , intent(in) :: self
    ...
    integer (kind=sidl_int) , intent(in), dimension(:) :: to_index
    !  in int to_var
    integer (kind=sidl_int) , intent(in) :: to_var
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    ...
    external bHYPRE_SStructGraph_AddEntries_m
    dim = size(index, 1)
    call bHYPRE_SStructGraph_AddEntries_m(self, part, index, dim, var,         &
      to_part, to_index, to_var, retval, exception)

  end subroutine AddEntries_2s
  ...
  recursive subroutine SetObjectType_s(self, type, retval, exception)
    ...
    external bHYPRE_SStructGraph_SetObjectType_m
    call bHYPRE_SStructGraph_SetObjectType_m(self, type, retval, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_SStructGraph_SetCommunicator_m
    call bHYPRE_SStructGraph_SetCommunicator_m(self, mpi_comm, retval,         &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_SStructGraph_Destroy_m
    call bHYPRE_SStructGraph_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_SStructGraph_Initialize_m
    call bHYPRE_SStructGraph_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_SStructGraph_Assemble_m
    call bHYPRE_SStructGraph_Assemble_m(self, retval, exception)
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_SStructGraph_newLocal_m
    call bHYPRE_SStructGraph_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(bHYPRE_SStructGraph_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructGraph_newRemote_m
    call bHYPRE_SStructGraph_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_SStructGraph_rConnect_m
    call bHYPRE_SStructGraph_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_SStructGraph_addRef_m
    call bHYPRE_SStructGraph_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_SStructGraph_deleteRef_m
    call bHYPRE_SStructGraph_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_SStructGraph_isSame_m
    call bHYPRE_SStructGraph_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_SStructGraph_isType_m
    call bHYPRE_SStructGraph_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_SStructGraph_getClassInfo_m
    call bHYPRE_SStructGraph_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.SStructGraph
  ! to bHYPRE.ProblemDefinition.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_SStructGraph_t), intent(in) :: oldType
  ...
  ! to bHYPRE.SStructGraph.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_ProblemDefinition_t), intent(in) :: oldType
    type(bHYPRE_SStructGraph_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_SStructGraph__cast_m

    call bHYPRE_SStructGraph__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_SStructGraph__exec_m
    call bHYPRE_SStructGraph__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_SStructGraph__getURL_m
    call bHYPRE_SStructGraph__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_SStructGraph__isRemote_m
    call bHYPRE_SStructGraph__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_SStructGraph__isLocal_m
    call bHYPRE_SStructGraph__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_SStructGraph__set_hooks_m
    call bHYPRE_SStructGraph__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_SStructGraph__set_hooks_static_m
    call bHYPRE_SStructGraph__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_SStructGraph_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_SStructGraph_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_SStructGraph

module bHYPRE_SStructGraph_array
  use sidl
  use bHYPRE_SStructGraph_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructGgsyshgdgg7_p, &
    castbHYPRE_SStructGbcs3z4wszk_p, &
    castbHYPRE_SStructGt86vn2j6gt_p, &
    castbHYPRE_SStructGrfsq3ccmgm_p, &
    castbHYPRE_SStructG7kzanjc4uu_p, &
    castbHYPRE_SStructG4xqbjlk02s_p, &
    castbHYPRE_SStructGgze5k4tiow_p
interface cast
  module procedure &
    castbHYPRE_SStructGgsyshgdgg7_p, &
    castbHYPRE_SStructGbcs3z4wszk_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_1d), intent(out) :: array
    external SS_ary_createColgzsu5kv0u0y2y_m
    call SS_ary_createColgzsu5kv0u0y2y_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_SStructGraph_1d), intent(out) :: array
    external SS_ary_createRow0u5i25b9dsgwb_m
    call SS_ary_createRow0u5i25b9dsgwb_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_SStructGraph_1d), intent(out) :: array
    external SSt_ary_create1dcteip34yaghkr_m
    call SSt_ary_create1dcteip34yaghkr_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructGraph_1d), intent(in) :: src
    type(bHYPRE_SStructGraph_1d), intent(in) :: dest
    external SStruct_ary_copynosjwieu5akck_m
    call SStruct_ary_copynosjwieu5akck_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: src
    type(bHYPRE_SStructGraph_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure3ai1xd18dw698_m
    call SStru_ary_ensure3ai1xd18dw698_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external SStruc_ary_slicexvqqjnpimpjh7_m
    call SStruc_ary_slicexvqqjnpimpjh7_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructGraph_t), intent(out) :: value
    external SStructG_ary_getkgy863s1b3wgk_m
    call SStructG_ary_getkgy863s1b3wgk_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructGraph_t), intent(in) :: value
    external SStructG_ary_set2jfq72f5ztdir_m
    call SStructG_ary_set2jfq72f5ztdir_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_SStructGraph_t), intent(out) :: value
    external SStruct_ary_get1d9o_zbwigrd9j_m
    call SStruct_ary_get1d9o_zbwigrd9j_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_SStructGraph_t), intent(in) :: value
    external SStruct_ary_set1axx2o961n01rw_m
    call SStruct_ary_set1axx2o961n01rw_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructGraph_1d), intent(in) :: src
    type(bHYPRE_SStructGraph_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyneqw3dszef2tf_m
    dim = 1
    call SS_ary_smartCopyneqw3dszef2tf_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    external ary_isColumnOrderw5xon6mzr_yt_m
    call ary_isColumnOrderw5xon6mzr_yt_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    external S_ary_isRowOrderhjqw0ytyq4t7z_m
    call S_ary_isRowOrderhjqw0ytyq4t7z_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    external SStruc_ary_dimen60edira152tck_m
    call SStruc_ary_dimen60edira152tck_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideiz4aezvvpnkp2_m
    call SStru_ary_strideiz4aezvvpnkp2_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerqgly43wgwa2so_m
    call SStruc_ary_lowerqgly43wgwa2so_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperd_057462e0slc_m
    call SStruc_ary_upperd_057462e0slc_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length9tbukn1tjmw1e_m
    call SStru_ary_length9tbukn1tjmw1e_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    external SStru_ary_addRefcxb3dq8e8ejqt_m
    call SStru_ary_addRefcxb3dq8e8ejqt_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_SStructGraph_1d), intent(in)  :: array
    external SS_ary_deleteReffg_lpq86vtvmb_m
    call SS_ary_deleteReffg_lpq86vtvmb_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_2d), intent(out) :: array
    external SS_ary_createColgzsu5kv0u0y2y_m
    call SS_ary_createColgzsu5kv0u0y2y_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_2d), intent(out) :: array
    external SS_ary_createRow0u5i25b9dsgwb_m
    call SS_ary_createRow0u5i25b9dsgwb_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructGraph_2d), intent(out) :: array
    external ary_create2dColvipuo_bmcedgr6_m
    call ary_create2dColvipuo_bmcedgr6_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructGraph_2d), intent(out) :: array
    external ary_create2dRowv6786_4qs5mt5u_m
    call ary_create2dRowv6786_4qs5mt5u_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructGraph_2d), intent(in) :: src
    type(bHYPRE_SStructGraph_2d), intent(in) :: dest
    external SStruct_ary_copynosjwieu5akck_m
    call SStruct_ary_copynosjwieu5akck_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructGraph_2d), intent(in)  :: src
    type(bHYPRE_SStructGraph_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure3ai1xd18dw698_m
    call SStru_ary_ensure3ai1xd18dw698_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicexvqqjnpimpjh7_m
    call SStruc_ary_slicexvqqjnpimpjh7_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructGraph_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_SStructGraph_t), intent(out) :: value
    external SStruct_ary_get2fes2_l18vzszz_m
    call SStruct_ary_get2fes2_l18vzszz_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_SStructGraph_t), intent(in) :: value
    external SStruct_ary_set2_i8bp7easm66i_m
    call SStruct_ary_set2_i8bp7easm66i_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructGraph_2d), intent(in) :: src
    type(bHYPRE_SStructGraph_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyneqw3dszef2tf_m
    dim = 2
    call SS_ary_smartCopyneqw3dszef2tf_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_SStructGraph_2d), intent(in)  :: array
    external ary_isColumnOrderw5xon6mzr_yt_m
    call ary_isColumnOrderw5xon6mzr_yt_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_SStructGraph_2d), intent(in)  :: array
    external S_ary_isRowOrderhjqw0ytyq4t7z_m
    call S_ary_isRowOrderhjqw0ytyq4t7z_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_SStructGraph_2d), intent(in)  :: array
    external SStruc_ary_dimen60edira152tck_m
    call SStruc_ary_dimen60edira152tck_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideiz4aezvvpnkp2_m
    call SStru_ary_strideiz4aezvvpnkp2_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerqgly43wgwa2so_m
    call SStruc_ary_lowerqgly43wgwa2so_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperd_057462e0slc_m
    call SStruc_ary_upperd_057462e0slc_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length9tbukn1tjmw1e_m
    call SStru_ary_length9tbukn1tjmw1e_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_3d), intent(out) :: array
    external SS_ary_createColgzsu5kv0u0y2y_m
    call SS_ary_createColgzsu5kv0u0y2y_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_3d), intent(out) :: array
    external SS_ary_createRow0u5i25b9dsgwb_m
    call SS_ary_createRow0u5i25b9dsgwb_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructGraph_3d), intent(in) :: src
    type(bHYPRE_SStructGraph_3d), intent(in) :: dest
    external SStruct_ary_copynosjwieu5akck_m
    call SStruct_ary_copynosjwieu5akck_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructGraph_3d), intent(in)  :: src
    type(bHYPRE_SStructGraph_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure3ai1xd18dw698_m
    call SStru_ary_ensure3ai1xd18dw698_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicexvqqjnpimpjh7_m
    call SStruc_ary_slicexvqqjnpimpjh7_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructGraph_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_SStructGraph_t), intent(out) :: value
    external SStruct_ary_get3ngf1auqmkj09x_m
    call SStruct_ary_get3ngf1auqmkj09x_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_SStructGraph_t), intent(in) :: value
    external SStruct_ary_set3xa9eprqd7lt3m_m
    call SStruct_ary_set3xa9eprqd7lt3m_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructGraph_3d), intent(in) :: src
    type(bHYPRE_SStructGraph_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyneqw3dszef2tf_m
    dim = 3
    call SS_ary_smartCopyneqw3dszef2tf_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_SStructGraph_3d), intent(in)  :: array
    external ary_isColumnOrderw5xon6mzr_yt_m
    call ary_isColumnOrderw5xon6mzr_yt_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_SStructGraph_3d), intent(in)  :: array
    external S_ary_isRowOrderhjqw0ytyq4t7z_m
    call S_ary_isRowOrderhjqw0ytyq4t7z_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_SStructGraph_3d), intent(in)  :: array
    external SStruc_ary_dimen60edira152tck_m
    call SStruc_ary_dimen60edira152tck_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideiz4aezvvpnkp2_m
    call SStru_ary_strideiz4aezvvpnkp2_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerqgly43wgwa2so_m
    call SStruc_ary_lowerqgly43wgwa2so_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperd_057462e0slc_m
    call SStruc_ary_upperd_057462e0slc_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length9tbukn1tjmw1e_m
    call SStru_ary_length9tbukn1tjmw1e_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_4d), intent(out) :: array
    external SS_ary_createColgzsu5kv0u0y2y_m
    call SS_ary_createColgzsu5kv0u0y2y_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_4d), intent(out) :: array
    external SS_ary_createRow0u5i25b9dsgwb_m
    call SS_ary_createRow0u5i25b9dsgwb_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructGraph_4d), intent(in) :: src
    type(bHYPRE_SStructGraph_4d), intent(in) :: dest
    external SStruct_ary_copynosjwieu5akck_m
    call SStruct_ary_copynosjwieu5akck_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructGraph_4d), intent(in)  :: src
    type(bHYPRE_SStructGraph_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure3ai1xd18dw698_m
    call SStru_ary_ensure3ai1xd18dw698_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicexvqqjnpimpjh7_m
    call SStruc_ary_slicexvqqjnpimpjh7_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructGraph_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_SStructGraph_t), intent(out) :: value
    external SStruct_ary_get4gvw6dy99b6wq9_m
    call SStruct_ary_get4gvw6dy99b6wq9_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_SStructGraph_t), intent(in) :: value
    external SStruct_ary_set45xp7xzgxf9t0r_m
    call SStruct_ary_set45xp7xzgxf9t0r_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructGraph_4d), intent(in) :: src
    type(bHYPRE_SStructGraph_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyneqw3dszef2tf_m
    dim = 4
    call SS_ary_smartCopyneqw3dszef2tf_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_SStructGraph_4d), intent(in)  :: array
    external ary_isColumnOrderw5xon6mzr_yt_m
    call ary_isColumnOrderw5xon6mzr_yt_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_SStructGraph_4d), intent(in)  :: array
    external S_ary_isRowOrderhjqw0ytyq4t7z_m
    call S_ary_isRowOrderhjqw0ytyq4t7z_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_SStructGraph_4d), intent(in)  :: array
    external SStruc_ary_dimen60edira152tck_m
    call SStruc_ary_dimen60edira152tck_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideiz4aezvvpnkp2_m
    call SStru_ary_strideiz4aezvvpnkp2_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerqgly43wgwa2so_m
    call SStruc_ary_lowerqgly43wgwa2so_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperd_057462e0slc_m
    call SStruc_ary_upperd_057462e0slc_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length9tbukn1tjmw1e_m
    call SStru_ary_length9tbukn1tjmw1e_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_5d), intent(out) :: array
    external SS_ary_createColgzsu5kv0u0y2y_m
    call SS_ary_createColgzsu5kv0u0y2y_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_5d), intent(out) :: array
    external SS_ary_createRow0u5i25b9dsgwb_m
    call SS_ary_createRow0u5i25b9dsgwb_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructGraph_5d), intent(in) :: src
    type(bHYPRE_SStructGraph_5d), intent(in) :: dest
    external SStruct_ary_copynosjwieu5akck_m
    call SStruct_ary_copynosjwieu5akck_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructGraph_5d), intent(in)  :: src
    type(bHYPRE_SStructGraph_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure3ai1xd18dw698_m
    call SStru_ary_ensure3ai1xd18dw698_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicexvqqjnpimpjh7_m
    call SStruc_ary_slicexvqqjnpimpjh7_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructGraph_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_SStructGraph_t), intent(out) :: value
    external SStruct_ary_get534_w8366ia86z_m
    call SStruct_ary_get534_w8366ia86z_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_SStructGraph_t), intent(in) :: value
    external SStruct_ary_set51nxtlh_vlqbwp_m
    call SStruct_ary_set51nxtlh_vlqbwp_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructGraph_5d), intent(in) :: src
    type(bHYPRE_SStructGraph_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyneqw3dszef2tf_m
    dim = 5
    call SS_ary_smartCopyneqw3dszef2tf_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_SStructGraph_5d), intent(in)  :: array
    external ary_isColumnOrderw5xon6mzr_yt_m
    call ary_isColumnOrderw5xon6mzr_yt_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_SStructGraph_5d), intent(in)  :: array
    external S_ary_isRowOrderhjqw0ytyq4t7z_m
    call S_ary_isRowOrderhjqw0ytyq4t7z_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_SStructGraph_5d), intent(in)  :: array
    external SStruc_ary_dimen60edira152tck_m
    call SStruc_ary_dimen60edira152tck_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideiz4aezvvpnkp2_m
    call SStru_ary_strideiz4aezvvpnkp2_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerqgly43wgwa2so_m
    call SStruc_ary_lowerqgly43wgwa2so_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperd_057462e0slc_m
    call SStruc_ary_upperd_057462e0slc_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length9tbukn1tjmw1e_m
    call SStru_ary_length9tbukn1tjmw1e_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_6d), intent(out) :: array
    external SS_ary_createColgzsu5kv0u0y2y_m
    call SS_ary_createColgzsu5kv0u0y2y_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_6d), intent(out) :: array
    external SS_ary_createRow0u5i25b9dsgwb_m
    call SS_ary_createRow0u5i25b9dsgwb_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructGraph_6d), intent(in) :: src
    type(bHYPRE_SStructGraph_6d), intent(in) :: dest
    external SStruct_ary_copynosjwieu5akck_m
    call SStruct_ary_copynosjwieu5akck_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructGraph_6d), intent(in)  :: src
    type(bHYPRE_SStructGraph_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure3ai1xd18dw698_m
    call SStru_ary_ensure3ai1xd18dw698_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicexvqqjnpimpjh7_m
    call SStruc_ary_slicexvqqjnpimpjh7_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructGraph_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_SStructGraph_t), intent(out) :: value
    external SStruct_ary_get69b2a2g_3cf9nh_m
    call SStruct_ary_get69b2a2g_3cf9nh_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_SStructGraph_t), intent(in) :: value
    external SStruct_ary_set626e63zqj03urx_m
    call SStruct_ary_set626e63zqj03urx_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructGraph_6d), intent(in) :: src
    type(bHYPRE_SStructGraph_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyneqw3dszef2tf_m
    dim = 6
    call SS_ary_smartCopyneqw3dszef2tf_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_SStructGraph_6d), intent(in)  :: array
    external ary_isColumnOrderw5xon6mzr_yt_m
    call ary_isColumnOrderw5xon6mzr_yt_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_SStructGraph_6d), intent(in)  :: array
    external S_ary_isRowOrderhjqw0ytyq4t7z_m
    call S_ary_isRowOrderhjqw0ytyq4t7z_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_SStructGraph_6d), intent(in)  :: array
    external SStruc_ary_dimen60edira152tck_m
    call SStruc_ary_dimen60edira152tck_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideiz4aezvvpnkp2_m
    call SStru_ary_strideiz4aezvvpnkp2_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerqgly43wgwa2so_m
    call SStruc_ary_lowerqgly43wgwa2so_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperd_057462e0slc_m
    call SStruc_ary_upperd_057462e0slc_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length9tbukn1tjmw1e_m
    call SStru_ary_length9tbukn1tjmw1e_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_7d), intent(out) :: array
    external SS_ary_createColgzsu5kv0u0y2y_m
    call SS_ary_createColgzsu5kv0u0y2y_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructGraph_7d), intent(out) :: array
    external SS_ary_createRow0u5i25b9dsgwb_m
    call SS_ary_createRow0u5i25b9dsgwb_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructGraph_7d), intent(in) :: src
    type(bHYPRE_SStructGraph_7d), intent(in) :: dest
    external SStruct_ary_copynosjwieu5akck_m
    call SStruct_ary_copynosjwieu5akck_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructGraph_7d), intent(in)  :: src
    type(bHYPRE_SStructGraph_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure3ai1xd18dw698_m
    call SStru_ary_ensure3ai1xd18dw698_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicexvqqjnpimpjh7_m
    call SStruc_ary_slicexvqqjnpimpjh7_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructGraph_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_SStructGraph_t), intent(out) :: value
    external SStruct_ary_get76t17gd_d1oms3_m
    call SStruct_ary_get76t17gd_d1oms3_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_SStructGraph_t), intent(in) :: value
    external SStruct_ary_set70ppur0_nz5j80_m
    call SStruct_ary_set70ppur0_nz5j80_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructGraph_7d), intent(in) :: src
    type(bHYPRE_SStructGraph_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyneqw3dszef2tf_m
    dim = 7
    call SS_ary_smartCopyneqw3dszef2tf_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_SStructGraph_7d), intent(in)  :: array
    external ary_isColumnOrderw5xon6mzr_yt_m
    call ary_isColumnOrderw5xon6mzr_yt_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_SStructGraph_7d), intent(in)  :: array
    external S_ary_isRowOrderhjqw0ytyq4t7z_m
    call S_ary_isRowOrderhjqw0ytyq4t7z_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_SStructGraph_7d), intent(in)  :: array
    external SStruc_ary_dimen60edira152tck_m
    call SStruc_ary_dimen60edira152tck_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideiz4aezvvpnkp2_m
    call SStru_ary_strideiz4aezvvpnkp2_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerqgly43wgwa2so_m
    call SStruc_ary_lowerqgly43wgwa2so_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperd_057462e0slc_m
    call SStruc_ary_upperd_057462e0slc_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length9tbukn1tjmw1e_m
    call SStru_ary_length9tbukn1tjmw1e_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_SStructGgsyshgdgg7_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructGraph_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructGgsyshgdgg7_p

  subroutine castbHYPRE_SStructGbcs3z4wszk_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructGraph_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructGbcs3z4wszk_p

  subroutine castbHYPRE_SStructGt86vn2j6gt_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructGraph_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructGt86vn2j6gt_p

  subroutine castbHYPRE_SStructGrfsq3ccmgm_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructGraph_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructGrfsq3ccmgm_p

  subroutine castbHYPRE_SStructG7kzanjc4uu_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructGraph_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructG7kzanjc4uu_p

  subroutine castbHYPRE_SStructG4xqbjlk02s_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructGraph_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructG4xqbjlk02s_p

  subroutine castbHYPRE_SStructGgze5k4tiow_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructGraph_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructGgze5k4tiow_p


end module bHYPRE_SStructGraph_array
