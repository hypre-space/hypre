! 
! File:          sidl_rmi_ObjectDoesNotExistException.F90
...
! 
! Symbol "sidl.rmi.ObjectDoesNotExistException" (version 0.9.15)
! 
...
#include "sidl_io_IOException_fAbbrev.h"
#include "sidl_rmi_NetworkException_fAbbrev.h"
...
module sidl_rmi_ObjectDoesNotExistException

  use sidl
  use sidl_rmi_ObjectDoesNotExistException_type
  use sidl_SIDLException_type
  use sidl_io_Deserializer_type
  use sidl_ClassInfo_type
  use sidl_io_IOException_type
  use sidl_rmi_NetworkException_type
  ...
  private :: cast_0, cast_1, cast_2, cast_3, cast_4, cast_5, cast_6, cast_7,   &
    cast_8, cast_9, cast_10, cast_11, cast_12, cast_13, cast_14, cast_15
interface cast
  module procedure cast_0, cast_1, cast_2, cast_3, cast_4, cast_5, cast_6,     &
    cast_7, cast_8, cast_9, cast_10, cast_11, cast_12, cast_13, cast_14,       &
    cast_15
end interface
...
interface add
  ...
  private :: getHopCount_s


interface getHopCount
  module procedure getHopCount_s
end interface
  private :: packObj_s
...
contains
  ...
  recursive subroutine newLocal_s(retval, exception)
    implicit none
    !  out sidl.rmi.ObjectDoesNotExistException retval
    type(sidl_rmi_ObjectDoesNotExistException_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_ObjectDoesNotExistException_newLocal_m
    call sidl_rmi_ObjectDoesNotExistException_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_ObjectDoesNotExistException_newRemote_m
    call sidl_rmi_ObjectDoesNotExistException_newRemote_m(self, url,           &
      exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_rConnect_m
    call sidl_rmi_ObjectDoesNotExistException_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    implicit none
    !  in sidl.rmi.ObjectDoesNotExistException self
    type(sidl_rmi_ObjectDoesNotExistException_t) , intent(in) :: self
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_ObjectDoesNotExistException_addRef_m
    call sidl_rmi_ObjectDoesNotExistException_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_deleteRef_m
    call sidl_rmi_ObjectDoesNotExistException_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_isSame_m
    call sidl_rmi_ObjectDoesNotExistException_isSame_m(self, iobj, retval,     &
      exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_isType_m
    call sidl_rmi_ObjectDoesNotExistException_isType_m(self, name, retval,     &
      exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_getClassInfo_m
    call sidl_rmi_ObjectDoesNotExistException_getClassInfo_m(self, retval,     &
      exception)
  ...
  recursive subroutine getNote_s(self, retval, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_getNote_m
    call sidl_rmi_ObjectDoesNotExistException_getNote_m(self, retval,          &
      exception)
  ...
  recursive subroutine setNote_s(self, message, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_setNote_m
    call sidl_rmi_ObjectDoesNotExistException_setNote_m(self, message,         &
      exception)
  ...
  recursive subroutine getTrace_s(self, retval, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_getTrace_m
    call sidl_rmi_ObjectDoesNotExistException_getTrace_m(self, retval,         &
      exception)
  ...
  recursive subroutine addLine_s(self, traceline, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_addLine_m
    call sidl_rmi_ObjectDoesNotExistException_addLine_m(self, traceline,       &
      exception)
  ...
  recursive subroutine add_s(self, filename, lineno, methodname, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_add_m
    call sidl_rmi_ObjectDoesNotExistException_add_m(self, filename, lineno,    &
      methodname, exception)

  end subroutine add_s


  recursive subroutine getHopCount_s(self, retval, exception)
    implicit none
    !  in sidl.rmi.ObjectDoesNotExistException self
    type(sidl_rmi_ObjectDoesNotExistException_t) , intent(in) :: self
    !  out int retval
    ...
    external sidl_rmi_ObjectDoesNotExistException_getHopCount_m
    call sidl_rmi_ObjectDoesNotExistException_getHopCount_m(self, retval,      &
      exception)

  end subroutine getHopCount_s
  ...
  recursive subroutine packObj_s(self, ser, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_packObj_m
    call sidl_rmi_ObjectDoesNotExistException_packObj_m(self, ser, exception)
  ...
  recursive subroutine unpackObj_s(self, des, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException_unpackObj_m
    call sidl_rmi_ObjectDoesNotExistException_unpackObj_m(self, des,           &
      exception)

  end subroutine unpackObj_s

  ! 
  ! Static function to cast from sidl.rmi.ObjectDoesNotExistException
  ! to sidl.BaseClass.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: oldType
  ...
  ! to sidl.rmi.ObjectDoesNotExistException.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseClass_t), intent(in) :: oldType
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_ObjectDoesNotExistException__cast_m

    call sidl_rmi_ObjectDoesNotExistException__cast_m(oldType, newType,        &
      exception)
  ...
  ! 
  ! Static function to cast from sidl.rmi.ObjectDoesNotExistException
  ! to sidl.io.IOException.
  ! 

  subroutine cast_10(oldType, newType, exception)
    implicit none
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: oldType
    type(sidl_io_IOException_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_io_IOException__cast_m

    call sidl_io_IOException__cast_m(oldType, newType, exception)
  end subroutine cast_10

  ! 
  ! Static function to cast from sidl.io.IOException
  ! to sidl.rmi.ObjectDoesNotExistException.
  ! 

  subroutine cast_11(oldType, newType, exception)
    implicit none
    type(sidl_io_IOException_t), intent(in) :: oldType
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_ObjectDoesNotExistException__cast_m
  ...
  ! 
  ! Static function to cast from sidl.rmi.ObjectDoesNotExistException
  ! to sidl.rmi.NetworkException.
  ! 

  subroutine cast_14(oldType, newType, exception)
    implicit none
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: oldType
    type(sidl_rmi_NetworkException_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_NetworkException__cast_m

    call sidl_rmi_NetworkException__cast_m(oldType, newType, exception)
  end subroutine cast_14

  ! 
  ! Static function to cast from sidl.rmi.NetworkException
  ! to sidl.rmi.ObjectDoesNotExistException.
  ! 

  subroutine cast_15(oldType, newType, exception)
    implicit none
    type(sidl_rmi_NetworkException_t), intent(in) :: oldType
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_ObjectDoesNotExistException__cast_m
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException__exec_m
    call sidl_rmi_ObjectDoesNotExistException__exec_m(self, methodName,        &
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException__getURL_m
    call sidl_rmi_ObjectDoesNotExistException__getURL_m(self, retval,          &
      exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException__isRemote_m
    call sidl_rmi_ObjectDoesNotExistException__isRemote_m(self, retval,        &
      exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException__isLocal_m
    call sidl_rmi_ObjectDoesNotExistException__isLocal_m(self, retval,         &
      exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_rmi_ObjectDoesNotExistException__set_hooks_m
    call sidl_rmi_ObjectDoesNotExistException__set_hooks_m(self, on,           &
      exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_rmi_ObjectDoesNotExistException

module sidl_rmi_ObjectDoesNotExistException_array
  use sidl
  use sidl_rmi_ObjectDoesNotExistException_type
  use sidl_array_type
  ...
  private :: &
    castsidl_rmi_Objectsps9za2sjs_p, &
    castsidl_rmi_Objecthw937b8o2s_p, &
    castsidl_rmi_Objectvd0530nhrl_p, &
    castsidl_rmi_Object3x0smou3tv_p, &
    castsidl_rmi_Object98zdqtu2nj_p, &
    castsidl_rmi_Objectd9s7u7g8tw_p, &
    castsidl_rmi_Objectke62hd3hle_p
interface cast
  module procedure &
    castsidl_rmi_Objectsps9za2sjs_p, &
    castsidl_rmi_Objecthw937b8o2s_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(out) :: array
    external Ob_ary_createCol4aex5trb6v1fj_m
    call Ob_ary_createCol4aex5trb6v1fj_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(out) :: array
    external Ob_ary_createRowx44d9ii7oh4w1_m
    call Ob_ary_createRowx44d9ii7oh4w1_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(out) :: array
    external Obj_ary_create1dl0h32rml_9y9k_m
    call Obj_ary_create1dl0h32rml_9y9k_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in) :: dest
    external ObjectD_ary_copyglur06icnwtrp_m
    call ObjectD_ary_copyglur06icnwtrp_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: src
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Objec_ary_ensuredcmcbwj2ndle1_m
    call Objec_ary_ensuredcmcbwj2ndle1_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Object_ary_slice_16pvqqq1g7_x_m
    call Object_ary_slice_16pvqqq1g7_x_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: value
    external ObjectDo_ary_gett1oyr0n4jnu1o_m
    call ObjectDo_ary_gett1oyr0n4jnu1o_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: value
    external ObjectDo_ary_setcnaghanc4pzo7_m
    call ObjectDo_ary_setcnaghanc4pzo7_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: value
    external ObjectD_ary_get1a_23x0o44hzqz_m
    call ObjectD_ary_get1a_23x0o44hzqz_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: value
    external ObjectD_ary_set1vlc6mz9vq1itt_m
    call ObjectD_ary_set1vlc6mz9vq1itt_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ob_ary_smartCopy1rha4ucjd4yz3_m
    dim = 1
    call Ob_ary_smartCopy1rha4ucjd4yz3_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    external ary_isColumnOrderskrnujme3jsw_m
    call ary_isColumnOrderskrnujme3jsw_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    external O_ary_isRowOrder2dwhz3med9mto_m
    call O_ary_isRowOrder2dwhz3med9mto_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    external Object_ary_dimenjldlm04gepjjg_m
    call Object_ary_dimenjldlm04gepjjg_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_strideoggjr_oxwefu0_m
    call Objec_ary_strideoggjr_oxwefu0_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_loweregv2yf28apn7j_m
    call Object_ary_loweregv2yf28apn7j_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_upper5d93rzxah2p_l_m
    call Object_ary_upper5d93rzxah2p_l_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_lengthiql_ng5edsdud_m
    call Objec_ary_lengthiql_ng5edsdud_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    external Objec_ary_addRefi88ncioopha3m_m
    call Objec_ary_addRefi88ncioopha3m_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in)  :: array
    external Ob_ary_deleteRef_om5d58jv75_6_m
    call Ob_ary_deleteRef_om5d58jv75_6_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(out) :: array
    external Ob_ary_createCol4aex5trb6v1fj_m
    call Ob_ary_createCol4aex5trb6v1fj_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(out) :: array
    external Ob_ary_createRowx44d9ii7oh4w1_m
    call Ob_ary_createRowx44d9ii7oh4w1_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(out) :: array
    external ary_create2dColwnwcqvvwkyfrdx_m
    call ary_create2dColwnwcqvvwkyfrdx_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(out) :: array
    external ary_create2dRowdka_d3pmwrq0_9_m
    call ary_create2dRowdka_d3pmwrq0_9_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in) :: dest
    external ObjectD_ary_copyglur06icnwtrp_m
    call ObjectD_ary_copyglur06icnwtrp_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in)  :: src
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Objec_ary_ensuredcmcbwj2ndle1_m
    call Objec_ary_ensuredcmcbwj2ndle1_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Object_ary_slice_16pvqqq1g7_x_m
    call Object_ary_slice_16pvqqq1g7_x_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: value
    external ObjectD_ary_get2hovd7x7tt2j1u_m
    call ObjectD_ary_get2hovd7x7tt2j1u_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: value
    external ObjectD_ary_set20a11_q9xyru9y_m
    call ObjectD_ary_set20a11_q9xyru9y_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ob_ary_smartCopy1rha4ucjd4yz3_m
    dim = 2
    call Ob_ary_smartCopy1rha4ucjd4yz3_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in)  :: array
    external ary_isColumnOrderskrnujme3jsw_m
    call ary_isColumnOrderskrnujme3jsw_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in)  :: array
    external O_ary_isRowOrder2dwhz3med9mto_m
    call O_ary_isRowOrder2dwhz3med9mto_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in)  :: array
    external Object_ary_dimenjldlm04gepjjg_m
    call Object_ary_dimenjldlm04gepjjg_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_strideoggjr_oxwefu0_m
    call Objec_ary_strideoggjr_oxwefu0_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_loweregv2yf28apn7j_m
    call Object_ary_loweregv2yf28apn7j_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_upper5d93rzxah2p_l_m
    call Object_ary_upper5d93rzxah2p_l_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_lengthiql_ng5edsdud_m
    call Objec_ary_lengthiql_ng5edsdud_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(out) :: array
    external Ob_ary_createCol4aex5trb6v1fj_m
    call Ob_ary_createCol4aex5trb6v1fj_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(out) :: array
    external Ob_ary_createRowx44d9ii7oh4w1_m
    call Ob_ary_createRowx44d9ii7oh4w1_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in) :: dest
    external ObjectD_ary_copyglur06icnwtrp_m
    call ObjectD_ary_copyglur06icnwtrp_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in)  :: src
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Objec_ary_ensuredcmcbwj2ndle1_m
    call Objec_ary_ensuredcmcbwj2ndle1_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Object_ary_slice_16pvqqq1g7_x_m
    call Object_ary_slice_16pvqqq1g7_x_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: value
    external ObjectD_ary_get3rv8gagbw0a0fg_m
    call ObjectD_ary_get3rv8gagbw0a0fg_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: value
    external ObjectD_ary_set3la2bv2qi6dnia_m
    call ObjectD_ary_set3la2bv2qi6dnia_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ob_ary_smartCopy1rha4ucjd4yz3_m
    dim = 3
    call Ob_ary_smartCopy1rha4ucjd4yz3_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in)  :: array
    external ary_isColumnOrderskrnujme3jsw_m
    call ary_isColumnOrderskrnujme3jsw_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in)  :: array
    external O_ary_isRowOrder2dwhz3med9mto_m
    call O_ary_isRowOrder2dwhz3med9mto_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in)  :: array
    external Object_ary_dimenjldlm04gepjjg_m
    call Object_ary_dimenjldlm04gepjjg_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_strideoggjr_oxwefu0_m
    call Objec_ary_strideoggjr_oxwefu0_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_loweregv2yf28apn7j_m
    call Object_ary_loweregv2yf28apn7j_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_upper5d93rzxah2p_l_m
    call Object_ary_upper5d93rzxah2p_l_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_lengthiql_ng5edsdud_m
    call Objec_ary_lengthiql_ng5edsdud_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(out) :: array
    external Ob_ary_createCol4aex5trb6v1fj_m
    call Ob_ary_createCol4aex5trb6v1fj_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(out) :: array
    external Ob_ary_createRowx44d9ii7oh4w1_m
    call Ob_ary_createRowx44d9ii7oh4w1_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in) :: dest
    external ObjectD_ary_copyglur06icnwtrp_m
    call ObjectD_ary_copyglur06icnwtrp_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in)  :: src
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Objec_ary_ensuredcmcbwj2ndle1_m
    call Objec_ary_ensuredcmcbwj2ndle1_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Object_ary_slice_16pvqqq1g7_x_m
    call Object_ary_slice_16pvqqq1g7_x_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: value
    external ObjectD_ary_get41r8l_53b62n4a_m
    call ObjectD_ary_get41r8l_53b62n4a_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: value
    external ObjectD_ary_set4mngnhuli24aa1_m
    call ObjectD_ary_set4mngnhuli24aa1_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ob_ary_smartCopy1rha4ucjd4yz3_m
    dim = 4
    call Ob_ary_smartCopy1rha4ucjd4yz3_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in)  :: array
    external ary_isColumnOrderskrnujme3jsw_m
    call ary_isColumnOrderskrnujme3jsw_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in)  :: array
    external O_ary_isRowOrder2dwhz3med9mto_m
    call O_ary_isRowOrder2dwhz3med9mto_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in)  :: array
    external Object_ary_dimenjldlm04gepjjg_m
    call Object_ary_dimenjldlm04gepjjg_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_strideoggjr_oxwefu0_m
    call Objec_ary_strideoggjr_oxwefu0_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_loweregv2yf28apn7j_m
    call Object_ary_loweregv2yf28apn7j_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_upper5d93rzxah2p_l_m
    call Object_ary_upper5d93rzxah2p_l_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_lengthiql_ng5edsdud_m
    call Objec_ary_lengthiql_ng5edsdud_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(out) :: array
    external Ob_ary_createCol4aex5trb6v1fj_m
    call Ob_ary_createCol4aex5trb6v1fj_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(out) :: array
    external Ob_ary_createRowx44d9ii7oh4w1_m
    call Ob_ary_createRowx44d9ii7oh4w1_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in) :: dest
    external ObjectD_ary_copyglur06icnwtrp_m
    call ObjectD_ary_copyglur06icnwtrp_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in)  :: src
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Objec_ary_ensuredcmcbwj2ndle1_m
    call Objec_ary_ensuredcmcbwj2ndle1_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Object_ary_slice_16pvqqq1g7_x_m
    call Object_ary_slice_16pvqqq1g7_x_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: value
    external ObjectD_ary_get5a7m7xyrmssetb_m
    call ObjectD_ary_get5a7m7xyrmssetb_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: value
    external ObjectD_ary_set5m38y7c7z5e9kx_m
    call ObjectD_ary_set5m38y7c7z5e9kx_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ob_ary_smartCopy1rha4ucjd4yz3_m
    dim = 5
    call Ob_ary_smartCopy1rha4ucjd4yz3_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in)  :: array
    external ary_isColumnOrderskrnujme3jsw_m
    call ary_isColumnOrderskrnujme3jsw_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in)  :: array
    external O_ary_isRowOrder2dwhz3med9mto_m
    call O_ary_isRowOrder2dwhz3med9mto_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in)  :: array
    external Object_ary_dimenjldlm04gepjjg_m
    call Object_ary_dimenjldlm04gepjjg_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_strideoggjr_oxwefu0_m
    call Objec_ary_strideoggjr_oxwefu0_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_loweregv2yf28apn7j_m
    call Object_ary_loweregv2yf28apn7j_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_upper5d93rzxah2p_l_m
    call Object_ary_upper5d93rzxah2p_l_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_lengthiql_ng5edsdud_m
    call Objec_ary_lengthiql_ng5edsdud_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(out) :: array
    external Ob_ary_createCol4aex5trb6v1fj_m
    call Ob_ary_createCol4aex5trb6v1fj_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(out) :: array
    external Ob_ary_createRowx44d9ii7oh4w1_m
    call Ob_ary_createRowx44d9ii7oh4w1_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in) :: dest
    external ObjectD_ary_copyglur06icnwtrp_m
    call ObjectD_ary_copyglur06icnwtrp_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in)  :: src
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Objec_ary_ensuredcmcbwj2ndle1_m
    call Objec_ary_ensuredcmcbwj2ndle1_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Object_ary_slice_16pvqqq1g7_x_m
    call Object_ary_slice_16pvqqq1g7_x_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: value
    external ObjectD_ary_get61day1u63kpcwc_m
    call ObjectD_ary_get61day1u63kpcwc_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: value
    external ObjectD_ary_set6p642j3jpqam81_m
    call ObjectD_ary_set6p642j3jpqam81_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ob_ary_smartCopy1rha4ucjd4yz3_m
    dim = 6
    call Ob_ary_smartCopy1rha4ucjd4yz3_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in)  :: array
    external ary_isColumnOrderskrnujme3jsw_m
    call ary_isColumnOrderskrnujme3jsw_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in)  :: array
    external O_ary_isRowOrder2dwhz3med9mto_m
    call O_ary_isRowOrder2dwhz3med9mto_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in)  :: array
    external Object_ary_dimenjldlm04gepjjg_m
    call Object_ary_dimenjldlm04gepjjg_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_strideoggjr_oxwefu0_m
    call Objec_ary_strideoggjr_oxwefu0_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_loweregv2yf28apn7j_m
    call Object_ary_loweregv2yf28apn7j_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_upper5d93rzxah2p_l_m
    call Object_ary_upper5d93rzxah2p_l_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_lengthiql_ng5edsdud_m
    call Objec_ary_lengthiql_ng5edsdud_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(out) :: array
    external Ob_ary_createCol4aex5trb6v1fj_m
    call Ob_ary_createCol4aex5trb6v1fj_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(out) :: array
    external Ob_ary_createRowx44d9ii7oh4w1_m
    call Ob_ary_createRowx44d9ii7oh4w1_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in) :: dest
    external ObjectD_ary_copyglur06icnwtrp_m
    call ObjectD_ary_copyglur06icnwtrp_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in)  :: src
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Objec_ary_ensuredcmcbwj2ndle1_m
    call Objec_ary_ensuredcmcbwj2ndle1_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Object_ary_slice_16pvqqq1g7_x_m
    call Object_ary_slice_16pvqqq1g7_x_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(out) :: value
    external ObjectD_ary_get71tf0xdsaqa857_m
    call ObjectD_ary_get71tf0xdsaqa857_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_rmi_ObjectDoesNotExistException_t), intent(in) :: value
    external ObjectD_ary_set76dz39a7z79_pa_m
    call ObjectD_ary_set76dz39a7z79_pa_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in) :: src
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ob_ary_smartCopy1rha4ucjd4yz3_m
    dim = 7
    call Ob_ary_smartCopy1rha4ucjd4yz3_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in)  :: array
    external ary_isColumnOrderskrnujme3jsw_m
    call ary_isColumnOrderskrnujme3jsw_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in)  :: array
    external O_ary_isRowOrder2dwhz3med9mto_m
    call O_ary_isRowOrder2dwhz3med9mto_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in)  :: array
    external Object_ary_dimenjldlm04gepjjg_m
    call Object_ary_dimenjldlm04gepjjg_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_strideoggjr_oxwefu0_m
    call Objec_ary_strideoggjr_oxwefu0_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_loweregv2yf28apn7j_m
    call Object_ary_loweregv2yf28apn7j_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Object_ary_upper5d93rzxah2p_l_m
    call Object_ary_upper5d93rzxah2p_l_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Objec_ary_lengthiql_ng5edsdud_m
    call Objec_ary_lengthiql_ng5edsdud_m(array, index, length7_p)
  ...
  subroutine castsidl_rmi_Objectsps9za2sjs_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ObjectDoesNotExistException_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Objectsps9za2sjs_p

  subroutine castsidl_rmi_Objecthw937b8o2s_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ObjectDoesNotExistException_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Objecthw937b8o2s_p

  subroutine castsidl_rmi_Objectvd0530nhrl_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ObjectDoesNotExistException_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Objectvd0530nhrl_p

  subroutine castsidl_rmi_Object3x0smou3tv_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ObjectDoesNotExistException_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Object3x0smou3tv_p

  subroutine castsidl_rmi_Object98zdqtu2nj_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ObjectDoesNotExistException_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Object98zdqtu2nj_p

  subroutine castsidl_rmi_Objectd9s7u7g8tw_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ObjectDoesNotExistException_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Objectd9s7u7g8tw_p

  subroutine castsidl_rmi_Objectke62hd3hle_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ObjectDoesNotExistException_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Objectke62hd3hle_p


end module sidl_rmi_ObjectDoesNotExistException_array
