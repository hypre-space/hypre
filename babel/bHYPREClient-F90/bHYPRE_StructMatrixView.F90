! 
! File:          bHYPRE_StructMatrixView.F90
...
module bHYPRE_StructMatrixView
  ...
  interface SetGrid
    ...
    private :: SetStencil_s


  interface SetStencil
    module procedure SetStencil_s
  end interface
  ...
  interface SetSymmetric
    ...
    private :: SetConstantEntries_1s, &
    SetConstantEntries_2s


  interface SetConstantEntries
    module procedure SetConstantEntries_1s, &
    SetConstantEntries_2s
  end interface
    private :: SetConstantValues_1s, &
    SetConstantValues_2s


  interface SetConstantValues
    module procedure SetConstantValues_1s, &
    SetConstantValues_2s
  end interface
  private :: rConnect_s
  interface rConnect
...
contains
  ...
  recursive subroutine SetGrid_s(self, grid, retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_StructMatrixView_SetGrid_m
    call bHYPRE_StructMatrixView_SetGrid_m(self, grid, retval, exception)

  end subroutine SetGrid_s


  recursive subroutine SetStencil_s(self, stencil, retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    !  in bHYPRE.StructStencil stencil
    type(bHYPRE_StructStencil_t) , intent(in) :: stencil
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructMatrixView_SetStencil_m
    call bHYPRE_StructMatrixView_SetStencil_m(self, stencil, retval,           &
      exception)

  end subroutine SetStencil_s


  recursive subroutine SetValues_1s(self, index, stencil_indices, values,      &
    retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    ...
    !  in array<int,column-major> stencil_indices
    type(sidl_int_1d) , intent(in) :: stencil_indices
    ...
    external bHYPRE_StructMatrixView_SetValues_a
    call bHYPRE_StructMatrixView_SetValues_a(self, index, stencil_indices,     &
      values, retval, exception)

  end subroutine SetValues_1s

  recursive subroutine SetValues_2s(self, index, stencil_indices, values,      &
    retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    ...
    integer (kind=sidl_int) , intent(in), dimension(:) :: stencil_indices
    ...
    integer (kind=sidl_int) :: num_stencil_indices
    !  in int dim
    integer (kind=sidl_int) :: dim

    external bHYPRE_StructMatrixView_SetValues_m
    num_stencil_indices = size(values, 1)
    dim = size(index, 1)
    call bHYPRE_StructMatrixView_SetValues_m(self, index, dim,                 &
      num_stencil_indices, stencil_indices, values, retval, exception)

  end subroutine SetValues_2s


  recursive subroutine SetBoxValues_1s(self, ilower, iupper, stencil_indices,  &
    values, retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_StructMatrixView_SetBoxValues_a
    call bHYPRE_StructMatrixView_SetBoxValues_a(self, ilower, iupper,          &
      stencil_indices, values, retval, exception)

  end subroutine SetBoxValues_1s

  recursive subroutine SetBoxValues_2s(self, ilower, iupper, stencil_indices,  &
    values, retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_StructMatrixView_SetBoxValues_m
    num_stencil_indices = size(stencil_indices, 1)
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_StructMatrixView_SetBoxValues_m(self, ilower, iupper, dim,     &
      num_stencil_indices, stencil_indices, values, nvalues, retval,           &
      exception)
  ...
  recursive subroutine SetNumGhost_1s(self, num_ghost, retval, exception)
    ...
    external bHYPRE_StructMatrixView_SetNumGhost_a
    call bHYPRE_StructMatrixView_SetNumGhost_a(self, num_ghost, retval,        &
      exception)
  ...
  recursive subroutine SetNumGhost_2s(self, num_ghost, retval, exception)
    ...
    external bHYPRE_StructMatrixView_SetNumGhost_m
    dim2 = size(num_ghost, 1)
    call bHYPRE_StructMatrixView_SetNumGhost_m(self, num_ghost, dim2, retval,  &
      exception)

  end subroutine SetNumGhost_2s


  recursive subroutine SetSymmetric_s(self, symmetric, retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    !  in int symmetric
    ...
    external bHYPRE_StructMatrixView_SetSymmetric_m
    call bHYPRE_StructMatrixView_SetSymmetric_m(self, symmetric, retval,       &
      exception)

  end subroutine SetSymmetric_s


  recursive subroutine SetConstantEntries_1s(self, stencil_constant_points,    &
    retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    !  in array<int,column-major> stencil_constant_points
    type(sidl_int_1d) , intent(in) :: stencil_constant_points
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructMatrixView_SetConstantEntries_a
    call bHYPRE_StructMatrixView_SetConstantEntries_a(self,                    &
      stencil_constant_points, retval, exception)

  end subroutine SetConstantEntries_1s

  recursive subroutine SetConstantEntries_2s(self, stencil_constant_points,    &
    retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    !  in rarray<int> stencil_constant_points(num_stencil_constant_points)
    integer (kind=sidl_int) , intent(in),                                      &
      dimension(:) :: stencil_constant_points
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception
    !  in int num_stencil_constant_points
    integer (kind=sidl_int) :: num_stencil_constant_points

    external bHYPRE_StructMatrixView_SetConstantEntries_m
    num_stencil_constant_points = size(stencil_constant_points, 1)
    call bHYPRE_StructMatrixView_SetConstantEntries_m(self,                    &
      num_stencil_constant_points, stencil_constant_points, retval, exception)

  end subroutine SetConstantEntries_2s


  recursive subroutine SetConstantValues_1s(self, stencil_indices, values,     &
    retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_StructMatrixView_SetConstantValues_a
    call bHYPRE_StructMatrixView_SetConstantValues_a(self, stencil_indices,    &
      values, retval, exception)

  end subroutine SetConstantValues_1s

  recursive subroutine SetConstantValues_2s(self, stencil_indices, values,     &
    retval, exception)
    implicit none
    !  in bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_StructMatrixView_SetConstantValues_m
    num_stencil_indices = size(values, 1)
    call bHYPRE_StructMatrixView_SetConstantValues_m(self,                     &
      num_stencil_indices, stencil_indices, values, retval, exception)

  end subroutine SetConstantValues_2s


  recursive subroutine rConnect_s(self, url, exception)
    implicit none
    !  out bHYPRE.StructMatrixView self
    type(bHYPRE_StructMatrixView_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructMatrixView_rConnect_m
    call bHYPRE_StructMatrixView_rConnect_m(self, url, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_StructMatrixView_SetCommunicator_m
    call bHYPRE_StructMatrixView_SetCommunicator_m(self, mpi_comm, retval,     &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_StructMatrixView_Destroy_m
    call bHYPRE_StructMatrixView_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_StructMatrixView_Initialize_m
    call bHYPRE_StructMatrixView_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_StructMatrixView_Assemble_m
    call bHYPRE_StructMatrixView_Assemble_m(self, retval, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_StructMatrixView_addRef_m
    call bHYPRE_StructMatrixView_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_StructMatrixView_deleteRef_m
    call bHYPRE_StructMatrixView_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_StructMatrixView_isSame_m
    call bHYPRE_StructMatrixView_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_StructMatrixView_isType_m
    call bHYPRE_StructMatrixView_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_StructMatrixView_getClassInfo_m
    call bHYPRE_StructMatrixView_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.StructMatrixView
  ! to bHYPRE.MatrixVectorView.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_StructMatrixView_t), intent(in) :: oldType
  ...
  ! to bHYPRE.StructMatrixView.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_MatrixVectorView_t), intent(in) :: oldType
    type(bHYPRE_StructMatrixView_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_StructMatrixView__cast_m

    call bHYPRE_StructMatrixView__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_StructMatrixView__exec_m
    call bHYPRE_StructMatrixView__exec_m(self, methodName, inArgs, outArgs,    &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_StructMatrixView__getURL_m
    call bHYPRE_StructMatrixView__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_StructMatrixView__isRemote_m
    call bHYPRE_StructMatrixView__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_StructMatrixView__isLocal_m
    call bHYPRE_StructMatrixView__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_StructMatrixView__set_hooks_m
    call bHYPRE_StructMatrixView__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_StructMatrixView_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_StructMatrixView_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_StructMatrixView

module bHYPRE_StructMatrixView_array
  use sidl
  use bHYPRE_StructMatrixView_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_StructMaxx5itfwzl0_p, &
    castbHYPRE_StructMavqcf4qwfvj_p, &
    castbHYPRE_StructMawim68x13xb_p, &
    castbHYPRE_StructMaxxai4oztv6_p, &
    castbHYPRE_StructMapey4oc_d7l_p, &
    castbHYPRE_StructMaw4kwe5x2v5_p, &
    castbHYPRE_StructMarmuu_yqm44_p
interface cast
  module procedure &
    castbHYPRE_StructMaxx5itfwzl0_p, &
    castbHYPRE_StructMavqcf4qwfvj_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_1d), intent(out) :: array
    external St_ary_createColotnfcgo_ns9ua_m
    call St_ary_createColotnfcgo_ns9ua_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_StructMatrixView_1d), intent(out) :: array
    external St_ary_createRowh5kkujuklhaz2_m
    call St_ary_createRowh5kkujuklhaz2_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_StructMatrixView_1d), intent(out) :: array
    external Str_ary_create1d09rmysm2r4qe6_m
    call Str_ary_create1d09rmysm2r4qe6_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_StructMatrixView_1d), intent(in) :: src
    type(bHYPRE_StructMatrixView_1d), intent(in) :: dest
    external StructM_ary_copy5heuo0hkm97rh_m
    call StructM_ary_copy5heuo0hkm97rh_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: src
    type(bHYPRE_StructMatrixView_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensure6kd7zgb5cdz2p_m
    call Struc_ary_ensure6kd7zgb5cdz2p_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Struct_ary_slicen51dkuliviedw_m
    call Struct_ary_slicen51dkuliviedw_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructMatrixView_t), intent(out) :: value
    external StructMa_ary_getvg7ydj8f2zicx_m
    call StructMa_ary_getvg7ydj8f2zicx_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructMatrixView_t), intent(in) :: value
    external StructMa_ary_setqmwylkr08e3ev_m
    call StructMa_ary_setqmwylkr08e3ev_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_StructMatrixView_t), intent(out) :: value
    external StructM_ary_get15b2d6cun1f1na_m
    call StructM_ary_get15b2d6cun1f1na_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_StructMatrixView_t), intent(in) :: value
    external StructM_ary_set1fai1_jgisfki2_m
    call StructM_ary_set1fai1_jgisfki2_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_StructMatrixView_1d), intent(in) :: src
    type(bHYPRE_StructMatrixView_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyr49b4gmpvmvxk_m
    dim = 1
    call St_ary_smartCopyr49b4gmpvmvxk_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    external ary_isColumnOrdere3mk60erioyp_m
    call ary_isColumnOrdere3mk60erioyp_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    external S_ary_isRowOrderae1yd0daj_m1l_m
    call S_ary_isRowOrderae1yd0daj_m1l_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    external Struct_ary_dimen2hid9q_jh5cmr_m
    call Struct_ary_dimen2hid9q_jh5cmr_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridexs_a185b1h590_m
    call Struc_ary_stridexs_a185b1h590_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerv_11umdpwlpil_m
    call Struct_ary_lowerv_11umdpwlpil_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppervp4cpkdrcjb6l_m
    call Struct_ary_uppervp4cpkdrcjb6l_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthz1o28qcdbvy8b_m
    call Struc_ary_lengthz1o28qcdbvy8b_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    external Struc_ary_addRefj3p20rrfda574_m
    call Struc_ary_addRefj3p20rrfda574_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_StructMatrixView_1d), intent(in)  :: array
    external St_ary_deleteRef_tnj2bnh5qrr2_m
    call St_ary_deleteRef_tnj2bnh5qrr2_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_2d), intent(out) :: array
    external St_ary_createColotnfcgo_ns9ua_m
    call St_ary_createColotnfcgo_ns9ua_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_2d), intent(out) :: array
    external St_ary_createRowh5kkujuklhaz2_m
    call St_ary_createRowh5kkujuklhaz2_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructMatrixView_2d), intent(out) :: array
    external ary_create2dColuo2nwad6t5py35_m
    call ary_create2dColuo2nwad6t5py35_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructMatrixView_2d), intent(out) :: array
    external ary_create2dRowmdm0k3ib4ek4vk_m
    call ary_create2dRowmdm0k3ib4ek4vk_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_StructMatrixView_2d), intent(in) :: src
    type(bHYPRE_StructMatrixView_2d), intent(in) :: dest
    external StructM_ary_copy5heuo0hkm97rh_m
    call StructM_ary_copy5heuo0hkm97rh_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_StructMatrixView_2d), intent(in)  :: src
    type(bHYPRE_StructMatrixView_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensure6kd7zgb5cdz2p_m
    call Struc_ary_ensure6kd7zgb5cdz2p_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicen51dkuliviedw_m
    call Struct_ary_slicen51dkuliviedw_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_StructMatrixView_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_StructMatrixView_t), intent(out) :: value
    external StructM_ary_get2ot9rlxznjlhdx_m
    call StructM_ary_get2ot9rlxznjlhdx_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_StructMatrixView_t), intent(in) :: value
    external StructM_ary_set2wzhf07md9zer1_m
    call StructM_ary_set2wzhf07md9zer1_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_StructMatrixView_2d), intent(in) :: src
    type(bHYPRE_StructMatrixView_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyr49b4gmpvmvxk_m
    dim = 2
    call St_ary_smartCopyr49b4gmpvmvxk_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_StructMatrixView_2d), intent(in)  :: array
    external ary_isColumnOrdere3mk60erioyp_m
    call ary_isColumnOrdere3mk60erioyp_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_StructMatrixView_2d), intent(in)  :: array
    external S_ary_isRowOrderae1yd0daj_m1l_m
    call S_ary_isRowOrderae1yd0daj_m1l_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_StructMatrixView_2d), intent(in)  :: array
    external Struct_ary_dimen2hid9q_jh5cmr_m
    call Struct_ary_dimen2hid9q_jh5cmr_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridexs_a185b1h590_m
    call Struc_ary_stridexs_a185b1h590_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerv_11umdpwlpil_m
    call Struct_ary_lowerv_11umdpwlpil_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppervp4cpkdrcjb6l_m
    call Struct_ary_uppervp4cpkdrcjb6l_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthz1o28qcdbvy8b_m
    call Struc_ary_lengthz1o28qcdbvy8b_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_3d), intent(out) :: array
    external St_ary_createColotnfcgo_ns9ua_m
    call St_ary_createColotnfcgo_ns9ua_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_3d), intent(out) :: array
    external St_ary_createRowh5kkujuklhaz2_m
    call St_ary_createRowh5kkujuklhaz2_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_StructMatrixView_3d), intent(in) :: src
    type(bHYPRE_StructMatrixView_3d), intent(in) :: dest
    external StructM_ary_copy5heuo0hkm97rh_m
    call StructM_ary_copy5heuo0hkm97rh_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_StructMatrixView_3d), intent(in)  :: src
    type(bHYPRE_StructMatrixView_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensure6kd7zgb5cdz2p_m
    call Struc_ary_ensure6kd7zgb5cdz2p_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicen51dkuliviedw_m
    call Struct_ary_slicen51dkuliviedw_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_StructMatrixView_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_StructMatrixView_t), intent(out) :: value
    external StructM_ary_get3g9ql08refme5y_m
    call StructM_ary_get3g9ql08refme5y_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_StructMatrixView_t), intent(in) :: value
    external StructM_ary_set3q4slc517_icf7_m
    call StructM_ary_set3q4slc517_icf7_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_StructMatrixView_3d), intent(in) :: src
    type(bHYPRE_StructMatrixView_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyr49b4gmpvmvxk_m
    dim = 3
    call St_ary_smartCopyr49b4gmpvmvxk_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_StructMatrixView_3d), intent(in)  :: array
    external ary_isColumnOrdere3mk60erioyp_m
    call ary_isColumnOrdere3mk60erioyp_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_StructMatrixView_3d), intent(in)  :: array
    external S_ary_isRowOrderae1yd0daj_m1l_m
    call S_ary_isRowOrderae1yd0daj_m1l_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_StructMatrixView_3d), intent(in)  :: array
    external Struct_ary_dimen2hid9q_jh5cmr_m
    call Struct_ary_dimen2hid9q_jh5cmr_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridexs_a185b1h590_m
    call Struc_ary_stridexs_a185b1h590_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerv_11umdpwlpil_m
    call Struct_ary_lowerv_11umdpwlpil_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppervp4cpkdrcjb6l_m
    call Struct_ary_uppervp4cpkdrcjb6l_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthz1o28qcdbvy8b_m
    call Struc_ary_lengthz1o28qcdbvy8b_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_4d), intent(out) :: array
    external St_ary_createColotnfcgo_ns9ua_m
    call St_ary_createColotnfcgo_ns9ua_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_4d), intent(out) :: array
    external St_ary_createRowh5kkujuklhaz2_m
    call St_ary_createRowh5kkujuklhaz2_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_StructMatrixView_4d), intent(in) :: src
    type(bHYPRE_StructMatrixView_4d), intent(in) :: dest
    external StructM_ary_copy5heuo0hkm97rh_m
    call StructM_ary_copy5heuo0hkm97rh_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_StructMatrixView_4d), intent(in)  :: src
    type(bHYPRE_StructMatrixView_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensure6kd7zgb5cdz2p_m
    call Struc_ary_ensure6kd7zgb5cdz2p_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicen51dkuliviedw_m
    call Struct_ary_slicen51dkuliviedw_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_StructMatrixView_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_StructMatrixView_t), intent(out) :: value
    external StructM_ary_get46yt1fwlpxyxbz_m
    call StructM_ary_get46yt1fwlpxyxbz_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_StructMatrixView_t), intent(in) :: value
    external StructM_ary_set4ppv5pwcwqt9gw_m
    call StructM_ary_set4ppv5pwcwqt9gw_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_StructMatrixView_4d), intent(in) :: src
    type(bHYPRE_StructMatrixView_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyr49b4gmpvmvxk_m
    dim = 4
    call St_ary_smartCopyr49b4gmpvmvxk_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_StructMatrixView_4d), intent(in)  :: array
    external ary_isColumnOrdere3mk60erioyp_m
    call ary_isColumnOrdere3mk60erioyp_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_StructMatrixView_4d), intent(in)  :: array
    external S_ary_isRowOrderae1yd0daj_m1l_m
    call S_ary_isRowOrderae1yd0daj_m1l_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_StructMatrixView_4d), intent(in)  :: array
    external Struct_ary_dimen2hid9q_jh5cmr_m
    call Struct_ary_dimen2hid9q_jh5cmr_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridexs_a185b1h590_m
    call Struc_ary_stridexs_a185b1h590_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerv_11umdpwlpil_m
    call Struct_ary_lowerv_11umdpwlpil_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppervp4cpkdrcjb6l_m
    call Struct_ary_uppervp4cpkdrcjb6l_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthz1o28qcdbvy8b_m
    call Struc_ary_lengthz1o28qcdbvy8b_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_5d), intent(out) :: array
    external St_ary_createColotnfcgo_ns9ua_m
    call St_ary_createColotnfcgo_ns9ua_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_5d), intent(out) :: array
    external St_ary_createRowh5kkujuklhaz2_m
    call St_ary_createRowh5kkujuklhaz2_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_StructMatrixView_5d), intent(in) :: src
    type(bHYPRE_StructMatrixView_5d), intent(in) :: dest
    external StructM_ary_copy5heuo0hkm97rh_m
    call StructM_ary_copy5heuo0hkm97rh_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_StructMatrixView_5d), intent(in)  :: src
    type(bHYPRE_StructMatrixView_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensure6kd7zgb5cdz2p_m
    call Struc_ary_ensure6kd7zgb5cdz2p_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicen51dkuliviedw_m
    call Struct_ary_slicen51dkuliviedw_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_StructMatrixView_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_StructMatrixView_t), intent(out) :: value
    external StructM_ary_get5l0969x_roh516_m
    call StructM_ary_get5l0969x_roh516_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_StructMatrixView_t), intent(in) :: value
    external StructM_ary_set5bx1slin79rg4a_m
    call StructM_ary_set5bx1slin79rg4a_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_StructMatrixView_5d), intent(in) :: src
    type(bHYPRE_StructMatrixView_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyr49b4gmpvmvxk_m
    dim = 5
    call St_ary_smartCopyr49b4gmpvmvxk_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_StructMatrixView_5d), intent(in)  :: array
    external ary_isColumnOrdere3mk60erioyp_m
    call ary_isColumnOrdere3mk60erioyp_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_StructMatrixView_5d), intent(in)  :: array
    external S_ary_isRowOrderae1yd0daj_m1l_m
    call S_ary_isRowOrderae1yd0daj_m1l_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_StructMatrixView_5d), intent(in)  :: array
    external Struct_ary_dimen2hid9q_jh5cmr_m
    call Struct_ary_dimen2hid9q_jh5cmr_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridexs_a185b1h590_m
    call Struc_ary_stridexs_a185b1h590_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerv_11umdpwlpil_m
    call Struct_ary_lowerv_11umdpwlpil_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppervp4cpkdrcjb6l_m
    call Struct_ary_uppervp4cpkdrcjb6l_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthz1o28qcdbvy8b_m
    call Struc_ary_lengthz1o28qcdbvy8b_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_6d), intent(out) :: array
    external St_ary_createColotnfcgo_ns9ua_m
    call St_ary_createColotnfcgo_ns9ua_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_6d), intent(out) :: array
    external St_ary_createRowh5kkujuklhaz2_m
    call St_ary_createRowh5kkujuklhaz2_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_StructMatrixView_6d), intent(in) :: src
    type(bHYPRE_StructMatrixView_6d), intent(in) :: dest
    external StructM_ary_copy5heuo0hkm97rh_m
    call StructM_ary_copy5heuo0hkm97rh_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_StructMatrixView_6d), intent(in)  :: src
    type(bHYPRE_StructMatrixView_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensure6kd7zgb5cdz2p_m
    call Struc_ary_ensure6kd7zgb5cdz2p_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicen51dkuliviedw_m
    call Struct_ary_slicen51dkuliviedw_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_StructMatrixView_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_StructMatrixView_t), intent(out) :: value
    external StructM_ary_get6_684m130ei1y8_m
    call StructM_ary_get6_684m130ei1y8_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_StructMatrixView_t), intent(in) :: value
    external StructM_ary_set6d9dn34ac87ku2_m
    call StructM_ary_set6d9dn34ac87ku2_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_StructMatrixView_6d), intent(in) :: src
    type(bHYPRE_StructMatrixView_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyr49b4gmpvmvxk_m
    dim = 6
    call St_ary_smartCopyr49b4gmpvmvxk_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_StructMatrixView_6d), intent(in)  :: array
    external ary_isColumnOrdere3mk60erioyp_m
    call ary_isColumnOrdere3mk60erioyp_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_StructMatrixView_6d), intent(in)  :: array
    external S_ary_isRowOrderae1yd0daj_m1l_m
    call S_ary_isRowOrderae1yd0daj_m1l_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_StructMatrixView_6d), intent(in)  :: array
    external Struct_ary_dimen2hid9q_jh5cmr_m
    call Struct_ary_dimen2hid9q_jh5cmr_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridexs_a185b1h590_m
    call Struc_ary_stridexs_a185b1h590_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerv_11umdpwlpil_m
    call Struct_ary_lowerv_11umdpwlpil_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppervp4cpkdrcjb6l_m
    call Struct_ary_uppervp4cpkdrcjb6l_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthz1o28qcdbvy8b_m
    call Struc_ary_lengthz1o28qcdbvy8b_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_7d), intent(out) :: array
    external St_ary_createColotnfcgo_ns9ua_m
    call St_ary_createColotnfcgo_ns9ua_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_StructMatrixView_7d), intent(out) :: array
    external St_ary_createRowh5kkujuklhaz2_m
    call St_ary_createRowh5kkujuklhaz2_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_StructMatrixView_7d), intent(in) :: src
    type(bHYPRE_StructMatrixView_7d), intent(in) :: dest
    external StructM_ary_copy5heuo0hkm97rh_m
    call StructM_ary_copy5heuo0hkm97rh_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_StructMatrixView_7d), intent(in)  :: src
    type(bHYPRE_StructMatrixView_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensure6kd7zgb5cdz2p_m
    call Struc_ary_ensure6kd7zgb5cdz2p_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicen51dkuliviedw_m
    call Struct_ary_slicen51dkuliviedw_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_StructMatrixView_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_StructMatrixView_t), intent(out) :: value
    external StructM_ary_get7k0zzrsxydgizj_m
    call StructM_ary_get7k0zzrsxydgizj_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_StructMatrixView_t), intent(in) :: value
    external StructM_ary_set7vg2jh689ux5d1_m
    call StructM_ary_set7vg2jh689ux5d1_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_StructMatrixView_7d), intent(in) :: src
    type(bHYPRE_StructMatrixView_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyr49b4gmpvmvxk_m
    dim = 7
    call St_ary_smartCopyr49b4gmpvmvxk_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_StructMatrixView_7d), intent(in)  :: array
    external ary_isColumnOrdere3mk60erioyp_m
    call ary_isColumnOrdere3mk60erioyp_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_StructMatrixView_7d), intent(in)  :: array
    external S_ary_isRowOrderae1yd0daj_m1l_m
    call S_ary_isRowOrderae1yd0daj_m1l_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_StructMatrixView_7d), intent(in)  :: array
    external Struct_ary_dimen2hid9q_jh5cmr_m
    call Struct_ary_dimen2hid9q_jh5cmr_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridexs_a185b1h590_m
    call Struc_ary_stridexs_a185b1h590_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerv_11umdpwlpil_m
    call Struct_ary_lowerv_11umdpwlpil_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppervp4cpkdrcjb6l_m
    call Struct_ary_uppervp4cpkdrcjb6l_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthz1o28qcdbvy8b_m
    call Struc_ary_lengthz1o28qcdbvy8b_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_StructMaxx5itfwzl0_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructMatrixView_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructMaxx5itfwzl0_p

  subroutine castbHYPRE_StructMavqcf4qwfvj_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructMatrixView_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructMavqcf4qwfvj_p

  subroutine castbHYPRE_StructMawim68x13xb_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructMatrixView_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructMawim68x13xb_p

  subroutine castbHYPRE_StructMaxxai4oztv6_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructMatrixView_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructMaxxai4oztv6_p

  subroutine castbHYPRE_StructMapey4oc_d7l_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructMatrixView_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructMapey4oc_d7l_p

  subroutine castbHYPRE_StructMaw4kwe5x2v5_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructMatrixView_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructMaw4kwe5x2v5_p

  subroutine castbHYPRE_StructMarmuu_yqm44_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructMatrixView_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructMarmuu_yqm44_p


end module bHYPRE_StructMatrixView_array
