...
module bHYPRE_StructStencil
  ...
  interface SetSize
    module procedure SetSize_s
  end interface
    private :: SetElement_1s, &
    SetElement_2s


  interface SetElement
    module procedure SetElement_1s, &
    SetElement_2s
  end interface
    private :: newLocal_s, &
    newRemote_s
  ...
  interface bHYPRE_StructStencil__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(ndim, size, retval, exception)
    implicit none
    !  in int ndim
    integer (kind=sidl_int) , intent(in) :: ndim
    !  in int size
    integer (kind=sidl_int) , intent(in) :: size
    !  out bHYPRE.StructStencil retval
    type(bHYPRE_StructStencil_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructStencil_Create_m
    call bHYPRE_StructStencil_Create_m(ndim, size, retval, exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    implicit none
    !  in bHYPRE.StructStencil self
    type(bHYPRE_StructStencil_t) , intent(in) :: self
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructStencil_Destroy_m
    call bHYPRE_StructStencil_Destroy_m(self, exception)
  ...
  recursive subroutine SetDimension_s(self, dim, retval, exception)
    ...
    external bHYPRE_StructStencil_SetDimension_m
    call bHYPRE_StructStencil_SetDimension_m(self, dim, retval, exception)

  end subroutine SetDimension_s


  recursive subroutine SetSize_s(self, size, retval, exception)
    implicit none
    !  in bHYPRE.StructStencil self
    type(bHYPRE_StructStencil_t) , intent(in) :: self
    !  in int size
    ...
    external bHYPRE_StructStencil_SetSize_m
    call bHYPRE_StructStencil_SetSize_m(self, size, retval, exception)

  end subroutine SetSize_s


  recursive subroutine SetElement_1s(self, index, offset, retval, exception)
    implicit none
    !  in bHYPRE.StructStencil self
    type(bHYPRE_StructStencil_t) , intent(in) :: self
    !  in int index
    integer (kind=sidl_int) , intent(in) :: index
    !  in array<int,column-major> offset
    type(sidl_int_1d) , intent(in) :: offset
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructStencil_SetElement_a
    call bHYPRE_StructStencil_SetElement_a(self, index, offset, retval,        &
      exception)

  end subroutine SetElement_1s

  recursive subroutine SetElement_2s(self, index, offset, retval, exception)
    implicit none
    !  in bHYPRE.StructStencil self
    type(bHYPRE_StructStencil_t) , intent(in) :: self
    !  in int index
    ...
    integer (kind=sidl_int) , intent(in), dimension(:) :: offset
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception
    ...
    external bHYPRE_StructStencil_SetElement_m
    dim = size(offset, 1)
    call bHYPRE_StructStencil_SetElement_m(self, index, offset, dim, retval,   &
      exception)

  end subroutine SetElement_2s
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_StructStencil_newLocal_m
    call bHYPRE_StructStencil_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(bHYPRE_StructStencil_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructStencil_newRemote_m
    call bHYPRE_StructStencil_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_StructStencil_rConnect_m
    call bHYPRE_StructStencil_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_StructStencil_addRef_m
    call bHYPRE_StructStencil_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_StructStencil_deleteRef_m
    call bHYPRE_StructStencil_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_StructStencil_isSame_m
    call bHYPRE_StructStencil_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_StructStencil_isType_m
    call bHYPRE_StructStencil_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_StructStencil_getClassInfo_m
    call bHYPRE_StructStencil_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.StructStencil
  ! to sidl.BaseClass.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_StructStencil_t), intent(in) :: oldType
  ...
  ! to bHYPRE.StructStencil.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseClass_t), intent(in) :: oldType
    type(bHYPRE_StructStencil_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_StructStencil__cast_m

    call bHYPRE_StructStencil__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_StructStencil__exec_m
    call bHYPRE_StructStencil__exec_m(self, methodName, inArgs, outArgs,       &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_StructStencil__getURL_m
    call bHYPRE_StructStencil__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_StructStencil__isRemote_m
    call bHYPRE_StructStencil__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_StructStencil__isLocal_m
    call bHYPRE_StructStencil__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_StructStencil__set_hooks_m
    call bHYPRE_StructStencil__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_StructStencil__set_hooks_static_m
    call bHYPRE_StructStencil__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_StructStencil_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_StructStencil_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_StructStencil

module bHYPRE_StructStencil_array
  use sidl
  use bHYPRE_StructStencil_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_StructStvbg74jpab2_p, &
    castbHYPRE_StructStf_6tqc1kpk_p, &
    castbHYPRE_StructSt6kucidx_kj_p, &
    castbHYPRE_StructStspi2ia8309_p, &
    castbHYPRE_StructStecccfpf2c1_p, &
    castbHYPRE_StructStjw6oi_tcra_p, &
    castbHYPRE_StructSthgp07usgc6_p
interface cast
  module procedure &
    castbHYPRE_StructStvbg74jpab2_p, &
    castbHYPRE_StructStf_6tqc1kpk_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_1d), intent(out) :: array
    external St_ary_createCold6pzeiiv685wz_m
    call St_ary_createCold6pzeiiv685wz_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_StructStencil_1d), intent(out) :: array
    external St_ary_createRowjitfo667k5oli_m
    call St_ary_createRowjitfo667k5oli_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_StructStencil_1d), intent(out) :: array
    external Str_ary_create1djh1v6ft6w1pgy_m
    call Str_ary_create1djh1v6ft6w1pgy_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_StructStencil_1d), intent(in) :: src
    type(bHYPRE_StructStencil_1d), intent(in) :: dest
    external StructS_ary_copyhyqymz7gl5jt1_m
    call StructS_ary_copyhyqymz7gl5jt1_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_StructStencil_1d), intent(in)  :: src
    type(bHYPRE_StructStencil_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurecuvzfdl3rx70u_m
    call Struc_ary_ensurecuvzfdl3rx70u_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Struct_ary_slicewh18td25375v1_m
    call Struct_ary_slicewh18td25375v1_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructStencil_t), intent(out) :: value
    external StructSt_ary_get1d1thjklgrj1e_m
    call StructSt_ary_get1d1thjklgrj1e_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructStencil_t), intent(in) :: value
    external StructSt_ary_setkxdy9gaxy0j5g_m
    call StructSt_ary_setkxdy9gaxy0j5g_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_StructStencil_t), intent(out) :: value
    external StructS_ary_get19jmkk1i454oie_m
    call StructS_ary_get19jmkk1i454oie_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_StructStencil_t), intent(in) :: value
    external StructS_ary_set1vbi_bvrb8l_l__m
    call StructS_ary_set1vbi_bvrb8l_l__m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_StructStencil_1d), intent(in) :: src
    type(bHYPRE_StructStencil_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopy34_s_d957x93l_m
    dim = 1
    call St_ary_smartCopy34_s_d957x93l_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    external ary_isColumnOrder0y0yzlhpoj4u_m
    call ary_isColumnOrder0y0yzlhpoj4u_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    external S_ary_isRowOrdert_tz7jfepxz79_m
    call S_ary_isRowOrdert_tz7jfepxz79_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    external Struct_ary_dimennxer8uknz_n4l_m
    call Struct_ary_dimennxer8uknz_n4l_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride4u2m2pdwe47yg_m
    call Struc_ary_stride4u2m2pdwe47yg_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower36s50bps0ozm5_m
    call Struct_ary_lower36s50bps0ozm5_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upper6t209qdgc4aug_m
    call Struct_ary_upper6t209qdgc4aug_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthycilrrgk0zq88_m
    call Struc_ary_lengthycilrrgk0zq88_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    external Struc_ary_addRefcdkicz7vgs0m__m
    call Struc_ary_addRefcdkicz7vgs0m__m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_StructStencil_1d), intent(in)  :: array
    external St_ary_deleteRefmld2m5hc3019t_m
    call St_ary_deleteRefmld2m5hc3019t_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_2d), intent(out) :: array
    external St_ary_createCold6pzeiiv685wz_m
    call St_ary_createCold6pzeiiv685wz_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_2d), intent(out) :: array
    external St_ary_createRowjitfo667k5oli_m
    call St_ary_createRowjitfo667k5oli_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructStencil_2d), intent(out) :: array
    external ary_create2dCol0uydmvmi89jzm7_m
    call ary_create2dCol0uydmvmi89jzm7_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructStencil_2d), intent(out) :: array
    external ary_create2dRowmtwbxzr08lysp__m
    call ary_create2dRowmtwbxzr08lysp__m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_StructStencil_2d), intent(in) :: src
    type(bHYPRE_StructStencil_2d), intent(in) :: dest
    external StructS_ary_copyhyqymz7gl5jt1_m
    call StructS_ary_copyhyqymz7gl5jt1_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_StructStencil_2d), intent(in)  :: src
    type(bHYPRE_StructStencil_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurecuvzfdl3rx70u_m
    call Struc_ary_ensurecuvzfdl3rx70u_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicewh18td25375v1_m
    call Struct_ary_slicewh18td25375v1_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_StructStencil_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_StructStencil_t), intent(out) :: value
    external StructS_ary_get21m_wln4r_6yxj_m
    call StructS_ary_get21m_wln4r_6yxj_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_StructStencil_t), intent(in) :: value
    external StructS_ary_set22whjludonoyoq_m
    call StructS_ary_set22whjludonoyoq_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_StructStencil_2d), intent(in) :: src
    type(bHYPRE_StructStencil_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopy34_s_d957x93l_m
    dim = 2
    call St_ary_smartCopy34_s_d957x93l_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_StructStencil_2d), intent(in)  :: array
    external ary_isColumnOrder0y0yzlhpoj4u_m
    call ary_isColumnOrder0y0yzlhpoj4u_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_StructStencil_2d), intent(in)  :: array
    external S_ary_isRowOrdert_tz7jfepxz79_m
    call S_ary_isRowOrdert_tz7jfepxz79_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_StructStencil_2d), intent(in)  :: array
    external Struct_ary_dimennxer8uknz_n4l_m
    call Struct_ary_dimennxer8uknz_n4l_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride4u2m2pdwe47yg_m
    call Struc_ary_stride4u2m2pdwe47yg_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower36s50bps0ozm5_m
    call Struct_ary_lower36s50bps0ozm5_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upper6t209qdgc4aug_m
    call Struct_ary_upper6t209qdgc4aug_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthycilrrgk0zq88_m
    call Struc_ary_lengthycilrrgk0zq88_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_3d), intent(out) :: array
    external St_ary_createCold6pzeiiv685wz_m
    call St_ary_createCold6pzeiiv685wz_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_3d), intent(out) :: array
    external St_ary_createRowjitfo667k5oli_m
    call St_ary_createRowjitfo667k5oli_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_StructStencil_3d), intent(in) :: src
    type(bHYPRE_StructStencil_3d), intent(in) :: dest
    external StructS_ary_copyhyqymz7gl5jt1_m
    call StructS_ary_copyhyqymz7gl5jt1_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_StructStencil_3d), intent(in)  :: src
    type(bHYPRE_StructStencil_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurecuvzfdl3rx70u_m
    call Struc_ary_ensurecuvzfdl3rx70u_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicewh18td25375v1_m
    call Struct_ary_slicewh18td25375v1_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_StructStencil_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_StructStencil_t), intent(out) :: value
    external StructS_ary_get3s_d9vrb79p2ut_m
    call StructS_ary_get3s_d9vrb79p2ut_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_StructStencil_t), intent(in) :: value
    external StructS_ary_set3p95vhgj16h3di_m
    call StructS_ary_set3p95vhgj16h3di_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_StructStencil_3d), intent(in) :: src
    type(bHYPRE_StructStencil_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopy34_s_d957x93l_m
    dim = 3
    call St_ary_smartCopy34_s_d957x93l_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_StructStencil_3d), intent(in)  :: array
    external ary_isColumnOrder0y0yzlhpoj4u_m
    call ary_isColumnOrder0y0yzlhpoj4u_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_StructStencil_3d), intent(in)  :: array
    external S_ary_isRowOrdert_tz7jfepxz79_m
    call S_ary_isRowOrdert_tz7jfepxz79_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_StructStencil_3d), intent(in)  :: array
    external Struct_ary_dimennxer8uknz_n4l_m
    call Struct_ary_dimennxer8uknz_n4l_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride4u2m2pdwe47yg_m
    call Struc_ary_stride4u2m2pdwe47yg_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower36s50bps0ozm5_m
    call Struct_ary_lower36s50bps0ozm5_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upper6t209qdgc4aug_m
    call Struct_ary_upper6t209qdgc4aug_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthycilrrgk0zq88_m
    call Struc_ary_lengthycilrrgk0zq88_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_4d), intent(out) :: array
    external St_ary_createCold6pzeiiv685wz_m
    call St_ary_createCold6pzeiiv685wz_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_4d), intent(out) :: array
    external St_ary_createRowjitfo667k5oli_m
    call St_ary_createRowjitfo667k5oli_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_StructStencil_4d), intent(in) :: src
    type(bHYPRE_StructStencil_4d), intent(in) :: dest
    external StructS_ary_copyhyqymz7gl5jt1_m
    call StructS_ary_copyhyqymz7gl5jt1_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_StructStencil_4d), intent(in)  :: src
    type(bHYPRE_StructStencil_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurecuvzfdl3rx70u_m
    call Struc_ary_ensurecuvzfdl3rx70u_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicewh18td25375v1_m
    call Struct_ary_slicewh18td25375v1_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_StructStencil_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_StructStencil_t), intent(out) :: value
    external StructS_ary_get4sxsjzp1ok9u70_m
    call StructS_ary_get4sxsjzp1ok9u70_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_StructStencil_t), intent(in) :: value
    external StructS_ary_set4j81myd62iui5z_m
    call StructS_ary_set4j81myd62iui5z_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_StructStencil_4d), intent(in) :: src
    type(bHYPRE_StructStencil_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopy34_s_d957x93l_m
    dim = 4
    call St_ary_smartCopy34_s_d957x93l_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_StructStencil_4d), intent(in)  :: array
    external ary_isColumnOrder0y0yzlhpoj4u_m
    call ary_isColumnOrder0y0yzlhpoj4u_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_StructStencil_4d), intent(in)  :: array
    external S_ary_isRowOrdert_tz7jfepxz79_m
    call S_ary_isRowOrdert_tz7jfepxz79_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_StructStencil_4d), intent(in)  :: array
    external Struct_ary_dimennxer8uknz_n4l_m
    call Struct_ary_dimennxer8uknz_n4l_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride4u2m2pdwe47yg_m
    call Struc_ary_stride4u2m2pdwe47yg_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower36s50bps0ozm5_m
    call Struct_ary_lower36s50bps0ozm5_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upper6t209qdgc4aug_m
    call Struct_ary_upper6t209qdgc4aug_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthycilrrgk0zq88_m
    call Struc_ary_lengthycilrrgk0zq88_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_5d), intent(out) :: array
    external St_ary_createCold6pzeiiv685wz_m
    call St_ary_createCold6pzeiiv685wz_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_5d), intent(out) :: array
    external St_ary_createRowjitfo667k5oli_m
    call St_ary_createRowjitfo667k5oli_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_StructStencil_5d), intent(in) :: src
    type(bHYPRE_StructStencil_5d), intent(in) :: dest
    external StructS_ary_copyhyqymz7gl5jt1_m
    call StructS_ary_copyhyqymz7gl5jt1_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_StructStencil_5d), intent(in)  :: src
    type(bHYPRE_StructStencil_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurecuvzfdl3rx70u_m
    call Struc_ary_ensurecuvzfdl3rx70u_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicewh18td25375v1_m
    call Struct_ary_slicewh18td25375v1_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_StructStencil_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_StructStencil_t), intent(out) :: value
    external StructS_ary_get5jjec5wkg_3_0z_m
    call StructS_ary_get5jjec5wkg_3_0z_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_StructStencil_t), intent(in) :: value
    external StructS_ary_set5st0nxvbyw0zzc_m
    call StructS_ary_set5st0nxvbyw0zzc_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_StructStencil_5d), intent(in) :: src
    type(bHYPRE_StructStencil_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopy34_s_d957x93l_m
    dim = 5
    call St_ary_smartCopy34_s_d957x93l_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_StructStencil_5d), intent(in)  :: array
    external ary_isColumnOrder0y0yzlhpoj4u_m
    call ary_isColumnOrder0y0yzlhpoj4u_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_StructStencil_5d), intent(in)  :: array
    external S_ary_isRowOrdert_tz7jfepxz79_m
    call S_ary_isRowOrdert_tz7jfepxz79_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_StructStencil_5d), intent(in)  :: array
    external Struct_ary_dimennxer8uknz_n4l_m
    call Struct_ary_dimennxer8uknz_n4l_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride4u2m2pdwe47yg_m
    call Struc_ary_stride4u2m2pdwe47yg_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower36s50bps0ozm5_m
    call Struct_ary_lower36s50bps0ozm5_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upper6t209qdgc4aug_m
    call Struct_ary_upper6t209qdgc4aug_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthycilrrgk0zq88_m
    call Struc_ary_lengthycilrrgk0zq88_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_6d), intent(out) :: array
    external St_ary_createCold6pzeiiv685wz_m
    call St_ary_createCold6pzeiiv685wz_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_6d), intent(out) :: array
    external St_ary_createRowjitfo667k5oli_m
    call St_ary_createRowjitfo667k5oli_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_StructStencil_6d), intent(in) :: src
    type(bHYPRE_StructStencil_6d), intent(in) :: dest
    external StructS_ary_copyhyqymz7gl5jt1_m
    call StructS_ary_copyhyqymz7gl5jt1_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_StructStencil_6d), intent(in)  :: src
    type(bHYPRE_StructStencil_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurecuvzfdl3rx70u_m
    call Struc_ary_ensurecuvzfdl3rx70u_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicewh18td25375v1_m
    call Struct_ary_slicewh18td25375v1_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_StructStencil_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_StructStencil_t), intent(out) :: value
    external StructS_ary_get62jx822louz2dn_m
    call StructS_ary_get62jx822louz2dn_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_StructStencil_t), intent(in) :: value
    external StructS_ary_set6retf7koh2w8np_m
    call StructS_ary_set6retf7koh2w8np_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_StructStencil_6d), intent(in) :: src
    type(bHYPRE_StructStencil_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopy34_s_d957x93l_m
    dim = 6
    call St_ary_smartCopy34_s_d957x93l_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_StructStencil_6d), intent(in)  :: array
    external ary_isColumnOrder0y0yzlhpoj4u_m
    call ary_isColumnOrder0y0yzlhpoj4u_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_StructStencil_6d), intent(in)  :: array
    external S_ary_isRowOrdert_tz7jfepxz79_m
    call S_ary_isRowOrdert_tz7jfepxz79_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_StructStencil_6d), intent(in)  :: array
    external Struct_ary_dimennxer8uknz_n4l_m
    call Struct_ary_dimennxer8uknz_n4l_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride4u2m2pdwe47yg_m
    call Struc_ary_stride4u2m2pdwe47yg_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower36s50bps0ozm5_m
    call Struct_ary_lower36s50bps0ozm5_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upper6t209qdgc4aug_m
    call Struct_ary_upper6t209qdgc4aug_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthycilrrgk0zq88_m
    call Struc_ary_lengthycilrrgk0zq88_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_7d), intent(out) :: array
    external St_ary_createCold6pzeiiv685wz_m
    call St_ary_createCold6pzeiiv685wz_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_StructStencil_7d), intent(out) :: array
    external St_ary_createRowjitfo667k5oli_m
    call St_ary_createRowjitfo667k5oli_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_StructStencil_7d), intent(in) :: src
    type(bHYPRE_StructStencil_7d), intent(in) :: dest
    external StructS_ary_copyhyqymz7gl5jt1_m
    call StructS_ary_copyhyqymz7gl5jt1_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_StructStencil_7d), intent(in)  :: src
    type(bHYPRE_StructStencil_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurecuvzfdl3rx70u_m
    call Struc_ary_ensurecuvzfdl3rx70u_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicewh18td25375v1_m
    call Struct_ary_slicewh18td25375v1_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_StructStencil_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_StructStencil_t), intent(out) :: value
    external StructS_ary_get7n7m5r43av2fxp_m
    call StructS_ary_get7n7m5r43av2fxp_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_StructStencil_t), intent(in) :: value
    external StructS_ary_set7aki_ngvu8fo0k_m
    call StructS_ary_set7aki_ngvu8fo0k_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_StructStencil_7d), intent(in) :: src
    type(bHYPRE_StructStencil_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopy34_s_d957x93l_m
    dim = 7
    call St_ary_smartCopy34_s_d957x93l_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_StructStencil_7d), intent(in)  :: array
    external ary_isColumnOrder0y0yzlhpoj4u_m
    call ary_isColumnOrder0y0yzlhpoj4u_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_StructStencil_7d), intent(in)  :: array
    external S_ary_isRowOrdert_tz7jfepxz79_m
    call S_ary_isRowOrdert_tz7jfepxz79_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_StructStencil_7d), intent(in)  :: array
    external Struct_ary_dimennxer8uknz_n4l_m
    call Struct_ary_dimennxer8uknz_n4l_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride4u2m2pdwe47yg_m
    call Struc_ary_stride4u2m2pdwe47yg_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower36s50bps0ozm5_m
    call Struct_ary_lower36s50bps0ozm5_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upper6t209qdgc4aug_m
    call Struct_ary_upper6t209qdgc4aug_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthycilrrgk0zq88_m
    call Struc_ary_lengthycilrrgk0zq88_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_StructStvbg74jpab2_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructStencil_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructStvbg74jpab2_p

  subroutine castbHYPRE_StructStf_6tqc1kpk_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructStencil_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructStf_6tqc1kpk_p

  subroutine castbHYPRE_StructSt6kucidx_kj_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructStencil_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructSt6kucidx_kj_p

  subroutine castbHYPRE_StructStspi2ia8309_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructStencil_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructStspi2ia8309_p

  subroutine castbHYPRE_StructStecccfpf2c1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructStencil_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructStecccfpf2c1_p

  subroutine castbHYPRE_StructStjw6oi_tcra_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructStencil_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructStjw6oi_tcra_p

  subroutine castbHYPRE_StructSthgp07usgc6_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructStencil_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructSthgp07usgc6_p


end module bHYPRE_StructStencil_array
