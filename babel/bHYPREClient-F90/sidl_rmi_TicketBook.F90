! 
! File:          sidl_rmi_TicketBook.F90
! Symbol:        sidl.rmi.TicketBook-v0.9.15
! Symbol Type:   interface
! Babel Version: 1.0.0
! Release:       $Name$
! Revision:      @(#) $Id$
! Description:   Client-side module for sidl.rmi.TicketBook
! 
...
module sidl_rmi_TicketBook
  ...
  interface cast
    ...
    private :: insertWithID_s


  interface insertWithID
    module procedure insertWithID_s
  end interface
    private :: insert_s


  interface insert
    module procedure insert_s
  end interface
    private :: removeReady_s


  interface removeReady
    module procedure removeReady_s
  end interface
    private :: isEmpty_s


  interface isEmpty
    module procedure isEmpty_s
  end interface
  private :: rConnect_s
  interface rConnect
...
contains
  ...
  recursive subroutine insertWithID_s(self, t, id, exception)
    implicit none
    !  in sidl.rmi.TicketBook self
    type(sidl_rmi_TicketBook_t) , intent(in) :: self
    !  in sidl.rmi.Ticket t
    type(sidl_rmi_Ticket_t) , intent(in) :: t
    !  in int id
    integer (kind=sidl_int) , intent(in) :: id
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_TicketBook_insertWithID_m
    call sidl_rmi_TicketBook_insertWithID_m(self, t, id, exception)

  end subroutine insertWithID_s


  recursive subroutine insert_s(self, t, retval, exception)
    implicit none
    !  in sidl.rmi.TicketBook self
    type(sidl_rmi_TicketBook_t) , intent(in) :: self
    !  in sidl.rmi.Ticket t
    ...
    external sidl_rmi_TicketBook_insert_m
    call sidl_rmi_TicketBook_insert_m(self, t, retval, exception)

  end subroutine insert_s


  recursive subroutine removeReady_s(self, t, retval, exception)
    implicit none
    !  in sidl.rmi.TicketBook self
    type(sidl_rmi_TicketBook_t) , intent(in) :: self
    !  out sidl.rmi.Ticket t
    type(sidl_rmi_Ticket_t) , intent(out) :: t
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_TicketBook_removeReady_m
    call sidl_rmi_TicketBook_removeReady_m(self, t, retval, exception)

  end subroutine removeReady_s


  recursive subroutine isEmpty_s(self, retval, exception)
    implicit none
    !  in sidl.rmi.TicketBook self
    type(sidl_rmi_TicketBook_t) , intent(in) :: self
    !  out bool retval
    ...
    external sidl_rmi_TicketBook_isEmpty_m
    call sidl_rmi_TicketBook_isEmpty_m(self, retval, exception)

  end subroutine isEmpty_s


  recursive subroutine rConnect_s(self, url, exception)
    implicit none
    !  out sidl.rmi.TicketBook self
    type(sidl_rmi_TicketBook_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_TicketBook_rConnect_m
    call sidl_rmi_TicketBook_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external sidl_rmi_TicketBook_addRef_m
    call sidl_rmi_TicketBook_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_rmi_TicketBook_deleteRef_m
    call sidl_rmi_TicketBook_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_rmi_TicketBook_isSame_m
    call sidl_rmi_TicketBook_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_rmi_TicketBook_isType_m
    call sidl_rmi_TicketBook_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_rmi_TicketBook_getClassInfo_m
    call sidl_rmi_TicketBook_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine block_s(self, exception)
    ...
    external sidl_rmi_TicketBook_block_m
    call sidl_rmi_TicketBook_block_m(self, exception)
  ...
  recursive subroutine test_s(self, retval, exception)
    ...
    external sidl_rmi_TicketBook_test_m
    call sidl_rmi_TicketBook_test_m(self, retval, exception)
  ...
  recursive subroutine createEmptyTicketBook_s(self, retval, exception)
    ...
    external sidl_rmi_TicketBook_createEmptyTicketBook_m
    call sidl_rmi_TicketBook_createEmptyTicketBook_m(self, retval, exception)
  ...
  recursive subroutine getResponse_s(self, retval, exception)
    ...
    external sidl_rmi_TicketBook_getResponse_m
    call sidl_rmi_TicketBook_getResponse_m(self, retval, exception)

  end subroutine getResponse_s

  ! 
  ! Static function to cast from sidl.rmi.TicketBook
  ! to sidl.BaseInterface.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(sidl_rmi_TicketBook_t), intent(in) :: oldType
  ...
  ! to sidl.rmi.TicketBook.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseInterface_t), intent(in) :: oldType
    type(sidl_rmi_TicketBook_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_TicketBook__cast_m

    call sidl_rmi_TicketBook__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_rmi_TicketBook__exec_m
    call sidl_rmi_TicketBook__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_rmi_TicketBook__getURL_m
    call sidl_rmi_TicketBook__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_rmi_TicketBook__isRemote_m
    call sidl_rmi_TicketBook__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_rmi_TicketBook__isLocal_m
    call sidl_rmi_TicketBook__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_rmi_TicketBook__set_hooks_m
    call sidl_rmi_TicketBook__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(sidl_rmi_TicketBook_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_rmi_TicketBook_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_rmi_TicketBook

module sidl_rmi_TicketBook_array
  use sidl
  use sidl_rmi_TicketBook_type
  use sidl_array_type
  ...
  private :: &
    castsidl_rmi_Tickett5r3kr3s___p, &
    castsidl_rmi_Ticketo7c3ai3cbu_p, &
    castsidl_rmi_Ticketbt4el4ee4m_p, &
    castsidl_rmi_Ticket4mwuvbgdrj_p, &
    castsidl_rmi_Ticket_q6ozmwja8_p, &
    castsidl_rmi_Tickety7evsx4xtn_p, &
    castsidl_rmi_Ticketkoc21nygup_p
interface cast
  module procedure &
    castsidl_rmi_Tickett5r3kr3s___p, &
    castsidl_rmi_Ticketo7c3ai3cbu_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_1d), intent(out) :: array
    external Ti_ary_createCold8m2dltwccuqt_m
    call Ti_ary_createCold8m2dltwccuqt_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_rmi_TicketBook_1d), intent(out) :: array
    external Ti_ary_createRowiyf5ba37pjnt1_m
    call Ti_ary_createRowiyf5ba37pjnt1_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_rmi_TicketBook_1d), intent(out) :: array
    external Tic_ary_create1dhjzyp5hm15ox7_m
    call Tic_ary_create1dhjzyp5hm15ox7_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_rmi_TicketBook_1d), intent(in) :: src
    type(sidl_rmi_TicketBook_1d), intent(in) :: dest
    external TicketB_ary_copy2_yh4b42p5jhq_m
    call TicketB_ary_copy2_yh4b42p5jhq_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: src
    type(sidl_rmi_TicketBook_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Ticke_ary_ensurescy53oqzmphzw_m
    call Ticke_ary_ensurescy53oqzmphzw_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Ticket_ary_slicex4i588pe_9ija_m
    call Ticket_ary_slicex4i588pe_9ija_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_TicketBook_t), intent(out) :: value
    external TicketBo_ary_getaf3c3rcpn2lcx_m
    call TicketBo_ary_getaf3c3rcpn2lcx_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_TicketBook_t), intent(in) :: value
    external TicketBo_ary_setg07n2jvl90qa3_m
    call TicketBo_ary_setg07n2jvl90qa3_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_rmi_TicketBook_t), intent(out) :: value
    external TicketB_ary_get1byd963a_gmd2__m
    call TicketB_ary_get1byd963a_gmd2__m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_rmi_TicketBook_t), intent(in) :: value
    external TicketB_ary_set10nxs7x54zw_jp_m
    call TicketB_ary_set10nxs7x54zw_jp_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_rmi_TicketBook_1d), intent(in) :: src
    type(sidl_rmi_TicketBook_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ti_ary_smartCopy_nmm4kv89qo9m_m
    dim = 1
    call Ti_ary_smartCopy_nmm4kv89qo9m_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    external ary_isColumnOrdernqd6qhovtvck_m
    call ary_isColumnOrdernqd6qhovtvck_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    external T_ary_isRowOrdery6j_r4gwuwn6v_m
    call T_ary_isRowOrdery6j_r4gwuwn6v_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    external Ticket_ary_dimenpozv1ojq_9y_1_m
    call Ticket_ary_dimenpozv1ojq_9y_1_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_stride9nuczrp_dj1lt_m
    call Ticke_ary_stride9nuczrp_dj1lt_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_lower2j8cfqo65isv1_m
    call Ticket_ary_lower2j8cfqo65isv1_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_upperpffu_hc8vy00f_m
    call Ticket_ary_upperpffu_hc8vy00f_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_length9kdwji4t9y2mc_m
    call Ticke_ary_length9kdwji4t9y2mc_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    external Ticke_ary_addRef8uddu2jfa24cb_m
    call Ticke_ary_addRef8uddu2jfa24cb_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_rmi_TicketBook_1d), intent(in)  :: array
    external Ti_ary_deleteRefz0j4_3jlug_a8_m
    call Ti_ary_deleteRefz0j4_3jlug_a8_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_2d), intent(out) :: array
    external Ti_ary_createCold8m2dltwccuqt_m
    call Ti_ary_createCold8m2dltwccuqt_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_2d), intent(out) :: array
    external Ti_ary_createRowiyf5ba37pjnt1_m
    call Ti_ary_createRowiyf5ba37pjnt1_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_TicketBook_2d), intent(out) :: array
    external ary_create2dColx15m3m68pnydnw_m
    call ary_create2dColx15m3m68pnydnw_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_TicketBook_2d), intent(out) :: array
    external ary_create2dRow_1ykh4ku18grpl_m
    call ary_create2dRow_1ykh4ku18grpl_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_rmi_TicketBook_2d), intent(in) :: src
    type(sidl_rmi_TicketBook_2d), intent(in) :: dest
    external TicketB_ary_copy2_yh4b42p5jhq_m
    call TicketB_ary_copy2_yh4b42p5jhq_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_rmi_TicketBook_2d), intent(in)  :: src
    type(sidl_rmi_TicketBook_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Ticke_ary_ensurescy53oqzmphzw_m
    call Ticke_ary_ensurescy53oqzmphzw_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Ticket_ary_slicex4i588pe_9ija_m
    call Ticket_ary_slicex4i588pe_9ija_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_rmi_TicketBook_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_rmi_TicketBook_t), intent(out) :: value
    external TicketB_ary_get280p4rbjeg_mt7_m
    call TicketB_ary_get280p4rbjeg_mt7_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_rmi_TicketBook_t), intent(in) :: value
    external TicketB_ary_set2_2q_tr4g8rh8k_m
    call TicketB_ary_set2_2q_tr4g8rh8k_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_rmi_TicketBook_2d), intent(in) :: src
    type(sidl_rmi_TicketBook_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ti_ary_smartCopy_nmm4kv89qo9m_m
    dim = 2
    call Ti_ary_smartCopy_nmm4kv89qo9m_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_rmi_TicketBook_2d), intent(in)  :: array
    external ary_isColumnOrdernqd6qhovtvck_m
    call ary_isColumnOrdernqd6qhovtvck_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_rmi_TicketBook_2d), intent(in)  :: array
    external T_ary_isRowOrdery6j_r4gwuwn6v_m
    call T_ary_isRowOrdery6j_r4gwuwn6v_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_rmi_TicketBook_2d), intent(in)  :: array
    external Ticket_ary_dimenpozv1ojq_9y_1_m
    call Ticket_ary_dimenpozv1ojq_9y_1_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_stride9nuczrp_dj1lt_m
    call Ticke_ary_stride9nuczrp_dj1lt_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_lower2j8cfqo65isv1_m
    call Ticket_ary_lower2j8cfqo65isv1_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_upperpffu_hc8vy00f_m
    call Ticket_ary_upperpffu_hc8vy00f_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_length9kdwji4t9y2mc_m
    call Ticke_ary_length9kdwji4t9y2mc_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_3d), intent(out) :: array
    external Ti_ary_createCold8m2dltwccuqt_m
    call Ti_ary_createCold8m2dltwccuqt_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_3d), intent(out) :: array
    external Ti_ary_createRowiyf5ba37pjnt1_m
    call Ti_ary_createRowiyf5ba37pjnt1_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_rmi_TicketBook_3d), intent(in) :: src
    type(sidl_rmi_TicketBook_3d), intent(in) :: dest
    external TicketB_ary_copy2_yh4b42p5jhq_m
    call TicketB_ary_copy2_yh4b42p5jhq_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_rmi_TicketBook_3d), intent(in)  :: src
    type(sidl_rmi_TicketBook_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Ticke_ary_ensurescy53oqzmphzw_m
    call Ticke_ary_ensurescy53oqzmphzw_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Ticket_ary_slicex4i588pe_9ija_m
    call Ticket_ary_slicex4i588pe_9ija_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_rmi_TicketBook_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_rmi_TicketBook_t), intent(out) :: value
    external TicketB_ary_get3jjshwajkv80rg_m
    call TicketB_ary_get3jjshwajkv80rg_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_rmi_TicketBook_t), intent(in) :: value
    external TicketB_ary_set3yjdaxj3kqz8df_m
    call TicketB_ary_set3yjdaxj3kqz8df_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_rmi_TicketBook_3d), intent(in) :: src
    type(sidl_rmi_TicketBook_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ti_ary_smartCopy_nmm4kv89qo9m_m
    dim = 3
    call Ti_ary_smartCopy_nmm4kv89qo9m_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_rmi_TicketBook_3d), intent(in)  :: array
    external ary_isColumnOrdernqd6qhovtvck_m
    call ary_isColumnOrdernqd6qhovtvck_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_rmi_TicketBook_3d), intent(in)  :: array
    external T_ary_isRowOrdery6j_r4gwuwn6v_m
    call T_ary_isRowOrdery6j_r4gwuwn6v_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_rmi_TicketBook_3d), intent(in)  :: array
    external Ticket_ary_dimenpozv1ojq_9y_1_m
    call Ticket_ary_dimenpozv1ojq_9y_1_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_stride9nuczrp_dj1lt_m
    call Ticke_ary_stride9nuczrp_dj1lt_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_lower2j8cfqo65isv1_m
    call Ticket_ary_lower2j8cfqo65isv1_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_upperpffu_hc8vy00f_m
    call Ticket_ary_upperpffu_hc8vy00f_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_length9kdwji4t9y2mc_m
    call Ticke_ary_length9kdwji4t9y2mc_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_4d), intent(out) :: array
    external Ti_ary_createCold8m2dltwccuqt_m
    call Ti_ary_createCold8m2dltwccuqt_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_4d), intent(out) :: array
    external Ti_ary_createRowiyf5ba37pjnt1_m
    call Ti_ary_createRowiyf5ba37pjnt1_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_rmi_TicketBook_4d), intent(in) :: src
    type(sidl_rmi_TicketBook_4d), intent(in) :: dest
    external TicketB_ary_copy2_yh4b42p5jhq_m
    call TicketB_ary_copy2_yh4b42p5jhq_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_rmi_TicketBook_4d), intent(in)  :: src
    type(sidl_rmi_TicketBook_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Ticke_ary_ensurescy53oqzmphzw_m
    call Ticke_ary_ensurescy53oqzmphzw_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Ticket_ary_slicex4i588pe_9ija_m
    call Ticket_ary_slicex4i588pe_9ija_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_rmi_TicketBook_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_rmi_TicketBook_t), intent(out) :: value
    external TicketB_ary_get4bokjnmdvbasae_m
    call TicketB_ary_get4bokjnmdvbasae_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_rmi_TicketBook_t), intent(in) :: value
    external TicketB_ary_set4kbgw2yuw2ylwz_m
    call TicketB_ary_set4kbgw2yuw2ylwz_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_rmi_TicketBook_4d), intent(in) :: src
    type(sidl_rmi_TicketBook_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ti_ary_smartCopy_nmm4kv89qo9m_m
    dim = 4
    call Ti_ary_smartCopy_nmm4kv89qo9m_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_rmi_TicketBook_4d), intent(in)  :: array
    external ary_isColumnOrdernqd6qhovtvck_m
    call ary_isColumnOrdernqd6qhovtvck_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_rmi_TicketBook_4d), intent(in)  :: array
    external T_ary_isRowOrdery6j_r4gwuwn6v_m
    call T_ary_isRowOrdery6j_r4gwuwn6v_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_rmi_TicketBook_4d), intent(in)  :: array
    external Ticket_ary_dimenpozv1ojq_9y_1_m
    call Ticket_ary_dimenpozv1ojq_9y_1_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_stride9nuczrp_dj1lt_m
    call Ticke_ary_stride9nuczrp_dj1lt_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_lower2j8cfqo65isv1_m
    call Ticket_ary_lower2j8cfqo65isv1_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_upperpffu_hc8vy00f_m
    call Ticket_ary_upperpffu_hc8vy00f_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_length9kdwji4t9y2mc_m
    call Ticke_ary_length9kdwji4t9y2mc_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_5d), intent(out) :: array
    external Ti_ary_createCold8m2dltwccuqt_m
    call Ti_ary_createCold8m2dltwccuqt_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_5d), intent(out) :: array
    external Ti_ary_createRowiyf5ba37pjnt1_m
    call Ti_ary_createRowiyf5ba37pjnt1_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_rmi_TicketBook_5d), intent(in) :: src
    type(sidl_rmi_TicketBook_5d), intent(in) :: dest
    external TicketB_ary_copy2_yh4b42p5jhq_m
    call TicketB_ary_copy2_yh4b42p5jhq_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_rmi_TicketBook_5d), intent(in)  :: src
    type(sidl_rmi_TicketBook_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Ticke_ary_ensurescy53oqzmphzw_m
    call Ticke_ary_ensurescy53oqzmphzw_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Ticket_ary_slicex4i588pe_9ija_m
    call Ticket_ary_slicex4i588pe_9ija_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_rmi_TicketBook_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_rmi_TicketBook_t), intent(out) :: value
    external TicketB_ary_get5s99yqc6yz07n1_m
    call TicketB_ary_get5s99yqc6yz07n1_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_rmi_TicketBook_t), intent(in) :: value
    external TicketB_ary_set5q0nw04ztll7vu_m
    call TicketB_ary_set5q0nw04ztll7vu_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_rmi_TicketBook_5d), intent(in) :: src
    type(sidl_rmi_TicketBook_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ti_ary_smartCopy_nmm4kv89qo9m_m
    dim = 5
    call Ti_ary_smartCopy_nmm4kv89qo9m_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_rmi_TicketBook_5d), intent(in)  :: array
    external ary_isColumnOrdernqd6qhovtvck_m
    call ary_isColumnOrdernqd6qhovtvck_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_rmi_TicketBook_5d), intent(in)  :: array
    external T_ary_isRowOrdery6j_r4gwuwn6v_m
    call T_ary_isRowOrdery6j_r4gwuwn6v_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_rmi_TicketBook_5d), intent(in)  :: array
    external Ticket_ary_dimenpozv1ojq_9y_1_m
    call Ticket_ary_dimenpozv1ojq_9y_1_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_stride9nuczrp_dj1lt_m
    call Ticke_ary_stride9nuczrp_dj1lt_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_lower2j8cfqo65isv1_m
    call Ticket_ary_lower2j8cfqo65isv1_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_upperpffu_hc8vy00f_m
    call Ticket_ary_upperpffu_hc8vy00f_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_length9kdwji4t9y2mc_m
    call Ticke_ary_length9kdwji4t9y2mc_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_6d), intent(out) :: array
    external Ti_ary_createCold8m2dltwccuqt_m
    call Ti_ary_createCold8m2dltwccuqt_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_6d), intent(out) :: array
    external Ti_ary_createRowiyf5ba37pjnt1_m
    call Ti_ary_createRowiyf5ba37pjnt1_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_rmi_TicketBook_6d), intent(in) :: src
    type(sidl_rmi_TicketBook_6d), intent(in) :: dest
    external TicketB_ary_copy2_yh4b42p5jhq_m
    call TicketB_ary_copy2_yh4b42p5jhq_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_rmi_TicketBook_6d), intent(in)  :: src
    type(sidl_rmi_TicketBook_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Ticke_ary_ensurescy53oqzmphzw_m
    call Ticke_ary_ensurescy53oqzmphzw_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Ticket_ary_slicex4i588pe_9ija_m
    call Ticket_ary_slicex4i588pe_9ija_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_rmi_TicketBook_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_rmi_TicketBook_t), intent(out) :: value
    external TicketB_ary_get66s026vq2_tf3e_m
    call TicketB_ary_get66s026vq2_tf3e_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_rmi_TicketBook_t), intent(in) :: value
    external TicketB_ary_set6lztcrbz1gd7dk_m
    call TicketB_ary_set6lztcrbz1gd7dk_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_rmi_TicketBook_6d), intent(in) :: src
    type(sidl_rmi_TicketBook_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ti_ary_smartCopy_nmm4kv89qo9m_m
    dim = 6
    call Ti_ary_smartCopy_nmm4kv89qo9m_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_rmi_TicketBook_6d), intent(in)  :: array
    external ary_isColumnOrdernqd6qhovtvck_m
    call ary_isColumnOrdernqd6qhovtvck_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_rmi_TicketBook_6d), intent(in)  :: array
    external T_ary_isRowOrdery6j_r4gwuwn6v_m
    call T_ary_isRowOrdery6j_r4gwuwn6v_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_rmi_TicketBook_6d), intent(in)  :: array
    external Ticket_ary_dimenpozv1ojq_9y_1_m
    call Ticket_ary_dimenpozv1ojq_9y_1_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_stride9nuczrp_dj1lt_m
    call Ticke_ary_stride9nuczrp_dj1lt_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_lower2j8cfqo65isv1_m
    call Ticket_ary_lower2j8cfqo65isv1_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_upperpffu_hc8vy00f_m
    call Ticket_ary_upperpffu_hc8vy00f_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_length9kdwji4t9y2mc_m
    call Ticke_ary_length9kdwji4t9y2mc_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_7d), intent(out) :: array
    external Ti_ary_createCold8m2dltwccuqt_m
    call Ti_ary_createCold8m2dltwccuqt_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_rmi_TicketBook_7d), intent(out) :: array
    external Ti_ary_createRowiyf5ba37pjnt1_m
    call Ti_ary_createRowiyf5ba37pjnt1_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_rmi_TicketBook_7d), intent(in) :: src
    type(sidl_rmi_TicketBook_7d), intent(in) :: dest
    external TicketB_ary_copy2_yh4b42p5jhq_m
    call TicketB_ary_copy2_yh4b42p5jhq_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_rmi_TicketBook_7d), intent(in)  :: src
    type(sidl_rmi_TicketBook_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Ticke_ary_ensurescy53oqzmphzw_m
    call Ticke_ary_ensurescy53oqzmphzw_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Ticket_ary_slicex4i588pe_9ija_m
    call Ticket_ary_slicex4i588pe_9ija_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_rmi_TicketBook_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_rmi_TicketBook_t), intent(out) :: value
    external TicketB_ary_get74tlx9b5p7cy0h_m
    call TicketB_ary_get74tlx9b5p7cy0h_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_rmi_TicketBook_t), intent(in) :: value
    external TicketB_ary_set74xdzlg66on41s_m
    call TicketB_ary_set74xdzlg66on41s_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_rmi_TicketBook_7d), intent(in) :: src
    type(sidl_rmi_TicketBook_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ti_ary_smartCopy_nmm4kv89qo9m_m
    dim = 7
    call Ti_ary_smartCopy_nmm4kv89qo9m_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_rmi_TicketBook_7d), intent(in)  :: array
    external ary_isColumnOrdernqd6qhovtvck_m
    call ary_isColumnOrdernqd6qhovtvck_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_rmi_TicketBook_7d), intent(in)  :: array
    external T_ary_isRowOrdery6j_r4gwuwn6v_m
    call T_ary_isRowOrdery6j_r4gwuwn6v_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_rmi_TicketBook_7d), intent(in)  :: array
    external Ticket_ary_dimenpozv1ojq_9y_1_m
    call Ticket_ary_dimenpozv1ojq_9y_1_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_stride9nuczrp_dj1lt_m
    call Ticke_ary_stride9nuczrp_dj1lt_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_lower2j8cfqo65isv1_m
    call Ticket_ary_lower2j8cfqo65isv1_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticket_ary_upperpffu_hc8vy00f_m
    call Ticket_ary_upperpffu_hc8vy00f_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Ticke_ary_length9kdwji4t9y2mc_m
    call Ticke_ary_length9kdwji4t9y2mc_m(array, index, length7_p)
  ...
  subroutine castsidl_rmi_Tickett5r3kr3s___p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_TicketBook_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Tickett5r3kr3s___p

  subroutine castsidl_rmi_Ticketo7c3ai3cbu_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_TicketBook_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Ticketo7c3ai3cbu_p

  subroutine castsidl_rmi_Ticketbt4el4ee4m_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_TicketBook_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Ticketbt4el4ee4m_p

  subroutine castsidl_rmi_Ticket4mwuvbgdrj_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_TicketBook_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Ticket4mwuvbgdrj_p

  subroutine castsidl_rmi_Ticket_q6ozmwja8_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_TicketBook_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Ticket_q6ozmwja8_p

  subroutine castsidl_rmi_Tickety7evsx4xtn_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_TicketBook_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Tickety7evsx4xtn_p

  subroutine castsidl_rmi_Ticketkoc21nygup_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_TicketBook_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Ticketkoc21nygup_p


end module sidl_rmi_TicketBook_array
