! 
! File:          sidl_ClassInfoI.F90
! Symbol:        sidl.ClassInfoI-v0.9.15
! Symbol Type:   class
! Babel Version: 1.0.0
! Release:       $Name$
! Revision:      @(#) $Id$
! Description:   Client-side module for sidl.ClassInfoI
! 
...
module sidl_ClassInfoI

  use sidl
  use sidl_ClassInfoI_type
  ...
  interface setName
    module procedure setName_s
  end interface
    private :: setIORVersion_s


  interface setIORVersion
    module procedure setIORVersion_s
  end interface
    private :: getName_s


  interface getName
    module procedure getName_s
  end interface
    private :: getIORVersion_s


  interface getIORVersion
    module procedure getIORVersion_s
  end interface
    private :: newLocal_s, &
    newRemote_s
...
contains
  ...
  recursive subroutine setName_s(self, name, exception)
    implicit none
    !  in sidl.ClassInfoI self
    type(sidl_ClassInfoI_t) , intent(in) :: self
    !  in string name
    character (len=*) , intent(in) :: name
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_ClassInfoI_setName_m
    call sidl_ClassInfoI_setName_m(self, name, exception)

  end subroutine setName_s


  recursive subroutine setIORVersion_s(self, major, minor, exception)
    implicit none
    !  in sidl.ClassInfoI self
    type(sidl_ClassInfoI_t) , intent(in) :: self
    !  in int major
    integer (kind=sidl_int) , intent(in) :: major
    !  in int minor
    integer (kind=sidl_int) , intent(in) :: minor
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_ClassInfoI_setIORVersion_m
    call sidl_ClassInfoI_setIORVersion_m(self, major, minor, exception)

  end subroutine setIORVersion_s


  recursive subroutine getName_s(self, retval, exception)
    implicit none
    !  in sidl.ClassInfoI self
    type(sidl_ClassInfoI_t) , intent(in) :: self
    !  out string retval
    ...
    external sidl_ClassInfoI_getName_m
    call sidl_ClassInfoI_getName_m(self, retval, exception)

  end subroutine getName_s


  recursive subroutine getIORVersion_s(self, retval, exception)
    implicit none
    !  in sidl.ClassInfoI self
    type(sidl_ClassInfoI_t) , intent(in) :: self
    !  out string retval
    ...
    external sidl_ClassInfoI_getIORVersion_m
    call sidl_ClassInfoI_getIORVersion_m(self, retval, exception)

  end subroutine getIORVersion_s


  recursive subroutine newLocal_s(retval, exception)
    implicit none
    !  out sidl.ClassInfoI retval
    type(sidl_ClassInfoI_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_ClassInfoI_newLocal_m
    call sidl_ClassInfoI_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    implicit none
    !  out sidl.ClassInfoI self
    type(sidl_ClassInfoI_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_ClassInfoI_newRemote_m
    call sidl_ClassInfoI_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external sidl_ClassInfoI_rConnect_m
    call sidl_ClassInfoI_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external sidl_ClassInfoI_addRef_m
    call sidl_ClassInfoI_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_ClassInfoI_deleteRef_m
    call sidl_ClassInfoI_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_ClassInfoI_isSame_m
    call sidl_ClassInfoI_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_ClassInfoI_isType_m
    call sidl_ClassInfoI_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_ClassInfoI_getClassInfo_m
    call sidl_ClassInfoI_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from sidl.ClassInfoI
  ! to sidl.BaseClass.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(sidl_ClassInfoI_t), intent(in) :: oldType
  ...
  subroutine cast_1(oldType, newType, exception)
    ...
    type(sidl_ClassInfoI_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_ClassInfoI__cast_m

    call sidl_ClassInfoI__cast_m(oldType, newType, exception)
  ...
  subroutine cast_4(oldType, newType, exception)
    implicit none
    type(sidl_ClassInfoI_t), intent(in) :: oldType
    type(sidl_ClassInfo_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_ClassInfo__cast_m

    call sidl_ClassInfo__cast_m(oldType, newType, exception)
  end subroutine cast_4

  ! 
  ! Static function to cast from sidl.ClassInfo
  ! to sidl.ClassInfoI.
  ! 

  subroutine cast_5(oldType, newType, exception)
    implicit none
    type(sidl_ClassInfo_t), intent(in) :: oldType
    type(sidl_ClassInfoI_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_ClassInfoI__cast_m
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_ClassInfoI__exec_m
    call sidl_ClassInfoI__exec_m(self, methodName, inArgs, outArgs, exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_ClassInfoI__getURL_m
    call sidl_ClassInfoI__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_ClassInfoI__isRemote_m
    call sidl_ClassInfoI__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_ClassInfoI__isLocal_m
    call sidl_ClassInfoI__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_ClassInfoI__set_hooks_m
    call sidl_ClassInfoI__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(sidl_ClassInfoI_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_ClassInfoI_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_ClassInfoI

module sidl_ClassInfoI_array
  use sidl
  use sidl_ClassInfoI_type
  use sidl_array_type
  ...
  private :: &
    castsidl_ClassInfoIksufh_cjqa_p, &
    castsidl_ClassInfoIbz6eky3mt1_p, &
    castsidl_ClassInfoIsy1p9e_9h3_p, &
    castsidl_ClassInfoI6_7z2cw5rb_p, &
    castsidl_ClassInfoInbzy8x7li9_p, &
    castsidl_ClassInfoI3j2ir46xx5_p, &
    castsidl_ClassInfoIga5t843pf4_p
interface cast
  module procedure &
    castsidl_ClassInfoIksufh_cjqa_p, &
    castsidl_ClassInfoIbz6eky3mt1_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_1d), intent(out) :: array
    external Cl_ary_createCol1s7g_01gjcwe8_m
    call Cl_ary_createCol1s7g_01gjcwe8_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_ClassInfoI_1d), intent(out) :: array
    external Cl_ary_createRownzj0vub147u9o_m
    call Cl_ary_createRownzj0vub147u9o_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_ClassInfoI_1d), intent(out) :: array
    external Cla_ary_create1dhk4grwo6dohbi_m
    call Cla_ary_create1dhk4grwo6dohbi_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_ClassInfoI_1d), intent(in) :: src
    type(sidl_ClassInfoI_1d), intent(in) :: dest
    external sidl_ClassInfoI__array_copy_m
    call sidl_ClassInfoI__array_copy_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_ClassInfoI_1d), intent(in)  :: src
    type(sidl_ClassInfoI_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_ClassInfoI__array_ensure_m
    call sidl_ClassInfoI__array_ensure_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external sidl_ClassInfoI__array_slice_m
    call sidl_ClassInfoI__array_slice_m(src, 1, numElem, srcStart, srcStride,  &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_ClassInfoI_t), intent(out) :: value
    external sidl_ClassInfoI__array_get_m
    call sidl_ClassInfoI__array_get_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_ClassInfoI_t), intent(in) :: value
    external sidl_ClassInfoI__array_set_m
    call sidl_ClassInfoI__array_set_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_ClassInfoI_t), intent(out) :: value
    external sidl_ClassInfoI__array_get1_m
    call sidl_ClassInfoI__array_get1_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_ClassInfoI_t), intent(in) :: value
    external sidl_ClassInfoI__array_set1_m
    call sidl_ClassInfoI__array_set1_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_ClassInfoI_1d), intent(in) :: src
    type(sidl_ClassInfoI_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Cl_ary_smartCopywlhxnbvduz24e_m
    dim = 1
    call Cl_ary_smartCopywlhxnbvduz24e_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    external ary_isColumnOrder2li32g67cz8h_m
    call ary_isColumnOrder2li32g67cz8h_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    external C_ary_isRowOrderqzofpd6_dsgdx_m
    call C_ary_isRowOrderqzofpd6_dsgdx_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    external sidl_ClassInfoI__array_dimen_m
    call sidl_ClassInfoI__array_dimen_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_stride_m
    call sidl_ClassInfoI__array_stride_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_lower_m
    call sidl_ClassInfoI__array_lower_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_upper_m
    call sidl_ClassInfoI__array_upper_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_length_m
    call sidl_ClassInfoI__array_length_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    external sidl_ClassInfoI__array_addRef_m
    call sidl_ClassInfoI__array_addRef_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_ClassInfoI_1d), intent(in)  :: array
    external Cl_ary_deleteRefl2s9a29mbz9hp_m
    call Cl_ary_deleteRefl2s9a29mbz9hp_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_2d), intent(out) :: array
    external Cl_ary_createCol1s7g_01gjcwe8_m
    call Cl_ary_createCol1s7g_01gjcwe8_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_2d), intent(out) :: array
    external Cl_ary_createRownzj0vub147u9o_m
    call Cl_ary_createRownzj0vub147u9o_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_ClassInfoI_2d), intent(out) :: array
    external ary_create2dColj9biorg5sp1re0_m
    call ary_create2dColj9biorg5sp1re0_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_ClassInfoI_2d), intent(out) :: array
    external ary_create2dRowio646tikktj8eu_m
    call ary_create2dRowio646tikktj8eu_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_ClassInfoI_2d), intent(in) :: src
    type(sidl_ClassInfoI_2d), intent(in) :: dest
    external sidl_ClassInfoI__array_copy_m
    call sidl_ClassInfoI__array_copy_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_ClassInfoI_2d), intent(in)  :: src
    type(sidl_ClassInfoI_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_ClassInfoI__array_ensure_m
    call sidl_ClassInfoI__array_ensure_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external sidl_ClassInfoI__array_slice_m
    call sidl_ClassInfoI__array_slice_m(src, 2, numElem, srcStart, srcStride,  &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_ClassInfoI_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_ClassInfoI_t), intent(out) :: value
    external sidl_ClassInfoI__array_get2_m
    call sidl_ClassInfoI__array_get2_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_ClassInfoI_t), intent(in) :: value
    external sidl_ClassInfoI__array_set2_m
    call sidl_ClassInfoI__array_set2_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_ClassInfoI_2d), intent(in) :: src
    type(sidl_ClassInfoI_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Cl_ary_smartCopywlhxnbvduz24e_m
    dim = 2
    call Cl_ary_smartCopywlhxnbvduz24e_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_ClassInfoI_2d), intent(in)  :: array
    external ary_isColumnOrder2li32g67cz8h_m
    call ary_isColumnOrder2li32g67cz8h_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_ClassInfoI_2d), intent(in)  :: array
    external C_ary_isRowOrderqzofpd6_dsgdx_m
    call C_ary_isRowOrderqzofpd6_dsgdx_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_ClassInfoI_2d), intent(in)  :: array
    external sidl_ClassInfoI__array_dimen_m
    call sidl_ClassInfoI__array_dimen_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_stride_m
    call sidl_ClassInfoI__array_stride_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_lower_m
    call sidl_ClassInfoI__array_lower_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_upper_m
    call sidl_ClassInfoI__array_upper_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_length_m
    call sidl_ClassInfoI__array_length_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_3d), intent(out) :: array
    external Cl_ary_createCol1s7g_01gjcwe8_m
    call Cl_ary_createCol1s7g_01gjcwe8_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_3d), intent(out) :: array
    external Cl_ary_createRownzj0vub147u9o_m
    call Cl_ary_createRownzj0vub147u9o_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_ClassInfoI_3d), intent(in) :: src
    type(sidl_ClassInfoI_3d), intent(in) :: dest
    external sidl_ClassInfoI__array_copy_m
    call sidl_ClassInfoI__array_copy_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_ClassInfoI_3d), intent(in)  :: src
    type(sidl_ClassInfoI_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_ClassInfoI__array_ensure_m
    call sidl_ClassInfoI__array_ensure_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external sidl_ClassInfoI__array_slice_m
    call sidl_ClassInfoI__array_slice_m(src, 3, numElem, srcStart, srcStride,  &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_ClassInfoI_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_ClassInfoI_t), intent(out) :: value
    external sidl_ClassInfoI__array_get3_m
    call sidl_ClassInfoI__array_get3_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_ClassInfoI_t), intent(in) :: value
    external sidl_ClassInfoI__array_set3_m
    call sidl_ClassInfoI__array_set3_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_ClassInfoI_3d), intent(in) :: src
    type(sidl_ClassInfoI_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Cl_ary_smartCopywlhxnbvduz24e_m
    dim = 3
    call Cl_ary_smartCopywlhxnbvduz24e_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_ClassInfoI_3d), intent(in)  :: array
    external ary_isColumnOrder2li32g67cz8h_m
    call ary_isColumnOrder2li32g67cz8h_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_ClassInfoI_3d), intent(in)  :: array
    external C_ary_isRowOrderqzofpd6_dsgdx_m
    call C_ary_isRowOrderqzofpd6_dsgdx_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_ClassInfoI_3d), intent(in)  :: array
    external sidl_ClassInfoI__array_dimen_m
    call sidl_ClassInfoI__array_dimen_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_stride_m
    call sidl_ClassInfoI__array_stride_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_lower_m
    call sidl_ClassInfoI__array_lower_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_upper_m
    call sidl_ClassInfoI__array_upper_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_length_m
    call sidl_ClassInfoI__array_length_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_4d), intent(out) :: array
    external Cl_ary_createCol1s7g_01gjcwe8_m
    call Cl_ary_createCol1s7g_01gjcwe8_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_4d), intent(out) :: array
    external Cl_ary_createRownzj0vub147u9o_m
    call Cl_ary_createRownzj0vub147u9o_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_ClassInfoI_4d), intent(in) :: src
    type(sidl_ClassInfoI_4d), intent(in) :: dest
    external sidl_ClassInfoI__array_copy_m
    call sidl_ClassInfoI__array_copy_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_ClassInfoI_4d), intent(in)  :: src
    type(sidl_ClassInfoI_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_ClassInfoI__array_ensure_m
    call sidl_ClassInfoI__array_ensure_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external sidl_ClassInfoI__array_slice_m
    call sidl_ClassInfoI__array_slice_m(src, 4, numElem, srcStart, srcStride,  &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_ClassInfoI_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_ClassInfoI_t), intent(out) :: value
    external sidl_ClassInfoI__array_get4_m
    call sidl_ClassInfoI__array_get4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_ClassInfoI_t), intent(in) :: value
    external sidl_ClassInfoI__array_set4_m
    call sidl_ClassInfoI__array_set4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_ClassInfoI_4d), intent(in) :: src
    type(sidl_ClassInfoI_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Cl_ary_smartCopywlhxnbvduz24e_m
    dim = 4
    call Cl_ary_smartCopywlhxnbvduz24e_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_ClassInfoI_4d), intent(in)  :: array
    external ary_isColumnOrder2li32g67cz8h_m
    call ary_isColumnOrder2li32g67cz8h_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_ClassInfoI_4d), intent(in)  :: array
    external C_ary_isRowOrderqzofpd6_dsgdx_m
    call C_ary_isRowOrderqzofpd6_dsgdx_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_ClassInfoI_4d), intent(in)  :: array
    external sidl_ClassInfoI__array_dimen_m
    call sidl_ClassInfoI__array_dimen_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_stride_m
    call sidl_ClassInfoI__array_stride_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_lower_m
    call sidl_ClassInfoI__array_lower_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_upper_m
    call sidl_ClassInfoI__array_upper_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_length_m
    call sidl_ClassInfoI__array_length_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_5d), intent(out) :: array
    external Cl_ary_createCol1s7g_01gjcwe8_m
    call Cl_ary_createCol1s7g_01gjcwe8_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_5d), intent(out) :: array
    external Cl_ary_createRownzj0vub147u9o_m
    call Cl_ary_createRownzj0vub147u9o_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_ClassInfoI_5d), intent(in) :: src
    type(sidl_ClassInfoI_5d), intent(in) :: dest
    external sidl_ClassInfoI__array_copy_m
    call sidl_ClassInfoI__array_copy_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_ClassInfoI_5d), intent(in)  :: src
    type(sidl_ClassInfoI_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_ClassInfoI__array_ensure_m
    call sidl_ClassInfoI__array_ensure_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external sidl_ClassInfoI__array_slice_m
    call sidl_ClassInfoI__array_slice_m(src, 5, numElem, srcStart, srcStride,  &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_ClassInfoI_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_ClassInfoI_t), intent(out) :: value
    external sidl_ClassInfoI__array_get5_m
    call sidl_ClassInfoI__array_get5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_ClassInfoI_t), intent(in) :: value
    external sidl_ClassInfoI__array_set5_m
    call sidl_ClassInfoI__array_set5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_ClassInfoI_5d), intent(in) :: src
    type(sidl_ClassInfoI_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Cl_ary_smartCopywlhxnbvduz24e_m
    dim = 5
    call Cl_ary_smartCopywlhxnbvduz24e_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_ClassInfoI_5d), intent(in)  :: array
    external ary_isColumnOrder2li32g67cz8h_m
    call ary_isColumnOrder2li32g67cz8h_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_ClassInfoI_5d), intent(in)  :: array
    external C_ary_isRowOrderqzofpd6_dsgdx_m
    call C_ary_isRowOrderqzofpd6_dsgdx_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_ClassInfoI_5d), intent(in)  :: array
    external sidl_ClassInfoI__array_dimen_m
    call sidl_ClassInfoI__array_dimen_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_stride_m
    call sidl_ClassInfoI__array_stride_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_lower_m
    call sidl_ClassInfoI__array_lower_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_upper_m
    call sidl_ClassInfoI__array_upper_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_length_m
    call sidl_ClassInfoI__array_length_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_6d), intent(out) :: array
    external Cl_ary_createCol1s7g_01gjcwe8_m
    call Cl_ary_createCol1s7g_01gjcwe8_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_6d), intent(out) :: array
    external Cl_ary_createRownzj0vub147u9o_m
    call Cl_ary_createRownzj0vub147u9o_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_ClassInfoI_6d), intent(in) :: src
    type(sidl_ClassInfoI_6d), intent(in) :: dest
    external sidl_ClassInfoI__array_copy_m
    call sidl_ClassInfoI__array_copy_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_ClassInfoI_6d), intent(in)  :: src
    type(sidl_ClassInfoI_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_ClassInfoI__array_ensure_m
    call sidl_ClassInfoI__array_ensure_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external sidl_ClassInfoI__array_slice_m
    call sidl_ClassInfoI__array_slice_m(src, 6, numElem, srcStart, srcStride,  &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_ClassInfoI_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_ClassInfoI_t), intent(out) :: value
    external sidl_ClassInfoI__array_get6_m
    call sidl_ClassInfoI__array_get6_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_ClassInfoI_t), intent(in) :: value
    external sidl_ClassInfoI__array_set6_m
    call sidl_ClassInfoI__array_set6_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_ClassInfoI_6d), intent(in) :: src
    type(sidl_ClassInfoI_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Cl_ary_smartCopywlhxnbvduz24e_m
    dim = 6
    call Cl_ary_smartCopywlhxnbvduz24e_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_ClassInfoI_6d), intent(in)  :: array
    external ary_isColumnOrder2li32g67cz8h_m
    call ary_isColumnOrder2li32g67cz8h_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_ClassInfoI_6d), intent(in)  :: array
    external C_ary_isRowOrderqzofpd6_dsgdx_m
    call C_ary_isRowOrderqzofpd6_dsgdx_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_ClassInfoI_6d), intent(in)  :: array
    external sidl_ClassInfoI__array_dimen_m
    call sidl_ClassInfoI__array_dimen_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_stride_m
    call sidl_ClassInfoI__array_stride_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_lower_m
    call sidl_ClassInfoI__array_lower_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_upper_m
    call sidl_ClassInfoI__array_upper_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_length_m
    call sidl_ClassInfoI__array_length_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_7d), intent(out) :: array
    external Cl_ary_createCol1s7g_01gjcwe8_m
    call Cl_ary_createCol1s7g_01gjcwe8_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_ClassInfoI_7d), intent(out) :: array
    external Cl_ary_createRownzj0vub147u9o_m
    call Cl_ary_createRownzj0vub147u9o_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_ClassInfoI_7d), intent(in) :: src
    type(sidl_ClassInfoI_7d), intent(in) :: dest
    external sidl_ClassInfoI__array_copy_m
    call sidl_ClassInfoI__array_copy_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_ClassInfoI_7d), intent(in)  :: src
    type(sidl_ClassInfoI_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_ClassInfoI__array_ensure_m
    call sidl_ClassInfoI__array_ensure_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external sidl_ClassInfoI__array_slice_m
    call sidl_ClassInfoI__array_slice_m(src, 7, numElem, srcStart, srcStride,  &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_ClassInfoI_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_ClassInfoI_t), intent(out) :: value
    external sidl_ClassInfoI__array_get7_m
    call sidl_ClassInfoI__array_get7_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_ClassInfoI_t), intent(in) :: value
    external sidl_ClassInfoI__array_set7_m
    call sidl_ClassInfoI__array_set7_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_ClassInfoI_7d), intent(in) :: src
    type(sidl_ClassInfoI_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Cl_ary_smartCopywlhxnbvduz24e_m
    dim = 7
    call Cl_ary_smartCopywlhxnbvduz24e_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_ClassInfoI_7d), intent(in)  :: array
    external ary_isColumnOrder2li32g67cz8h_m
    call ary_isColumnOrder2li32g67cz8h_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_ClassInfoI_7d), intent(in)  :: array
    external C_ary_isRowOrderqzofpd6_dsgdx_m
    call C_ary_isRowOrderqzofpd6_dsgdx_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_ClassInfoI_7d), intent(in)  :: array
    external sidl_ClassInfoI__array_dimen_m
    call sidl_ClassInfoI__array_dimen_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_stride_m
    call sidl_ClassInfoI__array_stride_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_lower_m
    call sidl_ClassInfoI__array_lower_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_upper_m
    call sidl_ClassInfoI__array_upper_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external sidl_ClassInfoI__array_length_m
    call sidl_ClassInfoI__array_length_m(array, index, length7_p)
  ...
  subroutine castsidl_ClassInfoIksufh_cjqa_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_ClassInfoI_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_ClassInfoIksufh_cjqa_p

  subroutine castsidl_ClassInfoIbz6eky3mt1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_ClassInfoI_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_ClassInfoIbz6eky3mt1_p

  subroutine castsidl_ClassInfoIsy1p9e_9h3_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_ClassInfoI_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_ClassInfoIsy1p9e_9h3_p

  subroutine castsidl_ClassInfoI6_7z2cw5rb_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_ClassInfoI_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_ClassInfoI6_7z2cw5rb_p

  subroutine castsidl_ClassInfoInbzy8x7li9_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_ClassInfoI_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_ClassInfoInbzy8x7li9_p

  subroutine castsidl_ClassInfoI3j2ir46xx5_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_ClassInfoI_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_ClassInfoI3j2ir46xx5_p

  subroutine castsidl_ClassInfoIga5t843pf4_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_ClassInfoI_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_ClassInfoIga5t843pf4_p


end module sidl_ClassInfoI_array
