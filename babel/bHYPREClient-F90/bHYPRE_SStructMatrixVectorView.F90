! 
! File:          bHYPRE_SStructMatrixVectorView.F90
...
module bHYPRE_SStructMatrixVectorView
...
contains
  ...
  recursive subroutine GetObject_s(self, A, retval, exception)
    implicit none
    !  in bHYPRE.SStructMatrixVectorView self
    type(bHYPRE_SStructMatrixVectorView_t) , intent(in) :: self
    ...
    external bHYPRE_SStructMatrixVectorView_GetObject_m
    call bHYPRE_SStructMatrixVectorView_GetObject_m(self, A, retval,           &
      exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    type(bHYPRE_SStructMatrixVectorView_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructMatrixVectorView_rConnect_m
    call bHYPRE_SStructMatrixVectorView_rConnect_m(self, url, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_SetCommunicator_m
    call bHYPRE_SStructMatrixVectorView_SetCommunicator_m(self, mpi_comm,      &
      retval, exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_Destroy_m
    call bHYPRE_SStructMatrixVectorView_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_Initialize_m
    call bHYPRE_SStructMatrixVectorView_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_Assemble_m
    call bHYPRE_SStructMatrixVectorView_Assemble_m(self, retval, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_addRef_m
    call bHYPRE_SStructMatrixVectorView_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_deleteRef_m
    call bHYPRE_SStructMatrixVectorView_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_isSame_m
    call bHYPRE_SStructMatrixVectorView_isSame_m(self, iobj, retval,           &
      exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_isType_m
    call bHYPRE_SStructMatrixVectorView_isType_m(self, name, retval,           &
      exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView_getClassInfo_m
    call bHYPRE_SStructMatrixVectorView_getClassInfo_m(self, retval,           &
      exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_SStructMatrixVectorView__exec_m
    call bHYPRE_SStructMatrixVectorView__exec_m(self, methodName, inArgs,      &
      outArgs, exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView__getURL_m
    call bHYPRE_SStructMatrixVectorView__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView__isRemote_m
    call bHYPRE_SStructMatrixVectorView__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixVectorView__isLocal_m
    call bHYPRE_SStructMatrixVectorView__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_SStructMatrixVectorView__set_hooks_m
    call bHYPRE_SStructMatrixVectorView__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_SStructMatrixVectorView

module bHYPRE_SStructMatrixVectorView_array
  use sidl
  use bHYPRE_SStructMatrixVectorView_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructM9dj29jsqv7_p, &
    castbHYPRE_SStructMxw3p0s7q30_p, &
    castbHYPRE_SStructMs4p6cmvc4c_p, &
    castbHYPRE_SStructM2t09athb2z_p, &
    castbHYPRE_SStructM53qehtz9is_p, &
    castbHYPRE_SStructMo1nnni9s35_p, &
    castbHYPRE_SStructM3munvpuuot_p
interface cast
  module procedure &
    castbHYPRE_SStructM9dj29jsqv7_p, &
    castbHYPRE_SStructMxw3p0s7q30_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_1d), intent(out) :: array
    external SS_ary_createColsq9nx1vkphscx_m
    call SS_ary_createColsq9nx1vkphscx_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_SStructMatrixVectorView_1d), intent(out) :: array
    external SS_ary_createRow5jw8ntn4qha57_m
    call SS_ary_createRow5jw8ntn4qha57_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_SStructMatrixVectorView_1d), intent(out) :: array
    external SSt_ary_create1dhcwv2bl4vyqnl_m
    call SSt_ary_create1dhcwv2bl4vyqnl_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in) :: dest
    external SStruct_ary_copypcbaamp9p2zch_m
    call SStruct_ary_copypcbaamp9p2zch_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: src
    type(bHYPRE_SStructMatrixVectorView_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureezcslr3afadzv_m
    call SStru_ary_ensureezcslr3afadzv_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external SStruc_ary_slicepdffqrfhfxp9q_m
    call SStruc_ary_slicepdffqrfhfxp9q_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: value
    external SStructM_ary_getz_dhjtyzr2wp4_m
    call SStructM_ary_getz_dhjtyzr2wp4_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: value
    external SStructM_ary_setv9ybhoivmgxo8_m
    call SStructM_ary_setv9ybhoivmgxo8_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: value
    external SStruct_ary_get1rn_r2uiu0pit8_m
    call SStruct_ary_get1rn_r2uiu0pit8_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: value
    external SStruct_ary_set1u6cy128nki1_w_m
    call SStruct_ary_set1u6cy128nki1_w_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopycislvc9d4ando_m
    dim = 1
    call SS_ary_smartCopycislvc9d4ando_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    external ary_isColumnOrderqgc02s443uzt_m
    call ary_isColumnOrderqgc02s443uzt_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    external S_ary_isRowOrdernv8ta7w0m3woe_m
    call S_ary_isRowOrdernv8ta7w0m3woe_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    external SStruc_ary_dimen6imarm20_rets_m
    call SStruc_ary_dimen6imarm20_rets_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride2uva99tua69kj_m
    call SStru_ary_stride2uva99tua69kj_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerp8troi9flbh4z_m
    call SStruc_ary_lowerp8troi9flbh4z_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper_cr0l2ccns2fg_m
    call SStruc_ary_upper_cr0l2ccns2fg_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthunn37f6s7dk11_m
    call SStru_ary_lengthunn37f6s7dk11_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    external SStru_ary_addRef01a340t5eqgjz_m
    call SStru_ary_addRef01a340t5eqgjz_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in)  :: array
    external SS_ary_deleteRef02fcznrmik1rw_m
    call SS_ary_deleteRef02fcznrmik1rw_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_2d), intent(out) :: array
    external SS_ary_createColsq9nx1vkphscx_m
    call SS_ary_createColsq9nx1vkphscx_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_2d), intent(out) :: array
    external SS_ary_createRow5jw8ntn4qha57_m
    call SS_ary_createRow5jw8ntn4qha57_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructMatrixVectorView_2d), intent(out) :: array
    external ary_create2dColfm0vghr2j_k_lx_m
    call ary_create2dColfm0vghr2j_k_lx_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructMatrixVectorView_2d), intent(out) :: array
    external ary_create2dRowhmygceuz5ppt9e_m
    call ary_create2dRowhmygceuz5ppt9e_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in) :: dest
    external SStruct_ary_copypcbaamp9p2zch_m
    call SStruct_ary_copypcbaamp9p2zch_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in)  :: src
    type(bHYPRE_SStructMatrixVectorView_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureezcslr3afadzv_m
    call SStru_ary_ensureezcslr3afadzv_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicepdffqrfhfxp9q_m
    call SStruc_ary_slicepdffqrfhfxp9q_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: value
    external SStruct_ary_get22roagntzz90tl_m
    call SStruct_ary_get22roagntzz90tl_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: value
    external SStruct_ary_set2xugq1dn8ot4w8_m
    call SStruct_ary_set2xugq1dn8ot4w8_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopycislvc9d4ando_m
    dim = 2
    call SS_ary_smartCopycislvc9d4ando_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in)  :: array
    external ary_isColumnOrderqgc02s443uzt_m
    call ary_isColumnOrderqgc02s443uzt_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in)  :: array
    external S_ary_isRowOrdernv8ta7w0m3woe_m
    call S_ary_isRowOrdernv8ta7w0m3woe_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in)  :: array
    external SStruc_ary_dimen6imarm20_rets_m
    call SStruc_ary_dimen6imarm20_rets_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride2uva99tua69kj_m
    call SStru_ary_stride2uva99tua69kj_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerp8troi9flbh4z_m
    call SStruc_ary_lowerp8troi9flbh4z_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper_cr0l2ccns2fg_m
    call SStruc_ary_upper_cr0l2ccns2fg_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthunn37f6s7dk11_m
    call SStru_ary_lengthunn37f6s7dk11_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_3d), intent(out) :: array
    external SS_ary_createColsq9nx1vkphscx_m
    call SS_ary_createColsq9nx1vkphscx_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_3d), intent(out) :: array
    external SS_ary_createRow5jw8ntn4qha57_m
    call SS_ary_createRow5jw8ntn4qha57_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in) :: dest
    external SStruct_ary_copypcbaamp9p2zch_m
    call SStruct_ary_copypcbaamp9p2zch_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in)  :: src
    type(bHYPRE_SStructMatrixVectorView_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureezcslr3afadzv_m
    call SStru_ary_ensureezcslr3afadzv_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicepdffqrfhfxp9q_m
    call SStruc_ary_slicepdffqrfhfxp9q_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: value
    external SStruct_ary_get3byepvyqu852gl_m
    call SStruct_ary_get3byepvyqu852gl_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: value
    external SStruct_ary_set3za2kdevu7ji0g_m
    call SStruct_ary_set3za2kdevu7ji0g_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopycislvc9d4ando_m
    dim = 3
    call SS_ary_smartCopycislvc9d4ando_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in)  :: array
    external ary_isColumnOrderqgc02s443uzt_m
    call ary_isColumnOrderqgc02s443uzt_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in)  :: array
    external S_ary_isRowOrdernv8ta7w0m3woe_m
    call S_ary_isRowOrdernv8ta7w0m3woe_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in)  :: array
    external SStruc_ary_dimen6imarm20_rets_m
    call SStruc_ary_dimen6imarm20_rets_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride2uva99tua69kj_m
    call SStru_ary_stride2uva99tua69kj_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerp8troi9flbh4z_m
    call SStruc_ary_lowerp8troi9flbh4z_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper_cr0l2ccns2fg_m
    call SStruc_ary_upper_cr0l2ccns2fg_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthunn37f6s7dk11_m
    call SStru_ary_lengthunn37f6s7dk11_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_4d), intent(out) :: array
    external SS_ary_createColsq9nx1vkphscx_m
    call SS_ary_createColsq9nx1vkphscx_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_4d), intent(out) :: array
    external SS_ary_createRow5jw8ntn4qha57_m
    call SS_ary_createRow5jw8ntn4qha57_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in) :: dest
    external SStruct_ary_copypcbaamp9p2zch_m
    call SStruct_ary_copypcbaamp9p2zch_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in)  :: src
    type(bHYPRE_SStructMatrixVectorView_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureezcslr3afadzv_m
    call SStru_ary_ensureezcslr3afadzv_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicepdffqrfhfxp9q_m
    call SStruc_ary_slicepdffqrfhfxp9q_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: value
    external SStruct_ary_get4aw4f18b44zvha_m
    call SStruct_ary_get4aw4f18b44zvha_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: value
    external SStruct_ary_set4x7efl3bk71xy4_m
    call SStruct_ary_set4x7efl3bk71xy4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopycislvc9d4ando_m
    dim = 4
    call SS_ary_smartCopycislvc9d4ando_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in)  :: array
    external ary_isColumnOrderqgc02s443uzt_m
    call ary_isColumnOrderqgc02s443uzt_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in)  :: array
    external S_ary_isRowOrdernv8ta7w0m3woe_m
    call S_ary_isRowOrdernv8ta7w0m3woe_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in)  :: array
    external SStruc_ary_dimen6imarm20_rets_m
    call SStruc_ary_dimen6imarm20_rets_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride2uva99tua69kj_m
    call SStru_ary_stride2uva99tua69kj_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerp8troi9flbh4z_m
    call SStruc_ary_lowerp8troi9flbh4z_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper_cr0l2ccns2fg_m
    call SStruc_ary_upper_cr0l2ccns2fg_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthunn37f6s7dk11_m
    call SStru_ary_lengthunn37f6s7dk11_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_5d), intent(out) :: array
    external SS_ary_createColsq9nx1vkphscx_m
    call SS_ary_createColsq9nx1vkphscx_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_5d), intent(out) :: array
    external SS_ary_createRow5jw8ntn4qha57_m
    call SS_ary_createRow5jw8ntn4qha57_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in) :: dest
    external SStruct_ary_copypcbaamp9p2zch_m
    call SStruct_ary_copypcbaamp9p2zch_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in)  :: src
    type(bHYPRE_SStructMatrixVectorView_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureezcslr3afadzv_m
    call SStru_ary_ensureezcslr3afadzv_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicepdffqrfhfxp9q_m
    call SStruc_ary_slicepdffqrfhfxp9q_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: value
    external SStruct_ary_get5ule5p6vct2zv8_m
    call SStruct_ary_get5ule5p6vct2zv8_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: value
    external SStruct_ary_set5h8ivzs20o7fwe_m
    call SStruct_ary_set5h8ivzs20o7fwe_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopycislvc9d4ando_m
    dim = 5
    call SS_ary_smartCopycislvc9d4ando_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in)  :: array
    external ary_isColumnOrderqgc02s443uzt_m
    call ary_isColumnOrderqgc02s443uzt_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in)  :: array
    external S_ary_isRowOrdernv8ta7w0m3woe_m
    call S_ary_isRowOrdernv8ta7w0m3woe_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in)  :: array
    external SStruc_ary_dimen6imarm20_rets_m
    call SStruc_ary_dimen6imarm20_rets_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride2uva99tua69kj_m
    call SStru_ary_stride2uva99tua69kj_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerp8troi9flbh4z_m
    call SStruc_ary_lowerp8troi9flbh4z_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper_cr0l2ccns2fg_m
    call SStruc_ary_upper_cr0l2ccns2fg_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthunn37f6s7dk11_m
    call SStru_ary_lengthunn37f6s7dk11_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_6d), intent(out) :: array
    external SS_ary_createColsq9nx1vkphscx_m
    call SS_ary_createColsq9nx1vkphscx_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_6d), intent(out) :: array
    external SS_ary_createRow5jw8ntn4qha57_m
    call SS_ary_createRow5jw8ntn4qha57_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in) :: dest
    external SStruct_ary_copypcbaamp9p2zch_m
    call SStruct_ary_copypcbaamp9p2zch_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in)  :: src
    type(bHYPRE_SStructMatrixVectorView_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureezcslr3afadzv_m
    call SStru_ary_ensureezcslr3afadzv_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicepdffqrfhfxp9q_m
    call SStruc_ary_slicepdffqrfhfxp9q_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: value
    external SStruct_ary_get6asa_5ipoeq8o4_m
    call SStruct_ary_get6asa_5ipoeq8o4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: value
    external SStruct_ary_set6zf9zd0vy8mur3_m
    call SStruct_ary_set6zf9zd0vy8mur3_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopycislvc9d4ando_m
    dim = 6
    call SS_ary_smartCopycislvc9d4ando_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in)  :: array
    external ary_isColumnOrderqgc02s443uzt_m
    call ary_isColumnOrderqgc02s443uzt_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in)  :: array
    external S_ary_isRowOrdernv8ta7w0m3woe_m
    call S_ary_isRowOrdernv8ta7w0m3woe_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in)  :: array
    external SStruc_ary_dimen6imarm20_rets_m
    call SStruc_ary_dimen6imarm20_rets_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride2uva99tua69kj_m
    call SStru_ary_stride2uva99tua69kj_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerp8troi9flbh4z_m
    call SStruc_ary_lowerp8troi9flbh4z_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper_cr0l2ccns2fg_m
    call SStruc_ary_upper_cr0l2ccns2fg_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthunn37f6s7dk11_m
    call SStru_ary_lengthunn37f6s7dk11_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_7d), intent(out) :: array
    external SS_ary_createColsq9nx1vkphscx_m
    call SS_ary_createColsq9nx1vkphscx_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixVectorView_7d), intent(out) :: array
    external SS_ary_createRow5jw8ntn4qha57_m
    call SS_ary_createRow5jw8ntn4qha57_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in) :: dest
    external SStruct_ary_copypcbaamp9p2zch_m
    call SStruct_ary_copypcbaamp9p2zch_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in)  :: src
    type(bHYPRE_SStructMatrixVectorView_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureezcslr3afadzv_m
    call SStru_ary_ensureezcslr3afadzv_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicepdffqrfhfxp9q_m
    call SStruc_ary_slicepdffqrfhfxp9q_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_SStructMatrixVectorView_t), intent(out) :: value
    external SStruct_ary_get70o8mmzsrg4cut_m
    call SStruct_ary_get70o8mmzsrg4cut_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_SStructMatrixVectorView_t), intent(in) :: value
    external SStruct_ary_set7lmljivtqkuk___m
    call SStruct_ary_set7lmljivtqkuk___m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in) :: src
    type(bHYPRE_SStructMatrixVectorView_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopycislvc9d4ando_m
    dim = 7
    call SS_ary_smartCopycislvc9d4ando_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in)  :: array
    external ary_isColumnOrderqgc02s443uzt_m
    call ary_isColumnOrderqgc02s443uzt_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in)  :: array
    external S_ary_isRowOrdernv8ta7w0m3woe_m
    call S_ary_isRowOrdernv8ta7w0m3woe_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in)  :: array
    external SStruc_ary_dimen6imarm20_rets_m
    call SStruc_ary_dimen6imarm20_rets_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride2uva99tua69kj_m
    call SStru_ary_stride2uva99tua69kj_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerp8troi9flbh4z_m
    call SStruc_ary_lowerp8troi9flbh4z_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper_cr0l2ccns2fg_m
    call SStruc_ary_upper_cr0l2ccns2fg_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthunn37f6s7dk11_m
    call SStru_ary_lengthunn37f6s7dk11_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_SStructM9dj29jsqv7_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixVectorView_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructM9dj29jsqv7_p

  subroutine castbHYPRE_SStructMxw3p0s7q30_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixVectorView_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructMxw3p0s7q30_p

  subroutine castbHYPRE_SStructMs4p6cmvc4c_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixVectorView_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructMs4p6cmvc4c_p

  subroutine castbHYPRE_SStructM2t09athb2z_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixVectorView_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructM2t09athb2z_p

  subroutine castbHYPRE_SStructM53qehtz9is_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixVectorView_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructM53qehtz9is_p

  subroutine castbHYPRE_SStructMo1nnni9s35_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixVectorView_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructMo1nnni9s35_p

  subroutine castbHYPRE_SStructM3munvpuuot_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixVectorView_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructM3munvpuuot_p


end module bHYPRE_SStructMatrixVectorView_array
