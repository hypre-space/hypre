! 
! File:          bHYPRE_SStructStencil.F90
...
module bHYPRE_SStructStencil
  ...
  interface Destroy
    ...
    private :: SetNumDimSize_s


  interface SetNumDimSize
    module procedure SetNumDimSize_s
  end interface
    private :: SetEntry_1s, &
    SetEntry_2s
  ...
  interface bHYPRE_SStructStencil__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(ndim, size, retval, exception)
    ...
    !  out bHYPRE.SStructStencil retval
    type(bHYPRE_SStructStencil_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructStencil_Create_m
    call bHYPRE_SStructStencil_Create_m(ndim, size, retval, exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    implicit none
    !  in bHYPRE.SStructStencil self
    type(bHYPRE_SStructStencil_t) , intent(in) :: self
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructStencil_Destroy_m
    call bHYPRE_SStructStencil_Destroy_m(self, exception)

  end subroutine Destroy_s


  recursive subroutine SetNumDimSize_s(self, ndim, size, retval, exception)
    implicit none
    !  in bHYPRE.SStructStencil self
    type(bHYPRE_SStructStencil_t) , intent(in) :: self
    !  in int ndim
    ...
    external bHYPRE_SStructStencil_SetNumDimSize_m
    call bHYPRE_SStructStencil_SetNumDimSize_m(self, ndim, size, retval,       &
      exception)

  end subroutine SetNumDimSize_s


  recursive subroutine SetEntry_1s(self, entry, offset, var, retval,           &
    exception)
    implicit none
    !  in bHYPRE.SStructStencil self
    type(bHYPRE_SStructStencil_t) , intent(in) :: self
    !  in int entry
    integer (kind=sidl_int) , intent(in) :: entry
    ...
    external bHYPRE_SStructStencil_SetEntry_a
    call bHYPRE_SStructStencil_SetEntry_a(self, entry, offset, var, retval,    &
      exception)

  end subroutine SetEntry_1s

  recursive subroutine SetEntry_2s(self, entry, offset, var, retval,           &
    exception)
    implicit none
    !  in bHYPRE.SStructStencil self
    type(bHYPRE_SStructStencil_t) , intent(in) :: self
    ...
    external bHYPRE_SStructStencil_SetEntry_m
    dim = size(offset, 1)
    call bHYPRE_SStructStencil_SetEntry_m(self, entry, offset, dim, var,       &
      retval, exception)

  end subroutine SetEntry_2s
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_SStructStencil_newLocal_m
    call bHYPRE_SStructStencil_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    implicit none
    !  out bHYPRE.SStructStencil self
    type(bHYPRE_SStructStencil_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructStencil_newRemote_m
    call bHYPRE_SStructStencil_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_SStructStencil_rConnect_m
    call bHYPRE_SStructStencil_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_SStructStencil_addRef_m
    call bHYPRE_SStructStencil_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_SStructStencil_deleteRef_m
    call bHYPRE_SStructStencil_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_SStructStencil_isSame_m
    call bHYPRE_SStructStencil_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_SStructStencil_isType_m
    call bHYPRE_SStructStencil_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_SStructStencil_getClassInfo_m
    call bHYPRE_SStructStencil_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.SStructStencil
  ! to sidl.BaseClass.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_SStructStencil_t), intent(in) :: oldType
  ...
  ! to bHYPRE.SStructStencil.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseClass_t), intent(in) :: oldType
    type(bHYPRE_SStructStencil_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_SStructStencil__cast_m

    call bHYPRE_SStructStencil__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_SStructStencil__exec_m
    call bHYPRE_SStructStencil__exec_m(self, methodName, inArgs, outArgs,      &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_SStructStencil__getURL_m
    call bHYPRE_SStructStencil__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_SStructStencil__isRemote_m
    call bHYPRE_SStructStencil__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_SStructStencil__isLocal_m
    call bHYPRE_SStructStencil__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_SStructStencil__set_hooks_m
    call bHYPRE_SStructStencil__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_SStructStencil__set_hooks_static_m
    call bHYPRE_SStructStencil__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_SStructStencil_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_SStructStencil_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_SStructStencil

module bHYPRE_SStructStencil_array
  use sidl
  use bHYPRE_SStructStencil_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructSuxpbetjuie_p, &
    castbHYPRE_SStructSdxl9hcdry6_p, &
    castbHYPRE_SStructS0ccqywmq76_p, &
    castbHYPRE_SStructS1ui5sv7qge_p, &
    castbHYPRE_SStructSk0rmnfkcbk_p, &
    castbHYPRE_SStructS8atykk61q5_p, &
    castbHYPRE_SStructS4j9b4ejxr1_p
interface cast
  module procedure &
    castbHYPRE_SStructSuxpbetjuie_p, &
    castbHYPRE_SStructSdxl9hcdry6_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_1d), intent(out) :: array
    external SS_ary_createCol5p3o3dz_ypmr1_m
    call SS_ary_createCol5p3o3dz_ypmr1_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_SStructStencil_1d), intent(out) :: array
    external SS_ary_createRowllqgjy59kjerx_m
    call SS_ary_createRowllqgjy59kjerx_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_SStructStencil_1d), intent(out) :: array
    external SSt_ary_create1ddqpirym6d38dw_m
    call SSt_ary_create1ddqpirym6d38dw_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructStencil_1d), intent(in) :: src
    type(bHYPRE_SStructStencil_1d), intent(in) :: dest
    external SStruct_ary_copydomvo840qey8e_m
    call SStruct_ary_copydomvo840qey8e_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: src
    type(bHYPRE_SStructStencil_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurelorv2mrfnhwxm_m
    call SStru_ary_ensurelorv2mrfnhwxm_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external SStruc_ary_slice9hx495gvkqi65_m
    call SStruc_ary_slice9hx495gvkqi65_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructStencil_t), intent(out) :: value
    external SStructS_ary_getzlnr4xmzor_ry_m
    call SStructS_ary_getzlnr4xmzor_ry_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructStencil_t), intent(in) :: value
    external SStructS_ary_setcw3z01xi8xnzq_m
    call SStructS_ary_setcw3z01xi8xnzq_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_SStructStencil_t), intent(out) :: value
    external SStruct_ary_get1jwuzgr80h6gke_m
    call SStruct_ary_get1jwuzgr80h6gke_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_SStructStencil_t), intent(in) :: value
    external SStruct_ary_set1l5ug4h0mdw454_m
    call SStruct_ary_set1l5ug4h0mdw454_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructStencil_1d), intent(in) :: src
    type(bHYPRE_SStructStencil_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyeiz6isz3c94_e_m
    dim = 1
    call SS_ary_smartCopyeiz6isz3c94_e_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    external ary_isColumnOrder_1esedij7zs4_m
    call ary_isColumnOrder_1esedij7zs4_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    external S_ary_isRowOrder8tgs6k6lvwg9p_m
    call S_ary_isRowOrder8tgs6k6lvwg9p_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    external SStruc_ary_dimeno_f5imninobuu_m
    call SStruc_ary_dimeno_f5imninobuu_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideox9o3yho3xhkw_m
    call SStru_ary_strideox9o3yho3xhkw_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_qs19tnyev8sq_m
    call SStruc_ary_lower_qs19tnyev8sq_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper5vxx2vfhhmgxs_m
    call SStruc_ary_upper5vxx2vfhhmgxs_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthabv20jvdh5egd_m
    call SStru_ary_lengthabv20jvdh5egd_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    external SStru_ary_addRefs8vhlquf0ccg2_m
    call SStru_ary_addRefs8vhlquf0ccg2_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_SStructStencil_1d), intent(in)  :: array
    external SS_ary_deleteRefasbs0wwnov_lv_m
    call SS_ary_deleteRefasbs0wwnov_lv_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_2d), intent(out) :: array
    external SS_ary_createCol5p3o3dz_ypmr1_m
    call SS_ary_createCol5p3o3dz_ypmr1_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_2d), intent(out) :: array
    external SS_ary_createRowllqgjy59kjerx_m
    call SS_ary_createRowllqgjy59kjerx_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructStencil_2d), intent(out) :: array
    external ary_create2dCol8tt3erqkctw8bh_m
    call ary_create2dCol8tt3erqkctw8bh_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructStencil_2d), intent(out) :: array
    external ary_create2dRowdi6xckzprsupw0_m
    call ary_create2dRowdi6xckzprsupw0_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructStencil_2d), intent(in) :: src
    type(bHYPRE_SStructStencil_2d), intent(in) :: dest
    external SStruct_ary_copydomvo840qey8e_m
    call SStruct_ary_copydomvo840qey8e_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructStencil_2d), intent(in)  :: src
    type(bHYPRE_SStructStencil_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurelorv2mrfnhwxm_m
    call SStru_ary_ensurelorv2mrfnhwxm_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9hx495gvkqi65_m
    call SStruc_ary_slice9hx495gvkqi65_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructStencil_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_SStructStencil_t), intent(out) :: value
    external SStruct_ary_get2grycsaaj5d5j7_m
    call SStruct_ary_get2grycsaaj5d5j7_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_SStructStencil_t), intent(in) :: value
    external SStruct_ary_set2ob4q4dprtgfm6_m
    call SStruct_ary_set2ob4q4dprtgfm6_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructStencil_2d), intent(in) :: src
    type(bHYPRE_SStructStencil_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyeiz6isz3c94_e_m
    dim = 2
    call SS_ary_smartCopyeiz6isz3c94_e_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_SStructStencil_2d), intent(in)  :: array
    external ary_isColumnOrder_1esedij7zs4_m
    call ary_isColumnOrder_1esedij7zs4_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_SStructStencil_2d), intent(in)  :: array
    external S_ary_isRowOrder8tgs6k6lvwg9p_m
    call S_ary_isRowOrder8tgs6k6lvwg9p_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_SStructStencil_2d), intent(in)  :: array
    external SStruc_ary_dimeno_f5imninobuu_m
    call SStruc_ary_dimeno_f5imninobuu_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideox9o3yho3xhkw_m
    call SStru_ary_strideox9o3yho3xhkw_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_qs19tnyev8sq_m
    call SStruc_ary_lower_qs19tnyev8sq_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper5vxx2vfhhmgxs_m
    call SStruc_ary_upper5vxx2vfhhmgxs_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthabv20jvdh5egd_m
    call SStru_ary_lengthabv20jvdh5egd_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_3d), intent(out) :: array
    external SS_ary_createCol5p3o3dz_ypmr1_m
    call SS_ary_createCol5p3o3dz_ypmr1_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_3d), intent(out) :: array
    external SS_ary_createRowllqgjy59kjerx_m
    call SS_ary_createRowllqgjy59kjerx_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructStencil_3d), intent(in) :: src
    type(bHYPRE_SStructStencil_3d), intent(in) :: dest
    external SStruct_ary_copydomvo840qey8e_m
    call SStruct_ary_copydomvo840qey8e_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructStencil_3d), intent(in)  :: src
    type(bHYPRE_SStructStencil_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurelorv2mrfnhwxm_m
    call SStru_ary_ensurelorv2mrfnhwxm_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9hx495gvkqi65_m
    call SStruc_ary_slice9hx495gvkqi65_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructStencil_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_SStructStencil_t), intent(out) :: value
    external SStruct_ary_get3jpmjxvpre9hh__m
    call SStruct_ary_get3jpmjxvpre9hh__m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_SStructStencil_t), intent(in) :: value
    external SStruct_ary_set3aqaqm91_ain4i_m
    call SStruct_ary_set3aqaqm91_ain4i_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructStencil_3d), intent(in) :: src
    type(bHYPRE_SStructStencil_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyeiz6isz3c94_e_m
    dim = 3
    call SS_ary_smartCopyeiz6isz3c94_e_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_SStructStencil_3d), intent(in)  :: array
    external ary_isColumnOrder_1esedij7zs4_m
    call ary_isColumnOrder_1esedij7zs4_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_SStructStencil_3d), intent(in)  :: array
    external S_ary_isRowOrder8tgs6k6lvwg9p_m
    call S_ary_isRowOrder8tgs6k6lvwg9p_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_SStructStencil_3d), intent(in)  :: array
    external SStruc_ary_dimeno_f5imninobuu_m
    call SStruc_ary_dimeno_f5imninobuu_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideox9o3yho3xhkw_m
    call SStru_ary_strideox9o3yho3xhkw_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_qs19tnyev8sq_m
    call SStruc_ary_lower_qs19tnyev8sq_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper5vxx2vfhhmgxs_m
    call SStruc_ary_upper5vxx2vfhhmgxs_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthabv20jvdh5egd_m
    call SStru_ary_lengthabv20jvdh5egd_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_4d), intent(out) :: array
    external SS_ary_createCol5p3o3dz_ypmr1_m
    call SS_ary_createCol5p3o3dz_ypmr1_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_4d), intent(out) :: array
    external SS_ary_createRowllqgjy59kjerx_m
    call SS_ary_createRowllqgjy59kjerx_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructStencil_4d), intent(in) :: src
    type(bHYPRE_SStructStencil_4d), intent(in) :: dest
    external SStruct_ary_copydomvo840qey8e_m
    call SStruct_ary_copydomvo840qey8e_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructStencil_4d), intent(in)  :: src
    type(bHYPRE_SStructStencil_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurelorv2mrfnhwxm_m
    call SStru_ary_ensurelorv2mrfnhwxm_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9hx495gvkqi65_m
    call SStruc_ary_slice9hx495gvkqi65_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructStencil_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_SStructStencil_t), intent(out) :: value
    external SStruct_ary_get4f_smo4ut4cau3_m
    call SStruct_ary_get4f_smo4ut4cau3_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_SStructStencil_t), intent(in) :: value
    external SStruct_ary_set4cs7zmujl1_dhg_m
    call SStruct_ary_set4cs7zmujl1_dhg_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructStencil_4d), intent(in) :: src
    type(bHYPRE_SStructStencil_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyeiz6isz3c94_e_m
    dim = 4
    call SS_ary_smartCopyeiz6isz3c94_e_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_SStructStencil_4d), intent(in)  :: array
    external ary_isColumnOrder_1esedij7zs4_m
    call ary_isColumnOrder_1esedij7zs4_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_SStructStencil_4d), intent(in)  :: array
    external S_ary_isRowOrder8tgs6k6lvwg9p_m
    call S_ary_isRowOrder8tgs6k6lvwg9p_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_SStructStencil_4d), intent(in)  :: array
    external SStruc_ary_dimeno_f5imninobuu_m
    call SStruc_ary_dimeno_f5imninobuu_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideox9o3yho3xhkw_m
    call SStru_ary_strideox9o3yho3xhkw_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_qs19tnyev8sq_m
    call SStruc_ary_lower_qs19tnyev8sq_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper5vxx2vfhhmgxs_m
    call SStruc_ary_upper5vxx2vfhhmgxs_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthabv20jvdh5egd_m
    call SStru_ary_lengthabv20jvdh5egd_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_5d), intent(out) :: array
    external SS_ary_createCol5p3o3dz_ypmr1_m
    call SS_ary_createCol5p3o3dz_ypmr1_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_5d), intent(out) :: array
    external SS_ary_createRowllqgjy59kjerx_m
    call SS_ary_createRowllqgjy59kjerx_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructStencil_5d), intent(in) :: src
    type(bHYPRE_SStructStencil_5d), intent(in) :: dest
    external SStruct_ary_copydomvo840qey8e_m
    call SStruct_ary_copydomvo840qey8e_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructStencil_5d), intent(in)  :: src
    type(bHYPRE_SStructStencil_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurelorv2mrfnhwxm_m
    call SStru_ary_ensurelorv2mrfnhwxm_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9hx495gvkqi65_m
    call SStruc_ary_slice9hx495gvkqi65_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructStencil_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_SStructStencil_t), intent(out) :: value
    external SStruct_ary_get55mu7b3vqevdyh_m
    call SStruct_ary_get55mu7b3vqevdyh_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_SStructStencil_t), intent(in) :: value
    external SStruct_ary_set5ribki07_19yqo_m
    call SStruct_ary_set5ribki07_19yqo_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructStencil_5d), intent(in) :: src
    type(bHYPRE_SStructStencil_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyeiz6isz3c94_e_m
    dim = 5
    call SS_ary_smartCopyeiz6isz3c94_e_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_SStructStencil_5d), intent(in)  :: array
    external ary_isColumnOrder_1esedij7zs4_m
    call ary_isColumnOrder_1esedij7zs4_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_SStructStencil_5d), intent(in)  :: array
    external S_ary_isRowOrder8tgs6k6lvwg9p_m
    call S_ary_isRowOrder8tgs6k6lvwg9p_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_SStructStencil_5d), intent(in)  :: array
    external SStruc_ary_dimeno_f5imninobuu_m
    call SStruc_ary_dimeno_f5imninobuu_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideox9o3yho3xhkw_m
    call SStru_ary_strideox9o3yho3xhkw_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_qs19tnyev8sq_m
    call SStruc_ary_lower_qs19tnyev8sq_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper5vxx2vfhhmgxs_m
    call SStruc_ary_upper5vxx2vfhhmgxs_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthabv20jvdh5egd_m
    call SStru_ary_lengthabv20jvdh5egd_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_6d), intent(out) :: array
    external SS_ary_createCol5p3o3dz_ypmr1_m
    call SS_ary_createCol5p3o3dz_ypmr1_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_6d), intent(out) :: array
    external SS_ary_createRowllqgjy59kjerx_m
    call SS_ary_createRowllqgjy59kjerx_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructStencil_6d), intent(in) :: src
    type(bHYPRE_SStructStencil_6d), intent(in) :: dest
    external SStruct_ary_copydomvo840qey8e_m
    call SStruct_ary_copydomvo840qey8e_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructStencil_6d), intent(in)  :: src
    type(bHYPRE_SStructStencil_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurelorv2mrfnhwxm_m
    call SStru_ary_ensurelorv2mrfnhwxm_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9hx495gvkqi65_m
    call SStruc_ary_slice9hx495gvkqi65_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructStencil_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_SStructStencil_t), intent(out) :: value
    external SStruct_ary_get6c6_e25x3l8q02_m
    call SStruct_ary_get6c6_e25x3l8q02_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_SStructStencil_t), intent(in) :: value
    external SStruct_ary_set6pbwdq39elf27__m
    call SStruct_ary_set6pbwdq39elf27__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructStencil_6d), intent(in) :: src
    type(bHYPRE_SStructStencil_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyeiz6isz3c94_e_m
    dim = 6
    call SS_ary_smartCopyeiz6isz3c94_e_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_SStructStencil_6d), intent(in)  :: array
    external ary_isColumnOrder_1esedij7zs4_m
    call ary_isColumnOrder_1esedij7zs4_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_SStructStencil_6d), intent(in)  :: array
    external S_ary_isRowOrder8tgs6k6lvwg9p_m
    call S_ary_isRowOrder8tgs6k6lvwg9p_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_SStructStencil_6d), intent(in)  :: array
    external SStruc_ary_dimeno_f5imninobuu_m
    call SStruc_ary_dimeno_f5imninobuu_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideox9o3yho3xhkw_m
    call SStru_ary_strideox9o3yho3xhkw_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_qs19tnyev8sq_m
    call SStruc_ary_lower_qs19tnyev8sq_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper5vxx2vfhhmgxs_m
    call SStruc_ary_upper5vxx2vfhhmgxs_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthabv20jvdh5egd_m
    call SStru_ary_lengthabv20jvdh5egd_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_7d), intent(out) :: array
    external SS_ary_createCol5p3o3dz_ypmr1_m
    call SS_ary_createCol5p3o3dz_ypmr1_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructStencil_7d), intent(out) :: array
    external SS_ary_createRowllqgjy59kjerx_m
    call SS_ary_createRowllqgjy59kjerx_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructStencil_7d), intent(in) :: src
    type(bHYPRE_SStructStencil_7d), intent(in) :: dest
    external SStruct_ary_copydomvo840qey8e_m
    call SStruct_ary_copydomvo840qey8e_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructStencil_7d), intent(in)  :: src
    type(bHYPRE_SStructStencil_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurelorv2mrfnhwxm_m
    call SStru_ary_ensurelorv2mrfnhwxm_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9hx495gvkqi65_m
    call SStruc_ary_slice9hx495gvkqi65_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructStencil_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_SStructStencil_t), intent(out) :: value
    external SStruct_ary_get7q_rxut1yh0bjd_m
    call SStruct_ary_get7q_rxut1yh0bjd_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_SStructStencil_t), intent(in) :: value
    external SStruct_ary_set7wk1u3npngjky5_m
    call SStruct_ary_set7wk1u3npngjky5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructStencil_7d), intent(in) :: src
    type(bHYPRE_SStructStencil_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyeiz6isz3c94_e_m
    dim = 7
    call SS_ary_smartCopyeiz6isz3c94_e_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_SStructStencil_7d), intent(in)  :: array
    external ary_isColumnOrder_1esedij7zs4_m
    call ary_isColumnOrder_1esedij7zs4_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_SStructStencil_7d), intent(in)  :: array
    external S_ary_isRowOrder8tgs6k6lvwg9p_m
    call S_ary_isRowOrder8tgs6k6lvwg9p_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_SStructStencil_7d), intent(in)  :: array
    external SStruc_ary_dimeno_f5imninobuu_m
    call SStruc_ary_dimeno_f5imninobuu_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_strideox9o3yho3xhkw_m
    call SStru_ary_strideox9o3yho3xhkw_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_qs19tnyev8sq_m
    call SStruc_ary_lower_qs19tnyev8sq_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper5vxx2vfhhmgxs_m
    call SStruc_ary_upper5vxx2vfhhmgxs_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthabv20jvdh5egd_m
    call SStru_ary_lengthabv20jvdh5egd_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_SStructSuxpbetjuie_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructStencil_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructSuxpbetjuie_p

  subroutine castbHYPRE_SStructSdxl9hcdry6_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructStencil_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructSdxl9hcdry6_p

  subroutine castbHYPRE_SStructS0ccqywmq76_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructStencil_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructS0ccqywmq76_p

  subroutine castbHYPRE_SStructS1ui5sv7qge_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructStencil_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructS1ui5sv7qge_p

  subroutine castbHYPRE_SStructSk0rmnfkcbk_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructStencil_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructSk0rmnfkcbk_p

  subroutine castbHYPRE_SStructS8atykk61q5_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructStencil_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructS8atykk61q5_p

  subroutine castbHYPRE_SStructS4j9b4ejxr1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructStencil_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructS4j9b4ejxr1_p


end module bHYPRE_SStructStencil_array
