! 
! File:          sidl_rmi_ConnectRegistry.F90
! Symbol:        sidl.rmi.ConnectRegistry-v0.9.15
! Symbol Type:   class
! Babel Version: 1.0.0
! Release:       $Name$
! Revision:      @(#) $Id$
! Description:   Client-side module for sidl.rmi.ConnectRegistry
! 
...
#include "sidl_rmi_ConnectRegistry_fAbbrev.h"
...
module sidl_rmi_ConnectRegistry

  use sidl
  use sidl_rmi_ConnectRegistry_type
  ...
  interface cast
    ...
    private :: registerConnect_s


  interface registerConnect
    module procedure registerConnect_s
  end interface
    private :: getConnect_s


  interface getConnect
    module procedure getConnect_s
  end interface
    private :: removeConnect_s


  interface removeConnect
    module procedure removeConnect_s
  end interface
    private :: newLocal_s, &
    newRemote_s
  ...
  interface sidl_rmi_ConnectRegistry__set_hooks_static
...
contains
  ...
  recursive subroutine registerConnect_s(key, func, exception)
    implicit none
    !  in string key
    character (len=*) , intent(in) :: key
    !  in opaque func
    integer (kind=sidl_opaque) , intent(in) :: func
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_ConnectRegistry_registerConnect_m
    call sidl_rmi_ConnectRegistry_registerConnect_m(key, func, exception)

  end subroutine registerConnect_s


  recursive subroutine getConnect_s(key, retval, exception)
    implicit none
    !  in string key
    character (len=*) , intent(in) :: key
    !  out opaque retval
    integer (kind=sidl_opaque) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_ConnectRegistry_getConnect_m
    call sidl_rmi_ConnectRegistry_getConnect_m(key, retval, exception)

  end subroutine getConnect_s


  recursive subroutine removeConnect_s(key, retval, exception)
    implicit none
    !  in string key
    character (len=*) , intent(in) :: key
    !  out opaque retval
    ...
    external sidl_rmi_ConnectRegistry_removeConnect_m
    call sidl_rmi_ConnectRegistry_removeConnect_m(key, retval, exception)

  end subroutine removeConnect_s


  recursive subroutine newLocal_s(retval, exception)
    implicit none
    !  out sidl.rmi.ConnectRegistry retval
    type(sidl_rmi_ConnectRegistry_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_ConnectRegistry_newLocal_m
    call sidl_rmi_ConnectRegistry_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(sidl_rmi_ConnectRegistry_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_ConnectRegistry_newRemote_m
    call sidl_rmi_ConnectRegistry_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external sidl_rmi_ConnectRegistry_rConnect_m
    call sidl_rmi_ConnectRegistry_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    implicit none
    !  in sidl.rmi.ConnectRegistry self
    type(sidl_rmi_ConnectRegistry_t) , intent(in) :: self
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_ConnectRegistry_addRef_m
    call sidl_rmi_ConnectRegistry_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_rmi_ConnectRegistry_deleteRef_m
    call sidl_rmi_ConnectRegistry_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_rmi_ConnectRegistry_isSame_m
    call sidl_rmi_ConnectRegistry_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_rmi_ConnectRegistry_isType_m
    call sidl_rmi_ConnectRegistry_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_rmi_ConnectRegistry_getClassInfo_m
    call sidl_rmi_ConnectRegistry_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from sidl.rmi.ConnectRegistry
  ! to sidl.BaseClass.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: oldType
  ...
  ! to sidl.rmi.ConnectRegistry.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseClass_t), intent(in) :: oldType
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_ConnectRegistry__cast_m

    call sidl_rmi_ConnectRegistry__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_rmi_ConnectRegistry__exec_m
    call sidl_rmi_ConnectRegistry__exec_m(self, methodName, inArgs, outArgs,   &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_rmi_ConnectRegistry__getURL_m
    call sidl_rmi_ConnectRegistry__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_rmi_ConnectRegistry__isRemote_m
    call sidl_rmi_ConnectRegistry__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_rmi_ConnectRegistry__isLocal_m
    call sidl_rmi_ConnectRegistry__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_rmi_ConnectRegistry__set_hooks_m
    call sidl_rmi_ConnectRegistry__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external sidl_rmi_ConnectRegistry__set_hooks_static_m
    call sidl_rmi_ConnectRegistry__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_rmi_ConnectRegistry

module sidl_rmi_ConnectRegistry_array
  use sidl
  use sidl_rmi_ConnectRegistry_type
  use sidl_array_type
  ...
  private :: &
    castsidl_rmi_Connecpyn4llori3_p, &
    castsidl_rmi_Connec3ouiywr0pl_p, &
    castsidl_rmi_Connecjhhlxcdqa__p, &
    castsidl_rmi_Connecm7w3k9kdwj_p, &
    castsidl_rmi_Connecq0ek_v4u1b_p, &
    castsidl_rmi_Connecph2eq6b88b_p, &
    castsidl_rmi_Connecrupccq2wq4_p
interface cast
  module procedure &
    castsidl_rmi_Connecpyn4llori3_p, &
    castsidl_rmi_Connec3ouiywr0pl_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_1d), intent(out) :: array
    external Co_ary_createColhzy43zj0eso8s_m
    call Co_ary_createColhzy43zj0eso8s_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_rmi_ConnectRegistry_1d), intent(out) :: array
    external Co_ary_createRowyu9fp8qoeke2y_m
    call Co_ary_createRowyu9fp8qoeke2y_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_rmi_ConnectRegistry_1d), intent(out) :: array
    external Con_ary_create1dx36mxvgwi7x_p_m
    call Con_ary_create1dx36mxvgwi7x_p_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_rmi_ConnectRegistry_1d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_1d), intent(in) :: dest
    external Connect_ary_copye_rdye57fmmay_m
    call Connect_ary_copye_rdye57fmmay_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: src
    type(sidl_rmi_ConnectRegistry_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Conne_ary_ensurehvkhqugpfkk99_m
    call Conne_ary_ensurehvkhqugpfkk99_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Connec_ary_sliceg_8z10oijgtzx_m
    call Connec_ary_sliceg_8z10oijgtzx_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: value
    external ConnectR_ary_get5vkcn4zsxjtkh_m
    call ConnectR_ary_get5vkcn4zsxjtkh_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: value
    external ConnectR_ary_set7_o29p66zrljl_m
    call ConnectR_ary_set7_o29p66zrljl_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: value
    external Connect_ary_get1que5__a08cim6_m
    call Connect_ary_get1que5__a08cim6_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: value
    external Connect_ary_set187i4zksrterbj_m
    call Connect_ary_set187i4zksrterbj_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_rmi_ConnectRegistry_1d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopy5jpifd0zrmamz_m
    dim = 1
    call Co_ary_smartCopy5jpifd0zrmamz_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    external ary_isColumnOrderb1ylisqohc9t_m
    call ary_isColumnOrderb1ylisqohc9t_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    external C_ary_isRowOrdero7ale2xrfhatu_m
    call C_ary_isRowOrdero7ale2xrfhatu_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    external Connec_ary_dimeng4ss8lm4n3so7_m
    call Connec_ary_dimeng4ss8lm4n3so7_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_stride3d1xxevpxbv1v_m
    call Conne_ary_stride3d1xxevpxbv1v_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_lower9zxhnmlohsdbq_m
    call Connec_ary_lower9zxhnmlohsdbq_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_upperl1xthehwhzuoz_m
    call Connec_ary_upperl1xthehwhzuoz_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_lengthg5f0sbi1qc1lf_m
    call Conne_ary_lengthg5f0sbi1qc1lf_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    external Conne_ary_addRef04r68in_xw62b_m
    call Conne_ary_addRef04r68in_xw62b_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_rmi_ConnectRegistry_1d), intent(in)  :: array
    external Co_ary_deleteRefs0da_b1ax_fel_m
    call Co_ary_deleteRefs0da_b1ax_fel_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_2d), intent(out) :: array
    external Co_ary_createColhzy43zj0eso8s_m
    call Co_ary_createColhzy43zj0eso8s_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_2d), intent(out) :: array
    external Co_ary_createRowyu9fp8qoeke2y_m
    call Co_ary_createRowyu9fp8qoeke2y_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_ConnectRegistry_2d), intent(out) :: array
    external ary_create2dCol12jjbc7zrjdb8a_m
    call ary_create2dCol12jjbc7zrjdb8a_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_ConnectRegistry_2d), intent(out) :: array
    external ary_create2dRowl_8c0ji02ibxy0_m
    call ary_create2dRowl_8c0ji02ibxy0_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_rmi_ConnectRegistry_2d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_2d), intent(in) :: dest
    external Connect_ary_copye_rdye57fmmay_m
    call Connect_ary_copye_rdye57fmmay_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_rmi_ConnectRegistry_2d), intent(in)  :: src
    type(sidl_rmi_ConnectRegistry_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Conne_ary_ensurehvkhqugpfkk99_m
    call Conne_ary_ensurehvkhqugpfkk99_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Connec_ary_sliceg_8z10oijgtzx_m
    call Connec_ary_sliceg_8z10oijgtzx_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_rmi_ConnectRegistry_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: value
    external Connect_ary_get2zr_1kcihsggis_m
    call Connect_ary_get2zr_1kcihsggis_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: value
    external Connect_ary_set2s3g_baftaca12_m
    call Connect_ary_set2s3g_baftaca12_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_rmi_ConnectRegistry_2d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopy5jpifd0zrmamz_m
    dim = 2
    call Co_ary_smartCopy5jpifd0zrmamz_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_rmi_ConnectRegistry_2d), intent(in)  :: array
    external ary_isColumnOrderb1ylisqohc9t_m
    call ary_isColumnOrderb1ylisqohc9t_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_rmi_ConnectRegistry_2d), intent(in)  :: array
    external C_ary_isRowOrdero7ale2xrfhatu_m
    call C_ary_isRowOrdero7ale2xrfhatu_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_rmi_ConnectRegistry_2d), intent(in)  :: array
    external Connec_ary_dimeng4ss8lm4n3so7_m
    call Connec_ary_dimeng4ss8lm4n3so7_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_stride3d1xxevpxbv1v_m
    call Conne_ary_stride3d1xxevpxbv1v_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_lower9zxhnmlohsdbq_m
    call Connec_ary_lower9zxhnmlohsdbq_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_upperl1xthehwhzuoz_m
    call Connec_ary_upperl1xthehwhzuoz_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_lengthg5f0sbi1qc1lf_m
    call Conne_ary_lengthg5f0sbi1qc1lf_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_3d), intent(out) :: array
    external Co_ary_createColhzy43zj0eso8s_m
    call Co_ary_createColhzy43zj0eso8s_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_3d), intent(out) :: array
    external Co_ary_createRowyu9fp8qoeke2y_m
    call Co_ary_createRowyu9fp8qoeke2y_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_rmi_ConnectRegistry_3d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_3d), intent(in) :: dest
    external Connect_ary_copye_rdye57fmmay_m
    call Connect_ary_copye_rdye57fmmay_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_rmi_ConnectRegistry_3d), intent(in)  :: src
    type(sidl_rmi_ConnectRegistry_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Conne_ary_ensurehvkhqugpfkk99_m
    call Conne_ary_ensurehvkhqugpfkk99_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Connec_ary_sliceg_8z10oijgtzx_m
    call Connec_ary_sliceg_8z10oijgtzx_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_rmi_ConnectRegistry_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: value
    external Connect_ary_get31v2umj0a5kudi_m
    call Connect_ary_get31v2umj0a5kudi_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: value
    external Connect_ary_set3zgkesnxlk_3dd_m
    call Connect_ary_set3zgkesnxlk_3dd_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_rmi_ConnectRegistry_3d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopy5jpifd0zrmamz_m
    dim = 3
    call Co_ary_smartCopy5jpifd0zrmamz_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_rmi_ConnectRegistry_3d), intent(in)  :: array
    external ary_isColumnOrderb1ylisqohc9t_m
    call ary_isColumnOrderb1ylisqohc9t_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_rmi_ConnectRegistry_3d), intent(in)  :: array
    external C_ary_isRowOrdero7ale2xrfhatu_m
    call C_ary_isRowOrdero7ale2xrfhatu_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_rmi_ConnectRegistry_3d), intent(in)  :: array
    external Connec_ary_dimeng4ss8lm4n3so7_m
    call Connec_ary_dimeng4ss8lm4n3so7_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_stride3d1xxevpxbv1v_m
    call Conne_ary_stride3d1xxevpxbv1v_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_lower9zxhnmlohsdbq_m
    call Connec_ary_lower9zxhnmlohsdbq_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_upperl1xthehwhzuoz_m
    call Connec_ary_upperl1xthehwhzuoz_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_lengthg5f0sbi1qc1lf_m
    call Conne_ary_lengthg5f0sbi1qc1lf_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_4d), intent(out) :: array
    external Co_ary_createColhzy43zj0eso8s_m
    call Co_ary_createColhzy43zj0eso8s_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_4d), intent(out) :: array
    external Co_ary_createRowyu9fp8qoeke2y_m
    call Co_ary_createRowyu9fp8qoeke2y_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_rmi_ConnectRegistry_4d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_4d), intent(in) :: dest
    external Connect_ary_copye_rdye57fmmay_m
    call Connect_ary_copye_rdye57fmmay_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_rmi_ConnectRegistry_4d), intent(in)  :: src
    type(sidl_rmi_ConnectRegistry_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Conne_ary_ensurehvkhqugpfkk99_m
    call Conne_ary_ensurehvkhqugpfkk99_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Connec_ary_sliceg_8z10oijgtzx_m
    call Connec_ary_sliceg_8z10oijgtzx_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_rmi_ConnectRegistry_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: value
    external Connect_ary_get4m3ljqvru1hdjt_m
    call Connect_ary_get4m3ljqvru1hdjt_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: value
    external Connect_ary_set4s_i9vtd9cv09__m
    call Connect_ary_set4s_i9vtd9cv09__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_rmi_ConnectRegistry_4d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopy5jpifd0zrmamz_m
    dim = 4
    call Co_ary_smartCopy5jpifd0zrmamz_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_rmi_ConnectRegistry_4d), intent(in)  :: array
    external ary_isColumnOrderb1ylisqohc9t_m
    call ary_isColumnOrderb1ylisqohc9t_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_rmi_ConnectRegistry_4d), intent(in)  :: array
    external C_ary_isRowOrdero7ale2xrfhatu_m
    call C_ary_isRowOrdero7ale2xrfhatu_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_rmi_ConnectRegistry_4d), intent(in)  :: array
    external Connec_ary_dimeng4ss8lm4n3so7_m
    call Connec_ary_dimeng4ss8lm4n3so7_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_stride3d1xxevpxbv1v_m
    call Conne_ary_stride3d1xxevpxbv1v_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_lower9zxhnmlohsdbq_m
    call Connec_ary_lower9zxhnmlohsdbq_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_upperl1xthehwhzuoz_m
    call Connec_ary_upperl1xthehwhzuoz_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_lengthg5f0sbi1qc1lf_m
    call Conne_ary_lengthg5f0sbi1qc1lf_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_5d), intent(out) :: array
    external Co_ary_createColhzy43zj0eso8s_m
    call Co_ary_createColhzy43zj0eso8s_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_5d), intent(out) :: array
    external Co_ary_createRowyu9fp8qoeke2y_m
    call Co_ary_createRowyu9fp8qoeke2y_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_rmi_ConnectRegistry_5d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_5d), intent(in) :: dest
    external Connect_ary_copye_rdye57fmmay_m
    call Connect_ary_copye_rdye57fmmay_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_rmi_ConnectRegistry_5d), intent(in)  :: src
    type(sidl_rmi_ConnectRegistry_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Conne_ary_ensurehvkhqugpfkk99_m
    call Conne_ary_ensurehvkhqugpfkk99_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Connec_ary_sliceg_8z10oijgtzx_m
    call Connec_ary_sliceg_8z10oijgtzx_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_rmi_ConnectRegistry_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: value
    external Connect_ary_get508ftgnxrmv1r7_m
    call Connect_ary_get508ftgnxrmv1r7_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: value
    external Connect_ary_set5gqwent_tfz43c_m
    call Connect_ary_set5gqwent_tfz43c_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_rmi_ConnectRegistry_5d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopy5jpifd0zrmamz_m
    dim = 5
    call Co_ary_smartCopy5jpifd0zrmamz_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_rmi_ConnectRegistry_5d), intent(in)  :: array
    external ary_isColumnOrderb1ylisqohc9t_m
    call ary_isColumnOrderb1ylisqohc9t_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_rmi_ConnectRegistry_5d), intent(in)  :: array
    external C_ary_isRowOrdero7ale2xrfhatu_m
    call C_ary_isRowOrdero7ale2xrfhatu_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_rmi_ConnectRegistry_5d), intent(in)  :: array
    external Connec_ary_dimeng4ss8lm4n3so7_m
    call Connec_ary_dimeng4ss8lm4n3so7_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_stride3d1xxevpxbv1v_m
    call Conne_ary_stride3d1xxevpxbv1v_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_lower9zxhnmlohsdbq_m
    call Connec_ary_lower9zxhnmlohsdbq_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_upperl1xthehwhzuoz_m
    call Connec_ary_upperl1xthehwhzuoz_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_lengthg5f0sbi1qc1lf_m
    call Conne_ary_lengthg5f0sbi1qc1lf_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_6d), intent(out) :: array
    external Co_ary_createColhzy43zj0eso8s_m
    call Co_ary_createColhzy43zj0eso8s_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_6d), intent(out) :: array
    external Co_ary_createRowyu9fp8qoeke2y_m
    call Co_ary_createRowyu9fp8qoeke2y_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_rmi_ConnectRegistry_6d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_6d), intent(in) :: dest
    external Connect_ary_copye_rdye57fmmay_m
    call Connect_ary_copye_rdye57fmmay_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_rmi_ConnectRegistry_6d), intent(in)  :: src
    type(sidl_rmi_ConnectRegistry_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Conne_ary_ensurehvkhqugpfkk99_m
    call Conne_ary_ensurehvkhqugpfkk99_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Connec_ary_sliceg_8z10oijgtzx_m
    call Connec_ary_sliceg_8z10oijgtzx_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_rmi_ConnectRegistry_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: value
    external Connect_ary_get64w3w59t_x94gx_m
    call Connect_ary_get64w3w59t_x94gx_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: value
    external Connect_ary_set6phmgw3u9pxg07_m
    call Connect_ary_set6phmgw3u9pxg07_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_rmi_ConnectRegistry_6d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopy5jpifd0zrmamz_m
    dim = 6
    call Co_ary_smartCopy5jpifd0zrmamz_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_rmi_ConnectRegistry_6d), intent(in)  :: array
    external ary_isColumnOrderb1ylisqohc9t_m
    call ary_isColumnOrderb1ylisqohc9t_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_rmi_ConnectRegistry_6d), intent(in)  :: array
    external C_ary_isRowOrdero7ale2xrfhatu_m
    call C_ary_isRowOrdero7ale2xrfhatu_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_rmi_ConnectRegistry_6d), intent(in)  :: array
    external Connec_ary_dimeng4ss8lm4n3so7_m
    call Connec_ary_dimeng4ss8lm4n3so7_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_stride3d1xxevpxbv1v_m
    call Conne_ary_stride3d1xxevpxbv1v_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_lower9zxhnmlohsdbq_m
    call Connec_ary_lower9zxhnmlohsdbq_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_upperl1xthehwhzuoz_m
    call Connec_ary_upperl1xthehwhzuoz_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_lengthg5f0sbi1qc1lf_m
    call Conne_ary_lengthg5f0sbi1qc1lf_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_7d), intent(out) :: array
    external Co_ary_createColhzy43zj0eso8s_m
    call Co_ary_createColhzy43zj0eso8s_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_rmi_ConnectRegistry_7d), intent(out) :: array
    external Co_ary_createRowyu9fp8qoeke2y_m
    call Co_ary_createRowyu9fp8qoeke2y_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_rmi_ConnectRegistry_7d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_7d), intent(in) :: dest
    external Connect_ary_copye_rdye57fmmay_m
    call Connect_ary_copye_rdye57fmmay_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_rmi_ConnectRegistry_7d), intent(in)  :: src
    type(sidl_rmi_ConnectRegistry_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Conne_ary_ensurehvkhqugpfkk99_m
    call Conne_ary_ensurehvkhqugpfkk99_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Connec_ary_sliceg_8z10oijgtzx_m
    call Connec_ary_sliceg_8z10oijgtzx_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_rmi_ConnectRegistry_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_rmi_ConnectRegistry_t), intent(out) :: value
    external Connect_ary_get7ec55dgl9hvfcp_m
    call Connect_ary_get7ec55dgl9hvfcp_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_rmi_ConnectRegistry_t), intent(in) :: value
    external Connect_ary_set776xrn760h5g96_m
    call Connect_ary_set776xrn760h5g96_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_rmi_ConnectRegistry_7d), intent(in) :: src
    type(sidl_rmi_ConnectRegistry_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopy5jpifd0zrmamz_m
    dim = 7
    call Co_ary_smartCopy5jpifd0zrmamz_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_rmi_ConnectRegistry_7d), intent(in)  :: array
    external ary_isColumnOrderb1ylisqohc9t_m
    call ary_isColumnOrderb1ylisqohc9t_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_rmi_ConnectRegistry_7d), intent(in)  :: array
    external C_ary_isRowOrdero7ale2xrfhatu_m
    call C_ary_isRowOrdero7ale2xrfhatu_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_rmi_ConnectRegistry_7d), intent(in)  :: array
    external Connec_ary_dimeng4ss8lm4n3so7_m
    call Connec_ary_dimeng4ss8lm4n3so7_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_stride3d1xxevpxbv1v_m
    call Conne_ary_stride3d1xxevpxbv1v_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_lower9zxhnmlohsdbq_m
    call Connec_ary_lower9zxhnmlohsdbq_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Connec_ary_upperl1xthehwhzuoz_m
    call Connec_ary_upperl1xthehwhzuoz_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Conne_ary_lengthg5f0sbi1qc1lf_m
    call Conne_ary_lengthg5f0sbi1qc1lf_m(array, index, length7_p)
  ...
  subroutine castsidl_rmi_Connecpyn4llori3_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ConnectRegistry_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Connecpyn4llori3_p

  subroutine castsidl_rmi_Connec3ouiywr0pl_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ConnectRegistry_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Connec3ouiywr0pl_p

  subroutine castsidl_rmi_Connecjhhlxcdqa__p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ConnectRegistry_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Connecjhhlxcdqa__p

  subroutine castsidl_rmi_Connecm7w3k9kdwj_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ConnectRegistry_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Connecm7w3k9kdwj_p

  subroutine castsidl_rmi_Connecq0ek_v4u1b_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ConnectRegistry_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Connecq0ek_v4u1b_p

  subroutine castsidl_rmi_Connecph2eq6b88b_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ConnectRegistry_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Connecph2eq6b88b_p

  subroutine castsidl_rmi_Connecrupccq2wq4_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_ConnectRegistry_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Connecrupccq2wq4_p


end module sidl_rmi_ConnectRegistry_array
