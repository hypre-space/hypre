! 
! File:          bHYPRE_SStructVariable.F90
! Symbol:        bHYPRE.SStructVariable-v1.0.0
! Symbol Type:   enumeration
! Babel Version: 1.0.0
! Description:   Client-side module for bHYPRE.SStructVariable
! 
! WARNING: Automatically generated; changes will be lost
! 


module bHYPRE_SStructVariable
! 
...
! 
  ...
  use sidl
  integer (kind=sidl_enum), parameter :: UNDEFINED = -1

  integer (kind=sidl_enum), parameter :: CELL = 0

  integer (kind=sidl_enum), parameter :: NODE = 1

  integer (kind=sidl_enum), parameter :: XFACE = 2

  integer (kind=sidl_enum), parameter :: YFACE = 3

  integer (kind=sidl_enum), parameter :: ZFACE = 4

  integer (kind=sidl_enum), parameter :: XEDGE = 5

  integer (kind=sidl_enum), parameter :: YEDGE = 6

  integer (kind=sidl_enum), parameter :: ZEDGE = 7

end module bHYPRE_SStructVariable

module bHYPRE_SStructVariable_array
  use sidl
  use bHYPRE_SStructVariable_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructV3eep4mf_23_p, &
    castbHYPRE_SStructVeylo_e_nno_p, &
    castbHYPRE_SStructVfbi3jt1vzj_p, &
    castbHYPRE_SStructVupo6a8o5x1_p, &
    castbHYPRE_SStructVcbsyn_kvbo_p, &
    castbHYPRE_SStructV3ersklumy__p, &
    castbHYPRE_SStructVait9v60bv5_p
interface cast
  module procedure &
    castbHYPRE_SStructV3eep4mf_23_p, &
    castbHYPRE_SStructVeylo_e_nno_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVariable_1d), intent(out) :: array
  ...
  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructVariable_1d), intent(in) :: src
    type(bHYPRE_SStructVariable_1d), intent(in) :: dest
  ...
  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructVariable_1d), intent(in)  :: src
    type(bHYPRE_SStructVariable_1d), intent(out) :: result
  ...
  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructVariable_1d), intent(in)  :: array
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructVariable_1d), intent(in) :: src
    type(bHYPRE_SStructVariable_1d), intent(out) :: dest
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVariable_2d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructVariable_2d), intent(in) :: src
    type(bHYPRE_SStructVariable_2d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructVariable_2d), intent(in)  :: src
    type(bHYPRE_SStructVariable_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructVariable_2d), intent(in)  :: array
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructVariable_2d), intent(in) :: src
    type(bHYPRE_SStructVariable_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 2
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVariable_3d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructVariable_3d), intent(in) :: src
    type(bHYPRE_SStructVariable_3d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructVariable_3d), intent(in)  :: src
    type(bHYPRE_SStructVariable_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructVariable_3d), intent(in)  :: array
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructVariable_3d), intent(in) :: src
    type(bHYPRE_SStructVariable_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 3
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVariable_4d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructVariable_4d), intent(in) :: src
    type(bHYPRE_SStructVariable_4d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructVariable_4d), intent(in)  :: src
    type(bHYPRE_SStructVariable_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructVariable_4d), intent(in)  :: array
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructVariable_4d), intent(in) :: src
    type(bHYPRE_SStructVariable_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 4
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVariable_5d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructVariable_5d), intent(in) :: src
    type(bHYPRE_SStructVariable_5d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructVariable_5d), intent(in)  :: src
    type(bHYPRE_SStructVariable_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructVariable_5d), intent(in)  :: array
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructVariable_5d), intent(in) :: src
    type(bHYPRE_SStructVariable_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 5
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVariable_6d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructVariable_6d), intent(in) :: src
    type(bHYPRE_SStructVariable_6d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructVariable_6d), intent(in)  :: src
    type(bHYPRE_SStructVariable_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructVariable_6d), intent(in)  :: array
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructVariable_6d), intent(in) :: src
    type(bHYPRE_SStructVariable_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 6
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVariable_7d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructVariable_7d), intent(in) :: src
    type(bHYPRE_SStructVariable_7d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructVariable_7d), intent(in)  :: src
    type(bHYPRE_SStructVariable_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructVariable_7d), intent(in)  :: array
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructVariable_7d), intent(in) :: src
    type(bHYPRE_SStructVariable_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 7
  ...
  subroutine castbHYPRE_SStructV3eep4mf_23_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVariable_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructV3eep4mf_23_p

  subroutine castbHYPRE_SStructVeylo_e_nno_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVariable_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVeylo_e_nno_p

  subroutine castbHYPRE_SStructVfbi3jt1vzj_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVariable_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVfbi3jt1vzj_p

  subroutine castbHYPRE_SStructVupo6a8o5x1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVariable_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVupo6a8o5x1_p

  subroutine castbHYPRE_SStructVcbsyn_kvbo_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVariable_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVcbsyn_kvbo_p

  subroutine castbHYPRE_SStructV3ersklumy__p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVariable_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructV3ersklumy__p

  subroutine castbHYPRE_SStructVait9v60bv5_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVariable_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVait9v60bv5_p


end module bHYPRE_SStructVariable_array
