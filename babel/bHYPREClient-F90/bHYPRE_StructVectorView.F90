! 
! File:          bHYPRE_StructVectorView.F90
...
module bHYPRE_StructVectorView

  use sidl
  use bHYPRE_StructGrid_type
  use bHYPRE_StructVectorView_type
  ...
  interface SetGrid
    ...
    private :: SetNumGhost_1s, &
    SetNumGhost_2s


  interface SetNumGhost
    module procedure SetNumGhost_1s, &
    SetNumGhost_2s
  end interface
    private :: SetValue_1s, &
    SetValue_2s
...
contains
  ...
  recursive subroutine SetGrid_s(self, grid, retval, exception)
    implicit none
    !  in bHYPRE.StructVectorView self
    type(bHYPRE_StructVectorView_t) , intent(in) :: self
    !  in bHYPRE.StructGrid grid
    type(bHYPRE_StructGrid_t) , intent(in) :: grid
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructVectorView_SetGrid_m
    call bHYPRE_StructVectorView_SetGrid_m(self, grid, retval, exception)

  end subroutine SetGrid_s


  recursive subroutine SetNumGhost_1s(self, num_ghost, retval, exception)
    implicit none
    !  in bHYPRE.StructVectorView self
    type(bHYPRE_StructVectorView_t) , intent(in) :: self
    !  in array<int,column-major> num_ghost
    type(sidl_int_1d) , intent(in) :: num_ghost
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructVectorView_SetNumGhost_a
    call bHYPRE_StructVectorView_SetNumGhost_a(self, num_ghost, retval,        &
      exception)

  end subroutine SetNumGhost_1s

  recursive subroutine SetNumGhost_2s(self, num_ghost, retval, exception)
    implicit none
    !  in bHYPRE.StructVectorView self
    type(bHYPRE_StructVectorView_t) , intent(in) :: self
    !  in rarray<int> num_ghost(dim2)
    integer (kind=sidl_int) , intent(in), dimension(:) :: num_ghost
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception
    !  in int dim2
    integer (kind=sidl_int) :: dim2

    external bHYPRE_StructVectorView_SetNumGhost_m
    dim2 = size(num_ghost, 1)
    call bHYPRE_StructVectorView_SetNumGhost_m(self, num_ghost, dim2, retval,  &
      exception)

  end subroutine SetNumGhost_2s


  recursive subroutine SetValue_1s(self, grid_index, value, retval, exception)
    implicit none
    !  in bHYPRE.StructVectorView self
    type(bHYPRE_StructVectorView_t) , intent(in) :: self
    !  in array<int,column-major> grid_index
    type(sidl_int_1d) , intent(in) :: grid_index
    !  in double value
    ...
    external bHYPRE_StructVectorView_SetValue_a
    call bHYPRE_StructVectorView_SetValue_a(self, grid_index, value, retval,   &
      exception)

  end subroutine SetValue_1s

  recursive subroutine SetValue_2s(self, grid_index, value, retval, exception)
    implicit none
    !  in bHYPRE.StructVectorView self
    type(bHYPRE_StructVectorView_t) , intent(in) :: self
    !  in rarray<int> grid_index(dim)
    integer (kind=sidl_int) , intent(in), dimension(:) :: grid_index
    !  in double value
    real (kind=sidl_double) , intent(in) :: value
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    ...
    external bHYPRE_StructVectorView_SetValue_m
    dim = size(grid_index, 1)
    call bHYPRE_StructVectorView_SetValue_m(self, grid_index, dim, value,      &
      retval, exception)

  end subroutine SetValue_2s


  recursive subroutine SetBoxValues_1s(self, ilower, iupper, values, retval,   &
    exception)
    implicit none
    !  in bHYPRE.StructVectorView self
    type(bHYPRE_StructVectorView_t) , intent(in) :: self
    ...
    external bHYPRE_StructVectorView_SetBoxValues_a
    call bHYPRE_StructVectorView_SetBoxValues_a(self, ilower, iupper, values,  &
      retval, exception)

  end subroutine SetBoxValues_1s

  recursive subroutine SetBoxValues_2s(self, ilower, iupper, values, retval,   &
    exception)
    implicit none
    !  in bHYPRE.StructVectorView self
    type(bHYPRE_StructVectorView_t) , intent(in) :: self
    ...
    external bHYPRE_StructVectorView_SetBoxValues_m
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_StructVectorView_SetBoxValues_m(self, ilower, iupper, dim,     &
      values, nvalues, retval, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    type(bHYPRE_StructVectorView_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructVectorView_rConnect_m
    call bHYPRE_StructVectorView_rConnect_m(self, url, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_StructVectorView_SetCommunicator_m
    call bHYPRE_StructVectorView_SetCommunicator_m(self, mpi_comm, retval,     &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_StructVectorView_Destroy_m
    call bHYPRE_StructVectorView_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_StructVectorView_Initialize_m
    call bHYPRE_StructVectorView_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_StructVectorView_Assemble_m
    call bHYPRE_StructVectorView_Assemble_m(self, retval, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_StructVectorView_addRef_m
    call bHYPRE_StructVectorView_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_StructVectorView_deleteRef_m
    call bHYPRE_StructVectorView_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_StructVectorView_isSame_m
    call bHYPRE_StructVectorView_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_StructVectorView_isType_m
    call bHYPRE_StructVectorView_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_StructVectorView_getClassInfo_m
    call bHYPRE_StructVectorView_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.StructVectorView
  ! to bHYPRE.MatrixVectorView.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_StructVectorView_t), intent(in) :: oldType
  ...
  ! to bHYPRE.StructVectorView.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_MatrixVectorView_t), intent(in) :: oldType
    type(bHYPRE_StructVectorView_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_StructVectorView__cast_m

    call bHYPRE_StructVectorView__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_StructVectorView__exec_m
    call bHYPRE_StructVectorView__exec_m(self, methodName, inArgs, outArgs,    &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_StructVectorView__getURL_m
    call bHYPRE_StructVectorView__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_StructVectorView__isRemote_m
    call bHYPRE_StructVectorView__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_StructVectorView__isLocal_m
    call bHYPRE_StructVectorView__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_StructVectorView__set_hooks_m
    call bHYPRE_StructVectorView__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_StructVectorView_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_StructVectorView_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_StructVectorView

module bHYPRE_StructVectorView_array
  use sidl
  use bHYPRE_StructVectorView_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_StructVe3z0yx58u7n_p, &
    castbHYPRE_StructVejn6lc3_sb__p, &
    castbHYPRE_StructVepudcst5dnj_p, &
    castbHYPRE_StructVeyqcuks0qm8_p, &
    castbHYPRE_StructVevqhsp_m44b_p, &
    castbHYPRE_StructVeceq0k1xqv1_p, &
    castbHYPRE_StructVefxbv7vvq9b_p
interface cast
  module procedure &
    castbHYPRE_StructVe3z0yx58u7n_p, &
    castbHYPRE_StructVejn6lc3_sb__p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_1d), intent(out) :: array
    external St_ary_createCols65rq1zjo9jvj_m
    call St_ary_createCols65rq1zjo9jvj_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_StructVectorView_1d), intent(out) :: array
    external St_ary_createRow3ssb3e7zwhai1_m
    call St_ary_createRow3ssb3e7zwhai1_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_StructVectorView_1d), intent(out) :: array
    external Str_ary_create1d7ftvxne2spogh_m
    call Str_ary_create1d7ftvxne2spogh_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_StructVectorView_1d), intent(in) :: src
    type(bHYPRE_StructVectorView_1d), intent(in) :: dest
    external StructV_ary_copy_nbwdyyr7qf1p_m
    call StructV_ary_copy_nbwdyyr7qf1p_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: src
    type(bHYPRE_StructVectorView_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurebbwzwexg57qdc_m
    call Struc_ary_ensurebbwzwexg57qdc_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Struct_ary_slice7xgwtvbsoxm9e_m
    call Struct_ary_slice7xgwtvbsoxm9e_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructVectorView_t), intent(out) :: value
    external StructVe_ary_get1pvz4wt7sp1be_m
    call StructVe_ary_get1pvz4wt7sp1be_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructVectorView_t), intent(in) :: value
    external StructVe_ary_settiq1rz2yx23w9_m
    call StructVe_ary_settiq1rz2yx23w9_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_StructVectorView_t), intent(out) :: value
    external StructV_ary_get1cjpidsquqcxw4_m
    call StructV_ary_get1cjpidsquqcxw4_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_StructVectorView_t), intent(in) :: value
    external StructV_ary_set1x26cw4hhqqbz__m
    call StructV_ary_set1x26cw4hhqqbz__m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_StructVectorView_1d), intent(in) :: src
    type(bHYPRE_StructVectorView_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyhmrwxa3zdym98_m
    dim = 1
    call St_ary_smartCopyhmrwxa3zdym98_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    external ary_isColumnOrderpcjkeunykpej_m
    call ary_isColumnOrderpcjkeunykpej_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    external S_ary_isRowOrder64136sgbuy8us_m
    call S_ary_isRowOrder64136sgbuy8us_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    external Struct_ary_dimen6newi8h4nhiq3_m
    call Struct_ary_dimen6newi8h4nhiq3_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridep_5y0s_jnw1ua_m
    call Struc_ary_stridep_5y0s_jnw1ua_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerla4a3qi0n0rn9_m
    call Struct_ary_lowerla4a3qi0n0rn9_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppero1nvko89rs0_e_m
    call Struct_ary_uppero1nvko89rs0_e_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthikhwsv0zlfjy4_m
    call Struc_ary_lengthikhwsv0zlfjy4_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    external Struc_ary_addRefr28anfng1gr7j_m
    call Struc_ary_addRefr28anfng1gr7j_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_StructVectorView_1d), intent(in)  :: array
    external St_ary_deleteRefka0yyxh6r4jhr_m
    call St_ary_deleteRefka0yyxh6r4jhr_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_2d), intent(out) :: array
    external St_ary_createCols65rq1zjo9jvj_m
    call St_ary_createCols65rq1zjo9jvj_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_2d), intent(out) :: array
    external St_ary_createRow3ssb3e7zwhai1_m
    call St_ary_createRow3ssb3e7zwhai1_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructVectorView_2d), intent(out) :: array
    external ary_create2dCologzi3jt6mh70xd_m
    call ary_create2dCologzi3jt6mh70xd_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructVectorView_2d), intent(out) :: array
    external ary_create2dRowhcns8zjw6z1el4_m
    call ary_create2dRowhcns8zjw6z1el4_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_StructVectorView_2d), intent(in) :: src
    type(bHYPRE_StructVectorView_2d), intent(in) :: dest
    external StructV_ary_copy_nbwdyyr7qf1p_m
    call StructV_ary_copy_nbwdyyr7qf1p_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_StructVectorView_2d), intent(in)  :: src
    type(bHYPRE_StructVectorView_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurebbwzwexg57qdc_m
    call Struc_ary_ensurebbwzwexg57qdc_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice7xgwtvbsoxm9e_m
    call Struct_ary_slice7xgwtvbsoxm9e_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_StructVectorView_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_StructVectorView_t), intent(out) :: value
    external StructV_ary_get2cndem1n36hfwx_m
    call StructV_ary_get2cndem1n36hfwx_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_StructVectorView_t), intent(in) :: value
    external StructV_ary_set2qzr14rl7ab0ma_m
    call StructV_ary_set2qzr14rl7ab0ma_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_StructVectorView_2d), intent(in) :: src
    type(bHYPRE_StructVectorView_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyhmrwxa3zdym98_m
    dim = 2
    call St_ary_smartCopyhmrwxa3zdym98_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_StructVectorView_2d), intent(in)  :: array
    external ary_isColumnOrderpcjkeunykpej_m
    call ary_isColumnOrderpcjkeunykpej_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_StructVectorView_2d), intent(in)  :: array
    external S_ary_isRowOrder64136sgbuy8us_m
    call S_ary_isRowOrder64136sgbuy8us_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_StructVectorView_2d), intent(in)  :: array
    external Struct_ary_dimen6newi8h4nhiq3_m
    call Struct_ary_dimen6newi8h4nhiq3_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridep_5y0s_jnw1ua_m
    call Struc_ary_stridep_5y0s_jnw1ua_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerla4a3qi0n0rn9_m
    call Struct_ary_lowerla4a3qi0n0rn9_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppero1nvko89rs0_e_m
    call Struct_ary_uppero1nvko89rs0_e_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthikhwsv0zlfjy4_m
    call Struc_ary_lengthikhwsv0zlfjy4_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_3d), intent(out) :: array
    external St_ary_createCols65rq1zjo9jvj_m
    call St_ary_createCols65rq1zjo9jvj_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_3d), intent(out) :: array
    external St_ary_createRow3ssb3e7zwhai1_m
    call St_ary_createRow3ssb3e7zwhai1_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_StructVectorView_3d), intent(in) :: src
    type(bHYPRE_StructVectorView_3d), intent(in) :: dest
    external StructV_ary_copy_nbwdyyr7qf1p_m
    call StructV_ary_copy_nbwdyyr7qf1p_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_StructVectorView_3d), intent(in)  :: src
    type(bHYPRE_StructVectorView_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurebbwzwexg57qdc_m
    call Struc_ary_ensurebbwzwexg57qdc_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice7xgwtvbsoxm9e_m
    call Struct_ary_slice7xgwtvbsoxm9e_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_StructVectorView_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_StructVectorView_t), intent(out) :: value
    external StructV_ary_get38k_g4j2wdgo6b_m
    call StructV_ary_get38k_g4j2wdgo6b_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_StructVectorView_t), intent(in) :: value
    external StructV_ary_set3t2e8bdlw1lto3_m
    call StructV_ary_set3t2e8bdlw1lto3_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_StructVectorView_3d), intent(in) :: src
    type(bHYPRE_StructVectorView_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyhmrwxa3zdym98_m
    dim = 3
    call St_ary_smartCopyhmrwxa3zdym98_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_StructVectorView_3d), intent(in)  :: array
    external ary_isColumnOrderpcjkeunykpej_m
    call ary_isColumnOrderpcjkeunykpej_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_StructVectorView_3d), intent(in)  :: array
    external S_ary_isRowOrder64136sgbuy8us_m
    call S_ary_isRowOrder64136sgbuy8us_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_StructVectorView_3d), intent(in)  :: array
    external Struct_ary_dimen6newi8h4nhiq3_m
    call Struct_ary_dimen6newi8h4nhiq3_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridep_5y0s_jnw1ua_m
    call Struc_ary_stridep_5y0s_jnw1ua_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerla4a3qi0n0rn9_m
    call Struct_ary_lowerla4a3qi0n0rn9_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppero1nvko89rs0_e_m
    call Struct_ary_uppero1nvko89rs0_e_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthikhwsv0zlfjy4_m
    call Struc_ary_lengthikhwsv0zlfjy4_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_4d), intent(out) :: array
    external St_ary_createCols65rq1zjo9jvj_m
    call St_ary_createCols65rq1zjo9jvj_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_4d), intent(out) :: array
    external St_ary_createRow3ssb3e7zwhai1_m
    call St_ary_createRow3ssb3e7zwhai1_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_StructVectorView_4d), intent(in) :: src
    type(bHYPRE_StructVectorView_4d), intent(in) :: dest
    external StructV_ary_copy_nbwdyyr7qf1p_m
    call StructV_ary_copy_nbwdyyr7qf1p_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_StructVectorView_4d), intent(in)  :: src
    type(bHYPRE_StructVectorView_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurebbwzwexg57qdc_m
    call Struc_ary_ensurebbwzwexg57qdc_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice7xgwtvbsoxm9e_m
    call Struct_ary_slice7xgwtvbsoxm9e_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_StructVectorView_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_StructVectorView_t), intent(out) :: value
    external StructV_ary_get4zye4z9vok_d0j_m
    call StructV_ary_get4zye4z9vok_d0j_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_StructVectorView_t), intent(in) :: value
    external StructV_ary_set4tjr6xc_kspzhf_m
    call StructV_ary_set4tjr6xc_kspzhf_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_StructVectorView_4d), intent(in) :: src
    type(bHYPRE_StructVectorView_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyhmrwxa3zdym98_m
    dim = 4
    call St_ary_smartCopyhmrwxa3zdym98_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_StructVectorView_4d), intent(in)  :: array
    external ary_isColumnOrderpcjkeunykpej_m
    call ary_isColumnOrderpcjkeunykpej_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_StructVectorView_4d), intent(in)  :: array
    external S_ary_isRowOrder64136sgbuy8us_m
    call S_ary_isRowOrder64136sgbuy8us_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_StructVectorView_4d), intent(in)  :: array
    external Struct_ary_dimen6newi8h4nhiq3_m
    call Struct_ary_dimen6newi8h4nhiq3_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridep_5y0s_jnw1ua_m
    call Struc_ary_stridep_5y0s_jnw1ua_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerla4a3qi0n0rn9_m
    call Struct_ary_lowerla4a3qi0n0rn9_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppero1nvko89rs0_e_m
    call Struct_ary_uppero1nvko89rs0_e_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthikhwsv0zlfjy4_m
    call Struc_ary_lengthikhwsv0zlfjy4_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_5d), intent(out) :: array
    external St_ary_createCols65rq1zjo9jvj_m
    call St_ary_createCols65rq1zjo9jvj_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_5d), intent(out) :: array
    external St_ary_createRow3ssb3e7zwhai1_m
    call St_ary_createRow3ssb3e7zwhai1_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_StructVectorView_5d), intent(in) :: src
    type(bHYPRE_StructVectorView_5d), intent(in) :: dest
    external StructV_ary_copy_nbwdyyr7qf1p_m
    call StructV_ary_copy_nbwdyyr7qf1p_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_StructVectorView_5d), intent(in)  :: src
    type(bHYPRE_StructVectorView_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurebbwzwexg57qdc_m
    call Struc_ary_ensurebbwzwexg57qdc_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice7xgwtvbsoxm9e_m
    call Struct_ary_slice7xgwtvbsoxm9e_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_StructVectorView_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_StructVectorView_t), intent(out) :: value
    external StructV_ary_get5vh_adlia2ih6m_m
    call StructV_ary_get5vh_adlia2ih6m_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_StructVectorView_t), intent(in) :: value
    external StructV_ary_set5_0qfgcim_iqc1_m
    call StructV_ary_set5_0qfgcim_iqc1_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_StructVectorView_5d), intent(in) :: src
    type(bHYPRE_StructVectorView_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyhmrwxa3zdym98_m
    dim = 5
    call St_ary_smartCopyhmrwxa3zdym98_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_StructVectorView_5d), intent(in)  :: array
    external ary_isColumnOrderpcjkeunykpej_m
    call ary_isColumnOrderpcjkeunykpej_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_StructVectorView_5d), intent(in)  :: array
    external S_ary_isRowOrder64136sgbuy8us_m
    call S_ary_isRowOrder64136sgbuy8us_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_StructVectorView_5d), intent(in)  :: array
    external Struct_ary_dimen6newi8h4nhiq3_m
    call Struct_ary_dimen6newi8h4nhiq3_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridep_5y0s_jnw1ua_m
    call Struc_ary_stridep_5y0s_jnw1ua_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerla4a3qi0n0rn9_m
    call Struct_ary_lowerla4a3qi0n0rn9_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppero1nvko89rs0_e_m
    call Struct_ary_uppero1nvko89rs0_e_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthikhwsv0zlfjy4_m
    call Struc_ary_lengthikhwsv0zlfjy4_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_6d), intent(out) :: array
    external St_ary_createCols65rq1zjo9jvj_m
    call St_ary_createCols65rq1zjo9jvj_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_6d), intent(out) :: array
    external St_ary_createRow3ssb3e7zwhai1_m
    call St_ary_createRow3ssb3e7zwhai1_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_StructVectorView_6d), intent(in) :: src
    type(bHYPRE_StructVectorView_6d), intent(in) :: dest
    external StructV_ary_copy_nbwdyyr7qf1p_m
    call StructV_ary_copy_nbwdyyr7qf1p_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_StructVectorView_6d), intent(in)  :: src
    type(bHYPRE_StructVectorView_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurebbwzwexg57qdc_m
    call Struc_ary_ensurebbwzwexg57qdc_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice7xgwtvbsoxm9e_m
    call Struct_ary_slice7xgwtvbsoxm9e_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_StructVectorView_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_StructVectorView_t), intent(out) :: value
    external StructV_ary_get6bb5q1q6_lzlud_m
    call StructV_ary_get6bb5q1q6_lzlud_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_StructVectorView_t), intent(in) :: value
    external StructV_ary_set6cjpi_kfmwv4tr_m
    call StructV_ary_set6cjpi_kfmwv4tr_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_StructVectorView_6d), intent(in) :: src
    type(bHYPRE_StructVectorView_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyhmrwxa3zdym98_m
    dim = 6
    call St_ary_smartCopyhmrwxa3zdym98_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_StructVectorView_6d), intent(in)  :: array
    external ary_isColumnOrderpcjkeunykpej_m
    call ary_isColumnOrderpcjkeunykpej_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_StructVectorView_6d), intent(in)  :: array
    external S_ary_isRowOrder64136sgbuy8us_m
    call S_ary_isRowOrder64136sgbuy8us_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_StructVectorView_6d), intent(in)  :: array
    external Struct_ary_dimen6newi8h4nhiq3_m
    call Struct_ary_dimen6newi8h4nhiq3_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridep_5y0s_jnw1ua_m
    call Struc_ary_stridep_5y0s_jnw1ua_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerla4a3qi0n0rn9_m
    call Struct_ary_lowerla4a3qi0n0rn9_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppero1nvko89rs0_e_m
    call Struct_ary_uppero1nvko89rs0_e_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthikhwsv0zlfjy4_m
    call Struc_ary_lengthikhwsv0zlfjy4_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_7d), intent(out) :: array
    external St_ary_createCols65rq1zjo9jvj_m
    call St_ary_createCols65rq1zjo9jvj_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_StructVectorView_7d), intent(out) :: array
    external St_ary_createRow3ssb3e7zwhai1_m
    call St_ary_createRow3ssb3e7zwhai1_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_StructVectorView_7d), intent(in) :: src
    type(bHYPRE_StructVectorView_7d), intent(in) :: dest
    external StructV_ary_copy_nbwdyyr7qf1p_m
    call StructV_ary_copy_nbwdyyr7qf1p_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_StructVectorView_7d), intent(in)  :: src
    type(bHYPRE_StructVectorView_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurebbwzwexg57qdc_m
    call Struc_ary_ensurebbwzwexg57qdc_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice7xgwtvbsoxm9e_m
    call Struct_ary_slice7xgwtvbsoxm9e_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_StructVectorView_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_StructVectorView_t), intent(out) :: value
    external StructV_ary_get70rrt3ji_c7k6l_m
    call StructV_ary_get70rrt3ji_c7k6l_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_StructVectorView_t), intent(in) :: value
    external StructV_ary_set7kjl0mgj0emxi3_m
    call StructV_ary_set7kjl0mgj0emxi3_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_StructVectorView_7d), intent(in) :: src
    type(bHYPRE_StructVectorView_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyhmrwxa3zdym98_m
    dim = 7
    call St_ary_smartCopyhmrwxa3zdym98_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_StructVectorView_7d), intent(in)  :: array
    external ary_isColumnOrderpcjkeunykpej_m
    call ary_isColumnOrderpcjkeunykpej_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_StructVectorView_7d), intent(in)  :: array
    external S_ary_isRowOrder64136sgbuy8us_m
    call S_ary_isRowOrder64136sgbuy8us_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_StructVectorView_7d), intent(in)  :: array
    external Struct_ary_dimen6newi8h4nhiq3_m
    call Struct_ary_dimen6newi8h4nhiq3_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stridep_5y0s_jnw1ua_m
    call Struc_ary_stridep_5y0s_jnw1ua_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowerla4a3qi0n0rn9_m
    call Struct_ary_lowerla4a3qi0n0rn9_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_uppero1nvko89rs0_e_m
    call Struct_ary_uppero1nvko89rs0_e_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthikhwsv0zlfjy4_m
    call Struc_ary_lengthikhwsv0zlfjy4_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_StructVe3z0yx58u7n_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVectorView_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVe3z0yx58u7n_p

  subroutine castbHYPRE_StructVejn6lc3_sb__p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVectorView_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVejn6lc3_sb__p

  subroutine castbHYPRE_StructVepudcst5dnj_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVectorView_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVepudcst5dnj_p

  subroutine castbHYPRE_StructVeyqcuks0qm8_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVectorView_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVeyqcuks0qm8_p

  subroutine castbHYPRE_StructVevqhsp_m44b_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVectorView_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVevqhsp_m44b_p

  subroutine castbHYPRE_StructVeceq0k1xqv1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVectorView_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVeceq0k1xqv1_p

  subroutine castbHYPRE_StructVefxbv7vvq9b_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVectorView_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVefxbv7vvq9b_p


end module bHYPRE_StructVectorView_array
