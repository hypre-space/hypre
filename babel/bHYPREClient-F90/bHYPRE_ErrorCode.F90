! 
! File:          bHYPRE_ErrorCode.F90
! Symbol:        bHYPRE.ErrorCode-v1.0.0
! Symbol Type:   enumeration
! Babel Version: 1.0.0
! Description:   Client-side module for bHYPRE.ErrorCode
! 
! WARNING: Automatically generated; changes will be lost
! 


module bHYPRE_ErrorCode
! 
...
! 
  ...
  use sidl
  integer (kind=sidl_enum), parameter :: HYPRE_ERROR_GENERIC = 1

  integer (kind=sidl_enum), parameter :: HYPRE_ERROR_MEMORY = 2

  integer (kind=sidl_enum), parameter :: HYPRE_ERROR_ARG = 4

  integer (kind=sidl_enum), parameter :: HYPRE_ERROR_CONV = 256

end module bHYPRE_ErrorCode

module bHYPRE_ErrorCode_array
  use sidl
  use bHYPRE_ErrorCode_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_ErrorCodvb53mfl6hp_p, &
    castbHYPRE_ErrorCodmd0hygb3b2_p, &
    castbHYPRE_ErrorCodjxhyhy5x3s_p, &
    castbHYPRE_ErrorCodttiakyy7ow_p, &
    castbHYPRE_ErrorCod6mbcczysx8_p, &
    castbHYPRE_ErrorCodf0n1tib2dn_p, &
    castbHYPRE_ErrorCodr6ypglc2np_p
interface cast
  module procedure &
    castbHYPRE_ErrorCodvb53mfl6hp_p, &
    castbHYPRE_ErrorCodmd0hygb3b2_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorCode_1d), intent(out) :: array
  ...
  subroutine copy1_p(src, dest)
    type(bHYPRE_ErrorCode_1d), intent(in) :: src
    type(bHYPRE_ErrorCode_1d), intent(in) :: dest
  ...
  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_ErrorCode_1d), intent(in)  :: src
    type(bHYPRE_ErrorCode_1d), intent(out) :: result
  ...
  subroutine getg1_p(array, index, value)
    type(bHYPRE_ErrorCode_1d), intent(in)  :: array
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_ErrorCode_1d), intent(in) :: src
    type(bHYPRE_ErrorCode_1d), intent(out) :: dest
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorCode_2d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy2_p(src, dest)
    type(bHYPRE_ErrorCode_2d), intent(in) :: src
    type(bHYPRE_ErrorCode_2d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_ErrorCode_2d), intent(in)  :: src
    type(bHYPRE_ErrorCode_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg2_p(array, index, value)
    type(bHYPRE_ErrorCode_2d), intent(in)  :: array
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_ErrorCode_2d), intent(in) :: src
    type(bHYPRE_ErrorCode_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 2
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorCode_3d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy3_p(src, dest)
    type(bHYPRE_ErrorCode_3d), intent(in) :: src
    type(bHYPRE_ErrorCode_3d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_ErrorCode_3d), intent(in)  :: src
    type(bHYPRE_ErrorCode_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg3_p(array, index, value)
    type(bHYPRE_ErrorCode_3d), intent(in)  :: array
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_ErrorCode_3d), intent(in) :: src
    type(bHYPRE_ErrorCode_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 3
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorCode_4d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy4_p(src, dest)
    type(bHYPRE_ErrorCode_4d), intent(in) :: src
    type(bHYPRE_ErrorCode_4d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_ErrorCode_4d), intent(in)  :: src
    type(bHYPRE_ErrorCode_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg4_p(array, index, value)
    type(bHYPRE_ErrorCode_4d), intent(in)  :: array
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_ErrorCode_4d), intent(in) :: src
    type(bHYPRE_ErrorCode_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 4
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorCode_5d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy5_p(src, dest)
    type(bHYPRE_ErrorCode_5d), intent(in) :: src
    type(bHYPRE_ErrorCode_5d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_ErrorCode_5d), intent(in)  :: src
    type(bHYPRE_ErrorCode_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg5_p(array, index, value)
    type(bHYPRE_ErrorCode_5d), intent(in)  :: array
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_ErrorCode_5d), intent(in) :: src
    type(bHYPRE_ErrorCode_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 5
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorCode_6d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy6_p(src, dest)
    type(bHYPRE_ErrorCode_6d), intent(in) :: src
    type(bHYPRE_ErrorCode_6d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_ErrorCode_6d), intent(in)  :: src
    type(bHYPRE_ErrorCode_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg6_p(array, index, value)
    type(bHYPRE_ErrorCode_6d), intent(in)  :: array
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_ErrorCode_6d), intent(in) :: src
    type(bHYPRE_ErrorCode_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 6
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorCode_7d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy7_p(src, dest)
    type(bHYPRE_ErrorCode_7d), intent(in) :: src
    type(bHYPRE_ErrorCode_7d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_ErrorCode_7d), intent(in)  :: src
    type(bHYPRE_ErrorCode_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg7_p(array, index, value)
    type(bHYPRE_ErrorCode_7d), intent(in)  :: array
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_ErrorCode_7d), intent(in) :: src
    type(bHYPRE_ErrorCode_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 7
  ...
  subroutine castbHYPRE_ErrorCodvb53mfl6hp_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorCode_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorCodvb53mfl6hp_p

  subroutine castbHYPRE_ErrorCodmd0hygb3b2_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorCode_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorCodmd0hygb3b2_p

  subroutine castbHYPRE_ErrorCodjxhyhy5x3s_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorCode_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorCodjxhyhy5x3s_p

  subroutine castbHYPRE_ErrorCodttiakyy7ow_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorCode_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorCodttiakyy7ow_p

  subroutine castbHYPRE_ErrorCod6mbcczysx8_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorCode_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorCod6mbcczysx8_p

  subroutine castbHYPRE_ErrorCodf0n1tib2dn_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorCode_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorCodf0n1tib2dn_p

  subroutine castbHYPRE_ErrorCodr6ypglc2np_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorCode_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorCodr6ypglc2np_p


end module bHYPRE_ErrorCode_array
