! 
! File:          bHYPRE_SStructParCSRMatrix.F90
...
module bHYPRE_SStructParCSRMatrix

  use sidl
  use bHYPRE_MPICommunicator_type
  use bHYPRE_SStructParCSRMatrix_type
...
interface bHYPRE_SStructParCSRMatrix__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(mpi_comm, graph, retval, exception)
    ...
    !  out bHYPRE.SStructParCSRMatrix retval
    type(bHYPRE_SStructParCSRMatrix_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructParCSRMatrix_Create_m
    call bHYPRE_SStructParCSRMatrix_Create_m(mpi_comm, graph, retval,          &
      exception)
  ...
  recursive subroutine SetGraph_s(self, graph, retval, exception)
    implicit none
    !  in bHYPRE.SStructParCSRMatrix self
    type(bHYPRE_SStructParCSRMatrix_t) , intent(in) :: self
    !  in bHYPRE.SStructGraph graph
    type(bHYPRE_SStructGraph_t) , intent(in) :: graph
    !  out int retval
    ...
    external bHYPRE_SStructParCSRMatrix_SetGraph_m
    call bHYPRE_SStructParCSRMatrix_SetGraph_m(self, graph, retval, exception)
  ...
  recursive subroutine SetValues_1s(self, part, index, var, entries, values,   &
    ...
    external bHYPRE_SStructParCSRMatrix_SetValues_a
    call bHYPRE_SStructParCSRMatrix_SetValues_a(self, part, index, var,        &
  ...
  recursive subroutine SetValues_2s(self, part, index, var, entries, values,   &
    ...
    external bHYPRE_SStructParCSRMatrix_SetValues_m
    nentries = size(values, 1)
    dim = size(index, 1)
    call bHYPRE_SStructParCSRMatrix_SetValues_m(self, part, index, dim, var,   &
  ...
  recursive subroutine SetBoxValues_1s(self, part, ilower, iupper, var,        &
    ...
    external bHYPRE_SStructParCSRMatrix_SetBoxValues_a
    call bHYPRE_SStructParCSRMatrix_SetBoxValues_a(self, part, ilower, iupper, &
  ...
  recursive subroutine SetBoxValues_2s(self, part, ilower, iupper, var,        &
    ...
    external bHYPRE_SStructParCSRMatrix_SetBoxValues_m
    nentries = size(entries, 1)
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_SStructParCSRMatrix_SetBoxValues_m(self, part, ilower, iupper, &
  ...
  recursive subroutine AddToValues_1s(self, part, index, var, entries, values, &
    ...
    external bHYPRE_SStructParCSRMatrix_AddToValues_a
    call bHYPRE_SStructParCSRMatrix_AddToValues_a(self, part, index, var,      &
      entries, values, retval, exception)
  ...
  recursive subroutine AddToValues_2s(self, part, index, var, entries, values, &
    ...
    external bHYPRE_SStructParCSRMatrix_AddToValues_m
    nentries = size(values, 1)
    dim = size(index, 1)
    call bHYPRE_SStructParCSRMatrix_AddToValues_m(self, part, index, dim, var, &
      nentries, entries, values, retval, exception)
  ...
  recursive subroutine AddToBoxValues_1s(self, part, ilower, iupper, var,      &
    ...
    external bHYPRE_SStructParCSRMatrix_AddToBoxValues_a
    call bHYPRE_SStructParCSRMatrix_AddToBoxValues_a(self, part, ilower,       &
      iupper, var, entries, values, retval, exception)
  ...
  recursive subroutine AddToBoxValues_2s(self, part, ilower, iupper, var,      &
    ...
    external bHYPRE_SStructParCSRMatrix_AddToBoxValues_m
    nentries = size(entries, 1)
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_SStructParCSRMatrix_AddToBoxValues_m(self, part, ilower,       &
      iupper, dim, var, nentries, entries, values, nvalues, retval, exception)
  ...
  recursive subroutine SetSymmetric_s(self, part, var, to_var, symmetric,      &
    ...
    external bHYPRE_SStructParCSRMatrix_SetSymmetric_m
    call bHYPRE_SStructParCSRMatrix_SetSymmetric_m(self, part, var, to_var,    &
  ...
  recursive subroutine SetNSSymmetric_s(self, symmetric, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_SetNSSymmetric_m
    call bHYPRE_SStructParCSRMatrix_SetNSSymmetric_m(self, symmetric, retval,  &
      exception)
  ...
  recursive subroutine SetComplex_s(self, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_SetComplex_m
    call bHYPRE_SStructParCSRMatrix_SetComplex_m(self, retval, exception)
  ...
  recursive subroutine Print_s(self, filename, all, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_Print_m
    call bHYPRE_SStructParCSRMatrix_Print_m(self, filename, all, retval,       &
      exception)
  ...
  recursive subroutine GetObject_s(self, A, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_GetObject_m
    call bHYPRE_SStructParCSRMatrix_GetObject_m(self, A, retval, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_SetCommunicator_m
    call bHYPRE_SStructParCSRMatrix_SetCommunicator_m(self, mpi_comm, retval,  &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_Destroy_m
    call bHYPRE_SStructParCSRMatrix_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_Initialize_m
    call bHYPRE_SStructParCSRMatrix_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_Assemble_m
    call bHYPRE_SStructParCSRMatrix_Assemble_m(self, retval, exception)
  ...
  recursive subroutine SetIntParameter_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_SetIntParameter_m
    call bHYPRE_SStructParCSRMatrix_SetIntParameter_m(self, name, value,       &
      retval, exception)
  ...
  recursive subroutine SetDoubleParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_SStructParCSRMatrix_SetDoubleParameter_m
    call bHYPRE_SStructParCSRMatrix_SetDoubleParameter_m(self, name, value,    &
      retval, exception)
  ...
  recursive subroutine SetStringParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_SStructParCSRMatrix_SetStringParameter_m
    call bHYPRE_SStructParCSRMatrix_SetStringParameter_m(self, name, value,    &
      retval, exception)
  ...
  recursive subroutine SetIntArray1Parameter_1s(self, name, value, retval,     &
    ...
    external bHYPRE_SStructParCSRMatrix_SetIntArray1Parameter_a
    call bHYPRE_SStructParCSRMatrix_SetIntArray1Parameter_a(self, name, value, &
      retval, exception)
  ...
  recursive subroutine SetIntArray1Parameter_2s(self, name, value, retval,     &
    ...
    external bHYPRE_SStructParCSRMatrix_SetIntArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_SStructParCSRMatrix_SetIntArray1Parameter_m(self, name, value, &
  ...
  recursive subroutine SetIntArray2Parameter_s(self, name, value, retval,      &
    ...
    external bHYPRE_SStructParCSRMatrix_SetIntArray2Parameter_m
    call bHYPRE_SStructParCSRMatrix_SetIntArray2Parameter_m(self, name, value, &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_1s(self, name, value, retval,  &
    ...
    external bHYPRE_SStructParCSRMatrix_SetDoubleArray1Parameter_a
    call bHYPRE_SStructParCSRMatrix_SetDoubleArray1Parameter_a(self, name,     &
  ...
  recursive subroutine SetDoubleArray1Parameter_2s(self, name, value, retval,  &
    ...
    external bHYPRE_SStructParCSRMatrix_SetDoubleArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_SStructParCSRMatrix_SetDoubleArray1Parameter_m(self, name,     &
  ...
  recursive subroutine SetDoubleArray2Parameter_s(self, name, value, retval,   &
    ...
    external bHYPRE_SStructParCSRMatrix_SetDoubleArray2Parameter_m
    call bHYPRE_SStructParCSRMatrix_SetDoubleArray2Parameter_m(self, name,     &
      value, retval, exception)
  ...
  recursive subroutine GetIntValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_GetIntValue_m
    call bHYPRE_SStructParCSRMatrix_GetIntValue_m(self, name, value, retval,   &
      exception)
  ...
  recursive subroutine GetDoubleValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_GetDoubleValue_m
    call bHYPRE_SStructParCSRMatrix_GetDoubleValue_m(self, name, value,        &
      retval, exception)
  ...
  recursive subroutine Setup_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_Setup_m
    call bHYPRE_SStructParCSRMatrix_Setup_m(self, b, x, retval, exception)
  ...
  recursive subroutine Apply_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_Apply_m
    call bHYPRE_SStructParCSRMatrix_Apply_m(self, b, x, retval, exception)
  ...
  recursive subroutine ApplyAdjoint_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_ApplyAdjoint_m
    call bHYPRE_SStructParCSRMatrix_ApplyAdjoint_m(self, b, x, retval,         &
      exception)
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_newLocal_m
    call bHYPRE_SStructParCSRMatrix_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(bHYPRE_SStructParCSRMatrix_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructParCSRMatrix_newRemote_m
    call bHYPRE_SStructParCSRMatrix_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_rConnect_m
    call bHYPRE_SStructParCSRMatrix_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_addRef_m
    call bHYPRE_SStructParCSRMatrix_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_deleteRef_m
    call bHYPRE_SStructParCSRMatrix_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_isSame_m
    call bHYPRE_SStructParCSRMatrix_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_isType_m
    call bHYPRE_SStructParCSRMatrix_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix_getClassInfo_m
    call bHYPRE_SStructParCSRMatrix_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.SStructParCSRMatrix
  ! to bHYPRE.MatrixVectorView.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: oldType
  ...
  ! to bHYPRE.SStructParCSRMatrix.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_MatrixVectorView_t), intent(in) :: oldType
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_SStructParCSRMatrix__cast_m

    call bHYPRE_SStructParCSRMatrix__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_SStructParCSRMatrix__exec_m
    call bHYPRE_SStructParCSRMatrix__exec_m(self, methodName, inArgs, outArgs, &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix__getURL_m
    call bHYPRE_SStructParCSRMatrix__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix__isRemote_m
    call bHYPRE_SStructParCSRMatrix__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_SStructParCSRMatrix__isLocal_m
    call bHYPRE_SStructParCSRMatrix__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_SStructParCSRMatrix__set_hooks_m
    call bHYPRE_SStructParCSRMatrix__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_SStructParCSRMatrix__set_hooks_static_m
    call bHYPRE_SStructParCSRMatrix__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_SStructParCSRMatrix

module bHYPRE_SStructParCSRMatrix_array
  use sidl
  use bHYPRE_SStructParCSRMatrix_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructPr2q7sahel0_p, &
    castbHYPRE_SStructP16d93hkwzw_p, &
    castbHYPRE_SStructPx3vdbf7cqq_p, &
    castbHYPRE_SStructPvdaxaoqbpd_p, &
    castbHYPRE_SStructP3dzpslk988_p, &
    castbHYPRE_SStructPvpc00sru6y_p, &
    castbHYPRE_SStructP6gkcy204qk_p
interface cast
  module procedure &
    castbHYPRE_SStructPr2q7sahel0_p, &
    castbHYPRE_SStructP16d93hkwzw_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_1d), intent(out) :: array
    external SS_ary_createCol7i4lzk6mgdydk_m
    call SS_ary_createCol7i4lzk6mgdydk_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_SStructParCSRMatrix_1d), intent(out) :: array
    external SS_ary_createRowpqkibgfs6xkc3_m
    call SS_ary_createRowpqkibgfs6xkc3_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_SStructParCSRMatrix_1d), intent(out) :: array
    external SSt_ary_create1d00l11fmpmf3xw_m
    call SSt_ary_create1d00l11fmpmf3xw_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in) :: dest
    external SStruct_ary_copyri1qc6pcggoz__m
    call SStruct_ary_copyri1qc6pcggoz__m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: src
    type(bHYPRE_SStructParCSRMatrix_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurekzfjgvwqwamuk_m
    call SStru_ary_ensurekzfjgvwqwamuk_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external SStruc_ary_sliceq7zshi6o8iyzi_m
    call SStruc_ary_sliceq7zshi6o8iyzi_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: value
    external SStructP_ary_getxbfowh7iszlg4_m
    call SStructP_ary_getxbfowh7iszlg4_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: value
    external SStructP_ary_setpi3h_niqrhrba_m
    call SStructP_ary_setpi3h_niqrhrba_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: value
    external SStruct_ary_get1kjwgldxmq5kwy_m
    call SStruct_ary_get1kjwgldxmq5kwy_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: value
    external SStruct_ary_set1q2aynlzc9spm5_m
    call SStruct_ary_set1q2aynlzc9spm5_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy7aiwue7evj5eg_m
    dim = 1
    call SS_ary_smartCopy7aiwue7evj5eg_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    external ary_isColumnOrderi9v1ew3xsdi3_m
    call ary_isColumnOrderi9v1ew3xsdi3_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    external S_ary_isRowOrderp6y_irf10ki2p_m
    call S_ary_isRowOrderp6y_irf10ki2p_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    external SStruc_ary_dimena9qw1xj8cl90w_m
    call SStruc_ary_dimena9qw1xj8cl90w_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride_e70cl2_ngc8x_m
    call SStru_ary_stride_e70cl2_ngc8x_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_lvu45kvpwqbm_m
    call SStruc_ary_lower_lvu45kvpwqbm_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperrgdawwag7thtw_m
    call SStruc_ary_upperrgdawwag7thtw_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthqqzojulpal6i6_m
    call SStru_ary_lengthqqzojulpal6i6_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    external SStru_ary_addRefdslemrau1m1ir_m
    call SStru_ary_addRefdslemrau1m1ir_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in)  :: array
    external SS_ary_deleteReff4ftt0_li7stq_m
    call SS_ary_deleteReff4ftt0_li7stq_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_2d), intent(out) :: array
    external SS_ary_createCol7i4lzk6mgdydk_m
    call SS_ary_createCol7i4lzk6mgdydk_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_2d), intent(out) :: array
    external SS_ary_createRowpqkibgfs6xkc3_m
    call SS_ary_createRowpqkibgfs6xkc3_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructParCSRMatrix_2d), intent(out) :: array
    external ary_create2dColhptutm4uulf5b6_m
    call ary_create2dColhptutm4uulf5b6_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructParCSRMatrix_2d), intent(out) :: array
    external ary_create2dRowkt5ap4p683m87j_m
    call ary_create2dRowkt5ap4p683m87j_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in) :: dest
    external SStruct_ary_copyri1qc6pcggoz__m
    call SStruct_ary_copyri1qc6pcggoz__m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in)  :: src
    type(bHYPRE_SStructParCSRMatrix_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurekzfjgvwqwamuk_m
    call SStru_ary_ensurekzfjgvwqwamuk_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_sliceq7zshi6o8iyzi_m
    call SStruc_ary_sliceq7zshi6o8iyzi_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: value
    external SStruct_ary_get2ropvckpcjw3ya_m
    call SStruct_ary_get2ropvckpcjw3ya_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: value
    external SStruct_ary_set25p0p3fo_srk4m_m
    call SStruct_ary_set25p0p3fo_srk4m_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy7aiwue7evj5eg_m
    dim = 2
    call SS_ary_smartCopy7aiwue7evj5eg_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in)  :: array
    external ary_isColumnOrderi9v1ew3xsdi3_m
    call ary_isColumnOrderi9v1ew3xsdi3_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in)  :: array
    external S_ary_isRowOrderp6y_irf10ki2p_m
    call S_ary_isRowOrderp6y_irf10ki2p_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in)  :: array
    external SStruc_ary_dimena9qw1xj8cl90w_m
    call SStruc_ary_dimena9qw1xj8cl90w_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride_e70cl2_ngc8x_m
    call SStru_ary_stride_e70cl2_ngc8x_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_lvu45kvpwqbm_m
    call SStruc_ary_lower_lvu45kvpwqbm_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperrgdawwag7thtw_m
    call SStruc_ary_upperrgdawwag7thtw_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthqqzojulpal6i6_m
    call SStru_ary_lengthqqzojulpal6i6_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_3d), intent(out) :: array
    external SS_ary_createCol7i4lzk6mgdydk_m
    call SS_ary_createCol7i4lzk6mgdydk_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_3d), intent(out) :: array
    external SS_ary_createRowpqkibgfs6xkc3_m
    call SS_ary_createRowpqkibgfs6xkc3_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in) :: dest
    external SStruct_ary_copyri1qc6pcggoz__m
    call SStruct_ary_copyri1qc6pcggoz__m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in)  :: src
    type(bHYPRE_SStructParCSRMatrix_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurekzfjgvwqwamuk_m
    call SStru_ary_ensurekzfjgvwqwamuk_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_sliceq7zshi6o8iyzi_m
    call SStruc_ary_sliceq7zshi6o8iyzi_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: value
    external SStruct_ary_get34l2_n0078cijd_m
    call SStruct_ary_get34l2_n0078cijd_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: value
    external SStruct_ary_set3ojodf6fiduv6z_m
    call SStruct_ary_set3ojodf6fiduv6z_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy7aiwue7evj5eg_m
    dim = 3
    call SS_ary_smartCopy7aiwue7evj5eg_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in)  :: array
    external ary_isColumnOrderi9v1ew3xsdi3_m
    call ary_isColumnOrderi9v1ew3xsdi3_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in)  :: array
    external S_ary_isRowOrderp6y_irf10ki2p_m
    call S_ary_isRowOrderp6y_irf10ki2p_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in)  :: array
    external SStruc_ary_dimena9qw1xj8cl90w_m
    call SStruc_ary_dimena9qw1xj8cl90w_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride_e70cl2_ngc8x_m
    call SStru_ary_stride_e70cl2_ngc8x_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_lvu45kvpwqbm_m
    call SStruc_ary_lower_lvu45kvpwqbm_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperrgdawwag7thtw_m
    call SStruc_ary_upperrgdawwag7thtw_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthqqzojulpal6i6_m
    call SStru_ary_lengthqqzojulpal6i6_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_4d), intent(out) :: array
    external SS_ary_createCol7i4lzk6mgdydk_m
    call SS_ary_createCol7i4lzk6mgdydk_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_4d), intent(out) :: array
    external SS_ary_createRowpqkibgfs6xkc3_m
    call SS_ary_createRowpqkibgfs6xkc3_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in) :: dest
    external SStruct_ary_copyri1qc6pcggoz__m
    call SStruct_ary_copyri1qc6pcggoz__m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in)  :: src
    type(bHYPRE_SStructParCSRMatrix_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurekzfjgvwqwamuk_m
    call SStru_ary_ensurekzfjgvwqwamuk_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_sliceq7zshi6o8iyzi_m
    call SStruc_ary_sliceq7zshi6o8iyzi_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: value
    external SStruct_ary_get4j7n3se7e36snx_m
    call SStruct_ary_get4j7n3se7e36snx_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: value
    external SStruct_ary_set4ko37_msmai8pd_m
    call SStruct_ary_set4ko37_msmai8pd_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy7aiwue7evj5eg_m
    dim = 4
    call SS_ary_smartCopy7aiwue7evj5eg_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in)  :: array
    external ary_isColumnOrderi9v1ew3xsdi3_m
    call ary_isColumnOrderi9v1ew3xsdi3_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in)  :: array
    external S_ary_isRowOrderp6y_irf10ki2p_m
    call S_ary_isRowOrderp6y_irf10ki2p_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in)  :: array
    external SStruc_ary_dimena9qw1xj8cl90w_m
    call SStruc_ary_dimena9qw1xj8cl90w_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride_e70cl2_ngc8x_m
    call SStru_ary_stride_e70cl2_ngc8x_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_lvu45kvpwqbm_m
    call SStruc_ary_lower_lvu45kvpwqbm_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperrgdawwag7thtw_m
    call SStruc_ary_upperrgdawwag7thtw_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthqqzojulpal6i6_m
    call SStru_ary_lengthqqzojulpal6i6_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_5d), intent(out) :: array
    external SS_ary_createCol7i4lzk6mgdydk_m
    call SS_ary_createCol7i4lzk6mgdydk_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_5d), intent(out) :: array
    external SS_ary_createRowpqkibgfs6xkc3_m
    call SS_ary_createRowpqkibgfs6xkc3_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in) :: dest
    external SStruct_ary_copyri1qc6pcggoz__m
    call SStruct_ary_copyri1qc6pcggoz__m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in)  :: src
    type(bHYPRE_SStructParCSRMatrix_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurekzfjgvwqwamuk_m
    call SStru_ary_ensurekzfjgvwqwamuk_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_sliceq7zshi6o8iyzi_m
    call SStruc_ary_sliceq7zshi6o8iyzi_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: value
    external SStruct_ary_get5l5p_tfqx7j3hg_m
    call SStruct_ary_get5l5p_tfqx7j3hg_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: value
    external SStruct_ary_set5pmcrkzww3kpch_m
    call SStruct_ary_set5pmcrkzww3kpch_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy7aiwue7evj5eg_m
    dim = 5
    call SS_ary_smartCopy7aiwue7evj5eg_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in)  :: array
    external ary_isColumnOrderi9v1ew3xsdi3_m
    call ary_isColumnOrderi9v1ew3xsdi3_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in)  :: array
    external S_ary_isRowOrderp6y_irf10ki2p_m
    call S_ary_isRowOrderp6y_irf10ki2p_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in)  :: array
    external SStruc_ary_dimena9qw1xj8cl90w_m
    call SStruc_ary_dimena9qw1xj8cl90w_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride_e70cl2_ngc8x_m
    call SStru_ary_stride_e70cl2_ngc8x_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_lvu45kvpwqbm_m
    call SStruc_ary_lower_lvu45kvpwqbm_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperrgdawwag7thtw_m
    call SStruc_ary_upperrgdawwag7thtw_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthqqzojulpal6i6_m
    call SStru_ary_lengthqqzojulpal6i6_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_6d), intent(out) :: array
    external SS_ary_createCol7i4lzk6mgdydk_m
    call SS_ary_createCol7i4lzk6mgdydk_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_6d), intent(out) :: array
    external SS_ary_createRowpqkibgfs6xkc3_m
    call SS_ary_createRowpqkibgfs6xkc3_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in) :: dest
    external SStruct_ary_copyri1qc6pcggoz__m
    call SStruct_ary_copyri1qc6pcggoz__m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in)  :: src
    type(bHYPRE_SStructParCSRMatrix_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurekzfjgvwqwamuk_m
    call SStru_ary_ensurekzfjgvwqwamuk_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_sliceq7zshi6o8iyzi_m
    call SStruc_ary_sliceq7zshi6o8iyzi_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: value
    external SStruct_ary_get60tg8cumjjs83w_m
    call SStruct_ary_get60tg8cumjjs83w_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: value
    external SStruct_ary_set617izoo79cs9tc_m
    call SStruct_ary_set617izoo79cs9tc_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy7aiwue7evj5eg_m
    dim = 6
    call SS_ary_smartCopy7aiwue7evj5eg_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in)  :: array
    external ary_isColumnOrderi9v1ew3xsdi3_m
    call ary_isColumnOrderi9v1ew3xsdi3_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in)  :: array
    external S_ary_isRowOrderp6y_irf10ki2p_m
    call S_ary_isRowOrderp6y_irf10ki2p_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in)  :: array
    external SStruc_ary_dimena9qw1xj8cl90w_m
    call SStruc_ary_dimena9qw1xj8cl90w_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride_e70cl2_ngc8x_m
    call SStru_ary_stride_e70cl2_ngc8x_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_lvu45kvpwqbm_m
    call SStruc_ary_lower_lvu45kvpwqbm_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperrgdawwag7thtw_m
    call SStruc_ary_upperrgdawwag7thtw_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthqqzojulpal6i6_m
    call SStru_ary_lengthqqzojulpal6i6_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_7d), intent(out) :: array
    external SS_ary_createCol7i4lzk6mgdydk_m
    call SS_ary_createCol7i4lzk6mgdydk_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructParCSRMatrix_7d), intent(out) :: array
    external SS_ary_createRowpqkibgfs6xkc3_m
    call SS_ary_createRowpqkibgfs6xkc3_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in) :: dest
    external SStruct_ary_copyri1qc6pcggoz__m
    call SStruct_ary_copyri1qc6pcggoz__m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in)  :: src
    type(bHYPRE_SStructParCSRMatrix_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensurekzfjgvwqwamuk_m
    call SStru_ary_ensurekzfjgvwqwamuk_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_sliceq7zshi6o8iyzi_m
    call SStruc_ary_sliceq7zshi6o8iyzi_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_SStructParCSRMatrix_t), intent(out) :: value
    external SStruct_ary_get7y9txh9mukhjkn_m
    call SStruct_ary_get7y9txh9mukhjkn_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_SStructParCSRMatrix_t), intent(in) :: value
    external SStruct_ary_set740m3a7emcc9nz_m
    call SStruct_ary_set740m3a7emcc9nz_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in) :: src
    type(bHYPRE_SStructParCSRMatrix_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy7aiwue7evj5eg_m
    dim = 7
    call SS_ary_smartCopy7aiwue7evj5eg_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in)  :: array
    external ary_isColumnOrderi9v1ew3xsdi3_m
    call ary_isColumnOrderi9v1ew3xsdi3_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in)  :: array
    external S_ary_isRowOrderp6y_irf10ki2p_m
    call S_ary_isRowOrderp6y_irf10ki2p_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in)  :: array
    external SStruc_ary_dimena9qw1xj8cl90w_m
    call SStruc_ary_dimena9qw1xj8cl90w_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride_e70cl2_ngc8x_m
    call SStru_ary_stride_e70cl2_ngc8x_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower_lvu45kvpwqbm_m
    call SStruc_ary_lower_lvu45kvpwqbm_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upperrgdawwag7thtw_m
    call SStruc_ary_upperrgdawwag7thtw_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthqqzojulpal6i6_m
    call SStru_ary_lengthqqzojulpal6i6_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_SStructPr2q7sahel0_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructParCSRMatrix_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructPr2q7sahel0_p

  subroutine castbHYPRE_SStructP16d93hkwzw_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructParCSRMatrix_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructP16d93hkwzw_p

  subroutine castbHYPRE_SStructPx3vdbf7cqq_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructParCSRMatrix_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructPx3vdbf7cqq_p

  subroutine castbHYPRE_SStructPvdaxaoqbpd_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructParCSRMatrix_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructPvdaxaoqbpd_p

  subroutine castbHYPRE_SStructP3dzpslk988_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructParCSRMatrix_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructP3dzpslk988_p

  subroutine castbHYPRE_SStructPvpc00sru6y_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructParCSRMatrix_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructPvpc00sru6y_p

  subroutine castbHYPRE_SStructP6gkcy204qk_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructParCSRMatrix_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructP6gkcy204qk_p


end module bHYPRE_SStructParCSRMatrix_array
