...
contains
  ...
  recursive subroutine SetLocalRange_s(self, jlower, jupper, retval,           &
    exception)
    implicit none
    !  in bHYPRE.IJVectorView self
    type(bHYPRE_IJVectorView_t) , intent(in) :: self
    !  in int jlower
    ...
    external bHYPRE_IJVectorView_SetLocalRange_m
    call bHYPRE_IJVectorView_SetLocalRange_m(self, jlower, jupper, retval,     &
      exception)
  ...
  recursive subroutine SetValues_1s(self, indices, values, retval, exception)
    ...
    external bHYPRE_IJVectorView_SetValues_a
    call bHYPRE_IJVectorView_SetValues_a(self, indices, values, retval,        &
      exception)
  ...
  recursive subroutine SetValues_2s(self, indices, values, retval, exception)
    ...
    external bHYPRE_IJVectorView_SetValues_m
    nvalues = size(indices, 1)
    call bHYPRE_IJVectorView_SetValues_m(self, nvalues, indices, values,       &
      retval, exception)
  ...
  recursive subroutine AddToValues_1s(self, indices, values, retval,           &
    ...
    external bHYPRE_IJVectorView_AddToValues_a
    call bHYPRE_IJVectorView_AddToValues_a(self, indices, values, retval,      &
      exception)
  ...
  recursive subroutine AddToValues_2s(self, indices, values, retval,           &
    ...
    external bHYPRE_IJVectorView_AddToValues_m
    nvalues = size(indices, 1)
    call bHYPRE_IJVectorView_AddToValues_m(self, nvalues, indices, values,     &
      retval, exception)
  ...
  recursive subroutine GetLocalRange_s(self, jlower, jupper, retval,           &
    ...
    external bHYPRE_IJVectorView_GetLocalRange_m
    call bHYPRE_IJVectorView_GetLocalRange_m(self, jlower, jupper, retval,     &
      exception)
  ...
  recursive subroutine GetValues_1s(self, indices, values, retval, exception)
    ...
    external bHYPRE_IJVectorView_GetValues_a
    call bHYPRE_IJVectorView_GetValues_a(self, indices, values, retval,        &
      exception)
  ...
  recursive subroutine GetValues_2s(self, indices, values, retval, exception)
    ...
    external bHYPRE_IJVectorView_GetValues_m
    nvalues = size(indices, 1)
    call bHYPRE_IJVectorView_GetValues_m(self, nvalues, indices, values,       &
      retval, exception)
  ...
  recursive subroutine Print_s(self, filename, retval, exception)
    ...
    external bHYPRE_IJVectorView_Print_m
    call bHYPRE_IJVectorView_Print_m(self, filename, retval, exception)
  ...
  recursive subroutine Read_s(self, filename, comm, retval, exception)
    ...
    external bHYPRE_IJVectorView_Read_m
    call bHYPRE_IJVectorView_Read_m(self, filename, comm, retval, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    type(bHYPRE_IJVectorView_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_IJVectorView_rConnect_m
    call bHYPRE_IJVectorView_rConnect_m(self, url, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_IJVectorView_SetCommunicator_m
    call bHYPRE_IJVectorView_SetCommunicator_m(self, mpi_comm, retval,         &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_IJVectorView_Destroy_m
    call bHYPRE_IJVectorView_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_IJVectorView_Initialize_m
    call bHYPRE_IJVectorView_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_IJVectorView_Assemble_m
    call bHYPRE_IJVectorView_Assemble_m(self, retval, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_IJVectorView_addRef_m
    call bHYPRE_IJVectorView_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_IJVectorView_deleteRef_m
    call bHYPRE_IJVectorView_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_IJVectorView_isSame_m
    call bHYPRE_IJVectorView_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_IJVectorView_isType_m
    call bHYPRE_IJVectorView_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_IJVectorView_getClassInfo_m
    call bHYPRE_IJVectorView_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_IJVectorView__exec_m
    call bHYPRE_IJVectorView__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_IJVectorView__getURL_m
    call bHYPRE_IJVectorView__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_IJVectorView__isRemote_m
    call bHYPRE_IJVectorView__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_IJVectorView__isLocal_m
    call bHYPRE_IJVectorView__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_IJVectorView__set_hooks_m
    call bHYPRE_IJVectorView__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_IJVectorView_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_IJVectorView_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_IJVectorView

module bHYPRE_IJVectorView_array
  use sidl
  use bHYPRE_IJVectorView_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_IJVectormku0kftws9_p, &
    castbHYPRE_IJVectore9cun3ggq8_p, &
    castbHYPRE_IJVector_24b_qfddr_p, &
    castbHYPRE_IJVectorcpye5k_rde_p, &
    castbHYPRE_IJVector49_x31bvls_p, &
    castbHYPRE_IJVector7vusljzpyd_p, &
    castbHYPRE_IJVector7xvtebu25f_p
interface cast
  module procedure &
    castbHYPRE_IJVectormku0kftws9_p, &
    castbHYPRE_IJVectore9cun3ggq8_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_1d), intent(out) :: array
    external IJ_ary_createColopws0tlgsr7bd_m
    call IJ_ary_createColopws0tlgsr7bd_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_IJVectorView_1d), intent(out) :: array
    external IJ_ary_createRow2vsymjb2g8vh__m
    call IJ_ary_createRow2vsymjb2g8vh__m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_IJVectorView_1d), intent(out) :: array
    external IJV_ary_create1dq5saozitdpvc8_m
    call IJV_ary_create1dq5saozitdpvc8_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_IJVectorView_1d), intent(in) :: src
    type(bHYPRE_IJVectorView_1d), intent(in) :: dest
    external IJVecto_ary_copy1isvmjr9uh5rc_m
    call IJVecto_ary_copy1isvmjr9uh5rc_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: src
    type(bHYPRE_IJVectorView_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJVec_ary_ensurez5izn04corvd5_m
    call IJVec_ary_ensurez5izn04corvd5_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external IJVect_ary_slice1b_xi7nvvtd06_m
    call IJVect_ary_slice1b_xi7nvvtd06_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_IJVectorView_t), intent(out) :: value
    external IJVector_ary_geta28j0n9_2gh1u_m
    call IJVector_ary_geta28j0n9_2gh1u_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_IJVectorView_t), intent(in) :: value
    external IJVector_ary_setwck_e9bm085oc_m
    call IJVector_ary_setwck_e9bm085oc_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_IJVectorView_t), intent(out) :: value
    external IJVecto_ary_get1bl9ygt45bq4r6_m
    call IJVecto_ary_get1bl9ygt45bq4r6_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_IJVectorView_t), intent(in) :: value
    external IJVecto_ary_set17cgtc_gw91h20_m
    call IJVecto_ary_set17cgtc_gw91h20_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_IJVectorView_1d), intent(in) :: src
    type(bHYPRE_IJVectorView_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopypdu8amo15nqeu_m
    dim = 1
    call IJ_ary_smartCopypdu8amo15nqeu_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    external ary_isColumnOrdery9bjx9vsnxav_m
    call ary_isColumnOrdery9bjx9vsnxav_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    external I_ary_isRowOrderaztkcsdczddok_m
    call I_ary_isRowOrderaztkcsdczddok_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    external IJVect_ary_dimenmkq6xj_hp3f69_m
    call IJVect_ary_dimenmkq6xj_hp3f69_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_stridexgs_6yi5coqqt_m
    call IJVec_ary_stridexgs_6yi5coqqt_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_lowerkbvplmnj04d_9_m
    call IJVect_ary_lowerkbvplmnj04d_9_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_upper08ow7ih3x42y8_m
    call IJVect_ary_upper08ow7ih3x42y8_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_lengthcc3louz1w4k2w_m
    call IJVec_ary_lengthcc3louz1w4k2w_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    external IJVec_ary_addRefnohfyyrlgdpuq_m
    call IJVec_ary_addRefnohfyyrlgdpuq_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_IJVectorView_1d), intent(in)  :: array
    external IJ_ary_deleteRef4n7k86ka65lid_m
    call IJ_ary_deleteRef4n7k86ka65lid_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_2d), intent(out) :: array
    external IJ_ary_createColopws0tlgsr7bd_m
    call IJ_ary_createColopws0tlgsr7bd_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_2d), intent(out) :: array
    external IJ_ary_createRow2vsymjb2g8vh__m
    call IJ_ary_createRow2vsymjb2g8vh__m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_IJVectorView_2d), intent(out) :: array
    external ary_create2dCol4dvukskbt8omtb_m
    call ary_create2dCol4dvukskbt8omtb_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_IJVectorView_2d), intent(out) :: array
    external ary_create2dRowuyquleuhf2mxvj_m
    call ary_create2dRowuyquleuhf2mxvj_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_IJVectorView_2d), intent(in) :: src
    type(bHYPRE_IJVectorView_2d), intent(in) :: dest
    external IJVecto_ary_copy1isvmjr9uh5rc_m
    call IJVecto_ary_copy1isvmjr9uh5rc_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_IJVectorView_2d), intent(in)  :: src
    type(bHYPRE_IJVectorView_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJVec_ary_ensurez5izn04corvd5_m
    call IJVec_ary_ensurez5izn04corvd5_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJVect_ary_slice1b_xi7nvvtd06_m
    call IJVect_ary_slice1b_xi7nvvtd06_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_IJVectorView_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_IJVectorView_t), intent(out) :: value
    external IJVecto_ary_get29w4qcsfop4iu0_m
    call IJVecto_ary_get29w4qcsfop4iu0_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_IJVectorView_t), intent(in) :: value
    external IJVecto_ary_set2blj0tu0bnc9i3_m
    call IJVecto_ary_set2blj0tu0bnc9i3_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_IJVectorView_2d), intent(in) :: src
    type(bHYPRE_IJVectorView_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopypdu8amo15nqeu_m
    dim = 2
    call IJ_ary_smartCopypdu8amo15nqeu_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_IJVectorView_2d), intent(in)  :: array
    external ary_isColumnOrdery9bjx9vsnxav_m
    call ary_isColumnOrdery9bjx9vsnxav_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_IJVectorView_2d), intent(in)  :: array
    external I_ary_isRowOrderaztkcsdczddok_m
    call I_ary_isRowOrderaztkcsdczddok_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_IJVectorView_2d), intent(in)  :: array
    external IJVect_ary_dimenmkq6xj_hp3f69_m
    call IJVect_ary_dimenmkq6xj_hp3f69_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_stridexgs_6yi5coqqt_m
    call IJVec_ary_stridexgs_6yi5coqqt_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_lowerkbvplmnj04d_9_m
    call IJVect_ary_lowerkbvplmnj04d_9_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_upper08ow7ih3x42y8_m
    call IJVect_ary_upper08ow7ih3x42y8_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_lengthcc3louz1w4k2w_m
    call IJVec_ary_lengthcc3louz1w4k2w_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_3d), intent(out) :: array
    external IJ_ary_createColopws0tlgsr7bd_m
    call IJ_ary_createColopws0tlgsr7bd_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_3d), intent(out) :: array
    external IJ_ary_createRow2vsymjb2g8vh__m
    call IJ_ary_createRow2vsymjb2g8vh__m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_IJVectorView_3d), intent(in) :: src
    type(bHYPRE_IJVectorView_3d), intent(in) :: dest
    external IJVecto_ary_copy1isvmjr9uh5rc_m
    call IJVecto_ary_copy1isvmjr9uh5rc_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_IJVectorView_3d), intent(in)  :: src
    type(bHYPRE_IJVectorView_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJVec_ary_ensurez5izn04corvd5_m
    call IJVec_ary_ensurez5izn04corvd5_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJVect_ary_slice1b_xi7nvvtd06_m
    call IJVect_ary_slice1b_xi7nvvtd06_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_IJVectorView_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_IJVectorView_t), intent(out) :: value
    external IJVecto_ary_get3ka5hf3u437bax_m
    call IJVecto_ary_get3ka5hf3u437bax_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_IJVectorView_t), intent(in) :: value
    external IJVecto_ary_set3fu3fufnh8_4c9_m
    call IJVecto_ary_set3fu3fufnh8_4c9_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_IJVectorView_3d), intent(in) :: src
    type(bHYPRE_IJVectorView_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopypdu8amo15nqeu_m
    dim = 3
    call IJ_ary_smartCopypdu8amo15nqeu_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_IJVectorView_3d), intent(in)  :: array
    external ary_isColumnOrdery9bjx9vsnxav_m
    call ary_isColumnOrdery9bjx9vsnxav_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_IJVectorView_3d), intent(in)  :: array
    external I_ary_isRowOrderaztkcsdczddok_m
    call I_ary_isRowOrderaztkcsdczddok_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_IJVectorView_3d), intent(in)  :: array
    external IJVect_ary_dimenmkq6xj_hp3f69_m
    call IJVect_ary_dimenmkq6xj_hp3f69_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_stridexgs_6yi5coqqt_m
    call IJVec_ary_stridexgs_6yi5coqqt_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_lowerkbvplmnj04d_9_m
    call IJVect_ary_lowerkbvplmnj04d_9_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_upper08ow7ih3x42y8_m
    call IJVect_ary_upper08ow7ih3x42y8_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_lengthcc3louz1w4k2w_m
    call IJVec_ary_lengthcc3louz1w4k2w_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_4d), intent(out) :: array
    external IJ_ary_createColopws0tlgsr7bd_m
    call IJ_ary_createColopws0tlgsr7bd_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_4d), intent(out) :: array
    external IJ_ary_createRow2vsymjb2g8vh__m
    call IJ_ary_createRow2vsymjb2g8vh__m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_IJVectorView_4d), intent(in) :: src
    type(bHYPRE_IJVectorView_4d), intent(in) :: dest
    external IJVecto_ary_copy1isvmjr9uh5rc_m
    call IJVecto_ary_copy1isvmjr9uh5rc_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_IJVectorView_4d), intent(in)  :: src
    type(bHYPRE_IJVectorView_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJVec_ary_ensurez5izn04corvd5_m
    call IJVec_ary_ensurez5izn04corvd5_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJVect_ary_slice1b_xi7nvvtd06_m
    call IJVect_ary_slice1b_xi7nvvtd06_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_IJVectorView_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_IJVectorView_t), intent(out) :: value
    external IJVecto_ary_get4_fhn0djlr3bj0_m
    call IJVecto_ary_get4_fhn0djlr3bj0_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_IJVectorView_t), intent(in) :: value
    external IJVecto_ary_set44m9fhuq_jwyd9_m
    call IJVecto_ary_set44m9fhuq_jwyd9_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_IJVectorView_4d), intent(in) :: src
    type(bHYPRE_IJVectorView_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopypdu8amo15nqeu_m
    dim = 4
    call IJ_ary_smartCopypdu8amo15nqeu_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_IJVectorView_4d), intent(in)  :: array
    external ary_isColumnOrdery9bjx9vsnxav_m
    call ary_isColumnOrdery9bjx9vsnxav_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_IJVectorView_4d), intent(in)  :: array
    external I_ary_isRowOrderaztkcsdczddok_m
    call I_ary_isRowOrderaztkcsdczddok_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_IJVectorView_4d), intent(in)  :: array
    external IJVect_ary_dimenmkq6xj_hp3f69_m
    call IJVect_ary_dimenmkq6xj_hp3f69_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_stridexgs_6yi5coqqt_m
    call IJVec_ary_stridexgs_6yi5coqqt_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_lowerkbvplmnj04d_9_m
    call IJVect_ary_lowerkbvplmnj04d_9_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_upper08ow7ih3x42y8_m
    call IJVect_ary_upper08ow7ih3x42y8_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_lengthcc3louz1w4k2w_m
    call IJVec_ary_lengthcc3louz1w4k2w_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_5d), intent(out) :: array
    external IJ_ary_createColopws0tlgsr7bd_m
    call IJ_ary_createColopws0tlgsr7bd_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_5d), intent(out) :: array
    external IJ_ary_createRow2vsymjb2g8vh__m
    call IJ_ary_createRow2vsymjb2g8vh__m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_IJVectorView_5d), intent(in) :: src
    type(bHYPRE_IJVectorView_5d), intent(in) :: dest
    external IJVecto_ary_copy1isvmjr9uh5rc_m
    call IJVecto_ary_copy1isvmjr9uh5rc_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_IJVectorView_5d), intent(in)  :: src
    type(bHYPRE_IJVectorView_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJVec_ary_ensurez5izn04corvd5_m
    call IJVec_ary_ensurez5izn04corvd5_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJVect_ary_slice1b_xi7nvvtd06_m
    call IJVect_ary_slice1b_xi7nvvtd06_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_IJVectorView_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_IJVectorView_t), intent(out) :: value
    external IJVecto_ary_get55v4ldfqx3c82r_m
    call IJVecto_ary_get55v4ldfqx3c82r_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_IJVectorView_t), intent(in) :: value
    external IJVecto_ary_set5d85u5p3ncuy4__m
    call IJVecto_ary_set5d85u5p3ncuy4__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_IJVectorView_5d), intent(in) :: src
    type(bHYPRE_IJVectorView_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopypdu8amo15nqeu_m
    dim = 5
    call IJ_ary_smartCopypdu8amo15nqeu_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_IJVectorView_5d), intent(in)  :: array
    external ary_isColumnOrdery9bjx9vsnxav_m
    call ary_isColumnOrdery9bjx9vsnxav_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_IJVectorView_5d), intent(in)  :: array
    external I_ary_isRowOrderaztkcsdczddok_m
    call I_ary_isRowOrderaztkcsdczddok_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_IJVectorView_5d), intent(in)  :: array
    external IJVect_ary_dimenmkq6xj_hp3f69_m
    call IJVect_ary_dimenmkq6xj_hp3f69_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_stridexgs_6yi5coqqt_m
    call IJVec_ary_stridexgs_6yi5coqqt_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_lowerkbvplmnj04d_9_m
    call IJVect_ary_lowerkbvplmnj04d_9_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_upper08ow7ih3x42y8_m
    call IJVect_ary_upper08ow7ih3x42y8_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_lengthcc3louz1w4k2w_m
    call IJVec_ary_lengthcc3louz1w4k2w_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_6d), intent(out) :: array
    external IJ_ary_createColopws0tlgsr7bd_m
    call IJ_ary_createColopws0tlgsr7bd_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_6d), intent(out) :: array
    external IJ_ary_createRow2vsymjb2g8vh__m
    call IJ_ary_createRow2vsymjb2g8vh__m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_IJVectorView_6d), intent(in) :: src
    type(bHYPRE_IJVectorView_6d), intent(in) :: dest
    external IJVecto_ary_copy1isvmjr9uh5rc_m
    call IJVecto_ary_copy1isvmjr9uh5rc_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_IJVectorView_6d), intent(in)  :: src
    type(bHYPRE_IJVectorView_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJVec_ary_ensurez5izn04corvd5_m
    call IJVec_ary_ensurez5izn04corvd5_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJVect_ary_slice1b_xi7nvvtd06_m
    call IJVect_ary_slice1b_xi7nvvtd06_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_IJVectorView_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_IJVectorView_t), intent(out) :: value
    external IJVecto_ary_get61ky0sxq8kim7__m
    call IJVecto_ary_get61ky0sxq8kim7__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_IJVectorView_t), intent(in) :: value
    external IJVecto_ary_set623_uw0lx4vdvj_m
    call IJVecto_ary_set623_uw0lx4vdvj_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_IJVectorView_6d), intent(in) :: src
    type(bHYPRE_IJVectorView_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopypdu8amo15nqeu_m
    dim = 6
    call IJ_ary_smartCopypdu8amo15nqeu_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_IJVectorView_6d), intent(in)  :: array
    external ary_isColumnOrdery9bjx9vsnxav_m
    call ary_isColumnOrdery9bjx9vsnxav_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_IJVectorView_6d), intent(in)  :: array
    external I_ary_isRowOrderaztkcsdczddok_m
    call I_ary_isRowOrderaztkcsdczddok_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_IJVectorView_6d), intent(in)  :: array
    external IJVect_ary_dimenmkq6xj_hp3f69_m
    call IJVect_ary_dimenmkq6xj_hp3f69_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_stridexgs_6yi5coqqt_m
    call IJVec_ary_stridexgs_6yi5coqqt_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_lowerkbvplmnj04d_9_m
    call IJVect_ary_lowerkbvplmnj04d_9_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_upper08ow7ih3x42y8_m
    call IJVect_ary_upper08ow7ih3x42y8_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_lengthcc3louz1w4k2w_m
    call IJVec_ary_lengthcc3louz1w4k2w_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_7d), intent(out) :: array
    external IJ_ary_createColopws0tlgsr7bd_m
    call IJ_ary_createColopws0tlgsr7bd_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_IJVectorView_7d), intent(out) :: array
    external IJ_ary_createRow2vsymjb2g8vh__m
    call IJ_ary_createRow2vsymjb2g8vh__m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_IJVectorView_7d), intent(in) :: src
    type(bHYPRE_IJVectorView_7d), intent(in) :: dest
    external IJVecto_ary_copy1isvmjr9uh5rc_m
    call IJVecto_ary_copy1isvmjr9uh5rc_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_IJVectorView_7d), intent(in)  :: src
    type(bHYPRE_IJVectorView_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJVec_ary_ensurez5izn04corvd5_m
    call IJVec_ary_ensurez5izn04corvd5_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJVect_ary_slice1b_xi7nvvtd06_m
    call IJVect_ary_slice1b_xi7nvvtd06_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_IJVectorView_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_IJVectorView_t), intent(out) :: value
    external IJVecto_ary_get736wth6_olpb8i_m
    call IJVecto_ary_get736wth6_olpb8i_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_IJVectorView_t), intent(in) :: value
    external IJVecto_ary_set7jq4fdnpyltoay_m
    call IJVecto_ary_set7jq4fdnpyltoay_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_IJVectorView_7d), intent(in) :: src
    type(bHYPRE_IJVectorView_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopypdu8amo15nqeu_m
    dim = 7
    call IJ_ary_smartCopypdu8amo15nqeu_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_IJVectorView_7d), intent(in)  :: array
    external ary_isColumnOrdery9bjx9vsnxav_m
    call ary_isColumnOrdery9bjx9vsnxav_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_IJVectorView_7d), intent(in)  :: array
    external I_ary_isRowOrderaztkcsdczddok_m
    call I_ary_isRowOrderaztkcsdczddok_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_IJVectorView_7d), intent(in)  :: array
    external IJVect_ary_dimenmkq6xj_hp3f69_m
    call IJVect_ary_dimenmkq6xj_hp3f69_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_stridexgs_6yi5coqqt_m
    call IJVec_ary_stridexgs_6yi5coqqt_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_lowerkbvplmnj04d_9_m
    call IJVect_ary_lowerkbvplmnj04d_9_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVect_ary_upper08ow7ih3x42y8_m
    call IJVect_ary_upper08ow7ih3x42y8_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJVec_ary_lengthcc3louz1w4k2w_m
    call IJVec_ary_lengthcc3louz1w4k2w_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_IJVectormku0kftws9_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJVectorView_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJVectormku0kftws9_p

  subroutine castbHYPRE_IJVectore9cun3ggq8_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJVectorView_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJVectore9cun3ggq8_p

  subroutine castbHYPRE_IJVector_24b_qfddr_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJVectorView_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJVector_24b_qfddr_p

  subroutine castbHYPRE_IJVectorcpye5k_rde_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJVectorView_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJVectorcpye5k_rde_p

  subroutine castbHYPRE_IJVector49_x31bvls_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJVectorView_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJVector49_x31bvls_p

  subroutine castbHYPRE_IJVector7vusljzpyd_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJVectorView_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJVector7vusljzpyd_p

  subroutine castbHYPRE_IJVector7xvtebu25f_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJVectorView_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJVector7xvtebu25f_p


end module bHYPRE_IJVectorView_array
