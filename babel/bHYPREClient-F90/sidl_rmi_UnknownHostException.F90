! 
! File:          sidl_rmi_UnknownHostException.F90
! Symbol:        sidl.rmi.UnknownHostException-v0.9.15
! Symbol Type:   class
! Babel Version: 1.0.0
! Release:       $Name$
! Revision:      @(#) $Id$
! Description:   Client-side module for sidl.rmi.UnknownHostException
! 
...
module sidl_rmi_UnknownHostException

  use sidl
  use sidl_SIDLException_type
  use sidl_rmi_UnknownHostException_type
...
contains
  ...
  recursive subroutine newLocal_s(retval, exception)
    implicit none
    !  out sidl.rmi.UnknownHostException retval
    type(sidl_rmi_UnknownHostException_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_UnknownHostException_newLocal_m
    call sidl_rmi_UnknownHostException_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    implicit none
    !  out sidl.rmi.UnknownHostException self
    type(sidl_rmi_UnknownHostException_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_UnknownHostException_newRemote_m
    call sidl_rmi_UnknownHostException_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external sidl_rmi_UnknownHostException_rConnect_m
    call sidl_rmi_UnknownHostException_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    implicit none
    !  in sidl.rmi.UnknownHostException self
    type(sidl_rmi_UnknownHostException_t) , intent(in) :: self
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_UnknownHostException_addRef_m
    call sidl_rmi_UnknownHostException_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_rmi_UnknownHostException_deleteRef_m
    call sidl_rmi_UnknownHostException_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_rmi_UnknownHostException_isSame_m
    call sidl_rmi_UnknownHostException_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_rmi_UnknownHostException_isType_m
    call sidl_rmi_UnknownHostException_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_rmi_UnknownHostException_getClassInfo_m
    call sidl_rmi_UnknownHostException_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine getNote_s(self, retval, exception)
    ...
    external sidl_rmi_UnknownHostException_getNote_m
    call sidl_rmi_UnknownHostException_getNote_m(self, retval, exception)
  ...
  recursive subroutine setNote_s(self, message, exception)
    ...
    external sidl_rmi_UnknownHostException_setNote_m
    call sidl_rmi_UnknownHostException_setNote_m(self, message, exception)
  ...
  recursive subroutine getTrace_s(self, retval, exception)
    ...
    external sidl_rmi_UnknownHostException_getTrace_m
    call sidl_rmi_UnknownHostException_getTrace_m(self, retval, exception)
  ...
  recursive subroutine addLine_s(self, traceline, exception)
    ...
    external sidl_rmi_UnknownHostException_addLine_m
    call sidl_rmi_UnknownHostException_addLine_m(self, traceline, exception)
  ...
  recursive subroutine add_s(self, filename, lineno, methodname, exception)
    ...
    external sidl_rmi_UnknownHostException_add_m
    call sidl_rmi_UnknownHostException_add_m(self, filename, lineno,           &
  ...
  recursive subroutine getHopCount_s(self, retval, exception)
    ...
    external sidl_rmi_UnknownHostException_getHopCount_m
    call sidl_rmi_UnknownHostException_getHopCount_m(self, retval, exception)
  ...
  recursive subroutine packObj_s(self, ser, exception)
    ...
    external sidl_rmi_UnknownHostException_packObj_m
    call sidl_rmi_UnknownHostException_packObj_m(self, ser, exception)
  ...
  recursive subroutine unpackObj_s(self, des, exception)
    ...
    external sidl_rmi_UnknownHostException_unpackObj_m
    call sidl_rmi_UnknownHostException_unpackObj_m(self, des, exception)

  end subroutine unpackObj_s

  ! 
  ! Static function to cast from sidl.rmi.UnknownHostException
  ! to sidl.BaseClass.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(sidl_rmi_UnknownHostException_t), intent(in) :: oldType
  ...
  ! to sidl.rmi.UnknownHostException.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseClass_t), intent(in) :: oldType
    type(sidl_rmi_UnknownHostException_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_UnknownHostException__cast_m

    call sidl_rmi_UnknownHostException__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_rmi_UnknownHostException__exec_m
    call sidl_rmi_UnknownHostException__exec_m(self, methodName, inArgs,       &
      outArgs, exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_rmi_UnknownHostException__getURL_m
    call sidl_rmi_UnknownHostException__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_rmi_UnknownHostException__isRemote_m
    call sidl_rmi_UnknownHostException__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_rmi_UnknownHostException__isLocal_m
    call sidl_rmi_UnknownHostException__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_rmi_UnknownHostException__set_hooks_m
    call sidl_rmi_UnknownHostException__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(sidl_rmi_UnknownHostException_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_rmi_UnknownHostException_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_rmi_UnknownHostException

module sidl_rmi_UnknownHostException_array
  use sidl
  use sidl_rmi_UnknownHostException_type
  use sidl_array_type
  ...
  private :: &
    castsidl_rmi_Unknowatcaaz1asv_p, &
    castsidl_rmi_Unknowizcanq645v_p, &
    castsidl_rmi_Unknowqyne16mqwq_p, &
    castsidl_rmi_Unknow0wjckwwqkx_p, &
    castsidl_rmi_Unknowrnu1iguccu_p, &
    castsidl_rmi_Unknowfo913xhne1_p, &
    castsidl_rmi_Unknowclxilt8qpr_p
interface cast
  module procedure &
    castsidl_rmi_Unknowatcaaz1asv_p, &
    castsidl_rmi_Unknowizcanq645v_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_1d), intent(out) :: array
    external Un_ary_createColbv8ss7x0jy5q9_m
    call Un_ary_createColbv8ss7x0jy5q9_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_rmi_UnknownHostException_1d), intent(out) :: array
    external Un_ary_createRow0zzmn2rghaq71_m
    call Un_ary_createRow0zzmn2rghaq71_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_rmi_UnknownHostException_1d), intent(out) :: array
    external Unk_ary_create1dyvdjwku9s3r9p_m
    call Unk_ary_create1dyvdjwku9s3r9p_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_rmi_UnknownHostException_1d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_1d), intent(in) :: dest
    external Unknown_ary_copy_gk7hi_dtrtys_m
    call Unknown_ary_copy_gk7hi_dtrtys_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: src
    type(sidl_rmi_UnknownHostException_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Unkno_ary_ensurer7tmgwjw4zvyz_m
    call Unkno_ary_ensurer7tmgwjw4zvyz_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Unknow_ary_slicefhr669_mcvh4i_m
    call Unknow_ary_slicefhr669_mcvh4i_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_UnknownHostException_t), intent(out) :: value
    external UnknownH_ary_getgh5m7sig19bdd_m
    call UnknownH_ary_getgh5m7sig19bdd_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_UnknownHostException_t), intent(in) :: value
    external UnknownH_ary_setjd64bsldrrgvi_m
    call UnknownH_ary_setjd64bsldrrgvi_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_rmi_UnknownHostException_t), intent(out) :: value
    external Unknown_ary_get1rh2087bki0fej_m
    call Unknown_ary_get1rh2087bki0fej_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_rmi_UnknownHostException_t), intent(in) :: value
    external Unknown_ary_set1heq3s5_t30bqp_m
    call Unknown_ary_set1heq3s5_t30bqp_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_rmi_UnknownHostException_1d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Un_ary_smartCopydyccobuo_1z7c_m
    dim = 1
    call Un_ary_smartCopydyccobuo_1z7c_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    external ary_isColumnOrder9da2r7ear_ir_m
    call ary_isColumnOrder9da2r7ear_ir_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    external U_ary_isRowOrderffe8ovl8mr_lf_m
    call U_ary_isRowOrderffe8ovl8mr_lf_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    external Unknow_ary_dimencbk3535od5bgj_m
    call Unknow_ary_dimencbk3535od5bgj_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_strideonifc714vpsrx_m
    call Unkno_ary_strideonifc714vpsrx_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_lowerimiqole0ynu7t_m
    call Unknow_ary_lowerimiqole0ynu7t_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_uppervph6dftgo5bvs_m
    call Unknow_ary_uppervph6dftgo5bvs_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_lengthxntoxvtphfjqp_m
    call Unkno_ary_lengthxntoxvtphfjqp_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    external Unkno_ary_addRef5yq5bvd5d_f45_m
    call Unkno_ary_addRef5yq5bvd5d_f45_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_rmi_UnknownHostException_1d), intent(in)  :: array
    external Un_ary_deleteRefbm333hqz8_uyw_m
    call Un_ary_deleteRefbm333hqz8_uyw_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_2d), intent(out) :: array
    external Un_ary_createColbv8ss7x0jy5q9_m
    call Un_ary_createColbv8ss7x0jy5q9_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_2d), intent(out) :: array
    external Un_ary_createRow0zzmn2rghaq71_m
    call Un_ary_createRow0zzmn2rghaq71_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_UnknownHostException_2d), intent(out) :: array
    external ary_create2dCol_an81cs3qjcug4_m
    call ary_create2dCol_an81cs3qjcug4_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_UnknownHostException_2d), intent(out) :: array
    external ary_create2dRow8nhvztax4u2z7b_m
    call ary_create2dRow8nhvztax4u2z7b_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_rmi_UnknownHostException_2d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_2d), intent(in) :: dest
    external Unknown_ary_copy_gk7hi_dtrtys_m
    call Unknown_ary_copy_gk7hi_dtrtys_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_rmi_UnknownHostException_2d), intent(in)  :: src
    type(sidl_rmi_UnknownHostException_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Unkno_ary_ensurer7tmgwjw4zvyz_m
    call Unkno_ary_ensurer7tmgwjw4zvyz_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Unknow_ary_slicefhr669_mcvh4i_m
    call Unknow_ary_slicefhr669_mcvh4i_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_rmi_UnknownHostException_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_rmi_UnknownHostException_t), intent(out) :: value
    external Unknown_ary_get20tl_5auz3twbp_m
    call Unknown_ary_get20tl_5auz3twbp_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_rmi_UnknownHostException_t), intent(in) :: value
    external Unknown_ary_set2a2qio7mc7pq01_m
    call Unknown_ary_set2a2qio7mc7pq01_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_rmi_UnknownHostException_2d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Un_ary_smartCopydyccobuo_1z7c_m
    dim = 2
    call Un_ary_smartCopydyccobuo_1z7c_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_rmi_UnknownHostException_2d), intent(in)  :: array
    external ary_isColumnOrder9da2r7ear_ir_m
    call ary_isColumnOrder9da2r7ear_ir_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_rmi_UnknownHostException_2d), intent(in)  :: array
    external U_ary_isRowOrderffe8ovl8mr_lf_m
    call U_ary_isRowOrderffe8ovl8mr_lf_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_rmi_UnknownHostException_2d), intent(in)  :: array
    external Unknow_ary_dimencbk3535od5bgj_m
    call Unknow_ary_dimencbk3535od5bgj_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_strideonifc714vpsrx_m
    call Unkno_ary_strideonifc714vpsrx_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_lowerimiqole0ynu7t_m
    call Unknow_ary_lowerimiqole0ynu7t_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_uppervph6dftgo5bvs_m
    call Unknow_ary_uppervph6dftgo5bvs_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_lengthxntoxvtphfjqp_m
    call Unkno_ary_lengthxntoxvtphfjqp_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_3d), intent(out) :: array
    external Un_ary_createColbv8ss7x0jy5q9_m
    call Un_ary_createColbv8ss7x0jy5q9_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_3d), intent(out) :: array
    external Un_ary_createRow0zzmn2rghaq71_m
    call Un_ary_createRow0zzmn2rghaq71_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_rmi_UnknownHostException_3d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_3d), intent(in) :: dest
    external Unknown_ary_copy_gk7hi_dtrtys_m
    call Unknown_ary_copy_gk7hi_dtrtys_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_rmi_UnknownHostException_3d), intent(in)  :: src
    type(sidl_rmi_UnknownHostException_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Unkno_ary_ensurer7tmgwjw4zvyz_m
    call Unkno_ary_ensurer7tmgwjw4zvyz_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Unknow_ary_slicefhr669_mcvh4i_m
    call Unknow_ary_slicefhr669_mcvh4i_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_rmi_UnknownHostException_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_rmi_UnknownHostException_t), intent(out) :: value
    external Unknown_ary_get3fvcmptqhx2938_m
    call Unknown_ary_get3fvcmptqhx2938_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_rmi_UnknownHostException_t), intent(in) :: value
    external Unknown_ary_set30max4c34m4yhh_m
    call Unknown_ary_set30max4c34m4yhh_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_rmi_UnknownHostException_3d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Un_ary_smartCopydyccobuo_1z7c_m
    dim = 3
    call Un_ary_smartCopydyccobuo_1z7c_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_rmi_UnknownHostException_3d), intent(in)  :: array
    external ary_isColumnOrder9da2r7ear_ir_m
    call ary_isColumnOrder9da2r7ear_ir_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_rmi_UnknownHostException_3d), intent(in)  :: array
    external U_ary_isRowOrderffe8ovl8mr_lf_m
    call U_ary_isRowOrderffe8ovl8mr_lf_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_rmi_UnknownHostException_3d), intent(in)  :: array
    external Unknow_ary_dimencbk3535od5bgj_m
    call Unknow_ary_dimencbk3535od5bgj_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_strideonifc714vpsrx_m
    call Unkno_ary_strideonifc714vpsrx_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_lowerimiqole0ynu7t_m
    call Unknow_ary_lowerimiqole0ynu7t_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_uppervph6dftgo5bvs_m
    call Unknow_ary_uppervph6dftgo5bvs_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_lengthxntoxvtphfjqp_m
    call Unkno_ary_lengthxntoxvtphfjqp_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_4d), intent(out) :: array
    external Un_ary_createColbv8ss7x0jy5q9_m
    call Un_ary_createColbv8ss7x0jy5q9_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_4d), intent(out) :: array
    external Un_ary_createRow0zzmn2rghaq71_m
    call Un_ary_createRow0zzmn2rghaq71_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_rmi_UnknownHostException_4d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_4d), intent(in) :: dest
    external Unknown_ary_copy_gk7hi_dtrtys_m
    call Unknown_ary_copy_gk7hi_dtrtys_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_rmi_UnknownHostException_4d), intent(in)  :: src
    type(sidl_rmi_UnknownHostException_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Unkno_ary_ensurer7tmgwjw4zvyz_m
    call Unkno_ary_ensurer7tmgwjw4zvyz_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Unknow_ary_slicefhr669_mcvh4i_m
    call Unknow_ary_slicefhr669_mcvh4i_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_rmi_UnknownHostException_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_rmi_UnknownHostException_t), intent(out) :: value
    external Unknown_ary_get4nmi25rlfjx9oh_m
    call Unknown_ary_get4nmi25rlfjx9oh_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_rmi_UnknownHostException_t), intent(in) :: value
    external Unknown_ary_set4ziex65_e3_j55_m
    call Unknown_ary_set4ziex65_e3_j55_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_rmi_UnknownHostException_4d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Un_ary_smartCopydyccobuo_1z7c_m
    dim = 4
    call Un_ary_smartCopydyccobuo_1z7c_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_rmi_UnknownHostException_4d), intent(in)  :: array
    external ary_isColumnOrder9da2r7ear_ir_m
    call ary_isColumnOrder9da2r7ear_ir_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_rmi_UnknownHostException_4d), intent(in)  :: array
    external U_ary_isRowOrderffe8ovl8mr_lf_m
    call U_ary_isRowOrderffe8ovl8mr_lf_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_rmi_UnknownHostException_4d), intent(in)  :: array
    external Unknow_ary_dimencbk3535od5bgj_m
    call Unknow_ary_dimencbk3535od5bgj_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_strideonifc714vpsrx_m
    call Unkno_ary_strideonifc714vpsrx_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_lowerimiqole0ynu7t_m
    call Unknow_ary_lowerimiqole0ynu7t_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_uppervph6dftgo5bvs_m
    call Unknow_ary_uppervph6dftgo5bvs_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_lengthxntoxvtphfjqp_m
    call Unkno_ary_lengthxntoxvtphfjqp_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_5d), intent(out) :: array
    external Un_ary_createColbv8ss7x0jy5q9_m
    call Un_ary_createColbv8ss7x0jy5q9_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_5d), intent(out) :: array
    external Un_ary_createRow0zzmn2rghaq71_m
    call Un_ary_createRow0zzmn2rghaq71_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_rmi_UnknownHostException_5d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_5d), intent(in) :: dest
    external Unknown_ary_copy_gk7hi_dtrtys_m
    call Unknown_ary_copy_gk7hi_dtrtys_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_rmi_UnknownHostException_5d), intent(in)  :: src
    type(sidl_rmi_UnknownHostException_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Unkno_ary_ensurer7tmgwjw4zvyz_m
    call Unkno_ary_ensurer7tmgwjw4zvyz_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Unknow_ary_slicefhr669_mcvh4i_m
    call Unknow_ary_slicefhr669_mcvh4i_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_rmi_UnknownHostException_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_rmi_UnknownHostException_t), intent(out) :: value
    external Unknown_ary_get5phnxx2850sfd2_m
    call Unknown_ary_get5phnxx2850sfd2_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_rmi_UnknownHostException_t), intent(in) :: value
    external Unknown_ary_set5rc53rsre4yfo8_m
    call Unknown_ary_set5rc53rsre4yfo8_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_rmi_UnknownHostException_5d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Un_ary_smartCopydyccobuo_1z7c_m
    dim = 5
    call Un_ary_smartCopydyccobuo_1z7c_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_rmi_UnknownHostException_5d), intent(in)  :: array
    external ary_isColumnOrder9da2r7ear_ir_m
    call ary_isColumnOrder9da2r7ear_ir_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_rmi_UnknownHostException_5d), intent(in)  :: array
    external U_ary_isRowOrderffe8ovl8mr_lf_m
    call U_ary_isRowOrderffe8ovl8mr_lf_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_rmi_UnknownHostException_5d), intent(in)  :: array
    external Unknow_ary_dimencbk3535od5bgj_m
    call Unknow_ary_dimencbk3535od5bgj_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_strideonifc714vpsrx_m
    call Unkno_ary_strideonifc714vpsrx_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_lowerimiqole0ynu7t_m
    call Unknow_ary_lowerimiqole0ynu7t_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_uppervph6dftgo5bvs_m
    call Unknow_ary_uppervph6dftgo5bvs_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_lengthxntoxvtphfjqp_m
    call Unkno_ary_lengthxntoxvtphfjqp_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_6d), intent(out) :: array
    external Un_ary_createColbv8ss7x0jy5q9_m
    call Un_ary_createColbv8ss7x0jy5q9_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_6d), intent(out) :: array
    external Un_ary_createRow0zzmn2rghaq71_m
    call Un_ary_createRow0zzmn2rghaq71_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_rmi_UnknownHostException_6d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_6d), intent(in) :: dest
    external Unknown_ary_copy_gk7hi_dtrtys_m
    call Unknown_ary_copy_gk7hi_dtrtys_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_rmi_UnknownHostException_6d), intent(in)  :: src
    type(sidl_rmi_UnknownHostException_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Unkno_ary_ensurer7tmgwjw4zvyz_m
    call Unkno_ary_ensurer7tmgwjw4zvyz_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Unknow_ary_slicefhr669_mcvh4i_m
    call Unknow_ary_slicefhr669_mcvh4i_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_rmi_UnknownHostException_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_rmi_UnknownHostException_t), intent(out) :: value
    external Unknown_ary_get6lfo_zzgyxtp41_m
    call Unknown_ary_get6lfo_zzgyxtp41_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_rmi_UnknownHostException_t), intent(in) :: value
    external Unknown_ary_set627tj77isxwxtt_m
    call Unknown_ary_set627tj77isxwxtt_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_rmi_UnknownHostException_6d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Un_ary_smartCopydyccobuo_1z7c_m
    dim = 6
    call Un_ary_smartCopydyccobuo_1z7c_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_rmi_UnknownHostException_6d), intent(in)  :: array
    external ary_isColumnOrder9da2r7ear_ir_m
    call ary_isColumnOrder9da2r7ear_ir_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_rmi_UnknownHostException_6d), intent(in)  :: array
    external U_ary_isRowOrderffe8ovl8mr_lf_m
    call U_ary_isRowOrderffe8ovl8mr_lf_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_rmi_UnknownHostException_6d), intent(in)  :: array
    external Unknow_ary_dimencbk3535od5bgj_m
    call Unknow_ary_dimencbk3535od5bgj_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_strideonifc714vpsrx_m
    call Unkno_ary_strideonifc714vpsrx_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_lowerimiqole0ynu7t_m
    call Unknow_ary_lowerimiqole0ynu7t_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_uppervph6dftgo5bvs_m
    call Unknow_ary_uppervph6dftgo5bvs_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_lengthxntoxvtphfjqp_m
    call Unkno_ary_lengthxntoxvtphfjqp_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_7d), intent(out) :: array
    external Un_ary_createColbv8ss7x0jy5q9_m
    call Un_ary_createColbv8ss7x0jy5q9_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_rmi_UnknownHostException_7d), intent(out) :: array
    external Un_ary_createRow0zzmn2rghaq71_m
    call Un_ary_createRow0zzmn2rghaq71_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_rmi_UnknownHostException_7d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_7d), intent(in) :: dest
    external Unknown_ary_copy_gk7hi_dtrtys_m
    call Unknown_ary_copy_gk7hi_dtrtys_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_rmi_UnknownHostException_7d), intent(in)  :: src
    type(sidl_rmi_UnknownHostException_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Unkno_ary_ensurer7tmgwjw4zvyz_m
    call Unkno_ary_ensurer7tmgwjw4zvyz_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Unknow_ary_slicefhr669_mcvh4i_m
    call Unknow_ary_slicefhr669_mcvh4i_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_rmi_UnknownHostException_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_rmi_UnknownHostException_t), intent(out) :: value
    external Unknown_ary_get7vjiux3t16s4zw_m
    call Unknown_ary_get7vjiux3t16s4zw_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_rmi_UnknownHostException_t), intent(in) :: value
    external Unknown_ary_set7awa5hu76z30k2_m
    call Unknown_ary_set7awa5hu76z30k2_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_rmi_UnknownHostException_7d), intent(in) :: src
    type(sidl_rmi_UnknownHostException_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Un_ary_smartCopydyccobuo_1z7c_m
    dim = 7
    call Un_ary_smartCopydyccobuo_1z7c_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_rmi_UnknownHostException_7d), intent(in)  :: array
    external ary_isColumnOrder9da2r7ear_ir_m
    call ary_isColumnOrder9da2r7ear_ir_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_rmi_UnknownHostException_7d), intent(in)  :: array
    external U_ary_isRowOrderffe8ovl8mr_lf_m
    call U_ary_isRowOrderffe8ovl8mr_lf_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_rmi_UnknownHostException_7d), intent(in)  :: array
    external Unknow_ary_dimencbk3535od5bgj_m
    call Unknow_ary_dimencbk3535od5bgj_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_strideonifc714vpsrx_m
    call Unkno_ary_strideonifc714vpsrx_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_lowerimiqole0ynu7t_m
    call Unknow_ary_lowerimiqole0ynu7t_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unknow_ary_uppervph6dftgo5bvs_m
    call Unknow_ary_uppervph6dftgo5bvs_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Unkno_ary_lengthxntoxvtphfjqp_m
    call Unkno_ary_lengthxntoxvtphfjqp_m(array, index, length7_p)
  ...
  subroutine castsidl_rmi_Unknowatcaaz1asv_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_UnknownHostException_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Unknowatcaaz1asv_p

  subroutine castsidl_rmi_Unknowizcanq645v_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_UnknownHostException_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Unknowizcanq645v_p

  subroutine castsidl_rmi_Unknowqyne16mqwq_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_UnknownHostException_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Unknowqyne16mqwq_p

  subroutine castsidl_rmi_Unknow0wjckwwqkx_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_UnknownHostException_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Unknow0wjckwwqkx_p

  subroutine castsidl_rmi_Unknowrnu1iguccu_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_UnknownHostException_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Unknowrnu1iguccu_p

  subroutine castsidl_rmi_Unknowfo913xhne1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_UnknownHostException_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Unknowfo913xhne1_p

  subroutine castsidl_rmi_Unknowclxilt8qpr_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_UnknownHostException_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Unknowclxilt8qpr_p


end module sidl_rmi_UnknownHostException_array
