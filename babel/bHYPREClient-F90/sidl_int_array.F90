...
module sidl_int_array
  ...
  type sidl_int_1d
    ...
    integer (kind=sidl_int), pointer, &
      dimension(:) :: d_data
  end type sidl_int_1d
  ...
  private :: &
    castsidl_int1dToGeneric_p, &
    castsidl_int2dToGeneric_p, &
    castsidl_int3dToGeneric_p, &
    castsidl_int4dToGeneric_p, &
    castsidl_int5dToGeneric_p, &
    castsidl_int6dToGeneric_p, &
    castsidl_int7dToGeneric_p

    private :: &
      castGenericTosidl_int1d_p, &
      castGenericTosidl_int2d_p, &
      castGenericTosidl_int3d_p, &
      castGenericTosidl_int4d_p, &
      castGenericTosidl_int5d_p, &
      castGenericTosidl_int6d_p, &
      castGenericTosidl_int7d_p
  interface cast
    module procedure &
      castsidl_int1dToGeneric_p, &
      castsidl_int2dToGeneric_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_int_1d), intent(out) :: array
  ...
  subroutine copy1_p(src, dest)
    type(sidl_int_1d), intent(in) :: src
    type(sidl_int_1d), intent(in) :: dest
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_int_1d), intent(in) :: src
    type(sidl_int_1d), intent(out) :: dest
  ...
  subroutine access1_p(array, ref, low, up, str, index)
    implicit none
    type(sidl_int_1d), intent(in) :: array
    integer (kind=sidl_int), dimension(1), intent(in) :: ref
    integer (kind=sidl_int), intent(out), dimension(:) :: low, up, str
    integer (kind=sidl_int), intent(out) :: index
    external sidl_int__array_access_m
    call sidl_int__array_access_m(array, ref, low, up, str, index)
  end subroutine access1_p
  subroutine borrow1_p(first, low, up, astr, result)
    integer (kind=sidl_int), intent(in) :: first
    integer (kind=sidl_int), dimension(1), intent(in) :: low, up, astr
    type(sidl_int_1d), intent(out) :: result
    external sidl_int__array_borrow_m
    call sidl_int__array_borrow_m(first, 1, low, up, astr, result)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_int_2d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy2_p(src, dest)
    type(sidl_int_2d), intent(in) :: src
    type(sidl_int_2d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_int_2d), intent(in) :: src
    type(sidl_int_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 2
  ...
  subroutine borrow2_p(first, low, up, astr, result)
    ...
    type(sidl_int_2d), intent(out) :: result
    external sidl_int__array_borrow_m
    call sidl_int__array_borrow_m(first, 2, low, up, astr, result)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_int_3d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy3_p(src, dest)
    type(sidl_int_3d), intent(in) :: src
    type(sidl_int_3d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_int_3d), intent(in)  :: src
    type(sidl_int_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_int_3d), intent(in) :: src
    type(sidl_int_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 3
  ...
  subroutine borrow3_p(first, low, up, astr, result)
    ...
    type(sidl_int_3d), intent(out) :: result
    external sidl_int__array_borrow_m
    call sidl_int__array_borrow_m(first, 3, low, up, astr, result)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_int_4d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy4_p(src, dest)
    type(sidl_int_4d), intent(in) :: src
    type(sidl_int_4d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_int_4d), intent(in)  :: src
    type(sidl_int_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_int_4d), intent(in) :: src
    type(sidl_int_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 4
  ...
  subroutine borrow4_p(first, low, up, astr, result)
    ...
    type(sidl_int_4d), intent(out) :: result
    external sidl_int__array_borrow_m
    call sidl_int__array_borrow_m(first, 4, low, up, astr, result)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_int_5d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy5_p(src, dest)
    type(sidl_int_5d), intent(in) :: src
    type(sidl_int_5d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_int_5d), intent(in)  :: src
    type(sidl_int_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg5_p(array, index, value)
    type(sidl_int_5d), intent(in)  :: array
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_int_5d), intent(in) :: src
    type(sidl_int_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 5
  ...
  subroutine borrow5_p(first, low, up, astr, result)
    ...
    type(sidl_int_5d), intent(out) :: result
    external sidl_int__array_borrow_m
    call sidl_int__array_borrow_m(first, 5, low, up, astr, result)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_int_6d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy6_p(src, dest)
    type(sidl_int_6d), intent(in) :: src
    type(sidl_int_6d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_int_6d), intent(in)  :: src
    type(sidl_int_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg6_p(array, index, value)
    type(sidl_int_6d), intent(in)  :: array
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_int_6d), intent(in) :: src
    type(sidl_int_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 6
  ...
  subroutine borrow6_p(first, low, up, astr, result)
    ...
    type(sidl_int_6d), intent(out) :: result
    external sidl_int__array_borrow_m
    call sidl_int__array_borrow_m(first, 6, low, up, astr, result)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_int_7d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy7_p(src, dest)
    type(sidl_int_7d), intent(in) :: src
    type(sidl_int_7d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_int_7d), intent(in)  :: src
    type(sidl_int_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg7_p(array, index, value)
    type(sidl_int_7d), intent(in)  :: array
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_int_7d), intent(in) :: src
    type(sidl_int_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 7
  ...
  subroutine borrow7_p(first, low, up, astr, result)
    ...
    type(sidl_int_7d), intent(out) :: result
    external sidl_int__array_borrow_m
    call sidl_int__array_borrow_m(first, 7, low, up, astr, result)
  end subroutine borrow7_p

  subroutine castsidl_int1dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_int_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_int1dToGeneric_p

  subroutine castsidl_int2dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_int_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_int2dToGeneric_p

  subroutine castsidl_int3dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_int_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_int3dToGeneric_p

  subroutine castsidl_int4dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_int_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_int4dToGeneric_p

  subroutine castsidl_int5dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_int_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_int5dToGeneric_p

  subroutine castsidl_int6dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_int_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_int6dToGeneric_p

  subroutine castsidl_int7dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_int_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_int7dToGeneric_p


  subroutine castGenericTosidl_int1d_p(oldType, newType)
    type(sidl__array), intent(in) :: oldType
    type(sidl_int_1d), intent(out) :: newType
    external sidl_int__array_cast_m
    call sidl_int__array_cast_m(oldType%d_array, 1, newType)
  end subroutine castGenericTosidl_int1d_p

  subroutine castGenericTosidl_int2d_p(oldType, newType)
    type(sidl__array), intent(in) :: oldType
    type(sidl_int_2d), intent(out) :: newType
    external sidl_int__array_cast_m
    call sidl_int__array_cast_m(oldType%d_array, 2, newType)
  end subroutine castGenericTosidl_int2d_p

  subroutine castGenericTosidl_int3d_p(oldType, newType)
    type(sidl__array), intent(in) :: oldType
    type(sidl_int_3d), intent(out) :: newType
    external sidl_int__array_cast_m
    call sidl_int__array_cast_m(oldType%d_array, 3, newType)
  end subroutine castGenericTosidl_int3d_p

  subroutine castGenericTosidl_int4d_p(oldType, newType)
    type(sidl__array), intent(in) :: oldType
    type(sidl_int_4d), intent(out) :: newType
    external sidl_int__array_cast_m
    call sidl_int__array_cast_m(oldType%d_array, 4, newType)
  end subroutine castGenericTosidl_int4d_p

  subroutine castGenericTosidl_int5d_p(oldType, newType)
    type(sidl__array), intent(in) :: oldType
    type(sidl_int_5d), intent(out) :: newType
    external sidl_int__array_cast_m
    call sidl_int__array_cast_m(oldType%d_array, 5, newType)
  end subroutine castGenericTosidl_int5d_p

  subroutine castGenericTosidl_int6d_p(oldType, newType)
    type(sidl__array), intent(in) :: oldType
    type(sidl_int_6d), intent(out) :: newType
    external sidl_int__array_cast_m
    call sidl_int__array_cast_m(oldType%d_array, 6, newType)
  end subroutine castGenericTosidl_int6d_p

  subroutine castGenericTosidl_int7d_p(oldType, newType)
    type(sidl__array), intent(in) :: oldType
    type(sidl_int_7d), intent(out) :: newType
    external sidl_int__array_cast_m
    call sidl_int__array_cast_m(oldType%d_array, 7, newType)
  end subroutine castGenericTosidl_int7d_p


end module sidl_int_array
