! 
! File:          bHYPRE_CoefficientAccess.F90
...
module bHYPRE_CoefficientAccess

  use sidl
  use bHYPRE_CoefficientAccess_type
...
contains
  ...
  recursive subroutine GetRow_s(self, row, size, col_ind, values, retval,      &
    exception)
    implicit none
    !  in bHYPRE.CoefficientAccess self
    type(bHYPRE_CoefficientAccess_t) , intent(in) :: self
    !  in int row
    integer (kind=sidl_int) , intent(in) :: row
    !  out int size
    integer (kind=sidl_int) , intent(out) :: size
    !  out array<int,column-major> col_ind
    type(sidl_int_1d) , intent(out) :: col_ind
    !  out array<double,column-major> values
    type(sidl_double_1d) , intent(out) :: values
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_CoefficientAccess_GetRow_m
    call bHYPRE_CoefficientAccess_GetRow_m(self, row, size, col_ind, values,   &
      retval, exception)

  end subroutine GetRow_s


  recursive subroutine rConnect_s(self, url, exception)
    implicit none
    !  out bHYPRE.CoefficientAccess self
    type(bHYPRE_CoefficientAccess_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_CoefficientAccess_rConnect_m
    call bHYPRE_CoefficientAccess_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_CoefficientAccess_addRef_m
    call bHYPRE_CoefficientAccess_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_CoefficientAccess_deleteRef_m
    call bHYPRE_CoefficientAccess_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_CoefficientAccess_isSame_m
    call bHYPRE_CoefficientAccess_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_CoefficientAccess_isType_m
    call bHYPRE_CoefficientAccess_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_CoefficientAccess_getClassInfo_m
    call bHYPRE_CoefficientAccess_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.CoefficientAccess
  ! to sidl.BaseInterface.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_CoefficientAccess_t), intent(in) :: oldType
  ...
  ! to bHYPRE.CoefficientAccess.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseInterface_t), intent(in) :: oldType
    type(bHYPRE_CoefficientAccess_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_CoefficientAccess__cast_m

    call bHYPRE_CoefficientAccess__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_CoefficientAccess__exec_m
    call bHYPRE_CoefficientAccess__exec_m(self, methodName, inArgs, outArgs,   &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_CoefficientAccess__getURL_m
    call bHYPRE_CoefficientAccess__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_CoefficientAccess__isRemote_m
    call bHYPRE_CoefficientAccess__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_CoefficientAccess__isLocal_m
    call bHYPRE_CoefficientAccess__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_CoefficientAccess__set_hooks_m
    call bHYPRE_CoefficientAccess__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_CoefficientAccess_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_CoefficientAccess_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_CoefficientAccess

module bHYPRE_CoefficientAccess_array
  use sidl
  use bHYPRE_CoefficientAccess_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_Coefficigzhyynx3d8_p, &
    castbHYPRE_Coefficigaz0mcta1e_p, &
    castbHYPRE_Coefficilfwzhj4anv_p, &
    castbHYPRE_Coeffici2a1t9c176c_p, &
    castbHYPRE_Coefficiagckx27_pr_p, &
    castbHYPRE_Coefficixqpcbmw76x_p, &
    castbHYPRE_Coefficip5j3bdaetv_p
interface cast
  module procedure &
    castbHYPRE_Coefficigzhyynx3d8_p, &
    castbHYPRE_Coefficigaz0mcta1e_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_1d), intent(out) :: array
    external Co_ary_createColczevkk97g_f1v_m
    call Co_ary_createColczevkk97g_f1v_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_CoefficientAccess_1d), intent(out) :: array
    external Co_ary_createRowphh58aytg5h8v_m
    call Co_ary_createRowphh58aytg5h8v_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_CoefficientAccess_1d), intent(out) :: array
    external Coe_ary_create1d15wany32yqypz_m
    call Coe_ary_create1d15wany32yqypz_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_CoefficientAccess_1d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_1d), intent(in) :: dest
    external Coeffic_ary_copyhefbdqxcihl0o_m
    call Coeffic_ary_copyhefbdqxcihl0o_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: src
    type(bHYPRE_CoefficientAccess_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Coeff_ary_ensurev5zgving1ke8t_m
    call Coeff_ary_ensurev5zgving1ke8t_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Coeffi_ary_sliceb1c4e2tf4x31r_m
    call Coeffi_ary_sliceb1c4e2tf4x31r_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_CoefficientAccess_t), intent(out) :: value
    external Coeffici_ary_getk_qc84ypw79sk_m
    call Coeffici_ary_getk_qc84ypw79sk_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_CoefficientAccess_t), intent(in) :: value
    external Coeffici_ary_setc3to66w2q0do9_m
    call Coeffici_ary_setc3to66w2q0do9_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_CoefficientAccess_t), intent(out) :: value
    external Coeffic_ary_get1374g43pbe67ff_m
    call Coeffic_ary_get1374g43pbe67ff_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_CoefficientAccess_t), intent(in) :: value
    external Coeffic_ary_set1lzm2h_djqoezs_m
    call Coeffic_ary_set1lzm2h_djqoezs_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_CoefficientAccess_1d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopyeit400cp594fc_m
    dim = 1
    call Co_ary_smartCopyeit400cp594fc_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    external ary_isColumnOrder9bxrd26tzbt0_m
    call ary_isColumnOrder9bxrd26tzbt0_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    external C_ary_isRowOrderbjy8qs608myll_m
    call C_ary_isRowOrderbjy8qs608myll_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    external Coeffi_ary_dimenkov_y0o51lbjx_m
    call Coeffi_ary_dimenkov_y0o51lbjx_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_strideylcho7_2auoa__m
    call Coeff_ary_strideylcho7_2auoa__m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_lower9vx0dh32awanz_m
    call Coeffi_ary_lower9vx0dh32awanz_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_uppernvr6ebgzolnnz_m
    call Coeffi_ary_uppernvr6ebgzolnnz_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_lengthb0hyt3ae8v2f0_m
    call Coeff_ary_lengthb0hyt3ae8v2f0_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    external Coeff_ary_addRefjj3hsess5wyp8_m
    call Coeff_ary_addRefjj3hsess5wyp8_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_CoefficientAccess_1d), intent(in)  :: array
    external Co_ary_deleteRefgh_tl19ndzu_b_m
    call Co_ary_deleteRefgh_tl19ndzu_b_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_2d), intent(out) :: array
    external Co_ary_createColczevkk97g_f1v_m
    call Co_ary_createColczevkk97g_f1v_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_2d), intent(out) :: array
    external Co_ary_createRowphh58aytg5h8v_m
    call Co_ary_createRowphh58aytg5h8v_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_CoefficientAccess_2d), intent(out) :: array
    external ary_create2dColr44_bvwamn1r1c_m
    call ary_create2dColr44_bvwamn1r1c_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_CoefficientAccess_2d), intent(out) :: array
    external ary_create2dRowfl963p8aq9nulj_m
    call ary_create2dRowfl963p8aq9nulj_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_CoefficientAccess_2d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_2d), intent(in) :: dest
    external Coeffic_ary_copyhefbdqxcihl0o_m
    call Coeffic_ary_copyhefbdqxcihl0o_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_CoefficientAccess_2d), intent(in)  :: src
    type(bHYPRE_CoefficientAccess_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Coeff_ary_ensurev5zgving1ke8t_m
    call Coeff_ary_ensurev5zgving1ke8t_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Coeffi_ary_sliceb1c4e2tf4x31r_m
    call Coeffi_ary_sliceb1c4e2tf4x31r_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_CoefficientAccess_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_CoefficientAccess_t), intent(out) :: value
    external Coeffic_ary_get2moepiaqp6stn8_m
    call Coeffic_ary_get2moepiaqp6stn8_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_CoefficientAccess_t), intent(in) :: value
    external Coeffic_ary_set22elcpmuxljkee_m
    call Coeffic_ary_set22elcpmuxljkee_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_CoefficientAccess_2d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopyeit400cp594fc_m
    dim = 2
    call Co_ary_smartCopyeit400cp594fc_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_CoefficientAccess_2d), intent(in)  :: array
    external ary_isColumnOrder9bxrd26tzbt0_m
    call ary_isColumnOrder9bxrd26tzbt0_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_CoefficientAccess_2d), intent(in)  :: array
    external C_ary_isRowOrderbjy8qs608myll_m
    call C_ary_isRowOrderbjy8qs608myll_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_CoefficientAccess_2d), intent(in)  :: array
    external Coeffi_ary_dimenkov_y0o51lbjx_m
    call Coeffi_ary_dimenkov_y0o51lbjx_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_strideylcho7_2auoa__m
    call Coeff_ary_strideylcho7_2auoa__m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_lower9vx0dh32awanz_m
    call Coeffi_ary_lower9vx0dh32awanz_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_uppernvr6ebgzolnnz_m
    call Coeffi_ary_uppernvr6ebgzolnnz_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_lengthb0hyt3ae8v2f0_m
    call Coeff_ary_lengthb0hyt3ae8v2f0_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_3d), intent(out) :: array
    external Co_ary_createColczevkk97g_f1v_m
    call Co_ary_createColczevkk97g_f1v_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_3d), intent(out) :: array
    external Co_ary_createRowphh58aytg5h8v_m
    call Co_ary_createRowphh58aytg5h8v_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_CoefficientAccess_3d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_3d), intent(in) :: dest
    external Coeffic_ary_copyhefbdqxcihl0o_m
    call Coeffic_ary_copyhefbdqxcihl0o_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_CoefficientAccess_3d), intent(in)  :: src
    type(bHYPRE_CoefficientAccess_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Coeff_ary_ensurev5zgving1ke8t_m
    call Coeff_ary_ensurev5zgving1ke8t_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Coeffi_ary_sliceb1c4e2tf4x31r_m
    call Coeffi_ary_sliceb1c4e2tf4x31r_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_CoefficientAccess_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_CoefficientAccess_t), intent(out) :: value
    external Coeffic_ary_get3dr2ktksh2bvlp_m
    call Coeffic_ary_get3dr2ktksh2bvlp_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_CoefficientAccess_t), intent(in) :: value
    external Coeffic_ary_set3vy2f505_hxpo8_m
    call Coeffic_ary_set3vy2f505_hxpo8_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_CoefficientAccess_3d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopyeit400cp594fc_m
    dim = 3
    call Co_ary_smartCopyeit400cp594fc_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_CoefficientAccess_3d), intent(in)  :: array
    external ary_isColumnOrder9bxrd26tzbt0_m
    call ary_isColumnOrder9bxrd26tzbt0_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_CoefficientAccess_3d), intent(in)  :: array
    external C_ary_isRowOrderbjy8qs608myll_m
    call C_ary_isRowOrderbjy8qs608myll_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_CoefficientAccess_3d), intent(in)  :: array
    external Coeffi_ary_dimenkov_y0o51lbjx_m
    call Coeffi_ary_dimenkov_y0o51lbjx_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_strideylcho7_2auoa__m
    call Coeff_ary_strideylcho7_2auoa__m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_lower9vx0dh32awanz_m
    call Coeffi_ary_lower9vx0dh32awanz_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_uppernvr6ebgzolnnz_m
    call Coeffi_ary_uppernvr6ebgzolnnz_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_lengthb0hyt3ae8v2f0_m
    call Coeff_ary_lengthb0hyt3ae8v2f0_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_4d), intent(out) :: array
    external Co_ary_createColczevkk97g_f1v_m
    call Co_ary_createColczevkk97g_f1v_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_4d), intent(out) :: array
    external Co_ary_createRowphh58aytg5h8v_m
    call Co_ary_createRowphh58aytg5h8v_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_CoefficientAccess_4d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_4d), intent(in) :: dest
    external Coeffic_ary_copyhefbdqxcihl0o_m
    call Coeffic_ary_copyhefbdqxcihl0o_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_CoefficientAccess_4d), intent(in)  :: src
    type(bHYPRE_CoefficientAccess_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Coeff_ary_ensurev5zgving1ke8t_m
    call Coeff_ary_ensurev5zgving1ke8t_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Coeffi_ary_sliceb1c4e2tf4x31r_m
    call Coeffi_ary_sliceb1c4e2tf4x31r_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_CoefficientAccess_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_CoefficientAccess_t), intent(out) :: value
    external Coeffic_ary_get451vpt19xnhh6c_m
    call Coeffic_ary_get451vpt19xnhh6c_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_CoefficientAccess_t), intent(in) :: value
    external Coeffic_ary_set416190u1m6vx6x_m
    call Coeffic_ary_set416190u1m6vx6x_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_CoefficientAccess_4d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopyeit400cp594fc_m
    dim = 4
    call Co_ary_smartCopyeit400cp594fc_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_CoefficientAccess_4d), intent(in)  :: array
    external ary_isColumnOrder9bxrd26tzbt0_m
    call ary_isColumnOrder9bxrd26tzbt0_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_CoefficientAccess_4d), intent(in)  :: array
    external C_ary_isRowOrderbjy8qs608myll_m
    call C_ary_isRowOrderbjy8qs608myll_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_CoefficientAccess_4d), intent(in)  :: array
    external Coeffi_ary_dimenkov_y0o51lbjx_m
    call Coeffi_ary_dimenkov_y0o51lbjx_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_strideylcho7_2auoa__m
    call Coeff_ary_strideylcho7_2auoa__m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_lower9vx0dh32awanz_m
    call Coeffi_ary_lower9vx0dh32awanz_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_uppernvr6ebgzolnnz_m
    call Coeffi_ary_uppernvr6ebgzolnnz_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_lengthb0hyt3ae8v2f0_m
    call Coeff_ary_lengthb0hyt3ae8v2f0_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_5d), intent(out) :: array
    external Co_ary_createColczevkk97g_f1v_m
    call Co_ary_createColczevkk97g_f1v_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_5d), intent(out) :: array
    external Co_ary_createRowphh58aytg5h8v_m
    call Co_ary_createRowphh58aytg5h8v_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_CoefficientAccess_5d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_5d), intent(in) :: dest
    external Coeffic_ary_copyhefbdqxcihl0o_m
    call Coeffic_ary_copyhefbdqxcihl0o_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_CoefficientAccess_5d), intent(in)  :: src
    type(bHYPRE_CoefficientAccess_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Coeff_ary_ensurev5zgving1ke8t_m
    call Coeff_ary_ensurev5zgving1ke8t_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Coeffi_ary_sliceb1c4e2tf4x31r_m
    call Coeffi_ary_sliceb1c4e2tf4x31r_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_CoefficientAccess_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_CoefficientAccess_t), intent(out) :: value
    external Coeffic_ary_get51_wczzevjeyhu_m
    call Coeffic_ary_get51_wczzevjeyhu_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_CoefficientAccess_t), intent(in) :: value
    external Coeffic_ary_set5qn6hu2mdmtycx_m
    call Coeffic_ary_set5qn6hu2mdmtycx_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_CoefficientAccess_5d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopyeit400cp594fc_m
    dim = 5
    call Co_ary_smartCopyeit400cp594fc_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_CoefficientAccess_5d), intent(in)  :: array
    external ary_isColumnOrder9bxrd26tzbt0_m
    call ary_isColumnOrder9bxrd26tzbt0_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_CoefficientAccess_5d), intent(in)  :: array
    external C_ary_isRowOrderbjy8qs608myll_m
    call C_ary_isRowOrderbjy8qs608myll_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_CoefficientAccess_5d), intent(in)  :: array
    external Coeffi_ary_dimenkov_y0o51lbjx_m
    call Coeffi_ary_dimenkov_y0o51lbjx_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_strideylcho7_2auoa__m
    call Coeff_ary_strideylcho7_2auoa__m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_lower9vx0dh32awanz_m
    call Coeffi_ary_lower9vx0dh32awanz_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_uppernvr6ebgzolnnz_m
    call Coeffi_ary_uppernvr6ebgzolnnz_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_lengthb0hyt3ae8v2f0_m
    call Coeff_ary_lengthb0hyt3ae8v2f0_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_6d), intent(out) :: array
    external Co_ary_createColczevkk97g_f1v_m
    call Co_ary_createColczevkk97g_f1v_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_6d), intent(out) :: array
    external Co_ary_createRowphh58aytg5h8v_m
    call Co_ary_createRowphh58aytg5h8v_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_CoefficientAccess_6d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_6d), intent(in) :: dest
    external Coeffic_ary_copyhefbdqxcihl0o_m
    call Coeffic_ary_copyhefbdqxcihl0o_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_CoefficientAccess_6d), intent(in)  :: src
    type(bHYPRE_CoefficientAccess_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Coeff_ary_ensurev5zgving1ke8t_m
    call Coeff_ary_ensurev5zgving1ke8t_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Coeffi_ary_sliceb1c4e2tf4x31r_m
    call Coeffi_ary_sliceb1c4e2tf4x31r_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_CoefficientAccess_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_CoefficientAccess_t), intent(out) :: value
    external Coeffic_ary_get63fk2sc2yu2_6__m
    call Coeffic_ary_get63fk2sc2yu2_6__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_CoefficientAccess_t), intent(in) :: value
    external Coeffic_ary_set6ri2bxovqwoia__m
    call Coeffic_ary_set6ri2bxovqwoia__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_CoefficientAccess_6d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopyeit400cp594fc_m
    dim = 6
    call Co_ary_smartCopyeit400cp594fc_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_CoefficientAccess_6d), intent(in)  :: array
    external ary_isColumnOrder9bxrd26tzbt0_m
    call ary_isColumnOrder9bxrd26tzbt0_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_CoefficientAccess_6d), intent(in)  :: array
    external C_ary_isRowOrderbjy8qs608myll_m
    call C_ary_isRowOrderbjy8qs608myll_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_CoefficientAccess_6d), intent(in)  :: array
    external Coeffi_ary_dimenkov_y0o51lbjx_m
    call Coeffi_ary_dimenkov_y0o51lbjx_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_strideylcho7_2auoa__m
    call Coeff_ary_strideylcho7_2auoa__m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_lower9vx0dh32awanz_m
    call Coeffi_ary_lower9vx0dh32awanz_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_uppernvr6ebgzolnnz_m
    call Coeffi_ary_uppernvr6ebgzolnnz_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_lengthb0hyt3ae8v2f0_m
    call Coeff_ary_lengthb0hyt3ae8v2f0_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_7d), intent(out) :: array
    external Co_ary_createColczevkk97g_f1v_m
    call Co_ary_createColczevkk97g_f1v_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_CoefficientAccess_7d), intent(out) :: array
    external Co_ary_createRowphh58aytg5h8v_m
    call Co_ary_createRowphh58aytg5h8v_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_CoefficientAccess_7d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_7d), intent(in) :: dest
    external Coeffic_ary_copyhefbdqxcihl0o_m
    call Coeffic_ary_copyhefbdqxcihl0o_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_CoefficientAccess_7d), intent(in)  :: src
    type(bHYPRE_CoefficientAccess_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Coeff_ary_ensurev5zgving1ke8t_m
    call Coeff_ary_ensurev5zgving1ke8t_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Coeffi_ary_sliceb1c4e2tf4x31r_m
    call Coeffi_ary_sliceb1c4e2tf4x31r_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_CoefficientAccess_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_CoefficientAccess_t), intent(out) :: value
    external Coeffic_ary_get7ps7b_0k2cv0j1_m
    call Coeffic_ary_get7ps7b_0k2cv0j1_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_CoefficientAccess_t), intent(in) :: value
    external Coeffic_ary_set7g2z88lyafijxm_m
    call Coeffic_ary_set7g2z88lyafijxm_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_CoefficientAccess_7d), intent(in) :: src
    type(bHYPRE_CoefficientAccess_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Co_ary_smartCopyeit400cp594fc_m
    dim = 7
    call Co_ary_smartCopyeit400cp594fc_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_CoefficientAccess_7d), intent(in)  :: array
    external ary_isColumnOrder9bxrd26tzbt0_m
    call ary_isColumnOrder9bxrd26tzbt0_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_CoefficientAccess_7d), intent(in)  :: array
    external C_ary_isRowOrderbjy8qs608myll_m
    call C_ary_isRowOrderbjy8qs608myll_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_CoefficientAccess_7d), intent(in)  :: array
    external Coeffi_ary_dimenkov_y0o51lbjx_m
    call Coeffi_ary_dimenkov_y0o51lbjx_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_strideylcho7_2auoa__m
    call Coeff_ary_strideylcho7_2auoa__m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_lower9vx0dh32awanz_m
    call Coeffi_ary_lower9vx0dh32awanz_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeffi_ary_uppernvr6ebgzolnnz_m
    call Coeffi_ary_uppernvr6ebgzolnnz_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Coeff_ary_lengthb0hyt3ae8v2f0_m
    call Coeff_ary_lengthb0hyt3ae8v2f0_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_Coefficigzhyynx3d8_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_CoefficientAccess_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_Coefficigzhyynx3d8_p

  subroutine castbHYPRE_Coefficigaz0mcta1e_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_CoefficientAccess_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_Coefficigaz0mcta1e_p

  subroutine castbHYPRE_Coefficilfwzhj4anv_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_CoefficientAccess_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_Coefficilfwzhj4anv_p

  subroutine castbHYPRE_Coeffici2a1t9c176c_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_CoefficientAccess_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_Coeffici2a1t9c176c_p

  subroutine castbHYPRE_Coefficiagckx27_pr_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_CoefficientAccess_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_Coefficiagckx27_pr_p

  subroutine castbHYPRE_Coefficixqpcbmw76x_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_CoefficientAccess_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_Coefficixqpcbmw76x_p

  subroutine castbHYPRE_Coefficip5j3bdaetv_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_CoefficientAccess_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_Coefficip5j3bdaetv_p


end module bHYPRE_CoefficientAccess_array
