/*
 * File:          Hypre_SStructParCSRMatrix_IOR.c
...
static struct Hypre_SStructParCSRMatrix__epv s_new__hypre_sstructparcsrmatrix;
static struct Hypre_SStructParCSRMatrix__epv s_rem__hypre_sstructparcsrmatrix;
...
extern void Hypre_SStructParCSRMatrix__set_epv(
  struct Hypre_SStructParCSRMatrix__epv* epv);

/*
 * CAST: dynamic type casting support.
 */

static void* ior_Hypre_SStructParCSRMatrix__cast(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name)
{
  void* cast = NULL;

  struct Hypre_SStructParCSRMatrix__object* s0 = self;
  struct SIDL_BaseClass__object*            s1 = &s0->d_sidl_baseclass;

  if (!strcmp(name, "Hypre.SStructParCSRMatrix")) {
    cast = (void*) s0;
...
static void ior_Hypre_SStructParCSRMatrix__delete(
  struct Hypre_SStructParCSRMatrix__object* self)
{
  Hypre_SStructParCSRMatrix__fini(self);
  memset((void*)self, 0, sizeof(struct Hypre_SStructParCSRMatrix__object));
  free((void*) self);
}
...
static void Hypre_SStructParCSRMatrix__init_epv(
  struct Hypre_SStructParCSRMatrix__object* self)
{
  struct Hypre_SStructParCSRMatrix__object* s0 = self;
  struct SIDL_BaseClass__object*            s1 = &s0->d_sidl_baseclass;
  ...
  struct Hypre_SStructParCSRMatrix__epv* epv = 
    &s_new__hypre_sstructparcsrmatrix;
  ...
  epv->f__cast                   = ior_Hypre_SStructParCSRMatrix__cast;
  epv->f__delete                 = ior_Hypre_SStructParCSRMatrix__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = (void (*)(struct 
    Hypre_SStructParCSRMatrix__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef               = (void (*)(struct 
    Hypre_SStructParCSRMatrix__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                  = (SIDL_bool (*)(struct 
    Hypre_SStructParCSRMatrix__object*,
  ...
  epv->f_isType                  = (SIDL_bool (*)(struct 
    Hypre_SStructParCSRMatrix__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo            = (struct SIDL_ClassInfo__object* (*)(struct 
    Hypre_SStructParCSRMatrix__object*)) s1->d_epv->f_getClassInfo;
  ...
  Hypre_SStructParCSRMatrix__set_epv(epv);
...
initClassInfo(SIDL_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      SIDL_ClassInfoI_setName(impl, "Hypre.SStructParCSRMatrix");
...
static void
initMetadata(struct Hypre_SStructParCSRMatrix__object* self)
{
  if (self) {
...
{
  struct Hypre_SStructParCSRMatrix__object* self =
    (struct Hypre_SStructParCSRMatrix__object*) malloc(
      sizeof(struct Hypre_SStructParCSRMatrix__object));
  Hypre_SStructParCSRMatrix__init(self);
  initMetadata(self);
  return self;
}
...
void Hypre_SStructParCSRMatrix__init(
  struct Hypre_SStructParCSRMatrix__object* self)
{
  struct Hypre_SStructParCSRMatrix__object* s0 = self;
  struct SIDL_BaseClass__object*            s1 = &s0->d_sidl_baseclass;
  ...
  if (!s_method_initialized) {
    Hypre_SStructParCSRMatrix__init_epv(s0);
  }
  ...
  s0->d_epv                            = &s_new__hypre_sstructparcsrmatrix;
...
void Hypre_SStructParCSRMatrix__fini(
  struct Hypre_SStructParCSRMatrix__object* self)
{
  struct Hypre_SStructParCSRMatrix__object* s0 = self;
  struct SIDL_BaseClass__object*            s1 = &s0->d_sidl_baseclass;
...
void
Hypre_SStructParCSRMatrix__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}
static const struct Hypre_SStructParCSRMatrix__external
s_externalEntryPoints = {
  Hypre_SStructParCSRMatrix__new,
  Hypre_SStructParCSRMatrix__remote,
};
...
static void* remote_Hypre_SStructParCSRMatrix__cast(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name)
{
  return NULL;
...
static void remote_Hypre_SStructParCSRMatrix__delete(
  struct Hypre_SStructParCSRMatrix__object* self)
{
  free((void*) self);
}
...
static void
remote_Hypre_SStructParCSRMatrix_addRef(
  struct Hypre_SStructParCSRMatrix__object* self)
{
}
...
static void
remote_Hypre_SStructParCSRMatrix_deleteRef(
  struct Hypre_SStructParCSRMatrix__object* self)
{
}
...
static SIDL_bool
remote_Hypre_SStructParCSRMatrix_isSame(
  struct Hypre_SStructParCSRMatrix__object* self,
...
remote_Hypre_SStructParCSRMatrix_queryInt(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name)
{
...
static SIDL_bool
remote_Hypre_SStructParCSRMatrix_isType(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name)
{
  return 0;
...
remote_Hypre_SStructParCSRMatrix_getClassInfo(
  struct Hypre_SStructParCSRMatrix__object* self)
{
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetCommunicator(
  struct Hypre_SStructParCSRMatrix__object* self,
  void* mpi_comm)
{
  return 0;
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetIntParameter(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name,
  int32_t value)
{
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetDoubleParameter(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name,
  double value)
{
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetStringParameter(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name,
  const char* value)
{
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetIntArrayParameter(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetDoubleArrayParameter(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_GetIntValue(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name,
  int32_t* value)
{
...
static int32_t
remote_Hypre_SStructParCSRMatrix_GetDoubleValue(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* name,
  double* value)
{
...
static int32_t
remote_Hypre_SStructParCSRMatrix_Setup(
  struct Hypre_SStructParCSRMatrix__object* self,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_Apply(
  struct Hypre_SStructParCSRMatrix__object* self,
  struct Hypre_Vector__object* b,
  struct Hypre_Vector__object** x)
{
...
static int32_t
remote_Hypre_SStructParCSRMatrix_Initialize(
  struct Hypre_SStructParCSRMatrix__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_SStructParCSRMatrix_Assemble(
  struct Hypre_SStructParCSRMatrix__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_SStructParCSRMatrix_GetObject(
  struct Hypre_SStructParCSRMatrix__object* self,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetGraph(
  struct Hypre_SStructParCSRMatrix__object* self,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetValues(
  struct Hypre_SStructParCSRMatrix__object* self,
  int32_t part,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetBoxValues(
  struct Hypre_SStructParCSRMatrix__object* self,
  int32_t part,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_AddToValues(
  struct Hypre_SStructParCSRMatrix__object* self,
  int32_t part,
  struct SIDL_int__array* index,
  int32_t var,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_AddToBoxValues(
  struct Hypre_SStructParCSRMatrix__object* self,
  int32_t part,
  struct SIDL_int__array* ilower,
  struct SIDL_int__array* iupper,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetSymmetric(
  struct Hypre_SStructParCSRMatrix__object* self,
  int32_t part,
  int32_t var,
  int32_t to_var,
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetNSSymmetric(
  struct Hypre_SStructParCSRMatrix__object* self,
  int32_t symmetric)
{
  return 0;
...
static int32_t
remote_Hypre_SStructParCSRMatrix_SetComplex(
  struct Hypre_SStructParCSRMatrix__object* self)
{
  return 0;
}
...
static int32_t
remote_Hypre_SStructParCSRMatrix_Print(
  struct Hypre_SStructParCSRMatrix__object* self,
  const char* filename,
  int32_t all)
{
...
static void Hypre_SStructParCSRMatrix__init_remote_epv(void)
{
  struct Hypre_SStructParCSRMatrix__epv* epv = 
    &s_rem__hypre_sstructparcsrmatrix;
  ...
  epv->f__cast                   = remote_Hypre_SStructParCSRMatrix__cast;
  epv->f__delete                 = remote_Hypre_SStructParCSRMatrix__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = remote_Hypre_SStructParCSRMatrix_addRef;
  epv->f_deleteRef               = remote_Hypre_SStructParCSRMatrix_deleteRef;
  epv->f_isSame                  = remote_Hypre_SStructParCSRMatrix_isSame;
  epv->f_queryInt                = remote_Hypre_SStructParCSRMatrix_queryInt;
  epv->f_isType                  = remote_Hypre_SStructParCSRMatrix_isType;
  epv->f_getClassInfo            = 
    remote_Hypre_SStructParCSRMatrix_getClassInfo;
  ...
  epv->f_SetDoubleArrayParameter = 
    remote_Hypre_SStructParCSRMatrix_SetDoubleArrayParameter;
  epv->f_GetIntValue             = remote_Hypre_SStructParCSRMatrix_GetIntValue;
  epv->f_GetDoubleValue          = 
    remote_Hypre_SStructParCSRMatrix_GetDoubleValue;
  epv->f_Setup                   = remote_Hypre_SStructParCSRMatrix_Setup;
  epv->f_Apply                   = remote_Hypre_SStructParCSRMatrix_Apply;
  epv->f_Initialize              = remote_Hypre_SStructParCSRMatrix_Initialize;
  epv->f_Assemble                = remote_Hypre_SStructParCSRMatrix_Assemble;
  epv->f_GetObject               = remote_Hypre_SStructParCSRMatrix_GetObject;
  epv->f_SetGraph                = remote_Hypre_SStructParCSRMatrix_SetGraph;
  epv->f_SetValues               = remote_Hypre_SStructParCSRMatrix_SetValues;
  epv->f_SetBoxValues            = 
    remote_Hypre_SStructParCSRMatrix_SetBoxValues;
  epv->f_AddToValues             = remote_Hypre_SStructParCSRMatrix_AddToValues;
  ...
  epv->f_SetNSSymmetric          = 
    remote_Hypre_SStructParCSRMatrix_SetNSSymmetric;
  epv->f_SetComplex              = remote_Hypre_SStructParCSRMatrix_SetComplex;
  epv->f_Print                   = remote_Hypre_SStructParCSRMatrix_Print;
...
Hypre_SStructParCSRMatrix__remote(const char *url)
{
  ...
  if (!s_remote_initialized) {
    Hypre_SStructParCSRMatrix__init_remote_epv();
  }
  ...
  s0->d_epv  = &s_rem__hypre_sstructparcsrmatrix;
