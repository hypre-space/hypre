/*
 * File:          Hypre_SStructParCSRVector_IOR.h
...
#ifndef included_Hypre_SStructParCSRVector_IOR_h
#define included_Hypre_SStructParCSRVector_IOR_h
...
extern struct Hypre_SStructParCSRVector__object*
Hypre_SStructParCSRVector__new(void);

extern struct Hypre_SStructParCSRVector__object*
Hypre_SStructParCSRVector__remote(const char *url);

extern void Hypre_SStructParCSRVector__init(
  struct Hypre_SStructParCSRVector__object* self);
extern void Hypre_SStructParCSRVector__fini(
  struct Hypre_SStructParCSRVector__object* self);
extern void Hypre_SStructParCSRVector__IOR_version(int32_t *major,
  int32_t *minor);
...
struct Hypre_SStructParCSRVector__epv {
  ...
  int32_t (*f_Axpy)(
    ...
    double a,
    struct Hypre_Vector__object* x);
  /* Methods introduced in Hypre.SStructParCSRVector-v0.1.7 */
};
...
struct Hypre_SStructParCSRVector__object {
  ...
  struct Hypre_SStructParCSRVector__epv*  d_epv;
  void*                                   d_data;
};

struct Hypre_SStructParCSRVector__external {
  struct Hypre_SStructParCSRVector__object*
  (*createObject)(void);
