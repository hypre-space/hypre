...
static struct Hypre_BoomerAMG__epv s_new__hypre_boomeramg;
static struct Hypre_BoomerAMG__epv s_rem__hypre_boomeramg;
...
extern void Hypre_BoomerAMG__set_epv(
  struct Hypre_BoomerAMG__epv* epv);

/*
 * CAST: dynamic type casting support.
 */

static void* ior_Hypre_BoomerAMG__cast(
  struct Hypre_BoomerAMG__object* self,
  const char* name)
{
  void* cast = NULL;

  struct Hypre_BoomerAMG__object* s0 = self;
  struct SIDL_BaseClass__object*  s1 = &s0->d_sidl_baseclass;

  if (!strcmp(name, "Hypre.BoomerAMG")) {
    cast = (void*) s0;
...
static void ior_Hypre_BoomerAMG__delete(
  struct Hypre_BoomerAMG__object* self)
{
  Hypre_BoomerAMG__fini(self);
  memset((void*)self, 0, sizeof(struct Hypre_BoomerAMG__object));
  free((void*) self);
}
...
static void Hypre_BoomerAMG__init_epv(
  struct Hypre_BoomerAMG__object* self)
{
  struct Hypre_BoomerAMG__object* s0 = self;
  struct SIDL_BaseClass__object*  s1 = &s0->d_sidl_baseclass;

  struct Hypre_BoomerAMG__epv*    epv = &s_new__hypre_boomeramg;
  ...
  epv->f__cast                   = ior_Hypre_BoomerAMG__cast;
  epv->f__delete                 = ior_Hypre_BoomerAMG__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = (void (*)(struct Hypre_BoomerAMG__object*)) 
    s1->d_epv->f_addRef;
  epv->f_deleteRef               = (void (*)(struct Hypre_BoomerAMG__object*)) 
    s1->d_epv->f_deleteRef;
  epv->f_isSame                  = (SIDL_bool (*)(struct 
    Hypre_BoomerAMG__object*,
    struct SIDL_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                = (struct SIDL_BaseInterface__object* 
    (*)(struct Hypre_BoomerAMG__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                  = (SIDL_bool (*)(struct 
    Hypre_BoomerAMG__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo            = (struct SIDL_ClassInfo__object* (*)(struct 
    Hypre_BoomerAMG__object*)) s1->d_epv->f_getClassInfo;
...
initClassInfo(SIDL_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      SIDL_ClassInfoI_setName(impl, "Hypre.BoomerAMG");
...
static void
initMetadata(struct Hypre_BoomerAMG__object* self)
{
  if (self) {
...
{
  struct Hypre_BoomerAMG__object* self =
    (struct Hypre_BoomerAMG__object*) malloc(
      sizeof(struct Hypre_BoomerAMG__object));
  Hypre_BoomerAMG__init(self);
  initMetadata(self);
  return self;
}
  ...
  struct Hypre_BoomerAMG__object* self)
{
  ...
  s0->d_epv                  = &s_new__hypre_boomeramg;
...
void
Hypre_BoomerAMG__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}
static const struct Hypre_BoomerAMG__external
s_externalEntryPoints = {
  Hypre_BoomerAMG__new,
  Hypre_BoomerAMG__remote,
};
...
static void* remote_Hypre_BoomerAMG__cast(
  struct Hypre_BoomerAMG__object* self,
  const char* name)
{
  return NULL;
...
static void remote_Hypre_BoomerAMG__delete(
  struct Hypre_BoomerAMG__object* self)
{
  free((void*) self);
}
...
static void
remote_Hypre_BoomerAMG_deleteRef(
  struct Hypre_BoomerAMG__object* self)
{
}
...
remote_Hypre_BoomerAMG_queryInt(
  struct Hypre_BoomerAMG__object* self,
  const char* name)
{
...
remote_Hypre_BoomerAMG_getClassInfo(
  struct Hypre_BoomerAMG__object* self)
{
...
static int32_t
remote_Hypre_BoomerAMG_SetCommunicator(
  struct Hypre_BoomerAMG__object* self,
  void* mpi_comm)
{
  return 0;
...
static int32_t
remote_Hypre_BoomerAMG_SetIntParameter(
  struct Hypre_BoomerAMG__object* self,
  const char* name,
  int32_t value)
{
...
static int32_t
remote_Hypre_BoomerAMG_SetDoubleParameter(
  struct Hypre_BoomerAMG__object* self,
  const char* name,
  double value)
{
...
static int32_t
remote_Hypre_BoomerAMG_SetStringParameter(
  struct Hypre_BoomerAMG__object* self,
  const char* name,
  const char* value)
{
...
static int32_t
remote_Hypre_BoomerAMG_SetIntArrayParameter(
  struct Hypre_BoomerAMG__object* self,
  const char* name,
...
static int32_t
remote_Hypre_BoomerAMG_SetDoubleArrayParameter(
  struct Hypre_BoomerAMG__object* self,
  const char* name,
...
static int32_t
remote_Hypre_BoomerAMG_GetIntValue(
  struct Hypre_BoomerAMG__object* self,
  const char* name,
  int32_t* value)
{
...
static int32_t
remote_Hypre_BoomerAMG_GetDoubleValue(
  struct Hypre_BoomerAMG__object* self,
  const char* name,
  double* value)
{
...
static int32_t
remote_Hypre_BoomerAMG_SetOperator(
  struct Hypre_BoomerAMG__object* self,
...
static int32_t
remote_Hypre_BoomerAMG_SetTolerance(
  struct Hypre_BoomerAMG__object* self,
  double tolerance)
{
  return 0;
...
static int32_t
remote_Hypre_BoomerAMG_SetMaxIterations(
  struct Hypre_BoomerAMG__object* self,
...
static int32_t
remote_Hypre_BoomerAMG_SetLogging(
  struct Hypre_BoomerAMG__object* self,
  int32_t level)
{
  return 0;
...
static int32_t
remote_Hypre_BoomerAMG_SetPrintLevel(
  struct Hypre_BoomerAMG__object* self,
  int32_t level)
{
  return 0;
...
static int32_t
remote_Hypre_BoomerAMG_GetNumIterations(
  struct Hypre_BoomerAMG__object* self,
...
static int32_t
remote_Hypre_BoomerAMG_GetRelResidualNorm(
  struct Hypre_BoomerAMG__object* self,
  double* norm)
{
  return 0;
...
static void Hypre_BoomerAMG__init_remote_epv(void)
{
  struct Hypre_BoomerAMG__epv*    epv = &s_rem__hypre_boomeramg;
  ...
  epv->f__cast                   = remote_Hypre_BoomerAMG__cast;
  epv->f__delete                 = remote_Hypre_BoomerAMG__delete;
  epv->f__ctor                   = NULL;
  epv->f__dtor                   = NULL;
  epv->f_addRef                  = remote_Hypre_BoomerAMG_addRef;
  epv->f_deleteRef               = remote_Hypre_BoomerAMG_deleteRef;
  epv->f_isSame                  = remote_Hypre_BoomerAMG_isSame;
  epv->f_queryInt                = remote_Hypre_BoomerAMG_queryInt;
  epv->f_isType                  = remote_Hypre_BoomerAMG_isType;
  epv->f_getClassInfo            = remote_Hypre_BoomerAMG_getClassInfo;
  epv->f_SetCommunicator         = remote_Hypre_BoomerAMG_SetCommunicator;
  epv->f_SetIntParameter         = remote_Hypre_BoomerAMG_SetIntParameter;
  epv->f_SetDoubleParameter      = remote_Hypre_BoomerAMG_SetDoubleParameter;
  epv->f_SetStringParameter      = remote_Hypre_BoomerAMG_SetStringParameter;
  epv->f_SetIntArrayParameter    = remote_Hypre_BoomerAMG_SetIntArrayParameter;
  epv->f_SetDoubleArrayParameter = 
    remote_Hypre_BoomerAMG_SetDoubleArrayParameter;
  epv->f_GetIntValue             = remote_Hypre_BoomerAMG_GetIntValue;
  epv->f_GetDoubleValue          = remote_Hypre_BoomerAMG_GetDoubleValue;
  epv->f_Setup                   = remote_Hypre_BoomerAMG_Setup;
  epv->f_Apply                   = remote_Hypre_BoomerAMG_Apply;
  epv->f_SetOperator             = remote_Hypre_BoomerAMG_SetOperator;
  epv->f_SetTolerance            = remote_Hypre_BoomerAMG_SetTolerance;
  epv->f_SetMaxIterations        = remote_Hypre_BoomerAMG_SetMaxIterations;
  epv->f_SetLogging              = remote_Hypre_BoomerAMG_SetLogging;
  epv->f_SetPrintLevel           = remote_Hypre_BoomerAMG_SetPrintLevel;
  epv->f_GetNumIterations        = remote_Hypre_BoomerAMG_GetNumIterations;
  epv->f_GetRelResidualNorm      = remote_Hypre_BoomerAMG_GetRelResidualNorm;
...
Hypre_BoomerAMG__remote(const char *url)
{
  ...
  if (!s_remote_initialized) {
    Hypre_BoomerAMG__init_remote_epv();
  }
  ...
  s0->d_epv  = &s_rem__hypre_boomeramg;
