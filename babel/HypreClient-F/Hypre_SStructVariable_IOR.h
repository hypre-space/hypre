/*
 * File:          Hypre_SStructVariable_IOR.h
 * Symbol:        Hypre.SStructVariable-v0.1.7
 * Symbol Type:   enumeration
 * Babel Version: 0.8.0
 * SIDL Created:  20030306 17:05:23 PST
 * Generated:     20030306 17:05:25 PST
 * Description:   Intermediate Object Representation for Hypre.SStructVariable
 * 
...
#define included_Hypre_SStructVariable_IOR_h
...
/*
 * Symbol "Hypre.SStructVariable" (version 0.1.7)
 * 
...
enum Hypre_SStructVariable__enum {
  Hypre_SStructVariable_UNDEFINED = -1,
  Hypre_SStructVariable_CELL      = 0,
  Hypre_SStructVariable_NODE      = 1,
  Hypre_SStructVariable_XFACE     = 2,
  Hypre_SStructVariable_YFACE     = 3,
  Hypre_SStructVariable_ZFACE     = 4,
  Hypre_SStructVariable_XEDGE     = 5,
  Hypre_SStructVariable_YEDGE     = 6,
  Hypre_SStructVariable_ZEDGE     = 7
};
