/*
 * File:          bHYPRE_StructStencil_jniStub.c
 * Symbol:        bHYPRE.StructStencil-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.StructStencil
 * 
...
static struct bHYPRE_StructStencil__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_StructStencil__object*) ptr;
}
...
static const struct bHYPRE_StructStencil__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_StructStencil__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_StructStencil__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_StructStencil__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_StructStencil__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jint _arg_size)
{
  ...
  int32_t _tmp_ndim = 0;
  int32_t _tmp_size = 0;
  struct bHYPRE_StructStencil__object* _ior_res = (struct 
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.StructStencil", 
  ...
  jobject obj)
{
  ...
  struct bHYPRE_StructStencil__object* _ior = NULL;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  jobject _arg_offset)
{
  ...
  _ior_res = (*(_ior->d_epv->f_SetElement))(
    _ior,
    _tmp_index,
    _tmp_offset,
    &_ex);
...
void bHYPRE_StructStencil__register(JNIEnv* env)
{
  JNINativeMethod methods[12];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_StructStencil__externals();
#else
  s_external = (struct bHYPRE_StructStencil__external*)sidl_dynamicLoadIOR(
    "bHYPRE.StructStencil","bHYPRE_StructStencil__externals") ;
  sidl_checkIORVersion("bHYPRE.StructStencil", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/StructStencil;)J";
  ...
  methods[7].signature = "(II)LbHYPRE/StructStencil;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "Destroy";
  methods[8].signature = "()V";
  methods[8].fnPtr     = (void *)jni_Destroy;
  methods[9].name      = "SetDimension";
  methods[9].signature = "(I)I";
  methods[9].fnPtr     = (void *)jni_SetDimension;
  methods[10].name      = "SetSize";
  methods[10].signature = "(I)I";
  methods[10].fnPtr     = (void *)jni_SetSize;
  methods[11].name      = "SetElement";
  methods[11].signature = "(ILsidl/Integer$Array1;)I";
  methods[11].fnPtr     = (void *)jni_SetElement;


  cls = (*env)->FindClass(env, "bHYPRE/StructStencil");
  if (cls) {
