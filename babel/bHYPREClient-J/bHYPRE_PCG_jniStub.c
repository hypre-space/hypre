/*
 * File:          bHYPRE_PCG_jniStub.c
 * Symbol:        bHYPRE.PCG-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.PCG
 * 
...
#endif
#ifndef included_bHYPRE_PCG_jniStub_h
#include "bHYPRE_PCG_jniStub.h"
#endif
...
static struct bHYPRE_PCG__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_PCG__object*) ptr;
}
...
static const struct bHYPRE_PCG__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_PCG__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_PCG__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_PCG__object *_ptr = (*s_external->createObject)(g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_PCG__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_Operator__object* _tmp_A = (struct bHYPRE_Operator__object*) 
    NULL;
  struct bHYPRE_PCG__object* _ior_res = (struct bHYPRE_PCG__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.PCG", FALSE);JAVA_CHECK(env);
  ...
  jobject _arg_s)
{
  ...
  struct bHYPRE_PCG__object* _ior = NULL;
...
void bHYPRE_PCG__register(JNIEnv* env)
{
  JNINativeMethod methods[32];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_PCG__externals();
#else
  s_external = (struct bHYPRE_PCG__external*)sidl_dynamicLoadIOR("bHYPRE.PCG",
    "bHYPRE_PCG__externals") ;
  sidl_checkIORVersion("bHYPRE.PCG", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/PCG;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/Operator;)LbHYPRE/PCG;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/PCG");
  if (cls) {
