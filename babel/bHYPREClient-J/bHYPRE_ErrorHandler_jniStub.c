/*
 * File:          bHYPRE_ErrorHandler_jniStub.c
 * Symbol:        bHYPRE.ErrorHandler-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.ErrorHandler
 * 
...
#include "bHYPRE_ErrorHandler_jniStub.h"
#endif
...
static struct bHYPRE_ErrorHandler__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_ErrorHandler__object*) ptr;
}
...
static const struct bHYPRE_ErrorHandler__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_ErrorHandler__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_ErrorHandler__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_ErrorHandler__object *_ptr = (*s_external->createObject)(g_data,
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_ErrorHandler__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jint _arg_error_code)
{
  ...
  int32_t _tmp_ierr = 0;
  enum bHYPRE_ErrorCode__enum _tmp_error_code = (enum bHYPRE_ErrorCode__enum) 0;
  int32_t _ior_res = 0;
  jint _res = 0;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  _tmp_ierr = (int32_t) _arg_ierr;
  _tmp_error_code = (enum bHYPRE_ErrorCode__enum) _arg_error_code;

  /*
   * Call the IOR method through the EPV.
   */

  _ior_res = (*(s_sepv->f_Check))(
    _tmp_ierr,
    _tmp_error_code,
    &_ex);
  ...
  jobject _arg_message)
{
  ...
  sidl_Java_I2J_string_holder(env, _arg_message, _tmp_message);
  ...
  jobject _arg_outArgs)
{
  ...
  struct bHYPRE_ErrorHandler__object* _ior = NULL;
...
void bHYPRE_ErrorHandler__register(JNIEnv* env)
{
  JNINativeMethod methods[9];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_ErrorHandler__externals();
#else
  s_external = (struct bHYPRE_ErrorHandler__external*)sidl_dynamicLoadIOR(
    "bHYPRE.ErrorHandler","bHYPRE_ErrorHandler__externals") ;
  sidl_checkIORVersion("bHYPRE.ErrorHandler", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/ErrorHandler;)J";
  ...
  methods[7].name      = "Check";
  methods[7].signature = "(II)I";
  methods[7].fnPtr     = (void *)jni_Check;
  methods[8].name      = "Describe";
  methods[8].signature = "(ILsidl/String$Holder;)V";
  methods[8].fnPtr     = (void *)jni_Describe;


  cls = (*env)->FindClass(env, "bHYPRE/ErrorHandler");
  if (cls) {
