/*
 * File:          bHYPRE_Hybrid_jniStub.c
 * Symbol:        bHYPRE.Hybrid-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.Hybrid
 * 
...
#include "bHYPRE_Hybrid_jniStub.h"
#endif
...
static struct bHYPRE_Hybrid__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_Hybrid__object*) ptr;
}
...
static const struct bHYPRE_Hybrid__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_Hybrid__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_Hybrid__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_Hybrid__object *_ptr = (*s_external->createObject)(g_data, 
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_Hybrid__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_PreconditionedSolver__object* _tmp_SecondSolver = (struct 
    bHYPRE_PreconditionedSolver__object*) NULL;
  struct bHYPRE_Operator__object* _tmp_A = (struct bHYPRE_Operator__object*) 
    NULL;
  struct bHYPRE_Hybrid__object* _ior_res = (struct bHYPRE_Hybrid__object*) NULL;
  ...
  _tmp_SecondSolver = (struct bHYPRE_PreconditionedSolver__object*) 
    sidl_Java_J2I_ifc(env, _arg_SecondSolver, "bHYPRE.PreconditionedSolver", 
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.Hybrid", FALSE);JAVA_CHECK(
    env);
...
jni_GetFirstSolver(
  JNIEnv* env,
  jobject obj,
  jobject _arg_FirstSolver)
{
  /*
   * Declare return and temporary variables.
   */

  struct bHYPRE_Hybrid__object* _ior = NULL;
  struct bHYPRE_PreconditionedSolver__object* _tmp_FirstSolver = (struct 
    bHYPRE_PreconditionedSolver__object*) NULL;
  int32_t _ior_res = 0;
  jint _res = 0;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  _ior_res = (*(_ior->d_epv->f_GetFirstSolver))(
    _ior,
    &_tmp_FirstSolver,
    &_ex);
  ...
  sidl_Java_I2J_ifc_holder(env, _arg_FirstSolver, _tmp_FirstSolver, 
    "bHYPRE.PreconditionedSolver", FALSE);JAVA_CHECK(env);
  _res = (jint) _ior_res;
  ...
  jobject _arg_SecondSolver)
{
  ...
  _ior_res = (*(_ior->d_epv->f_GetSecondSolver))(
    _ior,
    &_tmp_SecondSolver,
    &_ex);
  ...
  sidl_Java_I2J_ifc_holder(env, _arg_SecondSolver, _tmp_SecondSolver, 
    "bHYPRE.PreconditionedSolver", FALSE);JAVA_CHECK(env);
  _res = (jint) _ior_res;
...
void bHYPRE_Hybrid__register(JNIEnv* env)
{
  JNINativeMethod methods[31];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_Hybrid__externals();
#else
  s_external = (struct bHYPRE_Hybrid__external*)sidl_dynamicLoadIOR(
    "bHYPRE.Hybrid","bHYPRE_Hybrid__externals") ;
  sidl_checkIORVersion("bHYPRE.Hybrid", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/Hybrid;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/PreconditionedSolver;LbHYPRE/Operator;)LbHYPRE/Hybrid;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "GetFirstSolver";
  methods[8].signature = "(LbHYPRE/PreconditionedSolver$Holder;)I";
  methods[8].fnPtr     = (void *)jni_GetFirstSolver;
  methods[9].name      = "GetSecondSolver";
  methods[9].signature = "(LbHYPRE/PreconditionedSolver$Holder;)I";
  methods[9].fnPtr     = (void *)jni_GetSecondSolver;
  ...
  cls = (*env)->FindClass(env, "bHYPRE/Hybrid");
  if (cls) {
