/*
 * File:          bHYPRE_ParCSRDiagScale_jniStub.c
 * Symbol:        bHYPRE.ParCSRDiagScale-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.ParCSRDiagScale
 * 
...
#endif
#ifndef included_bHYPRE_ParCSRDiagScale_jniStub_h
#include "bHYPRE_ParCSRDiagScale_jniStub.h"
#endif
...
static struct bHYPRE_ParCSRDiagScale__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_ParCSRDiagScale__object*) ptr;
}
...
static const struct bHYPRE_ParCSRDiagScale__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_ParCSRDiagScale__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_ParCSRDiagScale__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_ParCSRDiagScale__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_ParCSRDiagScale__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_ParCSRDiagScale__object* _ior_res = (struct 
    bHYPRE_ParCSRDiagScale__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.ParCSRDiagScale", 
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_ParCSRDiagScale__object* _ior = NULL;
...
void bHYPRE_ParCSRDiagScale__register(JNIEnv* env)
{
  JNINativeMethod methods[29];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_ParCSRDiagScale__externals();
#else
  s_external = (struct bHYPRE_ParCSRDiagScale__external*)sidl_dynamicLoadIOR(
  ...
  methods[2].signature = "(LbHYPRE/ParCSRDiagScale;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/IJParCSRMatrix;)LbHYPRE/ParCSRDiagScale;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/ParCSRDiagScale");
  if (cls) {
