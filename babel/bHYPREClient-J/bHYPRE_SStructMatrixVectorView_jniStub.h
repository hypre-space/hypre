/*
 * File:          bHYPRE_SStructMatrixVectorView_jniStub.h
 * Symbol:        bHYPRE.SStructMatrixVectorView-v1.0.0
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Description:   Client-side header code for bHYPRE.SStructMatrixVectorView
 * 
...
#define included_bHYPRE_SStructMatrixVectorView_jniStub_h
