/*
 * File:          bHYPRE_Operator_jniStub.c
 * Symbol:        bHYPRE.Operator-v1.0.0
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.Operator
 * 
...
static struct bHYPRE_Operator__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_Operator__object*) ptr;
}
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_Operator__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
  ...
  jobject _arg_mpi_comm)
{
  ...
  struct bHYPRE_Operator__object* _ior = NULL;
...
void bHYPRE_Operator__register(JNIEnv* env)
{
  ...
  methods[5].name      = "SetIntParameter";
  methods[5].signature = "(Ljava/lang/String;I)I";
  methods[5].fnPtr     = (void *)jni_SetIntParameter;
  methods[6].name      = "SetDoubleParameter";
  methods[6].signature = "(Ljava/lang/String;D)I";
  methods[6].fnPtr     = (void *)jni_SetDoubleParameter;
  methods[7].name      = "SetStringParameter";
  methods[7].signature = "(Ljava/lang/String;Ljava/lang/String;)I";
  methods[7].fnPtr     = (void *)jni_SetStringParameter;
  methods[8].name      = "SetIntArray1Parameter";
  methods[8].signature = "(Ljava/lang/String;Lsidl/Integer$Array1;)I";
  methods[8].fnPtr     = (void *)jni_SetIntArray1Parameter;
  methods[9].name      = "SetIntArray2Parameter";
  methods[9].signature = "(Ljava/lang/String;Lsidl/Integer$Array2;)I";
  methods[9].fnPtr     = (void *)jni_SetIntArray2Parameter;
  methods[10].name      = "SetDoubleArray1Parameter";
  methods[10].signature = "(Ljava/lang/String;Lsidl/Double$Array1;)I";
  methods[10].fnPtr     = (void *)jni_SetDoubleArray1Parameter;
  methods[11].name      = "SetDoubleArray2Parameter";
  methods[11].signature = "(Ljava/lang/String;Lsidl/Double$Array2;)I";
  methods[11].fnPtr     = (void *)jni_SetDoubleArray2Parameter;
  methods[12].name      = "GetIntValue";
  methods[12].signature = "(Ljava/lang/String;Lsidl/Integer$Holder;)I";
  methods[12].fnPtr     = (void *)jni_GetIntValue;
  methods[13].name      = "GetDoubleValue";
  methods[13].signature = "(Ljava/lang/String;Lsidl/Double$Holder;)I";
  methods[13].fnPtr     = (void *)jni_GetDoubleValue;
  methods[14].name      = "Setup";
  methods[14].signature = "(LbHYPRE/Vector;LbHYPRE/Vector;)I";
  methods[14].fnPtr     = (void *)jni_Setup;
  methods[15].name      = "Apply";
  methods[15].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[15].fnPtr     = (void *)jni_Apply;
  methods[16].name      = "ApplyAdjoint";
  methods[16].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[16].fnPtr     = (void *)jni_ApplyAdjoint;
  ...
  cls = (*env)->FindClass(env, "bHYPRE/Operator$Wrapper");
  if (cls) {
