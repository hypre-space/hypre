/*
 * File:          bHYPRE_StructJacobi_jniStub.c
 * Symbol:        bHYPRE.StructJacobi-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.StructJacobi
 * 
...
#include "bHYPRE_StructJacobi_jniStub.h"
#endif
...
static struct bHYPRE_StructJacobi__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_StructJacobi__object*) ptr;
}
...
static const struct bHYPRE_StructJacobi__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_StructJacobi__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_StructJacobi__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_StructJacobi__object *_ptr = (*s_external->createObject)(g_data,
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_StructJacobi__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_StructJacobi__object* _ior_res = (struct 
    bHYPRE_StructJacobi__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.StructJacobi", 
    FALSE);JAVA_CHECK(env);
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_StructJacobi__object* _ior = NULL;
...
void bHYPRE_StructJacobi__register(JNIEnv* env)
{
  JNINativeMethod methods[29];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_StructJacobi__externals();
#else
  s_external = (struct bHYPRE_StructJacobi__external*)sidl_dynamicLoadIOR(
    "bHYPRE.StructJacobi","bHYPRE_StructJacobi__externals") ;
  sidl_checkIORVersion("bHYPRE.StructJacobi", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/StructJacobi;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/StructMatrix;)LbHYPRE/StructJacobi;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/StructJacobi");
  if (cls) {
