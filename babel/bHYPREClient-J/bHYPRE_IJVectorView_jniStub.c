/*
 * File:          bHYPRE_IJVectorView_jniStub.c
 * Symbol:        bHYPRE.IJVectorView-v1.0.0
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.IJVectorView
 * 
...
#ifndef included_bHYPRE_IJVectorView_jniStub_h
#include "bHYPRE_IJVectorView_jniStub.h"
#endif
...
static struct bHYPRE_IJVectorView__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_IJVectorView__object*) ptr;
}
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_IJVectorView__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
  ...
  jint _arg_jupper)
{
  ...
  struct bHYPRE_IJVectorView__object* _ior = NULL;
  ...
  jobject _arg_values)
{
  ...
  struct bHYPRE_IJVectorView__object* _ior = NULL;
  struct sidl_int__array* _tmp_indices = (struct sidl_int__array*) NULL;
  ...
  _ior = _get_ior(env, obj);
  _tmp_indices = (struct sidl_int__array*) sidl_Java_J2I_borrow_array(env, 
    _arg_indices);
...
void bHYPRE_IJVectorView__register(JNIEnv* env)
{
  ...
  methods[3].signature = "(II)I";
  methods[3].fnPtr     = (void *)jni_SetLocalRange;
  methods[4].name      = "SetValues";
  methods[4].signature = "(Lsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  methods[4].fnPtr     = (void *)jni_SetValues;
  methods[5].name      = "AddToValues";
  methods[5].signature = "(Lsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  methods[5].fnPtr     = (void *)jni_AddToValues;
  methods[6].name      = "GetLocalRange";
  methods[6].signature = "(Lsidl/Integer$Holder;Lsidl/Integer$Holder;)I";
  methods[6].fnPtr     = (void *)jni_GetLocalRange;
  methods[7].name      = "GetValues";
  methods[7].signature = "(Lsidl/Integer$Array1;Lsidl/Double$Array1$Holder;)I";
  methods[7].fnPtr     = (void *)jni_GetValues;
  methods[8].name      = "Print";
  methods[8].signature = "(Ljava/lang/String;)I";
  methods[8].fnPtr     = (void *)jni_Print;
  methods[9].name      = "Read";
  methods[9].signature = "(Ljava/lang/String;LbHYPRE/MPICommunicator;)I";
  methods[9].fnPtr     = (void *)jni_Read;
  methods[10].name      = "SetCommunicator";
  methods[10].signature = "(LbHYPRE/MPICommunicator;)I";
  methods[10].fnPtr     = (void *)jni_SetCommunicator;
  methods[11].name      = "Destroy";
  methods[11].signature = "()V";
  methods[11].fnPtr     = (void *)jni_Destroy;
  methods[12].name      = "Initialize";
  methods[12].signature = "()I";
  methods[12].fnPtr     = (void *)jni_Initialize;
  methods[13].name      = "Assemble";
  methods[13].signature = "()I";
  methods[13].fnPtr     = (void *)jni_Assemble;
  methods[14].name      = "addRef";
  methods[14].signature = "()V";
  methods[14].fnPtr     = (void *)jni_addRef;
  methods[15].name      = "deleteRef";
  methods[15].signature = "()V";
  methods[15].fnPtr     = (void *)jni_deleteRef;
  methods[16].name      = "isSame";
  methods[16].signature = "(Lsidl/BaseInterface;)Z";
  methods[16].fnPtr     = (void *)jni_isSame;
  methods[17].name      = "isType";
  methods[17].signature = "(Ljava/lang/String;)Z";
  methods[17].fnPtr     = (void *)jni_isType;
  methods[18].name      = "getClassInfo";
  methods[18].signature = "()Lsidl/ClassInfo;";
  methods[18].fnPtr     = (void *)jni_getClassInfo;


  cls = (*env)->FindClass(env, "bHYPRE/IJVectorView$Wrapper");
  if (cls) {
