/*
 * File:          bHYPRE_SStructParCSRMatrix_jniStub.c
 * Symbol:        bHYPRE.SStructParCSRMatrix-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.SStructParCSRMatrix
 * 
...
#include "bHYPRE_SStructParCSRMatrix_jniStub.h"
#endif
...
static struct bHYPRE_SStructParCSRMatrix__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_SStructParCSRMatrix__object*) ptr;
}
...
static const struct bHYPRE_SStructParCSRMatrix__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_SStructParCSRMatrix__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_SStructParCSRMatrix__remoteCreate(_tmp_url, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_SStructParCSRMatrix__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_SStructParCSRMatrix__remoteConnect(_tmp_url, 1,
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_graph)
{
  ...
  struct bHYPRE_SStructParCSRMatrix__object* _ior_res = (struct 
    bHYPRE_SStructParCSRMatrix__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.SStructParCSRMatrix", 
  ...
  jobject _arg_graph)
{
  ...
  struct bHYPRE_SStructParCSRMatrix__object* _ior = NULL;
  struct bHYPRE_SStructGraph__object* _tmp_graph = (struct 
    bHYPRE_SStructGraph__object*) NULL;
  int32_t _ior_res = 0;
  jint _res = 0;
...
void bHYPRE_SStructParCSRMatrix__register(JNIEnv* env)
{
  JNINativeMethod methods[34];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_SStructParCSRMatrix__externals();
#else
  s_external = (struct 
  ...
  methods[2].signature = "(LbHYPRE/SStructParCSRMatrix;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/SStructGraph;)LbHYPRE/SStructParCSRMatrix;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "SetGraph";
  methods[8].signature = "(LbHYPRE/SStructGraph;)I";
  methods[8].fnPtr     = (void *)jni_SetGraph;
  methods[9].name      = "SetValues";
  methods[9].signature = "(ILsidl/Integer$Array1;ILsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  methods[9].fnPtr     = (void *)jni_SetValues;
  methods[10].name      = "SetBoxValues";
  methods[10].signature = "(ILsidl/Integer$Array1;Lsidl/Integer$Array1;ILsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  methods[10].fnPtr     = (void *)jni_SetBoxValues;
  methods[11].name      = "AddToValues";
  methods[11].signature = "(ILsidl/Integer$Array1;ILsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  methods[11].fnPtr     = (void *)jni_AddToValues;
  methods[12].name      = "AddToBoxValues";
  methods[12].signature = "(ILsidl/Integer$Array1;Lsidl/Integer$Array1;ILsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  methods[12].fnPtr     = (void *)jni_AddToBoxValues;
  methods[13].name      = "SetSymmetric";
  methods[13].signature = "(IIII)I";
  methods[13].fnPtr     = (void *)jni_SetSymmetric;
  methods[14].name      = "SetNSSymmetric";
  methods[14].signature = "(I)I";
  methods[14].fnPtr     = (void *)jni_SetNSSymmetric;
  methods[15].name      = "SetComplex";
  methods[15].signature = "()I";
  methods[15].fnPtr     = (void *)jni_SetComplex;
  methods[16].name      = "Print";
  methods[16].signature = "(Ljava/lang/String;I)I";
  methods[16].fnPtr     = (void *)jni_Print;
  methods[17].name      = "GetObject";
  methods[17].signature = "(Lsidl/BaseInterface$Holder;)I";
  methods[17].fnPtr     = (void *)jni_GetObject;
  ...
  methods[20].name      = "Initialize";
  methods[20].signature = "()I";
  methods[20].fnPtr     = (void *)jni_Initialize;
  methods[21].name      = "Assemble";
  methods[21].signature = "()I";
  methods[21].fnPtr     = (void *)jni_Assemble;
  methods[22].name      = "SetIntParameter";
  methods[22].signature = "(Ljava/lang/String;I)I";
  methods[22].fnPtr     = (void *)jni_SetIntParameter;
  methods[23].name      = "SetDoubleParameter";
  methods[23].signature = "(Ljava/lang/String;D)I";
  methods[23].fnPtr     = (void *)jni_SetDoubleParameter;
  methods[24].name      = "SetStringParameter";
  methods[24].signature = "(Ljava/lang/String;Ljava/lang/String;)I";
  methods[24].fnPtr     = (void *)jni_SetStringParameter;
  methods[25].name      = "SetIntArray1Parameter";
  methods[25].signature = "(Ljava/lang/String;Lsidl/Integer$Array1;)I";
  methods[25].fnPtr     = (void *)jni_SetIntArray1Parameter;
  methods[26].name      = "SetIntArray2Parameter";
  methods[26].signature = "(Ljava/lang/String;Lsidl/Integer$Array2;)I";
  methods[26].fnPtr     = (void *)jni_SetIntArray2Parameter;
  methods[27].name      = "SetDoubleArray1Parameter";
  methods[27].signature = "(Ljava/lang/String;Lsidl/Double$Array1;)I";
  methods[27].fnPtr     = (void *)jni_SetDoubleArray1Parameter;
  methods[28].name      = "SetDoubleArray2Parameter";
  methods[28].signature = "(Ljava/lang/String;Lsidl/Double$Array2;)I";
  methods[28].fnPtr     = (void *)jni_SetDoubleArray2Parameter;
  methods[29].name      = "GetIntValue";
  methods[29].signature = "(Ljava/lang/String;Lsidl/Integer$Holder;)I";
  methods[29].fnPtr     = (void *)jni_GetIntValue;
  methods[30].name      = "GetDoubleValue";
  methods[30].signature = "(Ljava/lang/String;Lsidl/Double$Holder;)I";
  methods[30].fnPtr     = (void *)jni_GetDoubleValue;
  methods[31].name      = "Setup";
  methods[31].signature = "(LbHYPRE/Vector;LbHYPRE/Vector;)I";
  methods[31].fnPtr     = (void *)jni_Setup;
  methods[32].name      = "Apply";
  methods[32].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[32].fnPtr     = (void *)jni_Apply;
  methods[33].name      = "ApplyAdjoint";
  methods[33].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[33].fnPtr     = (void *)jni_ApplyAdjoint;


  cls = (*env)->FindClass(env, "bHYPRE/SStructParCSRMatrix");
  if (cls) {
    (*env)->RegisterNatives(env, cls, methods, 34);
    (*env)->DeleteLocalRef(env, cls);
  }
}
