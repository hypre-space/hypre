/*
 * File:          bHYPRE_Euclid_jniStub.c
 * Symbol:        bHYPRE.Euclid-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.Euclid
 * 
...
#ifndef included_bHYPRE_Euclid_jniStub_h
#include "bHYPRE_Euclid_jniStub.h"
#endif
...
static struct bHYPRE_Euclid__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_Euclid__object*) ptr;
}
...
static const struct bHYPRE_Euclid__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_Euclid__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_Euclid__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_Euclid__object *_ptr = (*s_external->createObject)(g_data, 
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_Euclid__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_Euclid__object* _ior_res = (struct bHYPRE_Euclid__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.Euclid", FALSE);JAVA_CHECK(
    env);
  ...
  jobject _arg_argv)
{
  ...
  struct bHYPRE_Euclid__object* _ior = NULL;
  int32_t _tmp_argc = 0;
  char* _tmp_argv = (char*) NULL;
  int32_t _ior_res = 0;
  jint _res = 0;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  _tmp_argv = sidl_Java_J2I_string_holder(env, _arg_argv);

  /*
   * Call the IOR method through the EPV.
   */

  _ior_res = (*(_ior->d_epv->f_SetParameters))(
    _ior,
    _tmp_argc,
    &_tmp_argv,
    &_ex);
  ...
  sidl_Java_I2J_string_holder(env, _arg_argv, _tmp_argv);
  sidl_String_free(_tmp_argv);
  _res = (jint) _ior_res;
...
void bHYPRE_Euclid__register(JNIEnv* env)
{
  JNINativeMethod methods[30];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_Euclid__externals();
#else
  s_external = (struct bHYPRE_Euclid__external*)sidl_dynamicLoadIOR(
    "bHYPRE.Euclid","bHYPRE_Euclid__externals") ;
  sidl_checkIORVersion("bHYPRE.Euclid", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/Euclid;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/IJParCSRMatrix;)LbHYPRE/Euclid;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "SetParameters";
  methods[8].signature = "(ILsidl/String$Holder;)I";
  methods[8].fnPtr     = (void *)jni_SetParameters;
  methods[9].name      = "SetOperator";
  methods[9].signature = "(LbHYPRE/Operator;)I";
  methods[9].fnPtr     = (void *)jni_SetOperator;
  methods[10].name      = "SetTolerance";
  methods[10].signature = "(D)I";
  methods[10].fnPtr     = (void *)jni_SetTolerance;
  methods[11].name      = "SetMaxIterations";
  methods[11].signature = "(I)I";
  methods[11].fnPtr     = (void *)jni_SetMaxIterations;
  methods[12].name      = "SetLogging";
  methods[12].signature = "(I)I";
  methods[12].fnPtr     = (void *)jni_SetLogging;
  methods[13].name      = "SetPrintLevel";
  methods[13].signature = "(I)I";
  methods[13].fnPtr     = (void *)jni_SetPrintLevel;
  methods[14].name      = "GetNumIterations";
  methods[14].signature = "(Lsidl/Integer$Holder;)I";
  methods[14].fnPtr     = (void *)jni_GetNumIterations;
  methods[15].name      = "GetRelResidualNorm";
  methods[15].signature = "(Lsidl/Double$Holder;)I";
  methods[15].fnPtr     = (void *)jni_GetRelResidualNorm;
  ...
  methods[18].name      = "SetIntParameter";
  methods[18].signature = "(Ljava/lang/String;I)I";
  methods[18].fnPtr     = (void *)jni_SetIntParameter;
  methods[19].name      = "SetDoubleParameter";
  methods[19].signature = "(Ljava/lang/String;D)I";
  methods[19].fnPtr     = (void *)jni_SetDoubleParameter;
  methods[20].name      = "SetStringParameter";
  methods[20].signature = "(Ljava/lang/String;Ljava/lang/String;)I";
  methods[20].fnPtr     = (void *)jni_SetStringParameter;
  methods[21].name      = "SetIntArray1Parameter";
  methods[21].signature = "(Ljava/lang/String;Lsidl/Integer$Array1;)I";
  methods[21].fnPtr     = (void *)jni_SetIntArray1Parameter;
  methods[22].name      = "SetIntArray2Parameter";
  methods[22].signature = "(Ljava/lang/String;Lsidl/Integer$Array2;)I";
  methods[22].fnPtr     = (void *)jni_SetIntArray2Parameter;
  methods[23].name      = "SetDoubleArray1Parameter";
  methods[23].signature = "(Ljava/lang/String;Lsidl/Double$Array1;)I";
  methods[23].fnPtr     = (void *)jni_SetDoubleArray1Parameter;
  methods[24].name      = "SetDoubleArray2Parameter";
  methods[24].signature = "(Ljava/lang/String;Lsidl/Double$Array2;)I";
  methods[24].fnPtr     = (void *)jni_SetDoubleArray2Parameter;
  methods[25].name      = "GetIntValue";
  methods[25].signature = "(Ljava/lang/String;Lsidl/Integer$Holder;)I";
  methods[25].fnPtr     = (void *)jni_GetIntValue;
  methods[26].name      = "GetDoubleValue";
  methods[26].signature = "(Ljava/lang/String;Lsidl/Double$Holder;)I";
  methods[26].fnPtr     = (void *)jni_GetDoubleValue;
  methods[27].name      = "Setup";
  methods[27].signature = "(LbHYPRE/Vector;LbHYPRE/Vector;)I";
  methods[27].fnPtr     = (void *)jni_Setup;
  methods[28].name      = "Apply";
  methods[28].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[28].fnPtr     = (void *)jni_Apply;
  methods[29].name      = "ApplyAdjoint";
  methods[29].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[29].fnPtr     = (void *)jni_ApplyAdjoint;


  cls = (*env)->FindClass(env, "bHYPRE/Euclid");
  if (cls) {
