/*
 * File:          bHYPRE_Hybrid_jniStub.h
 * Symbol:        bHYPRE.Hybrid-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side header code for bHYPRE.Hybrid
 * 
 * WARNING: Automatically generated; changes will be lost
 * 
 */

#ifndef included_bHYPRE_Hybrid_jniStub_h
#define included_bHYPRE_Hybrid_jniStub_h
