/*
 * File:          bHYPRE_Solver_jniStub.c
 * Symbol:        bHYPRE.Solver-v1.0.0
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.Solver
 * 
...
static struct bHYPRE_Solver__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_Solver__object*) ptr;
}
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_Solver__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_Solver__object* _ior = NULL;
...
void bHYPRE_Solver__register(JNIEnv* env)
{
  ...
  methods[3].name      = "SetOperator";
  methods[3].signature = "(LbHYPRE/Operator;)I";
  methods[3].fnPtr     = (void *)jni_SetOperator;
  methods[4].name      = "SetTolerance";
  methods[4].signature = "(D)I";
  methods[4].fnPtr     = (void *)jni_SetTolerance;
  methods[5].name      = "SetMaxIterations";
  methods[5].signature = "(I)I";
  methods[5].fnPtr     = (void *)jni_SetMaxIterations;
  methods[6].name      = "SetLogging";
  methods[6].signature = "(I)I";
  methods[6].fnPtr     = (void *)jni_SetLogging;
  methods[7].name      = "SetPrintLevel";
  methods[7].signature = "(I)I";
  methods[7].fnPtr     = (void *)jni_SetPrintLevel;
  methods[8].name      = "GetNumIterations";
  methods[8].signature = "(Lsidl/Integer$Holder;)I";
  methods[8].fnPtr     = (void *)jni_GetNumIterations;
  methods[9].name      = "GetRelResidualNorm";
  methods[9].signature = "(Lsidl/Double$Holder;)I";
  methods[9].fnPtr     = (void *)jni_GetRelResidualNorm;
  ...
  methods[12].name      = "SetIntParameter";
  methods[12].signature = "(Ljava/lang/String;I)I";
  methods[12].fnPtr     = (void *)jni_SetIntParameter;
  methods[13].name      = "SetDoubleParameter";
  methods[13].signature = "(Ljava/lang/String;D)I";
  methods[13].fnPtr     = (void *)jni_SetDoubleParameter;
  methods[14].name      = "SetStringParameter";
  methods[14].signature = "(Ljava/lang/String;Ljava/lang/String;)I";
  methods[14].fnPtr     = (void *)jni_SetStringParameter;
  methods[15].name      = "SetIntArray1Parameter";
  methods[15].signature = "(Ljava/lang/String;Lsidl/Integer$Array1;)I";
  methods[15].fnPtr     = (void *)jni_SetIntArray1Parameter;
  methods[16].name      = "SetIntArray2Parameter";
  methods[16].signature = "(Ljava/lang/String;Lsidl/Integer$Array2;)I";
  methods[16].fnPtr     = (void *)jni_SetIntArray2Parameter;
  methods[17].name      = "SetDoubleArray1Parameter";
  methods[17].signature = "(Ljava/lang/String;Lsidl/Double$Array1;)I";
  methods[17].fnPtr     = (void *)jni_SetDoubleArray1Parameter;
  methods[18].name      = "SetDoubleArray2Parameter";
  methods[18].signature = "(Ljava/lang/String;Lsidl/Double$Array2;)I";
  methods[18].fnPtr     = (void *)jni_SetDoubleArray2Parameter;
  methods[19].name      = "GetIntValue";
  methods[19].signature = "(Ljava/lang/String;Lsidl/Integer$Holder;)I";
  methods[19].fnPtr     = (void *)jni_GetIntValue;
  methods[20].name      = "GetDoubleValue";
  methods[20].signature = "(Ljava/lang/String;Lsidl/Double$Holder;)I";
  methods[20].fnPtr     = (void *)jni_GetDoubleValue;
  methods[21].name      = "Setup";
  methods[21].signature = "(LbHYPRE/Vector;LbHYPRE/Vector;)I";
  methods[21].fnPtr     = (void *)jni_Setup;
  methods[22].name      = "Apply";
  methods[22].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[22].fnPtr     = (void *)jni_Apply;
  methods[23].name      = "ApplyAdjoint";
  methods[23].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[23].fnPtr     = (void *)jni_ApplyAdjoint;
  methods[24].name      = "addRef";
  methods[24].signature = "()V";
  methods[24].fnPtr     = (void *)jni_addRef;
  methods[25].name      = "deleteRef";
  methods[25].signature = "()V";
  methods[25].fnPtr     = (void *)jni_deleteRef;
  methods[26].name      = "isSame";
  methods[26].signature = "(Lsidl/BaseInterface;)Z";
  methods[26].fnPtr     = (void *)jni_isSame;
  methods[27].name      = "isType";
  methods[27].signature = "(Ljava/lang/String;)Z";
  methods[27].fnPtr     = (void *)jni_isType;
  methods[28].name      = "getClassInfo";
  methods[28].signature = "()Lsidl/ClassInfo;";
  methods[28].fnPtr     = (void *)jni_getClassInfo;


  cls = (*env)->FindClass(env, "bHYPRE/Solver$Wrapper");
  if (cls) {
