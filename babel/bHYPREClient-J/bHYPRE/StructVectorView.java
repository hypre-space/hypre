 ...
 */
public interface StructVectorView extends
  ...
  bHYPRE.MatrixVectorView
{
  ...
  public static class Wrapper
    ...
    implements bHYPRE.StructVectorView
  {
    /*
    ...
    static {
      gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.StructVectorView");
    }
    ...
    public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
      ...
      long ior = obj._cast_ior("bHYPRE.StructVectorView");
      if (ior != 0) {
        Class java_class = null;
        try {
          java_class = Class.forName("bHYPRE.StructVectorView$Wrapper");
        } catch (Exception ex) {
  ...
  public static class Holder {
    private bHYPRE.StructVectorView d_obj;
     ...
     */
    public Holder(bHYPRE.StructVectorView obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.StructVectorView obj) {
      d_obj = obj;
    }
     ...
     */
    public bHYPRE.StructVectorView get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.StructVectorView.Wrapper _get(int i, int j, int k, int l, int 
      m, int n, int o) {
      bHYPRE.StructVectorView.Wrapper ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.StructVectorView.Wrapper) preCast._cast2(
          "bHYPRE.StructVectorView");
      } else {
        return null;
      }
      return (bHYPRE.StructVectorView.Wrapper) ret;
    }
     ...
     */
    public bHYPRE.StructVectorView.Array _slice(int dimen, int[] numElem, int[] 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.StructVectorView.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.StructVectorView.Array(
        preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.StructVectorView.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.StructVectorView.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.StructVectorView.Array1(
            getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.StructVectorView.Array2(
            getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.StructVectorView.Array3(
            getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.StructVectorView.Array4(
            getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.StructVectorView.Array5(
            getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.StructVectorView.Array6(
            getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.StructVectorView.Array7(
            getBaseInterfaceArray());
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private bHYPRE.StructVectorView.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.StructVectorView.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.StructVectorView.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.StructVectorView.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.StructVectorView 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.StructVectorView[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.StructVectorView.Wrapper _get( int j0) {
      return (bHYPRE.StructVectorView.Wrapper)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.StructVectorView.Wrapper get( int j0) {
      checkBounds(  j0);
      bHYPRE.StructVectorView.Wrapper ret = null;
      ret = (bHYPRE.StructVectorView.Wrapper) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.StructVectorView.Array1 smartCopy() {
      bHYPRE.StructVectorView.Array1 ret = null;
      bHYPRE.StructVectorView.Array preCast = null;
      preCast = (bHYPRE.StructVectorView.Array) _smartCopy();
      return new bHYPRE.StructVectorView.Array1(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     */
    public void copy(bHYPRE.StructVectorView.Array1 dest) {
      _copy((bHYPRE.StructVectorView.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.StructVectorView value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.StructVectorView value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.StructVectorView[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.StructVectorView[] toArray() {
      bHYPRE.StructVectorView[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.StructVectorView[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.StructVectorView.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.StructVectorView.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.StructVectorView.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.StructVectorView.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.StructVectorView 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.StructVectorView[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.StructVectorView.Wrapper _get( int j0, int j1) {
      return (bHYPRE.StructVectorView.Wrapper)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.StructVectorView.Wrapper get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.StructVectorView.Wrapper ret = null;
      ret = (bHYPRE.StructVectorView.Wrapper) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.StructVectorView.Array2 smartCopy() {
      bHYPRE.StructVectorView.Array2 ret = null;
      bHYPRE.StructVectorView.Array preCast = null;
      preCast = (bHYPRE.StructVectorView.Array) _smartCopy();
      return new bHYPRE.StructVectorView.Array2(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.StructVectorView.Array2 dest) {
      _copy((bHYPRE.StructVectorView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.StructVectorView value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.StructVectorView value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.StructVectorView[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.StructVectorView[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.StructVectorView[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.StructVectorView.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.StructVectorView.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.StructVectorView.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.StructVectorView.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.StructVectorView 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.StructVectorView[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.StructVectorView.Wrapper _get( int j0, int j1, int j2) {
      return (bHYPRE.StructVectorView.Wrapper)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.StructVectorView.Wrapper get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.StructVectorView.Wrapper ret = null;
      ret = (bHYPRE.StructVectorView.Wrapper) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.StructVectorView.Array3 smartCopy() {
      bHYPRE.StructVectorView.Array3 ret = null;
      bHYPRE.StructVectorView.Array preCast = null;
      preCast = (bHYPRE.StructVectorView.Array) _smartCopy();
      return new bHYPRE.StructVectorView.Array3(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.StructVectorView.Array3 dest) {
      _copy((bHYPRE.StructVectorView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.StructVectorView value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.StructVectorView value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.StructVectorView[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.StructVectorView[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.StructVectorView[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.StructVectorView.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.StructVectorView.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.StructVectorView.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.StructVectorView.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.StructVectorView 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.StructVectorView[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.StructVectorView.Wrapper _get( int j0, int j1, int j2, int 
      j3) {
      return (bHYPRE.StructVectorView.Wrapper)_get(  j0,  j1,  j2,  j3, 0, 0, 
        0);
    }
     ...
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.StructVectorView.Wrapper get( int j0, int j1, int j2, int j3) 
      {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.StructVectorView.Wrapper ret = null;
      ret = (bHYPRE.StructVectorView.Wrapper) _get(  j0,  j1,  j2,  j3, 0, 0, 
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.StructVectorView.Array4 smartCopy() {
      bHYPRE.StructVectorView.Array4 ret = null;
      bHYPRE.StructVectorView.Array preCast = null;
      preCast = (bHYPRE.StructVectorView.Array) _smartCopy();
      return new bHYPRE.StructVectorView.Array4(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.StructVectorView.Array4 dest) {
      _copy((bHYPRE.StructVectorView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.StructVectorView 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.StructVectorView 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.StructVectorView[][][][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.StructVectorView[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.StructVectorView[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.StructVectorView.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.StructVectorView.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.StructVectorView.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.StructVectorView.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.StructVectorView 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.StructVectorView[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.StructVectorView.Wrapper _get( int j0, int j1, int j2, int j3,
      int j4) {
      return (bHYPRE.StructVectorView.Wrapper)_get(  j0,  j1,  j2,  j3,  j4, 0, 
        0);
    }
    ...
    public bHYPRE.StructVectorView.Wrapper get( int j0, int j1, int j2, int j3, 
      ...
      bHYPRE.StructVectorView.Wrapper ret = null;
      ret = (bHYPRE.StructVectorView.Wrapper) _get(  j0,  j1,  j2,  j3,  j4, 0, 
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.StructVectorView.Array5 smartCopy() {
      bHYPRE.StructVectorView.Array5 ret = null;
      bHYPRE.StructVectorView.Array preCast = null;
      preCast = (bHYPRE.StructVectorView.Array) _smartCopy();
      return new bHYPRE.StructVectorView.Array5(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.StructVectorView.Array5 dest) {
      _copy((bHYPRE.StructVectorView.Array) dest);
    }
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.StructVectorView[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.StructVectorView[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.StructVectorView.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.StructVectorView.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.StructVectorView.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.StructVectorView.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.StructVectorView 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.StructVectorView[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.StructVectorView.Wrapper _get( int j0, int j1, int j2, int j3,
      int j4, int j5) {
      return (bHYPRE.StructVectorView.Wrapper)_get(  j0,  j1,  j2,  j3,  j4,  
        j5, 0);
    }
    ...
    public bHYPRE.StructVectorView.Wrapper get( int j0, int j1, int j2, int j3, 
      ...
      bHYPRE.StructVectorView.Wrapper ret = null;
      ret = (bHYPRE.StructVectorView.Wrapper) _get(  j0,  j1,  j2,  j3,  j4,  
        j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.StructVectorView.Array6 smartCopy() {
      bHYPRE.StructVectorView.Array6 ret = null;
      bHYPRE.StructVectorView.Array preCast = null;
      preCast = (bHYPRE.StructVectorView.Array) _smartCopy();
      return new bHYPRE.StructVectorView.Array6(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.StructVectorView.Array6 dest) {
      _copy((bHYPRE.StructVectorView.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.StructVectorView[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.StructVectorView[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.StructVectorView.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.StructVectorView.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.StructVectorView.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.StructVectorView.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.StructVectorView 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.StructVectorView[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.StructVectorView.Array7 smartCopy() {
      bHYPRE.StructVectorView.Array7 ret = null;
      bHYPRE.StructVectorView.Array preCast = null;
      preCast = (bHYPRE.StructVectorView.Array) _smartCopy();
      return new bHYPRE.StructVectorView.Array7(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.StructVectorView.Array7 dest) {
      _copy((bHYPRE.StructVectorView.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.StructVectorView[][][][][][][] orray , 
      boolean inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
                ...
                for (int m = l4; m <= u4; m++) {
                  ...
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new 
                      bHYPRE.StructVectorView[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.StructVectorView.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.StructVectorView.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.StructVectorView.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.StructVectorView.Array7 get() {
        return d_obj;
      }
