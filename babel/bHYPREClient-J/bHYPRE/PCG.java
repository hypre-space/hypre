  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.PCG");
  }
   ...
   */
  protected static native long _wrap(PCG ddata);

  /**
   * Remote constructor for the class.
   */
  public PCG(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new PCG(_connect_remote_ior(url));
  }
   ...
   */
  public static native bHYPRE.PCG Create(
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("bHYPRE.PCG");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("bHYPRE.PCG");
      } catch (Exception ex) {
  ...
  public static class Holder {
     ...
     */
    public void set(bHYPRE.PCG obj) {
      d_obj = obj;
    }
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.PCG _get(int i, int j, int k, int l, int m, int n, int o) {
      bHYPRE.PCG ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.PCG) preCast._cast2("bHYPRE.PCG");
      } else {
        return null;
      }
      return (bHYPRE.PCG) ret;
    }
     ...
     */
    public bHYPRE.PCG.Array _slice(int dimen, int[] numElem, int[] srcStart, 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.PCG.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.PCG.Array(preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.PCG.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.PCG.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.PCG.Array1(getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.PCG.Array2(getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.PCG.Array3(getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.PCG.Array4(getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.PCG.Array5(getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.PCG.Array6(getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.PCG.Array7(getBaseInterfaceArray());
          return ret;
        default:
          return null;
        }
     ...
     */
    public static class Holder {
      private bHYPRE.PCG.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PCG.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PCG.Array obj) {
        d_obj = obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PCG 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.PCG[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.PCG _get( int j0) {
      return (bHYPRE.PCG)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PCG get( int j0) {
      checkBounds(  j0);
      bHYPRE.PCG ret = null;
      ret = (bHYPRE.PCG) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.PCG.Array1 smartCopy() {
      bHYPRE.PCG.Array1 ret = null;
      bHYPRE.PCG.Array preCast = null;
      preCast = (bHYPRE.PCG.Array) _smartCopy();
      return new bHYPRE.PCG.Array1(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PCG.Array1 dest) {
      _copy((bHYPRE.PCG.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.PCG[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.PCG[] toArray() {
      bHYPRE.PCG[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.PCG[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.PCG.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PCG.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PCG.Array1 obj) {
        d_obj = obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PCG 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.PCG[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.PCG _get( int j0, int j1) {
      return (bHYPRE.PCG)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PCG get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.PCG ret = null;
      ret = (bHYPRE.PCG) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PCG.Array2 smartCopy() {
      bHYPRE.PCG.Array2 ret = null;
      bHYPRE.PCG.Array preCast = null;
      preCast = (bHYPRE.PCG.Array) _smartCopy();
      return new bHYPRE.PCG.Array2(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PCG.Array2 dest) {
      _copy((bHYPRE.PCG.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.PCG value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.PCG value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.PCG[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.PCG[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.PCG[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PCG.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PCG.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PCG.Array2 obj) {
        d_obj = obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PCG 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.PCG[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.PCG _get( int j0, int j1, int j2) {
      return (bHYPRE.PCG)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PCG get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.PCG ret = null;
      ret = (bHYPRE.PCG) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PCG.Array3 smartCopy() {
      bHYPRE.PCG.Array3 ret = null;
      bHYPRE.PCG.Array preCast = null;
      preCast = (bHYPRE.PCG.Array) _smartCopy();
      return new bHYPRE.PCG.Array3(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PCG.Array3 dest) {
      _copy((bHYPRE.PCG.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.PCG value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.PCG value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.PCG[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.PCG[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.PCG[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PCG.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PCG.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PCG.Array3 obj) {
        d_obj = obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PCG 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.PCG[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.PCG _get( int j0, int j1, int j2, int j3) {
      return (bHYPRE.PCG)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PCG get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.PCG ret = null;
      ret = (bHYPRE.PCG) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PCG.Array4 smartCopy() {
      bHYPRE.PCG.Array4 ret = null;
      bHYPRE.PCG.Array preCast = null;
      preCast = (bHYPRE.PCG.Array) _smartCopy();
      return new bHYPRE.PCG.Array4(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PCG.Array4 dest) {
      _copy((bHYPRE.PCG.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.PCG value) {
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.PCG value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.PCG[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.PCG[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PCG.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PCG.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PCG.Array4 obj) {
        d_obj = obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PCG 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.PCG[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.PCG _get( int j0, int j1, int j2, int j3, int j4) {
      return (bHYPRE.PCG)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PCG get( int j0, int j1, int j2, int j3, int j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      bHYPRE.PCG ret = null;
      ret = (bHYPRE.PCG) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PCG.Array5 smartCopy() {
      bHYPRE.PCG.Array5 ret = null;
      bHYPRE.PCG.Array preCast = null;
      preCast = (bHYPRE.PCG.Array) _smartCopy();
      return new bHYPRE.PCG.Array5(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PCG.Array5 dest) {
      _copy((bHYPRE.PCG.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3, int j4,bHYPRE.PCG value) {
      _set(  j0,  j1,  j2,  j3,  j4, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3, int j4,bHYPRE.PCG value) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      _set(  j0,  j1,  j2,  j3,  j4, 0, 0, value);
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.PCG[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.PCG[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PCG.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PCG.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PCG.Array5 obj) {
        d_obj = obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PCG 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.PCG[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.PCG _get( int j0, int j1, int j2, int j3, int j4, int j5) {
      return (bHYPRE.PCG)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PCG get( int j0, int j1, int j2, int j3, int j4, int j5) {
      checkBounds(  j0,  j1,  j2,  j3,  j4,  j5);
      bHYPRE.PCG ret = null;
      ret = (bHYPRE.PCG) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PCG.Array6 smartCopy() {
      bHYPRE.PCG.Array6 ret = null;
      bHYPRE.PCG.Array preCast = null;
      preCast = (bHYPRE.PCG.Array) _smartCopy();
      return new bHYPRE.PCG.Array6(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PCG.Array6 dest) {
      _copy((bHYPRE.PCG.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3, int j4, int j5,bHYPRE.PCG 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3, int j4, int j5,bHYPRE.PCG 
      value) {
      checkBounds(  j0,  j1,  j2,  j3,  j4,  j5);
      _set(  j0,  j1,  j2,  j3,  j4,  j5, 0, value);
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.PCG[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.PCG[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PCG.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PCG.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PCG.Array6 obj) {
        d_obj = obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PCG 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.PCG[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PCG get( int j0, int j1, int j2, int j3, int j4, int j5, int 
      j6) {
      checkBounds(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      bHYPRE.PCG ret = null;
      ret = (bHYPRE.PCG) _get(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PCG.Array7 smartCopy() {
      bHYPRE.PCG.Array7 ret = null;
      bHYPRE.PCG.Array preCast = null;
      preCast = (bHYPRE.PCG.Array) _smartCopy();
      return new bHYPRE.PCG.Array7(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PCG.Array7 dest) {
      _copy((bHYPRE.PCG.Array) dest);
    }
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                ...
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.PCG[u4-l4+1][];
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new bHYPRE.PCG[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PCG.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PCG.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PCG.Array7 obj) {
        d_obj = obj;
      }
