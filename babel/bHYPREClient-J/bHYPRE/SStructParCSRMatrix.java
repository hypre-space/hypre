 ...
 */
public class SStructParCSRMatrix extends
  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.SStructParCSRMatrix");
  }

  /**
   * Default constructor for the class.
   */
  public SStructParCSRMatrix() {
    super(_create_ior());
  }
   ...
   */
  protected static native long _wrap(SStructParCSRMatrix ddata);

  /**
   * Remote constructor for the class.
   */
  public SStructParCSRMatrix(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new SStructParCSRMatrix(
   ...
   */
  public SStructParCSRMatrix(long ior) {
    super(ior);
  }
   ...
   */
  public static native bHYPRE.SStructParCSRMatrix Create(
    bHYPRE.MPICommunicator mpi_comm,
    bHYPRE.SStructGraph graph);

  /**
   * Set the matrix graph.
   * DEPRECATED     Use Create
   */
  public native int SetGraph(
    bHYPRE.SStructGraph graph);
   ...
   * entries.
   */
  public native int SetNSSymmetric(
    int symmetric);
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("bHYPRE.SStructParCSRMatrix");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("bHYPRE.SStructParCSRMatrix");
      } catch (Exception ex) {
  ...
  public static class Holder {
    private bHYPRE.SStructParCSRMatrix d_obj;
     ...
     */
    public Holder(bHYPRE.SStructParCSRMatrix obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.SStructParCSRMatrix obj) {
      d_obj = obj;
    }
     ...
     */
    public bHYPRE.SStructParCSRMatrix get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.SStructParCSRMatrix _get(int i, int j, int k, int l, int m, 
      int n, int o) {
      bHYPRE.SStructParCSRMatrix ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.SStructParCSRMatrix) preCast._cast2(
          "bHYPRE.SStructParCSRMatrix");
      } else {
        return null;
      }
      return (bHYPRE.SStructParCSRMatrix) ret;
    }
    ...
    public void _set(int i, int j, int k, int l, int m, int n, int o, 
      bHYPRE.SStructParCSRMatrix value) {
     ...
     */
    public bHYPRE.SStructParCSRMatrix.Array _slice(int dimen, int[] numElem, 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.SStructParCSRMatrix.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.SStructParCSRMatrix.Array(
        preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.SStructParCSRMatrix.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.SStructParCSRMatrix.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.SStructParCSRMatrix.Array1(
            getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.SStructParCSRMatrix.Array2(
            getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.SStructParCSRMatrix.Array3(
            getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.SStructParCSRMatrix.Array4(
            getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.SStructParCSRMatrix.Array5(
            getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.SStructParCSRMatrix.Array6(
            getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.SStructParCSRMatrix.Array7(
            getBaseInterfaceArray());
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private bHYPRE.SStructParCSRMatrix.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructParCSRMatrix.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructParCSRMatrix.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructParCSRMatrix.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructParCSRMatrix 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.SStructParCSRMatrix[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.SStructParCSRMatrix _get( int j0) {
      return (bHYPRE.SStructParCSRMatrix)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructParCSRMatrix get( int j0) {
      checkBounds(  j0);
      bHYPRE.SStructParCSRMatrix ret = null;
      ret = (bHYPRE.SStructParCSRMatrix) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.SStructParCSRMatrix.Array1 smartCopy() {
      bHYPRE.SStructParCSRMatrix.Array1 ret = null;
      bHYPRE.SStructParCSRMatrix.Array preCast = null;
      preCast = (bHYPRE.SStructParCSRMatrix.Array) _smartCopy();
      return new bHYPRE.SStructParCSRMatrix.Array1(
     ...
     */
    public void copy(bHYPRE.SStructParCSRMatrix.Array1 dest) {
      _copy((bHYPRE.SStructParCSRMatrix.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.SStructParCSRMatrix value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.SStructParCSRMatrix value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructParCSRMatrix[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.SStructParCSRMatrix[] toArray() {
      bHYPRE.SStructParCSRMatrix[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.SStructParCSRMatrix[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.SStructParCSRMatrix.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructParCSRMatrix.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructParCSRMatrix.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructParCSRMatrix.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructParCSRMatrix 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.SStructParCSRMatrix[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructParCSRMatrix _get( int j0, int j1) {
      return (bHYPRE.SStructParCSRMatrix)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructParCSRMatrix get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.SStructParCSRMatrix ret = null;
      ret = (bHYPRE.SStructParCSRMatrix) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructParCSRMatrix.Array2 smartCopy() {
      bHYPRE.SStructParCSRMatrix.Array2 ret = null;
      bHYPRE.SStructParCSRMatrix.Array preCast = null;
      preCast = (bHYPRE.SStructParCSRMatrix.Array) _smartCopy();
      return new bHYPRE.SStructParCSRMatrix.Array2(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructParCSRMatrix.Array2 dest) {
      _copy((bHYPRE.SStructParCSRMatrix.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.SStructParCSRMatrix value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.SStructParCSRMatrix value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructParCSRMatrix[][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
    ...
    public bHYPRE.SStructParCSRMatrix[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.SStructParCSRMatrix[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.SStructParCSRMatrix[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructParCSRMatrix.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructParCSRMatrix.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructParCSRMatrix.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructParCSRMatrix.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructParCSRMatrix 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.SStructParCSRMatrix[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructParCSRMatrix _get( int j0, int j1, int j2) {
      return (bHYPRE.SStructParCSRMatrix)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructParCSRMatrix get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.SStructParCSRMatrix ret = null;
      ret = (bHYPRE.SStructParCSRMatrix) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructParCSRMatrix.Array3 smartCopy() {
      bHYPRE.SStructParCSRMatrix.Array3 ret = null;
      bHYPRE.SStructParCSRMatrix.Array preCast = null;
      preCast = (bHYPRE.SStructParCSRMatrix.Array) _smartCopy();
      return new bHYPRE.SStructParCSRMatrix.Array3(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructParCSRMatrix.Array3 dest) {
      _copy((bHYPRE.SStructParCSRMatrix.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.SStructParCSRMatrix value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.SStructParCSRMatrix value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.SStructParCSRMatrix[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.SStructParCSRMatrix[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.SStructParCSRMatrix[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructParCSRMatrix.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructParCSRMatrix.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructParCSRMatrix.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructParCSRMatrix.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructParCSRMatrix 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.SStructParCSRMatrix[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructParCSRMatrix _get( int j0, int j1, int j2, int j3) {
      return (bHYPRE.SStructParCSRMatrix)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructParCSRMatrix get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.SStructParCSRMatrix ret = null;
      ret = (bHYPRE.SStructParCSRMatrix) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructParCSRMatrix.Array4 smartCopy() {
      bHYPRE.SStructParCSRMatrix.Array4 ret = null;
      bHYPRE.SStructParCSRMatrix.Array preCast = null;
      preCast = (bHYPRE.SStructParCSRMatrix.Array) _smartCopy();
      return new bHYPRE.SStructParCSRMatrix.Array4(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructParCSRMatrix.Array4 dest) {
      _copy((bHYPRE.SStructParCSRMatrix.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.SStructParCSRMatrix 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.SStructParCSRMatrix 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.SStructParCSRMatrix[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.SStructParCSRMatrix[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructParCSRMatrix.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructParCSRMatrix.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructParCSRMatrix.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructParCSRMatrix.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructParCSRMatrix 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.SStructParCSRMatrix[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructParCSRMatrix _get( int j0, int j1, int j2, int j3, int 
      j4) {
      return (bHYPRE.SStructParCSRMatrix)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructParCSRMatrix get( int j0, int j1, int j2, int j3, int 
      j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      bHYPRE.SStructParCSRMatrix ret = null;
      ret = (bHYPRE.SStructParCSRMatrix) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructParCSRMatrix.Array5 smartCopy() {
      bHYPRE.SStructParCSRMatrix.Array5 ret = null;
      bHYPRE.SStructParCSRMatrix.Array preCast = null;
      preCast = (bHYPRE.SStructParCSRMatrix.Array) _smartCopy();
      return new bHYPRE.SStructParCSRMatrix.Array5(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructParCSRMatrix.Array5 dest) {
      _copy((bHYPRE.SStructParCSRMatrix.Array) dest);
    }
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.SStructParCSRMatrix[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.SStructParCSRMatrix[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructParCSRMatrix.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructParCSRMatrix.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructParCSRMatrix.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructParCSRMatrix.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructParCSRMatrix 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.SStructParCSRMatrix[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.SStructParCSRMatrix _get( int j0, int j1, int j2, int j3, int 
      j4, int j5) {
      return (bHYPRE.SStructParCSRMatrix)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }
    ...
    public bHYPRE.SStructParCSRMatrix get( int j0, int j1, int j2, int j3, int 
      ...
      bHYPRE.SStructParCSRMatrix ret = null;
      ret = (bHYPRE.SStructParCSRMatrix) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructParCSRMatrix.Array6 smartCopy() {
      bHYPRE.SStructParCSRMatrix.Array6 ret = null;
      bHYPRE.SStructParCSRMatrix.Array preCast = null;
      preCast = (bHYPRE.SStructParCSRMatrix.Array) _smartCopy();
      return new bHYPRE.SStructParCSRMatrix.Array6(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructParCSRMatrix.Array6 dest) {
      _copy((bHYPRE.SStructParCSRMatrix.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructParCSRMatrix[][][][][][] orray , 
      boolean inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                ...
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new 
                    bHYPRE.SStructParCSRMatrix[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructParCSRMatrix.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructParCSRMatrix.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructParCSRMatrix.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructParCSRMatrix.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructParCSRMatrix 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.SStructParCSRMatrix[][][][][][][] array, boolean 
      isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.SStructParCSRMatrix get( int j0, int j1, int j2, int j3, int 
      ...
      bHYPRE.SStructParCSRMatrix ret = null;
      ret = (bHYPRE.SStructParCSRMatrix) _get(  j0,  j1,  j2,  j3,  j4,  j5,  
        j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructParCSRMatrix.Array7 smartCopy() {
      bHYPRE.SStructParCSRMatrix.Array7 ret = null;
      bHYPRE.SStructParCSRMatrix.Array preCast = null;
      preCast = (bHYPRE.SStructParCSRMatrix.Array) _smartCopy();
      return new bHYPRE.SStructParCSRMatrix.Array7(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructParCSRMatrix.Array7 dest) {
      _copy((bHYPRE.SStructParCSRMatrix.Array) dest);
    }
                ...
                for (int m = l4; m <= u4; m++) {
                  ...
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new 
                      bHYPRE.SStructParCSRMatrix[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructParCSRMatrix.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructParCSRMatrix.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructParCSRMatrix.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructParCSRMatrix.Array7 get() {
        return d_obj;
      }
