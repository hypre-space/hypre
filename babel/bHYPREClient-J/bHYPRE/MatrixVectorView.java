 ...
 */
public interface MatrixVectorView extends
  ...
  bHYPRE.ProblemDefinition
{
  ...
  public static class Wrapper
    ...
    implements bHYPRE.MatrixVectorView
  {
    /*
    ...
    static {
      gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.MatrixVectorView");
    }
    ...
    public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
      ...
      long ior = obj._cast_ior("bHYPRE.MatrixVectorView");
      if (ior != 0) {
        Class java_class = null;
        try {
          java_class = Class.forName("bHYPRE.MatrixVectorView$Wrapper");
        } catch (Exception ex) {
  ...
  public static class Holder {
    private bHYPRE.MatrixVectorView d_obj;
     ...
     */
    public Holder(bHYPRE.MatrixVectorView obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.MatrixVectorView obj) {
      d_obj = obj;
    }
     ...
     */
    public bHYPRE.MatrixVectorView get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.MatrixVectorView.Wrapper _get(int i, int j, int k, int l, int 
      m, int n, int o) {
      bHYPRE.MatrixVectorView.Wrapper ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.MatrixVectorView.Wrapper) preCast._cast2(
          "bHYPRE.MatrixVectorView");
      } else {
        return null;
      }
      return (bHYPRE.MatrixVectorView.Wrapper) ret;
    }
     ...
     */
    public bHYPRE.MatrixVectorView.Array _slice(int dimen, int[] numElem, int[] 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.MatrixVectorView.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.MatrixVectorView.Array(
        preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.MatrixVectorView.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.MatrixVectorView.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.MatrixVectorView.Array1(
            getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.MatrixVectorView.Array2(
            getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.MatrixVectorView.Array3(
            getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.MatrixVectorView.Array4(
            getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.MatrixVectorView.Array5(
            getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.MatrixVectorView.Array6(
            getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.MatrixVectorView.Array7(
            getBaseInterfaceArray());
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private bHYPRE.MatrixVectorView.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.MatrixVectorView.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.MatrixVectorView.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.MatrixVectorView.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.MatrixVectorView 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.MatrixVectorView[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.MatrixVectorView.Wrapper _get( int j0) {
      return (bHYPRE.MatrixVectorView.Wrapper)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.MatrixVectorView.Wrapper get( int j0) {
      checkBounds(  j0);
      bHYPRE.MatrixVectorView.Wrapper ret = null;
      ret = (bHYPRE.MatrixVectorView.Wrapper) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.MatrixVectorView.Array1 smartCopy() {
      bHYPRE.MatrixVectorView.Array1 ret = null;
      bHYPRE.MatrixVectorView.Array preCast = null;
      preCast = (bHYPRE.MatrixVectorView.Array) _smartCopy();
      return new bHYPRE.MatrixVectorView.Array1(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     */
    public void copy(bHYPRE.MatrixVectorView.Array1 dest) {
      _copy((bHYPRE.MatrixVectorView.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.MatrixVectorView value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.MatrixVectorView value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.MatrixVectorView[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.MatrixVectorView[] toArray() {
      bHYPRE.MatrixVectorView[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.MatrixVectorView[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.MatrixVectorView.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.MatrixVectorView.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.MatrixVectorView.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.MatrixVectorView.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.MatrixVectorView 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.MatrixVectorView[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.MatrixVectorView.Wrapper _get( int j0, int j1) {
      return (bHYPRE.MatrixVectorView.Wrapper)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.MatrixVectorView.Wrapper get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.MatrixVectorView.Wrapper ret = null;
      ret = (bHYPRE.MatrixVectorView.Wrapper) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.MatrixVectorView.Array2 smartCopy() {
      bHYPRE.MatrixVectorView.Array2 ret = null;
      bHYPRE.MatrixVectorView.Array preCast = null;
      preCast = (bHYPRE.MatrixVectorView.Array) _smartCopy();
      return new bHYPRE.MatrixVectorView.Array2(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.MatrixVectorView.Array2 dest) {
      _copy((bHYPRE.MatrixVectorView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.MatrixVectorView value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.MatrixVectorView value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.MatrixVectorView[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.MatrixVectorView[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.MatrixVectorView[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.MatrixVectorView.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.MatrixVectorView.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.MatrixVectorView.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.MatrixVectorView.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.MatrixVectorView 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.MatrixVectorView[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.MatrixVectorView.Wrapper _get( int j0, int j1, int j2) {
      return (bHYPRE.MatrixVectorView.Wrapper)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.MatrixVectorView.Wrapper get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.MatrixVectorView.Wrapper ret = null;
      ret = (bHYPRE.MatrixVectorView.Wrapper) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.MatrixVectorView.Array3 smartCopy() {
      bHYPRE.MatrixVectorView.Array3 ret = null;
      bHYPRE.MatrixVectorView.Array preCast = null;
      preCast = (bHYPRE.MatrixVectorView.Array) _smartCopy();
      return new bHYPRE.MatrixVectorView.Array3(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.MatrixVectorView.Array3 dest) {
      _copy((bHYPRE.MatrixVectorView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.MatrixVectorView value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.MatrixVectorView value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.MatrixVectorView[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.MatrixVectorView[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.MatrixVectorView[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.MatrixVectorView.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.MatrixVectorView.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.MatrixVectorView.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.MatrixVectorView.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.MatrixVectorView 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.MatrixVectorView[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.MatrixVectorView.Wrapper _get( int j0, int j1, int j2, int 
      j3) {
      return (bHYPRE.MatrixVectorView.Wrapper)_get(  j0,  j1,  j2,  j3, 0, 0, 
        0);
    }
     ...
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.MatrixVectorView.Wrapper get( int j0, int j1, int j2, int j3) 
      {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.MatrixVectorView.Wrapper ret = null;
      ret = (bHYPRE.MatrixVectorView.Wrapper) _get(  j0,  j1,  j2,  j3, 0, 0, 
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.MatrixVectorView.Array4 smartCopy() {
      bHYPRE.MatrixVectorView.Array4 ret = null;
      bHYPRE.MatrixVectorView.Array preCast = null;
      preCast = (bHYPRE.MatrixVectorView.Array) _smartCopy();
      return new bHYPRE.MatrixVectorView.Array4(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.MatrixVectorView.Array4 dest) {
      _copy((bHYPRE.MatrixVectorView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.MatrixVectorView 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.MatrixVectorView 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.MatrixVectorView[][][][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.MatrixVectorView[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.MatrixVectorView[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.MatrixVectorView.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.MatrixVectorView.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.MatrixVectorView.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.MatrixVectorView.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.MatrixVectorView 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.MatrixVectorView[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.MatrixVectorView.Wrapper _get( int j0, int j1, int j2, int j3,
      int j4) {
      return (bHYPRE.MatrixVectorView.Wrapper)_get(  j0,  j1,  j2,  j3,  j4, 0, 
        0);
    }
    ...
    public bHYPRE.MatrixVectorView.Wrapper get( int j0, int j1, int j2, int j3, 
      ...
      bHYPRE.MatrixVectorView.Wrapper ret = null;
      ret = (bHYPRE.MatrixVectorView.Wrapper) _get(  j0,  j1,  j2,  j3,  j4, 0, 
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.MatrixVectorView.Array5 smartCopy() {
      bHYPRE.MatrixVectorView.Array5 ret = null;
      bHYPRE.MatrixVectorView.Array preCast = null;
      preCast = (bHYPRE.MatrixVectorView.Array) _smartCopy();
      return new bHYPRE.MatrixVectorView.Array5(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.MatrixVectorView.Array5 dest) {
      _copy((bHYPRE.MatrixVectorView.Array) dest);
    }
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.MatrixVectorView[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.MatrixVectorView[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.MatrixVectorView.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.MatrixVectorView.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.MatrixVectorView.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.MatrixVectorView.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.MatrixVectorView 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.MatrixVectorView[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.MatrixVectorView.Wrapper _get( int j0, int j1, int j2, int j3,
      int j4, int j5) {
      return (bHYPRE.MatrixVectorView.Wrapper)_get(  j0,  j1,  j2,  j3,  j4,  
        j5, 0);
    }
    ...
    public bHYPRE.MatrixVectorView.Wrapper get( int j0, int j1, int j2, int j3, 
      ...
      bHYPRE.MatrixVectorView.Wrapper ret = null;
      ret = (bHYPRE.MatrixVectorView.Wrapper) _get(  j0,  j1,  j2,  j3,  j4,  
        j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.MatrixVectorView.Array6 smartCopy() {
      bHYPRE.MatrixVectorView.Array6 ret = null;
      bHYPRE.MatrixVectorView.Array preCast = null;
      preCast = (bHYPRE.MatrixVectorView.Array) _smartCopy();
      return new bHYPRE.MatrixVectorView.Array6(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.MatrixVectorView.Array6 dest) {
      _copy((bHYPRE.MatrixVectorView.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.MatrixVectorView[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.MatrixVectorView[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.MatrixVectorView.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.MatrixVectorView.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.MatrixVectorView.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.MatrixVectorView.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.MatrixVectorView 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.MatrixVectorView[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.MatrixVectorView.Array7 smartCopy() {
      bHYPRE.MatrixVectorView.Array7 ret = null;
      bHYPRE.MatrixVectorView.Array preCast = null;
      preCast = (bHYPRE.MatrixVectorView.Array) _smartCopy();
      return new bHYPRE.MatrixVectorView.Array7(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.MatrixVectorView.Array7 dest) {
      _copy((bHYPRE.MatrixVectorView.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.MatrixVectorView[][][][][][][] orray , 
      boolean inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
                ...
                for (int m = l4; m <= u4; m++) {
                  ...
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new 
                      bHYPRE.MatrixVectorView[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.MatrixVectorView.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.MatrixVectorView.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.MatrixVectorView.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.MatrixVectorView.Array7 get() {
        return d_obj;
      }
