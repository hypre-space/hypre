 ...
 */
public interface Vector extends
  ...
  sidl.BaseInterface
{
    ...
    implements bHYPRE.Vector
  {
    ...
    static {
      gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.Vector");
    }
    ...
    public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
      ...
      long ior = obj._cast_ior("bHYPRE.Vector");
      if (ior != 0) {
        Class java_class = null;
        try {
          java_class = Class.forName("bHYPRE.Vector$Wrapper");
        } catch (Exception ex) {
  ...
  public static class Holder {
     ...
     */
    public Holder(bHYPRE.Vector obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.Vector obj) {
      d_obj = obj;
    }
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.Vector.Wrapper _get(int i, int j, int k, int l, int m, int n, 
      int o) {
      bHYPRE.Vector.Wrapper ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.Vector.Wrapper) preCast._cast2("bHYPRE.Vector");
      } else {
        return null;
      }
      return (bHYPRE.Vector.Wrapper) ret;
    }
     ...
     */
    public bHYPRE.Vector.Array _slice(int dimen, int[] numElem, int[] srcStart, 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.Vector.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.Vector.Array(preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.Vector.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.Vector.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.Vector.Array1(getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.Vector.Array2(getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.Vector.Array3(getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.Vector.Array4(getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.Vector.Array5(getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.Vector.Array6(getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.Vector.Array7(getBaseInterfaceArray());
          return ret;
        default:
          return null;
        }
     ...
     */
    public static class Holder {
      private bHYPRE.Vector.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.Vector.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.Vector.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.Vector.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.Vector 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.Vector[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.Vector.Wrapper _get( int j0) {
      return (bHYPRE.Vector.Wrapper)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.Vector.Wrapper get( int j0) {
      checkBounds(  j0);
      bHYPRE.Vector.Wrapper ret = null;
      ret = (bHYPRE.Vector.Wrapper) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.Vector.Array1 smartCopy() {
      bHYPRE.Vector.Array1 ret = null;
      bHYPRE.Vector.Array preCast = null;
      preCast = (bHYPRE.Vector.Array) _smartCopy();
      return new bHYPRE.Vector.Array1(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.Vector.Array1 dest) {
      _copy((bHYPRE.Vector.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.Vector value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.Vector value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.Vector[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.Vector[] toArray() {
      bHYPRE.Vector[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.Vector[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.Vector.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.Vector.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.Vector.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.Vector.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.Vector 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.Vector[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.Vector.Wrapper _get( int j0, int j1) {
      return (bHYPRE.Vector.Wrapper)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.Vector.Wrapper get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.Vector.Wrapper ret = null;
      ret = (bHYPRE.Vector.Wrapper) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.Vector.Array2 smartCopy() {
      bHYPRE.Vector.Array2 ret = null;
      bHYPRE.Vector.Array preCast = null;
      preCast = (bHYPRE.Vector.Array) _smartCopy();
      return new bHYPRE.Vector.Array2(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.Vector.Array2 dest) {
      _copy((bHYPRE.Vector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.Vector value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.Vector value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.Vector[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.Vector[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.Vector[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.Vector.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.Vector.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.Vector.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.Vector.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.Vector 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.Vector[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.Vector.Wrapper _get( int j0, int j1, int j2) {
      return (bHYPRE.Vector.Wrapper)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.Vector.Wrapper get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.Vector.Wrapper ret = null;
      ret = (bHYPRE.Vector.Wrapper) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.Vector.Array3 smartCopy() {
      bHYPRE.Vector.Array3 ret = null;
      bHYPRE.Vector.Array preCast = null;
      preCast = (bHYPRE.Vector.Array) _smartCopy();
      return new bHYPRE.Vector.Array3(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.Vector.Array3 dest) {
      _copy((bHYPRE.Vector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.Vector value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.Vector value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.Vector[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.Vector[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.Vector[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.Vector.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.Vector.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.Vector.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.Vector.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.Vector 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.Vector[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.Vector.Wrapper _get( int j0, int j1, int j2, int j3) {
      return (bHYPRE.Vector.Wrapper)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.Vector.Wrapper get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.Vector.Wrapper ret = null;
      ret = (bHYPRE.Vector.Wrapper) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.Vector.Array4 smartCopy() {
      bHYPRE.Vector.Array4 ret = null;
      bHYPRE.Vector.Array preCast = null;
      preCast = (bHYPRE.Vector.Array) _smartCopy();
      return new bHYPRE.Vector.Array4(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.Vector.Array4 dest) {
      _copy((bHYPRE.Vector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.Vector value) {
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.Vector value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.Vector[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.Vector[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.Vector.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.Vector.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.Vector.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.Vector.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.Vector 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.Vector[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.Vector.Wrapper _get( int j0, int j1, int j2, int j3, int j4) {
      return (bHYPRE.Vector.Wrapper)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.Vector.Wrapper get( int j0, int j1, int j2, int j3, int j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      bHYPRE.Vector.Wrapper ret = null;
      ret = (bHYPRE.Vector.Wrapper) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.Vector.Array5 smartCopy() {
      bHYPRE.Vector.Array5 ret = null;
      bHYPRE.Vector.Array preCast = null;
      preCast = (bHYPRE.Vector.Array) _smartCopy();
      return new bHYPRE.Vector.Array5(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.Vector.Array5 dest) {
      _copy((bHYPRE.Vector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3, int j4,bHYPRE.Vector 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3, int j4,bHYPRE.Vector 
      value) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      _set(  j0,  j1,  j2,  j3,  j4, 0, 0, value);
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.Vector[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.Vector[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.Vector.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.Vector.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.Vector.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.Vector.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.Vector 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.Vector[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.Vector.Wrapper _get( int j0, int j1, int j2, int j3, int j4, 
      int j5) {
      return (bHYPRE.Vector.Wrapper)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }
    ...
    public bHYPRE.Vector.Wrapper get( int j0, int j1, int j2, int j3, int j4, 
      ...
      bHYPRE.Vector.Wrapper ret = null;
      ret = (bHYPRE.Vector.Wrapper) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.Vector.Array6 smartCopy() {
      bHYPRE.Vector.Array6 ret = null;
      bHYPRE.Vector.Array preCast = null;
      preCast = (bHYPRE.Vector.Array) _smartCopy();
      return new bHYPRE.Vector.Array6(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.Vector.Array6 dest) {
      _copy((bHYPRE.Vector.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.Vector[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.Vector[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.Vector.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.Vector.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.Vector.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.Vector.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.Vector 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.Vector[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.Vector.Wrapper get( int j0, int j1, int j2, int j3, int j4, 
      ...
      bHYPRE.Vector.Wrapper ret = null;
      ret = (bHYPRE.Vector.Wrapper) _get(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.Vector.Array7 smartCopy() {
      bHYPRE.Vector.Array7 ret = null;
      bHYPRE.Vector.Array preCast = null;
      preCast = (bHYPRE.Vector.Array) _smartCopy();
      return new bHYPRE.Vector.Array7(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.Vector.Array7 dest) {
      _copy((bHYPRE.Vector.Array) dest);
    }
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                ...
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.Vector[u4-l4+1][];
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new bHYPRE.Vector[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.Vector.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.Vector.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.Vector.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.Vector.Array7 get() {
        return d_obj;
      }
