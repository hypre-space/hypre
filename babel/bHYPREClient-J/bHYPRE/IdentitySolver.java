 ...
 * {\tt \_\_cast} methods.
 */
public class IdentitySolver extends
  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.IdentitySolver");
  }

  /**
   * Default constructor for the class.
   */
  public IdentitySolver() {
    super(_create_ior());
  }
   ...
   */
  protected static native long _wrap(IdentitySolver ddata);

  /**
   * Remote constructor for the class.
   */
  public IdentitySolver(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new IdentitySolver(_connect_remote_ior(
      url));
  }
   ...
   */
  public IdentitySolver(long ior) {
    super(ior);
  }
   ...
   */
  public static native bHYPRE.IdentitySolver Create(
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("bHYPRE.IdentitySolver");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("bHYPRE.IdentitySolver");
      } catch (Exception ex) {
  ...
  public static class Holder {
    private bHYPRE.IdentitySolver d_obj;
     ...
     */
    public Holder(bHYPRE.IdentitySolver obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.IdentitySolver obj) {
      d_obj = obj;
    }
     ...
     */
    public bHYPRE.IdentitySolver get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.IdentitySolver _get(int i, int j, int k, int l, int m, int n, 
      int o) {
      bHYPRE.IdentitySolver ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.IdentitySolver) preCast._cast2("bHYPRE.IdentitySolver");
      } else {
        return null;
      }
      return (bHYPRE.IdentitySolver) ret;
    }
     ...
     */
    public bHYPRE.IdentitySolver.Array _slice(int dimen, int[] numElem, int[] 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.IdentitySolver.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.IdentitySolver.Array(preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.IdentitySolver.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.IdentitySolver.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.IdentitySolver.Array1(getBaseInterfaceArray(
            ));
          return ret;
        case 2:
          ret = (Array) new bHYPRE.IdentitySolver.Array2(getBaseInterfaceArray(
            ));
          return ret;
        case 3:
          ret = (Array) new bHYPRE.IdentitySolver.Array3(getBaseInterfaceArray(
            ));
          return ret;
        case 4:
          ret = (Array) new bHYPRE.IdentitySolver.Array4(getBaseInterfaceArray(
            ));
          return ret;
        case 5:
          ret = (Array) new bHYPRE.IdentitySolver.Array5(getBaseInterfaceArray(
            ));
          return ret;
        case 6:
          ret = (Array) new bHYPRE.IdentitySolver.Array6(getBaseInterfaceArray(
            ));
          return ret;
        case 7:
          ret = (Array) new bHYPRE.IdentitySolver.Array7(getBaseInterfaceArray(
            ));
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private bHYPRE.IdentitySolver.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.IdentitySolver.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.IdentitySolver.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.IdentitySolver.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.IdentitySolver 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.IdentitySolver[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.IdentitySolver _get( int j0) {
      return (bHYPRE.IdentitySolver)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.IdentitySolver get( int j0) {
      checkBounds(  j0);
      bHYPRE.IdentitySolver ret = null;
      ret = (bHYPRE.IdentitySolver) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.IdentitySolver.Array1 smartCopy() {
      bHYPRE.IdentitySolver.Array1 ret = null;
      bHYPRE.IdentitySolver.Array preCast = null;
      preCast = (bHYPRE.IdentitySolver.Array) _smartCopy();
      return new bHYPRE.IdentitySolver.Array1(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.IdentitySolver.Array1 dest) {
      _copy((bHYPRE.IdentitySolver.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.IdentitySolver value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.IdentitySolver value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.IdentitySolver[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.IdentitySolver[] toArray() {
      bHYPRE.IdentitySolver[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.IdentitySolver[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.IdentitySolver.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.IdentitySolver.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.IdentitySolver.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.IdentitySolver.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.IdentitySolver 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.IdentitySolver[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.IdentitySolver _get( int j0, int j1) {
      return (bHYPRE.IdentitySolver)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.IdentitySolver get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.IdentitySolver ret = null;
      ret = (bHYPRE.IdentitySolver) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.IdentitySolver.Array2 smartCopy() {
      bHYPRE.IdentitySolver.Array2 ret = null;
      bHYPRE.IdentitySolver.Array preCast = null;
      preCast = (bHYPRE.IdentitySolver.Array) _smartCopy();
      return new bHYPRE.IdentitySolver.Array2(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.IdentitySolver.Array2 dest) {
      _copy((bHYPRE.IdentitySolver.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.IdentitySolver value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.IdentitySolver value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.IdentitySolver[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.IdentitySolver[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.IdentitySolver[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.IdentitySolver.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.IdentitySolver.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.IdentitySolver.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.IdentitySolver.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.IdentitySolver 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.IdentitySolver[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.IdentitySolver _get( int j0, int j1, int j2) {
      return (bHYPRE.IdentitySolver)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.IdentitySolver get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.IdentitySolver ret = null;
      ret = (bHYPRE.IdentitySolver) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.IdentitySolver.Array3 smartCopy() {
      bHYPRE.IdentitySolver.Array3 ret = null;
      bHYPRE.IdentitySolver.Array preCast = null;
      preCast = (bHYPRE.IdentitySolver.Array) _smartCopy();
      return new bHYPRE.IdentitySolver.Array3(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.IdentitySolver.Array3 dest) {
      _copy((bHYPRE.IdentitySolver.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.IdentitySolver value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.IdentitySolver value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.IdentitySolver[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.IdentitySolver[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.IdentitySolver[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.IdentitySolver.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.IdentitySolver.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.IdentitySolver.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.IdentitySolver.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.IdentitySolver 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.IdentitySolver[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.IdentitySolver _get( int j0, int j1, int j2, int j3) {
      return (bHYPRE.IdentitySolver)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.IdentitySolver get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.IdentitySolver ret = null;
      ret = (bHYPRE.IdentitySolver) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.IdentitySolver.Array4 smartCopy() {
      bHYPRE.IdentitySolver.Array4 ret = null;
      bHYPRE.IdentitySolver.Array preCast = null;
      preCast = (bHYPRE.IdentitySolver.Array) _smartCopy();
      return new bHYPRE.IdentitySolver.Array4(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.IdentitySolver.Array4 dest) {
      _copy((bHYPRE.IdentitySolver.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.IdentitySolver 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.IdentitySolver 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.IdentitySolver[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.IdentitySolver[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.IdentitySolver.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.IdentitySolver.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.IdentitySolver.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.IdentitySolver.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.IdentitySolver 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.IdentitySolver[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.IdentitySolver _get( int j0, int j1, int j2, int j3, int j4) {
      return (bHYPRE.IdentitySolver)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.IdentitySolver get( int j0, int j1, int j2, int j3, int j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      bHYPRE.IdentitySolver ret = null;
      ret = (bHYPRE.IdentitySolver) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.IdentitySolver.Array5 smartCopy() {
      bHYPRE.IdentitySolver.Array5 ret = null;
      bHYPRE.IdentitySolver.Array preCast = null;
      preCast = (bHYPRE.IdentitySolver.Array) _smartCopy();
      return new bHYPRE.IdentitySolver.Array5(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.IdentitySolver.Array5 dest) {
      _copy((bHYPRE.IdentitySolver.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.IdentitySolver[][][][][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.IdentitySolver[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.IdentitySolver[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.IdentitySolver.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.IdentitySolver.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.IdentitySolver.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.IdentitySolver.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.IdentitySolver 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.IdentitySolver[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.IdentitySolver _get( int j0, int j1, int j2, int j3, int j4, 
      int j5) {
      return (bHYPRE.IdentitySolver)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }
    ...
    public bHYPRE.IdentitySolver get( int j0, int j1, int j2, int j3, int j4, 
      ...
      bHYPRE.IdentitySolver ret = null;
      ret = (bHYPRE.IdentitySolver) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.IdentitySolver.Array6 smartCopy() {
      bHYPRE.IdentitySolver.Array6 ret = null;
      bHYPRE.IdentitySolver.Array preCast = null;
      preCast = (bHYPRE.IdentitySolver.Array) _smartCopy();
      return new bHYPRE.IdentitySolver.Array6(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.IdentitySolver.Array6 dest) {
      _copy((bHYPRE.IdentitySolver.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.IdentitySolver[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.IdentitySolver[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.IdentitySolver.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.IdentitySolver.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.IdentitySolver.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.IdentitySolver.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.IdentitySolver 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.IdentitySolver[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.IdentitySolver get( int j0, int j1, int j2, int j3, int j4, 
      ...
      bHYPRE.IdentitySolver ret = null;
      ret = (bHYPRE.IdentitySolver) _get(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.IdentitySolver.Array7 smartCopy() {
      bHYPRE.IdentitySolver.Array7 ret = null;
      bHYPRE.IdentitySolver.Array preCast = null;
      preCast = (bHYPRE.IdentitySolver.Array) _smartCopy();
      return new bHYPRE.IdentitySolver.Array7(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.IdentitySolver.Array7 dest) {
      _copy((bHYPRE.IdentitySolver.Array) dest);
    }
     ...
     */
    public static class Holder {
      private bHYPRE.IdentitySolver.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.IdentitySolver.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.IdentitySolver.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.IdentitySolver.Array7 get() {
        return d_obj;
      }
