 ...
 */
public class SStructVector extends
  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.SStructVector");
  }

  /**
   * Default constructor for the class.
   */
  public SStructVector() {
    super(_create_ior());
  }
   ...
   */
  protected static native long _wrap(SStructVector ddata);

  /**
   * Remote constructor for the class.
   */
  public SStructVector(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new SStructVector(_connect_remote_ior(
      url));
  }
   ...
   */
  public static native bHYPRE.SStructVector Create(
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("bHYPRE.SStructVector");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("bHYPRE.SStructVector");
      } catch (Exception ex) {
  ...
  public static class Holder {
    private bHYPRE.SStructVector d_obj;
     ...
     */
    public Holder(bHYPRE.SStructVector obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.SStructVector obj) {
      d_obj = obj;
    }
     ...
     */
    public bHYPRE.SStructVector get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.SStructVector _get(int i, int j, int k, int l, int m, int n, 
      int o) {
      bHYPRE.SStructVector ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.SStructVector) preCast._cast2("bHYPRE.SStructVector");
      } else {
        return null;
      }
      return (bHYPRE.SStructVector) ret;
    }
     ...
     */
    public bHYPRE.SStructVector.Array _slice(int dimen, int[] numElem, int[] 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.SStructVector.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.SStructVector.Array(preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.SStructVector.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.SStructVector.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.SStructVector.Array1(getBaseInterfaceArray(
            ));
          return ret;
        case 2:
          ret = (Array) new bHYPRE.SStructVector.Array2(getBaseInterfaceArray(
            ));
          return ret;
        case 3:
          ret = (Array) new bHYPRE.SStructVector.Array3(getBaseInterfaceArray(
            ));
          return ret;
        case 4:
          ret = (Array) new bHYPRE.SStructVector.Array4(getBaseInterfaceArray(
            ));
          return ret;
        case 5:
          ret = (Array) new bHYPRE.SStructVector.Array5(getBaseInterfaceArray(
            ));
          return ret;
        case 6:
          ret = (Array) new bHYPRE.SStructVector.Array6(getBaseInterfaceArray(
            ));
          return ret;
        case 7:
          ret = (Array) new bHYPRE.SStructVector.Array7(getBaseInterfaceArray(
            ));
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private bHYPRE.SStructVector.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructVector.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructVector.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructVector.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructVector 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.SStructVector[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.SStructVector _get( int j0) {
      return (bHYPRE.SStructVector)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructVector get( int j0) {
      checkBounds(  j0);
      bHYPRE.SStructVector ret = null;
      ret = (bHYPRE.SStructVector) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.SStructVector.Array1 smartCopy() {
      bHYPRE.SStructVector.Array1 ret = null;
      bHYPRE.SStructVector.Array preCast = null;
      preCast = (bHYPRE.SStructVector.Array) _smartCopy();
      return new bHYPRE.SStructVector.Array1(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructVector.Array1 dest) {
      _copy((bHYPRE.SStructVector.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.SStructVector value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.SStructVector value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructVector[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.SStructVector[] toArray() {
      bHYPRE.SStructVector[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.SStructVector[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.SStructVector.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructVector.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructVector.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructVector.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructVector 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.SStructVector[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructVector _get( int j0, int j1) {
      return (bHYPRE.SStructVector)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructVector get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.SStructVector ret = null;
      ret = (bHYPRE.SStructVector) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructVector.Array2 smartCopy() {
      bHYPRE.SStructVector.Array2 ret = null;
      bHYPRE.SStructVector.Array preCast = null;
      preCast = (bHYPRE.SStructVector.Array) _smartCopy();
      return new bHYPRE.SStructVector.Array2(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructVector.Array2 dest) {
      _copy((bHYPRE.SStructVector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.SStructVector value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.SStructVector value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.SStructVector[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.SStructVector[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.SStructVector[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructVector.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructVector.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructVector.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructVector.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructVector 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.SStructVector[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructVector _get( int j0, int j1, int j2) {
      return (bHYPRE.SStructVector)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructVector get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.SStructVector ret = null;
      ret = (bHYPRE.SStructVector) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructVector.Array3 smartCopy() {
      bHYPRE.SStructVector.Array3 ret = null;
      bHYPRE.SStructVector.Array preCast = null;
      preCast = (bHYPRE.SStructVector.Array) _smartCopy();
      return new bHYPRE.SStructVector.Array3(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructVector.Array3 dest) {
      _copy((bHYPRE.SStructVector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.SStructVector value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.SStructVector value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.SStructVector[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.SStructVector[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.SStructVector[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructVector.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructVector.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructVector.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructVector.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructVector 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.SStructVector[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructVector _get( int j0, int j1, int j2, int j3) {
      return (bHYPRE.SStructVector)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructVector get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.SStructVector ret = null;
      ret = (bHYPRE.SStructVector) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructVector.Array4 smartCopy() {
      bHYPRE.SStructVector.Array4 ret = null;
      bHYPRE.SStructVector.Array preCast = null;
      preCast = (bHYPRE.SStructVector.Array) _smartCopy();
      return new bHYPRE.SStructVector.Array4(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructVector.Array4 dest) {
      _copy((bHYPRE.SStructVector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.SStructVector 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.SStructVector value) 
      {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.SStructVector[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.SStructVector[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructVector.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructVector.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructVector.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructVector.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructVector 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.SStructVector[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructVector _get( int j0, int j1, int j2, int j3, int j4) {
      return (bHYPRE.SStructVector)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructVector get( int j0, int j1, int j2, int j3, int j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      bHYPRE.SStructVector ret = null;
      ret = (bHYPRE.SStructVector) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructVector.Array5 smartCopy() {
      bHYPRE.SStructVector.Array5 ret = null;
      bHYPRE.SStructVector.Array preCast = null;
      preCast = (bHYPRE.SStructVector.Array) _smartCopy();
      return new bHYPRE.SStructVector.Array5(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructVector.Array5 dest) {
      _copy((bHYPRE.SStructVector.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructVector[][][][][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.SStructVector[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.SStructVector[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructVector.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructVector.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructVector.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructVector.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructVector 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.SStructVector[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.SStructVector _get( int j0, int j1, int j2, int j3, int j4, 
      int j5) {
      return (bHYPRE.SStructVector)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }
    ...
    public bHYPRE.SStructVector get( int j0, int j1, int j2, int j3, int j4, 
      ...
      bHYPRE.SStructVector ret = null;
      ret = (bHYPRE.SStructVector) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructVector.Array6 smartCopy() {
      bHYPRE.SStructVector.Array6 ret = null;
      bHYPRE.SStructVector.Array preCast = null;
      preCast = (bHYPRE.SStructVector.Array) _smartCopy();
      return new bHYPRE.SStructVector.Array6(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructVector.Array6 dest) {
      _copy((bHYPRE.SStructVector.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.SStructVector[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.SStructVector[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructVector.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructVector.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructVector.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructVector.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructVector 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.SStructVector[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.SStructVector get( int j0, int j1, int j2, int j3, int j4, 
      ...
      bHYPRE.SStructVector ret = null;
      ret = (bHYPRE.SStructVector) _get(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructVector.Array7 smartCopy() {
      bHYPRE.SStructVector.Array7 ret = null;
      bHYPRE.SStructVector.Array preCast = null;
      preCast = (bHYPRE.SStructVector.Array) _smartCopy();
      return new bHYPRE.SStructVector.Array7(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructVector.Array7 dest) {
      _copy((bHYPRE.SStructVector.Array) dest);
    }
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                ...
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.SStructVector[u4-l4+1][];
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new bHYPRE.SStructVector[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructVector.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructVector.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructVector.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructVector.Array7 get() {
        return d_obj;
      }
