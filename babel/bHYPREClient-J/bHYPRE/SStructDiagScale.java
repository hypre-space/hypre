 ...
 */
public class SStructDiagScale extends
  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.SStructDiagScale");
  }

  /**
   * Default constructor for the class.
   */
  public SStructDiagScale() {
    super(_create_ior());
  }
   ...
   */
  protected static native long _wrap(SStructDiagScale ddata);

  /**
   * Remote constructor for the class.
   */
  public SStructDiagScale(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new SStructDiagScale(_connect_remote_ior(
      url));
  }
   ...
   */
  public SStructDiagScale(long ior) {
    super(ior);
  }
   ...
   */
  public static native bHYPRE.SStructDiagScale Create(
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("bHYPRE.SStructDiagScale");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("bHYPRE.SStructDiagScale");
      } catch (Exception ex) {
  ...
  public static class Holder {
    private bHYPRE.SStructDiagScale d_obj;
     ...
     */
    public Holder(bHYPRE.SStructDiagScale obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.SStructDiagScale obj) {
      d_obj = obj;
    }
     ...
     */
    public bHYPRE.SStructDiagScale get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.SStructDiagScale _get(int i, int j, int k, int l, int m, int 
      n, int o) {
      bHYPRE.SStructDiagScale ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.SStructDiagScale) preCast._cast2(
          "bHYPRE.SStructDiagScale");
      } else {
        return null;
      }
      return (bHYPRE.SStructDiagScale) ret;
    }
     ...
     */
    public bHYPRE.SStructDiagScale.Array _slice(int dimen, int[] numElem, int[] 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.SStructDiagScale.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.SStructDiagScale.Array(
        preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.SStructDiagScale.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.SStructDiagScale.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.SStructDiagScale.Array1(
            getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.SStructDiagScale.Array2(
            getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.SStructDiagScale.Array3(
            getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.SStructDiagScale.Array4(
            getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.SStructDiagScale.Array5(
            getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.SStructDiagScale.Array6(
            getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.SStructDiagScale.Array7(
            getBaseInterfaceArray());
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private bHYPRE.SStructDiagScale.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructDiagScale.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructDiagScale.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructDiagScale.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructDiagScale 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.SStructDiagScale[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.SStructDiagScale _get( int j0) {
      return (bHYPRE.SStructDiagScale)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructDiagScale get( int j0) {
      checkBounds(  j0);
      bHYPRE.SStructDiagScale ret = null;
      ret = (bHYPRE.SStructDiagScale) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.SStructDiagScale.Array1 smartCopy() {
      bHYPRE.SStructDiagScale.Array1 ret = null;
      bHYPRE.SStructDiagScale.Array preCast = null;
      preCast = (bHYPRE.SStructDiagScale.Array) _smartCopy();
      return new bHYPRE.SStructDiagScale.Array1(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     */
    public void copy(bHYPRE.SStructDiagScale.Array1 dest) {
      _copy((bHYPRE.SStructDiagScale.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.SStructDiagScale value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.SStructDiagScale value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructDiagScale[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.SStructDiagScale[] toArray() {
      bHYPRE.SStructDiagScale[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.SStructDiagScale[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.SStructDiagScale.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructDiagScale.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructDiagScale.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructDiagScale.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructDiagScale 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.SStructDiagScale[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructDiagScale _get( int j0, int j1) {
      return (bHYPRE.SStructDiagScale)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructDiagScale get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.SStructDiagScale ret = null;
      ret = (bHYPRE.SStructDiagScale) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructDiagScale.Array2 smartCopy() {
      bHYPRE.SStructDiagScale.Array2 ret = null;
      bHYPRE.SStructDiagScale.Array preCast = null;
      preCast = (bHYPRE.SStructDiagScale.Array) _smartCopy();
      return new bHYPRE.SStructDiagScale.Array2(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructDiagScale.Array2 dest) {
      _copy((bHYPRE.SStructDiagScale.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.SStructDiagScale value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.SStructDiagScale value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.SStructDiagScale[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.SStructDiagScale[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.SStructDiagScale[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructDiagScale.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructDiagScale.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructDiagScale.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructDiagScale.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructDiagScale 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.SStructDiagScale[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructDiagScale _get( int j0, int j1, int j2) {
      return (bHYPRE.SStructDiagScale)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructDiagScale get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.SStructDiagScale ret = null;
      ret = (bHYPRE.SStructDiagScale) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructDiagScale.Array3 smartCopy() {
      bHYPRE.SStructDiagScale.Array3 ret = null;
      bHYPRE.SStructDiagScale.Array preCast = null;
      preCast = (bHYPRE.SStructDiagScale.Array) _smartCopy();
      return new bHYPRE.SStructDiagScale.Array3(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructDiagScale.Array3 dest) {
      _copy((bHYPRE.SStructDiagScale.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.SStructDiagScale value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.SStructDiagScale value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.SStructDiagScale[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.SStructDiagScale[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.SStructDiagScale[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructDiagScale.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructDiagScale.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructDiagScale.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructDiagScale.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructDiagScale 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.SStructDiagScale[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructDiagScale _get( int j0, int j1, int j2, int j3) {
      return (bHYPRE.SStructDiagScale)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructDiagScale get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.SStructDiagScale ret = null;
      ret = (bHYPRE.SStructDiagScale) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructDiagScale.Array4 smartCopy() {
      bHYPRE.SStructDiagScale.Array4 ret = null;
      bHYPRE.SStructDiagScale.Array preCast = null;
      preCast = (bHYPRE.SStructDiagScale.Array) _smartCopy();
      return new bHYPRE.SStructDiagScale.Array4(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructDiagScale.Array4 dest) {
      _copy((bHYPRE.SStructDiagScale.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.SStructDiagScale 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.SStructDiagScale 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructDiagScale[][][][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.SStructDiagScale[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.SStructDiagScale[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructDiagScale.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructDiagScale.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructDiagScale.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructDiagScale.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructDiagScale 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.SStructDiagScale[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructDiagScale _get( int j0, int j1, int j2, int j3, int 
      j4) {
      return (bHYPRE.SStructDiagScale)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructDiagScale get( int j0, int j1, int j2, int j3, int j4) 
      {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      bHYPRE.SStructDiagScale ret = null;
      ret = (bHYPRE.SStructDiagScale) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructDiagScale.Array5 smartCopy() {
      bHYPRE.SStructDiagScale.Array5 ret = null;
      bHYPRE.SStructDiagScale.Array preCast = null;
      preCast = (bHYPRE.SStructDiagScale.Array) _smartCopy();
      return new bHYPRE.SStructDiagScale.Array5(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructDiagScale.Array5 dest) {
      _copy((bHYPRE.SStructDiagScale.Array) dest);
    }
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.SStructDiagScale[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.SStructDiagScale[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructDiagScale.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructDiagScale.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructDiagScale.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructDiagScale.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructDiagScale 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.SStructDiagScale[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructDiagScale _get( int j0, int j1, int j2, int j3, int j4,
      int j5) {
      return (bHYPRE.SStructDiagScale)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }
    ...
    public bHYPRE.SStructDiagScale get( int j0, int j1, int j2, int j3, int j4, 
      ...
      bHYPRE.SStructDiagScale ret = null;
      ret = (bHYPRE.SStructDiagScale) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructDiagScale.Array6 smartCopy() {
      bHYPRE.SStructDiagScale.Array6 ret = null;
      bHYPRE.SStructDiagScale.Array preCast = null;
      preCast = (bHYPRE.SStructDiagScale.Array) _smartCopy();
      return new bHYPRE.SStructDiagScale.Array6(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructDiagScale.Array6 dest) {
      _copy((bHYPRE.SStructDiagScale.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.SStructDiagScale[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.SStructDiagScale[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructDiagScale.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructDiagScale.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructDiagScale.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructDiagScale.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructDiagScale 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.SStructDiagScale[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.SStructDiagScale get( int j0, int j1, int j2, int j3, int j4, 
      ...
      bHYPRE.SStructDiagScale ret = null;
      ret = (bHYPRE.SStructDiagScale) _get(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructDiagScale.Array7 smartCopy() {
      bHYPRE.SStructDiagScale.Array7 ret = null;
      bHYPRE.SStructDiagScale.Array preCast = null;
      preCast = (bHYPRE.SStructDiagScale.Array) _smartCopy();
      return new bHYPRE.SStructDiagScale.Array7(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructDiagScale.Array7 dest) {
      _copy((bHYPRE.SStructDiagScale.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructDiagScale[][][][][][][] orray , 
      boolean inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
                ...
                for (int m = l4; m <= u4; m++) {
                  ...
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new 
                      bHYPRE.SStructDiagScale[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructDiagScale.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructDiagScale.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructDiagScale.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructDiagScale.Array7 get() {
        return d_obj;
      }
