/*
 * File:          bHYPRE_SStructMatrixVectorView_jniStub.c
 * Symbol:        bHYPRE.SStructMatrixVectorView-v1.0.0
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.SStructMatrixVectorView
 * 
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    if (!cmp1) {
      ...
      if (!cmp2) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = ((struct bHYPRE__SStructMatrixVectorView__object*)self);
        return cast;
      }
    }
  }
...
static void
remote_bHYPRE__SStructMatrixVectorView_Destroy(
  /* in */ struct bHYPRE__SStructMatrixVectorView__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE._SStructMatrixVectorView.Destroy.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void bHYPRE__SStructMatrixVectorView__init_remote_epv(void)
{
  ...
  epv->f_SetCommunicator      = 
    remote_bHYPRE__SStructMatrixVectorView_SetCommunicator;
  epv->f_Destroy              = remote_bHYPRE__SStructMatrixVectorView_Destroy;
  epv->f_Initialize           = 
    remote_bHYPRE__SStructMatrixVectorView_Initialize;
...
static struct bHYPRE_SStructMatrixVectorView__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_SStructMatrixVectorView__object*) ptr;
}
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_SStructMatrixVectorView__remoteConnect(
    _tmp_url, 1, &_ex));
  if(_ex) {
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_SStructMatrixVectorView__object* _ior = NULL;
...
void bHYPRE_SStructMatrixVectorView__register(JNIEnv* env)
{
  ...
  methods[3].name      = "GetObject";
  methods[3].signature = "(Lsidl/BaseInterface$Holder;)I";
  methods[3].fnPtr     = (void *)jni_GetObject;
  methods[4].name      = "SetCommunicator";
  methods[4].signature = "(LbHYPRE/MPICommunicator;)I";
  methods[4].fnPtr     = (void *)jni_SetCommunicator;
  methods[5].name      = "Destroy";
  methods[5].signature = "()V";
  methods[5].fnPtr     = (void *)jni_Destroy;
  methods[6].name      = "Initialize";
  methods[6].signature = "()I";
  methods[6].fnPtr     = (void *)jni_Initialize;
  methods[7].name      = "Assemble";
  methods[7].signature = "()I";
  methods[7].fnPtr     = (void *)jni_Assemble;
  methods[8].name      = "addRef";
  methods[8].signature = "()V";
  methods[8].fnPtr     = (void *)jni_addRef;
  methods[9].name      = "deleteRef";
  methods[9].signature = "()V";
  methods[9].fnPtr     = (void *)jni_deleteRef;
  methods[10].name      = "isSame";
  methods[10].signature = "(Lsidl/BaseInterface;)Z";
  methods[10].fnPtr     = (void *)jni_isSame;
  methods[11].name      = "isType";
  methods[11].signature = "(Ljava/lang/String;)Z";
  methods[11].fnPtr     = (void *)jni_isType;
  methods[12].name      = "getClassInfo";
  methods[12].signature = "()Lsidl/ClassInfo;";
  methods[12].fnPtr     = (void *)jni_getClassInfo;


  cls = (*env)->FindClass(env, "bHYPRE/SStructMatrixVectorView$Wrapper");
  if (cls) {
