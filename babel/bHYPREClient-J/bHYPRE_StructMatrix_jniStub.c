/*
 * File:          bHYPRE_StructMatrix_jniStub.c
 * Symbol:        bHYPRE.StructMatrix-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.StructMatrix
 * 
...
#include "bHYPRE_StructMatrixView_jniStub.h"
#endif
#ifndef included_bHYPRE_StructStencil_jniStub_h
#include "bHYPRE_StructStencil_jniStub.h"
#endif
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    cast = ((struct bHYPRE_StructMatrix__object*)self);
    return cast;
  }
  else if (cmp0 < 0) {
...
bHYPRE_StructMatrix__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "bHYPRE.StructMatrix", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_StructMatrix__object*) malloc(
      sizeof(struct bHYPRE_StructMatrix__object));
...
static struct bHYPRE_StructMatrix__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_StructMatrix__object*) ptr;
}
...
static const struct bHYPRE_StructMatrix__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_StructMatrix__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_StructMatrix__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_StructMatrix__object *_ptr = (*s_external->createObject)(g_data,
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_StructMatrix__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_stencil)
{
  ...
  struct bHYPRE_StructStencil__object* _tmp_stencil = (struct 
    bHYPRE_StructStencil__object*) NULL;
  struct bHYPRE_StructMatrix__object* _ior_res = (struct 
  ...
  _tmp_stencil = (struct bHYPRE_StructStencil__object*) sidl_Java_J2I_cls(env, 
    _arg_stencil, FALSE);JAVA_CHECK(env);
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.StructMatrix", 
  ...
  jobject _arg_grid)
{
  ...
  struct bHYPRE_StructMatrix__object* _ior = NULL;
  struct bHYPRE_StructGrid__object* _tmp_grid = (struct 
    bHYPRE_StructGrid__object*) NULL;
  int32_t _ior_res = 0;
  jint _res = 0;
  ...
  jobject _arg_stencil)
{
  ...
  _ior_res = (*(_ior->d_epv->f_SetStencil))(
    _ior,
    _tmp_stencil,
    &_ex);
  ...
  jobject _arg_values)
{
  ...
  struct sidl_int__array* _tmp_stencil_indices = (struct sidl_int__array*) NULL;
  ...
  _tmp_index = (struct sidl_int__array*) sidl_Java_J2I_borrow_array(env, 
    _arg_index);
  _tmp_stencil_indices = (struct sidl_int__array*) sidl_Java_J2I_borrow_array(
    env, _arg_stencil_indices);
...
static jint
jni_SetConstantEntries(
  JNIEnv* env,
  jobject obj,
  jobject _arg_stencil_constant_points)
{
  /*
   * Declare return and temporary variables.
   */
  ...
  struct bHYPRE_StructMatrix__object* _ior = NULL;
  struct sidl_int__array* _tmp_stencil_constant_points = (struct 
    sidl_int__array*) NULL;
  int32_t _ior_res = 0;
  jint _res = 0;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  _ior = _get_ior(env, obj);
  _tmp_stencil_constant_points = (struct sidl_int__array*) 
    sidl_Java_J2I_borrow_array(env, _arg_stencil_constant_points);

  /*
   * Call the IOR method through the EPV.
   */

  _ior_res = (*(_ior->d_epv->f_SetConstantEntries))(
    _ior,
    _tmp_stencil_constant_points,
    &_ex);
  ...
  jobject _arg_values)
{
  ...
  _ior_res = (*(_ior->d_epv->f_SetConstantValues))(
    _ior,
    _tmp_stencil_indices,
    _tmp_values,
    &_ex);
...
void bHYPRE_StructMatrix__register(JNIEnv* env)
{
  JNINativeMethod methods[32];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_StructMatrix__externals();
#else
  s_external = (struct bHYPRE_StructMatrix__external*)sidl_dynamicLoadIOR(
    "bHYPRE.StructMatrix","bHYPRE_StructMatrix__externals") ;
  sidl_checkIORVersion("bHYPRE.StructMatrix", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/StructMatrix;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/StructGrid;LbHYPRE/StructStencil;)LbHYPRE/StructMatrix;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "SetGrid";
  methods[8].signature = "(LbHYPRE/StructGrid;)I";
  methods[8].fnPtr     = (void *)jni_SetGrid;
  methods[9].name      = "SetStencil";
  methods[9].signature = "(LbHYPRE/StructStencil;)I";
  methods[9].fnPtr     = (void *)jni_SetStencil;
  methods[10].name      = "SetValues";
  methods[10].signature = "(Lsidl/Integer$Array1;Lsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  ...
  methods[12].name      = "SetNumGhost";
  methods[12].signature = "(Lsidl/Integer$Array1;)I";
  methods[12].fnPtr     = (void *)jni_SetNumGhost;
  methods[13].name      = "SetSymmetric";
  methods[13].signature = "(I)I";
  methods[13].fnPtr     = (void *)jni_SetSymmetric;
  methods[14].name      = "SetConstantEntries";
  methods[14].signature = "(Lsidl/Integer$Array1;)I";
  methods[14].fnPtr     = (void *)jni_SetConstantEntries;
  methods[15].name      = "SetConstantValues";
  methods[15].signature = "(Lsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  methods[15].fnPtr     = (void *)jni_SetConstantValues;
  methods[16].name      = "SetCommunicator";
  methods[16].signature = "(LbHYPRE/MPICommunicator;)I";
  methods[16].fnPtr     = (void *)jni_SetCommunicator;
  methods[17].name      = "Destroy";
  methods[17].signature = "()V";
  methods[17].fnPtr     = (void *)jni_Destroy;
  methods[18].name      = "Initialize";
  methods[18].signature = "()I";
  methods[18].fnPtr     = (void *)jni_Initialize;
  methods[19].name      = "Assemble";
  methods[19].signature = "()I";
  methods[19].fnPtr     = (void *)jni_Assemble;
  ...
  cls = (*env)->FindClass(env, "bHYPRE/StructMatrix");
  if (cls) {
