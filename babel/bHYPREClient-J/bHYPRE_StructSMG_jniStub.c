/*
 * File:          bHYPRE_StructSMG_jniStub.c
 * Symbol:        bHYPRE.StructSMG-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.StructSMG
 * 
...
#endif
#ifndef included_bHYPRE_StructMatrix_jniStub_h
#include "bHYPRE_StructMatrix_jniStub.h"
#endif
#ifndef included_bHYPRE_StructSMG_jniStub_h
#include "bHYPRE_StructSMG_jniStub.h"
#endif
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    cast = ((struct bHYPRE_StructSMG__object*)self);
    return cast;
  }
  else if (cmp0 < 0) {
...
bHYPRE_StructSMG__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "bHYPRE.StructSMG", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_StructSMG__object*) malloc(
      sizeof(struct bHYPRE_StructSMG__object));
...
static struct bHYPRE_StructSMG__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_StructSMG__object*) ptr;
}
...
static const struct bHYPRE_StructSMG__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_StructSMG__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_StructSMG__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_StructSMG__object *_ptr = (*s_external->createObject)(g_data, 
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_StructSMG__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_StructMatrix__object* _tmp_A = (struct 
    bHYPRE_StructMatrix__object*) NULL;
  struct bHYPRE_StructSMG__object* _ior_res = (struct 
    bHYPRE_StructSMG__object*) NULL;
  ...
  _tmp_A = (struct bHYPRE_StructMatrix__object*) sidl_Java_J2I_cls(env, _arg_A, 
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.StructSMG", FALSE);JAVA_CHECK(
    env);
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_StructSMG__object* _ior = NULL;
...
void bHYPRE_StructSMG__register(JNIEnv* env)
{
  JNINativeMethod methods[29];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_StructSMG__externals();
#else
  s_external = (struct bHYPRE_StructSMG__external*)sidl_dynamicLoadIOR(
    "bHYPRE.StructSMG","bHYPRE_StructSMG__externals") ;
  sidl_checkIORVersion("bHYPRE.StructSMG", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/StructSMG;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/StructMatrix;)LbHYPRE/StructSMG;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/StructSMG");
  if (cls) {
