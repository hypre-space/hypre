/*
 * File:          bHYPRE_SStructDiagScale_jniStub.c
 * Symbol:        bHYPRE.SStructDiagScale-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.SStructDiagScale
 * 
...
#include "bHYPRE_SStructDiagScale_jniStub.h"
#endif
...
static struct bHYPRE_SStructDiagScale__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_SStructDiagScale__object*) ptr;
}
...
static const struct bHYPRE_SStructDiagScale__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_SStructDiagScale__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_SStructDiagScale__remoteCreate(_tmp_url, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_SStructDiagScale__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_SStructDiagScale__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_Operator__object* _tmp_A = (struct bHYPRE_Operator__object*) 
    NULL;
  struct bHYPRE_SStructDiagScale__object* _ior_res = (struct 
    bHYPRE_SStructDiagScale__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.SStructDiagScale", 
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_SStructDiagScale__object* _ior = NULL;
  struct bHYPRE_Operator__object* _tmp_A = (struct bHYPRE_Operator__object*) 
    NULL;
  int32_t _ior_res = 0;
  jint _res = 0;
...
void bHYPRE_SStructDiagScale__register(JNIEnv* env)
{
  JNINativeMethod methods[29];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_SStructDiagScale__externals();
#else
  s_external = (struct bHYPRE_SStructDiagScale__external*)sidl_dynamicLoadIOR(
  ...
  methods[2].signature = "(LbHYPRE/SStructDiagScale;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/Operator;)LbHYPRE/SStructDiagScale;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/SStructDiagScale");
  if (cls) {
