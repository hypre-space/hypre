/*
 * File:          bHYPRE_CGNR_jniStub.c
 * Symbol:        bHYPRE.CGNR-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.CGNR
 * 
...
#ifndef included_bHYPRE_CGNR_jniStub_h
#include "bHYPRE_CGNR_jniStub.h"
#endif
...
static void bHYPRE_CGNR__init_remote_epv(void)
{
  ...
  epv->f_GetRelResidualNorm            = remote_bHYPRE_CGNR_GetRelResidualNorm;
  ...
  epv->f_SetDoubleParameter            = remote_bHYPRE_CGNR_SetDoubleParameter;
  epv->f_SetStringParameter            = remote_bHYPRE_CGNR_SetStringParameter;
...
static struct bHYPRE_CGNR__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_CGNR__object*) ptr;
}
...
static const struct bHYPRE_CGNR__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_CGNR__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_CGNR__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_CGNR__object *_ptr = (*s_external->createObject)(g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_CGNR__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_Operator__object* _tmp_A = (struct bHYPRE_Operator__object*) 
    NULL;
  struct bHYPRE_CGNR__object* _ior_res = (struct bHYPRE_CGNR__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.CGNR", FALSE);JAVA_CHECK(env);
  ...
  jobject _arg_s)
{
  ...
  struct bHYPRE_CGNR__object* _ior = NULL;
...
void bHYPRE_CGNR__register(JNIEnv* env)
{
  JNINativeMethod methods[32];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_CGNR__externals();
#else
  s_external = (struct bHYPRE_CGNR__external*)sidl_dynamicLoadIOR("bHYPRE.CGNR",
    "bHYPRE_CGNR__externals") ;
  sidl_checkIORVersion("bHYPRE.CGNR", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/CGNR;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/Operator;)LbHYPRE/CGNR;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/CGNR");
  if (cls) {
