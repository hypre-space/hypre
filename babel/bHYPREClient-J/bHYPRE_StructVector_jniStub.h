/*
 * File:          bHYPRE_StructVector_jniStub.h
 * Symbol:        bHYPRE.StructVector-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side header code for bHYPRE.StructVector
 * 
 * WARNING: Automatically generated; changes will be lost
 * 
 */

#ifndef included_bHYPRE_StructVector_jniStub_h
#define included_bHYPRE_StructVector_jniStub_h
