/*
 * File:          bHYPRE_SStructGraph_jniStub.c
 * Symbol:        bHYPRE.SStructGraph-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.SStructGraph
 * 
...
static struct bHYPRE_SStructGraph__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_SStructGraph__object*) ptr;
}
...
static const struct bHYPRE_SStructGraph__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_SStructGraph__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_SStructGraph__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_SStructGraph__object *_ptr = (*s_external->createObject)(g_data,
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_SStructGraph__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_grid)
{
  ...
  struct bHYPRE_SStructGraph__object* _ior_res = (struct 
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.SStructGraph", 
  ...
  jobject _arg_grid)
{
  ...
  struct bHYPRE_SStructGraph__object* _ior = NULL;
  struct bHYPRE_MPICommunicator__object* _tmp_mpi_comm = (struct 
    bHYPRE_MPICommunicator__object*) NULL;
  struct bHYPRE_SStructGrid__object* _tmp_grid = (struct 
    bHYPRE_SStructGrid__object*) NULL;
  ...
  _ior_res = (*(_ior->d_epv->f_SetCommGrid))(
    _ior,
    _tmp_mpi_comm,
    _tmp_grid,
    &_ex);
  ...
  jobject _arg_stencil)
{
  ...
  int32_t _tmp_part = 0;
  int32_t _tmp_var = 0;
  struct bHYPRE_SStructStencil__object* _tmp_stencil = (struct 
  ...
  _tmp_stencil = (struct bHYPRE_SStructStencil__object*) sidl_Java_J2I_cls(env, 
  ...
  jint _arg_to_var)
{
  ...
  int32_t _tmp_var = 0;
  int32_t _tmp_to_part = 0;
  struct sidl_int__array* _tmp_to_index = (struct sidl_int__array*) NULL;
  ...
  _tmp_index = (struct sidl_int__array*) sidl_Java_J2I_borrow_array(env, 
    _arg_index);
  _tmp_var = (int32_t) _arg_var;
  _tmp_to_part = (int32_t) _arg_to_part;
  _tmp_to_index = (struct sidl_int__array*) sidl_Java_J2I_borrow_array(env, 
    _arg_to_index);
  ...
  _ior_res = (*(_ior->d_epv->f_AddEntries))(
    _ior,
    _tmp_part,
    _tmp_index,
    _tmp_var,
...
void bHYPRE_SStructGraph__register(JNIEnv* env)
{
  JNINativeMethod methods[16];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_SStructGraph__externals();
#else
  s_external = (struct bHYPRE_SStructGraph__external*)sidl_dynamicLoadIOR(
    "bHYPRE.SStructGraph","bHYPRE_SStructGraph__externals") ;
  sidl_checkIORVersion("bHYPRE.SStructGraph", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/SStructGraph;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/SStructGrid;)LbHYPRE/SStructGraph;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "SetCommGrid";
  methods[8].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/SStructGrid;)I";
  methods[8].fnPtr     = (void *)jni_SetCommGrid;
  methods[9].name      = "SetStencil";
  methods[9].signature = "(IILbHYPRE/SStructStencil;)I";
  methods[9].fnPtr     = (void *)jni_SetStencil;
  methods[10].name      = "AddEntries";
  methods[10].signature = "(ILsidl/Integer$Array1;IILsidl/Integer$Array1;I)I";
  methods[10].fnPtr     = (void *)jni_AddEntries;
  methods[11].name      = "SetObjectType";
  methods[11].signature = "(I)I";
  methods[11].fnPtr     = (void *)jni_SetObjectType;
  ...
  cls = (*env)->FindClass(env, "bHYPRE/SStructGraph");
  if (cls) {
