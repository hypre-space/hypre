/*
 * File:          bHYPRE_Schwarz_jniStub.c
 * Symbol:        bHYPRE.Schwarz-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.Schwarz
 * 
...
#endif
#ifndef included_bHYPRE_Schwarz_jniStub_h
#include "bHYPRE_Schwarz_jniStub.h"
#endif
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    if (!cmp1) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = ((struct bHYPRE_Schwarz__object*)self);
      return cast;
    }
    else if (cmp1 < 0) {
...
bHYPRE_Schwarz__remoteConnect(const char *url, sidl_bool ar, sidl_BaseInterface 
  *_ex)
{
  struct bHYPRE_Schwarz__object* self;
...
static struct bHYPRE_Schwarz__object*
bHYPRE_Schwarz__IHConnect(sidl_rmi_InstanceHandle instance, sidl_BaseInterface 
  *_ex)
{
  struct bHYPRE_Schwarz__object* self;
...
bHYPRE_Schwarz__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "bHYPRE.Schwarz", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_Schwarz__object*) malloc(
      sizeof(struct bHYPRE_Schwarz__object));
...
static struct bHYPRE_Schwarz__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_Schwarz__object*) ptr;
}
...
static const struct bHYPRE_Schwarz__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_Schwarz__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_Schwarz__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_Schwarz__object *_ptr = (*s_external->createObject)(g_data, 
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_Schwarz__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_IJParCSRMatrix__object* _tmp_A = (struct 
    bHYPRE_IJParCSRMatrix__object*) NULL;
  struct bHYPRE_Schwarz__object* _ior_res = (struct bHYPRE_Schwarz__object*) 
    NULL;
  ...
  _tmp_A = (struct bHYPRE_IJParCSRMatrix__object*) sidl_Java_J2I_cls(env, 
    _arg_A, FALSE);JAVA_CHECK(env);
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.Schwarz", FALSE);JAVA_CHECK(
    env);
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_Schwarz__object* _ior = NULL;
...
void bHYPRE_Schwarz__register(JNIEnv* env)
{
  JNINativeMethod methods[29];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_Schwarz__externals();
#else
  s_external = (struct bHYPRE_Schwarz__external*)sidl_dynamicLoadIOR(
    "bHYPRE.Schwarz","bHYPRE_Schwarz__externals") ;
  sidl_checkIORVersion("bHYPRE.Schwarz", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/Schwarz;)J";
  ...
  methods[7].signature = "(LbHYPRE/IJParCSRMatrix;)LbHYPRE/Schwarz;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "SetOperator";
  methods[8].signature = "(LbHYPRE/Operator;)I";
  methods[8].fnPtr     = (void *)jni_SetOperator;
  methods[9].name      = "SetTolerance";
  methods[9].signature = "(D)I";
  methods[9].fnPtr     = (void *)jni_SetTolerance;
  methods[10].name      = "SetMaxIterations";
  methods[10].signature = "(I)I";
  methods[10].fnPtr     = (void *)jni_SetMaxIterations;
  methods[11].name      = "SetLogging";
  methods[11].signature = "(I)I";
  methods[11].fnPtr     = (void *)jni_SetLogging;
  methods[12].name      = "SetPrintLevel";
  methods[12].signature = "(I)I";
  methods[12].fnPtr     = (void *)jni_SetPrintLevel;
  methods[13].name      = "GetNumIterations";
  methods[13].signature = "(Lsidl/Integer$Holder;)I";
  methods[13].fnPtr     = (void *)jni_GetNumIterations;
  methods[14].name      = "GetRelResidualNorm";
  methods[14].signature = "(Lsidl/Double$Holder;)I";
  methods[14].fnPtr     = (void *)jni_GetRelResidualNorm;
  methods[15].name      = "SetCommunicator";
  methods[15].signature = "(LbHYPRE/MPICommunicator;)I";
  methods[15].fnPtr     = (void *)jni_SetCommunicator;
  methods[16].name      = "Destroy";
  methods[16].signature = "()V";
  methods[16].fnPtr     = (void *)jni_Destroy;
  methods[17].name      = "SetIntParameter";
  methods[17].signature = "(Ljava/lang/String;I)I";
  methods[17].fnPtr     = (void *)jni_SetIntParameter;
  methods[18].name      = "SetDoubleParameter";
  methods[18].signature = "(Ljava/lang/String;D)I";
  methods[18].fnPtr     = (void *)jni_SetDoubleParameter;
  methods[19].name      = "SetStringParameter";
  methods[19].signature = "(Ljava/lang/String;Ljava/lang/String;)I";
  methods[19].fnPtr     = (void *)jni_SetStringParameter;
  methods[20].name      = "SetIntArray1Parameter";
  methods[20].signature = "(Ljava/lang/String;Lsidl/Integer$Array1;)I";
  methods[20].fnPtr     = (void *)jni_SetIntArray1Parameter;
  methods[21].name      = "SetIntArray2Parameter";
  methods[21].signature = "(Ljava/lang/String;Lsidl/Integer$Array2;)I";
  methods[21].fnPtr     = (void *)jni_SetIntArray2Parameter;
  methods[22].name      = "SetDoubleArray1Parameter";
  methods[22].signature = "(Ljava/lang/String;Lsidl/Double$Array1;)I";
  methods[22].fnPtr     = (void *)jni_SetDoubleArray1Parameter;
  methods[23].name      = "SetDoubleArray2Parameter";
  methods[23].signature = "(Ljava/lang/String;Lsidl/Double$Array2;)I";
  methods[23].fnPtr     = (void *)jni_SetDoubleArray2Parameter;
  methods[24].name      = "GetIntValue";
  methods[24].signature = "(Ljava/lang/String;Lsidl/Integer$Holder;)I";
  methods[24].fnPtr     = (void *)jni_GetIntValue;
  methods[25].name      = "GetDoubleValue";
  methods[25].signature = "(Ljava/lang/String;Lsidl/Double$Holder;)I";
  methods[25].fnPtr     = (void *)jni_GetDoubleValue;
  methods[26].name      = "Setup";
  methods[26].signature = "(LbHYPRE/Vector;LbHYPRE/Vector;)I";
  methods[26].fnPtr     = (void *)jni_Setup;
  methods[27].name      = "Apply";
  methods[27].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[27].fnPtr     = (void *)jni_Apply;
  methods[28].name      = "ApplyAdjoint";
  methods[28].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[28].fnPtr     = (void *)jni_ApplyAdjoint;


  cls = (*env)->FindClass(env, "bHYPRE/Schwarz");
  if (cls) {
