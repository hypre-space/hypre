...
extern void bHYPRE_GMRES__init(
  struct bHYPRE_GMRES__object* self, void* ddata,
...
extern void bHYPRE_GMRES__getEPVs(
  ...
  struct bHYPRE_GMRES__epv **s_arg_epv__bhypre_gmres,
    struct bHYPRE_GMRES__epv **s_arg_epv_hooks__bhypre_gmres);
  ...
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_GMRES_fcast_bHYPRE_MPICommunicator(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_Operator__object* 
    skel_bHYPRE_GMRES_fconnect_bHYPRE_Operator(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseClass__object* 
    skel_bHYPRE_GMRES_fconnect_sidl_BaseClass(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_GMRES_fcast_sidl_BaseInterface(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct sidl_ClassInfo__object* 
    skel_bHYPRE_GMRES_fconnect_sidl_ClassInfo(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* skel_bHYPRE_GMRES_fcast_sidl_ClassInfo(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_RuntimeException__object* 
    skel_bHYPRE_GMRES_fconnect_sidl_RuntimeException(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_GMRES_fcast_sidl_RuntimeException(void *bi,
    struct sidl_BaseInterface__object **_ex);
