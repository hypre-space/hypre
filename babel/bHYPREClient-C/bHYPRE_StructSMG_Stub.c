...
#else
  _externals = (struct bHYPRE_StructSMG__external*)sidl_dynamicLoadIOR(
...
{
  return (struct bHYPRE_StructSMG__array*)sidl_interface__array_create1dInit(
