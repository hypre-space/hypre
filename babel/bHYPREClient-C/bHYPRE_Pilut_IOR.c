...
static int32_t
remote_bHYPRE_Pilut_SetIntArrayParameter(
  struct bHYPRE_Pilut__object* self,
  const char* name,
...
static int32_t
remote_bHYPRE_Pilut_SetDoubleArrayParameter(
  struct bHYPRE_Pilut__object* self,
  const char* name,
...
static void bHYPRE_Pilut__init_remote_epv(void)
{
  ...
  epv->f_SetIntArrayParameter    = remote_bHYPRE_Pilut_SetIntArrayParameter;
  epv->f_SetDoubleArrayParameter = remote_bHYPRE_Pilut_SetDoubleArrayParameter;
