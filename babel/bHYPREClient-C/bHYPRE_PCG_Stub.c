...
static const struct bHYPRE_PCG__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_PCG__external* _loadIOR(void)
/*
...

{
  ...
  _externals = bHYPRE_PCG__externals();
#else
  _externals = (struct bHYPRE_PCG__external*)sidl_dynamicLoadIOR("bHYPRE.PCG",
...
static bHYPRE_PCG bHYPRE_PCG__remote(const char* url, sidl_BaseInterface *_ex);
/*
...
{
  return bHYPRE_PCG__remote(url, _ex);
}

static struct bHYPRE_PCG__object* bHYPRE_PCG__remoteConnect(const char* url,
  sidl_BaseInterface *_ex);
static struct bHYPRE_PCG__object* bHYPRE_PCG__IHConnect(sidl_rmi_InstanceHandle 
...
bHYPRE_PCG
bHYPRE_PCG__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_PCG__remoteConnect(url, _ex);
}
...
bHYPRE_PCG__cast(
  void* obj)
{
  bHYPRE_PCG cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.PCG",
      (void*)bHYPRE_PCG__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_PCG) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.PCG");
  }
...
bHYPRE_PCG__sexec(
        ...
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_PCG__smethod s_methods[] = {
    { "Create", bHYPRE_PCG_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_PCG__smethod);
  if (methodName) {
...
bHYPRE_PCG__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_PCG__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
bHYPRE_PCG__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_PCG__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct bHYPRE_PCG__array*)sidl_interface__array_create1d(len);
}
...
bHYPRE_PCG__array_create1dInit(
  ...
  bHYPRE_PCG* data)
{
  return (struct bHYPRE_PCG__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct bHYPRE_PCG__array*)sidl_interface__array_create2dCol(m, n);
}

struct bHYPRE_PCG__array*
bHYPRE_PCG__array_create2dRow(int32_t m, int32_t n)
{
  return (struct bHYPRE_PCG__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_PCG__array*)sidl_interface__array_borrow(
...
{
  return (struct bHYPRE_PCG__array*)
...
const char* name)
{
  ...
  else if(bHYPRE_PCG_isType(self, name)) {
...
static void bHYPRE_PCG__init_remote_epv(void)
{
  ...
  epv->f_queryInt                      = remote_bHYPRE_PCG_queryInt;
...
bHYPRE_PCG__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_PCG__object* self;
...
static struct bHYPRE_PCG__object*
bHYPRE_PCG__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_PCG__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.PCG", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_PCG__object*) malloc(
      sizeof(struct bHYPRE_PCG__object));
