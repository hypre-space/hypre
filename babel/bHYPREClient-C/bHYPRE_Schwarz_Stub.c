...
static const struct bHYPRE_Schwarz__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_Schwarz__external* _loadIOR(void)
/*
...

{
  ...
  _externals = bHYPRE_Schwarz__externals();
#else
  _externals = (struct 
...
bHYPRE_Schwarz
bHYPRE_Schwarz__create()
{
  return (*(_getExternals()->createObject))();
}

static bHYPRE_Schwarz bHYPRE_Schwarz__remote(const char* url,
...
{
  return bHYPRE_Schwarz__remote(url, _ex);
}
...
bHYPRE_Schwarz
bHYPRE_Schwarz__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_Schwarz__remoteConnect(url, _ex);
}
...
void
bHYPRE_Schwarz_Create__sexec(
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  bHYPRE_IJParCSRMatrix A;
  bHYPRE_Schwarz _retval;
...
bHYPRE_Schwarz__cast(
  void* obj)
{
  bHYPRE_Schwarz cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.Schwarz",
      (void*)bHYPRE_Schwarz__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_Schwarz) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.Schwarz");
  }
...
struct bHYPRE_Schwarz__smethod {
  const char *d_name;
...
void
bHYPRE_Schwarz__sexec(
        const char* methodName,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_Schwarz__smethod s_methods[] = {
    { "Create", bHYPRE_Schwarz_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_Schwarz__smethod);
  if (methodName) {
...
bHYPRE_Schwarz__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_Schwarz__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
bHYPRE_Schwarz__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_Schwarz__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct bHYPRE_Schwarz__array*)sidl_interface__array_create1d(len);
}
...
bHYPRE_Schwarz__array_create1dInit(
  ...
  bHYPRE_Schwarz* data)
{
  return (struct bHYPRE_Schwarz__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct bHYPRE_Schwarz__array*)sidl_interface__array_create2dCol(m, n);
}

struct bHYPRE_Schwarz__array*
bHYPRE_Schwarz__array_create2dRow(int32_t m, int32_t n)
{
  return (struct bHYPRE_Schwarz__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_Schwarz__array*)sidl_interface__array_borrow(
...
{
  return (struct bHYPRE_Schwarz__array*)
...
const char* name)
{
  ...
  else if(bHYPRE_Schwarz_isType(self, name)) {
...
remote_bHYPRE_Schwarz_addRef(
  /* in */ struct bHYPRE_Schwarz__object* self /* TLD */)
{
...
remote_bHYPRE_Schwarz_queryInt(
  /* in */ struct bHYPRE_Schwarz__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void bHYPRE_Schwarz__init_remote_epv(void)
{
  ...
  epv->f_queryInt                      = remote_bHYPRE_Schwarz_queryInt;
...
static struct bHYPRE_Schwarz__object*
bHYPRE_Schwarz__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_Schwarz__object* self;
...
static struct bHYPRE_Schwarz__object*
bHYPRE_Schwarz__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_Schwarz__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.Schwarz", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_Schwarz__object*) malloc(
      sizeof(struct bHYPRE_Schwarz__object));
