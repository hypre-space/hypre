...
static const struct bHYPRE_StructDiagScale__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_StructDiagScale__external* _loadIOR(void)
/*
...
bHYPRE_StructDiagScale__create()
{
  return (*(_getExternals()->createObject))();
}

static bHYPRE_StructDiagScale bHYPRE_StructDiagScale__remote(const char* url,
...
bHYPRE_StructDiagScale
bHYPRE_StructDiagScale__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_StructDiagScale__remote(url, _ex);
}

static struct bHYPRE_StructDiagScale__object* 
  bHYPRE_StructDiagScale__remoteConnect(const char* url,
  sidl_BaseInterface *_ex);
static struct bHYPRE_StructDiagScale__object* 
...
bHYPRE_StructDiagScale
bHYPRE_StructDiagScale__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_StructDiagScale__remoteConnect(url, _ex);
}
...
void
bHYPRE_StructDiagScale_Create__sexec(
...
bHYPRE_StructDiagScale__cast(
  void* obj)
{
  bHYPRE_StructDiagScale cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.StructDiagScale",
      (void*)bHYPRE_StructDiagScale__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_StructDiagScale) (*base->d_epv->f__cast)(
      base->d_object,
...
struct bHYPRE_StructDiagScale__smethod {
  const char *d_name;
...
bHYPRE_StructDiagScale__sexec(
        ...
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_StructDiagScale__smethod s_methods[] = {
    { "Create", bHYPRE_StructDiagScale_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_StructDiagScale__smethod);
  if (methodName) {
...
{
  return (struct 
    bHYPRE_StructDiagScale__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    bHYPRE_StructDiagScale__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_StructDiagScale__array*)sidl_interface__array_borrow(
...
const char* name)
{
  ...
  if (!strcmp(name, "bHYPRE.StructDiagScale")) {
    cast = (void*) s0;
  ...
  else if(bHYPRE_StructDiagScale_isType(self, name)) {
...
remote_bHYPRE_StructDiagScale_addRef(
  /* in */ struct bHYPRE_StructDiagScale__object* self /* TLD */)
{
...
remote_bHYPRE_StructDiagScale_queryInt(
  /* in */ struct bHYPRE_StructDiagScale__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void bHYPRE_StructDiagScale__init_remote_epv(void)
{
  ...
  epv->f_queryInt                      = remote_bHYPRE_StructDiagScale_queryInt;
...
static struct bHYPRE_StructDiagScale__object*
bHYPRE_StructDiagScale__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_StructDiagScale__object* self;
...
static struct bHYPRE_StructDiagScale__object*
bHYPRE_StructDiagScale__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_StructDiagScale__object* self;
