...
static bHYPRE_StructDiagScale bHYPRE_StructDiagScale__remoteCreate(const char* 
...
{
  return bHYPRE_StructDiagScale__remoteCreate(url, _ex);
}
...
{
  return bHYPRE_StructDiagScale__remoteConnect(url, TRUE, _ex);
}
...
void
bHYPRE_StructDiagScale__set_hooks_static(
  int32_t on,
...
SIDL_C_INLINE_DEFN
void
bHYPRE_StructDiagScale__set_hooks(
  /* in */ bHYPRE_StructDiagScale self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
bHYPRE_StructDiagScale__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_StructDiagScale__isRemote(self,_ex);
}
