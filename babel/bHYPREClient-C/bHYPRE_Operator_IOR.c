...
static int32_t
remote_bHYPRE_Operator_SetIntArrayParameter(
  void* self,
  const char* name,
...
static int32_t
remote_bHYPRE_Operator_SetDoubleArrayParameter(
  void* self,
  const char* name,
...
static void bHYPRE_Operator__init_remote_epv(void)
{
  ...
  epv->f_SetIntArrayParameter    = remote_bHYPRE_Operator_SetIntArrayParameter;
