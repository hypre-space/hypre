...
static bHYPRE_BoomerAMG bHYPRE_BoomerAMG__remote(const char* url,
...
{
  return bHYPRE_BoomerAMG__remote(url, _ex);
}
...
{
  return bHYPRE_BoomerAMG__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.BoomerAMG",
      (void*)bHYPRE_BoomerAMG__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  else if(bHYPRE_BoomerAMG_isType(self, name)) {
  ...
  /* in */ int32_t level)
{
  ...
  sidl_rmi_InstanceHandle _conn = (sidl_rmi_InstanceHandle)self->d_data;
  sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation( _conn,
    "SetLevelRelaxWt", _ex2 );
  sidl_rmi_Response _rsvp = NULL;
  int32_t _retval;

  /* pack in and inout arguments */
  sidl_rmi_Invocation_packDouble( _inv, "relax_wt", relax_wt, _ex2);
...
static struct bHYPRE_BoomerAMG__object*
bHYPRE_BoomerAMG__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_BoomerAMG__object* self;
...
static struct bHYPRE_BoomerAMG__object*
bHYPRE_BoomerAMG__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_BoomerAMG__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.BoomerAMG", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_BoomerAMG__object*) malloc(
      sizeof(struct bHYPRE_BoomerAMG__object));
