...
static const struct bHYPRE_CGNR__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_CGNR__external* _loadIOR(void)
/*
...

{
  ...
  _externals = bHYPRE_CGNR__externals();
#else
  _externals = (struct bHYPRE_CGNR__external*)sidl_dynamicLoadIOR("bHYPRE.CGNR",
...
static bHYPRE_CGNR bHYPRE_CGNR__remote(const char* url,
...
{
  return bHYPRE_CGNR__remote(url, _ex);
}
...
bHYPRE_CGNR
bHYPRE_CGNR__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_CGNR__remoteConnect(url, _ex);
}
...
bHYPRE_CGNR__cast(
  void* obj)
{
  bHYPRE_CGNR cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.CGNR",
      (void*)bHYPRE_CGNR__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_CGNR) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.CGNR");
  }
...
bHYPRE_CGNR__sexec(
        ...
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_CGNR__smethod s_methods[] = {
    { "Create", bHYPRE_CGNR_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_CGNR__smethod);
  if (methodName) {
...
bHYPRE_CGNR__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_CGNR__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
bHYPRE_CGNR__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_CGNR__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct bHYPRE_CGNR__array*)sidl_interface__array_create1d(len);
}
...
bHYPRE_CGNR__array_create1dInit(
  ...
  bHYPRE_CGNR* data)
{
  return (struct bHYPRE_CGNR__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct bHYPRE_CGNR__array*)sidl_interface__array_create2dCol(m, n);
}

struct bHYPRE_CGNR__array*
bHYPRE_CGNR__array_create2dRow(int32_t m, int32_t n)
{
  return (struct bHYPRE_CGNR__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_CGNR__array*)sidl_interface__array_borrow(
...
{
  return (struct bHYPRE_CGNR__array*)
...
const char* name)
{
  ...
  else if(bHYPRE_CGNR_isType(self, name)) {
...
remote_bHYPRE_CGNR_addRef(
  /* in */ struct bHYPRE_CGNR__object* self /* TLD */)
{
...
static void bHYPRE_CGNR__init_remote_epv(void)
{
  ...
  epv->f_queryInt                      = remote_bHYPRE_CGNR_queryInt;
...
static struct bHYPRE_CGNR__object*
bHYPRE_CGNR__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_CGNR__object* self;
...
static struct bHYPRE_CGNR__object*
bHYPRE_CGNR__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_CGNR__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.CGNR", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_CGNR__object*) malloc(
      sizeof(struct bHYPRE_CGNR__object));
