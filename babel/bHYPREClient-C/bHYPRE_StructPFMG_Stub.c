...
#else
  _externals = (struct bHYPRE_StructPFMG__external*)sidl_dynamicLoadIOR(
...
bHYPRE_StructPFMG__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_StructPFMG__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
bHYPRE_StructPFMG__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_StructPFMG__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct bHYPRE_StructPFMG__array*)sidl_interface__array_create1dInit(
