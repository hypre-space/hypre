  ...
  struct bHYPRE_IJParCSRMatrix__object* self)
{
  ...
  struct bHYPRE_CoefficientAccess__epv* e2  = &s_new__bhypre_coefficientaccess;
  struct bHYPRE_IJBuildMatrix__epv*     e3  = &s_new__bhypre_ijbuildmatrix;
  struct bHYPRE_Operator__epv*          e4  = &s_new__bhypre_operator;
  struct bHYPRE_ProblemDefinition__epv* e5  = &s_new__bhypre_problemdefinition;
  ...
  e3->f_SetLocalRange   = (int32_t (*)(void*,int32_t,int32_t,int32_t,
  ...
  e3->f_GetLocalRange   = (int32_t (*)(void*,int32_t*,int32_t*,int32_t*,
    int32_t*)) epv->f_GetLocalRange;
  e3->f_GetRowCounts    = (int32_t (*)(void*,int32_t,struct SIDL_int__array*,
  ...
  e3->f_SetRowSizes     = (int32_t (*)(void*,
    struct SIDL_int__array*)) epv->f_SetRowSizes;
  e3->f_Print           = (int32_t (*)(void*,const char*)) epv->f_Print;
  e3->f_Read            = (int32_t (*)(void*,const char*,void*)) epv->f_Read;
  ...
  e4->f_SetIntArrayParameter    = (int32_t (*)(void*,const char*,
    struct SIDL_int__array*)) epv->f_SetIntArrayParameter;
  e4->f_SetDoubleArrayParameter = (int32_t (*)(void*,const char*,
...
static int32_t
remote_bHYPRE_IJParCSRMatrix_SetIntArrayParameter(
  struct bHYPRE_IJParCSRMatrix__object* self,
  const char* name,
...
static int32_t
remote_bHYPRE_IJParCSRMatrix_SetDoubleArrayParameter(
  struct bHYPRE_IJParCSRMatrix__object* self,
  const char* name,
...
static void bHYPRE_IJParCSRMatrix__init_remote_epv(void)
{
  ...
  struct bHYPRE_CoefficientAccess__epv* e2  = &s_rem__bhypre_coefficientaccess;
  struct bHYPRE_IJBuildMatrix__epv*     e3  = &s_rem__bhypre_ijbuildmatrix;
  struct bHYPRE_Operator__epv*          e4  = &s_rem__bhypre_operator;
  struct bHYPRE_ProblemDefinition__epv* e5  = &s_rem__bhypre_problemdefinition;
  ...
  epv->f_SetDiagOffdSizes        = 
    remote_bHYPRE_IJParCSRMatrix_SetDiagOffdSizes;
  epv->f_SetCommunicator         = remote_bHYPRE_IJParCSRMatrix_SetCommunicator;
  epv->f_SetIntParameter         = remote_bHYPRE_IJParCSRMatrix_SetIntParameter;
