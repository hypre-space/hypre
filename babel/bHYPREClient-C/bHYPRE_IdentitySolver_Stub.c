...
static const struct bHYPRE_IdentitySolver__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_IdentitySolver__external* _loadIOR(void)
/*
...
static const struct bHYPRE_IdentitySolver__sepv *_sepv = NULL;
/*
...
static bHYPRE_IdentitySolver bHYPRE_IdentitySolver__remoteCreate(const char* 
...
{
  return bHYPRE_IdentitySolver__remoteCreate(url, _ex);
}
...
bHYPRE_IdentitySolver
bHYPRE_IdentitySolver__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_IdentitySolver__remoteConnect(url, TRUE, _ex);
}
...
bHYPRE_IdentitySolver__cast(
  ...
  sidl_BaseInterface* _ex)
{
  bHYPRE_IdentitySolver cast = NULL;
  ...
  if (obj != NULL) {
    ...
    cast = (bHYPRE_IdentitySolver) (*base->d_epv->f__cast)(
      base->d_object,
...
void
bHYPRE_IdentitySolver__set_hooks_static(
  int32_t on,
...
SIDL_C_INLINE_DEFN
void
bHYPRE_IdentitySolver__set_hooks(
  /* in */ bHYPRE_IdentitySolver self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
bHYPRE_IdentitySolver__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_IdentitySolver__isRemote(self,_ex);
}
...
{
  return (struct 
    bHYPRE_IdentitySolver__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    bHYPRE_IdentitySolver__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_IdentitySolver__array*)sidl_interface__array_borrow(
...
static void bHYPRE_IdentitySolver__init_remote_epv(void)
{
  ...
  epv->f__raddRef                      = remote_bHYPRE_IdentitySolver__raddRef;
  epv->f__isRemote                     = remote_bHYPRE_IdentitySolver__isRemote;
  epv->f__set_hooks                    = 
    remote_bHYPRE_IdentitySolver__set_hooks;
  epv->f__ctor                         = NULL;
  epv->f__ctor2                        = NULL;
  ...
  epv->f_deleteRef                     = remote_bHYPRE_IdentitySolver_deleteRef;
