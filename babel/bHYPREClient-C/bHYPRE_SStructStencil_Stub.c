...
#else
  _externals = (struct bHYPRE_SStructStencil__external*)sidl_dynamicLoadIOR(
...
{
  int32_t _result;
  _result = (*self->d_epv->f_SetNumDimSize)(
    self,
    ndim,
    size,
    _ex);
...
bHYPRE_SStructStencil__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_SStructStencil__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
bHYPRE_SStructStencil__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_SStructStencil__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct bHYPRE_SStructStencil__array*)sidl_interface__array_create1d(
    len);
}
