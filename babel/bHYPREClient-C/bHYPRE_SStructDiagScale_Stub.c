/*
 * File:          bHYPRE_SStructDiagScale_Stub.c
...
static const struct bHYPRE_SStructDiagScale__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_SStructDiagScale__external* _loadIOR(void)
/*
...

{
  ...
  _externals = bHYPRE_SStructDiagScale__externals();
#else
  _externals = (struct 
...
bHYPRE_SStructDiagScale__create()
{
  return (*(_getExternals()->createObject))();
}

static bHYPRE_SStructDiagScale bHYPRE_SStructDiagScale__remote(const char* url,
...
bHYPRE_SStructDiagScale
bHYPRE_SStructDiagScale__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_SStructDiagScale__remote(url, _ex);
}

static struct bHYPRE_SStructDiagScale__object* 
  bHYPRE_SStructDiagScale__remoteConnect(const char* url,
  sidl_BaseInterface *_ex);
static struct bHYPRE_SStructDiagScale__object* 
...
bHYPRE_SStructDiagScale
bHYPRE_SStructDiagScale__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_SStructDiagScale__remoteConnect(url, _ex);
}
...
void
bHYPRE_SStructDiagScale_Create__sexec(
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  bHYPRE_MPICommunicator mpi_comm;
  bHYPRE_SStructDiagScale _retval;
...
bHYPRE_SStructDiagScale__cast(
  void* obj)
{
  bHYPRE_SStructDiagScale cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.SStructDiagScale",
      (void*)bHYPRE_SStructDiagScale__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_SStructDiagScale) (*base->d_epv->f__cast)(
      base->d_object,
...
struct bHYPRE_SStructDiagScale__smethod {
  const char *d_name;
...
bHYPRE_SStructDiagScale__sexec(
        ...
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_SStructDiagScale__smethod s_methods[] = {
    { "Create", bHYPRE_SStructDiagScale_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_SStructDiagScale__smethod);
  if (methodName) {
...
{
  return (struct 
    bHYPRE_SStructDiagScale__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
{
  return (struct 
    bHYPRE_SStructDiagScale__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct 
    bHYPRE_SStructDiagScale__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    bHYPRE_SStructDiagScale__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct 
    bHYPRE_SStructDiagScale__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    bHYPRE_SStructDiagScale__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_SStructDiagScale__array*)sidl_interface__array_borrow(
...
{
  return (struct bHYPRE_SStructDiagScale__array*)
...
bHYPRE_SStructDiagScale__array_get1(
  ...
  const int32_t i1)
{
  return (bHYPRE_SStructDiagScale)
...
const char* name)
{
  ...
  else if(bHYPRE_SStructDiagScale_isType(self, name)) {
...
remote_bHYPRE_SStructDiagScale_addRef(
  /* in */ struct bHYPRE_SStructDiagScale__object* self /* TLD */)
{
...
remote_bHYPRE_SStructDiagScale_queryInt(
  /* in */ struct bHYPRE_SStructDiagScale__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static struct bHYPRE_SStructDiagScale__object*
bHYPRE_SStructDiagScale__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_SStructDiagScale__object* self;
...
static struct bHYPRE_SStructDiagScale__object*
bHYPRE_SStructDiagScale__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_SStructDiagScale__object* self;
