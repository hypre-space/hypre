...
#else
  _externals = (struct bHYPRE_SStructDiagScale__external*)sidl_dynamicLoadIOR(
    "bHYPRE.SStructDiagScale","bHYPRE_SStructDiagScale__externals") ;
  sidl_checkIORVersion("bHYPRE.SStructDiagScale", 
...
static bHYPRE_SStructDiagScale bHYPRE_SStructDiagScale__remoteCreate(const 
...
{
  return bHYPRE_SStructDiagScale__remoteCreate(url, _ex);
}
...
{
  return bHYPRE_SStructDiagScale__remoteConnect(url, TRUE, _ex);
}
...
{
  bHYPRE_SStructDiagScale _result;
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.SStructDiagScale", (
      void*)bHYPRE_SStructDiagScale__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
void
bHYPRE_SStructDiagScale__set_hooks_static(
  int32_t on,
...
SIDL_C_INLINE_DEFN
void
bHYPRE_SStructDiagScale__set_hooks(
  /* in */ bHYPRE_SStructDiagScale self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
bHYPRE_SStructDiagScale__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_SStructDiagScale__isRemote(self,_ex);
}
...
{
  return (struct bHYPRE_SStructDiagScale__array*)sidl_interface__array_create1d(
    len);
}
