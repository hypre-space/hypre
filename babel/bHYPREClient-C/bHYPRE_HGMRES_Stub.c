...
static int32_t
remote_bHYPRE_HGMRES_GetPreconditioner(
  /* in */ struct bHYPRE_HGMRES__object* self /* TLD */,
...
static void bHYPRE_HGMRES__init_remote_epv(void)
{
  ...
  epv->f_GetPreconditioner             = remote_bHYPRE_HGMRES_GetPreconditioner;
  epv->f_Clone                         = remote_bHYPRE_HGMRES_Clone;
