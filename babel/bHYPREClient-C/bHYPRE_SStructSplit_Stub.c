...
#else
  _externals = (struct bHYPRE_SStructSplit__external*)sidl_dynamicLoadIOR(
...
bHYPRE_SStructSplit__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_SStructSplit__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
bHYPRE_SStructSplit__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_SStructSplit__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct bHYPRE_SStructSplit__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct bHYPRE_SStructSplit__array*)sidl_interface__array_create1dInit(
...
{
  return (struct bHYPRE_SStructSplit__array*)sidl_interface__array_create2dCol(
    m, n);
}
...
{
  return (struct bHYPRE_SStructSplit__array*)sidl_interface__array_create2dRow(
    m, n);
}
