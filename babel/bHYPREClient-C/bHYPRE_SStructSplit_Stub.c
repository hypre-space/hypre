...
bHYPRE_SStructSplit
bHYPRE_SStructSplit__create()
{
  return (*(_getExternals()->createObject))();
}

static bHYPRE_SStructSplit bHYPRE_SStructSplit__remote(const char* url,
...
{
  return bHYPRE_SStructSplit__remote(url, _ex);
}

static struct bHYPRE_SStructSplit__object* 
  bHYPRE_SStructSplit__remoteConnect(const char* url, sidl_BaseInterface *_ex);
static struct bHYPRE_SStructSplit__object* 
...
{
  return bHYPRE_SStructSplit__remoteConnect(url, _ex);
}
...
void
bHYPRE_SStructSplit_Create__sexec(
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  bHYPRE_MPICommunicator mpi_comm;
  bHYPRE_Operator A;
  bHYPRE_SStructSplit _retval;
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.SStructSplit",
      (void*)bHYPRE_SStructSplit__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
struct bHYPRE_SStructSplit__smethod {
  const char *d_name;
...
bHYPRE_SStructSplit__sexec(
        ...
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs ) { 
  static const struct bHYPRE_SStructSplit__smethod s_methods[] = {
    { "Create", bHYPRE_SStructSplit_Create__sexec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_SStructSplit__smethod);
  if (methodName) {
...
const char* name)
{
  ...
  else if(bHYPRE_SStructSplit_isType(self, name)) {
...
remote_bHYPRE_SStructSplit_addRef(
  /* in */ struct bHYPRE_SStructSplit__object* self /* TLD */)
{
...
remote_bHYPRE_SStructSplit_queryInt(
  /* in */ struct bHYPRE_SStructSplit__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void bHYPRE_SStructSplit__init_remote_epv(void)
{
  ...
  epv->f_queryInt                      = remote_bHYPRE_SStructSplit_queryInt;
...
static struct bHYPRE_SStructSplit__object*
bHYPRE_SStructSplit__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct bHYPRE_SStructSplit__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.SStructSplit", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_SStructSplit__object*) malloc(
      sizeof(struct bHYPRE_SStructSplit__object));
