...
static struct bHYPRE_StructPFMG__epv s_new__bhypre_structpfmg;
static struct bHYPRE_StructPFMG__epv s_rem__bhypre_structpfmg;
...
static void bHYPRE_StructPFMG__init_epv(
  struct bHYPRE_StructPFMG__object* self)
{
  struct bHYPRE_StructPFMG__object* s0 = self;
  struct sidl_BaseClass__object*    s1 = &s0->d_sidl_baseclass;

  struct bHYPRE_StructPFMG__epv*  epv = &s_new__bhypre_structpfmg;
  ...
  epv->f_addRef                   = (void (*)(struct 
    bHYPRE_StructPFMG__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                = (void (*)(struct 
    bHYPRE_StructPFMG__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct 
    bHYPRE_StructPFMG__object*,
    struct sidl_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                 = (struct sidl_BaseInterface__object* 
    (*)(struct bHYPRE_StructPFMG__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                   = (sidl_bool (*)(struct 
    bHYPRE_StructPFMG__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    bHYPRE_StructPFMG__object*)) s1->d_epv->f_getClassInfo;
...
initClassInfo(sidl_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.StructPFMG");
...
static void
initMetadata(struct bHYPRE_StructPFMG__object* self)
{
  if (self) {
  ...
  struct bHYPRE_StructPFMG__object* self)
{
  ...
  if (!s_method_initialized) {
    bHYPRE_StructPFMG__init_epv(s0);
  }
  ...
  s0->d_epv                   = &s_new__bhypre_structpfmg;
...
{
  struct bHYPRE_StructPFMG__epv*  epv = &s_rem__bhypre_structpfmg;
  ...
  epv->f_SetCommunicator          = remote_bHYPRE_StructPFMG_SetCommunicator;
  epv->f_SetIntParameter          = remote_bHYPRE_StructPFMG_SetIntParameter;
  epv->f_SetDoubleParameter       = remote_bHYPRE_StructPFMG_SetDoubleParameter;
  epv->f_SetStringParameter       = remote_bHYPRE_StructPFMG_SetStringParameter;
  ...
  epv->f_GetDoubleValue           = remote_bHYPRE_StructPFMG_GetDoubleValue;
  ...
  epv->f_SetMaxIterations         = remote_bHYPRE_StructPFMG_SetMaxIterations;
  epv->f_SetLogging               = remote_bHYPRE_StructPFMG_SetLogging;
  epv->f_SetPrintLevel            = remote_bHYPRE_StructPFMG_SetPrintLevel;
  epv->f_GetNumIterations         = remote_bHYPRE_StructPFMG_GetNumIterations;
  epv->f_GetRelResidualNorm       = remote_bHYPRE_StructPFMG_GetRelResidualNorm;
...
bHYPRE_StructPFMG__remote(const char *url)
{
  ...
  s0->d_epv  = &s_rem__bhypre_structpfmg;
