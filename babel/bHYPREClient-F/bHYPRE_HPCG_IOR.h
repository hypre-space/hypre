...
char* skel_bHYPRE_HPCG_fgetURL_bHYPRE_Solver(struct bHYPRE_Solver__object* 
  obj); 
...
struct bHYPRE_Vector__object* skel_bHYPRE_HPCG_fconnect_bHYPRE_Vector(char* url,
  struct sidl_BaseInterface__object **_ex);
char* skel_bHYPRE_HPCG_fgetURL_bHYPRE_Vector(struct bHYPRE_Vector__object* 
  obj); 
