...
static int32_t
remote_bHYPRE_SStructParCSRMatrix_SetIntArrayParameter(
  struct bHYPRE_SStructParCSRMatrix__object* self,
  const char* name,
...
static int32_t
remote_bHYPRE_SStructParCSRMatrix_SetDoubleArrayParameter(
  struct bHYPRE_SStructParCSRMatrix__object* self,
  const char* name,
...
static void bHYPRE_SStructParCSRMatrix__init_remote_epv(void)
{
  ...
  epv->f_Initialize              = remote_bHYPRE_SStructParCSRMatrix_Initialize;
  ...
  epv->f_SetNSSymmetric          = 
    remote_bHYPRE_SStructParCSRMatrix_SetNSSymmetric;
  epv->f_SetComplex              = remote_bHYPRE_SStructParCSRMatrix_SetComplex;
