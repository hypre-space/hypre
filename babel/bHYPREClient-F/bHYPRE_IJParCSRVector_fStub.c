...
#else
    _ior = (struct bHYPRE_IJParCSRVector__external*)sidl_dynamicLoadIOR(
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__createremote_f,BHYPRE_IJPARCSRVECTOR__CREATEREMOTE_F,bHYPRE_IJParCSRVector__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__wrapobj_f,BHYPRE_IJPARCSRVECTOR__WRAPOBJ_F,bHYPRE_IJParCSRVector__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__connect_f,BHYPRE_IJPARCSRVECTOR__CONNECT_F,bHYPRE_IJParCSRVector__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__exec_f,BHYPRE_IJPARCSRVECTOR__EXEC_F,bHYPRE_IJParCSRVector__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__geturl_f,BHYPRE_IJPARCSRVECTOR__GETURL_F,bHYPRE_IJParCSRVector__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__isremote_f,BHYPRE_IJPARCSRVECTOR__ISREMOTE_F,bHYPRE_IJParCSRVector__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__islocal_f,BHYPRE_IJPARCSRVECTOR__ISLOCAL_F,bHYPRE_IJParCSRVector__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__set_hooks_f,BHYPRE_IJPARCSRVECTOR__SET_HOOKS_F,bHYPRE_IJParCSRVector__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector__set_hooks_static_f,BHYPRE_IJPARCSRVECTOR__SET_HOOKS_STATIC_F,bHYPRE_IJParCSRVector__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
)
{
  ...
  *retval = 
  ...
  sidl__array_deleteRef((struct sidl__array*)_proxy_indices);
...
void
SIDLFortran77Symbol(bhypre_ijparcsrvector_destroy_f,BHYPRE_IJPARCSRVECTOR_DESTROY_F,bHYPRE_IJParCSRVector_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
