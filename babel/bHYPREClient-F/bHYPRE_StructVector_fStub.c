...
static struct bHYPRE_StructVector__object* bHYPRE_StructVector__remoteCreate(
  const char* url, sidl_BaseInterface *_ex);
static struct bHYPRE_StructVector__object* bHYPRE_StructVector__remoteConnect(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct bHYPRE_StructVector__object* bHYPRE_StructVector__IHConnect(
...
#else
    _ior = (struct bHYPRE_StructVector__external*)sidl_dynamicLoadIOR(
...
void
SIDLFortran77Symbol(bhypre_structvector__createremote_f,BHYPRE_STRUCTVECTOR__CREATEREMOTE_F,bHYPRE_StructVector__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_structvector__wrapobj_f,BHYPRE_STRUCTVECTOR__WRAPOBJ_F,bHYPRE_StructVector__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_structvector__connect_f,BHYPRE_STRUCTVECTOR__CONNECT_F,bHYPRE_StructVector__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_structvector__exec_f,BHYPRE_STRUCTVECTOR__EXEC_F,bHYPRE_StructVector__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structvector__geturl_f,BHYPRE_STRUCTVECTOR__GETURL_F,bHYPRE_StructVector__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structvector__isremote_f,BHYPRE_STRUCTVECTOR__ISREMOTE_F,bHYPRE_StructVector__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structvector__islocal_f,BHYPRE_STRUCTVECTOR__ISLOCAL_F,bHYPRE_StructVector__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_structvector__set_hooks_f,BHYPRE_STRUCTVECTOR__SET_HOOKS_F,bHYPRE_StructVector__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_structvector__set_hooks_static_f,BHYPRE_STRUCTVECTOR__SET_HOOKS_STATIC_F,bHYPRE_StructVector__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
#ifdef SIDL_DEBUG_REFCOUNT
  sidl__array_deleteRef((struct sidl__array*)_proxy_grid_index);
#endif /* SIDL_DEBUG_REFCOUNT */
}
...
void
SIDLFortran77Symbol(bhypre_structvector_destroy_f,BHYPRE_STRUCTVECTOR_DESTROY_F,bHYPRE_StructVector_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
