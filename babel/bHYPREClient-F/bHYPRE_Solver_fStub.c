...
void
SIDLFortran77Symbol(bhypre_solver__connect_f,BHYPRE_SOLVER__CONNECT_F,bHYPRE_Solver__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_solver__cast_f,BHYPRE_SOLVER__CAST_F,bHYPRE_Solver__cast_f)
(
  int64_t *ref,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_solver__cast2_f,BHYPRE_SOLVER__CAST2_F,bHYPRE_Solver__cast2_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_solver__exec_f,BHYPRE_SOLVER__EXEC_F,bHYPRE_Solver__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_solver__geturl_f,BHYPRE_SOLVER__GETURL_F,bHYPRE_Solver__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_solver__isremote_f,BHYPRE_SOLVER__ISREMOTE_F,bHYPRE_Solver__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_solver__islocal_f,BHYPRE_SOLVER__ISLOCAL_F,bHYPRE_Solver__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_solver__set_hooks_f,BHYPRE_SOLVER__SET_HOOKS_F,bHYPRE_Solver__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_solver_setoperator_f,BHYPRE_SOLVER_SETOPERATOR_F,bHYPRE_Solver_SetOperator_f)
(
  int64_t *self,
  int64_t *A,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_solver_settolerance_f,BHYPRE_SOLVER_SETTOLERANCE_F,bHYPRE_Solver_SetTolerance_f)
(
  int64_t *self,
  double *tolerance,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_solver_setmaxiterations_f,BHYPRE_SOLVER_SETMAXITERATIONS_F,bHYPRE_Solver_SetMaxIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_solver_setlogging_f,BHYPRE_SOLVER_SETLOGGING_F,bHYPRE_Solver_SetLogging_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_solver_setprintlevel_f,BHYPRE_SOLVER_SETPRINTLEVEL_F,bHYPRE_Solver_SetPrintLevel_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_solver_getnumiterations_f,BHYPRE_SOLVER_GETNUMITERATIONS_F,bHYPRE_Solver_GetNumIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_solver_getrelresidualnorm_f,BHYPRE_SOLVER_GETRELRESIDUALNORM_F,bHYPRE_Solver_GetRelResidualNorm_f)
(
  int64_t *self,
  double *norm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_solver_setcommunicator_f,BHYPRE_SOLVER_SETCOMMUNICATOR_F,bHYPRE_Solver_SetCommunicator_f)
(
  int64_t *self,
  int64_t *mpi_comm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_solver_destroy_f,BHYPRE_SOLVER_DESTROY_F,bHYPRE_Solver_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_solver_setintparameter_f,BHYPRE_SOLVER_SETINTPARAMETER_F,bHYPRE_Solver_SetIntParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_setdoubleparameter_f,BHYPRE_SOLVER_SETDOUBLEPARAMETER_F,bHYPRE_Solver_SetDoubleParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_setstringparameter_f,BHYPRE_SOLVER_SETSTRINGPARAMETER_F,bHYPRE_Solver_SetStringParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_setintarray1parameter_f,BHYPRE_SOLVER_SETINTARRAY1PARAMETER_F,bHYPRE_Solver_SetIntArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_setintarray2parameter_f,BHYPRE_SOLVER_SETINTARRAY2PARAMETER_F,bHYPRE_Solver_SetIntArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_setdoublearray1parameter_f,BHYPRE_SOLVER_SETDOUBLEARRAY1PARAMETER_F,bHYPRE_Solver_SetDoubleArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_setdoublearray2parameter_f,BHYPRE_SOLVER_SETDOUBLEARRAY2PARAMETER_F,bHYPRE_Solver_SetDoubleArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_getintvalue_f,BHYPRE_SOLVER_GETINTVALUE_F,bHYPRE_Solver_GetIntValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_getdoublevalue_f,BHYPRE_SOLVER_GETDOUBLEVALUE_F,bHYPRE_Solver_GetDoubleValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_setup_f,BHYPRE_SOLVER_SETUP_F,bHYPRE_Solver_Setup_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_solver_apply_f,BHYPRE_SOLVER_APPLY_F,bHYPRE_Solver_Apply_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_solver_applyadjoint_f,BHYPRE_SOLVER_APPLYADJOINT_F,bHYPRE_Solver_ApplyAdjoint_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_solver_addref_f,BHYPRE_SOLVER_ADDREF_F,bHYPRE_Solver_addRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_solver_deleteref_f,BHYPRE_SOLVER_DELETEREF_F,bHYPRE_Solver_deleteRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_solver_issame_f,BHYPRE_SOLVER_ISSAME_F,bHYPRE_Solver_isSame_f)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F77_Bool *retval,
...
void
SIDLFortran77Symbol(bhypre_solver_istype_f,BHYPRE_SOLVER_ISTYPE_F,bHYPRE_Solver_isType_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_solver_getclassinfo_f,BHYPRE_SOLVER_GETCLASSINFO_F,bHYPRE_Solver_getClassInfo_f)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_solver__array_createcol_f,
                  BHYPRE_SOLVER__ARRAY_CREATECOL_F,
                  bHYPRE_Solver__array_createCol_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_solver__array_createrow_f,
                  BHYPRE_SOLVER__ARRAY_CREATEROW_F,
                  bHYPRE_Solver__array_createRow_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_solver__array_create1d_f,
                  BHYPRE_SOLVER__ARRAY_CREATE1D_F,
                  bHYPRE_Solver__array_create1d_f)
...
void
SIDLFortran77Symbol(bhypre_solver__array_create2dcol_f,
                  BHYPRE_SOLVER__ARRAY_CREATE2DCOL_F,
                  bHYPRE_Solver__array_create2dCol_f)
...
void
SIDLFortran77Symbol(bhypre_solver__array_create2drow_f,
                  BHYPRE_SOLVER__ARRAY_CREATE2DROW_F,
                  bHYPRE_Solver__array_create2dRow_f)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran77Symbol(bhypre_solver__array_addref_f,
                  BHYPRE_SOLVER__ARRAY_ADDREF_F,
                  bHYPRE_Solver__array_addRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_solver__array_deleteref_f,
                  BHYPRE_SOLVER__ARRAY_DELETEREF_F,
                  bHYPRE_Solver__array_deleteRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_solver__array_get1_f,
                  BHYPRE_SOLVER__ARRAY_GET1_F,
                  bHYPRE_Solver__array_get1_f)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_solver__array_get2_f,
                  BHYPRE_SOLVER__ARRAY_GET2_F,
                  bHYPRE_Solver__array_get2_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_solver__array_get3_f,
                  BHYPRE_SOLVER__ARRAY_GET3_F,
                  bHYPRE_Solver__array_get3_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_solver__array_get4_f,
                  BHYPRE_SOLVER__ARRAY_GET4_F,
                  bHYPRE_Solver__array_get4_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_solver__array_get5_f,
                  BHYPRE_SOLVER__ARRAY_GET5_F,
                  bHYPRE_Solver__array_get5_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_solver__array_get6_f,
                  BHYPRE_SOLVER__ARRAY_GET6_F,
                  bHYPRE_Solver__array_get6_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_solver__array_get7_f,
                  BHYPRE_SOLVER__ARRAY_GET7_F,
                  bHYPRE_Solver__array_get7_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_solver__array_get_f,
                  BHYPRE_SOLVER__ARRAY_GET_F,
                  bHYPRE_Solver__array_get_f)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_solver__array_set1_f,
                  BHYPRE_SOLVER__ARRAY_SET1_F,
                  bHYPRE_Solver__array_set1_f)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_solver__array_set2_f,
                  BHYPRE_SOLVER__ARRAY_SET2_F,
                  bHYPRE_Solver__array_set2_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_solver__array_set3_f,
                  BHYPRE_SOLVER__ARRAY_SET3_F,
                  bHYPRE_Solver__array_set3_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_solver__array_set4_f,
                  BHYPRE_SOLVER__ARRAY_SET4_F,
                  bHYPRE_Solver__array_set4_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_solver__array_set5_f,
                  BHYPRE_SOLVER__ARRAY_SET5_F,
                  bHYPRE_Solver__array_set5_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_solver__array_set6_f,
                  BHYPRE_SOLVER__ARRAY_SET6_F,
                  bHYPRE_Solver__array_set6_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_solver__array_set7_f,
                  BHYPRE_SOLVER__ARRAY_SET7_F,
                  bHYPRE_Solver__array_set7_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_solver__array_set_f,
                  BHYPRE_SOLVER__ARRAY_SET_F,
                  bHYPRE_Solver__array_set_f)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_solver__array_dimen_f,
                  BHYPRE_SOLVER__ARRAY_DIMEN_F,
                  bHYPRE_Solver__array_dimen_f)
...
void
SIDLFortran77Symbol(bhypre_solver__array_lower_f,
                  BHYPRE_SOLVER__ARRAY_LOWER_F,
                  bHYPRE_Solver__array_lower_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_solver__array_upper_f,
                  BHYPRE_SOLVER__ARRAY_UPPER_F,
                  bHYPRE_Solver__array_upper_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_solver__array_length_f,
                  BHYPRE_SOLVER__ARRAY_LENGTH_F,
                  bHYPRE_Solver__array_length_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_solver__array_stride_f,
                  BHYPRE_SOLVER__ARRAY_STRIDE_F,
                  bHYPRE_Solver__array_stride_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_solver__array_iscolumnorder_f,
                  BHYPRE_SOLVER__ARRAY_ISCOLUMNORDER_F,
                  bHYPRE_Solver__array_isColumnOrder_f)
  (int64_t *array,
...
void
SIDLFortran77Symbol(bhypre_solver__array_isroworder_f,
                  BHYPRE_SOLVER__ARRAY_ISROWORDER_F,
                  bHYPRE_Solver__array_isRowOrder_f)
  (int64_t *array,
   SIDL_F77_Bool *result)
{
...
void
SIDLFortran77Symbol(bhypre_solver__array_copy_f,
                  BHYPRE_SOLVER__ARRAY_COPY_F,
                  bHYPRE_Solver__array_copy_f)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran77Symbol(bhypre_solver__array_smartcopy_f,
                  BHYPRE_SOLVER__ARRAY_SMARTCOPY_F,
                  bHYPRE_Solver__array_smartCopy_f)
  (int64_t *src)
{
...
void
SIDLFortran77Symbol(bhypre_solver__array_slice_f,
                  BHYPRE_SOLVER__ARRAY_SLICE_F,
                  bHYPRE_Solver__array_slice_f)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
...
void
SIDLFortran77Symbol(bhypre_solver__array_ensure_f,
                  BHYPRE_SOLVER__ARRAY_ENSURE_F,
                  bHYPRE_Solver__array_ensure_f)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
...
bHYPRE_Solver__remoteConnect(const char *url, sidl_bool ar, sidl_BaseInterface 
  *_ex)
{
  struct bHYPRE__Solver__object* self;
