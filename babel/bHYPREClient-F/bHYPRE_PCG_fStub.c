...
void
SIDLFortran77Symbol(bhypre_pcg__create_f,BHYPRE_PCG__CREATE_F,bHYPRE_PCG__create_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_pcg__createremote_f,BHYPRE_PCG__CREATEREMOTE_F,bHYPRE_PCG__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_pcg__wrapobj_f,BHYPRE_PCG__WRAPOBJ_F,bHYPRE_PCG__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_pcg__connect_f,BHYPRE_PCG__CONNECT_F,bHYPRE_PCG__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_pcg__exec_f,BHYPRE_PCG__EXEC_F,bHYPRE_PCG__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_pcg__geturl_f,BHYPRE_PCG__GETURL_F,bHYPRE_PCG__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_pcg__isremote_f,BHYPRE_PCG__ISREMOTE_F,bHYPRE_PCG__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_pcg__islocal_f,BHYPRE_PCG__ISLOCAL_F,bHYPRE_PCG__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_pcg__set_hooks_f,BHYPRE_PCG__SET_HOOKS_F,bHYPRE_PCG__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_pcg__set_hooks_static_f,BHYPRE_PCG__SET_HOOKS_STATIC_F,bHYPRE_PCG__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_pcg_addref_f,BHYPRE_PCG_ADDREF_F,bHYPRE_PCG_addRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_pcg_deleteref_f,BHYPRE_PCG_DELETEREF_F,bHYPRE_PCG_deleteRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_pcg_issame_f,BHYPRE_PCG_ISSAME_F,bHYPRE_PCG_isSame_f)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F77_Bool *retval,
...
void
SIDLFortran77Symbol(bhypre_pcg_istype_f,BHYPRE_PCG_ISTYPE_F,bHYPRE_PCG_isType_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_getclassinfo_f,BHYPRE_PCG_GETCLASSINFO_F,bHYPRE_PCG_getClassInfo_f)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_pcg_setpreconditioner_f,BHYPRE_PCG_SETPRECONDITIONER_F,bHYPRE_PCG_SetPreconditioner_f)
(
  int64_t *self,
  int64_t *s,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_pcg_setoperator_f,BHYPRE_PCG_SETOPERATOR_F,bHYPRE_PCG_SetOperator_f)
(
  int64_t *self,
  int64_t *A,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_pcg_settolerance_f,BHYPRE_PCG_SETTOLERANCE_F,bHYPRE_PCG_SetTolerance_f)
(
  int64_t *self,
  double *tolerance,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_pcg_setmaxiterations_f,BHYPRE_PCG_SETMAXITERATIONS_F,bHYPRE_PCG_SetMaxIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_pcg_setlogging_f,BHYPRE_PCG_SETLOGGING_F,bHYPRE_PCG_SetLogging_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_pcg_setprintlevel_f,BHYPRE_PCG_SETPRINTLEVEL_F,bHYPRE_PCG_SetPrintLevel_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_pcg_getnumiterations_f,BHYPRE_PCG_GETNUMITERATIONS_F,bHYPRE_PCG_GetNumIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_pcg_getrelresidualnorm_f,BHYPRE_PCG_GETRELRESIDUALNORM_F,bHYPRE_PCG_GetRelResidualNorm_f)
(
  int64_t *self,
  double *norm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_pcg_setcommunicator_f,BHYPRE_PCG_SETCOMMUNICATOR_F,bHYPRE_PCG_SetCommunicator_f)
(
  int64_t *self,
  int64_t *mpi_comm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_pcg_setintparameter_f,BHYPRE_PCG_SETINTPARAMETER_F,bHYPRE_PCG_SetIntParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_setdoubleparameter_f,BHYPRE_PCG_SETDOUBLEPARAMETER_F,bHYPRE_PCG_SetDoubleParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_setstringparameter_f,BHYPRE_PCG_SETSTRINGPARAMETER_F,bHYPRE_PCG_SetStringParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_setintarray1parameter_f,BHYPRE_PCG_SETINTARRAY1PARAMETER_F,bHYPRE_PCG_SetIntArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_setintarray2parameter_f,BHYPRE_PCG_SETINTARRAY2PARAMETER_F,bHYPRE_PCG_SetIntArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_setdoublearray1parameter_f,BHYPRE_PCG_SETDOUBLEARRAY1PARAMETER_F,bHYPRE_PCG_SetDoubleArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_setdoublearray2parameter_f,BHYPRE_PCG_SETDOUBLEARRAY2PARAMETER_F,bHYPRE_PCG_SetDoubleArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_getintvalue_f,BHYPRE_PCG_GETINTVALUE_F,bHYPRE_PCG_GetIntValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_getdoublevalue_f,BHYPRE_PCG_GETDOUBLEVALUE_F,bHYPRE_PCG_GetDoubleValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_pcg_setup_f,BHYPRE_PCG_SETUP_F,bHYPRE_PCG_Setup_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_pcg_apply_f,BHYPRE_PCG_APPLY_F,bHYPRE_PCG_Apply_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_pcg_applyadjoint_f,BHYPRE_PCG_APPLYADJOINT_F,bHYPRE_PCG_ApplyAdjoint_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_pcg__array_createcol_f,
                  BHYPRE_PCG__ARRAY_CREATECOL_F,
                  bHYPRE_PCG__array_createCol_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_pcg__array_createrow_f,
                  BHYPRE_PCG__ARRAY_CREATEROW_F,
                  bHYPRE_PCG__array_createRow_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_pcg__array_create1d_f,
                  BHYPRE_PCG__ARRAY_CREATE1D_F,
                  bHYPRE_PCG__array_create1d_f)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_create2dcol_f,
                  BHYPRE_PCG__ARRAY_CREATE2DCOL_F,
                  bHYPRE_PCG__array_create2dCol_f)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_create2drow_f,
                  BHYPRE_PCG__ARRAY_CREATE2DROW_F,
                  bHYPRE_PCG__array_create2dRow_f)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran77Symbol(bhypre_pcg__array_addref_f,
                  BHYPRE_PCG__ARRAY_ADDREF_F,
                  bHYPRE_PCG__array_addRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_pcg__array_deleteref_f,
                  BHYPRE_PCG__ARRAY_DELETEREF_F,
                  bHYPRE_PCG__array_deleteRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_pcg__array_get1_f,
                  BHYPRE_PCG__ARRAY_GET1_F,
                  bHYPRE_PCG__array_get1_f)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_get2_f,
                  BHYPRE_PCG__ARRAY_GET2_F,
                  bHYPRE_PCG__array_get2_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_pcg__array_get3_f,
                  BHYPRE_PCG__ARRAY_GET3_F,
                  bHYPRE_PCG__array_get3_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_pcg__array_get4_f,
                  BHYPRE_PCG__ARRAY_GET4_F,
                  bHYPRE_PCG__array_get4_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_pcg__array_get5_f,
                  BHYPRE_PCG__ARRAY_GET5_F,
                  bHYPRE_PCG__array_get5_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_pcg__array_get6_f,
                  BHYPRE_PCG__ARRAY_GET6_F,
                  bHYPRE_PCG__array_get6_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_pcg__array_get7_f,
                  BHYPRE_PCG__ARRAY_GET7_F,
                  bHYPRE_PCG__array_get7_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_pcg__array_get_f,
                  BHYPRE_PCG__ARRAY_GET_F,
                  bHYPRE_PCG__array_get_f)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_set1_f,
                  BHYPRE_PCG__ARRAY_SET1_F,
                  bHYPRE_PCG__array_set1_f)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_set2_f,
                  BHYPRE_PCG__ARRAY_SET2_F,
                  bHYPRE_PCG__array_set2_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_pcg__array_set3_f,
                  BHYPRE_PCG__ARRAY_SET3_F,
                  bHYPRE_PCG__array_set3_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_pcg__array_set4_f,
                  BHYPRE_PCG__ARRAY_SET4_F,
                  bHYPRE_PCG__array_set4_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_pcg__array_set5_f,
                  BHYPRE_PCG__ARRAY_SET5_F,
                  bHYPRE_PCG__array_set5_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_pcg__array_set6_f,
                  BHYPRE_PCG__ARRAY_SET6_F,
                  bHYPRE_PCG__array_set6_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_pcg__array_set7_f,
                  BHYPRE_PCG__ARRAY_SET7_F,
                  bHYPRE_PCG__array_set7_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_pcg__array_set_f,
                  BHYPRE_PCG__ARRAY_SET_F,
                  bHYPRE_PCG__array_set_f)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_dimen_f,
                  BHYPRE_PCG__ARRAY_DIMEN_F,
                  bHYPRE_PCG__array_dimen_f)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_lower_f,
                  BHYPRE_PCG__ARRAY_LOWER_F,
                  bHYPRE_PCG__array_lower_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_upper_f,
                  BHYPRE_PCG__ARRAY_UPPER_F,
                  bHYPRE_PCG__array_upper_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_length_f,
                  BHYPRE_PCG__ARRAY_LENGTH_F,
                  bHYPRE_PCG__array_length_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_stride_f,
                  BHYPRE_PCG__ARRAY_STRIDE_F,
                  bHYPRE_PCG__array_stride_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_pcg__array_iscolumnorder_f,
                  BHYPRE_PCG__ARRAY_ISCOLUMNORDER_F,
                  bHYPRE_PCG__array_isColumnOrder_f)
  (int64_t *array,
...
void
SIDLFortran77Symbol(bhypre_pcg__array_isroworder_f,
                  BHYPRE_PCG__ARRAY_ISROWORDER_F,
                  bHYPRE_PCG__array_isRowOrder_f)
  (int64_t *array,
   SIDL_F77_Bool *result)
{
...
void
SIDLFortran77Symbol(bhypre_pcg__array_copy_f,
                  BHYPRE_PCG__ARRAY_COPY_F,
                  bHYPRE_PCG__array_copy_f)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran77Symbol(bhypre_pcg__array_smartcopy_f,
                  BHYPRE_PCG__ARRAY_SMARTCOPY_F,
                  bHYPRE_PCG__array_smartCopy_f)
  (int64_t *src)
{
...
void
SIDLFortran77Symbol(bhypre_pcg__array_ensure_f,
                  BHYPRE_PCG__ARRAY_ENSURE_F,
                  bHYPRE_PCG__array_ensure_f)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
