...
static int32_t
remote_bHYPRE_PCG_SetIntArrayParameter(
  struct bHYPRE_PCG__object* self,
  const char* name,
...
static int32_t
remote_bHYPRE_PCG_SetDoubleArrayParameter(
  struct bHYPRE_PCG__object* self,
  const char* name,
...
static void bHYPRE_PCG__init_remote_epv(void)
{
  ...
  epv->f_SetIntArrayParameter    = remote_bHYPRE_PCG_SetIntArrayParameter;
  epv->f_SetDoubleArrayParameter = remote_bHYPRE_PCG_SetDoubleArrayParameter;
