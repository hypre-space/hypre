...
static struct bHYPRE_SStructVector__object* bHYPRE_SStructVector__remoteCreate(
  const char* url, sidl_BaseInterface *_ex);
static struct bHYPRE_SStructVector__object* bHYPRE_SStructVector__remoteConnect(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct bHYPRE_SStructVector__object* bHYPRE_SStructVector__IHConnect(
...
#else
    _ior = (struct bHYPRE_SStructVector__external*)sidl_dynamicLoadIOR(
...
void
SIDLFortran77Symbol(bhypre_sstructvector__createremote_f,BHYPRE_SSTRUCTVECTOR__CREATEREMOTE_F,bHYPRE_SStructVector__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_sstructvector__wrapobj_f,BHYPRE_SSTRUCTVECTOR__WRAPOBJ_F,bHYPRE_SStructVector__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_sstructvector__connect_f,BHYPRE_SSTRUCTVECTOR__CONNECT_F,bHYPRE_SStructVector__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_sstructvector__exec_f,BHYPRE_SSTRUCTVECTOR__EXEC_F,bHYPRE_SStructVector__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructvector__geturl_f,BHYPRE_SSTRUCTVECTOR__GETURL_F,bHYPRE_SStructVector__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructvector__isremote_f,BHYPRE_SSTRUCTVECTOR__ISREMOTE_F,bHYPRE_SStructVector__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructvector__islocal_f,BHYPRE_SSTRUCTVECTOR__ISLOCAL_F,bHYPRE_SStructVector__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_sstructvector__set_hooks_f,BHYPRE_SSTRUCTVECTOR__SET_HOOKS_F,bHYPRE_SStructVector__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_sstructvector__set_hooks_static_f,BHYPRE_SSTRUCTVECTOR__SET_HOOKS_STATIC_F,bHYPRE_SStructVector__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_sstructvector_destroy_f,BHYPRE_SSTRUCTVECTOR_DESTROY_F,bHYPRE_SStructVector_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
