...
static struct bHYPRE_IdentitySolver__epv s_new__bhypre_identitysolver;
static struct bHYPRE_IdentitySolver__epv s_rem__bhypre_identitysolver;
...
static void ior_bHYPRE_IdentitySolver__delete(
  struct bHYPRE_IdentitySolver__object* self)
{
  bHYPRE_IdentitySolver__fini(self);
...
static void bHYPRE_IdentitySolver__init_epv(
  struct bHYPRE_IdentitySolver__object* self)
{
  struct bHYPRE_IdentitySolver__object* s0 = self;
  struct sidl_BaseClass__object*        s1 = &s0->d_sidl_baseclass;

  struct bHYPRE_IdentitySolver__epv* epv = &s_new__bhypre_identitysolver;
  ...
  epv->f_addRef                   = (void (*)(struct 
    bHYPRE_IdentitySolver__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                = (void (*)(struct 
    bHYPRE_IdentitySolver__object*)) s1->d_epv->f_deleteRef;
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    bHYPRE_IdentitySolver__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    bHYPRE_IdentitySolver__object*)) s1->d_epv->f_getClassInfo;
...
initClassInfo(sidl_ClassInfo *info)
{
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.IdentitySolver");
...
static void
initMetadata(struct bHYPRE_IdentitySolver__object* self)
{
  if (self) {
...
bHYPRE_IdentitySolver__new(void)
{
  ...
  bHYPRE_IdentitySolver__init(self);
  initMetadata(self);
  return self;
}
  ...
  struct bHYPRE_IdentitySolver__object* self)
{
  ...
  if (!s_method_initialized) {
    bHYPRE_IdentitySolver__init_epv(s0);
  }
  ...
  s0->d_epv                   = &s_new__bhypre_identitysolver;
...
{
  struct bHYPRE_IdentitySolver__epv* epv = &s_rem__bhypre_identitysolver;
  ...
  epv->f_getClassInfo             = remote_bHYPRE_IdentitySolver_getClassInfo;
  ...
  epv->f_SetDoubleArray2Parameter = 
    remote_bHYPRE_IdentitySolver_SetDoubleArray2Parameter;
  epv->f_GetIntValue              = remote_bHYPRE_IdentitySolver_GetIntValue;
  epv->f_GetDoubleValue           = remote_bHYPRE_IdentitySolver_GetDoubleValue;
  epv->f_Setup                    = remote_bHYPRE_IdentitySolver_Setup;
  epv->f_Apply                    = remote_bHYPRE_IdentitySolver_Apply;
  epv->f_SetOperator              = remote_bHYPRE_IdentitySolver_SetOperator;
  epv->f_SetTolerance             = remote_bHYPRE_IdentitySolver_SetTolerance;
  epv->f_SetMaxIterations         = 
    remote_bHYPRE_IdentitySolver_SetMaxIterations;
  epv->f_SetLogging               = remote_bHYPRE_IdentitySolver_SetLogging;
  epv->f_SetPrintLevel            = remote_bHYPRE_IdentitySolver_SetPrintLevel;
...
bHYPRE_IdentitySolver__remote(const char *url)
{
  ...
  s0->d_epv  = &s_rem__bhypre_identitysolver;
