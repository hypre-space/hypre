...
static struct bHYPRE_MPICommunicator__object* 
  bHYPRE_MPICommunicator__remoteCreate(const char* url, sidl_BaseInterface 
  *_ex);
static struct bHYPRE_MPICommunicator__object* 
...
#else
    _ior = (struct bHYPRE_MPICommunicator__external*)sidl_dynamicLoadIOR(
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__createremote_f,BHYPRE_MPICOMMUNICATOR__CREATEREMOTE_F,bHYPRE_MPICommunicator__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__wrapobj_f,BHYPRE_MPICOMMUNICATOR__WRAPOBJ_F,bHYPRE_MPICommunicator__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__connect_f,BHYPRE_MPICOMMUNICATOR__CONNECT_F,bHYPRE_MPICommunicator__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__exec_f,BHYPRE_MPICOMMUNICATOR__EXEC_F,bHYPRE_MPICommunicator__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__geturl_f,BHYPRE_MPICOMMUNICATOR__GETURL_F,bHYPRE_MPICommunicator__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__isremote_f,BHYPRE_MPICOMMUNICATOR__ISREMOTE_F,bHYPRE_MPICommunicator__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__islocal_f,BHYPRE_MPICOMMUNICATOR__ISLOCAL_F,bHYPRE_MPICommunicator__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__set_hooks_f,BHYPRE_MPICOMMUNICATOR__SET_HOOKS_F,bHYPRE_MPICommunicator__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator__set_hooks_static_f,BHYPRE_MPICOMMUNICATOR__SET_HOOKS_STATIC_F,bHYPRE_MPICommunicator__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator_create_mpicommworld_f,BHYPRE_MPICOMMUNICATOR_CREATE_MPICOMMWORLD_F,bHYPRE_MPICommunicator_Create_MPICommWorld_f)
(
  int64_t *retval,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator_destroy_f,BHYPRE_MPICOMMUNICATOR_DESTROY_F,bHYPRE_MPICommunicator_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator_init_f,BHYPRE_MPICOMMUNICATOR_INIT_F,bHYPRE_MPICommunicator_Init_f)
(
  int64_t *exception
)
{
...
void
SIDLFortran77Symbol(bhypre_mpicommunicator_finalize_f,BHYPRE_MPICOMMUNICATOR_FINALIZE_F,bHYPRE_MPICommunicator_Finalize_f)
(
  int64_t *exception
)
{
