...
static struct bHYPRE_ParCSRDiagScale__object* 
  bHYPRE_ParCSRDiagScale__remoteCreate(const char* url, sidl_BaseInterface 
  *_ex);
static struct bHYPRE_ParCSRDiagScale__object* 
...
#else
    _ior = (struct bHYPRE_ParCSRDiagScale__external*)sidl_dynamicLoadIOR(
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__createremote_f,BHYPRE_PARCSRDIAGSCALE__CREATEREMOTE_F,bHYPRE_ParCSRDiagScale__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__wrapobj_f,BHYPRE_PARCSRDIAGSCALE__WRAPOBJ_F,bHYPRE_ParCSRDiagScale__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__connect_f,BHYPRE_PARCSRDIAGSCALE__CONNECT_F,bHYPRE_ParCSRDiagScale__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__exec_f,BHYPRE_PARCSRDIAGSCALE__EXEC_F,bHYPRE_ParCSRDiagScale__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__geturl_f,BHYPRE_PARCSRDIAGSCALE__GETURL_F,bHYPRE_ParCSRDiagScale__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__isremote_f,BHYPRE_PARCSRDIAGSCALE__ISREMOTE_F,bHYPRE_ParCSRDiagScale__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__islocal_f,BHYPRE_PARCSRDIAGSCALE__ISLOCAL_F,bHYPRE_ParCSRDiagScale__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__set_hooks_f,BHYPRE_PARCSRDIAGSCALE__SET_HOOKS_F,bHYPRE_ParCSRDiagScale__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale__set_hooks_static_f,BHYPRE_PARCSRDIAGSCALE__SET_HOOKS_STATIC_F,bHYPRE_ParCSRDiagScale__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_parcsrdiagscale_destroy_f,BHYPRE_PARCSRDIAGSCALE_DESTROY_F,bHYPRE_ParCSRDiagScale_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
