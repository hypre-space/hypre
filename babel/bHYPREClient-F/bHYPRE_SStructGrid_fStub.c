...
static struct bHYPRE_SStructGrid__object* bHYPRE_SStructGrid__remoteCreate(
  const char* url, sidl_BaseInterface *_ex);
static struct bHYPRE_SStructGrid__object* bHYPRE_SStructGrid__remoteConnect(
...
#else
    _ior = (struct bHYPRE_SStructGrid__external*)sidl_dynamicLoadIOR(
...
)
{
  ...
  *retval = 
  ...
  sidl__array_deleteRef((struct sidl__array*)_proxy_ilower);
  sidl__array_deleteRef((struct sidl__array*)_proxy_iupper);
  sidl__array_deleteRef((struct sidl__array*)_proxy_nbor_ilower);
  sidl__array_deleteRef((struct sidl__array*)_proxy_nbor_iupper);
  sidl__array_deleteRef((struct sidl__array*)_proxy_index_map);
#endif /* SIDL_DEBUG_REFCOUNT */
}
