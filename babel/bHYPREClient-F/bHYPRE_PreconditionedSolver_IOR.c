...
static int32_t
remote_bHYPRE_PreconditionedSolver_SetIntArrayParameter(
  void* self,
  const char* name,
...
static int32_t
remote_bHYPRE_PreconditionedSolver_SetDoubleArrayParameter(
  void* self,
  const char* name,
...
static void bHYPRE_PreconditionedSolver__init_remote_epv(void)
{
  ...
  epv->f_deleteRef               = remote_bHYPRE_PreconditionedSolver_deleteRef;
