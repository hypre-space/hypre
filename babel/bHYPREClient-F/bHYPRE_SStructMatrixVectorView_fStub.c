...
void
SIDLFortran77Symbol(bhypre_sstructmatrixvectorview__connect_f,BHYPRE_SSTRUCTMATRIXVECTORVIEW__CONNECT_F,bHYPRE_SStructMatrixVectorView__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
...
)
{
  ...
  _proxy_self = bHYPRE_SStructMatrixVectorView__remoteConnect(_proxy_url, 1,
    &_proxy_exception);
  if (_proxy_exception) {
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.SStructMatrixVectorView",
      (void*)bHYPRE_SStructMatrixVectorView__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "bHYPRE.SStructMatrixVectorView", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran77Symbol(bhypre_sstructmatrixvectorview__exec_f,BHYPRE_SSTRUCTMATRIXVECTORVIEW__EXEC_F,bHYPRE_SStructMatrixVectorView__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructmatrixvectorview__geturl_f,BHYPRE_SSTRUCTMATRIXVECTORVIEW__GETURL_F,bHYPRE_SStructMatrixVectorView__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructmatrixvectorview__isremote_f,BHYPRE_SSTRUCTMATRIXVECTORVIEW__ISREMOTE_F,bHYPRE_SStructMatrixVectorView__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructmatrixvectorview__islocal_f,BHYPRE_SSTRUCTMATRIXVECTORVIEW__ISLOCAL_F,bHYPRE_SStructMatrixVectorView__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_sstructmatrixvectorview__set_hooks_f,BHYPRE_SSTRUCTMATRIXVECTORVIEW__SET_HOOKS_F,bHYPRE_SStructMatrixVectorView__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
