/*
 * File:          bHYPRE_StructDiagScale_fStub.h
 * Symbol:        bHYPRE.StructDiagScale-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side documentation text for bHYPRE.StructDiagScale
 * 
...
#define included_bHYPRE_StructDiagScale_fStub_h
