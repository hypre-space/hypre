...
void
SIDLFortran77Symbol(bhypre_operator_setintarrayparameter_f,BHYPRE_OPERATOR_SETINTARRAYPARAMETER_F,bHYPRE_Operator_SetIntArrayParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_operator_setdoublearrayparameter_f,BHYPRE_OPERATOR_SETDOUBLEARRAYPARAMETER_F,bHYPRE_Operator_SetDoubleArrayParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
