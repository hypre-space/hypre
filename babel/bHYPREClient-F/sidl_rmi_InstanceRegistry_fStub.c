 ...
 * 
 * babel-version = 0.10.10
 * xml-url       = /home/painter/babel/share/babel-0.10.10/repository/sidl.rmi.InstanceRegistry-v0.9.3.xml
 */
...
void
SIDLFortran77Symbol(sidl_rmi_instanceregistry_queryint_f,SIDL_RMI_INSTANCEREGISTRY_QUERYINT_F,sidl_rmi_InstanceRegistry_queryInt_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(sidl_rmi_instanceregistry_getinstance_f,SIDL_RMI_INSTANCEREGISTRY_GETINSTANCE_F,sidl_rmi_InstanceRegistry_getInstance_f)
(
...
)
{
  ...
  struct sidl_BaseInterface__object* _proxy_exception = NULL;
  _proxy_instanceID =
    sidl_copy_fortran_str(SIDL_F77_STR(instanceID),
...
void
SIDLFortran77Symbol(sidl_rmi_instanceregistry_removeinstance_f,SIDL_RMI_INSTANCEREGISTRY_REMOVEINSTANCE_F,sidl_rmi_InstanceRegistry_removeInstance_f)
(
  SIDL_F77_String instanceID
  SIDL_F77_STR_NEAR_LEN_DECL(instanceID),
  int64_t *retval,
