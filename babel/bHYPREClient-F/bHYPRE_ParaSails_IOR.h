...
struct bHYPRE_ParaSails__controls {
  int     use_hooks;
};
/*
...
bHYPRE_ParaSails__new(void* ddata,struct sidl_BaseInterface__object ** _ex);

extern struct bHYPRE_ParaSails__sepv*
bHYPRE_ParaSails__statics(void);

extern void bHYPRE_ParaSails__init(
  struct bHYPRE_ParaSails__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void bHYPRE_ParaSails__getEPVs(
  ...
  struct bHYPRE_ParaSails__epv **s_arg_epv__bhypre_parasails,
    struct bHYPRE_ParaSails__epv **s_arg_epv_hooks__bhypre_parasails);
  ...
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_ParaSails_fconnect_bHYPRE_Operator(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_ParaSails_fcast_bHYPRE_Operator(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_ParaSails__object* 
    skel_bHYPRE_ParaSails_fconnect_bHYPRE_ParaSails(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_ParaSails__object* 
    skel_bHYPRE_ParaSails_fcast_bHYPRE_ParaSails(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_Solver__object* 
    skel_bHYPRE_ParaSails_fconnect_bHYPRE_Solver(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Solver__object* skel_bHYPRE_ParaSails_fcast_bHYPRE_Solver(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_Vector__object* 
    skel_bHYPRE_ParaSails_fconnect_bHYPRE_Vector(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Vector__object* skel_bHYPRE_ParaSails_fcast_bHYPRE_Vector(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_BaseClass__object* 
    skel_bHYPRE_ParaSails_fconnect_sidl_BaseClass(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* 
    skel_bHYPRE_ParaSails_fcast_sidl_BaseClass(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct sidl_BaseInterface__object* 
    skel_bHYPRE_ParaSails_fconnect_sidl_BaseInterface(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_ParaSails_fcast_sidl_BaseInterface(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct sidl_ClassInfo__object* 
    skel_bHYPRE_ParaSails_fconnect_sidl_ClassInfo(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_bHYPRE_ParaSails_fcast_sidl_ClassInfo(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_ParaSails__remote{
    int d_refcount;
