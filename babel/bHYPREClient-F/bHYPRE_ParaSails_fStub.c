...
#include "bHYPRE_ParaSails_fStub.h"
#endif
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
...
static struct bHYPRE_ParaSails__object* bHYPRE_ParaSails__remoteCreate(const 
  char* url, sidl_BaseInterface *_ex);
static struct bHYPRE_ParaSails__object* bHYPRE_ParaSails__remoteConnect(const 
  char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct bHYPRE_ParaSails__object* bHYPRE_ParaSails__IHConnect(struct 
...
static const struct bHYPRE_ParaSails__external* _getIOR(void)
{
...
#else
    _ior = (struct 
      bHYPRE_ParaSails__external*)sidl_dynamicLoadIOR("bHYPRE.ParaSails",
      "bHYPRE_ParaSails__externals") ;
    sidl_checkIORVersion("bHYPRE.ParaSails", _ior->d_ior_major_version,
...
static const struct bHYPRE_ParaSails__sepv* _getSEPV(void)
{
  static const struct bHYPRE_ParaSails__sepv *_sepv = NULL;
  if (!_sepv) {
...
void
SIDLFortran77Symbol(bhypre_parasails__create_f,BHYPRE_PARASAILS__CREATE_F,bHYPRE_ParaSails__create_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_parasails__createremote_f,BHYPRE_PARASAILS__CREATEREMOTE_F,bHYPRE_ParaSails__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
)
{
  ...
  _proxy_self = bHYPRE_ParaSails__remoteCreate(_proxy_url, &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran77Symbol(bhypre_parasails__wrapobj_f,BHYPRE_PARASAILS__WRAPOBJ_F,bHYPRE_ParaSails__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_parasails__connect_f,BHYPRE_PARASAILS__CONNECT_F,bHYPRE_ParaSails__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
)
{
  ...
  _proxy_url =
    sidl_copy_fortran_str(SIDL_F77_STR(url),
      SIDL_F77_STR_LEN(url));
  _proxy_self = bHYPRE_ParaSails__remoteConnect(_proxy_url, 1,
    &_proxy_exception);
  if (_proxy_exception) {
    *exception = (ptrdiff_t)_proxy_exception;
  }
...
void
SIDLFortran77Symbol(bhypre_parasails__cast_f,BHYPRE_PARASAILS__CAST_F,bHYPRE_ParaSails__cast_f)
(
  int64_t *ref,
  int64_t *retval,
  int64_t *exception
)
{
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.ParaSails",
      (void*)bHYPRE_ParaSails__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "bHYPRE.ParaSails", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran77Symbol(bhypre_parasails__cast2_f,BHYPRE_PARASAILS__CAST2_F,bHYPRE_ParaSails__cast2_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parasails__exec_f,BHYPRE_PARASAILS__EXEC_F,bHYPRE_ParaSails__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parasails__geturl_f,BHYPRE_PARASAILS__GETURL_F,bHYPRE_ParaSails__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parasails__isremote_f,BHYPRE_PARASAILS__ISREMOTE_F,bHYPRE_ParaSails__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parasails__islocal_f,BHYPRE_PARASAILS__ISLOCAL_F,bHYPRE_ParaSails__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_parasails__set_hooks_f,BHYPRE_PARASAILS__SET_HOOKS_F,bHYPRE_ParaSails__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_parasails__set_hooks_static_f,BHYPRE_PARASAILS__SET_HOOKS_STATIC_F,bHYPRE_ParaSails__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
{
  const struct bHYPRE_ParaSails__sepv *_epv = _getSEPV();
  sidl_bool _proxy_on;
  struct sidl_BaseInterface__object* _proxy_exception = NULL;
  _proxy_on = ((*on == SIDL_F77_TRUE) ? TRUE : FALSE);
...
void
SIDLFortran77Symbol(bhypre_parasails_create_f,BHYPRE_PARASAILS_CREATE_F,bHYPRE_ParaSails_Create_f)
(
  int64_t *mpi_comm,
  int64_t *A,
  int64_t *retval,
...
)
{
  ...
  struct bHYPRE_ParaSails__object* _proxy_retval = NULL;
  struct sidl_BaseInterface__object* _proxy_exception = NULL;
  _proxy_mpi_comm =
...
void
SIDLFortran77Symbol(bhypre_parasails_addref_f,BHYPRE_PARASAILS_ADDREF_F,bHYPRE_ParaSails_addRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_parasails_deleteref_f,BHYPRE_PARASAILS_DELETEREF_F,bHYPRE_ParaSails_deleteRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_parasails_issame_f,BHYPRE_PARASAILS_ISSAME_F,bHYPRE_ParaSails_isSame_f)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F77_Bool *retval,
...
void
SIDLFortran77Symbol(bhypre_parasails_istype_f,BHYPRE_PARASAILS_ISTYPE_F,bHYPRE_ParaSails_isType_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_getclassinfo_f,BHYPRE_PARASAILS_GETCLASSINFO_F,bHYPRE_ParaSails_getClassInfo_f)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_parasails_setoperator_f,BHYPRE_PARASAILS_SETOPERATOR_F,bHYPRE_ParaSails_SetOperator_f)
(
  int64_t *self,
  int64_t *A,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_parasails_settolerance_f,BHYPRE_PARASAILS_SETTOLERANCE_F,bHYPRE_ParaSails_SetTolerance_f)
(
  int64_t *self,
  double *tolerance,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_parasails_setmaxiterations_f,BHYPRE_PARASAILS_SETMAXITERATIONS_F,bHYPRE_ParaSails_SetMaxIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parasails_setlogging_f,BHYPRE_PARASAILS_SETLOGGING_F,bHYPRE_ParaSails_SetLogging_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_parasails_setprintlevel_f,BHYPRE_PARASAILS_SETPRINTLEVEL_F,bHYPRE_ParaSails_SetPrintLevel_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_parasails_getnumiterations_f,BHYPRE_PARASAILS_GETNUMITERATIONS_F,bHYPRE_ParaSails_GetNumIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_parasails_getrelresidualnorm_f,BHYPRE_PARASAILS_GETRELRESIDUALNORM_F,bHYPRE_ParaSails_GetRelResidualNorm_f)
(
  int64_t *self,
  double *norm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_parasails_setcommunicator_f,BHYPRE_PARASAILS_SETCOMMUNICATOR_F,bHYPRE_ParaSails_SetCommunicator_f)
(
  int64_t *self,
  int64_t *mpi_comm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_parasails_setintparameter_f,BHYPRE_PARASAILS_SETINTPARAMETER_F,bHYPRE_ParaSails_SetIntParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_setdoubleparameter_f,BHYPRE_PARASAILS_SETDOUBLEPARAMETER_F,bHYPRE_ParaSails_SetDoubleParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_setstringparameter_f,BHYPRE_PARASAILS_SETSTRINGPARAMETER_F,bHYPRE_ParaSails_SetStringParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_setintarray1parameter_f,BHYPRE_PARASAILS_SETINTARRAY1PARAMETER_F,bHYPRE_ParaSails_SetIntArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_setintarray2parameter_f,BHYPRE_PARASAILS_SETINTARRAY2PARAMETER_F,bHYPRE_ParaSails_SetIntArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_setdoublearray1parameter_f,BHYPRE_PARASAILS_SETDOUBLEARRAY1PARAMETER_F,bHYPRE_ParaSails_SetDoubleArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_setdoublearray2parameter_f,BHYPRE_PARASAILS_SETDOUBLEARRAY2PARAMETER_F,bHYPRE_ParaSails_SetDoubleArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_getintvalue_f,BHYPRE_PARASAILS_GETINTVALUE_F,bHYPRE_ParaSails_GetIntValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_getdoublevalue_f,BHYPRE_PARASAILS_GETDOUBLEVALUE_F,bHYPRE_ParaSails_GetDoubleValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_parasails_setup_f,BHYPRE_PARASAILS_SETUP_F,bHYPRE_ParaSails_Setup_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_parasails_apply_f,BHYPRE_PARASAILS_APPLY_F,bHYPRE_ParaSails_Apply_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_parasails_applyadjoint_f,BHYPRE_PARASAILS_APPLYADJOINT_F,bHYPRE_ParaSails_ApplyAdjoint_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_parasails__array_createcol_f,
                  BHYPRE_PARASAILS__ARRAY_CREATECOL_F,
                  bHYPRE_ParaSails__array_createCol_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_parasails__array_createrow_f,
                  BHYPRE_PARASAILS__ARRAY_CREATEROW_F,
                  bHYPRE_ParaSails__array_createRow_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_parasails__array_create1d_f,
                  BHYPRE_PARASAILS__ARRAY_CREATE1D_F,
                  bHYPRE_ParaSails__array_create1d_f)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_create2dcol_f,
                  BHYPRE_PARASAILS__ARRAY_CREATE2DCOL_F,
                  bHYPRE_ParaSails__array_create2dCol_f)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_create2drow_f,
                  BHYPRE_PARASAILS__ARRAY_CREATE2DROW_F,
                  bHYPRE_ParaSails__array_create2dRow_f)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran77Symbol(bhypre_parasails__array_addref_f,
                  BHYPRE_PARASAILS__ARRAY_ADDREF_F,
                  bHYPRE_ParaSails__array_addRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_parasails__array_deleteref_f,
                  BHYPRE_PARASAILS__ARRAY_DELETEREF_F,
                  bHYPRE_ParaSails__array_deleteRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_parasails__array_get1_f,
                  BHYPRE_PARASAILS__ARRAY_GET1_F,
                  bHYPRE_ParaSails__array_get1_f)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_get2_f,
                  BHYPRE_PARASAILS__ARRAY_GET2_F,
                  bHYPRE_ParaSails__array_get2_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_parasails__array_get3_f,
                  BHYPRE_PARASAILS__ARRAY_GET3_F,
                  bHYPRE_ParaSails__array_get3_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_parasails__array_get4_f,
                  BHYPRE_PARASAILS__ARRAY_GET4_F,
                  bHYPRE_ParaSails__array_get4_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_parasails__array_get5_f,
                  BHYPRE_PARASAILS__ARRAY_GET5_F,
                  bHYPRE_ParaSails__array_get5_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_parasails__array_get6_f,
                  BHYPRE_PARASAILS__ARRAY_GET6_F,
                  bHYPRE_ParaSails__array_get6_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_parasails__array_get7_f,
                  BHYPRE_PARASAILS__ARRAY_GET7_F,
                  bHYPRE_ParaSails__array_get7_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_parasails__array_get_f,
                  BHYPRE_PARASAILS__ARRAY_GET_F,
                  bHYPRE_ParaSails__array_get_f)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_set1_f,
                  BHYPRE_PARASAILS__ARRAY_SET1_F,
                  bHYPRE_ParaSails__array_set1_f)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_set2_f,
                  BHYPRE_PARASAILS__ARRAY_SET2_F,
                  bHYPRE_ParaSails__array_set2_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_parasails__array_set3_f,
                  BHYPRE_PARASAILS__ARRAY_SET3_F,
                  bHYPRE_ParaSails__array_set3_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_parasails__array_set4_f,
                  BHYPRE_PARASAILS__ARRAY_SET4_F,
                  bHYPRE_ParaSails__array_set4_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_parasails__array_set5_f,
                  BHYPRE_PARASAILS__ARRAY_SET5_F,
                  bHYPRE_ParaSails__array_set5_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_parasails__array_set6_f,
                  BHYPRE_PARASAILS__ARRAY_SET6_F,
                  bHYPRE_ParaSails__array_set6_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_parasails__array_set7_f,
                  BHYPRE_PARASAILS__ARRAY_SET7_F,
                  bHYPRE_ParaSails__array_set7_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_parasails__array_set_f,
                  BHYPRE_PARASAILS__ARRAY_SET_F,
                  bHYPRE_ParaSails__array_set_f)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_dimen_f,
                  BHYPRE_PARASAILS__ARRAY_DIMEN_F,
                  bHYPRE_ParaSails__array_dimen_f)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_lower_f,
                  BHYPRE_PARASAILS__ARRAY_LOWER_F,
                  bHYPRE_ParaSails__array_lower_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_upper_f,
                  BHYPRE_PARASAILS__ARRAY_UPPER_F,
                  bHYPRE_ParaSails__array_upper_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_length_f,
                  BHYPRE_PARASAILS__ARRAY_LENGTH_F,
                  bHYPRE_ParaSails__array_length_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_stride_f,
                  BHYPRE_PARASAILS__ARRAY_STRIDE_F,
                  bHYPRE_ParaSails__array_stride_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_parasails__array_iscolumnorder_f,
                  BHYPRE_PARASAILS__ARRAY_ISCOLUMNORDER_F,
                  bHYPRE_ParaSails__array_isColumnOrder_f)
  (int64_t *array,
...
void
SIDLFortran77Symbol(bhypre_parasails__array_isroworder_f,
                  BHYPRE_PARASAILS__ARRAY_ISROWORDER_F,
                  bHYPRE_ParaSails__array_isRowOrder_f)
  (int64_t *array,
   SIDL_F77_Bool *result)
{
...
void
SIDLFortran77Symbol(bhypre_parasails__array_copy_f,
                  BHYPRE_PARASAILS__ARRAY_COPY_F,
                  bHYPRE_ParaSails__array_copy_f)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran77Symbol(bhypre_parasails__array_smartcopy_f,
                  BHYPRE_PARASAILS__ARRAY_SMARTCOPY_F,
                  bHYPRE_ParaSails__array_smartCopy_f)
  (int64_t *src)
{
...
void
SIDLFortran77Symbol(bhypre_parasails__array_slice_f,
                  BHYPRE_PARASAILS__ARRAY_SLICE_F,
                  bHYPRE_ParaSails__array_slice_f)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
...
void
SIDLFortran77Symbol(bhypre_parasails__array_ensure_f,
                  BHYPRE_PARASAILS__ARRAY_ENSURE_F,
                  bHYPRE_ParaSails__array_ensure_f)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t bHYPRE_ParaSails__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &bHYPRE_ParaSails__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &bHYPRE_ParaSails__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &bHYPRE_ParaSails__mutex )==EDEADLOCK) */
#else
...
static struct bHYPRE_ParaSails__epv s_rem_epv__bhypre_parasails;
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    cmp1 = strcmp(name, "bHYPRE.ParaSails");
    if (!cmp1) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = self;
      return cast;
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct bHYPRE_ParaSails__remote*)self->d_data)->d_ih,
      _ex);
  }
...
static char* remote_bHYPRE_ParaSails__getURL(
  struct bHYPRE_ParaSails__object* self, sidl_BaseInterface* _ex)
{
...
static void remote_bHYPRE_ParaSails__raddRef(
  struct bHYPRE_ParaSails__object* self,sidl_BaseInterface* _ex)
{
...
static sidl_bool
remote_bHYPRE_ParaSails__isRemote(
    struct bHYPRE_ParaSails__object* self, 
    sidl_BaseInterface *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_bHYPRE_ParaSails__set_hooks(
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails._set_hooks.", &throwaway_exception);
...
static void remote_bHYPRE_ParaSails__exec(
  struct bHYPRE_ParaSails__object* self,const char* methodName,
  ...
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    struct bHYPRE_ParaSails__remote* r_obj = (struct 
      bHYPRE_ParaSails__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.isSame.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.isType.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.getClassInfo.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetOperator.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetTolerance.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetMaxIterations.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetLogging.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetPrintLevel.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.GetNumIterations.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.GetRelResidualNorm.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetCommunicator.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetIntParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetDoubleParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetStringParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetIntArray1Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetIntArray2Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetDoubleArray1Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.SetDoubleArray2Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.GetIntValue.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.GetDoubleValue.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.Setup.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.Apply.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_ParaSails_ApplyAdjoint(
  /* in */ struct bHYPRE_ParaSails__object* self ,
  /* in */ struct bHYPRE_Vector__object* b,
  /* inout */ struct bHYPRE_Vector__object** x,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.ParaSails.ApplyAdjoint.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void bHYPRE_ParaSails__init_remote_epv(void)
{
  ...
  struct bHYPRE_ParaSails__epv*   epv = &s_rem_epv__bhypre_parasails;
  ...
  epv->f__exec                         = remote_bHYPRE_ParaSails__exec;
  epv->f__getURL                       = remote_bHYPRE_ParaSails__getURL;
  epv->f__raddRef                      = remote_bHYPRE_ParaSails__raddRef;
  epv->f__isRemote                     = remote_bHYPRE_ParaSails__isRemote;
  epv->f__set_hooks                    = remote_bHYPRE_ParaSails__set_hooks;
  epv->f__ctor                         = NULL;
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  ...
  epv->f_ApplyAdjoint                  = remote_bHYPRE_ParaSails_ApplyAdjoint;
...
static struct bHYPRE_ParaSails__object*
bHYPRE_ParaSails__remoteConnect(const char *url, sidl_bool ar,
  sidl_BaseInterface *_ex)
{
  struct bHYPRE_ParaSails__object* self;

  struct bHYPRE_ParaSails__object* s0;
  struct sidl_BaseClass__object* s1;

  struct bHYPRE_ParaSails__remote* r_obj;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    return bHYPRE_ParaSails__rmicast(bi,_ex);SIDL_CHECK(*_ex);
  }
  ...
  r_obj =
    (struct bHYPRE_ParaSails__remote*) malloc(
      sizeof(struct bHYPRE_ParaSails__remote));
  ...
  s0->d_epv  = &s_rem_epv__bhypre_parasails;
...
static struct bHYPRE_ParaSails__object*
bHYPRE_ParaSails__IHConnect(sidl_rmi_InstanceHandle instance,
  sidl_BaseInterface *_ex)
{
  struct bHYPRE_ParaSails__object* self;
...
static struct bHYPRE_ParaSails__object*
bHYPRE_ParaSails__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.ParaSails",
    _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_ParaSails__object*) malloc(
...
bHYPRE_ParaSails__rmicast(
  ...
  sidl_BaseInterface* _ex)
{
  struct bHYPRE_ParaSails__object* cast = NULL;

  *_ex = NULL;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.ParaSails",
      (void*)bHYPRE_ParaSails__IHConnect, _ex);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    struct sidl_BaseInterface__object* base = (struct 
      sidl_BaseInterface__object*) obj;
    cast = (struct bHYPRE_ParaSails__object*) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.ParaSails", _ex); SIDL_CHECK(*_ex);
  }
...
bHYPRE_ParaSails__connectI(const char* url, sidl_bool ar,
  struct sidl_BaseInterface__object **_ex)
{
  return bHYPRE_ParaSails__remoteConnect(url, ar, _ex);
}
