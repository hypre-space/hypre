...
void
SIDLFortran77Symbol(sidl_baseinterface__connect_f,SIDL_BASEINTERFACE__CONNECT_F,sidl_BaseInterface__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(sidl_baseinterface__exec_f,SIDL_BASEINTERFACE__EXEC_F,sidl_BaseInterface__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_baseinterface__geturl_f,SIDL_BASEINTERFACE__GETURL_F,sidl_BaseInterface__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_baseinterface__isremote_f,SIDL_BASEINTERFACE__ISREMOTE_F,sidl_BaseInterface__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_baseinterface__islocal_f,SIDL_BASEINTERFACE__ISLOCAL_F,sidl_BaseInterface__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(sidl_baseinterface__set_hooks_f,SIDL_BASEINTERFACE__SET_HOOKS_F,sidl_BaseInterface__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
