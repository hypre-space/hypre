...
void
SIDLFortran77Symbol(bhypre_problemdefinition__connect_f,BHYPRE_PROBLEMDEFINITION__CONNECT_F,bHYPRE_ProblemDefinition__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
...
)
{
  ...
  _proxy_self = bHYPRE_ProblemDefinition__remoteConnect(_proxy_url, 1,
    &_proxy_exception);
  if (_proxy_exception) {
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.ProblemDefinition",
      (void*)bHYPRE_ProblemDefinition__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "bHYPRE.ProblemDefinition", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran77Symbol(bhypre_problemdefinition__exec_f,BHYPRE_PROBLEMDEFINITION__EXEC_F,bHYPRE_ProblemDefinition__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_problemdefinition__geturl_f,BHYPRE_PROBLEMDEFINITION__GETURL_F,bHYPRE_ProblemDefinition__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_problemdefinition__isremote_f,BHYPRE_PROBLEMDEFINITION__ISREMOTE_F,bHYPRE_ProblemDefinition__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_problemdefinition__islocal_f,BHYPRE_PROBLEMDEFINITION__ISLOCAL_F,bHYPRE_ProblemDefinition__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_problemdefinition__set_hooks_f,BHYPRE_PROBLEMDEFINITION__SET_HOOKS_F,bHYPRE_ProblemDefinition__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
