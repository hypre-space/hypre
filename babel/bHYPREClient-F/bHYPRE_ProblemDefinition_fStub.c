 ...
 * Babel Version: 0.9.8
 * sidl Created:  20050317 11:17:49 PST
...
void
SIDLFortran77Symbol(bhypre_problemdefinition_getobject_f,BHYPRE_PROBLEMDEFINITION_GETOBJECT_F,bHYPRE_ProblemDefinition_GetObject_f)
(
  int64_t *self,
  int64_t *A,
  int32_t *retval
