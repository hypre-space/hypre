...
STUBDOCS = bHYPRE_BiCGSTAB.fif bHYPRE_BoomerAMG.fif bHYPRE_CGNR.fif           \
  ...
  sidl_BaseException.fif sidl_BaseInterface.fif sidl_CastException.fif        \
  sidl_ClassInfo.fif sidl_ClassInfoI.fif sidl_DFinder.fif sidl_DLL.fif        \
  sidl_Finder.fif sidl_InvViolation.fif sidl_LangSpecificException.fif        \
  sidl_Loader.fif sidl_MemoryAllocationException.fif                          \
  sidl_NotImplementedException.fif sidl_PostViolation.fif                     \
  sidl_PreViolation.fif sidl_RuntimeException.fif sidl_SIDLException.fif      \
  sidl_io_Deserializer.fif sidl_io_IOException.fif sidl_io_Serializable.fif   \
  sidl_io_Serializer.fif sidl_rmi_BindException.fif sidl_rmi_Call.fif         \
  sidl_rmi_ConnectException.fif sidl_rmi_ConnectRegistry.fif                  \
  sidl_rmi_InstanceHandle.fif sidl_rmi_InstanceRegistry.fif                   \
  sidl_rmi_Invocation.fif sidl_rmi_MalformedURLException.fif                  \
  sidl_rmi_NetworkException.fif sidl_rmi_NoRouteToHostException.fif           \
  sidl_rmi_NoServerException.fif sidl_rmi_ObjectDoesNotExistException.fif     \
  sidl_rmi_ProtocolException.fif sidl_rmi_ProtocolFactory.fif                 \
  sidl_rmi_Response.fif sidl_rmi_Return.fif sidl_rmi_ServerInfo.fif           \
