...
/*
 * Symbol "bHYPRE._StructBuildVector" (version 1.0)
 */

struct bHYPRE__StructBuildVector__array;
struct bHYPRE__StructBuildVector__object;

/*
 * Declare the method entry point vector.
 */

struct bHYPRE__StructBuildVector__epv {
  /* Implicit builtin methods */
  void* (*f__cast)(
    /* in */ struct bHYPRE__StructBuildVector__object* self,
    /* in */ const char* name);
  void (*f__delete)(
    /* in */ struct bHYPRE__StructBuildVector__object* self);
  void (*f__exec)(
  ...
  int32_t (*f_SetBoxValues)(
    ...
    /* in */ struct sidl_int__array* iupper,
    /* in */ struct sidl_double__array* values);
  /* Methods introduced in bHYPRE._StructBuildVector-v1.0 */
};
...
struct bHYPRE__StructBuildVector__object {
  ...
  struct bHYPRE__StructBuildVector__epv*  d_epv;
  void*                                   d_data;
};
