...
static struct bHYPRE_StructDiagScale__object* 
  bHYPRE_StructDiagScale__remoteCreate(const char* url, sidl_BaseInterface 
  *_ex);
static struct bHYPRE_StructDiagScale__object* 
...
#else
    _ior = (struct bHYPRE_StructDiagScale__external*)sidl_dynamicLoadIOR(
...
void
SIDLFortran77Symbol(bhypre_structdiagscale_destroy_f,BHYPRE_STRUCTDIAGSCALE_DESTROY_F,bHYPRE_StructDiagScale_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
