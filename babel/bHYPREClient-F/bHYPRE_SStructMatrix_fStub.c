...
void
SIDLFortran77Symbol(bhypre_sstructmatrix_setintarrayparameter_f,BHYPRE_SSTRUCTMATRIX_SETINTARRAYPARAMETER_F,bHYPRE_SStructMatrix_SetIntArrayParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix_setdoublearrayparameter_f,BHYPRE_SSTRUCTMATRIX_SETDOUBLEARRAYPARAMETER_F,bHYPRE_SStructMatrix_SetDoubleArrayParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
