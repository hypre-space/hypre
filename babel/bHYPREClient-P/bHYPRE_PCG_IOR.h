...
extern void bHYPRE_PCG__init(
  struct bHYPRE_PCG__object* self, void* ddata, struct 
...
extern void bHYPRE_PCG__getEPVs(
  ...
  struct bHYPRE_PCG__epv **s_arg_epv__bhypre_pcg,struct bHYPRE_PCG__epv 
    **s_arg_epv_hooks__bhypre_pcg);
  ...
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_PCG_fconnect_bHYPRE_MPICommunicator(const char* url, sidl_bool 
    ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_PCG_fcast_bHYPRE_MPICommunicator(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct bHYPRE_Operator__object* skel_bHYPRE_PCG_fconnect_bHYPRE_Operator(
  ...
  struct bHYPRE_PCG__object* skel_bHYPRE_PCG_fcast_bHYPRE_PCG(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_PreconditionedSolver__object* 
    skel_bHYPRE_PCG_fcast_bHYPRE_PreconditionedSolver(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_PCG_fconnect_sidl_RuntimeException(const char* url, sidl_bool 
    ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_PCG_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
