...
extern void bHYPRE_SStructParCSRMatrix__init(
  struct bHYPRE_SStructParCSRMatrix__object* self, void* ddata, struct 
...
extern void bHYPRE_SStructParCSRMatrix__getEPVs(
  ...
  extern void bHYPRE_SStructParCSRMatrix__fini(
    struct bHYPRE_SStructParCSRMatrix__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void bHYPRE_SStructParCSRMatrix__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_SStructParCSRMatrix_fcast_bHYPRE_Operator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_SStructGraph__object* 
    ...
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_SStructGraph__object* 
    skel_bHYPRE_SStructParCSRMatrix_fcast_bHYPRE_SStructGraph(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Vector__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Vector__object* 
    skel_bHYPRE_SStructParCSRMatrix_fcast_bHYPRE_Vector(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseClass__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* 
    skel_bHYPRE_SStructParCSRMatrix_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_SStructParCSRMatrix_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_bHYPRE_SStructParCSRMatrix_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
