...
static PyObject *
pStub_HPCG__set_hooks_static(PyObject *_ignored, PyObject *_args,             \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  sidl_bool on = (sidl_bool) 0;
  struct sidl_BaseInterface__object *_exception = NULL;
...
bHYPRE_HPCG_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)bHYPRE_HPCG__convert, &optarg, &url, &implObj);
  if (_okay) {
...
preconditioner: StructSMG, StructPFMG"
  ...
  PyTuple_SetItem(_bHYPRE_HPCGType.tp_bases,0,                                \
    (PyObject *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_HPCGType.tp_bases,1,                                \
    (PyObject *)bHYPRE_PreconditionedSolver_PyType());
