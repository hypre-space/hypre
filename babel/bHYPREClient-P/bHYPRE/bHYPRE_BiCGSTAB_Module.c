...
static PyObject *
pStub_BiCGSTAB__connect(PyObject *_ignored, PyObject *_args, PyObject         \
  *_kwdict) {
...
static PyObject *
pStub_BiCGSTAB_Create(PyObject *_ignored, PyObject *_args, PyObject *_kwdict) \
  {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_BiCGSTAB__isRemote(PyObject *_self, PyObject *_args, PyObject *_kwdict) \
  {
  PyObject *_return_value = NULL;
  struct bHYPRE_BiCGSTAB__object *_self_ior =
    ((struct bHYPRE_BiCGSTAB__object *)
...
static PyObject *
pStub_BiCGSTAB__set_hooks(PyObject *_self, PyObject *_args, PyObject          \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_BiCGSTAB__object *_self_ior =
    ((struct bHYPRE_BiCGSTAB__object *)
...
bHYPRE_BiCGSTAB_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)bHYPRE_BiCGSTAB__convert, &optarg, &url, &implObj);
  if (_okay) {
...
with any consistent matrix, vector, and preconditioner classes."
  ...
  PyTuple_SetItem(_bHYPRE_BiCGSTABType.tp_bases,0, (PyObject                  \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_BiCGSTABType.tp_bases,1, (PyObject                  \
