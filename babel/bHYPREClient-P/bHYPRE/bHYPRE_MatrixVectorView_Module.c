/*
 * File:          bHYPRE_MatrixVectorView_Module.c
...
#define bHYPRE_MatrixVectorView_INTERNAL 1
...
static PyObject *
pStub_MatrixVectorView__connect(PyObject *_ignored, PyObject *_args, PyObject \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_MatrixVectorView__object* self = NULL;
  char* url = NULL;
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &url);
  if (_okay) {
    self = bHYPRE_MatrixVectorView__remoteConnect(url,1,&_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)bHYPRE_MatrixVectorView__wrap, self);
    }
  }
  return _return_value;
}

staticforward PyTypeObject _bHYPRE_MatrixVectorViewType;

static PyObject *
pStub_MatrixVectorView__exec(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_MatrixVectorView__object *_self_ior =
    ((struct bHYPRE_MatrixVectorView__object *)
     sidl_Cast(_self, "bHYPRE.MatrixVectorView"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a bHYPRE.MatrixVectorView");
  }
  return _return_value;
}

static PyObject *
pStub_MatrixVectorView__getURL(PyObject *_self, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_MatrixVectorView__object *_self_ior =
    ((struct bHYPRE_MatrixVectorView__object *)
...
static PyObject *
pStub_MatrixVectorView__isLocal(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_MatrixVectorView__object *_self_ior =
    ((struct bHYPRE_MatrixVectorView__object *)
...
static PyObject *
pStub_MatrixVectorView__isRemote(PyObject *_self, PyObject *_args, PyObject   \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_MatrixVectorView__object *_self_ior =
    ((struct bHYPRE_MatrixVectorView__object *)
...
static PyObject *
pStub_MatrixVectorView__set_hooks(PyObject *_self, PyObject *_args, PyObject  \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_MatrixVectorView__object *_self_ior =
    ((struct bHYPRE_MatrixVectorView__object *)
...
static int
bHYPRE_MatrixVectorView_createCast(PyObject *self, PyObject *args, PyObject   \
  *kwds) {
  struct bHYPRE_MatrixVectorView__object *optarg = NULL;
  static char *_kwlist[] = { "sobj", NULL };
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "O&", _kwlist, (void    \
    *)bHYPRE_MatrixVectorView__convert, &optarg);
  if (_okay) {
...
static PyMethodDef _MatrixVectorViewModuleMethods[] = {
  { "_connect", (PyCFunction)pStub_MatrixVectorView__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out bHYPRE.MatrixVectorView self)\n\
RAISES\n\
...
static PyMethodDef _MatrixVectorViewObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_MatrixVectorView__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_MatrixVectorView__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_MatrixVectorView__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_MatrixVectorView__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_MatrixVectorView__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _bHYPRE_MatrixVectorViewType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "bHYPRE.MatrixVectorView.MatrixVectorView", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
...
system.  Derived interfaces and classes have similar functions such as\n\
SetValues and Print, but the functions are not declared here because the\n\
function argument lists vary", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  0,       /* tp_weaklistoffset */
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _MatrixVectorViewObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  bHYPRE_MatrixVectorView_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

bHYPRE_MatrixVectorView__wrap_RETURN
bHYPRE_MatrixVectorView__wrap bHYPRE_MatrixVectorView__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_MatrixVectorViewType.tp_new(                             \
      &_bHYPRE_MatrixVectorViewType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
bHYPRE_MatrixVectorView__weakRef bHYPRE_MatrixVectorView__weakRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_MatrixVectorViewType.tp_new(                             \
      &_bHYPRE_MatrixVectorViewType, NULL, NULL);
...
bHYPRE_MatrixVectorView_deref bHYPRE_MatrixVectorView_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
bHYPRE_MatrixVectorView__newRef bHYPRE_MatrixVectorView__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_MatrixVectorViewType.tp_new(                             \
      &_bHYPRE_MatrixVectorViewType, NULL, NULL);
...
bHYPRE_MatrixVectorView__addRef bHYPRE_MatrixVectorView__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
bHYPRE_MatrixVectorView_PyType bHYPRE_MatrixVectorView_PyType_PROTO {
  Py_INCREF(&_bHYPRE_MatrixVectorViewType);
  return &_bHYPRE_MatrixVectorViewType;
}

bHYPRE_MatrixVectorView__convert_RETURN
bHYPRE_MatrixVectorView__convert bHYPRE_MatrixVectorView__convert_PROTO {
  *sidlobj = sidl_Cast(obj, "bHYPRE.MatrixVectorView");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) bHYPRE.MatrixVectorView");
    return 0;
  }
  return 1;
}
...
{
  struct bHYPRE_MatrixVectorView__object *sidlobj;
  if (bHYPRE_MatrixVectorView__convert(pyobj, &sidlobj)) {
  ...
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              bHYPRE_MatrixVectorView__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct bHYPRE_MatrixVectorView__object *sidlobj = (struct                   \
    bHYPRE_MatrixVectorView__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = bHYPRE_MatrixVectorView__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initMatrixVectorView(void) {
  PyObject *module, *dict, *c_api;
  static void *ExternalAPI[bHYPRE_MatrixVectorView__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule3("MatrixVectorView", _MatrixVectorViewModuleMethods, \
    "\
\
This interface is defined to express the conceptual structure of the object\n\
system.  Derived interfaces and classes have similar functions such as\n\
...
function argument lists vary"
  ...
  ExternalAPI[bHYPRE_MatrixVectorView__wrap_NUM] = (                          \
    void*)bHYPRE_MatrixVectorView__wrap;
  ExternalAPI[bHYPRE_MatrixVectorView__convert_NUM] = (                       \
    void*)bHYPRE_MatrixVectorView__convert;
  ExternalAPI[bHYPRE_MatrixVectorView__convert_python_array_NUM] = (          \
    void*)bHYPRE_MatrixVectorView__convert_python_array;
  ExternalAPI[bHYPRE_MatrixVectorView__convert_sidl_array_NUM] = (            \
    void*)bHYPRE_MatrixVectorView__convert_sidl_array;
  ExternalAPI[bHYPRE_MatrixVectorView__weakRef_NUM] = (                       \
    void*)bHYPRE_MatrixVectorView__weakRef;
  ExternalAPI[bHYPRE_MatrixVectorView_deref_NUM] = (                          \
    void*)bHYPRE_MatrixVectorView_deref;
  ExternalAPI[bHYPRE_MatrixVectorView__newRef_NUM] = (                        \
    void*)bHYPRE_MatrixVectorView__newRef;
  ExternalAPI[bHYPRE_MatrixVectorView__addRef_NUM] = (                        \
    void*)bHYPRE_MatrixVectorView__addRef;
  ExternalAPI[bHYPRE_MatrixVectorView_PyType_NUM] = (                         \
    void*)bHYPRE_MatrixVectorView_PyType;
  ExternalAPI[bHYPRE_MatrixVectorView__connectI_NUM] = (                      \
    void*)bHYPRE_MatrixVectorView__connectI;
  ExternalAPI[bHYPRE_MatrixVectorView__rmicast_NUM] = (                       \
    void*)bHYPRE_MatrixVectorView__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  bHYPRE_ProblemDefinition__import();
  _bHYPRE_MatrixVectorViewType.tp_base = bHYPRE_ProblemDefinition_PyType();
  _bHYPRE_MatrixVectorViewType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_bHYPRE_MatrixVectorViewType.tp_bases,0, (PyObject          \
    *)bHYPRE_ProblemDefinition_PyType());
  if (PyType_Ready(&_bHYPRE_MatrixVectorViewType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on bHYPRE.MatrixVectorView failed.\n");
    return;
  }
  Py_INCREF(&_bHYPRE_MatrixVectorViewType);
  PyDict_SetItemString(dict, "MatrixVectorView", (PyObject                    \
    *)&_bHYPRE_MatrixVectorViewType);
