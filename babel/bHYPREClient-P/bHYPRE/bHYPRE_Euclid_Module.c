...
#define bHYPRE_Euclid_INTERNAL 1
#include "bHYPRE_Euclid_Module.h"
...
static struct bHYPRE_Euclid__epv s_rem_epv__bhypre_euclid;
...
static void* remote_bHYPRE_Euclid__cast(
...
static void remote_bHYPRE_Euclid__delete(
  struct bHYPRE_Euclid__object* self,
...
static char* remote_bHYPRE_Euclid__getURL(
  struct bHYPRE_Euclid__object* self, sidl_BaseInterface* _ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct                     \
    bHYPRE_Euclid__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_bHYPRE_Euclid__raddRef(
  struct bHYPRE_Euclid__object* self,sidl_BaseInterface* _ex)
{
...
static sidl_bool
remote_bHYPRE_Euclid__isRemote(
    struct bHYPRE_Euclid__object* self, 
    sidl_BaseInterface *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_bHYPRE_Euclid__set_hooks(
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid._set_hooks.", &throwaway_exception);
...
static void remote_bHYPRE_Euclid__exec(
  struct bHYPRE_Euclid__object* self,const char* methodName,
...
/* REMOTE METHOD STUB:SetParameters */
static int32_t
remote_bHYPRE_Euclid_SetParameters(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ int32_t argc,
  /* inout */ char** argv,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct                 \
      bHYPRE_Euclid__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation(      \
      _conn, "SetParameters", _ex ); SIDL_CHECK(*_ex);
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetParameters.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
  ...
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    struct bHYPRE_Euclid__remote* r_obj = (struct                             \
      bHYPRE_Euclid__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
...
static void
remote_bHYPRE_Euclid_deleteRef(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.isSame.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.isType.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
remote_bHYPRE_Euclid_getClassInfo(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.getClassInfo.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetOperator(
  /* in */ struct bHYPRE_Euclid__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetOperator.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetTolerance(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ double tolerance,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetTolerance.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetMaxIterations(
  /* in */ struct bHYPRE_Euclid__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetMaxIterations.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetLogging(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ int32_t level,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetLogging.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetPrintLevel(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ int32_t level,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetPrintLevel.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_GetNumIterations(
  /* in */ struct bHYPRE_Euclid__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.GetNumIterations.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_GetRelResidualNorm(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* out */ double* norm,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.GetRelResidualNorm.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetCommunicator(
  /* in */ struct bHYPRE_Euclid__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetCommunicator.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.Destroy.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetIntParameter(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  /* in */ int32_t value,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetIntParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetDoubleParameter(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  /* in */ double value,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetDoubleParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetStringParameter(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  /* in */ const char* value,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetStringParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetIntArray1Parameter(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetIntArray1Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetIntArray2Parameter(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetIntArray2Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetDoubleArray1Parameter(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetDoubleArray1Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_SetDoubleArray2Parameter(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.SetDoubleArray2Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_GetIntValue(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  /* out */ int32_t* value,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.GetIntValue.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_GetDoubleValue(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ const char* name,
  /* out */ double* value,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.GetDoubleValue.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.Setup.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.Apply.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_Euclid_ApplyAdjoint(
  /* in */ struct bHYPRE_Euclid__object* self ,
  /* in */ struct bHYPRE_Vector__object* b,
  /* inout */ struct bHYPRE_Vector__object** x,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.Euclid.ApplyAdjoint.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,            \
        &throwaway_exception);
      goto EXIT;
    }
...
static void bHYPRE_Euclid__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct bHYPRE_Euclid__epv*      epv = &s_rem_epv__bhypre_euclid;
  ...
  epv->f__cast                         = remote_bHYPRE_Euclid__cast;
  epv->f__delete                       = remote_bHYPRE_Euclid__delete;
  epv->f__exec                         = remote_bHYPRE_Euclid__exec;
  epv->f__getURL                       = remote_bHYPRE_Euclid__getURL;
  epv->f__raddRef                      = remote_bHYPRE_Euclid__raddRef;
  epv->f__isRemote                     = remote_bHYPRE_Euclid__isRemote;
  epv->f__set_hooks                    = remote_bHYPRE_Euclid__set_hooks;
  epv->f__ctor                         = NULL;
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  epv->f_SetParameters                 = remote_bHYPRE_Euclid_SetParameters;
  epv->f_addRef                        = remote_bHYPRE_Euclid_addRef;
  epv->f_deleteRef                     = remote_bHYPRE_Euclid_deleteRef;
  epv->f_isSame                        = remote_bHYPRE_Euclid_isSame;
  epv->f_isType                        = remote_bHYPRE_Euclid_isType;
  epv->f_getClassInfo                  = remote_bHYPRE_Euclid_getClassInfo;
  epv->f_SetOperator                   = remote_bHYPRE_Euclid_SetOperator;
  epv->f_SetTolerance                  = remote_bHYPRE_Euclid_SetTolerance;
  epv->f_SetMaxIterations              =                                      \
    remote_bHYPRE_Euclid_SetMaxIterations;
  epv->f_SetLogging                    = remote_bHYPRE_Euclid_SetLogging;
  epv->f_SetPrintLevel                 = remote_bHYPRE_Euclid_SetPrintLevel;
  epv->f_GetNumIterations              =                                      \
    remote_bHYPRE_Euclid_GetNumIterations;
  epv->f_GetRelResidualNorm            =                                      \
    remote_bHYPRE_Euclid_GetRelResidualNorm;
  epv->f_SetCommunicator               = remote_bHYPRE_Euclid_SetCommunicator;
  epv->f_Destroy                       = remote_bHYPRE_Euclid_Destroy;
  epv->f_SetIntParameter               = remote_bHYPRE_Euclid_SetIntParameter;
  ...
  epv->f_SetDoubleArray2Parameter      =                                      \
    remote_bHYPRE_Euclid_SetDoubleArray2Parameter;
  epv->f_GetIntValue                   = remote_bHYPRE_Euclid_GetIntValue;
  epv->f_GetDoubleValue                = remote_bHYPRE_Euclid_GetDoubleValue;
  epv->f_Setup                         = remote_bHYPRE_Euclid_Setup;
  epv->f_Apply                         = remote_bHYPRE_Euclid_Apply;
  epv->f_ApplyAdjoint                  = remote_bHYPRE_Euclid_ApplyAdjoint;
...
bHYPRE_Euclid__remoteConnect(const char *url, sidl_bool ar,                   \
  sidl_BaseInterface *_ex)
{
  struct bHYPRE_Euclid__object* self;

  struct bHYPRE_Euclid__object* s0;
  ...
  *_ex = NULL;
  ...
  r_obj =
    (struct bHYPRE_Euclid__remote*) malloc(
      sizeof(struct bHYPRE_Euclid__remote));
  ...
  if (!s_remote_initialized) {
    bHYPRE_Euclid__init_remote_epv();
  }
  UNLOCK_STATIC_GLOBALS;
  ...
  s0->d_epv  = &s_rem_epv__bhypre_euclid;
...
static struct bHYPRE_Euclid__object*
bHYPRE_Euclid__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
...
bHYPRE_Euclid__rmicast(
  ...
  sidl_BaseInterface* _ex)
{
  struct bHYPRE_Euclid__object* cast = NULL;
  ...
  *_ex = NULL;
  ...
  if (obj != NULL) {
    ...
    cast = (struct bHYPRE_Euclid__object*) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.Euclid", _ex); SIDL_CHECK(*_ex);
  }
...
pStub_Euclid__connect(PyObject *_ignored, PyObject *_args,                    \
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &url);
  if (_okay) {
    self = bHYPRE_Euclid__remoteConnect(url,1,&_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)bHYPRE_Euclid__wrap, self);
    }
  }
  return _return_value;
}

staticforward PyTypeObject _bHYPRE_EuclidType;

static struct bHYPRE_Euclid__sepv *_sepv = NULL;

static const struct bHYPRE_Euclid__external *_implEPV = NULL;

static PyObject *
pStub_Euclid_Create(PyObject *_ignored, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  ...
  if (_okay) {
    struct bHYPRE_Euclid__object* _return = NULL;
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)bHYPRE_Euclid__wrap, _return);
    }
...
pStub_Euclid_SetParameters(PyObject *_self, PyObject *_args,                  \
  ...
  struct bHYPRE_Euclid__object *_self_ior =
    ((struct bHYPRE_Euclid__object *)
     sidl_Cast(_self, "bHYPRE.Euclid"));
  if (_self_ior) {
    int32_t argc = (int32_t) 0;
    char* argv = NULL;
    struct sidl_BaseInterface__object *_exception = NULL;
    long _proxy_argc;
    static char *_kwlist[] = {
    ...
    if (_okay) {
      ...
      long _proxy__return;
      argc = _proxy_argc;
      argv = (argv ? strcpy(malloc(strlen(argv)+1), argv) : NULL);
      _return = (*(_self_ior->d_epv->f_SetParameters))(_self_ior, argc, &argv,\
        &_exception);
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a bHYPRE.Euclid");
  }
  return _return_value;
}

static PyObject *
pStub_Euclid__exec(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_Euclid__object *_self_ior =
    ((struct bHYPRE_Euclid__object *)
     sidl_Cast(_self, "bHYPRE.Euclid"));
...
static PyObject *
pStub_Euclid__getURL(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_Euclid__object *_self_ior =
    ((struct bHYPRE_Euclid__object *)
     sidl_Cast(_self, "bHYPRE.Euclid"));
...
static PyObject *
pStub_Euclid__isLocal(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_Euclid__object *_self_ior =
    ((struct bHYPRE_Euclid__object *)
     sidl_Cast(_self, "bHYPRE.Euclid"));
...
static PyObject *
pStub_Euclid__isRemote(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_Euclid__object *_self_ior =
    ((struct bHYPRE_Euclid__object *)
     sidl_Cast(_self, "bHYPRE.Euclid"));
...
static PyObject *
pStub_Euclid__set_hooks(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_Euclid__object *_self_ior =
    ((struct bHYPRE_Euclid__object *)
     sidl_Cast(_self, "bHYPRE.Euclid"));
...
static int
bHYPRE_Euclid_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  struct bHYPRE_Euclid__object *optarg = NULL;
  char* url = NULL;
  ...
  if (_okay) {
    ...
    struct sidl_BaseInterface__object *_exception = NULL;
    optarg = bHYPRE_Euclid__remoteCreate(url,&_exception);
    if (_exception) {
      sidl_rmi_NetworkException__import();
      struct sidl_rmi_NetworkException__object *_ex0;
      if ((_ex0 = (struct sidl_rmi_NetworkException__object *)
...
static PyMethodDef _EuclidModuleMethods[] = {
  { "Create", (PyCFunction)pStub_Euclid_Create,
...
RETURNS\n\
   ( out bHYPRE.Euclid self)\n\
RAISES\n\
    sidl.rmi.NetworkException\n\
"
   },
  { "_set_hooks_static", (PyCFunction)pStub_Euclid__set_hooks_static,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyMethodDef _EuclidObjectMethods[] = {
  { "SetParameters", (PyCFunction)pStub_Euclid_SetParameters,
  (METH_VARARGS | METH_KEYWORDS),
"\
SetParameters( in int argc,\n\
               inout string argv)\n\
RETURNS\n\
   (int _return,\n\
     inout string argv)\n\
...
"
  ...
  { "_exec", (PyCFunction)pStub_Euclid__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_Euclid__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_Euclid__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_Euclid__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_Euclid__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _bHYPRE_EuclidType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "bHYPRE.Euclid.Euclid", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
...
a Euclid-stype parameter-setting function is also available, SetParameters.", /* tp_doc */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _EuclidObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  bHYPRE_Euclid_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

bHYPRE_Euclid__wrap_RETURN
bHYPRE_Euclid__wrap bHYPRE_Euclid__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_EuclidType.tp_new(&_bHYPRE_EuclidType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
bHYPRE_Euclid__weakRef bHYPRE_Euclid__weakRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_EuclidType.tp_new(&_bHYPRE_EuclidType, NULL, NULL);
    if (result) {
...
bHYPRE_Euclid_deref bHYPRE_Euclid_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
bHYPRE_Euclid__newRef bHYPRE_Euclid__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_EuclidType.tp_new(&_bHYPRE_EuclidType, NULL, NULL);
    if (result) {
...
bHYPRE_Euclid__addRef bHYPRE_Euclid__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
bHYPRE_Euclid_PyType bHYPRE_Euclid_PyType_PROTO {
  Py_INCREF(&_bHYPRE_EuclidType);
  return &_bHYPRE_EuclidType;
}

bHYPRE_Euclid__convert_RETURN
bHYPRE_Euclid__convert bHYPRE_Euclid__convert_PROTO {
  *sidlobj = sidl_Cast(obj, "bHYPRE.Euclid");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) bHYPRE.Euclid");
    return 0;
  }
  return 1;
}
...
{
  struct bHYPRE_Euclid__object *sidlobj;
  if (bHYPRE_Euclid__convert(pyobj, &sidlobj)) {
...
bHYPRE_Euclid__convert_python_array bHYPRE_Euclid__convert_python_array_PROTO \
  {
  int result = 0;
  *sidlarray = NULL;
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              bHYPRE_Euclid__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct bHYPRE_Euclid__object *sidlobj = (struct bHYPRE_Euclid__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = bHYPRE_Euclid__wrap(sidlobj);
  return (*dest == NULL);
}

bHYPRE_Euclid__convert_sidl_array_RETURN
bHYPRE_Euclid__convert_sidl_array bHYPRE_Euclid__convert_sidl_array_PROTO {
  PyObject *pya = NULL;
  if (sidlarray) {
...
initEuclid(void) {
  ...
  static void *ExternalAPI[bHYPRE_Euclid__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  sidl_DLL dll = NULL;
  struct bHYPRE_Euclid__external*(*_extFunc)(void) = NULL;
  module = Py_InitModule3("Euclid", _EuclidModuleMethods, "\
\
Objects of this type can be cast to Solver objects using the\n\
{\\tt \\_\\_cast} methods.\n\
\n\
...
a Euclid-stype parameter-setting function is also available, SetParameters."
  ...
  ExternalAPI[bHYPRE_Euclid__addRef_NUM] = (void*)bHYPRE_Euclid__addRef;
  ExternalAPI[bHYPRE_Euclid_PyType_NUM] = (void*)bHYPRE_Euclid_PyType;
  ExternalAPI[bHYPRE_Euclid__connectI_NUM] = (void*)bHYPRE_Euclid__connectI;
  ExternalAPI[bHYPRE_Euclid__rmicast_NUM] = (void*)bHYPRE_Euclid__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  Py_INCREF(&_bHYPRE_EuclidType);
  PyDict_SetItemString(dict, "Euclid", (PyObject *)&_bHYPRE_EuclidType);
  ...
  if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                  \
    &throwaway_exception)) {
    _extFunc = (struct bHYPRE_Euclid__external*(*)(void))
      sidl_DLL_lookupSymbol(dll, "bHYPRE_Euclid__externals",                  \
        &throwaway_exception);
    if (_extFunc) {
      _implEPV = (*_extFunc)();
    }
  ...
  if (!_implEPV) {
    dll = sidl_Loader_findLibrary("bHYPRE.Euclid",
  ...
  if (_implEPV) {
    _sepv = (*_implEPV->getStaticEPV)();
    if (PyErr_Occurred()) {
      Py_FatalError("Cannot initialize Python module bHYPRE.Euclid.");
    }
  }
  else {
