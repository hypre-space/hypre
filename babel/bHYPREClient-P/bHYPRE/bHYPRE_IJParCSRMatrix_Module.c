...
static PyObject *
pStub_IJParCSRMatrix__connect(PyObject *_ignored, PyObject *_args, PyObject   \
  *_kwdict) {
...
static PyObject *
pStub_IJParCSRMatrix_Create(PyObject *_ignored, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_IJParCSRMatrix__exec(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRMatrix__object *_self_ior =
    ((struct bHYPRE_IJParCSRMatrix__object *)
...
static PyObject *
pStub_IJParCSRMatrix__getURL(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRMatrix__object *_self_ior =
    ((struct bHYPRE_IJParCSRMatrix__object *)
...
static PyObject *
pStub_IJParCSRMatrix__isLocal(PyObject *_self, PyObject *_args, PyObject      \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRMatrix__object *_self_ior =
    ((struct bHYPRE_IJParCSRMatrix__object *)
...
static PyObject *
pStub_IJParCSRMatrix__isRemote(PyObject *_self, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRMatrix__object *_self_ior =
    ((struct bHYPRE_IJParCSRMatrix__object *)
...
static PyObject *
pStub_IJParCSRMatrix__set_hooks(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRMatrix__object *_self_ior =
    ((struct bHYPRE_IJParCSRMatrix__object *)
...
static int
bHYPRE_IJParCSRMatrix_createCast(PyObject *self, PyObject *args, PyObject     \
  *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)bHYPRE_IJParCSRMatrix__convert, &optarg, &url, &implObj);
  if (_okay) {
...
CoefficientAccess objects using the {\\tt \\_\\_cast} methods."
  ...
  PyTuple_SetItem(_bHYPRE_IJParCSRMatrixType.tp_bases,0, (PyObject            \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_IJParCSRMatrixType.tp_bases,1, (PyObject            \
    *)bHYPRE_CoefficientAccess_PyType());
  PyTuple_SetItem(_bHYPRE_IJParCSRMatrixType.tp_bases,2, (PyObject            \
    *)bHYPRE_Operator_PyType());
  PyTuple_SetItem(_bHYPRE_IJParCSRMatrixType.tp_bases,3, (PyObject            \
  ...
  Py_INCREF(&_bHYPRE_IJParCSRMatrixType);
  PyDict_SetItemString(dict, "IJParCSRMatrix", (PyObject                      \
    *)&_bHYPRE_IJParCSRMatrixType);
