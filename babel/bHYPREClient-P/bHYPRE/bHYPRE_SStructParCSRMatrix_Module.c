...
static PyObject *
pStub_SStructParCSRMatrix__exec(PyObject *_self, PyObject *_args,             \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_SStructParCSRMatrix__getURL(PyObject *_self, PyObject *_args,           \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_SStructParCSRMatrix__object *_self_ior =
    ((struct bHYPRE_SStructParCSRMatrix__object *)
...
static PyObject *
pStub_SStructParCSRMatrix__isLocal(PyObject *_self, PyObject *_args,          \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_SStructParCSRMatrix__object *_self_ior =
    ((struct bHYPRE_SStructParCSRMatrix__object *)
...
static PyObject *
pStub_SStructParCSRMatrix__set_hooks_static(PyObject *_ignored,               \
...
bHYPRE_SStructParCSRMatrix_createCast(PyObject *self, PyObject *args,         \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)bHYPRE_SStructParCSRMatrix__convert, &optarg, &url, &implObj);
  if (_okay) {
...
bHYPRE_SStructParCSRMatrix__wrap bHYPRE_SStructParCSRMatrix__wrap_PROTO {
  ...
  if (sidlobj) {
    result =                                                                  \
      _bHYPRE_SStructParCSRMatrixType.tp_new(&_bHYPRE_SStructParCSRMatrixType,\
      NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
Operator objects using the {\\tt \\_\\_cast} methods."
  ...
  PyTuple_SetItem(_bHYPRE_SStructParCSRMatrixType.tp_bases,0,                 \
    (PyObject *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_SStructParCSRMatrixType.tp_bases,1,                 \
    (PyObject *)bHYPRE_SStructMatrixView_PyType());
  PyTuple_SetItem(_bHYPRE_SStructParCSRMatrixType.tp_bases,2,                 \
  ...
  Py_INCREF(&_bHYPRE_SStructParCSRMatrixType);
  PyDict_SetItemString(dict, "SStructParCSRMatrix",                           \
    (PyObject *)&_bHYPRE_SStructParCSRMatrixType);
