...
/* additive versions */
   ...
   */
   ...
   mgr_frelax_method[0] = 0;
   //mgr_frelax_method[1] = 1;
   ...
   if( solver_id == 72 )
   {
     ...
     */
      ...
      */
      ...
      //HYPRE_MGRSetCpointsByBlockExp( pcg_precond, mgr_bsize, mgr_nlevels, mgr_idx_array, mgr_num_cindexes,mgr_cindexes);
