...
HYPRE_Int BuildMatrix ( MPI_Comm comm , ProblemData data , HYPRE_SStructGrid grid , HYPRE_Int object_type , HYPRE_SStructStencil *stencils , HYPRE_SStructGraph graph , HYPRE_SStructMatrix *A_ptr );
