...
/*    hypre_ParCSRMatrix *A = hypre_ParCSRMatrixRead(hypre_MPI_COMM_WORLD, "A"); */
/*    hypre_ParCSRMatrix *P = hypre_ParCSRMatrixRead(hypre_MPI_COMM_WORLD, "P"); */
/*    hypre_ParCSRMatrixMigrate(A, HYPRE_MEMORY_DEVICE); */
/*    hypre_ParCSRMatrixMigrate(P, HYPRE_MEMORY_DEVICE); */
/*    hypre_MatvecCommPkgCreate(A); */
/*    hypre_MatvecCommPkgCreate(P); */

/*    hypre_printf("Do RAPKT\n"); */
/*    hypre_ParCSRMatrixRAPKTDevice(P, A, P, 1); */
/*    hypre_printf("DONE!\n"); */
