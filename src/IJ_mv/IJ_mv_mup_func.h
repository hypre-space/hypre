...
#define hypre_IJMatrixMigrateParCSR HYPRE_MULTIPRECISION_FUNC ( hypre_IJMatrixMigrateParCSR )
...
#define hypre_IJVectorInitializeParShell HYPRE_MULTIPRECISION_FUNC ( hypre_IJVectorInitializeParShell )
#define hypre_IJVectorInitializePar_v2 HYPRE_MULTIPRECISION_FUNC ( hypre_IJVectorInitializePar_v2 )
#define hypre_IJVectorMigrateParCSR HYPRE_MULTIPRECISION_FUNC ( hypre_IJVectorMigrateParCSR )
