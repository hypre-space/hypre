...
/******************************************************************************
 *
 * hypre_IJMatrixSetShrinkThresholdParCSR
 *
 *****************************************************************************/

HYPRE_Int
hypre_IJMatrixSetShrinkThresholdParCSR(hypre_IJMatrix *matrix,
                                       HYPRE_Real      threshold)
{
   ...
   hypre_AuxParCSRMatrixShrinkThreshold(aux_matrix) = threshold;
#endif
