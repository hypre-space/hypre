...
HYPRE_Int
hypre_StructMatmultDestroy( hypre_StructMMData *mmdata )
{
   if (mmdata)
   {
...
HYPRE_Int
hypre_StructMatmultSetup( hypre_StructMMData  *mmdata,
...
HYPRE_Int
hypre_StructMatmultCommunicate( hypre_StructMMData  *mmdata,
