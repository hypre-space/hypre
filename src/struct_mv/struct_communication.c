...
#undef DEVICE_VAR
   ...
   hypre_CommHandleAllocateBuffers(memory_location,
                                   memory_location,
                                   hypre_CommPkgSendBufsize(comm_pkg),
   ...
   hypre_CommHandleNumExtraRequests(comm_handle) = num_extra_requests;
   hypre_CommHandleExtraRequests(comm_handle)    = extra_requests;
