...
HYPRE_Int hypre_StructMatrixSetArrayValuesDevice( hypre_StructMatrix *matrix, HYPRE_Int nvalues, HYPRE_Int *indexes,
                                                  HYPRE_Int *stencil_indices, HYPRE_Complex *values, HYPRE_Int clear_ghost );
HYPRE_Int hypre_StructMatrixAddToArrayValuesDevice( hypre_StructMatrix *matrix, HYPRE_Int nvalues, HYPRE_Int *indexes,
                                                    HYPRE_Int *stencil_indices, HYPRE_Complex *values, HYPRE_Int add_to_ghost );
HYPRE_Int hypre_StructMatrixGetArrayValuesDevice( hypre_StructMatrix *matrix, HYPRE_Int nvalues, HYPRE_Int *indexes,
...
HYPRE_Int hypre_StructVectorSetBoxValues ( hypre_StructVector *vector, hypre_Box *set_box,
                                           ...
                                           HYPRE_Int outside );
HYPRE_Int hypre_StructVectorSetArrayValuesDevice( hypre_StructVector *vector, HYPRE_Int nvalues, HYPRE_Int *indexes,
                                                  HYPRE_Complex *values, HYPRE_Int clear_ghost );
HYPRE_Int hypre_StructVectorAddToArrayValuesDevice( hypre_StructVector *vector, HYPRE_Int nvalues, HYPRE_Int *indexes,
                                                    HYPRE_Complex *values, HYPRE_Int add_to_ghost );
HYPRE_Int hypre_StructVectorGetArrayValuesDevice( hypre_StructVector *vector, HYPRE_Int nvalues, HYPRE_Int *indexes,
