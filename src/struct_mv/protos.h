...
HYPRE_Int hypre_StructMatmultCompute_core_1t ( hypre_StructMatmultHelper **a , HYPRE_Int ncomponents , HYPRE_Int *entries , HYPRE_Int *indices , HYPRE_Int ndim , hypre_Index loop_size , hypre_Box *gdbox , hypre_Index gdstart , hypre_Index gdstride , hypre_Box *Mdbox , hypre_Index Mdstart , hypre_Index Mdstride );
...
HYPRE_Int hypre_StructMatmultCompute_core_1tbbb ( hypre_StructMatmultHelper **a , HYPRE_Int ncomponents , HYPRE_Int *entries , HYPRE_Int *indices , HYPRE_Int ndim , hypre_Index loop_size , hypre_Box *gdbox , hypre_Index gdstart , hypre_Index gdstride , hypre_Box *Mdbox , hypre_Index Mdstart , hypre_Index Mdstride );
