 ...
 * z = beta * y + alpha * A*x
 *
 * Initialize StructMatrix/Vector multiplication for one constant and an
 * arbitrary number of variable coefficients
 *--------------------------------------------------------------------------*/
...
#define HYPRE_CORE_CASE(n)                                                     \
   case n:                                                                     \
      ...
      {                                                                        \
         zp[zi] = beta * yp[yi] + alpha * (HYPRE_CALC_CAX_ADD(26) +            \
                                           HYPRE_CALC_AX_ADD_UP_TO_##n);       \
      }                                                                        \
