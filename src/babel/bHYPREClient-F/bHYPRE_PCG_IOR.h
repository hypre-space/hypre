...
bHYPRE_PCG__new(void* ddata,struct sidl_BaseInterface__object ** _ex);

extern struct bHYPRE_PCG__sepv*
bHYPRE_PCG__statics(void);

extern void bHYPRE_PCG__init(
  struct bHYPRE_PCG__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void bHYPRE_PCG__getEPVs(
  ...
  struct bHYPRE_PCG__epv **s_arg_epv__bhypre_pcg,
    struct bHYPRE_PCG__epv **s_arg_epv_hooks__bhypre_pcg);
  extern void bHYPRE_PCG__fini(
    struct bHYPRE_PCG__object* self, struct sidl_BaseInterface__object ** _ex);
  extern void bHYPRE_PCG__IOR_version(int32_t *major, int32_t *minor);

  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_PCG_fconnect_bHYPRE_MPICommunicator(const char* url,
  ...
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_PCG_fconnect_bHYPRE_Operator(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Operator__object* skel_bHYPRE_PCG_fcast_bHYPRE_Operator(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_PCG__object* skel_bHYPRE_PCG_fconnect_bHYPRE_PCG(const char* 
  ...
  struct sidl_BaseInterface__object* 
    ...
    struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_PCG_fcast_sidl_BaseInterface(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_PCG_fconnect_sidl_RuntimeException(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_PCG_fcast_sidl_RuntimeException(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_PCG__remote{
    int d_refcount;
