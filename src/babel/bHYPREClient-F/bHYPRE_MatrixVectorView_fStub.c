...
void
SIDLFortran77Symbol(bhypre_matrixvectorview__connect_f,BHYPRE_MATRIXVECTORVIEW__CONNECT_F,bHYPRE_MatrixVectorView__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_matrixvectorview__exec_f,BHYPRE_MATRIXVECTORVIEW__EXEC_F,bHYPRE_MatrixVectorView__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_matrixvectorview__geturl_f,BHYPRE_MATRIXVECTORVIEW__GETURL_F,bHYPRE_MatrixVectorView__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_matrixvectorview__isremote_f,BHYPRE_MATRIXVECTORVIEW__ISREMOTE_F,bHYPRE_MatrixVectorView__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_matrixvectorview__islocal_f,BHYPRE_MATRIXVECTORVIEW__ISLOCAL_F,bHYPRE_MatrixVectorView__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_matrixvectorview__set_hooks_f,BHYPRE_MATRIXVECTORVIEW__SET_HOOKS_F,bHYPRE_MatrixVectorView__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_matrixvectorview_destroy_f,BHYPRE_MATRIXVECTORVIEW_DESTROY_F,bHYPRE_MatrixVectorView_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
