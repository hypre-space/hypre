...
static struct bHYPRE_HGMRES__object* bHYPRE_HGMRES__remoteCreate(const char* 
  url, sidl_BaseInterface *_ex);
static struct bHYPRE_HGMRES__object* bHYPRE_HGMRES__remoteConnect(const char* 
  url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct bHYPRE_HGMRES__object* bHYPRE_HGMRES__IHConnect(struct 
...
static const struct bHYPRE_HGMRES__external* _getIOR(void)
{
  static const struct bHYPRE_HGMRES__external *_ior = NULL;
  if (!_ior) {
#ifdef SIDL_STATIC_LIBRARY
    _ior = bHYPRE_HGMRES__externals();
#else
    _ior = (struct bHYPRE_HGMRES__external*)sidl_dynamicLoadIOR("bHYPRE.HGMRES",
      "bHYPRE_HGMRES__externals") ;
    sidl_checkIORVersion("bHYPRE.HGMRES", _ior->d_ior_major_version,
...
static const struct bHYPRE_HGMRES__sepv* _getSEPV(void)
{
...
void
SIDLFortran77Symbol(bhypre_hgmres__create_f,BHYPRE_HGMRES__CREATE_F,bHYPRE_HGMRES__create_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_hgmres__createremote_f,BHYPRE_HGMRES__CREATEREMOTE_F,bHYPRE_HGMRES__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
{
  struct bHYPRE_HGMRES__object* _proxy_self = NULL;
  ...
  _proxy_self = bHYPRE_HGMRES__remoteCreate(_proxy_url, &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran77Symbol(bhypre_hgmres__wrapobj_f,BHYPRE_HGMRES__WRAPOBJ_F,bHYPRE_HGMRES__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_hgmres__connect_f,BHYPRE_HGMRES__CONNECT_F,bHYPRE_HGMRES__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
)
{
  ...
  _proxy_url =
    sidl_copy_fortran_str(SIDL_F77_STR(url),
      SIDL_F77_STR_LEN(url));
  _proxy_self = bHYPRE_HGMRES__remoteConnect(_proxy_url, 1, &_proxy_exception);
  if (_proxy_exception) {
    *exception = (ptrdiff_t)_proxy_exception;
  }
  else {
...
void
SIDLFortran77Symbol(bhypre_hgmres__cast_f,BHYPRE_HGMRES__CAST_F,bHYPRE_HGMRES__cast_f)
(
  int64_t *ref,
  int64_t *retval,
  int64_t *exception
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.HGMRES",
      (void*)bHYPRE_HGMRES__IHConnect, &proxy_exception);
...
void
SIDLFortran77Symbol(bhypre_hgmres__cast2_f,BHYPRE_HGMRES__CAST2_F,bHYPRE_HGMRES__cast2_f)
(
  int64_t *self,
...
{
  struct bHYPRE_HGMRES__epv *_epv = NULL;
  struct bHYPRE_HGMRES__object* _proxy_self = NULL;
...
void
SIDLFortran77Symbol(bhypre_hgmres__exec_f,BHYPRE_HGMRES__EXEC_F,bHYPRE_HGMRES__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_hgmres__geturl_f,BHYPRE_HGMRES__GETURL_F,bHYPRE_HGMRES__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_hgmres__isremote_f,BHYPRE_HGMRES__ISREMOTE_F,bHYPRE_HGMRES__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_hgmres__islocal_f,BHYPRE_HGMRES__ISLOCAL_F,bHYPRE_HGMRES__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_hgmres__set_hooks_f,BHYPRE_HGMRES__SET_HOOKS_F,bHYPRE_HGMRES__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_hgmres__set_hooks_static_f,BHYPRE_HGMRES__SET_HOOKS_STATIC_F,bHYPRE_HGMRES__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
{
  const struct bHYPRE_HGMRES__sepv *_epv = _getSEPV();
  sidl_bool _proxy_on;
  struct sidl_BaseInterface__object* _proxy_exception = NULL;
  _proxy_on = ((*on == SIDL_F77_TRUE) ? TRUE : FALSE);
...
void
SIDLFortran77Symbol(bhypre_hgmres_create_f,BHYPRE_HGMRES_CREATE_F,bHYPRE_HGMRES_Create_f)
(
  int64_t *mpi_comm,
  int64_t *retval,
  int64_t *exception
)
{
  ...
  struct bHYPRE_HGMRES__object* _proxy_retval = NULL;
  struct sidl_BaseInterface__object* _proxy_exception = NULL;
  _proxy_mpi_comm =
...
void
SIDLFortran77Symbol(bhypre_hgmres_addref_f,BHYPRE_HGMRES_ADDREF_F,bHYPRE_HGMRES_addRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_hgmres_deleteref_f,BHYPRE_HGMRES_DELETEREF_F,bHYPRE_HGMRES_deleteRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_hgmres_issame_f,BHYPRE_HGMRES_ISSAME_F,bHYPRE_HGMRES_isSame_f)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F77_Bool *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_istype_f,BHYPRE_HGMRES_ISTYPE_F,bHYPRE_HGMRES_isType_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_getclassinfo_f,BHYPRE_HGMRES_GETCLASSINFO_F,bHYPRE_HGMRES_getClassInfo_f)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_hgmres_setpreconditioner_f,BHYPRE_HGMRES_SETPRECONDITIONER_F,bHYPRE_HGMRES_SetPreconditioner_f)
(
  int64_t *self,
  int64_t *s,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_getpreconditioner_f,BHYPRE_HGMRES_GETPRECONDITIONER_F,bHYPRE_HGMRES_GetPreconditioner_f)
(
  int64_t *self,
  int64_t *s,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_clone_f,BHYPRE_HGMRES_CLONE_F,bHYPRE_HGMRES_Clone_f)
(
  int64_t *self,
  int64_t *x,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_setoperator_f,BHYPRE_HGMRES_SETOPERATOR_F,bHYPRE_HGMRES_SetOperator_f)
(
  int64_t *self,
  int64_t *A,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_settolerance_f,BHYPRE_HGMRES_SETTOLERANCE_F,bHYPRE_HGMRES_SetTolerance_f)
(
  int64_t *self,
  double *tolerance,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_setmaxiterations_f,BHYPRE_HGMRES_SETMAXITERATIONS_F,bHYPRE_HGMRES_SetMaxIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_hgmres_setlogging_f,BHYPRE_HGMRES_SETLOGGING_F,bHYPRE_HGMRES_SetLogging_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_setprintlevel_f,BHYPRE_HGMRES_SETPRINTLEVEL_F,bHYPRE_HGMRES_SetPrintLevel_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_getnumiterations_f,BHYPRE_HGMRES_GETNUMITERATIONS_F,bHYPRE_HGMRES_GetNumIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_hgmres_getrelresidualnorm_f,BHYPRE_HGMRES_GETRELRESIDUALNORM_F,bHYPRE_HGMRES_GetRelResidualNorm_f)
(
  int64_t *self,
  double *norm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_setcommunicator_f,BHYPRE_HGMRES_SETCOMMUNICATOR_F,bHYPRE_HGMRES_SetCommunicator_f)
(
  int64_t *self,
  int64_t *mpi_comm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_hgmres_destroy_f,BHYPRE_HGMRES_DESTROY_F,bHYPRE_HGMRES_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_hgmres_setintparameter_f,BHYPRE_HGMRES_SETINTPARAMETER_F,bHYPRE_HGMRES_SetIntParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_setdoubleparameter_f,BHYPRE_HGMRES_SETDOUBLEPARAMETER_F,bHYPRE_HGMRES_SetDoubleParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_setstringparameter_f,BHYPRE_HGMRES_SETSTRINGPARAMETER_F,bHYPRE_HGMRES_SetStringParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_setintarray1parameter_f,BHYPRE_HGMRES_SETINTARRAY1PARAMETER_F,bHYPRE_HGMRES_SetIntArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_setintarray2parameter_f,BHYPRE_HGMRES_SETINTARRAY2PARAMETER_F,bHYPRE_HGMRES_SetIntArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_setdoublearray1parameter_f,BHYPRE_HGMRES_SETDOUBLEARRAY1PARAMETER_F,bHYPRE_HGMRES_SetDoubleArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_setdoublearray2parameter_f,BHYPRE_HGMRES_SETDOUBLEARRAY2PARAMETER_F,bHYPRE_HGMRES_SetDoubleArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_getintvalue_f,BHYPRE_HGMRES_GETINTVALUE_F,bHYPRE_HGMRES_GetIntValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_getdoublevalue_f,BHYPRE_HGMRES_GETDOUBLEVALUE_F,bHYPRE_HGMRES_GetDoubleValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_hgmres_setup_f,BHYPRE_HGMRES_SETUP_F,bHYPRE_HGMRES_Setup_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_hgmres_apply_f,BHYPRE_HGMRES_APPLY_F,bHYPRE_HGMRES_Apply_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_hgmres_applyadjoint_f,BHYPRE_HGMRES_APPLYADJOINT_F,bHYPRE_HGMRES_ApplyAdjoint_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_createcol_f,
                  BHYPRE_HGMRES__ARRAY_CREATECOL_F,
                  bHYPRE_HGMRES__array_createCol_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_createrow_f,
                  BHYPRE_HGMRES__ARRAY_CREATEROW_F,
                  bHYPRE_HGMRES__array_createRow_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_create1d_f,
                  BHYPRE_HGMRES__ARRAY_CREATE1D_F,
                  bHYPRE_HGMRES__array_create1d_f)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_create2dcol_f,
                  BHYPRE_HGMRES__ARRAY_CREATE2DCOL_F,
                  bHYPRE_HGMRES__array_create2dCol_f)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_create2drow_f,
                  BHYPRE_HGMRES__ARRAY_CREATE2DROW_F,
                  bHYPRE_HGMRES__array_create2dRow_f)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_addref_f,
                  BHYPRE_HGMRES__ARRAY_ADDREF_F,
                  bHYPRE_HGMRES__array_addRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_deleteref_f,
                  BHYPRE_HGMRES__ARRAY_DELETEREF_F,
                  bHYPRE_HGMRES__array_deleteRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_get1_f,
                  BHYPRE_HGMRES__ARRAY_GET1_F,
                  bHYPRE_HGMRES__array_get1_f)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_get2_f,
                  BHYPRE_HGMRES__ARRAY_GET2_F,
                  bHYPRE_HGMRES__array_get2_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_get3_f,
                  BHYPRE_HGMRES__ARRAY_GET3_F,
                  bHYPRE_HGMRES__array_get3_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_get4_f,
                  BHYPRE_HGMRES__ARRAY_GET4_F,
                  bHYPRE_HGMRES__array_get4_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_get5_f,
                  BHYPRE_HGMRES__ARRAY_GET5_F,
                  bHYPRE_HGMRES__array_get5_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_get6_f,
                  BHYPRE_HGMRES__ARRAY_GET6_F,
                  bHYPRE_HGMRES__array_get6_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_get7_f,
                  BHYPRE_HGMRES__ARRAY_GET7_F,
                  bHYPRE_HGMRES__array_get7_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_get_f,
                  BHYPRE_HGMRES__ARRAY_GET_F,
                  bHYPRE_HGMRES__array_get_f)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_set1_f,
                  BHYPRE_HGMRES__ARRAY_SET1_F,
                  bHYPRE_HGMRES__array_set1_f)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_set2_f,
                  BHYPRE_HGMRES__ARRAY_SET2_F,
                  bHYPRE_HGMRES__array_set2_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_set3_f,
                  BHYPRE_HGMRES__ARRAY_SET3_F,
                  bHYPRE_HGMRES__array_set3_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_set4_f,
                  BHYPRE_HGMRES__ARRAY_SET4_F,
                  bHYPRE_HGMRES__array_set4_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_set5_f,
                  BHYPRE_HGMRES__ARRAY_SET5_F,
                  bHYPRE_HGMRES__array_set5_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_set6_f,
                  BHYPRE_HGMRES__ARRAY_SET6_F,
                  bHYPRE_HGMRES__array_set6_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_set7_f,
                  BHYPRE_HGMRES__ARRAY_SET7_F,
                  bHYPRE_HGMRES__array_set7_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_set_f,
                  BHYPRE_HGMRES__ARRAY_SET_F,
                  bHYPRE_HGMRES__array_set_f)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_dimen_f,
                  BHYPRE_HGMRES__ARRAY_DIMEN_F,
                  bHYPRE_HGMRES__array_dimen_f)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_lower_f,
                  BHYPRE_HGMRES__ARRAY_LOWER_F,
                  bHYPRE_HGMRES__array_lower_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_upper_f,
                  BHYPRE_HGMRES__ARRAY_UPPER_F,
                  bHYPRE_HGMRES__array_upper_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_length_f,
                  BHYPRE_HGMRES__ARRAY_LENGTH_F,
                  bHYPRE_HGMRES__array_length_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_stride_f,
                  BHYPRE_HGMRES__ARRAY_STRIDE_F,
                  bHYPRE_HGMRES__array_stride_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_iscolumnorder_f,
                  BHYPRE_HGMRES__ARRAY_ISCOLUMNORDER_F,
                  bHYPRE_HGMRES__array_isColumnOrder_f)
  (int64_t *array,
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_isroworder_f,
                  BHYPRE_HGMRES__ARRAY_ISROWORDER_F,
                  bHYPRE_HGMRES__array_isRowOrder_f)
  (int64_t *array,
   SIDL_F77_Bool *result)
{
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_copy_f,
                  BHYPRE_HGMRES__ARRAY_COPY_F,
                  bHYPRE_HGMRES__array_copy_f)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_smartcopy_f,
                  BHYPRE_HGMRES__ARRAY_SMARTCOPY_F,
                  bHYPRE_HGMRES__array_smartCopy_f)
  (int64_t *src)
{
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_slice_f,
                  BHYPRE_HGMRES__ARRAY_SLICE_F,
                  bHYPRE_HGMRES__array_slice_f)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
...
void
SIDLFortran77Symbol(bhypre_hgmres__array_ensure_f,
                  BHYPRE_HGMRES__ARRAY_ENSURE_F,
                  bHYPRE_HGMRES__array_ensure_f)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct bHYPRE_HGMRES__remote*)self->d_data)->d_ih, _ex);
  }
  ...
  struct bHYPRE_HGMRES__object* self, sidl_BaseInterface* _ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct 
    bHYPRE_HGMRES__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_bHYPRE_HGMRES__raddRef(
  struct bHYPRE_HGMRES__object* self,sidl_BaseInterface* _ex)
{
...
static sidl_bool
remote_bHYPRE_HGMRES__isRemote(
    struct bHYPRE_HGMRES__object* self, 
    sidl_BaseInterface *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_bHYPRE_HGMRES__set_hooks(
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES._set_hooks.", &throwaway_exception);
...
static void remote_bHYPRE_HGMRES__exec(
  struct bHYPRE_HGMRES__object* self,const char* methodName,
  ...
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    struct bHYPRE_HGMRES__remote* r_obj = (struct 
      bHYPRE_HGMRES__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.isSame.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.isType.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.getClassInfo.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetPreconditioner.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.GetPreconditioner.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.Clone.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetOperator.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetTolerance.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetMaxIterations.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetLogging.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetPrintLevel.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.GetNumIterations.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.GetRelResidualNorm.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetCommunicator.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.Destroy.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetIntParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetDoubleParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetStringParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetIntArray1Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetIntArray2Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetDoubleArray1Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.SetDoubleArray2Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.GetIntValue.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.GetDoubleValue.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.Setup.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.Apply.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.HGMRES.ApplyAdjoint.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void bHYPRE_HGMRES__init_remote_epv(void)
{
  ...
  epv->f__raddRef                      = remote_bHYPRE_HGMRES__raddRef;
  epv->f__isRemote                     = remote_bHYPRE_HGMRES__isRemote;
  epv->f__set_hooks                    = remote_bHYPRE_HGMRES__set_hooks;
  epv->f__ctor                         = NULL;
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  ...
  epv->f_Destroy                       = remote_bHYPRE_HGMRES_Destroy;
...
bHYPRE_HGMRES__remoteConnect(const char *url, sidl_bool ar,
  sidl_BaseInterface *_ex)
{
  struct bHYPRE_HGMRES__object* self;
  ...
  struct bHYPRE_HGMRES__remote* r_obj;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    return bHYPRE_HGMRES__rmicast(bi,_ex);SIDL_CHECK(*_ex);
  }
  ...
  r_obj =
    (struct bHYPRE_HGMRES__remote*) malloc(
      sizeof(struct bHYPRE_HGMRES__remote));
...
static struct bHYPRE_HGMRES__object*
bHYPRE_HGMRES__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.HGMRES",
    _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_HGMRES__object*) malloc(
...
bHYPRE_HGMRES__rmicast(
  ...
  sidl_BaseInterface* _ex)
{
  struct bHYPRE_HGMRES__object* cast = NULL;

  *_ex = NULL;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.HGMRES",
      (void*)bHYPRE_HGMRES__IHConnect, _ex);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    struct sidl_BaseInterface__object* base = (struct 
      sidl_BaseInterface__object*) obj;
    cast = (struct bHYPRE_HGMRES__object*) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.HGMRES", _ex); SIDL_CHECK(*_ex);
  }
...
bHYPRE_HGMRES__connectI(const char* url, sidl_bool ar,
  struct sidl_BaseInterface__object **_ex)
{
  return bHYPRE_HGMRES__remoteConnect(url, ar, _ex);
}
