 ...
 * Revision:      @(#) $Id: sidl_DFinder_fStub.c,v 1.29 2007/09/27 19:56:34 painter Exp $
...
static struct sidl_DFinder__object* sidl_DFinder__remoteCreate(const char* url, 
...
void
SIDLFortran77Symbol(sidl_dfinder__createremote_f,SIDL_DFINDER__CREATEREMOTE_F,sidl_DFinder__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
)
{
  ...
  _proxy_self = sidl_DFinder__remoteCreate(_proxy_url, &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran77Symbol(sidl_dfinder__connect_f,SIDL_DFINDER__CONNECT_F,sidl_DFinder__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
)
{
  ...
  _proxy_url =
    sidl_copy_fortran_str(SIDL_F77_STR(url),(ptrdiff_t)
      SIDL_F77_STR_LEN(url));
  _proxy_self = sidl_DFinder__remoteConnect(_proxy_url, 1, &_proxy_exception);
  if (_proxy_exception) {
    *exception = (ptrdiff_t)_proxy_exception;
  }
  else {
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.DFinder", (
      void*)sidl_DFinder__IHConnect, &proxy_exception);
...
void
SIDLFortran77Symbol(sidl_dfinder__exec_f,SIDL_DFINDER__EXEC_F,sidl_DFinder__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_dfinder__geturl_f,SIDL_DFINDER__GETURL_F,sidl_DFinder__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_dfinder__isremote_f,SIDL_DFINDER__ISREMOTE_F,sidl_DFinder__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_dfinder__islocal_f,SIDL_DFINDER__ISLOCAL_F,sidl_DFinder__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(sidl_dfinder__set_hooks_f,SIDL_DFINDER__SET_HOOKS_F,sidl_DFinder__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
)
{
  ...
  _proxy_self =
    ...
    (ptrdiff_t)(*self);
  _proxy_sidl_name =
    sidl_copy_fortran_str(SIDL_F77_STR(sidl_name),(ptrdiff_t)
      SIDL_F77_STR_LEN(sidl_name));
  _proxy_target =
    sidl_copy_fortran_str(SIDL_F77_STR(target),(ptrdiff_t)
...
)
{
  ...
  _proxy_self =
    ...
    (ptrdiff_t)(*self);
  _proxy_path_name =
    sidl_copy_fortran_str(SIDL_F77_STR(path_name),(ptrdiff_t)
...
)
{
  ...
  _proxy_path_fragment =
    sidl_copy_fortran_str(SIDL_F77_STR(path_fragment),(ptrdiff_t)
