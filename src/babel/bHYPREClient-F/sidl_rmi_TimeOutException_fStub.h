/*
 * File:          sidl_rmi_TimeOutException_fStub.h
 * Symbol:        sidl.rmi.TimeOutException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V1-13-0b $
 * Revision:      @(#) $Id: sidl_rmi_TimeOutException_fStub.h,v 1.2 2006/09/14 21:51:54 painter Exp $
 * Description:   Client-side documentation text for sidl.rmi.TimeOutException
 * 
...
#define included_sidl_rmi_TimeOutException_fStub_h
