...
#define included_bHYPRE_BiCGSTAB_IOR_h
...
struct bHYPRE_BiCGSTAB__sepv {
  ...
  /* Methods introduced in bHYPRE.BiCGSTAB-v1.0.0 */
  struct bHYPRE_BiCGSTAB__object* (*f_Create)(
...
struct bHYPRE_BiCGSTAB__controls {
  int     use_hooks;
};
/*
...
struct bHYPRE_BiCGSTAB__object {
  ...
  struct bHYPRE_BiCGSTAB__epv*               d_epv;
  void*                                      d_data;
};

struct bHYPRE_BiCGSTAB__external {
  struct bHYPRE_BiCGSTAB__object*
...
bHYPRE_BiCGSTAB__new(void* ddata,struct sidl_BaseInterface__object ** _ex);

extern struct bHYPRE_BiCGSTAB__sepv*
bHYPRE_BiCGSTAB__statics(void);

extern void bHYPRE_BiCGSTAB__init(
  struct bHYPRE_BiCGSTAB__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void bHYPRE_BiCGSTAB__getEPVs(
  ...
  struct bHYPRE_BiCGSTAB__epv **s_arg_epv__bhypre_bicgstab,
    struct bHYPRE_BiCGSTAB__epv **s_arg_epv_hooks__bhypre_bicgstab);
  extern void bHYPRE_BiCGSTAB__fini(
    struct bHYPRE_BiCGSTAB__object* self,
      struct sidl_BaseInterface__object ** _ex);
  extern void bHYPRE_BiCGSTAB__IOR_version(int32_t *major, int32_t *minor);

  struct bHYPRE_BiCGSTAB__object* 
    skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_BiCGSTAB(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_BiCGSTAB__object* 
    skel_bHYPRE_BiCGSTAB_fcast_bHYPRE_BiCGSTAB(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Operator(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_BiCGSTAB_fcast_bHYPRE_Operator(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Solver__object* 
    skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Solver(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Solver__object* skel_bHYPRE_BiCGSTAB_fcast_bHYPRE_Solver(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_Vector__object* 
    skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Vector(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Vector__object* skel_bHYPRE_BiCGSTAB_fcast_bHYPRE_Vector(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_BaseClass__object* 
    skel_bHYPRE_BiCGSTAB_fconnect_sidl_BaseClass(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* skel_bHYPRE_BiCGSTAB_fcast_sidl_BaseClass(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_BaseInterface__object* 
    skel_bHYPRE_BiCGSTAB_fconnect_sidl_BaseInterface(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_BiCGSTAB_fcast_sidl_BaseInterface(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct sidl_ClassInfo__object* 
    skel_bHYPRE_BiCGSTAB_fconnect_sidl_ClassInfo(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_BiCGSTAB_fcast_sidl_RuntimeException(void *bi,
    struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_BiCGSTAB__remote{
    int d_refcount;
