...
#include "bHYPRE_BoomerAMG_fStub.h"
#endif
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
...
static struct bHYPRE_BoomerAMG__object* bHYPRE_BoomerAMG__remoteCreate(const 
  char* url, sidl_BaseInterface *_ex);
static struct bHYPRE_BoomerAMG__object* bHYPRE_BoomerAMG__remoteConnect(const 
  char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct bHYPRE_BoomerAMG__object* bHYPRE_BoomerAMG__IHConnect(struct 
...
#else
    _ior = (struct bHYPRE_BoomerAMG__external*)sidl_dynamicLoadIOR(
      "bHYPRE.BoomerAMG","bHYPRE_BoomerAMG__externals") ;
    sidl_checkIORVersion("bHYPRE.BoomerAMG", _ior->d_ior_major_version, 
...
static const struct bHYPRE_BoomerAMG__sepv* _getSEPV(void)
{
  static const struct bHYPRE_BoomerAMG__sepv *_sepv = NULL;
  if (!_sepv) {
...
void
SIDLFortran77Symbol(bhypre_boomeramg__createremote_f,BHYPRE_BOOMERAMG__CREATEREMOTE_F,bHYPRE_BoomerAMG__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
)
{
  ...
  _proxy_self = bHYPRE_BoomerAMG__remoteCreate(_proxy_url, &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran77Symbol(bhypre_boomeramg__wrapobj_f,BHYPRE_BOOMERAMG__WRAPOBJ_F,bHYPRE_BoomerAMG__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_boomeramg__connect_f,BHYPRE_BOOMERAMG__CONNECT_F,bHYPRE_BoomerAMG__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
)
{
  ...
  _proxy_url =
    sidl_copy_fortran_str(SIDL_F77_STR(url),(ptrdiff_t)
      SIDL_F77_STR_LEN(url));
  _proxy_self = bHYPRE_BoomerAMG__remoteConnect(_proxy_url, 1, 
    &_proxy_exception);
  if (_proxy_exception) {
    *exception = (ptrdiff_t)_proxy_exception;
  }
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.BoomerAMG", (
      void*)bHYPRE_BoomerAMG__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "bHYPRE.BoomerAMG", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran77Symbol(bhypre_boomeramg__exec_f,BHYPRE_BOOMERAMG__EXEC_F,bHYPRE_BoomerAMG__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_boomeramg__geturl_f,BHYPRE_BOOMERAMG__GETURL_F,bHYPRE_BoomerAMG__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_boomeramg__isremote_f,BHYPRE_BOOMERAMG__ISREMOTE_F,bHYPRE_BoomerAMG__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_boomeramg__islocal_f,BHYPRE_BOOMERAMG__ISLOCAL_F,bHYPRE_BoomerAMG__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_boomeramg__set_hooks_f,BHYPRE_BOOMERAMG__SET_HOOKS_F,bHYPRE_BoomerAMG__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_boomeramg__set_hooks_static_f,BHYPRE_BOOMERAMG__SET_HOOKS_STATIC_F,bHYPRE_BoomerAMG__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_boomeramg_destroy_f,BHYPRE_BOOMERAMG_DESTROY_F,bHYPRE_BoomerAMG_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_boomeramg_applyadjoint_f,BHYPRE_BOOMERAMG_APPLYADJOINT_F,bHYPRE_BoomerAMG_ApplyAdjoint_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct 
      bHYPRE_BoomerAMG__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation( _conn, 
      "SetLevelRelaxWt", _ex ); SIDL_CHECK(*_ex);

    /* pack in and inout arguments */
    sidl_rmi_Invocation_packDouble( _inv, "relax_wt", relax_wt, _ex);SIDL_CHECK(
      *_ex);
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct 
      bHYPRE_BoomerAMG__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation( _conn, 
      "InitGridRelaxation", _ex ); SIDL_CHECK(*_ex);
...
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.BoomerAMG.InitGridRelaxation.", &throwaway_exception);
    ...
    /* unpack out and inout arguments */
    sidl_rmi_Response_unpackIntArray( _rsvp, "num_grid_sweeps", num_grid_sweeps,
      sidl_column_major_order,1,FALSE, _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Response_unpackIntArray( _rsvp, "grid_relax_type", grid_relax_type,
      sidl_column_major_order,1,FALSE, _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Response_unpackIntArray( _rsvp, "grid_relax_points", 
      grid_relax_points,sidl_column_major_order,2,FALSE, _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Response_unpackDoubleArray( _rsvp, "relax_weights", relax_weights,
      sidl_column_major_order,1,FALSE, _ex);SIDL_CHECK(*_ex);
