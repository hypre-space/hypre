...
void
SIDLFortran77Symbol(bhypre_cgnr__create_f,BHYPRE_CGNR__CREATE_F,bHYPRE_CGNR__create_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_cgnr__createremote_f,BHYPRE_CGNR__CREATEREMOTE_F,bHYPRE_CGNR__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_cgnr__wrapobj_f,BHYPRE_CGNR__WRAPOBJ_F,bHYPRE_CGNR__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_cgnr__connect_f,BHYPRE_CGNR__CONNECT_F,bHYPRE_CGNR__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_cgnr__cast_f,BHYPRE_CGNR__CAST_F,bHYPRE_CGNR__cast_f)
(
  int64_t *ref,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_cgnr__cast2_f,BHYPRE_CGNR__CAST2_F,bHYPRE_CGNR__cast2_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_cgnr__exec_f,BHYPRE_CGNR__EXEC_F,bHYPRE_CGNR__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_cgnr__geturl_f,BHYPRE_CGNR__GETURL_F,bHYPRE_CGNR__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_cgnr__isremote_f,BHYPRE_CGNR__ISREMOTE_F,bHYPRE_CGNR__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_cgnr__islocal_f,BHYPRE_CGNR__ISLOCAL_F,bHYPRE_CGNR__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_cgnr__set_hooks_f,BHYPRE_CGNR__SET_HOOKS_F,bHYPRE_CGNR__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_cgnr__set_hooks_static_f,BHYPRE_CGNR__SET_HOOKS_STATIC_F,bHYPRE_CGNR__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_cgnr_create_f,BHYPRE_CGNR_CREATE_F,bHYPRE_CGNR_Create_f)
(
  int64_t *mpi_comm,
  int64_t *A,
  int64_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_addref_f,BHYPRE_CGNR_ADDREF_F,bHYPRE_CGNR_addRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_cgnr_deleteref_f,BHYPRE_CGNR_DELETEREF_F,bHYPRE_CGNR_deleteRef_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_cgnr_issame_f,BHYPRE_CGNR_ISSAME_F,bHYPRE_CGNR_isSame_f)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F77_Bool *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_istype_f,BHYPRE_CGNR_ISTYPE_F,bHYPRE_CGNR_isType_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_getclassinfo_f,BHYPRE_CGNR_GETCLASSINFO_F,bHYPRE_CGNR_getClassInfo_f)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_cgnr_setpreconditioner_f,BHYPRE_CGNR_SETPRECONDITIONER_F,bHYPRE_CGNR_SetPreconditioner_f)
(
  int64_t *self,
  int64_t *s,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_getpreconditioner_f,BHYPRE_CGNR_GETPRECONDITIONER_F,bHYPRE_CGNR_GetPreconditioner_f)
(
  int64_t *self,
  int64_t *s,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_clone_f,BHYPRE_CGNR_CLONE_F,bHYPRE_CGNR_Clone_f)
(
  int64_t *self,
  int64_t *x,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_setoperator_f,BHYPRE_CGNR_SETOPERATOR_F,bHYPRE_CGNR_SetOperator_f)
(
  int64_t *self,
  int64_t *A,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_settolerance_f,BHYPRE_CGNR_SETTOLERANCE_F,bHYPRE_CGNR_SetTolerance_f)
(
  int64_t *self,
  double *tolerance,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_setmaxiterations_f,BHYPRE_CGNR_SETMAXITERATIONS_F,bHYPRE_CGNR_SetMaxIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_cgnr_setlogging_f,BHYPRE_CGNR_SETLOGGING_F,bHYPRE_CGNR_SetLogging_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_setprintlevel_f,BHYPRE_CGNR_SETPRINTLEVEL_F,bHYPRE_CGNR_SetPrintLevel_f)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_getnumiterations_f,BHYPRE_CGNR_GETNUMITERATIONS_F,bHYPRE_CGNR_GetNumIterations_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_cgnr_getrelresidualnorm_f,BHYPRE_CGNR_GETRELRESIDUALNORM_F,bHYPRE_CGNR_GetRelResidualNorm_f)
(
  int64_t *self,
  double *norm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_setcommunicator_f,BHYPRE_CGNR_SETCOMMUNICATOR_F,bHYPRE_CGNR_SetCommunicator_f)
(
  int64_t *self,
  int64_t *mpi_comm,
  int32_t *retval,
...
void
SIDLFortran77Symbol(bhypre_cgnr_destroy_f,BHYPRE_CGNR_DESTROY_F,bHYPRE_CGNR_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_cgnr_setintparameter_f,BHYPRE_CGNR_SETINTPARAMETER_F,bHYPRE_CGNR_SetIntParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_setdoubleparameter_f,BHYPRE_CGNR_SETDOUBLEPARAMETER_F,bHYPRE_CGNR_SetDoubleParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_setstringparameter_f,BHYPRE_CGNR_SETSTRINGPARAMETER_F,bHYPRE_CGNR_SetStringParameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_setintarray1parameter_f,BHYPRE_CGNR_SETINTARRAY1PARAMETER_F,bHYPRE_CGNR_SetIntArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_setintarray2parameter_f,BHYPRE_CGNR_SETINTARRAY2PARAMETER_F,bHYPRE_CGNR_SetIntArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_setdoublearray1parameter_f,BHYPRE_CGNR_SETDOUBLEARRAY1PARAMETER_F,bHYPRE_CGNR_SetDoubleArray1Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_setdoublearray2parameter_f,BHYPRE_CGNR_SETDOUBLEARRAY2PARAMETER_F,bHYPRE_CGNR_SetDoubleArray2Parameter_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_getintvalue_f,BHYPRE_CGNR_GETINTVALUE_F,bHYPRE_CGNR_GetIntValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_getdoublevalue_f,BHYPRE_CGNR_GETDOUBLEVALUE_F,bHYPRE_CGNR_GetDoubleValue_f)
(
  int64_t *self,
  SIDL_F77_String name
  SIDL_F77_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran77Symbol(bhypre_cgnr_setup_f,BHYPRE_CGNR_SETUP_F,bHYPRE_CGNR_Setup_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_cgnr_apply_f,BHYPRE_CGNR_APPLY_F,bHYPRE_CGNR_Apply_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_cgnr_applyadjoint_f,BHYPRE_CGNR_APPLYADJOINT_F,bHYPRE_CGNR_ApplyAdjoint_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_createcol_f,
                  BHYPRE_CGNR__ARRAY_CREATECOL_F,
                  bHYPRE_CGNR__array_createCol_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_createrow_f,
                  BHYPRE_CGNR__ARRAY_CREATEROW_F,
                  bHYPRE_CGNR__array_createRow_f)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_create1d_f,
                  BHYPRE_CGNR__ARRAY_CREATE1D_F,
                  bHYPRE_CGNR__array_create1d_f)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_create2dcol_f,
                  BHYPRE_CGNR__ARRAY_CREATE2DCOL_F,
                  bHYPRE_CGNR__array_create2dCol_f)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_create2drow_f,
                  BHYPRE_CGNR__ARRAY_CREATE2DROW_F,
                  bHYPRE_CGNR__array_create2dRow_f)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_addref_f,
                  BHYPRE_CGNR__ARRAY_ADDREF_F,
                  bHYPRE_CGNR__array_addRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_deleteref_f,
                  BHYPRE_CGNR__ARRAY_DELETEREF_F,
                  bHYPRE_CGNR__array_deleteRef_f)
  (int64_t *array)
{
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_get1_f,
                  BHYPRE_CGNR__ARRAY_GET1_F,
                  bHYPRE_CGNR__array_get1_f)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_get2_f,
                  BHYPRE_CGNR__ARRAY_GET2_F,
                  bHYPRE_CGNR__array_get2_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_get3_f,
                  BHYPRE_CGNR__ARRAY_GET3_F,
                  bHYPRE_CGNR__array_get3_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_get4_f,
                  BHYPRE_CGNR__ARRAY_GET4_F,
                  bHYPRE_CGNR__array_get4_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_get5_f,
                  BHYPRE_CGNR__ARRAY_GET5_F,
                  bHYPRE_CGNR__array_get5_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_get6_f,
                  BHYPRE_CGNR__ARRAY_GET6_F,
                  bHYPRE_CGNR__array_get6_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_get7_f,
                  BHYPRE_CGNR__ARRAY_GET7_F,
                  bHYPRE_CGNR__array_get7_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_get_f,
                  BHYPRE_CGNR__ARRAY_GET_F,
                  bHYPRE_CGNR__array_get_f)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_set1_f,
                  BHYPRE_CGNR__ARRAY_SET1_F,
                  bHYPRE_CGNR__array_set1_f)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_set2_f,
                  BHYPRE_CGNR__ARRAY_SET2_F,
                  bHYPRE_CGNR__array_set2_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_set3_f,
                  BHYPRE_CGNR__ARRAY_SET3_F,
                  bHYPRE_CGNR__array_set3_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_set4_f,
                  BHYPRE_CGNR__ARRAY_SET4_F,
                  bHYPRE_CGNR__array_set4_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_set5_f,
                  BHYPRE_CGNR__ARRAY_SET5_F,
                  bHYPRE_CGNR__array_set5_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_set6_f,
                  BHYPRE_CGNR__ARRAY_SET6_F,
                  bHYPRE_CGNR__array_set6_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_set7_f,
                  BHYPRE_CGNR__ARRAY_SET7_F,
                  bHYPRE_CGNR__array_set7_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_set_f,
                  BHYPRE_CGNR__ARRAY_SET_F,
                  bHYPRE_CGNR__array_set_f)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_dimen_f,
                  BHYPRE_CGNR__ARRAY_DIMEN_F,
                  bHYPRE_CGNR__array_dimen_f)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_lower_f,
                  BHYPRE_CGNR__ARRAY_LOWER_F,
                  bHYPRE_CGNR__array_lower_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_upper_f,
                  BHYPRE_CGNR__ARRAY_UPPER_F,
                  bHYPRE_CGNR__array_upper_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_length_f,
                  BHYPRE_CGNR__ARRAY_LENGTH_F,
                  bHYPRE_CGNR__array_length_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_stride_f,
                  BHYPRE_CGNR__ARRAY_STRIDE_F,
                  bHYPRE_CGNR__array_stride_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_iscolumnorder_f,
                  BHYPRE_CGNR__ARRAY_ISCOLUMNORDER_F,
                  bHYPRE_CGNR__array_isColumnOrder_f)
  (int64_t *array,
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_isroworder_f,
                  BHYPRE_CGNR__ARRAY_ISROWORDER_F,
                  bHYPRE_CGNR__array_isRowOrder_f)
  (int64_t *array,
   SIDL_F77_Bool *result)
{
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_copy_f,
                  BHYPRE_CGNR__ARRAY_COPY_F,
                  bHYPRE_CGNR__array_copy_f)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_smartcopy_f,
                  BHYPRE_CGNR__ARRAY_SMARTCOPY_F,
                  bHYPRE_CGNR__array_smartCopy_f)
  (int64_t *src)
{
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_slice_f,
                  BHYPRE_CGNR__ARRAY_SLICE_F,
                  bHYPRE_CGNR__array_slice_f)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
...
void
SIDLFortran77Symbol(bhypre_cgnr__array_ensure_f,
                  BHYPRE_CGNR__ARRAY_ENSURE_F,
                  bHYPRE_CGNR__array_ensure_f)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
