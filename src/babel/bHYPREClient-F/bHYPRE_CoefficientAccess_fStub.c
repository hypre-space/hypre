...
void
SIDLFortran77Symbol(bhypre_coefficientaccess__connect_f,BHYPRE_COEFFICIENTACCESS__CONNECT_F,bHYPRE_CoefficientAccess__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_coefficientaccess__exec_f,BHYPRE_COEFFICIENTACCESS__EXEC_F,bHYPRE_CoefficientAccess__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_coefficientaccess__geturl_f,BHYPRE_COEFFICIENTACCESS__GETURL_F,bHYPRE_CoefficientAccess__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_coefficientaccess__isremote_f,BHYPRE_COEFFICIENTACCESS__ISREMOTE_F,bHYPRE_CoefficientAccess__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_coefficientaccess__islocal_f,BHYPRE_COEFFICIENTACCESS__ISLOCAL_F,bHYPRE_CoefficientAccess__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_coefficientaccess__set_hooks_f,BHYPRE_COEFFICIENTACCESS__SET_HOOKS_F,bHYPRE_CoefficientAccess__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
