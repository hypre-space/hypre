...
void
SIDLFortran77Symbol(bhypre_structgrid__createremote_f,BHYPRE_STRUCTGRID__CREATEREMOTE_F,bHYPRE_StructGrid__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_structgrid__wrapobj_f,BHYPRE_STRUCTGRID__WRAPOBJ_F,bHYPRE_StructGrid__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_structgrid__connect_f,BHYPRE_STRUCTGRID__CONNECT_F,bHYPRE_StructGrid__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_structgrid__exec_f,BHYPRE_STRUCTGRID__EXEC_F,bHYPRE_StructGrid__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structgrid__geturl_f,BHYPRE_STRUCTGRID__GETURL_F,bHYPRE_StructGrid__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structgrid__isremote_f,BHYPRE_STRUCTGRID__ISREMOTE_F,bHYPRE_StructGrid__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structgrid__islocal_f,BHYPRE_STRUCTGRID__ISLOCAL_F,bHYPRE_StructGrid__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_structgrid__set_hooks_f,BHYPRE_STRUCTGRID__SET_HOOKS_F,bHYPRE_StructGrid__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_structgrid__set_hooks_static_f,BHYPRE_STRUCTGRID__SET_HOOKS_STATIC_F,bHYPRE_StructGrid__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_structgrid_destroy_f,BHYPRE_STRUCTGRID_DESTROY_F,bHYPRE_StructGrid_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
