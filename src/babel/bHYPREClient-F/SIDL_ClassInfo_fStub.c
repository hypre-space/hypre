 ...
 * Revision:      @(#) $Id: sidl_ClassInfo_fStub.c,v 1.40 2007/09/27 19:56:34 painter Exp $
...
static struct sidl_ClassInfo__object*
sidl_ClassInfo__remoteConnect(const char *url, sidl_bool ar, sidl_BaseInterface 
  *_ex)
{
  struct sidl__ClassInfo__object* self;
...
static struct sidl_ClassInfo__object*
sidl_ClassInfo__IHConnect(sidl_rmi_InstanceHandle instance, sidl_BaseInterface 
  *_ex)
{
  struct sidl__ClassInfo__object* self;
