/*
 * File:          sidl_rmi_TicketBook_fStub.h
 * Symbol:        sidl.rmi.TicketBook-v0.9.15
 * Symbol Type:   interface
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_rmi_TicketBook_fStub.h,v 1.2 2006/09/14 21:51:54 painter Exp $
 * Description:   Client-side documentation text for sidl.rmi.TicketBook
 * 
...
#define included_sidl_rmi_TicketBook_fStub_h
