...
void
SIDLFortran77Symbol(bhypre_structvectorview__connect_f,BHYPRE_STRUCTVECTORVIEW__CONNECT_F,bHYPRE_StructVectorView__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
...
)
{
  ...
  _proxy_self = bHYPRE_StructVectorView__remoteConnect(_proxy_url, 1, 
    &_proxy_exception);
  if (_proxy_exception) {
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.StructVectorView", (
      void*)bHYPRE_StructVectorView__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "bHYPRE.StructVectorView", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran77Symbol(bhypre_structvectorview__exec_f,BHYPRE_STRUCTVECTORVIEW__EXEC_F,bHYPRE_StructVectorView__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structvectorview__geturl_f,BHYPRE_STRUCTVECTORVIEW__GETURL_F,bHYPRE_StructVectorView__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structvectorview__isremote_f,BHYPRE_STRUCTVECTORVIEW__ISREMOTE_F,bHYPRE_StructVectorView__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structvectorview__islocal_f,BHYPRE_STRUCTVECTORVIEW__ISLOCAL_F,bHYPRE_StructVectorView__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_structvectorview__set_hooks_f,BHYPRE_STRUCTVECTORVIEW__SET_HOOKS_F,bHYPRE_StructVectorView__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_structvectorview_destroy_f,BHYPRE_STRUCTVECTORVIEW_DESTROY_F,bHYPRE_StructVectorView_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
