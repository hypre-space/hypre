...
#else
    _ior = (struct bHYPRE_StructSMG__external*)sidl_dynamicLoadIOR(
...
void
SIDLFortran77Symbol(bhypre_structsmg__createremote_f,BHYPRE_STRUCTSMG__CREATEREMOTE_F,bHYPRE_StructSMG__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(bhypre_structsmg__wrapobj_f,BHYPRE_STRUCTSMG__WRAPOBJ_F,bHYPRE_StructSMG__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_structsmg__connect_f,BHYPRE_STRUCTSMG__CONNECT_F,bHYPRE_StructSMG__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(bhypre_structsmg__exec_f,BHYPRE_STRUCTSMG__EXEC_F,bHYPRE_StructSMG__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structsmg__geturl_f,BHYPRE_STRUCTSMG__GETURL_F,bHYPRE_StructSMG__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structsmg__isremote_f,BHYPRE_STRUCTSMG__ISREMOTE_F,bHYPRE_StructSMG__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_structsmg__islocal_f,BHYPRE_STRUCTSMG__ISLOCAL_F,bHYPRE_StructSMG__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_structsmg__set_hooks_f,BHYPRE_STRUCTSMG__SET_HOOKS_F,bHYPRE_StructSMG__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_structsmg__set_hooks_static_f,BHYPRE_STRUCTSMG__SET_HOOKS_STATIC_F,bHYPRE_StructSMG__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_structsmg_create_f,BHYPRE_STRUCTSMG_CREATE_F,bHYPRE_StructSMG_Create_f)
(
  int64_t *mpi_comm,
  int64_t *A,
  int64_t *retval,
...
void
SIDLFortran77Symbol(bhypre_structsmg_destroy_f,BHYPRE_STRUCTSMG_DESTROY_F,bHYPRE_StructSMG_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_structsmg_applyadjoint_f,BHYPRE_STRUCTSMG_APPLYADJOINT_F,bHYPRE_StructSMG_ApplyAdjoint_f)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
