...
#include "bHYPRE_SStructMatrix_fStub.h"
#endif
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
...
static struct bHYPRE_SStructMatrix__object* bHYPRE_SStructMatrix__remoteCreate(
...
#else
    _ior = (struct bHYPRE_SStructMatrix__external*)sidl_dynamicLoadIOR(
      "bHYPRE.SStructMatrix","bHYPRE_SStructMatrix__externals") ;
    sidl_checkIORVersion("bHYPRE.SStructMatrix", _ior->d_ior_major_version, 
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__createremote_f,BHYPRE_SSTRUCTMATRIX__CREATEREMOTE_F,bHYPRE_SStructMatrix__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
)
{
  ...
  _proxy_self = bHYPRE_SStructMatrix__remoteCreate(_proxy_url, 
    &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__wrapobj_f,BHYPRE_SSTRUCTMATRIX__WRAPOBJ_F,bHYPRE_SStructMatrix__wrapObj_f)
(
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__connect_f,BHYPRE_SSTRUCTMATRIX__CONNECT_F,bHYPRE_SStructMatrix__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
)
{
  ...
  _proxy_url =
    sidl_copy_fortran_str(SIDL_F77_STR(url),(ptrdiff_t)
      SIDL_F77_STR_LEN(url));
  _proxy_self = bHYPRE_SStructMatrix__remoteConnect(_proxy_url, 1, 
    &_proxy_exception);
  if (_proxy_exception) {
    *exception = (ptrdiff_t)_proxy_exception;
  }
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.SStructMatrix", (
      void*)bHYPRE_SStructMatrix__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "bHYPRE.SStructMatrix", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__exec_f,BHYPRE_SSTRUCTMATRIX__EXEC_F,bHYPRE_SStructMatrix__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__geturl_f,BHYPRE_SSTRUCTMATRIX__GETURL_F,bHYPRE_SStructMatrix__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__isremote_f,BHYPRE_SSTRUCTMATRIX__ISREMOTE_F,bHYPRE_SStructMatrix__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__islocal_f,BHYPRE_SSTRUCTMATRIX__ISLOCAL_F,bHYPRE_SStructMatrix__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__set_hooks_f,BHYPRE_SSTRUCTMATRIX__SET_HOOKS_F,bHYPRE_SStructMatrix__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix__set_hooks_static_f,BHYPRE_SSTRUCTMATRIX__SET_HOOKS_STATIC_F,bHYPRE_SStructMatrix__set_hooks_static_f)
(
  SIDL_F77_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran77Symbol(bhypre_sstructmatrix_destroy_f,BHYPRE_SSTRUCTMATRIX_DESTROY_F,bHYPRE_SStructMatrix_Destroy_f)
(
  int64_t *self,
  int64_t *exception
)
