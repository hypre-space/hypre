 ...
 * Revision:      @(#) $Id: sidl_SIDLException_fStub.c,v 1.39 2007/09/27 19:56:35 painter Exp $
...
static struct sidl_SIDLException__object* sidl_SIDLException__remoteCreate(
  const char* url, sidl_BaseInterface *_ex);
static struct sidl_SIDLException__object* sidl_SIDLException__remoteConnect(
...
void
SIDLFortran77Symbol(sidl_sidlexception__createremote_f,SIDL_SIDLEXCEPTION__CREATEREMOTE_F,sidl_SIDLException__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(sidl_sidlexception__connect_f,SIDL_SIDLEXCEPTION__CONNECT_F,sidl_SIDLException__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(sidl_sidlexception__exec_f,SIDL_SIDLEXCEPTION__EXEC_F,sidl_SIDLException__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_sidlexception__geturl_f,SIDL_SIDLEXCEPTION__GETURL_F,sidl_SIDLException__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_sidlexception__isremote_f,SIDL_SIDLEXCEPTION__ISREMOTE_F,sidl_SIDLException__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_sidlexception__islocal_f,SIDL_SIDLEXCEPTION__ISLOCAL_F,sidl_SIDLException__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(sidl_sidlexception__set_hooks_f,SIDL_SIDLEXCEPTION__SET_HOOKS_F,sidl_SIDLException__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(sidl_sidlexception_packobj_f,SIDL_SIDLEXCEPTION_PACKOBJ_F,sidl_SIDLException_packObj_f)
(
  int64_t *self,
  int64_t *ser,
  int64_t *exception
...
void
SIDLFortran77Symbol(sidl_sidlexception_unpackobj_f,SIDL_SIDLEXCEPTION_UNPACKOBJ_F,sidl_SIDLException_unpackObj_f)
(
  int64_t *self,
  int64_t *des,
  int64_t *exception
