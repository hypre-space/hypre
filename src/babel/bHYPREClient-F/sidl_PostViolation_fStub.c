 ...
 * Revision:      @(#) $Id: sidl_PostViolation_fStub.c,v 1.29 2007/09/27 19:56:34 painter Exp $
...
static struct sidl_PostViolation__object* sidl_PostViolation__remoteCreate(
...
void
SIDLFortran77Symbol(sidl_postviolation__createremote_f,SIDL_POSTVIOLATION__CREATEREMOTE_F,sidl_PostViolation__createRemote_f)
(
  int64_t *self,
  SIDL_F77_String url
...
void
SIDLFortran77Symbol(sidl_postviolation__connect_f,SIDL_POSTVIOLATION__CONNECT_F,sidl_PostViolation__connect_f)
(
  int64_t *self,
  SIDL_F77_String url
  SIDL_F77_STR_NEAR_LEN_DECL(url),
...
void
SIDLFortran77Symbol(sidl_postviolation__exec_f,SIDL_POSTVIOLATION__EXEC_F,sidl_PostViolation__exec_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_postviolation__geturl_f,SIDL_POSTVIOLATION__GETURL_F,sidl_PostViolation__getURL_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_postviolation__isremote_f,SIDL_POSTVIOLATION__ISREMOTE_F,sidl_PostViolation__isRemote_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_postviolation__islocal_f,SIDL_POSTVIOLATION__ISLOCAL_F,sidl_PostViolation__isLocal_f)
(
  int64_t *self,
  SIDL_F77_Bool *retval,
  int64_t *exception
...
void
SIDLFortran77Symbol(sidl_postviolation__set_hooks_f,SIDL_POSTVIOLATION__SET_HOOKS_F,sidl_PostViolation__set_hooks_f)
(
  int64_t *self,
  SIDL_F77_Bool *on,
  int64_t *exception
...
void
SIDLFortran77Symbol(sidl_postviolation_packobj_f,SIDL_POSTVIOLATION_PACKOBJ_F,sidl_PostViolation_packObj_f)
(
  int64_t *self,
  int64_t *ser,
  int64_t *exception
...
void
SIDLFortran77Symbol(sidl_postviolation_unpackobj_f,SIDL_POSTVIOLATION_UNPACKOBJ_F,sidl_PostViolation_unpackObj_f)
(
  int64_t *self,
  int64_t *des,
  int64_t *exception
