/*
 * File:          sidl_BaseClass_fStub.h
 * Symbol:        sidl.BaseClass-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V2-2-0b $
 * Revision:      @(#) $Id: sidl_BaseClass_fStub.h,v 1.3 2006/12/29 21:24:26 painter Exp $
 * Description:   Client-side documentation text for sidl.BaseClass
 * 
...
#define included_sidl_BaseClass_fStub_h
