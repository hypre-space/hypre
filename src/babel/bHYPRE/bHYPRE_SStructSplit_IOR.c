...
static struct bHYPRE_SStructSplit__epv  s_new_epv_hooks__bhypre_sstructsplit;
static struct bHYPRE_SStructSplit__sepv s_stc_epv_hooks__bhypre_sstructsplit;
...
bHYPRE_SStructSplit_isSame__exec(
  ...
  iobj = skel_bHYPRE_SStructSplit_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_SStructSplit_SetOperator__exec(
  ...
  A = skel_bHYPRE_SStructSplit_fconnect_bHYPRE_Operator(A_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_SStructSplit_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str, 
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = skel_bHYPRE_SStructSplit_fconnect_bHYPRE_MPICommunicator(
...
static void
bHYPRE_SStructSplit_Destroy__exec(
        struct bHYPRE_SStructSplit__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
bHYPRE_SStructSplit_Setup__exec(
  ...
  b = skel_bHYPRE_SStructSplit_fconnect_bHYPRE_Vector(b_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  x = skel_bHYPRE_SStructSplit_fconnect_bHYPRE_Vector(x_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_SStructSplit_Apply__exec(
  ...
  b = skel_bHYPRE_SStructSplit_fconnect_bHYPRE_Vector(b_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  *x = skel_bHYPRE_SStructSplit_fconnect_bHYPRE_Vector(x_str, FALSE, 
    _ex);SIDL_CHECK(*_ex);
...
static void ior_bHYPRE_SStructSplit__set_hooks_static(
...
static void ior_bHYPRE_SStructSplit__set_hooks(
  struct bHYPRE_SStructSplit__object* self,
  int on, struct sidl_BaseInterface__object **_ex ) { 
  *_ex = NULL;
  /*
...
{
  *_ex = NULL; /* default to no exception */
  bHYPRE_SStructSplit__fini(self,_ex);
...
ior_bHYPRE_SStructSplit__exec(
  ...
  static const struct bHYPRE_SStructSplit__method  s_methods[] = {
    ...
    { "Destroy", bHYPRE_SStructSplit_Destroy__exec },
    ...
    { "SetIntArray1Parameter", bHYPRE_SStructSplit_SetIntArray1Parameter__exec 
      },
    { "SetIntArray2Parameter", bHYPRE_SStructSplit_SetIntArray2Parameter__exec 
      },
...
static void bHYPRE_SStructSplit__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct bHYPRE_SStructSplit__epv*  hepv = 
    &s_new_epv_hooks__bhypre_sstructsplit;
  ...
  epv->f__raddRef                      = ior_bHYPRE_SStructSplit__raddRef;
  epv->f__isRemote                     = ior_bHYPRE_SStructSplit__isRemote;
  epv->f__set_hooks                    = ior_bHYPRE_SStructSplit__set_hooks;
  epv->f__ctor                         = NULL;
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  epv->f_addRef                        = (void (*)(struct 
    bHYPRE_SStructSplit__object*,struct sidl_BaseInterface__object **)) 
    s1->f_addRef;
  epv->f_deleteRef                     = (void (*)(struct 
    bHYPRE_SStructSplit__object*,struct sidl_BaseInterface__object **)) 
    s1->f_deleteRef;
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_SStructSplit__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_SStructSplit__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* (*)(
    struct bHYPRE_SStructSplit__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
  ...
  memcpy((void*)hepv, epv, sizeof(struct bHYPRE_SStructSplit__epv));
...
static void bHYPRE_SStructSplit__init_sepv(void)
{
  ...
  struct bHYPRE_SStructSplit__sepv* hs = &s_stc_epv_hooks__bhypre_sstructsplit;

  s->f__set_hooks_static                = 
    ior_bHYPRE_SStructSplit__set_hooks_static;
  s->f_Create         = NULL;

  bHYPRE_SStructSplit__set_sepv(s);

  memcpy((void*)hs, s, sizeof(struct bHYPRE_SStructSplit__sepv));

  ior_bHYPRE_SStructSplit__set_hooks_static(FALSE, &throwaway_exception);
  s_static_initialized = 1;
  ior_bHYPRE_SStructSplit__ensure_load_called();
}

void bHYPRE_SStructSplit__getEPVs(
    ...
    bHYPRE_SStructSplit__epv **s_arg_epv_hooks__bhypre_sstructsplit)
{
  ...
  *s_arg_epv__bhypre_sstructsplit = &s_new_epv__bhypre_sstructsplit;
  *s_arg_epv_hooks__bhypre_sstructsplit = &s_new_epv_hooks__bhypre_sstructsplit;
}
/*
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.SStructSplit",_ex);
...
static void
initMetadata(struct bHYPRE_SStructSplit__object* self, sidl_BaseInterface* _ex)
{
...
bHYPRE_SStructSplit__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct bHYPRE_SStructSplit__object* self =
    (struct bHYPRE_SStructSplit__object*) malloc(
      sizeof(struct bHYPRE_SStructSplit__object));
  *_ex = NULL; /* default to no exception */
  bHYPRE_SStructSplit__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_bHYPRE_SStructSplit__set_hooks(s0, FALSE, _ex);
