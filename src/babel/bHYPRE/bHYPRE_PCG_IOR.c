...
static struct bHYPRE_PCG__epv  s_new_epv_hooks__bhypre_pcg;
static struct bHYPRE_PCG__sepv s_stc_epv_hooks__bhypre_pcg;
...
bHYPRE_PCG_isSame__exec(
  ...
  iobj = skel_bHYPRE_PCG_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_PCG_SetPreconditioner__exec(
  ...
  s = skel_bHYPRE_PCG_fconnect_bHYPRE_Solver(s_str, TRUE, _ex);SIDL_CHECK(*_ex);
...
bHYPRE_PCG_SetOperator__exec(
  ...
  A = skel_bHYPRE_PCG_fconnect_bHYPRE_Operator(A_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
...
bHYPRE_PCG_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str, 
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = skel_bHYPRE_PCG_fconnect_bHYPRE_MPICommunicator(mpi_comm_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
bHYPRE_PCG_Setup__exec(
  ...
  b = skel_bHYPRE_PCG_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  x = skel_bHYPRE_PCG_fconnect_bHYPRE_Vector(x_str, TRUE, _ex);SIDL_CHECK(*_ex);
...
bHYPRE_PCG_Apply__exec(
  ...
  b = skel_bHYPRE_PCG_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  *x = skel_bHYPRE_PCG_fconnect_bHYPRE_Vector(x_str, FALSE, _ex);SIDL_CHECK(
    *_ex);
...
static void ior_bHYPRE_PCG__set_hooks_static(
...
static void ior_bHYPRE_PCG__set_hooks(
  struct bHYPRE_PCG__object* self,
  int on, struct sidl_BaseInterface__object **_ex ) { 
  *_ex = NULL;
  /*
...
ior_bHYPRE_PCG__exec(
  ...
  static const struct bHYPRE_PCG__method  s_methods[] = {
    ...
    { "Destroy", bHYPRE_PCG_Destroy__exec },
...
static void bHYPRE_PCG__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct bHYPRE_PCG__epv*                  hepv = &s_new_epv_hooks__bhypre_pcg;
  ...
  epv->f__raddRef                      = ior_bHYPRE_PCG__raddRef;
  epv->f__isRemote                     = ior_bHYPRE_PCG__isRemote;
  epv->f__set_hooks                    = ior_bHYPRE_PCG__set_hooks;
  epv->f__ctor                         = NULL;
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  ...
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_PCG__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_PCG__object*,const char*,struct sidl_BaseInterface__object **)) 
    s1->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* (*)(
    struct bHYPRE_PCG__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
  ...
  memcpy((void*)hepv, epv, sizeof(struct bHYPRE_PCG__epv));
...
static void bHYPRE_PCG__init_sepv(void)
{
  ...
  struct bHYPRE_PCG__sepv* hs = &s_stc_epv_hooks__bhypre_pcg;

  s->f__set_hooks_static       = ior_bHYPRE_PCG__set_hooks_static;
  s->f_Create         = NULL;

  bHYPRE_PCG__set_sepv(s);

  memcpy((void*)hs, s, sizeof(struct bHYPRE_PCG__sepv));

  ior_bHYPRE_PCG__set_hooks_static(FALSE, &throwaway_exception);
  s_static_initialized = 1;
  ior_bHYPRE_PCG__ensure_load_called();
}

void bHYPRE_PCG__getEPVs(
    ...
    **s_arg_epv_hooks__bhypre_pcg)
{
  ...
  *s_arg_epv__bhypre_pcg = &s_new_epv__bhypre_pcg;
  *s_arg_epv_hooks__bhypre_pcg = &s_new_epv_hooks__bhypre_pcg;
}
/*
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.PCG",_ex);
...
static void
initMetadata(struct bHYPRE_PCG__object* self, sidl_BaseInterface* _ex)
{
...
bHYPRE_PCG__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  bHYPRE_PCG__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_bHYPRE_PCG__set_hooks(s0, FALSE, _ex);
