...
#define included_bHYPRE_Euclid_IOR_h
...
struct bHYPRE_Euclid__epv {
  /* Implicit builtin methods */
  /* 0 */
  void* (*f__cast)(
    /* in */ struct bHYPRE_Euclid__object* self,
    /* in */ const char* name,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* 1 */
  void (*f__delete)(
...
struct bHYPRE_Euclid__controls {
  int     use_hooks;
};
/*
...
struct bHYPRE_Euclid__object {
  ...
  struct bHYPRE_Euclid__epv*     d_epv;
  void*                          d_data;
};

struct bHYPRE_Euclid__external {
  struct bHYPRE_Euclid__object*
...
extern struct bHYPRE_Euclid__sepv*
bHYPRE_Euclid__statics(void);

extern void bHYPRE_Euclid__init(
  struct bHYPRE_Euclid__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void bHYPRE_Euclid__getEPVs(
  ...
  extern void bHYPRE_Euclid__fini(
    struct bHYPRE_Euclid__object* self, struct sidl_BaseInterface__object ** 
      _ex);
  extern void bHYPRE_Euclid__IOR_version(int32_t *major, int32_t *minor);
  ...
  struct bHYPRE_IJParCSRMatrix__object* 
    skel_bHYPRE_Euclid_fcast_bHYPRE_IJParCSRMatrix(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_MPICommunicator__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_Euclid_fcast_bHYPRE_MPICommunicator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseClass__object* skel_bHYPRE_Euclid_fconnect_sidl_BaseClass(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* skel_bHYPRE_Euclid_fcast_sidl_BaseClass(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_BaseInterface__object* 
    skel_bHYPRE_Euclid_fconnect_sidl_BaseInterface(const char* url, sidl_bool 
    ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_Euclid_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_ClassInfo__object* skel_bHYPRE_Euclid_fconnect_sidl_ClassInfo(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* skel_bHYPRE_Euclid_fcast_sidl_ClassInfo(void 
    *bi, struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_Euclid_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct bHYPRE_Euclid__remote{
    int d_refcount;
