...
bHYPRE_Hybrid_GetFirstSolver__exec(
  ...
  if(*FirstSolver){
    char* _url = sidl_BaseInterface__getURL((sidl_BaseInterface)*FirstSolver, 
      _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Return_packString( outArgs, "FirstSolver", _url, _ex);SIDL_CHECK(
      *_ex);
    free((void*)_url);
  } else {
    sidl_rmi_Return_packString( outArgs, "FirstSolver", NULL, _ex);SIDL_CHECK(
      *_ex);
  }
  /* clean-up dangling references */
  if(*FirstSolver && sidl_BaseInterface__isRemote((
    sidl_BaseInterface)*FirstSolver, _ex)) {
    (*((sidl_BaseInterface)*FirstSolver)->d_epv->f__raddRef)(((
      sidl_BaseInterface)*FirstSolver)->d_object, _ex); SIDL_CHECK(*_ex);
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)*FirstSolver, _ex); 
      SIDL_CHECK(*_ex);
  }
  return;
...
bHYPRE_Hybrid_GetSecondSolver__exec(
  ...
  if(*SecondSolver){
    char* _url = sidl_BaseInterface__getURL((sidl_BaseInterface)*SecondSolver, 
      _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Return_packString( outArgs, "SecondSolver", _url, _ex);SIDL_CHECK(
      *_ex);
    free((void*)_url);
  } else {
    sidl_rmi_Return_packString( outArgs, "SecondSolver", NULL, _ex);SIDL_CHECK(
      *_ex);
  }
  /* clean-up dangling references */
  if(*SecondSolver && sidl_BaseInterface__isRemote((
    sidl_BaseInterface)*SecondSolver, _ex)) {
    (*((sidl_BaseInterface)*SecondSolver)->d_epv->f__raddRef)(((
      sidl_BaseInterface)*SecondSolver)->d_object, _ex); SIDL_CHECK(*_ex);
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)*SecondSolver, _ex); 
      SIDL_CHECK(*_ex);
  }
  return;
...
bHYPRE_Hybrid_SetOperator__exec(
  ...
  A = skel_bHYPRE_Hybrid_fconnect_bHYPRE_Operator(A_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
...
bHYPRE_Hybrid_Setup__exec(
  ...
  b = skel_bHYPRE_Hybrid_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  x = skel_bHYPRE_Hybrid_fconnect_bHYPRE_Vector(x_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
...
bHYPRE_Hybrid_Apply__exec(
  ...
  b = skel_bHYPRE_Hybrid_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  *x = skel_bHYPRE_Hybrid_fconnect_bHYPRE_Vector(x_str, FALSE, _ex);SIDL_CHECK(
    *_ex);
...
ior_bHYPRE_Hybrid__exec(
  ...
  static const struct bHYPRE_Hybrid__method  s_methods[] = {
    ...
    { "SetDoubleArray1Parameter", bHYPRE_Hybrid_SetDoubleArray1Parameter__exec 
      },
    { "SetDoubleArray2Parameter", bHYPRE_Hybrid_SetDoubleArray2Parameter__exec 
      },
 ...
 */
  ...
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_Hybrid__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_Hybrid__object*,const char*,struct sidl_BaseInterface__object **)) 
    s1->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* (*)(
    struct bHYPRE_Hybrid__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
