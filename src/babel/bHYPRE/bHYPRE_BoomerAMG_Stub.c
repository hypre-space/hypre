...
static const struct bHYPRE_BoomerAMG__external *_externals = NULL;
/*
...

{
  ...
  _externals = bHYPRE_BoomerAMG__externals();
#else
  _externals = (struct bHYPRE_BoomerAMG__external*)sidl_dynamicLoadIOR(
    "bHYPRE.BoomerAMG","bHYPRE_BoomerAMG__externals") ;
  sidl_checkIORVersion("bHYPRE.BoomerAMG", _externals->d_ior_major_version, 
...
static bHYPRE_BoomerAMG bHYPRE_BoomerAMG__remoteCreate(const char* url, 
...
{
  return bHYPRE_BoomerAMG__remoteCreate(url, _ex);
}
...
bHYPRE_BoomerAMG
bHYPRE_BoomerAMG__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_BoomerAMG__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.BoomerAMG", (
      void*)bHYPRE_BoomerAMG__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
void
bHYPRE_BoomerAMG__set_hooks_static(
  int32_t on,
...
bHYPRE_BoomerAMG__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_BoomerAMG__isRemote(self,_ex);
}
...
{
  return (struct bHYPRE_BoomerAMG__array*)sidl_interface__array_create1dInit(
