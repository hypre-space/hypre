...
bHYPRE_SStructVector_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str, 
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = skel_bHYPRE_SStructVector_fconnect_bHYPRE_MPICommunicator(
...
static void ior_bHYPRE_SStructVector__delete(
  struct bHYPRE_SStructVector__object* self, struct sidl_BaseInterface__object 
    **_ex)
{
  *_ex = NULL; /* default to no exception */
 ...
 */
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    bHYPRE_SStructVector__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    bHYPRE_SStructVector__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
...
void bHYPRE_SStructVector__getEPVs(
  ...
  struct bHYPRE_SStructVector__epv **s_arg_epv__bhypre_sstructvector,struct 
    bHYPRE_SStructVector__epv **s_arg_epv_hooks__bhypre_sstructvector)
{
  LOCK_STATIC_GLOBALS;
