...
static void
bHYPRE_StructSMG_Destroy__exec(
        struct bHYPRE_StructSMG__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
bHYPRE_StructSMG_Setup__exec(
  ...
  b = skel_bHYPRE_StructSMG_fconnect_bHYPRE_Vector(b_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
  sidl_rmi_Call_unpackString( inArgs, "x", &x_str, _ex);SIDL_CHECK(*_ex);
  x = skel_bHYPRE_StructSMG_fconnect_bHYPRE_Vector(x_str, TRUE, _ex);SIDL_CHECK(
    *_ex);
...
ior_bHYPRE_StructSMG__exec(
  ...
  static const struct bHYPRE_StructSMG__method  s_methods[] = {
    ...
    { "Destroy", bHYPRE_StructSMG_Destroy__exec },
 ...
 */
  ...
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_StructSMG__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_StructSMG__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* (*)(
    struct bHYPRE_StructSMG__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
