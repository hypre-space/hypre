...
static struct bHYPRE_ErrorHandler__epv  s_new_epv__bhypre_errorhandler;
static struct bHYPRE_ErrorHandler__sepv s_stc_epv__bhypre_errorhandler;

static struct bHYPRE_ErrorHandler__epv  s_new_epv_hooks__bhypre_errorhandler;
static struct bHYPRE_ErrorHandler__sepv s_stc_epv_hooks__bhypre_errorhandler;
...
extern void bHYPRE_ErrorHandler__set_epv(
  struct bHYPRE_ErrorHandler__epv* epv);
extern void bHYPRE_ErrorHandler__set_sepv(
  struct bHYPRE_ErrorHandler__sepv* sepv);
extern void bHYPRE_ErrorHandler__call_load(void);
#ifdef __cplusplus
}
#endif

static void
bHYPRE_ErrorHandler_addRef__exec(
...
static void
bHYPRE_ErrorHandler_deleteRef__exec(
        struct bHYPRE_ErrorHandler__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
bHYPRE_ErrorHandler_isSame__exec(
        struct bHYPRE_ErrorHandler__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
bHYPRE_ErrorHandler_isType__exec(
        struct bHYPRE_ErrorHandler__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
bHYPRE_ErrorHandler_getClassInfo__exec(
        struct bHYPRE_ErrorHandler__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_bHYPRE_ErrorHandler__ensure_load_called(void) {
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */

  if (! s_load_called ) {
    bHYPRE_ErrorHandler__call_load();
    s_load_called=1;
  }
}

/* CAST: dynamic type casting support. */
static void* ior_bHYPRE_ErrorHandler__cast(
  struct bHYPRE_ErrorHandler__object* self,
...
static void ior_bHYPRE_ErrorHandler__set_hooks_static(
...
static void ior_bHYPRE_ErrorHandler__set_hooks(
  struct bHYPRE_ErrorHandler__object* self,
  int on, struct sidl_BaseInterface__object **_ex ) { 
  *_ex = NULL;
  /*
    ...
    struct sidl_BaseInterface__object **_ex)
{
  *_ex = NULL; /* default to no exception */
  ...
  memset((void*)self, 0, sizeof(struct bHYPRE_ErrorHandler__object));
  free((void*) self);
}

static char*
ior_bHYPRE_ErrorHandler__getURL(
    struct bHYPRE_ErrorHandler__object* self,
    struct sidl_BaseInterface__object **_ex) {
  char* ret = NULL;
  char* objid = 
...
static void
ior_bHYPRE_ErrorHandler__raddRef(
    struct bHYPRE_ErrorHandler__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_bHYPRE_ErrorHandler__isRemote(
    struct bHYPRE_ErrorHandler__object* self, sidl_BaseInterface* _ex) {
  *_ex = NULL; /* default to no exception */
  return FALSE;
}

struct bHYPRE_ErrorHandler__method {
  const char *d_name;
  void (*d_func)(struct bHYPRE_ErrorHandler__object*,
...
static void
ior_bHYPRE_ErrorHandler__exec(
    struct bHYPRE_ErrorHandler__object* self,
    const char* methodName,
    struct sidl_rmi_Call__object* inArgs,
    struct sidl_rmi_Return__object* outArgs,
    struct sidl_BaseInterface__object **_ex ) { 
  static const struct bHYPRE_ErrorHandler__method  s_methods[] = {
    { "addRef", bHYPRE_ErrorHandler_addRef__exec },
    { "deleteRef", bHYPRE_ErrorHandler_deleteRef__exec },
    { "getClassInfo", bHYPRE_ErrorHandler_getClassInfo__exec },
    { "isSame", bHYPRE_ErrorHandler_isSame__exec },
    { "isType", bHYPRE_ErrorHandler_isType__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct bHYPRE_ErrorHandler__method);
  *_ex = NULL; /* default to no exception */
  if (methodName) {
...
static void bHYPRE_ErrorHandler__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct bHYPRE_ErrorHandler__epv*  epv  = &s_new_epv__bhypre_errorhandler;
  struct bHYPRE_ErrorHandler__epv*  hepv = 
    &s_new_epv_hooks__bhypre_errorhandler;
  ...
  epv->f__cast                    = ior_bHYPRE_ErrorHandler__cast;
  epv->f__delete                  = ior_bHYPRE_ErrorHandler__delete;
  epv->f__exec                    = ior_bHYPRE_ErrorHandler__exec;
  epv->f__getURL                  = ior_bHYPRE_ErrorHandler__getURL;
  epv->f__raddRef                 = ior_bHYPRE_ErrorHandler__raddRef;
  epv->f__isRemote                = ior_bHYPRE_ErrorHandler__isRemote;
  epv->f__set_hooks               = ior_bHYPRE_ErrorHandler__set_hooks;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  ...
  ior_bHYPRE_ErrorHandler__ensure_load_called();
}
...
static void bHYPRE_ErrorHandler__init_sepv(void)
{
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */
  ...
  struct bHYPRE_ErrorHandler__sepv*  s = &s_stc_epv__bhypre_errorhandler;
  struct bHYPRE_ErrorHandler__sepv* hs = &s_stc_epv_hooks__bhypre_errorhandler;

  s->f__set_hooks_static                = 
    ior_bHYPRE_ErrorHandler__set_hooks_static;
  s->f_Check            = NULL;
  s->f_Describe         = NULL;

  bHYPRE_ErrorHandler__set_sepv(s);

  memcpy((void*)hs, s, sizeof(struct bHYPRE_ErrorHandler__sepv));

  ior_bHYPRE_ErrorHandler__set_hooks_static(FALSE, &throwaway_exception);
    ...
    struct bHYPRE_ErrorHandler__epv **s_arg_epv_hooks__bhypre_errorhandler)
{
  ...
  *s_arg_epv__bhypre_errorhandler = &s_new_epv__bhypre_errorhandler;
  *s_arg_epv_hooks__bhypre_errorhandler = &s_new_epv_hooks__bhypre_errorhandler;
}
/*
...
bHYPRE_ErrorHandler__statics(void)
{
  ...
  if (!s_static_initialized) {
    bHYPRE_ErrorHandler__init_sepv();
  }
  UNLOCK_STATIC_GLOBALS;
  return &s_stc_epv__bhypre_errorhandler;
}
...
static struct sidl_BaseClass__epv* bHYPRE_ErrorHandler__super(void) {
...
static void
initMetadata(struct bHYPRE_ErrorHandler__object* self, sidl_BaseInterface* _ex)
{
...
bHYPRE_ErrorHandler__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  bHYPRE_ErrorHandler__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void bHYPRE_ErrorHandler__init(
  struct bHYPRE_ErrorHandler__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct bHYPRE_ErrorHandler__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_new_epv__bhypre_errorhandler;

  s0->d_data = NULL;

  ior_bHYPRE_ErrorHandler__set_hooks(s0, FALSE, _ex);
...
void bHYPRE_ErrorHandler__fini(
  struct bHYPRE_ErrorHandler__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct bHYPRE_ErrorHandler__object* s0 = self;
...
void
bHYPRE_ErrorHandler__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct bHYPRE_ErrorHandler__external
