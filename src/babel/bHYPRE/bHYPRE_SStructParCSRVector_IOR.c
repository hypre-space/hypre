...
static struct bHYPRE_SStructParCSRVector__epv  
  s_new_epv_hooks__bhypre_sstructparcsrvector;
static struct bHYPRE_SStructParCSRVector__sepv 
  s_stc_epv_hooks__bhypre_sstructparcsrvector;
...
bHYPRE_SStructParCSRVector_isSame__exec(
  ...
  iobj = skel_bHYPRE_SStructParCSRVector_fconnect_sidl_BaseInterface(iobj_str, 
...
bHYPRE_SStructParCSRVector_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str, 
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = skel_bHYPRE_SStructParCSRVector_fconnect_bHYPRE_MPICommunicator(
...
static void
bHYPRE_SStructParCSRVector_Destroy__exec(
        struct bHYPRE_SStructParCSRVector__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
bHYPRE_SStructParCSRVector_Copy__exec(
  ...
  x = skel_bHYPRE_SStructParCSRVector_fconnect_bHYPRE_Vector(x_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
static void ior_bHYPRE_SStructParCSRVector__set_hooks_static(
...
static void ior_bHYPRE_SStructParCSRVector__set_hooks(
  struct bHYPRE_SStructParCSRVector__object* self,
  int on, struct sidl_BaseInterface__object **_ex ) { 
  *_ex = NULL;
  /*
...
{
  *_ex = NULL; /* default to no exception */
  bHYPRE_SStructParCSRVector__fini(self,_ex);
...
static void
ior_bHYPRE_SStructParCSRVector__raddRef(
...
static sidl_bool
ior_bHYPRE_SStructParCSRVector__isRemote(
    struct bHYPRE_SStructParCSRVector__object* self, sidl_BaseInterface* _ex) {
  *_ex = NULL; /* default to no exception */
  return FALSE;
}
...
ior_bHYPRE_SStructParCSRVector__exec(
  ...
  static const struct bHYPRE_SStructParCSRVector__method  s_methods[] = {
    ...
    { "Destroy", bHYPRE_SStructParCSRVector_Destroy__exec },
...
static void bHYPRE_SStructParCSRVector__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct bHYPRE_SStructParCSRVector__epv*     epv  = 
    &s_new_epv__bhypre_sstructparcsrvector;
  struct bHYPRE_SStructParCSRVector__epv*     hepv = 
    &s_new_epv_hooks__bhypre_sstructparcsrvector;
  ...
  epv->f__raddRef                 = ior_bHYPRE_SStructParCSRVector__raddRef;
  epv->f__isRemote                = ior_bHYPRE_SStructParCSRVector__isRemote;
  epv->f__set_hooks               = ior_bHYPRE_SStructParCSRVector__set_hooks;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_addRef                   = (void (*)(struct 
    bHYPRE_SStructParCSRVector__object*,struct sidl_BaseInterface__object **)) 
    s1->f_addRef;
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    bHYPRE_SStructParCSRVector__object*,const char*,struct 
  ...
  memcpy((void*)hepv, epv, sizeof(struct bHYPRE_SStructParCSRVector__epv));
  ...
  e3->f_SetGrid             = (int32_t (*)(void*,struct 
    ...
    epv->f_SetGrid;
  e3->f_SetValues           = (int32_t (*)(void*,int32_t,struct 
    sidl_int__array*,int32_t,double,struct sidl_BaseInterface__object **)) 
    epv->f_SetValues;
  e3->f_SetBoxValues        = (int32_t (*)(void*,int32_t,struct 
    sidl_int__array*,struct sidl_int__array*,int32_t,struct sidl_double__array*,
    struct sidl_BaseInterface__object **)) epv->f_SetBoxValues;
  e3->f_AddToValues         = (int32_t (*)(void*,int32_t,struct 
    sidl_int__array*,int32_t,double,struct sidl_BaseInterface__object **)) 
    epv->f_AddToValues;
  e3->f_AddToBoxValues      = (int32_t (*)(void*,int32_t,struct 
    sidl_int__array*,struct sidl_int__array*,int32_t,struct sidl_double__array*,
  ...
  e3->f_GetValues           = (int32_t (*)(void*,int32_t,struct 
    sidl_int__array*,int32_t,double*,struct sidl_BaseInterface__object **)) 
    epv->f_GetValues;
  e3->f_GetBoxValues        = (int32_t (*)(void*,int32_t,struct 
    sidl_int__array*,struct sidl_int__array*,int32_t,struct 
  ...
  e4->f__exec               = (void (*)(void*,const char*,struct 
    sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
    sidl_BaseInterface__object **)) epv->f__exec;
  e4->f_Clear               = (int32_t (*)(void*,struct 
...
static void bHYPRE_SStructParCSRVector__init_sepv(void)
{
  ...
  struct bHYPRE_SStructParCSRVector__sepv*  s = 
    &s_stc_epv__bhypre_sstructparcsrvector;
  struct bHYPRE_SStructParCSRVector__sepv* hs = 
    &s_stc_epv_hooks__bhypre_sstructparcsrvector;

  s->f__set_hooks_static                       = 
    ior_bHYPRE_SStructParCSRVector__set_hooks_static;
  s->f_Create         = NULL;

  bHYPRE_SStructParCSRVector__set_sepv(s);

  memcpy((void*)hs, s, sizeof(struct bHYPRE_SStructParCSRVector__sepv));

  ior_bHYPRE_SStructParCSRVector__set_hooks_static(FALSE, &throwaway_exception);
  s_static_initialized = 1;
  ior_bHYPRE_SStructParCSRVector__ensure_load_called();
}

void bHYPRE_SStructParCSRVector__getEPVs(
    ...
    **s_arg_epv_hooks__bhypre_sstructparcsrvector)
{
  ...
  if (!s_method_initialized) {
    bHYPRE_SStructParCSRVector__init_epv();
  }
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "bHYPRE.SStructParCSRVector",_ex);
  ...
  ** _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  bHYPRE_SStructParCSRVector__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_bHYPRE_SStructParCSRVector__set_hooks(s0, FALSE, _ex);
