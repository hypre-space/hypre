 ...
 */
struct bHYPRE_HGMRES__object*
bHYPRE_HGMRES__create(sidl_BaseInterface* _ex);
...
/**
 * Wraps up the private data struct pointer (struct bHYPRE_HGMRES__data) passed in rather than running the constructor.
 */
bHYPRE_HGMRES
bHYPRE_HGMRES__wrapObj(void * data, sidl_BaseInterface *_ex);
