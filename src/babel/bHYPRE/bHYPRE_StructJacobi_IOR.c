...
bHYPRE_StructJacobi_SetCommunicator__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "mpi_comm", &mpi_comm_str, 
    _ex);SIDL_CHECK(*_ex);
  mpi_comm = skel_bHYPRE_StructJacobi_fconnect_bHYPRE_MPICommunicator(
...
static void
bHYPRE_StructJacobi_Destroy__exec(
        struct bHYPRE_StructJacobi__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
ior_bHYPRE_StructJacobi__exec(
  ...
  static const struct bHYPRE_StructJacobi__method  s_methods[] = {
    ...
    { "Destroy", bHYPRE_StructJacobi_Destroy__exec },
    ...
    { "SetIntArray1Parameter", bHYPRE_StructJacobi_SetIntArray1Parameter__exec 
      },
    { "SetIntArray2Parameter", bHYPRE_StructJacobi_SetIntArray2Parameter__exec 
      },
 ...
 */
  ...
  epv->f_isSame                        = (sidl_bool (*)(struct 
    bHYPRE_StructJacobi__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                        = (sidl_bool (*)(struct 
    bHYPRE_StructJacobi__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  epv->f_getClassInfo                  = (struct sidl_ClassInfo__object* (*)(
    struct bHYPRE_StructJacobi__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
