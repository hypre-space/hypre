...
static const struct bHYPRE_Hybrid__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct bHYPRE_Hybrid__external* _loadIOR(void)
/*
...

{
  ...
  _externals = bHYPRE_Hybrid__externals();
#else
  _externals = (struct bHYPRE_Hybrid__external*)sidl_dynamicLoadIOR(
    "bHYPRE.Hybrid","bHYPRE_Hybrid__externals") ;
  sidl_checkIORVersion("bHYPRE.Hybrid", _externals->d_ior_major_version, 
...
bHYPRE_Hybrid
bHYPRE_Hybrid__create(sidl_BaseInterface* _ex)
{
...
static bHYPRE_Hybrid bHYPRE_Hybrid__remoteCreate(const char* url, 
...
bHYPRE_Hybrid
bHYPRE_Hybrid__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_Hybrid__remoteCreate(url, _ex);
}
...
bHYPRE_Hybrid
bHYPRE_Hybrid__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_Hybrid__remoteConnect(url, TRUE, _ex);
}
...
{
  int32_t _result;
  _result = (*self->d_epv->f_GetFirstSolver)(
    self,
    FirstSolver,
    _ex);
  return _result;
...
{
  int32_t _result;
  _result = (*self->d_epv->f_GetSecondSolver)(
    self,
    SecondSolver,
    _ex);
  return _result;
...
bHYPRE_Hybrid__cast(
  ...
  sidl_BaseInterface* _ex)
{
  bHYPRE_Hybrid cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.Hybrid", (
      void*)bHYPRE_Hybrid__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (bHYPRE_Hybrid) (*base->d_epv->f__cast)(
      base->d_object,
...
void
bHYPRE_Hybrid__set_hooks_static(
  int32_t on,
...
bHYPRE_Hybrid__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_Hybrid__isRemote(self,_ex);
}
...
bHYPRE_Hybrid__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_Hybrid__array*)sidl_interface__array_createCol(dimen, 
    lower, upper);
}
...
bHYPRE_Hybrid__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_Hybrid__array*)sidl_interface__array_createRow(dimen, 
    lower, upper);
}
...
{
  return (struct bHYPRE_Hybrid__array*)sidl_interface__array_create1d(len);
}
...
bHYPRE_Hybrid__array_create1dInit(
  ...
  bHYPRE_Hybrid* data)
{
  return (struct bHYPRE_Hybrid__array*)sidl_interface__array_create1dInit(len, (
...
{
  return (struct bHYPRE_Hybrid__array*)sidl_interface__array_create2dCol(m, n);
}

struct bHYPRE_Hybrid__array*
bHYPRE_Hybrid__array_create2dRow(int32_t m, int32_t n)
{
  return (struct bHYPRE_Hybrid__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct bHYPRE_Hybrid__array*)sidl_interface__array_borrow(
...
{
  return (struct bHYPRE_Hybrid__array*)
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    if (!cmp1) {
      ...
      if (!cmp2) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = ((struct bHYPRE_Hybrid__object*)self);
        return cast;
      }
    }
  }
...
bHYPRE_Hybrid__remoteConnect(const char *url, sidl_bool ar, sidl_BaseInterface 
  *_ex)
{
  struct bHYPRE_Hybrid__object* self;
...
static struct bHYPRE_Hybrid__object*
bHYPRE_Hybrid__IHConnect(sidl_rmi_InstanceHandle instance, sidl_BaseInterface 
  *_ex)
{
  struct bHYPRE_Hybrid__object* self;
...
bHYPRE_Hybrid__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "bHYPRE.Hybrid", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_Hybrid__object*) malloc(
      sizeof(struct bHYPRE_Hybrid__object));
