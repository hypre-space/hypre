...
extern void bHYPRE_Euclid__init(
  struct bHYPRE_Euclid__object* self, void* ddata,
...
extern void bHYPRE_Euclid__getEPVs(
  ...
  struct sidl_BaseClass__object* 
    skel_bHYPRE_Euclid_fconnect_sidl_BaseClass(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* skel_bHYPRE_Euclid_fcast_sidl_BaseClass(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_BaseInterface__object* 
    skel_bHYPRE_Euclid_fconnect_sidl_BaseInterface(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
  ...
  struct sidl_ClassInfo__object* 
    skel_bHYPRE_Euclid_fconnect_sidl_ClassInfo(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
