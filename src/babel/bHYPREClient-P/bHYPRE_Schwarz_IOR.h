...
extern void bHYPRE_Schwarz__init(
  struct bHYPRE_Schwarz__object* self, void* ddata, struct 
...
extern void bHYPRE_Schwarz__getEPVs(
  ...
  extern void bHYPRE_Schwarz__fini(
    struct bHYPRE_Schwarz__object* self, struct sidl_BaseInterface__object ** 
      _ex);
  ...
  struct bHYPRE_IJParCSRMatrix__object* 
    skel_bHYPRE_Schwarz_fcast_bHYPRE_IJParCSRMatrix(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_MPICommunicator__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_Schwarz_fcast_bHYPRE_MPICommunicator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Operator__object* skel_bHYPRE_Schwarz_fcast_bHYPRE_Operator(
  ...
  struct bHYPRE_Solver__object* skel_bHYPRE_Schwarz_fconnect_bHYPRE_Solver(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Solver__object* skel_bHYPRE_Schwarz_fcast_bHYPRE_Solver(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_Vector__object* skel_bHYPRE_Schwarz_fconnect_bHYPRE_Vector(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_Schwarz_fconnect_sidl_BaseInterface(const char* url, sidl_bool 
    ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_Schwarz_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_Schwarz_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
