...
static PyObject *
pStub_SStructDiagScale__connect(PyObject *_ignored, PyObject *_args,          \
  PyObject *_kwdict) {
...
static PyObject *
pStub_SStructDiagScale_Create(PyObject *_ignored, PyObject *_args,            \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_SStructDiagScale__exec(PyObject *_self, PyObject *_args,                \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_SStructDiagScale__getURL(PyObject *_self, PyObject *_args,              \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_SStructDiagScale__object *_self_ior =
    ((struct bHYPRE_SStructDiagScale__object *)
...
static PyObject *
pStub_SStructDiagScale__isLocal(PyObject *_self, PyObject *_args,             \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_SStructDiagScale__object *_self_ior =
    ((struct bHYPRE_SStructDiagScale__object *)
...
static PyObject *
pStub_SStructDiagScale__isRemote(PyObject *_self, PyObject *_args,            \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_SStructDiagScale__object *_self_ior =
    ((struct bHYPRE_SStructDiagScale__object *)
...
static PyObject *
pStub_SStructDiagScale__set_hooks(PyObject *_self, PyObject *_args,           \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_SStructDiagScale__object *_self_ior =
    ((struct bHYPRE_SStructDiagScale__object *)
...
static int
bHYPRE_SStructDiagScale_createCast(PyObject *self, PyObject *args,            \
  PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)bHYPRE_SStructDiagScale__convert, &optarg, &url, &implObj);
  if (_okay) {
...
bHYPRE_SStructDiagScale__wrap bHYPRE_SStructDiagScale__wrap_PROTO {
  ...
  if (sidlobj) {
    result =                                                                  \
      _bHYPRE_SStructDiagScaleType.tp_new(&_bHYPRE_SStructDiagScaleType, NULL,\
      NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
initSStructDiagScale(void) {
  ...
  PyTuple_SetItem(_bHYPRE_SStructDiagScaleType.tp_bases,0,                    \
    (PyObject *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_SStructDiagScaleType.tp_bases,1,                    \
  ...
  Py_INCREF(&_bHYPRE_SStructDiagScaleType);
  PyDict_SetItemString(dict, "SStructDiagScale",                              \
    (PyObject *)&_bHYPRE_SStructDiagScaleType);
