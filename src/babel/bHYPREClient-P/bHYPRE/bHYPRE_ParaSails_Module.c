...
static PyObject *
pStub_ParaSails__connect(PyObject *_ignored, PyObject *_args, PyObject        \
  *_kwdict) {
...
static PyObject *
pStub_ParaSails_Create(PyObject *_ignored, PyObject *_args, PyObject          \
  *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_ParaSails__isLocal(PyObject *_self, PyObject *_args, PyObject *_kwdict) \
  {
  PyObject *_return_value = NULL;
  struct bHYPRE_ParaSails__object *_self_ior =
    ((struct bHYPRE_ParaSails__object *)
...
static PyObject *
pStub_ParaSails__isRemote(PyObject *_self, PyObject *_args, PyObject          \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_ParaSails__object *_self_ior =
    ((struct bHYPRE_ParaSails__object *)
...
static PyObject *
pStub_ParaSails__set_hooks(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_ParaSails__object *_self_ior =
    ((struct bHYPRE_ParaSails__object *)
...
bHYPRE_ParaSails_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)bHYPRE_ParaSails__convert, &optarg, &url, &implObj);
  if (_okay) {
...
ParaSails requires an IJParCSR matrix"
  ...
  PyTuple_SetItem(_bHYPRE_ParaSailsType.tp_bases,0, (PyObject                 \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_ParaSailsType.tp_bases,1, (PyObject                 \
