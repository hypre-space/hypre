...
static PyObject *
pStub_Hybrid__connect(PyObject *_ignored, PyObject *_args,                    \
  PyObject *_kwdict) {
...
static PyObject *
pStub_Hybrid_GetFirstSolver(PyObject *_self, PyObject *_args,                 \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_Hybrid_GetSecondSolver(PyObject *_self, PyObject *_args,                \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_Hybrid__object *_self_ior =
    ((struct bHYPRE_Hybrid__object *)
...
static PyObject *
pStub_Hybrid__set_hooks_static(PyObject *_ignored, PyObject *_args,           \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  sidl_bool on = (sidl_bool) 0;
  struct sidl_BaseInterface__object *_exception = NULL;
...
bHYPRE_Hybrid_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)bHYPRE_Hybrid__convert, &optarg, &url, &implObj);
  if (_okay) {
...
user should not call Setup on KrylovSolver."
  ...
  PyTuple_SetItem(_bHYPRE_HybridType.tp_bases,0,                              \
    (PyObject *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_HybridType.tp_bases,1,                              \
