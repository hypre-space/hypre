/*
 * File:          bHYPRE_IJParCSRVector_Module.c
...
#define bHYPRE_IJParCSRVector_INTERNAL 1
#include "bHYPRE_IJParCSRVector_Module.h"
...
static PyObject *
pStub_IJParCSRVector__connect(PyObject *_ignored, PyObject *_args, PyObject   \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRVector__object* self = NULL;
  char* url = NULL;
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &url);
  if (_okay) {
    self = bHYPRE_IJParCSRVector__remoteConnect(url,1,&_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)bHYPRE_IJParCSRVector__wrap, self);
    }
  }
  return _return_value;
}

staticforward PyTypeObject _bHYPRE_IJParCSRVectorType;

static struct bHYPRE_IJParCSRVector__sepv *_sepv = NULL;

static const struct bHYPRE_IJParCSRVector__external *_implEPV = NULL;

static PyObject *
pStub_IJParCSRVector_Create(PyObject *_ignored, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &_proxy_jupper);
  if (_okay) {
    struct bHYPRE_IJParCSRVector__object* _return = NULL;
    jlower = _proxy_jlower;
    jupper = _proxy_jupper;
    _return = (*(_sepv->f_Create))(mpi_comm, jlower, jupper, &_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)bHYPRE_IJParCSRVector__wrap, _return);
    }
...
static PyObject *
pStub_IJParCSRVector__exec(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRVector__object *_self_ior =
    ((struct bHYPRE_IJParCSRVector__object *)
     sidl_Cast(_self, "bHYPRE.IJParCSRVector"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a bHYPRE.IJParCSRVector");
  }
  return _return_value;
}

static PyObject *
pStub_IJParCSRVector__getURL(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRVector__object *_self_ior =
    ((struct bHYPRE_IJParCSRVector__object *)
...
static PyObject *
pStub_IJParCSRVector__isLocal(PyObject *_self, PyObject *_args, PyObject      \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRVector__object *_self_ior =
    ((struct bHYPRE_IJParCSRVector__object *)
...
static PyObject *
pStub_IJParCSRVector__isRemote(PyObject *_self, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRVector__object *_self_ior =
    ((struct bHYPRE_IJParCSRVector__object *)
...
static PyObject *
pStub_IJParCSRVector__set_hooks(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_IJParCSRVector__object *_self_ior =
    ((struct bHYPRE_IJParCSRVector__object *)
...
static PyObject *
pStub_IJParCSRVector__set_hooks_static(PyObject *_ignored, PyObject *_args,   \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  sidl_bool on = (sidl_bool) 0;
  struct sidl_BaseInterface__object *_exception = NULL;
...
static int
bHYPRE_IJParCSRVector_createCast(PyObject *self, PyObject *args, PyObject     \
  *kwds) {
  struct bHYPRE_IJParCSRVector__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)bHYPRE_IJParCSRVector__convert, &optarg, &url, &implObj);
  if (_okay) {
    ...
    struct sidl_BaseInterface__object *_exception = NULL;
    optarg = bHYPRE_IJParCSRVector__remoteCreate(url,&_exception);
    if (_exception) {
      sidl_rmi_NetworkException__import();
      struct sidl_rmi_NetworkException__object *_ex0;
      if ((_ex0 = (struct sidl_rmi_NetworkException__object *)
...
static PyMethodDef _IJParCSRVectorModuleMethods[] = {
  { "Create", (PyCFunction)pStub_IJParCSRVector_Create,
...
"
  ...
  { "_set_hooks_static", (PyCFunction)pStub_IJParCSRVector__set_hooks_static,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyMethodDef _IJParCSRVectorObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_IJParCSRVector__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_IJParCSRVector__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_IJParCSRVector__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_IJParCSRVector__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_IJParCSRVector__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _bHYPRE_IJParCSRVectorType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "bHYPRE.IJParCSRVector.IJParCSRVector", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
...
objects using the {\\tt \\_\\_cast} methods.", /* tp_doc */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _IJParCSRVectorObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  bHYPRE_IJParCSRVector_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

bHYPRE_IJParCSRVector__wrap_RETURN
bHYPRE_IJParCSRVector__wrap bHYPRE_IJParCSRVector__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_IJParCSRVectorType.tp_new(&_bHYPRE_IJParCSRVectorType,   \
      NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
bHYPRE_IJParCSRVector__weakRef bHYPRE_IJParCSRVector__weakRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_IJParCSRVectorType.tp_new(&_bHYPRE_IJParCSRVectorType,   \
      NULL, NULL);
...
bHYPRE_IJParCSRVector_deref bHYPRE_IJParCSRVector_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
bHYPRE_IJParCSRVector__newRef bHYPRE_IJParCSRVector__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_IJParCSRVectorType.tp_new(&_bHYPRE_IJParCSRVectorType,   \
      NULL, NULL);
...
bHYPRE_IJParCSRVector__addRef bHYPRE_IJParCSRVector__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
bHYPRE_IJParCSRVector_PyType bHYPRE_IJParCSRVector_PyType_PROTO {
  Py_INCREF(&_bHYPRE_IJParCSRVectorType);
  return &_bHYPRE_IJParCSRVectorType;
}

bHYPRE_IJParCSRVector__convert_RETURN
bHYPRE_IJParCSRVector__convert bHYPRE_IJParCSRVector__convert_PROTO {
  *sidlobj = sidl_Cast(obj, "bHYPRE.IJParCSRVector");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) bHYPRE.IJParCSRVector");
    return 0;
  }
  return 1;
}
...
{
  struct bHYPRE_IJParCSRVector__object *sidlobj;
  if (bHYPRE_IJParCSRVector__convert(pyobj, &sidlobj)) {
  ...
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              bHYPRE_IJParCSRVector__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct bHYPRE_IJParCSRVector__object *sidlobj = (struct                     \
    bHYPRE_IJParCSRVector__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = bHYPRE_IJParCSRVector__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initIJParCSRVector(void) {
  PyObject *module, *dict, *c_api;
  static void *ExternalAPI[bHYPRE_IJParCSRVector__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  sidl_DLL dll = NULL;
  struct bHYPRE_IJParCSRVector__external*(*_extFunc)(void) = NULL;
  module = Py_InitModule3("IJParCSRVector", _IJParCSRVectorModuleMethods, "\
\
The IJParCSR vector class.\n\
\n\
Objects of this type can be cast to IJVectorView or Vector\n\
objects using the {\\tt \\_\\_cast} methods."
  ...
  ExternalAPI[bHYPRE_IJParCSRVector__wrap_NUM] = (                            \
    void*)bHYPRE_IJParCSRVector__wrap;
  ExternalAPI[bHYPRE_IJParCSRVector__convert_NUM] = (                         \
    void*)bHYPRE_IJParCSRVector__convert;
  ExternalAPI[bHYPRE_IJParCSRVector__convert_python_array_NUM] = (            \
    void*)bHYPRE_IJParCSRVector__convert_python_array;
  ExternalAPI[bHYPRE_IJParCSRVector__convert_sidl_array_NUM] = (              \
    void*)bHYPRE_IJParCSRVector__convert_sidl_array;
  ExternalAPI[bHYPRE_IJParCSRVector__weakRef_NUM] = (                         \
    void*)bHYPRE_IJParCSRVector__weakRef;
  ExternalAPI[bHYPRE_IJParCSRVector_deref_NUM] = (                            \
    void*)bHYPRE_IJParCSRVector_deref;
  ExternalAPI[bHYPRE_IJParCSRVector__newRef_NUM] = (                          \
    void*)bHYPRE_IJParCSRVector__newRef;
  ExternalAPI[bHYPRE_IJParCSRVector__addRef_NUM] = (                          \
    void*)bHYPRE_IJParCSRVector__addRef;
  ExternalAPI[bHYPRE_IJParCSRVector_PyType_NUM] = (                           \
    void*)bHYPRE_IJParCSRVector_PyType;
  ExternalAPI[bHYPRE_IJParCSRVector__connectI_NUM] = (                        \
    void*)bHYPRE_IJParCSRVector__connectI;
  ExternalAPI[bHYPRE_IJParCSRVector__rmicast_NUM] = (                         \
    void*)bHYPRE_IJParCSRVector__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  bHYPRE_Vector__import();
  sidl_BaseClass__import();
  _bHYPRE_IJParCSRVectorType.tp_base = sidl_BaseClass_PyType();
  _bHYPRE_IJParCSRVectorType.tp_bases = PyTuple_New(3);
  PyTuple_SetItem(_bHYPRE_IJParCSRVectorType.tp_bases,0, (PyObject            \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_IJParCSRVectorType.tp_bases,1, (PyObject            \
    *)bHYPRE_Vector_PyType());
  PyTuple_SetItem(_bHYPRE_IJParCSRVectorType.tp_bases,2, (PyObject            \
    *)bHYPRE_IJVectorView_PyType());
  if (PyType_Ready(&_bHYPRE_IJParCSRVectorType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on bHYPRE.IJParCSRVector failed.\n");
    return;
  }
  Py_INCREF(&_bHYPRE_IJParCSRVectorType);
  PyDict_SetItemString(dict, "IJParCSRVector", (PyObject                      \
    *)&_bHYPRE_IJParCSRVectorType);
  ...
  if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                  \
    &throwaway_exception)) {
    _extFunc = (struct bHYPRE_IJParCSRVector__external*(*)(void))
      sidl_DLL_lookupSymbol(dll, "bHYPRE_IJParCSRVector__externals",          \
        &throwaway_exception);
    if (_extFunc) {
      _implEPV = (*_extFunc)();
    }
  ...
  if (_implEPV) {
    _sepv = (*_implEPV->getStaticEPV)();
    if (PyErr_Occurred()) {
      Py_FatalError("Cannot initialize Python module bHYPRE.IJParCSRVector.");
    }
  }
  else {
