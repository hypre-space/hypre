...
static PyObject *
pStub_Vector__connect(PyObject *_ignored, PyObject *_args, PyObject *_kwdict) \
  {
...
initVector(void) {
  ...
  PyTuple_SetItem(_bHYPRE_VectorType.tp_bases,0, (PyObject                    \
