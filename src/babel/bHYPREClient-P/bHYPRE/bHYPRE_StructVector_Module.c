/*
 * File:          bHYPRE_StructVector_Module.c
...
#define bHYPRE_StructVector_INTERNAL 1
#include "bHYPRE_StructVector_Module.h"
...
static PyObject *
pStub_StructVector__connect(PyObject *_ignored, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_StructVector__object* self = NULL;
  char* url = NULL;
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &url);
  if (_okay) {
    self = bHYPRE_StructVector__remoteConnect(url,1,&_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)bHYPRE_StructVector__wrap, self);
    }
  }
  return _return_value;
}

staticforward PyTypeObject _bHYPRE_StructVectorType;

static struct bHYPRE_StructVector__sepv *_sepv = NULL;

static const struct bHYPRE_StructVector__external *_implEPV = NULL;

static PyObject *
pStub_StructVector_Create(PyObject *_ignored, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  ...
  if (_okay) {
    struct bHYPRE_StructVector__object* _return = NULL;
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)bHYPRE_StructVector__wrap, _return);
    }
...
static PyObject *
pStub_StructVector__exec(PyObject *_self, PyObject *_args, PyObject *_kwdict) \
  {
  PyObject *_return_value = NULL;
  struct bHYPRE_StructVector__object *_self_ior =
    ((struct bHYPRE_StructVector__object *)
     sidl_Cast(_self, "bHYPRE.StructVector"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a bHYPRE.StructVector");
  }
  return _return_value;
}

static PyObject *
pStub_StructVector__getURL(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_StructVector__object *_self_ior =
    ((struct bHYPRE_StructVector__object *)
...
static PyObject *
pStub_StructVector__isLocal(PyObject *_self, PyObject *_args, PyObject        \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_StructVector__object *_self_ior =
    ((struct bHYPRE_StructVector__object *)
...
static PyObject *
pStub_StructVector__isRemote(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_StructVector__object *_self_ior =
    ((struct bHYPRE_StructVector__object *)
...
static PyObject *
pStub_StructVector__set_hooks(PyObject *_self, PyObject *_args, PyObject      \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_StructVector__object *_self_ior =
    ((struct bHYPRE_StructVector__object *)
...
static PyObject *
pStub_StructVector__set_hooks_static(PyObject *_ignored, PyObject *_args,     \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  sidl_bool on = (sidl_bool) 0;
  struct sidl_BaseInterface__object *_exception = NULL;
...
static int
bHYPRE_StructVector_createCast(PyObject *self, PyObject *args, PyObject       \
  *kwds) {
  struct bHYPRE_StructVector__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)bHYPRE_StructVector__convert, &optarg, &url, &implObj);
  if (_okay) {
    ...
    struct sidl_BaseInterface__object *_exception = NULL;
    optarg = bHYPRE_StructVector__remoteCreate(url,&_exception);
    if (_exception) {
      sidl_rmi_NetworkException__import();
      struct sidl_rmi_NetworkException__object *_ex0;
      if ((_ex0 = (struct sidl_rmi_NetworkException__object *)
...
static PyMethodDef _StructVectorModuleMethods[] = {
  { "Create", (PyCFunction)pStub_StructVector_Create,
...
RETURNS\n\
   ( out bHYPRE.StructVector self)\n\
RAISES\n\
    sidl.rmi.NetworkException\n\
"
   },
  { "_set_hooks_static", (PyCFunction)pStub_StructVector__set_hooks_static,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyMethodDef _StructVectorObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_StructVector__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_StructVector__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_StructVector__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_StructVector__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_StructVector__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _bHYPRE_StructVectorType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "bHYPRE.StructVector.StructVector", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
SIDL wrapper for the bHYPRE.StructVector type.\
", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _StructVectorObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  bHYPRE_StructVector_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

bHYPRE_StructVector__wrap_RETURN
bHYPRE_StructVector__wrap bHYPRE_StructVector__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_StructVectorType.tp_new(&_bHYPRE_StructVectorType, NULL, \
      NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
bHYPRE_StructVector__weakRef bHYPRE_StructVector__weakRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_StructVectorType.tp_new(&_bHYPRE_StructVectorType, NULL, \
      NULL);
...
bHYPRE_StructVector_deref bHYPRE_StructVector_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
bHYPRE_StructVector__newRef bHYPRE_StructVector__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _bHYPRE_StructVectorType.tp_new(&_bHYPRE_StructVectorType, NULL, \
      NULL);
...
bHYPRE_StructVector__addRef bHYPRE_StructVector__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
bHYPRE_StructVector_PyType bHYPRE_StructVector_PyType_PROTO {
  Py_INCREF(&_bHYPRE_StructVectorType);
  return &_bHYPRE_StructVectorType;
}

bHYPRE_StructVector__convert_RETURN
bHYPRE_StructVector__convert bHYPRE_StructVector__convert_PROTO {
  *sidlobj = sidl_Cast(obj, "bHYPRE.StructVector");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) bHYPRE.StructVector");
    return 0;
  }
  return 1;
}
...
{
  struct bHYPRE_StructVector__object *sidlobj;
  if (bHYPRE_StructVector__convert(pyobj, &sidlobj)) {
  ...
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              bHYPRE_StructVector__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct bHYPRE_StructVector__object *sidlobj = (struct                       \
    bHYPRE_StructVector__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = bHYPRE_StructVector__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initStructVector(void) {
  PyObject *module, *dict, *c_api;
  static void *ExternalAPI[bHYPRE_StructVector__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  sidl_DLL dll = NULL;
  struct bHYPRE_StructVector__external*(*_extFunc)(void) = NULL;
  module = Py_InitModule("StructVector", _StructVectorModuleMethods);
  dict = PyModule_GetDict(module);
  ExternalAPI[bHYPRE_StructVector__wrap_NUM] = (                              \
    void*)bHYPRE_StructVector__wrap;
  ExternalAPI[bHYPRE_StructVector__convert_NUM] = (                           \
    void*)bHYPRE_StructVector__convert;
  ExternalAPI[bHYPRE_StructVector__convert_python_array_NUM] = (              \
    void*)bHYPRE_StructVector__convert_python_array;
  ExternalAPI[bHYPRE_StructVector__convert_sidl_array_NUM] = (                \
    void*)bHYPRE_StructVector__convert_sidl_array;
  ExternalAPI[bHYPRE_StructVector__weakRef_NUM] = (                           \
    void*)bHYPRE_StructVector__weakRef;
  ExternalAPI[bHYPRE_StructVector_deref_NUM] = (                              \
    void*)bHYPRE_StructVector_deref;
  ExternalAPI[bHYPRE_StructVector__newRef_NUM] = (                            \
    void*)bHYPRE_StructVector__newRef;
  ExternalAPI[bHYPRE_StructVector__addRef_NUM] = (                            \
    void*)bHYPRE_StructVector__addRef;
  ExternalAPI[bHYPRE_StructVector_PyType_NUM] = (                             \
    void*)bHYPRE_StructVector_PyType;
  ExternalAPI[bHYPRE_StructVector__connectI_NUM] = (                          \
    void*)bHYPRE_StructVector__connectI;
  ExternalAPI[bHYPRE_StructVector__rmicast_NUM] = (                           \
    void*)bHYPRE_StructVector__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  bHYPRE_Vector__import();
  sidl_BaseClass__import();
  _bHYPRE_StructVectorType.tp_base = sidl_BaseClass_PyType();
  _bHYPRE_StructVectorType.tp_bases = PyTuple_New(3);
  PyTuple_SetItem(_bHYPRE_StructVectorType.tp_bases,0, (PyObject              \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_StructVectorType.tp_bases,1, (PyObject              \
    *)bHYPRE_StructVectorView_PyType());
  PyTuple_SetItem(_bHYPRE_StructVectorType.tp_bases,2, (PyObject              \
    *)bHYPRE_Vector_PyType());
  if (PyType_Ready(&_bHYPRE_StructVectorType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on bHYPRE.StructVector failed.\n");
    return;
  }
  Py_INCREF(&_bHYPRE_StructVectorType);
  PyDict_SetItemString(dict, "StructVector", (PyObject                        \
    *)&_bHYPRE_StructVectorType);
  ...
  if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                  \
    &throwaway_exception)) {
    _extFunc = (struct bHYPRE_StructVector__external*(*)(void))
      sidl_DLL_lookupSymbol(dll, "bHYPRE_StructVector__externals",            \
        &throwaway_exception);
    if (_extFunc) {
      _implEPV = (*_extFunc)();
    }
  ...
  if (_implEPV) {
    _sepv = (*_implEPV->getStaticEPV)();
    if (PyErr_Occurred()) {
      Py_FatalError("Cannot initialize Python module bHYPRE.StructVector.");
    }
  }
  else {
