...
bHYPRE_SStructMatrixVectorView_createCast(PyObject *self, PyObject *args,     \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "O&", _kwlist,          \
    (void *)bHYPRE_SStructMatrixVectorView__convert, &optarg);
  if (_okay) {
...
bHYPRE_SStructMatrixVectorView__wrap                                          \
  ...
  if (sidlobj) {
    result =                                                                  \
      _bHYPRE_SStructMatrixVectorViewType.tp_new(                             \
...
initSStructMatrixVectorView(void) {
  ...
  PyTuple_SetItem(_bHYPRE_SStructMatrixVectorViewType.tp_bases,0,             \
    (PyObject *)bHYPRE_MatrixVectorView_PyType());
  if (PyType_Ready(&_bHYPRE_SStructMatrixVectorViewType) < 0) {
    PyErr_Print();
    fprintf(stderr,                                                           \
      "PyType_Ready on bHYPRE.SStructMatrixVectorView failed.\n");
    return;
  }
  Py_INCREF(&_bHYPRE_SStructMatrixVectorViewType);
  PyDict_SetItemString(dict, "SStructMatrixVectorView",                       \
    (PyObject *)&_bHYPRE_SStructMatrixVectorViewType);
