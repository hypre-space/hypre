...
static PyObject *
pStub_Schwarz__connect(PyObject *_ignored, PyObject *_args,                   \
  PyObject *_kwdict) {
...
static PyObject *
pStub_Schwarz__set_hooks(PyObject *_self, PyObject *_args,                    \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct bHYPRE_Schwarz__object *_self_ior =
    ((struct bHYPRE_Schwarz__object *)
...
static PyObject *
pStub_Schwarz__set_hooks_static(PyObject *_ignored, PyObject *_args,          \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  sidl_bool on = (sidl_bool) 0;
  struct sidl_BaseInterface__object *_exception = NULL;
...
bHYPRE_Schwarz_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)bHYPRE_Schwarz__convert, &optarg, &url, &implObj);
  if (_okay) {
...
Schwarz requires an IJParCSR matrix"
  ...
  PyTuple_SetItem(_bHYPRE_SchwarzType.tp_bases,0,                             \
    (PyObject *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_SchwarzType.tp_bases,1,                             \
