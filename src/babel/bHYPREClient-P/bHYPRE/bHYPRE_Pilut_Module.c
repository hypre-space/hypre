...
static PyObject *
pStub_Pilut__set_hooks_static(PyObject *_ignored, PyObject *_args,            \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  sidl_bool on = (sidl_bool) 0;
  struct sidl_BaseInterface__object *_exception = NULL;
...
bHYPRE_Pilut_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)bHYPRE_Pilut__convert, &optarg, &url, &implObj);
  if (_okay) {
...
Pilut has not been implemented yet."
  ...
  PyTuple_SetItem(_bHYPRE_PilutType.tp_bases,0,                               \
    (PyObject *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_bHYPRE_PilutType.tp_bases,1,                               \
