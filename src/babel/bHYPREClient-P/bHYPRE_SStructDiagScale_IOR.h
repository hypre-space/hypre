...
bHYPRE_SStructDiagScale__new(void* ddata,struct sidl_BaseInterface__object ** 
  _ex);
...
extern void bHYPRE_SStructDiagScale__init(
  struct bHYPRE_SStructDiagScale__object* self, void* ddata, struct 
...
extern void bHYPRE_SStructDiagScale__getEPVs(
  ...
  extern void bHYPRE_SStructDiagScale__fini(
    struct bHYPRE_SStructDiagScale__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void bHYPRE_SStructDiagScale__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_SStructDiagScale_fcast_bHYPRE_MPICommunicator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Operator__object* 
    skel_bHYPRE_SStructDiagScale_fcast_bHYPRE_Operator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_SStructDiagScale__object* 
    ...
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_SStructDiagScale__object* 
    skel_bHYPRE_SStructDiagScale_fcast_bHYPRE_SStructDiagScale(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Solver__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Solver__object* 
    skel_bHYPRE_SStructDiagScale_fcast_bHYPRE_Solver(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_Vector__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Vector__object* 
    skel_bHYPRE_SStructDiagScale_fcast_bHYPRE_Vector(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseClass__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* 
    skel_bHYPRE_SStructDiagScale_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_SStructDiagScale_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_bHYPRE_SStructDiagScale_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_SStructDiagScale_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
