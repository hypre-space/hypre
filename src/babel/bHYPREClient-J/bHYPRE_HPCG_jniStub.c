/*
 * File:          bHYPRE_HPCG_jniStub.c
 * Symbol:        bHYPRE.HPCG-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.HPCG
 * 
...
#ifndef included_bHYPRE_HPCG_jniStub_h
#include "bHYPRE_HPCG_jniStub.h"
#endif
...
static struct bHYPRE_HPCG__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_HPCG__object*) ptr;
}
...
static const struct bHYPRE_HPCG__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_HPCG__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_HPCG__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_HPCG__object *_ptr = (*s_external->createObject)(g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_HPCG__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_mpi_comm)
{
  ...
  struct bHYPRE_HPCG__object* _ior_res = (struct bHYPRE_HPCG__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.HPCG", FALSE);JAVA_CHECK(env);
  ...
  jobject _arg_s)
{
  ...
  struct bHYPRE_HPCG__object* _ior = NULL;
...
void bHYPRE_HPCG__register(JNIEnv* env)
{
  JNINativeMethod methods[32];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_HPCG__externals();
#else
  s_external = (struct bHYPRE_HPCG__external*)sidl_dynamicLoadIOR("bHYPRE.HPCG",
    "bHYPRE_HPCG__externals") ;
  sidl_checkIORVersion("bHYPRE.HPCG", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/HPCG;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;)LbHYPRE/HPCG;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/HPCG");
  if (cls) {
