/*
 * File:          bHYPRE_MatrixVectorView_jniStub.h
 * Symbol:        bHYPRE.MatrixVectorView-v1.0.0
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Description:   Client-side header code for bHYPRE.MatrixVectorView
 * 
...
#define included_bHYPRE_MatrixVectorView_jniStub_h
