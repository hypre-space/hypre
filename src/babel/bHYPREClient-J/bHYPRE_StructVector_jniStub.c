/*
 * File:          bHYPRE_StructVector_jniStub.c
 * Symbol:        bHYPRE.StructVector-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.StructVector
 * 
...
#include "bHYPRE_StructVector_jniStub.h"
#endif
...
static struct bHYPRE_StructVector__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_StructVector__object*) ptr;
}
...
static const struct bHYPRE_StructVector__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_StructVector__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_StructVector__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_StructVector__object *_ptr = (*s_external->createObject)(g_data,
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_StructVector__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_grid)
{
  ...
  struct bHYPRE_StructVector__object* _ior_res = (struct 
    bHYPRE_StructVector__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.StructVector", 
  ...
  jobject _arg_grid)
{
  ...
  struct bHYPRE_StructVector__object* _ior = NULL;
  struct bHYPRE_StructGrid__object* _tmp_grid = (struct 
    bHYPRE_StructGrid__object*) NULL;
  int32_t _ior_res = 0;
  jint _res = 0;
...
void bHYPRE_StructVector__register(JNIEnv* env)
{
  JNINativeMethod methods[22];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_StructVector__externals();
#else
  s_external = (struct bHYPRE_StructVector__external*)sidl_dynamicLoadIOR(
    "bHYPRE.StructVector","bHYPRE_StructVector__externals") ;
  sidl_checkIORVersion("bHYPRE.StructVector", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/StructVector;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/StructGrid;)LbHYPRE/StructVector;";
  ...
  methods[9].name      = "SetNumGhost";
  methods[9].signature = "(Lsidl/Integer$Array1;)I";
  methods[9].fnPtr     = (void *)jni_SetNumGhost;
  methods[10].name      = "SetValue";
  methods[10].signature = "(Lsidl/Integer$Array1;D)I";
  methods[10].fnPtr     = (void *)jni_SetValue;
  methods[11].name      = "SetBoxValues";
  methods[11].signature = "(Lsidl/Integer$Array1;Lsidl/Integer$Array1;Lsidl/Double$Array1;)I";
  ...
  methods[16].name      = "Clear";
  methods[16].signature = "()I";
  methods[16].fnPtr     = (void *)jni_Clear;
  methods[17].name      = "Copy";
  methods[17].signature = "(LbHYPRE/Vector;)I";
  methods[17].fnPtr     = (void *)jni_Copy;
  methods[18].name      = "Clone";
  methods[18].signature = "(LbHYPRE/Vector$Holder;)I";
  methods[18].fnPtr     = (void *)jni_Clone;
  methods[19].name      = "Scale";
  methods[19].signature = "(D)I";
  methods[19].fnPtr     = (void *)jni_Scale;
  methods[20].name      = "Dot";
  methods[20].signature = "(LbHYPRE/Vector;Lsidl/Double$Holder;)I";
  methods[20].fnPtr     = (void *)jni_Dot;
  methods[21].name      = "Axpy";
  methods[21].signature = "(DLbHYPRE/Vector;)I";
  methods[21].fnPtr     = (void *)jni_Axpy;


  cls = (*env)->FindClass(env, "bHYPRE/StructVector");
  if (cls) {
