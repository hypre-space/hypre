/*
 * File:          bHYPRE_BoomerAMG_jniStub.c
 * Symbol:        bHYPRE.BoomerAMG-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.BoomerAMG
 * 
...
#include "bHYPRE_BoomerAMG_jniStub.h"
#endif
...
static struct bHYPRE_BoomerAMG__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_BoomerAMG__object*) ptr;
}
...
static const struct bHYPRE_BoomerAMG__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_BoomerAMG__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_BoomerAMG__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_BoomerAMG__object *_ptr = (*s_external->createObject)(g_data, 
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_BoomerAMG__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_BoomerAMG__object* _ior_res = (struct 
    bHYPRE_BoomerAMG__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.BoomerAMG", FALSE);JAVA_CHECK(
    env);
  ...
  jint _arg_level)
{
  ...
  struct bHYPRE_BoomerAMG__object* _ior = NULL;
  double _tmp_relax_wt = 0.0;
  ...
  _tmp_relax_wt = (double) _arg_relax_wt;
  ...
  _ior_res = (*(_ior->d_epv->f_SetLevelRelaxWt))(
    _ior,
    _tmp_relax_wt,
    _tmp_level,
    &_ex);
...
static jint
jni_InitGridRelaxation(
  JNIEnv* env,
  jobject obj,
  jobject _arg_num_grid_sweeps,
  jobject _arg_grid_relax_type,
  jobject _arg_grid_relax_points,
  jint _arg_coarsen_type,
  jobject _arg_relax_weights,
  jint _arg_max_levels)
{
  /*
   * Declare return and temporary variables.
   */
  ...
  struct bHYPRE_BoomerAMG__object* _ior = NULL;
  struct sidl_int__array* _tmp_num_grid_sweeps = (struct sidl_int__array*) NULL;
  struct sidl_int__array* _tmp_grid_relax_type = (struct sidl_int__array*) NULL;
  struct sidl_int__array* _tmp_grid_relax_points = (struct sidl_int__array*) 
    NULL;
  int32_t _tmp_coarsen_type = 0;
  struct sidl_double__array* _tmp_relax_weights = (struct sidl_double__array*) 
    NULL;
  int32_t _tmp_max_levels = 0;
  int32_t _ior_res = 0;
  jint _res = 0;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  _ior = _get_ior(env, obj);
  if(_arg_num_grid_sweeps== NULL) {
    jclass newExcCls = (*env)->FindClass(env, "java/lang/RuntimeException");
    (*env)->ThrowNew(env, newExcCls, "Null Holder Sent as OUT Argument");
    return 0;
    }
  if(_arg_grid_relax_type== NULL) {
    jclass newExcCls = (*env)->FindClass(env, "java/lang/RuntimeException");
    (*env)->ThrowNew(env, newExcCls, "Null Holder Sent as OUT Argument");
    return 0;
    }
  if(_arg_grid_relax_points== NULL) {
    jclass newExcCls = (*env)->FindClass(env, "java/lang/RuntimeException");
    (*env)->ThrowNew(env, newExcCls, "Null Holder Sent as OUT Argument");
    return 0;
    }
  _tmp_coarsen_type = (int32_t) _arg_coarsen_type;
  if(_arg_relax_weights== NULL) {
    jclass newExcCls = (*env)->FindClass(env, "java/lang/RuntimeException");
    (*env)->ThrowNew(env, newExcCls, "Null Holder Sent as OUT Argument");
    return 0;
    }
  _tmp_max_levels = (int32_t) _arg_max_levels;

  /*
   * Call the IOR method through the EPV.
   */

  _ior_res = (*(_ior->d_epv->f_InitGridRelaxation))(
    _ior,
    &_tmp_num_grid_sweeps,
    &_tmp_grid_relax_type,
    &_tmp_grid_relax_points,
    _tmp_coarsen_type,
    &_tmp_relax_weights,
    _tmp_max_levels,
    &_ex);
  ...
  sidl_Java_I2J_array_holder(env, _arg_num_grid_sweeps, _tmp_num_grid_sweeps, 
    "sidl.Integer$Array1");
  sidl_Java_I2J_array_holder(env, _arg_grid_relax_type, _tmp_grid_relax_type, 
    "sidl.Integer$Array1");
  sidl_Java_I2J_array_holder(env, _arg_grid_relax_points, 
    _tmp_grid_relax_points, "sidl.Integer$Array2");
  sidl_Java_I2J_array_holder(env, _arg_relax_weights, _tmp_relax_weights, 
    "sidl.Double$Array1");
  _res = (jint) _ior_res;
...
void bHYPRE_BoomerAMG__register(JNIEnv* env)
{
  JNINativeMethod methods[31];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_BoomerAMG__externals();
#else
  s_external = (struct bHYPRE_BoomerAMG__external*)sidl_dynamicLoadIOR(
    "bHYPRE.BoomerAMG","bHYPRE_BoomerAMG__externals") ;
  sidl_checkIORVersion("bHYPRE.BoomerAMG", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/BoomerAMG;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/IJParCSRMatrix;)LbHYPRE/BoomerAMG;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "SetLevelRelaxWt";
  methods[8].signature = "(DI)I";
  methods[8].fnPtr     = (void *)jni_SetLevelRelaxWt;
  methods[9].name      = "InitGridRelaxation";
  methods[9].signature = "(Lsidl/Integer$Array1$Holder;Lsidl/Integer$Array1$Holder;Lsidl/Integer$Array2$Holder;ILsidl/Double$Array1$Holder;I)I";
  methods[9].fnPtr     = (void *)jni_InitGridRelaxation;
  methods[10].name      = "SetOperator";
  methods[10].signature = "(LbHYPRE/Operator;)I";
  methods[10].fnPtr     = (void *)jni_SetOperator;
  methods[11].name      = "SetTolerance";
  methods[11].signature = "(D)I";
  methods[11].fnPtr     = (void *)jni_SetTolerance;
  methods[12].name      = "SetMaxIterations";
  methods[12].signature = "(I)I";
  methods[12].fnPtr     = (void *)jni_SetMaxIterations;
  methods[13].name      = "SetLogging";
  methods[13].signature = "(I)I";
  methods[13].fnPtr     = (void *)jni_SetLogging;
  methods[14].name      = "SetPrintLevel";
  methods[14].signature = "(I)I";
  methods[14].fnPtr     = (void *)jni_SetPrintLevel;
  methods[15].name      = "GetNumIterations";
  methods[15].signature = "(Lsidl/Integer$Holder;)I";
  methods[15].fnPtr     = (void *)jni_GetNumIterations;
  methods[16].name      = "GetRelResidualNorm";
  methods[16].signature = "(Lsidl/Double$Holder;)I";
  methods[16].fnPtr     = (void *)jni_GetRelResidualNorm;
  methods[17].name      = "SetCommunicator";
  methods[17].signature = "(LbHYPRE/MPICommunicator;)I";
  methods[17].fnPtr     = (void *)jni_SetCommunicator;
  methods[18].name      = "Destroy";
  methods[18].signature = "()V";
  methods[18].fnPtr     = (void *)jni_Destroy;
  methods[19].name      = "SetIntParameter";
  methods[19].signature = "(Ljava/lang/String;I)I";
  methods[19].fnPtr     = (void *)jni_SetIntParameter;
  methods[20].name      = "SetDoubleParameter";
  methods[20].signature = "(Ljava/lang/String;D)I";
  methods[20].fnPtr     = (void *)jni_SetDoubleParameter;
  methods[21].name      = "SetStringParameter";
  methods[21].signature = "(Ljava/lang/String;Ljava/lang/String;)I";
  methods[21].fnPtr     = (void *)jni_SetStringParameter;
  methods[22].name      = "SetIntArray1Parameter";
  methods[22].signature = "(Ljava/lang/String;Lsidl/Integer$Array1;)I";
  methods[22].fnPtr     = (void *)jni_SetIntArray1Parameter;
  methods[23].name      = "SetIntArray2Parameter";
  methods[23].signature = "(Ljava/lang/String;Lsidl/Integer$Array2;)I";
  methods[23].fnPtr     = (void *)jni_SetIntArray2Parameter;
  methods[24].name      = "SetDoubleArray1Parameter";
  methods[24].signature = "(Ljava/lang/String;Lsidl/Double$Array1;)I";
  methods[24].fnPtr     = (void *)jni_SetDoubleArray1Parameter;
  methods[25].name      = "SetDoubleArray2Parameter";
  methods[25].signature = "(Ljava/lang/String;Lsidl/Double$Array2;)I";
  methods[25].fnPtr     = (void *)jni_SetDoubleArray2Parameter;
  methods[26].name      = "GetIntValue";
  methods[26].signature = "(Ljava/lang/String;Lsidl/Integer$Holder;)I";
  methods[26].fnPtr     = (void *)jni_GetIntValue;
  methods[27].name      = "GetDoubleValue";
  methods[27].signature = "(Ljava/lang/String;Lsidl/Double$Holder;)I";
  methods[27].fnPtr     = (void *)jni_GetDoubleValue;
  methods[28].name      = "Setup";
  methods[28].signature = "(LbHYPRE/Vector;LbHYPRE/Vector;)I";
  methods[28].fnPtr     = (void *)jni_Setup;
  methods[29].name      = "Apply";
  methods[29].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[29].fnPtr     = (void *)jni_Apply;
  methods[30].name      = "ApplyAdjoint";
  methods[30].signature = "(LbHYPRE/Vector;LbHYPRE/Vector$Holder;)I";
  methods[30].fnPtr     = (void *)jni_ApplyAdjoint;


  cls = (*env)->FindClass(env, "bHYPRE/BoomerAMG");
  if (cls) {
    (*env)->RegisterNatives(env, cls, methods, 31);
    (*env)->DeleteLocalRef(env, cls);
  }
}
