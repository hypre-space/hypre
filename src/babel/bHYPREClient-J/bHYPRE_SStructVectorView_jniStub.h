/*
 * File:          bHYPRE_SStructVectorView_jniStub.h
 * Symbol:        bHYPRE.SStructVectorView-v1.0.0
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Description:   Client-side header code for bHYPRE.SStructVectorView
 * 
...
#define included_bHYPRE_SStructVectorView_jniStub_h
