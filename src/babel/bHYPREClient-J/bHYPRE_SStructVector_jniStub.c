/*
 * File:          bHYPRE_SStructVector_jniStub.c
 * Symbol:        bHYPRE.SStructVector-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.SStructVector
 * 
...
#endif
#ifndef included_bHYPRE_SStructVector_jniStub_h
#include "bHYPRE_SStructVector_jniStub.h"
#endif
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    if (!cmp1) {
      ...
      if (!cmp2) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = ((struct bHYPRE_SStructVector__object*)self);
        return cast;
      }
    }
  }
...
bHYPRE_SStructVector__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "bHYPRE.SStructVector", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_SStructVector__object*) malloc(
      sizeof(struct bHYPRE_SStructVector__object));
...
static struct bHYPRE_SStructVector__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_SStructVector__object*) ptr;
}
...
static const struct bHYPRE_SStructVector__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_SStructVector__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_SStructVector__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_SStructVector__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_SStructVector__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_grid)
{
  ...
  struct bHYPRE_SStructVector__object* _ior_res = (struct 
    bHYPRE_SStructVector__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.SStructVector", 
  ...
  jint _arg_type)
{
  ...
  struct bHYPRE_SStructVector__object* _ior = NULL;
  int32_t _tmp_type = 0;
  int32_t _ior_res = 0;
  jint _res = 0;
  struct sidl_BaseInterface__object *_ex = NULL;
...
void bHYPRE_SStructVector__register(JNIEnv* env)
{
  JNINativeMethod methods[30];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_SStructVector__externals();
#else
  s_external = (struct bHYPRE_SStructVector__external*)sidl_dynamicLoadIOR(
    "bHYPRE.SStructVector","bHYPRE_SStructVector__externals") ;
  sidl_checkIORVersion("bHYPRE.SStructVector", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/SStructVector;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/SStructGrid;)LbHYPRE/SStructVector;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "SetObjectType";
  methods[8].signature = "(I)I";
  methods[8].fnPtr     = (void *)jni_SetObjectType;
  methods[9].name      = "SetGrid";
  methods[9].signature = "(LbHYPRE/SStructGrid;)I";
  methods[9].fnPtr     = (void *)jni_SetGrid;
  methods[10].name      = "SetValues";
  methods[10].signature = "(ILsidl/Integer$Array1;ID)I";
  methods[10].fnPtr     = (void *)jni_SetValues;
  methods[11].name      = "SetBoxValues";
  methods[11].signature = "(ILsidl/Integer$Array1;Lsidl/Integer$Array1;ILsidl/Double$Array1;)I";
  methods[11].fnPtr     = (void *)jni_SetBoxValues;
  methods[12].name      = "AddToValues";
  methods[12].signature = "(ILsidl/Integer$Array1;ID)I";
  methods[12].fnPtr     = (void *)jni_AddToValues;
  methods[13].name      = "AddToBoxValues";
  methods[13].signature = "(ILsidl/Integer$Array1;Lsidl/Integer$Array1;ILsidl/Double$Array1;)I";
  methods[13].fnPtr     = (void *)jni_AddToBoxValues;
  methods[14].name      = "Gather";
  methods[14].signature = "()I";
  methods[14].fnPtr     = (void *)jni_Gather;
  methods[15].name      = "GetValues";
  methods[15].signature = "(ILsidl/Integer$Array1;ILsidl/Double$Holder;)I";
  methods[15].fnPtr     = (void *)jni_GetValues;
  methods[16].name      = "GetBoxValues";
  methods[16].signature = "(ILsidl/Integer$Array1;Lsidl/Integer$Array1;ILsidl/Double$Array1$Holder;)I";
  methods[16].fnPtr     = (void *)jni_GetBoxValues;
  methods[17].name      = "SetComplex";
  methods[17].signature = "()I";
  methods[17].fnPtr     = (void *)jni_SetComplex;
  methods[18].name      = "Print";
  methods[18].signature = "(Ljava/lang/String;I)I";
  methods[18].fnPtr     = (void *)jni_Print;
  methods[19].name      = "GetObject";
  methods[19].signature = "(Lsidl/BaseInterface$Holder;)I";
  methods[19].fnPtr     = (void *)jni_GetObject;
  methods[20].name      = "SetCommunicator";
  methods[20].signature = "(LbHYPRE/MPICommunicator;)I";
  methods[20].fnPtr     = (void *)jni_SetCommunicator;
  methods[21].name      = "Destroy";
  methods[21].signature = "()V";
  methods[21].fnPtr     = (void *)jni_Destroy;
  methods[22].name      = "Initialize";
  methods[22].signature = "()I";
  methods[22].fnPtr     = (void *)jni_Initialize;
  methods[23].name      = "Assemble";
  methods[23].signature = "()I";
  methods[23].fnPtr     = (void *)jni_Assemble;
  methods[24].name      = "Clear";
  methods[24].signature = "()I";
  methods[24].fnPtr     = (void *)jni_Clear;
  methods[25].name      = "Copy";
  methods[25].signature = "(LbHYPRE/Vector;)I";
  methods[25].fnPtr     = (void *)jni_Copy;
  methods[26].name      = "Clone";
  methods[26].signature = "(LbHYPRE/Vector$Holder;)I";
  methods[26].fnPtr     = (void *)jni_Clone;
  methods[27].name      = "Scale";
  methods[27].signature = "(D)I";
  methods[27].fnPtr     = (void *)jni_Scale;
  methods[28].name      = "Dot";
  methods[28].signature = "(LbHYPRE/Vector;Lsidl/Double$Holder;)I";
  methods[28].fnPtr     = (void *)jni_Dot;
  methods[29].name      = "Axpy";
  methods[29].signature = "(DLbHYPRE/Vector;)I";
  methods[29].fnPtr     = (void *)jni_Axpy;


  cls = (*env)->FindClass(env, "bHYPRE/SStructVector");
  if (cls) {
    (*env)->RegisterNatives(env, cls, methods, 30);
    (*env)->DeleteLocalRef(env, cls);
  }
}
