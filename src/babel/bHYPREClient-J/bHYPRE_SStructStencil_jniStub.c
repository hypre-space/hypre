/*
 * File:          bHYPRE_SStructStencil_jniStub.c
 * Symbol:        bHYPRE.SStructStencil-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.SStructStencil
 * 
...
#include "bHYPRE_SStructStencil_jniStub.h"
#endif
...
static struct bHYPRE_SStructStencil__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_SStructStencil__object*) ptr;
}
...
static const struct bHYPRE_SStructStencil__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_SStructStencil__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_SStructStencil__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_SStructStencil__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_SStructStencil__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jint _arg_size)
{
  ...
  int32_t _tmp_ndim = 0;
  int32_t _tmp_size = 0;
  struct bHYPRE_SStructStencil__object* _ior_res = (struct 
    bHYPRE_SStructStencil__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.SStructStencil", 
  ...
  jobject obj)
{
  ...
  struct bHYPRE_SStructStencil__object* _ior = NULL;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  jint _arg_size)
{
  ...
  _ior_res = (*(_ior->d_epv->f_SetNumDimSize))(
    _ior,
    _tmp_ndim,
    _tmp_size,
    &_ex);
  ...
  jint _arg_var)
{
  ...
  struct bHYPRE_SStructStencil__object* _ior = NULL;
  int32_t _tmp_entry = 0;
  struct sidl_int__array* _tmp_offset = (struct sidl_int__array*) NULL;
  int32_t _tmp_var = 0;
  int32_t _ior_res = 0;
  jint _res = 0;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  _ior = _get_ior(env, obj);
  _tmp_entry = (int32_t) _arg_entry;
  _tmp_offset = (struct sidl_int__array*) sidl_Java_J2I_borrow_array(env, 
    _arg_offset);
  ...
  _ior_res = (*(_ior->d_epv->f_SetEntry))(
    _ior,
    _tmp_entry,
    _tmp_offset,
    _tmp_var,
...
void bHYPRE_SStructStencil__register(JNIEnv* env)
{
  JNINativeMethod methods[11];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_SStructStencil__externals();
#else
  s_external = (struct bHYPRE_SStructStencil__external*)sidl_dynamicLoadIOR(
    "bHYPRE.SStructStencil","bHYPRE_SStructStencil__externals") ;
  sidl_checkIORVersion("bHYPRE.SStructStencil", s_external->d_ior_major_version,
  ...
  methods[2].signature = "(LbHYPRE/SStructStencil;)J";
  ...
  methods[7].signature = "(II)LbHYPRE/SStructStencil;";
  methods[7].fnPtr     = (void *)jni_Create;
  methods[8].name      = "Destroy";
  methods[8].signature = "()V";
  methods[8].fnPtr     = (void *)jni_Destroy;
  methods[9].name      = "SetNumDimSize";
  methods[9].signature = "(II)I";
  methods[9].fnPtr     = (void *)jni_SetNumDimSize;
  methods[10].name      = "SetEntry";
  methods[10].signature = "(ILsidl/Integer$Array1;I)I";
  methods[10].fnPtr     = (void *)jni_SetEntry;


  cls = (*env)->FindClass(env, "bHYPRE/SStructStencil");
  if (cls) {
