  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.HGMRES");
  }
   ...
   */
  protected static native long _wrap(HGMRES ddata);

  /**
   * Remote constructor for the class.
   */
  public HGMRES(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new HGMRES(_connect_remote_ior(url));
  }

  /**
   * Public constructor for an existing IOR.
   */
  public HGMRES(long ior) {
    super(ior);
  }
   ...
   */
  public static native bHYPRE.HGMRES Create(
    bHYPRE.MPICommunicator mpi_comm);

  /**
   * Set the preconditioner.
   */
  public native int SetPreconditioner(
    bHYPRE.Solver s);

  /**
   * Method:  GetPreconditioner[]
   */
  public native int GetPreconditioner(
    bHYPRE.Solver.Holder s);

  /**
   * Method:  Clone[]
   */
  public native int Clone(
    bHYPRE.PreconditionedSolver.Holder x);
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("bHYPRE.HGMRES");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("bHYPRE.HGMRES");
      } catch (Exception ex) {
  ...
  public static class Holder {
     ...
     */
    public Holder(bHYPRE.HGMRES obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.HGMRES obj) {
      d_obj = obj;
    }
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.HGMRES _get(int i, int j, int k, int l, int m, int n, int o) {
      bHYPRE.HGMRES ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.HGMRES) preCast._cast2("bHYPRE.HGMRES");
      } else {
        return null;
      }
      return (bHYPRE.HGMRES) ret;
    }
     ...
     */
    public bHYPRE.HGMRES.Array _slice(int dimen, int[] numElem, int[] srcStart, 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.HGMRES.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.HGMRES.Array(preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.HGMRES.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.HGMRES.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.HGMRES.Array1(getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.HGMRES.Array2(getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.HGMRES.Array3(getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.HGMRES.Array4(getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.HGMRES.Array5(getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.HGMRES.Array6(getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.HGMRES.Array7(getBaseInterfaceArray());
          return ret;
        default:
          return null;
        }
     ...
     */
    public static class Holder {
      private bHYPRE.HGMRES.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.HGMRES.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.HGMRES.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.HGMRES.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.HGMRES 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.HGMRES[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.HGMRES _get( int j0) {
      return (bHYPRE.HGMRES)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.HGMRES get( int j0) {
      checkBounds(  j0);
      bHYPRE.HGMRES ret = null;
      ret = (bHYPRE.HGMRES) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.HGMRES.Array1 smartCopy() {
      bHYPRE.HGMRES.Array1 ret = null;
      bHYPRE.HGMRES.Array preCast = null;
      preCast = (bHYPRE.HGMRES.Array) _smartCopy();
      return new bHYPRE.HGMRES.Array1(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.HGMRES.Array1 dest) {
      _copy((bHYPRE.HGMRES.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.HGMRES value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.HGMRES value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.HGMRES[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.HGMRES[] toArray() {
      bHYPRE.HGMRES[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.HGMRES[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.HGMRES.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.HGMRES.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.HGMRES.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.HGMRES.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.HGMRES 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.HGMRES[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.HGMRES _get( int j0, int j1) {
      return (bHYPRE.HGMRES)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.HGMRES get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.HGMRES ret = null;
      ret = (bHYPRE.HGMRES) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.HGMRES.Array2 smartCopy() {
      bHYPRE.HGMRES.Array2 ret = null;
      bHYPRE.HGMRES.Array preCast = null;
      preCast = (bHYPRE.HGMRES.Array) _smartCopy();
      return new bHYPRE.HGMRES.Array2(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.HGMRES.Array2 dest) {
      _copy((bHYPRE.HGMRES.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.HGMRES value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.HGMRES value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.HGMRES[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.HGMRES[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.HGMRES[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.HGMRES.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.HGMRES.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.HGMRES.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.HGMRES.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.HGMRES 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.HGMRES[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.HGMRES _get( int j0, int j1, int j2) {
      return (bHYPRE.HGMRES)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.HGMRES get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.HGMRES ret = null;
      ret = (bHYPRE.HGMRES) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.HGMRES.Array3 smartCopy() {
      bHYPRE.HGMRES.Array3 ret = null;
      bHYPRE.HGMRES.Array preCast = null;
      preCast = (bHYPRE.HGMRES.Array) _smartCopy();
      return new bHYPRE.HGMRES.Array3(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.HGMRES.Array3 dest) {
      _copy((bHYPRE.HGMRES.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.HGMRES value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.HGMRES value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.HGMRES[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.HGMRES[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.HGMRES[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.HGMRES.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.HGMRES.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.HGMRES.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.HGMRES.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.HGMRES 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.HGMRES[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.HGMRES _get( int j0, int j1, int j2, int j3) {
      return (bHYPRE.HGMRES)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.HGMRES get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.HGMRES ret = null;
      ret = (bHYPRE.HGMRES) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.HGMRES.Array4 smartCopy() {
      bHYPRE.HGMRES.Array4 ret = null;
      bHYPRE.HGMRES.Array preCast = null;
      preCast = (bHYPRE.HGMRES.Array) _smartCopy();
      return new bHYPRE.HGMRES.Array4(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.HGMRES.Array4 dest) {
      _copy((bHYPRE.HGMRES.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.HGMRES value) {
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.HGMRES value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.HGMRES[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.HGMRES[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.HGMRES.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.HGMRES.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.HGMRES.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.HGMRES.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.HGMRES 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.HGMRES[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.HGMRES _get( int j0, int j1, int j2, int j3, int j4) {
      return (bHYPRE.HGMRES)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.HGMRES get( int j0, int j1, int j2, int j3, int j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      bHYPRE.HGMRES ret = null;
      ret = (bHYPRE.HGMRES) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.HGMRES.Array5 smartCopy() {
      bHYPRE.HGMRES.Array5 ret = null;
      bHYPRE.HGMRES.Array preCast = null;
      preCast = (bHYPRE.HGMRES.Array) _smartCopy();
      return new bHYPRE.HGMRES.Array5(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.HGMRES.Array5 dest) {
      _copy((bHYPRE.HGMRES.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3, int j4,bHYPRE.HGMRES 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3, int j4,bHYPRE.HGMRES 
      value) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      _set(  j0,  j1,  j2,  j3,  j4, 0, 0, value);
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.HGMRES[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.HGMRES[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.HGMRES.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.HGMRES.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.HGMRES.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.HGMRES.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.HGMRES 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.HGMRES[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.HGMRES _get( int j0, int j1, int j2, int j3, int j4, int j5) {
      return (bHYPRE.HGMRES)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.HGMRES get( int j0, int j1, int j2, int j3, int j4, int j5) {
      checkBounds(  j0,  j1,  j2,  j3,  j4,  j5);
      bHYPRE.HGMRES ret = null;
      ret = (bHYPRE.HGMRES) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.HGMRES.Array6 smartCopy() {
      bHYPRE.HGMRES.Array6 ret = null;
      bHYPRE.HGMRES.Array preCast = null;
      preCast = (bHYPRE.HGMRES.Array) _smartCopy();
      return new bHYPRE.HGMRES.Array6(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.HGMRES.Array6 dest) {
      _copy((bHYPRE.HGMRES.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.HGMRES[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.HGMRES[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.HGMRES.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.HGMRES.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.HGMRES.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.HGMRES.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.HGMRES 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.HGMRES[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.HGMRES get( int j0, int j1, int j2, int j3, int j4, int j5, 
      ...
      bHYPRE.HGMRES ret = null;
      ret = (bHYPRE.HGMRES) _get(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.HGMRES.Array7 smartCopy() {
      bHYPRE.HGMRES.Array7 ret = null;
      bHYPRE.HGMRES.Array preCast = null;
      preCast = (bHYPRE.HGMRES.Array) _smartCopy();
      return new bHYPRE.HGMRES.Array7(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.HGMRES.Array7 dest) {
      _copy((bHYPRE.HGMRES.Array) dest);
    }
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                ...
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.HGMRES[u4-l4+1][];
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new bHYPRE.HGMRES[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.HGMRES.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.HGMRES.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.HGMRES.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.HGMRES.Array7 get() {
        return d_obj;
      }
