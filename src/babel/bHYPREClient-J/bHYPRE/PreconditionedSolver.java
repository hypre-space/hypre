/*
 * File:          PreconditionedSolver.java
 ...
 */
public interface PreconditionedSolver extends
  ...
  bHYPRE.Solver
{
   ...
   */
  public abstract int SetPreconditioner(
    bHYPRE.Solver s);

  /**
   * Method:  GetPreconditioner[]
   */
  public abstract int GetPreconditioner(
  ...
  public static class Wrapper
    ...
    implements bHYPRE.PreconditionedSolver
  {
    /*
    ...
    static {
      gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.PreconditionedSolver");
    }
    ...
    public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
      ...
      long ior = obj._cast_ior("bHYPRE.PreconditionedSolver");
      if (ior != 0) {
        Class java_class = null;
        try {
          java_class = Class.forName("bHYPRE.PreconditionedSolver$Wrapper");
        } catch (Exception ex) {
  ...
  public static class Holder {
    private bHYPRE.PreconditionedSolver d_obj;
     ...
     */
    public Holder(bHYPRE.PreconditionedSolver obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.PreconditionedSolver obj) {
      d_obj = obj;
    }
     ...
     */
    public bHYPRE.PreconditionedSolver get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.PreconditionedSolver.Wrapper _get(int i, int j, int k, int l, 
      int m, int n, int o) {
      bHYPRE.PreconditionedSolver.Wrapper ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.PreconditionedSolver.Wrapper) preCast._cast2(
          "bHYPRE.PreconditionedSolver");
      } else {
        return null;
      }
      return (bHYPRE.PreconditionedSolver.Wrapper) ret;
    }
    ...
    public void _set(int i, int j, int k, int l, int m, int n, int o, 
      bHYPRE.PreconditionedSolver value) {
     ...
     */
    public bHYPRE.PreconditionedSolver.Array _slice(int dimen, int[] numElem, 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.PreconditionedSolver.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.PreconditionedSolver.Array(
        preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.PreconditionedSolver.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.PreconditionedSolver.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.PreconditionedSolver.Array1(
            getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.PreconditionedSolver.Array2(
            getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.PreconditionedSolver.Array3(
            getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.PreconditionedSolver.Array4(
            getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.PreconditionedSolver.Array5(
            getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.PreconditionedSolver.Array6(
            getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.PreconditionedSolver.Array7(
            getBaseInterfaceArray());
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private bHYPRE.PreconditionedSolver.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PreconditionedSolver.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PreconditionedSolver.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.PreconditionedSolver.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PreconditionedSolver 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.PreconditionedSolver[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.PreconditionedSolver.Wrapper _get( int j0) {
      return (bHYPRE.PreconditionedSolver.Wrapper)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PreconditionedSolver.Wrapper get( int j0) {
      checkBounds(  j0);
      bHYPRE.PreconditionedSolver.Wrapper ret = null;
      ret = (bHYPRE.PreconditionedSolver.Wrapper) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.PreconditionedSolver.Array1 smartCopy() {
      bHYPRE.PreconditionedSolver.Array1 ret = null;
      bHYPRE.PreconditionedSolver.Array preCast = null;
      preCast = (bHYPRE.PreconditionedSolver.Array) _smartCopy();
      return new bHYPRE.PreconditionedSolver.Array1(
     ...
     */
    public void copy(bHYPRE.PreconditionedSolver.Array1 dest) {
      _copy((bHYPRE.PreconditionedSolver.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.PreconditionedSolver value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.PreconditionedSolver value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.PreconditionedSolver[] orray , boolean inRow) 
      {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.PreconditionedSolver[] toArray() {
      bHYPRE.PreconditionedSolver[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.PreconditionedSolver[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.PreconditionedSolver.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PreconditionedSolver.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PreconditionedSolver.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.PreconditionedSolver.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PreconditionedSolver 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.PreconditionedSolver[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.PreconditionedSolver.Wrapper _get( int j0, int j1) {
      return (bHYPRE.PreconditionedSolver.Wrapper)_get(  j0,  j1, 0, 0, 0, 0, 
        0);
    }
     ...
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PreconditionedSolver.Wrapper get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.PreconditionedSolver.Wrapper ret = null;
      ret = (bHYPRE.PreconditionedSolver.Wrapper) _get(  j0,  j1, 0, 0, 0, 0, 
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PreconditionedSolver.Array2 smartCopy() {
      bHYPRE.PreconditionedSolver.Array2 ret = null;
      bHYPRE.PreconditionedSolver.Array preCast = null;
      preCast = (bHYPRE.PreconditionedSolver.Array) _smartCopy();
      return new bHYPRE.PreconditionedSolver.Array2(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PreconditionedSolver.Array2 dest) {
      _copy((bHYPRE.PreconditionedSolver.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.PreconditionedSolver value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.PreconditionedSolver value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.PreconditionedSolver[][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
    ...
    public bHYPRE.PreconditionedSolver[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.PreconditionedSolver[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.PreconditionedSolver[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PreconditionedSolver.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PreconditionedSolver.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PreconditionedSolver.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.PreconditionedSolver.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PreconditionedSolver 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.PreconditionedSolver[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.PreconditionedSolver.Wrapper _get( int j0, int j1, int j2) {
      return (bHYPRE.PreconditionedSolver.Wrapper)_get(  j0,  j1,  j2, 0, 0, 0, 
        0);
    }
     ...
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PreconditionedSolver.Wrapper get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.PreconditionedSolver.Wrapper ret = null;
      ret = (bHYPRE.PreconditionedSolver.Wrapper) _get(  j0,  j1,  j2, 0, 0, 0, 
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PreconditionedSolver.Array3 smartCopy() {
      bHYPRE.PreconditionedSolver.Array3 ret = null;
      bHYPRE.PreconditionedSolver.Array preCast = null;
      preCast = (bHYPRE.PreconditionedSolver.Array) _smartCopy();
      return new bHYPRE.PreconditionedSolver.Array3(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PreconditionedSolver.Array3 dest) {
      _copy((bHYPRE.PreconditionedSolver.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.PreconditionedSolver value) 
      {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.PreconditionedSolver value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public bHYPRE.PreconditionedSolver[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.PreconditionedSolver[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.PreconditionedSolver[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PreconditionedSolver.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PreconditionedSolver.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PreconditionedSolver.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.PreconditionedSolver.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PreconditionedSolver 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.PreconditionedSolver[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.PreconditionedSolver.Wrapper _get( int j0, int j1, int j2, 
      int j3) {
      return (bHYPRE.PreconditionedSolver.Wrapper)_get(  j0,  j1,  j2,  j3, 0, 
        0, 0);
    }
     ...
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.PreconditionedSolver.Wrapper get( int j0, int j1, int j2, int 
      j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.PreconditionedSolver.Wrapper ret = null;
      ret = (bHYPRE.PreconditionedSolver.Wrapper) _get(  j0,  j1,  j2,  j3, 0, 
        0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PreconditionedSolver.Array4 smartCopy() {
      bHYPRE.PreconditionedSolver.Array4 ret = null;
      bHYPRE.PreconditionedSolver.Array preCast = null;
      preCast = (bHYPRE.PreconditionedSolver.Array) _smartCopy();
      return new bHYPRE.PreconditionedSolver.Array4(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PreconditionedSolver.Array4 dest) {
      _copy((bHYPRE.PreconditionedSolver.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.PreconditionedSolver 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.PreconditionedSolver[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.PreconditionedSolver[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PreconditionedSolver.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PreconditionedSolver.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PreconditionedSolver.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.PreconditionedSolver.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PreconditionedSolver 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.PreconditionedSolver[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.PreconditionedSolver.Wrapper _get( int j0, int j1, int j2, 
      int j3, int j4) {
      return (bHYPRE.PreconditionedSolver.Wrapper)_get(  j0,  j1,  j2,  j3,  j4,
        0, 0);
    }
    ...
    public bHYPRE.PreconditionedSolver.Wrapper get( int j0, int j1, int j2, int 
      ...
      bHYPRE.PreconditionedSolver.Wrapper ret = null;
      ret = (bHYPRE.PreconditionedSolver.Wrapper) _get(  j0,  j1,  j2,  j3,  j4,
        0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PreconditionedSolver.Array5 smartCopy() {
      bHYPRE.PreconditionedSolver.Array5 ret = null;
      bHYPRE.PreconditionedSolver.Array preCast = null;
      preCast = (bHYPRE.PreconditionedSolver.Array) _smartCopy();
      return new bHYPRE.PreconditionedSolver.Array5(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PreconditionedSolver.Array5 dest) {
      _copy((bHYPRE.PreconditionedSolver.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.PreconditionedSolver[][][][][] orray , 
      boolean inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.PreconditionedSolver[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.PreconditionedSolver[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PreconditionedSolver.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PreconditionedSolver.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PreconditionedSolver.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.PreconditionedSolver.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PreconditionedSolver 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.PreconditionedSolver[][][][][][] array, boolean isRow) 
      {
      super();
      fromArray(array, isRow);
    }
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PreconditionedSolver.Array6 smartCopy() {
      bHYPRE.PreconditionedSolver.Array6 ret = null;
      bHYPRE.PreconditionedSolver.Array preCast = null;
      preCast = (bHYPRE.PreconditionedSolver.Array) _smartCopy();
      return new bHYPRE.PreconditionedSolver.Array6(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PreconditionedSolver.Array6 dest) {
      _copy((bHYPRE.PreconditionedSolver.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                ...
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new 
                    bHYPRE.PreconditionedSolver[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PreconditionedSolver.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PreconditionedSolver.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PreconditionedSolver.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.PreconditionedSolver.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.PreconditionedSolver 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.PreconditionedSolver[][][][][][][] array, boolean 
      isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.PreconditionedSolver.Array7 smartCopy() {
      bHYPRE.PreconditionedSolver.Array7 ret = null;
      bHYPRE.PreconditionedSolver.Array preCast = null;
      preCast = (bHYPRE.PreconditionedSolver.Array) _smartCopy();
      return new bHYPRE.PreconditionedSolver.Array7(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.PreconditionedSolver.Array7 dest) {
      _copy((bHYPRE.PreconditionedSolver.Array) dest);
    }
                ...
                for (int m = l4; m <= u4; m++) {
                  ...
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new 
                      bHYPRE.PreconditionedSolver[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.PreconditionedSolver.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.PreconditionedSolver.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.PreconditionedSolver.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.PreconditionedSolver.Array7 get() {
        return d_obj;
      }
