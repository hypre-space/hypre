 ...
 */
public interface SStructMatrixView extends
  ...
  bHYPRE.SStructMatrixVectorView
{
   ...
   * entries.
   */
  public abstract int SetNSSymmetric(
    int symmetric);
  ...
  public static class Wrapper
    ...
    implements bHYPRE.SStructMatrixView
  {
    /*
    ...
    static {
      gov.llnl.sidl.BaseClass._registerNatives("bHYPRE.SStructMatrixView");
    }
    ...
    public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
      ...
      long ior = obj._cast_ior("bHYPRE.SStructMatrixView");
      if (ior != 0) {
        Class java_class = null;
        try {
          java_class = Class.forName("bHYPRE.SStructMatrixView$Wrapper");
        } catch (Exception ex) {
  ...
  public static class Holder {
    private bHYPRE.SStructMatrixView d_obj;
     ...
     */
    public Holder(bHYPRE.SStructMatrixView obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(bHYPRE.SStructMatrixView obj) {
      d_obj = obj;
    }
     ...
     */
    public bHYPRE.SStructMatrixView get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public bHYPRE.SStructMatrixView.Wrapper _get(int i, int j, int k, int l, 
      int m, int n, int o) {
      bHYPRE.SStructMatrixView.Wrapper ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (bHYPRE.SStructMatrixView.Wrapper) preCast._cast2(
          "bHYPRE.SStructMatrixView");
      } else {
        return null;
      }
      return (bHYPRE.SStructMatrixView.Wrapper) ret;
    }
    ...
    public void _set(int i, int j, int k, int l, int m, int n, int o, 
      bHYPRE.SStructMatrixView value) {
     ...
     */
    public bHYPRE.SStructMatrixView.Array _slice(int dimen, int[] numElem, 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new bHYPRE.SStructMatrixView.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new bHYPRE.SStructMatrixView.Array(
        preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(bHYPRE.SStructMatrixView.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        bHYPRE.SStructMatrixView.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new bHYPRE.SStructMatrixView.Array1(
            getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new bHYPRE.SStructMatrixView.Array2(
            getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new bHYPRE.SStructMatrixView.Array3(
            getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new bHYPRE.SStructMatrixView.Array4(
            getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new bHYPRE.SStructMatrixView.Array5(
            getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new bHYPRE.SStructMatrixView.Array6(
            getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new bHYPRE.SStructMatrixView.Array7(
            getBaseInterfaceArray());
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private bHYPRE.SStructMatrixView.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructMatrixView.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructMatrixView.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructMatrixView.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructMatrixView 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(bHYPRE.SStructMatrixView[] array, boolean isRow) {
      super();
     ...
     */
    public bHYPRE.SStructMatrixView.Wrapper _get( int j0) {
      return (bHYPRE.SStructMatrixView.Wrapper)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructMatrixView.Wrapper get( int j0) {
      checkBounds(  j0);
      bHYPRE.SStructMatrixView.Wrapper ret = null;
      ret = (bHYPRE.SStructMatrixView.Wrapper) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public bHYPRE.SStructMatrixView.Array1 smartCopy() {
      bHYPRE.SStructMatrixView.Array1 ret = null;
      bHYPRE.SStructMatrixView.Array preCast = null;
      preCast = (bHYPRE.SStructMatrixView.Array) _smartCopy();
      return new bHYPRE.SStructMatrixView.Array1(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     */
    public void copy(bHYPRE.SStructMatrixView.Array1 dest) {
      _copy((bHYPRE.SStructMatrixView.Array) dest);
    }
     ...
     */
    public void _set( int j0,bHYPRE.SStructMatrixView value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,bHYPRE.SStructMatrixView value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructMatrixView[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public bHYPRE.SStructMatrixView[] toArray() {
      bHYPRE.SStructMatrixView[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new bHYPRE.SStructMatrixView[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private bHYPRE.SStructMatrixView.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructMatrixView.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructMatrixView.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructMatrixView.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructMatrixView 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(bHYPRE.SStructMatrixView[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructMatrixView.Wrapper _get( int j0, int j1) {
      return (bHYPRE.SStructMatrixView.Wrapper)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructMatrixView.Wrapper get( int j0, int j1) {
      checkBounds(  j0,  j1);
      bHYPRE.SStructMatrixView.Wrapper ret = null;
      ret = (bHYPRE.SStructMatrixView.Wrapper) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructMatrixView.Array2 smartCopy() {
      bHYPRE.SStructMatrixView.Array2 ret = null;
      bHYPRE.SStructMatrixView.Array preCast = null;
      preCast = (bHYPRE.SStructMatrixView.Array) _smartCopy();
      return new bHYPRE.SStructMatrixView.Array2(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructMatrixView.Array2 dest) {
      _copy((bHYPRE.SStructMatrixView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,bHYPRE.SStructMatrixView value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,bHYPRE.SStructMatrixView value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public bHYPRE.SStructMatrixView[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new bHYPRE.SStructMatrixView[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.SStructMatrixView[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructMatrixView.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructMatrixView.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructMatrixView.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructMatrixView.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructMatrixView 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(bHYPRE.SStructMatrixView[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructMatrixView.Wrapper _get( int j0, int j1, int j2) {
      return (bHYPRE.SStructMatrixView.Wrapper)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructMatrixView.Wrapper get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      bHYPRE.SStructMatrixView.Wrapper ret = null;
      ret = (bHYPRE.SStructMatrixView.Wrapper) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructMatrixView.Array3 smartCopy() {
      bHYPRE.SStructMatrixView.Array3 ret = null;
      bHYPRE.SStructMatrixView.Array preCast = null;
      preCast = (bHYPRE.SStructMatrixView.Array) _smartCopy();
      return new bHYPRE.SStructMatrixView.Array3(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructMatrixView.Array3 dest) {
      _copy((bHYPRE.SStructMatrixView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,bHYPRE.SStructMatrixView value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,bHYPRE.SStructMatrixView value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructMatrixView[][][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
    ...
    public bHYPRE.SStructMatrixView[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new bHYPRE.SStructMatrixView[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.SStructMatrixView[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructMatrixView.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructMatrixView.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructMatrixView.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructMatrixView.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructMatrixView 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(bHYPRE.SStructMatrixView[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public bHYPRE.SStructMatrixView.Wrapper _get( int j0, int j1, int j2, int 
      j3) {
      return (bHYPRE.SStructMatrixView.Wrapper)_get(  j0,  j1,  j2,  j3, 0, 0, 
        0);
    }
     ...
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructMatrixView.Wrapper get( int j0, int j1, int j2, int 
      j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      bHYPRE.SStructMatrixView.Wrapper ret = null;
      ret = (bHYPRE.SStructMatrixView.Wrapper) _get(  j0,  j1,  j2,  j3, 0, 0, 
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructMatrixView.Array4 smartCopy() {
      bHYPRE.SStructMatrixView.Array4 ret = null;
      bHYPRE.SStructMatrixView.Array preCast = null;
      preCast = (bHYPRE.SStructMatrixView.Array) _smartCopy();
      return new bHYPRE.SStructMatrixView.Array4(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructMatrixView.Array4 dest) {
      _copy((bHYPRE.SStructMatrixView.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,bHYPRE.SStructMatrixView 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,bHYPRE.SStructMatrixView 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new bHYPRE.SStructMatrixView[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.SStructMatrixView[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructMatrixView.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructMatrixView.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructMatrixView.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructMatrixView.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructMatrixView 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(bHYPRE.SStructMatrixView[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.SStructMatrixView.Wrapper _get( int j0, int j1, int j2, int 
      j3, int j4) {
      return (bHYPRE.SStructMatrixView.Wrapper)_get(  j0,  j1,  j2,  j3,  j4, 0,
        0);
    }
     ...
     * Get the element at the specified array with bounds checking
     */
    public bHYPRE.SStructMatrixView.Wrapper get( int j0, int j1, int j2, int j3,
      int j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      bHYPRE.SStructMatrixView.Wrapper ret = null;
      ret = (bHYPRE.SStructMatrixView.Wrapper) _get(  j0,  j1,  j2,  j3,  j4, 0,
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructMatrixView.Array5 smartCopy() {
      bHYPRE.SStructMatrixView.Array5 ret = null;
      bHYPRE.SStructMatrixView.Array preCast = null;
      preCast = (bHYPRE.SStructMatrixView.Array) _smartCopy();
      return new bHYPRE.SStructMatrixView.Array5(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructMatrixView.Array5 dest) {
      _copy((bHYPRE.SStructMatrixView.Array) dest);
    }
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new bHYPRE.SStructMatrixView[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.SStructMatrixView[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructMatrixView.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructMatrixView.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructMatrixView.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructMatrixView.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructMatrixView 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(bHYPRE.SStructMatrixView[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public bHYPRE.SStructMatrixView.Wrapper _get( int j0, int j1, int j2, int 
      j3, int j4, int j5) {
      return (bHYPRE.SStructMatrixView.Wrapper)_get(  j0,  j1,  j2,  j3,  j4,  
        j5, 0);
    }
    ...
    public bHYPRE.SStructMatrixView.Wrapper get( int j0, int j1, int j2, int j3,
      ...
      bHYPRE.SStructMatrixView.Wrapper ret = null;
      ret = (bHYPRE.SStructMatrixView.Wrapper) _get(  j0,  j1,  j2,  j3,  j4,  
        j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructMatrixView.Array6 smartCopy() {
      bHYPRE.SStructMatrixView.Array6 ret = null;
      bHYPRE.SStructMatrixView.Array preCast = null;
      preCast = (bHYPRE.SStructMatrixView.Array) _smartCopy();
      return new bHYPRE.SStructMatrixView.Array6(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructMatrixView.Array6 dest) {
      _copy((bHYPRE.SStructMatrixView.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new bHYPRE.SStructMatrixView[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new bHYPRE.SStructMatrixView[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructMatrixView.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructMatrixView.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructMatrixView.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructMatrixView.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of bHYPRE.SStructMatrixView 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(bHYPRE.SStructMatrixView[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public bHYPRE.SStructMatrixView.Array7 smartCopy() {
      bHYPRE.SStructMatrixView.Array7 ret = null;
      bHYPRE.SStructMatrixView.Array preCast = null;
      preCast = (bHYPRE.SStructMatrixView.Array) _smartCopy();
      return new bHYPRE.SStructMatrixView.Array7(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(bHYPRE.SStructMatrixView.Array7 dest) {
      _copy((bHYPRE.SStructMatrixView.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( bHYPRE.SStructMatrixView[][][][][][][] orray , 
      boolean inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                ...
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new 
                    bHYPRE.SStructMatrixView[u4-l4+1][];
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new 
                      bHYPRE.SStructMatrixView[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private bHYPRE.SStructMatrixView.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(bHYPRE.SStructMatrixView.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(bHYPRE.SStructMatrixView.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public bHYPRE.SStructMatrixView.Array7 get() {
        return d_obj;
      }
