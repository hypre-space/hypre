/*
 * File:          bHYPRE_StructDiagScale_jniStub.c
 * Symbol:        bHYPRE.StructDiagScale-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.StructDiagScale
 * 
...
#include "bHYPRE_StructDiagScale_jniStub.h"
#endif
...
static struct bHYPRE_StructDiagScale__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_StructDiagScale__object*) ptr;
}
...
static const struct bHYPRE_StructDiagScale__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_StructDiagScale__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_StructDiagScale__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_StructDiagScale__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_StructDiagScale__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_StructDiagScale__object* _ior_res = (struct 
    bHYPRE_StructDiagScale__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.StructDiagScale", 
    FALSE);JAVA_CHECK(env);
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_StructDiagScale__object* _ior = NULL;
...
void bHYPRE_StructDiagScale__register(JNIEnv* env)
{
  JNINativeMethod methods[29];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_StructDiagScale__externals();
#else
  s_external = (struct bHYPRE_StructDiagScale__external*)sidl_dynamicLoadIOR(
  ...
  methods[2].signature = "(LbHYPRE/StructDiagScale;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/StructMatrix;)LbHYPRE/StructDiagScale;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/StructDiagScale");
  if (cls) {
