/*
 * File:          bHYPRE_Pilut_jniStub.c
 * Symbol:        bHYPRE.Pilut-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.Pilut
 * 
...
#include "bHYPRE_Pilut_jniStub.h"
#endif
...
static struct bHYPRE_Pilut__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_Pilut__object*) ptr;
}
...
static const struct bHYPRE_Pilut__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_Pilut__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_Pilut__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_Pilut__object *_ptr = (*s_external->createObject)(g_data, &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_Pilut__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_Operator__object* _tmp_A = (struct bHYPRE_Operator__object*) 
    NULL;
  struct bHYPRE_Pilut__object* _ior_res = (struct bHYPRE_Pilut__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.Pilut", FALSE);JAVA_CHECK(
    env);
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_Pilut__object* _ior = NULL;
  struct bHYPRE_Operator__object* _tmp_A = (struct bHYPRE_Operator__object*) 
    NULL;
  int32_t _ior_res = 0;
  jint _res = 0;
...
void bHYPRE_Pilut__register(JNIEnv* env)
{
  JNINativeMethod methods[29];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_Pilut__externals();
#else
  s_external = (struct bHYPRE_Pilut__external*)sidl_dynamicLoadIOR(
    "bHYPRE.Pilut","bHYPRE_Pilut__externals") ;
  sidl_checkIORVersion("bHYPRE.Pilut", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/Pilut;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/Operator;)LbHYPRE/Pilut;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/Pilut");
  if (cls) {
