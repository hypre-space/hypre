/*
 * File:          bHYPRE_StructPFMG_jniStub.c
 * Symbol:        bHYPRE.StructPFMG-v1.0.0
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Description:   Client-side JNI glue code for bHYPRE.StructPFMG
 * 
...
#include "bHYPRE_StructPFMG_jniStub.h"
#endif
...
bHYPRE_StructPFMG__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "bHYPRE.StructPFMG", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_StructPFMG__object*) malloc(
      sizeof(struct bHYPRE_StructPFMG__object));
...
static struct bHYPRE_StructPFMG__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct bHYPRE_StructPFMG__object*) ptr;
}
...
static const struct bHYPRE_StructPFMG__external* s_external = NULL;

/*
 * External reference to static EPV.
 */

static const struct bHYPRE_StructPFMG__sepv* s_sepv = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(bHYPRE_StructPFMG__remoteCreate(_tmp_url, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject obj)
{
  ...
  struct bHYPRE_StructPFMG__object *_ptr = (*s_external->createObject)(g_data, 
    &_ex);
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jstring url)
{
  ...
  jlong _res = 0;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(bHYPRE_StructPFMG__remoteConnect(_tmp_url, 1, &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
      _ex,
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_StructPFMG__object* _ior_res = (struct 
    bHYPRE_StructPFMG__object*) NULL;
  ...
  _res = sidl_Java_I2J_cls(env, _ior_res, "bHYPRE.StructPFMG", 
    FALSE);JAVA_CHECK(env);
  ...
  jobject _arg_A)
{
  ...
  struct bHYPRE_StructPFMG__object* _ior = NULL;
...
void bHYPRE_StructPFMG__register(JNIEnv* env)
{
  JNINativeMethod methods[29];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = bHYPRE_StructPFMG__externals();
#else
  s_external = (struct bHYPRE_StructPFMG__external*)sidl_dynamicLoadIOR(
    "bHYPRE.StructPFMG","bHYPRE_StructPFMG__externals") ;
  sidl_checkIORVersion("bHYPRE.StructPFMG", s_external->d_ior_major_version, 
  ...
  methods[2].signature = "(LbHYPRE/StructPFMG;)J";
  ...
  methods[7].signature = "(LbHYPRE/MPICommunicator;LbHYPRE/StructMatrix;)LbHYPRE/StructPFMG;";
  ...
  cls = (*env)->FindClass(env, "bHYPRE/StructPFMG");
  if (cls) {
