...
// Revision:      @(#) $Id: sidl_PostViolation.cxx,v 1.4 2007/09/27 19:55:46 painter Exp $
...
sidl::PostViolation::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_PostViolation__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
sidl::PostViolation::PostViolation ( const ::sidl::PostViolation& original ) {
  d_self = (struct sidl_PostViolation__object*) 
    original.::sidl::PostViolation::_get_ior();
  if(d_self) {
...
sidl::PostViolation::operator=( const ::sidl::PostViolation& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct sidl_PostViolation__object*) 
      rhs.::sidl::PostViolation::_get_ior();
    if(d_self) {
...
sidl::PostViolation::PostViolation ( ::sidl::PostViolation::ior_t* ior, bool 
  isWeak ) : 
...
{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_PostViolation__object*) 
    ::sidl::PostViolation::_get_ior();
  char * _local_result;
