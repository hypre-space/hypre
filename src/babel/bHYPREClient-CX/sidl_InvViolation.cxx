// 
// File:          sidl_InvViolation.cxx
// Symbol:        sidl.InvViolation-v0.9.15
// Symbol Type:   class
// Babel Version: 1.0.4
// Release:       $Name: V2-4-0b $
// Revision:      @(#) $Id: sidl_InvViolation.cxx,v 1.4 2007/09/27 19:55:45 painter Exp $
...
void
sidl::InvViolation::throwException0(
...
// static constructor
::sidl::InvViolation
sidl::InvViolation::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::InvViolation self( (*_get_ext()->createObject)(NULL,&_exception), 
    false );
  if (_exception) {
...
// remote constructor
::sidl::InvViolation
sidl::InvViolation::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_InvViolation__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::InvViolation( ior_self, false );
}

// remote connector
::sidl::InvViolation
sidl::InvViolation::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_InvViolation__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
// copy constructor
sidl::InvViolation::InvViolation ( const ::sidl::InvViolation& original ) {
  d_self = (struct sidl_InvViolation__object*) 
    original.::sidl::InvViolation::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::InvViolation&
sidl::InvViolation::operator=( const ::sidl::InvViolation& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct sidl_InvViolation__object*) 
      rhs.::sidl::InvViolation::_get_ior();
    if(d_self) {
...
sidl::InvViolation::InvViolation ( ::sidl::InvViolation::ior_t* ior ) 
...
sidl::InvViolation::InvViolation ( ::sidl::InvViolation::ior_t* ior, bool 
  isWeak ) : 
...
void ::sidl::InvViolation::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::InvViolation::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::InvViolation::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_InvViolation__object*) 
    ::sidl::InvViolation::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::InvViolation::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_InvViolation__object* sidl::InvViolation::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.InvViolation", (
      void*)sidl_InvViolation__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.InvViolation", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::InvViolation::ext_t * sidl::InvViolation::s_ext = 0;

// private static method to get static data type
const ::sidl::InvViolation::ext_t *
sidl::InvViolation::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_InvViolation__externals();
  }
  return s_ext;
}
