...
// Revision:      @(#) $Id: sidl_InvViolation.cxx,v 1.2 2006/09/14 21:52:15 painter Exp $
...
sidl::InvViolation::_create(const std::string& url) {
  ...
  ior_self = sidl_InvViolation__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::InvViolation::InvViolation ( const ::sidl::InvViolation& original ) {
  d_self = ::sidl::InvViolation::_cast(original._get_ior());
...
sidl::InvViolation::operator=( const ::sidl::InvViolation& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::InvViolation::_cast(rhs._get_ior());
