...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_SStructMatrix__object*) 
    ::bHYPRE::SStructMatrix::_get_ior();
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
 ...
 */
int32_t
bHYPRE::SStructMatrix::SetValues( /* in */int32_t part, /* in rarray[dim] 
 ...
 */
int32_t
bHYPRE::SStructMatrix::SetBoxValues( /* in */int32_t part, /* in rarray[dim] 
  */int32_t* ilower, /* in rarray[dim] */int32_t* iupper, /* in */int32_t dim, 
  /* in */int32_t var, /* in */int32_t nentries, /* in rarray[nentries] 
  */int32_t* entries, /* in rarray[nvalues] */double* values, /* in */int32_t 
  nvalues )
...
bHYPRE::SStructMatrix::SetBoxValues( /* in */int32_t part, /* in rarray[dim] 
  */::sidl::array<int32_t> ilower, /* in rarray[dim] */::sidl::array<int32_t> 
  iupper, /* in */int32_t var, /* in rarray[nentries] */::sidl::array<int32_t> 
  entries, /* in rarray[nvalues] */::sidl::array<double> values )
 ...
 */
int32_t
bHYPRE::SStructMatrix::AddToValues( /* in */int32_t part, /* in rarray[dim] 
  */int32_t* index, /* in */int32_t dim, /* in */int32_t var, /* in */int32_t 
  nentries, /* in rarray[nentries] */int32_t* entries, /* in rarray[nentries] 
  */double* values )
 ...
 */
int32_t
bHYPRE::SStructMatrix::AddToBoxValues( /* in */int32_t part, /* in rarray[dim] 
  */int32_t* ilower, /* in rarray[dim] */int32_t* iupper, /* in */int32_t dim, 
  /* in */int32_t var, /* in */int32_t nentries, /* in rarray[nentries] 
  */int32_t* entries, /* in rarray[nvalues] */double* values, /* in */int32_t 
  nvalues )
 ...
 */
int32_t
bHYPRE::SStructMatrix::Print( /* in */const ::std::string& filename, /* in 
  */int32_t all )
 ...
 */
int32_t
bHYPRE::SStructMatrix::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::SStructMatrix::Setup( /* in */::bHYPRE::Vector b, /* in 
  */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::SStructMatrix::Apply( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
 ...
 */
int32_t
bHYPRE::SStructMatrix::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::SStructMatrix::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::SStructMatrix::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::SStructMatrix::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_SStructMatrix__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::SStructMatrix::SStructMatrix ( const ::bHYPRE::SStructMatrix& original 
  ...
  d_self = (struct bHYPRE_SStructMatrix__object*) 
    original.::bHYPRE::SStructMatrix::_get_ior();
  if(d_self) {
...
bHYPRE::SStructMatrix::operator=( const ::bHYPRE::SStructMatrix& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_SStructMatrix__object*) 
      rhs.::bHYPRE::SStructMatrix::_get_ior();
    if(d_self) {
...
#else
    s_ext = (struct bHYPRE_SStructMatrix__external*)sidl_dynamicLoadIOR(
