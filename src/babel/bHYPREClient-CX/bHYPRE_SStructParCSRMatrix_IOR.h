...
struct bHYPRE_SStructParCSRMatrix__controls {
  int     use_hooks;
};
/*
...
bHYPRE_SStructParCSRMatrix__new(void* ddata,
...
extern void bHYPRE_SStructParCSRMatrix__init(
  struct bHYPRE_SStructParCSRMatrix__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void bHYPRE_SStructParCSRMatrix__getEPVs(
  ...
  struct bHYPRE_MatrixVectorView__object* 
    skel_bHYPRE_SStructParCSRMatrix_fconnect_bHYPRE_MatrixVectorView(const 
  ...
  struct bHYPRE_ProblemDefinition__object* 
    skel_bHYPRE_SStructParCSRMatrix_fconnect_bHYPRE_ProblemDefinition(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_ProblemDefinition__object* 
  ...
  struct bHYPRE_SStructGraph__object* 
    skel_bHYPRE_SStructParCSRMatrix_fconnect_bHYPRE_SStructGraph(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_SStructGraph__object* 
  ...
  struct bHYPRE_SStructMatrixVectorView__object* 
    skel_bHYPRE_SStructParCSRMatrix_fconnect_bHYPRE_SStructMatrixVectorView(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_SStructMatrixVectorView__object* 
    skel_bHYPRE_SStructParCSRMatrix_fcast_bHYPRE_SStructMatrixVectorView(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_SStructMatrixView__object* 
    skel_bHYPRE_SStructParCSRMatrix_fconnect_bHYPRE_SStructMatrixView(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_SStructMatrixView__object* 
  ...
  struct bHYPRE_SStructParCSRMatrix__remote{
    int d_refcount;
