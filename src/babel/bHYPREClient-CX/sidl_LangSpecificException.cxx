...
// Revision:      @(#) $Id: sidl_LangSpecificException.cxx,v 1.2 2006/09/14 21:52:15 painter Exp $
...
sidl::LangSpecificException::_create(const std::string& url) {
  ...
  ior_self = sidl_LangSpecificException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::LangSpecificException::LangSpecificException ( const 
  ...
  d_self = ::sidl::LangSpecificException::_cast(original._get_ior());
...
sidl::LangSpecificException::operator=( const ::sidl::LangSpecificException& 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::LangSpecificException::_cast(rhs._get_ior());
...
struct sidl_LangSpecificException__object* 
  sidl::LangSpecificException::_cast(const void* src)
{
  ior_t* cast = NULL;
