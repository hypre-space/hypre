 ...
 */
int32_t
bHYPRE::IJParCSRVector::SetLocalRange( /* in */int32_t jlower, /* in */int32_t 
  jupper )

{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_IJParCSRVector__object*) 
    ::bHYPRE::IJParCSRVector::_get_ior();
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
 ...
 */
int32_t
bHYPRE::IJParCSRVector::SetValues( /* in */int32_t nvalues, /* in 
  rarray[nvalues] */int32_t* indices, /* in rarray[nvalues] */double* values )

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_SetValues))(loc_self, /* in rarray[nvalues] 
    */ indices_tmp, /* in rarray[nvalues] */ values_tmp, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
...

{
  ...
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_SetValues))(loc_self, /* in rarray[nvalues] 
    */ indices._get_ior(), /* in rarray[nvalues] */ values._get_ior(), 
    &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
 ...
 */
int32_t
bHYPRE::IJParCSRVector::AddToValues( /* in */int32_t nvalues, /* in 
  rarray[nvalues] */int32_t* indices, /* in rarray[nvalues] */double* values )

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_AddToValues))(loc_self, /* in rarray[nvalues] 
    */ indices_tmp, /* in rarray[nvalues] */ values_tmp, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    sidl__array_deleteRef((struct sidl__array *)indices_tmp);
 ...
 */
int32_t
bHYPRE::IJParCSRVector::GetLocalRange( /* out */int32_t& jlower, /* out 
  */int32_t& jupper )
 ...
 */
int32_t
bHYPRE::IJParCSRVector::GetValues( /* in */int32_t nvalues, /* in 
  rarray[nvalues] */int32_t* indices, /* inout rarray[nvalues] */double* values 
  )

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_GetValues))(loc_self, /* in rarray[nvalues] 
    */ indices_tmp, /* inout rarray[nvalues] */ &values_tmp, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    sidl__array_deleteRef((struct sidl__array *)indices_tmp);
    sidl__array_deleteRef((struct sidl__array *)values_tmp);
...

{
  ...
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_GetValues))(loc_self, /* in rarray[nvalues] 
    */ indices._get_ior(), /* inout rarray[nvalues] */ &_local_values, 
    &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
 ...
 */
int32_t
bHYPRE::IJParCSRVector::Read( /* in */const ::std::string& filename, /* in 
...
bHYPRE::IJParCSRVector::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::IJParCSRVector::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::IJParCSRVector::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_IJParCSRVector__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::IJParCSRVector::IJParCSRVector ( const ::bHYPRE::IJParCSRVector& 
  original ) {
  d_self = (struct bHYPRE_IJParCSRVector__object*) 
    original.::bHYPRE::IJParCSRVector::_get_ior();
  if(d_self) {

    bHYPRE_Vector_IORCache = &((*reinterpret_cast< ior_t*>(
      d_self)).d_bhypre_vector);
    bHYPRE_IJVectorView_IORCache = &((*reinterpret_cast< ior_t*>(
      d_self)).d_bhypre_ijvectorview);
...
bHYPRE::IJParCSRVector::operator=( const ::bHYPRE::IJParCSRVector& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_IJParCSRVector__object*) 
      rhs.::bHYPRE::IJParCSRVector::_get_ior();
    if(d_self) {
...
#else
    s_ext = (struct bHYPRE_IJParCSRVector__external*)sidl_dynamicLoadIOR(
