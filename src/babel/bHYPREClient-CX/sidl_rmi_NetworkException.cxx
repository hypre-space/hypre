...
// Revision:      @(#) $Id: sidl_rmi_NetworkException.cxx,v 1.2 2006/09/14 21:52:16 painter Exp $
...

{
  ...
  struct sidl_io_Serializer__object* _local_ser = (struct 
    ...
    ::sidl::io::Serializer::_cast((void*)(ser._get_ior()));
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  ...
  if (_local_ser) {
    struct sidl_BaseInterface__object *throwaway_exception;  
    (_local_ser->d_epv->f_deleteRef)(_local_ser->d_object,
    &throwaway_exception);
  }
  /*unpack results and cleanup*/
}
...

{
  ...
  struct sidl_io_Deserializer__object* _local_des = (struct 
    ...
    ::sidl::io::Deserializer::_cast((void*)(des._get_ior()));
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  (*(loc_self->d_epv->f_unpackObj))(loc_self, /* in */ _local_des,
    &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
  ...
  if (_local_des) {
    struct sidl_BaseInterface__object *throwaway_exception;  
    (_local_des->d_epv->f_deleteRef)(_local_des->d_object,
    &throwaway_exception);
  }
  /*unpack results and cleanup*/
}
...
sidl::rmi::NetworkException::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_NetworkException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::NetworkException::NetworkException ( const 
  ...
  d_self = ::sidl::rmi::NetworkException::_cast(original._get_ior());
...
sidl::rmi::NetworkException::operator=( const ::sidl::rmi::NetworkException& 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::NetworkException::_cast(rhs._get_ior());
...
struct sidl_rmi_NetworkException__object* 
  sidl::rmi::NetworkException::_cast(const void* src)
{
  ior_t* cast = NULL;
