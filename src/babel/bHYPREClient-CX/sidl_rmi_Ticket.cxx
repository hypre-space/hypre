...
// Revision:      @(#) $Id: sidl_rmi_Ticket.cxx,v 1.2 2006/09/14 21:52:16 painter Exp $
...

{
  ...
  ior_t* const loc_self = (ior_t*) 
    ::sidl::rmi::Ticket::_cast((void*)(_get_ior()));
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _local_result = (*(loc_self->d_epv->f_test))(loc_self->d_object,
    &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
...

{
  ...
  _result = ::sidl::rmi::TicketBook( 
    (*(loc_self->d_epv->f_createEmptyTicketBook))(loc_self->d_object,
    &_exception ), false);
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
...

{
  ...
  _result = ::sidl::rmi::Response( 
    (*(loc_self->d_epv->f_getResponse))(loc_self->d_object, &_exception ),
    false);
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
...
sidl::rmi::Ticket::_connect(const std::string& url, const bool ar ) {
  ...
  ior_self = sidl_rmi_Ticket__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::Ticket::Ticket ( const ::sidl::rmi::Ticket& original ) {
  d_self = ::sidl::rmi::Ticket::_cast(original._get_ior());
...
sidl::rmi::Ticket::operator=( const ::sidl::rmi::Ticket& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::Ticket::_cast(rhs._get_ior());
