 ...
 */
int32_t
bHYPRE::ParCSRDiagScale::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
 ...
 */
int32_t
bHYPRE::ParCSRDiagScale::Setup( /* in */::bHYPRE::Vector b,
  /* in */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::ParCSRDiagScale::Apply( /* in */::bHYPRE::Vector b,
 ...
 */
int32_t
bHYPRE::ParCSRDiagScale::ApplyAdjoint( /* in */::bHYPRE::Vector b,
  /* inout */::bHYPRE::Vector& x )
...
bHYPRE::ParCSRDiagScale::_create(const std::string& url) {
  ...
  ior_self = bHYPRE_ParCSRDiagScale__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
bHYPRE::ParCSRDiagScale::ParCSRDiagScale ( const ::bHYPRE::ParCSRDiagScale& 
  original ) {
  d_self = ::bHYPRE::ParCSRDiagScale::_cast(original._get_ior());
...
bHYPRE::ParCSRDiagScale::operator=( const ::bHYPRE::ParCSRDiagScale& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::ParCSRDiagScale::_cast(rhs._get_ior());
