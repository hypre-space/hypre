// 
// File:          sidl_rmi_BindException.cxx
// Symbol:        sidl.rmi.BindException-v0.9.15
// Symbol Type:   class
// Babel Version: 1.0.4
// Release:       $Name: V2-4-0b $
// Revision:      @(#) $Id: sidl_rmi_BindException.cxx,v 1.4 2007/09/27 19:55:46 painter Exp $
...
#include "sidl_rmi_BindException.hxx"
#endif
...
void
sidl::rmi::BindException::throwException0(
...
sidl::rmi::BindException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::rmi::BindException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::rmi::BindException
sidl::rmi::BindException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_BindException__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::rmi::BindException( ior_self, false );
}

// remote connector
::sidl::rmi::BindException
sidl::rmi::BindException::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_BindException__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
// copy constructor
sidl::rmi::BindException::BindException ( const ::sidl::rmi::BindException& 
  original ) {
  d_self = (struct sidl_rmi_BindException__object*) 
    original.::sidl::rmi::BindException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::rmi::BindException&
sidl::rmi::BindException::operator=( const ::sidl::rmi::BindException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct sidl_rmi_BindException__object*) 
      rhs.::sidl::rmi::BindException::_get_ior();
    if(d_self) {
...
sidl::rmi::BindException::BindException ( ::sidl::rmi::BindException::ior_t* 
  ior ) 
...
void ::sidl::rmi::BindException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::rmi::BindException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::rmi::BindException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_rmi_BindException__object*) 
    ::sidl::rmi::BindException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::rmi::BindException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_rmi_BindException__object* sidl::rmi::BindException::_cast(const 
  void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.BindException", (
      void*)sidl_rmi_BindException__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.rmi.BindException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::rmi::BindException::ext_t * sidl::rmi::BindException::s_ext = 0;

// private static method to get static data type
const ::sidl::rmi::BindException::ext_t *
sidl::rmi::BindException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_rmi_BindException__externals();
  }
  return s_ext;
}
