...
// Revision:      @(#) $Id: sidl_rmi_BindException.cxx,v 1.3 2006/12/29 21:24:49 painter Exp $
...
sidl::rmi::BindException::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_BindException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::BindException::BindException ( const ::sidl::rmi::BindException& 
  original ) {
  d_self = ::sidl::rmi::BindException::_cast(original._get_ior());
...
sidl::rmi::BindException::operator=( const ::sidl::rmi::BindException& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::BindException::_cast(rhs._get_ior());
