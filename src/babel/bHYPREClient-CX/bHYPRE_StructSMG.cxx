...

{
  ...
  struct bHYPRE_StructMatrix__object* _local_A = A._get_ior();
 ...
 */
int32_t
bHYPRE::StructSMG::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
 ...
 */
int32_t
bHYPRE::StructSMG::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
 ...
 */
int32_t
bHYPRE::StructSMG::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::StructSMG::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
 ...
 */
int32_t
bHYPRE::StructSMG::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
 ...
 */
int32_t
bHYPRE::StructSMG::Setup( /* in */::bHYPRE::Vector b,
  /* in */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::StructSMG::Apply( /* in */::bHYPRE::Vector b,
 ...
 */
int32_t
bHYPRE::StructSMG::ApplyAdjoint( /* in */::bHYPRE::Vector b,
  /* inout */::bHYPRE::Vector& x )
...
bHYPRE::StructSMG::_create(const std::string& url) {
  ...
  ior_self = bHYPRE_StructSMG__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
bHYPRE::StructSMG::StructSMG ( const ::bHYPRE::StructSMG& original ) {
  d_self = ::bHYPRE::StructSMG::_cast(original._get_ior());
...
bHYPRE::StructSMG::operator=( const ::bHYPRE::StructSMG& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::StructSMG::_cast(rhs._get_ior());
