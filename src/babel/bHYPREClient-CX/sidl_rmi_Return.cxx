...
// Revision:      @(#) $Id: sidl_rmi_Return.cxx,v 1.2 2006/09/14 21:52:16 painter Exp $
...

{
  ...
  ior_t* const loc_self = (ior_t*) 
    ::sidl::rmi::Return::_cast((void*)(_get_ior()));
  struct sidl_BaseException__object* _local_ex_to_throw = (struct 
    sidl_BaseException__object*) 
    ::sidl::BaseException::_cast((void*)(ex_to_throw._get_ior()));
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  (*(loc_self->d_epv->f_throwException))(loc_self->d_object,
    /* in */ _local_ex_to_throw, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  if (_local_ex_to_throw) {
    struct sidl_BaseInterface__object *throwaway_exception;  
    (_local_ex_to_throw->d_epv->f_deleteRef)(_local_ex_to_throw->d_object,
    &throwaway_exception);
  }
  {  struct sidl_BaseInterface__object *throwaway_exception;  
...
sidl::rmi::Return::_connect(const std::string& url, const bool ar ) {
  ...
  ior_self = sidl_rmi_Return__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::Return::Return ( const ::sidl::rmi::Return& original ) {
  d_self = ::sidl::rmi::Return::_cast(original._get_ior());
...
sidl::rmi::Return::operator=( const ::sidl::rmi::Return& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::Return::_cast(rhs._get_ior());
