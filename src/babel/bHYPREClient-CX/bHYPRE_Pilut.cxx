 ...
 */
::bHYPRE::Pilut
bHYPRE::Pilut::Create( /* in */::bHYPRE::MPICommunicator mpi_comm, /* in 
  */::bHYPRE::Operator A )
...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_Pilut__object*) 
    ::bHYPRE::Pilut::_get_ior();
  struct bHYPRE_Operator__object* _local_A = (struct bHYPRE_Operator__object*) 
    A.::bHYPRE::Operator::_get_ior();
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
 ...
 */
int32_t
bHYPRE::Pilut::SetIntParameter( /* in */const ::std::string& name, /* in 
  */int32_t value )
 ...
 */
int32_t
bHYPRE::Pilut::SetDoubleParameter( /* in */const ::std::string& name, /* in 
  */double value )
 ...
 */
int32_t
bHYPRE::Pilut::SetStringParameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::Pilut::SetIntArray1Parameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::Pilut::SetIntArray2Parameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::Pilut::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::Pilut::GetDoubleValue( /* in */const ::std::string& name, /* out 
  */double& value )
 ...
 */
int32_t
bHYPRE::Pilut::Apply( /* in */::bHYPRE::Vector b, /* inout */::bHYPRE::Vector& 
  x )
 ...
 */
int32_t
bHYPRE::Pilut::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::Pilut::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::Pilut::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::Pilut::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_Pilut__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::Pilut::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_Pilut__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::Pilut::Pilut ( const ::bHYPRE::Pilut& original ) {
  d_self = (struct bHYPRE_Pilut__object*) original.::bHYPRE::Pilut::_get_ior();
  if(d_self) {
...
bHYPRE::Pilut::operator=( const ::bHYPRE::Pilut& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_Pilut__object*) rhs.::bHYPRE::Pilut::_get_ior();
    if(d_self) {
