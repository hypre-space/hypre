...
#define included_bHYPRE_Euclid_hxx
...
namespace bHYPRE { 
  ...
  public:
    ...
    // RMI constructor
    static ::bHYPRE::Euclid _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::Euclid _connect( /*in*/ const std::string& url ) { 
    ...
    static inline const char * type_name() throw () { return "bHYPRE.Euclid";}

    static struct bHYPRE_Euclid__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::Euclid > {
    typedef array< ::bHYPRE::Euclid > cxx_array_t;
    typedef ::bHYPRE::Euclid cxx_item_t;
    ...
    typedef array_iter< array_traits< ::bHYPRE::Euclid > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::Euclid > > const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::Euclid >: public interface_array< array_traits< 
    ::bHYPRE::Euclid > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::Euclid > > Base;
    typedef array_traits< ::bHYPRE::Euclid >::cxx_array_t          cxx_array_t;
    typedef array_traits< ::bHYPRE::Euclid >::cxx_item_t           cxx_item_t;
    typedef array_traits< ::bHYPRE::Euclid >::ior_array_t          ior_array_t;
    typedef array_traits< ::bHYPRE::Euclid >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::Euclid >::ior_item_t           ior_item_t;
     ...
     * copy constructor
     */
    array( const array< ::bHYPRE::Euclid >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::Euclid >&
    operator =( const array< ::bHYPRE::Euclid >&rhs ) { 
