...
// Revision:      @(#) $Id: sidl_io_Serializable.cxx,v 1.2 2006/09/14 21:52:15 painter Exp $
...

{
  ...
  ior_t* const loc_self = (ior_t*) 
    ::sidl::io::Serializable::_cast((void*)(_get_ior()));
...
sidl::io::Serializable::Serializable ( const ::sidl::io::Serializable& original 
  ...
  d_self = ::sidl::io::Serializable::_cast(original._get_ior());
...
sidl::io::Serializable::operator=( const ::sidl::io::Serializable& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::io::Serializable::_cast(rhs._get_ior());
