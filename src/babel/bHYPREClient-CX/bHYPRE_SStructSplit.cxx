 ...
 */
::bHYPRE::SStructSplit
bHYPRE::SStructSplit::Create( /* in */::bHYPRE::MPICommunicator mpi_comm, /* in 
  */::bHYPRE::Operator A )
...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_SStructSplit__object*) 
    ::bHYPRE::SStructSplit::_get_ior();
  struct bHYPRE_Operator__object* _local_A = (struct bHYPRE_Operator__object*) 
    A.::bHYPRE::Operator::_get_ior();
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
 ...
 */
int32_t
bHYPRE::SStructSplit::SetIntParameter( /* in */const ::std::string& name, /* in 
  */int32_t value )
 ...
 */
int32_t
bHYPRE::SStructSplit::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::SStructSplit::GetDoubleValue( /* in */const ::std::string& name, /* out 
  */double& value )
 ...
 */
int32_t
bHYPRE::SStructSplit::Setup( /* in */::bHYPRE::Vector b, /* in 
  */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::SStructSplit::Apply( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
 ...
 */
int32_t
bHYPRE::SStructSplit::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::SStructSplit::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::SStructSplit::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::SStructSplit::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_SStructSplit__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::SStructSplit::SStructSplit ( const ::bHYPRE::SStructSplit& original ) {
  d_self = (struct bHYPRE_SStructSplit__object*) 
    original.::bHYPRE::SStructSplit::_get_ior();
  if(d_self) {
...
bHYPRE::SStructSplit::operator=( const ::bHYPRE::SStructSplit& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_SStructSplit__object*) 
      rhs.::bHYPRE::SStructSplit::_get_ior();
    if(d_self) {
...
bHYPRE::SStructSplit::SStructSplit ( ::bHYPRE::SStructSplit::ior_t* ior, bool 
  isWeak ) : 
...
#else
    s_ext = (struct bHYPRE_SStructSplit__external*)sidl_dynamicLoadIOR(
