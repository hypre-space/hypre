 ...
 */
int32_t
bHYPRE::CGNR::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
 ...
 */
int32_t
bHYPRE::CGNR::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
 ...
 */
int32_t
bHYPRE::CGNR::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::CGNR::SetIntArray1Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::CGNR::SetIntArray2Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::CGNR::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
 ...
 */
int32_t
bHYPRE::CGNR::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
 ...
 */
int32_t
bHYPRE::CGNR::Apply( /* in */::bHYPRE::Vector b,
 ...
 */
int32_t
bHYPRE::CGNR::ApplyAdjoint( /* in */::bHYPRE::Vector b,
  /* inout */::bHYPRE::Vector& x )
...
bHYPRE::CGNR::_create(const std::string& url) {
  ...
  ior_self = bHYPRE_CGNR__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
bHYPRE::CGNR::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
  ior_self = bHYPRE_CGNR__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
    ; //TODO: handle exception
  }
  return ::bHYPRE::CGNR( ior_self, false );
...
bHYPRE::CGNR::CGNR ( const ::bHYPRE::CGNR& original ) {
  d_self = ::bHYPRE::CGNR::_cast(original._get_ior());
...
bHYPRE::CGNR::operator=( const ::bHYPRE::CGNR& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::CGNR::_cast(rhs._get_ior());
