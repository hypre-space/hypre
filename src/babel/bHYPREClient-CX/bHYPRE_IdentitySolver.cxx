...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_IdentitySolver__object*) 
    ::bHYPRE::IdentitySolver::_get_ior();
 ...
 */
int32_t
bHYPRE::IdentitySolver::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::IdentitySolver::Setup( /* in */::bHYPRE::Vector b, /* in 
  */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::IdentitySolver::Apply( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
 ...
 */
int32_t
bHYPRE::IdentitySolver::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::IdentitySolver::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::IdentitySolver::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::IdentitySolver::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_IdentitySolver__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::IdentitySolver::IdentitySolver ( const ::bHYPRE::IdentitySolver& 
  original ) {
  d_self = (struct bHYPRE_IdentitySolver__object*) 
    original.::bHYPRE::IdentitySolver::_get_ior();
  if(d_self) {
...
bHYPRE::IdentitySolver::operator=( const ::bHYPRE::IdentitySolver& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_IdentitySolver__object*) 
      rhs.::bHYPRE::IdentitySolver::_get_ior();
    if(d_self) {
...
#else
    s_ext = (struct bHYPRE_IdentitySolver__external*)sidl_dynamicLoadIOR(
