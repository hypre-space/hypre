...
// Revision:      @(#) $Id: sidl_MemoryAllocationException.cxx,v 1.2 2006/09/14 21:52:15 painter Exp $
...
sidl::MemoryAllocationException::_create(const std::string& url) {
  ...
  ior_self = sidl_MemoryAllocationException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
// remote connector 2
::sidl::MemoryAllocationException
sidl::MemoryAllocationException::_connect(const std::string& url,
  const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
...
sidl::MemoryAllocationException::MemoryAllocationException ( const 
  ...
  d_self = ::sidl::MemoryAllocationException::_cast(original._get_ior());
...
sidl::MemoryAllocationException::operator=( const 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::MemoryAllocationException::_cast(rhs._get_ior());
