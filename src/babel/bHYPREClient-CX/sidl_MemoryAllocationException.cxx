// 
// File:          sidl_MemoryAllocationException.cxx
// Symbol:        sidl.MemoryAllocationException-v0.9.15
// Symbol Type:   class
// Babel Version: 1.0.4
// Release:       $Name: V2-4-0b $
// Revision:      @(#) $Id: sidl_MemoryAllocationException.cxx,v 1.4 2007/09/27 19:55:46 painter Exp $
...
#ifndef included_sidl_MemoryAllocationException_hxx
#include "sidl_MemoryAllocationException.hxx"
#endif
...
/* #define HAVE_LOCKED_STATIC_GLOBALS (1) */
    ...
    const char* name, sidl_BaseInterface* _ex)
  {
    ...
    *_ex = NULL; /* default to no exception */
    ...
    if (!cmp0) {
      ...
      cast = ((struct sidl_MemoryAllocationException__object*)self);
      return cast;
    }
    else if (cmp0 < 0) {
  ...
  static char* remote_sidl_MemoryAllocationException__getURL(
    struct sidl_MemoryAllocationException__object* self, sidl_BaseInterface* 
      _ex)
  {
...
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.MemoryAllocationException.unpackObj.", &throwaway_exception);
    ...
    sidl_BaseInterface *_ex)
  {
    ...
    sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
      url, "sidl.MemoryAllocationException", _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct sidl_MemoryAllocationException__object*) malloc(
        sizeof(struct sidl_MemoryAllocationException__object));
...
void
sidl::MemoryAllocationException::throwException0(
...
// static constructor
::sidl::MemoryAllocationException
sidl::MemoryAllocationException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::MemoryAllocationException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::MemoryAllocationException
sidl::MemoryAllocationException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_MemoryAllocationException__remoteCreate( url.c_str(), 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::MemoryAllocationException( ior_self, false );
}

// remote connector
::sidl::MemoryAllocationException
sidl::MemoryAllocationException::_connect(const std::string& url, const bool ar 
  ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_MemoryAllocationException__remoteConnect( url.c_str(), 
...
// copy constructor
sidl::MemoryAllocationException::MemoryAllocationException ( const 
  ::sidl::MemoryAllocationException& original ) {
  d_self = (struct sidl_MemoryAllocationException__object*) 
    original.::sidl::MemoryAllocationException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::MemoryAllocationException&
sidl::MemoryAllocationException::operator=( const 
  ::sidl::MemoryAllocationException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct sidl_MemoryAllocationException__object*) 
      rhs.::sidl::MemoryAllocationException::_get_ior();
    if(d_self) {
...
sidl::MemoryAllocationException::MemoryAllocationException ( 
  ::sidl::MemoryAllocationException::ior_t* ior ) 
...
sidl::MemoryAllocationException::MemoryAllocationException ( 
  ::sidl::MemoryAllocationException::ior_t* ior, bool isWeak ) : 
...
void ::sidl::MemoryAllocationException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::MemoryAllocationException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::MemoryAllocationException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_MemoryAllocationException__object*) 
    ::sidl::MemoryAllocationException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::MemoryAllocationException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_MemoryAllocationException__object* 
  sidl::MemoryAllocationException::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.MemoryAllocationException", (
      void*)sidl_MemoryAllocationException__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.MemoryAllocationException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::MemoryAllocationException::ext_t * 
  sidl::MemoryAllocationException::s_ext = 0;

// private static method to get static data type
const ::sidl::MemoryAllocationException::ext_t *
sidl::MemoryAllocationException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_MemoryAllocationException__externals();
  }
  return s_ext;
}
