// 
// File:          sidl_rmi_ConnectException.cxx
// Symbol:        sidl.rmi.ConnectException-v0.9.15
// Symbol Type:   class
// Babel Version: 1.0.4
// Release:       $Name: V2-4-0b $
// Revision:      @(#) $Id: sidl_rmi_ConnectException.cxx,v 1.4 2007/09/27 19:55:46 painter Exp $
...
#ifndef included_sidl_rmi_ConnectException_hxx
#include "sidl_rmi_ConnectException.hxx"
#endif
...
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.ConnectException.unpackObj.", &throwaway_exception);
  ...
  static struct sidl_rmi_ConnectException__object*
  sidl_rmi_ConnectException__remoteCreate(const char *url, sidl_BaseInterface 
    *_ex)
  {
    ...
    sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
      url, "sidl.rmi.ConnectException", _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct sidl_rmi_ConnectException__object*) malloc(
        sizeof(struct sidl_rmi_ConnectException__object));
    ...
    sidl_BaseInterface* _ex)
  {
    ...
    *_ex = NULL;
    ...
    if (obj != NULL) {
      ...
      cast = (struct sidl_rmi_ConnectException__object*) (
        *base->d_epv->f__cast)(
        base->d_object,
...
void
sidl::rmi::ConnectException::throwException0(
...
// static constructor
::sidl::rmi::ConnectException
sidl::rmi::ConnectException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::rmi::ConnectException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::rmi::ConnectException
sidl::rmi::ConnectException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_ConnectException__remoteCreate( url.c_str(), &_exception 
    );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::rmi::ConnectException( ior_self, false );
}

// remote connector
::sidl::rmi::ConnectException
sidl::rmi::ConnectException::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_ConnectException__remoteConnect( url.c_str(), 
...
// copy constructor
sidl::rmi::ConnectException::ConnectException ( const 
  ::sidl::rmi::ConnectException& original ) {
  d_self = (struct sidl_rmi_ConnectException__object*) 
    original.::sidl::rmi::ConnectException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::rmi::ConnectException&
sidl::rmi::ConnectException::operator=( const ::sidl::rmi::ConnectException& 
  rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct sidl_rmi_ConnectException__object*) 
      rhs.::sidl::rmi::ConnectException::_get_ior();
    if(d_self) {
...
sidl::rmi::ConnectException::ConnectException ( 
  ::sidl::rmi::ConnectException::ior_t* ior ) 
...
sidl::rmi::ConnectException::ConnectException ( 
  ::sidl::rmi::ConnectException::ior_t* ior, bool isWeak ) : 
...
void ::sidl::rmi::ConnectException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::rmi::ConnectException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::rmi::ConnectException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_rmi_ConnectException__object*) 
    ::sidl::rmi::ConnectException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::rmi::ConnectException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_rmi_ConnectException__object* sidl::rmi::ConnectException::_cast(
  const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.ConnectException", (
      void*)sidl_rmi_ConnectException__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.rmi.ConnectException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::rmi::ConnectException::ext_t * sidl::rmi::ConnectException::s_ext 
  = 0;

// private static method to get static data type
const ::sidl::rmi::ConnectException::ext_t *
sidl::rmi::ConnectException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_rmi_ConnectException__externals();
  }
  return s_ext;
}
