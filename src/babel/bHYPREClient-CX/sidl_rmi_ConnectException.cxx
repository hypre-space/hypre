...
// Revision:      @(#) $Id: sidl_rmi_ConnectException.cxx,v 1.3 2006/12/29 21:24:49 painter Exp $
...
sidl::rmi::ConnectException::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_ConnectException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::ConnectException::ConnectException ( const 
  ...
  d_self = ::sidl::rmi::ConnectException::_cast(original._get_ior());
...
sidl::rmi::ConnectException::operator=( const ::sidl::rmi::ConnectException& 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::ConnectException::_cast(rhs._get_ior());
...
struct sidl_rmi_ConnectException__object* 
  sidl::rmi::ConnectException::_cast(const void* src)
{
  ior_t* cast = NULL;
