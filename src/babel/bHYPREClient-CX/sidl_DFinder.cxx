...
// Revision:      @(#) $Id: sidl_DFinder.cxx,v 1.2 2006/09/14 21:52:14 painter Exp $
 ...
 */
void
sidl::DFinder::setSearchPath( /* in */const ::std::string& path_name )
 ...
 */
void
sidl::DFinder::addSearchPath( /* in */const ::std::string& path_fragment )
...
// assignment operator
::sidl::DFinder&
sidl::DFinder::operator=( const ::sidl::DFinder& rhs ) {
...
void ::sidl::DFinder::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::DFinder::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
void
sidl::DFinder::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_DFinder__object* sidl::DFinder::_cast(const void* src)
{
  ior_t* cast = NULL;
...
// Static data type
const ::sidl::DFinder::ext_t * sidl::DFinder::s_ext = 0;

// private static method to get static data type
const ::sidl::DFinder::ext_t *
sidl::DFinder::_get_ext()
