...
// Revision:      @(#) $Id: sidl_rmi_Ticket.hxx,v 1.3 2006/12/29 21:24:50 painter Exp $
...
#define included_sidl_rmi_Ticket_hxx
...
namespace sidl { 
  namespace rmi { 
     ...
     */
    class Ticket: public virtual ::sidl::BaseInterface {
    ...
    public:
      typedef struct sidl_rmi_Ticket__object ior_t;
      typedef struct sidl_rmi_Ticket__external ext_t;
      ...
      static struct sidl_rmi_Ticket__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::sidl::rmi::Ticket > {
    typedef array< ::sidl::rmi::Ticket > cxx_array_t;
    typedef ::sidl::rmi::Ticket cxx_item_t;
    typedef struct sidl_rmi_Ticket__array ior_array_t;
    typedef sidl_interface__array ior_array_internal_t;
    typedef struct sidl_rmi_Ticket__object ior_item_t;
    typedef cxx_item_t value_type;
    typedef value_type reference;
    typedef value_type* pointer;
    typedef const value_type const_reference;
    typedef const value_type* const_pointer;
    typedef array_iter< array_traits< ::sidl::rmi::Ticket > > iterator;
    typedef const_array_iter< array_traits< ::sidl::rmi::Ticket > > 
      const_iterator;
  };

  // array specialization
  template<>
  class array< ::sidl::rmi::Ticket >: public interface_array< array_traits< 
    ::sidl::rmi::Ticket > > {
  public:
    typedef interface_array< array_traits< ::sidl::rmi::Ticket > > Base;
    typedef array_traits< ::sidl::rmi::Ticket >::cxx_array_t          
      cxx_array_t;
    typedef array_traits< ::sidl::rmi::Ticket >::cxx_item_t           
      cxx_item_t;
    typedef array_traits< ::sidl::rmi::Ticket >::ior_array_t          
      ior_array_t;
    typedef array_traits< ::sidl::rmi::Ticket >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::sidl::rmi::Ticket >::ior_item_t           
      ior_item_t;
     ...
     */
    array( struct sidl_rmi_Ticket__array* src = 0) : Base(src) {}

    /**
     * copy constructor
     */
    array( const array< ::sidl::rmi::Ticket >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::sidl::rmi::Ticket >&
    operator =( const array< ::sidl::rmi::Ticket >&rhs ) { 
