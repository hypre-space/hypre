...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_Schwarz__object*) 
    ::bHYPRE::Schwarz::_get_ior();
 ...
 */
int32_t
bHYPRE::Schwarz::SetIntParameter( /* in */const ::std::string& name, /* in 
  */int32_t value )
 ...
 */
int32_t
bHYPRE::Schwarz::SetDoubleParameter( /* in */const ::std::string& name, /* in 
  */double value )
 ...
 */
int32_t
bHYPRE::Schwarz::SetStringParameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::Schwarz::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::Schwarz::GetDoubleValue( /* in */const ::std::string& name, /* out 
  */double& value )
 ...
 */
int32_t
bHYPRE::Schwarz::Apply( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
 ...
 */
int32_t
bHYPRE::Schwarz::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::Schwarz::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::bHYPRE::Schwarz self( (*_get_ext()->createObject)(NULL,&_exception), false 
    );
  if (_exception) {
    throwException0(_exception);
  }
...
bHYPRE::Schwarz::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::Schwarz::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::Schwarz::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_Schwarz__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::Schwarz::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_Schwarz__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::Schwarz::Schwarz ( const ::bHYPRE::Schwarz& original ) {
  d_self = (struct bHYPRE_Schwarz__object*) 
    original.::bHYPRE::Schwarz::_get_ior();
  if(d_self) {
...
bHYPRE::Schwarz::operator=( const ::bHYPRE::Schwarz& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_Schwarz__object*) rhs.::bHYPRE::Schwarz::_get_ior();
    if(d_self) {
...
#else
    s_ext = (struct bHYPRE_Schwarz__external*)sidl_dynamicLoadIOR(
