...
// Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException.cxx,v 1.2 2006/09/14 21:52:16 painter Exp $
...
sidl::rmi::NoRouteToHostException::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_NoRouteToHostException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
// remote connector 2
::sidl::rmi::NoRouteToHostException
sidl::rmi::NoRouteToHostException::_connect(const std::string& url,
  const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
...
sidl::rmi::NoRouteToHostException::NoRouteToHostException ( const 
  ...
  d_self = ::sidl::rmi::NoRouteToHostException::_cast(original._get_ior());
...
sidl::rmi::NoRouteToHostException::operator=( const 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::NoRouteToHostException::_cast(rhs._get_ior());
