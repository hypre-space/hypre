...
#ifndef included_bHYPRE_HGMRES_hxx
#define included_bHYPRE_HGMRES_hxx
...
namespace bHYPRE { 
   ...
   */
  class HGMRES: public virtual ::bHYPRE::PreconditionedSolver, public virtual 
    ::sidl::BaseClass {
  ...
  public:
    typedef struct bHYPRE_HGMRES__object ior_t;
    typedef struct bHYPRE_HGMRES__external ext_t;
    typedef struct bHYPRE_HGMRES__sepv sepv_t;
    ...
    // static constructor
    static ::bHYPRE::HGMRES _create();

    // RMI constructor
    static ::bHYPRE::HGMRES _create( /*in*/ const std::string& url );

    // RMI connect
    static inline ::bHYPRE::HGMRES _connect( /*in*/ const std::string& url ) { 
      return _connect(url, true);
    }

    // RMI connect 2
    static ::bHYPRE::HGMRES _connect( /*in*/ const std::string& url, /*in*/ 
      const bool ar  );
    ...
    // copy constructor
    HGMRES ( const HGMRES& original );

    // assignment operator
    HGMRES& operator= ( const HGMRES& rhs );
    ...
    HGMRES ( HGMRES::ior_t* ior );

    // Alternate constructor: does not call addRef()
    // (sets d_weak_reference=isWeak)
    // For internal use by Impls (fixes bug#275)
    HGMRES ( HGMRES::ior_t* ior, bool isWeak );
    ...
    static inline const char * type_name() throw () { return "bHYPRE.HGMRES";}

    static struct bHYPRE_HGMRES__object* _cast(const void* src);
...
namespace sidl {
  ...
  template<>
  struct array_traits< ::bHYPRE::HGMRES > {
    typedef array< ::bHYPRE::HGMRES > cxx_array_t;
    typedef ::bHYPRE::HGMRES cxx_item_t;
    typedef struct bHYPRE_HGMRES__array ior_array_t;
    typedef sidl_interface__array ior_array_internal_t;
    typedef struct bHYPRE_HGMRES__object ior_item_t;
    typedef cxx_item_t value_type;
    typedef value_type reference;
    typedef value_type* pointer;
    typedef const value_type const_reference;
    typedef const value_type* const_pointer;
    typedef array_iter< array_traits< ::bHYPRE::HGMRES > > iterator;
    typedef const_array_iter< array_traits< ::bHYPRE::HGMRES > > const_iterator;
  };

  // array specialization
  template<>
  class array< ::bHYPRE::HGMRES >: public interface_array< array_traits< 
    ::bHYPRE::HGMRES > > {
  public:
    typedef interface_array< array_traits< ::bHYPRE::HGMRES > > Base;
    typedef array_traits< ::bHYPRE::HGMRES >::cxx_array_t          cxx_array_t;
    typedef array_traits< ::bHYPRE::HGMRES >::cxx_item_t           cxx_item_t;
    typedef array_traits< ::bHYPRE::HGMRES >::ior_array_t          ior_array_t;
    typedef array_traits< ::bHYPRE::HGMRES >::ior_array_internal_t 
      ior_array_internal_t;
    typedef array_traits< ::bHYPRE::HGMRES >::ior_item_t           ior_item_t;

    /**
     * conversion from ior to C++ class
     * (constructor/casting operator)
     */
    array( struct bHYPRE_HGMRES__array* src = 0) : Base(src) {}

    /**
     * copy constructor
     */
    array( const array< ::bHYPRE::HGMRES >&src) : Base(src) {}

    /**
     * assignment
     */
    array< ::bHYPRE::HGMRES >&
    operator =( const array< ::bHYPRE::HGMRES >&rhs ) { 
