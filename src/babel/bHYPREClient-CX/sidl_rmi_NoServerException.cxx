...
// Revision:      @(#) $Id: sidl_rmi_NoServerException.cxx,v 1.3 2006/12/29 21:24:49 painter Exp $
...
sidl::rmi::NoServerException::_create(const std::string& url) {
  ...
  ior_self = sidl_rmi_NoServerException__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::NoServerException::NoServerException ( const 
  ...
  d_self = ::sidl::rmi::NoServerException::_cast(original._get_ior());
...
sidl::rmi::NoServerException::operator=( const ::sidl::rmi::NoServerException& 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::NoServerException::_cast(rhs._get_ior());
...
struct sidl_rmi_NoServerException__object* 
  sidl::rmi::NoServerException::_cast(const void* src)
{
  ior_t* cast = NULL;
