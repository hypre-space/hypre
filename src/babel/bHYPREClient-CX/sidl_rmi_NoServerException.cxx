// 
// File:          sidl_rmi_NoServerException.cxx
// Symbol:        sidl.rmi.NoServerException-v0.9.15
// Symbol Type:   class
// Babel Version: 1.0.4
// Release:       $Name: V2-4-0b $
// Revision:      @(#) $Id: sidl_rmi_NoServerException.cxx,v 1.4 2007/09/27 19:55:47 painter Exp $
...
void
sidl::rmi::NoServerException::throwException0(
...
sidl::rmi::NoServerException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::rmi::NoServerException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::rmi::NoServerException
sidl::rmi::NoServerException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_NoServerException__remoteCreate( url.c_str(), &_exception 
    );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::rmi::NoServerException( ior_self, false );
}

// remote connector
::sidl::rmi::NoServerException
sidl::rmi::NoServerException::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_NoServerException__remoteConnect( url.c_str(), 
...
// copy constructor
sidl::rmi::NoServerException::NoServerException ( const 
  ::sidl::rmi::NoServerException& original ) {
  d_self = (struct sidl_rmi_NoServerException__object*) 
    original.::sidl::rmi::NoServerException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::rmi::NoServerException&
sidl::rmi::NoServerException::operator=( const ::sidl::rmi::NoServerException& 
  rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct sidl_rmi_NoServerException__object*) 
      rhs.::sidl::rmi::NoServerException::_get_ior();
    if(d_self) {
...
sidl::rmi::NoServerException::NoServerException ( 
  ::sidl::rmi::NoServerException::ior_t* ior ) 
...
sidl::rmi::NoServerException::NoServerException ( 
  ::sidl::rmi::NoServerException::ior_t* ior, bool isWeak ) : 
...
void ::sidl::rmi::NoServerException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::rmi::NoServerException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::rmi::NoServerException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_rmi_NoServerException__object*) 
    ::sidl::rmi::NoServerException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::rmi::NoServerException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_rmi_NoServerException__object* sidl::rmi::NoServerException::_cast(
  const void* src)
{
  ior_t* cast = NULL;
  ...
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.rmi.NoServerException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::rmi::NoServerException::ext_t * 
  sidl::rmi::NoServerException::s_ext = 0;

// private static method to get static data type
const ::sidl::rmi::NoServerException::ext_t *
sidl::rmi::NoServerException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_rmi_NoServerException__externals();
  }
  return s_ext;
}
