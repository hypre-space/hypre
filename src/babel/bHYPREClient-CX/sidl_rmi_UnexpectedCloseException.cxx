// 
// File:          sidl_rmi_UnexpectedCloseException.cxx
// Symbol:        sidl.rmi.UnexpectedCloseException-v0.9.15
// Symbol Type:   class
// Babel Version: 1.0.4
// Release:       $Name: V2-4-0b $
// Revision:      @(#) $Id: sidl_rmi_UnexpectedCloseException.cxx,v 1.4 2007/09/27 19:55:47 painter Exp $
...
#include "sidl_rmi_UnexpectedCloseException.hxx"
#endif
...
/* #define HAVE_LOCKED_STATIC_GLOBALS (1) */
    ...
    *_ex = NULL; /* default to no exception */
    ...
    if (!cmp0) {
      ...
      if (!cmp1) {
        ...
        if (!cmp2) {
          (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
          cast = ((struct sidl_rmi_UnexpectedCloseException__object*)self);
          return cast;
        }
      }
    }
  ...
  static char* remote_sidl_rmi_UnexpectedCloseException__getURL(
    struct sidl_rmi_UnexpectedCloseException__object* self, sidl_BaseInterface* 
      _ex)
  {
...
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.UnexpectedCloseException._set_hooks.", &throwaway_exception);
  ...
  static void remote_sidl_rmi_UnexpectedCloseException__exec(
    struct sidl_rmi_UnexpectedCloseException__object* self,const char* 
      methodName,
...
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.UnexpectedCloseException.unpackObj.", &throwaway_exception);
  ...
  static void sidl_rmi_UnexpectedCloseException__init_remote_epv(void)
  {
    ...
    epv->f__raddRef          = 
      remote_sidl_rmi_UnexpectedCloseException__raddRef;
    epv->f__isRemote         = 
      remote_sidl_rmi_UnexpectedCloseException__isRemote;
    epv->f__set_hooks        = 
      remote_sidl_rmi_UnexpectedCloseException__set_hooks;
  ...
  sidl_rmi_UnexpectedCloseException__remoteConnect(const char *url, sidl_bool 
    ar, sidl_BaseInterface *_ex)
  {
    ...
    *_ex = NULL;
    ...
    if(objectID) {
      ...
      return sidl_rmi_UnexpectedCloseException__rmicast(bi,_ex);SIDL_CHECK(
        *_ex);
    }
    ...
    sidl_BaseInterface *_ex)
  {
    ...
    sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
      url, "sidl.rmi.UnexpectedCloseException", _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct sidl_rmi_UnexpectedCloseException__object*) malloc(
        sizeof(struct sidl_rmi_UnexpectedCloseException__object));
...
void
sidl::rmi::UnexpectedCloseException::throwException0(
...
// static constructor
::sidl::rmi::UnexpectedCloseException
sidl::rmi::UnexpectedCloseException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::rmi::UnexpectedCloseException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::rmi::UnexpectedCloseException
sidl::rmi::UnexpectedCloseException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_UnexpectedCloseException__remoteCreate( url.c_str(), 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::rmi::UnexpectedCloseException( ior_self, false );
}

// remote connector
::sidl::rmi::UnexpectedCloseException
sidl::rmi::UnexpectedCloseException::_connect(const std::string& url, const 
  bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_rmi_UnexpectedCloseException__remoteConnect( url.c_str(), 
...
// copy constructor
sidl::rmi::UnexpectedCloseException::UnexpectedCloseException ( const 
  ::sidl::rmi::UnexpectedCloseException& original ) {
  d_self = (struct sidl_rmi_UnexpectedCloseException__object*) 
    original.::sidl::rmi::UnexpectedCloseException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::rmi::UnexpectedCloseException&
sidl::rmi::UnexpectedCloseException::operator=( const 
  ::sidl::rmi::UnexpectedCloseException& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    d_self = (struct sidl_rmi_UnexpectedCloseException__object*) 
      rhs.::sidl::rmi::UnexpectedCloseException::_get_ior();
    if(d_self) {
...
sidl::rmi::UnexpectedCloseException::UnexpectedCloseException ( 
  ::sidl::rmi::UnexpectedCloseException::ior_t* ior ) 
...
sidl::rmi::UnexpectedCloseException::UnexpectedCloseException ( 
  ::sidl::rmi::UnexpectedCloseException::ior_t* ior, bool isWeak ) : 
...
void ::sidl::rmi::UnexpectedCloseException::_exec( const std::string& 
  methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::rmi::UnexpectedCloseException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::rmi::UnexpectedCloseException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_rmi_UnexpectedCloseException__object*) 
    ::sidl::rmi::UnexpectedCloseException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::rmi::UnexpectedCloseException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_rmi_UnexpectedCloseException__object* 
  sidl::rmi::UnexpectedCloseException::_cast(const void* src)
{
  ior_t* cast = NULL;
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect(
      "sidl.rmi.UnexpectedCloseException", (
      void*)sidl_rmi_UnexpectedCloseException__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.rmi.UnexpectedCloseException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::rmi::UnexpectedCloseException::ext_t * 
  sidl::rmi::UnexpectedCloseException::s_ext = 0;

// private static method to get static data type
const ::sidl::rmi::UnexpectedCloseException::ext_t *
sidl::rmi::UnexpectedCloseException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_rmi_UnexpectedCloseException__externals();
  }
  return s_ext;
}
