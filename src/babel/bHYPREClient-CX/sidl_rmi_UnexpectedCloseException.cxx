...
// Revision:      @(#) $Id: sidl_rmi_UnexpectedCloseException.cxx,v 1.3 2006/12/29 21:24:50 painter Exp $
    ...
    sidl_bool ar, sidl_BaseInterface *_ex)
  {
    ...
    *_ex = NULL;
    ...
    if(objectID) {
      ...
      return sidl_rmi_UnexpectedCloseException__rmicast(bi,
        _ex);SIDL_CHECK(*_ex);
    }
...
// remote connector 2
::sidl::rmi::UnexpectedCloseException
sidl::rmi::UnexpectedCloseException::_connect(const std::string& url,
  const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
...
sidl::rmi::UnexpectedCloseException::UnexpectedCloseException ( const 
  ...
  d_self = ::sidl::rmi::UnexpectedCloseException::_cast(original._get_ior());
...
sidl::rmi::UnexpectedCloseException::operator=( const 
  ...
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::UnexpectedCloseException::_cast(rhs._get_ior());
  ...
  sidl::rmi::UnexpectedCloseException::_cast(const void* src)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect(
      "sidl.rmi.UnexpectedCloseException",
      (void*)sidl_rmi_UnexpectedCloseException__IHConnect,
      &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
