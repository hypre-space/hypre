...
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.PCG.ApplyAdjoint.", &throwaway_exception);
  ...
  static struct bHYPRE_PCG__object*
  bHYPRE_PCG__IHConnect(sidl_rmi_InstanceHandle instance,
    sidl_BaseInterface *_ex)
  {
    struct bHYPRE_PCG__object* self;
 ...
 */
int32_t
bHYPRE::PCG::SetIntParameter( /* in */const ::std::string& name,
  /* in */int32_t value )
 ...
 */
int32_t
bHYPRE::PCG::SetDoubleParameter( /* in */const ::std::string& name,
  /* in */double value )
 ...
 */
int32_t
bHYPRE::PCG::SetStringParameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::PCG::SetIntArray1Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::PCG::SetIntArray2Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::PCG::SetDoubleArray1Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::PCG::SetDoubleArray2Parameter( /* in */const ::std::string& name,
 ...
 */
int32_t
bHYPRE::PCG::GetIntValue( /* in */const ::std::string& name,
  /* out */int32_t& value )
 ...
 */
int32_t
bHYPRE::PCG::GetDoubleValue( /* in */const ::std::string& name,
  /* out */double& value )
 ...
 */
int32_t
bHYPRE::PCG::ApplyAdjoint( /* in */::bHYPRE::Vector b,
...
bHYPRE::PCG::_create(const std::string& url) {
  ...
  ior_self = bHYPRE_PCG__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
bHYPRE::PCG::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  sidl_BaseInterface__object* _ex = 0;
  ior_self = bHYPRE_PCG__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
    ; //TODO: handle exception
  }
  return ::bHYPRE::PCG( ior_self, false );
...
bHYPRE::PCG::PCG ( const ::bHYPRE::PCG& original ) {
  d_self = ::bHYPRE::PCG::_cast(original._get_ior());
...
bHYPRE::PCG::operator=( const ::bHYPRE::PCG& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::PCG::_cast(rhs._get_ior());
