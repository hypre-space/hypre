...
// Revision:      @(#) $Id: sidl_rmi_Call.cxx,v 1.3 2006/12/29 21:24:49 painter Exp $
...
sidl::rmi::Call::_connect(const std::string& url, const bool ar ) {
  ...
  ior_self = sidl_rmi_Call__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_ex );
  if (_ex != 0 ) {
...
sidl::rmi::Call::Call ( const ::sidl::rmi::Call& original ) {
  d_self = ::sidl::rmi::Call::_cast(original._get_ior());
...
sidl::rmi::Call::operator=( const ::sidl::rmi::Call& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::sidl::rmi::Call::_cast(rhs._get_ior());
...

{
  ...
  ior_t* const loc_self = (ior_t*) 
    ::sidl::rmi::Call::_cast((void*)(_get_ior()));
  char * _local_result;
