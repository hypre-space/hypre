...
// Revision:      @(#) $Id: sidl_RuntimeException.cxx,v 1.4 2007/09/27 19:55:46 painter Exp $
...
sidl::RuntimeException::RuntimeException ( const ::sidl::RuntimeException& 
  original ) {
  d_self = (struct sidl_RuntimeException__object*) 
    original.::sidl::RuntimeException::_get_ior();
  sidl_RuntimeException_IORCache = (ior_t*) d_self;
  if(d_self) {
    addRef();
  }
...
sidl::RuntimeException::operator=( const ::sidl::RuntimeException& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct sidl_RuntimeException__object*) 
      rhs.::sidl::RuntimeException::_get_ior();
    sidl_RuntimeException_IORCache = (ior_t*) d_self;
    if(d_self) {
      addRef();
    }
...
{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_RuntimeException__object*) 
    ::sidl::RuntimeException::_get_ior();
  char * _local_result;
