 ...
 */
int32_t
bHYPRE::SStructDiagScale::Setup( /* in */::bHYPRE::Vector b,
  /* in */::bHYPRE::Vector x )
 ...
 */
int32_t
bHYPRE::SStructDiagScale::Apply( /* in */::bHYPRE::Vector b,
 ...
 */
int32_t
bHYPRE::SStructDiagScale::ApplyAdjoint( /* in */::bHYPRE::Vector b,
  /* inout */::bHYPRE::Vector& x )
...
bHYPRE::SStructDiagScale::_create(const std::string& url) {
  ...
  ior_self = bHYPRE_SStructDiagScale__remoteCreate( url.c_str(), &_ex );
  if (_ex != 0 ) {
...
bHYPRE::SStructDiagScale::SStructDiagScale ( const ::bHYPRE::SStructDiagScale& 
  original ) {
  d_self = ::bHYPRE::SStructDiagScale::_cast(original._get_ior());
...
bHYPRE::SStructDiagScale::operator=( const ::bHYPRE::SStructDiagScale& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = ::bHYPRE::SStructDiagScale::_cast(rhs._get_ior());
