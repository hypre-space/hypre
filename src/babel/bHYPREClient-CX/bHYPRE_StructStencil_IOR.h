...
extern void bHYPRE_StructStencil__init(
  struct bHYPRE_StructStencil__object* self, void* ddata, struct 
...
extern void bHYPRE_StructStencil__getEPVs(
  ...
  extern void bHYPRE_StructStencil__fini(
    struct bHYPRE_StructStencil__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  ...
  struct bHYPRE_StructStencil__object* 
    skel_bHYPRE_StructStencil_fcast_bHYPRE_StructStencil(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_StructStencil_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_StructStencil_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
