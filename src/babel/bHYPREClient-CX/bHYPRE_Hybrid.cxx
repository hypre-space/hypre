 ...
 */
::bHYPRE::Hybrid
bHYPRE::Hybrid::Create( /* in */::bHYPRE::MPICommunicator mpi_comm, /* in 
  */::bHYPRE::PreconditionedSolver SecondSolver, /* in */::bHYPRE::Operator A )

{
  ...
  struct bHYPRE_PreconditionedSolver__object* _local_SecondSolver = (struct 
    ...
    SecondSolver.::bHYPRE::PreconditionedSolver::_get_ior();
...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_Hybrid__object*) 
    ::bHYPRE::Hybrid::_get_ior();
  struct bHYPRE_PreconditionedSolver__object* _local_FirstSolver;
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_GetFirstSolver))(loc_self, /* out */ 
    &_local_FirstSolver, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
...

{
  ...
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_GetSecondSolver))(loc_self, /* out */ 
    &_local_SecondSolver, &_exception );
  /*dispatch to ior*/
  if (_exception != 0 ) {
 ...
 */
int32_t
bHYPRE::Hybrid::SetIntParameter( /* in */const ::std::string& name, /* in 
  */int32_t value )
 ...
 */
int32_t
bHYPRE::Hybrid::SetDoubleParameter( /* in */const ::std::string& name, /* in 
  */double value )
 ...
 */
int32_t
bHYPRE::Hybrid::SetStringParameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::Hybrid::SetIntArray1Parameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::Hybrid::SetIntArray2Parameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::Hybrid::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::Hybrid::GetDoubleValue( /* in */const ::std::string& name, /* out 
  */double& value )
 ...
 */
int32_t
bHYPRE::Hybrid::Apply( /* in */::bHYPRE::Vector b, /* inout */::bHYPRE::Vector& 
  x )
 ...
 */
int32_t
bHYPRE::Hybrid::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::Hybrid::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::Hybrid::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::Hybrid::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_Hybrid__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::Hybrid::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_Hybrid__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::Hybrid::Hybrid ( const ::bHYPRE::Hybrid& original ) {
  d_self = (struct bHYPRE_Hybrid__object*) original.::bHYPRE::Hybrid::_get_ior(
    );
  if(d_self) {
...
bHYPRE::Hybrid::operator=( const ::bHYPRE::Hybrid& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_Hybrid__object*) rhs.::bHYPRE::Hybrid::_get_ior();
    if(d_self) {
...
#else
    s_ext = (struct bHYPRE_Hybrid__external*)sidl_dynamicLoadIOR(
