 ...
 */
::bHYPRE::GMRES
bHYPRE::GMRES::Create( /* in */::bHYPRE::MPICommunicator mpi_comm, /* in 
  */::bHYPRE::Operator A )
...
{
  int32_t _result;
  ior_t* const loc_self = (struct bHYPRE_GMRES__object*) 
    ::bHYPRE::GMRES::_get_ior();
 ...
 */
int32_t
bHYPRE::GMRES::SetIntParameter( /* in */const ::std::string& name, /* in 
  */int32_t value )
 ...
 */
int32_t
bHYPRE::GMRES::SetDoubleParameter( /* in */const ::std::string& name, /* in 
  */double value )
 ...
 */
int32_t
bHYPRE::GMRES::SetStringParameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::GMRES::SetIntArray1Parameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::GMRES::SetIntArray2Parameter( /* in */const ::std::string& name, /* in 
 ...
 */
int32_t
bHYPRE::GMRES::GetIntValue( /* in */const ::std::string& name, /* out 
  */int32_t& value )
 ...
 */
int32_t
bHYPRE::GMRES::GetDoubleValue( /* in */const ::std::string& name, /* out 
  */double& value )
 ...
 */
int32_t
bHYPRE::GMRES::Apply( /* in */::bHYPRE::Vector b, /* inout */::bHYPRE::Vector& 
  x )
 ...
 */
int32_t
bHYPRE::GMRES::ApplyAdjoint( /* in */::bHYPRE::Vector b, /* inout 
  */::bHYPRE::Vector& x )
...
bHYPRE::GMRES::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception;
  ::bHYPRE::GMRES::ior_t* returnValue = (*_get_ext()->createObject)(
...
bHYPRE::GMRES::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_GMRES__remoteCreate( url.c_str(), &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::GMRES::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = bHYPRE_GMRES__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
...
bHYPRE::GMRES::GMRES ( const ::bHYPRE::GMRES& original ) {
  d_self = (struct bHYPRE_GMRES__object*) original.::bHYPRE::GMRES::_get_ior();
  if(d_self) {
...
bHYPRE::GMRES::operator=( const ::bHYPRE::GMRES& rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct bHYPRE_GMRES__object*) rhs.::bHYPRE::GMRES::_get_ior();
    if(d_self) {
