...
extern void bHYPRE_BiCGSTAB__init(
  struct bHYPRE_BiCGSTAB__object* self, void* ddata, struct 
...
extern void bHYPRE_BiCGSTAB__getEPVs(
  ...
  extern void bHYPRE_BiCGSTAB__fini(
    struct bHYPRE_BiCGSTAB__object* self, struct sidl_BaseInterface__object ** 
      _ex);
  ...
  struct bHYPRE_MPICommunicator__object* 
    skel_bHYPRE_BiCGSTAB_fcast_bHYPRE_MPICommunicator(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct bHYPRE_PreconditionedSolver__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_PreconditionedSolver__object* 
    skel_bHYPRE_BiCGSTAB_fcast_bHYPRE_PreconditionedSolver(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct bHYPRE_Solver__object* skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Solver(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct bHYPRE_Solver__object* skel_bHYPRE_BiCGSTAB_fcast_bHYPRE_Solver(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct bHYPRE_Vector__object* skel_bHYPRE_BiCGSTAB_fconnect_bHYPRE_Vector(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    skel_bHYPRE_BiCGSTAB_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_bHYPRE_BiCGSTAB_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
