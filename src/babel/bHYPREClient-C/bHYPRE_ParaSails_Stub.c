...
static const struct bHYPRE_ParaSails__external *_externals = NULL;
/*
...

{
  ...
  _externals = bHYPRE_ParaSails__externals();
#else
  _externals = (struct bHYPRE_ParaSails__external*)sidl_dynamicLoadIOR(
    "bHYPRE.ParaSails","bHYPRE_ParaSails__externals") ;
  sidl_checkIORVersion("bHYPRE.ParaSails", _externals->d_ior_major_version, 
...
static bHYPRE_ParaSails bHYPRE_ParaSails__remoteCreate(const char* url, 
...
{
  return bHYPRE_ParaSails__remoteCreate(url, _ex);
}
...
bHYPRE_ParaSails
bHYPRE_ParaSails__connect(const char* url, sidl_BaseInterface *_ex)
{
  return bHYPRE_ParaSails__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.ParaSails", (
      void*)bHYPRE_ParaSails__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
void
bHYPRE_ParaSails__set_hooks_static(
  int32_t on,
...
bHYPRE_ParaSails__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_ParaSails__isRemote(self,_ex);
}
...
{
  return (struct bHYPRE_ParaSails__array*)sidl_interface__array_create1dInit(
