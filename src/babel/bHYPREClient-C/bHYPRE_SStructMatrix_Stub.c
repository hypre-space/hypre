...
#else
  _externals = (struct bHYPRE_SStructMatrix__external*)sidl_dynamicLoadIOR(
    "bHYPRE.SStructMatrix","bHYPRE_SStructMatrix__externals") ;
  sidl_checkIORVersion("bHYPRE.SStructMatrix", _externals->d_ior_major_version, 
...
static bHYPRE_SStructMatrix bHYPRE_SStructMatrix__remoteCreate(const char* url, 
...
{
  return bHYPRE_SStructMatrix__remoteCreate(url, _ex);
}

static struct bHYPRE_SStructMatrix__object* bHYPRE_SStructMatrix__remoteConnect(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct bHYPRE_SStructMatrix__object* bHYPRE_SStructMatrix__IHConnect(
...
{
  return bHYPRE_SStructMatrix__remoteConnect(url, TRUE, _ex);
}
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  ...
  sidl_double__array_init(values, values_tmp, 1, values_lower, values_upper, 
    values_stride);
  _result = (*self->d_epv->f_SetBoxValues)(
    self,
    part,
    ilower_tmp,
    iupper_tmp,
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  ...
  sidl_double__array_init(values, values_tmp, 1, values_lower, values_upper, 
    values_stride);
  _result = (*self->d_epv->f_AddToBoxValues)(
    self,
    part,
    ilower_tmp,
    iupper_tmp,
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.SStructMatrix", (
      void*)bHYPRE_SStructMatrix__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
void
bHYPRE_SStructMatrix__set_hooks_static(
  int32_t on,
...
SIDL_C_INLINE_DEFN
void
bHYPRE_SStructMatrix__set_hooks(
  /* in */ bHYPRE_SStructMatrix self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
bHYPRE_SStructMatrix__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !bHYPRE_SStructMatrix__isRemote(self,_ex);
}
...
bHYPRE_SStructMatrix__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_SStructMatrix__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
bHYPRE_SStructMatrix__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct bHYPRE_SStructMatrix__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct bHYPRE_SStructMatrix__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct bHYPRE_SStructMatrix__array*)sidl_interface__array_create2dCol(
    m, n);
}
...
{
  return (struct bHYPRE_SStructMatrix__array*)sidl_interface__array_create2dRow(
    m, n);
}
