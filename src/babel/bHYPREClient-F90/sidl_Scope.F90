...
! Revision:      @(#) $Id: sidl_Scope.F90,v 1.1 2007/02/06 01:23:08 painter Exp $
! Description:   Client-side module for sidl.Scope
! 
...
! 
  ...
  use sidl
  integer (kind=sidl_enum), parameter :: LOCAL = 0
  integer (kind=sidl_enum), parameter :: GLOBAL = 1
  integer (kind=sidl_enum), parameter :: SCLSCOPE = 2
end module sidl_Scope

module sidl_Scope_array
  use sidl
  use sidl_Scope_type
  use sidl_array_type
  ...
  private :: &
    castsidl_Scope1dToGeneric_p, &
    castsidl_Scope2dToGeneric_p, &
    castsidl_Scope3dToGeneric_p, &
    castsidl_Scope4dToGeneric_p, &
    castsidl_Scope5dToGeneric_p, &
    castsidl_Scope6dToGeneric_p, &
    castsidl_Scope7dToGeneric_p
interface cast
  module procedure &
    castsidl_Scope1dToGeneric_p, &
    castsidl_Scope2dToGeneric_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_Scope_1d), intent(out) :: array
  ...
  subroutine copy1_p(src, dest)
    type(sidl_Scope_1d), intent(in) :: src
    type(sidl_Scope_1d), intent(in) :: dest
  ...
  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_Scope_1d), intent(in)  :: src
    type(sidl_Scope_1d), intent(out) :: result
  ...
  subroutine getg1_p(array, index, value)
    type(sidl_Scope_1d), intent(in)  :: array
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_Scope_1d), intent(in) :: src
    type(sidl_Scope_1d), intent(out) :: dest
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_Scope_2d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy2_p(src, dest)
    type(sidl_Scope_2d), intent(in) :: src
    type(sidl_Scope_2d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_Scope_2d), intent(in)  :: src
    type(sidl_Scope_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg2_p(array, index, value)
    type(sidl_Scope_2d), intent(in)  :: array
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_Scope_2d), intent(in) :: src
    type(sidl_Scope_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 2
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_Scope_3d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy3_p(src, dest)
    type(sidl_Scope_3d), intent(in) :: src
    type(sidl_Scope_3d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_Scope_3d), intent(in)  :: src
    type(sidl_Scope_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg3_p(array, index, value)
    type(sidl_Scope_3d), intent(in)  :: array
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_Scope_3d), intent(in) :: src
    type(sidl_Scope_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 3
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_Scope_4d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy4_p(src, dest)
    type(sidl_Scope_4d), intent(in) :: src
    type(sidl_Scope_4d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_Scope_4d), intent(in)  :: src
    type(sidl_Scope_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg4_p(array, index, value)
    type(sidl_Scope_4d), intent(in)  :: array
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_Scope_4d), intent(in) :: src
    type(sidl_Scope_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 4
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_Scope_5d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy5_p(src, dest)
    type(sidl_Scope_5d), intent(in) :: src
    type(sidl_Scope_5d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_Scope_5d), intent(in)  :: src
    type(sidl_Scope_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg5_p(array, index, value)
    type(sidl_Scope_5d), intent(in)  :: array
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_Scope_5d), intent(in) :: src
    type(sidl_Scope_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 5
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_Scope_6d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy6_p(src, dest)
    type(sidl_Scope_6d), intent(in) :: src
    type(sidl_Scope_6d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_Scope_6d), intent(in)  :: src
    type(sidl_Scope_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg6_p(array, index, value)
    type(sidl_Scope_6d), intent(in)  :: array
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_Scope_6d), intent(in) :: src
    type(sidl_Scope_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 6
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_Scope_7d), intent(out) :: array
    external sidl_int__array_createCol_m
  ...
  subroutine copy7_p(src, dest)
    type(sidl_Scope_7d), intent(in) :: src
    type(sidl_Scope_7d), intent(in) :: dest
    external sidl_int__array_copy_m
    call sidl_int__array_copy_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_Scope_7d), intent(in)  :: src
    type(sidl_Scope_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external sidl_int__array_ensure_m
  ...
  subroutine getg7_p(array, index, value)
    type(sidl_Scope_7d), intent(in)  :: array
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_Scope_7d), intent(in) :: src
    type(sidl_Scope_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external sidl_int__array_smartCopy_m
    dim = 7
  ...
  subroutine castsidl_Scope1dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_Scope_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_Scope1dToGeneric_p

  subroutine castsidl_Scope2dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_Scope_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_Scope2dToGeneric_p

  subroutine castsidl_Scope3dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_Scope_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_Scope3dToGeneric_p

  subroutine castsidl_Scope4dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_Scope_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_Scope4dToGeneric_p

  subroutine castsidl_Scope5dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_Scope_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_Scope5dToGeneric_p

  subroutine castsidl_Scope6dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_Scope_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_Scope6dToGeneric_p

  subroutine castsidl_Scope7dToGeneric_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_Scope_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_Scope7dToGeneric_p


end module sidl_Scope_array
