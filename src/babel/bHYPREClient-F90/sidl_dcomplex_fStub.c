...
{
  (void)sidl_dcomplex__array_convert2f90(
...
{
  (void)sidl_dcomplex__array_convert2f90(
    sidl_dcomplex__array_create1d(*len), 1, result);
}
...
{
  (void)sidl_dcomplex__array_convert2f90(
    sidl_dcomplex__array_create2dRow(*m, *n), 2, result);
}
...
{
  (void)sidl_dcomplex__array_convert2f90(
    sidl_dcomplex__array_create2dCol(*m, *n), 2, result);
}
...
void
SIDLFortran90Symbol(sidl_dcomplex__array_cast_m,
                    SIDL_DCOMPLEX__ARRAY_CAST_M,
                    sidl_dcomplex__array_cast_m)
...
void
SIDLFortran90Symbol(sidl_dcomplex__array_length_m,
                    SIDL_DCOMPLEX__ARRAY_LENGTH_M,
                    sidl_dcomplex__array_length_m)
  (int64_t *array, int32_t *ind, int32_t *result)
{
  *result =
...
SIDLFortran90Symbol(sidl_dcomplex__array_borrow_m,
                    ...
                    sidl_dcomplex__array_borrow_m)
  (struct sidl_dcomplex *firstElement, int32_t *dimen, int32_t lower[], int32_t upper[], int32_t stride[], struct sidl_fortran_array *result)
{
  sidl_dcomplex__array_convert2f90(
...
void
SIDLFortran90Symbol(sidl_dcomplex__array_get5_m,
                    SIDL_DCOMPLEX__ARRAY_GET5_M,
                    sidl_dcomplex__array_get5_m)
  (int64_t *array,   int32_t *i1,
   int32_t *i2,
   int32_t *i3,
...
void
SIDLFortran90Symbol(sidl_dcomplex__array_set5_m,
                    SIDL_DCOMPLEX__ARRAY_SET5_M,
                    sidl_dcomplex__array_set5_m)
  (int64_t *array,   int32_t *i1,
   int32_t *i2,
   int32_t *i3,
...
void
SIDLFortran90Symbol(sidl_dcomplex__array_get6_m,
                    SIDL_DCOMPLEX__ARRAY_GET6_M,
                    sidl_dcomplex__array_get6_m)
  (int64_t *array,   int32_t *i1,
   int32_t *i2,
   int32_t *i3,
...
void
SIDLFortran90Symbol(sidl_dcomplex__array_set6_m,
                    SIDL_DCOMPLEX__ARRAY_SET6_M,
                    sidl_dcomplex__array_set6_m)
  (int64_t *array,   int32_t *i1,
   int32_t *i2,
   int32_t *i3,
...
void
SIDLFortran90Symbol(sidl_dcomplex__array_get7_m,
                    SIDL_DCOMPLEX__ARRAY_GET7_M,
                    sidl_dcomplex__array_get7_m)
  (int64_t *array,   int32_t *i1,
   int32_t *i2,
   int32_t *i3,
...
void
SIDLFortran90Symbol(sidl_dcomplex__array_set7_m,
                    SIDL_DCOMPLEX__ARRAY_SET7_M,
                    sidl_dcomplex__array_set7_m)
  (int64_t *array,   int32_t *i1,
   int32_t *i2,
   int32_t *i3,
