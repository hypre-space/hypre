/*
 * File:          sidl_rmi_BindException_fStub.c
 * Symbol:        sidl.rmi.BindException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V2-2-0b $
 * Revision:      @(#) $Id: sidl_rmi_BindException_fStub.c,v 1.1 2007/02/06 01:23:10 painter Exp $
...
#include "sidl_rmi_BindException_fStub.h"
#endif
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
...
static struct sidl_rmi_BindException__object* 
  sidl_rmi_BindException__remoteCreate(const char* url,
  sidl_BaseInterface *_ex);
static struct sidl_rmi_BindException__object* 
  sidl_rmi_BindException__remoteConnect(const char* url, sidl_bool ar,
  sidl_BaseInterface *_ex);
static struct sidl_rmi_BindException__object* 
  sidl_rmi_BindException__IHConnect(struct sidl_rmi_InstanceHandle__object 
  *instance, struct sidl_BaseInterface__object **_ex);
/*
 * Return pointer to internal IOR functions.
 */

static const struct sidl_rmi_BindException__external* _getIOR(void)
{
  static const struct sidl_rmi_BindException__external *_ior = NULL;
  if (!_ior) {
    _ior = sidl_rmi_BindException__externals();
  }
  return _ior;
}
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_newlocal_m,SIDL_RMI_BINDEXCEPTION_NEWLOCAL_M,sidl_rmi_BindException_newLocal_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_newremote_m,SIDL_RMI_BINDEXCEPTION_NEWREMOTE_M,sidl_rmi_BindException_newRemote_m)
(
  int64_t *self,
  SIDL_F90_String url
...
{
  struct sidl_rmi_BindException__object* _proxy_self = NULL;
  ...
  _proxy_self = sidl_rmi_BindException__remoteCreate(_proxy_url,
    &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_rconnect_m,SIDL_RMI_BINDEXCEPTION_RCONNECT_M,sidl_rmi_BindException_rConnect_m)
(
  int64_t *self,
  SIDL_F90_String url
  SIDL_F90_STR_NEAR_LEN_DECL(url),
...
)
{
  ...
  _proxy_url =
    sidl_copy_fortran_str(SIDL_F90_STR(url),
      SIDL_F90_STR_LEN(url));
  _proxy_self = sidl_rmi_BindException__remoteConnect(_proxy_url, 1,
    &_proxy_exception);
  if (_proxy_exception) {
    *exception = (ptrdiff_t)_proxy_exception;
  }
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__cast_m,SIDL_RMI_BINDEXCEPTION__CAST_M,sidl_rmi_BindException__cast_m)
(
  int64_t *ref,
  int64_t *retval,
  int64_t *exception
)
{
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.BindException",
      (void*)sidl_rmi_BindException__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "sidl.rmi.BindException", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__cast2_m,SIDL_RMI_BINDEXCEPTION__CAST2_M,sidl_rmi_BindException__cast2_m)
(
  int64_t *self,
...
{
  struct sidl_rmi_BindException__epv *_epv = NULL;
  struct sidl_rmi_BindException__object* _proxy_self = NULL;
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__exec_m,SIDL_RMI_BINDEXCEPTION__EXEC_M,sidl_rmi_BindException__exec_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__geturl_m,SIDL_RMI_BINDEXCEPTION__GETURL_M,sidl_rmi_BindException__getURL_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__isremote_m,SIDL_RMI_BINDEXCEPTION__ISREMOTE_M,sidl_rmi_BindException__isRemote_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__islocal_m,SIDL_RMI_BINDEXCEPTION__ISLOCAL_M,sidl_rmi_BindException__isLocal_m)
(
  int64_t *self,
  SIDL_F90_Bool *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__set_hooks_m,SIDL_RMI_BINDEXCEPTION__SET_HOOKS_M,sidl_rmi_BindException__set_hooks_m)
(
  int64_t *self,
  SIDL_F90_Bool *on,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_addref_m,SIDL_RMI_BINDEXCEPTION_ADDREF_M,sidl_rmi_BindException_addRef_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_deleteref_m,SIDL_RMI_BINDEXCEPTION_DELETEREF_M,sidl_rmi_BindException_deleteRef_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_issame_m,SIDL_RMI_BINDEXCEPTION_ISSAME_M,sidl_rmi_BindException_isSame_m)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F90_Bool *retval,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_istype_m,SIDL_RMI_BINDEXCEPTION_ISTYPE_M,sidl_rmi_BindException_isType_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_getclassinfo_m,SIDL_RMI_BINDEXCEPTION_GETCLASSINFO_M,sidl_rmi_BindException_getClassInfo_m)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_getnote_m,SIDL_RMI_BINDEXCEPTION_GETNOTE_M,sidl_rmi_BindException_getNote_m)
(
  int64_t *self,
  SIDL_F90_String retval
  SIDL_F90_STR_NEAR_LEN_DECL(retval),
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_setnote_m,SIDL_RMI_BINDEXCEPTION_SETNOTE_M,sidl_rmi_BindException_setNote_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_gettrace_m,SIDL_RMI_BINDEXCEPTION_GETTRACE_M,sidl_rmi_BindException_getTrace_m)
(
  int64_t *self,
  SIDL_F90_String retval
  SIDL_F90_STR_NEAR_LEN_DECL(retval),
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_addline_m,SIDL_RMI_BINDEXCEPTION_ADDLINE_M,sidl_rmi_BindException_addLine_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_add_m,SIDL_RMI_BINDEXCEPTION_ADD_M,sidl_rmi_BindException_add_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_gethopcount_m,SIDL_RMI_BINDEXCEPTION_GETHOPCOUNT_M,sidl_rmi_BindException_getHopCount_m)
(
  int64_t *self,
  int32_t *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_packobj_m,SIDL_RMI_BINDEXCEPTION_PACKOBJ_M,sidl_rmi_BindException_packObj_m)
(
  int64_t *self,
  int64_t *ser,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception_unpackobj_m,SIDL_RMI_BINDEXCEPTION_UNPACKOBJ_M,sidl_rmi_BindException_unpackObj_m)
(
  int64_t *self,
  int64_t *des,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_createcol_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_CREATECOL_M,
                  sidl_rmi_BindException__array_createCol_m)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_createrow_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_CREATEROW_M,
                  sidl_rmi_BindException__array_createRow_m)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_create1d_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_CREATE1D_M,
                  sidl_rmi_BindException__array_create1d_m)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_create2dcol_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_CREATE2DCOL_M,
                  sidl_rmi_BindException__array_create2dCol_m)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_create2drow_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_CREATE2DROW_M,
                  sidl_rmi_BindException__array_create2dRow_m)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_addref_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_ADDREF_M,
                  sidl_rmi_BindException__array_addRef_m)
  (int64_t *array)
{
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_deleteref_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_DELETEREF_M,
                  sidl_rmi_BindException__array_deleteRef_m)
  (int64_t *array)
{
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_get1_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_GET1_M,
                  sidl_rmi_BindException__array_get1_m)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_get2_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_GET2_M,
                  sidl_rmi_BindException__array_get2_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_get3_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_GET3_M,
                  sidl_rmi_BindException__array_get3_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_get4_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_GET4_M,
                  sidl_rmi_BindException__array_get4_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_get5_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_GET5_M,
                  sidl_rmi_BindException__array_get5_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_get6_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_GET6_M,
                  sidl_rmi_BindException__array_get6_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_get7_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_GET7_M,
                  sidl_rmi_BindException__array_get7_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_get_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_GET_M,
                  sidl_rmi_BindException__array_get_m)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_set1_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SET1_M,
                  sidl_rmi_BindException__array_set1_m)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_set2_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SET2_M,
                  sidl_rmi_BindException__array_set2_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_set3_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SET3_M,
                  sidl_rmi_BindException__array_set3_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_set4_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SET4_M,
                  sidl_rmi_BindException__array_set4_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_set5_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SET5_M,
                  sidl_rmi_BindException__array_set5_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_set6_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SET6_M,
                  sidl_rmi_BindException__array_set6_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_set7_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SET7_M,
                  sidl_rmi_BindException__array_set7_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_set_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SET_M,
                  sidl_rmi_BindException__array_set_m)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_dimen_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_DIMEN_M,
                  sidl_rmi_BindException__array_dimen_m)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_lower_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_LOWER_M,
                  sidl_rmi_BindException__array_lower_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_upper_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_UPPER_M,
                  sidl_rmi_BindException__array_upper_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_length_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_LENGTH_M,
                  sidl_rmi_BindException__array_length_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_stride_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_STRIDE_M,
                  sidl_rmi_BindException__array_stride_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_iscolumnorder_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_ISCOLUMNORDER_M,
                  sidl_rmi_BindException__array_isColumnOrder_m)
  (int64_t *array,
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_isroworder_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_ISROWORDER_M,
                  sidl_rmi_BindException__array_isRowOrder_m)
  (int64_t *array,
   SIDL_F90_Bool *result)
{
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_copy_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_COPY_M,
                  sidl_rmi_BindException__array_copy_m)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_smartcopy_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SMARTCOPY_M,
                  sidl_rmi_BindException__array_smartCopy_m)
  (int64_t *src)
{
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_slice_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_SLICE_M,
                  sidl_rmi_BindException__array_slice_m)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
...
void
SIDLFortran90Symbol(sidl_rmi_bindexception__array_ensure_m,
                  SIDL_RMI_BINDEXCEPTION__ARRAY_ENSURE_M,
                  sidl_rmi_BindException__array_ensure_m)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t sidl_rmi_BindException__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &sidl_rmi_BindException__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &sidl_rmi_BindException__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &sidl_rmi_BindException__mutex )==EDEADLOCK) */
#else
...
static struct sidl_rmi_BindException__epv s_rem_epv__sidl_rmi_bindexception;
...
static void* remote_sidl_rmi_BindException__cast(
  struct sidl_rmi_BindException__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    cmp1 = strcmp(name, "sidl.rmi.BindException");
    if (!cmp1) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = self;
      return cast;
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct 
      sidl_rmi_BindException__remote*)self->d_data)->d_ih, _ex);
  }
...
static void remote_sidl_rmi_BindException__delete(
  struct sidl_rmi_BindException__object* self,
  sidl_BaseInterface* _ex)
{
  *_ex = NULL;
...
static char* remote_sidl_rmi_BindException__getURL(
  struct sidl_rmi_BindException__object* self, sidl_BaseInterface* _ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct 
    sidl_rmi_BindException__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_sidl_rmi_BindException__raddRef(
  struct sidl_rmi_BindException__object* self,sidl_BaseInterface* _ex)
{
...
static sidl_bool
remote_sidl_rmi_BindException__isRemote(
    struct sidl_rmi_BindException__object* self, 
    sidl_BaseInterface *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_sidl_rmi_BindException__set_hooks(
  /* in */ struct sidl_rmi_BindException__object* self ,
  /* in */ sidl_bool on,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException._set_hooks.", &throwaway_exception);
...
static void remote_sidl_rmi_BindException__exec(
  struct sidl_rmi_BindException__object* self,const char* methodName,
...
static void
remote_sidl_rmi_BindException_addRef(
  /* in */ struct sidl_rmi_BindException__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    struct sidl_rmi_BindException__remote* r_obj = (struct 
      sidl_rmi_BindException__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
...
static void
remote_sidl_rmi_BindException_deleteRef(
  /* in */ struct sidl_rmi_BindException__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
...
static sidl_bool
remote_sidl_rmi_BindException_isSame(
  /* in */ struct sidl_rmi_BindException__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.isSame.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static sidl_bool
remote_sidl_rmi_BindException_isType(
  /* in */ struct sidl_rmi_BindException__object* self ,
  /* in */ const char* name,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.isType.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
remote_sidl_rmi_BindException_getClassInfo(
  /* in */ struct sidl_rmi_BindException__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.getClassInfo.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static char*
remote_sidl_rmi_BindException_getNote(
  /* in */ struct sidl_rmi_BindException__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.getNote.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_sidl_rmi_BindException_setNote(
  /* in */ struct sidl_rmi_BindException__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.setNote.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static char*
remote_sidl_rmi_BindException_getTrace(
  /* in */ struct sidl_rmi_BindException__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.getTrace.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_sidl_rmi_BindException_addLine(
  /* in */ struct sidl_rmi_BindException__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.addLine.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_sidl_rmi_BindException_add(
  /* in */ struct sidl_rmi_BindException__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.add.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_sidl_rmi_BindException_getHopCount(
  /* in */ struct sidl_rmi_BindException__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.getHopCount.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_sidl_rmi_BindException_packObj(
  /* in */ struct sidl_rmi_BindException__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.packObj.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_sidl_rmi_BindException_unpackObj(
  /* in */ struct sidl_rmi_BindException__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.rmi.BindException.unpackObj.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void sidl_rmi_BindException__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct sidl_rmi_BindException__epv*    epv = 
    &s_rem_epv__sidl_rmi_bindexception;
  ...
  epv->f__cast             = remote_sidl_rmi_BindException__cast;
  epv->f__delete           = remote_sidl_rmi_BindException__delete;
  epv->f__exec             = remote_sidl_rmi_BindException__exec;
  epv->f__getURL           = remote_sidl_rmi_BindException__getURL;
  epv->f__raddRef          = remote_sidl_rmi_BindException__raddRef;
  epv->f__isRemote         = remote_sidl_rmi_BindException__isRemote;
  epv->f__set_hooks        = remote_sidl_rmi_BindException__set_hooks;
  epv->f__ctor             = NULL;
  epv->f__ctor2            = NULL;
  epv->f__dtor             = NULL;
  epv->f_addRef            = remote_sidl_rmi_BindException_addRef;
  epv->f_deleteRef         = remote_sidl_rmi_BindException_deleteRef;
  epv->f_isSame            = remote_sidl_rmi_BindException_isSame;
  epv->f_isType            = remote_sidl_rmi_BindException_isType;
  epv->f_getClassInfo      = remote_sidl_rmi_BindException_getClassInfo;
  epv->f_getNote           = remote_sidl_rmi_BindException_getNote;
  epv->f_setNote           = remote_sidl_rmi_BindException_setNote;
  epv->f_getTrace          = remote_sidl_rmi_BindException_getTrace;
  epv->f_addLine           = remote_sidl_rmi_BindException_addLine;
  epv->f_add               = remote_sidl_rmi_BindException_add;
  epv->f_getHopCount       = remote_sidl_rmi_BindException_getHopCount;
  epv->f_packObj           = remote_sidl_rmi_BindException_packObj;
  epv->f_unpackObj         = remote_sidl_rmi_BindException_unpackObj;
  ...
  sidl_BaseInterface *_ex)
{
  ...
  struct sidl_rmi_BindException__object* s0;
  ...
  struct sidl_rmi_BindException__remote* r_obj;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    return sidl_rmi_BindException__rmicast(bi,_ex);SIDL_CHECK(*_ex);
  }
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, ar,
    _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_rmi_BindException__object*) malloc(
      sizeof(struct sidl_rmi_BindException__object));

  r_obj =
    (struct sidl_rmi_BindException__remote*) malloc(
      sizeof(struct sidl_rmi_BindException__remote));
  ...
  if (!s_remote_initialized) {
    sidl_rmi_BindException__init_remote_epv();
  }
  UNLOCK_STATIC_GLOBALS;
  ...
  s0->d_epv  = &s_rem_epv__sidl_rmi_bindexception;
...
static struct sidl_rmi_BindException__object*
sidl_rmi_BindException__IHConnect(sidl_rmi_InstanceHandle instance,
  sidl_BaseInterface *_ex)
{
  struct sidl_rmi_BindException__object* self;
...
static struct sidl_rmi_BindException__object*
sidl_rmi_BindException__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "sidl.rmi.BindException",
    _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_rmi_BindException__object*) malloc(
...
sidl_rmi_BindException__rmicast(
  ...
  sidl_BaseInterface* _ex)
{
  struct sidl_rmi_BindException__object* cast = NULL;

  *_ex = NULL;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.BindException",
      (void*)sidl_rmi_BindException__IHConnect, _ex);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    struct sidl_BaseInterface__object* base = (struct 
      sidl_BaseInterface__object*) obj;
    cast = (struct sidl_rmi_BindException__object*) (*base->d_epv->f__cast)(
      base->d_object,
      "sidl.rmi.BindException", _ex); SIDL_CHECK(*_ex);
  }
...
{
  return sidl_rmi_BindException__remoteConnect(url, ar, _ex);
}
