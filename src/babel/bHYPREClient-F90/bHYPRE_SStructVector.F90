...
interface bHYPRE_SStructVector__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(mpi_comm, grid, retval, exception)
    ...
    !  out bHYPRE.SStructVector retval
    type(bHYPRE_SStructVector_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructVector_Create_m
    call bHYPRE_SStructVector_Create_m(mpi_comm, grid, retval, exception)
  ...
  recursive subroutine SetObjectType_s(self, type, retval, exception)
    implicit none
    !  in bHYPRE.SStructVector self
    type(bHYPRE_SStructVector_t) , intent(in) :: self
    !  in int type
    ...
    external bHYPRE_SStructVector_SetObjectType_m
    call bHYPRE_SStructVector_SetObjectType_m(self, type, retval, exception)
  ...
  recursive subroutine SetGrid_s(self, grid, retval, exception)
    ...
    external bHYPRE_SStructVector_SetGrid_m
    call bHYPRE_SStructVector_SetGrid_m(self, grid, retval, exception)
  ...
  recursive subroutine SetValues_1s(self, part, index, var, value, retval,     &
    ...
    external bHYPRE_SStructVector_SetValues_a
    call bHYPRE_SStructVector_SetValues_a(self, part, index, var, value,       &
      retval, exception)
  ...
  recursive subroutine SetValues_2s(self, part, index, var, value, retval,     &
    ...
    external bHYPRE_SStructVector_SetValues_m
    dim = size(index, 1)
    call bHYPRE_SStructVector_SetValues_m(self, part, index, dim, var, value,  &
      retval, exception)
  ...
  recursive subroutine SetBoxValues_1s(self, part, ilower, iupper, var,        &
    ...
    external bHYPRE_SStructVector_SetBoxValues_a
    call bHYPRE_SStructVector_SetBoxValues_a(self, part, ilower, iupper, var,  &
      values, retval, exception)
  ...
  recursive subroutine SetBoxValues_2s(self, part, ilower, iupper, var,        &
    ...
    external bHYPRE_SStructVector_SetBoxValues_m
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_SStructVector_SetBoxValues_m(self, part, ilower, iupper, dim,  &
      var, values, nvalues, retval, exception)
  ...
  recursive subroutine AddToValues_1s(self, part, index, var, value, retval,   &
    ...
    external bHYPRE_SStructVector_AddToValues_a
    call bHYPRE_SStructVector_AddToValues_a(self, part, index, var, value,     &
      retval, exception)
  ...
  recursive subroutine AddToValues_2s(self, part, index, var, value, retval,   &
    ...
    external bHYPRE_SStructVector_AddToValues_m
    dim = size(index, 1)
    call bHYPRE_SStructVector_AddToValues_m(self, part, index, dim, var,       &
  ...
  recursive subroutine AddToBoxValues_1s(self, part, ilower, iupper, var,      &
    ...
    external bHYPRE_SStructVector_AddToBoxValues_a
    call bHYPRE_SStructVector_AddToBoxValues_a(self, part, ilower, iupper,     &
  ...
  recursive subroutine AddToBoxValues_2s(self, part, ilower, iupper, var,      &
    ...
    external bHYPRE_SStructVector_AddToBoxValues_m
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_SStructVector_AddToBoxValues_m(self, part, ilower, iupper,     &
  ...
  recursive subroutine Gather_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector_Gather_m
    call bHYPRE_SStructVector_Gather_m(self, retval, exception)
  ...
  recursive subroutine GetValues_1s(self, part, index, var, value, retval,     &
    ...
    external bHYPRE_SStructVector_GetValues_a
    call bHYPRE_SStructVector_GetValues_a(self, part, index, var, value,       &
      retval, exception)
  ...
  recursive subroutine GetValues_2s(self, part, index, var, value, retval,     &
    ...
    external bHYPRE_SStructVector_GetValues_m
    dim = size(index, 1)
    call bHYPRE_SStructVector_GetValues_m(self, part, index, dim, var, value,  &
      retval, exception)
  ...
  recursive subroutine GetBoxValues_1s(self, part, ilower, iupper, var,        &
    ...
    external bHYPRE_SStructVector_GetBoxValues_a
    call bHYPRE_SStructVector_GetBoxValues_a(self, part, ilower, iupper, var,  &
      values, retval, exception)
  ...
  recursive subroutine GetBoxValues_2s(self, part, ilower, iupper, var,        &
    ...
    external bHYPRE_SStructVector_GetBoxValues_m
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_SStructVector_GetBoxValues_m(self, part, ilower, iupper, dim,  &
      var, values, nvalues, retval, exception)
  ...
  recursive subroutine SetComplex_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector_SetComplex_m
    call bHYPRE_SStructVector_SetComplex_m(self, retval, exception)
  ...
  recursive subroutine Print_s(self, filename, all, retval, exception)
    ...
    external bHYPRE_SStructVector_Print_m
    call bHYPRE_SStructVector_Print_m(self, filename, all, retval, exception)
  ...
  recursive subroutine GetObject_s(self, A, retval, exception)
    ...
    external bHYPRE_SStructVector_GetObject_m
    call bHYPRE_SStructVector_GetObject_m(self, A, retval, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_SStructVector_SetCommunicator_m
    call bHYPRE_SStructVector_SetCommunicator_m(self, mpi_comm, retval,        &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_SStructVector_Destroy_m
    call bHYPRE_SStructVector_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector_Initialize_m
    call bHYPRE_SStructVector_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector_Assemble_m
    call bHYPRE_SStructVector_Assemble_m(self, retval, exception)
  ...
  recursive subroutine Clear_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector_Clear_m
    call bHYPRE_SStructVector_Clear_m(self, retval, exception)
  ...
  recursive subroutine Copy_s(self, x, retval, exception)
    ...
    external bHYPRE_SStructVector_Copy_m
    call bHYPRE_SStructVector_Copy_m(self, x, retval, exception)
  ...
  recursive subroutine Clone_s(self, x, retval, exception)
    ...
    external bHYPRE_SStructVector_Clone_m
    call bHYPRE_SStructVector_Clone_m(self, x, retval, exception)
  ...
  recursive subroutine Scale_s(self, a, retval, exception)
    ...
    external bHYPRE_SStructVector_Scale_m
    call bHYPRE_SStructVector_Scale_m(self, a, retval, exception)
  ...
  recursive subroutine Dot_s(self, x, d, retval, exception)
    ...
    external bHYPRE_SStructVector_Dot_m
    call bHYPRE_SStructVector_Dot_m(self, x, d, retval, exception)
  ...
  recursive subroutine Axpy_s(self, a, x, retval, exception)
    ...
    external bHYPRE_SStructVector_Axpy_m
    call bHYPRE_SStructVector_Axpy_m(self, a, x, retval, exception)
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_SStructVector_newLocal_m
    call bHYPRE_SStructVector_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    implicit none
    !  out bHYPRE.SStructVector self
    type(bHYPRE_SStructVector_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructVector_newRemote_m
    call bHYPRE_SStructVector_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_SStructVector_rConnect_m
    call bHYPRE_SStructVector_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_SStructVector_addRef_m
    call bHYPRE_SStructVector_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_SStructVector_deleteRef_m
    call bHYPRE_SStructVector_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_SStructVector_isSame_m
    call bHYPRE_SStructVector_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_SStructVector_isType_m
    call bHYPRE_SStructVector_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector_getClassInfo_m
    call bHYPRE_SStructVector_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.SStructVector
  ! to bHYPRE.MatrixVectorView.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_SStructVector_t), intent(in) :: oldType
  ...
  ! to bHYPRE.SStructVector.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_MatrixVectorView_t), intent(in) :: oldType
    type(bHYPRE_SStructVector_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_SStructVector__cast_m

    call bHYPRE_SStructVector__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_SStructVector__exec_m
    call bHYPRE_SStructVector__exec_m(self, methodName, inArgs, outArgs,       &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector__getURL_m
    call bHYPRE_SStructVector__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector__isRemote_m
    call bHYPRE_SStructVector__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_SStructVector__isLocal_m
    call bHYPRE_SStructVector__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_SStructVector__set_hooks_m
    call bHYPRE_SStructVector__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_SStructVector__set_hooks_static_m
    call bHYPRE_SStructVector__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_SStructVector_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_SStructVector_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_SStructVector

module bHYPRE_SStructVector_array
  use sidl
  use bHYPRE_SStructVector_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructVy__9akrqm2_p, &
    castbHYPRE_SStructVbyqtddt85g_p, &
    castbHYPRE_SStructV1imujzymjc_p, &
    castbHYPRE_SStructVo12jg8v6xh_p, &
    castbHYPRE_SStructVw35vpnoy6d_p, &
    castbHYPRE_SStructVfdgelfywst_p, &
    castbHYPRE_SStructVeqs1zo031x_p
interface cast
  module procedure &
    castbHYPRE_SStructVy__9akrqm2_p, &
    castbHYPRE_SStructVbyqtddt85g_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_1d), intent(out) :: array
    external SS_ary_createColxc6055vnc8l0j_m
    call SS_ary_createColxc6055vnc8l0j_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_SStructVector_1d), intent(out) :: array
    external SS_ary_createRowg66qb5olf6zph_m
    call SS_ary_createRowg66qb5olf6zph_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_SStructVector_1d), intent(out) :: array
    external SSt_ary_create1d9pmerenm_q0_x_m
    call SSt_ary_create1d9pmerenm_q0_x_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructVector_1d), intent(in) :: src
    type(bHYPRE_SStructVector_1d), intent(in) :: dest
    external SStruct_ary_copykgqpj15stiedp_m
    call SStruct_ary_copykgqpj15stiedp_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructVector_1d), intent(in)  :: src
    type(bHYPRE_SStructVector_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure014go1lc0_mhq_m
    call SStru_ary_ensure014go1lc0_mhq_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external SStruc_ary_slicek4zm7nyet0e2p_m
    call SStruc_ary_slicek4zm7nyet0e2p_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructVector_t), intent(out) :: value
    external SStructV_ary_gettwng6trpdqqs9_m
    call SStructV_ary_gettwng6trpdqqs9_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructVector_t), intent(in) :: value
    external SStructV_ary_set_cvmx3jfkchvs_m
    call SStructV_ary_set_cvmx3jfkchvs_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_SStructVector_t), intent(out) :: value
    external SStruct_ary_get1gs5esx1cu02lt_m
    call SStruct_ary_get1gs5esx1cu02lt_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_SStructVector_t), intent(in) :: value
    external SStruct_ary_set1hbwxzrbwc3sy0_m
    call SStruct_ary_set1hbwxzrbwc3sy0_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructVector_1d), intent(in) :: src
    type(bHYPRE_SStructVector_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy_v5_3stopnh6c_m
    dim = 1
    call SS_ary_smartCopy_v5_3stopnh6c_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    external ary_isColumnOrderz1ne7nxakg2y_m
    call ary_isColumnOrderz1ne7nxakg2y_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    external S_ary_isRowOrder758239v0691gg_m
    call S_ary_isRowOrder758239v0691gg_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    external SStruc_ary_dimenewnyy6aic3uy2_m
    call SStruc_ary_dimenewnyy6aic3uy2_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride3c2g6z3gu6jxa_m
    call SStru_ary_stride3c2g6z3gu6jxa_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower4oij7jf2i33hd_m
    call SStruc_ary_lower4oij7jf2i33hd_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper54_09vkx0dwv__m
    call SStruc_ary_upper54_09vkx0dwv__m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length89kdgh5_5pmh3_m
    call SStru_ary_length89kdgh5_5pmh3_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    external SStru_ary_addRefkd9p61b7rdi4w_m
    call SStru_ary_addRefkd9p61b7rdi4w_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_SStructVector_1d), intent(in)  :: array
    external SS_ary_deleteRefourp8zwz2msz1_m
    call SS_ary_deleteRefourp8zwz2msz1_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_2d), intent(out) :: array
    external SS_ary_createColxc6055vnc8l0j_m
    call SS_ary_createColxc6055vnc8l0j_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_2d), intent(out) :: array
    external SS_ary_createRowg66qb5olf6zph_m
    call SS_ary_createRowg66qb5olf6zph_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructVector_2d), intent(out) :: array
    external ary_create2dColh6rieobj479fht_m
    call ary_create2dColh6rieobj479fht_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructVector_2d), intent(out) :: array
    external ary_create2dRow00uuf2dx21y9ff_m
    call ary_create2dRow00uuf2dx21y9ff_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructVector_2d), intent(in) :: src
    type(bHYPRE_SStructVector_2d), intent(in) :: dest
    external SStruct_ary_copykgqpj15stiedp_m
    call SStruct_ary_copykgqpj15stiedp_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructVector_2d), intent(in)  :: src
    type(bHYPRE_SStructVector_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure014go1lc0_mhq_m
    call SStru_ary_ensure014go1lc0_mhq_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicek4zm7nyet0e2p_m
    call SStruc_ary_slicek4zm7nyet0e2p_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructVector_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_SStructVector_t), intent(out) :: value
    external SStruct_ary_get2agp_34c4d68er_m
    call SStruct_ary_get2agp_34c4d68er_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_SStructVector_t), intent(in) :: value
    external SStruct_ary_set2rsntf_pcsu0qp_m
    call SStruct_ary_set2rsntf_pcsu0qp_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructVector_2d), intent(in) :: src
    type(bHYPRE_SStructVector_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy_v5_3stopnh6c_m
    dim = 2
    call SS_ary_smartCopy_v5_3stopnh6c_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_SStructVector_2d), intent(in)  :: array
    external ary_isColumnOrderz1ne7nxakg2y_m
    call ary_isColumnOrderz1ne7nxakg2y_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_SStructVector_2d), intent(in)  :: array
    external S_ary_isRowOrder758239v0691gg_m
    call S_ary_isRowOrder758239v0691gg_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_SStructVector_2d), intent(in)  :: array
    external SStruc_ary_dimenewnyy6aic3uy2_m
    call SStruc_ary_dimenewnyy6aic3uy2_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride3c2g6z3gu6jxa_m
    call SStru_ary_stride3c2g6z3gu6jxa_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower4oij7jf2i33hd_m
    call SStruc_ary_lower4oij7jf2i33hd_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper54_09vkx0dwv__m
    call SStruc_ary_upper54_09vkx0dwv__m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length89kdgh5_5pmh3_m
    call SStru_ary_length89kdgh5_5pmh3_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_3d), intent(out) :: array
    external SS_ary_createColxc6055vnc8l0j_m
    call SS_ary_createColxc6055vnc8l0j_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_3d), intent(out) :: array
    external SS_ary_createRowg66qb5olf6zph_m
    call SS_ary_createRowg66qb5olf6zph_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructVector_3d), intent(in) :: src
    type(bHYPRE_SStructVector_3d), intent(in) :: dest
    external SStruct_ary_copykgqpj15stiedp_m
    call SStruct_ary_copykgqpj15stiedp_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructVector_3d), intent(in)  :: src
    type(bHYPRE_SStructVector_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure014go1lc0_mhq_m
    call SStru_ary_ensure014go1lc0_mhq_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicek4zm7nyet0e2p_m
    call SStruc_ary_slicek4zm7nyet0e2p_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructVector_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_SStructVector_t), intent(out) :: value
    external SStruct_ary_get3z7hmei2p9vmpg_m
    call SStruct_ary_get3z7hmei2p9vmpg_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_SStructVector_t), intent(in) :: value
    external SStruct_ary_set3joknjmq82q2bs_m
    call SStruct_ary_set3joknjmq82q2bs_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructVector_3d), intent(in) :: src
    type(bHYPRE_SStructVector_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy_v5_3stopnh6c_m
    dim = 3
    call SS_ary_smartCopy_v5_3stopnh6c_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_SStructVector_3d), intent(in)  :: array
    external ary_isColumnOrderz1ne7nxakg2y_m
    call ary_isColumnOrderz1ne7nxakg2y_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_SStructVector_3d), intent(in)  :: array
    external S_ary_isRowOrder758239v0691gg_m
    call S_ary_isRowOrder758239v0691gg_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_SStructVector_3d), intent(in)  :: array
    external SStruc_ary_dimenewnyy6aic3uy2_m
    call SStruc_ary_dimenewnyy6aic3uy2_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride3c2g6z3gu6jxa_m
    call SStru_ary_stride3c2g6z3gu6jxa_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower4oij7jf2i33hd_m
    call SStruc_ary_lower4oij7jf2i33hd_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper54_09vkx0dwv__m
    call SStruc_ary_upper54_09vkx0dwv__m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length89kdgh5_5pmh3_m
    call SStru_ary_length89kdgh5_5pmh3_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_4d), intent(out) :: array
    external SS_ary_createColxc6055vnc8l0j_m
    call SS_ary_createColxc6055vnc8l0j_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_4d), intent(out) :: array
    external SS_ary_createRowg66qb5olf6zph_m
    call SS_ary_createRowg66qb5olf6zph_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructVector_4d), intent(in) :: src
    type(bHYPRE_SStructVector_4d), intent(in) :: dest
    external SStruct_ary_copykgqpj15stiedp_m
    call SStruct_ary_copykgqpj15stiedp_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructVector_4d), intent(in)  :: src
    type(bHYPRE_SStructVector_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure014go1lc0_mhq_m
    call SStru_ary_ensure014go1lc0_mhq_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicek4zm7nyet0e2p_m
    call SStruc_ary_slicek4zm7nyet0e2p_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructVector_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_SStructVector_t), intent(out) :: value
    external SStruct_ary_get4z5d28wrmt2pbp_m
    call SStruct_ary_get4z5d28wrmt2pbp_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_SStructVector_t), intent(in) :: value
    external SStruct_ary_set4_z4gs0baj6o2a_m
    call SStruct_ary_set4_z4gs0baj6o2a_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructVector_4d), intent(in) :: src
    type(bHYPRE_SStructVector_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy_v5_3stopnh6c_m
    dim = 4
    call SS_ary_smartCopy_v5_3stopnh6c_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_SStructVector_4d), intent(in)  :: array
    external ary_isColumnOrderz1ne7nxakg2y_m
    call ary_isColumnOrderz1ne7nxakg2y_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_SStructVector_4d), intent(in)  :: array
    external S_ary_isRowOrder758239v0691gg_m
    call S_ary_isRowOrder758239v0691gg_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_SStructVector_4d), intent(in)  :: array
    external SStruc_ary_dimenewnyy6aic3uy2_m
    call SStruc_ary_dimenewnyy6aic3uy2_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride3c2g6z3gu6jxa_m
    call SStru_ary_stride3c2g6z3gu6jxa_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower4oij7jf2i33hd_m
    call SStruc_ary_lower4oij7jf2i33hd_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper54_09vkx0dwv__m
    call SStruc_ary_upper54_09vkx0dwv__m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length89kdgh5_5pmh3_m
    call SStru_ary_length89kdgh5_5pmh3_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_5d), intent(out) :: array
    external SS_ary_createColxc6055vnc8l0j_m
    call SS_ary_createColxc6055vnc8l0j_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_5d), intent(out) :: array
    external SS_ary_createRowg66qb5olf6zph_m
    call SS_ary_createRowg66qb5olf6zph_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructVector_5d), intent(in) :: src
    type(bHYPRE_SStructVector_5d), intent(in) :: dest
    external SStruct_ary_copykgqpj15stiedp_m
    call SStruct_ary_copykgqpj15stiedp_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructVector_5d), intent(in)  :: src
    type(bHYPRE_SStructVector_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure014go1lc0_mhq_m
    call SStru_ary_ensure014go1lc0_mhq_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicek4zm7nyet0e2p_m
    call SStruc_ary_slicek4zm7nyet0e2p_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructVector_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_SStructVector_t), intent(out) :: value
    external SStruct_ary_get54guttsvgfpo1q_m
    call SStruct_ary_get54guttsvgfpo1q_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_SStructVector_t), intent(in) :: value
    external SStruct_ary_set5kqmccc03agxj5_m
    call SStruct_ary_set5kqmccc03agxj5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructVector_5d), intent(in) :: src
    type(bHYPRE_SStructVector_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy_v5_3stopnh6c_m
    dim = 5
    call SS_ary_smartCopy_v5_3stopnh6c_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_SStructVector_5d), intent(in)  :: array
    external ary_isColumnOrderz1ne7nxakg2y_m
    call ary_isColumnOrderz1ne7nxakg2y_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_SStructVector_5d), intent(in)  :: array
    external S_ary_isRowOrder758239v0691gg_m
    call S_ary_isRowOrder758239v0691gg_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_SStructVector_5d), intent(in)  :: array
    external SStruc_ary_dimenewnyy6aic3uy2_m
    call SStruc_ary_dimenewnyy6aic3uy2_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride3c2g6z3gu6jxa_m
    call SStru_ary_stride3c2g6z3gu6jxa_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower4oij7jf2i33hd_m
    call SStruc_ary_lower4oij7jf2i33hd_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper54_09vkx0dwv__m
    call SStruc_ary_upper54_09vkx0dwv__m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length89kdgh5_5pmh3_m
    call SStru_ary_length89kdgh5_5pmh3_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_6d), intent(out) :: array
    external SS_ary_createColxc6055vnc8l0j_m
    call SS_ary_createColxc6055vnc8l0j_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_6d), intent(out) :: array
    external SS_ary_createRowg66qb5olf6zph_m
    call SS_ary_createRowg66qb5olf6zph_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructVector_6d), intent(in) :: src
    type(bHYPRE_SStructVector_6d), intent(in) :: dest
    external SStruct_ary_copykgqpj15stiedp_m
    call SStruct_ary_copykgqpj15stiedp_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructVector_6d), intent(in)  :: src
    type(bHYPRE_SStructVector_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure014go1lc0_mhq_m
    call SStru_ary_ensure014go1lc0_mhq_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicek4zm7nyet0e2p_m
    call SStruc_ary_slicek4zm7nyet0e2p_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructVector_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_SStructVector_t), intent(out) :: value
    external SStruct_ary_get6ydcmpi2qgx586_m
    call SStruct_ary_get6ydcmpi2qgx586_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_SStructVector_t), intent(in) :: value
    external SStruct_ary_set6jh6l0eltff17n_m
    call SStruct_ary_set6jh6l0eltff17n_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructVector_6d), intent(in) :: src
    type(bHYPRE_SStructVector_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy_v5_3stopnh6c_m
    dim = 6
    call SS_ary_smartCopy_v5_3stopnh6c_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_SStructVector_6d), intent(in)  :: array
    external ary_isColumnOrderz1ne7nxakg2y_m
    call ary_isColumnOrderz1ne7nxakg2y_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_SStructVector_6d), intent(in)  :: array
    external S_ary_isRowOrder758239v0691gg_m
    call S_ary_isRowOrder758239v0691gg_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_SStructVector_6d), intent(in)  :: array
    external SStruc_ary_dimenewnyy6aic3uy2_m
    call SStruc_ary_dimenewnyy6aic3uy2_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride3c2g6z3gu6jxa_m
    call SStru_ary_stride3c2g6z3gu6jxa_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower4oij7jf2i33hd_m
    call SStruc_ary_lower4oij7jf2i33hd_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper54_09vkx0dwv__m
    call SStruc_ary_upper54_09vkx0dwv__m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length89kdgh5_5pmh3_m
    call SStru_ary_length89kdgh5_5pmh3_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_7d), intent(out) :: array
    external SS_ary_createColxc6055vnc8l0j_m
    call SS_ary_createColxc6055vnc8l0j_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructVector_7d), intent(out) :: array
    external SS_ary_createRowg66qb5olf6zph_m
    call SS_ary_createRowg66qb5olf6zph_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructVector_7d), intent(in) :: src
    type(bHYPRE_SStructVector_7d), intent(in) :: dest
    external SStruct_ary_copykgqpj15stiedp_m
    call SStruct_ary_copykgqpj15stiedp_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructVector_7d), intent(in)  :: src
    type(bHYPRE_SStructVector_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensure014go1lc0_mhq_m
    call SStru_ary_ensure014go1lc0_mhq_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicek4zm7nyet0e2p_m
    call SStruc_ary_slicek4zm7nyet0e2p_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructVector_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_SStructVector_t), intent(out) :: value
    external SStruct_ary_get7wr8htc2dnrnmo_m
    call SStruct_ary_get7wr8htc2dnrnmo_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_SStructVector_t), intent(in) :: value
    external SStruct_ary_set7xw6bu8fjkob4q_m
    call SStruct_ary_set7xw6bu8fjkob4q_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructVector_7d), intent(in) :: src
    type(bHYPRE_SStructVector_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy_v5_3stopnh6c_m
    dim = 7
    call SS_ary_smartCopy_v5_3stopnh6c_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_SStructVector_7d), intent(in)  :: array
    external ary_isColumnOrderz1ne7nxakg2y_m
    call ary_isColumnOrderz1ne7nxakg2y_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_SStructVector_7d), intent(in)  :: array
    external S_ary_isRowOrder758239v0691gg_m
    call S_ary_isRowOrder758239v0691gg_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_SStructVector_7d), intent(in)  :: array
    external SStruc_ary_dimenewnyy6aic3uy2_m
    call SStruc_ary_dimenewnyy6aic3uy2_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride3c2g6z3gu6jxa_m
    call SStru_ary_stride3c2g6z3gu6jxa_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower4oij7jf2i33hd_m
    call SStruc_ary_lower4oij7jf2i33hd_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper54_09vkx0dwv__m
    call SStruc_ary_upper54_09vkx0dwv__m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length89kdgh5_5pmh3_m
    call SStru_ary_length89kdgh5_5pmh3_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_SStructVy__9akrqm2_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVector_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVy__9akrqm2_p

  subroutine castbHYPRE_SStructVbyqtddt85g_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVector_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVbyqtddt85g_p

  subroutine castbHYPRE_SStructV1imujzymjc_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVector_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructV1imujzymjc_p

  subroutine castbHYPRE_SStructVo12jg8v6xh_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVector_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVo12jg8v6xh_p

  subroutine castbHYPRE_SStructVw35vpnoy6d_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVector_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVw35vpnoy6d_p

  subroutine castbHYPRE_SStructVfdgelfywst_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVector_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVfdgelfywst_p

  subroutine castbHYPRE_SStructVeqs1zo031x_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructVector_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructVeqs1zo031x_p


end module bHYPRE_SStructVector_array
