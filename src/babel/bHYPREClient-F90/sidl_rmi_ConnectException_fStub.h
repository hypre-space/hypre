/*
 * File:          sidl_rmi_ConnectException_fStub.h
 * Symbol:        sidl.rmi.ConnectException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V2-2-0b $
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_fStub.h,v 1.1 2007/02/06 01:23:11 painter Exp $
 * Description:   Client-side documentation text for sidl.rmi.ConnectException
 * 
...
#define included_sidl_rmi_ConnectException_fStub_h
