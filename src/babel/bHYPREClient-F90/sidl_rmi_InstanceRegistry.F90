! 
! File:          sidl_rmi_InstanceRegistry.F90
! Symbol:        sidl.rmi.InstanceRegistry-v0.9.15
! Symbol Type:   class
! Babel Version: 1.0.0
! Release:       $Name: V2-4-0b $
! Revision:      @(#) $Id: sidl_rmi_InstanceRegistry.F90,v 1.1 2007/02/06 01:23:11 painter Exp $
...
module sidl_rmi_InstanceRegistry

  use sidl
  use sidl_rmi_InstanceRegistry_type
  ...
  interface cast
    ...
    private :: registerInstance_s, &
    registerInstanceByString_s


  interface registerInstance
    module procedure registerInstance_s, &
    registerInstanceByString_s
  end interface
    private :: getInstanceByString_s, &
    getInstanceByClass_s


  interface getInstance
    module procedure getInstanceByString_s, &
    getInstanceByClass_s
  end interface
    private :: removeInstanceByString_s, &
    removeInstanceByClass_s


  interface removeInstance
    module procedure removeInstanceByString_s, &
    removeInstanceByClass_s
  end interface
    private :: newLocal_s, &
    newRemote_s
  ...
  interface sidl_rmi_InstanceRegistry__set_hooks_static
...
contains
  ...
  recursive subroutine registerInstance_s(instance, retval, exception)
    implicit none
    !  in sidl.BaseClass instance
    type(sidl_BaseClass_t) , intent(in) :: instance
    !  out string retval
    character (len=*) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_InstanceRegistry_registerInstance_m
    call sidl_rmi_InstanceRegistry_registerInstance_m(instance, retval,        &
      exception)

  end subroutine registerInstance_s


  recursive subroutine registerInstanceByString_s(instance, instanceID,        &
    retval, exception)
    implicit none
    !  in sidl.BaseClass instance
    type(sidl_BaseClass_t) , intent(in) :: instance
    !  in string instanceID
    character (len=*) , intent(in) :: instanceID
    !  out string retval
    character (len=*) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_InstanceRegistry_registerInstanceByString_m
    call sidl_rmi_InstanceRegistry_registerInstanceByString_m(instance,        &
      instanceID, retval, exception)

  end subroutine registerInstanceByString_s


  recursive subroutine getInstanceByString_s(instanceID, retval, exception)
    implicit none
    !  in string instanceID
    character (len=*) , intent(in) :: instanceID
    !  out sidl.BaseClass retval
    type(sidl_BaseClass_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_InstanceRegistry_getInstanceByString_m
    call sidl_rmi_InstanceRegistry_getInstanceByString_m(instanceID, retval,   &
      exception)

  end subroutine getInstanceByString_s


  recursive subroutine getInstanceByClass_s(instance, retval, exception)
    implicit none
    !  in sidl.BaseClass instance
    type(sidl_BaseClass_t) , intent(in) :: instance
    !  out string retval
    ...
    external sidl_rmi_InstanceRegistry_getInstanceByClass_m
    call sidl_rmi_InstanceRegistry_getInstanceByClass_m(instance, retval,      &
      exception)

  end subroutine getInstanceByClass_s


  recursive subroutine removeInstanceByString_s(instanceID, retval, exception)
    implicit none
    !  in string instanceID
    character (len=*) , intent(in) :: instanceID
    !  out sidl.BaseClass retval
    ...
    external sidl_rmi_InstanceRegistry_removeInstanceByString_m
    call sidl_rmi_InstanceRegistry_removeInstanceByString_m(instanceID,        &
      retval, exception)

  end subroutine removeInstanceByString_s


  recursive subroutine removeInstanceByClass_s(instance, retval, exception)
    implicit none
    !  in sidl.BaseClass instance
    type(sidl_BaseClass_t) , intent(in) :: instance
    !  out string retval
    ...
    external sidl_rmi_InstanceRegistry_removeInstanceByClass_m
    call sidl_rmi_InstanceRegistry_removeInstanceByClass_m(instance, retval,   &
      exception)

  end subroutine removeInstanceByClass_s


  recursive subroutine newLocal_s(retval, exception)
    implicit none
    !  out sidl.rmi.InstanceRegistry retval
    type(sidl_rmi_InstanceRegistry_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_InstanceRegistry_newLocal_m
    call sidl_rmi_InstanceRegistry_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(sidl_rmi_InstanceRegistry_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_InstanceRegistry_newRemote_m
    call sidl_rmi_InstanceRegistry_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external sidl_rmi_InstanceRegistry_rConnect_m
    call sidl_rmi_InstanceRegistry_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    implicit none
    !  in sidl.rmi.InstanceRegistry self
    type(sidl_rmi_InstanceRegistry_t) , intent(in) :: self
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_InstanceRegistry_addRef_m
    call sidl_rmi_InstanceRegistry_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_rmi_InstanceRegistry_deleteRef_m
    call sidl_rmi_InstanceRegistry_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_rmi_InstanceRegistry_isSame_m
    call sidl_rmi_InstanceRegistry_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_rmi_InstanceRegistry_isType_m
    call sidl_rmi_InstanceRegistry_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_rmi_InstanceRegistry_getClassInfo_m
    call sidl_rmi_InstanceRegistry_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from sidl.rmi.InstanceRegistry
  ! to sidl.BaseClass.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: oldType
  ...
  ! to sidl.rmi.InstanceRegistry.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseClass_t), intent(in) :: oldType
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_InstanceRegistry__cast_m

    call sidl_rmi_InstanceRegistry__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_rmi_InstanceRegistry__exec_m
    call sidl_rmi_InstanceRegistry__exec_m(self, methodName, inArgs, outArgs,  &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_rmi_InstanceRegistry__getURL_m
    call sidl_rmi_InstanceRegistry__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_rmi_InstanceRegistry__isRemote_m
    call sidl_rmi_InstanceRegistry__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_rmi_InstanceRegistry__isLocal_m
    call sidl_rmi_InstanceRegistry__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_rmi_InstanceRegistry__set_hooks_m
    call sidl_rmi_InstanceRegistry__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external sidl_rmi_InstanceRegistry__set_hooks_static_m
    call sidl_rmi_InstanceRegistry__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_rmi_InstanceRegistry

module sidl_rmi_InstanceRegistry_array
  use sidl
  use sidl_rmi_InstanceRegistry_type
  use sidl_array_type
  ...
  private :: &
    castsidl_rmi_Instanfojc8rhhyy_p, &
    castsidl_rmi_Instan6dtvrypstl_p, &
    castsidl_rmi_Instanjddpp182gy_p, &
    castsidl_rmi_Instans9c2n_bqhb_p, &
    castsidl_rmi_Instan2dtq_15wi8_p, &
    castsidl_rmi_Instanm2k_g3g_z6_p, &
    castsidl_rmi_Instanxolxyq0j91_p
interface cast
  module procedure &
    castsidl_rmi_Instanfojc8rhhyy_p, &
    castsidl_rmi_Instan6dtvrypstl_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_1d), intent(out) :: array
    external In_ary_createColhlyv3t1h0kcgo_m
    call In_ary_createColhlyv3t1h0kcgo_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_rmi_InstanceRegistry_1d), intent(out) :: array
    external In_ary_createRowq2mn7hizpd2p__m
    call In_ary_createRowq2mn7hizpd2p__m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_rmi_InstanceRegistry_1d), intent(out) :: array
    external Ins_ary_create1d6eksn787qaa8c_m
    call Ins_ary_create1d6eksn787qaa8c_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_rmi_InstanceRegistry_1d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_1d), intent(in) :: dest
    external Instanc_ary_copyzs9uny0ro84b0_m
    call Instanc_ary_copyzs9uny0ro84b0_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: src
    type(sidl_rmi_InstanceRegistry_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Insta_ary_ensuree4k5k4t85i01m_m
    call Insta_ary_ensuree4k5k4t85i01m_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Instan_ary_slice6akb30j1e46lr_m
    call Instan_ary_slice6akb30j1e46lr_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: value
    external Instance_ary_get06h5dydcl5gja_m
    call Instance_ary_get06h5dydcl5gja_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: value
    external Instance_ary_setesj63h3_jv_eo_m
    call Instance_ary_setesj63h3_jv_eo_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: value
    external Instanc_ary_get1qfv1tsitavxrd_m
    call Instanc_ary_get1qfv1tsitavxrd_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: value
    external Instanc_ary_set1kc0s0d5qqrqqr_m
    call Instanc_ary_set1kc0s0d5qqrqqr_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_rmi_InstanceRegistry_1d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopy6u4tzppxrm2v4_m
    dim = 1
    call In_ary_smartCopy6u4tzppxrm2v4_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    external ary_isColumnOrder1haonpz8d06u_m
    call ary_isColumnOrder1haonpz8d06u_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    external I_ary_isRowOrderp2p0_x5gmuybc_m
    call I_ary_isRowOrderp2p0_x5gmuybc_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    external Instan_ary_dimenzmpow3_zoyg7b_m
    call Instan_ary_dimenzmpow3_zoyg7b_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_strideppj30dn4kaatk_m
    call Insta_ary_strideppj30dn4kaatk_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_lower04bhjwfwu9wvj_m
    call Instan_ary_lower04bhjwfwu9wvj_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_upperxac5vdv649w_8_m
    call Instan_ary_upperxac5vdv649w_8_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_length61e93acy3klh5_m
    call Insta_ary_length61e93acy3klh5_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    external Insta_ary_addRefx55mvb_p7g7rn_m
    call Insta_ary_addRefx55mvb_p7g7rn_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_rmi_InstanceRegistry_1d), intent(in)  :: array
    external In_ary_deleteRefe96vuoksaqfm7_m
    call In_ary_deleteRefe96vuoksaqfm7_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_2d), intent(out) :: array
    external In_ary_createColhlyv3t1h0kcgo_m
    call In_ary_createColhlyv3t1h0kcgo_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_2d), intent(out) :: array
    external In_ary_createRowq2mn7hizpd2p__m
    call In_ary_createRowq2mn7hizpd2p__m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_InstanceRegistry_2d), intent(out) :: array
    external ary_create2dCol4txgrmuieusl_5_m
    call ary_create2dCol4txgrmuieusl_5_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_InstanceRegistry_2d), intent(out) :: array
    external ary_create2dRow8fplrt4jf3i9rm_m
    call ary_create2dRow8fplrt4jf3i9rm_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_rmi_InstanceRegistry_2d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_2d), intent(in) :: dest
    external Instanc_ary_copyzs9uny0ro84b0_m
    call Instanc_ary_copyzs9uny0ro84b0_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_rmi_InstanceRegistry_2d), intent(in)  :: src
    type(sidl_rmi_InstanceRegistry_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Insta_ary_ensuree4k5k4t85i01m_m
    call Insta_ary_ensuree4k5k4t85i01m_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Instan_ary_slice6akb30j1e46lr_m
    call Instan_ary_slice6akb30j1e46lr_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_rmi_InstanceRegistry_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: value
    external Instanc_ary_get2_9vs8a9lbf5pg_m
    call Instanc_ary_get2_9vs8a9lbf5pg_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: value
    external Instanc_ary_set2baqhwd_3kd7uc_m
    call Instanc_ary_set2baqhwd_3kd7uc_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_rmi_InstanceRegistry_2d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopy6u4tzppxrm2v4_m
    dim = 2
    call In_ary_smartCopy6u4tzppxrm2v4_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_rmi_InstanceRegistry_2d), intent(in)  :: array
    external ary_isColumnOrder1haonpz8d06u_m
    call ary_isColumnOrder1haonpz8d06u_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_rmi_InstanceRegistry_2d), intent(in)  :: array
    external I_ary_isRowOrderp2p0_x5gmuybc_m
    call I_ary_isRowOrderp2p0_x5gmuybc_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_rmi_InstanceRegistry_2d), intent(in)  :: array
    external Instan_ary_dimenzmpow3_zoyg7b_m
    call Instan_ary_dimenzmpow3_zoyg7b_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_strideppj30dn4kaatk_m
    call Insta_ary_strideppj30dn4kaatk_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_lower04bhjwfwu9wvj_m
    call Instan_ary_lower04bhjwfwu9wvj_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_upperxac5vdv649w_8_m
    call Instan_ary_upperxac5vdv649w_8_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_length61e93acy3klh5_m
    call Insta_ary_length61e93acy3klh5_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_3d), intent(out) :: array
    external In_ary_createColhlyv3t1h0kcgo_m
    call In_ary_createColhlyv3t1h0kcgo_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_3d), intent(out) :: array
    external In_ary_createRowq2mn7hizpd2p__m
    call In_ary_createRowq2mn7hizpd2p__m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_rmi_InstanceRegistry_3d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_3d), intent(in) :: dest
    external Instanc_ary_copyzs9uny0ro84b0_m
    call Instanc_ary_copyzs9uny0ro84b0_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_rmi_InstanceRegistry_3d), intent(in)  :: src
    type(sidl_rmi_InstanceRegistry_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Insta_ary_ensuree4k5k4t85i01m_m
    call Insta_ary_ensuree4k5k4t85i01m_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Instan_ary_slice6akb30j1e46lr_m
    call Instan_ary_slice6akb30j1e46lr_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_rmi_InstanceRegistry_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: value
    external Instanc_ary_get3unvcb3kku5zae_m
    call Instanc_ary_get3unvcb3kku5zae_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: value
    external Instanc_ary_set3kld19jx6da8pn_m
    call Instanc_ary_set3kld19jx6da8pn_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_rmi_InstanceRegistry_3d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopy6u4tzppxrm2v4_m
    dim = 3
    call In_ary_smartCopy6u4tzppxrm2v4_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_rmi_InstanceRegistry_3d), intent(in)  :: array
    external ary_isColumnOrder1haonpz8d06u_m
    call ary_isColumnOrder1haonpz8d06u_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_rmi_InstanceRegistry_3d), intent(in)  :: array
    external I_ary_isRowOrderp2p0_x5gmuybc_m
    call I_ary_isRowOrderp2p0_x5gmuybc_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_rmi_InstanceRegistry_3d), intent(in)  :: array
    external Instan_ary_dimenzmpow3_zoyg7b_m
    call Instan_ary_dimenzmpow3_zoyg7b_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_strideppj30dn4kaatk_m
    call Insta_ary_strideppj30dn4kaatk_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_lower04bhjwfwu9wvj_m
    call Instan_ary_lower04bhjwfwu9wvj_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_upperxac5vdv649w_8_m
    call Instan_ary_upperxac5vdv649w_8_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_length61e93acy3klh5_m
    call Insta_ary_length61e93acy3klh5_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_4d), intent(out) :: array
    external In_ary_createColhlyv3t1h0kcgo_m
    call In_ary_createColhlyv3t1h0kcgo_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_4d), intent(out) :: array
    external In_ary_createRowq2mn7hizpd2p__m
    call In_ary_createRowq2mn7hizpd2p__m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_rmi_InstanceRegistry_4d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_4d), intent(in) :: dest
    external Instanc_ary_copyzs9uny0ro84b0_m
    call Instanc_ary_copyzs9uny0ro84b0_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_rmi_InstanceRegistry_4d), intent(in)  :: src
    type(sidl_rmi_InstanceRegistry_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Insta_ary_ensuree4k5k4t85i01m_m
    call Insta_ary_ensuree4k5k4t85i01m_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Instan_ary_slice6akb30j1e46lr_m
    call Instan_ary_slice6akb30j1e46lr_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_rmi_InstanceRegistry_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: value
    external Instanc_ary_get4htc1q4c956jce_m
    call Instanc_ary_get4htc1q4c956jce_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: value
    external Instanc_ary_set4pstui4kt87ceb_m
    call Instanc_ary_set4pstui4kt87ceb_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_rmi_InstanceRegistry_4d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopy6u4tzppxrm2v4_m
    dim = 4
    call In_ary_smartCopy6u4tzppxrm2v4_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_rmi_InstanceRegistry_4d), intent(in)  :: array
    external ary_isColumnOrder1haonpz8d06u_m
    call ary_isColumnOrder1haonpz8d06u_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_rmi_InstanceRegistry_4d), intent(in)  :: array
    external I_ary_isRowOrderp2p0_x5gmuybc_m
    call I_ary_isRowOrderp2p0_x5gmuybc_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_rmi_InstanceRegistry_4d), intent(in)  :: array
    external Instan_ary_dimenzmpow3_zoyg7b_m
    call Instan_ary_dimenzmpow3_zoyg7b_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_strideppj30dn4kaatk_m
    call Insta_ary_strideppj30dn4kaatk_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_lower04bhjwfwu9wvj_m
    call Instan_ary_lower04bhjwfwu9wvj_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_upperxac5vdv649w_8_m
    call Instan_ary_upperxac5vdv649w_8_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_length61e93acy3klh5_m
    call Insta_ary_length61e93acy3klh5_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_5d), intent(out) :: array
    external In_ary_createColhlyv3t1h0kcgo_m
    call In_ary_createColhlyv3t1h0kcgo_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_5d), intent(out) :: array
    external In_ary_createRowq2mn7hizpd2p__m
    call In_ary_createRowq2mn7hizpd2p__m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_rmi_InstanceRegistry_5d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_5d), intent(in) :: dest
    external Instanc_ary_copyzs9uny0ro84b0_m
    call Instanc_ary_copyzs9uny0ro84b0_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_rmi_InstanceRegistry_5d), intent(in)  :: src
    type(sidl_rmi_InstanceRegistry_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Insta_ary_ensuree4k5k4t85i01m_m
    call Insta_ary_ensuree4k5k4t85i01m_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Instan_ary_slice6akb30j1e46lr_m
    call Instan_ary_slice6akb30j1e46lr_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_rmi_InstanceRegistry_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: value
    external Instanc_ary_get5bks57uclr3p46_m
    call Instanc_ary_get5bks57uclr3p46_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: value
    external Instanc_ary_set5vu597krq44vt6_m
    call Instanc_ary_set5vu597krq44vt6_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_rmi_InstanceRegistry_5d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopy6u4tzppxrm2v4_m
    dim = 5
    call In_ary_smartCopy6u4tzppxrm2v4_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_rmi_InstanceRegistry_5d), intent(in)  :: array
    external ary_isColumnOrder1haonpz8d06u_m
    call ary_isColumnOrder1haonpz8d06u_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_rmi_InstanceRegistry_5d), intent(in)  :: array
    external I_ary_isRowOrderp2p0_x5gmuybc_m
    call I_ary_isRowOrderp2p0_x5gmuybc_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_rmi_InstanceRegistry_5d), intent(in)  :: array
    external Instan_ary_dimenzmpow3_zoyg7b_m
    call Instan_ary_dimenzmpow3_zoyg7b_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_strideppj30dn4kaatk_m
    call Insta_ary_strideppj30dn4kaatk_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_lower04bhjwfwu9wvj_m
    call Instan_ary_lower04bhjwfwu9wvj_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_upperxac5vdv649w_8_m
    call Instan_ary_upperxac5vdv649w_8_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_length61e93acy3klh5_m
    call Insta_ary_length61e93acy3klh5_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_6d), intent(out) :: array
    external In_ary_createColhlyv3t1h0kcgo_m
    call In_ary_createColhlyv3t1h0kcgo_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_6d), intent(out) :: array
    external In_ary_createRowq2mn7hizpd2p__m
    call In_ary_createRowq2mn7hizpd2p__m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_rmi_InstanceRegistry_6d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_6d), intent(in) :: dest
    external Instanc_ary_copyzs9uny0ro84b0_m
    call Instanc_ary_copyzs9uny0ro84b0_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_rmi_InstanceRegistry_6d), intent(in)  :: src
    type(sidl_rmi_InstanceRegistry_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Insta_ary_ensuree4k5k4t85i01m_m
    call Insta_ary_ensuree4k5k4t85i01m_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Instan_ary_slice6akb30j1e46lr_m
    call Instan_ary_slice6akb30j1e46lr_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_rmi_InstanceRegistry_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: value
    external Instanc_ary_get6rabdp61jss6ke_m
    call Instanc_ary_get6rabdp61jss6ke_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: value
    external Instanc_ary_set66rdnpl50ripcy_m
    call Instanc_ary_set66rdnpl50ripcy_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_rmi_InstanceRegistry_6d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopy6u4tzppxrm2v4_m
    dim = 6
    call In_ary_smartCopy6u4tzppxrm2v4_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_rmi_InstanceRegistry_6d), intent(in)  :: array
    external ary_isColumnOrder1haonpz8d06u_m
    call ary_isColumnOrder1haonpz8d06u_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_rmi_InstanceRegistry_6d), intent(in)  :: array
    external I_ary_isRowOrderp2p0_x5gmuybc_m
    call I_ary_isRowOrderp2p0_x5gmuybc_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_rmi_InstanceRegistry_6d), intent(in)  :: array
    external Instan_ary_dimenzmpow3_zoyg7b_m
    call Instan_ary_dimenzmpow3_zoyg7b_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_strideppj30dn4kaatk_m
    call Insta_ary_strideppj30dn4kaatk_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_lower04bhjwfwu9wvj_m
    call Instan_ary_lower04bhjwfwu9wvj_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_upperxac5vdv649w_8_m
    call Instan_ary_upperxac5vdv649w_8_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_length61e93acy3klh5_m
    call Insta_ary_length61e93acy3klh5_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_7d), intent(out) :: array
    external In_ary_createColhlyv3t1h0kcgo_m
    call In_ary_createColhlyv3t1h0kcgo_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_rmi_InstanceRegistry_7d), intent(out) :: array
    external In_ary_createRowq2mn7hizpd2p__m
    call In_ary_createRowq2mn7hizpd2p__m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_rmi_InstanceRegistry_7d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_7d), intent(in) :: dest
    external Instanc_ary_copyzs9uny0ro84b0_m
    call Instanc_ary_copyzs9uny0ro84b0_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_rmi_InstanceRegistry_7d), intent(in)  :: src
    type(sidl_rmi_InstanceRegistry_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Insta_ary_ensuree4k5k4t85i01m_m
    call Insta_ary_ensuree4k5k4t85i01m_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Instan_ary_slice6akb30j1e46lr_m
    call Instan_ary_slice6akb30j1e46lr_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_rmi_InstanceRegistry_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_rmi_InstanceRegistry_t), intent(out) :: value
    external Instanc_ary_get7kk22tt_vyssz5_m
    call Instanc_ary_get7kk22tt_vyssz5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_rmi_InstanceRegistry_t), intent(in) :: value
    external Instanc_ary_set777rztvnr7qcza_m
    call Instanc_ary_set777rztvnr7qcza_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_rmi_InstanceRegistry_7d), intent(in) :: src
    type(sidl_rmi_InstanceRegistry_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopy6u4tzppxrm2v4_m
    dim = 7
    call In_ary_smartCopy6u4tzppxrm2v4_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_rmi_InstanceRegistry_7d), intent(in)  :: array
    external ary_isColumnOrder1haonpz8d06u_m
    call ary_isColumnOrder1haonpz8d06u_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_rmi_InstanceRegistry_7d), intent(in)  :: array
    external I_ary_isRowOrderp2p0_x5gmuybc_m
    call I_ary_isRowOrderp2p0_x5gmuybc_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_rmi_InstanceRegistry_7d), intent(in)  :: array
    external Instan_ary_dimenzmpow3_zoyg7b_m
    call Instan_ary_dimenzmpow3_zoyg7b_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_strideppj30dn4kaatk_m
    call Insta_ary_strideppj30dn4kaatk_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_lower04bhjwfwu9wvj_m
    call Instan_ary_lower04bhjwfwu9wvj_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Instan_ary_upperxac5vdv649w_8_m
    call Instan_ary_upperxac5vdv649w_8_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Insta_ary_length61e93acy3klh5_m
    call Insta_ary_length61e93acy3klh5_m(array, index, length7_p)
  ...
  subroutine castsidl_rmi_Instanfojc8rhhyy_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_InstanceRegistry_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Instanfojc8rhhyy_p

  subroutine castsidl_rmi_Instan6dtvrypstl_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_InstanceRegistry_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Instan6dtvrypstl_p

  subroutine castsidl_rmi_Instanjddpp182gy_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_InstanceRegistry_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Instanjddpp182gy_p

  subroutine castsidl_rmi_Instans9c2n_bqhb_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_InstanceRegistry_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Instans9c2n_bqhb_p

  subroutine castsidl_rmi_Instan2dtq_15wi8_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_InstanceRegistry_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Instan2dtq_15wi8_p

  subroutine castsidl_rmi_Instanm2k_g3g_z6_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_InstanceRegistry_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Instanm2k_g3g_z6_p

  subroutine castsidl_rmi_Instanxolxyq0j91_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_InstanceRegistry_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Instanxolxyq0j91_p


end module sidl_rmi_InstanceRegistry_array
