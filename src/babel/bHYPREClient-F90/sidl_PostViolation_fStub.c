 ...
 * Revision:      @(#) $Id: sidl_PostViolation_fStub.c,v 1.1 2007/02/06 01:23:07 painter Exp $
...
#include "sidl_PostViolation_fStub.h"
#endif
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
...
void
SIDLFortran90Symbol(sidl_postviolation_newlocal_m,SIDL_POSTVIOLATION_NEWLOCAL_M,sidl_PostViolation_newLocal_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(sidl_postviolation_newremote_m,SIDL_POSTVIOLATION_NEWREMOTE_M,sidl_PostViolation_newRemote_m)
(
  int64_t *self,
  SIDL_F90_String url
...
)
{
  ...
  _proxy_self = sidl_PostViolation__remoteCreate(_proxy_url, &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran90Symbol(sidl_postviolation_rconnect_m,SIDL_POSTVIOLATION_RCONNECT_M,sidl_PostViolation_rConnect_m)
(
  int64_t *self,
  SIDL_F90_String url
  SIDL_F90_STR_NEAR_LEN_DECL(url),
...
)
{
  ...
  _proxy_url =
    sidl_copy_fortran_str(SIDL_F90_STR(url),
      SIDL_F90_STR_LEN(url));
  _proxy_self = sidl_PostViolation__remoteConnect(_proxy_url, 1,
    &_proxy_exception);
  if (_proxy_exception) {
    *exception = (ptrdiff_t)_proxy_exception;
  }
...
void
SIDLFortran90Symbol(sidl_postviolation__cast_m,SIDL_POSTVIOLATION__CAST_M,sidl_PostViolation__cast_m)
(
  int64_t *ref,
  int64_t *retval,
  int64_t *exception
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.PostViolation",
      (void*)sidl_PostViolation__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "sidl.PostViolation", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran90Symbol(sidl_postviolation__cast2_m,SIDL_POSTVIOLATION__CAST2_M,sidl_PostViolation__cast2_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_postviolation__exec_m,SIDL_POSTVIOLATION__EXEC_M,sidl_PostViolation__exec_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_postviolation__geturl_m,SIDL_POSTVIOLATION__GETURL_M,sidl_PostViolation__getURL_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_postviolation__isremote_m,SIDL_POSTVIOLATION__ISREMOTE_M,sidl_PostViolation__isRemote_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_postviolation__islocal_m,SIDL_POSTVIOLATION__ISLOCAL_M,sidl_PostViolation__isLocal_m)
(
  int64_t *self,
  SIDL_F90_Bool *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_postviolation__set_hooks_m,SIDL_POSTVIOLATION__SET_HOOKS_M,sidl_PostViolation__set_hooks_m)
(
  int64_t *self,
  SIDL_F90_Bool *on,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_postviolation_addref_m,SIDL_POSTVIOLATION_ADDREF_M,sidl_PostViolation_addRef_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(sidl_postviolation_deleteref_m,SIDL_POSTVIOLATION_DELETEREF_M,sidl_PostViolation_deleteRef_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(sidl_postviolation_issame_m,SIDL_POSTVIOLATION_ISSAME_M,sidl_PostViolation_isSame_m)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F90_Bool *retval,
...
void
SIDLFortran90Symbol(sidl_postviolation_istype_m,SIDL_POSTVIOLATION_ISTYPE_M,sidl_PostViolation_isType_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(sidl_postviolation_getclassinfo_m,SIDL_POSTVIOLATION_GETCLASSINFO_M,sidl_PostViolation_getClassInfo_m)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_postviolation_getnote_m,SIDL_POSTVIOLATION_GETNOTE_M,sidl_PostViolation_getNote_m)
(
  int64_t *self,
  SIDL_F90_String retval
  SIDL_F90_STR_NEAR_LEN_DECL(retval),
...
void
SIDLFortran90Symbol(sidl_postviolation_setnote_m,SIDL_POSTVIOLATION_SETNOTE_M,sidl_PostViolation_setNote_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_postviolation_gettrace_m,SIDL_POSTVIOLATION_GETTRACE_M,sidl_PostViolation_getTrace_m)
(
  int64_t *self,
  SIDL_F90_String retval
  SIDL_F90_STR_NEAR_LEN_DECL(retval),
...
void
SIDLFortran90Symbol(sidl_postviolation_addline_m,SIDL_POSTVIOLATION_ADDLINE_M,sidl_PostViolation_addLine_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_postviolation_add_m,SIDL_POSTVIOLATION_ADD_M,sidl_PostViolation_add_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_postviolation_packobj_m,SIDL_POSTVIOLATION_PACKOBJ_M,sidl_PostViolation_packObj_m)
(
  int64_t *self,
  int64_t *ser,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_postviolation_unpackobj_m,SIDL_POSTVIOLATION_UNPACKOBJ_M,sidl_PostViolation_unpackObj_m)
(
  int64_t *self,
  int64_t *des,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_postviolation__array_createcol_m,
                  SIDL_POSTVIOLATION__ARRAY_CREATECOL_M,
                  sidl_PostViolation__array_createCol_m)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran90Symbol(sidl_postviolation__array_createrow_m,
                  SIDL_POSTVIOLATION__ARRAY_CREATEROW_M,
                  sidl_PostViolation__array_createRow_m)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran90Symbol(sidl_postviolation__array_create1d_m,
                  SIDL_POSTVIOLATION__ARRAY_CREATE1D_M,
                  sidl_PostViolation__array_create1d_m)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_create2dcol_m,
                  SIDL_POSTVIOLATION__ARRAY_CREATE2DCOL_M,
                  sidl_PostViolation__array_create2dCol_m)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_create2drow_m,
                  SIDL_POSTVIOLATION__ARRAY_CREATE2DROW_M,
                  sidl_PostViolation__array_create2dRow_m)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran90Symbol(sidl_postviolation__array_addref_m,
                  SIDL_POSTVIOLATION__ARRAY_ADDREF_M,
                  sidl_PostViolation__array_addRef_m)
  (int64_t *array)
{
...
void
SIDLFortran90Symbol(sidl_postviolation__array_deleteref_m,
                  SIDL_POSTVIOLATION__ARRAY_DELETEREF_M,
                  sidl_PostViolation__array_deleteRef_m)
  (int64_t *array)
{
...
void
SIDLFortran90Symbol(sidl_postviolation__array_get1_m,
                  SIDL_POSTVIOLATION__ARRAY_GET1_M,
                  sidl_PostViolation__array_get1_m)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_get2_m,
                  SIDL_POSTVIOLATION__ARRAY_GET2_M,
                  sidl_PostViolation__array_get2_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_postviolation__array_get3_m,
                  SIDL_POSTVIOLATION__ARRAY_GET3_M,
                  sidl_PostViolation__array_get3_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_postviolation__array_get4_m,
                  SIDL_POSTVIOLATION__ARRAY_GET4_M,
                  sidl_PostViolation__array_get4_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_postviolation__array_get5_m,
                  SIDL_POSTVIOLATION__ARRAY_GET5_M,
                  sidl_PostViolation__array_get5_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_postviolation__array_get6_m,
                  SIDL_POSTVIOLATION__ARRAY_GET6_M,
                  sidl_PostViolation__array_get6_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_postviolation__array_get7_m,
                  SIDL_POSTVIOLATION__ARRAY_GET7_M,
                  sidl_PostViolation__array_get7_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_postviolation__array_get_m,
                  SIDL_POSTVIOLATION__ARRAY_GET_M,
                  sidl_PostViolation__array_get_m)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_set1_m,
                  SIDL_POSTVIOLATION__ARRAY_SET1_M,
                  sidl_PostViolation__array_set1_m)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_set2_m,
                  SIDL_POSTVIOLATION__ARRAY_SET2_M,
                  sidl_PostViolation__array_set2_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_postviolation__array_set3_m,
                  SIDL_POSTVIOLATION__ARRAY_SET3_M,
                  sidl_PostViolation__array_set3_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_postviolation__array_set4_m,
                  SIDL_POSTVIOLATION__ARRAY_SET4_M,
                  sidl_PostViolation__array_set4_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_postviolation__array_set5_m,
                  SIDL_POSTVIOLATION__ARRAY_SET5_M,
                  sidl_PostViolation__array_set5_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_postviolation__array_set6_m,
                  SIDL_POSTVIOLATION__ARRAY_SET6_M,
                  sidl_PostViolation__array_set6_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_postviolation__array_set7_m,
                  SIDL_POSTVIOLATION__ARRAY_SET7_M,
                  sidl_PostViolation__array_set7_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_postviolation__array_set_m,
                  SIDL_POSTVIOLATION__ARRAY_SET_M,
                  sidl_PostViolation__array_set_m)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_dimen_m,
                  SIDL_POSTVIOLATION__ARRAY_DIMEN_M,
                  sidl_PostViolation__array_dimen_m)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_lower_m,
                  SIDL_POSTVIOLATION__ARRAY_LOWER_M,
                  sidl_PostViolation__array_lower_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_upper_m,
                  SIDL_POSTVIOLATION__ARRAY_UPPER_M,
                  sidl_PostViolation__array_upper_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_length_m,
                  SIDL_POSTVIOLATION__ARRAY_LENGTH_M,
                  sidl_PostViolation__array_length_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_stride_m,
                  SIDL_POSTVIOLATION__ARRAY_STRIDE_M,
                  sidl_PostViolation__array_stride_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_postviolation__array_iscolumnorder_m,
                  SIDL_POSTVIOLATION__ARRAY_ISCOLUMNORDER_M,
                  sidl_PostViolation__array_isColumnOrder_m)
  (int64_t *array,
...
void
SIDLFortran90Symbol(sidl_postviolation__array_isroworder_m,
                  SIDL_POSTVIOLATION__ARRAY_ISROWORDER_M,
                  sidl_PostViolation__array_isRowOrder_m)
  (int64_t *array,
   SIDL_F90_Bool *result)
{
...
void
SIDLFortran90Symbol(sidl_postviolation__array_copy_m,
                  SIDL_POSTVIOLATION__ARRAY_COPY_M,
                  sidl_PostViolation__array_copy_m)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran90Symbol(sidl_postviolation__array_smartcopy_m,
                  SIDL_POSTVIOLATION__ARRAY_SMARTCOPY_M,
                  sidl_PostViolation__array_smartCopy_m)
  (int64_t *src)
{
...
void
SIDLFortran90Symbol(sidl_postviolation__array_slice_m,
                  SIDL_POSTVIOLATION__ARRAY_SLICE_M,
                  sidl_PostViolation__array_slice_m)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
...
void
SIDLFortran90Symbol(sidl_postviolation__array_ensure_m,
                  SIDL_POSTVIOLATION__ARRAY_ENSURE_M,
                  sidl_PostViolation__array_ensure_m)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
