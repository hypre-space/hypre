/*
 * File:          sidl_rmi_NoRouteToHostException_fStub.h
 * Symbol:        sidl.rmi.NoRouteToHostException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_fStub.h,v 1.1 2007/02/06 01:23:12 painter Exp $
 * Description:   Client-side documentation text for sidl.rmi.NoRouteToHostException
 * 
...
#define included_sidl_rmi_NoRouteToHostException_fStub_h
