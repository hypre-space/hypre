! 
! File:          sidl_io_Serializable.F90
! Symbol:        sidl.io.Serializable-v0.9.15
! Symbol Type:   interface
! Babel Version: 1.0.0
! Release:       $Name: V2-2-0b $
! Revision:      @(#) $Id: sidl_io_Serializable.F90,v 1.1 2007/02/06 01:23:09 painter Exp $
...
contains
  ...
  recursive subroutine packObj_s(self, ser, exception)
    implicit none
    !  in sidl.io.Serializable self
    type(sidl_io_Serializable_t) , intent(in) :: self
    !  in sidl.io.Serializer ser
    type(sidl_io_Serializer_t) , intent(in) :: ser
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_io_Serializable_packObj_m
    call sidl_io_Serializable_packObj_m(self, ser, exception)
  ...
  recursive subroutine unpackObj_s(self, des, exception)
    ...
    external sidl_io_Serializable_unpackObj_m
    call sidl_io_Serializable_unpackObj_m(self, des, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    type(sidl_io_Serializable_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_io_Serializable_rConnect_m
    call sidl_io_Serializable_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external sidl_io_Serializable_addRef_m
    call sidl_io_Serializable_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_io_Serializable_deleteRef_m
    call sidl_io_Serializable_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_io_Serializable_isSame_m
    call sidl_io_Serializable_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_io_Serializable_isType_m
    call sidl_io_Serializable_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_io_Serializable_getClassInfo_m
    call sidl_io_Serializable_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_io_Serializable__exec_m
    call sidl_io_Serializable__exec_m(self, methodName, inArgs, outArgs,       &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_io_Serializable__getURL_m
    call sidl_io_Serializable__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_io_Serializable__isRemote_m
    call sidl_io_Serializable__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_io_Serializable__isLocal_m
    call sidl_io_Serializable__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_io_Serializable__set_hooks_m
    call sidl_io_Serializable__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(sidl_io_Serializable_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_io_Serializable_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_io_Serializable

module sidl_io_Serializable_array
  use sidl
  use sidl_io_Serializable_type
  use sidl_array_type
  ...
  private :: &
    castsidl_io_Serialir0rfo5t1bt_p, &
    castsidl_io_Serialijaz3ajuu0v_p, &
    castsidl_io_Serialicq3qeiuh01_p, &
    castsidl_io_Serialiks009nw7f4_p, &
    castsidl_io_Seriali_ebyypr9l3_p, &
    castsidl_io_Serialixdl7k8uu1m_p, &
    castsidl_io_Serialigur569zp8__p
interface cast
  module procedure &
    castsidl_io_Serialir0rfo5t1bt_p, &
    castsidl_io_Serialijaz3ajuu0v_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_1d), intent(out) :: array
    external Se_ary_createColr885aaj2elb78_m
    call Se_ary_createColr885aaj2elb78_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_io_Serializable_1d), intent(out) :: array
    external Se_ary_createRows1pppha5vld88_m
    call Se_ary_createRows1pppha5vld88_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_io_Serializable_1d), intent(out) :: array
    external Ser_ary_create1dfbur71ovd1a1e_m
    call Ser_ary_create1dfbur71ovd1a1e_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_io_Serializable_1d), intent(in) :: src
    type(sidl_io_Serializable_1d), intent(in) :: dest
    external Seriali_ary_copy57oppwuw8r12r_m
    call Seriali_ary_copy57oppwuw8r12r_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_io_Serializable_1d), intent(in)  :: src
    type(sidl_io_Serializable_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Seria_ary_ensurei4rgyd3vw_3no_m
    call Seria_ary_ensurei4rgyd3vw_3no_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Serial_ary_slicehskj_g9vfcwdw_m
    call Serial_ary_slicehskj_g9vfcwdw_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_io_Serializable_t), intent(out) :: value
    external Serializ_ary_getv6oeaeplqa8vy_m
    call Serializ_ary_getv6oeaeplqa8vy_m(array, index, value)
  ...
  subroutine setg1_p(array, index, value)
    ...
    external Serializ_ary_setltp35hyjmi_q6_m
    call Serializ_ary_setltp35hyjmi_q6_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_io_Serializable_t), intent(out) :: value
    external Seriali_ary_get1i_rg5dfuncp06_m
    call Seriali_ary_get1i_rg5dfuncp06_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_io_Serializable_t), intent(in) :: value
    external Seriali_ary_set14ahu9bjl622em_m
    call Seriali_ary_set14ahu9bjl622em_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_io_Serializable_1d), intent(in) :: src
    type(sidl_io_Serializable_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Se_ary_smartCopyems5xa_e2ysss_m
    dim = 1
    call Se_ary_smartCopyems5xa_e2ysss_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    external ary_isColumnOrderu8lao_v_vwv8_m
    call ary_isColumnOrderu8lao_v_vwv8_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    external S_ary_isRowOrdertjiv6tm2d82r__m
    call S_ary_isRowOrdertjiv6tm2d82r__m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    external Serial_ary_dimenqgfo5vnn0uv5__m
    call Serial_ary_dimenqgfo5vnn0uv5__m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_stride4t8eijwfo_p0x_m
    call Seria_ary_stride4t8eijwfo_p0x_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_lowerqgmp_y38oxuk7_m
    call Serial_ary_lowerqgmp_y38oxuk7_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_upperf_83b9pzjnfll_m
    call Serial_ary_upperf_83b9pzjnfll_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_length6deinl4tlmtxk_m
    call Seria_ary_length6deinl4tlmtxk_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    external Seria_ary_addRefthzknrtfh8pmi_m
    call Seria_ary_addRefthzknrtfh8pmi_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_io_Serializable_1d), intent(in)  :: array
    external Se_ary_deleteRefec8cle2m6p2yu_m
    call Se_ary_deleteRefec8cle2m6p2yu_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_2d), intent(out) :: array
    external Se_ary_createColr885aaj2elb78_m
    call Se_ary_createColr885aaj2elb78_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_2d), intent(out) :: array
    external Se_ary_createRows1pppha5vld88_m
    call Se_ary_createRows1pppha5vld88_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_io_Serializable_2d), intent(out) :: array
    external ary_create2dColh7s5ml1tnkhjp__m
    call ary_create2dColh7s5ml1tnkhjp__m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_io_Serializable_2d), intent(out) :: array
    external ary_create2dRowalbil06m4jqvu8_m
    call ary_create2dRowalbil06m4jqvu8_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_io_Serializable_2d), intent(in) :: src
    type(sidl_io_Serializable_2d), intent(in) :: dest
    external Seriali_ary_copy57oppwuw8r12r_m
    call Seriali_ary_copy57oppwuw8r12r_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_io_Serializable_2d), intent(in)  :: src
    type(sidl_io_Serializable_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Seria_ary_ensurei4rgyd3vw_3no_m
    call Seria_ary_ensurei4rgyd3vw_3no_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Serial_ary_slicehskj_g9vfcwdw_m
    call Serial_ary_slicehskj_g9vfcwdw_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_io_Serializable_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_io_Serializable_t), intent(out) :: value
    external Seriali_ary_get28gz5lmmh5hekg_m
    call Seriali_ary_get28gz5lmmh5hekg_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_io_Serializable_t), intent(in) :: value
    external Seriali_ary_set2wjtw2b1hi7vx1_m
    call Seriali_ary_set2wjtw2b1hi7vx1_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_io_Serializable_2d), intent(in) :: src
    type(sidl_io_Serializable_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Se_ary_smartCopyems5xa_e2ysss_m
    dim = 2
    call Se_ary_smartCopyems5xa_e2ysss_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_io_Serializable_2d), intent(in)  :: array
    external ary_isColumnOrderu8lao_v_vwv8_m
    call ary_isColumnOrderu8lao_v_vwv8_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_io_Serializable_2d), intent(in)  :: array
    external S_ary_isRowOrdertjiv6tm2d82r__m
    call S_ary_isRowOrdertjiv6tm2d82r__m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_io_Serializable_2d), intent(in)  :: array
    external Serial_ary_dimenqgfo5vnn0uv5__m
    call Serial_ary_dimenqgfo5vnn0uv5__m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_stride4t8eijwfo_p0x_m
    call Seria_ary_stride4t8eijwfo_p0x_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_lowerqgmp_y38oxuk7_m
    call Serial_ary_lowerqgmp_y38oxuk7_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_upperf_83b9pzjnfll_m
    call Serial_ary_upperf_83b9pzjnfll_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_length6deinl4tlmtxk_m
    call Seria_ary_length6deinl4tlmtxk_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_3d), intent(out) :: array
    external Se_ary_createColr885aaj2elb78_m
    call Se_ary_createColr885aaj2elb78_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_3d), intent(out) :: array
    external Se_ary_createRows1pppha5vld88_m
    call Se_ary_createRows1pppha5vld88_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_io_Serializable_3d), intent(in) :: src
    type(sidl_io_Serializable_3d), intent(in) :: dest
    external Seriali_ary_copy57oppwuw8r12r_m
    call Seriali_ary_copy57oppwuw8r12r_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_io_Serializable_3d), intent(in)  :: src
    type(sidl_io_Serializable_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Seria_ary_ensurei4rgyd3vw_3no_m
    call Seria_ary_ensurei4rgyd3vw_3no_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Serial_ary_slicehskj_g9vfcwdw_m
    call Serial_ary_slicehskj_g9vfcwdw_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_io_Serializable_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_io_Serializable_t), intent(out) :: value
    external Seriali_ary_get36puxg5cwyhi4e_m
    call Seriali_ary_get36puxg5cwyhi4e_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_io_Serializable_t), intent(in) :: value
    external Seriali_ary_set3gm_741djw0wl5_m
    call Seriali_ary_set3gm_741djw0wl5_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_io_Serializable_3d), intent(in) :: src
    type(sidl_io_Serializable_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Se_ary_smartCopyems5xa_e2ysss_m
    dim = 3
    call Se_ary_smartCopyems5xa_e2ysss_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_io_Serializable_3d), intent(in)  :: array
    external ary_isColumnOrderu8lao_v_vwv8_m
    call ary_isColumnOrderu8lao_v_vwv8_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_io_Serializable_3d), intent(in)  :: array
    external S_ary_isRowOrdertjiv6tm2d82r__m
    call S_ary_isRowOrdertjiv6tm2d82r__m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_io_Serializable_3d), intent(in)  :: array
    external Serial_ary_dimenqgfo5vnn0uv5__m
    call Serial_ary_dimenqgfo5vnn0uv5__m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_stride4t8eijwfo_p0x_m
    call Seria_ary_stride4t8eijwfo_p0x_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_lowerqgmp_y38oxuk7_m
    call Serial_ary_lowerqgmp_y38oxuk7_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_upperf_83b9pzjnfll_m
    call Serial_ary_upperf_83b9pzjnfll_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_length6deinl4tlmtxk_m
    call Seria_ary_length6deinl4tlmtxk_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_4d), intent(out) :: array
    external Se_ary_createColr885aaj2elb78_m
    call Se_ary_createColr885aaj2elb78_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_4d), intent(out) :: array
    external Se_ary_createRows1pppha5vld88_m
    call Se_ary_createRows1pppha5vld88_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_io_Serializable_4d), intent(in) :: src
    type(sidl_io_Serializable_4d), intent(in) :: dest
    external Seriali_ary_copy57oppwuw8r12r_m
    call Seriali_ary_copy57oppwuw8r12r_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_io_Serializable_4d), intent(in)  :: src
    type(sidl_io_Serializable_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Seria_ary_ensurei4rgyd3vw_3no_m
    call Seria_ary_ensurei4rgyd3vw_3no_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Serial_ary_slicehskj_g9vfcwdw_m
    call Serial_ary_slicehskj_g9vfcwdw_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_io_Serializable_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_io_Serializable_t), intent(out) :: value
    external Seriali_ary_get44fv2pfmczxa05_m
    call Seriali_ary_get44fv2pfmczxa05_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_io_Serializable_t), intent(in) :: value
    external Seriali_ary_set4ptjfcup4l2ct8_m
    call Seriali_ary_set4ptjfcup4l2ct8_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_io_Serializable_4d), intent(in) :: src
    type(sidl_io_Serializable_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Se_ary_smartCopyems5xa_e2ysss_m
    dim = 4
    call Se_ary_smartCopyems5xa_e2ysss_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_io_Serializable_4d), intent(in)  :: array
    external ary_isColumnOrderu8lao_v_vwv8_m
    call ary_isColumnOrderu8lao_v_vwv8_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_io_Serializable_4d), intent(in)  :: array
    external S_ary_isRowOrdertjiv6tm2d82r__m
    call S_ary_isRowOrdertjiv6tm2d82r__m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_io_Serializable_4d), intent(in)  :: array
    external Serial_ary_dimenqgfo5vnn0uv5__m
    call Serial_ary_dimenqgfo5vnn0uv5__m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_stride4t8eijwfo_p0x_m
    call Seria_ary_stride4t8eijwfo_p0x_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_lowerqgmp_y38oxuk7_m
    call Serial_ary_lowerqgmp_y38oxuk7_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_upperf_83b9pzjnfll_m
    call Serial_ary_upperf_83b9pzjnfll_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_length6deinl4tlmtxk_m
    call Seria_ary_length6deinl4tlmtxk_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_5d), intent(out) :: array
    external Se_ary_createColr885aaj2elb78_m
    call Se_ary_createColr885aaj2elb78_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_5d), intent(out) :: array
    external Se_ary_createRows1pppha5vld88_m
    call Se_ary_createRows1pppha5vld88_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_io_Serializable_5d), intent(in) :: src
    type(sidl_io_Serializable_5d), intent(in) :: dest
    external Seriali_ary_copy57oppwuw8r12r_m
    call Seriali_ary_copy57oppwuw8r12r_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_io_Serializable_5d), intent(in)  :: src
    type(sidl_io_Serializable_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Seria_ary_ensurei4rgyd3vw_3no_m
    call Seria_ary_ensurei4rgyd3vw_3no_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Serial_ary_slicehskj_g9vfcwdw_m
    call Serial_ary_slicehskj_g9vfcwdw_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_io_Serializable_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_io_Serializable_t), intent(out) :: value
    external Seriali_ary_get51ntvumjppoxh6_m
    call Seriali_ary_get51ntvumjppoxh6_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_io_Serializable_t), intent(in) :: value
    external Seriali_ary_set5nrxhle9499oid_m
    call Seriali_ary_set5nrxhle9499oid_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_io_Serializable_5d), intent(in) :: src
    type(sidl_io_Serializable_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Se_ary_smartCopyems5xa_e2ysss_m
    dim = 5
    call Se_ary_smartCopyems5xa_e2ysss_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_io_Serializable_5d), intent(in)  :: array
    external ary_isColumnOrderu8lao_v_vwv8_m
    call ary_isColumnOrderu8lao_v_vwv8_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_io_Serializable_5d), intent(in)  :: array
    external S_ary_isRowOrdertjiv6tm2d82r__m
    call S_ary_isRowOrdertjiv6tm2d82r__m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_io_Serializable_5d), intent(in)  :: array
    external Serial_ary_dimenqgfo5vnn0uv5__m
    call Serial_ary_dimenqgfo5vnn0uv5__m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_stride4t8eijwfo_p0x_m
    call Seria_ary_stride4t8eijwfo_p0x_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_lowerqgmp_y38oxuk7_m
    call Serial_ary_lowerqgmp_y38oxuk7_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_upperf_83b9pzjnfll_m
    call Serial_ary_upperf_83b9pzjnfll_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_length6deinl4tlmtxk_m
    call Seria_ary_length6deinl4tlmtxk_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_6d), intent(out) :: array
    external Se_ary_createColr885aaj2elb78_m
    call Se_ary_createColr885aaj2elb78_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_6d), intent(out) :: array
    external Se_ary_createRows1pppha5vld88_m
    call Se_ary_createRows1pppha5vld88_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_io_Serializable_6d), intent(in) :: src
    type(sidl_io_Serializable_6d), intent(in) :: dest
    external Seriali_ary_copy57oppwuw8r12r_m
    call Seriali_ary_copy57oppwuw8r12r_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_io_Serializable_6d), intent(in)  :: src
    type(sidl_io_Serializable_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Seria_ary_ensurei4rgyd3vw_3no_m
    call Seria_ary_ensurei4rgyd3vw_3no_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Serial_ary_slicehskj_g9vfcwdw_m
    call Serial_ary_slicehskj_g9vfcwdw_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_io_Serializable_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_io_Serializable_t), intent(out) :: value
    external Seriali_ary_get6nmb_0bcolawnp_m
    call Seriali_ary_get6nmb_0bcolawnp_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_io_Serializable_t), intent(in) :: value
    external Seriali_ary_set6zqhh42aoqkzx5_m
    call Seriali_ary_set6zqhh42aoqkzx5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_io_Serializable_6d), intent(in) :: src
    type(sidl_io_Serializable_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Se_ary_smartCopyems5xa_e2ysss_m
    dim = 6
    call Se_ary_smartCopyems5xa_e2ysss_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_io_Serializable_6d), intent(in)  :: array
    external ary_isColumnOrderu8lao_v_vwv8_m
    call ary_isColumnOrderu8lao_v_vwv8_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_io_Serializable_6d), intent(in)  :: array
    external S_ary_isRowOrdertjiv6tm2d82r__m
    call S_ary_isRowOrdertjiv6tm2d82r__m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_io_Serializable_6d), intent(in)  :: array
    external Serial_ary_dimenqgfo5vnn0uv5__m
    call Serial_ary_dimenqgfo5vnn0uv5__m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_stride4t8eijwfo_p0x_m
    call Seria_ary_stride4t8eijwfo_p0x_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_lowerqgmp_y38oxuk7_m
    call Serial_ary_lowerqgmp_y38oxuk7_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_upperf_83b9pzjnfll_m
    call Serial_ary_upperf_83b9pzjnfll_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_length6deinl4tlmtxk_m
    call Seria_ary_length6deinl4tlmtxk_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_7d), intent(out) :: array
    external Se_ary_createColr885aaj2elb78_m
    call Se_ary_createColr885aaj2elb78_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_io_Serializable_7d), intent(out) :: array
    external Se_ary_createRows1pppha5vld88_m
    call Se_ary_createRows1pppha5vld88_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_io_Serializable_7d), intent(in) :: src
    type(sidl_io_Serializable_7d), intent(in) :: dest
    external Seriali_ary_copy57oppwuw8r12r_m
    call Seriali_ary_copy57oppwuw8r12r_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_io_Serializable_7d), intent(in)  :: src
    type(sidl_io_Serializable_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Seria_ary_ensurei4rgyd3vw_3no_m
    call Seria_ary_ensurei4rgyd3vw_3no_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Serial_ary_slicehskj_g9vfcwdw_m
    call Serial_ary_slicehskj_g9vfcwdw_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_io_Serializable_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_io_Serializable_t), intent(out) :: value
    external Seriali_ary_get735_nitjpa7wpy_m
    call Seriali_ary_get735_nitjpa7wpy_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_io_Serializable_t), intent(in) :: value
    external Seriali_ary_set7v2zt39_zbtfw6_m
    call Seriali_ary_set7v2zt39_zbtfw6_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_io_Serializable_7d), intent(in) :: src
    type(sidl_io_Serializable_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Se_ary_smartCopyems5xa_e2ysss_m
    dim = 7
    call Se_ary_smartCopyems5xa_e2ysss_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_io_Serializable_7d), intent(in)  :: array
    external ary_isColumnOrderu8lao_v_vwv8_m
    call ary_isColumnOrderu8lao_v_vwv8_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_io_Serializable_7d), intent(in)  :: array
    external S_ary_isRowOrdertjiv6tm2d82r__m
    call S_ary_isRowOrdertjiv6tm2d82r__m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_io_Serializable_7d), intent(in)  :: array
    external Serial_ary_dimenqgfo5vnn0uv5__m
    call Serial_ary_dimenqgfo5vnn0uv5__m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_stride4t8eijwfo_p0x_m
    call Seria_ary_stride4t8eijwfo_p0x_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_lowerqgmp_y38oxuk7_m
    call Serial_ary_lowerqgmp_y38oxuk7_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Serial_ary_upperf_83b9pzjnfll_m
    call Serial_ary_upperf_83b9pzjnfll_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Seria_ary_length6deinl4tlmtxk_m
    call Seria_ary_length6deinl4tlmtxk_m(array, index, length7_p)
  ...
  subroutine castsidl_io_Serialir0rfo5t1bt_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_io_Serializable_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_io_Serialir0rfo5t1bt_p

  subroutine castsidl_io_Serialijaz3ajuu0v_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_io_Serializable_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_io_Serialijaz3ajuu0v_p

  subroutine castsidl_io_Serialicq3qeiuh01_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_io_Serializable_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_io_Serialicq3qeiuh01_p

  subroutine castsidl_io_Serialiks009nw7f4_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_io_Serializable_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_io_Serialiks009nw7f4_p

  subroutine castsidl_io_Seriali_ebyypr9l3_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_io_Serializable_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_io_Seriali_ebyypr9l3_p

  subroutine castsidl_io_Serialixdl7k8uu1m_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_io_Serializable_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_io_Serialixdl7k8uu1m_p

  subroutine castsidl_io_Serialigur569zp8__p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_io_Serializable_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_io_Serialigur569zp8__p


end module sidl_io_Serializable_array
