! 
! File:          bHYPRE_SStructMatrixView.F90
...
module bHYPRE_SStructMatrixView
...
contains
  ...
  recursive subroutine SetGraph_s(self, graph, retval, exception)
    implicit none
    !  in bHYPRE.SStructMatrixView self
    type(bHYPRE_SStructMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_SStructMatrixView_SetGraph_m
    call bHYPRE_SStructMatrixView_SetGraph_m(self, graph, retval, exception)
  ...
  recursive subroutine SetValues_1s(self, part, index, var, entries, values,   &
    ...
    external bHYPRE_SStructMatrixView_SetValues_a
    call bHYPRE_SStructMatrixView_SetValues_a(self, part, index, var, entries, &
  ...
  recursive subroutine SetValues_2s(self, part, index, var, entries, values,   &
    ...
    external bHYPRE_SStructMatrixView_SetValues_m
    nentries = size(values, 1)
    dim = size(index, 1)
    call bHYPRE_SStructMatrixView_SetValues_m(self, part, index, dim, var,     &
  ...
  recursive subroutine SetBoxValues_1s(self, part, ilower, iupper, var,        &
    ...
    external bHYPRE_SStructMatrixView_SetBoxValues_a
    call bHYPRE_SStructMatrixView_SetBoxValues_a(self, part, ilower, iupper,   &
  ...
  recursive subroutine SetBoxValues_2s(self, part, ilower, iupper, var,        &
    ...
    external bHYPRE_SStructMatrixView_SetBoxValues_m
    nentries = size(entries, 1)
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_SStructMatrixView_SetBoxValues_m(self, part, ilower, iupper,   &
  ...
  recursive subroutine AddToValues_1s(self, part, index, var, entries, values, &
    ...
    external bHYPRE_SStructMatrixView_AddToValues_a
    call bHYPRE_SStructMatrixView_AddToValues_a(self, part, index, var,        &
      entries, values, retval, exception)
  ...
  recursive subroutine AddToValues_2s(self, part, index, var, entries, values, &
    ...
    external bHYPRE_SStructMatrixView_AddToValues_m
    nentries = size(values, 1)
    dim = size(index, 1)
    call bHYPRE_SStructMatrixView_AddToValues_m(self, part, index, dim, var,   &
      nentries, entries, values, retval, exception)
  ...
  recursive subroutine AddToBoxValues_1s(self, part, ilower, iupper, var,      &
    ...
    external bHYPRE_SStructMatrixView_AddToBoxValues_a
    call bHYPRE_SStructMatrixView_AddToBoxValues_a(self, part, ilower, iupper, &
      var, entries, values, retval, exception)
  ...
  recursive subroutine AddToBoxValues_2s(self, part, ilower, iupper, var,      &
    ...
    external bHYPRE_SStructMatrixView_AddToBoxValues_m
    nentries = size(entries, 1)
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_SStructMatrixView_AddToBoxValues_m(self, part, ilower, iupper, &
      dim, var, nentries, entries, values, nvalues, retval, exception)
  ...
  recursive subroutine SetSymmetric_s(self, part, var, to_var, symmetric,      &
    ...
    external bHYPRE_SStructMatrixView_SetSymmetric_m
    call bHYPRE_SStructMatrixView_SetSymmetric_m(self, part, var, to_var,      &
  ...
  recursive subroutine SetNSSymmetric_s(self, symmetric, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_SetNSSymmetric_m
    call bHYPRE_SStructMatrixView_SetNSSymmetric_m(self, symmetric, retval,    &
      exception)
  ...
  recursive subroutine SetComplex_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_SetComplex_m
    call bHYPRE_SStructMatrixView_SetComplex_m(self, retval, exception)
  ...
  recursive subroutine Print_s(self, filename, all, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_Print_m
    call bHYPRE_SStructMatrixView_Print_m(self, filename, all, retval,         &
      exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    type(bHYPRE_SStructMatrixView_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructMatrixView_rConnect_m
    call bHYPRE_SStructMatrixView_rConnect_m(self, url, exception)
  ...
  recursive subroutine GetObject_s(self, A, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_GetObject_m
    call bHYPRE_SStructMatrixView_GetObject_m(self, A, retval, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_SetCommunicator_m
    call bHYPRE_SStructMatrixView_SetCommunicator_m(self, mpi_comm, retval,    &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_SStructMatrixView_Destroy_m
    call bHYPRE_SStructMatrixView_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_Initialize_m
    call bHYPRE_SStructMatrixView_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_Assemble_m
    call bHYPRE_SStructMatrixView_Assemble_m(self, retval, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_SStructMatrixView_addRef_m
    call bHYPRE_SStructMatrixView_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_SStructMatrixView_deleteRef_m
    call bHYPRE_SStructMatrixView_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_isSame_m
    call bHYPRE_SStructMatrixView_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_isType_m
    call bHYPRE_SStructMatrixView_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixView_getClassInfo_m
    call bHYPRE_SStructMatrixView_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_SStructMatrixView__exec_m
    call bHYPRE_SStructMatrixView__exec_m(self, methodName, inArgs, outArgs,   &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixView__getURL_m
    call bHYPRE_SStructMatrixView__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixView__isRemote_m
    call bHYPRE_SStructMatrixView__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_SStructMatrixView__isLocal_m
    call bHYPRE_SStructMatrixView__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_SStructMatrixView__set_hooks_m
    call bHYPRE_SStructMatrixView__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_SStructMatrixView_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_SStructMatrixView_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_SStructMatrixView

module bHYPRE_SStructMatrixView_array
  use sidl
  use bHYPRE_SStructMatrixView_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructM290qrl6xr5_p, &
    castbHYPRE_SStructMqh6k209a_7_p, &
    castbHYPRE_SStructM8518p118fb_p, &
    castbHYPRE_SStructMc3wnigfl9t_p, &
    castbHYPRE_SStructMa3jei7_wgt_p, &
    castbHYPRE_SStructMqhblrpl2ee_p, &
    castbHYPRE_SStructM044675jd2y_p
interface cast
  module procedure &
    castbHYPRE_SStructM290qrl6xr5_p, &
    castbHYPRE_SStructMqh6k209a_7_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_1d), intent(out) :: array
    external SS_ary_createCol4_i9ri1pq2ky__m
    call SS_ary_createCol4_i9ri1pq2ky__m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_SStructMatrixView_1d), intent(out) :: array
    external SS_ary_createRowg4h8kehymu7eb_m
    call SS_ary_createRowg4h8kehymu7eb_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_SStructMatrixView_1d), intent(out) :: array
    external SSt_ary_create1d5no4auvb8kl_l_m
    call SSt_ary_create1d5no4auvb8kl_l_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructMatrixView_1d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_1d), intent(in) :: dest
    external SStruct_ary_copyavx915rndtlmq_m
    call SStruct_ary_copyavx915rndtlmq_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: src
    type(bHYPRE_SStructMatrixView_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureh1q6a6izoqe5o_m
    call SStru_ary_ensureh1q6a6izoqe5o_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external SStruc_ary_slice9qtpilm10swvv_m
    call SStruc_ary_slice9qtpilm10swvv_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructMatrixView_t), intent(out) :: value
    external SStructM_ary_getma8m30e1drpqx_m
    call SStructM_ary_getma8m30e1drpqx_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructMatrixView_t), intent(in) :: value
    external SStructM_ary_setvhcgyug4i2hkt_m
    call SStructM_ary_setvhcgyug4i2hkt_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_SStructMatrixView_t), intent(out) :: value
    external SStruct_ary_get1jufh3jxj_b1qi_m
    call SStruct_ary_get1jufh3jxj_b1qi_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_SStructMatrixView_t), intent(in) :: value
    external SStruct_ary_set14jd8jlfxkov8y_m
    call SStruct_ary_set14jd8jlfxkov8y_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructMatrixView_1d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyhsz7qwoybp0j9_m
    dim = 1
    call SS_ary_smartCopyhsz7qwoybp0j9_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    external ary_isColumnOrdert3gxmjjxlc8z_m
    call ary_isColumnOrdert3gxmjjxlc8z_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    external S_ary_isRowOrder9knq3jdk1voxl_m
    call S_ary_isRowOrder9knq3jdk1voxl_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    external SStruc_ary_dimenanh783m_dzifo_m
    call SStruc_ary_dimenanh783m_dzifo_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride7c89fhf3wnfks_m
    call SStru_ary_stride7c89fhf3wnfks_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower8qidaxmsy225m_m
    call SStruc_ary_lower8qidaxmsy225m_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper2pm206kpw7_0f_m
    call SStruc_ary_upper2pm206kpw7_0f_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthwo_7g9zffhhtu_m
    call SStru_ary_lengthwo_7g9zffhhtu_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    external SStru_ary_addRefg3anxcqyxvb_z_m
    call SStru_ary_addRefg3anxcqyxvb_z_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_SStructMatrixView_1d), intent(in)  :: array
    external SS_ary_deleteRefw3ti7l98uhfu3_m
    call SS_ary_deleteRefw3ti7l98uhfu3_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_2d), intent(out) :: array
    external SS_ary_createCol4_i9ri1pq2ky__m
    call SS_ary_createCol4_i9ri1pq2ky__m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_2d), intent(out) :: array
    external SS_ary_createRowg4h8kehymu7eb_m
    call SS_ary_createRowg4h8kehymu7eb_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructMatrixView_2d), intent(out) :: array
    external ary_create2dColrvu0epu1z31vv5_m
    call ary_create2dColrvu0epu1z31vv5_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructMatrixView_2d), intent(out) :: array
    external ary_create2dRow_gg7j95lft6l57_m
    call ary_create2dRow_gg7j95lft6l57_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructMatrixView_2d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_2d), intent(in) :: dest
    external SStruct_ary_copyavx915rndtlmq_m
    call SStruct_ary_copyavx915rndtlmq_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixView_2d), intent(in)  :: src
    type(bHYPRE_SStructMatrixView_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureh1q6a6izoqe5o_m
    call SStru_ary_ensureh1q6a6izoqe5o_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9qtpilm10swvv_m
    call SStruc_ary_slice9qtpilm10swvv_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructMatrixView_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_SStructMatrixView_t), intent(out) :: value
    external SStruct_ary_get26h35zqk1rwxi4_m
    call SStruct_ary_get26h35zqk1rwxi4_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_SStructMatrixView_t), intent(in) :: value
    external SStruct_ary_set22w4cbey1wz46u_m
    call SStruct_ary_set22w4cbey1wz46u_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructMatrixView_2d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyhsz7qwoybp0j9_m
    dim = 2
    call SS_ary_smartCopyhsz7qwoybp0j9_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_SStructMatrixView_2d), intent(in)  :: array
    external ary_isColumnOrdert3gxmjjxlc8z_m
    call ary_isColumnOrdert3gxmjjxlc8z_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_SStructMatrixView_2d), intent(in)  :: array
    external S_ary_isRowOrder9knq3jdk1voxl_m
    call S_ary_isRowOrder9knq3jdk1voxl_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_SStructMatrixView_2d), intent(in)  :: array
    external SStruc_ary_dimenanh783m_dzifo_m
    call SStruc_ary_dimenanh783m_dzifo_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride7c89fhf3wnfks_m
    call SStru_ary_stride7c89fhf3wnfks_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower8qidaxmsy225m_m
    call SStruc_ary_lower8qidaxmsy225m_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper2pm206kpw7_0f_m
    call SStruc_ary_upper2pm206kpw7_0f_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthwo_7g9zffhhtu_m
    call SStru_ary_lengthwo_7g9zffhhtu_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_3d), intent(out) :: array
    external SS_ary_createCol4_i9ri1pq2ky__m
    call SS_ary_createCol4_i9ri1pq2ky__m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_3d), intent(out) :: array
    external SS_ary_createRowg4h8kehymu7eb_m
    call SS_ary_createRowg4h8kehymu7eb_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructMatrixView_3d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_3d), intent(in) :: dest
    external SStruct_ary_copyavx915rndtlmq_m
    call SStruct_ary_copyavx915rndtlmq_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixView_3d), intent(in)  :: src
    type(bHYPRE_SStructMatrixView_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureh1q6a6izoqe5o_m
    call SStru_ary_ensureh1q6a6izoqe5o_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9qtpilm10swvv_m
    call SStruc_ary_slice9qtpilm10swvv_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructMatrixView_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_SStructMatrixView_t), intent(out) :: value
    external SStruct_ary_get3nzw9t5uq9gylu_m
    call SStruct_ary_get3nzw9t5uq9gylu_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_SStructMatrixView_t), intent(in) :: value
    external SStruct_ary_set3rw2nxpe_mi40g_m
    call SStruct_ary_set3rw2nxpe_mi40g_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructMatrixView_3d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyhsz7qwoybp0j9_m
    dim = 3
    call SS_ary_smartCopyhsz7qwoybp0j9_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_SStructMatrixView_3d), intent(in)  :: array
    external ary_isColumnOrdert3gxmjjxlc8z_m
    call ary_isColumnOrdert3gxmjjxlc8z_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_SStructMatrixView_3d), intent(in)  :: array
    external S_ary_isRowOrder9knq3jdk1voxl_m
    call S_ary_isRowOrder9knq3jdk1voxl_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_SStructMatrixView_3d), intent(in)  :: array
    external SStruc_ary_dimenanh783m_dzifo_m
    call SStruc_ary_dimenanh783m_dzifo_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride7c89fhf3wnfks_m
    call SStru_ary_stride7c89fhf3wnfks_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower8qidaxmsy225m_m
    call SStruc_ary_lower8qidaxmsy225m_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper2pm206kpw7_0f_m
    call SStruc_ary_upper2pm206kpw7_0f_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthwo_7g9zffhhtu_m
    call SStru_ary_lengthwo_7g9zffhhtu_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_4d), intent(out) :: array
    external SS_ary_createCol4_i9ri1pq2ky__m
    call SS_ary_createCol4_i9ri1pq2ky__m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_4d), intent(out) :: array
    external SS_ary_createRowg4h8kehymu7eb_m
    call SS_ary_createRowg4h8kehymu7eb_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructMatrixView_4d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_4d), intent(in) :: dest
    external SStruct_ary_copyavx915rndtlmq_m
    call SStruct_ary_copyavx915rndtlmq_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixView_4d), intent(in)  :: src
    type(bHYPRE_SStructMatrixView_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureh1q6a6izoqe5o_m
    call SStru_ary_ensureh1q6a6izoqe5o_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9qtpilm10swvv_m
    call SStruc_ary_slice9qtpilm10swvv_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructMatrixView_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_SStructMatrixView_t), intent(out) :: value
    external SStruct_ary_get4r1b00uia57li1_m
    call SStruct_ary_get4r1b00uia57li1_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_SStructMatrixView_t), intent(in) :: value
    external SStruct_ary_set42c2_1j_huew8h_m
    call SStruct_ary_set42c2_1j_huew8h_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructMatrixView_4d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyhsz7qwoybp0j9_m
    dim = 4
    call SS_ary_smartCopyhsz7qwoybp0j9_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_SStructMatrixView_4d), intent(in)  :: array
    external ary_isColumnOrdert3gxmjjxlc8z_m
    call ary_isColumnOrdert3gxmjjxlc8z_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_SStructMatrixView_4d), intent(in)  :: array
    external S_ary_isRowOrder9knq3jdk1voxl_m
    call S_ary_isRowOrder9knq3jdk1voxl_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_SStructMatrixView_4d), intent(in)  :: array
    external SStruc_ary_dimenanh783m_dzifo_m
    call SStruc_ary_dimenanh783m_dzifo_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride7c89fhf3wnfks_m
    call SStru_ary_stride7c89fhf3wnfks_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower8qidaxmsy225m_m
    call SStruc_ary_lower8qidaxmsy225m_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper2pm206kpw7_0f_m
    call SStruc_ary_upper2pm206kpw7_0f_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthwo_7g9zffhhtu_m
    call SStru_ary_lengthwo_7g9zffhhtu_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_5d), intent(out) :: array
    external SS_ary_createCol4_i9ri1pq2ky__m
    call SS_ary_createCol4_i9ri1pq2ky__m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_5d), intent(out) :: array
    external SS_ary_createRowg4h8kehymu7eb_m
    call SS_ary_createRowg4h8kehymu7eb_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructMatrixView_5d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_5d), intent(in) :: dest
    external SStruct_ary_copyavx915rndtlmq_m
    call SStruct_ary_copyavx915rndtlmq_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixView_5d), intent(in)  :: src
    type(bHYPRE_SStructMatrixView_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureh1q6a6izoqe5o_m
    call SStru_ary_ensureh1q6a6izoqe5o_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9qtpilm10swvv_m
    call SStruc_ary_slice9qtpilm10swvv_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructMatrixView_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_SStructMatrixView_t), intent(out) :: value
    external SStruct_ary_get5tsna_oz8bixem_m
    call SStruct_ary_get5tsna_oz8bixem_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_SStructMatrixView_t), intent(in) :: value
    external SStruct_ary_set5otrinysl4v43s_m
    call SStruct_ary_set5otrinysl4v43s_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructMatrixView_5d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyhsz7qwoybp0j9_m
    dim = 5
    call SS_ary_smartCopyhsz7qwoybp0j9_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_SStructMatrixView_5d), intent(in)  :: array
    external ary_isColumnOrdert3gxmjjxlc8z_m
    call ary_isColumnOrdert3gxmjjxlc8z_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_SStructMatrixView_5d), intent(in)  :: array
    external S_ary_isRowOrder9knq3jdk1voxl_m
    call S_ary_isRowOrder9knq3jdk1voxl_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_SStructMatrixView_5d), intent(in)  :: array
    external SStruc_ary_dimenanh783m_dzifo_m
    call SStruc_ary_dimenanh783m_dzifo_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride7c89fhf3wnfks_m
    call SStru_ary_stride7c89fhf3wnfks_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower8qidaxmsy225m_m
    call SStruc_ary_lower8qidaxmsy225m_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper2pm206kpw7_0f_m
    call SStruc_ary_upper2pm206kpw7_0f_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthwo_7g9zffhhtu_m
    call SStru_ary_lengthwo_7g9zffhhtu_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_6d), intent(out) :: array
    external SS_ary_createCol4_i9ri1pq2ky__m
    call SS_ary_createCol4_i9ri1pq2ky__m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_6d), intent(out) :: array
    external SS_ary_createRowg4h8kehymu7eb_m
    call SS_ary_createRowg4h8kehymu7eb_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructMatrixView_6d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_6d), intent(in) :: dest
    external SStruct_ary_copyavx915rndtlmq_m
    call SStruct_ary_copyavx915rndtlmq_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixView_6d), intent(in)  :: src
    type(bHYPRE_SStructMatrixView_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureh1q6a6izoqe5o_m
    call SStru_ary_ensureh1q6a6izoqe5o_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9qtpilm10swvv_m
    call SStruc_ary_slice9qtpilm10swvv_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructMatrixView_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_SStructMatrixView_t), intent(out) :: value
    external SStruct_ary_get6luge4kp5iuqrp_m
    call SStruct_ary_get6luge4kp5iuqrp_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_SStructMatrixView_t), intent(in) :: value
    external SStruct_ary_set6smk5kp51i3rff_m
    call SStruct_ary_set6smk5kp51i3rff_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructMatrixView_6d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyhsz7qwoybp0j9_m
    dim = 6
    call SS_ary_smartCopyhsz7qwoybp0j9_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_SStructMatrixView_6d), intent(in)  :: array
    external ary_isColumnOrdert3gxmjjxlc8z_m
    call ary_isColumnOrdert3gxmjjxlc8z_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_SStructMatrixView_6d), intent(in)  :: array
    external S_ary_isRowOrder9knq3jdk1voxl_m
    call S_ary_isRowOrder9knq3jdk1voxl_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_SStructMatrixView_6d), intent(in)  :: array
    external SStruc_ary_dimenanh783m_dzifo_m
    call SStruc_ary_dimenanh783m_dzifo_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride7c89fhf3wnfks_m
    call SStru_ary_stride7c89fhf3wnfks_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower8qidaxmsy225m_m
    call SStruc_ary_lower8qidaxmsy225m_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper2pm206kpw7_0f_m
    call SStruc_ary_upper2pm206kpw7_0f_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthwo_7g9zffhhtu_m
    call SStru_ary_lengthwo_7g9zffhhtu_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_7d), intent(out) :: array
    external SS_ary_createCol4_i9ri1pq2ky__m
    call SS_ary_createCol4_i9ri1pq2ky__m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructMatrixView_7d), intent(out) :: array
    external SS_ary_createRowg4h8kehymu7eb_m
    call SS_ary_createRowg4h8kehymu7eb_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructMatrixView_7d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_7d), intent(in) :: dest
    external SStruct_ary_copyavx915rndtlmq_m
    call SStruct_ary_copyavx915rndtlmq_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructMatrixView_7d), intent(in)  :: src
    type(bHYPRE_SStructMatrixView_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensureh1q6a6izoqe5o_m
    call SStru_ary_ensureh1q6a6izoqe5o_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slice9qtpilm10swvv_m
    call SStruc_ary_slice9qtpilm10swvv_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructMatrixView_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_SStructMatrixView_t), intent(out) :: value
    external SStruct_ary_get714y363q519ko8_m
    call SStruct_ary_get714y363q519ko8_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_SStructMatrixView_t), intent(in) :: value
    external SStruct_ary_set7xnxj6r6f2vdo6_m
    call SStruct_ary_set7xnxj6r6f2vdo6_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructMatrixView_7d), intent(in) :: src
    type(bHYPRE_SStructMatrixView_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopyhsz7qwoybp0j9_m
    dim = 7
    call SS_ary_smartCopyhsz7qwoybp0j9_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_SStructMatrixView_7d), intent(in)  :: array
    external ary_isColumnOrdert3gxmjjxlc8z_m
    call ary_isColumnOrdert3gxmjjxlc8z_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_SStructMatrixView_7d), intent(in)  :: array
    external S_ary_isRowOrder9knq3jdk1voxl_m
    call S_ary_isRowOrder9knq3jdk1voxl_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_SStructMatrixView_7d), intent(in)  :: array
    external SStruc_ary_dimenanh783m_dzifo_m
    call SStruc_ary_dimenanh783m_dzifo_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride7c89fhf3wnfks_m
    call SStru_ary_stride7c89fhf3wnfks_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lower8qidaxmsy225m_m
    call SStruc_ary_lower8qidaxmsy225m_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_upper2pm206kpw7_0f_m
    call SStruc_ary_upper2pm206kpw7_0f_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_lengthwo_7g9zffhhtu_m
    call SStru_ary_lengthwo_7g9zffhhtu_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_SStructM290qrl6xr5_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixView_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructM290qrl6xr5_p

  subroutine castbHYPRE_SStructMqh6k209a_7_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixView_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructMqh6k209a_7_p

  subroutine castbHYPRE_SStructM8518p118fb_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixView_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructM8518p118fb_p

  subroutine castbHYPRE_SStructMc3wnigfl9t_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixView_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructMc3wnigfl9t_p

  subroutine castbHYPRE_SStructMa3jei7_wgt_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixView_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructMa3jei7_wgt_p

  subroutine castbHYPRE_SStructMqhblrpl2ee_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixView_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructMqhblrpl2ee_p

  subroutine castbHYPRE_SStructM044675jd2y_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructMatrixView_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructM044675jd2y_p


end module bHYPRE_SStructMatrixView_array
