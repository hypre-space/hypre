! 
! File:          bHYPRE_ParCSRDiagScale.F90
...
module bHYPRE_ParCSRDiagScale

  use sidl
  use bHYPRE_Solver_type
  use bHYPRE_ParCSRDiagScale_type
...
interface bHYPRE_ParCSRDiagScale__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(mpi_comm, A, retval, exception)
    ...
    !  out bHYPRE.ParCSRDiagScale retval
    type(bHYPRE_ParCSRDiagScale_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_ParCSRDiagScale_Create_m
    call bHYPRE_ParCSRDiagScale_Create_m(mpi_comm, A, retval, exception)
  ...
  recursive subroutine SetOperator_s(self, A, retval, exception)
    implicit none
    !  in bHYPRE.ParCSRDiagScale self
    type(bHYPRE_ParCSRDiagScale_t) , intent(in) :: self
    ...
    external bHYPRE_ParCSRDiagScale_SetOperator_m
    call bHYPRE_ParCSRDiagScale_SetOperator_m(self, A, retval, exception)
  ...
  recursive subroutine SetTolerance_s(self, tolerance, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_SetTolerance_m
    call bHYPRE_ParCSRDiagScale_SetTolerance_m(self, tolerance, retval,        &
      exception)
  ...
  recursive subroutine SetMaxIterations_s(self, max_iterations, retval,        &
    ...
    external bHYPRE_ParCSRDiagScale_SetMaxIterations_m
    call bHYPRE_ParCSRDiagScale_SetMaxIterations_m(self, max_iterations,       &
      retval, exception)
  ...
  recursive subroutine SetLogging_s(self, level, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_SetLogging_m
    call bHYPRE_ParCSRDiagScale_SetLogging_m(self, level, retval, exception)
  ...
  recursive subroutine SetPrintLevel_s(self, level, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_SetPrintLevel_m
    call bHYPRE_ParCSRDiagScale_SetPrintLevel_m(self, level, retval,           &
      exception)
  ...
  recursive subroutine GetNumIterations_s(self, num_iterations, retval,        &
    ...
    external bHYPRE_ParCSRDiagScale_GetNumIterations_m
    call bHYPRE_ParCSRDiagScale_GetNumIterations_m(self, num_iterations,       &
      retval, exception)
  ...
  recursive subroutine GetRelResidualNorm_s(self, norm, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_GetRelResidualNorm_m
    call bHYPRE_ParCSRDiagScale_GetRelResidualNorm_m(self, norm, retval,       &
      exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_SetCommunicator_m
    call bHYPRE_ParCSRDiagScale_SetCommunicator_m(self, mpi_comm, retval,      &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_ParCSRDiagScale_Destroy_m
    call bHYPRE_ParCSRDiagScale_Destroy_m(self, exception)
  ...
  recursive subroutine SetIntParameter_s(self, name, value, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_SetIntParameter_m
    call bHYPRE_ParCSRDiagScale_SetIntParameter_m(self, name, value, retval,   &
      exception)
  ...
  recursive subroutine SetDoubleParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_ParCSRDiagScale_SetDoubleParameter_m
    call bHYPRE_ParCSRDiagScale_SetDoubleParameter_m(self, name, value,        &
      retval, exception)
  ...
  recursive subroutine SetStringParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_ParCSRDiagScale_SetStringParameter_m
    call bHYPRE_ParCSRDiagScale_SetStringParameter_m(self, name, value,        &
      retval, exception)
  ...
  recursive subroutine SetIntArray1Parameter_1s(self, name, value, retval,     &
    ...
    external bHYPRE_ParCSRDiagScale_SetIntArray1Parameter_a
    call bHYPRE_ParCSRDiagScale_SetIntArray1Parameter_a(self, name, value,     &
      retval, exception)
  ...
  recursive subroutine SetIntArray1Parameter_2s(self, name, value, retval,     &
    ...
    external bHYPRE_ParCSRDiagScale_SetIntArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_ParCSRDiagScale_SetIntArray1Parameter_m(self, name, value,     &
  ...
  recursive subroutine SetIntArray2Parameter_s(self, name, value, retval,      &
    ...
    external bHYPRE_ParCSRDiagScale_SetIntArray2Parameter_m
    call bHYPRE_ParCSRDiagScale_SetIntArray2Parameter_m(self, name, value,     &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_1s(self, name, value, retval,  &
    ...
    external bHYPRE_ParCSRDiagScale_SetDoubleArray1Parameter_a
    call bHYPRE_ParCSRDiagScale_SetDoubleArray1Parameter_a(self, name, value,  &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_2s(self, name, value, retval,  &
    ...
    external bHYPRE_ParCSRDiagScale_SetDoubleArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_ParCSRDiagScale_SetDoubleArray1Parameter_m(self, name, value,  &
      nvalues, retval, exception)
  ...
  recursive subroutine SetDoubleArray2Parameter_s(self, name, value, retval,   &
    ...
    external bHYPRE_ParCSRDiagScale_SetDoubleArray2Parameter_m
    call bHYPRE_ParCSRDiagScale_SetDoubleArray2Parameter_m(self, name, value,  &
      retval, exception)
  ...
  recursive subroutine GetIntValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_GetIntValue_m
    call bHYPRE_ParCSRDiagScale_GetIntValue_m(self, name, value, retval,       &
      exception)
  ...
  recursive subroutine GetDoubleValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_GetDoubleValue_m
    call bHYPRE_ParCSRDiagScale_GetDoubleValue_m(self, name, value, retval,    &
      exception)
  ...
  recursive subroutine Setup_s(self, b, x, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_Setup_m
    call bHYPRE_ParCSRDiagScale_Setup_m(self, b, x, retval, exception)
  ...
  recursive subroutine Apply_s(self, b, x, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_Apply_m
    call bHYPRE_ParCSRDiagScale_Apply_m(self, b, x, retval, exception)
  ...
  recursive subroutine ApplyAdjoint_s(self, b, x, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_ApplyAdjoint_m
    call bHYPRE_ParCSRDiagScale_ApplyAdjoint_m(self, b, x, retval, exception)
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_newLocal_m
    call bHYPRE_ParCSRDiagScale_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    implicit none
    !  out bHYPRE.ParCSRDiagScale self
    type(bHYPRE_ParCSRDiagScale_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_ParCSRDiagScale_newRemote_m
    call bHYPRE_ParCSRDiagScale_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_ParCSRDiagScale_rConnect_m
    call bHYPRE_ParCSRDiagScale_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_ParCSRDiagScale_addRef_m
    call bHYPRE_ParCSRDiagScale_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_ParCSRDiagScale_deleteRef_m
    call bHYPRE_ParCSRDiagScale_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_isSame_m
    call bHYPRE_ParCSRDiagScale_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_isType_m
    call bHYPRE_ParCSRDiagScale_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale_getClassInfo_m
    call bHYPRE_ParCSRDiagScale_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.ParCSRDiagScale
  ! to bHYPRE.Operator.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: oldType
  ...
  ! to bHYPRE.ParCSRDiagScale.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_Operator_t), intent(in) :: oldType
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_ParCSRDiagScale__cast_m

    call bHYPRE_ParCSRDiagScale__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_ParCSRDiagScale__exec_m
    call bHYPRE_ParCSRDiagScale__exec_m(self, methodName, inArgs, outArgs,     &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale__getURL_m
    call bHYPRE_ParCSRDiagScale__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale__isRemote_m
    call bHYPRE_ParCSRDiagScale__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_ParCSRDiagScale__isLocal_m
    call bHYPRE_ParCSRDiagScale__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_ParCSRDiagScale__set_hooks_m
    call bHYPRE_ParCSRDiagScale__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_ParCSRDiagScale__set_hooks_static_m
    call bHYPRE_ParCSRDiagScale__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_ParCSRDiagScale

module bHYPRE_ParCSRDiagScale_array
  use sidl
  use bHYPRE_ParCSRDiagScale_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_ParCSRDiaayoxwltz1_p, &
    castbHYPRE_ParCSRDimr4um_5nw4_p, &
    castbHYPRE_ParCSRDi128yq852uu_p, &
    castbHYPRE_ParCSRDi9he_r4cum1_p, &
    castbHYPRE_ParCSRDidyndznme9g_p, &
    castbHYPRE_ParCSRDi9ri6ubdvbi_p, &
    castbHYPRE_ParCSRDiz9kyqo2hnd_p
interface cast
  module procedure &
    castbHYPRE_ParCSRDiaayoxwltz1_p, &
    castbHYPRE_ParCSRDimr4um_5nw4_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_1d), intent(out) :: array
    external Pa_ary_createCol4xgw3dcxtiuzv_m
    call Pa_ary_createCol4xgw3dcxtiuzv_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_ParCSRDiagScale_1d), intent(out) :: array
    external Pa_ary_createRow9ecbyuxdlhu67_m
    call Pa_ary_createRow9ecbyuxdlhu67_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_ParCSRDiagScale_1d), intent(out) :: array
    external Par_ary_create1drncgaej9bac5w_m
    call Par_ary_create1drncgaej9bac5w_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_1d), intent(in) :: dest
    external ParCSRD_ary_copyip3rn_btoonwu_m
    call ParCSRD_ary_copyip3rn_btoonwu_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: src
    type(bHYPRE_ParCSRDiagScale_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external ParCS_ary_ensurecu6gualwt28gw_m
    call ParCS_ary_ensurecu6gualwt28gw_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external ParCSR_ary_slicebtmtajf464d5d_m
    call ParCSR_ary_slicebtmtajf464d5d_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: value
    external ParCSRDi_ary_get8h_vi5b86ejov_m
    call ParCSRDi_ary_get8h_vi5b86ejov_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: value
    external ParCSRDi_ary_set6yeanvttu5ln4_m
    call ParCSRDi_ary_set6yeanvttu5ln4_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: value
    external ParCSRD_ary_get1r1f3rzlen54ll_m
    call ParCSRD_ary_get1r1f3rzlen54ll_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: value
    external ParCSRD_ary_set1wizhwrssvg9d8_m
    call ParCSRD_ary_set1wizhwrssvg9d8_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pa_ary_smartCopyvba8i8wgp94cr_m
    dim = 1
    call Pa_ary_smartCopyvba8i8wgp94cr_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    external ary_isColumnOrderctpbiz_tn6cu_m
    call ary_isColumnOrderctpbiz_tn6cu_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    external P_ary_isRowOrderpkjahghiotdzs_m
    call P_ary_isRowOrderpkjahghiotdzs_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    external ParCSR_ary_dimensz9e_omluv3u6_m
    call ParCSR_ary_dimensz9e_omluv3u6_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_stride642pkq6nsuv98_m
    call ParCS_ary_stride642pkq6nsuv98_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_loweri2ofmmootrn63_m
    call ParCSR_ary_loweri2ofmmootrn63_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_upperrit0danmdfzct_m
    call ParCSR_ary_upperrit0danmdfzct_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_lengthnrhrxrnl18cnl_m
    call ParCS_ary_lengthnrhrxrnl18cnl_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    external ParCS_ary_addRef0835979djeioq_m
    call ParCS_ary_addRef0835979djeioq_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_ParCSRDiagScale_1d), intent(in)  :: array
    external Pa_ary_deleteRefy0etertmb56c7_m
    call Pa_ary_deleteRefy0etertmb56c7_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_2d), intent(out) :: array
    external Pa_ary_createCol4xgw3dcxtiuzv_m
    call Pa_ary_createCol4xgw3dcxtiuzv_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_2d), intent(out) :: array
    external Pa_ary_createRow9ecbyuxdlhu67_m
    call Pa_ary_createRow9ecbyuxdlhu67_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_ParCSRDiagScale_2d), intent(out) :: array
    external ary_create2dCol_c1nitos4u8gdg_m
    call ary_create2dCol_c1nitos4u8gdg_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_ParCSRDiagScale_2d), intent(out) :: array
    external ary_create2dRowsf2viqaorw7slv_m
    call ary_create2dRowsf2viqaorw7slv_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_2d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_2d), intent(in) :: dest
    external ParCSRD_ary_copyip3rn_btoonwu_m
    call ParCSRD_ary_copyip3rn_btoonwu_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_ParCSRDiagScale_2d), intent(in)  :: src
    type(bHYPRE_ParCSRDiagScale_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external ParCS_ary_ensurecu6gualwt28gw_m
    call ParCS_ary_ensurecu6gualwt28gw_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ParCSR_ary_slicebtmtajf464d5d_m
    call ParCSR_ary_slicebtmtajf464d5d_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_ParCSRDiagScale_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: value
    external ParCSRD_ary_get2i0gkndkq_tlbm_m
    call ParCSRD_ary_get2i0gkndkq_tlbm_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: value
    external ParCSRD_ary_set2ouhnxyij63tlt_m
    call ParCSRD_ary_set2ouhnxyij63tlt_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_2d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pa_ary_smartCopyvba8i8wgp94cr_m
    dim = 2
    call Pa_ary_smartCopyvba8i8wgp94cr_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_ParCSRDiagScale_2d), intent(in)  :: array
    external ary_isColumnOrderctpbiz_tn6cu_m
    call ary_isColumnOrderctpbiz_tn6cu_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_ParCSRDiagScale_2d), intent(in)  :: array
    external P_ary_isRowOrderpkjahghiotdzs_m
    call P_ary_isRowOrderpkjahghiotdzs_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_ParCSRDiagScale_2d), intent(in)  :: array
    external ParCSR_ary_dimensz9e_omluv3u6_m
    call ParCSR_ary_dimensz9e_omluv3u6_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_stride642pkq6nsuv98_m
    call ParCS_ary_stride642pkq6nsuv98_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_loweri2ofmmootrn63_m
    call ParCSR_ary_loweri2ofmmootrn63_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_upperrit0danmdfzct_m
    call ParCSR_ary_upperrit0danmdfzct_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_lengthnrhrxrnl18cnl_m
    call ParCS_ary_lengthnrhrxrnl18cnl_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_3d), intent(out) :: array
    external Pa_ary_createCol4xgw3dcxtiuzv_m
    call Pa_ary_createCol4xgw3dcxtiuzv_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_3d), intent(out) :: array
    external Pa_ary_createRow9ecbyuxdlhu67_m
    call Pa_ary_createRow9ecbyuxdlhu67_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_3d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_3d), intent(in) :: dest
    external ParCSRD_ary_copyip3rn_btoonwu_m
    call ParCSRD_ary_copyip3rn_btoonwu_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_ParCSRDiagScale_3d), intent(in)  :: src
    type(bHYPRE_ParCSRDiagScale_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external ParCS_ary_ensurecu6gualwt28gw_m
    call ParCS_ary_ensurecu6gualwt28gw_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ParCSR_ary_slicebtmtajf464d5d_m
    call ParCSR_ary_slicebtmtajf464d5d_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_ParCSRDiagScale_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: value
    external ParCSRD_ary_get3m42jjzw44n2o4_m
    call ParCSRD_ary_get3m42jjzw44n2o4_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: value
    external ParCSRD_ary_set3nv13ass1apv7v_m
    call ParCSRD_ary_set3nv13ass1apv7v_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_3d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pa_ary_smartCopyvba8i8wgp94cr_m
    dim = 3
    call Pa_ary_smartCopyvba8i8wgp94cr_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_ParCSRDiagScale_3d), intent(in)  :: array
    external ary_isColumnOrderctpbiz_tn6cu_m
    call ary_isColumnOrderctpbiz_tn6cu_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_ParCSRDiagScale_3d), intent(in)  :: array
    external P_ary_isRowOrderpkjahghiotdzs_m
    call P_ary_isRowOrderpkjahghiotdzs_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_ParCSRDiagScale_3d), intent(in)  :: array
    external ParCSR_ary_dimensz9e_omluv3u6_m
    call ParCSR_ary_dimensz9e_omluv3u6_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_stride642pkq6nsuv98_m
    call ParCS_ary_stride642pkq6nsuv98_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_loweri2ofmmootrn63_m
    call ParCSR_ary_loweri2ofmmootrn63_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_upperrit0danmdfzct_m
    call ParCSR_ary_upperrit0danmdfzct_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_lengthnrhrxrnl18cnl_m
    call ParCS_ary_lengthnrhrxrnl18cnl_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_4d), intent(out) :: array
    external Pa_ary_createCol4xgw3dcxtiuzv_m
    call Pa_ary_createCol4xgw3dcxtiuzv_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_4d), intent(out) :: array
    external Pa_ary_createRow9ecbyuxdlhu67_m
    call Pa_ary_createRow9ecbyuxdlhu67_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_4d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_4d), intent(in) :: dest
    external ParCSRD_ary_copyip3rn_btoonwu_m
    call ParCSRD_ary_copyip3rn_btoonwu_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_ParCSRDiagScale_4d), intent(in)  :: src
    type(bHYPRE_ParCSRDiagScale_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external ParCS_ary_ensurecu6gualwt28gw_m
    call ParCS_ary_ensurecu6gualwt28gw_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ParCSR_ary_slicebtmtajf464d5d_m
    call ParCSR_ary_slicebtmtajf464d5d_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_ParCSRDiagScale_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: value
    external ParCSRD_ary_get4b3fbz40j0si_x_m
    call ParCSRD_ary_get4b3fbz40j0si_x_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: value
    external ParCSRD_ary_set474553i__24758_m
    call ParCSRD_ary_set474553i__24758_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_4d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pa_ary_smartCopyvba8i8wgp94cr_m
    dim = 4
    call Pa_ary_smartCopyvba8i8wgp94cr_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_ParCSRDiagScale_4d), intent(in)  :: array
    external ary_isColumnOrderctpbiz_tn6cu_m
    call ary_isColumnOrderctpbiz_tn6cu_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_ParCSRDiagScale_4d), intent(in)  :: array
    external P_ary_isRowOrderpkjahghiotdzs_m
    call P_ary_isRowOrderpkjahghiotdzs_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_ParCSRDiagScale_4d), intent(in)  :: array
    external ParCSR_ary_dimensz9e_omluv3u6_m
    call ParCSR_ary_dimensz9e_omluv3u6_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_stride642pkq6nsuv98_m
    call ParCS_ary_stride642pkq6nsuv98_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_loweri2ofmmootrn63_m
    call ParCSR_ary_loweri2ofmmootrn63_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_upperrit0danmdfzct_m
    call ParCSR_ary_upperrit0danmdfzct_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_lengthnrhrxrnl18cnl_m
    call ParCS_ary_lengthnrhrxrnl18cnl_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_5d), intent(out) :: array
    external Pa_ary_createCol4xgw3dcxtiuzv_m
    call Pa_ary_createCol4xgw3dcxtiuzv_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_5d), intent(out) :: array
    external Pa_ary_createRow9ecbyuxdlhu67_m
    call Pa_ary_createRow9ecbyuxdlhu67_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_5d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_5d), intent(in) :: dest
    external ParCSRD_ary_copyip3rn_btoonwu_m
    call ParCSRD_ary_copyip3rn_btoonwu_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_ParCSRDiagScale_5d), intent(in)  :: src
    type(bHYPRE_ParCSRDiagScale_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external ParCS_ary_ensurecu6gualwt28gw_m
    call ParCS_ary_ensurecu6gualwt28gw_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ParCSR_ary_slicebtmtajf464d5d_m
    call ParCSR_ary_slicebtmtajf464d5d_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_ParCSRDiagScale_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: value
    external ParCSRD_ary_get5_7itof859usye_m
    call ParCSRD_ary_get5_7itof859usye_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: value
    external ParCSRD_ary_set5ypgp9y0oi2f6g_m
    call ParCSRD_ary_set5ypgp9y0oi2f6g_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_5d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pa_ary_smartCopyvba8i8wgp94cr_m
    dim = 5
    call Pa_ary_smartCopyvba8i8wgp94cr_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_ParCSRDiagScale_5d), intent(in)  :: array
    external ary_isColumnOrderctpbiz_tn6cu_m
    call ary_isColumnOrderctpbiz_tn6cu_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_ParCSRDiagScale_5d), intent(in)  :: array
    external P_ary_isRowOrderpkjahghiotdzs_m
    call P_ary_isRowOrderpkjahghiotdzs_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_ParCSRDiagScale_5d), intent(in)  :: array
    external ParCSR_ary_dimensz9e_omluv3u6_m
    call ParCSR_ary_dimensz9e_omluv3u6_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_stride642pkq6nsuv98_m
    call ParCS_ary_stride642pkq6nsuv98_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_loweri2ofmmootrn63_m
    call ParCSR_ary_loweri2ofmmootrn63_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_upperrit0danmdfzct_m
    call ParCSR_ary_upperrit0danmdfzct_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_lengthnrhrxrnl18cnl_m
    call ParCS_ary_lengthnrhrxrnl18cnl_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_6d), intent(out) :: array
    external Pa_ary_createCol4xgw3dcxtiuzv_m
    call Pa_ary_createCol4xgw3dcxtiuzv_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_6d), intent(out) :: array
    external Pa_ary_createRow9ecbyuxdlhu67_m
    call Pa_ary_createRow9ecbyuxdlhu67_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_6d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_6d), intent(in) :: dest
    external ParCSRD_ary_copyip3rn_btoonwu_m
    call ParCSRD_ary_copyip3rn_btoonwu_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_ParCSRDiagScale_6d), intent(in)  :: src
    type(bHYPRE_ParCSRDiagScale_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external ParCS_ary_ensurecu6gualwt28gw_m
    call ParCS_ary_ensurecu6gualwt28gw_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ParCSR_ary_slicebtmtajf464d5d_m
    call ParCSR_ary_slicebtmtajf464d5d_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_ParCSRDiagScale_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: value
    external ParCSRD_ary_get66pzr9d3u836xn_m
    call ParCSRD_ary_get66pzr9d3u836xn_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: value
    external ParCSRD_ary_set63z9clc0gt2b8__m
    call ParCSRD_ary_set63z9clc0gt2b8__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_6d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pa_ary_smartCopyvba8i8wgp94cr_m
    dim = 6
    call Pa_ary_smartCopyvba8i8wgp94cr_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_ParCSRDiagScale_6d), intent(in)  :: array
    external ary_isColumnOrderctpbiz_tn6cu_m
    call ary_isColumnOrderctpbiz_tn6cu_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_ParCSRDiagScale_6d), intent(in)  :: array
    external P_ary_isRowOrderpkjahghiotdzs_m
    call P_ary_isRowOrderpkjahghiotdzs_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_ParCSRDiagScale_6d), intent(in)  :: array
    external ParCSR_ary_dimensz9e_omluv3u6_m
    call ParCSR_ary_dimensz9e_omluv3u6_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_stride642pkq6nsuv98_m
    call ParCS_ary_stride642pkq6nsuv98_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_loweri2ofmmootrn63_m
    call ParCSR_ary_loweri2ofmmootrn63_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_upperrit0danmdfzct_m
    call ParCSR_ary_upperrit0danmdfzct_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_lengthnrhrxrnl18cnl_m
    call ParCS_ary_lengthnrhrxrnl18cnl_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_7d), intent(out) :: array
    external Pa_ary_createCol4xgw3dcxtiuzv_m
    call Pa_ary_createCol4xgw3dcxtiuzv_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_ParCSRDiagScale_7d), intent(out) :: array
    external Pa_ary_createRow9ecbyuxdlhu67_m
    call Pa_ary_createRow9ecbyuxdlhu67_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_7d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_7d), intent(in) :: dest
    external ParCSRD_ary_copyip3rn_btoonwu_m
    call ParCSRD_ary_copyip3rn_btoonwu_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_ParCSRDiagScale_7d), intent(in)  :: src
    type(bHYPRE_ParCSRDiagScale_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external ParCS_ary_ensurecu6gualwt28gw_m
    call ParCS_ary_ensurecu6gualwt28gw_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ParCSR_ary_slicebtmtajf464d5d_m
    call ParCSR_ary_slicebtmtajf464d5d_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_ParCSRDiagScale_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_ParCSRDiagScale_t), intent(out) :: value
    external ParCSRD_ary_get7jruahr0ly22t0_m
    call ParCSRD_ary_get7jruahr0ly22t0_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_ParCSRDiagScale_t), intent(in) :: value
    external ParCSRD_ary_set74ceohe7lo1czh_m
    call ParCSRD_ary_set74ceohe7lo1czh_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_ParCSRDiagScale_7d), intent(in) :: src
    type(bHYPRE_ParCSRDiagScale_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pa_ary_smartCopyvba8i8wgp94cr_m
    dim = 7
    call Pa_ary_smartCopyvba8i8wgp94cr_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_ParCSRDiagScale_7d), intent(in)  :: array
    external ary_isColumnOrderctpbiz_tn6cu_m
    call ary_isColumnOrderctpbiz_tn6cu_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_ParCSRDiagScale_7d), intent(in)  :: array
    external P_ary_isRowOrderpkjahghiotdzs_m
    call P_ary_isRowOrderpkjahghiotdzs_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_ParCSRDiagScale_7d), intent(in)  :: array
    external ParCSR_ary_dimensz9e_omluv3u6_m
    call ParCSR_ary_dimensz9e_omluv3u6_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_stride642pkq6nsuv98_m
    call ParCS_ary_stride642pkq6nsuv98_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_loweri2ofmmootrn63_m
    call ParCSR_ary_loweri2ofmmootrn63_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCSR_ary_upperrit0danmdfzct_m
    call ParCSR_ary_upperrit0danmdfzct_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ParCS_ary_lengthnrhrxrnl18cnl_m
    call ParCS_ary_lengthnrhrxrnl18cnl_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_ParCSRDiaayoxwltz1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ParCSRDiagScale_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ParCSRDiaayoxwltz1_p

  subroutine castbHYPRE_ParCSRDimr4um_5nw4_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ParCSRDiagScale_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ParCSRDimr4um_5nw4_p

  subroutine castbHYPRE_ParCSRDi128yq852uu_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ParCSRDiagScale_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ParCSRDi128yq852uu_p

  subroutine castbHYPRE_ParCSRDi9he_r4cum1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ParCSRDiagScale_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ParCSRDi9he_r4cum1_p

  subroutine castbHYPRE_ParCSRDidyndznme9g_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ParCSRDiagScale_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ParCSRDidyndznme9g_p

  subroutine castbHYPRE_ParCSRDi9ri6ubdvbi_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ParCSRDiagScale_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ParCSRDi9ri6ubdvbi_p

  subroutine castbHYPRE_ParCSRDiz9kyqo2hnd_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ParCSRDiagScale_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ParCSRDiz9kyqo2hnd_p


end module bHYPRE_ParCSRDiagScale_array
