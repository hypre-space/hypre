! 
! File:          bHYPRE_SStructDiagScale.F90
...
module bHYPRE_SStructDiagScale
  ...
  use bHYPRE_SStructDiagScale_type
...
interface bHYPRE_SStructDiagScale__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(mpi_comm, A, retval, exception)
    ...
    !  out bHYPRE.SStructDiagScale retval
    type(bHYPRE_SStructDiagScale_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructDiagScale_Create_m
    call bHYPRE_SStructDiagScale_Create_m(mpi_comm, A, retval, exception)
  ...
  recursive subroutine SetOperator_s(self, A, retval, exception)
    implicit none
    !  in bHYPRE.SStructDiagScale self
    type(bHYPRE_SStructDiagScale_t) , intent(in) :: self
    !  in bHYPRE.Operator A
    type(bHYPRE_Operator_t) , intent(in) :: A
    !  out int retval
    ...
    external bHYPRE_SStructDiagScale_SetOperator_m
    call bHYPRE_SStructDiagScale_SetOperator_m(self, A, retval, exception)
  ...
  recursive subroutine SetTolerance_s(self, tolerance, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_SetTolerance_m
    call bHYPRE_SStructDiagScale_SetTolerance_m(self, tolerance, retval,       &
      exception)
  ...
  recursive subroutine SetMaxIterations_s(self, max_iterations, retval,        &
    ...
    external bHYPRE_SStructDiagScale_SetMaxIterations_m
    call bHYPRE_SStructDiagScale_SetMaxIterations_m(self, max_iterations,      &
      retval, exception)
  ...
  recursive subroutine SetLogging_s(self, level, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_SetLogging_m
    call bHYPRE_SStructDiagScale_SetLogging_m(self, level, retval, exception)
  ...
  recursive subroutine SetPrintLevel_s(self, level, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_SetPrintLevel_m
    call bHYPRE_SStructDiagScale_SetPrintLevel_m(self, level, retval,          &
      exception)
  ...
  recursive subroutine GetNumIterations_s(self, num_iterations, retval,        &
    ...
    external bHYPRE_SStructDiagScale_GetNumIterations_m
    call bHYPRE_SStructDiagScale_GetNumIterations_m(self, num_iterations,      &
      retval, exception)
  ...
  recursive subroutine GetRelResidualNorm_s(self, norm, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_GetRelResidualNorm_m
    call bHYPRE_SStructDiagScale_GetRelResidualNorm_m(self, norm, retval,      &
      exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_SetCommunicator_m
    call bHYPRE_SStructDiagScale_SetCommunicator_m(self, mpi_comm, retval,     &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_SStructDiagScale_Destroy_m
    call bHYPRE_SStructDiagScale_Destroy_m(self, exception)
  ...
  recursive subroutine SetIntParameter_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_SetIntParameter_m
    call bHYPRE_SStructDiagScale_SetIntParameter_m(self, name, value, retval,  &
      exception)
  ...
  recursive subroutine SetDoubleParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_SStructDiagScale_SetDoubleParameter_m
    call bHYPRE_SStructDiagScale_SetDoubleParameter_m(self, name, value,       &
      retval, exception)
  ...
  recursive subroutine SetStringParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_SStructDiagScale_SetStringParameter_m
    call bHYPRE_SStructDiagScale_SetStringParameter_m(self, name, value,       &
      retval, exception)
  ...
  recursive subroutine SetIntArray1Parameter_1s(self, name, value, retval,     &
    ...
    external bHYPRE_SStructDiagScale_SetIntArray1Parameter_a
    call bHYPRE_SStructDiagScale_SetIntArray1Parameter_a(self, name, value,    &
      retval, exception)
  ...
  recursive subroutine SetIntArray1Parameter_2s(self, name, value, retval,     &
    ...
    external bHYPRE_SStructDiagScale_SetIntArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_SStructDiagScale_SetIntArray1Parameter_m(self, name, value,    &
  ...
  recursive subroutine SetIntArray2Parameter_s(self, name, value, retval,      &
    ...
    external bHYPRE_SStructDiagScale_SetIntArray2Parameter_m
    call bHYPRE_SStructDiagScale_SetIntArray2Parameter_m(self, name, value,    &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_1s(self, name, value, retval,  &
    ...
    external bHYPRE_SStructDiagScale_SetDoubleArray1Parameter_a
    call bHYPRE_SStructDiagScale_SetDoubleArray1Parameter_a(self, name, value, &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_2s(self, name, value, retval,  &
    ...
    external bHYPRE_SStructDiagScale_SetDoubleArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_SStructDiagScale_SetDoubleArray1Parameter_m(self, name, value, &
      nvalues, retval, exception)
  ...
  recursive subroutine SetDoubleArray2Parameter_s(self, name, value, retval,   &
    ...
    external bHYPRE_SStructDiagScale_SetDoubleArray2Parameter_m
    call bHYPRE_SStructDiagScale_SetDoubleArray2Parameter_m(self, name, value, &
      retval, exception)
  ...
  recursive subroutine GetIntValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_GetIntValue_m
    call bHYPRE_SStructDiagScale_GetIntValue_m(self, name, value, retval,      &
      exception)
  ...
  recursive subroutine GetDoubleValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_GetDoubleValue_m
    call bHYPRE_SStructDiagScale_GetDoubleValue_m(self, name, value, retval,   &
      exception)
  ...
  recursive subroutine Setup_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_Setup_m
    call bHYPRE_SStructDiagScale_Setup_m(self, b, x, retval, exception)
  ...
  recursive subroutine Apply_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_Apply_m
    call bHYPRE_SStructDiagScale_Apply_m(self, b, x, retval, exception)
  ...
  recursive subroutine ApplyAdjoint_s(self, b, x, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_ApplyAdjoint_m
    call bHYPRE_SStructDiagScale_ApplyAdjoint_m(self, b, x, retval, exception)
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_SStructDiagScale_newLocal_m
    call bHYPRE_SStructDiagScale_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    implicit none
    !  out bHYPRE.SStructDiagScale self
    type(bHYPRE_SStructDiagScale_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_SStructDiagScale_newRemote_m
    call bHYPRE_SStructDiagScale_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_SStructDiagScale_rConnect_m
    call bHYPRE_SStructDiagScale_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_SStructDiagScale_addRef_m
    call bHYPRE_SStructDiagScale_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_SStructDiagScale_deleteRef_m
    call bHYPRE_SStructDiagScale_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_isSame_m
    call bHYPRE_SStructDiagScale_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_isType_m
    call bHYPRE_SStructDiagScale_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_SStructDiagScale_getClassInfo_m
    call bHYPRE_SStructDiagScale_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.SStructDiagScale
  ! to bHYPRE.Operator.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_SStructDiagScale_t), intent(in) :: oldType
  ...
  ! to bHYPRE.SStructDiagScale.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_Operator_t), intent(in) :: oldType
    type(bHYPRE_SStructDiagScale_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_SStructDiagScale__cast_m

    call bHYPRE_SStructDiagScale__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_SStructDiagScale__exec_m
    call bHYPRE_SStructDiagScale__exec_m(self, methodName, inArgs, outArgs,    &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_SStructDiagScale__getURL_m
    call bHYPRE_SStructDiagScale__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_SStructDiagScale__isRemote_m
    call bHYPRE_SStructDiagScale__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_SStructDiagScale__isLocal_m
    call bHYPRE_SStructDiagScale__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_SStructDiagScale__set_hooks_m
    call bHYPRE_SStructDiagScale__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_SStructDiagScale__set_hooks_static_m
    call bHYPRE_SStructDiagScale__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_SStructDiagScale_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_SStructDiagScale_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_SStructDiagScale

module bHYPRE_SStructDiagScale_array
  use sidl
  use bHYPRE_SStructDiagScale_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_SStructDdi6vich9nz_p, &
    castbHYPRE_SStructDvs2uh3up9c_p, &
    castbHYPRE_SStructDa07a9kq3oq_p, &
    castbHYPRE_SStructD0h7v6_lptl_p, &
    castbHYPRE_SStructDcufnulfqt3_p, &
    castbHYPRE_SStructDiwalfd8ysx_p, &
    castbHYPRE_SStructDa52yzy6uto_p
interface cast
  module procedure &
    castbHYPRE_SStructDdi6vich9nz_p, &
    castbHYPRE_SStructDvs2uh3up9c_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_1d), intent(out) :: array
    external SS_ary_createColtlx9eg0bh49hq_m
    call SS_ary_createColtlx9eg0bh49hq_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_SStructDiagScale_1d), intent(out) :: array
    external SS_ary_createRowas3q3lfdbxbs8_m
    call SS_ary_createRowas3q3lfdbxbs8_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_SStructDiagScale_1d), intent(out) :: array
    external SSt_ary_create1d86q55xo4yo2yf_m
    call SSt_ary_create1d86q55xo4yo2yf_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_SStructDiagScale_1d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_1d), intent(in) :: dest
    external SStruct_ary_copyfdpt00zgld0hv_m
    call SStruct_ary_copyfdpt00zgld0hv_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: src
    type(bHYPRE_SStructDiagScale_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensuregyah175ni563__m
    call SStru_ary_ensuregyah175ni563__m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external SStruc_ary_slicekj8s9isfchytr_m
    call SStruc_ary_slicekj8s9isfchytr_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructDiagScale_t), intent(out) :: value
    external SStructD_ary_getvx1xhn72grvv3_m
    call SStructD_ary_getvx1xhn72grvv3_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_SStructDiagScale_t), intent(in) :: value
    external SStructD_ary_setr67ew8ekols85_m
    call SStructD_ary_setr67ew8ekols85_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_SStructDiagScale_t), intent(out) :: value
    external SStruct_ary_get1ico_7_y8tmka2_m
    call SStruct_ary_get1ico_7_y8tmka2_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_SStructDiagScale_t), intent(in) :: value
    external SStruct_ary_set1edomgohc85kib_m
    call SStruct_ary_set1edomgohc85kib_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_SStructDiagScale_1d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy9trl0dh2_hwkt_m
    dim = 1
    call SS_ary_smartCopy9trl0dh2_hwkt_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    external ary_isColumnOrdercjzn24j6gcfn_m
    call ary_isColumnOrdercjzn24j6gcfn_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    external S_ary_isRowOrderztavu1dd_m7wk_m
    call S_ary_isRowOrderztavu1dd_m7wk_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    external SStruc_ary_dimen6snt6fq662zh9_m
    call SStruc_ary_dimen6snt6fq662zh9_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride74q8he6v5k50__m
    call SStru_ary_stride74q8he6v5k50__m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerfxxc9nqpkqkm7_m
    call SStruc_ary_lowerfxxc9nqpkqkm7_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergdm6lud0fj5ys_m
    call SStruc_ary_uppergdm6lud0fj5ys_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length1_t5dndr5dt1__m
    call SStru_ary_length1_t5dndr5dt1__m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    external SStru_ary_addRefas46crvzcu1aa_m
    call SStru_ary_addRefas46crvzcu1aa_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_SStructDiagScale_1d), intent(in)  :: array
    external SS_ary_deleteReffv5odd94xzq95_m
    call SS_ary_deleteReffv5odd94xzq95_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_2d), intent(out) :: array
    external SS_ary_createColtlx9eg0bh49hq_m
    call SS_ary_createColtlx9eg0bh49hq_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_2d), intent(out) :: array
    external SS_ary_createRowas3q3lfdbxbs8_m
    call SS_ary_createRowas3q3lfdbxbs8_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructDiagScale_2d), intent(out) :: array
    external ary_create2dColt7an0ecad5xcrb_m
    call ary_create2dColt7an0ecad5xcrb_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_SStructDiagScale_2d), intent(out) :: array
    external ary_create2dRowxnsoq7_ow9h1k8_m
    call ary_create2dRowxnsoq7_ow9h1k8_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_SStructDiagScale_2d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_2d), intent(in) :: dest
    external SStruct_ary_copyfdpt00zgld0hv_m
    call SStruct_ary_copyfdpt00zgld0hv_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_SStructDiagScale_2d), intent(in)  :: src
    type(bHYPRE_SStructDiagScale_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensuregyah175ni563__m
    call SStru_ary_ensuregyah175ni563__m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicekj8s9isfchytr_m
    call SStruc_ary_slicekj8s9isfchytr_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_SStructDiagScale_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_SStructDiagScale_t), intent(out) :: value
    external SStruct_ary_get29j__z2iay0bj8_m
    call SStruct_ary_get29j__z2iay0bj8_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_SStructDiagScale_t), intent(in) :: value
    external SStruct_ary_set2hk5m_p1ep2ftj_m
    call SStruct_ary_set2hk5m_p1ep2ftj_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_SStructDiagScale_2d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy9trl0dh2_hwkt_m
    dim = 2
    call SS_ary_smartCopy9trl0dh2_hwkt_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_SStructDiagScale_2d), intent(in)  :: array
    external ary_isColumnOrdercjzn24j6gcfn_m
    call ary_isColumnOrdercjzn24j6gcfn_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_SStructDiagScale_2d), intent(in)  :: array
    external S_ary_isRowOrderztavu1dd_m7wk_m
    call S_ary_isRowOrderztavu1dd_m7wk_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_SStructDiagScale_2d), intent(in)  :: array
    external SStruc_ary_dimen6snt6fq662zh9_m
    call SStruc_ary_dimen6snt6fq662zh9_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride74q8he6v5k50__m
    call SStru_ary_stride74q8he6v5k50__m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerfxxc9nqpkqkm7_m
    call SStruc_ary_lowerfxxc9nqpkqkm7_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergdm6lud0fj5ys_m
    call SStruc_ary_uppergdm6lud0fj5ys_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length1_t5dndr5dt1__m
    call SStru_ary_length1_t5dndr5dt1__m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_3d), intent(out) :: array
    external SS_ary_createColtlx9eg0bh49hq_m
    call SS_ary_createColtlx9eg0bh49hq_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_3d), intent(out) :: array
    external SS_ary_createRowas3q3lfdbxbs8_m
    call SS_ary_createRowas3q3lfdbxbs8_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_SStructDiagScale_3d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_3d), intent(in) :: dest
    external SStruct_ary_copyfdpt00zgld0hv_m
    call SStruct_ary_copyfdpt00zgld0hv_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_SStructDiagScale_3d), intent(in)  :: src
    type(bHYPRE_SStructDiagScale_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensuregyah175ni563__m
    call SStru_ary_ensuregyah175ni563__m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicekj8s9isfchytr_m
    call SStruc_ary_slicekj8s9isfchytr_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_SStructDiagScale_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_SStructDiagScale_t), intent(out) :: value
    external SStruct_ary_get3ti8ermf8gwpyl_m
    call SStruct_ary_get3ti8ermf8gwpyl_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_SStructDiagScale_t), intent(in) :: value
    external SStruct_ary_set3g6_i5t5w50na3_m
    call SStruct_ary_set3g6_i5t5w50na3_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_SStructDiagScale_3d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy9trl0dh2_hwkt_m
    dim = 3
    call SS_ary_smartCopy9trl0dh2_hwkt_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_SStructDiagScale_3d), intent(in)  :: array
    external ary_isColumnOrdercjzn24j6gcfn_m
    call ary_isColumnOrdercjzn24j6gcfn_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_SStructDiagScale_3d), intent(in)  :: array
    external S_ary_isRowOrderztavu1dd_m7wk_m
    call S_ary_isRowOrderztavu1dd_m7wk_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_SStructDiagScale_3d), intent(in)  :: array
    external SStruc_ary_dimen6snt6fq662zh9_m
    call SStruc_ary_dimen6snt6fq662zh9_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride74q8he6v5k50__m
    call SStru_ary_stride74q8he6v5k50__m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerfxxc9nqpkqkm7_m
    call SStruc_ary_lowerfxxc9nqpkqkm7_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergdm6lud0fj5ys_m
    call SStruc_ary_uppergdm6lud0fj5ys_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length1_t5dndr5dt1__m
    call SStru_ary_length1_t5dndr5dt1__m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_4d), intent(out) :: array
    external SS_ary_createColtlx9eg0bh49hq_m
    call SS_ary_createColtlx9eg0bh49hq_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_4d), intent(out) :: array
    external SS_ary_createRowas3q3lfdbxbs8_m
    call SS_ary_createRowas3q3lfdbxbs8_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_SStructDiagScale_4d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_4d), intent(in) :: dest
    external SStruct_ary_copyfdpt00zgld0hv_m
    call SStruct_ary_copyfdpt00zgld0hv_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_SStructDiagScale_4d), intent(in)  :: src
    type(bHYPRE_SStructDiagScale_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensuregyah175ni563__m
    call SStru_ary_ensuregyah175ni563__m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicekj8s9isfchytr_m
    call SStruc_ary_slicekj8s9isfchytr_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_SStructDiagScale_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_SStructDiagScale_t), intent(out) :: value
    external SStruct_ary_get4tmci023dtvtdd_m
    call SStruct_ary_get4tmci023dtvtdd_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_SStructDiagScale_t), intent(in) :: value
    external SStruct_ary_set488ex8mx96dcjr_m
    call SStruct_ary_set488ex8mx96dcjr_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_SStructDiagScale_4d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy9trl0dh2_hwkt_m
    dim = 4
    call SS_ary_smartCopy9trl0dh2_hwkt_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_SStructDiagScale_4d), intent(in)  :: array
    external ary_isColumnOrdercjzn24j6gcfn_m
    call ary_isColumnOrdercjzn24j6gcfn_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_SStructDiagScale_4d), intent(in)  :: array
    external S_ary_isRowOrderztavu1dd_m7wk_m
    call S_ary_isRowOrderztavu1dd_m7wk_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_SStructDiagScale_4d), intent(in)  :: array
    external SStruc_ary_dimen6snt6fq662zh9_m
    call SStruc_ary_dimen6snt6fq662zh9_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride74q8he6v5k50__m
    call SStru_ary_stride74q8he6v5k50__m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerfxxc9nqpkqkm7_m
    call SStruc_ary_lowerfxxc9nqpkqkm7_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergdm6lud0fj5ys_m
    call SStruc_ary_uppergdm6lud0fj5ys_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length1_t5dndr5dt1__m
    call SStru_ary_length1_t5dndr5dt1__m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_5d), intent(out) :: array
    external SS_ary_createColtlx9eg0bh49hq_m
    call SS_ary_createColtlx9eg0bh49hq_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_5d), intent(out) :: array
    external SS_ary_createRowas3q3lfdbxbs8_m
    call SS_ary_createRowas3q3lfdbxbs8_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_SStructDiagScale_5d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_5d), intent(in) :: dest
    external SStruct_ary_copyfdpt00zgld0hv_m
    call SStruct_ary_copyfdpt00zgld0hv_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_SStructDiagScale_5d), intent(in)  :: src
    type(bHYPRE_SStructDiagScale_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensuregyah175ni563__m
    call SStru_ary_ensuregyah175ni563__m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicekj8s9isfchytr_m
    call SStruc_ary_slicekj8s9isfchytr_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_SStructDiagScale_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_SStructDiagScale_t), intent(out) :: value
    external SStruct_ary_get56jw15vpcmyb4m_m
    call SStruct_ary_get56jw15vpcmyb4m_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_SStructDiagScale_t), intent(in) :: value
    external SStruct_ary_set55z1z3oe0h3kxm_m
    call SStruct_ary_set55z1z3oe0h3kxm_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_SStructDiagScale_5d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy9trl0dh2_hwkt_m
    dim = 5
    call SS_ary_smartCopy9trl0dh2_hwkt_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_SStructDiagScale_5d), intent(in)  :: array
    external ary_isColumnOrdercjzn24j6gcfn_m
    call ary_isColumnOrdercjzn24j6gcfn_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_SStructDiagScale_5d), intent(in)  :: array
    external S_ary_isRowOrderztavu1dd_m7wk_m
    call S_ary_isRowOrderztavu1dd_m7wk_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_SStructDiagScale_5d), intent(in)  :: array
    external SStruc_ary_dimen6snt6fq662zh9_m
    call SStruc_ary_dimen6snt6fq662zh9_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride74q8he6v5k50__m
    call SStru_ary_stride74q8he6v5k50__m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerfxxc9nqpkqkm7_m
    call SStruc_ary_lowerfxxc9nqpkqkm7_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergdm6lud0fj5ys_m
    call SStruc_ary_uppergdm6lud0fj5ys_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length1_t5dndr5dt1__m
    call SStru_ary_length1_t5dndr5dt1__m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_6d), intent(out) :: array
    external SS_ary_createColtlx9eg0bh49hq_m
    call SS_ary_createColtlx9eg0bh49hq_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_6d), intent(out) :: array
    external SS_ary_createRowas3q3lfdbxbs8_m
    call SS_ary_createRowas3q3lfdbxbs8_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_SStructDiagScale_6d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_6d), intent(in) :: dest
    external SStruct_ary_copyfdpt00zgld0hv_m
    call SStruct_ary_copyfdpt00zgld0hv_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_SStructDiagScale_6d), intent(in)  :: src
    type(bHYPRE_SStructDiagScale_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensuregyah175ni563__m
    call SStru_ary_ensuregyah175ni563__m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicekj8s9isfchytr_m
    call SStruc_ary_slicekj8s9isfchytr_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_SStructDiagScale_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_SStructDiagScale_t), intent(out) :: value
    external SStruct_ary_get6b79klrybpt_lp_m
    call SStruct_ary_get6b79klrybpt_lp_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_SStructDiagScale_t), intent(in) :: value
    external SStruct_ary_set6e3w8536p9w4fe_m
    call SStruct_ary_set6e3w8536p9w4fe_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_SStructDiagScale_6d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy9trl0dh2_hwkt_m
    dim = 6
    call SS_ary_smartCopy9trl0dh2_hwkt_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_SStructDiagScale_6d), intent(in)  :: array
    external ary_isColumnOrdercjzn24j6gcfn_m
    call ary_isColumnOrdercjzn24j6gcfn_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_SStructDiagScale_6d), intent(in)  :: array
    external S_ary_isRowOrderztavu1dd_m7wk_m
    call S_ary_isRowOrderztavu1dd_m7wk_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_SStructDiagScale_6d), intent(in)  :: array
    external SStruc_ary_dimen6snt6fq662zh9_m
    call SStruc_ary_dimen6snt6fq662zh9_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride74q8he6v5k50__m
    call SStru_ary_stride74q8he6v5k50__m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerfxxc9nqpkqkm7_m
    call SStruc_ary_lowerfxxc9nqpkqkm7_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergdm6lud0fj5ys_m
    call SStruc_ary_uppergdm6lud0fj5ys_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length1_t5dndr5dt1__m
    call SStru_ary_length1_t5dndr5dt1__m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_7d), intent(out) :: array
    external SS_ary_createColtlx9eg0bh49hq_m
    call SS_ary_createColtlx9eg0bh49hq_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_SStructDiagScale_7d), intent(out) :: array
    external SS_ary_createRowas3q3lfdbxbs8_m
    call SS_ary_createRowas3q3lfdbxbs8_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_SStructDiagScale_7d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_7d), intent(in) :: dest
    external SStruct_ary_copyfdpt00zgld0hv_m
    call SStruct_ary_copyfdpt00zgld0hv_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_SStructDiagScale_7d), intent(in)  :: src
    type(bHYPRE_SStructDiagScale_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external SStru_ary_ensuregyah175ni563__m
    call SStru_ary_ensuregyah175ni563__m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external SStruc_ary_slicekj8s9isfchytr_m
    call SStruc_ary_slicekj8s9isfchytr_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_SStructDiagScale_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_SStructDiagScale_t), intent(out) :: value
    external SStruct_ary_get7x23j6nflz0pmq_m
    call SStruct_ary_get7x23j6nflz0pmq_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_SStructDiagScale_t), intent(in) :: value
    external SStruct_ary_set76x32cyp0qt35o_m
    call SStruct_ary_set76x32cyp0qt35o_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_SStructDiagScale_7d), intent(in) :: src
    type(bHYPRE_SStructDiagScale_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external SS_ary_smartCopy9trl0dh2_hwkt_m
    dim = 7
    call SS_ary_smartCopy9trl0dh2_hwkt_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_SStructDiagScale_7d), intent(in)  :: array
    external ary_isColumnOrdercjzn24j6gcfn_m
    call ary_isColumnOrdercjzn24j6gcfn_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_SStructDiagScale_7d), intent(in)  :: array
    external S_ary_isRowOrderztavu1dd_m7wk_m
    call S_ary_isRowOrderztavu1dd_m7wk_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_SStructDiagScale_7d), intent(in)  :: array
    external SStruc_ary_dimen6snt6fq662zh9_m
    call SStruc_ary_dimen6snt6fq662zh9_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_stride74q8he6v5k50__m
    call SStru_ary_stride74q8he6v5k50__m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_lowerfxxc9nqpkqkm7_m
    call SStruc_ary_lowerfxxc9nqpkqkm7_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStruc_ary_uppergdm6lud0fj5ys_m
    call SStruc_ary_uppergdm6lud0fj5ys_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external SStru_ary_length1_t5dndr5dt1__m
    call SStru_ary_length1_t5dndr5dt1__m(array, index, length7_p)
  ...
  subroutine castbHYPRE_SStructDdi6vich9nz_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructDiagScale_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructDdi6vich9nz_p

  subroutine castbHYPRE_SStructDvs2uh3up9c_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructDiagScale_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructDvs2uh3up9c_p

  subroutine castbHYPRE_SStructDa07a9kq3oq_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructDiagScale_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructDa07a9kq3oq_p

  subroutine castbHYPRE_SStructD0h7v6_lptl_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructDiagScale_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructD0h7v6_lptl_p

  subroutine castbHYPRE_SStructDcufnulfqt3_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructDiagScale_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructDcufnulfqt3_p

  subroutine castbHYPRE_SStructDiwalfd8ysx_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructDiagScale_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructDiwalfd8ysx_p

  subroutine castbHYPRE_SStructDa52yzy6uto_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_SStructDiagScale_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_SStructDa52yzy6uto_p


end module bHYPRE_SStructDiagScale_array
