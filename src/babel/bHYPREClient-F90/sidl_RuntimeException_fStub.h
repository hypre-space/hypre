/*
 * File:          sidl_RuntimeException_fStub.h
 * Symbol:        sidl.RuntimeException-v0.9.15
 * Symbol Type:   interface
 * Babel Version: 1.0.0
 * Release:       $Name: V2-2-0b $
 * Revision:      @(#) $Id: sidl_RuntimeException_fStub.h,v 1.1 2007/02/06 01:23:08 painter Exp $
 * Description:   Client-side documentation text for sidl.RuntimeException
 * 
...
#define included_sidl_RuntimeException_fStub_h
