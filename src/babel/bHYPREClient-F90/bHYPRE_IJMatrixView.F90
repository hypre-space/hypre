...
module bHYPRE_IJMatrixView

  use sidl
  use bHYPRE_MPICommunicator_type
  use sidl_ClassInfo_type
  use bHYPRE_IJMatrixView_type
  ...
  private :: cast_0, cast_1, cast_2, cast_3, cast_4, cast_5
  interface cast
    module procedure cast_0, cast_1, cast_2, cast_3, cast_4, cast_5
  end interface
  ...
  interface GetLocalRange
    ...
    private :: GetRowCounts_1s, &
    GetRowCounts_2s


  interface GetRowCounts
    module procedure GetRowCounts_1s, &
    GetRowCounts_2s
  end interface
  ...
  interface GetValues
    ...
    private :: SetRowSizes_1s, &
    SetRowSizes_2s


  interface SetRowSizes
    module procedure SetRowSizes_1s, &
    SetRowSizes_2s
  end interface
    private :: Print_s
...
contains
  ...
  recursive subroutine SetLocalRange_s(self, ilower, iupper, jlower, jupper,   &
    retval, exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    !  in int ilower
    integer (kind=sidl_int) , intent(in) :: ilower
    !  in int iupper
    integer (kind=sidl_int) , intent(in) :: iupper
    !  in int jlower
    ...
    external bHYPRE_IJMatrixView_SetLocalRange_m
    call bHYPRE_IJMatrixView_SetLocalRange_m(self, ilower, iupper, jlower,     &
      jupper, retval, exception)

  end subroutine SetLocalRange_s


  recursive subroutine SetValues_1s(self, ncols, rows, cols, values, retval,   &
    exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    !  in array<int,column-major> ncols
    type(sidl_int_1d) , intent(in) :: ncols
    !  in array<int,column-major> rows
    type(sidl_int_1d) , intent(in) :: rows
    !  in array<int,column-major> cols
    type(sidl_int_1d) , intent(in) :: cols
    ...
    external bHYPRE_IJMatrixView_SetValues_a
    call bHYPRE_IJMatrixView_SetValues_a(self, ncols, rows, cols, values,      &
      retval, exception)

  end subroutine SetValues_1s

  recursive subroutine SetValues_2s(self, ncols, rows, cols, values, retval,   &
    exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    !  in rarray<int> ncols(nrows)
    integer (kind=sidl_int) , intent(in), dimension(:) :: ncols
    !  in rarray<int> rows(nrows)
    integer (kind=sidl_int) , intent(in), dimension(:) :: rows
    !  in rarray<int> cols(nnonzeros)
    integer (kind=sidl_int) , intent(in), dimension(:) :: cols
    ...
    type(sidl_BaseInterface_t) , intent(out) :: exception
    !  in int nnonzeros
    integer (kind=sidl_int) :: nnonzeros
    !  in int nrows
    integer (kind=sidl_int) :: nrows

    external bHYPRE_IJMatrixView_SetValues_m
    nnonzeros = size(values, 1)
    nrows = size(rows, 1)
    call bHYPRE_IJMatrixView_SetValues_m(self, nrows, ncols, rows, cols,       &
      values, nnonzeros, retval, exception)

  end subroutine SetValues_2s


  recursive subroutine AddToValues_1s(self, ncols, rows, cols, values, retval, &
    exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_IJMatrixView_AddToValues_a
    call bHYPRE_IJMatrixView_AddToValues_a(self, ncols, rows, cols, values,    &
      retval, exception)

  end subroutine AddToValues_1s

  recursive subroutine AddToValues_2s(self, ncols, rows, cols, values, retval, &
    exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_IJMatrixView_AddToValues_m
    nnonzeros = size(values, 1)
    nrows = size(rows, 1)
    call bHYPRE_IJMatrixView_AddToValues_m(self, nrows, ncols, rows, cols,     &
      values, nnonzeros, retval, exception)

  end subroutine AddToValues_2s


  recursive subroutine GetLocalRange_s(self, ilower, iupper, jlower, jupper,   &
    retval, exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    !  out int ilower
    integer (kind=sidl_int) , intent(out) :: ilower
    !  out int iupper
    integer (kind=sidl_int) , intent(out) :: iupper
    !  out int jlower
    ...
    external bHYPRE_IJMatrixView_GetLocalRange_m
    call bHYPRE_IJMatrixView_GetLocalRange_m(self, ilower, iupper, jlower,     &
      jupper, retval, exception)

  end subroutine GetLocalRange_s


  recursive subroutine GetRowCounts_1s(self, rows, ncols, retval, exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    !  in array<int,column-major> rows
    type(sidl_int_1d) , intent(in) :: rows
    !  inout array<int,column-major> ncols
    type(sidl_int_1d) , intent(inout) :: ncols
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_IJMatrixView_GetRowCounts_a
    call bHYPRE_IJMatrixView_GetRowCounts_a(self, rows, ncols, retval,         &
      exception)

  end subroutine GetRowCounts_1s

  recursive subroutine GetRowCounts_2s(self, rows, ncols, retval, exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    !  in rarray<int> rows(nrows)
    ...
    integer (kind=sidl_int) , intent(inout), dimension(:) :: ncols
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception
    ...
    external bHYPRE_IJMatrixView_GetRowCounts_m
    nrows = size(rows, 1)
    call bHYPRE_IJMatrixView_GetRowCounts_m(self, nrows, rows, ncols, retval,  &
      exception)

  end subroutine GetRowCounts_2s


  recursive subroutine GetValues_1s(self, ncols, rows, cols, values, retval,   &
    exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_IJMatrixView_GetValues_a
    call bHYPRE_IJMatrixView_GetValues_a(self, ncols, rows, cols, values,      &
      retval, exception)

  end subroutine GetValues_1s

  recursive subroutine GetValues_2s(self, ncols, rows, cols, values, retval,   &
    exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    ...
    external bHYPRE_IJMatrixView_GetValues_m
    nnonzeros = size(values, 1)
    nrows = size(rows, 1)
    call bHYPRE_IJMatrixView_GetValues_m(self, nrows, ncols, rows, cols,       &
      values, nnonzeros, retval, exception)

  end subroutine GetValues_2s


  recursive subroutine SetRowSizes_1s(self, sizes, retval, exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    !  in array<int,column-major> sizes
    type(sidl_int_1d) , intent(in) :: sizes
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_IJMatrixView_SetRowSizes_a
    call bHYPRE_IJMatrixView_SetRowSizes_a(self, sizes, retval, exception)

  end subroutine SetRowSizes_1s

  recursive subroutine SetRowSizes_2s(self, sizes, retval, exception)
    implicit none
    !  in bHYPRE.IJMatrixView self
    type(bHYPRE_IJMatrixView_t) , intent(in) :: self
    !  in rarray<int> sizes(nrows)
    integer (kind=sidl_int) , intent(in), dimension(:) :: sizes
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception
    ...
    external bHYPRE_IJMatrixView_SetRowSizes_m
    nrows = size(sizes, 1)
    call bHYPRE_IJMatrixView_SetRowSizes_m(self, sizes, nrows, retval,         &
      exception)

  end subroutine SetRowSizes_2s
  ...
  recursive subroutine Print_s(self, filename, retval, exception)
    ...
    external bHYPRE_IJMatrixView_Print_m
    call bHYPRE_IJMatrixView_Print_m(self, filename, retval, exception)
  ...
  recursive subroutine Read_s(self, filename, comm, retval, exception)
    ...
    external bHYPRE_IJMatrixView_Read_m
    call bHYPRE_IJMatrixView_Read_m(self, filename, comm, retval, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    type(bHYPRE_IJMatrixView_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_IJMatrixView_rConnect_m
    call bHYPRE_IJMatrixView_rConnect_m(self, url, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_IJMatrixView_SetCommunicator_m
    call bHYPRE_IJMatrixView_SetCommunicator_m(self, mpi_comm, retval,         &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_IJMatrixView_Destroy_m
    call bHYPRE_IJMatrixView_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_IJMatrixView_Initialize_m
    call bHYPRE_IJMatrixView_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_IJMatrixView_Assemble_m
    call bHYPRE_IJMatrixView_Assemble_m(self, retval, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_IJMatrixView_addRef_m
    call bHYPRE_IJMatrixView_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_IJMatrixView_deleteRef_m
    call bHYPRE_IJMatrixView_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_IJMatrixView_isSame_m
    call bHYPRE_IJMatrixView_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_IJMatrixView_isType_m
    call bHYPRE_IJMatrixView_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_IJMatrixView_getClassInfo_m
    call bHYPRE_IJMatrixView_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.IJMatrixView
  ! to bHYPRE.MatrixVectorView.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_IJMatrixView_t), intent(in) :: oldType
  ...
  ! to bHYPRE.IJMatrixView.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_MatrixVectorView_t), intent(in) :: oldType
    type(bHYPRE_IJMatrixView_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_IJMatrixView__cast_m

    call bHYPRE_IJMatrixView__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_IJMatrixView__exec_m
    call bHYPRE_IJMatrixView__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_IJMatrixView__getURL_m
    call bHYPRE_IJMatrixView__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_IJMatrixView__isRemote_m
    call bHYPRE_IJMatrixView__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_IJMatrixView__isLocal_m
    call bHYPRE_IJMatrixView__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_IJMatrixView__set_hooks_m
    call bHYPRE_IJMatrixView__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_IJMatrixView_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_IJMatrixView_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_IJMatrixView

module bHYPRE_IJMatrixView_array
  use sidl
  use bHYPRE_IJMatrixView_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_IJMatrix8q7wc_614c_p, &
    castbHYPRE_IJMatrixjwjvnb037r_p, &
    castbHYPRE_IJMatrix5o2pig242g_p, &
    castbHYPRE_IJMatrixl2ask37ckp_p, &
    castbHYPRE_IJMatrix98q82mnpe2_p, &
    castbHYPRE_IJMatrixkpwyfitdgn_p, &
    castbHYPRE_IJMatrixnq_dtprw18_p
interface cast
  module procedure &
    castbHYPRE_IJMatrix8q7wc_614c_p, &
    castbHYPRE_IJMatrixjwjvnb037r_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_1d), intent(out) :: array
    external IJ_ary_createCol4yxv8oyypozg8_m
    call IJ_ary_createCol4yxv8oyypozg8_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_IJMatrixView_1d), intent(out) :: array
    external IJ_ary_createRow_bhyqi3qqhbpo_m
    call IJ_ary_createRow_bhyqi3qqhbpo_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_IJMatrixView_1d), intent(out) :: array
    external IJM_ary_create1dzyutuvod04mwk_m
    call IJM_ary_create1dzyutuvod04mwk_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_IJMatrixView_1d), intent(in) :: src
    type(bHYPRE_IJMatrixView_1d), intent(in) :: dest
    external IJMatri_ary_copy_z7fbffcjd1e2_m
    call IJMatri_ary_copy_z7fbffcjd1e2_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: src
    type(bHYPRE_IJMatrixView_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJMat_ary_ensure0pxo42vrnl2ng_m
    call IJMat_ary_ensure0pxo42vrnl2ng_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external IJMatr_ary_sliceuusyrq9do61a1_m
    call IJMatr_ary_sliceuusyrq9do61a1_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_IJMatrixView_t), intent(out) :: value
    external IJMatrix_ary_getoysr_yfvmca68_m
    call IJMatrix_ary_getoysr_yfvmca68_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_IJMatrixView_t), intent(in) :: value
    external IJMatrix_ary_setzuwgmtciuk23r_m
    call IJMatrix_ary_setzuwgmtciuk23r_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_IJMatrixView_t), intent(out) :: value
    external IJMatri_ary_get1gzp1ypcqlkf7h_m
    call IJMatri_ary_get1gzp1ypcqlkf7h_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_IJMatrixView_t), intent(in) :: value
    external IJMatri_ary_set169nycgfz1kh08_m
    call IJMatri_ary_set169nycgfz1kh08_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_IJMatrixView_1d), intent(in) :: src
    type(bHYPRE_IJMatrixView_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopyg6vr5bqgsg_g1_m
    dim = 1
    call IJ_ary_smartCopyg6vr5bqgsg_g1_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    external ary_isColumnOrdery025slt4tbui_m
    call ary_isColumnOrdery025slt4tbui_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    external I_ary_isRowOrder8qsvy784m_d84_m
    call I_ary_isRowOrder8qsvy784m_d84_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    external IJMatr_ary_dimenzlfakyuuz6fgk_m
    call IJMatr_ary_dimenzlfakyuuz6fgk_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_striderx7uufdgtef1o_m
    call IJMat_ary_striderx7uufdgtef1o_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_loweros_xppy0jan7o_m
    call IJMatr_ary_loweros_xppy0jan7o_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_uppery27z_i9s9v9qf_m
    call IJMatr_ary_uppery27z_i9s9v9qf_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_lengthv68jtykut84va_m
    call IJMat_ary_lengthv68jtykut84va_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    external IJMat_ary_addRef7rp6ah2yo6ghs_m
    call IJMat_ary_addRef7rp6ah2yo6ghs_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_IJMatrixView_1d), intent(in)  :: array
    external IJ_ary_deleteReftudocl4fsvt9s_m
    call IJ_ary_deleteReftudocl4fsvt9s_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_2d), intent(out) :: array
    external IJ_ary_createCol4yxv8oyypozg8_m
    call IJ_ary_createCol4yxv8oyypozg8_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_2d), intent(out) :: array
    external IJ_ary_createRow_bhyqi3qqhbpo_m
    call IJ_ary_createRow_bhyqi3qqhbpo_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_IJMatrixView_2d), intent(out) :: array
    external ary_create2dColhpsb1nr1g9ywho_m
    call ary_create2dColhpsb1nr1g9ywho_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_IJMatrixView_2d), intent(out) :: array
    external ary_create2dRow91t4zvhsyafxqc_m
    call ary_create2dRow91t4zvhsyafxqc_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_IJMatrixView_2d), intent(in) :: src
    type(bHYPRE_IJMatrixView_2d), intent(in) :: dest
    external IJMatri_ary_copy_z7fbffcjd1e2_m
    call IJMatri_ary_copy_z7fbffcjd1e2_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_IJMatrixView_2d), intent(in)  :: src
    type(bHYPRE_IJMatrixView_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJMat_ary_ensure0pxo42vrnl2ng_m
    call IJMat_ary_ensure0pxo42vrnl2ng_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJMatr_ary_sliceuusyrq9do61a1_m
    call IJMatr_ary_sliceuusyrq9do61a1_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_IJMatrixView_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_IJMatrixView_t), intent(out) :: value
    external IJMatri_ary_get2twkp2sykellr8_m
    call IJMatri_ary_get2twkp2sykellr8_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_IJMatrixView_t), intent(in) :: value
    external IJMatri_ary_set20w114dfiua4wu_m
    call IJMatri_ary_set20w114dfiua4wu_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_IJMatrixView_2d), intent(in) :: src
    type(bHYPRE_IJMatrixView_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopyg6vr5bqgsg_g1_m
    dim = 2
    call IJ_ary_smartCopyg6vr5bqgsg_g1_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_IJMatrixView_2d), intent(in)  :: array
    external ary_isColumnOrdery025slt4tbui_m
    call ary_isColumnOrdery025slt4tbui_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_IJMatrixView_2d), intent(in)  :: array
    external I_ary_isRowOrder8qsvy784m_d84_m
    call I_ary_isRowOrder8qsvy784m_d84_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_IJMatrixView_2d), intent(in)  :: array
    external IJMatr_ary_dimenzlfakyuuz6fgk_m
    call IJMatr_ary_dimenzlfakyuuz6fgk_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_striderx7uufdgtef1o_m
    call IJMat_ary_striderx7uufdgtef1o_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_loweros_xppy0jan7o_m
    call IJMatr_ary_loweros_xppy0jan7o_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_uppery27z_i9s9v9qf_m
    call IJMatr_ary_uppery27z_i9s9v9qf_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_lengthv68jtykut84va_m
    call IJMat_ary_lengthv68jtykut84va_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_3d), intent(out) :: array
    external IJ_ary_createCol4yxv8oyypozg8_m
    call IJ_ary_createCol4yxv8oyypozg8_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_3d), intent(out) :: array
    external IJ_ary_createRow_bhyqi3qqhbpo_m
    call IJ_ary_createRow_bhyqi3qqhbpo_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_IJMatrixView_3d), intent(in) :: src
    type(bHYPRE_IJMatrixView_3d), intent(in) :: dest
    external IJMatri_ary_copy_z7fbffcjd1e2_m
    call IJMatri_ary_copy_z7fbffcjd1e2_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_IJMatrixView_3d), intent(in)  :: src
    type(bHYPRE_IJMatrixView_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJMat_ary_ensure0pxo42vrnl2ng_m
    call IJMat_ary_ensure0pxo42vrnl2ng_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJMatr_ary_sliceuusyrq9do61a1_m
    call IJMatr_ary_sliceuusyrq9do61a1_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_IJMatrixView_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_IJMatrixView_t), intent(out) :: value
    external IJMatri_ary_get3h024iaknlxdih_m
    call IJMatri_ary_get3h024iaknlxdih_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_IJMatrixView_t), intent(in) :: value
    external IJMatri_ary_set3liba6anck86oc_m
    call IJMatri_ary_set3liba6anck86oc_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_IJMatrixView_3d), intent(in) :: src
    type(bHYPRE_IJMatrixView_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopyg6vr5bqgsg_g1_m
    dim = 3
    call IJ_ary_smartCopyg6vr5bqgsg_g1_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_IJMatrixView_3d), intent(in)  :: array
    external ary_isColumnOrdery025slt4tbui_m
    call ary_isColumnOrdery025slt4tbui_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_IJMatrixView_3d), intent(in)  :: array
    external I_ary_isRowOrder8qsvy784m_d84_m
    call I_ary_isRowOrder8qsvy784m_d84_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_IJMatrixView_3d), intent(in)  :: array
    external IJMatr_ary_dimenzlfakyuuz6fgk_m
    call IJMatr_ary_dimenzlfakyuuz6fgk_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_striderx7uufdgtef1o_m
    call IJMat_ary_striderx7uufdgtef1o_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_loweros_xppy0jan7o_m
    call IJMatr_ary_loweros_xppy0jan7o_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_uppery27z_i9s9v9qf_m
    call IJMatr_ary_uppery27z_i9s9v9qf_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_lengthv68jtykut84va_m
    call IJMat_ary_lengthv68jtykut84va_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_4d), intent(out) :: array
    external IJ_ary_createCol4yxv8oyypozg8_m
    call IJ_ary_createCol4yxv8oyypozg8_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_4d), intent(out) :: array
    external IJ_ary_createRow_bhyqi3qqhbpo_m
    call IJ_ary_createRow_bhyqi3qqhbpo_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_IJMatrixView_4d), intent(in) :: src
    type(bHYPRE_IJMatrixView_4d), intent(in) :: dest
    external IJMatri_ary_copy_z7fbffcjd1e2_m
    call IJMatri_ary_copy_z7fbffcjd1e2_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_IJMatrixView_4d), intent(in)  :: src
    type(bHYPRE_IJMatrixView_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJMat_ary_ensure0pxo42vrnl2ng_m
    call IJMat_ary_ensure0pxo42vrnl2ng_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJMatr_ary_sliceuusyrq9do61a1_m
    call IJMatr_ary_sliceuusyrq9do61a1_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_IJMatrixView_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_IJMatrixView_t), intent(out) :: value
    external IJMatri_ary_get4s9qjs9qfuoyo3_m
    call IJMatri_ary_get4s9qjs9qfuoyo3_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_IJMatrixView_t), intent(in) :: value
    external IJMatri_ary_set4uaofqicpyi9dm_m
    call IJMatri_ary_set4uaofqicpyi9dm_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_IJMatrixView_4d), intent(in) :: src
    type(bHYPRE_IJMatrixView_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopyg6vr5bqgsg_g1_m
    dim = 4
    call IJ_ary_smartCopyg6vr5bqgsg_g1_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_IJMatrixView_4d), intent(in)  :: array
    external ary_isColumnOrdery025slt4tbui_m
    call ary_isColumnOrdery025slt4tbui_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_IJMatrixView_4d), intent(in)  :: array
    external I_ary_isRowOrder8qsvy784m_d84_m
    call I_ary_isRowOrder8qsvy784m_d84_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_IJMatrixView_4d), intent(in)  :: array
    external IJMatr_ary_dimenzlfakyuuz6fgk_m
    call IJMatr_ary_dimenzlfakyuuz6fgk_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_striderx7uufdgtef1o_m
    call IJMat_ary_striderx7uufdgtef1o_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_loweros_xppy0jan7o_m
    call IJMatr_ary_loweros_xppy0jan7o_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_uppery27z_i9s9v9qf_m
    call IJMatr_ary_uppery27z_i9s9v9qf_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_lengthv68jtykut84va_m
    call IJMat_ary_lengthv68jtykut84va_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_5d), intent(out) :: array
    external IJ_ary_createCol4yxv8oyypozg8_m
    call IJ_ary_createCol4yxv8oyypozg8_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_5d), intent(out) :: array
    external IJ_ary_createRow_bhyqi3qqhbpo_m
    call IJ_ary_createRow_bhyqi3qqhbpo_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_IJMatrixView_5d), intent(in) :: src
    type(bHYPRE_IJMatrixView_5d), intent(in) :: dest
    external IJMatri_ary_copy_z7fbffcjd1e2_m
    call IJMatri_ary_copy_z7fbffcjd1e2_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_IJMatrixView_5d), intent(in)  :: src
    type(bHYPRE_IJMatrixView_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJMat_ary_ensure0pxo42vrnl2ng_m
    call IJMat_ary_ensure0pxo42vrnl2ng_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJMatr_ary_sliceuusyrq9do61a1_m
    call IJMatr_ary_sliceuusyrq9do61a1_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_IJMatrixView_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_IJMatrixView_t), intent(out) :: value
    external IJMatri_ary_get51usd5g2z9l_by_m
    call IJMatri_ary_get51usd5g2z9l_by_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_IJMatrixView_t), intent(in) :: value
    external IJMatri_ary_set5vtn4acm4j10sa_m
    call IJMatri_ary_set5vtn4acm4j10sa_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_IJMatrixView_5d), intent(in) :: src
    type(bHYPRE_IJMatrixView_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopyg6vr5bqgsg_g1_m
    dim = 5
    call IJ_ary_smartCopyg6vr5bqgsg_g1_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_IJMatrixView_5d), intent(in)  :: array
    external ary_isColumnOrdery025slt4tbui_m
    call ary_isColumnOrdery025slt4tbui_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_IJMatrixView_5d), intent(in)  :: array
    external I_ary_isRowOrder8qsvy784m_d84_m
    call I_ary_isRowOrder8qsvy784m_d84_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_IJMatrixView_5d), intent(in)  :: array
    external IJMatr_ary_dimenzlfakyuuz6fgk_m
    call IJMatr_ary_dimenzlfakyuuz6fgk_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_striderx7uufdgtef1o_m
    call IJMat_ary_striderx7uufdgtef1o_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_loweros_xppy0jan7o_m
    call IJMatr_ary_loweros_xppy0jan7o_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_uppery27z_i9s9v9qf_m
    call IJMatr_ary_uppery27z_i9s9v9qf_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_lengthv68jtykut84va_m
    call IJMat_ary_lengthv68jtykut84va_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_6d), intent(out) :: array
    external IJ_ary_createCol4yxv8oyypozg8_m
    call IJ_ary_createCol4yxv8oyypozg8_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_6d), intent(out) :: array
    external IJ_ary_createRow_bhyqi3qqhbpo_m
    call IJ_ary_createRow_bhyqi3qqhbpo_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_IJMatrixView_6d), intent(in) :: src
    type(bHYPRE_IJMatrixView_6d), intent(in) :: dest
    external IJMatri_ary_copy_z7fbffcjd1e2_m
    call IJMatri_ary_copy_z7fbffcjd1e2_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_IJMatrixView_6d), intent(in)  :: src
    type(bHYPRE_IJMatrixView_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJMat_ary_ensure0pxo42vrnl2ng_m
    call IJMat_ary_ensure0pxo42vrnl2ng_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJMatr_ary_sliceuusyrq9do61a1_m
    call IJMatr_ary_sliceuusyrq9do61a1_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_IJMatrixView_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_IJMatrixView_t), intent(out) :: value
    external IJMatri_ary_get6fptchmp3w5z87_m
    call IJMatri_ary_get6fptchmp3w5z87_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_IJMatrixView_t), intent(in) :: value
    external IJMatri_ary_set60b0dtym7ydfhe_m
    call IJMatri_ary_set60b0dtym7ydfhe_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_IJMatrixView_6d), intent(in) :: src
    type(bHYPRE_IJMatrixView_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopyg6vr5bqgsg_g1_m
    dim = 6
    call IJ_ary_smartCopyg6vr5bqgsg_g1_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_IJMatrixView_6d), intent(in)  :: array
    external ary_isColumnOrdery025slt4tbui_m
    call ary_isColumnOrdery025slt4tbui_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_IJMatrixView_6d), intent(in)  :: array
    external I_ary_isRowOrder8qsvy784m_d84_m
    call I_ary_isRowOrder8qsvy784m_d84_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_IJMatrixView_6d), intent(in)  :: array
    external IJMatr_ary_dimenzlfakyuuz6fgk_m
    call IJMatr_ary_dimenzlfakyuuz6fgk_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_striderx7uufdgtef1o_m
    call IJMat_ary_striderx7uufdgtef1o_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_loweros_xppy0jan7o_m
    call IJMatr_ary_loweros_xppy0jan7o_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_uppery27z_i9s9v9qf_m
    call IJMatr_ary_uppery27z_i9s9v9qf_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_lengthv68jtykut84va_m
    call IJMat_ary_lengthv68jtykut84va_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_7d), intent(out) :: array
    external IJ_ary_createCol4yxv8oyypozg8_m
    call IJ_ary_createCol4yxv8oyypozg8_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_IJMatrixView_7d), intent(out) :: array
    external IJ_ary_createRow_bhyqi3qqhbpo_m
    call IJ_ary_createRow_bhyqi3qqhbpo_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_IJMatrixView_7d), intent(in) :: src
    type(bHYPRE_IJMatrixView_7d), intent(in) :: dest
    external IJMatri_ary_copy_z7fbffcjd1e2_m
    call IJMatri_ary_copy_z7fbffcjd1e2_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_IJMatrixView_7d), intent(in)  :: src
    type(bHYPRE_IJMatrixView_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external IJMat_ary_ensure0pxo42vrnl2ng_m
    call IJMat_ary_ensure0pxo42vrnl2ng_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external IJMatr_ary_sliceuusyrq9do61a1_m
    call IJMatr_ary_sliceuusyrq9do61a1_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_IJMatrixView_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_IJMatrixView_t), intent(out) :: value
    external IJMatri_ary_get7uot0okocvhrt7_m
    call IJMatri_ary_get7uot0okocvhrt7_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_IJMatrixView_t), intent(in) :: value
    external IJMatri_ary_set7stjadc36ahmim_m
    call IJMatri_ary_set7stjadc36ahmim_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_IJMatrixView_7d), intent(in) :: src
    type(bHYPRE_IJMatrixView_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external IJ_ary_smartCopyg6vr5bqgsg_g1_m
    dim = 7
    call IJ_ary_smartCopyg6vr5bqgsg_g1_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_IJMatrixView_7d), intent(in)  :: array
    external ary_isColumnOrdery025slt4tbui_m
    call ary_isColumnOrdery025slt4tbui_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_IJMatrixView_7d), intent(in)  :: array
    external I_ary_isRowOrder8qsvy784m_d84_m
    call I_ary_isRowOrder8qsvy784m_d84_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_IJMatrixView_7d), intent(in)  :: array
    external IJMatr_ary_dimenzlfakyuuz6fgk_m
    call IJMatr_ary_dimenzlfakyuuz6fgk_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_striderx7uufdgtef1o_m
    call IJMat_ary_striderx7uufdgtef1o_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_loweros_xppy0jan7o_m
    call IJMatr_ary_loweros_xppy0jan7o_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMatr_ary_uppery27z_i9s9v9qf_m
    call IJMatr_ary_uppery27z_i9s9v9qf_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external IJMat_ary_lengthv68jtykut84va_m
    call IJMat_ary_lengthv68jtykut84va_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_IJMatrix8q7wc_614c_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJMatrixView_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJMatrix8q7wc_614c_p

  subroutine castbHYPRE_IJMatrixjwjvnb037r_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJMatrixView_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJMatrixjwjvnb037r_p

  subroutine castbHYPRE_IJMatrix5o2pig242g_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJMatrixView_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJMatrix5o2pig242g_p

  subroutine castbHYPRE_IJMatrixl2ask37ckp_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJMatrixView_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJMatrixl2ask37ckp_p

  subroutine castbHYPRE_IJMatrix98q82mnpe2_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJMatrixView_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJMatrix98q82mnpe2_p

  subroutine castbHYPRE_IJMatrixkpwyfitdgn_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJMatrixView_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJMatrixkpwyfitdgn_p

  subroutine castbHYPRE_IJMatrixnq_dtprw18_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_IJMatrixView_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_IJMatrixnq_dtprw18_p


end module bHYPRE_IJMatrixView_array
