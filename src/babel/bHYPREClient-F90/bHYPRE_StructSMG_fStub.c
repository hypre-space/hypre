...
#include "bHYPRE_StructSMG_fStub.h"
#endif
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
...
static struct bHYPRE_StructSMG__object* bHYPRE_StructSMG__remoteCreate(const 
  char* url, sidl_BaseInterface *_ex);
static struct bHYPRE_StructSMG__object* bHYPRE_StructSMG__remoteConnect(const 
  char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct bHYPRE_StructSMG__object* bHYPRE_StructSMG__IHConnect(struct 
...
#else
    _ior = (struct 
      bHYPRE_StructSMG__external*)sidl_dynamicLoadIOR("bHYPRE.StructSMG",
      "bHYPRE_StructSMG__externals") ;
    sidl_checkIORVersion("bHYPRE.StructSMG", _ior->d_ior_major_version,
...
static const struct bHYPRE_StructSMG__sepv* _getSEPV(void)
{
  static const struct bHYPRE_StructSMG__sepv *_sepv = NULL;
  if (!_sepv) {
...
void
SIDLFortran90Symbol(bhypre_structsmg_newlocal_m,BHYPRE_STRUCTSMG_NEWLOCAL_M,bHYPRE_StructSMG_newLocal_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(bhypre_structsmg_newremote_m,BHYPRE_STRUCTSMG_NEWREMOTE_M,bHYPRE_StructSMG_newRemote_m)
(
  int64_t *self,
  SIDL_F90_String url
...
)
{
  ...
  _proxy_self = bHYPRE_StructSMG__remoteCreate(_proxy_url, &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran90Symbol(bhypre_structsmg_wrapobj_m,BHYPRE_STRUCTSMG_WRAPOBJ_M,bHYPRE_StructSMG_wrapObj_m)
(
  void ** private_data,
  int64_t *self,
  int64_t *exception
...
void
SIDLFortran90Symbol(bhypre_structsmg_rconnect_m,BHYPRE_STRUCTSMG_RCONNECT_M,bHYPRE_StructSMG_rConnect_m)
(
  int64_t *self,
  SIDL_F90_String url
  SIDL_F90_STR_NEAR_LEN_DECL(url),
...
)
{
  ...
  _proxy_url =
    sidl_copy_fortran_str(SIDL_F90_STR(url),
      SIDL_F90_STR_LEN(url));
  _proxy_self = bHYPRE_StructSMG__remoteConnect(_proxy_url, 1,
    &_proxy_exception);
  if (_proxy_exception) {
    *exception = (ptrdiff_t)_proxy_exception;
  }
...
void
SIDLFortran90Symbol(bhypre_structsmg__cast_m,BHYPRE_STRUCTSMG__CAST_M,bHYPRE_StructSMG__cast_m)
(
  int64_t *ref,
  int64_t *retval,
  int64_t *exception
)
{
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.StructSMG",
      (void*)bHYPRE_StructSMG__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "bHYPRE.StructSMG", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran90Symbol(bhypre_structsmg__cast2_m,BHYPRE_STRUCTSMG__CAST2_M,bHYPRE_StructSMG__cast2_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(bhypre_structsmg__exec_m,BHYPRE_STRUCTSMG__EXEC_M,bHYPRE_StructSMG__exec_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(bhypre_structsmg__geturl_m,BHYPRE_STRUCTSMG__GETURL_M,bHYPRE_StructSMG__getURL_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(bhypre_structsmg__isremote_m,BHYPRE_STRUCTSMG__ISREMOTE_M,bHYPRE_StructSMG__isRemote_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(bhypre_structsmg__islocal_m,BHYPRE_STRUCTSMG__ISLOCAL_M,bHYPRE_StructSMG__isLocal_m)
(
  int64_t *self,
  SIDL_F90_Bool *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(bhypre_structsmg__set_hooks_m,BHYPRE_STRUCTSMG__SET_HOOKS_M,bHYPRE_StructSMG__set_hooks_m)
(
  int64_t *self,
  SIDL_F90_Bool *on,
  int64_t *exception
...
void
SIDLFortran90Symbol(bhypre_structsmg__set_hooks_static_m,BHYPRE_STRUCTSMG__SET_HOOKS_STATIC_M,bHYPRE_StructSMG__set_hooks_static_m)
(
  SIDL_F90_Bool *on,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(bhypre_structsmg_create_m,BHYPRE_STRUCTSMG_CREATE_M,bHYPRE_StructSMG_Create_m)
(
  int64_t *mpi_comm,
  int64_t *A,
  int64_t *retval,
...
void
SIDLFortran90Symbol(bhypre_structsmg_addref_m,BHYPRE_STRUCTSMG_ADDREF_M,bHYPRE_StructSMG_addRef_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(bhypre_structsmg_deleteref_m,BHYPRE_STRUCTSMG_DELETEREF_M,bHYPRE_StructSMG_deleteRef_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(bhypre_structsmg_issame_m,BHYPRE_STRUCTSMG_ISSAME_M,bHYPRE_StructSMG_isSame_m)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F90_Bool *retval,
...
void
SIDLFortran90Symbol(bhypre_structsmg_istype_m,BHYPRE_STRUCTSMG_ISTYPE_M,bHYPRE_StructSMG_isType_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_getclassinfo_m,BHYPRE_STRUCTSMG_GETCLASSINFO_M,bHYPRE_StructSMG_getClassInfo_m)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(bhypre_structsmg_setoperator_m,BHYPRE_STRUCTSMG_SETOPERATOR_M,bHYPRE_StructSMG_SetOperator_m)
(
  int64_t *self,
  int64_t *A,
  int32_t *retval,
...
void
SIDLFortran90Symbol(bhypre_structsmg_settolerance_m,BHYPRE_STRUCTSMG_SETTOLERANCE_M,bHYPRE_StructSMG_SetTolerance_m)
(
  int64_t *self,
  double *tolerance,
  int32_t *retval,
...
void
SIDLFortran90Symbol(bhypre_structsmg_setmaxiterations_m,BHYPRE_STRUCTSMG_SETMAXITERATIONS_M,bHYPRE_StructSMG_SetMaxIterations_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(bhypre_structsmg_setlogging_m,BHYPRE_STRUCTSMG_SETLOGGING_M,bHYPRE_StructSMG_SetLogging_m)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran90Symbol(bhypre_structsmg_setprintlevel_m,BHYPRE_STRUCTSMG_SETPRINTLEVEL_M,bHYPRE_StructSMG_SetPrintLevel_m)
(
  int64_t *self,
  int32_t *level,
  int32_t *retval,
...
void
SIDLFortran90Symbol(bhypre_structsmg_getnumiterations_m,BHYPRE_STRUCTSMG_GETNUMITERATIONS_M,bHYPRE_StructSMG_GetNumIterations_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(bhypre_structsmg_getrelresidualnorm_m,BHYPRE_STRUCTSMG_GETRELRESIDUALNORM_M,bHYPRE_StructSMG_GetRelResidualNorm_m)
(
  int64_t *self,
  double *norm,
  int32_t *retval,
...
void
SIDLFortran90Symbol(bhypre_structsmg_setcommunicator_m,BHYPRE_STRUCTSMG_SETCOMMUNICATOR_M,bHYPRE_StructSMG_SetCommunicator_m)
(
  int64_t *self,
  int64_t *mpi_comm,
  int32_t *retval,
...
void
SIDLFortran90Symbol(bhypre_structsmg_destroy_m,BHYPRE_STRUCTSMG_DESTROY_M,bHYPRE_StructSMG_Destroy_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(bhypre_structsmg_setintparameter_m,BHYPRE_STRUCTSMG_SETINTPARAMETER_M,bHYPRE_StructSMG_SetIntParameter_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setdoubleparameter_m,BHYPRE_STRUCTSMG_SETDOUBLEPARAMETER_M,bHYPRE_StructSMG_SetDoubleParameter_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setstringparameter_m,BHYPRE_STRUCTSMG_SETSTRINGPARAMETER_M,bHYPRE_StructSMG_SetStringParameter_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setintarray1parameter_m,BHYPRE_STRUCTSMG_SETINTARRAY1PARAMETER_M,bHYPRE_StructSMG_SetIntArray1Parameter_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setintarray1parameter_a,BHYPRE_STRUCTSMG_SETINTARRAY1PARAMETER_A,bHYPRE_StructSMG_SetIntArray1Parameter_a)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setintarray2parameter_m,BHYPRE_STRUCTSMG_SETINTARRAY2PARAMETER_M,bHYPRE_StructSMG_SetIntArray2Parameter_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setdoublearray1parameter_m,BHYPRE_STRUCTSMG_SETDOUBLEARRAY1PARAMETER_M,bHYPRE_StructSMG_SetDoubleArray1Parameter_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setdoublearray1parameter_a,BHYPRE_STRUCTSMG_SETDOUBLEARRAY1PARAMETER_A,bHYPRE_StructSMG_SetDoubleArray1Parameter_a)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setdoublearray2parameter_m,BHYPRE_STRUCTSMG_SETDOUBLEARRAY2PARAMETER_M,bHYPRE_StructSMG_SetDoubleArray2Parameter_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_getintvalue_m,BHYPRE_STRUCTSMG_GETINTVALUE_M,bHYPRE_StructSMG_GetIntValue_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_getdoublevalue_m,BHYPRE_STRUCTSMG_GETDOUBLEVALUE_M,bHYPRE_StructSMG_GetDoubleValue_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(bhypre_structsmg_setup_m,BHYPRE_STRUCTSMG_SETUP_M,bHYPRE_StructSMG_Setup_m)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran90Symbol(bhypre_structsmg_apply_m,BHYPRE_STRUCTSMG_APPLY_M,bHYPRE_StructSMG_Apply_m)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran90Symbol(bhypre_structsmg_applyadjoint_m,BHYPRE_STRUCTSMG_APPLYADJOINT_M,bHYPRE_StructSMG_ApplyAdjoint_m)
(
  int64_t *self,
  int64_t *b,
  int64_t *x,
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_createcol_m,
                  BHYPRE_STRUCTSMG__ARRAY_CREATECOL_M,
                  bHYPRE_StructSMG__array_createCol_m)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_createrow_m,
                  BHYPRE_STRUCTSMG__ARRAY_CREATEROW_M,
                  bHYPRE_StructSMG__array_createRow_m)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_create1d_m,
                  BHYPRE_STRUCTSMG__ARRAY_CREATE1D_M,
                  bHYPRE_StructSMG__array_create1d_m)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_create2dcol_m,
                  BHYPRE_STRUCTSMG__ARRAY_CREATE2DCOL_M,
                  bHYPRE_StructSMG__array_create2dCol_m)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_create2drow_m,
                  BHYPRE_STRUCTSMG__ARRAY_CREATE2DROW_M,
                  bHYPRE_StructSMG__array_create2dRow_m)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_addref_m,
                  BHYPRE_STRUCTSMG__ARRAY_ADDREF_M,
                  bHYPRE_StructSMG__array_addRef_m)
  (int64_t *array)
{
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_deleteref_m,
                  BHYPRE_STRUCTSMG__ARRAY_DELETEREF_M,
                  bHYPRE_StructSMG__array_deleteRef_m)
  (int64_t *array)
{
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_get1_m,
                  BHYPRE_STRUCTSMG__ARRAY_GET1_M,
                  bHYPRE_StructSMG__array_get1_m)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_get2_m,
                  BHYPRE_STRUCTSMG__ARRAY_GET2_M,
                  bHYPRE_StructSMG__array_get2_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_get3_m,
                  BHYPRE_STRUCTSMG__ARRAY_GET3_M,
                  bHYPRE_StructSMG__array_get3_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_get4_m,
                  BHYPRE_STRUCTSMG__ARRAY_GET4_M,
                  bHYPRE_StructSMG__array_get4_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_get5_m,
                  BHYPRE_STRUCTSMG__ARRAY_GET5_M,
                  bHYPRE_StructSMG__array_get5_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_get6_m,
                  BHYPRE_STRUCTSMG__ARRAY_GET6_M,
                  bHYPRE_StructSMG__array_get6_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_get7_m,
                  BHYPRE_STRUCTSMG__ARRAY_GET7_M,
                  bHYPRE_StructSMG__array_get7_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_get_m,
                  BHYPRE_STRUCTSMG__ARRAY_GET_M,
                  bHYPRE_StructSMG__array_get_m)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_set1_m,
                  BHYPRE_STRUCTSMG__ARRAY_SET1_M,
                  bHYPRE_StructSMG__array_set1_m)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_set2_m,
                  BHYPRE_STRUCTSMG__ARRAY_SET2_M,
                  bHYPRE_StructSMG__array_set2_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_set3_m,
                  BHYPRE_STRUCTSMG__ARRAY_SET3_M,
                  bHYPRE_StructSMG__array_set3_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_set4_m,
                  BHYPRE_STRUCTSMG__ARRAY_SET4_M,
                  bHYPRE_StructSMG__array_set4_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_set5_m,
                  BHYPRE_STRUCTSMG__ARRAY_SET5_M,
                  bHYPRE_StructSMG__array_set5_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_set6_m,
                  BHYPRE_STRUCTSMG__ARRAY_SET6_M,
                  bHYPRE_StructSMG__array_set6_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_set7_m,
                  BHYPRE_STRUCTSMG__ARRAY_SET7_M,
                  bHYPRE_StructSMG__array_set7_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_set_m,
                  BHYPRE_STRUCTSMG__ARRAY_SET_M,
                  bHYPRE_StructSMG__array_set_m)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_dimen_m,
                  BHYPRE_STRUCTSMG__ARRAY_DIMEN_M,
                  bHYPRE_StructSMG__array_dimen_m)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_lower_m,
                  BHYPRE_STRUCTSMG__ARRAY_LOWER_M,
                  bHYPRE_StructSMG__array_lower_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_upper_m,
                  BHYPRE_STRUCTSMG__ARRAY_UPPER_M,
                  bHYPRE_StructSMG__array_upper_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_length_m,
                  BHYPRE_STRUCTSMG__ARRAY_LENGTH_M,
                  bHYPRE_StructSMG__array_length_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_stride_m,
                  BHYPRE_STRUCTSMG__ARRAY_STRIDE_M,
                  bHYPRE_StructSMG__array_stride_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_iscolumnorder_m,
                  BHYPRE_STRUCTSMG__ARRAY_ISCOLUMNORDER_M,
                  bHYPRE_StructSMG__array_isColumnOrder_m)
  (int64_t *array,
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_isroworder_m,
                  BHYPRE_STRUCTSMG__ARRAY_ISROWORDER_M,
                  bHYPRE_StructSMG__array_isRowOrder_m)
  (int64_t *array,
   SIDL_F90_Bool *result)
{
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_copy_m,
                  BHYPRE_STRUCTSMG__ARRAY_COPY_M,
                  bHYPRE_StructSMG__array_copy_m)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_smartcopy_m,
                  BHYPRE_STRUCTSMG__ARRAY_SMARTCOPY_M,
                  bHYPRE_StructSMG__array_smartCopy_m)
  (int64_t *src)
{
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_slice_m,
                  BHYPRE_STRUCTSMG__ARRAY_SLICE_M,
                  bHYPRE_StructSMG__array_slice_m)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
...
void
SIDLFortran90Symbol(bhypre_structsmg__array_ensure_m,
                  BHYPRE_STRUCTSMG__ARRAY_ENSURE_M,
                  bHYPRE_StructSMG__array_ensure_m)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t bHYPRE_StructSMG__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &bHYPRE_StructSMG__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &bHYPRE_StructSMG__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &bHYPRE_StructSMG__mutex )==EDEADLOCK) */
#else
...
static struct bHYPRE_StructSMG__epv s_rem_epv__bhypre_structsmg;
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp0 = strcmp(name, "bHYPRE.StructSMG");
  if (!cmp0) {
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct bHYPRE_StructSMG__remote*)self->d_data)->d_ih,
      _ex);
  }
...
static char* remote_bHYPRE_StructSMG__getURL(
  struct bHYPRE_StructSMG__object* self, sidl_BaseInterface* _ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct 
    bHYPRE_StructSMG__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_bHYPRE_StructSMG__raddRef(
  struct bHYPRE_StructSMG__object* self,sidl_BaseInterface* _ex)
{
...
static sidl_bool
remote_bHYPRE_StructSMG__isRemote(
    struct bHYPRE_StructSMG__object* self, 
    sidl_BaseInterface *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_bHYPRE_StructSMG__set_hooks(
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG._set_hooks.", &throwaway_exception);
...
static void remote_bHYPRE_StructSMG__exec(
  struct bHYPRE_StructSMG__object* self,const char* methodName,
  ...
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    struct bHYPRE_StructSMG__remote* r_obj = (struct 
      bHYPRE_StructSMG__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.isSame.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.isType.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.getClassInfo.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetOperator.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetTolerance.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetMaxIterations.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetLogging.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetPrintLevel.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.GetNumIterations.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.GetRelResidualNorm.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetCommunicator.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_bHYPRE_StructSMG_Destroy(
  /* in */ struct bHYPRE_StructSMG__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.Destroy.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetIntParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetDoubleParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetStringParameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetIntArray1Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetIntArray2Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetDoubleArray1Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.SetDoubleArray2Parameter.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.GetIntValue.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.GetDoubleValue.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.Setup.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.Apply.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_bHYPRE_StructSMG_ApplyAdjoint(
  /* in */ struct bHYPRE_StructSMG__object* self ,
  /* in */ struct bHYPRE_Vector__object* b,
  /* inout */ struct bHYPRE_Vector__object** x,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from bHYPRE.StructSMG.ApplyAdjoint.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void bHYPRE_StructSMG__init_remote_epv(void)
{
  ...
  struct bHYPRE_StructSMG__epv*   epv = &s_rem_epv__bhypre_structsmg;
  ...
  epv->f__exec                         = remote_bHYPRE_StructSMG__exec;
  epv->f__getURL                       = remote_bHYPRE_StructSMG__getURL;
  epv->f__raddRef                      = remote_bHYPRE_StructSMG__raddRef;
  epv->f__isRemote                     = remote_bHYPRE_StructSMG__isRemote;
  epv->f__set_hooks                    = remote_bHYPRE_StructSMG__set_hooks;
  epv->f__ctor                         = NULL;
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  ...
  epv->f_SetCommunicator               = 
    remote_bHYPRE_StructSMG_SetCommunicator;
  epv->f_Destroy                       = remote_bHYPRE_StructSMG_Destroy;
  ...
  epv->f_ApplyAdjoint                  = remote_bHYPRE_StructSMG_ApplyAdjoint;
...
static struct bHYPRE_StructSMG__object*
bHYPRE_StructSMG__remoteConnect(const char *url, sidl_bool ar,
  sidl_BaseInterface *_ex)
{
  struct bHYPRE_StructSMG__object* self;

  struct bHYPRE_StructSMG__object* s0;
  struct sidl_BaseClass__object* s1;

  struct bHYPRE_StructSMG__remote* r_obj;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    return bHYPRE_StructSMG__rmicast(bi,_ex);SIDL_CHECK(*_ex);
  }
  ...
  r_obj =
    (struct bHYPRE_StructSMG__remote*) malloc(
      sizeof(struct bHYPRE_StructSMG__remote));
  ...
  s0->d_epv  = &s_rem_epv__bhypre_structsmg;
...
static struct bHYPRE_StructSMG__object*
bHYPRE_StructSMG__IHConnect(sidl_rmi_InstanceHandle instance,
  sidl_BaseInterface *_ex)
{
  struct bHYPRE_StructSMG__object* self;
...
static struct bHYPRE_StructSMG__object*
bHYPRE_StructSMG__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "bHYPRE.StructSMG",
    _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct bHYPRE_StructSMG__object*) malloc(
...
bHYPRE_StructSMG__rmicast(
  ...
  sidl_BaseInterface* _ex)
{
  struct bHYPRE_StructSMG__object* cast = NULL;

  *_ex = NULL;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("bHYPRE.StructSMG",
      (void*)bHYPRE_StructSMG__IHConnect, _ex);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    struct sidl_BaseInterface__object* base = (struct 
      sidl_BaseInterface__object*) obj;
    cast = (struct bHYPRE_StructSMG__object*) (*base->d_epv->f__cast)(
      base->d_object,
      "bHYPRE.StructSMG", _ex); SIDL_CHECK(*_ex);
  }
...
bHYPRE_StructSMG__connectI(const char* url, sidl_bool ar,
  struct sidl_BaseInterface__object **_ex)
{
  return bHYPRE_StructSMG__remoteConnect(url, ar, _ex);
}
