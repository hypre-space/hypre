...
#include "bHYPRE_ErrorCode_fAbbrev.h"
#include "sidl_RuntimeException_fAbbrev.h"
#include "sidl_BaseException_fAbbrev.h"
#include "sidl_BaseClass_fAbbrev.h"

module bHYPRE_ErrorHandler

  use sidl
  use bHYPRE_ErrorHandler_type
  ...
  interface Check
    module procedure Check_s
  end interface
    private :: Describe_s


  interface Describe
    module procedure Describe_s
  end interface
    private :: newLocal_s, &
    newRemote_s
  ...
  interface bHYPRE_ErrorHandler__set_hooks_static
...
contains
  ...
  recursive subroutine Check_s(ierr, error_code, retval, exception)
    implicit none
    !  in int ierr
    integer (kind=sidl_int) , intent(in) :: ierr
    !  in bHYPRE.ErrorCode error_code
    integer (kind=sidl_enum) , intent(in) :: error_code
    !  out int retval
    integer (kind=sidl_int) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_ErrorHandler_Check_m
    call bHYPRE_ErrorHandler_Check_m(ierr, error_code, retval, exception)

  end subroutine Check_s


  recursive subroutine Describe_s(ierr, message, exception)
    implicit none
    !  in int ierr
    integer (kind=sidl_int) , intent(in) :: ierr
    !  out string message
    ...
    external bHYPRE_ErrorHandler_Describe_m
    call bHYPRE_ErrorHandler_Describe_m(ierr, message, exception)

  end subroutine Describe_s


  recursive subroutine newLocal_s(retval, exception)
    implicit none
    !  out bHYPRE.ErrorHandler retval
    type(bHYPRE_ErrorHandler_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_ErrorHandler_newLocal_m
    call bHYPRE_ErrorHandler_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(bHYPRE_ErrorHandler_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_ErrorHandler_newRemote_m
    call bHYPRE_ErrorHandler_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_ErrorHandler_rConnect_m
    call bHYPRE_ErrorHandler_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    implicit none
    !  in bHYPRE.ErrorHandler self
    type(bHYPRE_ErrorHandler_t) , intent(in) :: self
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_ErrorHandler_addRef_m
    call bHYPRE_ErrorHandler_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_ErrorHandler_deleteRef_m
    call bHYPRE_ErrorHandler_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_ErrorHandler_isSame_m
    call bHYPRE_ErrorHandler_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_ErrorHandler_isType_m
    call bHYPRE_ErrorHandler_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_ErrorHandler_getClassInfo_m
    call bHYPRE_ErrorHandler_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.ErrorHandler
  ! to sidl.BaseClass.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_ErrorHandler_t), intent(in) :: oldType
  ...
  ! to bHYPRE.ErrorHandler.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseClass_t), intent(in) :: oldType
    type(bHYPRE_ErrorHandler_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_ErrorHandler__cast_m

    call bHYPRE_ErrorHandler__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_ErrorHandler__exec_m
    call bHYPRE_ErrorHandler__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_ErrorHandler__getURL_m
    call bHYPRE_ErrorHandler__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_ErrorHandler__isRemote_m
    call bHYPRE_ErrorHandler__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_ErrorHandler__isLocal_m
    call bHYPRE_ErrorHandler__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_ErrorHandler__set_hooks_m
    call bHYPRE_ErrorHandler__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_ErrorHandler__set_hooks_static_m
    call bHYPRE_ErrorHandler__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_ErrorHandler_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_ErrorHandler_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_ErrorHandler

module bHYPRE_ErrorHandler_array
  use sidl
  use bHYPRE_ErrorHandler_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_ErrorHan44w904esb3_p, &
    castbHYPRE_ErrorHanppo9i9pyle_p, &
    castbHYPRE_ErrorHanajdv8f_w0f_p, &
    castbHYPRE_ErrorHanjb5_hzwi44_p, &
    castbHYPRE_ErrorHanw3v6v4zw74_p, &
    castbHYPRE_ErrorHant4fk7exih7_p, &
    castbHYPRE_ErrorHanj8cltzi2xb_p
interface cast
  module procedure &
    castbHYPRE_ErrorHan44w904esb3_p, &
    castbHYPRE_ErrorHanppo9i9pyle_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_1d), intent(out) :: array
    external Er_ary_createCole0i6_kpbed8cy_m
    call Er_ary_createCole0i6_kpbed8cy_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_ErrorHandler_1d), intent(out) :: array
    external Er_ary_createRows45asw4rd8p9l_m
    call Er_ary_createRows45asw4rd8p9l_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_ErrorHandler_1d), intent(out) :: array
    external Err_ary_create1dpmyn9h7lra512_m
    call Err_ary_create1dpmyn9h7lra512_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_ErrorHandler_1d), intent(in) :: src
    type(bHYPRE_ErrorHandler_1d), intent(in) :: dest
    external ErrorHa_ary_copybyu7kgyc6lgl__m
    call ErrorHa_ary_copybyu7kgyc6lgl__m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: src
    type(bHYPRE_ErrorHandler_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Error_ary_ensure7dl9irlglfi9i_m
    call Error_ary_ensure7dl9irlglfi9i_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external ErrorH_ary_slicea8mc6isq1dah4_m
    call ErrorH_ary_slicea8mc6isq1dah4_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_ErrorHandler_t), intent(out) :: value
    external ErrorHan_ary_getgymluxomxoff7_m
    call ErrorHan_ary_getgymluxomxoff7_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_ErrorHandler_t), intent(in) :: value
    external ErrorHan_ary_setrizpxwb7q8z2__m
    call ErrorHan_ary_setrizpxwb7q8z2__m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_ErrorHandler_t), intent(out) :: value
    external ErrorHa_ary_get1w70hjp_31787b_m
    call ErrorHa_ary_get1w70hjp_31787b_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_ErrorHandler_t), intent(in) :: value
    external ErrorHa_ary_set18tf993q2x7xf9_m
    call ErrorHa_ary_set18tf993q2x7xf9_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_ErrorHandler_1d), intent(in) :: src
    type(bHYPRE_ErrorHandler_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Er_ary_smartCopyq8bimj4i4anc1_m
    dim = 1
    call Er_ary_smartCopyq8bimj4i4anc1_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    external ary_isColumnOrderw_l71gdul0wb_m
    call ary_isColumnOrderw_l71gdul0wb_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    external E_ary_isRowOrderv_izaskpquoh__m
    call E_ary_isRowOrderv_izaskpquoh__m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    external ErrorH_ary_dimenndmn_9xwly12w_m
    call ErrorH_ary_dimenndmn_9xwly12w_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_stride7pc56pbokzaj__m
    call Error_ary_stride7pc56pbokzaj__m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_lowerhhksosj13fej4_m
    call ErrorH_ary_lowerhhksosj13fej4_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_upper4fmzp_4zkiadb_m
    call ErrorH_ary_upper4fmzp_4zkiadb_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_lengthhabmmwbpmn_hq_m
    call Error_ary_lengthhabmmwbpmn_hq_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    external Error_ary_addRefkavauslpzxbyo_m
    call Error_ary_addRefkavauslpzxbyo_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_ErrorHandler_1d), intent(in)  :: array
    external Er_ary_deleteRefv6znvs644i505_m
    call Er_ary_deleteRefv6znvs644i505_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_2d), intent(out) :: array
    external Er_ary_createCole0i6_kpbed8cy_m
    call Er_ary_createCole0i6_kpbed8cy_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_2d), intent(out) :: array
    external Er_ary_createRows45asw4rd8p9l_m
    call Er_ary_createRows45asw4rd8p9l_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_ErrorHandler_2d), intent(out) :: array
    external ary_create2dColf5lc8xisxmewyx_m
    call ary_create2dColf5lc8xisxmewyx_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_ErrorHandler_2d), intent(out) :: array
    external ary_create2dRown6vnz5zrfrhwtm_m
    call ary_create2dRown6vnz5zrfrhwtm_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_ErrorHandler_2d), intent(in) :: src
    type(bHYPRE_ErrorHandler_2d), intent(in) :: dest
    external ErrorHa_ary_copybyu7kgyc6lgl__m
    call ErrorHa_ary_copybyu7kgyc6lgl__m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_ErrorHandler_2d), intent(in)  :: src
    type(bHYPRE_ErrorHandler_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Error_ary_ensure7dl9irlglfi9i_m
    call Error_ary_ensure7dl9irlglfi9i_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ErrorH_ary_slicea8mc6isq1dah4_m
    call ErrorH_ary_slicea8mc6isq1dah4_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_ErrorHandler_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_ErrorHandler_t), intent(out) :: value
    external ErrorHa_ary_get2npxijswcjxm64_m
    call ErrorHa_ary_get2npxijswcjxm64_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_ErrorHandler_t), intent(in) :: value
    external ErrorHa_ary_set2y_wamkv0af0cm_m
    call ErrorHa_ary_set2y_wamkv0af0cm_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_ErrorHandler_2d), intent(in) :: src
    type(bHYPRE_ErrorHandler_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Er_ary_smartCopyq8bimj4i4anc1_m
    dim = 2
    call Er_ary_smartCopyq8bimj4i4anc1_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_ErrorHandler_2d), intent(in)  :: array
    external ary_isColumnOrderw_l71gdul0wb_m
    call ary_isColumnOrderw_l71gdul0wb_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_ErrorHandler_2d), intent(in)  :: array
    external E_ary_isRowOrderv_izaskpquoh__m
    call E_ary_isRowOrderv_izaskpquoh__m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_ErrorHandler_2d), intent(in)  :: array
    external ErrorH_ary_dimenndmn_9xwly12w_m
    call ErrorH_ary_dimenndmn_9xwly12w_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_stride7pc56pbokzaj__m
    call Error_ary_stride7pc56pbokzaj__m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_lowerhhksosj13fej4_m
    call ErrorH_ary_lowerhhksosj13fej4_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_upper4fmzp_4zkiadb_m
    call ErrorH_ary_upper4fmzp_4zkiadb_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_lengthhabmmwbpmn_hq_m
    call Error_ary_lengthhabmmwbpmn_hq_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_3d), intent(out) :: array
    external Er_ary_createCole0i6_kpbed8cy_m
    call Er_ary_createCole0i6_kpbed8cy_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_3d), intent(out) :: array
    external Er_ary_createRows45asw4rd8p9l_m
    call Er_ary_createRows45asw4rd8p9l_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_ErrorHandler_3d), intent(in) :: src
    type(bHYPRE_ErrorHandler_3d), intent(in) :: dest
    external ErrorHa_ary_copybyu7kgyc6lgl__m
    call ErrorHa_ary_copybyu7kgyc6lgl__m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_ErrorHandler_3d), intent(in)  :: src
    type(bHYPRE_ErrorHandler_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Error_ary_ensure7dl9irlglfi9i_m
    call Error_ary_ensure7dl9irlglfi9i_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ErrorH_ary_slicea8mc6isq1dah4_m
    call ErrorH_ary_slicea8mc6isq1dah4_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_ErrorHandler_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_ErrorHandler_t), intent(out) :: value
    external ErrorHa_ary_get3ytwblc482vqze_m
    call ErrorHa_ary_get3ytwblc482vqze_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_ErrorHandler_t), intent(in) :: value
    external ErrorHa_ary_set3uqws_mxi1wj_c_m
    call ErrorHa_ary_set3uqws_mxi1wj_c_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_ErrorHandler_3d), intent(in) :: src
    type(bHYPRE_ErrorHandler_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Er_ary_smartCopyq8bimj4i4anc1_m
    dim = 3
    call Er_ary_smartCopyq8bimj4i4anc1_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_ErrorHandler_3d), intent(in)  :: array
    external ary_isColumnOrderw_l71gdul0wb_m
    call ary_isColumnOrderw_l71gdul0wb_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_ErrorHandler_3d), intent(in)  :: array
    external E_ary_isRowOrderv_izaskpquoh__m
    call E_ary_isRowOrderv_izaskpquoh__m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_ErrorHandler_3d), intent(in)  :: array
    external ErrorH_ary_dimenndmn_9xwly12w_m
    call ErrorH_ary_dimenndmn_9xwly12w_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_stride7pc56pbokzaj__m
    call Error_ary_stride7pc56pbokzaj__m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_lowerhhksosj13fej4_m
    call ErrorH_ary_lowerhhksosj13fej4_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_upper4fmzp_4zkiadb_m
    call ErrorH_ary_upper4fmzp_4zkiadb_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_lengthhabmmwbpmn_hq_m
    call Error_ary_lengthhabmmwbpmn_hq_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_4d), intent(out) :: array
    external Er_ary_createCole0i6_kpbed8cy_m
    call Er_ary_createCole0i6_kpbed8cy_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_4d), intent(out) :: array
    external Er_ary_createRows45asw4rd8p9l_m
    call Er_ary_createRows45asw4rd8p9l_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_ErrorHandler_4d), intent(in) :: src
    type(bHYPRE_ErrorHandler_4d), intent(in) :: dest
    external ErrorHa_ary_copybyu7kgyc6lgl__m
    call ErrorHa_ary_copybyu7kgyc6lgl__m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_ErrorHandler_4d), intent(in)  :: src
    type(bHYPRE_ErrorHandler_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Error_ary_ensure7dl9irlglfi9i_m
    call Error_ary_ensure7dl9irlglfi9i_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ErrorH_ary_slicea8mc6isq1dah4_m
    call ErrorH_ary_slicea8mc6isq1dah4_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_ErrorHandler_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_ErrorHandler_t), intent(out) :: value
    external ErrorHa_ary_get4r39odjcbtcxaa_m
    call ErrorHa_ary_get4r39odjcbtcxaa_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_ErrorHandler_t), intent(in) :: value
    external ErrorHa_ary_set4lg396p8l3qfsj_m
    call ErrorHa_ary_set4lg396p8l3qfsj_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_ErrorHandler_4d), intent(in) :: src
    type(bHYPRE_ErrorHandler_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Er_ary_smartCopyq8bimj4i4anc1_m
    dim = 4
    call Er_ary_smartCopyq8bimj4i4anc1_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_ErrorHandler_4d), intent(in)  :: array
    external ary_isColumnOrderw_l71gdul0wb_m
    call ary_isColumnOrderw_l71gdul0wb_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_ErrorHandler_4d), intent(in)  :: array
    external E_ary_isRowOrderv_izaskpquoh__m
    call E_ary_isRowOrderv_izaskpquoh__m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_ErrorHandler_4d), intent(in)  :: array
    external ErrorH_ary_dimenndmn_9xwly12w_m
    call ErrorH_ary_dimenndmn_9xwly12w_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_stride7pc56pbokzaj__m
    call Error_ary_stride7pc56pbokzaj__m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_lowerhhksosj13fej4_m
    call ErrorH_ary_lowerhhksosj13fej4_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_upper4fmzp_4zkiadb_m
    call ErrorH_ary_upper4fmzp_4zkiadb_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_lengthhabmmwbpmn_hq_m
    call Error_ary_lengthhabmmwbpmn_hq_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_5d), intent(out) :: array
    external Er_ary_createCole0i6_kpbed8cy_m
    call Er_ary_createCole0i6_kpbed8cy_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_5d), intent(out) :: array
    external Er_ary_createRows45asw4rd8p9l_m
    call Er_ary_createRows45asw4rd8p9l_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_ErrorHandler_5d), intent(in) :: src
    type(bHYPRE_ErrorHandler_5d), intent(in) :: dest
    external ErrorHa_ary_copybyu7kgyc6lgl__m
    call ErrorHa_ary_copybyu7kgyc6lgl__m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_ErrorHandler_5d), intent(in)  :: src
    type(bHYPRE_ErrorHandler_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Error_ary_ensure7dl9irlglfi9i_m
    call Error_ary_ensure7dl9irlglfi9i_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ErrorH_ary_slicea8mc6isq1dah4_m
    call ErrorH_ary_slicea8mc6isq1dah4_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_ErrorHandler_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_ErrorHandler_t), intent(out) :: value
    external ErrorHa_ary_get5h3cvp85f1uhe3_m
    call ErrorHa_ary_get5h3cvp85f1uhe3_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_ErrorHandler_t), intent(in) :: value
    external ErrorHa_ary_set5xg8jl0w66hi6__m
    call ErrorHa_ary_set5xg8jl0w66hi6__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_ErrorHandler_5d), intent(in) :: src
    type(bHYPRE_ErrorHandler_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Er_ary_smartCopyq8bimj4i4anc1_m
    dim = 5
    call Er_ary_smartCopyq8bimj4i4anc1_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_ErrorHandler_5d), intent(in)  :: array
    external ary_isColumnOrderw_l71gdul0wb_m
    call ary_isColumnOrderw_l71gdul0wb_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_ErrorHandler_5d), intent(in)  :: array
    external E_ary_isRowOrderv_izaskpquoh__m
    call E_ary_isRowOrderv_izaskpquoh__m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_ErrorHandler_5d), intent(in)  :: array
    external ErrorH_ary_dimenndmn_9xwly12w_m
    call ErrorH_ary_dimenndmn_9xwly12w_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_stride7pc56pbokzaj__m
    call Error_ary_stride7pc56pbokzaj__m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_lowerhhksosj13fej4_m
    call ErrorH_ary_lowerhhksosj13fej4_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_upper4fmzp_4zkiadb_m
    call ErrorH_ary_upper4fmzp_4zkiadb_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_lengthhabmmwbpmn_hq_m
    call Error_ary_lengthhabmmwbpmn_hq_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_6d), intent(out) :: array
    external Er_ary_createCole0i6_kpbed8cy_m
    call Er_ary_createCole0i6_kpbed8cy_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_6d), intent(out) :: array
    external Er_ary_createRows45asw4rd8p9l_m
    call Er_ary_createRows45asw4rd8p9l_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_ErrorHandler_6d), intent(in) :: src
    type(bHYPRE_ErrorHandler_6d), intent(in) :: dest
    external ErrorHa_ary_copybyu7kgyc6lgl__m
    call ErrorHa_ary_copybyu7kgyc6lgl__m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_ErrorHandler_6d), intent(in)  :: src
    type(bHYPRE_ErrorHandler_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Error_ary_ensure7dl9irlglfi9i_m
    call Error_ary_ensure7dl9irlglfi9i_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ErrorH_ary_slicea8mc6isq1dah4_m
    call ErrorH_ary_slicea8mc6isq1dah4_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_ErrorHandler_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_ErrorHandler_t), intent(out) :: value
    external ErrorHa_ary_get6ptcby8vyas8eb_m
    call ErrorHa_ary_get6ptcby8vyas8eb_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_ErrorHandler_t), intent(in) :: value
    external ErrorHa_ary_set6vk26u5w7tgw3z_m
    call ErrorHa_ary_set6vk26u5w7tgw3z_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_ErrorHandler_6d), intent(in) :: src
    type(bHYPRE_ErrorHandler_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Er_ary_smartCopyq8bimj4i4anc1_m
    dim = 6
    call Er_ary_smartCopyq8bimj4i4anc1_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_ErrorHandler_6d), intent(in)  :: array
    external ary_isColumnOrderw_l71gdul0wb_m
    call ary_isColumnOrderw_l71gdul0wb_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_ErrorHandler_6d), intent(in)  :: array
    external E_ary_isRowOrderv_izaskpquoh__m
    call E_ary_isRowOrderv_izaskpquoh__m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_ErrorHandler_6d), intent(in)  :: array
    external ErrorH_ary_dimenndmn_9xwly12w_m
    call ErrorH_ary_dimenndmn_9xwly12w_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_stride7pc56pbokzaj__m
    call Error_ary_stride7pc56pbokzaj__m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_lowerhhksosj13fej4_m
    call ErrorH_ary_lowerhhksosj13fej4_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_upper4fmzp_4zkiadb_m
    call ErrorH_ary_upper4fmzp_4zkiadb_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_lengthhabmmwbpmn_hq_m
    call Error_ary_lengthhabmmwbpmn_hq_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_7d), intent(out) :: array
    external Er_ary_createCole0i6_kpbed8cy_m
    call Er_ary_createCole0i6_kpbed8cy_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_ErrorHandler_7d), intent(out) :: array
    external Er_ary_createRows45asw4rd8p9l_m
    call Er_ary_createRows45asw4rd8p9l_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_ErrorHandler_7d), intent(in) :: src
    type(bHYPRE_ErrorHandler_7d), intent(in) :: dest
    external ErrorHa_ary_copybyu7kgyc6lgl__m
    call ErrorHa_ary_copybyu7kgyc6lgl__m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_ErrorHandler_7d), intent(in)  :: src
    type(bHYPRE_ErrorHandler_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Error_ary_ensure7dl9irlglfi9i_m
    call Error_ary_ensure7dl9irlglfi9i_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external ErrorH_ary_slicea8mc6isq1dah4_m
    call ErrorH_ary_slicea8mc6isq1dah4_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_ErrorHandler_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_ErrorHandler_t), intent(out) :: value
    external ErrorHa_ary_get7t6jy8dgbsnkum_m
    call ErrorHa_ary_get7t6jy8dgbsnkum_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_ErrorHandler_t), intent(in) :: value
    external ErrorHa_ary_set7vt_5zai4tyvo4_m
    call ErrorHa_ary_set7vt_5zai4tyvo4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_ErrorHandler_7d), intent(in) :: src
    type(bHYPRE_ErrorHandler_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Er_ary_smartCopyq8bimj4i4anc1_m
    dim = 7
    call Er_ary_smartCopyq8bimj4i4anc1_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_ErrorHandler_7d), intent(in)  :: array
    external ary_isColumnOrderw_l71gdul0wb_m
    call ary_isColumnOrderw_l71gdul0wb_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_ErrorHandler_7d), intent(in)  :: array
    external E_ary_isRowOrderv_izaskpquoh__m
    call E_ary_isRowOrderv_izaskpquoh__m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_ErrorHandler_7d), intent(in)  :: array
    external ErrorH_ary_dimenndmn_9xwly12w_m
    call ErrorH_ary_dimenndmn_9xwly12w_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_stride7pc56pbokzaj__m
    call Error_ary_stride7pc56pbokzaj__m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_lowerhhksosj13fej4_m
    call ErrorH_ary_lowerhhksosj13fej4_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external ErrorH_ary_upper4fmzp_4zkiadb_m
    call ErrorH_ary_upper4fmzp_4zkiadb_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Error_ary_lengthhabmmwbpmn_hq_m
    call Error_ary_lengthhabmmwbpmn_hq_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_ErrorHan44w904esb3_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorHandler_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorHan44w904esb3_p

  subroutine castbHYPRE_ErrorHanppo9i9pyle_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorHandler_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorHanppo9i9pyle_p

  subroutine castbHYPRE_ErrorHanajdv8f_w0f_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorHandler_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorHanajdv8f_w0f_p

  subroutine castbHYPRE_ErrorHanjb5_hzwi44_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorHandler_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorHanjb5_hzwi44_p

  subroutine castbHYPRE_ErrorHanw3v6v4zw74_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorHandler_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorHanw3v6v4zw74_p

  subroutine castbHYPRE_ErrorHant4fk7exih7_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorHandler_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorHant4fk7exih7_p

  subroutine castbHYPRE_ErrorHanj8cltzi2xb_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ErrorHandler_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ErrorHanj8cltzi2xb_p


end module bHYPRE_ErrorHandler_array
