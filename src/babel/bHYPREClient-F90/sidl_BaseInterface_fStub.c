 ...
 * Revision:      @(#) $Id: sidl_BaseInterface_fStub.c,v 1.1 2007/02/06 01:23:05 painter Exp $
...
static struct sidl_BaseInterface__object* sidl_BaseInterface__IHConnect(struct 
...
void
SIDLFortran90Symbol(sidl_baseinterface_rconnect_m,SIDL_BASEINTERFACE_RCONNECT_M,sidl_BaseInterface_rConnect_m)
(
  int64_t *self,
  SIDL_F90_String url
...
)
{
  ...
  _proxy_self = sidl_BaseInterface__remoteConnect(_proxy_url, 1,
    &_proxy_exception);
  if (_proxy_exception) {
...
void
SIDLFortran90Symbol(sidl_baseinterface__cast_m,SIDL_BASEINTERFACE__CAST_M,sidl_BaseInterface__cast_m)
(
  int64_t *ref,
  int64_t *retval,
  int64_t *exception
  ...
  *retval = 0;
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.BaseInterface",
      (void*)sidl_BaseInterface__IHConnect, &proxy_exception);
  ...
  if (_base) {
    *retval = (ptrdiff_t)(
      *_base->d_epv->f__cast)(
      _base->d_object,
      "sidl.BaseInterface", &proxy_exception);
  } else {
    *retval = 0;
    proxy_exception = 0;
  }
...
void
SIDLFortran90Symbol(sidl_baseinterface__cast2_m,SIDL_BASEINTERFACE__CAST2_M,sidl_BaseInterface__cast2_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_baseinterface__exec_m,SIDL_BASEINTERFACE__EXEC_M,sidl_BaseInterface__exec_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_baseinterface__geturl_m,SIDL_BASEINTERFACE__GETURL_M,sidl_BaseInterface__getURL_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_baseinterface__isremote_m,SIDL_BASEINTERFACE__ISREMOTE_M,sidl_BaseInterface__isRemote_m)
(
  int64_t *self,
...
void
SIDLFortran90Symbol(sidl_baseinterface__islocal_m,SIDL_BASEINTERFACE__ISLOCAL_M,sidl_BaseInterface__isLocal_m)
(
  int64_t *self,
  SIDL_F90_Bool *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_baseinterface__set_hooks_m,SIDL_BASEINTERFACE__SET_HOOKS_M,sidl_BaseInterface__set_hooks_m)
(
  int64_t *self,
  SIDL_F90_Bool *on,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_baseinterface_addref_m,SIDL_BASEINTERFACE_ADDREF_M,sidl_BaseInterface_addRef_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(sidl_baseinterface_deleteref_m,SIDL_BASEINTERFACE_DELETEREF_M,sidl_BaseInterface_deleteRef_m)
(
  int64_t *self,
  int64_t *exception
)
...
void
SIDLFortran90Symbol(sidl_baseinterface_issame_m,SIDL_BASEINTERFACE_ISSAME_M,sidl_BaseInterface_isSame_m)
(
  int64_t *self,
  int64_t *iobj,
  SIDL_F90_Bool *retval,
...
void
SIDLFortran90Symbol(sidl_baseinterface_istype_m,SIDL_BASEINTERFACE_ISTYPE_M,sidl_BaseInterface_isType_m)
(
  int64_t *self,
  SIDL_F90_String name
  SIDL_F90_STR_NEAR_LEN_DECL(name),
...
void
SIDLFortran90Symbol(sidl_baseinterface_getclassinfo_m,SIDL_BASEINTERFACE_GETCLASSINFO_M,sidl_BaseInterface_getClassInfo_m)
(
  int64_t *self,
  int64_t *retval,
  int64_t *exception
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_createcol_m,
                  SIDL_BASEINTERFACE__ARRAY_CREATECOL_M,
                  sidl_BaseInterface__array_createCol_m)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_createrow_m,
                  SIDL_BASEINTERFACE__ARRAY_CREATEROW_M,
                  sidl_BaseInterface__array_createRow_m)
  (int32_t *dimen,
   int32_t lower[],
   int32_t upper[],
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_create1d_m,
                  SIDL_BASEINTERFACE__ARRAY_CREATE1D_M,
                  sidl_BaseInterface__array_create1d_m)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_create2dcol_m,
                  SIDL_BASEINTERFACE__ARRAY_CREATE2DCOL_M,
                  sidl_BaseInterface__array_create2dCol_m)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_create2drow_m,
                  SIDL_BASEINTERFACE__ARRAY_CREATE2DROW_M,
                  sidl_BaseInterface__array_create2dRow_m)
  (int32_t *m, int32_t *n, int64_t *result)
{
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_addref_m,
                  SIDL_BASEINTERFACE__ARRAY_ADDREF_M,
                  sidl_BaseInterface__array_addRef_m)
  (int64_t *array)
{
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_deleteref_m,
                  SIDL_BASEINTERFACE__ARRAY_DELETEREF_M,
                  sidl_BaseInterface__array_deleteRef_m)
  (int64_t *array)
{
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_get1_m,
                  SIDL_BASEINTERFACE__ARRAY_GET1_M,
                  sidl_BaseInterface__array_get1_m)
  (int64_t *array, 
   int32_t *i1, 
   int64_t *result)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_get2_m,
                  SIDL_BASEINTERFACE__ARRAY_GET2_M,
                  sidl_BaseInterface__array_get2_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_get3_m,
                  SIDL_BASEINTERFACE__ARRAY_GET3_M,
                  sidl_BaseInterface__array_get3_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_get4_m,
                  SIDL_BASEINTERFACE__ARRAY_GET4_M,
                  sidl_BaseInterface__array_get4_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_get5_m,
                  SIDL_BASEINTERFACE__ARRAY_GET5_M,
                  sidl_BaseInterface__array_get5_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_get6_m,
                  SIDL_BASEINTERFACE__ARRAY_GET6_M,
                  sidl_BaseInterface__array_get6_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_get7_m,
                  SIDL_BASEINTERFACE__ARRAY_GET7_M,
                  sidl_BaseInterface__array_get7_m)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_get_m,
                  SIDL_BASEINTERFACE__ARRAY_GET_M,
                  sidl_BaseInterface__array_get_m)
  (int64_t *array,
   int32_t indices[],
   int64_t *result)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_set1_m,
                  SIDL_BASEINTERFACE__ARRAY_SET1_M,
                  sidl_BaseInterface__array_set1_m)
  (int64_t *array,
   int32_t *i1,
   int64_t *value)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_set2_m,
                  SIDL_BASEINTERFACE__ARRAY_SET2_M,
                  sidl_BaseInterface__array_set2_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_set3_m,
                  SIDL_BASEINTERFACE__ARRAY_SET3_M,
                  sidl_BaseInterface__array_set3_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_set4_m,
                  SIDL_BASEINTERFACE__ARRAY_SET4_M,
                  sidl_BaseInterface__array_set4_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_set5_m,
                  SIDL_BASEINTERFACE__ARRAY_SET5_M,
                  sidl_BaseInterface__array_set5_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_set6_m,
                  SIDL_BASEINTERFACE__ARRAY_SET6_M,
                  sidl_BaseInterface__array_set6_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_set7_m,
                  SIDL_BASEINTERFACE__ARRAY_SET7_M,
                  sidl_BaseInterface__array_set7_m)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_set_m,
                  SIDL_BASEINTERFACE__ARRAY_SET_M,
                  sidl_BaseInterface__array_set_m)
  (int64_t *array,
  int32_t indices[],
  int64_t *value)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_dimen_m,
                  SIDL_BASEINTERFACE__ARRAY_DIMEN_M,
                  sidl_BaseInterface__array_dimen_m)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_lower_m,
                  SIDL_BASEINTERFACE__ARRAY_LOWER_M,
                  sidl_BaseInterface__array_lower_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_upper_m,
                  SIDL_BASEINTERFACE__ARRAY_UPPER_M,
                  sidl_BaseInterface__array_upper_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_length_m,
                  SIDL_BASEINTERFACE__ARRAY_LENGTH_M,
                  sidl_BaseInterface__array_length_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_stride_m,
                  SIDL_BASEINTERFACE__ARRAY_STRIDE_M,
                  sidl_BaseInterface__array_stride_m)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_iscolumnorder_m,
                  SIDL_BASEINTERFACE__ARRAY_ISCOLUMNORDER_M,
                  sidl_BaseInterface__array_isColumnOrder_m)
  (int64_t *array,
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_isroworder_m,
                  SIDL_BASEINTERFACE__ARRAY_ISROWORDER_M,
                  sidl_BaseInterface__array_isRowOrder_m)
  (int64_t *array,
   SIDL_F90_Bool *result)
{
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_copy_m,
                  SIDL_BASEINTERFACE__ARRAY_COPY_M,
                  sidl_BaseInterface__array_copy_m)
  (int64_t *src,
   int64_t *dest)
{
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_smartcopy_m,
                  SIDL_BASEINTERFACE__ARRAY_SMARTCOPY_M,
                  sidl_BaseInterface__array_smartCopy_m)
  (int64_t *src)
{
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_slice_m,
                  SIDL_BASEINTERFACE__ARRAY_SLICE_M,
                  sidl_BaseInterface__array_slice_m)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
...
void
SIDLFortran90Symbol(sidl_baseinterface__array_ensure_m,
                  SIDL_BASEINTERFACE__ARRAY_ENSURE_M,
                  sidl_BaseInterface__array_ensure_m)
  (int64_t *src,
   int32_t *dimen,
   int     *ordering,
