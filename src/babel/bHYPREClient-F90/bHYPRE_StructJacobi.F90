...
module bHYPRE_StructJacobi

  use sidl
  use bHYPRE_Solver_type
  use bHYPRE_StructMatrix_type
...
interface bHYPRE_StructJacobi__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(mpi_comm, A, retval, exception)
    ...
    type(bHYPRE_StructMatrix_t) , intent(in) :: A
    !  out bHYPRE.StructJacobi retval
    type(bHYPRE_StructJacobi_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructJacobi_Create_m
    call bHYPRE_StructJacobi_Create_m(mpi_comm, A, retval, exception)
  ...
  recursive subroutine SetOperator_s(self, A, retval, exception)
    implicit none
    !  in bHYPRE.StructJacobi self
    type(bHYPRE_StructJacobi_t) , intent(in) :: self
    ...
    external bHYPRE_StructJacobi_SetOperator_m
    call bHYPRE_StructJacobi_SetOperator_m(self, A, retval, exception)
  ...
  recursive subroutine SetTolerance_s(self, tolerance, retval, exception)
    ...
    external bHYPRE_StructJacobi_SetTolerance_m
    call bHYPRE_StructJacobi_SetTolerance_m(self, tolerance, retval,           &
      exception)
  ...
  recursive subroutine SetMaxIterations_s(self, max_iterations, retval,        &
    ...
    external bHYPRE_StructJacobi_SetMaxIterations_m
    call bHYPRE_StructJacobi_SetMaxIterations_m(self, max_iterations, retval,  &
      exception)
  ...
  recursive subroutine SetLogging_s(self, level, retval, exception)
    ...
    external bHYPRE_StructJacobi_SetLogging_m
    call bHYPRE_StructJacobi_SetLogging_m(self, level, retval, exception)
  ...
  recursive subroutine SetPrintLevel_s(self, level, retval, exception)
    ...
    external bHYPRE_StructJacobi_SetPrintLevel_m
    call bHYPRE_StructJacobi_SetPrintLevel_m(self, level, retval, exception)
  ...
  recursive subroutine GetNumIterations_s(self, num_iterations, retval,        &
    ...
    external bHYPRE_StructJacobi_GetNumIterations_m
    call bHYPRE_StructJacobi_GetNumIterations_m(self, num_iterations, retval,  &
      exception)
  ...
  recursive subroutine GetRelResidualNorm_s(self, norm, retval, exception)
    ...
    external bHYPRE_StructJacobi_GetRelResidualNorm_m
    call bHYPRE_StructJacobi_GetRelResidualNorm_m(self, norm, retval,          &
      exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_StructJacobi_SetCommunicator_m
    call bHYPRE_StructJacobi_SetCommunicator_m(self, mpi_comm, retval,         &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_StructJacobi_Destroy_m
    call bHYPRE_StructJacobi_Destroy_m(self, exception)
  ...
  recursive subroutine SetIntParameter_s(self, name, value, retval, exception)
    ...
    external bHYPRE_StructJacobi_SetIntParameter_m
    call bHYPRE_StructJacobi_SetIntParameter_m(self, name, value, retval,      &
      exception)
  ...
  recursive subroutine SetDoubleParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_StructJacobi_SetDoubleParameter_m
    call bHYPRE_StructJacobi_SetDoubleParameter_m(self, name, value, retval,   &
      exception)
  ...
  recursive subroutine SetStringParameter_s(self, name, value, retval,         &
    ...
    external bHYPRE_StructJacobi_SetStringParameter_m
    call bHYPRE_StructJacobi_SetStringParameter_m(self, name, value, retval,   &
      exception)
  ...
  recursive subroutine SetIntArray1Parameter_1s(self, name, value, retval,     &
    ...
    external bHYPRE_StructJacobi_SetIntArray1Parameter_a
    call bHYPRE_StructJacobi_SetIntArray1Parameter_a(self, name, value,        &
      retval, exception)
  ...
  recursive subroutine SetIntArray1Parameter_2s(self, name, value, retval,     &
    ...
    external bHYPRE_StructJacobi_SetIntArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_StructJacobi_SetIntArray1Parameter_m(self, name, value,        &
  ...
  recursive subroutine SetIntArray2Parameter_s(self, name, value, retval,      &
    ...
    external bHYPRE_StructJacobi_SetIntArray2Parameter_m
    call bHYPRE_StructJacobi_SetIntArray2Parameter_m(self, name, value,        &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_1s(self, name, value, retval,  &
    ...
    external bHYPRE_StructJacobi_SetDoubleArray1Parameter_a
    call bHYPRE_StructJacobi_SetDoubleArray1Parameter_a(self, name, value,     &
      retval, exception)
  ...
  recursive subroutine SetDoubleArray1Parameter_2s(self, name, value, retval,  &
    ...
    external bHYPRE_StructJacobi_SetDoubleArray1Parameter_m
    nvalues = size(value, 1)
    call bHYPRE_StructJacobi_SetDoubleArray1Parameter_m(self, name, value,     &
      nvalues, retval, exception)
  ...
  recursive subroutine SetDoubleArray2Parameter_s(self, name, value, retval,   &
    ...
    external bHYPRE_StructJacobi_SetDoubleArray2Parameter_m
    call bHYPRE_StructJacobi_SetDoubleArray2Parameter_m(self, name, value,     &
      retval, exception)
  ...
  recursive subroutine GetIntValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_StructJacobi_GetIntValue_m
    call bHYPRE_StructJacobi_GetIntValue_m(self, name, value, retval,          &
      exception)
  ...
  recursive subroutine GetDoubleValue_s(self, name, value, retval, exception)
    ...
    external bHYPRE_StructJacobi_GetDoubleValue_m
    call bHYPRE_StructJacobi_GetDoubleValue_m(self, name, value, retval,       &
      exception)
  ...
  recursive subroutine Setup_s(self, b, x, retval, exception)
    ...
    external bHYPRE_StructJacobi_Setup_m
    call bHYPRE_StructJacobi_Setup_m(self, b, x, retval, exception)
  ...
  recursive subroutine Apply_s(self, b, x, retval, exception)
    ...
    external bHYPRE_StructJacobi_Apply_m
    call bHYPRE_StructJacobi_Apply_m(self, b, x, retval, exception)
  ...
  recursive subroutine ApplyAdjoint_s(self, b, x, retval, exception)
    ...
    external bHYPRE_StructJacobi_ApplyAdjoint_m
    call bHYPRE_StructJacobi_ApplyAdjoint_m(self, b, x, retval, exception)
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_StructJacobi_newLocal_m
    call bHYPRE_StructJacobi_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(bHYPRE_StructJacobi_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructJacobi_newRemote_m
    call bHYPRE_StructJacobi_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_StructJacobi_rConnect_m
    call bHYPRE_StructJacobi_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_StructJacobi_addRef_m
    call bHYPRE_StructJacobi_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_StructJacobi_deleteRef_m
    call bHYPRE_StructJacobi_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_StructJacobi_isSame_m
    call bHYPRE_StructJacobi_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_StructJacobi_isType_m
    call bHYPRE_StructJacobi_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_StructJacobi_getClassInfo_m
    call bHYPRE_StructJacobi_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.StructJacobi
  ! to bHYPRE.Operator.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_StructJacobi_t), intent(in) :: oldType
  ...
  ! to bHYPRE.StructJacobi.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_Operator_t), intent(in) :: oldType
    type(bHYPRE_StructJacobi_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_StructJacobi__cast_m

    call bHYPRE_StructJacobi__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_StructJacobi__exec_m
    call bHYPRE_StructJacobi__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_StructJacobi__getURL_m
    call bHYPRE_StructJacobi__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_StructJacobi__isRemote_m
    call bHYPRE_StructJacobi__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_StructJacobi__isLocal_m
    call bHYPRE_StructJacobi__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_StructJacobi__set_hooks_m
    call bHYPRE_StructJacobi__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_StructJacobi__set_hooks_static_m
    call bHYPRE_StructJacobi__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_StructJacobi_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_StructJacobi_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_StructJacobi

module bHYPRE_StructJacobi_array
  use sidl
  use bHYPRE_StructJacobi_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_StructJa7mr5bavfg1_p, &
    castbHYPRE_StructJab7hrdp15ss_p, &
    castbHYPRE_StructJaeklllja6jd_p, &
    castbHYPRE_StructJamok4msa5e0_p, &
    castbHYPRE_StructJad48wnqfa0__p, &
    castbHYPRE_StructJa2ugsywplyf_p, &
    castbHYPRE_StructJa7i4a7czhzc_p
interface cast
  module procedure &
    castbHYPRE_StructJa7mr5bavfg1_p, &
    castbHYPRE_StructJab7hrdp15ss_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_1d), intent(out) :: array
    external St_ary_createColhfkd2g2zzx0ye_m
    call St_ary_createColhfkd2g2zzx0ye_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_StructJacobi_1d), intent(out) :: array
    external St_ary_createRowyfjy9_2chxf8o_m
    call St_ary_createRowyfjy9_2chxf8o_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_StructJacobi_1d), intent(out) :: array
    external Str_ary_create1d1ztkd07h1qky5_m
    call Str_ary_create1d1ztkd07h1qky5_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_StructJacobi_1d), intent(in) :: src
    type(bHYPRE_StructJacobi_1d), intent(in) :: dest
    external StructJ_ary_copy3xllrssil6g_k_m
    call StructJ_ary_copy3xllrssil6g_k_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: src
    type(bHYPRE_StructJacobi_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurek5zdnolowx292_m
    call Struc_ary_ensurek5zdnolowx292_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Struct_ary_slicex3qc6mq75u9f0_m
    call Struct_ary_slicex3qc6mq75u9f0_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructJacobi_t), intent(out) :: value
    external StructJa_ary_geta8uf02swy_z2d_m
    call StructJa_ary_geta8uf02swy_z2d_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructJacobi_t), intent(in) :: value
    external StructJa_ary_set8rekwyuucuaht_m
    call StructJa_ary_set8rekwyuucuaht_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_StructJacobi_t), intent(out) :: value
    external StructJ_ary_get1a11v4ica1vei__m
    call StructJ_ary_get1a11v4ica1vei__m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_StructJacobi_t), intent(in) :: value
    external StructJ_ary_set138sadzd6n1lxj_m
    call StructJ_ary_set138sadzd6n1lxj_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_StructJacobi_1d), intent(in) :: src
    type(bHYPRE_StructJacobi_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopytf6aq2i2mwxt__m
    dim = 1
    call St_ary_smartCopytf6aq2i2mwxt__m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    external ary_isColumnOrderwbcwueuxmh8w_m
    call ary_isColumnOrderwbcwueuxmh8w_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    external S_ary_isRowOrder99_i5e3fnhj0i_m
    call S_ary_isRowOrder99_i5e3fnhj0i_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    external Struct_ary_dimenugayglvv033f1_m
    call Struct_ary_dimenugayglvv033f1_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride2un6ghtis_5_7_m
    call Struc_ary_stride2un6ghtis_5_7_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower7e4kfbbke37cn_m
    call Struct_ary_lower7e4kfbbke37cn_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperc2p1bpytqe_hw_m
    call Struct_ary_upperc2p1bpytqe_hw_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthkmq5mtdj0c8v5_m
    call Struc_ary_lengthkmq5mtdj0c8v5_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    external Struc_ary_addRef8e5wf44bk0pvc_m
    call Struc_ary_addRef8e5wf44bk0pvc_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_StructJacobi_1d), intent(in)  :: array
    external St_ary_deleteRefyxyhcx66v0t2z_m
    call St_ary_deleteRefyxyhcx66v0t2z_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_2d), intent(out) :: array
    external St_ary_createColhfkd2g2zzx0ye_m
    call St_ary_createColhfkd2g2zzx0ye_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_2d), intent(out) :: array
    external St_ary_createRowyfjy9_2chxf8o_m
    call St_ary_createRowyfjy9_2chxf8o_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructJacobi_2d), intent(out) :: array
    external ary_create2dCol7n3n8qer80dwr9_m
    call ary_create2dCol7n3n8qer80dwr9_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructJacobi_2d), intent(out) :: array
    external ary_create2dRowhjthov3qnfaiwv_m
    call ary_create2dRowhjthov3qnfaiwv_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_StructJacobi_2d), intent(in) :: src
    type(bHYPRE_StructJacobi_2d), intent(in) :: dest
    external StructJ_ary_copy3xllrssil6g_k_m
    call StructJ_ary_copy3xllrssil6g_k_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_StructJacobi_2d), intent(in)  :: src
    type(bHYPRE_StructJacobi_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurek5zdnolowx292_m
    call Struc_ary_ensurek5zdnolowx292_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicex3qc6mq75u9f0_m
    call Struct_ary_slicex3qc6mq75u9f0_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_StructJacobi_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_StructJacobi_t), intent(out) :: value
    external StructJ_ary_get2l1yff_56u7pgp_m
    call StructJ_ary_get2l1yff_56u7pgp_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_StructJacobi_t), intent(in) :: value
    external StructJ_ary_set2ge2wrq32fkcn3_m
    call StructJ_ary_set2ge2wrq32fkcn3_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_StructJacobi_2d), intent(in) :: src
    type(bHYPRE_StructJacobi_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopytf6aq2i2mwxt__m
    dim = 2
    call St_ary_smartCopytf6aq2i2mwxt__m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_StructJacobi_2d), intent(in)  :: array
    external ary_isColumnOrderwbcwueuxmh8w_m
    call ary_isColumnOrderwbcwueuxmh8w_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_StructJacobi_2d), intent(in)  :: array
    external S_ary_isRowOrder99_i5e3fnhj0i_m
    call S_ary_isRowOrder99_i5e3fnhj0i_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_StructJacobi_2d), intent(in)  :: array
    external Struct_ary_dimenugayglvv033f1_m
    call Struct_ary_dimenugayglvv033f1_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride2un6ghtis_5_7_m
    call Struc_ary_stride2un6ghtis_5_7_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower7e4kfbbke37cn_m
    call Struct_ary_lower7e4kfbbke37cn_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperc2p1bpytqe_hw_m
    call Struct_ary_upperc2p1bpytqe_hw_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthkmq5mtdj0c8v5_m
    call Struc_ary_lengthkmq5mtdj0c8v5_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_3d), intent(out) :: array
    external St_ary_createColhfkd2g2zzx0ye_m
    call St_ary_createColhfkd2g2zzx0ye_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_3d), intent(out) :: array
    external St_ary_createRowyfjy9_2chxf8o_m
    call St_ary_createRowyfjy9_2chxf8o_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_StructJacobi_3d), intent(in) :: src
    type(bHYPRE_StructJacobi_3d), intent(in) :: dest
    external StructJ_ary_copy3xllrssil6g_k_m
    call StructJ_ary_copy3xllrssil6g_k_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_StructJacobi_3d), intent(in)  :: src
    type(bHYPRE_StructJacobi_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurek5zdnolowx292_m
    call Struc_ary_ensurek5zdnolowx292_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicex3qc6mq75u9f0_m
    call Struct_ary_slicex3qc6mq75u9f0_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_StructJacobi_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_StructJacobi_t), intent(out) :: value
    external StructJ_ary_get3xw5efy7xx0qs__m
    call StructJ_ary_get3xw5efy7xx0qs__m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_StructJacobi_t), intent(in) :: value
    external StructJ_ary_set39secjkzxsxjes_m
    call StructJ_ary_set39secjkzxsxjes_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_StructJacobi_3d), intent(in) :: src
    type(bHYPRE_StructJacobi_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopytf6aq2i2mwxt__m
    dim = 3
    call St_ary_smartCopytf6aq2i2mwxt__m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_StructJacobi_3d), intent(in)  :: array
    external ary_isColumnOrderwbcwueuxmh8w_m
    call ary_isColumnOrderwbcwueuxmh8w_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_StructJacobi_3d), intent(in)  :: array
    external S_ary_isRowOrder99_i5e3fnhj0i_m
    call S_ary_isRowOrder99_i5e3fnhj0i_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_StructJacobi_3d), intent(in)  :: array
    external Struct_ary_dimenugayglvv033f1_m
    call Struct_ary_dimenugayglvv033f1_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride2un6ghtis_5_7_m
    call Struc_ary_stride2un6ghtis_5_7_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower7e4kfbbke37cn_m
    call Struct_ary_lower7e4kfbbke37cn_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperc2p1bpytqe_hw_m
    call Struct_ary_upperc2p1bpytqe_hw_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthkmq5mtdj0c8v5_m
    call Struc_ary_lengthkmq5mtdj0c8v5_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_4d), intent(out) :: array
    external St_ary_createColhfkd2g2zzx0ye_m
    call St_ary_createColhfkd2g2zzx0ye_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_4d), intent(out) :: array
    external St_ary_createRowyfjy9_2chxf8o_m
    call St_ary_createRowyfjy9_2chxf8o_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_StructJacobi_4d), intent(in) :: src
    type(bHYPRE_StructJacobi_4d), intent(in) :: dest
    external StructJ_ary_copy3xllrssil6g_k_m
    call StructJ_ary_copy3xllrssil6g_k_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_StructJacobi_4d), intent(in)  :: src
    type(bHYPRE_StructJacobi_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurek5zdnolowx292_m
    call Struc_ary_ensurek5zdnolowx292_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicex3qc6mq75u9f0_m
    call Struct_ary_slicex3qc6mq75u9f0_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_StructJacobi_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_StructJacobi_t), intent(out) :: value
    external StructJ_ary_get4qxuqn39l8nz1x_m
    call StructJ_ary_get4qxuqn39l8nz1x_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_StructJacobi_t), intent(in) :: value
    external StructJ_ary_set4aw63toad4rg64_m
    call StructJ_ary_set4aw63toad4rg64_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_StructJacobi_4d), intent(in) :: src
    type(bHYPRE_StructJacobi_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopytf6aq2i2mwxt__m
    dim = 4
    call St_ary_smartCopytf6aq2i2mwxt__m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_StructJacobi_4d), intent(in)  :: array
    external ary_isColumnOrderwbcwueuxmh8w_m
    call ary_isColumnOrderwbcwueuxmh8w_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_StructJacobi_4d), intent(in)  :: array
    external S_ary_isRowOrder99_i5e3fnhj0i_m
    call S_ary_isRowOrder99_i5e3fnhj0i_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_StructJacobi_4d), intent(in)  :: array
    external Struct_ary_dimenugayglvv033f1_m
    call Struct_ary_dimenugayglvv033f1_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride2un6ghtis_5_7_m
    call Struc_ary_stride2un6ghtis_5_7_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower7e4kfbbke37cn_m
    call Struct_ary_lower7e4kfbbke37cn_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperc2p1bpytqe_hw_m
    call Struct_ary_upperc2p1bpytqe_hw_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthkmq5mtdj0c8v5_m
    call Struc_ary_lengthkmq5mtdj0c8v5_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_5d), intent(out) :: array
    external St_ary_createColhfkd2g2zzx0ye_m
    call St_ary_createColhfkd2g2zzx0ye_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_5d), intent(out) :: array
    external St_ary_createRowyfjy9_2chxf8o_m
    call St_ary_createRowyfjy9_2chxf8o_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_StructJacobi_5d), intent(in) :: src
    type(bHYPRE_StructJacobi_5d), intent(in) :: dest
    external StructJ_ary_copy3xllrssil6g_k_m
    call StructJ_ary_copy3xllrssil6g_k_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_StructJacobi_5d), intent(in)  :: src
    type(bHYPRE_StructJacobi_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurek5zdnolowx292_m
    call Struc_ary_ensurek5zdnolowx292_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicex3qc6mq75u9f0_m
    call Struct_ary_slicex3qc6mq75u9f0_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_StructJacobi_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_StructJacobi_t), intent(out) :: value
    external StructJ_ary_get57a5dppg8g0ney_m
    call StructJ_ary_get57a5dppg8g0ney_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_StructJacobi_t), intent(in) :: value
    external StructJ_ary_set5jvtvq50w4mm8y_m
    call StructJ_ary_set5jvtvq50w4mm8y_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_StructJacobi_5d), intent(in) :: src
    type(bHYPRE_StructJacobi_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopytf6aq2i2mwxt__m
    dim = 5
    call St_ary_smartCopytf6aq2i2mwxt__m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_StructJacobi_5d), intent(in)  :: array
    external ary_isColumnOrderwbcwueuxmh8w_m
    call ary_isColumnOrderwbcwueuxmh8w_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_StructJacobi_5d), intent(in)  :: array
    external S_ary_isRowOrder99_i5e3fnhj0i_m
    call S_ary_isRowOrder99_i5e3fnhj0i_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_StructJacobi_5d), intent(in)  :: array
    external Struct_ary_dimenugayglvv033f1_m
    call Struct_ary_dimenugayglvv033f1_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride2un6ghtis_5_7_m
    call Struc_ary_stride2un6ghtis_5_7_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower7e4kfbbke37cn_m
    call Struct_ary_lower7e4kfbbke37cn_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperc2p1bpytqe_hw_m
    call Struct_ary_upperc2p1bpytqe_hw_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthkmq5mtdj0c8v5_m
    call Struc_ary_lengthkmq5mtdj0c8v5_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_6d), intent(out) :: array
    external St_ary_createColhfkd2g2zzx0ye_m
    call St_ary_createColhfkd2g2zzx0ye_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_6d), intent(out) :: array
    external St_ary_createRowyfjy9_2chxf8o_m
    call St_ary_createRowyfjy9_2chxf8o_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_StructJacobi_6d), intent(in) :: src
    type(bHYPRE_StructJacobi_6d), intent(in) :: dest
    external StructJ_ary_copy3xllrssil6g_k_m
    call StructJ_ary_copy3xllrssil6g_k_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_StructJacobi_6d), intent(in)  :: src
    type(bHYPRE_StructJacobi_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurek5zdnolowx292_m
    call Struc_ary_ensurek5zdnolowx292_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicex3qc6mq75u9f0_m
    call Struct_ary_slicex3qc6mq75u9f0_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_StructJacobi_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_StructJacobi_t), intent(out) :: value
    external StructJ_ary_get6w70g_jzr_3fhp_m
    call StructJ_ary_get6w70g_jzr_3fhp_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_StructJacobi_t), intent(in) :: value
    external StructJ_ary_set6gb6lw4kh_l0y0_m
    call StructJ_ary_set6gb6lw4kh_l0y0_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_StructJacobi_6d), intent(in) :: src
    type(bHYPRE_StructJacobi_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopytf6aq2i2mwxt__m
    dim = 6
    call St_ary_smartCopytf6aq2i2mwxt__m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_StructJacobi_6d), intent(in)  :: array
    external ary_isColumnOrderwbcwueuxmh8w_m
    call ary_isColumnOrderwbcwueuxmh8w_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_StructJacobi_6d), intent(in)  :: array
    external S_ary_isRowOrder99_i5e3fnhj0i_m
    call S_ary_isRowOrder99_i5e3fnhj0i_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_StructJacobi_6d), intent(in)  :: array
    external Struct_ary_dimenugayglvv033f1_m
    call Struct_ary_dimenugayglvv033f1_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride2un6ghtis_5_7_m
    call Struc_ary_stride2un6ghtis_5_7_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower7e4kfbbke37cn_m
    call Struct_ary_lower7e4kfbbke37cn_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperc2p1bpytqe_hw_m
    call Struct_ary_upperc2p1bpytqe_hw_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthkmq5mtdj0c8v5_m
    call Struc_ary_lengthkmq5mtdj0c8v5_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_7d), intent(out) :: array
    external St_ary_createColhfkd2g2zzx0ye_m
    call St_ary_createColhfkd2g2zzx0ye_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_StructJacobi_7d), intent(out) :: array
    external St_ary_createRowyfjy9_2chxf8o_m
    call St_ary_createRowyfjy9_2chxf8o_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_StructJacobi_7d), intent(in) :: src
    type(bHYPRE_StructJacobi_7d), intent(in) :: dest
    external StructJ_ary_copy3xllrssil6g_k_m
    call StructJ_ary_copy3xllrssil6g_k_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_StructJacobi_7d), intent(in)  :: src
    type(bHYPRE_StructJacobi_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensurek5zdnolowx292_m
    call Struc_ary_ensurek5zdnolowx292_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slicex3qc6mq75u9f0_m
    call Struct_ary_slicex3qc6mq75u9f0_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_StructJacobi_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_StructJacobi_t), intent(out) :: value
    external StructJ_ary_get7gfacc_jjdfd1k_m
    call StructJ_ary_get7gfacc_jjdfd1k_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_StructJacobi_t), intent(in) :: value
    external StructJ_ary_set7rfbaht9ujyn67_m
    call StructJ_ary_set7rfbaht9ujyn67_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_StructJacobi_7d), intent(in) :: src
    type(bHYPRE_StructJacobi_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopytf6aq2i2mwxt__m
    dim = 7
    call St_ary_smartCopytf6aq2i2mwxt__m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_StructJacobi_7d), intent(in)  :: array
    external ary_isColumnOrderwbcwueuxmh8w_m
    call ary_isColumnOrderwbcwueuxmh8w_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_StructJacobi_7d), intent(in)  :: array
    external S_ary_isRowOrder99_i5e3fnhj0i_m
    call S_ary_isRowOrder99_i5e3fnhj0i_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_StructJacobi_7d), intent(in)  :: array
    external Struct_ary_dimenugayglvv033f1_m
    call Struct_ary_dimenugayglvv033f1_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_stride2un6ghtis_5_7_m
    call Struc_ary_stride2un6ghtis_5_7_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lower7e4kfbbke37cn_m
    call Struct_ary_lower7e4kfbbke37cn_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperc2p1bpytqe_hw_m
    call Struct_ary_upperc2p1bpytqe_hw_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthkmq5mtdj0c8v5_m
    call Struc_ary_lengthkmq5mtdj0c8v5_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_StructJa7mr5bavfg1_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructJacobi_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructJa7mr5bavfg1_p

  subroutine castbHYPRE_StructJab7hrdp15ss_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructJacobi_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructJab7hrdp15ss_p

  subroutine castbHYPRE_StructJaeklllja6jd_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructJacobi_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructJaeklllja6jd_p

  subroutine castbHYPRE_StructJamok4msa5e0_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructJacobi_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructJamok4msa5e0_p

  subroutine castbHYPRE_StructJad48wnqfa0__p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructJacobi_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructJad48wnqfa0__p

  subroutine castbHYPRE_StructJa2ugsywplyf_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructJacobi_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructJa2ugsywplyf_p

  subroutine castbHYPRE_StructJa7i4a7czhzc_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructJacobi_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructJa7i4a7czhzc_p


end module bHYPRE_StructJacobi_array
