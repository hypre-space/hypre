...
interface bHYPRE_StructVector__set_hooks_static
...
contains
  ...
  recursive subroutine Create_s(mpi_comm, grid, retval, exception)
    ...
    !  out bHYPRE.StructVector retval
    type(bHYPRE_StructVector_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructVector_Create_m
    call bHYPRE_StructVector_Create_m(mpi_comm, grid, retval, exception)
  ...
  recursive subroutine SetGrid_s(self, grid, retval, exception)
    implicit none
    !  in bHYPRE.StructVector self
    type(bHYPRE_StructVector_t) , intent(in) :: self
    !  in bHYPRE.StructGrid grid
    type(bHYPRE_StructGrid_t) , intent(in) :: grid
    !  out int retval
    ...
    external bHYPRE_StructVector_SetGrid_m
    call bHYPRE_StructVector_SetGrid_m(self, grid, retval, exception)
  ...
  recursive subroutine SetNumGhost_1s(self, num_ghost, retval, exception)
    ...
    external bHYPRE_StructVector_SetNumGhost_a
    call bHYPRE_StructVector_SetNumGhost_a(self, num_ghost, retval, exception)
  ...
  recursive subroutine SetNumGhost_2s(self, num_ghost, retval, exception)
    ...
    external bHYPRE_StructVector_SetNumGhost_m
    dim2 = size(num_ghost, 1)
    call bHYPRE_StructVector_SetNumGhost_m(self, num_ghost, dim2, retval,      &
      exception)
  ...
  recursive subroutine SetValue_1s(self, grid_index, value, retval, exception)
    ...
    external bHYPRE_StructVector_SetValue_a
    call bHYPRE_StructVector_SetValue_a(self, grid_index, value, retval,       &
      exception)
  ...
  recursive subroutine SetValue_2s(self, grid_index, value, retval, exception)
    ...
    external bHYPRE_StructVector_SetValue_m
    dim = size(grid_index, 1)
    call bHYPRE_StructVector_SetValue_m(self, grid_index, dim, value, retval,  &
      exception)
  ...
  recursive subroutine SetBoxValues_1s(self, ilower, iupper, values, retval,   &
    ...
    external bHYPRE_StructVector_SetBoxValues_a
    call bHYPRE_StructVector_SetBoxValues_a(self, ilower, iupper, values,      &
      retval, exception)
  ...
  recursive subroutine SetBoxValues_2s(self, ilower, iupper, values, retval,   &
    ...
    external bHYPRE_StructVector_SetBoxValues_m
    nvalues = size(values, 1)
    dim = size(iupper, 1)
    call bHYPRE_StructVector_SetBoxValues_m(self, ilower, iupper, dim, values, &
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    ...
    external bHYPRE_StructVector_SetCommunicator_m
    call bHYPRE_StructVector_SetCommunicator_m(self, mpi_comm, retval,         &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_StructVector_Destroy_m
    call bHYPRE_StructVector_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_StructVector_Initialize_m
    call bHYPRE_StructVector_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_StructVector_Assemble_m
    call bHYPRE_StructVector_Assemble_m(self, retval, exception)
  ...
  recursive subroutine Clear_s(self, retval, exception)
    ...
    external bHYPRE_StructVector_Clear_m
    call bHYPRE_StructVector_Clear_m(self, retval, exception)
  ...
  recursive subroutine Copy_s(self, x, retval, exception)
    ...
    external bHYPRE_StructVector_Copy_m
    call bHYPRE_StructVector_Copy_m(self, x, retval, exception)
  ...
  recursive subroutine Clone_s(self, x, retval, exception)
    ...
    external bHYPRE_StructVector_Clone_m
    call bHYPRE_StructVector_Clone_m(self, x, retval, exception)
  ...
  recursive subroutine Scale_s(self, a, retval, exception)
    ...
    external bHYPRE_StructVector_Scale_m
    call bHYPRE_StructVector_Scale_m(self, a, retval, exception)
  ...
  recursive subroutine Dot_s(self, x, d, retval, exception)
    ...
    external bHYPRE_StructVector_Dot_m
    call bHYPRE_StructVector_Dot_m(self, x, d, retval, exception)
  ...
  recursive subroutine Axpy_s(self, a, x, retval, exception)
    ...
    external bHYPRE_StructVector_Axpy_m
    call bHYPRE_StructVector_Axpy_m(self, a, x, retval, exception)
  ...
  recursive subroutine newLocal_s(retval, exception)
    ...
    external bHYPRE_StructVector_newLocal_m
    call bHYPRE_StructVector_newLocal_m(retval, exception)
  ...
  recursive subroutine newRemote_s(self, url, exception)
    ...
    type(bHYPRE_StructVector_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_StructVector_newRemote_m
    call bHYPRE_StructVector_newRemote_m(self, url, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    external bHYPRE_StructVector_rConnect_m
    call bHYPRE_StructVector_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_StructVector_addRef_m
    call bHYPRE_StructVector_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_StructVector_deleteRef_m
    call bHYPRE_StructVector_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_StructVector_isSame_m
    call bHYPRE_StructVector_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_StructVector_isType_m
    call bHYPRE_StructVector_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_StructVector_getClassInfo_m
    call bHYPRE_StructVector_getClassInfo_m(self, retval, exception)

  end subroutine getClassInfo_s

  ! 
  ! Static function to cast from bHYPRE.StructVector
  ! to bHYPRE.MatrixVectorView.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(bHYPRE_StructVector_t), intent(in) :: oldType
  ...
  ! to bHYPRE.StructVector.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(bHYPRE_MatrixVectorView_t), intent(in) :: oldType
    type(bHYPRE_StructVector_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external bHYPRE_StructVector__cast_m

    call bHYPRE_StructVector__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_StructVector__exec_m
    call bHYPRE_StructVector__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_StructVector__getURL_m
    call bHYPRE_StructVector__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_StructVector__isRemote_m
    call bHYPRE_StructVector__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_StructVector__isLocal_m
    call bHYPRE_StructVector__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_StructVector__set_hooks_m
    call bHYPRE_StructVector__set_hooks_m(self, on, exception)
  ...
  recursive subroutine set_hooks_static_s(on, exception)
    ...
    external bHYPRE_StructVector__set_hooks_static_m
    call bHYPRE_StructVector__set_hooks_static_m(on, exception)

  end subroutine set_hooks_static_s
  logical function is_null_s(ext)
    type(bHYPRE_StructVector_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_StructVector_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_StructVector

module bHYPRE_StructVector_array
  use sidl
  use bHYPRE_StructVector_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_StructVerpldv5vrof_p, &
    castbHYPRE_StructVejv6jom28lg_p, &
    castbHYPRE_StructVebxs9fgby4u_p, &
    castbHYPRE_StructVeamdkqxai19_p, &
    castbHYPRE_StructVerd1r420r3r_p, &
    castbHYPRE_StructVeare2os4kwa_p, &
    castbHYPRE_StructVegzt8r5p4xq_p
interface cast
  module procedure &
    castbHYPRE_StructVerpldv5vrof_p, &
    castbHYPRE_StructVejv6jom28lg_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_1d), intent(out) :: array
    external St_ary_createCol8pszj0ewh0epf_m
    call St_ary_createCol8pszj0ewh0epf_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_StructVector_1d), intent(out) :: array
    external St_ary_createRowxzqu343tyxmre_m
    call St_ary_createRowxzqu343tyxmre_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_StructVector_1d), intent(out) :: array
    external Str_ary_create1di4nlaqgc72lzp_m
    call Str_ary_create1di4nlaqgc72lzp_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_StructVector_1d), intent(in) :: src
    type(bHYPRE_StructVector_1d), intent(in) :: dest
    external StructV_ary_copyht3ytsogm0vs1_m
    call StructV_ary_copyht3ytsogm0vs1_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_StructVector_1d), intent(in)  :: src
    type(bHYPRE_StructVector_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensureldankfjh3912__m
    call Struc_ary_ensureldankfjh3912__m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Struct_ary_slice3dg7w838ggd2b_m
    call Struct_ary_slice3dg7w838ggd2b_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructVector_t), intent(out) :: value
    external StructVe_ary_getlbihn9y1sxvuq_m
    call StructVe_ary_getlbihn9y1sxvuq_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_StructVector_t), intent(in) :: value
    external StructVe_ary_seth9s38md8_eaha_m
    call StructVe_ary_seth9s38md8_eaha_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_StructVector_t), intent(out) :: value
    external StructV_ary_get11o8s4ro73kiuf_m
    call StructV_ary_get11o8s4ro73kiuf_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_StructVector_t), intent(in) :: value
    external StructV_ary_set1y96rxtgxndrr7_m
    call StructV_ary_set1y96rxtgxndrr7_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_StructVector_1d), intent(in) :: src
    type(bHYPRE_StructVector_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyj5fsk95ewvjln_m
    dim = 1
    call St_ary_smartCopyj5fsk95ewvjln_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    external ary_isColumnOrdersss8fj280gxk_m
    call ary_isColumnOrdersss8fj280gxk_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    external S_ary_isRowOrdermwsw7_xqi6p1x_m
    call S_ary_isRowOrdermwsw7_xqi6p1x_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    external Struct_ary_dimenmcij6lpzirj8p_m
    call Struct_ary_dimenmcij6lpzirj8p_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_strideox3eubuleux0j_m
    call Struc_ary_strideox3eubuleux0j_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowergj77e284dsow9_m
    call Struct_ary_lowergj77e284dsow9_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperi230jmrl24317_m
    call Struct_ary_upperi230jmrl24317_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthjama30tnh67v2_m
    call Struc_ary_lengthjama30tnh67v2_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    external Struc_ary_addRef1pb0ol3d67paj_m
    call Struc_ary_addRef1pb0ol3d67paj_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_StructVector_1d), intent(in)  :: array
    external St_ary_deleteRefylqynq63rn7gc_m
    call St_ary_deleteRefylqynq63rn7gc_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_2d), intent(out) :: array
    external St_ary_createCol8pszj0ewh0epf_m
    call St_ary_createCol8pszj0ewh0epf_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_2d), intent(out) :: array
    external St_ary_createRowxzqu343tyxmre_m
    call St_ary_createRowxzqu343tyxmre_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructVector_2d), intent(out) :: array
    external ary_create2dCol16zqt9bq86dagq_m
    call ary_create2dCol16zqt9bq86dagq_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_StructVector_2d), intent(out) :: array
    external ary_create2dRowog5586frvocnym_m
    call ary_create2dRowog5586frvocnym_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_StructVector_2d), intent(in) :: src
    type(bHYPRE_StructVector_2d), intent(in) :: dest
    external StructV_ary_copyht3ytsogm0vs1_m
    call StructV_ary_copyht3ytsogm0vs1_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_StructVector_2d), intent(in)  :: src
    type(bHYPRE_StructVector_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensureldankfjh3912__m
    call Struc_ary_ensureldankfjh3912__m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice3dg7w838ggd2b_m
    call Struct_ary_slice3dg7w838ggd2b_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_StructVector_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_StructVector_t), intent(out) :: value
    external StructV_ary_get2msr0p96g5qxih_m
    call StructV_ary_get2msr0p96g5qxih_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_StructVector_t), intent(in) :: value
    external StructV_ary_set21_62vtmghit0j_m
    call StructV_ary_set21_62vtmghit0j_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_StructVector_2d), intent(in) :: src
    type(bHYPRE_StructVector_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyj5fsk95ewvjln_m
    dim = 2
    call St_ary_smartCopyj5fsk95ewvjln_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_StructVector_2d), intent(in)  :: array
    external ary_isColumnOrdersss8fj280gxk_m
    call ary_isColumnOrdersss8fj280gxk_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_StructVector_2d), intent(in)  :: array
    external S_ary_isRowOrdermwsw7_xqi6p1x_m
    call S_ary_isRowOrdermwsw7_xqi6p1x_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_StructVector_2d), intent(in)  :: array
    external Struct_ary_dimenmcij6lpzirj8p_m
    call Struct_ary_dimenmcij6lpzirj8p_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_strideox3eubuleux0j_m
    call Struc_ary_strideox3eubuleux0j_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowergj77e284dsow9_m
    call Struct_ary_lowergj77e284dsow9_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperi230jmrl24317_m
    call Struct_ary_upperi230jmrl24317_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthjama30tnh67v2_m
    call Struc_ary_lengthjama30tnh67v2_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_3d), intent(out) :: array
    external St_ary_createCol8pszj0ewh0epf_m
    call St_ary_createCol8pszj0ewh0epf_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_3d), intent(out) :: array
    external St_ary_createRowxzqu343tyxmre_m
    call St_ary_createRowxzqu343tyxmre_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_StructVector_3d), intent(in) :: src
    type(bHYPRE_StructVector_3d), intent(in) :: dest
    external StructV_ary_copyht3ytsogm0vs1_m
    call StructV_ary_copyht3ytsogm0vs1_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_StructVector_3d), intent(in)  :: src
    type(bHYPRE_StructVector_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensureldankfjh3912__m
    call Struc_ary_ensureldankfjh3912__m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice3dg7w838ggd2b_m
    call Struct_ary_slice3dg7w838ggd2b_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_StructVector_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_StructVector_t), intent(out) :: value
    external StructV_ary_get3vk5pgnou4hreg_m
    call StructV_ary_get3vk5pgnou4hreg_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_StructVector_t), intent(in) :: value
    external StructV_ary_set3dfn4pwsujsauo_m
    call StructV_ary_set3dfn4pwsujsauo_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_StructVector_3d), intent(in) :: src
    type(bHYPRE_StructVector_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyj5fsk95ewvjln_m
    dim = 3
    call St_ary_smartCopyj5fsk95ewvjln_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_StructVector_3d), intent(in)  :: array
    external ary_isColumnOrdersss8fj280gxk_m
    call ary_isColumnOrdersss8fj280gxk_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_StructVector_3d), intent(in)  :: array
    external S_ary_isRowOrdermwsw7_xqi6p1x_m
    call S_ary_isRowOrdermwsw7_xqi6p1x_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_StructVector_3d), intent(in)  :: array
    external Struct_ary_dimenmcij6lpzirj8p_m
    call Struct_ary_dimenmcij6lpzirj8p_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_strideox3eubuleux0j_m
    call Struc_ary_strideox3eubuleux0j_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowergj77e284dsow9_m
    call Struct_ary_lowergj77e284dsow9_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperi230jmrl24317_m
    call Struct_ary_upperi230jmrl24317_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthjama30tnh67v2_m
    call Struc_ary_lengthjama30tnh67v2_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_4d), intent(out) :: array
    external St_ary_createCol8pszj0ewh0epf_m
    call St_ary_createCol8pszj0ewh0epf_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_4d), intent(out) :: array
    external St_ary_createRowxzqu343tyxmre_m
    call St_ary_createRowxzqu343tyxmre_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_StructVector_4d), intent(in) :: src
    type(bHYPRE_StructVector_4d), intent(in) :: dest
    external StructV_ary_copyht3ytsogm0vs1_m
    call StructV_ary_copyht3ytsogm0vs1_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_StructVector_4d), intent(in)  :: src
    type(bHYPRE_StructVector_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensureldankfjh3912__m
    call Struc_ary_ensureldankfjh3912__m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice3dg7w838ggd2b_m
    call Struct_ary_slice3dg7w838ggd2b_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_StructVector_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_StructVector_t), intent(out) :: value
    external StructV_ary_get45jixvljv9af2c_m
    call StructV_ary_get45jixvljv9af2c_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_StructVector_t), intent(in) :: value
    external StructV_ary_set4ineem1qu3ps1q_m
    call StructV_ary_set4ineem1qu3ps1q_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_StructVector_4d), intent(in) :: src
    type(bHYPRE_StructVector_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyj5fsk95ewvjln_m
    dim = 4
    call St_ary_smartCopyj5fsk95ewvjln_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_StructVector_4d), intent(in)  :: array
    external ary_isColumnOrdersss8fj280gxk_m
    call ary_isColumnOrdersss8fj280gxk_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_StructVector_4d), intent(in)  :: array
    external S_ary_isRowOrdermwsw7_xqi6p1x_m
    call S_ary_isRowOrdermwsw7_xqi6p1x_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_StructVector_4d), intent(in)  :: array
    external Struct_ary_dimenmcij6lpzirj8p_m
    call Struct_ary_dimenmcij6lpzirj8p_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_strideox3eubuleux0j_m
    call Struc_ary_strideox3eubuleux0j_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowergj77e284dsow9_m
    call Struct_ary_lowergj77e284dsow9_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperi230jmrl24317_m
    call Struct_ary_upperi230jmrl24317_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthjama30tnh67v2_m
    call Struc_ary_lengthjama30tnh67v2_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_5d), intent(out) :: array
    external St_ary_createCol8pszj0ewh0epf_m
    call St_ary_createCol8pszj0ewh0epf_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_5d), intent(out) :: array
    external St_ary_createRowxzqu343tyxmre_m
    call St_ary_createRowxzqu343tyxmre_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_StructVector_5d), intent(in) :: src
    type(bHYPRE_StructVector_5d), intent(in) :: dest
    external StructV_ary_copyht3ytsogm0vs1_m
    call StructV_ary_copyht3ytsogm0vs1_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_StructVector_5d), intent(in)  :: src
    type(bHYPRE_StructVector_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensureldankfjh3912__m
    call Struc_ary_ensureldankfjh3912__m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice3dg7w838ggd2b_m
    call Struct_ary_slice3dg7w838ggd2b_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_StructVector_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_StructVector_t), intent(out) :: value
    external StructV_ary_get57mz1584rf5mfj_m
    call StructV_ary_get57mz1584rf5mfj_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_StructVector_t), intent(in) :: value
    external StructV_ary_set5kb_n50pc3mkkl_m
    call StructV_ary_set5kb_n50pc3mkkl_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_StructVector_5d), intent(in) :: src
    type(bHYPRE_StructVector_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyj5fsk95ewvjln_m
    dim = 5
    call St_ary_smartCopyj5fsk95ewvjln_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_StructVector_5d), intent(in)  :: array
    external ary_isColumnOrdersss8fj280gxk_m
    call ary_isColumnOrdersss8fj280gxk_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_StructVector_5d), intent(in)  :: array
    external S_ary_isRowOrdermwsw7_xqi6p1x_m
    call S_ary_isRowOrdermwsw7_xqi6p1x_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_StructVector_5d), intent(in)  :: array
    external Struct_ary_dimenmcij6lpzirj8p_m
    call Struct_ary_dimenmcij6lpzirj8p_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_strideox3eubuleux0j_m
    call Struc_ary_strideox3eubuleux0j_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowergj77e284dsow9_m
    call Struct_ary_lowergj77e284dsow9_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperi230jmrl24317_m
    call Struct_ary_upperi230jmrl24317_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthjama30tnh67v2_m
    call Struc_ary_lengthjama30tnh67v2_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_6d), intent(out) :: array
    external St_ary_createCol8pszj0ewh0epf_m
    call St_ary_createCol8pszj0ewh0epf_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_6d), intent(out) :: array
    external St_ary_createRowxzqu343tyxmre_m
    call St_ary_createRowxzqu343tyxmre_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_StructVector_6d), intent(in) :: src
    type(bHYPRE_StructVector_6d), intent(in) :: dest
    external StructV_ary_copyht3ytsogm0vs1_m
    call StructV_ary_copyht3ytsogm0vs1_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_StructVector_6d), intent(in)  :: src
    type(bHYPRE_StructVector_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensureldankfjh3912__m
    call Struc_ary_ensureldankfjh3912__m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice3dg7w838ggd2b_m
    call Struct_ary_slice3dg7w838ggd2b_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_StructVector_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_StructVector_t), intent(out) :: value
    external StructV_ary_get6f9ojnfo7n4n1z_m
    call StructV_ary_get6f9ojnfo7n4n1z_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_StructVector_t), intent(in) :: value
    external StructV_ary_set65h9wcv822fwa__m
    call StructV_ary_set65h9wcv822fwa__m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_StructVector_6d), intent(in) :: src
    type(bHYPRE_StructVector_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyj5fsk95ewvjln_m
    dim = 6
    call St_ary_smartCopyj5fsk95ewvjln_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_StructVector_6d), intent(in)  :: array
    external ary_isColumnOrdersss8fj280gxk_m
    call ary_isColumnOrdersss8fj280gxk_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_StructVector_6d), intent(in)  :: array
    external S_ary_isRowOrdermwsw7_xqi6p1x_m
    call S_ary_isRowOrdermwsw7_xqi6p1x_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_StructVector_6d), intent(in)  :: array
    external Struct_ary_dimenmcij6lpzirj8p_m
    call Struct_ary_dimenmcij6lpzirj8p_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_strideox3eubuleux0j_m
    call Struc_ary_strideox3eubuleux0j_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowergj77e284dsow9_m
    call Struct_ary_lowergj77e284dsow9_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperi230jmrl24317_m
    call Struct_ary_upperi230jmrl24317_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthjama30tnh67v2_m
    call Struc_ary_lengthjama30tnh67v2_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_7d), intent(out) :: array
    external St_ary_createCol8pszj0ewh0epf_m
    call St_ary_createCol8pszj0ewh0epf_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_StructVector_7d), intent(out) :: array
    external St_ary_createRowxzqu343tyxmre_m
    call St_ary_createRowxzqu343tyxmre_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_StructVector_7d), intent(in) :: src
    type(bHYPRE_StructVector_7d), intent(in) :: dest
    external StructV_ary_copyht3ytsogm0vs1_m
    call StructV_ary_copyht3ytsogm0vs1_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_StructVector_7d), intent(in)  :: src
    type(bHYPRE_StructVector_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Struc_ary_ensureldankfjh3912__m
    call Struc_ary_ensureldankfjh3912__m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Struct_ary_slice3dg7w838ggd2b_m
    call Struct_ary_slice3dg7w838ggd2b_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_StructVector_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_StructVector_t), intent(out) :: value
    external StructV_ary_get7aq0xnianr4rmu_m
    call StructV_ary_get7aq0xnianr4rmu_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_StructVector_t), intent(in) :: value
    external StructV_ary_set7j3hmzvec85vz4_m
    call StructV_ary_set7j3hmzvec85vz4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_StructVector_7d), intent(in) :: src
    type(bHYPRE_StructVector_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external St_ary_smartCopyj5fsk95ewvjln_m
    dim = 7
    call St_ary_smartCopyj5fsk95ewvjln_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_StructVector_7d), intent(in)  :: array
    external ary_isColumnOrdersss8fj280gxk_m
    call ary_isColumnOrdersss8fj280gxk_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_StructVector_7d), intent(in)  :: array
    external S_ary_isRowOrdermwsw7_xqi6p1x_m
    call S_ary_isRowOrdermwsw7_xqi6p1x_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_StructVector_7d), intent(in)  :: array
    external Struct_ary_dimenmcij6lpzirj8p_m
    call Struct_ary_dimenmcij6lpzirj8p_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_strideox3eubuleux0j_m
    call Struc_ary_strideox3eubuleux0j_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_lowergj77e284dsow9_m
    call Struct_ary_lowergj77e284dsow9_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struct_ary_upperi230jmrl24317_m
    call Struct_ary_upperi230jmrl24317_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Struc_ary_lengthjama30tnh67v2_m
    call Struc_ary_lengthjama30tnh67v2_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_StructVerpldv5vrof_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVector_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVerpldv5vrof_p

  subroutine castbHYPRE_StructVejv6jom28lg_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVector_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVejv6jom28lg_p

  subroutine castbHYPRE_StructVebxs9fgby4u_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVector_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVebxs9fgby4u_p

  subroutine castbHYPRE_StructVeamdkqxai19_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVector_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVeamdkqxai19_p

  subroutine castbHYPRE_StructVerd1r420r3r_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVector_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVerd1r420r3r_p

  subroutine castbHYPRE_StructVeare2os4kwa_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVector_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVeare2os4kwa_p

  subroutine castbHYPRE_StructVegzt8r5p4xq_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_StructVector_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_StructVegzt8r5p4xq_p


end module bHYPRE_StructVector_array
