! 
! File:          bHYPRE_ProblemDefinition.F90
...
module bHYPRE_ProblemDefinition
...
contains
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    implicit none
    !  in bHYPRE.ProblemDefinition self
    type(bHYPRE_ProblemDefinition_t) , intent(in) :: self
    ...
    external bHYPRE_ProblemDefinition_SetCommunicator_m
    call bHYPRE_ProblemDefinition_SetCommunicator_m(self, mpi_comm, retval,    &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_ProblemDefinition_Destroy_m
    call bHYPRE_ProblemDefinition_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_ProblemDefinition_Initialize_m
    call bHYPRE_ProblemDefinition_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_ProblemDefinition_Assemble_m
    call bHYPRE_ProblemDefinition_Assemble_m(self, retval, exception)
  ...
  recursive subroutine rConnect_s(self, url, exception)
    implicit none
    !  out bHYPRE.ProblemDefinition self
    type(bHYPRE_ProblemDefinition_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_ProblemDefinition_rConnect_m
    call bHYPRE_ProblemDefinition_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_ProblemDefinition_addRef_m
    call bHYPRE_ProblemDefinition_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_ProblemDefinition_deleteRef_m
    call bHYPRE_ProblemDefinition_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_ProblemDefinition_isSame_m
    call bHYPRE_ProblemDefinition_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_ProblemDefinition_isType_m
    call bHYPRE_ProblemDefinition_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_ProblemDefinition_getClassInfo_m
    call bHYPRE_ProblemDefinition_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_ProblemDefinition__exec_m
    call bHYPRE_ProblemDefinition__exec_m(self, methodName, inArgs, outArgs,   &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_ProblemDefinition__getURL_m
    call bHYPRE_ProblemDefinition__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_ProblemDefinition__isRemote_m
    call bHYPRE_ProblemDefinition__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_ProblemDefinition__isLocal_m
    call bHYPRE_ProblemDefinition__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_ProblemDefinition__set_hooks_m
    call bHYPRE_ProblemDefinition__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_ProblemDefinition_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_ProblemDefinition_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_ProblemDefinition

module bHYPRE_ProblemDefinition_array
  use sidl
  use bHYPRE_ProblemDefinition_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_ProblemDjhggcfmr9g_p, &
    castbHYPRE_ProblemDt2i2g9ihf6_p, &
    castbHYPRE_ProblemDg5uklbahg6_p, &
    castbHYPRE_ProblemDdqx0jjyufu_p, &
    castbHYPRE_ProblemDgr2cjxfh3t_p, &
    castbHYPRE_ProblemD9drazcbh6f_p, &
    castbHYPRE_ProblemD4y_698lnvk_p
interface cast
  module procedure &
    castbHYPRE_ProblemDjhggcfmr9g_p, &
    castbHYPRE_ProblemDt2i2g9ihf6_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_1d), intent(out) :: array
    external Pr_ary_createColc24o42xnyo6br_m
    call Pr_ary_createColc24o42xnyo6br_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_ProblemDefinition_1d), intent(out) :: array
    external Pr_ary_createRowles14byx31t5m_m
    call Pr_ary_createRowles14byx31t5m_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_ProblemDefinition_1d), intent(out) :: array
    external Pro_ary_create1dlvp4dv7qizt9s_m
    call Pro_ary_create1dlvp4dv7qizt9s_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_ProblemDefinition_1d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_1d), intent(in) :: dest
    external Problem_ary_copykkzha7y5mnbv2_m
    call Problem_ary_copykkzha7y5mnbv2_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: src
    type(bHYPRE_ProblemDefinition_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Probl_ary_ensureltl7izi91z_l4_m
    call Probl_ary_ensureltl7izi91z_l4_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Proble_ary_slice1wt2uaw9yk0m5_m
    call Proble_ary_slice1wt2uaw9yk0m5_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_ProblemDefinition_t), intent(out) :: value
    external ProblemD_ary_get2xlquqq_hg10f_m
    call ProblemD_ary_get2xlquqq_hg10f_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_ProblemDefinition_t), intent(in) :: value
    external ProblemD_ary_setv70jbbfwscav0_m
    call ProblemD_ary_setv70jbbfwscav0_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_ProblemDefinition_t), intent(out) :: value
    external Problem_ary_get179utdlaesuulv_m
    call Problem_ary_get179utdlaesuulv_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_ProblemDefinition_t), intent(in) :: value
    external Problem_ary_set14blh3xo7j3otc_m
    call Problem_ary_set14blh3xo7j3otc_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_ProblemDefinition_1d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pr_ary_smartCopy22g4lbd48nno__m
    dim = 1
    call Pr_ary_smartCopy22g4lbd48nno__m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    external ary_isColumnOrderqvohvda3_29q_m
    call ary_isColumnOrderqvohvda3_29q_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    external P_ary_isRowOrderai2v6zvep3rau_m
    call P_ary_isRowOrderai2v6zvep3rau_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    external Proble_ary_dimen_tkp8glozxf6b_m
    call Proble_ary_dimen_tkp8glozxf6b_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_strideax17eokgx2jzj_m
    call Probl_ary_strideax17eokgx2jzj_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_lower9xvstb29pk87i_m
    call Proble_ary_lower9xvstb29pk87i_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_upperqftdyu2wl6fr2_m
    call Proble_ary_upperqftdyu2wl6fr2_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_lengthik71_qs8_ldz0_m
    call Probl_ary_lengthik71_qs8_ldz0_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    external Probl_ary_addRefwu4qjmkidu2cq_m
    call Probl_ary_addRefwu4qjmkidu2cq_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_ProblemDefinition_1d), intent(in)  :: array
    external Pr_ary_deleteRefda2ipkr0wljwv_m
    call Pr_ary_deleteRefda2ipkr0wljwv_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_2d), intent(out) :: array
    external Pr_ary_createColc24o42xnyo6br_m
    call Pr_ary_createColc24o42xnyo6br_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_2d), intent(out) :: array
    external Pr_ary_createRowles14byx31t5m_m
    call Pr_ary_createRowles14byx31t5m_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_ProblemDefinition_2d), intent(out) :: array
    external ary_create2dColisz2b26an0l2el_m
    call ary_create2dColisz2b26an0l2el_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_ProblemDefinition_2d), intent(out) :: array
    external ary_create2dRow0s7qwxa1mgwjqg_m
    call ary_create2dRow0s7qwxa1mgwjqg_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_ProblemDefinition_2d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_2d), intent(in) :: dest
    external Problem_ary_copykkzha7y5mnbv2_m
    call Problem_ary_copykkzha7y5mnbv2_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_ProblemDefinition_2d), intent(in)  :: src
    type(bHYPRE_ProblemDefinition_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Probl_ary_ensureltl7izi91z_l4_m
    call Probl_ary_ensureltl7izi91z_l4_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Proble_ary_slice1wt2uaw9yk0m5_m
    call Proble_ary_slice1wt2uaw9yk0m5_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_ProblemDefinition_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_ProblemDefinition_t), intent(out) :: value
    external Problem_ary_get20myewdht452fi_m
    call Problem_ary_get20myewdht452fi_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_ProblemDefinition_t), intent(in) :: value
    external Problem_ary_set2cuyzd8jbgvgyj_m
    call Problem_ary_set2cuyzd8jbgvgyj_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_ProblemDefinition_2d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pr_ary_smartCopy22g4lbd48nno__m
    dim = 2
    call Pr_ary_smartCopy22g4lbd48nno__m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_ProblemDefinition_2d), intent(in)  :: array
    external ary_isColumnOrderqvohvda3_29q_m
    call ary_isColumnOrderqvohvda3_29q_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_ProblemDefinition_2d), intent(in)  :: array
    external P_ary_isRowOrderai2v6zvep3rau_m
    call P_ary_isRowOrderai2v6zvep3rau_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_ProblemDefinition_2d), intent(in)  :: array
    external Proble_ary_dimen_tkp8glozxf6b_m
    call Proble_ary_dimen_tkp8glozxf6b_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_strideax17eokgx2jzj_m
    call Probl_ary_strideax17eokgx2jzj_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_lower9xvstb29pk87i_m
    call Proble_ary_lower9xvstb29pk87i_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_upperqftdyu2wl6fr2_m
    call Proble_ary_upperqftdyu2wl6fr2_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_lengthik71_qs8_ldz0_m
    call Probl_ary_lengthik71_qs8_ldz0_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_3d), intent(out) :: array
    external Pr_ary_createColc24o42xnyo6br_m
    call Pr_ary_createColc24o42xnyo6br_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_3d), intent(out) :: array
    external Pr_ary_createRowles14byx31t5m_m
    call Pr_ary_createRowles14byx31t5m_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_ProblemDefinition_3d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_3d), intent(in) :: dest
    external Problem_ary_copykkzha7y5mnbv2_m
    call Problem_ary_copykkzha7y5mnbv2_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_ProblemDefinition_3d), intent(in)  :: src
    type(bHYPRE_ProblemDefinition_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Probl_ary_ensureltl7izi91z_l4_m
    call Probl_ary_ensureltl7izi91z_l4_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Proble_ary_slice1wt2uaw9yk0m5_m
    call Proble_ary_slice1wt2uaw9yk0m5_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_ProblemDefinition_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_ProblemDefinition_t), intent(out) :: value
    external Problem_ary_get3e365d505vxxy6_m
    call Problem_ary_get3e365d505vxxy6_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_ProblemDefinition_t), intent(in) :: value
    external Problem_ary_set3vy29e5bv7shql_m
    call Problem_ary_set3vy29e5bv7shql_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_ProblemDefinition_3d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pr_ary_smartCopy22g4lbd48nno__m
    dim = 3
    call Pr_ary_smartCopy22g4lbd48nno__m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_ProblemDefinition_3d), intent(in)  :: array
    external ary_isColumnOrderqvohvda3_29q_m
    call ary_isColumnOrderqvohvda3_29q_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_ProblemDefinition_3d), intent(in)  :: array
    external P_ary_isRowOrderai2v6zvep3rau_m
    call P_ary_isRowOrderai2v6zvep3rau_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_ProblemDefinition_3d), intent(in)  :: array
    external Proble_ary_dimen_tkp8glozxf6b_m
    call Proble_ary_dimen_tkp8glozxf6b_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_strideax17eokgx2jzj_m
    call Probl_ary_strideax17eokgx2jzj_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_lower9xvstb29pk87i_m
    call Proble_ary_lower9xvstb29pk87i_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_upperqftdyu2wl6fr2_m
    call Proble_ary_upperqftdyu2wl6fr2_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_lengthik71_qs8_ldz0_m
    call Probl_ary_lengthik71_qs8_ldz0_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_4d), intent(out) :: array
    external Pr_ary_createColc24o42xnyo6br_m
    call Pr_ary_createColc24o42xnyo6br_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_4d), intent(out) :: array
    external Pr_ary_createRowles14byx31t5m_m
    call Pr_ary_createRowles14byx31t5m_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_ProblemDefinition_4d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_4d), intent(in) :: dest
    external Problem_ary_copykkzha7y5mnbv2_m
    call Problem_ary_copykkzha7y5mnbv2_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_ProblemDefinition_4d), intent(in)  :: src
    type(bHYPRE_ProblemDefinition_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Probl_ary_ensureltl7izi91z_l4_m
    call Probl_ary_ensureltl7izi91z_l4_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Proble_ary_slice1wt2uaw9yk0m5_m
    call Proble_ary_slice1wt2uaw9yk0m5_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_ProblemDefinition_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_ProblemDefinition_t), intent(out) :: value
    external Problem_ary_get41ja4car3rhhv4_m
    call Problem_ary_get41ja4car3rhhv4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_ProblemDefinition_t), intent(in) :: value
    external Problem_ary_set4ou03ofeko3jnr_m
    call Problem_ary_set4ou03ofeko3jnr_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_ProblemDefinition_4d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pr_ary_smartCopy22g4lbd48nno__m
    dim = 4
    call Pr_ary_smartCopy22g4lbd48nno__m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_ProblemDefinition_4d), intent(in)  :: array
    external ary_isColumnOrderqvohvda3_29q_m
    call ary_isColumnOrderqvohvda3_29q_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_ProblemDefinition_4d), intent(in)  :: array
    external P_ary_isRowOrderai2v6zvep3rau_m
    call P_ary_isRowOrderai2v6zvep3rau_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_ProblemDefinition_4d), intent(in)  :: array
    external Proble_ary_dimen_tkp8glozxf6b_m
    call Proble_ary_dimen_tkp8glozxf6b_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_strideax17eokgx2jzj_m
    call Probl_ary_strideax17eokgx2jzj_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_lower9xvstb29pk87i_m
    call Proble_ary_lower9xvstb29pk87i_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_upperqftdyu2wl6fr2_m
    call Proble_ary_upperqftdyu2wl6fr2_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_lengthik71_qs8_ldz0_m
    call Probl_ary_lengthik71_qs8_ldz0_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_5d), intent(out) :: array
    external Pr_ary_createColc24o42xnyo6br_m
    call Pr_ary_createColc24o42xnyo6br_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_5d), intent(out) :: array
    external Pr_ary_createRowles14byx31t5m_m
    call Pr_ary_createRowles14byx31t5m_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_ProblemDefinition_5d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_5d), intent(in) :: dest
    external Problem_ary_copykkzha7y5mnbv2_m
    call Problem_ary_copykkzha7y5mnbv2_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_ProblemDefinition_5d), intent(in)  :: src
    type(bHYPRE_ProblemDefinition_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Probl_ary_ensureltl7izi91z_l4_m
    call Probl_ary_ensureltl7izi91z_l4_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Proble_ary_slice1wt2uaw9yk0m5_m
    call Proble_ary_slice1wt2uaw9yk0m5_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_ProblemDefinition_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_ProblemDefinition_t), intent(out) :: value
    external Problem_ary_get5je4y2jqxrb1d7_m
    call Problem_ary_get5je4y2jqxrb1d7_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_ProblemDefinition_t), intent(in) :: value
    external Problem_ary_set5el3pbu1z9hhm5_m
    call Problem_ary_set5el3pbu1z9hhm5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_ProblemDefinition_5d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pr_ary_smartCopy22g4lbd48nno__m
    dim = 5
    call Pr_ary_smartCopy22g4lbd48nno__m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_ProblemDefinition_5d), intent(in)  :: array
    external ary_isColumnOrderqvohvda3_29q_m
    call ary_isColumnOrderqvohvda3_29q_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_ProblemDefinition_5d), intent(in)  :: array
    external P_ary_isRowOrderai2v6zvep3rau_m
    call P_ary_isRowOrderai2v6zvep3rau_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_ProblemDefinition_5d), intent(in)  :: array
    external Proble_ary_dimen_tkp8glozxf6b_m
    call Proble_ary_dimen_tkp8glozxf6b_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_strideax17eokgx2jzj_m
    call Probl_ary_strideax17eokgx2jzj_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_lower9xvstb29pk87i_m
    call Proble_ary_lower9xvstb29pk87i_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_upperqftdyu2wl6fr2_m
    call Proble_ary_upperqftdyu2wl6fr2_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_lengthik71_qs8_ldz0_m
    call Probl_ary_lengthik71_qs8_ldz0_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_6d), intent(out) :: array
    external Pr_ary_createColc24o42xnyo6br_m
    call Pr_ary_createColc24o42xnyo6br_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_6d), intent(out) :: array
    external Pr_ary_createRowles14byx31t5m_m
    call Pr_ary_createRowles14byx31t5m_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_ProblemDefinition_6d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_6d), intent(in) :: dest
    external Problem_ary_copykkzha7y5mnbv2_m
    call Problem_ary_copykkzha7y5mnbv2_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_ProblemDefinition_6d), intent(in)  :: src
    type(bHYPRE_ProblemDefinition_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Probl_ary_ensureltl7izi91z_l4_m
    call Probl_ary_ensureltl7izi91z_l4_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Proble_ary_slice1wt2uaw9yk0m5_m
    call Proble_ary_slice1wt2uaw9yk0m5_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_ProblemDefinition_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_ProblemDefinition_t), intent(out) :: value
    external Problem_ary_get6xfwau2z4mtz0z_m
    call Problem_ary_get6xfwau2z4mtz0z_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_ProblemDefinition_t), intent(in) :: value
    external Problem_ary_set6vzwiqm4jekehc_m
    call Problem_ary_set6vzwiqm4jekehc_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_ProblemDefinition_6d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pr_ary_smartCopy22g4lbd48nno__m
    dim = 6
    call Pr_ary_smartCopy22g4lbd48nno__m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_ProblemDefinition_6d), intent(in)  :: array
    external ary_isColumnOrderqvohvda3_29q_m
    call ary_isColumnOrderqvohvda3_29q_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_ProblemDefinition_6d), intent(in)  :: array
    external P_ary_isRowOrderai2v6zvep3rau_m
    call P_ary_isRowOrderai2v6zvep3rau_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_ProblemDefinition_6d), intent(in)  :: array
    external Proble_ary_dimen_tkp8glozxf6b_m
    call Proble_ary_dimen_tkp8glozxf6b_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_strideax17eokgx2jzj_m
    call Probl_ary_strideax17eokgx2jzj_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_lower9xvstb29pk87i_m
    call Proble_ary_lower9xvstb29pk87i_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_upperqftdyu2wl6fr2_m
    call Proble_ary_upperqftdyu2wl6fr2_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_lengthik71_qs8_ldz0_m
    call Probl_ary_lengthik71_qs8_ldz0_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_7d), intent(out) :: array
    external Pr_ary_createColc24o42xnyo6br_m
    call Pr_ary_createColc24o42xnyo6br_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_ProblemDefinition_7d), intent(out) :: array
    external Pr_ary_createRowles14byx31t5m_m
    call Pr_ary_createRowles14byx31t5m_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_ProblemDefinition_7d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_7d), intent(in) :: dest
    external Problem_ary_copykkzha7y5mnbv2_m
    call Problem_ary_copykkzha7y5mnbv2_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_ProblemDefinition_7d), intent(in)  :: src
    type(bHYPRE_ProblemDefinition_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Probl_ary_ensureltl7izi91z_l4_m
    call Probl_ary_ensureltl7izi91z_l4_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Proble_ary_slice1wt2uaw9yk0m5_m
    call Proble_ary_slice1wt2uaw9yk0m5_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_ProblemDefinition_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_ProblemDefinition_t), intent(out) :: value
    external Problem_ary_get7rq555k38ku7au_m
    call Problem_ary_get7rq555k38ku7au_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_ProblemDefinition_t), intent(in) :: value
    external Problem_ary_set7mcb9rzupf76kh_m
    call Problem_ary_set7mcb9rzupf76kh_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_ProblemDefinition_7d), intent(in) :: src
    type(bHYPRE_ProblemDefinition_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Pr_ary_smartCopy22g4lbd48nno__m
    dim = 7
    call Pr_ary_smartCopy22g4lbd48nno__m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_ProblemDefinition_7d), intent(in)  :: array
    external ary_isColumnOrderqvohvda3_29q_m
    call ary_isColumnOrderqvohvda3_29q_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_ProblemDefinition_7d), intent(in)  :: array
    external P_ary_isRowOrderai2v6zvep3rau_m
    call P_ary_isRowOrderai2v6zvep3rau_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_ProblemDefinition_7d), intent(in)  :: array
    external Proble_ary_dimen_tkp8glozxf6b_m
    call Proble_ary_dimen_tkp8glozxf6b_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_strideax17eokgx2jzj_m
    call Probl_ary_strideax17eokgx2jzj_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_lower9xvstb29pk87i_m
    call Proble_ary_lower9xvstb29pk87i_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Proble_ary_upperqftdyu2wl6fr2_m
    call Proble_ary_upperqftdyu2wl6fr2_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Probl_ary_lengthik71_qs8_ldz0_m
    call Probl_ary_lengthik71_qs8_ldz0_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_ProblemDjhggcfmr9g_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ProblemDefinition_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ProblemDjhggcfmr9g_p

  subroutine castbHYPRE_ProblemDt2i2g9ihf6_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ProblemDefinition_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ProblemDt2i2g9ihf6_p

  subroutine castbHYPRE_ProblemDg5uklbahg6_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ProblemDefinition_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ProblemDg5uklbahg6_p

  subroutine castbHYPRE_ProblemDdqx0jjyufu_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ProblemDefinition_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ProblemDdqx0jjyufu_p

  subroutine castbHYPRE_ProblemDgr2cjxfh3t_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ProblemDefinition_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ProblemDgr2cjxfh3t_p

  subroutine castbHYPRE_ProblemD9drazcbh6f_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ProblemDefinition_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ProblemD9drazcbh6f_p

  subroutine castbHYPRE_ProblemD4y_698lnvk_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_ProblemDefinition_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_ProblemD4y_698lnvk_p


end module bHYPRE_ProblemDefinition_array
