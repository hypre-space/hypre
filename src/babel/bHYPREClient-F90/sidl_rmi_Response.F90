! 
! File:          sidl_rmi_Response.F90
! Symbol:        sidl.rmi.Response-v0.9.15
! Symbol Type:   interface
! Babel Version: 1.0.0
! Release:       $Name: V2-2-0b $
! Revision:      @(#) $Id: sidl_rmi_Response.F90,v 1.1 2007/02/06 01:23:13 painter Exp $
! Description:   Client-side module for sidl.rmi.Response
! 
...
module sidl_rmi_Response

  use sidl
  use sidl_rmi_Response_type
  ...
  interface cast
    ...
    private :: getExceptionThrown_s


  interface getExceptionThrown
    module procedure getExceptionThrown_s
  end interface
  private :: rConnect_s
  interface rConnect
...
contains
  ...
  recursive subroutine getExceptionThrown_s(self, retval, exception)
    implicit none
    !  in sidl.rmi.Response self
    type(sidl_rmi_Response_t) , intent(in) :: self
    !  out sidl.BaseException retval
    type(sidl_BaseException_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_Response_getExceptionThrown_m
    call sidl_rmi_Response_getExceptionThrown_m(self, retval, exception)

  end subroutine getExceptionThrown_s


  recursive subroutine rConnect_s(self, url, exception)
    implicit none
    !  out sidl.rmi.Response self
    type(sidl_rmi_Response_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_Response_rConnect_m
    call sidl_rmi_Response_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external sidl_rmi_Response_addRef_m
    call sidl_rmi_Response_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_rmi_Response_deleteRef_m
    call sidl_rmi_Response_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_rmi_Response_isSame_m
    call sidl_rmi_Response_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_rmi_Response_isType_m
    call sidl_rmi_Response_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_rmi_Response_getClassInfo_m
    call sidl_rmi_Response_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine unpackBool_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackBool_m
    call sidl_rmi_Response_unpackBool_m(self, key, value, exception)
  ...
  recursive subroutine unpackChar_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackChar_m
    call sidl_rmi_Response_unpackChar_m(self, key, value, exception)
  ...
  recursive subroutine unpackInt_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackInt_m
    call sidl_rmi_Response_unpackInt_m(self, key, value, exception)
  ...
  recursive subroutine unpackLong_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackLong_m
    call sidl_rmi_Response_unpackLong_m(self, key, value, exception)
  ...
  recursive subroutine unpackOpaque_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackOpaque_m
    call sidl_rmi_Response_unpackOpaque_m(self, key, value, exception)
  ...
  recursive subroutine unpackFloat_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackFloat_m
    call sidl_rmi_Response_unpackFloat_m(self, key, value, exception)
  ...
  recursive subroutine unpackDouble_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackDouble_m
    call sidl_rmi_Response_unpackDouble_m(self, key, value, exception)
  ...
  recursive subroutine unpackFcomplex_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackFcomplex_m
    call sidl_rmi_Response_unpackFcomplex_m(self, key, value, exception)
  ...
  recursive subroutine unpackDcomplex_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackDcomplex_m
    call sidl_rmi_Response_unpackDcomplex_m(self, key, value, exception)
  ...
  recursive subroutine unpackString_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackString_m
    call sidl_rmi_Response_unpackString_m(self, key, value, exception)
  ...
  recursive subroutine unpackSerializable_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackSerializable_m
    call sidl_rmi_Response_unpackSerializable_m(self, key, value, exception)
  ...
  recursive subroutine unpackBoolArray_s(self, key, value, ordering, dimen,    &
    ...
    external sidl_rmi_Response_unpackBoolArray_m
    call sidl_rmi_Response_unpackBoolArray_m(self, key, value, ordering,       &
  ...
  recursive subroutine unpackCharArray_s(self, key, value, ordering, dimen,    &
    ...
    external sidl_rmi_Response_unpackCharArray_m
    call sidl_rmi_Response_unpackCharArray_m(self, key, value, ordering,       &
      dimen, isRarray, exception)
  ...
  recursive subroutine unpackIntArray_s(self, key, value, ordering, dimen,     &
    ...
    external sidl_rmi_Response_unpackIntArray_m
    call sidl_rmi_Response_unpackIntArray_m(self, key, value, ordering, dimen, &
      isRarray, exception)
  ...
  recursive subroutine unpackLongArray_s(self, key, value, ordering, dimen,    &
    ...
    external sidl_rmi_Response_unpackLongArray_m
    call sidl_rmi_Response_unpackLongArray_m(self, key, value, ordering,       &
      dimen, isRarray, exception)
  ...
  recursive subroutine unpackOpaqueArray_s(self, key, value, ordering, dimen,  &
    ...
    external sidl_rmi_Response_unpackOpaqueArray_m
    call sidl_rmi_Response_unpackOpaqueArray_m(self, key, value, ordering,     &
      dimen, isRarray, exception)
  ...
  recursive subroutine unpackFloatArray_s(self, key, value, ordering, dimen,   &
    ...
    external sidl_rmi_Response_unpackFloatArray_m
    call sidl_rmi_Response_unpackFloatArray_m(self, key, value, ordering,      &
      dimen, isRarray, exception)
  ...
  recursive subroutine unpackDoubleArray_s(self, key, value, ordering, dimen,  &
    ...
    external sidl_rmi_Response_unpackDoubleArray_m
    call sidl_rmi_Response_unpackDoubleArray_m(self, key, value, ordering,     &
      dimen, isRarray, exception)
  ...
  recursive subroutine unpackFcomplexArray_s(self, key, value, ordering,       &
    ...
    external sidl_rmi_Response_unpackFcomplexArray_m
    call sidl_rmi_Response_unpackFcomplexArray_m(self, key, value, ordering,   &
      dimen, isRarray, exception)
  ...
  recursive subroutine unpackDcomplexArray_s(self, key, value, ordering,       &
    ...
    external sidl_rmi_Response_unpackDcomplexArray_m
    call sidl_rmi_Response_unpackDcomplexArray_m(self, key, value, ordering,   &
      dimen, isRarray, exception)
  ...
  recursive subroutine unpackStringArray_s(self, key, value, ordering, dimen,  &
    ...
    external sidl_rmi_Response_unpackStringArray_m
    call sidl_rmi_Response_unpackStringArray_m(self, key, value, ordering,     &
      dimen, isRarray, exception)
  ...
  recursive subroutine unpackGenericArray_s(self, key, value, exception)
    ...
    external sidl_rmi_Response_unpackGenericArray_m
    call sidl_rmi_Response_unpackGenericArray_m(self, key, value, exception)
  ...
  recursive subroutine unpackSerializableArray_s(self, key, value, ordering,   &
    ...
    external sidl_rmi_Response_unpackSerializableArray_m
    call sidl_rmi_Response_unpackSerializableArray_m(self, key, value,         &
      ordering, dimen, isRarray, exception)

  end subroutine unpackSerializableArray_s

  ! 
  ! Static function to cast from sidl.rmi.Response
  ! to sidl.BaseInterface.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(sidl_rmi_Response_t), intent(in) :: oldType
  ...
  ! to sidl.rmi.Response.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseInterface_t), intent(in) :: oldType
    type(sidl_rmi_Response_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_Response__cast_m

    call sidl_rmi_Response__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_rmi_Response__exec_m
    call sidl_rmi_Response__exec_m(self, methodName, inArgs, outArgs,          &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_rmi_Response__getURL_m
    call sidl_rmi_Response__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_rmi_Response__isRemote_m
    call sidl_rmi_Response__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_rmi_Response__isLocal_m
    call sidl_rmi_Response__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_rmi_Response__set_hooks_m
    call sidl_rmi_Response__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(sidl_rmi_Response_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_rmi_Response_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_rmi_Response

module sidl_rmi_Response_array
  use sidl
  use sidl_rmi_Response_type
  use sidl_array_type
  ...
  private :: &
    castsidl_rmi_Responygp994bxv3_p, &
    castsidl_rmi_Respon05mxseptuz_p, &
    castsidl_rmi_Responjc0xzgp4zc_p, &
    castsidl_rmi_Responbqbg66xph8_p, &
    castsidl_rmi_Responadxcgx9_uy_p, &
    castsidl_rmi_Responbqe230z316_p, &
    castsidl_rmi_Respondth6kjtgbf_p
interface cast
  module procedure &
    castsidl_rmi_Responygp994bxv3_p, &
    castsidl_rmi_Respon05mxseptuz_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_1d), intent(out) :: array
    external Re_ary_createColf4bz63rxslk8v_m
    call Re_ary_createColf4bz63rxslk8v_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_rmi_Response_1d), intent(out) :: array
    external Re_ary_createRowjitca2yr5cofq_m
    call Re_ary_createRowjitca2yr5cofq_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_rmi_Response_1d), intent(out) :: array
    external Res_ary_create1dbluli_zpjh07l_m
    call Res_ary_create1dbluli_zpjh07l_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_rmi_Response_1d), intent(in) :: src
    type(sidl_rmi_Response_1d), intent(in) :: dest
    external sidl_rmi_Response__array_copy_m
    call sidl_rmi_Response__array_copy_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_rmi_Response_1d), intent(in)  :: src
    type(sidl_rmi_Response_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Respo_ary_ensure_zdpyklrhnagn_m
    call Respo_ary_ensure_zdpyklrhnagn_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Respon_ary_slicehavbzgwh1jq9m_m
    call Respon_ary_slicehavbzgwh1jq9m_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_Response_t), intent(out) :: value
    external sidl_rmi_Response__array_get_m
    call sidl_rmi_Response__array_get_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_Response_t), intent(in) :: value
    external sidl_rmi_Response__array_set_m
    call sidl_rmi_Response__array_set_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_rmi_Response_t), intent(out) :: value
    external sidl_rmi_Response__array_get1_m
    call sidl_rmi_Response__array_get1_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_rmi_Response_t), intent(in) :: value
    external sidl_rmi_Response__array_set1_m
    call sidl_rmi_Response__array_set1_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_rmi_Response_1d), intent(in) :: src
    type(sidl_rmi_Response_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Re_ary_smartCopybltu5y7g3a2st_m
    dim = 1
    call Re_ary_smartCopybltu5y7g3a2st_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    external ary_isColumnOrderh3j40lbebin__m
    call ary_isColumnOrderh3j40lbebin__m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    external R_ary_isRowOrderoqat6j755z0lv_m
    call R_ary_isRowOrderoqat6j755z0lv_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    external Respon_ary_dimen4p6wveeuirjy6_m
    call Respon_ary_dimen4p6wveeuirjy6_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_stride0og9_vogtd63x_m
    call Respo_ary_stride0og9_vogtd63x_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_lowerezy8y4gktyudt_m
    call Respon_ary_lowerezy8y4gktyudt_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_upper7o_2p64w1r6or_m
    call Respon_ary_upper7o_2p64w1r6or_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_lengthhvyjm20x0990i_m
    call Respo_ary_lengthhvyjm20x0990i_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    external Respo_ary_addRefl8htfz4kugkb7_m
    call Respo_ary_addRefl8htfz4kugkb7_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_rmi_Response_1d), intent(in)  :: array
    external Re_ary_deleteRefifkxxb9qqd5ej_m
    call Re_ary_deleteRefifkxxb9qqd5ej_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_2d), intent(out) :: array
    external Re_ary_createColf4bz63rxslk8v_m
    call Re_ary_createColf4bz63rxslk8v_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_2d), intent(out) :: array
    external Re_ary_createRowjitca2yr5cofq_m
    call Re_ary_createRowjitca2yr5cofq_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_Response_2d), intent(out) :: array
    external ary_create2dColfdud9n70nskx5r_m
    call ary_create2dColfdud9n70nskx5r_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_Response_2d), intent(out) :: array
    external ary_create2dRowhcsaub65hzor1w_m
    call ary_create2dRowhcsaub65hzor1w_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_rmi_Response_2d), intent(in) :: src
    type(sidl_rmi_Response_2d), intent(in) :: dest
    external sidl_rmi_Response__array_copy_m
    call sidl_rmi_Response__array_copy_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_rmi_Response_2d), intent(in)  :: src
    type(sidl_rmi_Response_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Respo_ary_ensure_zdpyklrhnagn_m
    call Respo_ary_ensure_zdpyklrhnagn_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Respon_ary_slicehavbzgwh1jq9m_m
    call Respon_ary_slicehavbzgwh1jq9m_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_rmi_Response_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_rmi_Response_t), intent(out) :: value
    external sidl_rmi_Response__array_get2_m
    call sidl_rmi_Response__array_get2_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_rmi_Response_t), intent(in) :: value
    external sidl_rmi_Response__array_set2_m
    call sidl_rmi_Response__array_set2_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_rmi_Response_2d), intent(in) :: src
    type(sidl_rmi_Response_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Re_ary_smartCopybltu5y7g3a2st_m
    dim = 2
    call Re_ary_smartCopybltu5y7g3a2st_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_rmi_Response_2d), intent(in)  :: array
    external ary_isColumnOrderh3j40lbebin__m
    call ary_isColumnOrderh3j40lbebin__m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_rmi_Response_2d), intent(in)  :: array
    external R_ary_isRowOrderoqat6j755z0lv_m
    call R_ary_isRowOrderoqat6j755z0lv_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_rmi_Response_2d), intent(in)  :: array
    external Respon_ary_dimen4p6wveeuirjy6_m
    call Respon_ary_dimen4p6wveeuirjy6_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_stride0og9_vogtd63x_m
    call Respo_ary_stride0og9_vogtd63x_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_lowerezy8y4gktyudt_m
    call Respon_ary_lowerezy8y4gktyudt_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_upper7o_2p64w1r6or_m
    call Respon_ary_upper7o_2p64w1r6or_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_lengthhvyjm20x0990i_m
    call Respo_ary_lengthhvyjm20x0990i_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_3d), intent(out) :: array
    external Re_ary_createColf4bz63rxslk8v_m
    call Re_ary_createColf4bz63rxslk8v_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_3d), intent(out) :: array
    external Re_ary_createRowjitca2yr5cofq_m
    call Re_ary_createRowjitca2yr5cofq_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_rmi_Response_3d), intent(in) :: src
    type(sidl_rmi_Response_3d), intent(in) :: dest
    external sidl_rmi_Response__array_copy_m
    call sidl_rmi_Response__array_copy_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_rmi_Response_3d), intent(in)  :: src
    type(sidl_rmi_Response_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Respo_ary_ensure_zdpyklrhnagn_m
    call Respo_ary_ensure_zdpyklrhnagn_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Respon_ary_slicehavbzgwh1jq9m_m
    call Respon_ary_slicehavbzgwh1jq9m_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_rmi_Response_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_rmi_Response_t), intent(out) :: value
    external sidl_rmi_Response__array_get3_m
    call sidl_rmi_Response__array_get3_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_rmi_Response_t), intent(in) :: value
    external sidl_rmi_Response__array_set3_m
    call sidl_rmi_Response__array_set3_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_rmi_Response_3d), intent(in) :: src
    type(sidl_rmi_Response_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Re_ary_smartCopybltu5y7g3a2st_m
    dim = 3
    call Re_ary_smartCopybltu5y7g3a2st_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_rmi_Response_3d), intent(in)  :: array
    external ary_isColumnOrderh3j40lbebin__m
    call ary_isColumnOrderh3j40lbebin__m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_rmi_Response_3d), intent(in)  :: array
    external R_ary_isRowOrderoqat6j755z0lv_m
    call R_ary_isRowOrderoqat6j755z0lv_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_rmi_Response_3d), intent(in)  :: array
    external Respon_ary_dimen4p6wveeuirjy6_m
    call Respon_ary_dimen4p6wveeuirjy6_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_stride0og9_vogtd63x_m
    call Respo_ary_stride0og9_vogtd63x_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_lowerezy8y4gktyudt_m
    call Respon_ary_lowerezy8y4gktyudt_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_upper7o_2p64w1r6or_m
    call Respon_ary_upper7o_2p64w1r6or_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_lengthhvyjm20x0990i_m
    call Respo_ary_lengthhvyjm20x0990i_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_4d), intent(out) :: array
    external Re_ary_createColf4bz63rxslk8v_m
    call Re_ary_createColf4bz63rxslk8v_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_4d), intent(out) :: array
    external Re_ary_createRowjitca2yr5cofq_m
    call Re_ary_createRowjitca2yr5cofq_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_rmi_Response_4d), intent(in) :: src
    type(sidl_rmi_Response_4d), intent(in) :: dest
    external sidl_rmi_Response__array_copy_m
    call sidl_rmi_Response__array_copy_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_rmi_Response_4d), intent(in)  :: src
    type(sidl_rmi_Response_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Respo_ary_ensure_zdpyklrhnagn_m
    call Respo_ary_ensure_zdpyklrhnagn_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Respon_ary_slicehavbzgwh1jq9m_m
    call Respon_ary_slicehavbzgwh1jq9m_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_rmi_Response_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_rmi_Response_t), intent(out) :: value
    external sidl_rmi_Response__array_get4_m
    call sidl_rmi_Response__array_get4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_rmi_Response_t), intent(in) :: value
    external sidl_rmi_Response__array_set4_m
    call sidl_rmi_Response__array_set4_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_rmi_Response_4d), intent(in) :: src
    type(sidl_rmi_Response_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Re_ary_smartCopybltu5y7g3a2st_m
    dim = 4
    call Re_ary_smartCopybltu5y7g3a2st_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_rmi_Response_4d), intent(in)  :: array
    external ary_isColumnOrderh3j40lbebin__m
    call ary_isColumnOrderh3j40lbebin__m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_rmi_Response_4d), intent(in)  :: array
    external R_ary_isRowOrderoqat6j755z0lv_m
    call R_ary_isRowOrderoqat6j755z0lv_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_rmi_Response_4d), intent(in)  :: array
    external Respon_ary_dimen4p6wveeuirjy6_m
    call Respon_ary_dimen4p6wveeuirjy6_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_stride0og9_vogtd63x_m
    call Respo_ary_stride0og9_vogtd63x_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_lowerezy8y4gktyudt_m
    call Respon_ary_lowerezy8y4gktyudt_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_upper7o_2p64w1r6or_m
    call Respon_ary_upper7o_2p64w1r6or_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_lengthhvyjm20x0990i_m
    call Respo_ary_lengthhvyjm20x0990i_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_5d), intent(out) :: array
    external Re_ary_createColf4bz63rxslk8v_m
    call Re_ary_createColf4bz63rxslk8v_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_5d), intent(out) :: array
    external Re_ary_createRowjitca2yr5cofq_m
    call Re_ary_createRowjitca2yr5cofq_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_rmi_Response_5d), intent(in) :: src
    type(sidl_rmi_Response_5d), intent(in) :: dest
    external sidl_rmi_Response__array_copy_m
    call sidl_rmi_Response__array_copy_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_rmi_Response_5d), intent(in)  :: src
    type(sidl_rmi_Response_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Respo_ary_ensure_zdpyklrhnagn_m
    call Respo_ary_ensure_zdpyklrhnagn_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Respon_ary_slicehavbzgwh1jq9m_m
    call Respon_ary_slicehavbzgwh1jq9m_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_rmi_Response_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_rmi_Response_t), intent(out) :: value
    external sidl_rmi_Response__array_get5_m
    call sidl_rmi_Response__array_get5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_rmi_Response_t), intent(in) :: value
    external sidl_rmi_Response__array_set5_m
    call sidl_rmi_Response__array_set5_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_rmi_Response_5d), intent(in) :: src
    type(sidl_rmi_Response_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Re_ary_smartCopybltu5y7g3a2st_m
    dim = 5
    call Re_ary_smartCopybltu5y7g3a2st_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_rmi_Response_5d), intent(in)  :: array
    external ary_isColumnOrderh3j40lbebin__m
    call ary_isColumnOrderh3j40lbebin__m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_rmi_Response_5d), intent(in)  :: array
    external R_ary_isRowOrderoqat6j755z0lv_m
    call R_ary_isRowOrderoqat6j755z0lv_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_rmi_Response_5d), intent(in)  :: array
    external Respon_ary_dimen4p6wveeuirjy6_m
    call Respon_ary_dimen4p6wveeuirjy6_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_stride0og9_vogtd63x_m
    call Respo_ary_stride0og9_vogtd63x_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_lowerezy8y4gktyudt_m
    call Respon_ary_lowerezy8y4gktyudt_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_upper7o_2p64w1r6or_m
    call Respon_ary_upper7o_2p64w1r6or_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_lengthhvyjm20x0990i_m
    call Respo_ary_lengthhvyjm20x0990i_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_6d), intent(out) :: array
    external Re_ary_createColf4bz63rxslk8v_m
    call Re_ary_createColf4bz63rxslk8v_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_6d), intent(out) :: array
    external Re_ary_createRowjitca2yr5cofq_m
    call Re_ary_createRowjitca2yr5cofq_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_rmi_Response_6d), intent(in) :: src
    type(sidl_rmi_Response_6d), intent(in) :: dest
    external sidl_rmi_Response__array_copy_m
    call sidl_rmi_Response__array_copy_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_rmi_Response_6d), intent(in)  :: src
    type(sidl_rmi_Response_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Respo_ary_ensure_zdpyklrhnagn_m
    call Respo_ary_ensure_zdpyklrhnagn_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Respon_ary_slicehavbzgwh1jq9m_m
    call Respon_ary_slicehavbzgwh1jq9m_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_rmi_Response_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_rmi_Response_t), intent(out) :: value
    external sidl_rmi_Response__array_get6_m
    call sidl_rmi_Response__array_get6_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_rmi_Response_t), intent(in) :: value
    external sidl_rmi_Response__array_set6_m
    call sidl_rmi_Response__array_set6_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_rmi_Response_6d), intent(in) :: src
    type(sidl_rmi_Response_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Re_ary_smartCopybltu5y7g3a2st_m
    dim = 6
    call Re_ary_smartCopybltu5y7g3a2st_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_rmi_Response_6d), intent(in)  :: array
    external ary_isColumnOrderh3j40lbebin__m
    call ary_isColumnOrderh3j40lbebin__m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_rmi_Response_6d), intent(in)  :: array
    external R_ary_isRowOrderoqat6j755z0lv_m
    call R_ary_isRowOrderoqat6j755z0lv_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_rmi_Response_6d), intent(in)  :: array
    external Respon_ary_dimen4p6wveeuirjy6_m
    call Respon_ary_dimen4p6wveeuirjy6_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_stride0og9_vogtd63x_m
    call Respo_ary_stride0og9_vogtd63x_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_lowerezy8y4gktyudt_m
    call Respon_ary_lowerezy8y4gktyudt_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_upper7o_2p64w1r6or_m
    call Respon_ary_upper7o_2p64w1r6or_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_lengthhvyjm20x0990i_m
    call Respo_ary_lengthhvyjm20x0990i_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_7d), intent(out) :: array
    external Re_ary_createColf4bz63rxslk8v_m
    call Re_ary_createColf4bz63rxslk8v_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_rmi_Response_7d), intent(out) :: array
    external Re_ary_createRowjitca2yr5cofq_m
    call Re_ary_createRowjitca2yr5cofq_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_rmi_Response_7d), intent(in) :: src
    type(sidl_rmi_Response_7d), intent(in) :: dest
    external sidl_rmi_Response__array_copy_m
    call sidl_rmi_Response__array_copy_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_rmi_Response_7d), intent(in)  :: src
    type(sidl_rmi_Response_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Respo_ary_ensure_zdpyklrhnagn_m
    call Respo_ary_ensure_zdpyklrhnagn_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Respon_ary_slicehavbzgwh1jq9m_m
    call Respon_ary_slicehavbzgwh1jq9m_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_rmi_Response_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_rmi_Response_t), intent(out) :: value
    external sidl_rmi_Response__array_get7_m
    call sidl_rmi_Response__array_get7_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_rmi_Response_t), intent(in) :: value
    external sidl_rmi_Response__array_set7_m
    call sidl_rmi_Response__array_set7_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_rmi_Response_7d), intent(in) :: src
    type(sidl_rmi_Response_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Re_ary_smartCopybltu5y7g3a2st_m
    dim = 7
    call Re_ary_smartCopybltu5y7g3a2st_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_rmi_Response_7d), intent(in)  :: array
    external ary_isColumnOrderh3j40lbebin__m
    call ary_isColumnOrderh3j40lbebin__m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_rmi_Response_7d), intent(in)  :: array
    external R_ary_isRowOrderoqat6j755z0lv_m
    call R_ary_isRowOrderoqat6j755z0lv_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_rmi_Response_7d), intent(in)  :: array
    external Respon_ary_dimen4p6wveeuirjy6_m
    call Respon_ary_dimen4p6wveeuirjy6_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_stride0og9_vogtd63x_m
    call Respo_ary_stride0og9_vogtd63x_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_lowerezy8y4gktyudt_m
    call Respon_ary_lowerezy8y4gktyudt_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respon_ary_upper7o_2p64w1r6or_m
    call Respon_ary_upper7o_2p64w1r6or_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Respo_ary_lengthhvyjm20x0990i_m
    call Respo_ary_lengthhvyjm20x0990i_m(array, index, length7_p)
  ...
  subroutine castsidl_rmi_Responygp994bxv3_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Response_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Responygp994bxv3_p

  subroutine castsidl_rmi_Respon05mxseptuz_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Response_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Respon05mxseptuz_p

  subroutine castsidl_rmi_Responjc0xzgp4zc_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Response_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Responjc0xzgp4zc_p

  subroutine castsidl_rmi_Responbqbg66xph8_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Response_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Responbqbg66xph8_p

  subroutine castsidl_rmi_Responadxcgx9_uy_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Response_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Responadxcgx9_uy_p

  subroutine castsidl_rmi_Responbqe230z316_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Response_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Responbqe230z316_p

  subroutine castsidl_rmi_Respondth6kjtgbf_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Response_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Respondth6kjtgbf_p


end module sidl_rmi_Response_array
