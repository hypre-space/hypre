! 
! File:          bHYPRE_MatrixVectorView.F90
...
module bHYPRE_MatrixVectorView
...
contains
  ...
  recursive subroutine rConnect_s(self, url, exception)
    ...
    type(bHYPRE_MatrixVectorView_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external bHYPRE_MatrixVectorView_rConnect_m
    call bHYPRE_MatrixVectorView_rConnect_m(self, url, exception)
  ...
  recursive subroutine SetCommunicator_s(self, mpi_comm, retval, exception)
    implicit none
    !  in bHYPRE.MatrixVectorView self
    type(bHYPRE_MatrixVectorView_t) , intent(in) :: self
    ...
    external bHYPRE_MatrixVectorView_SetCommunicator_m
    call bHYPRE_MatrixVectorView_SetCommunicator_m(self, mpi_comm, retval,     &
      exception)
  ...
  recursive subroutine Destroy_s(self, exception)
    ...
    external bHYPRE_MatrixVectorView_Destroy_m
    call bHYPRE_MatrixVectorView_Destroy_m(self, exception)
  ...
  recursive subroutine Initialize_s(self, retval, exception)
    ...
    external bHYPRE_MatrixVectorView_Initialize_m
    call bHYPRE_MatrixVectorView_Initialize_m(self, retval, exception)
  ...
  recursive subroutine Assemble_s(self, retval, exception)
    ...
    external bHYPRE_MatrixVectorView_Assemble_m
    call bHYPRE_MatrixVectorView_Assemble_m(self, retval, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external bHYPRE_MatrixVectorView_addRef_m
    call bHYPRE_MatrixVectorView_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external bHYPRE_MatrixVectorView_deleteRef_m
    call bHYPRE_MatrixVectorView_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external bHYPRE_MatrixVectorView_isSame_m
    call bHYPRE_MatrixVectorView_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external bHYPRE_MatrixVectorView_isType_m
    call bHYPRE_MatrixVectorView_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external bHYPRE_MatrixVectorView_getClassInfo_m
    call bHYPRE_MatrixVectorView_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external bHYPRE_MatrixVectorView__exec_m
    call bHYPRE_MatrixVectorView__exec_m(self, methodName, inArgs, outArgs,    &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external bHYPRE_MatrixVectorView__getURL_m
    call bHYPRE_MatrixVectorView__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external bHYPRE_MatrixVectorView__isRemote_m
    call bHYPRE_MatrixVectorView__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external bHYPRE_MatrixVectorView__isLocal_m
    call bHYPRE_MatrixVectorView__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external bHYPRE_MatrixVectorView__set_hooks_m
    call bHYPRE_MatrixVectorView__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(bHYPRE_MatrixVectorView_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(bHYPRE_MatrixVectorView_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module bHYPRE_MatrixVectorView

module bHYPRE_MatrixVectorView_array
  use sidl
  use bHYPRE_MatrixVectorView_type
  use sidl_array_type
  ...
  private :: &
    castbHYPRE_MatrixVe5sl8em111q_p, &
    castbHYPRE_MatrixVe5l6fd26lo__p, &
    castbHYPRE_MatrixVei3_wb030_l_p, &
    castbHYPRE_MatrixVezldss4y_iz_p, &
    castbHYPRE_MatrixVeipvwux7rre_p, &
    castbHYPRE_MatrixVe_lfn50mpfk_p, &
    castbHYPRE_MatrixVe_4zdd_8aaa_p
interface cast
  module procedure &
    castbHYPRE_MatrixVe5sl8em111q_p, &
    castbHYPRE_MatrixVe5l6fd26lo__p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_1d), intent(out) :: array
    external Ma_ary_createColent3fk6k19ka7_m
    call Ma_ary_createColent3fk6k19ka7_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(bHYPRE_MatrixVectorView_1d), intent(out) :: array
    external Ma_ary_createRow4wd2qq8jv6i0b_m
    call Ma_ary_createRow4wd2qq8jv6i0b_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(bHYPRE_MatrixVectorView_1d), intent(out) :: array
    external Mat_ary_create1diqy4_bshsfipa_m
    call Mat_ary_create1diqy4_bshsfipa_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(bHYPRE_MatrixVectorView_1d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_1d), intent(in) :: dest
    external MatrixV_ary_copyox9bxbejnxnhl_m
    call MatrixV_ary_copyox9bxbejnxnhl_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: src
    type(bHYPRE_MatrixVectorView_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Matri_ary_ensuredrev7op2qa1oy_m
    call Matri_ary_ensuredrev7op2qa1oy_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Matrix_ary_slices0ppui9gqmp5u_m
    call Matrix_ary_slices0ppui9gqmp5u_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_MatrixVectorView_t), intent(out) :: value
    external MatrixVe_ary_getriuha0gxf0c0u_m
    call MatrixVe_ary_getriuha0gxf0c0u_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(bHYPRE_MatrixVectorView_t), intent(in) :: value
    external MatrixVe_ary_seti06uugd4kl8bw_m
    call MatrixVe_ary_seti06uugd4kl8bw_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(bHYPRE_MatrixVectorView_t), intent(out) :: value
    external MatrixV_ary_get18346x0xv9y6yr_m
    call MatrixV_ary_get18346x0xv9y6yr_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(bHYPRE_MatrixVectorView_t), intent(in) :: value
    external MatrixV_ary_set184r9psql6zvsb_m
    call MatrixV_ary_set184r9psql6zvsb_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(bHYPRE_MatrixVectorView_1d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ma_ary_smartCopy5rkjy19xxrx38_m
    dim = 1
    call Ma_ary_smartCopy5rkjy19xxrx38_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    external ary_isColumnOrderdagmh3x0im3f_m
    call ary_isColumnOrderdagmh3x0im3f_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    external M_ary_isRowOrder6us8gdflgxof__m
    call M_ary_isRowOrder6us8gdflgxof__m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    external Matrix_ary_dimen6vd0gpf4zsokg_m
    call Matrix_ary_dimen6vd0gpf4zsokg_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_stride7eza22ulg79a3_m
    call Matri_ary_stride7eza22ulg79a3_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_lowerdade1q44jjaa6_m
    call Matrix_ary_lowerdade1q44jjaa6_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_upper28ngmumd9y3lg_m
    call Matrix_ary_upper28ngmumd9y3lg_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_lengtho7k7gfm1m4wnk_m
    call Matri_ary_lengtho7k7gfm1m4wnk_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    external Matri_ary_addRefyxon6i0mninpj_m
    call Matri_ary_addRefyxon6i0mninpj_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(bHYPRE_MatrixVectorView_1d), intent(in)  :: array
    external Ma_ary_deleteRefx66ksk8u39q2w_m
    call Ma_ary_deleteRefx66ksk8u39q2w_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_2d), intent(out) :: array
    external Ma_ary_createColent3fk6k19ka7_m
    call Ma_ary_createColent3fk6k19ka7_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_2d), intent(out) :: array
    external Ma_ary_createRow4wd2qq8jv6i0b_m
    call Ma_ary_createRow4wd2qq8jv6i0b_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_MatrixVectorView_2d), intent(out) :: array
    external ary_create2dCol91pu9dpwwar5z5_m
    call ary_create2dCol91pu9dpwwar5z5_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(bHYPRE_MatrixVectorView_2d), intent(out) :: array
    external ary_create2dRowwj1o28bh4qea65_m
    call ary_create2dRowwj1o28bh4qea65_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(bHYPRE_MatrixVectorView_2d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_2d), intent(in) :: dest
    external MatrixV_ary_copyox9bxbejnxnhl_m
    call MatrixV_ary_copyox9bxbejnxnhl_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(bHYPRE_MatrixVectorView_2d), intent(in)  :: src
    type(bHYPRE_MatrixVectorView_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Matri_ary_ensuredrev7op2qa1oy_m
    call Matri_ary_ensuredrev7op2qa1oy_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Matrix_ary_slices0ppui9gqmp5u_m
    call Matrix_ary_slices0ppui9gqmp5u_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(bHYPRE_MatrixVectorView_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(bHYPRE_MatrixVectorView_t), intent(out) :: value
    external MatrixV_ary_get23ff1twbqwhp85_m
    call MatrixV_ary_get23ff1twbqwhp85_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(bHYPRE_MatrixVectorView_t), intent(in) :: value
    external MatrixV_ary_set2riz_uvjayifao_m
    call MatrixV_ary_set2riz_uvjayifao_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(bHYPRE_MatrixVectorView_2d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ma_ary_smartCopy5rkjy19xxrx38_m
    dim = 2
    call Ma_ary_smartCopy5rkjy19xxrx38_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(bHYPRE_MatrixVectorView_2d), intent(in)  :: array
    external ary_isColumnOrderdagmh3x0im3f_m
    call ary_isColumnOrderdagmh3x0im3f_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(bHYPRE_MatrixVectorView_2d), intent(in)  :: array
    external M_ary_isRowOrder6us8gdflgxof__m
    call M_ary_isRowOrder6us8gdflgxof__m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(bHYPRE_MatrixVectorView_2d), intent(in)  :: array
    external Matrix_ary_dimen6vd0gpf4zsokg_m
    call Matrix_ary_dimen6vd0gpf4zsokg_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_stride7eza22ulg79a3_m
    call Matri_ary_stride7eza22ulg79a3_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_lowerdade1q44jjaa6_m
    call Matrix_ary_lowerdade1q44jjaa6_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_upper28ngmumd9y3lg_m
    call Matrix_ary_upper28ngmumd9y3lg_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_lengtho7k7gfm1m4wnk_m
    call Matri_ary_lengtho7k7gfm1m4wnk_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_3d), intent(out) :: array
    external Ma_ary_createColent3fk6k19ka7_m
    call Ma_ary_createColent3fk6k19ka7_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_3d), intent(out) :: array
    external Ma_ary_createRow4wd2qq8jv6i0b_m
    call Ma_ary_createRow4wd2qq8jv6i0b_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(bHYPRE_MatrixVectorView_3d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_3d), intent(in) :: dest
    external MatrixV_ary_copyox9bxbejnxnhl_m
    call MatrixV_ary_copyox9bxbejnxnhl_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(bHYPRE_MatrixVectorView_3d), intent(in)  :: src
    type(bHYPRE_MatrixVectorView_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Matri_ary_ensuredrev7op2qa1oy_m
    call Matri_ary_ensuredrev7op2qa1oy_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Matrix_ary_slices0ppui9gqmp5u_m
    call Matrix_ary_slices0ppui9gqmp5u_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(bHYPRE_MatrixVectorView_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(bHYPRE_MatrixVectorView_t), intent(out) :: value
    external MatrixV_ary_get3wh41iv2574ceh_m
    call MatrixV_ary_get3wh41iv2574ceh_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(bHYPRE_MatrixVectorView_t), intent(in) :: value
    external MatrixV_ary_set3e7h4jhrahsmj5_m
    call MatrixV_ary_set3e7h4jhrahsmj5_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(bHYPRE_MatrixVectorView_3d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ma_ary_smartCopy5rkjy19xxrx38_m
    dim = 3
    call Ma_ary_smartCopy5rkjy19xxrx38_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(bHYPRE_MatrixVectorView_3d), intent(in)  :: array
    external ary_isColumnOrderdagmh3x0im3f_m
    call ary_isColumnOrderdagmh3x0im3f_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(bHYPRE_MatrixVectorView_3d), intent(in)  :: array
    external M_ary_isRowOrder6us8gdflgxof__m
    call M_ary_isRowOrder6us8gdflgxof__m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(bHYPRE_MatrixVectorView_3d), intent(in)  :: array
    external Matrix_ary_dimen6vd0gpf4zsokg_m
    call Matrix_ary_dimen6vd0gpf4zsokg_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_stride7eza22ulg79a3_m
    call Matri_ary_stride7eza22ulg79a3_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_lowerdade1q44jjaa6_m
    call Matrix_ary_lowerdade1q44jjaa6_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_upper28ngmumd9y3lg_m
    call Matrix_ary_upper28ngmumd9y3lg_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_lengtho7k7gfm1m4wnk_m
    call Matri_ary_lengtho7k7gfm1m4wnk_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_4d), intent(out) :: array
    external Ma_ary_createColent3fk6k19ka7_m
    call Ma_ary_createColent3fk6k19ka7_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_4d), intent(out) :: array
    external Ma_ary_createRow4wd2qq8jv6i0b_m
    call Ma_ary_createRow4wd2qq8jv6i0b_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(bHYPRE_MatrixVectorView_4d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_4d), intent(in) :: dest
    external MatrixV_ary_copyox9bxbejnxnhl_m
    call MatrixV_ary_copyox9bxbejnxnhl_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(bHYPRE_MatrixVectorView_4d), intent(in)  :: src
    type(bHYPRE_MatrixVectorView_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Matri_ary_ensuredrev7op2qa1oy_m
    call Matri_ary_ensuredrev7op2qa1oy_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Matrix_ary_slices0ppui9gqmp5u_m
    call Matrix_ary_slices0ppui9gqmp5u_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(bHYPRE_MatrixVectorView_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(bHYPRE_MatrixVectorView_t), intent(out) :: value
    external MatrixV_ary_get404ay07sj18n9q_m
    call MatrixV_ary_get404ay07sj18n9q_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(bHYPRE_MatrixVectorView_t), intent(in) :: value
    external MatrixV_ary_set430efy4ul2ceqf_m
    call MatrixV_ary_set430efy4ul2ceqf_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(bHYPRE_MatrixVectorView_4d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ma_ary_smartCopy5rkjy19xxrx38_m
    dim = 4
    call Ma_ary_smartCopy5rkjy19xxrx38_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(bHYPRE_MatrixVectorView_4d), intent(in)  :: array
    external ary_isColumnOrderdagmh3x0im3f_m
    call ary_isColumnOrderdagmh3x0im3f_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(bHYPRE_MatrixVectorView_4d), intent(in)  :: array
    external M_ary_isRowOrder6us8gdflgxof__m
    call M_ary_isRowOrder6us8gdflgxof__m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(bHYPRE_MatrixVectorView_4d), intent(in)  :: array
    external Matrix_ary_dimen6vd0gpf4zsokg_m
    call Matrix_ary_dimen6vd0gpf4zsokg_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_stride7eza22ulg79a3_m
    call Matri_ary_stride7eza22ulg79a3_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_lowerdade1q44jjaa6_m
    call Matrix_ary_lowerdade1q44jjaa6_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_upper28ngmumd9y3lg_m
    call Matrix_ary_upper28ngmumd9y3lg_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_lengtho7k7gfm1m4wnk_m
    call Matri_ary_lengtho7k7gfm1m4wnk_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_5d), intent(out) :: array
    external Ma_ary_createColent3fk6k19ka7_m
    call Ma_ary_createColent3fk6k19ka7_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_5d), intent(out) :: array
    external Ma_ary_createRow4wd2qq8jv6i0b_m
    call Ma_ary_createRow4wd2qq8jv6i0b_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(bHYPRE_MatrixVectorView_5d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_5d), intent(in) :: dest
    external MatrixV_ary_copyox9bxbejnxnhl_m
    call MatrixV_ary_copyox9bxbejnxnhl_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(bHYPRE_MatrixVectorView_5d), intent(in)  :: src
    type(bHYPRE_MatrixVectorView_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Matri_ary_ensuredrev7op2qa1oy_m
    call Matri_ary_ensuredrev7op2qa1oy_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Matrix_ary_slices0ppui9gqmp5u_m
    call Matrix_ary_slices0ppui9gqmp5u_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(bHYPRE_MatrixVectorView_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(bHYPRE_MatrixVectorView_t), intent(out) :: value
    external MatrixV_ary_get58f7c8ozey6zv8_m
    call MatrixV_ary_get58f7c8ozey6zv8_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(bHYPRE_MatrixVectorView_t), intent(in) :: value
    external MatrixV_ary_set50789jtqs1mcyu_m
    call MatrixV_ary_set50789jtqs1mcyu_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(bHYPRE_MatrixVectorView_5d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ma_ary_smartCopy5rkjy19xxrx38_m
    dim = 5
    call Ma_ary_smartCopy5rkjy19xxrx38_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(bHYPRE_MatrixVectorView_5d), intent(in)  :: array
    external ary_isColumnOrderdagmh3x0im3f_m
    call ary_isColumnOrderdagmh3x0im3f_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(bHYPRE_MatrixVectorView_5d), intent(in)  :: array
    external M_ary_isRowOrder6us8gdflgxof__m
    call M_ary_isRowOrder6us8gdflgxof__m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(bHYPRE_MatrixVectorView_5d), intent(in)  :: array
    external Matrix_ary_dimen6vd0gpf4zsokg_m
    call Matrix_ary_dimen6vd0gpf4zsokg_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_stride7eza22ulg79a3_m
    call Matri_ary_stride7eza22ulg79a3_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_lowerdade1q44jjaa6_m
    call Matrix_ary_lowerdade1q44jjaa6_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_upper28ngmumd9y3lg_m
    call Matrix_ary_upper28ngmumd9y3lg_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_lengtho7k7gfm1m4wnk_m
    call Matri_ary_lengtho7k7gfm1m4wnk_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_6d), intent(out) :: array
    external Ma_ary_createColent3fk6k19ka7_m
    call Ma_ary_createColent3fk6k19ka7_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_6d), intent(out) :: array
    external Ma_ary_createRow4wd2qq8jv6i0b_m
    call Ma_ary_createRow4wd2qq8jv6i0b_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(bHYPRE_MatrixVectorView_6d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_6d), intent(in) :: dest
    external MatrixV_ary_copyox9bxbejnxnhl_m
    call MatrixV_ary_copyox9bxbejnxnhl_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(bHYPRE_MatrixVectorView_6d), intent(in)  :: src
    type(bHYPRE_MatrixVectorView_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Matri_ary_ensuredrev7op2qa1oy_m
    call Matri_ary_ensuredrev7op2qa1oy_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Matrix_ary_slices0ppui9gqmp5u_m
    call Matrix_ary_slices0ppui9gqmp5u_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(bHYPRE_MatrixVectorView_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(bHYPRE_MatrixVectorView_t), intent(out) :: value
    external MatrixV_ary_get68midycu27jaw3_m
    call MatrixV_ary_get68midycu27jaw3_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(bHYPRE_MatrixVectorView_t), intent(in) :: value
    external MatrixV_ary_set6kxkv57gk3g3zr_m
    call MatrixV_ary_set6kxkv57gk3g3zr_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(bHYPRE_MatrixVectorView_6d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ma_ary_smartCopy5rkjy19xxrx38_m
    dim = 6
    call Ma_ary_smartCopy5rkjy19xxrx38_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(bHYPRE_MatrixVectorView_6d), intent(in)  :: array
    external ary_isColumnOrderdagmh3x0im3f_m
    call ary_isColumnOrderdagmh3x0im3f_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(bHYPRE_MatrixVectorView_6d), intent(in)  :: array
    external M_ary_isRowOrder6us8gdflgxof__m
    call M_ary_isRowOrder6us8gdflgxof__m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(bHYPRE_MatrixVectorView_6d), intent(in)  :: array
    external Matrix_ary_dimen6vd0gpf4zsokg_m
    call Matrix_ary_dimen6vd0gpf4zsokg_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_stride7eza22ulg79a3_m
    call Matri_ary_stride7eza22ulg79a3_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_lowerdade1q44jjaa6_m
    call Matrix_ary_lowerdade1q44jjaa6_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_upper28ngmumd9y3lg_m
    call Matrix_ary_upper28ngmumd9y3lg_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_lengtho7k7gfm1m4wnk_m
    call Matri_ary_lengtho7k7gfm1m4wnk_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_7d), intent(out) :: array
    external Ma_ary_createColent3fk6k19ka7_m
    call Ma_ary_createColent3fk6k19ka7_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(bHYPRE_MatrixVectorView_7d), intent(out) :: array
    external Ma_ary_createRow4wd2qq8jv6i0b_m
    call Ma_ary_createRow4wd2qq8jv6i0b_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(bHYPRE_MatrixVectorView_7d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_7d), intent(in) :: dest
    external MatrixV_ary_copyox9bxbejnxnhl_m
    call MatrixV_ary_copyox9bxbejnxnhl_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(bHYPRE_MatrixVectorView_7d), intent(in)  :: src
    type(bHYPRE_MatrixVectorView_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Matri_ary_ensuredrev7op2qa1oy_m
    call Matri_ary_ensuredrev7op2qa1oy_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Matrix_ary_slices0ppui9gqmp5u_m
    call Matrix_ary_slices0ppui9gqmp5u_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(bHYPRE_MatrixVectorView_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(bHYPRE_MatrixVectorView_t), intent(out) :: value
    external MatrixV_ary_get76c992vs84hl51_m
    call MatrixV_ary_get76c992vs84hl51_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(bHYPRE_MatrixVectorView_t), intent(in) :: value
    external MatrixV_ary_set77f04epa550ny3_m
    call MatrixV_ary_set77f04epa550ny3_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(bHYPRE_MatrixVectorView_7d), intent(in) :: src
    type(bHYPRE_MatrixVectorView_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external Ma_ary_smartCopy5rkjy19xxrx38_m
    dim = 7
    call Ma_ary_smartCopy5rkjy19xxrx38_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(bHYPRE_MatrixVectorView_7d), intent(in)  :: array
    external ary_isColumnOrderdagmh3x0im3f_m
    call ary_isColumnOrderdagmh3x0im3f_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(bHYPRE_MatrixVectorView_7d), intent(in)  :: array
    external M_ary_isRowOrder6us8gdflgxof__m
    call M_ary_isRowOrder6us8gdflgxof__m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(bHYPRE_MatrixVectorView_7d), intent(in)  :: array
    external Matrix_ary_dimen6vd0gpf4zsokg_m
    call Matrix_ary_dimen6vd0gpf4zsokg_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_stride7eza22ulg79a3_m
    call Matri_ary_stride7eza22ulg79a3_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_lowerdade1q44jjaa6_m
    call Matrix_ary_lowerdade1q44jjaa6_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matrix_ary_upper28ngmumd9y3lg_m
    call Matrix_ary_upper28ngmumd9y3lg_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Matri_ary_lengtho7k7gfm1m4wnk_m
    call Matri_ary_lengtho7k7gfm1m4wnk_m(array, index, length7_p)
  ...
  subroutine castbHYPRE_MatrixVe5sl8em111q_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_MatrixVectorView_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_MatrixVe5sl8em111q_p

  subroutine castbHYPRE_MatrixVe5l6fd26lo__p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_MatrixVectorView_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_MatrixVe5l6fd26lo__p

  subroutine castbHYPRE_MatrixVei3_wb030_l_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_MatrixVectorView_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_MatrixVei3_wb030_l_p

  subroutine castbHYPRE_MatrixVezldss4y_iz_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_MatrixVectorView_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_MatrixVezldss4y_iz_p

  subroutine castbHYPRE_MatrixVeipvwux7rre_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_MatrixVectorView_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_MatrixVeipvwux7rre_p

  subroutine castbHYPRE_MatrixVe_lfn50mpfk_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_MatrixVectorView_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_MatrixVe_lfn50mpfk_p

  subroutine castbHYPRE_MatrixVe_4zdd_8aaa_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(bHYPRE_MatrixVectorView_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castbHYPRE_MatrixVe_4zdd_8aaa_p


end module bHYPRE_MatrixVectorView_array
