...
template HYPRE_Int hypre_spgemm_numerical_with_rownnz < 4, HYPRE_SPGEMM_NUMER_HASH_SIZE / 2,
                                                        HYPRE_WARP_SIZE / 2, true > ( HYPRE_Int m, HYPRE_Int *row_ind, HYPRE_Int k, HYPRE_Int n,
