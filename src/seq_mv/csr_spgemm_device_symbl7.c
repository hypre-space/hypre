...
template HYPRE_Int
hypre_spgemm_symbolic_rownnz<7, HYPRE_SPGEMM_SYMBL_HASH_SIZE * 4, HYPRE_WARP_SIZE * 4, true>
...
template HYPRE_Int hypre_spgemm_symbolic_max_num_blocks<HYPRE_SPGEMM_SYMBL_HASH_SIZE * 4, HYPRE_WARP_SIZE * 4, true>
