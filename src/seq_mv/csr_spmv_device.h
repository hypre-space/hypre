...
#define HYPRE_SPMV_GPU_LAUNCH(nv)                                                         \
   ...
   {                                                                                      \
      ...
      HYPRE_GPU_LAUNCH( (hypreGPUKernel_CSRMatvecShuffle<F, group_size, nv, HYPRE_Real>), \
                        gDim, bDim, nrows, idxstride_x, idxstride_y, vecstride_x,         \
                        vecstride_y, alpha, d_ia, d_ja, d_a, d_x, beta, d_y, d_yind );    \
   }                                                                                      \
