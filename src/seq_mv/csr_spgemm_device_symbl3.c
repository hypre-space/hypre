...
template HYPRE_Int
hypre_spgemm_symbolic_rownnz<3, HYPRE_SPGEMM_SYMBL_HASH_SIZE / 4, HYPRE_SPGEMM_BASE_GROUP_SIZE / 4, true>
...
template HYPRE_Int hypre_spgemm_symbolic_max_num_blocks<HYPRE_SPGEMM_SYMBL_HASH_SIZE / 4, HYPRE_SPGEMM_BASE_GROUP_SIZE / 4>
