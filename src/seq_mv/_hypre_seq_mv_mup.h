...
HYPRE_Int
hypre_CSRMatrixResetData_flt( hypre_CSRMatrix *matrix );
HYPRE_Int
hypre_CSRMatrixResetData_dbl( hypre_CSRMatrix *matrix );
HYPRE_Int
hypre_CSRMatrixResetData_long_dbl( hypre_CSRMatrix *matrix );
HYPRE_Int
