...
template HYPRE_Int
hypre_spgemm_symbolic_rownnz<1, HYPRE_SPGEMM_SYMBL_HASH_SIZE / 16, HYPRE_SPGEMM_BASE_GROUP_SIZE / 16, true>
...
template HYPRE_Int hypre_spgemm_symbolic_max_num_blocks<HYPRE_SPGEMM_SYMBL_HASH_SIZE / 16, HYPRE_SPGEMM_BASE_GROUP_SIZE / 16>
