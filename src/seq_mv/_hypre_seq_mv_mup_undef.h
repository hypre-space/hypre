...
#undef hypre_CSRSpAddDevice
#undef hypre_CSRSpGemmBinnedGetBlockNumDimDevice
#undef hypre_CSRSpGemmDevice
#undef hypre_CSRSpGemmNumerWithRownnzUpperboundBinnedDevice
#undef hypre_CSRSpGemmNumerWithRownnzUpperboundDevice
#undef hypre_CSRSpGemmNumerWithRownnzUpperboundNoBinDevice
#undef hypre_CSRSpGemmRownnzBinnedDevice
#undef hypre_CSRSpGemmRownnzDevice
#undef hypre_CSRSpGemmRownnzEstimateDevice
#undef hypre_CSRSpGemmRownnzNoBinDevice
#undef hypre_CSRSpGemmRownnzUpperboundBinnedDevice
#undef hypre_CSRSpGemmRownnzUpperboundDevice
#undef hypre_CSRSpGemmRownnzUpperboundNoBinDevice
#undef hypre_CSRSpGemmVendor
#undef hypre_CSRSpTransDevice
#undef hypre_CSRSpTransVendor
#undef hypre_CsrsvDataCreate
#undef hypre_CsrsvDataDestroy
#undef hypre_GPUKernelCSRCheckDiagFirst
#undef hypre_GPUKernelCSRDiagScale
#undef hypre_GPUKernelCSRMatrixCheckForMissingDiagonal
#undef hypre_GPUKernelCSRMatrixIntersectPattern
#undef hypre_GPUKernelCSRMatrixReplaceDiag
#undef hypre_GPUKernelCSRMatrixTaggedFnormAccum
#undef hypre_GPUKernelCSRMoveDiagFirst
