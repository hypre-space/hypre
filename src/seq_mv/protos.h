...
HYPRE_Int hypre_CSRMatrixTriLowerUpperSolveVendor(char uplo, HYPRE_Int unit_diag,
...
HYPRE_Int hypre_CSRMatrixMatvecDevice(HYPRE_Int trans, HYPRE_Complex alpha, hypre_CSRMatrix *A,
                                      hypre_Vector *x, HYPRE_Complex beta, hypre_Vector *b, hypre_Vector *y, HYPRE_Int offset );
HYPRE_Int hypre_CSRMatrixMatvecVendor(HYPRE_Int trans, HYPRE_Complex alpha,
...
HYPRE_Int hypre_SortCSRVendor(hypre_CSRMatrix *A);
