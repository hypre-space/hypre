...
HYPRE_Int hypreDevice_CSRSpGemmBinnedGetMaxNumBlocks()
{
   ...
   printf0("-----------------------------------------------------------------------\n");
   printf0("Bdim: "); for (HYPRE_Int i = 0; i < num_bins + 1; i++) { printf0("%5d ", max_nblocks[2][i]); } printf0("\n");
   printf0("Sym:  "); for (HYPRE_Int i = 0; i < num_bins + 1; i++) { printf0("%5d ", max_nblocks[0][i]); } printf0("\n");
   printf0("Bdim: "); for (HYPRE_Int i = 0; i < num_bins + 1; i++) { printf0("%5d ", max_nblocks[3][i]); } printf0("\n");
