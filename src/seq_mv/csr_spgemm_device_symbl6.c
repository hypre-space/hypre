...
template HYPRE_Int
hypre_spgemm_symbolic_rownnz<6, HYPRE_SPGEMM_SYMBL_HASH_SIZE * 2, HYPRE_WARP_SIZE * 2, true>
...
template HYPRE_Int hypre_spgemm_symbolic_max_num_blocks<HYPRE_SPGEMM_SYMBL_HASH_SIZE * 2, HYPRE_WARP_SIZE * 2, true>
