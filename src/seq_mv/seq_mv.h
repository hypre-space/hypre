...
HYPRE_Int hypre_CSRMatrixMatvecOutOfPlaceHost ( HYPRE_Complex alpha , hypre_CSRMatrix *A , hypre_Vector *x , HYPRE_Complex beta , hypre_Vector *b, hypre_Vector *y, HYPRE_Int offset );
...
HYPRE_Int hypreDevice_CSRSpTrans_v2(HYPRE_Int m, HYPRE_Int n, HYPRE_Int nnzA, HYPRE_Int *d_ia, HYPRE_Int *d_ja, HYPRE_Complex *d_aa, HYPRE_Int *d_ic, HYPRE_Int *d_jc, HYPRE_Complex *d_ac, HYPRE_Int want_data, HYPRE_Int *work);
