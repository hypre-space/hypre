                       ...
                       hypre_ParCSRMatrix **Pp)
{
   ...
   void                    *buffer;
   hypre_cusparseSpSMDescr  malL_info = NULL;
    ...
    */
   alpha = -1.0;
   hypre_cusparseSpSMDescr malU_info = NULL;
    ...
    */
   alpha = 1.0;
   hypre_cusparseSpSMDescr malU_info2 = NULL;
    ...
    */
   alpha = -1.0;
   hypre_cusparseSpSMDescr malL_info2 = NULL;
