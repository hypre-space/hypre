...
HYPRE_Int
hypre_BoomerAMGPartialCycle( void              *amg_vdata,
                      hypre_ParVector  **F_array,
                      hypre_ParVector  **U_array,
                      HYPRE_Int        coarsest_level,
                      HYPRE_Int        down_up_cycle   )
{
   hypre_ParAMGData *amg_data = (hypre_ParAMGData*) amg_vdata;
   ...
   while (Not_Finished)
   {
      ...
      if (down_up_cycle == 0 || down_up_cycle == 2)
      {
        if (level != num_levels-1)
        {
           ...
           if (down_up_cycle > 1) Not_Finished = 0;
...
HYPRE_Int
hypre_BoomerAMGCycleTimed( void              *amg_vdata,
                      hypre_ParVector  **F_array,
                      hypre_ParVector  **U_array,
                      HYPRE_Int        time_part   )
{
