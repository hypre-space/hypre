...
HYPRE_Int hypre_GenerateMultiPiDevice ( hypre_ParCSRMatrix *A, hypre_ParCSRMatrix *S , hypre_ParCSRMatrix *P , HYPRE_BigInt *c_pts_starts , HYPRE_Int *pass_order , HYPRE_Int *pass_marker , HYPRE_Int *pass_marker_offd , HYPRE_Int num_points , HYPRE_Int color , HYPRE_Int num_functions , HYPRE_Int *dof_func, HYPRE_Int *dof_func_offd , hypre_ParCSRMatrix **Pi_ptr, HYPRE_Real *, HYPRE_Int *, HYPRE_Int *, HYPRE_Real *, HYPRE_Int *, HYPRE_Int *, HYPRE_Int *, HYPRE_Int *, HYPRE_Int *, HYPRE_Int *, HYPRE_Int *, HYPRE_Int *, HYPRE_Int * );
