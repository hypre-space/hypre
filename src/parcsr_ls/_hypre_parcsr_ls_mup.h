...
HYPRE_Int
hypre_AMGHybridSetFlexibleCGCScalingFactors_flt( void *AMGhybrid_vdata, hypre_float *cgc_scaling_factors_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleCGCScalingFactors_dbl( void *AMGhybrid_vdata, hypre_double *cgc_scaling_factors_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleCGCScalingFactors_long_dbl( void *AMGhybrid_vdata, hypre_long_double *cgc_scaling_factors_flexible );

HYPRE_Int
hypre_AMGHybridSetFlexibleCycleStruct_flt( void *AMGhybrid_vdata, HYPRE_Int *cycle_struct_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleCycleStruct_dbl( void *AMGhybrid_vdata, HYPRE_Int *cycle_struct_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleCycleStruct_long_dbl( void *AMGhybrid_vdata, HYPRE_Int *cycle_struct_flexible );

HYPRE_Int
hypre_AMGHybridSetFlexibleOuterWeights_flt( void *AMGhybrid_vdata, hypre_float *outer_weights_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleOuterWeights_dbl( void *AMGhybrid_vdata, hypre_double *outer_weights_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleOuterWeights_long_dbl( void *AMGhybrid_vdata, hypre_long_double *outer_weights_flexible );

HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxOrders_flt( void *AMGhybrid_vdata, HYPRE_Int *relax_orders_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxOrders_dbl( void *AMGhybrid_vdata, HYPRE_Int *relax_orders_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxOrders_long_dbl( void *AMGhybrid_vdata, HYPRE_Int *relax_orders_flexible );

HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxTypes_flt( void *AMGhybrid_vdata, HYPRE_Int *relax_types_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxTypes_dbl( void *AMGhybrid_vdata, HYPRE_Int *relax_types_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxTypes_long_dbl( void *AMGhybrid_vdata, HYPRE_Int *relax_types_flexible );

HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxWeights_flt( void *AMGhybrid_vdata, hypre_float *relax_weights_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxWeights_dbl( void *AMGhybrid_vdata, hypre_double *relax_weights_flexible );
HYPRE_Int
hypre_AMGHybridSetFlexibleRelaxWeights_long_dbl( void *AMGhybrid_vdata, hypre_long_double *relax_weights_flexible );
...
HYPRE_Int
hypre_ILUSetupILUKSymbolic_flt( HYPRE_Int n, HYPRE_Int *A_diag_i, HYPRE_Int *A_diag_j, HYPRE_Int lfil, HYPRE_Int *perm, HYPRE_Int *rperm, HYPRE_Int *iw, HYPRE_Int nLU, HYPRE_Int *L_diag_i, HYPRE_Int *U_diag_i, HYPRE_Int *S_diag_i, HYPRE_Int **L_diag_j, HYPRE_Int **U_diag_j, HYPRE_Int **S_diag_j, HYPRE_Int **u_end, HYPRE_MemoryLocation memory_location);
HYPRE_Int
hypre_ILUSetupILUKSymbolic_dbl( HYPRE_Int n, HYPRE_Int *A_diag_i, HYPRE_Int *A_diag_j, HYPRE_Int lfil, HYPRE_Int *perm, HYPRE_Int *rperm, HYPRE_Int *iw, HYPRE_Int nLU, HYPRE_Int *L_diag_i, HYPRE_Int *U_diag_i, HYPRE_Int *S_diag_i, HYPRE_Int **L_diag_j, HYPRE_Int **U_diag_j, HYPRE_Int **S_diag_j, HYPRE_Int **u_end, HYPRE_MemoryLocation memory_location);
HYPRE_Int
hypre_ILUSetupILUKSymbolic_long_dbl( HYPRE_Int n, HYPRE_Int *A_diag_i, HYPRE_Int *A_diag_j, HYPRE_Int lfil, HYPRE_Int *perm, HYPRE_Int *rperm, HYPRE_Int *iw, HYPRE_Int nLU, HYPRE_Int *L_diag_i, HYPRE_Int *U_diag_i, HYPRE_Int *S_diag_i, HYPRE_Int **L_diag_j, HYPRE_Int **U_diag_j, HYPRE_Int **S_diag_j, HYPRE_Int **u_end, HYPRE_MemoryLocation memory_location);
...
HYPRE_Int
hypre_MGRCleanup_flt( void *mgr_vdata, HYPRE_Int num_coarse_levels, HYPRE_Int cleanup_mode );
HYPRE_Int
hypre_MGRCleanup_dbl( void *mgr_vdata, HYPRE_Int num_coarse_levels, HYPRE_Int cleanup_mode );
HYPRE_Int
hypre_MGRCleanup_long_dbl( void *mgr_vdata, HYPRE_Int num_coarse_levels, HYPRE_Int cleanup_mode );

HYPRE_Int
hypre_MGRCleanupBuildData_flt( void *mgr_vdata, HYPRE_Int num_coarse_levels );
HYPRE_Int
hypre_MGRCleanupBuildData_dbl( void *mgr_vdata, HYPRE_Int num_coarse_levels );
HYPRE_Int
...
HYPRE_Int
hypre_MGRReleaseCoarseGridSolver_dbl( void *mgr_vdata );
HYPRE_Int
hypre_MGRReleaseCoarseGridSolver_long_dbl( void *mgr_vdata );

HYPRE_Int
hypre_MGRReleaseFSolverAtLevel_flt( void *mgr_vdata, HYPRE_Int level );
HYPRE_Int
hypre_MGRReleaseFSolverAtLevel_dbl( void *mgr_vdata, HYPRE_Int level );
HYPRE_Int
hypre_MGRReleaseFSolverAtLevel_long_dbl( void *mgr_vdata, HYPRE_Int level );

HYPRE_Int
hypre_MGRReleaseLevelSmootherAtLevel_flt( void *mgr_vdata, HYPRE_Int level );
HYPRE_Int
hypre_MGRReleaseLevelSmootherAtLevel_dbl( void *mgr_vdata, HYPRE_Int level );
HYPRE_Int
hypre_MGRReleaseLevelSmootherAtLevel_long_dbl( void *mgr_vdata, HYPRE_Int level );
