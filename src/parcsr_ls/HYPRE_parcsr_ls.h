...
/**
 * (Optional) Set the type of ILU smoother to use.
 * See \e HYPRE_ILUSetType for \e ilu_type options. 
 **/
HYPRE_Int
...
/**
 * (Optional) Set the ILU smoother type for each MGR level.
 **/
HYPRE_Int
...
/**
 * (Optional) Set the max. nonzero per row for the ILU smoother.
 * See \e HYPRE_ILUSetMaxRowNnz for details.
 **/
HYPRE_Int
...
/**
 * (Optional) Set the max. nonzero per row for the ILU smoother at each MGR level.
 **/
HYPRE_Int
 ...
 * See \e HYPRE_ILUSetDroptol for details.
 **/
HYPRE_Int
...
/**
 * (Optional) Set the drop tolerance for the ILU smoother at each MGR level.
 **/
HYPRE_Int
...
/**
 * (Optional) Set the local reordering type for the ILU smoother.
 * See \e HYPRE_ILUSetLocalReordering for details.
 **/
HYPRE_Int
...
/**
 * (Optional) Set the local reordering type for the ILU smoother at each MGR level.
 **/
HYPRE_Int
