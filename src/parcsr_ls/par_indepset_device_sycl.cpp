                             ...
                             HYPRE_Int   IS_offd_temp_mark)
{
   ...
   marker_row = warp_reduce_min(marker_row, item);
...
hypreSYCLKernel_IndepSetFixMarker(cl::sycl::nd_item<1>& item,
				  HYPRE_Int  *IS_marker_diag,
                                  ...
                                  HYPRE_Int   IS_offd_temp_mark)
{
   HYPRE_Int thread_id = hypre_sycl_get_global_workitem_id<1>(item);
                               ...
                               HYPRE_Int           *int_send_buf )
{
   ...
   HYPRE_SYCL_1D_LAUNCH( hypreSYCLKernel_IndepSetMain, gDim, bDim,
   ...
   gDim = hypre_GetDefaultSYCLGridDimension(num_elmts_send, "thread", bDim);

   HYPRE_SYCL_1D_LAUNCH( hypreSYCLKernel_IndepSetFixMarker, gDim, bDim,
