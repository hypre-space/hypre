...
HYPRE_MGRPCDSetApSolver_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Solver ap_solver )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_MGRPCDSetApSolver_flt( solver, ap_solver );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_MGRPCDSetApSolver_dbl( solver, ap_solver );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_MGRPCDSetApSolver_long_dbl( solver, ap_solver );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_MGRPCDSetApplyOrder_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int apply_order )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_MGRPCDSetApplyOrder_flt( solver, apply_order );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_MGRPCDSetApplyOrder_dbl( solver, apply_order );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_MGRPCDSetApplyOrder_long_dbl( solver, apply_order );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_MGRPCDSetMassInvType_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int mass_inv_type )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_MGRPCDSetMassInvType_flt( solver, mass_inv_type );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_MGRPCDSetMassInvType_dbl( solver, mass_inv_type );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_MGRPCDSetMassInvType_long_dbl( solver, mass_inv_type );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_MGRPCDSetMpSolver_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Solver mp_solver )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_MGRPCDSetMpSolver_flt( solver, mp_solver );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_MGRPCDSetMpSolver_dbl( solver, mp_solver );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_MGRPCDSetMpSolver_long_dbl( solver, mp_solver );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_MGRPCDSetOperators_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_ParCSRMatrix Fp, HYPRE_ParCSRMatrix Ap, HYPRE_ParCSRMatrix Mp )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_MGRPCDSetOperators_flt( solver, Fp, Ap, Mp );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_MGRPCDSetOperators_dbl( solver, Fp, Ap, Mp );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_MGRPCDSetOperators_long_dbl( solver, Fp, Ap, Mp );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_MGRSetCycleType_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int cycle_type )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_MGRSetCycleType_flt( solver, cycle_type );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_MGRSetCycleType_dbl( solver, cycle_type );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_MGRSetCycleType_long_dbl( solver, cycle_type );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_ParCSRHybridSetFlexibleCGCScalingFactors_pre( HYPRE_Precision precision, HYPRE_Solver solver, void *cgc_scaling_factors_flexible )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_ParCSRHybridSetFlexibleCGCScalingFactors_flt( solver, (hypre_float *)cgc_scaling_factors_flexible );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleCGCScalingFactors_dbl( solver, (hypre_double *)cgc_scaling_factors_flexible );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleCGCScalingFactors_long_dbl( solver, (hypre_long_double *)cgc_scaling_factors_flexible );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_ParCSRHybridSetFlexibleCycleStruct_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int *cycle_struct_flexible )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_ParCSRHybridSetFlexibleCycleStruct_flt( solver, cycle_struct_flexible );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleCycleStruct_dbl( solver, cycle_struct_flexible );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleCycleStruct_long_dbl( solver, cycle_struct_flexible );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_ParCSRHybridSetFlexibleOuterWeights_pre( HYPRE_Precision precision, HYPRE_Solver solver, void *outer_weights_flexible )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_ParCSRHybridSetFlexibleOuterWeights_flt( solver, (hypre_float *)outer_weights_flexible );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleOuterWeights_dbl( solver, (hypre_double *)outer_weights_flexible );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleOuterWeights_long_dbl( solver, (hypre_long_double *)outer_weights_flexible );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_ParCSRHybridSetFlexibleRelaxOrders_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int *relax_orders_flexible )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxOrders_flt( solver, relax_orders_flexible );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxOrders_dbl( solver, relax_orders_flexible );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxOrders_long_dbl( solver, relax_orders_flexible );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_ParCSRHybridSetFlexibleRelaxTypes_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int *relax_types_flexible )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxTypes_flt( solver, relax_types_flexible );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxTypes_dbl( solver, relax_types_flexible );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxTypes_long_dbl( solver, relax_types_flexible );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_ParCSRHybridSetFlexibleRelaxWeights_pre( HYPRE_Precision precision, HYPRE_Solver solver, void *relax_weights_flexible )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxWeights_flt( solver, (hypre_float *)relax_weights_flexible );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxWeights_dbl( solver, (hypre_double *)relax_weights_flexible );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_ParCSRHybridSetFlexibleRelaxWeights_long_dbl( solver, (hypre_long_double *)relax_weights_flexible );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzGetFinalResidualNorm_pre( HYPRE_Precision precision, HYPRE_Solver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzGetFinalResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzGetFinalResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzGetFinalResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzGetNumIterations_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int *num_iterations )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzGetNumIterations_flt( solver, num_iterations );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzGetNumIterations_dbl( solver, num_iterations );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzGetNumIterations_long_dbl( solver, num_iterations );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzSetILUKLevelOfFill_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int level_of_fill )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzSetILUKLevelOfFill_flt( solver, level_of_fill );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzSetILUKLevelOfFill_dbl( solver, level_of_fill );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzSetILUKLevelOfFill_long_dbl( solver, level_of_fill );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzSetILUTDroptol_pre( HYPRE_Precision precision, HYPRE_Solver solver, hypre_long_double droptol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzSetILUTDroptol_flt( solver, (hypre_float)droptol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzSetILUTDroptol_dbl( solver, (hypre_double)droptol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzSetILUTDroptol_long_dbl( solver, (hypre_long_double)droptol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzSetILUTMaxNnzPerRow_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int max_nnz_row )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzSetILUTMaxNnzPerRow_flt( solver, max_nnz_row );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzSetILUTMaxNnzPerRow_dbl( solver, max_nnz_row );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzSetILUTMaxNnzPerRow_long_dbl( solver, max_nnz_row );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzSetLocalSolverType_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int local_solver_type )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzSetLocalSolverType_flt( solver, local_solver_type );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzSetLocalSolverType_dbl( solver, local_solver_type );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzSetLocalSolverType_long_dbl( solver, local_solver_type );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzSetLogging_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int logging )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzSetLogging_flt( solver, logging );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzSetLogging_dbl( solver, logging );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzSetLogging_long_dbl( solver, logging );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzSetMaxIter_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int max_iter )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzSetMaxIter_flt( solver, max_iter );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzSetMaxIter_dbl( solver, max_iter );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzSetMaxIter_long_dbl( solver, max_iter );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzSetPrintLevel_pre( HYPRE_Precision precision, HYPRE_Solver solver, HYPRE_Int print_level )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzSetPrintLevel_flt( solver, print_level );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzSetPrintLevel_dbl( solver, print_level );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzSetPrintLevel_long_dbl( solver, print_level );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_SchwarzSetTol_pre( HYPRE_Precision precision, HYPRE_Solver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_SchwarzSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_SchwarzSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_SchwarzSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
