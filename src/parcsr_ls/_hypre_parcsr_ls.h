...
HYPRE_Int hypre_AMGHybridGetSetupTime( void *AMGhybrid_vdata, HYPRE_Real *time );
...
HYPRE_Int HYPRE_ParCSRHybridGetSetupTime( HYPRE_Solver solver, HYPRE_Real  *setup_time );
