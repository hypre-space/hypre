...
typedef struct
{
   ...
   HYPRE_Int          **CF_marker_array;
   HYPRE_Int          *local_num_c_points;
   int          **local_c_point_mask;
   int          **local_f_point_mask;
...
#define hypre_ParAMGDataLocalNumCPoints(amg_data) ((amg_data)-> local_num_c_points)
#define hypre_ParAMGDataLocalCPointMask(amg_data) ((amg_data)-> local_c_point_mask)
#define hypre_ParAMGDataLocalFPointMask(amg_data) ((amg_data)-> local_f_point_mask)
...
HYPRE_Int hypre_ParCSRRelax_Cheby_Solve ( hypre_ParCSRMatrix *A , hypre_ParVector *f , HYPRE_Real *ds_data , HYPRE_Real *coefs , HYPRE_Int order , HYPRE_Int scale , HYPRE_Int variant , hypre_ParVector *u , hypre_ParVector *orig_u , hypre_ParVector *v , hypre_ParVector *r );
...
HYPRE_Int hypre_BoomerAMGPartialCycle( void *amg_vdata, hypre_ParVector **F_array, hypre_ParVector **U_array, HYPRE_Int coarsest_level, HYPRE_Int down_up_cycle );
HYPRE_Int hypre_BoomerAMGCycleTimed ( void *amg_vdata , hypre_ParVector **F_array , hypre_ParVector **U_array, HYPRE_Int time_part );
...
HYPRE_Int hypre_ParCSRRelax_L1_Jacobi_Device ( hypre_ParCSRMatrix *A , hypre_ParVector *f , int *mask , HYPRE_Int num_relax_points , HYPRE_Int relax_points , HYPRE_Real relax_weight , HYPRE_Real *l1_norms , hypre_ParVector *u , hypre_ParVector *Vtemp );
...
HYPRE_Int hypre_BoomerAMGDDSetFACRelax(HYPRE_Solver amg_solver, HYPRE_Int (*userFACRelaxation)( hypre_ParCompGrid*, hypre_ParCompGridMatrix*, hypre_ParCompGridVector*, hypre_ParCompGridVector* ));
...
HYPRE_Int hypre_ParCompGridSetupLocalIndicesGPU( hypre_ParCompGrid **compGrid, HYPRE_Int *num_added_nodes, HYPRE_Int ****recv_map, HYPRE_Int num_recv_procs, HYPRE_Int **A_tmp_info, HYPRE_Int start_level, HYPRE_Int num_levels, HYPRE_Int symmetric );
...
hypre_ParCompGridCommPkg *hypre_ParCompGridCommPkgCreate(HYPRE_Int num_levels);
HYPRE_Int hypre_ParCompGridCommPkgDestroy( hypre_ParCompGridCommPkg *compGridCommPkg );
HYPRE_Int hypre_ParCompGridCommPkgFinalize(hypre_ParAMGData* amg_data, hypre_ParCompGridCommPkg *compGridCommPkg, hypre_ParCompGrid **compGrid);
