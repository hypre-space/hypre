...
__global__ void hypreCUDAKernel_AMSComputePi_copy1(hypre_DeviceItem &item, HYPRE_Int nnz, HYPRE_Int dim,
                                                   HYPRE_Int *j_in,
                                                   HYPRE_Int *j_out);
__global__ void hypreCUDAKernel_AMSComputePi_copy2(hypre_DeviceItem &item, HYPRE_Int nrows, HYPRE_Int dim,
                                                   HYPRE_Int *i_in,
