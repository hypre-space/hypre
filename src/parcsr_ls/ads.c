...
__global__ void hypreCUDAKernel_AMSComputePi_copy1(hypre_Item &item, HYPRE_Int nnz, HYPRE_Int dim, HYPRE_Int *j_in,
                                                   HYPRE_Int *j_out);
__global__ void hypreCUDAKernel_AMSComputePi_copy2(hypre_Item &item, HYPRE_Int nrows, HYPRE_Int dim, HYPRE_Int *i_in,
                                                   HYPRE_Real *data_in, HYPRE_Real *Gx_data, HYPRE_Real *Gy_data, HYPRE_Real *Gz_data,
                                                   HYPRE_Real *data_out);
__global__ void hypreCUDAKernel_AMSComputePixyz_copy(hypre_Item &item, HYPRE_Int nrows, HYPRE_Int dim,
