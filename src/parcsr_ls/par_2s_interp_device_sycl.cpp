                                               ...
                                               hypre_ParCSRMatrix **P_ptr )
{
   ...
   hypre_CSRMatrixComputeRowSumDevice(hypre_ParCSRMatrixDiag(As_FC), nullptr, nullptr, Dbeta, 0, 1.0, "set");
   hypre_CSRMatrixComputeRowSumDevice(hypre_ParCSRMatrixOffd(As_FC), nullptr, nullptr, Dbeta, 0, 1.0, "add");
   ...
   sycl::range<1> gDim = hypre_GetDefaultSYCLGridDimension(A_nr_local, "warp", bDim);
   ...
   gDim = hypre_GetDefaultSYCLGridDimension(AF2F_nr_local, "warp", bDim);

   HYPRE_SYCL_1D_LAUNCH( hypreSYCLKernel_MMInterpScaleAFF,
			 gDim, bDim,
			 AF2F_nr_local,
                                                 ...
                                                 hypre_ParCSRMatrix **P_ptr )
{
   ...
   /* As_FF = As_{F,F} */
   hypre_ParCSRMatrixGenerateFFFCDevice(A, CF_marker, num_cpts_global, S, nullptr, &As_FF);

   hypre_assert(AFC_nr_local == hypre_ParCSRMatrixNumRows(As_FF));

   sycl::range<1> bDim = hypre_GetDefaultSYCLWorkgroupDimension();
   sycl::range<1> gDim = hypre_GetDefaultSYCLGridDimension(AFC_nr_local, "warp", bDim);
   ...
   gDim = hypre_GetDefaultSYCLGridDimension(A_nr_local, "warp", bDim);
   ...
   HYPRE_SYCL_1D_LAUNCH( hypreSYCLKernel_MMPEInterpScaleAFF,
			 gDim, bDim,
			 AF2F_nr_local,
			 hypre_CSRMatrixI(hypre_ParCSRMatrixDiag(As_F2F)),
			 hypre_CSRMatrixJ(hypre_ParCSRMatrixDiag(As_F2F)),
