...
void hypre_BoomerAMGCreateS_rowcount( HYPRE_Int nr_of_rows,
                             ...
                             hypre_ParCSRMatrix   **S_ptr)
{
   ...
   HYPRE_Int               *S_offd_i = nullptr;
   HYPRE_Int               *S_offd_j = nullptr, *S_temp_offd_j = nullptr;
   /* HYPRE_Real           *S_offd_data; */
   HYPRE_Int                i;
   HYPRE_Int                ierr = 0;
   HYPRE_Int               *dof_func_offd_dev = nullptr;
  ...
  /*-------------------------------------------------------------------
   ...
   sycl::range<1> gDim = hypre_GetDefaultSYCLGridDimension(num_variables, "warp", bDim);

   HYPRE_SYCL_1D_LAUNCH( hypre_BoomerAMGCreateS_rowcount, gDim, bDim,
   ...
   hypre_ParCSRMatrixCommPkg(S) = nullptr;
