...
/*
   ...
   Compile with: make ex06

   Sample run:   mpirun -np 2 ex06
...
int main (int argc, char *argv[])
{
   ...
   /* Save the solution for GLVis visualization, see vis/glvis-ex06.sh */
   if (vis)
   {
#ifdef HYPRE_EXVIS
      GLVis_PrintSStructGrid(grid, "vis/ex06.mesh", myid, NULL, NULL);
      GLVis_PrintSStructVector(x, 0, "vis/ex06.sol", myid);
      GLVis_PrintData("vis/ex06.data", myid, num_procs);
#endif
   }
