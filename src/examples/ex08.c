   ...
   /* 4. Set up a SStruct Matrix */
   {
      ...
      if (myid == 0)
      {
            ...
            over the gridpoints in my second box */
         {
            ...
            double *values = (double *) custom_malloc(108 * sizeof(double));
      ...
      else if (myid == 1)
      {
            ...
            over the gridpoints in my box */
         {
            ...
            double *values = (double *) custom_malloc(80 * sizeof(double));
      ...
      if (myid == 0)
      {
         ...
         double *values = (double *) custom_malloc(24 * sizeof(double));
      ...
      if (myid == 0)
      {
         ...
         double *values = (double *) custom_malloc(9 * sizeof(double));
   ...
   /* 5. Set up SStruct Vectors for b and x */
   {
      ...
      if (myid == 0)
      {
         /* Set the vector coefficients over the gridpoints in my first box */
         {
            ...
            double *values = (double *) custom_malloc(6 * sizeof(double));
         ...
         /* Set the vector coefficients over the gridpoints in my second box */
         {
            ...
            double *values = (double *) custom_malloc(12 * sizeof(double));
      ...
      else if (myid == 1)
      {
         /* Set the vector coefficients over the gridpoints in my box */
         {
            ...
            double *values = (double *) custom_malloc(16 * sizeof(double));
