...
/* amg_cycle.c */
HYPRE_Int hypre_AMGCycle P((hypre_Vector **U_array , hypre_Vector **F_array , HYPRE_Real tol , void *data ));
...
/* amg_relax.c */
HYPRE_Int hypre_AMGRelax P((hypre_Vector *u , hypre_Vector *f , hypre_Matrix *A , hypre_VectorInt *ICG , hypre_VectorInt *IV , HYPRE_Int min_point , HYPRE_Int max_point , HYPRE_Int point_type , HYPRE_Int relax_type , HYPRE_Real *D_mat , HYPRE_Real *S_vec ));
HYPRE_Int gselim P((HYPRE_Real *A , HYPRE_Real *x , HYPRE_Int n ));
...
/* data.c */
hypre_AMGData *hypre_AMGNewData P((HYPRE_Int levmax , HYPRE_Int ncg , HYPRE_Real ecg , HYPRE_Int nwt , HYPRE_Real ewt , HYPRE_Int nstr , HYPRE_Int ncyc , HYPRE_Int *mu , HYPRE_Int *ntrlx , HYPRE_Int *iprlx , HYPRE_Int ioutdat , HYPRE_Int cycle_op_count , char *log_file_name ));
...
void hypre_MatvecT P((HYPRE_Real alpha , hypre_Matrix *A , hypre_Vector *x , HYPRE_Real beta , hypre_Vector *y ));

/* random.c */
void hypre_SeedRand P((HYPRE_Int seed ));
HYPRE_Real hypre_Rand P((void ));
...
void hypre_WriteSolverParams P((HYPRE_Real tol , void *data ));
