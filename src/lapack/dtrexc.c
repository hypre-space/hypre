...
/* Subroutine */ integer dtrexc_(const char *compq, integer *n, doublereal *t, integer *
	...
	doublereal *work, integer *info)
{
    ...
    logical wantq;
    extern /* Subroutine */ integer dlaexc_(logical *, integer *, doublereal *, 
	    integer *, doublereal *, integer *, integer *, integer *, integer 
	    *, doublereal *, integer *), xerbla_(const char *, integer *);
    integer nbnext;
