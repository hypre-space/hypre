...
/* Subroutine */ HYPRE_Int zgeqrf_(integer *m, integer *n, doublecomplex *a, 
...
/*           Compute the QR factorization of the current block   
	    ...
	    i__3 = *m - i__ + 1;
	    zgeqr2_(&i__3, &ib, &a_ref(i__, i__), lda, &tau[i__], &work[1], &
		    iinfo);
	    if (i__ + ib <= *n) {
...
/*              Form the triangular factor of the block reflector   
		...
		i__3 = *m - i__ + 1;
		zlarft_("Forward", "Columnwise", &i__3, &ib, &a_ref(i__, i__),
...
/*              Apply H' to A(i:m,i+ib:n) from the left */
		...
		zlarfb_("Left", "Conjugate transpose", "Forward", "Columnwise"
			, &i__3, &i__4, &ib, &a_ref(i__, i__), lda, &work[1], 
...
/*     Use unblocked code to factor the last or only block. */
	...
	i__2 = *m - i__ + 1;
	i__1 = *n - i__ + 1;
	zgeqr2_(&i__2, &i__1, &a_ref(i__, i__), lda, &tau[i__], &work[1], &
		iinfo);
    }
