...
/* Subroutine */ integer dlaqr3_(logical *wantt, logical *wantz, integer *n, 
...
, integer *, doublereal *, doublereal *, integer *, doublereal *, 
    ...
    extern /* Subroutine */ integer dlaset_(const char *, integer *, integer *, 
	    ...
	    dtrexc_(const char *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, integer *, integer *, doublereal *, integer *),
	     dormhr_(const char *, const char *, integer *, integer *, integer *, integer 
	    *, doublereal *, integer *, doublereal *, doublereal *, integer *, 
