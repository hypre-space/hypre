...
/* Subroutine */ integer dlaqr2_(logical *wantt, logical *wantz, integer *n, 
	...
	nv, doublereal *wv, integer *ldwv, doublereal *work, integer *lwork)
{
    ...
    extern /* Subroutine */ integer dlarf_(const char *, integer *, integer *, 
	    ...
	    doublereal *), dgemm_(const char *, const char *, integer *, integer *
