...
/* Subroutine */ integer dlaqr4_(logical *wantt, logical *wantz, integer *n, 
	...
	integer *ldz, doublereal *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ integer dlaqr2_(logical *, logical *, integer *, 
    ...
    integer nibble;
    extern /* Subroutine */ integer dlahqr_(logical *, logical *, integer *, 
	    integer *, integer *, doublereal *, integer *, doublereal *, 
	    doublereal *, integer *, integer *, doublereal *, integer *, 
