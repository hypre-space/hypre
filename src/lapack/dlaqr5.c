...
/* Subroutine */integer dlaqr5_(logical *wantt, logical *wantz, integer *kacc22, 
	...
	integer *ldwv, integer *nh, doublereal *wh, integer *ldwh)
{
    ...
    extern /* Subroutine */integer dlarfg_(integer *, doublereal *, doublereal *, 
	     integer *, doublereal *), dlacpy_(const char *, integer *, integer *, 
	    doublereal *, integer *, doublereal *, integer *);
    doublereal safmin;
    extern /* Subroutine */integer dlaset_(const char *, integer *, integer *, 
