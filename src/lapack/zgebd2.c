...
/* Subroutine */ HYPRE_Int zgebd2_(integer *m, integer *n, doublecomplex *a, 
...
/*              Apply G(i) to A(i+1:m,i+1:n) from the right */
		...
		i__2 = *m - i__;
		i__3 = *n - i__;
		zlarf_("Right", &i__2, &i__3, &a_ref(i__, i__ + 1), lda, &
...
/*           Apply G(i) to A(i+1:m,i:n) from the right   
   ...
   Computing MIN */
	    ...
	    i__3 = *m - i__;
	    i__4 = *n - i__ + 1;
	    zlarf_("Right", &i__3, &i__4, &a_ref(i__, i__), lda, &taup[i__], &
...
/*              Apply H(i)' to A(i+1:m,i+1:n) from the left */
		...
		i__3 = *n - i__;
		d_cnjg(&z__1, &tauq[i__]);
		zlarf_("Left", &i__2, &i__3, &a_ref(i__ + 1, i__), &c__1, &
			z__1, &a_ref(i__ + 1, i__ + 1), lda, &work[1]);
		i__2 = a_subscr(i__ + 1, i__);
		i__3 = i__;
		a[i__2].r = e[i__3], a[i__2].i = 0.;
	    } else {
