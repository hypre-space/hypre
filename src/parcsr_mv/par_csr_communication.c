...
hypre_ParCSRPersistentCommHandleCreate( HYPRE_Int job, hypre_ParCSRCommPkg *comm_pkg )
{
   ...
   if (comm_pkg->neighbor_comm == NULL) {
      printf("Trying to communicate with a NULL communicator\n");
   }
   ...
   switch (job_type)
   {
      ...
      case HYPRE_COMM_PKG_JOB_COMPLEX_TRANSPOSE:
         ...
         MPIX_Neighbor_alltoallv_init( (HYPRE_Complex *)send_buff, recv_sizes,
                                       hypre_ParCSRCommPkgRecvVecStarts(comm_pkg), HYPRE_MPI_COMPLEX,
      ...
      case HYPRE_COMM_PKG_JOB_INT:
         ...
         MPIX_Neighbor_alltoallv_init( (HYPRE_Int *)send_buff, send_sizes,
                                       hypre_ParCSRCommPkgSendMapStarts(comm_pkg), HYPRE_MPI_INT,
      ...
      case HYPRE_COMM_PKG_JOB_INT_TRANSPOSE:
         ...
         MPIX_Neighbor_alltoallv_init( (HYPRE_Int *)send_buff, recv_sizes,
                                       hypre_ParCSRCommPkgRecvVecStarts(comm_pkg), HYPRE_MPI_INT,
      ...
      case HYPRE_COMM_PKG_JOB_BIGINT:
         ...
         MPIX_Neighbor_alltoallv_init( (HYPRE_BigInt *)send_buff, send_sizes,
                                       hypre_ParCSRCommPkgSendMapStarts(comm_pkg), HYPRE_MPI_BIG_INT,
      ...
      case HYPRE_COMM_PKG_JOB_BIGINT_TRANSPOSE:
         ...
         MPIX_Neighbor_alltoallv_init( (HYPRE_BigInt *)send_buff, recv_sizes,
                                       hypre_ParCSRCommPkgRecvVecStarts(comm_pkg), HYPRE_MPI_BIG_INT,
...
#endif
   comm_pkg->neighbor_comm  = NULL;
   comm_pkg->neighborT_comm = NULL;
...
hypre_MatvecCommPkgDestroy( hypre_ParCSRCommPkg *comm_pkg )
{
   ...
   if ( comm_pkg->neighborT_comm )
   {
      MPIX_Comm_free(comm_pkg->neighborT_comm);
   }
