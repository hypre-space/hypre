...
hypre_ParCSRPersistentCommHandleCreate( HYPRE_Int job, hypre_ParCSRCommPkg *comm_pkg )
{
   ...
   switch (job_type)
   {
      case HYPRE_COMM_PKG_JOB_COMPLEX:
         ...
         MPIX_Neighbor_part_locality_alltoallv_init( (HYPRE_Complex *)send_buff, send_sizes,
      ...
      case HYPRE_COMM_PKG_JOB_INT:
         ...
         MPIX_Neighbor_part_locality_alltoallv_init( (HYPRE_Int *)send_buff, send_sizes,
      ...
      case HYPRE_COMM_PKG_JOB_BIGINT:
         ...
         MPIX_Neighbor_part_locality_alltoallv_init( (HYPRE_BigInt *)send_buff, send_sizes,
