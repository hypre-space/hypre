                               ...
                               HYPRE_Complex   *values)
{
   ...
   if (indices)
   {
      ...
      if (ierr)
      {
         ...
         HYPRE_ONEDPL_CALL( gather_if,
                            oneapi::dpl::make_transform_iterator(indices, _1 - first_index),
                            oneapi::dpl::make_transform_iterator(indices, _1 - first_index) + num_values,
                            indices,
                            data,
                            values,
