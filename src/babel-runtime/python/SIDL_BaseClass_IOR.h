 ...
 * Revision:      @(#) $Id: sidl_BaseClass_IOR.h,v 1.6 2007/09/27 19:35:21 painter Exp $
...
struct sidl_BaseClass__controls {
  int     use_hooks;
};
/*
...
extern void sidl_BaseClass__getEPVs(
  ...
  struct sidl_BaseInterface__object* 
    skel_sidl_BaseClass_fconnect_sidl_BaseInterface(const char* url, sidl_bool 
    ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_BaseClass_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    skel_sidl_BaseClass_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
