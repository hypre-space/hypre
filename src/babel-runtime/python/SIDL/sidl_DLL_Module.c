 ...
 * Revision:      @(#) $Id: sidl_DLL_Module.c,v 1.5 2006/08/29 22:29:31 painter Exp $
...
sidl_DLL__remoteConnect(const char *url, sidl_bool ar,                        \
  sidl_BaseInterface *_ex)
{
  struct sidl_DLL__object* self;
...
sidl_DLL_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidl_DLL__convert, &optarg, &url, &implObj);
  if (_okay) {
