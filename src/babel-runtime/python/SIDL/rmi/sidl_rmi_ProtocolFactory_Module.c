 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolFactory_Module.c,v 1.6 2007/09/27 19:35:33 painter Exp $
...
static PyObject *
pStub_ProtocolFactory__connect(PyObject *_ignored, PyObject *_args, PyObject  \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolFactory__object* self = NULL;
  char* url = NULL;
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &url);
  if (_okay) {
    self = sidl_rmi_ProtocolFactory__remoteConnect(url,1,&_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidl_rmi_ProtocolFactory__wrap, self);
    }
  }
...
static PyObject *
pStub_ProtocolFactory__exec(PyObject *_self, PyObject *_args, PyObject        \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolFactory__object *_self_ior =
    ((struct sidl_rmi_ProtocolFactory__object *)
     sidl_Cast(_self, "sidl.rmi.ProtocolFactory"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidl.rmi.ProtocolFactory");
  }
  return _return_value;
}

static PyObject *
pStub_ProtocolFactory__getURL(PyObject *_self, PyObject *_args, PyObject      \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolFactory__object *_self_ior =
    ((struct sidl_rmi_ProtocolFactory__object *)
...
static PyObject *
pStub_ProtocolFactory__isLocal(PyObject *_self, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolFactory__object *_self_ior =
    ((struct sidl_rmi_ProtocolFactory__object *)
...
static PyObject *
pStub_ProtocolFactory__isRemote(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolFactory__object *_self_ior =
    ((struct sidl_rmi_ProtocolFactory__object *)
...
static PyObject *
pStub_ProtocolFactory__set_hooks(PyObject *_self, PyObject *_args, PyObject   \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolFactory__object *_self_ior =
    ((struct sidl_rmi_ProtocolFactory__object *)
...
static PyObject *
pStub_ProtocolFactory__set_hooks_static(PyObject *_ignored, PyObject *_args,  \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  sidl_bool on = (sidl_bool) 0;
  struct sidl_BaseInterface__object *_exception = NULL;
...
pStub_ProtocolFactory_connectInstance(PyObject *_ignored, PyObject *_args,    \
  ...
  if (_okay) {
    ...
    _return = (*(_sepv->f_connectInstance))(url, ar, &_exception);
    if (_exception) {
      struct sidl_RuntimeException__object *_ex0;
      if ((_ex0 = (struct sidl_RuntimeException__object *)
      sidl_PyExceptionCast(_exception, "sidl.RuntimeException"))) {
...
static PyObject *
pStub_ProtocolFactory_unserializeInstance(PyObject *_ignored, PyObject *_args,\
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  char* url = NULL;
  struct sidl_BaseInterface__object *_exception = NULL;
  ...
  if (_okay) {
    ...
    _return = (*(_sepv->f_unserializeInstance))(url, &_exception);
    if (_exception) {
      struct sidl_RuntimeException__object *_ex0;
      if ((_ex0 = (struct sidl_RuntimeException__object *)
      sidl_PyExceptionCast(_exception, "sidl.RuntimeException"))) {
...
static int
sidl_rmi_ProtocolFactory_createCast(PyObject *self, PyObject *args, PyObject  \
  *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidl_rmi_ProtocolFactory__convert, &optarg, &url, &implObj);
  if (_okay) {
    ...
    struct sidl_BaseInterface__object *_exception = NULL;
    optarg = sidl_rmi_ProtocolFactory__remoteCreate(url,&_exception);
    if (_exception) {
      sidl_rmi_NetworkException__import();
      struct sidl_rmi_NetworkException__object *_ex0;
      if ((_ex0 = (struct sidl_rmi_NetworkException__object *)
...
Return empty string if the prefix"
  ...
  { "unserializeInstance", (                                                  \
    PyCFunction)pStub_ProtocolFactory_unserializeInstance,
  (METH_VARARGS | METH_KEYWORDS),
"\
unserializeInstance( in string url)\n\
RETURNS\n\
...
null if protocol unknown or InstanceHandle.init() failed.  "
  ...
  { "_connect", (PyCFunction)pStub_ProtocolFactory__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out sidl.rmi.ProtocolFactory self)\n\
RAISES\n\
    sidl.rmi.NetworkException\n\
"
   },
  { "_set_hooks_static", (PyCFunction)pStub_ProtocolFactory__set_hooks_static,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyMethodDef _ProtocolFactoryObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_ProtocolFactory__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_ProtocolFactory__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_ProtocolFactory__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_ProtocolFactory__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_ProtocolFactory__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
intent is to parse a URL (e.g. \"babel://server:port/class\") and\n\
create classes that implement\n\
<code>sidl.rmi.InstanceHandle</code>.", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  0,       /* tp_weaklistoffset */
...
sidl_rmi_ProtocolFactory__wrap sidl_rmi_ProtocolFactory__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidl_rmi_ProtocolFactoryType.tp_new(                            \
      &_sidl_rmi_ProtocolFactoryType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
<code>sidl.rmi.InstanceHandle</code>."
  ...
  ExternalAPI[sidl_rmi_ProtocolFactory__connectI_NUM] = (                     \
    void*)sidl_rmi_ProtocolFactory__connectI;
  ExternalAPI[sidl_rmi_ProtocolFactory__rmicast_NUM] = (                      \
    void*)sidl_rmi_ProtocolFactory__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  PyTuple_SetItem(_sidl_rmi_ProtocolFactoryType.tp_bases,0, (PyObject         \
  ...
  Py_INCREF(&_sidl_rmi_ProtocolFactoryType);
  PyDict_SetItemString(dict, "ProtocolFactory", (PyObject                     \
    *)&_sidl_rmi_ProtocolFactoryType);
