 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_rmi_UnexpectedCloseException_Module.c,v 1.1 2006/08/29 23:43:46 painter Exp $
...
sidl_rmi_UnexpectedCloseException_createCast(PyObject *self, PyObject *args,  \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidl_rmi_UnexpectedCloseException__convert, &optarg, &url,        \
    &implObj);
  if (_okay) {
...
sidl_rmi_UnexpectedCloseException__wrap                                       \
  ...
  if (sidlobj) {
    result =                                                                  \
      _sidl_rmi_UnexpectedCloseExceptionType.tp_new(                          \
...
software connection abort, connection reset by peer, etc. "
  ...
  if (PyType_Ready(&_sidl_rmi_UnexpectedCloseExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr,                                                           \
      "PyType_Ready on sidl.rmi.UnexpectedCloseException failed.\n");
    return;
  }
  Py_INCREF(&_sidl_rmi_UnexpectedCloseExceptionType);
  PyDict_SetItemString(dict, "UnexpectedCloseException",                      \
    (PyObject *)&_sidl_rmi_UnexpectedCloseExceptionType);
