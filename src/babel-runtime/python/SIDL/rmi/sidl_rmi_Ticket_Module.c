 ...
 * Revision:      @(#) $Id: sidl_rmi_Ticket_Module.c,v 1.2 2007/09/27 19:35:33 painter Exp $
...
static PyObject *
pStub_Ticket__connect(PyObject *_ignored, PyObject *_args, PyObject *_kwdict) \
  {
...
static PyObject *
pStub_Ticket_createEmptyTicketBook(PyObject *_self, PyObject *_args, PyObject \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_Ticket__object *_self_ior =
    ((struct sidl_rmi_Ticket__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      _return = (*(_self_ior->d_epv->f_createEmptyTicketBook))(               \
...
static PyObject *
pStub_Ticket_getResponse(PyObject *_self, PyObject *_args, PyObject *_kwdict) \
  {
  PyObject *_return_value = NULL;
  struct sidl_rmi_Ticket__object *_self_ior =
    ((struct sidl_rmi_Ticket__object *)
...
sidl_rmi_Ticket_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "O&", _kwlist, (void    \
    *)sidl_rmi_Ticket__convert, &optarg);
  if (_okay) {
...
Used in lieu of a Response in nonblocking calls"
  ...
  PyTuple_SetItem(_sidl_rmi_TicketType.tp_bases,0, (PyObject                  \
