 ...
 * Revision:      @(#) $Id: sidl_rmi_Return_Module.c,v 1.1 2006/08/29 23:43:46 painter Exp $
...
static PyObject *
pStub_Return__connect(PyObject *_ignored, PyObject *_args,                    \
  PyObject *_kwdict) {
...
static PyObject *
pStub_Return_throwException(PyObject *_self, PyObject *_args,                 \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_Return__object *_self_ior =
    ((struct sidl_rmi_Return__object *)
...
sidl_rmi_Return_createCast(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "O&", _kwlist,          \
    (void *)sidl_rmi_Return__convert, &optarg);
  if (_okay) {
...
{
  struct sidl_rmi_Return__object *sidlobj;
...
call."
  ...
  ExternalAPI[sidl_rmi_Return__rmicast_NUM] = (void*)sidl_rmi_Return__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  PyTuple_SetItem(_sidl_rmi_ReturnType.tp_bases,0,                            \
    (PyObject *)sidl_io_Serializer_PyType());
