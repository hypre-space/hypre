 ...
 * Revision:      @(#) $Id: sidl_rmi_UnknownHostException_Module.c,v 1.1 2006/08/29 23:43:46 painter Exp $
...
static PyObject *
pStub_UnknownHostException__exec(PyObject *_self, PyObject *_args,            \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_UnknownHostException__getURL(PyObject *_self, PyObject *_args,          \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_UnknownHostException__object *_self_ior =
    ((struct sidl_rmi_UnknownHostException__object *)
...
sidl_rmi_UnknownHostException_createCast(PyObject *self, PyObject *args,      \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidl_rmi_UnknownHostException__convert, &optarg, &url, &implObj);
  if (_okay) {
...
sidl_rmi_UnknownHostException__wrap sidl_rmi_UnknownHostException__wrap_PROTO \
  ...
  if (sidlobj) {
    result =                                                                  \
      _sidl_rmi_UnknownHostExceptionType.tp_new(                              \
...
host can not be found by a DNS lookup."
  ...
  PyTuple_SetItem(_sidl_rmi_UnknownHostExceptionType.tp_bases,0,              \
    (PyObject *)sidl_rmi_NetworkException_PyType());
  if (PyType_Ready(&_sidl_rmi_UnknownHostExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr,                                                           \
      "PyType_Ready on sidl.rmi.UnknownHostException failed.\n");
    return;
  }
  Py_INCREF(&_sidl_rmi_UnknownHostExceptionType);
  PyDict_SetItemString(dict, "UnknownHostException",                          \
    (PyObject *)&_sidl_rmi_UnknownHostExceptionType);
