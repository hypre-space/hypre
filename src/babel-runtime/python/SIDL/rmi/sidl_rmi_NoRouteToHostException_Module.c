/*
 * File:          sidl_rmi_NoRouteToHostException_Module.c
 * Symbol:        sidl.rmi.NoRouteToHostException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_Module.c,v 1.2 2007/09/27 19:35:33 painter Exp $
...
#define sidl_rmi_NoRouteToHostException_INTERNAL 1
#include "sidl_rmi_NoRouteToHostException_Module.h"
...
static PyObject *
pStub_NoRouteToHostException__connect(PyObject *_ignored, PyObject *_args,    \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoRouteToHostException__object* self = NULL;
  char* url = NULL;
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &url);
  if (_okay) {
    self = sidl_rmi_NoRouteToHostException__remoteConnect(url,1,&_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidl_rmi_NoRouteToHostException__wrap, self);
    }
  }
  return _return_value;
}

staticforward PyTypeObject _sidl_rmi_NoRouteToHostExceptionType;

static const struct sidl_rmi_NoRouteToHostException__external *_implEPV =     \
  NULL;

static PyObject *
pStub_NoRouteToHostException__exec(PyObject *_self, PyObject *_args, PyObject \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoRouteToHostException__object *_self_ior =
    ((struct sidl_rmi_NoRouteToHostException__object *)
     sidl_Cast(_self, "sidl.rmi.NoRouteToHostException"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidl.rmi.NoRouteToHostException");
  }
  return _return_value;
}

static PyObject *
pStub_NoRouteToHostException__getURL(PyObject *_self, PyObject *_args,        \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoRouteToHostException__object *_self_ior =
    ((struct sidl_rmi_NoRouteToHostException__object *)
...
static PyObject *
pStub_NoRouteToHostException__isLocal(PyObject *_self, PyObject *_args,       \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoRouteToHostException__object *_self_ior =
    ((struct sidl_rmi_NoRouteToHostException__object *)
...
static PyObject *
pStub_NoRouteToHostException__isRemote(PyObject *_self, PyObject *_args,      \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoRouteToHostException__object *_self_ior =
    ((struct sidl_rmi_NoRouteToHostException__object *)
...
static PyObject *
pStub_NoRouteToHostException__set_hooks(PyObject *_self, PyObject *_args,     \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoRouteToHostException__object *_self_ior =
    ((struct sidl_rmi_NoRouteToHostException__object *)
...
static int
sidl_rmi_NoRouteToHostException_createCast(PyObject *self, PyObject *args,    \
  PyObject *kwds) {
  struct sidl_rmi_NoRouteToHostException__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidl_rmi_NoRouteToHostException__convert, &optarg, &url, &implObj);
  if (_okay) {
    ...
    struct sidl_BaseInterface__object *_exception = NULL;
    optarg = sidl_rmi_NoRouteToHostException__remoteCreate(url,&_exception);
    if (_exception) {
      sidl_rmi_NetworkException__import();
      struct sidl_rmi_NetworkException__object *_ex0;
      if ((_ex0 = (struct sidl_rmi_NetworkException__object *)
...
static PyMethodDef _NoRouteToHostExceptionModuleMethods[] = {
  { "_connect", (PyCFunction)pStub_NoRouteToHostException__connect,
...
static PyMethodDef _NoRouteToHostExceptionObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_NoRouteToHostException__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_NoRouteToHostException__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_NoRouteToHostException__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_NoRouteToHostException__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_NoRouteToHostException__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _sidl_rmi_NoRouteToHostExceptionType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidl.rmi.NoRouteToHostException.NoRouteToHostException", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
...
a router is down.", /* tp_doc */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _NoRouteToHostExceptionObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidl_rmi_NoRouteToHostException_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};
...
sidl_rmi_NoRouteToHostException__wrap                                         \
  ...
  PyObject *result;
  if (sidlobj) {
    result = _sidl_rmi_NoRouteToHostExceptionType.tp_new(                     \
      &_sidl_rmi_NoRouteToHostExceptionType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidl_rmi_NoRouteToHostException_PyType                                        \
  ...
  Py_INCREF(&_sidl_rmi_NoRouteToHostExceptionType);
  return &_sidl_rmi_NoRouteToHostExceptionType;
}
...
sidl_rmi_NoRouteToHostException__convert                                      \
  ...
  *sidlobj = sidl_Cast(obj, "sidl.rmi.NoRouteToHostException");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidl.rmi.NoRouteToHostException");
    return 0;
  }
  return 1;
}
...
{
  struct sidl_rmi_NoRouteToHostException__object *sidlobj;
  if (sidl_rmi_NoRouteToHostException__convert(pyobj, &sidlobj)) {
...
{
  struct sidl_rmi_NoRouteToHostException__object *sidlobj = (struct           \
    sidl_rmi_NoRouteToHostException__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidl_rmi_NoRouteToHostException__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initNoRouteToHostException(void) {
  PyObject *module, *dict, *c_api;
  PyObject *_exceptionBases, *_exceptionDict, *_exceptionName;
  static void *ExternalAPI[sidl_rmi_NoRouteToHostException__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule3("NoRouteToHostException",                           \
    _NoRouteToHostExceptionModuleMethods, "\
\
This exception is thrown by the RMI library when a host \n\
can be found by DNS, but is not reachable.  It usually means \n\
a router is down."
  ...
  ExternalAPI[sidl_rmi_NoRouteToHostException__wrap_NUM] = (                  \
    void*)sidl_rmi_NoRouteToHostException__wrap;
  ExternalAPI[sidl_rmi_NoRouteToHostException__convert_NUM] = (               \
    void*)sidl_rmi_NoRouteToHostException__convert;
  ExternalAPI[sidl_rmi_NoRouteToHostException__convert_python_array_NUM] = (  \
    void*)sidl_rmi_NoRouteToHostException__convert_python_array;
  ExternalAPI[sidl_rmi_NoRouteToHostException__convert_sidl_array_NUM] = (    \
    void*)sidl_rmi_NoRouteToHostException__convert_sidl_array;
  ExternalAPI[sidl_rmi_NoRouteToHostException__weakRef_NUM] = (               \
    void*)sidl_rmi_NoRouteToHostException__weakRef;
  ExternalAPI[sidl_rmi_NoRouteToHostException_deref_NUM] = (                  \
    void*)sidl_rmi_NoRouteToHostException_deref;
  ExternalAPI[sidl_rmi_NoRouteToHostException__newRef_NUM] = (                \
    void*)sidl_rmi_NoRouteToHostException__newRef;
  ExternalAPI[sidl_rmi_NoRouteToHostException__addRef_NUM] = (                \
    void*)sidl_rmi_NoRouteToHostException__addRef;
  ExternalAPI[sidl_rmi_NoRouteToHostException_PyType_NUM] = (                 \
    void*)sidl_rmi_NoRouteToHostException_PyType;
  ExternalAPI[sidl_rmi_NoRouteToHostException__connectI_NUM] = (              \
    void*)sidl_rmi_NoRouteToHostException__connectI;
  ExternalAPI[sidl_rmi_NoRouteToHostException__rmicast_NUM] = (               \
    void*)sidl_rmi_NoRouteToHostException__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  Py_INCREF(Py_None);
  ExternalAPI[sidl_rmi_NoRouteToHostException__type_NUM] = Py_None;
  ...
  sidl_rmi_NetworkException__import();
  _sidl_rmi_NoRouteToHostExceptionType.tp_base =                              \
    sidl_rmi_NetworkException_PyType();
  _sidl_rmi_NoRouteToHostExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidl_rmi_NoRouteToHostExceptionType.tp_bases,0, (PyObject  \
    *)sidl_rmi_NetworkException_PyType());
  if (PyType_Ready(&_sidl_rmi_NoRouteToHostExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidl.rmi.NoRouteToHostException          \
      failed.\n");
    return;
  }
  Py_INCREF(&_sidl_rmi_NoRouteToHostExceptionType);
  PyDict_SetItemString(dict, "NoRouteToHostException", (PyObject              \
    *)&_sidl_rmi_NoRouteToHostExceptionType);
  ...
  _implEPV = sidl_rmi_NoRouteToHostException__externals();
  if (!_implEPV) {
  ...
  sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.NoRouteToHostException", \
    (void*)sidl_rmi_NoRouteToHostException__IHConnect, &throwaway_exception);
}
