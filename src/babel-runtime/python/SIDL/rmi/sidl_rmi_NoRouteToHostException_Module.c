 ...
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_Module.c,v 1.1 2006/08/29 23:43:45 painter Exp $
...
static PyObject *
pStub_NoRouteToHostException__exec(PyObject *_self, PyObject *_args,          \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
sidl_rmi_NoRouteToHostException_createCast(PyObject *self, PyObject *args,    \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidl_rmi_NoRouteToHostException__convert, &optarg, &url,          \
    &implObj);
  if (_okay) {
...
sidl_rmi_NoRouteToHostException__wrap                                         \
  ...
  if (sidlobj) {
    result =                                                                  \
      _sidl_rmi_NoRouteToHostExceptionType.tp_new(                            \
...
a router is down."
  ...
  PyTuple_SetItem(_sidl_rmi_NoRouteToHostExceptionType.tp_bases,0,            \
    (PyObject *)sidl_rmi_NetworkException_PyType());
  if (PyType_Ready(&_sidl_rmi_NoRouteToHostExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr,                                                           \
      "PyType_Ready on sidl.rmi.NoRouteToHostException failed.\n");
    return;
  }
  Py_INCREF(&_sidl_rmi_NoRouteToHostExceptionType);
  PyDict_SetItemString(dict, "NoRouteToHostException",                        \
    (PyObject *)&_sidl_rmi_NoRouteToHostExceptionType);
