 ...
 * Revision:      @(#) $Id: sidl_rmi_ObjectDoesNotExistException_Module.c,v 1.1 2006/08/29 23:43:46 painter Exp $
...
static PyObject *
pStub_ObjectDoesNotExistException__connect(PyObject *_ignored,                \
...
static int
sidl_rmi_ObjectDoesNotExistException_createCast(PyObject *self,               \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidl_rmi_ObjectDoesNotExistException__convert, &optarg, &url,     \
    &implObj);
  if (_okay) {
...
sidl_rmi_ObjectDoesNotExistException__wrap                                    \
  ...
  if (sidlobj) {
    result =                                                                  \
      _sidl_rmi_ObjectDoesNotExistExceptionType.tp_new(                       \
...
{
  struct sidl_rmi_ObjectDoesNotExistException__object *sidlobj;
...
id does not match any known object. "
  ...
  ExternalAPI[sidl_rmi_ObjectDoesNotExistException__rmicast_NUM] =            \
    (void*)sidl_rmi_ObjectDoesNotExistException__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  if (PyType_Ready(&_sidl_rmi_ObjectDoesNotExistExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr,                                                           \
      "PyType_Ready on sidl.rmi.ObjectDoesNotExistException failed.\n");
    return;
  }
  Py_INCREF(&_sidl_rmi_ObjectDoesNotExistExceptionType);
  PyDict_SetItemString(dict, "ObjectDoesNotExistException",                   \
    (PyObject *)&_sidl_rmi_ObjectDoesNotExistExceptionType);
