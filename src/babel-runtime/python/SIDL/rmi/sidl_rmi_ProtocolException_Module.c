 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolException_Module.c,v 1.1 2006/08/29 23:43:46 painter Exp $
...
static PyObject *
pStub_ProtocolException__exec(PyObject *_self, PyObject *_args,               \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_ProtocolException__getURL(PyObject *_self, PyObject *_args,             \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolException__object *_self_ior =
    ((struct sidl_rmi_ProtocolException__object *)
...
static PyObject *
pStub_ProtocolException__isLocal(PyObject *_self, PyObject *_args,            \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolException__object *_self_ior =
    ((struct sidl_rmi_ProtocolException__object *)
...
static PyObject *
pStub_ProtocolException__isRemote(PyObject *_self, PyObject *_args,           \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolException__object *_self_ior =
    ((struct sidl_rmi_ProtocolException__object *)
...
static PyObject *
pStub_ProtocolException__set_hooks(PyObject *_self, PyObject *_args,          \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ProtocolException__object *_self_ior =
    ((struct sidl_rmi_ProtocolException__object *)
...
sidl_rmi_ProtocolException_createCast(PyObject *self, PyObject *args,         \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidl_rmi_ProtocolException__convert, &optarg, &url, &implObj);
  if (_okay) {
...
sidl_rmi_ProtocolException__wrap sidl_rmi_ProtocolException__wrap_PROTO {
  ...
  if (sidlobj) {
    result =                                                                  \
      _sidl_rmi_ProtocolExceptionType.tp_new(&_sidl_rmi_ProtocolExceptionType,\
      NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
This is a base class for all protocol specific exceptions."
  ...
  sidl_rmi_NetworkException__import();
  _sidl_rmi_ProtocolExceptionType.tp_base =                                   \
    sidl_rmi_NetworkException_PyType();
  _sidl_rmi_ProtocolExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidl_rmi_ProtocolExceptionType.tp_bases,0,                 \
  ...
  Py_INCREF(&_sidl_rmi_ProtocolExceptionType);
  PyDict_SetItemString(dict, "ProtocolException",                             \
    (PyObject *)&_sidl_rmi_ProtocolExceptionType);
