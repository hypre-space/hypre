/*
 * File:          ClassInfoI_Module.c
 * Symbol:        SIDL.ClassInfoI-v0.8.1
 * Symbol Type:   class
 * Babel Version: 0.8.0
 * Release:       $Name: V1-9-0b $
 * Revision:      @(#) $Id: ClassInfoI_Module.c,v 1.1 2003/02/12 23:26:49 painter Exp $
...
static PyObject *
pStub_ClassInfoI_addRef(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
...
static PyObject *
pStub_ClassInfoI_deleteRef(PyObject *_self, PyObject *_args,                  \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct SIDL_ClassInfoI__object *_self_ior =
    ((struct SIDL_ClassInfoI__object *)
...
static PyObject *
pStub_ClassInfoI_isSame(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct SIDL_ClassInfoI__object *_self_ior =
    ((struct SIDL_ClassInfoI__object *)
     SIDL_Cast(_self, "SIDL.ClassInfoI"));
...
static PyObject *
pStub_ClassInfoI_queryInt(PyObject *_self, PyObject *_args,                   \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct SIDL_ClassInfoI__object *_self_ior =
    ((struct SIDL_ClassInfoI__object *)
...
static PyObject *
pStub_ClassInfoI_isType(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct SIDL_ClassInfoI__object *_self_ior =
    ((struct SIDL_ClassInfoI__object *)
     SIDL_Cast(_self, "SIDL.ClassInfoI"));
...
static PyObject *
pStub_ClassInfoI_getClassInfo(PyObject *_self, PyObject *_args,               \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct SIDL_ClassInfoI__object *_self_ior =
    ((struct SIDL_ClassInfoI__object *)
...
static PyObject *
pStub_ClassInfoI_getName(PyObject *_self, PyObject *_args,                    \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct SIDL_ClassInfoI__object *_self_ior =
    ((struct SIDL_ClassInfoI__object *)
...
static PyObject *
pStub_ClassInfoI_getIORVersion(PyObject *_self, PyObject *_args,              \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct SIDL_ClassInfoI__object *_self_ior =
    ((struct SIDL_ClassInfoI__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      char* _return = NULL;
      _return = (*(_self_ior->d_epv->f_getIORVersion))(_self_ior);
      _return_value = Py_BuildValue(
        "z",
        _return);
      free((void *)_return);
...
_createCast(PyObject *self, PyObject *args) {
  ...
  int _okay = PyArg_ParseTuple(args, "|O&", (void *)SIDL_ClassInfoI__convert, \
    &optarg);
  if (_okay) {
    if (optarg) {
    ...
    return SIDL_ClassInfoI__wrap(optarg);
  }
  return NULL;
}

static PyMethodDef _ClassInfoIModuleMethods[] = {
  { "ClassInfoI", _createCast, METH_VARARGS, "Constructor and/or cast method for SIDL.ClassInfoI"
   },
  { NULL, NULL }
};

static PyMethodDef _ClassInfoIObjectMethods[] = {
  { "addRef", (PyCFunction)pStub_ClassInfoI_addRef,
...
class.\n\
  ...
  { "deleteRef", (PyCFunction)pStub_ClassInfoI_deleteRef,
  (METH_VARARGS | METH_KEYWORDS),
"\
deleteRef()\n\
RETURNS\n\
...
reference to an object or interface."
  ...
  { "getClassInfo", (PyCFunction)pStub_ClassInfoI_getClassInfo,
  (METH_VARARGS | METH_KEYWORDS),
"\
getClassInfo()\n\
RETURNS\n\
...
Return the meta-data about the class implementing this interface."
  ...
  { "getIORVersion", (PyCFunction)pStub_ClassInfoI_getIORVersion,
  (METH_VARARGS | METH_KEYWORDS),
"\
getIORVersion()\n\
RETURNS\n\
...
This will be in the form of major_version.minor_version."
  ...
  { "getName", (PyCFunction)pStub_ClassInfoI_getName,
  (METH_VARARGS | METH_KEYWORDS),
"\
getName()\n\
RETURNS\n\
...
Return the name of the class."
  ...
  { "isSame", (PyCFunction)pStub_ClassInfoI_isSame,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
object as this object."
  ...
  { "isType", (PyCFunction)pStub_ClassInfoI_isType,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
the string type name would succeed."
  ...
  { "queryInt", (PyCFunction)pStub_ClassInfoI_queryInt,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
SIDL_ClassInfoI__newRef SIDL_ClassInfoI__newRef_PROTO {
  return SIDL_Object_Create((struct SIDL_BaseClass__object *) sidlobj,        \
    _ClassInfoIObjectMethods, SIDL_PyNewRef);
}
...
SIDL_ClassInfoI__convert_sidl_array_RETURN
  SIDL_ClassInfoI__convert_sidl_array                                         \
    SIDL_ClassInfoI__convert_sidl_array_PROTO {PyObject *pya = NULL;
  if (sidlarray) {
...
SIDL_ClassInfoI__destroy_sidl_array SIDL_ClassInfoI__destroy_sidl_array_PROTO \
  {
  if (sidlarray) {
    SIDL_interface__array_deleteRef(
      (struct SIDL_interface__array *)sidlarray);
...
<code>ClassInfo</code> interface."
  ...
  ExternalAPI[SIDL_ClassInfoI__destroy_sidl_array_NUM] =                      \
    (void*)SIDL_ClassInfoI__destroy_sidl_array;
  ...
  Py_XDECREF(c_api);
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module SIDL.ClassInfoI.");
  }
  import_SIDLPyArrays();
  if (PyErr_Occurred()) {
