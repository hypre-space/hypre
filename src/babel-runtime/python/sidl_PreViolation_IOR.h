/*
 * File:          sidl_PreViolation_IOR.h
 * Symbol:        sidl.PreViolation-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_PreViolation_IOR.h,v 1.6 2007/09/27 19:35:22 painter Exp $
 * Description:   Intermediate Object Representation for sidl.PreViolation
 * 
...
#define included_sidl_PreViolation_IOR_h
...
struct sidl_PreViolation__epv {
  ...
  /* Methods introduced in sidl.PreViolation-v0.9.15 */
};
...
struct sidl_PreViolation__controls {
  int     use_hooks;
};
/*
...
struct sidl_PreViolation__object {
  ...
  struct sidl_PreViolation__epv*       d_epv;
  void*                                d_data;
};

struct sidl_PreViolation__external {
  struct sidl_PreViolation__object*
...
const struct sidl_PreViolation__external*
sidl_PreViolation__externals(void);

extern struct sidl_PreViolation__object*
sidl_PreViolation__new(void* ddata,struct sidl_BaseInterface__object ** _ex);

extern void sidl_PreViolation__init(
  struct sidl_PreViolation__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidl_PreViolation__getEPVs(
  ...
  struct sidl_PreViolation__epv **s_arg_epv__sidl_previolation,struct 
    sidl_PreViolation__epv **s_arg_epv_hooks__sidl_previolation);
  extern void sidl_PreViolation__fini(
    struct sidl_PreViolation__object* self, struct sidl_BaseInterface__object 
      ** _ex);
  extern void sidl_PreViolation__IOR_version(int32_t *major, int32_t *minor);
  ...
  struct sidl_BaseException__object* 
    skel_sidl_PreViolation_fconnect_sidl_BaseException(const char* url, 
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseException__object* 
    skel_sidl_PreViolation_fcast_sidl_BaseException(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_BaseInterface__object* 
    skel_sidl_PreViolation_fconnect_sidl_BaseInterface(const char* url, 
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_PreViolation_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_PreViolation__object* 
    skel_sidl_PreViolation_fconnect_sidl_PreViolation(const char* url, 
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_PreViolation__object* 
    skel_sidl_PreViolation_fcast_sidl_PreViolation(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_sidl_PreViolation_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_SIDLException__object* 
    skel_sidl_PreViolation_fconnect_sidl_SIDLException(const char* url, 
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_SIDLException__object* 
    skel_sidl_PreViolation_fcast_sidl_SIDLException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Deserializer__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Deserializer__object* 
    skel_sidl_PreViolation_fcast_sidl_io_Deserializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializable__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializable__object* 
    skel_sidl_PreViolation_fcast_sidl_io_Serializable(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_io_Serializer__object* 
    skel_sidl_PreViolation_fconnect_sidl_io_Serializer(const char* url, 
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
    skel_sidl_PreViolation_fcast_sidl_io_Serializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_PreViolation__remote{
    int d_refcount;
