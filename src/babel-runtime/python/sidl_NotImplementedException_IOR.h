/*
 * File:          sidl_NotImplementedException_IOR.h
 * Symbol:        sidl.NotImplementedException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_NotImplementedException_IOR.h,v 1.2 2007/09/27 19:35:22 painter Exp $
 * Description:   Intermediate Object Representation for sidl.NotImplementedException
 * 
...
#define included_sidl_NotImplementedException_IOR_h
...
struct sidl_NotImplementedException__epv {
  ...
  /* Methods introduced in sidl.NotImplementedException-v0.9.15 */
};
...
struct sidl_NotImplementedException__controls {
  int     use_hooks;
};
/*
...
struct sidl_NotImplementedException__object {
  ...
  struct sidl_NotImplementedException__epv* d_epv;
  void*                                     d_data;
};

struct sidl_NotImplementedException__external {
  struct sidl_NotImplementedException__object*
...
const struct sidl_NotImplementedException__external*
sidl_NotImplementedException__externals(void);

extern struct sidl_NotImplementedException__object*
sidl_NotImplementedException__new(void* ddata,struct sidl_BaseInterface__object 
  ** _ex);

extern void sidl_NotImplementedException__init(
  struct sidl_NotImplementedException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidl_NotImplementedException__getEPVs(
  ...
  struct sidl_NotImplementedException__epv 
    **s_arg_epv__sidl_notimplementedexception,struct 
    sidl_NotImplementedException__epv 
    **s_arg_epv_hooks__sidl_notimplementedexception);
  extern void sidl_NotImplementedException__fini(
    struct sidl_NotImplementedException__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void sidl_NotImplementedException__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct sidl_BaseClass__object* 
    skel_sidl_NotImplementedException_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_BaseException__object* 
    skel_sidl_NotImplementedException_fconnect_sidl_BaseException(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseException__object* 
    skel_sidl_NotImplementedException_fcast_sidl_BaseException(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_BaseInterface__object* 
    skel_sidl_NotImplementedException_fconnect_sidl_BaseInterface(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_NotImplementedException_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidl_NotImplementedException_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_NotImplementedException__object* 
    skel_sidl_NotImplementedException_fconnect_sidl_NotImplementedException(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_NotImplementedException__object* 
    skel_sidl_NotImplementedException_fcast_sidl_NotImplementedException(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_RuntimeException__object* 
    skel_sidl_NotImplementedException_fconnect_sidl_RuntimeException(const 
  ...
  struct sidl_SIDLException__object* 
    skel_sidl_NotImplementedException_fconnect_sidl_SIDLException(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_SIDLException__object* 
    skel_sidl_NotImplementedException_fcast_sidl_SIDLException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializer__object* 
    skel_sidl_NotImplementedException_fconnect_sidl_io_Serializer(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
    skel_sidl_NotImplementedException_fcast_sidl_io_Serializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_NotImplementedException__remote{
    int d_refcount;
