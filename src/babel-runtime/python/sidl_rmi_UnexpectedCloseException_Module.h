 ...
 * Revision:      @(#) $Id: sidl_rmi_UnexpectedCloseException_Module.h,v 1.2 2007/09/27 19:35:23 painter Exp $
...
#define sidl_rmi_UnexpectedCloseException__wrap_PROTO (struct sidl_rmi_UnexpectedCloseException__object *sidlobj)
...
#define sidl_rmi_UnexpectedCloseException__rmicast_NUM 10
#define sidl_rmi_UnexpectedCloseException__rmicast_RETURN struct sidl_rmi_UnexpectedCloseException__object* 
#define sidl_rmi_UnexpectedCloseException__rmicast_PROTO (void* bi, struct sidl_BaseInterface__object ** _ex)

#define sidl_rmi_UnexpectedCloseException__type_NUM 11

#define sidl_rmi_UnexpectedCloseException__API_NUM 12
...
#define sidl_rmi_UnexpectedCloseException__rmicast \
  (*((sidl_rmi_UnexpectedCloseException__rmicast_RETURN (*) \
  sidl_rmi_UnexpectedCloseException__rmicast_PROTO) \
  (sidl_rmi_UnexpectedCloseException__API \
  [sidl_rmi_UnexpectedCloseException__rmicast_NUM])))
...
{ \
  ...
  if (!sidl_rmi_UnexpectedCloseException__API) { \
    PyObject *module = PyImport_ImportModule("sidl.rmi.UnexpectedCloseException"); \
    if (module != NULL) { \
