 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolException_IOR.h,v 1.2 2007/09/27 19:35:23 painter Exp $
...
sidl_rmi_ProtocolException__new(void* ddata,struct sidl_BaseInterface__object 
  ** _ex);

extern void sidl_rmi_ProtocolException__init(
  struct sidl_rmi_ProtocolException__object* self, void* ddata, struct 
...
extern void sidl_rmi_ProtocolException__getEPVs(
  ...
  struct sidl_rmi_ProtocolException__epv 
    **s_arg_epv__sidl_rmi_protocolexception,struct 
    sidl_rmi_ProtocolException__epv 
    **s_arg_epv_hooks__sidl_rmi_protocolexception);
  extern void sidl_rmi_ProtocolException__fini(
    struct sidl_rmi_ProtocolException__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void sidl_rmi_ProtocolException__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct sidl_BaseClass__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseException__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_BaseException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_SIDLException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_SIDLException__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_SIDLException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Deserializer__object* 
    ...
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Deserializer__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_io_Deserializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_IOException__object* 
    ...
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_IOException__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_io_IOException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializable__object* 
    ...
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializable__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_io_Serializable(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializer__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
    skel_sidl_rmi_ProtocolException_fcast_sidl_io_Serializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);
