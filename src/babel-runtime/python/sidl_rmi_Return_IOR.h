/*
 * File:          sidl_rmi_Return_IOR.h
 * Symbol:        sidl.rmi.Return-v0.9.15
 * Symbol Type:   interface
 * Babel Version: 1.0.0
 * Release:       $Name: V2-2-0b $
 * Revision:      @(#) $Id: sidl_rmi_Return_IOR.h,v 1.1 2006/08/29 23:39:46 painter Exp $
 * Description:   Intermediate Object Representation for sidl.rmi.Return
 * 
...
#define included_sidl_rmi_Return_IOR_h
...
struct sidl_rmi_Return__object {
  struct sidl_rmi_Return__epv* d_epv;
  void*                        d_object;
};
 ...
 */
/*
 * Symbol "sidl.rmi._Return" (version 1.0)
 */

struct sidl_rmi__Return__array;
struct sidl_rmi__Return__object;

/*
 * Declare the method entry point vector.
 */

struct sidl_rmi__Return__epv {
  /* Implicit builtin methods */
  void* (*f__cast)(
  ...
  void (*f_throwException)(
    ...
    /* in */ struct sidl_BaseException__object* ex_to_throw,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidl.rmi._Return-v1.0 */
};
...
struct sidl_rmi__Return__object {
  ...
  struct sidl_rmi__Return__epv*     d_epv;
  void*                             d_data;
};


struct sidl_rmi__Return__remote{
  int d_refcount;
