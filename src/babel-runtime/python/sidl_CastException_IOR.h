/*
 * File:          sidl_CastException_IOR.h
 * Symbol:        sidl.CastException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_CastException_IOR.h,v 1.2 2007/09/27 19:35:21 painter Exp $
...
#define included_sidl_CastException_IOR_h
...
struct sidl_CastException__epv {
  ...
  /* Methods introduced in sidl.CastException-v0.9.15 */
};
...
struct sidl_CastException__controls {
  int     use_hooks;
};
/*
...
struct sidl_CastException__object {
  ...
  struct sidl_CastException__epv*      d_epv;
  void*                                d_data;
};

struct sidl_CastException__external {
  struct sidl_CastException__object*
...
extern void sidl_CastException__init(
  struct sidl_CastException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidl_CastException__getEPVs(
  ...
  extern void sidl_CastException__fini(
    struct sidl_CastException__object* self, struct sidl_BaseInterface__object 
      ** _ex);
  extern void sidl_CastException__IOR_version(int32_t *major, int32_t *minor);

  struct sidl_BaseClass__object* 
    skel_sidl_CastException_fconnect_sidl_BaseClass(const char* url, sidl_bool 
  ...
  struct sidl_BaseException__object* 
    skel_sidl_CastException_fcast_sidl_BaseException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_CastException_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_CastException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_CastException__object* 
    skel_sidl_CastException_fcast_sidl_CastException(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_ClassInfo__object* 
    skel_sidl_CastException_fconnect_sidl_ClassInfo(const char* url, sidl_bool 
    ar, struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_sidl_CastException_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_SIDLException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_SIDLException__object* 
    skel_sidl_CastException_fcast_sidl_SIDLException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Deserializer__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Deserializer__object* 
    skel_sidl_CastException_fcast_sidl_io_Deserializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializable__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializable__object* 
    skel_sidl_CastException_fcast_sidl_io_Serializable(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializer__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
    skel_sidl_CastException_fcast_sidl_io_Serializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_CastException__remote{
    int d_refcount;
