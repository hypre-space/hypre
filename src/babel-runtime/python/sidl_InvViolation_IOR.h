 ...
 * Revision:      @(#) $Id: sidl_InvViolation_IOR.h,v 1.5 2006/08/29 22:29:27 painter Exp $
...
extern void sidl_InvViolation__init(
  struct sidl_InvViolation__object* self, void* ddata,
...
extern void sidl_InvViolation__getEPVs(
  ...
  struct sidl_BaseClass__object* 
    skel_sidl_InvViolation_fconnect_sidl_BaseClass(const char* url,
  ...
  struct sidl_ClassInfo__object* 
    skel_sidl_InvViolation_fconnect_sidl_ClassInfo(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
