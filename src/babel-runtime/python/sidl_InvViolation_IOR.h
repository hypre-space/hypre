 ...
 * Revision:      @(#) $Id: sidl_InvViolation_IOR.h,v 1.6 2007/09/27 19:35:22 painter Exp $
...
struct sidl_InvViolation__epv {
  ...
  /* Methods introduced in sidl.InvViolation-v0.9.15 */
};
...
struct sidl_InvViolation__controls {
  int     use_hooks;
};
/*
...
extern void sidl_InvViolation__init(
  struct sidl_InvViolation__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidl_InvViolation__getEPVs(
  ...
  struct sidl_BaseException__object* 
    skel_sidl_InvViolation_fcast_sidl_BaseException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_InvViolation_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_InvViolation__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_InvViolation__object* 
    skel_sidl_InvViolation_fcast_sidl_InvViolation(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_sidl_InvViolation_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_SIDLException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_SIDLException__object* 
    skel_sidl_InvViolation_fcast_sidl_SIDLException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Deserializer__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Deserializer__object* 
    skel_sidl_InvViolation_fcast_sidl_io_Deserializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializable__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializable__object* 
    skel_sidl_InvViolation_fcast_sidl_io_Serializable(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializer__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
    skel_sidl_InvViolation_fcast_sidl_io_Serializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_InvViolation__remote{
    int d_refcount;
