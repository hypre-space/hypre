 ...
 * Revision:      @(#) $Id: sidl_rmi_InstanceRegistry_IOR.h,v 1.6 2007/09/27 19:35:22 painter Exp $
...
extern void sidl_rmi_InstanceRegistry__getEPVs(
  ...
  struct sidl_BaseClass__object* 
    skel_sidl_rmi_InstanceRegistry_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_rmi_InstanceRegistry_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidl_rmi_InstanceRegistry_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    skel_sidl_rmi_InstanceRegistry_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
