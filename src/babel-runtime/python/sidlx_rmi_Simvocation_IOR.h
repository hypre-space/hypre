...
struct sidlx_rmi_Simvocation__controls {
  int     use_hooks;
};
/*
...
sidlx_rmi_Simvocation__new(void* ddata,
  struct sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_Simvocation__init(
  struct sidlx_rmi_Simvocation__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void sidlx_rmi_Simvocation__getEPVs(
  ...
  struct sidl_rmi_Invocation__epv **s_arg_epv_hooks__sidl_rmi_invocation,
  struct sidlx_rmi_Simvocation__epv **s_arg_epv__sidlx_rmi_simvocation,
    struct sidlx_rmi_Simvocation__epv **s_arg_epv_hooks__sidlx_rmi_simvocation);
  extern void sidlx_rmi_Simvocation__fini(
    struct sidlx_rmi_Simvocation__object* self,
      struct sidl_BaseInterface__object ** _ex);
  extern void sidlx_rmi_Simvocation__IOR_version(int32_t *major,
    int32_t *minor);
