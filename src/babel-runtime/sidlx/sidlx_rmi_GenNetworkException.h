...
#define included_sidlx_rmi_GenNetworkException_h
...
typedef struct sidlx_rmi_GenNetworkException__object* 
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[]);
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[]);
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_create1d(int32_t len);
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_create1dInit(
  int32_t len, 
  sidlx_rmi_GenNetworkException* data);
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_create2dCol(int32_t m, int32_t n);
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_create2dRow(int32_t m, int32_t n);
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_borrow(
  sidlx_rmi_GenNetworkException* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_smartCopy(
  struct sidlx_rmi_GenNetworkException__array *array);

/**
 * Increment the array's internal reference count by one.
 */
void
sidlx_rmi_GenNetworkException__array_addRef(
  struct sidlx_rmi_GenNetworkException__array* array);
 ...
 */
void
sidlx_rmi_GenNetworkException__array_deleteRef(
  struct sidlx_rmi_GenNetworkException__array* array);
 ...
 */
sidlx_rmi_GenNetworkException
sidlx_rmi_GenNetworkException__array_get1(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1);
 ...
 */
sidlx_rmi_GenNetworkException
sidlx_rmi_GenNetworkException__array_get2(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2);
 ...
 */
sidlx_rmi_GenNetworkException
sidlx_rmi_GenNetworkException__array_get3(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3);
 ...
 */
sidlx_rmi_GenNetworkException
sidlx_rmi_GenNetworkException__array_get4(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_GenNetworkException
sidlx_rmi_GenNetworkException__array_get5(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_GenNetworkException
sidlx_rmi_GenNetworkException__array_get6(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_GenNetworkException
sidlx_rmi_GenNetworkException__array_get7(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_GenNetworkException
sidlx_rmi_GenNetworkException__array_get(
  const struct sidlx_rmi_GenNetworkException__array* array,
 ...
 */
void
sidlx_rmi_GenNetworkException__array_set1(
  struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  sidlx_rmi_GenNetworkException const value);

/**
 * Set element (i1,i2) of a(n) 2-dimensional array to value.
 */
void
sidlx_rmi_GenNetworkException__array_set2(
  struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  sidlx_rmi_GenNetworkException const value);
 ...
 */
void
sidlx_rmi_GenNetworkException__array_set3(
  struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_GenNetworkException__array_set4(
  struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_GenNetworkException__array_set5(
  struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_GenNetworkException__array_set6(
  struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_GenNetworkException__array_set7(
  struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_GenNetworkException__array_set(
  struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t indices[],
  sidlx_rmi_GenNetworkException const value);
 ...
 */
int32_t
sidlx_rmi_GenNetworkException__array_dimen(
  const struct sidlx_rmi_GenNetworkException__array* array);
 ...
 */
int32_t
sidlx_rmi_GenNetworkException__array_lower(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t ind);
 ...
 */
int32_t
sidlx_rmi_GenNetworkException__array_upper(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t ind);
 ...
 */
int32_t
sidlx_rmi_GenNetworkException__array_length(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t ind);
 ...
 */
int32_t
sidlx_rmi_GenNetworkException__array_stride(
  const struct sidlx_rmi_GenNetworkException__array* array,
  const int32_t ind);
 ...
 */
int
sidlx_rmi_GenNetworkException__array_isColumnOrder(
  const struct sidlx_rmi_GenNetworkException__array* array);
 ...
 */
int
sidlx_rmi_GenNetworkException__array_isRowOrder(
  const struct sidlx_rmi_GenNetworkException__array* array);
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_slice(
 ...
 */
void
sidlx_rmi_GenNetworkException__array_copy(
  const struct sidlx_rmi_GenNetworkException__array* src,
  struct sidlx_rmi_GenNetworkException__array* dest);
 ...
 */
struct sidlx_rmi_GenNetworkException__array*
sidlx_rmi_GenNetworkException__array_ensure(
  struct sidlx_rmi_GenNetworkException__array* src,
  int32_t dimen,
  int     ordering);
