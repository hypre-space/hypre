...
sidlx_rmi_SimReturn_init__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "methodName", &methodName,
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "objectid", &objectid,
    _ex);SIDL_CHECK(*_ex);
...
sidlx_rmi_SimReturn_throwException__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "ex_to_throw", &ex_to_throw_str,
    _ex);SIDL_CHECK(*_ex);
  ex_to_throw = 
    skel_sidlx_rmi_SimReturn_fconnect_sidl_BaseException(ex_to_throw_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
  ...
  /* clean-up dangling references */
  if(ex_to_throw) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)ex_to_throw,
      _ex); SIDL_CHECK(*_ex);
...
sidlx_rmi_SimReturn_packSerializable__exec(
  ...
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "key", &key, _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "value", &value_str,
    _ex);SIDL_CHECK(*_ex);
  ...
  if(key) {free(key);}
  if(value) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)value,
      _ex); SIDL_CHECK(*_ex);
...
sidlx_rmi_SimReturn_packGenericArray__exec(
  ...
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "key", &key, _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackGenericArray( inArgs, "value", &value,
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackBool( inArgs, "reuse_array", &reuse_array,
    _ex);SIDL_CHECK(*_ex);
 ...
 */
  ...
  epv->f_isType                     = (sidl_bool (*)(struct 
    sidlx_rmi_SimReturn__object*,const char*,
