...
sidlx_rmi_GenNetworkException_isSame__exec(
  ...
  iobj = skel_sidlx_rmi_GenNetworkException_fconnect_sidl_BaseInterface(
...
sidlx_rmi_GenNetworkException_unpackObj__exec(
  ...
  des = skel_sidlx_rmi_GenNetworkException_fconnect_sidl_io_Deserializer(
...
ior_sidlx_rmi_GenNetworkException__raddRef(
    struct sidlx_rmi_GenNetworkException__object* self, sidl_BaseInterface* 
  _ex) {
 ...
 */
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidlx_rmi_GenNetworkException__object*,const char*,struct 
