...
static struct sidlx_rmi_ChildSocket__object* 
  sidlx_rmi_ChildSocket__IHConnect(struct sidl_rmi_InstanceHandle__object* 
  ...
  *_ex = NULL;
  {
    ...
    /* pack in and inout arguments */
    sidl_rmi_Invocation_packInt( _inv, "fileDes", fileDes,
      _ex);SIDL_CHECK(*_ex);
...
sidlx_rmi_ChildSocket__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "sidlx.rmi.ChildSocket",
    _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidlx_rmi_ChildSocket__object*) malloc(
