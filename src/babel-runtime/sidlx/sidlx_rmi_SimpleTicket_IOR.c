...
static struct sidlx_rmi_SimpleTicket__epv s_new_epv__sidlx_rmi_simpleticket;

static struct sidlx_rmi_SimpleTicket__epv 
  s_new_epv_hooks__sidlx_rmi_simpleticket;
...
sidlx_rmi_SimpleTicket_setResponse__exec(
  ...
  if(r) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)r, _ex); SIDL_CHECK(*_ex);
    if(r_str) {free(r_str);}
  }
  return;
 ...
 */
  ...
  struct sidlx_rmi_SimpleTicket__epv*  epv  = 
    &s_new_epv__sidlx_rmi_simpleticket;
  struct sidlx_rmi_SimpleTicket__epv*  hepv = 
    &s_new_epv_hooks__sidlx_rmi_simpleticket;
  ...
  struct sidl_rmi_Ticket__epv*         he2  = &s_new_epv_hooks__sidl_rmi_ticket;
  ...
  epv->f_addRef                     = (void (*)(struct 
    sidlx_rmi_SimpleTicket__object*,struct sidl_BaseInterface__object **)) 
    s1->f_addRef;
  epv->f_deleteRef                  = (void (*)(struct 
    sidlx_rmi_SimpleTicket__object*,struct sidl_BaseInterface__object **)) 
    s1->f_deleteRef;
  epv->f_isSame                     = (sidl_bool (*)(struct 
    sidlx_rmi_SimpleTicket__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                     = (sidl_bool (*)(struct 
    sidlx_rmi_SimpleTicket__object*,const char*,struct 
    sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo               = (struct sidl_ClassInfo__object* (*)(
    struct sidlx_rmi_SimpleTicket__object*,struct sidl_BaseInterface__object 
    **)) s1->f_getClassInfo;
  epv->f_block                      = NULL;
  epv->f_test                       = NULL;
  ...
  memcpy((void*)hepv, epv, sizeof(struct sidlx_rmi_SimpleTicket__epv));
    ...
    sidlx_rmi_SimpleTicket__epv **s_arg_epv_hooks__sidlx_rmi_simpleticket)
{
  ...
  *s_arg_epv__sidlx_rmi_simpleticket = &s_new_epv__sidlx_rmi_simpleticket;
...
static struct sidl_BaseClass__epv* sidlx_rmi_SimpleTicket__super(void) {
...
static void
initMetadata(struct sidlx_rmi_SimpleTicket__object* self, sidl_BaseInterface* 
  _ex)
{
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                   = &s_new_epv__sidlx_rmi_simpleticket;

  s0->d_sidl_rmi_ticket.d_object = self;

  s0->d_data = NULL;

  ior_sidlx_rmi_SimpleTicket__set_hooks(s0, FALSE, _ex);
...
s_externalEntryPoints = {
  sidlx_rmi_SimpleTicket__new,
  sidlx_rmi_SimpleTicket__super,
  1, 
  0
};
