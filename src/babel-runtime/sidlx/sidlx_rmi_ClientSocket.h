...
#define included_sidlx_rmi_ClientSocket_h
...
typedef struct sidlx_rmi_ClientSocket__object* sidlx_rmi_ClientSocket;
 ...
 */
sidlx_rmi_ClientSocket
sidlx_rmi_ClientSocket__connect(const char *, sidl_BaseInterface *_ex);
...
#pragma weak sidlx_rmi_ClientSocket__connectI

#pragma weak sidlx_rmi_ClientSocket__rmicast
