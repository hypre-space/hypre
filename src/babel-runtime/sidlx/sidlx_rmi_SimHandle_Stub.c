...
static const struct sidlx_rmi_SimHandle__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidlx_rmi_SimHandle__external* _loadIOR(void)
/*
...

{
  ...
  _externals = sidlx_rmi_SimHandle__externals();
#else
  _externals = (struct sidlx_rmi_SimHandle__external*)sidl_dynamicLoadIOR(
    "sidlx.rmi.SimHandle","sidlx_rmi_SimHandle__externals") ;
...
static struct sidlx_rmi_SimHandle__object* sidlx_rmi_SimHandle__remoteConnect(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct sidlx_rmi_SimHandle__object* sidlx_rmi_SimHandle__IHConnect(
...
sidlx_rmi_SimHandle__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct sidlx_rmi_SimHandle__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
sidlx_rmi_SimHandle__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct sidlx_rmi_SimHandle__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct sidlx_rmi_SimHandle__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct sidlx_rmi_SimHandle__array*)sidl_interface__array_create1dInit(
...
{
  return (struct sidlx_rmi_SimHandle__array*)sidl_interface__array_create2dCol(
    m, n);
}
...
{
  return (struct sidlx_rmi_SimHandle__array*)sidl_interface__array_create2dRow(
    m, n);
}
...
{
  return (struct sidlx_rmi_SimHandle__array*)sidl_interface__array_borrow(
...
{
  return (struct sidlx_rmi_SimHandle__array*)
...
static struct sidlx_rmi_SimHandle__epv s_rem_epv__sidlx_rmi_simhandle;
  ...
  *_ex = NULL;
  {
    ...
    sidl_rmi_Invocation_packString( _inv, "typeName", typeName, _ex);SIDL_CHECK(
      *_ex);
...
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimHandle.createInvocation.", &throwaway_exception);
    ...
    sidl_rmi_Response_unpackString( _rsvp, "_retval", &_retval_str, 
      _ex);SIDL_CHECK(*_ex);
    _retval = sidl_rmi_Invocation__connectI(_retval_str, FALSE, _ex);SIDL_CHECK(
      *_ex);
...
static void sidlx_rmi_SimHandle__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct sidlx_rmi_SimHandle__epv*     epv = &s_rem_epv__sidlx_rmi_simhandle;
  struct sidl_BaseClass__epv*          e0  = &s_rem_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv*      e1  = &s_rem_epv__sidl_baseinterface;
  struct sidl_rmi_InstanceHandle__epv* e2  = 
    &s_rem_epv__sidl_rmi_instancehandle;

  epv->f__cast                 = remote_sidlx_rmi_SimHandle__cast;
  ...
  e2->f__exec            = (void (*)(void*,const char*,struct 
    sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
    sidl_BaseInterface__object **)) epv->f__exec;
  e2->f_initCreate       = (sidl_bool (*)(void*,const char*,const char*,struct 
    sidl_BaseInterface__object **)) epv->f_initCreate;
  ...
  e2->f_getProtocol      = (char* (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getProtocol;
  e2->f_getObjectID      = (char* (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getObjectID;
  e2->f_getObjectURL     = (char* (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getObjectURL;
  e2->f_createInvocation = (struct sidl_rmi_Invocation__object* (*)(void*,const 
    char*,struct sidl_BaseInterface__object **)) epv->f_createInvocation;
...
sidlx_rmi_SimHandle__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "sidlx.rmi.SimHandle", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidlx_rmi_SimHandle__object*) malloc(
      sizeof(struct sidlx_rmi_SimHandle__object));
