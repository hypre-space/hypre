/*
 * File:          sidlx_rmi_SimpleOrb_Stub.c
...
static sidlx_rmi_SimpleOrb sidlx_rmi_SimpleOrb__remoteCreate(const char* url, 
...
{
  return sidlx_rmi_SimpleOrb__remoteCreate(url, _ex);
}

static struct sidlx_rmi_SimpleOrb__object* sidlx_rmi_SimpleOrb__remoteConnect(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct sidlx_rmi_SimpleOrb__object* sidlx_rmi_SimpleOrb__IHConnect(
...
sidlx_rmi_SimpleOrb
sidlx_rmi_SimpleOrb__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidlx_rmi_SimpleOrb__remoteConnect(url, TRUE, _ex);
}
...
sidlx_rmi_SimpleOrb__cast(
  ...
  sidl_BaseInterface* _ex)
{
  sidlx_rmi_SimpleOrb cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.SimpleOrb", (
      void*)sidlx_rmi_SimpleOrb__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidlx_rmi_SimpleOrb) (*base->d_epv->f__cast)(
      base->d_object,
      "sidlx.rmi.SimpleOrb", _ex); SIDL_CHECK(*_ex);
  }
...
sidlx_rmi_SimpleOrb__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidlx_rmi_SimpleOrb__isRemote(self,_ex);
}
...
sidlx_rmi_SimpleOrb__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct sidlx_rmi_SimpleOrb__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
sidlx_rmi_SimpleOrb__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct sidlx_rmi_SimpleOrb__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct sidlx_rmi_SimpleOrb__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct sidlx_rmi_SimpleOrb__array*)sidl_interface__array_create1dInit(
...
{
  return (struct sidlx_rmi_SimpleOrb__array*)sidl_interface__array_create2dCol(
    m, n);
}
...
{
  return (struct sidlx_rmi_SimpleOrb__array*)sidl_interface__array_create2dRow(
    m, n);
}
...
{
  return (struct sidlx_rmi_SimpleOrb__array*)sidl_interface__array_borrow(
...
{
  return (struct sidlx_rmi_SimpleOrb__array*)
...
static struct sidlx_rmi_SimpleOrb__epv s_rem_epv__sidlx_rmi_simpleorb;
...
static void* remote_sidlx_rmi_SimpleOrb__cast(
...
static void remote_sidlx_rmi_SimpleOrb__delete(
  struct sidlx_rmi_SimpleOrb__object* self,
  sidl_BaseInterface* _ex)
{
  *_ex = NULL;
...
static char* remote_sidlx_rmi_SimpleOrb__getURL(
  struct sidlx_rmi_SimpleOrb__object* self, sidl_BaseInterface* _ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct 
    sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_sidlx_rmi_SimpleOrb__raddRef(
  struct sidlx_rmi_SimpleOrb__object* self,sidl_BaseInterface* _ex)
{
...
static sidl_bool
remote_sidlx_rmi_SimpleOrb__isRemote(
    struct sidlx_rmi_SimpleOrb__object* self, 
    sidl_BaseInterface *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_sidlx_rmi_SimpleOrb__set_hooks(
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb._set_hooks.", &throwaway_exception);
...
static void remote_sidlx_rmi_SimpleOrb__exec(
  struct sidlx_rmi_SimpleOrb__object* self,const char* methodName,
...
static void
remote_sidlx_rmi_SimpleOrb_serviceRequest(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.serviceRequest.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static char*
remote_sidlx_rmi_SimpleOrb_isLocalObject(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* in */ const char* url,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.isLocalObject.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static char*
remote_sidlx_rmi_SimpleOrb_getProtocol(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.getProtocol.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
remote_sidlx_rmi_SimpleOrb_getExceptions(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.getExceptions.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_sidlx_rmi_SimpleOrb_setMaxThreadPool(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* in */ int32_t max,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.setMaxThreadPool.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static sidl_bool
remote_sidlx_rmi_SimpleOrb_requestPort(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* in */ int32_t port,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.requestPort.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static sidl_bool
remote_sidlx_rmi_SimpleOrb_requestPortInRange(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* in */ int32_t minport,
  /* in */ int32_t maxport,
  /* out */ struct sidl_BaseInterface__object* *_ex)
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.requestPortInRange.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static int32_t
remote_sidlx_rmi_SimpleOrb_getPort(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.getPort.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static char*
remote_sidlx_rmi_SimpleOrb_getServerName(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.getServerName.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static char*
remote_sidlx_rmi_SimpleOrb_getServerURL(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* in */ const char* objID,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.getServerURL.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static int64_t
remote_sidlx_rmi_SimpleOrb_run(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.run.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_sidlx_rmi_SimpleOrb_shutdown(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.shutdown.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void
remote_sidlx_rmi_SimpleOrb_addRef(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    struct sidlx_rmi_SimpleOrb__remote* r_obj = (struct 
      sidlx_rmi_SimpleOrb__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
...
static void
remote_sidlx_rmi_SimpleOrb_deleteRef(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
...
static sidl_bool
remote_sidlx_rmi_SimpleOrb_isSame(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.isSame.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static sidl_bool
remote_sidlx_rmi_SimpleOrb_isType(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* in */ const char* name,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.isType.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
remote_sidlx_rmi_SimpleOrb_getClassInfo(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self ,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if(_be != NULL) {
      sidl_BaseInterface throwaway_exception = NULL;
sidl_BaseException_addLine(_be, "Exception unserialized from sidlx.rmi.SimpleOrb.getClassInfo.", &throwaway_exception);
      *_ex = (sidl_BaseInterface) sidl_BaseInterface__rmicast(_be,
        &throwaway_exception);
      goto EXIT;
    }
...
static void sidlx_rmi_SimpleOrb__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct sidlx_rmi_SimpleOrb__epv*    epv = &s_rem_epv__sidlx_rmi_simpleorb;
  ...
  epv->f__cast                   = remote_sidlx_rmi_SimpleOrb__cast;
  epv->f__delete                 = remote_sidlx_rmi_SimpleOrb__delete;
  epv->f__exec                   = remote_sidlx_rmi_SimpleOrb__exec;
  epv->f__getURL                 = remote_sidlx_rmi_SimpleOrb__getURL;
  epv->f__raddRef                = remote_sidlx_rmi_SimpleOrb__raddRef;
  epv->f__isRemote               = remote_sidlx_rmi_SimpleOrb__isRemote;
  epv->f__set_hooks              = remote_sidlx_rmi_SimpleOrb__set_hooks;
  epv->f__ctor                   = NULL;
  epv->f__ctor2                  = NULL;
  epv->f__dtor                   = NULL;
  epv->f_serviceRequest          = remote_sidlx_rmi_SimpleOrb_serviceRequest;
  epv->f_isLocalObject           = remote_sidlx_rmi_SimpleOrb_isLocalObject;
  epv->f_getProtocol             = remote_sidlx_rmi_SimpleOrb_getProtocol;
  epv->f_getExceptions           = remote_sidlx_rmi_SimpleOrb_getExceptions;
  epv->f_setMaxThreadPool        = remote_sidlx_rmi_SimpleOrb_setMaxThreadPool;
  epv->f_requestPort             = remote_sidlx_rmi_SimpleOrb_requestPort;
  epv->f_requestPortInRange      = 
    remote_sidlx_rmi_SimpleOrb_requestPortInRange;
  epv->f_getPort                 = remote_sidlx_rmi_SimpleOrb_getPort;
  epv->f_getServerName           = remote_sidlx_rmi_SimpleOrb_getServerName;
  epv->f_getServerURL            = remote_sidlx_rmi_SimpleOrb_getServerURL;
  epv->f_run                     = remote_sidlx_rmi_SimpleOrb_run;
  epv->f_shutdown                = remote_sidlx_rmi_SimpleOrb_shutdown;
  epv->f_addRef                  = remote_sidlx_rmi_SimpleOrb_addRef;
  epv->f_deleteRef               = remote_sidlx_rmi_SimpleOrb_deleteRef;
  epv->f_isSame                  = remote_sidlx_rmi_SimpleOrb_isSame;
  epv->f_isType                  = remote_sidlx_rmi_SimpleOrb_isType;
  epv->f_getClassInfo            = remote_sidlx_rmi_SimpleOrb_getClassInfo;
...
static struct sidlx_rmi_SimpleOrb__object*
sidlx_rmi_SimpleOrb__remoteConnect(const char *url, sidl_bool ar, 
  sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_SimpleOrb__object* self;

  struct sidlx_rmi_SimpleOrb__object* s0;
  ...
  *_ex = NULL;
  ...
  r_obj =
    (struct sidlx_rmi_SimpleOrb__remote*) malloc(
      sizeof(struct sidlx_rmi_SimpleOrb__remote));
  ...
  if (!s_remote_initialized) {
    sidlx_rmi_SimpleOrb__init_remote_epv();
  }
  UNLOCK_STATIC_GLOBALS;
  ...
  s0->d_epv  = &s_rem_epv__sidlx_rmi_simpleorb;
...
static struct sidlx_rmi_SimpleOrb__object*
sidlx_rmi_SimpleOrb__IHConnect(sidl_rmi_InstanceHandle instance, 
  sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_SimpleOrb__object* self;
...
static struct sidlx_rmi_SimpleOrb__object*
sidlx_rmi_SimpleOrb__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
...
sidlx_rmi_SimpleOrb__rmicast(
  ...
  sidl_BaseInterface* _ex)
{
  struct sidlx_rmi_SimpleOrb__object* cast = NULL;
  ...
  *_ex = NULL;
  ...
  if (obj != NULL) {
    ...
    cast = (struct sidlx_rmi_SimpleOrb__object*) (*base->d_epv->f__cast)(
      base->d_object,
      "sidlx.rmi.SimpleOrb", _ex); SIDL_CHECK(*_ex);
  }
