...
static struct sidlx_rmi_SimCall__epv s_new_epv__sidlx_rmi_simcall;

static struct sidlx_rmi_SimCall__epv s_new_epv_hooks__sidlx_rmi_simcall;
...
static struct sidl_rmi_Call__epv s_new_epv__sidl_rmi_call;
static struct sidl_rmi_Call__epv s_new_epv_hooks__sidl_rmi_call;
...
sidlx_rmi_SimCall_unpackBoolArray__exec(
  ...
  sidl_rmi_Call_unpackBool( inArgs, "isRarray", &isRarray,
    _ex);SIDL_CHECK(*_ex);
...
sidlx_rmi_SimCall_unpackIntArray__exec(
  ...
  /* pack return value */
  /* pack out and inout argments */
  sidl_rmi_Return_packIntArray( outArgs, "value", *value,0,0,0,
    _ex);SIDL_CHECK(*_ex);
  /* clean-up dangling references */
  if(key) {free(key);}
  sidl__array_deleteRef((struct sidl__array*)*value);
...
sidlx_rmi_SimCall_unpackGenericArray__exec(
  ...
  /* pack return value */
  /* pack out and inout argments */
  sidl_rmi_Return_packGenericArray( outArgs, "value", *value,0,
    _ex);SIDL_CHECK(*_ex);
  /* clean-up dangling references */
  if(key) {free(key);}
  sidl__array_deleteRef((struct sidl__array*)*value);
 ...
 */
  ...
  struct sidlx_rmi_SimCall__epv*    epv  = &s_new_epv__sidlx_rmi_simcall;
  struct sidlx_rmi_SimCall__epv*    hepv = &s_new_epv_hooks__sidlx_rmi_simcall;
  ...
  struct sidl_rmi_Call__epv*        e3   = &s_new_epv__sidl_rmi_call;
  struct sidl_rmi_Call__epv*        he3  = &s_new_epv_hooks__sidl_rmi_call;
  ...
  epv->f_isSame                       = (sidl_bool (*)(struct 
    sidlx_rmi_SimCall__object*,struct sidl_BaseInterface__object*,
    struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                       = (sidl_bool (*)(struct 
    sidlx_rmi_SimCall__object*,const char*,
  ...
  memcpy((void*)hepv, epv, sizeof(struct sidlx_rmi_SimCall__epv));
  ...
  memcpy((void*) he3, e3, sizeof(struct sidl_rmi_Call__epv));
    ...
    struct sidlx_rmi_SimCall__epv **s_arg_epv_hooks__sidlx_rmi_simcall)
{
  ...
  *s_arg_epv_hooks__sidl_io_deserializer = 
    &s_new_epv_hooks__sidl_io_deserializer;
  *s_arg_epv__sidl_rmi_call = &s_new_epv__sidl_rmi_call;
  *s_arg_epv_hooks__sidl_rmi_call = &s_new_epv_hooks__sidl_rmi_call;
  *s_arg_epv__sidlx_rmi_simcall = &s_new_epv__sidlx_rmi_simcall;
  *s_arg_epv_hooks__sidlx_rmi_simcall = &s_new_epv_hooks__sidlx_rmi_simcall;
}
/*
 * SUPER: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* sidlx_rmi_SimCall__super(void) {
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_rmi_call.d_epv        = &s_new_epv__sidl_rmi_call;
  s0->d_epv                        = &s_new_epv__sidlx_rmi_simcall;
  ...
  ior_sidlx_rmi_SimCall__set_hooks(s0, FALSE, _ex);
...
s_externalEntryPoints = {
  sidlx_rmi_SimCall__new,
  sidlx_rmi_SimCall__super,
  0, 
  10
};
