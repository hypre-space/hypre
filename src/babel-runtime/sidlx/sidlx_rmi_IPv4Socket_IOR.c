...
static void
sidlx_rmi_IPv4Socket_test__exec(
        struct sidlx_rmi_IPv4Socket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_IPv4Socket__set_hooks(
  struct sidlx_rmi_IPv4Socket__object* self,
...
static void
ior_sidlx_rmi_IPv4Socket__raddRef(
    struct sidlx_rmi_IPv4Socket__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_sidlx_rmi_IPv4Socket__isRemote(
    struct sidlx_rmi_IPv4Socket__object* self, sidl_BaseInterface* _ex) {
  *_ex = NULL; /* default to no exception */
  return FALSE;
}
...
ior_sidlx_rmi_IPv4Socket__exec(
  ...
  static const struct sidlx_rmi_IPv4Socket__method  s_methods[] = {
    ...
    { "test", sidlx_rmi_IPv4Socket_test__exec },
...
static void sidlx_rmi_IPv4Socket__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct sidlx_rmi_IPv4Socket__epv*  hepv = 
  ...
  struct sidlx_rmi_Socket__epv*      he2  = &s_new_epv_hooks__sidlx_rmi_socket;
  ...
  epv->f__raddRef                 = ior_sidlx_rmi_IPv4Socket__raddRef;
  epv->f__isRemote                = ior_sidlx_rmi_IPv4Socket__isRemote;
  epv->f__set_hooks               = ior_sidlx_rmi_IPv4Socket__set_hooks;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
    ...
    sidlx_rmi_IPv4Socket__epv **s_arg_epv_hooks__sidlx_rmi_ipv4socket)
{
  ...
  if (!s_method_initialized) {
    sidlx_rmi_IPv4Socket__init_epv();
  }
...
static void
initMetadata(struct sidlx_rmi_IPv4Socket__object* self, sidl_BaseInterface* _ex)
{
...
sidlx_rmi_IPv4Socket__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  sidlx_rmi_IPv4Socket__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_sidlx_rmi_IPv4Socket__set_hooks(s0, FALSE, _ex);
