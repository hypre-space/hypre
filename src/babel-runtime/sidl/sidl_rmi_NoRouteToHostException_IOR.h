 ...
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_IOR.h,v 1.1 2006/08/29 23:25:28 painter Exp $
...
extern void sidl_rmi_NoRouteToHostException__init(
  struct sidl_rmi_NoRouteToHostException__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void sidl_rmi_NoRouteToHostException__getEPVs(
  ...
  struct sidl_rmi_NoRouteToHostException__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_rmi_NoRouteToHostException(const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_NoRouteToHostException__object* 
