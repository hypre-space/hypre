/*
 * File:          sidl_rmi_NoRouteToHostException_IOR.h
 * Symbol:        sidl.rmi.NoRouteToHostException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_IOR.h,v 1.2 2007/09/27 19:35:47 painter Exp $
...
#define included_sidl_rmi_NoRouteToHostException_IOR_h
...
struct sidl_rmi_NoRouteToHostException__epv {
  ...
  int32_t (*f_getHopCount)(
    /* in */ struct sidl_rmi_NoRouteToHostException__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidl.rmi.NoRouteToHostException-v0.9.15 */
};
...
struct sidl_rmi_NoRouteToHostException__controls {
  int     use_hooks;
};
/*
...
struct sidl_rmi_NoRouteToHostException__object {
  ...
  struct sidl_rmi_NoRouteToHostException__epv* d_epv;
  void*                                        d_data;
};

struct sidl_rmi_NoRouteToHostException__external {
  struct sidl_rmi_NoRouteToHostException__object*
...
extern void sidl_rmi_NoRouteToHostException__init(
  struct sidl_rmi_NoRouteToHostException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidl_rmi_NoRouteToHostException__getEPVs(
  ...
  extern void sidl_rmi_NoRouteToHostException__fini(
    struct sidl_rmi_NoRouteToHostException__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void sidl_rmi_NoRouteToHostException__IOR_version(int32_t *major, 
    int32_t *minor);

  struct sidl_BaseClass__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_BaseClass(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseClass__object* 
    skel_sidl_rmi_NoRouteToHostException_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_BaseException__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_BaseException(const 
  ...
  struct sidl_BaseInterface__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_BaseInterface(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
  ...
  struct sidl_ClassInfo__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_ClassInfo(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidl_rmi_NoRouteToHostException_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_SIDLException__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_SIDLException(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_SIDLException__object* 
  ...
  struct sidl_io_IOException__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_io_IOException(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_IOException__object* 
  ...
  struct sidl_io_Serializer__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_io_Serializer(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
  ...
  struct sidl_rmi_NetworkException__object* 
    skel_sidl_rmi_NoRouteToHostException_fconnect_sidl_rmi_NetworkException(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_NetworkException__object* 
    skel_sidl_rmi_NoRouteToHostException_fcast_sidl_rmi_NetworkException(void 
  ...
  struct sidl_rmi_NoRouteToHostException__remote{
    int d_refcount;
