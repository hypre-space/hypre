 ...
 * Revision:      @(#) $Id: sidl_rmi_UnknownHostException_Impl.c,v 1.1 2006/08/29 23:31:44 painter Exp $
...
struct sidl_rmi_UnknownHostException__object* 
  ...
  return sidl_rmi_UnknownHostException__connectI(url, ar, _ex);
}
struct sidl_rmi_UnknownHostException__object* 
  impl_sidl_rmi_UnknownHostException_fcast_sidl_rmi_UnknownHostException(void* 
  bi, sidl_BaseInterface* _ex) {
  return sidl_rmi_UnknownHostException__cast(bi, _ex);
}
