...
#ifndef included_sidl_rmi_TimeOutException_Impl_h
#define included_sidl_rmi_TimeOutException_Impl_h
...
/* Insert-Code-Here {sidl.rmi.TimeOutException._includes} (include files) */
/* DO-NOT-DELETE splicer.end(sidl.rmi.TimeOutException._includes) */

/*
 * Private data for class sidl.rmi.TimeOutException
 */

struct sidl_rmi_TimeOutException__data {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.TimeOutException._data) */
  /* Insert-Code-Here {sidl.rmi.TimeOutException._data} (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.TimeOutException._data) */
};
...
extern struct sidl_rmi_TimeOutException__data*
sidl_rmi_TimeOutException__get_data(
  sidl_rmi_TimeOutException);

extern void
sidl_rmi_TimeOutException__set_data(
  sidl_rmi_TimeOutException,
  struct sidl_rmi_TimeOutException__data*);
