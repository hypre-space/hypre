 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_IOR.h,v 1.1 2006/08/29 23:25:28 painter Exp $
...
sidl_rmi_ConnectException__new(void* ddata,
  struct sidl_BaseInterface__object ** _ex);

extern void sidl_rmi_ConnectException__init(
  struct sidl_rmi_ConnectException__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void sidl_rmi_ConnectException__getEPVs(
  ...
  extern void sidl_rmi_ConnectException__fini(
    struct sidl_rmi_ConnectException__object* self,
      struct sidl_BaseInterface__object ** _ex);
  extern void sidl_rmi_ConnectException__IOR_version(int32_t *major,
    int32_t *minor);
