 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_IOR.h,v 1.2 2007/09/27 19:35:46 painter Exp $
...
struct sidl_rmi_ConnectException__epv {
  ...
  int32_t (*f_getHopCount)(
    /* in */ struct sidl_rmi_ConnectException__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidl.rmi.ConnectException-v0.9.15 */
};
...
struct sidl_rmi_ConnectException__controls {
  int     use_hooks;
};
/*
...
sidl_rmi_ConnectException__new(void* ddata,struct sidl_BaseInterface__object ** 
  _ex);
...
extern void sidl_rmi_ConnectException__getEPVs(
  ...
  struct sidl_rmi_ConnectException__epv **s_arg_epv__sidl_rmi_connectexception,
    struct sidl_rmi_ConnectException__epv 
    **s_arg_epv_hooks__sidl_rmi_connectexception);
  ...
  struct sidl_BaseClass__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseException__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_BaseException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_RuntimeException__object* 
    skel_sidl_rmi_ConnectException_fconnect_sidl_RuntimeException(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_SIDLException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_SIDLException__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_SIDLException(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_io_Deserializer__object* 
    skel_sidl_rmi_ConnectException_fconnect_sidl_io_Deserializer(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Deserializer__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_io_Deserializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_IOException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_IOException__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_io_IOException(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_io_Serializable__object* 
    skel_sidl_rmi_ConnectException_fconnect_sidl_io_Serializable(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializable__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_io_Serializable(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializer__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
    skel_sidl_rmi_ConnectException_fcast_sidl_io_Serializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_rmi_ConnectException__object* 
    skel_sidl_rmi_ConnectException_fconnect_sidl_rmi_ConnectException(const 
  ...
  struct sidl_rmi_NetworkException__object* 
    skel_sidl_rmi_ConnectException_fconnect_sidl_rmi_NetworkException(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_NetworkException__object* 
