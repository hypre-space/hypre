/*
 * File:          sidl_rmi_UnexpectedCloseException_Impl.c
 * Symbol:        sidl.rmi.UnexpectedCloseException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_rmi_UnexpectedCloseException_Impl.c,v 1.2 2007/09/27 19:35:48 painter Exp $
...
#include "sidl_rmi_UnexpectedCloseException_Impl.h"
#include "sidl_NotImplementedException.h"
#include "sidl_Exception.h"

/* DO-NOT-DELETE splicer.begin(sidl.rmi.UnexpectedCloseException._includes) */
/* Insert-Code-Here {sidl.rmi.UnexpectedCloseException._includes} (includes and arbitrary code) */
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_rmi_UnexpectedCloseException__load"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.UnexpectedCloseException._load) */
  /* Insert-Code-Here {sidl.rmi.UnexpectedCloseException._load} (static class initializer method) */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.UnexpectedCloseException._load) */
  }
}
/*
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_rmi_UnexpectedCloseException__ctor"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.UnexpectedCloseException._ctor) */
  /* Insert-Code-Here {sidl.rmi.UnexpectedCloseException._ctor} (constructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.UnexpectedCloseException._ctor) */
  }
}
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_rmi_UnexpectedCloseException__ctor2"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.UnexpectedCloseException._ctor2) */
  /* Insert-Code-Here {sidl.rmi.UnexpectedCloseException._ctor2} (special constructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.UnexpectedCloseException._ctor2) */
  }
}
/*
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_rmi_UnexpectedCloseException__dtor"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.UnexpectedCloseException._dtor) */
  /* Insert-Code-Here {sidl.rmi.UnexpectedCloseException._dtor} (destructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.UnexpectedCloseException._dtor) */
  }
}
...
struct sidl_rmi_UnexpectedCloseException__object* 
  ...
  (const char* url, sidl_bool ar, sidl_BaseInterface *_ex) {
  return sidl_rmi_UnexpectedCloseException__connectI(url, ar, _ex);
}
struct sidl_rmi_UnexpectedCloseException__object* 
  impl_sidl_rmi_UnexpectedCloseException_fcast_sidl_rmi_UnexpectedCloseException
  (void* bi, sidl_BaseInterface* _ex) {
  return sidl_rmi_UnexpectedCloseException__cast(bi, _ex);
}
