 ...
 * Revision:      @(#) $Id: sidl_SIDLException_IOR.c,v 1.7 2007/09/27 19:35:44 painter Exp $
...
sidl_SIDLException_isSame__exec(
  ...
  iobj = skel_sidl_SIDLException_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
static void
sidl_SIDLException_packObj__exec(
        struct sidl_SIDLException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  ser = skel_sidl_SIDLException_fconnect_sidl_io_Serializer(ser_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
static void
sidl_SIDLException_unpackObj__exec(
        struct sidl_SIDLException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  des = skel_sidl_SIDLException_fconnect_sidl_io_Deserializer(des_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
static void ior_sidl_SIDLException__set_hooks(
  struct sidl_SIDLException__object* self,
...
{
  *_ex = NULL; /* default to no exception */
  sidl_SIDLException__fini(self,_ex);
...
ior_sidl_SIDLException__exec(
  ...
  static const struct sidl_SIDLException__method  s_methods[] = {
    ...
    { "packObj", sidl_SIDLException_packObj__exec },
    { "setNote", sidl_SIDLException_setNote__exec },
    { "unpackObj", sidl_SIDLException_unpackObj__exec }
  };
  int i, cmp, l = 0;
...
static void sidl_SIDLException__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct sidl_SIDLException__epv*   hepv = &s_new_epv_hooks__sidl_sidlexception;
  ...
  struct sidl_BaseException__epv*   he1  = &s_new_epv_hooks__sidl_baseexception;
  struct sidl_BaseInterface__epv*   e2   = &s_new_epv__sidl_baseinterface;
  struct sidl_BaseInterface__epv*   he2  = &s_new_epv_hooks__sidl_baseinterface;
  struct sidl_io_Serializable__epv* e3   = &s_new_epv__sidl_io_serializable;
  struct sidl_io_Serializable__epv* he3  = 
  ...
  epv->f__raddRef                 = ior_sidl_SIDLException__raddRef;
  epv->f__isRemote                = ior_sidl_SIDLException__isRemote;
  epv->f__set_hooks               = ior_sidl_SIDLException__set_hooks;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_SIDLException__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_SIDLException__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  ...
  epv->f_add                      = NULL;
  epv->f_packObj                  = NULL;
  epv->f_unpackObj                = NULL;

  sidl_SIDLException__set_epv(epv);

  memcpy((void*)hepv, epv, sizeof(struct sidl_SIDLException__epv));
  ...
  memcpy((void*) he3, e3, sizeof(struct sidl_io_Serializable__epv));

  s_method_initialized = 1;
  ior_sidl_SIDLException__ensure_load_called();
}

void sidl_SIDLException__getEPVs(
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidl.SIDLException",_ex);
...
static void
initMetadata(struct sidl_SIDLException__object* self, sidl_BaseInterface* _ex)
{
...
sidl_SIDLException__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_SIDLException__object* self =
    (struct sidl_SIDLException__object*) malloc(
      sizeof(struct sidl_SIDLException__object));
  *_ex = NULL; /* default to no exception */
  sidl_SIDLException__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_io_serializable.d_epv = &s_new_epv__sidl_io_serializable;
  s0->d_epv                        = &s_new_epv__sidl_sidlexception;

  s0->d_sidl_baseexception.d_object = self;

  s0->d_sidl_io_serializable.d_object = self;

  s0->d_data = NULL;

  ior_sidl_SIDLException__set_hooks(s0, FALSE, _ex);
