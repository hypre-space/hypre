 ...
 * Revision:      @(#) $Id: sidl_DFinder_IOR.c,v 1.5 2006/08/29 22:29:49 painter Exp $
...
sidl_DFinder_findLibrary__exec(
  ...
  sidl_rmi_Call_unpackInt( inArgs, "lResolve", &lResolve_tmp,
    _ex);SIDL_CHECK(*_ex);
...
sidl_DFinder_setSearchPath__exec(
  ...
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "path_name", &path_name,
    _ex);SIDL_CHECK(*_ex);
