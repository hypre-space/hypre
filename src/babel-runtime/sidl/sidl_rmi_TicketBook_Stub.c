/*
 * File:          sidl_rmi_TicketBook_Stub.c
 * Symbol:        sidl.rmi.TicketBook-v0.9.15
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_rmi_TicketBook_Stub.c,v 1.2 2007/09/27 19:35:48 painter Exp $
...
sidl_rmi_TicketBook
sidl_rmi_TicketBook__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_TicketBook__remoteConnect(url, TRUE, _ex);
}
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_TicketBook_insertWithID(
  /* in */ sidl_rmi_TicketBook self,
...
SIDL_C_INLINE_DEFN
int32_t
sidl_rmi_TicketBook_removeReady(
  /* in */ sidl_rmi_TicketBook self,
...
SIDL_C_INLINE_DEFN
sidl_rmi_TicketBook
sidl_rmi_TicketBook_createEmptyTicketBook(
  /* in */ sidl_rmi_TicketBook self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
sidl_rmi_Response
sidl_rmi_TicketBook_getResponse(
  /* in */ sidl_rmi_TicketBook self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
sidl_ClassInfo
sidl_rmi_TicketBook_getClassInfo(
  /* in */ sidl_rmi_TicketBook self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_rmi_TicketBook
sidl_rmi_TicketBook__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidl_rmi_TicketBook cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.TicketBook", (
      void*)sidl_rmi_TicketBook__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_rmi_TicketBook) (*base->d_epv->f__cast)(
      base->d_object,
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_TicketBook__set_hooks(
  /* in */ sidl_rmi_TicketBook self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
sidl_bool
sidl_rmi_TicketBook__isLocal(
  /* in */ sidl_rmi_TicketBook self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_TicketBook__isRemote(self,_ex);
}
...
sidl_rmi_TicketBook__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_rmi_TicketBook__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_rmi_TicketBook__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_create1d(int32_t len)
{
  return (struct sidl_rmi_TicketBook__array*)sidl_interface__array_create1d(
    len);
}
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_create1dInit(
  int32_t len, 
  sidl_rmi_TicketBook* data)
{
  return (struct sidl_rmi_TicketBook__array*)sidl_interface__array_create1dInit(
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_create2dCol(int32_t m, int32_t n)
{
  return (struct sidl_rmi_TicketBook__array*)sidl_interface__array_create2dCol(
    m, n);
}
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_create2dRow(int32_t m, int32_t n)
{
  return (struct sidl_rmi_TicketBook__array*)sidl_interface__array_create2dRow(
    m, n);
}
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_borrow(
  sidl_rmi_TicketBook* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_rmi_TicketBook__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_smartCopy(
  struct sidl_rmi_TicketBook__array *array)
{
  return (struct sidl_rmi_TicketBook__array*)
 ...
 */
void
sidl_rmi_TicketBook__array_addRef(
  struct sidl_rmi_TicketBook__array* array)
{
 ...
 */
void
sidl_rmi_TicketBook__array_deleteRef(
  struct sidl_rmi_TicketBook__array* array)
{
 ...
 */
sidl_rmi_TicketBook
sidl_rmi_TicketBook__array_get1(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t i1)
{
  return (sidl_rmi_TicketBook)
 ...
 */
sidl_rmi_TicketBook
sidl_rmi_TicketBook__array_get2(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2)
{
 ...
 */
sidl_rmi_TicketBook
sidl_rmi_TicketBook__array_get3(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3)
 ...
 */
sidl_rmi_TicketBook
sidl_rmi_TicketBook__array_get4(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_rmi_TicketBook
sidl_rmi_TicketBook__array_get5(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_rmi_TicketBook
sidl_rmi_TicketBook__array_get6(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_rmi_TicketBook
sidl_rmi_TicketBook__array_get7(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_rmi_TicketBook
sidl_rmi_TicketBook__array_get(
  const struct sidl_rmi_TicketBook__array* array,
 ...
 */
void
sidl_rmi_TicketBook__array_set1(
  struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  sidl_rmi_TicketBook const value)
{
 ...
 */
void
sidl_rmi_TicketBook__array_set2(
  struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  sidl_rmi_TicketBook const value)
 ...
 */
void
sidl_rmi_TicketBook__array_set3(
  struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_TicketBook__array_set4(
  struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_TicketBook__array_set5(
  struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_TicketBook__array_set6(
  struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_TicketBook__array_set7(
  struct sidl_rmi_TicketBook__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_TicketBook__array_set(
  struct sidl_rmi_TicketBook__array* array,
  const int32_t indices[],
  sidl_rmi_TicketBook const value)
{
 ...
 */
int32_t
sidl_rmi_TicketBook__array_dimen(
  const struct sidl_rmi_TicketBook__array* array)
{
 ...
 */
int32_t
sidl_rmi_TicketBook__array_lower(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_rmi_TicketBook__array_upper(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_rmi_TicketBook__array_length(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_rmi_TicketBook__array_stride(
  const struct sidl_rmi_TicketBook__array* array,
  const int32_t ind)
{
 ...
 */
int
sidl_rmi_TicketBook__array_isColumnOrder(
  const struct sidl_rmi_TicketBook__array* array)
{
 ...
 */
int
sidl_rmi_TicketBook__array_isRowOrder(
  const struct sidl_rmi_TicketBook__array* array)
{
 ...
 */
void
sidl_rmi_TicketBook__array_copy(
  const struct sidl_rmi_TicketBook__array* src,
  struct sidl_rmi_TicketBook__array* dest)
{
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_slice(
  struct sidl_rmi_TicketBook__array* src,
  int32_t        dimen,
 ...
 */
struct sidl_rmi_TicketBook__array*
sidl_rmi_TicketBook__array_ensure(
  struct sidl_rmi_TicketBook__array* src,
  int32_t dimen,
  int     ordering)
{
