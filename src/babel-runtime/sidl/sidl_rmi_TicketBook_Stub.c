...
{
  return (struct 
    sidl_rmi_TicketBook__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_rmi_TicketBook__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_rmi_TicketBook__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidl_rmi_TicketBook__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct 
    sidl_rmi_TicketBook__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidl_rmi_TicketBook__array*)sidl_interface__array_create2dRow(m, n);
}
