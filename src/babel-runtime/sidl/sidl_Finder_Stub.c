 ...
 * Revision:      @(#) $Id: sidl_Finder_Stub.c,v 1.6 2007/09/27 19:35:43 painter Exp $
...
{
  return sidl_Finder__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.Finder", (
      void*)sidl_Finder__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
sidl_Finder__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_Finder__isRemote(self,_ex);
}
