/*
 * File:          sidl_rmi_ProtocolException_Skel.c
 * Symbol:        sidl.rmi.ProtocolException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_rmi_ProtocolException_Skel.c,v 1.1 2006/08/29 23:31:44 painter Exp $
 * Description:   Server-side glue code for sidl.rmi.ProtocolException
 * 
...
void
sidl_rmi_ProtocolException__set_epv(struct sidl_rmi_ProtocolException__epv *epv)
{
  epv->f__ctor = impl_sidl_rmi_ProtocolException__ctor;
  epv->f__ctor2 = impl_sidl_rmi_ProtocolException__ctor2;
  epv->f__dtor = impl_sidl_rmi_ProtocolException__dtor;
...
void sidl_rmi_ProtocolException__call_load(void) { 
  sidl_BaseInterface _throwaway_exception = NULL;
  impl_sidl_rmi_ProtocolException__load(&_throwaway_exception);
}
struct sidl_BaseClass__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_BaseClass(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_BaseClass(url, ar, _ex);
}

struct sidl_BaseClass__object* 
  skel_sidl_rmi_ProtocolException_fcast_sidl_BaseClass(void* bi,
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_BaseClass(bi, _ex);
}

struct sidl_BaseException__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_BaseException(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_BaseException(url, ar,
    _ex);
}
...
struct sidl_BaseException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_BaseException(bi, _ex);
}

struct sidl_BaseInterface__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_BaseInterface(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_BaseInterface(url, ar,
    _ex);
}
...
struct sidl_BaseInterface__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_BaseInterface(bi, _ex);
}

struct sidl_ClassInfo__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_ClassInfo(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_ClassInfo(url, ar, _ex);
}

struct sidl_ClassInfo__object* 
  skel_sidl_rmi_ProtocolException_fcast_sidl_ClassInfo(void* bi,
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_ClassInfo(bi, _ex);
}

struct sidl_RuntimeException__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_RuntimeException(const char* 
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_RuntimeException(url, ar,
    _ex);
}
...
struct sidl_RuntimeException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_RuntimeException(bi, _ex);
}

struct sidl_SIDLException__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_SIDLException(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_SIDLException(url, ar,
    _ex);
}
...
struct sidl_SIDLException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_SIDLException(bi, _ex);
}

struct sidl_io_Deserializer__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_io_Deserializer(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_io_Deserializer(url, ar,
    _ex);
}
...
struct sidl_io_Deserializer__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_io_Deserializer(bi, _ex);
}

struct sidl_io_IOException__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_io_IOException(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_io_IOException(url, ar,
    _ex);
}
...
struct sidl_io_IOException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_io_IOException(bi, _ex);
}

struct sidl_io_Serializable__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_io_Serializable(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_io_Serializable(url, ar,
    _ex);
}
...
struct sidl_io_Serializable__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_io_Serializable(bi, _ex);
}

struct sidl_io_Serializer__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_io_Serializer(const char* url,
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_io_Serializer(url, ar,
    _ex);
}
...
struct sidl_io_Serializer__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_io_Serializer(bi, _ex);
}

struct sidl_rmi_NetworkException__object* 
  skel_sidl_rmi_ProtocolException_fconnect_sidl_rmi_NetworkException(const 
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_rmi_NetworkException(url,
    ar, _ex);
}
...
struct sidl_rmi_NetworkException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_rmi_NetworkException(bi,
    _ex);
}
...
struct sidl_rmi_ProtocolException__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_rmi_ProtocolException_fconnect_sidl_rmi_ProtocolException(url, ar,
    _ex);
}
...
struct sidl_rmi_ProtocolException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fcast_sidl_rmi_ProtocolException(bi,
    _ex);
}

struct sidl_rmi_ProtocolException__data*
sidl_rmi_ProtocolException__get_data(sidl_rmi_ProtocolException self)
{
  return (struct sidl_rmi_ProtocolException__data*)(self ? self->d_data : NULL);
}

void sidl_rmi_ProtocolException__set_data(
  sidl_rmi_ProtocolException self,
  struct sidl_rmi_ProtocolException__data* data)
{
  if (self) {
    self->d_data = data;
  }
