 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolException_Skel.c,v 1.2 2007/09/27 19:35:47 painter Exp $
...
struct sidl_rmi_ProtocolException__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_ProtocolException_fconnect_sidl_rmi_ProtocolException(
    url, ar, _ex);
}
