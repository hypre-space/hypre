/*
 * File:          sidl_io_IOException.h
 * Symbol:        sidl.io.IOException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V1-13-0b $
 * Revision:      @(#) $Id: sidl_io_IOException.h,v 1.5 2006/08/29 22:29:51 painter Exp $
...
#define included_sidl_io_IOException_h
...
typedef struct sidl_io_IOException__object* sidl_io_IOException;
 ...
 */
struct sidl_io_IOException__object*
sidl_io_IOException__create(sidl_BaseInterface* _ex);
 ...
 */
sidl_io_IOException
sidl_io_IOException__connect(const char *, sidl_BaseInterface *_ex);
