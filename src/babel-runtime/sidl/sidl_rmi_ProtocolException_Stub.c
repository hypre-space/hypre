 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolException_Stub.c,v 1.2 2007/09/27 19:35:47 painter Exp $
...
static sidl_rmi_ProtocolException sidl_rmi_ProtocolException__remoteCreate(
