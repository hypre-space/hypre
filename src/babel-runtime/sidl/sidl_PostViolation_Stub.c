/*
 * File:          sidl_PostViolation_Stub.c
 * Symbol:        sidl.PostViolation-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_PostViolation_Stub.c,v 1.6 2007/09/27 19:35:44 painter Exp $
...
static const struct sidl_PostViolation__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_PostViolation__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_PostViolation__externals();
  return _externals;
}
...
sidl_PostViolation
sidl_PostViolation__create(sidl_BaseInterface* _ex)
{
  return (*(_getExternals()->createObject))(NULL,_ex);
}

static sidl_PostViolation sidl_PostViolation__remoteCreate(const char* url, 
...
sidl_PostViolation
sidl_PostViolation__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_PostViolation__remoteCreate(url, _ex);
}

static struct sidl_PostViolation__object* sidl_PostViolation__remoteConnect(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
static struct sidl_PostViolation__object* sidl_PostViolation__IHConnect(struct 
...
sidl_PostViolation
sidl_PostViolation__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_PostViolation__remoteConnect(url, TRUE, _ex);
}
...
SIDL_C_INLINE_DEFN
sidl_ClassInfo
sidl_PostViolation_getClassInfo(
  /* in */ sidl_PostViolation self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_PostViolation
sidl_PostViolation__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidl_PostViolation cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.PostViolation", (
      void*)sidl_PostViolation__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_PostViolation) (*base->d_epv->f__cast)(
      base->d_object,
...
sidl_bool
sidl_PostViolation__isLocal(
  /* in */ sidl_PostViolation self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_PostViolation__isRemote(self,_ex);
}
...
sidl_PostViolation__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_PostViolation__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_PostViolation__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_create1d(int32_t len)
{
  return (struct sidl_PostViolation__array*)sidl_interface__array_create1d(len);
}
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_create1dInit(
  int32_t len, 
  sidl_PostViolation* data)
{
  return (struct sidl_PostViolation__array*)sidl_interface__array_create1dInit(
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_create2dCol(int32_t m, int32_t n)
{
  return (struct sidl_PostViolation__array*)sidl_interface__array_create2dCol(m,
    n);
}
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_create2dRow(int32_t m, int32_t n)
{
  return (struct sidl_PostViolation__array*)sidl_interface__array_create2dRow(m,
    n);
}
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_borrow(
  sidl_PostViolation* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_PostViolation__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_smartCopy(
  struct sidl_PostViolation__array *array)
{
  return (struct sidl_PostViolation__array*)
 ...
 */
void
sidl_PostViolation__array_addRef(
  struct sidl_PostViolation__array* array)
{
 ...
 */
void
sidl_PostViolation__array_deleteRef(
  struct sidl_PostViolation__array* array)
{
 ...
 */
sidl_PostViolation
sidl_PostViolation__array_get1(
  const struct sidl_PostViolation__array* array,
  const int32_t i1)
{
  return (sidl_PostViolation)
 ...
 */
sidl_PostViolation
sidl_PostViolation__array_get2(
  const struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2)
{
 ...
 */
sidl_PostViolation
sidl_PostViolation__array_get3(
  const struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3)
 ...
 */
sidl_PostViolation
sidl_PostViolation__array_get4(
  const struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_PostViolation
sidl_PostViolation__array_get5(
  const struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_PostViolation
sidl_PostViolation__array_get6(
  const struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_PostViolation
sidl_PostViolation__array_get7(
  const struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_PostViolation__array_set1(
  struct sidl_PostViolation__array* array,
  const int32_t i1,
  sidl_PostViolation const value)
{
 ...
 */
void
sidl_PostViolation__array_set2(
  struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  sidl_PostViolation const value)
 ...
 */
void
sidl_PostViolation__array_set3(
  struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_PostViolation__array_set4(
  struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_PostViolation__array_set5(
  struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_PostViolation__array_set6(
  struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_PostViolation__array_set7(
  struct sidl_PostViolation__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
int32_t
sidl_PostViolation__array_dimen(
  const struct sidl_PostViolation__array* array)
{
 ...
 */
int32_t
sidl_PostViolation__array_lower(
  const struct sidl_PostViolation__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_PostViolation__array_upper(
  const struct sidl_PostViolation__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_PostViolation__array_length(
  const struct sidl_PostViolation__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_PostViolation__array_stride(
  const struct sidl_PostViolation__array* array,
  const int32_t ind)
{
 ...
 */
int
sidl_PostViolation__array_isColumnOrder(
  const struct sidl_PostViolation__array* array)
{
 ...
 */
int
sidl_PostViolation__array_isRowOrder(
  const struct sidl_PostViolation__array* array)
{
 ...
 */
void
sidl_PostViolation__array_copy(
  const struct sidl_PostViolation__array* src,
  struct sidl_PostViolation__array* dest)
{
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_slice(
  struct sidl_PostViolation__array* src,
  int32_t        dimen,
 ...
 */
struct sidl_PostViolation__array*
sidl_PostViolation__array_ensure(
  struct sidl_PostViolation__array* src,
  int32_t dimen,
  int     ordering)
{
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    cast = ((struct sidl_PostViolation__object*)self);
    return cast;
  }
  else if (cmp0 < 0) {
...
sidl_PostViolation__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "sidl.PostViolation", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_PostViolation__object*) malloc(
      sizeof(struct sidl_PostViolation__object));
