 ...
 * Revision:      @(#) $Id: sidl_PostViolation_Stub.c,v 1.5 2006/08/29 22:29:50 painter Exp $
...
{
  return (struct 
    sidl_PostViolation__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_PostViolation__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_PostViolation__array*)sidl_interface__array_create1dInit(len,
