 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_Impl.c,v 1.1 2006/08/29 23:31:43 painter Exp $
...
struct sidl_rmi_ConnectException__object* 
  ...
  return sidl_rmi_ConnectException__connectI(url, ar, _ex);
}
struct sidl_rmi_ConnectException__object* 
  impl_sidl_rmi_ConnectException_fcast_sidl_rmi_ConnectException(void* bi,
  sidl_BaseInterface* _ex) {
  return sidl_rmi_ConnectException__cast(bi, _ex);
}
