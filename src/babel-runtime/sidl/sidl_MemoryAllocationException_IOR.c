 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_MemoryAllocationException_IOR.c,v 1.1 2006/08/29 23:31:42 painter Exp $
...
sidl_MemoryAllocationException_isSame__exec(
  ...
  iobj = 
    skel_sidl_MemoryAllocationException_fconnect_sidl_BaseInterface(iobj_str,
...
sidl_MemoryAllocationException_unpackObj__exec(
  ...
  des = 
    skel_sidl_MemoryAllocationException_fconnect_sidl_io_Deserializer(des_str,
    TRUE, _ex);SIDL_CHECK(*_ex);
 ...
 */
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_MemoryAllocationException__object*,const char*,
...
static struct sidl_SIDLException__epv* 
  sidl_MemoryAllocationException__super(void) {
