/*
 * File:          sidl_rmi_ObjectDoesNotExistException_Impl.h
 * Symbol:        sidl.rmi.ObjectDoesNotExistException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V1-13-0b $
 * Revision:      @(#) $Id: sidl_rmi_ObjectDoesNotExistException_Impl.h,v 1.1 2006/08/29 23:25:28 painter Exp $
...
#ifndef included_sidl_rmi_ObjectDoesNotExistException_Impl_h
#define included_sidl_rmi_ObjectDoesNotExistException_Impl_h
...
/* Insert-Code-Here {sidl.rmi.ObjectDoesNotExistException._includes} (include files) */
/* DO-NOT-DELETE splicer.end(sidl.rmi.ObjectDoesNotExistException._includes) */

/*
 * Private data for class sidl.rmi.ObjectDoesNotExistException
 */

struct sidl_rmi_ObjectDoesNotExistException__data {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.ObjectDoesNotExistException._data) */
  /* Insert-Code-Here {sidl.rmi.ObjectDoesNotExistException._data} (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.ObjectDoesNotExistException._data) */
};
...
extern struct sidl_rmi_ObjectDoesNotExistException__data*
sidl_rmi_ObjectDoesNotExistException__get_data(
  sidl_rmi_ObjectDoesNotExistException);

extern void
sidl_rmi_ObjectDoesNotExistException__set_data(
  sidl_rmi_ObjectDoesNotExistException,
  struct sidl_rmi_ObjectDoesNotExistException__data*);
...
extern struct sidl_RuntimeException__object* 
  impl_sidl_rmi_ObjectDoesNotExistException_fcast_sidl_RuntimeException(void* 
...
extern struct sidl_io_Deserializer__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex);
extern struct sidl_io_Deserializer__object* 
  impl_sidl_rmi_ObjectDoesNotExistException_fcast_sidl_io_Deserializer(void* bi,
  sidl_BaseInterface* _ex);
...
extern struct sidl_io_Serializable__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex);
extern struct sidl_io_Serializable__object* 
  impl_sidl_rmi_ObjectDoesNotExistException_fcast_sidl_io_Serializable(void* bi,
  sidl_BaseInterface* _ex);
