 ...
 * Revision:      @(#) $Id: sidl_rmi_MalformedURLException_Skel.c,v 1.2 2007/09/27 19:35:47 painter Exp $
...
struct sidl_BaseClass__object* 
  ...
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_BaseClass(url, ar, 
    _ex);
}
...
struct sidl_BaseClass__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_BaseClass(bi, _ex);
}

struct sidl_BaseException__object* 
  skel_sidl_rmi_MalformedURLException_fconnect_sidl_BaseException(const char* 
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_BaseException(url, 
    ar, _ex);
}
...
struct sidl_BaseException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_BaseException(bi, _ex);
}

struct sidl_BaseInterface__object* 
  skel_sidl_rmi_MalformedURLException_fconnect_sidl_BaseInterface(const char* 
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_BaseInterface(url, 
    ar, _ex);
}
...
struct sidl_BaseInterface__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_BaseInterface(bi, _ex);
}

struct sidl_ClassInfo__object* 
  skel_sidl_rmi_MalformedURLException_fconnect_sidl_ClassInfo(const char* url, 
  sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_ClassInfo(url, ar, 
    _ex);
}
...
struct sidl_ClassInfo__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_ClassInfo(bi, _ex);
}

struct sidl_RuntimeException__object* 
  skel_sidl_rmi_MalformedURLException_fconnect_sidl_RuntimeException(const 
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_RuntimeException(url,
    ar, _ex);
}
...
struct sidl_RuntimeException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_RuntimeException(bi, 
    _ex);
}
...
struct sidl_SIDLException__object* 
  ...
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_SIDLException(url, 
    ar, _ex);
}
...
struct sidl_SIDLException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_SIDLException(bi, _ex);
}

struct sidl_io_Deserializer__object* 
  skel_sidl_rmi_MalformedURLException_fconnect_sidl_io_Deserializer(const char* 
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_io_Deserializer(url, 
    ar, _ex);
}
...
struct sidl_io_Deserializer__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_io_Deserializer(bi, 
    _ex);
}

struct sidl_io_IOException__object* 
  skel_sidl_rmi_MalformedURLException_fconnect_sidl_io_IOException(const char* 
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_io_IOException(url, 
    ar, _ex);
}
...
struct sidl_io_IOException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_io_IOException(bi, _ex);
}

struct sidl_io_Serializable__object* 
  skel_sidl_rmi_MalformedURLException_fconnect_sidl_io_Serializable(const char* 
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_io_Serializable(url, 
    ar, _ex);
}
...
struct sidl_io_Serializable__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_io_Serializable(bi, 
    _ex);
}
...
struct sidl_io_Serializer__object* 
  ...
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_io_Serializer(url, 
    ar, _ex);
}
...
struct sidl_io_Serializer__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_io_Serializer(bi, _ex);
}
...
struct sidl_rmi_MalformedURLException__object* 
  ...
  void* bi, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_rmi_MalformedURLException_fcast_sidl_rmi_MalformedURLException(bi,
    _ex);
}

struct sidl_rmi_NetworkException__object* 
  skel_sidl_rmi_MalformedURLException_fconnect_sidl_rmi_NetworkException(const 
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fconnect_sidl_rmi_NetworkException(
    url, ar, _ex);
}

struct sidl_rmi_NetworkException__object* 
  skel_sidl_rmi_MalformedURLException_fcast_sidl_rmi_NetworkException(void* bi, 
  sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_MalformedURLException_fcast_sidl_rmi_NetworkException(bi,
    _ex);
}
