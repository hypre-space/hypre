 ...
 * Revision:      @(#) $Id: sidl_rmi_MalformedURLException_Skel.c,v 1.1 2006/08/29 23:31:43 painter Exp $
...
struct sidl_rmi_NetworkException__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_rmi_MalformedURLException_fconnect_sidl_rmi_NetworkException(url,
    ar, _ex);
}
