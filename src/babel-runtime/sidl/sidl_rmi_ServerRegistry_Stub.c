/*
 * File:          sidl_rmi_ServerRegistry_Stub.c
 * Symbol:        sidl.rmi.ServerRegistry-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_rmi_ServerRegistry_Stub.c,v 1.2 2007/09/27 19:35:48 painter Exp $
...
static const struct sidl_rmi_ServerRegistry__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_rmi_ServerRegistry__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_rmi_ServerRegistry__externals();
  return _externals;
}
...
static sidl_rmi_ServerRegistry sidl_rmi_ServerRegistry__remoteCreate(const 
...
sidl_rmi_ServerRegistry
sidl_rmi_ServerRegistry__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_ServerRegistry__remoteCreate(url, _ex);
}
...
sidl_rmi_ServerRegistry
sidl_rmi_ServerRegistry__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_ServerRegistry__remoteConnect(url, TRUE, _ex);
}
...
{
  char* _result;
  _result = (_getSEPV()->f_getServerURL)(
    objID,
    _ex);
  return _result;
}
...
{
  char* _result;
  _result = (_getSEPV()->f_isLocalObject)(
    url,
    _ex);
  return _result;
}
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  ...
  _result = (_getSEPV()->f_getExceptions)(
    _ex);
  return _result;
}
...
sidl_rmi_ServerRegistry__cast(
  ...
  sidl_BaseInterface* _ex)
{
  sidl_rmi_ServerRegistry cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.ServerRegistry", (
      void*)sidl_rmi_ServerRegistry__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_rmi_ServerRegistry) (*base->d_epv->f__cast)(
      base->d_object,
...
void
sidl_rmi_ServerRegistry__set_hooks_static(
  int32_t on,
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_ServerRegistry__set_hooks(
  /* in */ sidl_rmi_ServerRegistry self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
sidl_rmi_ServerRegistry__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_ServerRegistry__isRemote(self,_ex);
}
...
{
  return (struct 
    sidl_rmi_ServerRegistry__array*)sidl_interface__array_createCol(dimen, 
    lower, upper);
}
...
{
  return (struct 
    sidl_rmi_ServerRegistry__array*)sidl_interface__array_createRow(dimen, 
    lower, upper);
}
...
{
  return (struct sidl_rmi_ServerRegistry__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct 
    sidl_rmi_ServerRegistry__array*)sidl_interface__array_create1dInit(len, (
...
{
  return (struct 
    sidl_rmi_ServerRegistry__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidl_rmi_ServerRegistry__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct sidl_rmi_ServerRegistry__array*)sidl_interface__array_borrow(
...
{
  return (struct sidl_rmi_ServerRegistry__array*)
...
sidl_rmi_ServerRegistry__array_get1(
  ...
  const int32_t i1)
{
  return (sidl_rmi_ServerRegistry)
