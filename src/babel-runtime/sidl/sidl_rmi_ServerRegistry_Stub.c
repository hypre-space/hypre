 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_rmi_ServerRegistry_Stub.c,v 1.1 2006/08/29 23:31:44 painter Exp $
...
sidl_rmi_ServerRegistry_getServerURL(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return (_getSEPV()->f_getServerURL)(
    objID,
    _ex);
}
...
sidl_rmi_ServerRegistry_isLocalObject(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return (_getSEPV()->f_isLocalObject)(
    url,
    _ex);
}
...
sidl_rmi_ServerRegistry_getExceptions(
  /* out */ sidl_BaseInterface *_ex)
{
  return (_getSEPV()->f_getExceptions)(
    _ex);
}
...
{
  return (struct 
    sidl_rmi_ServerRegistry__array*)sidl_interface__array_create1d(len);
}
