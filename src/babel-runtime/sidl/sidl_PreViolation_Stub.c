/*
 * File:          sidl_PreViolation_Stub.c
 * Symbol:        sidl.PreViolation-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_PreViolation_Stub.c,v 1.6 2007/09/27 19:35:44 painter Exp $
...
static const struct sidl_PreViolation__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_PreViolation__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_PreViolation__externals();
  return _externals;
}
...
sidl_PreViolation
sidl_PreViolation__create(sidl_BaseInterface* _ex)
{
  return (*(_getExternals()->createObject))(NULL,_ex);
}

static sidl_PreViolation sidl_PreViolation__remoteCreate(const char* url, 
...
sidl_PreViolation
sidl_PreViolation__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_PreViolation__remoteCreate(url, _ex);
}
...
sidl_PreViolation
sidl_PreViolation__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_PreViolation__remoteConnect(url, TRUE, _ex);
}
...
SIDL_C_INLINE_DEFN
sidl_ClassInfo
sidl_PreViolation_getClassInfo(
  /* in */ sidl_PreViolation self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_PreViolation
sidl_PreViolation__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidl_PreViolation cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.PreViolation", (
      void*)sidl_PreViolation__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_PreViolation) (*base->d_epv->f__cast)(
      base->d_object,
...
sidl_bool
sidl_PreViolation__isLocal(
  /* in */ sidl_PreViolation self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_PreViolation__isRemote(self,_ex);
}
...
sidl_PreViolation__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_PreViolation__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_PreViolation__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_create1d(int32_t len)
{
  return (struct sidl_PreViolation__array*)sidl_interface__array_create1d(len);
}
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_create1dInit(
  int32_t len, 
  sidl_PreViolation* data)
{
  return (struct sidl_PreViolation__array*)sidl_interface__array_create1dInit(
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_create2dCol(int32_t m, int32_t n)
{
  return (struct sidl_PreViolation__array*)sidl_interface__array_create2dCol(m, 
    n);
}
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_create2dRow(int32_t m, int32_t n)
{
  return (struct sidl_PreViolation__array*)sidl_interface__array_create2dRow(m, 
    n);
}
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_borrow(
  sidl_PreViolation* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_PreViolation__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_smartCopy(
  struct sidl_PreViolation__array *array)
{
  return (struct sidl_PreViolation__array*)
 ...
 */
void
sidl_PreViolation__array_addRef(
  struct sidl_PreViolation__array* array)
{
 ...
 */
void
sidl_PreViolation__array_deleteRef(
  struct sidl_PreViolation__array* array)
{
 ...
 */
sidl_PreViolation
sidl_PreViolation__array_get1(
  const struct sidl_PreViolation__array* array,
  const int32_t i1)
{
  return (sidl_PreViolation)
 ...
 */
void
sidl_PreViolation__array_set1(
  struct sidl_PreViolation__array* array,
  const int32_t i1,
  sidl_PreViolation const value)
{
 ...
 */
int32_t
sidl_PreViolation__array_dimen(
  const struct sidl_PreViolation__array* array)
{
 ...
 */
int32_t
sidl_PreViolation__array_lower(
  const struct sidl_PreViolation__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_PreViolation__array_upper(
  const struct sidl_PreViolation__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_PreViolation__array_length(
  const struct sidl_PreViolation__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_PreViolation__array_stride(
  const struct sidl_PreViolation__array* array,
  const int32_t ind)
{
 ...
 */
int
sidl_PreViolation__array_isColumnOrder(
  const struct sidl_PreViolation__array* array)
{
 ...
 */
int
sidl_PreViolation__array_isRowOrder(
  const struct sidl_PreViolation__array* array)
{
 ...
 */
void
sidl_PreViolation__array_copy(
  const struct sidl_PreViolation__array* src,
  struct sidl_PreViolation__array* dest)
{
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_slice(
  struct sidl_PreViolation__array* src,
  int32_t        dimen,
 ...
 */
struct sidl_PreViolation__array*
sidl_PreViolation__array_ensure(
  struct sidl_PreViolation__array* src,
  int32_t dimen,
  int     ordering)
{
