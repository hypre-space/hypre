 ...
 */
static void
sidl_char__array_rdestroy(struct sidl_char__array* array)
{
#ifdef SIDL_DEBUG_REFCOUNT
...
sidl_char__array_borrowSmartCp(struct sidl_char__array* array)
{
  ...
  if (array) {
    if (sidl_char__array_isColumnOrder(array)) {
      copy = sidl_char__array_createCol(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    else {
      copy = sidl_char__array_createRow(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
...
char_arrayType(void)
{
  return sidl_char_array;
}
/**
 * Virtual function table for rarrays.
 */

static const struct sidl__array_vtable rarray_char_vtable = {
  (void (*)(struct sidl__array *))sidl_char__array_rdestroy,
...
static const struct sidl__array_vtable normal_char_vtable = {
  (void (*)(struct sidl__array *))sidl_char__array_destroy,
  (struct sidl__array *(*)(struct sidl__array *))
...
static const struct sidl__array_vtable borrowed_char_vtable = {
  (void (*)(struct sidl__array *))sidl_char__array_bdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_char__array_borrowSmartCp,
  char_arrayType
};
...
static const struct sidl__array_vtable sliced_char_vtable = {
  (void (*)(struct sidl__array *))sidl_char__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_char__array_smartCp,
  char_arrayType
};
...
static const struct sidl__array_vtable bsliced_char_vtable = {
  (void (*)(struct sidl__array *))sidl_char__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_char__array_borrowSmartCp,
  char_arrayType
         ...
         struct sidl_char__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    ...
    result->d_metadata.d_vtable = &sliced_char_vtable;
  }
  else {
    result->d_metadata.d_vtable = &normal_char_vtable;
  }
 ...
 */
void
sidl_char__array_init(const char* c_array,
struct sidl_char__array* sidl_array, int32_t dim,
int32_t lower[], int32_t upper[], int32_t stride[])
{
  ...
  sidl_array->d_metadata.d_lower = lower;
  sidl_array->d_metadata.d_vtable = &rarray_char_vtable;
 ...
 */
struct sidl_char__array *
sidl_char__array_create1dInit(int32_t len,
                              const char* data)
{
  ...
  if (data && (len > 0)) {
    ...
    result = sidl_char__array_create1d(len);
  }
  return result;
}
  ...
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_metadata.d_vtable->d_smartcopy ==
        ...
        result->d_metadata.d_vtable = &bsliced_char_vtable;
      }
    }
  }
  return result;
                        ...
                        const int32_t  stride[])
{
  ...
  result->d_metadata.d_vtable = &borrowed_char_vtable;
  return result;
}
...
{
  return (struct sidl_char__array *)
...
/**
 * Attempt to cast a generic array reference to an char
 * array. A non-NULL return value indicates that the cast was
 * successful, and the returned pointer is a valid char
 * array. A NULL return value indicates that the cast failed.
 * This function never alters the reference count of array.
 * 
 */
struct sidl_char__array*
sidl_char__array_cast(struct sidl__array* array)
{
  return (array &&
          (sidl_char_array == ((array->d_vtable->d_arraytype)())))
 ...
 */
char
sidl_char__array_get5(const struct sidl_char__array* array,
                      const int32_t i1,
                      const int32_t i2,
                      const int32_t i3,
                      const int32_t i4,
 ...
 */
char
sidl_char__array_get6(const struct sidl_char__array* array,
                      const int32_t i1,
                      const int32_t i2,
                      const int32_t i3,
                      const int32_t i4,
 ...
 */
char
sidl_char__array_get7(const struct sidl_char__array* array,
                      const int32_t i1,
                      const int32_t i2,
                      const int32_t i3,
                      const int32_t i4,
                      ...
                      const int32_t i7)
{
  if (array) {
    ...
    case 4: return sidl_char__array_get4(array, i1, i2, i3, i4);
    case 5: return sidl_char__array_get5(array, i1, i2, i3, i4, i5);
    case 6: return sidl_char__array_get6(array, i1, i2, i3, i4, i5, i6);
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
 ...
 */
void
sidl_char__array_set5(struct sidl_char__array* array,
                      const int32_t i1,
                      const int32_t i2,
                      const int32_t i3,
                      const int32_t i4,
 ...
 */
void
sidl_char__array_set6(struct sidl_char__array* array,
                      const int32_t i1,
                      const int32_t i2,
                      const int32_t i3,
                      const int32_t i4,
 ...
 */
void
sidl_char__array_set7(struct sidl_char__array* array,
                      const int32_t i1,
                      const int32_t i2,
                      const int32_t i3,
                      const int32_t i4,
                      ...
                      const char value)
{
  if (array) {
    ...
    case 4: sidl_char__array_set4(array, i1, i2, i3, i4, value); break;
    case 5: sidl_char__array_set5(array, i1, i2, i3, i4, i5, value); break;
    case 6: sidl_char__array_set6(array, i1, i2, i3, i4, i5, i6, value); break;
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
 ...
 */
int32_t
sidl_char__array_length(const struct sidl_char__array* array,
                        const int32_t ind)
{
