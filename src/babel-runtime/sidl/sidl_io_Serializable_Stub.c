 ...
 * Revision:      @(#) $Id: sidl_io_Serializable_Stub.c,v 1.2 2007/09/27 19:35:45 painter Exp $
...
sidl_io_Serializable__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct sidl_io_Serializable__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
sidl_io_Serializable__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct sidl_io_Serializable__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct sidl_io_Serializable__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct sidl_io_Serializable__array*)sidl_interface__array_create2dCol(
    m, n);
}
...
{
  return (struct sidl_io_Serializable__array*)sidl_interface__array_create2dRow(
    m, n);
}
