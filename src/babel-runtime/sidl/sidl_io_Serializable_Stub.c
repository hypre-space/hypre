/*
 * File:          sidl_io_Serializable_Stub.c
 * Symbol:        sidl.io.Serializable-v0.9.15
 * Symbol Type:   interface
 * Babel Version: 1.0.0
 * Release:       $Name: V1-13-0b $
 * Revision:      @(#) $Id: sidl_io_Serializable_Stub.c,v 1.1 2006/08/29 23:31:42 painter Exp $
...
static struct sidl_io_Serializable__object* 
  sidl_io_Serializable__IHConnect(struct sidl_rmi_InstanceHandle__object* 
...
sidl_io_Serializable__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_io_Serializable__remoteConnect(url, TRUE, _ex);
}
...
SIDL_C_INLINE_DEFN
void
sidl_io_Serializable_packObj(
  /* in */ sidl_io_Serializable self,
...
SIDL_C_INLINE_DEFN
void
sidl_io_Serializable_unpackObj(
  /* in */ sidl_io_Serializable self,
...
SIDL_C_INLINE_DEFN
void
sidl_io_Serializable_deleteRef(
  /* in */ sidl_io_Serializable self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
sidl_ClassInfo
sidl_io_Serializable_getClassInfo(
  /* in */ sidl_io_Serializable self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_io_Serializable
sidl_io_Serializable__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidl_io_Serializable cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.io.Serializable",
      (void*)sidl_io_Serializable__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_io_Serializable) (*base->d_epv->f__cast)(
      base->d_object,
...
SIDL_C_INLINE_DEFN
void
sidl_io_Serializable__set_hooks(
  /* in */ sidl_io_Serializable self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
SIDL_C_INLINE_DEFN
sidl_bool
sidl_io_Serializable__isRemote(
  /* in */ sidl_io_Serializable self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_bool
sidl_io_Serializable__isLocal(
  /* in */ sidl_io_Serializable self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_io_Serializable__isRemote(self,_ex);
}
...
sidl_io_Serializable__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct 
    sidl_io_Serializable__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct 
    sidl_io_Serializable__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_create1d(int32_t len)
{
  return (struct 
    sidl_io_Serializable__array*)sidl_interface__array_create1d(len);
}
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_create1dInit(
  int32_t len, 
  sidl_io_Serializable* data)
{
  return (struct 
    sidl_io_Serializable__array*)sidl_interface__array_create1dInit(len,
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_create2dCol(int32_t m, int32_t n)
{
  return (struct 
    sidl_io_Serializable__array*)sidl_interface__array_create2dCol(m, n);
}
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_create2dRow(int32_t m, int32_t n)
{
  return (struct 
    sidl_io_Serializable__array*)sidl_interface__array_create2dRow(m, n);
}
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_borrow(
  sidl_io_Serializable* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_io_Serializable__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_smartCopy(
  struct sidl_io_Serializable__array *array)
{
  return (struct sidl_io_Serializable__array*)
 ...
 */
void
sidl_io_Serializable__array_addRef(
  struct sidl_io_Serializable__array* array)
{
 ...
 */
void
sidl_io_Serializable__array_deleteRef(
  struct sidl_io_Serializable__array* array)
{
 ...
 */
sidl_io_Serializable
sidl_io_Serializable__array_get1(
  const struct sidl_io_Serializable__array* array,
  const int32_t i1)
{
  return (sidl_io_Serializable)
 ...
 */
sidl_io_Serializable
sidl_io_Serializable__array_get2(
  const struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2)
{
 ...
 */
sidl_io_Serializable
sidl_io_Serializable__array_get3(
  const struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3)
 ...
 */
sidl_io_Serializable
sidl_io_Serializable__array_get4(
  const struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_io_Serializable
sidl_io_Serializable__array_get5(
  const struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_io_Serializable
sidl_io_Serializable__array_get6(
  const struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_io_Serializable
sidl_io_Serializable__array_get7(
  const struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_io_Serializable
sidl_io_Serializable__array_get(
  const struct sidl_io_Serializable__array* array,
 ...
 */
void
sidl_io_Serializable__array_set1(
  struct sidl_io_Serializable__array* array,
  const int32_t i1,
  sidl_io_Serializable const value)
{
 ...
 */
void
sidl_io_Serializable__array_set2(
  struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  sidl_io_Serializable const value)
 ...
 */
void
sidl_io_Serializable__array_set3(
  struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_io_Serializable__array_set4(
  struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_io_Serializable__array_set5(
  struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_io_Serializable__array_set6(
  struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_io_Serializable__array_set7(
  struct sidl_io_Serializable__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_io_Serializable__array_set(
  struct sidl_io_Serializable__array* array,
  const int32_t indices[],
  sidl_io_Serializable const value)
{
 ...
 */
int32_t
sidl_io_Serializable__array_dimen(
  const struct sidl_io_Serializable__array* array)
{
 ...
 */
int32_t
sidl_io_Serializable__array_lower(
  const struct sidl_io_Serializable__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_io_Serializable__array_upper(
  const struct sidl_io_Serializable__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_io_Serializable__array_length(
  const struct sidl_io_Serializable__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_io_Serializable__array_stride(
  const struct sidl_io_Serializable__array* array,
  const int32_t ind)
{
 ...
 */
int
sidl_io_Serializable__array_isColumnOrder(
  const struct sidl_io_Serializable__array* array)
{
 ...
 */
int
sidl_io_Serializable__array_isRowOrder(
  const struct sidl_io_Serializable__array* array)
{
 ...
 */
void
sidl_io_Serializable__array_copy(
  const struct sidl_io_Serializable__array* src,
  struct sidl_io_Serializable__array* dest)
{
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_slice(
  struct sidl_io_Serializable__array* src,
  int32_t        dimen,
 ...
 */
struct sidl_io_Serializable__array*
sidl_io_Serializable__array_ensure(
  struct sidl_io_Serializable__array* src,
  int32_t dimen,
  int     ordering)
{
