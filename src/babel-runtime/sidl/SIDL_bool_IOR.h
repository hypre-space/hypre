...
/* forward declaration of struct SIDL_bool__array */
...
struct SIDL_bool__vtable {
   ...
   */
  void (*d_destroy)(struct SIDL_bool__array *);
   ...
   */
  struct SIDL_bool__array *(*d_smartcopy)(struct SIDL_bool__array *);
};

/**
 * The data structure for multi-dimensional arrays for SIDL bool.
 * The client may access this with the functions below or using
 * the macros in the header file SIDLArray.h.
 */
struct SIDL_bool__array {
  SIDL_bool *d_firstElement;
  int32_t       *d_lower;
  int32_t       *d_upper;
  int32_t       *d_stride;
  int32_t        d_dimen;
  int32_t        d_refcount;
  const struct SIDL_bool__vtable *d_vtable;
};
...
#endif
#endif /* included_SIDL_bool_IOR_h */
