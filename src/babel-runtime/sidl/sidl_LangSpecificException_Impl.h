 ...
 * Revision:      @(#) $Id: sidl_LangSpecificException_Impl.h,v 1.1 2006/08/29 23:20:39 painter Exp $
...
/* Insert-Code-Here {sidl.LangSpecificException._includes} (include files) */
...
struct sidl_LangSpecificException__data {
  ...
  /* Insert-Code-Here {sidl.LangSpecificException._data} (private data members) */
