 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_Impl.h,v 1.1 2006/08/29 23:25:28 painter Exp $
...
/* Insert-Code-Here {sidl.rmi.NoRouteToHostException._includes} (include files) */
...
struct sidl_rmi_NoRouteToHostException__data {
  ...
  /* Insert-Code-Here {sidl.rmi.NoRouteToHostException._data} (private data members) */
