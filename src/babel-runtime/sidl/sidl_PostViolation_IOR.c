 ...
 * Revision:      @(#) $Id: sidl_PostViolation_IOR.c,v 1.6 2007/09/27 19:35:44 painter Exp $
 ...
 */
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_PostViolation__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_PostViolation__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_PostViolation__object*,const char*,int32_t,const char*,struct 
    sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj                  = (void (*)(struct 
    sidl_PostViolation__object*,struct sidl_io_Serializer__object*,struct 
    sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj                = (void (*)(struct 
    sidl_PostViolation__object*,struct sidl_io_Deserializer__object*,struct 
...
void sidl_PostViolation__getEPVs(
  ...
  struct sidl_PostViolation__epv **s_arg_epv__sidl_postviolation,struct 
    sidl_PostViolation__epv **s_arg_epv_hooks__sidl_postviolation)
{
  LOCK_STATIC_GLOBALS;
