 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_LangSpecificException_Skel.c,v 1.1 2006/08/29 23:31:42 painter Exp $
...
struct sidl_LangSpecificException__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_LangSpecificException_fconnect_sidl_LangSpecificException(url, ar,
    _ex);
}
