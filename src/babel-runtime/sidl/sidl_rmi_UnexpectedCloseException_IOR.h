 ...
 * Revision:      @(#) $Id: sidl_rmi_UnexpectedCloseException_IOR.h,v 1.2 2007/09/27 19:35:48 painter Exp $
...
sidl_rmi_UnexpectedCloseException__new(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void sidl_rmi_UnexpectedCloseException__init(
  struct sidl_rmi_UnexpectedCloseException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidl_rmi_UnexpectedCloseException__getEPVs(
  ...
  struct sidl_rmi_UnexpectedCloseException__epv 
    **s_arg_epv__sidl_rmi_unexpectedcloseexception,struct 
  ...
  extern void sidl_rmi_UnexpectedCloseException__fini(
    struct sidl_rmi_UnexpectedCloseException__object* self, struct 
      sidl_BaseInterface__object ** _ex);
