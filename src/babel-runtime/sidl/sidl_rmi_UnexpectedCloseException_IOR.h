/*
 * File:          sidl_rmi_UnexpectedCloseException_IOR.h
 * Symbol:        sidl.rmi.UnexpectedCloseException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V2-2-0b $
 * Revision:      @(#) $Id: sidl_rmi_UnexpectedCloseException_IOR.h,v 1.1 2006/08/29 23:25:29 painter Exp $
 * Description:   Intermediate Object Representation for sidl.rmi.UnexpectedCloseException
 * 
...
#define included_sidl_rmi_UnexpectedCloseException_IOR_h
...
struct sidl_rmi_UnexpectedCloseException__epv {
  ...
  int32_t (*f_getHopCount)(
    /* in */ struct sidl_rmi_UnexpectedCloseException__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidl.rmi.UnexpectedCloseException-v0.9.15 */
};
...
struct sidl_rmi_UnexpectedCloseException__controls {
  int     use_hooks;
};
/*
...
struct sidl_rmi_UnexpectedCloseException__object {
  ...
  struct sidl_rmi_UnexpectedCloseException__epv* d_epv;
  void*                                          d_data;
};

struct sidl_rmi_UnexpectedCloseException__external {
  struct sidl_rmi_UnexpectedCloseException__object*
...
const struct sidl_rmi_UnexpectedCloseException__external*
sidl_rmi_UnexpectedCloseException__externals(void);

extern struct sidl_rmi_UnexpectedCloseException__object*
sidl_rmi_UnexpectedCloseException__new(void* ddata,
  struct sidl_BaseInterface__object ** _ex);

extern void sidl_rmi_UnexpectedCloseException__init(
  struct sidl_rmi_UnexpectedCloseException__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void sidl_rmi_UnexpectedCloseException__getEPVs(
  ...
  struct sidl_rmi_UnexpectedCloseException__epv 
    **s_arg_epv__sidl_rmi_unexpectedcloseexception,
    struct sidl_rmi_UnexpectedCloseException__epv 
    **s_arg_epv_hooks__sidl_rmi_unexpectedcloseexception);
  extern void sidl_rmi_UnexpectedCloseException__fini(
    struct sidl_rmi_UnexpectedCloseException__object* self,
      struct sidl_BaseInterface__object ** _ex);
  extern void sidl_rmi_UnexpectedCloseException__IOR_version(int32_t *major,
    int32_t *minor);

  struct sidl_BaseClass__object* 
    skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_BaseClass(const char* 
  ...
  struct sidl_BaseException__object* 
    skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_BaseException(const 
  ...
  struct sidl_BaseInterface__object* 
    skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_BaseInterface(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
  ...
  struct sidl_ClassInfo__object* 
    skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_ClassInfo(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
  ...
  struct sidl_SIDLException__object* 
    skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_SIDLException(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_SIDLException__object* 
  ...
  struct sidl_io_Serializer__object* 
    skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_io_Serializer(const 
    char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
  ...
  struct sidl_rmi_NetworkException__object* 
    skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_rmi_NetworkException(
  ...
  struct sidl_rmi_UnexpectedCloseException__object* 
    skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_rmi_UnexpectedCloseException(const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_UnexpectedCloseException__object* 
    skel_sidl_rmi_UnexpectedCloseException_fcast_sidl_rmi_UnexpectedCloseException(void *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_rmi_UnexpectedCloseException__remote{
    int d_refcount;
