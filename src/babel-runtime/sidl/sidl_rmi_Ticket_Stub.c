/*
 * File:          sidl_rmi_Ticket_Stub.c
 * Symbol:        sidl.rmi.Ticket-v0.9.15
 * Symbol Type:   interface
 * Babel Version: 1.0.0
 * Release:       $Name: V2-2-0b $
 * Revision:      @(#) $Id: sidl_rmi_Ticket_Stub.c,v 1.1 2006/08/29 23:31:44 painter Exp $
...
sidl_rmi_Ticket
sidl_rmi_Ticket__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_Ticket__remoteConnect(url, TRUE, _ex);
}
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_Ticket_block(
  /* in */ sidl_rmi_Ticket self,
...
SIDL_C_INLINE_DEFN
sidl_rmi_TicketBook
sidl_rmi_Ticket_createEmptyTicketBook(
  /* in */ sidl_rmi_Ticket self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_rmi_Ticket
sidl_rmi_Ticket__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidl_rmi_Ticket cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.Ticket",
      (void*)sidl_rmi_Ticket__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_rmi_Ticket) (*base->d_epv->f__cast)(
      base->d_object,
...
sidl_bool
sidl_rmi_Ticket__isLocal(
  /* in */ sidl_rmi_Ticket self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_Ticket__isRemote(self,_ex);
}
...
sidl_rmi_Ticket__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_rmi_Ticket__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
 ...
 */
struct sidl_rmi_Ticket__array*
sidl_rmi_Ticket__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_rmi_Ticket__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
 ...
 */
struct sidl_rmi_Ticket__array*
sidl_rmi_Ticket__array_create1d(int32_t len)
{
  return (struct sidl_rmi_Ticket__array*)sidl_interface__array_create1d(len);
}
 ...
 */
struct sidl_rmi_Ticket__array*
sidl_rmi_Ticket__array_create1dInit(
  int32_t len, 
  sidl_rmi_Ticket* data)
{
  return (struct sidl_rmi_Ticket__array*)sidl_interface__array_create1dInit(len,
 ...
 */
struct sidl_rmi_Ticket__array*
sidl_rmi_Ticket__array_create2dCol(int32_t m, int32_t n)
{
  return (struct sidl_rmi_Ticket__array*)sidl_interface__array_create2dCol(m,
    n);
}
 ...
 */
struct sidl_rmi_Ticket__array*
sidl_rmi_Ticket__array_create2dRow(int32_t m, int32_t n)
{
  return (struct sidl_rmi_Ticket__array*)sidl_interface__array_create2dRow(m,
    n);
}
 ...
 */
struct sidl_rmi_Ticket__array*
sidl_rmi_Ticket__array_borrow(
  sidl_rmi_Ticket* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_rmi_Ticket__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_rmi_Ticket__array*
sidl_rmi_Ticket__array_smartCopy(
  struct sidl_rmi_Ticket__array *array)
{
  return (struct sidl_rmi_Ticket__array*)
 ...
 */
void
sidl_rmi_Ticket__array_deleteRef(
  struct sidl_rmi_Ticket__array* array)
{
 ...
 */
sidl_rmi_Ticket
sidl_rmi_Ticket__array_get1(
  const struct sidl_rmi_Ticket__array* array,
  const int32_t i1)
{
 ...
 */
void
sidl_rmi_Ticket__array_set1(
  struct sidl_rmi_Ticket__array* array,
  const int32_t i1,
  sidl_rmi_Ticket const value)
{
 ...
 */
int
sidl_rmi_Ticket__array_isColumnOrder(
  const struct sidl_rmi_Ticket__array* array)
{
 ...
 */
int
sidl_rmi_Ticket__array_isRowOrder(
  const struct sidl_rmi_Ticket__array* array)
{
 ...
 */
void
sidl_rmi_Ticket__array_copy(
  const struct sidl_rmi_Ticket__array* src,
  struct sidl_rmi_Ticket__array* dest)
{
 ...
 */
struct sidl_rmi_Ticket__array*
sidl_rmi_Ticket__array_slice(
  struct sidl_rmi_Ticket__array* src,
  int32_t        dimen,
