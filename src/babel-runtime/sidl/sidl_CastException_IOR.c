 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_CastException_IOR.c,v 1.1 2006/08/29 23:31:42 painter Exp $
 ...
 */
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_CastException__object*,const char*,
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_CastException__object*,const char*,int32_t,const char*,
    struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj                  = (void (*)(struct 
    sidl_CastException__object*,struct sidl_io_Serializer__object*,
    struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj                = (void (*)(struct 
    sidl_CastException__object*,struct sidl_io_Deserializer__object*,
