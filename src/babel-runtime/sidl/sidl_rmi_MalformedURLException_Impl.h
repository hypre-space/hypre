 ...
 * Revision:      @(#) $Id: sidl_rmi_MalformedURLException_Impl.h,v 1.1 2006/08/29 23:25:28 painter Exp $
...
#ifndef included_sidl_rmi_MalformedURLException_Impl_h
#define included_sidl_rmi_MalformedURLException_Impl_h
...
/* DO-NOT-DELETE splicer.begin(sidl.rmi.MalformedURLException._includes) */
/* Insert-Code-Here {sidl.rmi.MalformedURLException._includes} (include files) */
/* DO-NOT-DELETE splicer.end(sidl.rmi.MalformedURLException._includes) */

/*
 * Private data for class sidl.rmi.MalformedURLException
 */

struct sidl_rmi_MalformedURLException__data {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.MalformedURLException._data) */
  /* Insert-Code-Here {sidl.rmi.MalformedURLException._data} (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.MalformedURLException._data) */
};
...
extern struct sidl_rmi_MalformedURLException__data*
sidl_rmi_MalformedURLException__get_data(
  sidl_rmi_MalformedURLException);

extern void
sidl_rmi_MalformedURLException__set_data(
  sidl_rmi_MalformedURLException,
  struct sidl_rmi_MalformedURLException__data*);
...
extern struct sidl_rmi_MalformedURLException__object* 
  impl_sidl_rmi_MalformedURLException_fcast_sidl_rmi_MalformedURLException(
