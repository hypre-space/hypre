...
static struct sidl_BaseInterface__object* sidl_BaseInterface__remoteConnect(
...
{
  return sidl_BaseInterface__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.BaseInterface", (
      void*)sidl_BaseInterface__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
sidl_BaseInterface__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_BaseInterface__isRemote(self,_ex);
}
...
sidl_BaseInterface__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct sidl_BaseInterface__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
sidl_BaseInterface__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct sidl_BaseInterface__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct sidl_BaseInterface__array*)sidl_interface__array_create1dInit(
