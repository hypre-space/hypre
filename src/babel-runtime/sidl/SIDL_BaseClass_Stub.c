/*
 * File:          sidl_BaseClass_Stub.c
 * Symbol:        sidl.BaseClass-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_BaseClass_Stub.c,v 1.7 2007/09/27 19:35:42 painter Exp $
...
static const struct sidl_BaseClass__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_BaseClass__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_BaseClass__externals();
  return _externals;
}
...
sidl_BaseClass
sidl_BaseClass__create(sidl_BaseInterface* _ex)
{
  return (*(_getExternals()->createObject))(NULL,_ex);
}

static sidl_BaseClass sidl_BaseClass__remoteCreate(const char* url, 
...
sidl_BaseClass
sidl_BaseClass__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_BaseClass__remoteCreate(url, _ex);
}
...
sidl_BaseClass
sidl_BaseClass__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_BaseClass__remoteConnect(url, TRUE, _ex);
}
...
sidl_BaseClass__cast(
  ...
  sidl_BaseInterface* _ex)
{
  sidl_BaseClass cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.BaseClass", (
      void*)sidl_BaseClass__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_BaseClass) (*base->d_epv->f__cast)(
      base->d_object,
...
sidl_bool
sidl_BaseClass__isLocal(
  /* in */ sidl_BaseClass self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_BaseClass__isRemote(self,_ex);
}
...
sidl_BaseClass__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_BaseClass__array*)sidl_interface__array_createCol(dimen, 
    lower, upper);
}
 ...
 */
struct sidl_BaseClass__array*
sidl_BaseClass__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_BaseClass__array*)sidl_interface__array_createRow(dimen, 
    lower, upper);
}
 ...
 */
struct sidl_BaseClass__array*
sidl_BaseClass__array_create1d(int32_t len)
{
  return (struct sidl_BaseClass__array*)sidl_interface__array_create1d(len);
}
 ...
 */
struct sidl_BaseClass__array*
sidl_BaseClass__array_create1dInit(
  int32_t len, 
  sidl_BaseClass* data)
{
  return (struct sidl_BaseClass__array*)sidl_interface__array_create1dInit(len, 
 ...
 */
struct sidl_BaseClass__array*
sidl_BaseClass__array_create2dCol(int32_t m, int32_t n)
{
  return (struct sidl_BaseClass__array*)sidl_interface__array_create2dCol(m, n);
}
 ...
 */
struct sidl_BaseClass__array*
sidl_BaseClass__array_create2dRow(int32_t m, int32_t n)
{
  return (struct sidl_BaseClass__array*)sidl_interface__array_create2dRow(m, n);
}
 ...
 */
struct sidl_BaseClass__array*
sidl_BaseClass__array_borrow(
  sidl_BaseClass* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_BaseClass__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_BaseClass__array*
sidl_BaseClass__array_smartCopy(
  struct sidl_BaseClass__array *array)
{
  return (struct sidl_BaseClass__array*)
 ...
 */
void
sidl_BaseClass__array_deleteRef(
  struct sidl_BaseClass__array* array)
{
 ...
 */
sidl_BaseClass
sidl_BaseClass__array_get1(
  const struct sidl_BaseClass__array* array,
  const int32_t i1)
{
  return (sidl_BaseClass)
 ...
 */
void
sidl_BaseClass__array_set1(
  struct sidl_BaseClass__array* array,
  const int32_t i1,
  sidl_BaseClass const value)
{
 ...
 */
int
sidl_BaseClass__array_isColumnOrder(
  const struct sidl_BaseClass__array* array)
{
 ...
 */
int
sidl_BaseClass__array_isRowOrder(
  const struct sidl_BaseClass__array* array)
{
 ...
 */
void
sidl_BaseClass__array_copy(
  const struct sidl_BaseClass__array* src,
  struct sidl_BaseClass__array* dest)
{
 ...
 */
struct sidl_BaseClass__array*
sidl_BaseClass__array_slice(
  struct sidl_BaseClass__array* src,
  int32_t        dimen,
...
sidl_BaseClass__remoteConnect(const char *url, sidl_bool ar, sidl_BaseInterface 
  *_ex)
{
  struct sidl_BaseClass__object* self;
...
static struct sidl_BaseClass__object*
sidl_BaseClass__IHConnect(sidl_rmi_InstanceHandle instance, sidl_BaseInterface 
  *_ex)
{
  struct sidl_BaseClass__object* self;
