 ...
 * Revision:      @(#) $Id: sidl_DLL_IOR.h,v 1.7 2007/09/27 19:35:43 painter Exp $
...
extern void sidl_DLL__getEPVs(
  ...
  struct sidl_BaseInterface__object* skel_sidl_DLL_fcast_sidl_BaseInterface(
  ...
  struct sidl_DLL__object* skel_sidl_DLL_fcast_sidl_DLL(void *bi, struct 
  ...
  struct sidl_RuntimeException__object* 
    ...
    struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_sidl_DLL_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
