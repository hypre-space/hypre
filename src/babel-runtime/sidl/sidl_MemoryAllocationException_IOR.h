 ...
 * Revision:      @(#) $Id: sidl_MemoryAllocationException_IOR.h,v 1.1 2006/08/29 23:20:39 painter Exp $
...
#define included_sidl_MemoryAllocationException_IOR_h
...
struct sidl_MemoryAllocationException__epv {
  ...
  /* Methods introduced in sidl.MemoryAllocationException-v0.9.15 */
};
...
struct sidl_MemoryAllocationException__controls {
  int     use_hooks;
};
/*
...
struct sidl_MemoryAllocationException__object {
  ...
  struct sidl_MemoryAllocationException__epv* d_epv;
  void*                                       d_data;
};

struct sidl_MemoryAllocationException__external {
  struct sidl_MemoryAllocationException__object*
...
const struct sidl_MemoryAllocationException__external*
...
extern void sidl_MemoryAllocationException__getEPVs(
  ...
  struct sidl_MemoryAllocationException__object* 
    skel_sidl_MemoryAllocationException_fcast_sidl_MemoryAllocationException(
