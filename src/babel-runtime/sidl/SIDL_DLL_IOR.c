 ...
 * Revision:      @(#) $Id: sidl_DLL_IOR.c,v 1.6 2006/08/29 22:29:49 painter Exp $
...
sidl_DLL_loadLibrary__exec(
  ...
  sidl_rmi_Call_unpackBool( inArgs, "loadGlobally", &loadGlobally,
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackBool( inArgs, "loadLazy", &loadLazy,
    _ex);SIDL_CHECK(*_ex);
...
sidl_DLL_lookupSymbol__exec(
  ...
  /* pack return value */
  sidl_rmi_Return_packOpaque( outArgs, "_retval", _retval,
    _ex);SIDL_CHECK(*_ex);
  /* pack out and inout argments */
  /* clean-up dangling references */
...
sidl_DLL_createClass__exec(
  ...
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "sidl_name", &sidl_name,
    _ex);SIDL_CHECK(*_ex);
