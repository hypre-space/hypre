 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_DFinder_IOR.h,v 1.5 2006/08/29 22:29:49 painter Exp $
...
extern void sidl_DFinder__init(
  struct sidl_DFinder__object* self, void* ddata,
...
extern void sidl_DFinder__getEPVs(
  ...
  struct sidl_DFinder__epv **s_arg_epv__sidl_dfinder,
    struct sidl_DFinder__epv **s_arg_epv_hooks__sidl_dfinder);
  ...
  struct sidl_BaseClass__object* 
    skel_sidl_DFinder_fconnect_sidl_BaseClass(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    skel_sidl_DFinder_fconnect_sidl_ClassInfo(const char* url, sidl_bool ar,
    struct sidl_BaseInterface__object **_ex);
