 ...
 * Revision:      @(#) $Id: sidl_rmi_TimeOutException_IOR.c,v 1.1 2006/08/29 23:31:44 painter Exp $
 ...
 */
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_TimeOutException__object*,const char*,
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_rmi_TimeOutException__object*,const char*,int32_t,const char*,
...
static struct sidl_rmi_NetworkException__epv* 
  sidl_rmi_TimeOutException__super(void) {
