 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_IOR.c,v 1.2 2007/09/27 19:35:46 painter Exp $
...
static struct sidl_rmi_ConnectException__epv 
  s_new_epv__sidl_rmi_connectexception;

static struct sidl_rmi_ConnectException__epv 
  s_new_epv_hooks__sidl_rmi_connectexception;
 ...
 */
  ...
  struct sidl_rmi_ConnectException__epv*  epv  = 
    &s_new_epv__sidl_rmi_connectexception;
  struct sidl_rmi_ConnectException__epv*  hepv = 
    &s_new_epv_hooks__sidl_rmi_connectexception;
  ...
  epv->f_getHopCount              = (int32_t (*)(struct 
    sidl_rmi_ConnectException__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getHopCount;
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_ConnectException__object*,const char*,struct 
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_rmi_ConnectException__object*,const char*,int32_t,const char*,struct 
    sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj                  = (void (*)(struct 
    sidl_rmi_ConnectException__object*,struct sidl_io_Serializer__object*,
    struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj                = (void (*)(struct 
    sidl_rmi_ConnectException__object*,struct sidl_io_Deserializer__object*,
    struct sidl_BaseInterface__object **)) s1->f_unpackObj;

  sidl_rmi_ConnectException__set_epv(epv);

  memcpy((void*)hepv, epv, sizeof(struct sidl_rmi_ConnectException__epv));
    ...
    **s_arg_epv_hooks__sidl_rmi_connectexception)
{
  ...
  *s_arg_epv_hooks__sidl_rmi_networkexception = 
    &s_new_epv_hooks__sidl_rmi_networkexception;
  *s_arg_epv__sidl_rmi_connectexception = &s_new_epv__sidl_rmi_connectexception;
  *s_arg_epv_hooks__sidl_rmi_connectexception = 
    &s_new_epv_hooks__sidl_rmi_connectexception;
}
/*
...
static struct sidl_rmi_NetworkException__epv* sidl_rmi_ConnectException__super(
  void) {
...
static void
initMetadata(struct sidl_rmi_ConnectException__object* self, 
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_new_epv__sidl_rmi_connectexception;

  s0->d_data = NULL;

  ior_sidl_rmi_ConnectException__set_hooks(s0, FALSE, _ex);
...
s_externalEntryPoints = {
  sidl_rmi_ConnectException__new,
  sidl_rmi_ConnectException__super,
  1, 
  0
};
