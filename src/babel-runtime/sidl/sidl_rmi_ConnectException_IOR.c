 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_IOR.c,v 1.1 2006/08/29 23:31:43 painter Exp $
 ...
 */
  ...
  epv->f_getHopCount              = (int32_t (*)(struct 
    sidl_rmi_ConnectException__object*,
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_ConnectException__object*,const char*,
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_rmi_ConnectException__object*,const char*,int32_t,const char*,
...
static struct sidl_rmi_NetworkException__epv* 
  sidl_rmi_ConnectException__super(void) {
