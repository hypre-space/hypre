 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectRegistry_Stub.c,v 1.6 2007/09/27 19:35:46 painter Exp $
...
static sidl_rmi_ConnectRegistry sidl_rmi_ConnectRegistry__remoteCreate(const 
...
{
  return sidl_rmi_ConnectRegistry__remoteCreate(url, _ex);
}
...
{
  return sidl_rmi_ConnectRegistry__remoteConnect(url, TRUE, _ex);
}
...
{
  void* _result;
  _result = (_getSEPV()->f_removeConnect)(
    key,
    _ex);
  return _result;
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.ConnectRegistry", (
      void*)sidl_rmi_ConnectRegistry__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
void
sidl_rmi_ConnectRegistry__set_hooks_static(
  int32_t on,
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_ConnectRegistry__set_hooks(
  /* in */ sidl_rmi_ConnectRegistry self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
sidl_rmi_ConnectRegistry__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_ConnectRegistry__isRemote(self,_ex);
}
