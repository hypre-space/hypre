 ...
 * Revision:      @(#) $Id: sidl_rmi_InstanceRegistry.h,v 1.6 2007/09/27 19:35:46 painter Exp $
...
typedef struct sidl_rmi_InstanceRegistry__object* sidl_rmi_InstanceRegistry;
