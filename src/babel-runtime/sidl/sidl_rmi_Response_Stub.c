 ...
 * Revision:      @(#) $Id: sidl_rmi_Response_Stub.c,v 1.5 2006/08/29 22:29:52 painter Exp $
...
{
  return (struct 
    sidl_rmi_Response__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_rmi_Response__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_rmi_Response__array*)sidl_interface__array_create1dInit(len,
