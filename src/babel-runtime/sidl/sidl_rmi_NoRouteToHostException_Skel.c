 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_Skel.c,v 1.1 2006/08/29 23:31:43 painter Exp $
...
struct sidl_RuntimeException__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_rmi_NoRouteToHostException_fconnect_sidl_RuntimeException(url, ar,
    _ex);
}
...
struct sidl_rmi_NetworkException__object* 
  ...
  sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_rmi_NoRouteToHostException_fcast_sidl_rmi_NetworkException(bi,
    _ex);
}
...
struct sidl_rmi_NoRouteToHostException__object* 
  ...
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_rmi_NoRouteToHostException_fconnect_sidl_rmi_NoRouteToHostException(url, ar, _ex);
}
