 ...
 * Revision:      @(#) $Id: sidl_rmi_ObjectDoesNotExistException_Stub.c,v 1.1 2006/08/29 23:31:44 painter Exp $
...
{
  return (struct 
    sidl_rmi_ObjectDoesNotExistException__array*)sidl_interface__array_createCol(dimen, lower, upper);
}
...
{
  return (struct 
    sidl_rmi_ObjectDoesNotExistException__array*)sidl_interface__array_createRow(dimen, lower, upper);
}
...
{
  return (struct 
    sidl_rmi_ObjectDoesNotExistException__array*)sidl_interface__array_create1dInit(len, (struct sidl_BaseInterface__object **)data);
}
...
{
  return (struct 
    sidl_rmi_ObjectDoesNotExistException__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidl_rmi_ObjectDoesNotExistException__array*)sidl_interface__array_create2dRow(m, n);
}
