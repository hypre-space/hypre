 ...
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_Resolve_Stub.c,v 1.6 2006/08/29 22:29:50 painter Exp $
 ...
 */
struct sidl_Resolve__array*
sidl_Resolve__array_create1d(int32_t len)
{
  return (struct sidl_Resolve__array*)sidl_int__array_create1d(len);
}
 ...
 */
struct sidl_Resolve__array*
sidl_Resolve__array_create1dInit(
  int32_t len, 
  int32_t* data)
{
 ...
 */
struct sidl_Resolve__array*
sidl_Resolve__array_create2dCol(int32_t m, int32_t n)
{
  return (struct sidl_Resolve__array*)sidl_int__array_create2dCol(m, n);
}
 ...
 */
struct sidl_Resolve__array*
sidl_Resolve__array_create2dRow(int32_t m, int32_t n)
{
  return (struct sidl_Resolve__array*)sidl_int__array_create2dRow(m, n);
}
...
{
  return (struct sidl_Resolve__array*)sidl_int__array_borrow(
 ...
 */
struct sidl_Resolve__array*
sidl_Resolve__array_smartCopy(
  struct sidl_Resolve__array *array)
{
  return (struct sidl_Resolve__array*)
...
sidl_Resolve__array_get1(
  const struct sidl_Resolve__array* array,
  const int32_t i1)
{
  return (enum sidl_Resolve__enum)
 ...
 */
void
sidl_Resolve__array_set1(
  struct sidl_Resolve__array* array,
  const int32_t i1,
  enum sidl_Resolve__enum const value)
{
 ...
 */
int
sidl_Resolve__array_isColumnOrder(
  const struct sidl_Resolve__array* array)
{
 ...
 */
int
sidl_Resolve__array_isRowOrder(
  const struct sidl_Resolve__array* array)
{
 ...
 */
void
sidl_Resolve__array_copy(
  const struct sidl_Resolve__array* src,
  struct sidl_Resolve__array* dest)
{
 ...
 */
struct sidl_Resolve__array*
sidl_Resolve__array_slice(
  struct sidl_Resolve__array* src,
  int32_t        dimen,
