...
void
sidl_rmi_TimeOutException__set_epv(struct sidl_rmi_TimeOutException__epv *epv)
{
  epv->f__ctor = impl_sidl_rmi_TimeOutException__ctor;
  epv->f__ctor2 = impl_sidl_rmi_TimeOutException__ctor2;
  epv->f__dtor = impl_sidl_rmi_TimeOutException__dtor;
...
void sidl_rmi_TimeOutException__call_load(void) { 
...
struct sidl_rmi_TimeOutException__data*
sidl_rmi_TimeOutException__get_data(sidl_rmi_TimeOutException self)
{
  return (struct sidl_rmi_TimeOutException__data*)(self ? self->d_data : NULL);
}

void sidl_rmi_TimeOutException__set_data(
  sidl_rmi_TimeOutException self,
  struct sidl_rmi_TimeOutException__data* data)
{
  if (self) {
    self->d_data = data;
  }
