 ...
 * Revision:      @(#) $Id: sidl_SIDLException_Impl.c,v 1.8 2007/09/27 19:35:44 painter Exp $
...
struct sidl_BaseClass__object* impl_sidl_SIDLException_fconnect_sidl_BaseClass(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) {
  return sidl_BaseClass__connectI(url, ar, _ex);
}
struct sidl_BaseClass__object* impl_sidl_SIDLException_fcast_sidl_BaseClass(
...
struct sidl_ClassInfo__object* impl_sidl_SIDLException_fconnect_sidl_ClassInfo(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) {
  return sidl_ClassInfo__connectI(url, ar, _ex);
}
struct sidl_ClassInfo__object* impl_sidl_SIDLException_fcast_sidl_ClassInfo(
  void* bi, sidl_BaseInterface* _ex) {
