 ...
 * Revision:      @(#) $Id: sidl_Loader_Skel.c,v 1.7 2007/09/27 19:35:44 painter Exp $
...
extern struct sidl_BaseClass__object* impl_sidl_Loader_fconnect_sidl_BaseClass(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
extern struct sidl_BaseClass__object* impl_sidl_Loader_fcast_sidl_BaseClass(
...
extern struct sidl_ClassInfo__object* impl_sidl_Loader_fconnect_sidl_ClassInfo(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
extern struct sidl_ClassInfo__object* impl_sidl_Loader_fcast_sidl_ClassInfo(
  void* bi, sidl_BaseInterface* _ex);
...
extern struct sidl_RuntimeException__object* 
  ...
  sidl_BaseInterface *_ex);
extern struct sidl_RuntimeException__object* 
  impl_sidl_Loader_fcast_sidl_RuntimeException(void* bi, sidl_BaseInterface* 
  _ex);
extern struct sidl_BaseClass__object* impl_sidl_Loader_fconnect_sidl_BaseClass(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex);
extern struct sidl_BaseClass__object* impl_sidl_Loader_fcast_sidl_BaseClass(
...
struct sidl_RuntimeException__object* 
  skel_sidl_Loader_fcast_sidl_RuntimeException(void* bi, sidl_BaseInterface 
  *_ex) { 
