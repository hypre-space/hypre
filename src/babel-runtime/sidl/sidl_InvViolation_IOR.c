/*
 * File:          sidl_InvViolation_IOR.c
 * Symbol:        sidl.InvViolation-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_InvViolation_IOR.c,v 1.6 2007/09/27 19:35:43 painter Exp $
...
static struct sidl_InvViolation__epv s_new_epv__sidl_invviolation;

static struct sidl_InvViolation__epv s_new_epv_hooks__sidl_invviolation;
...
extern void sidl_InvViolation__set_epv(
  struct sidl_InvViolation__epv* epv);
extern void sidl_InvViolation__call_load(void);
#ifdef __cplusplus
}
#endif

static void
sidl_InvViolation_addRef__exec(
...
static void
sidl_InvViolation_deleteRef__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_InvViolation_isSame__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_sidl_InvViolation_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
static void
sidl_InvViolation_isType__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_InvViolation_getClassInfo__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_InvViolation_getNote__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_InvViolation_setNote__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_InvViolation_getTrace__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_InvViolation_addLine__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_InvViolation_packObj__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  ser = skel_sidl_InvViolation_fconnect_sidl_io_Serializer(ser_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
static void
sidl_InvViolation_unpackObj__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  des = skel_sidl_InvViolation_fconnect_sidl_io_Deserializer(des_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
...
static void ior_sidl_InvViolation__ensure_load_called(void) {
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */

  if (! s_load_called ) {
    sidl_InvViolation__call_load();
    s_load_called=1;
  }
}

/* CAST: dynamic type casting support. */
static void* ior_sidl_InvViolation__cast(
  struct sidl_InvViolation__object* self,
...
static void ior_sidl_InvViolation__set_hooks(
  struct sidl_InvViolation__object* self,
...
static void ior_sidl_InvViolation__delete(
  struct sidl_InvViolation__object* self, struct sidl_BaseInterface__object 
    **_ex)
{
  *_ex = NULL; /* default to no exception */
  sidl_InvViolation__fini(self,_ex);
  memset((void*)self, 0, sizeof(struct sidl_InvViolation__object));
  free((void*) self);
}

static char*
ior_sidl_InvViolation__getURL(
    struct sidl_InvViolation__object* self,
    struct sidl_BaseInterface__object **_ex) {
  char* ret = NULL;
...
static void
ior_sidl_InvViolation__raddRef(
    struct sidl_InvViolation__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_sidl_InvViolation__isRemote(
    struct sidl_InvViolation__object* self, sidl_BaseInterface* _ex) {
  *_ex = NULL; /* default to no exception */
  return FALSE;
}

struct sidl_InvViolation__method {
  const char *d_name;
  void (*d_func)(struct sidl_InvViolation__object*,
...
static void
ior_sidl_InvViolation__exec(
    struct sidl_InvViolation__object* self,
    const char* methodName,
    struct sidl_rmi_Call__object* inArgs,
    struct sidl_rmi_Return__object* outArgs,
    struct sidl_BaseInterface__object **_ex ) { 
  static const struct sidl_InvViolation__method  s_methods[] = {
    { "add", sidl_InvViolation_add__exec },
    { "addLine", sidl_InvViolation_addLine__exec },
    { "addRef", sidl_InvViolation_addRef__exec },
    { "deleteRef", sidl_InvViolation_deleteRef__exec },
    { "getClassInfo", sidl_InvViolation_getClassInfo__exec },
    { "getNote", sidl_InvViolation_getNote__exec },
    { "getTrace", sidl_InvViolation_getTrace__exec },
    { "isSame", sidl_InvViolation_isSame__exec },
    { "isType", sidl_InvViolation_isType__exec },
    { "packObj", sidl_InvViolation_packObj__exec },
    { "setNote", sidl_InvViolation_setNote__exec },
    { "unpackObj", sidl_InvViolation_unpackObj__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct sidl_InvViolation__method);
  *_ex = NULL; /* default to no exception */
  if (methodName) {
...
static void sidl_InvViolation__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidl_InvViolation__epv*     epv  = &s_new_epv__sidl_invviolation;
  struct sidl_InvViolation__epv*     hepv = &s_new_epv_hooks__sidl_invviolation;
  ...
  epv->f__cast                    = ior_sidl_InvViolation__cast;
  epv->f__delete                  = ior_sidl_InvViolation__delete;
  epv->f__exec                    = ior_sidl_InvViolation__exec;
  epv->f__getURL                  = ior_sidl_InvViolation__getURL;
  epv->f__raddRef                 = ior_sidl_InvViolation__raddRef;
  epv->f__isRemote                = ior_sidl_InvViolation__isRemote;
  epv->f__set_hooks               = ior_sidl_InvViolation__set_hooks;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_addRef                   = (void (*)(struct sidl_InvViolation__object*,
    struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct sidl_InvViolation__object*,
    struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_InvViolation__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_InvViolation__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    sidl_InvViolation__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
  epv->f_getNote                  = (char* (*)(struct 
    sidl_InvViolation__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getNote;
  epv->f_setNote                  = (void (*)(struct sidl_InvViolation__object*,
    const char*,struct sidl_BaseInterface__object **)) s1->f_setNote;
  epv->f_getTrace                 = (char* (*)(struct 
    sidl_InvViolation__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getTrace;
  epv->f_addLine                  = (void (*)(struct sidl_InvViolation__object*,
    const char*,struct sidl_BaseInterface__object **)) s1->f_addLine;
  epv->f_add                      = (void (*)(struct sidl_InvViolation__object*,
    const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) 
    s1->f_add;
  epv->f_packObj                  = (void (*)(struct sidl_InvViolation__object*,
    struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) 
    s1->f_packObj;
  epv->f_unpackObj                = (void (*)(struct sidl_InvViolation__object*,
    struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) 
    s1->f_unpackObj;

  sidl_InvViolation__set_epv(epv);

  memcpy((void*)hepv, epv, sizeof(struct sidl_InvViolation__epv));
  ...
  ior_sidl_InvViolation__ensure_load_called();
}

void sidl_InvViolation__getEPVs(
  ...
  struct sidl_InvViolation__epv **s_arg_epv__sidl_invviolation,struct 
    sidl_InvViolation__epv **s_arg_epv_hooks__sidl_invviolation)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    sidl_InvViolation__init_epv();
  }
  ...
  *s_arg_epv_hooks__sidl_runtimeexception = 
    &s_new_epv_hooks__sidl_runtimeexception;
  *s_arg_epv__sidl_invviolation = &s_new_epv__sidl_invviolation;
  *s_arg_epv_hooks__sidl_invviolation = &s_new_epv_hooks__sidl_invviolation;
}
/*
 * SUPER: returns parent's non-overrided EPV
 */

static struct sidl_SIDLException__epv* sidl_InvViolation__super(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidl.InvViolation",_ex);
...
static void
initMetadata(struct sidl_InvViolation__object* self, sidl_BaseInterface* _ex)
{
...
sidl_InvViolation__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_InvViolation__object* self =
    (struct sidl_InvViolation__object*) malloc(
      sizeof(struct sidl_InvViolation__object));
  *_ex = NULL; /* default to no exception */
  sidl_InvViolation__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void sidl_InvViolation__init(
  struct sidl_InvViolation__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidl_InvViolation__object*  s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                         = &s_new_epv__sidl_invviolation;

  s0->d_sidl_runtimeexception.d_object = self;

  s0->d_data = NULL;

  ior_sidl_InvViolation__set_hooks(s0, FALSE, _ex);
...
void
sidl_InvViolation__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct sidl_InvViolation__external
s_externalEntryPoints = {
  sidl_InvViolation__new,
  sidl_InvViolation__super,
  1, 
  0
};
