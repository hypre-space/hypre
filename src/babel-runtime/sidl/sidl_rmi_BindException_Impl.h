/*
 * File:          sidl_rmi_BindException_Impl.h
 * Symbol:        sidl.rmi.BindException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name:  $
 * Revision:      @(#) $Id: sidl_rmi_BindException_Impl.h,v 1.1 2006/08/29 23:25:28 painter Exp $
...
#ifndef included_sidl_rmi_BindException_Impl_h
#define included_sidl_rmi_BindException_Impl_h
...
/* Insert-Code-Here {sidl.rmi.BindException._includes} (include files) */
/* DO-NOT-DELETE splicer.end(sidl.rmi.BindException._includes) */

/*
 * Private data for class sidl.rmi.BindException
 */

struct sidl_rmi_BindException__data {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.BindException._data) */
  /* Insert-Code-Here {sidl.rmi.BindException._data} (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.BindException._data) */
};
...
extern struct sidl_rmi_BindException__data*
sidl_rmi_BindException__get_data(
  sidl_rmi_BindException);

extern void
sidl_rmi_BindException__set_data(
  sidl_rmi_BindException,
  struct sidl_rmi_BindException__data*);
