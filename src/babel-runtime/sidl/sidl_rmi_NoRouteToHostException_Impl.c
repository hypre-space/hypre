 ...
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_Impl.c,v 1.1 2006/08/29 23:31:43 painter Exp $
...
#include "sidl_rmi_NoRouteToHostException_Impl.h"
#include "sidl_NotImplementedException.h"
#include "sidl_Exception.h"

/* DO-NOT-DELETE splicer.begin(sidl.rmi.NoRouteToHostException._includes) */
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_rmi_NoRouteToHostException__load"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.NoRouteToHostException._load) */
  /* Insert-Code-Here {sidl.rmi.NoRouteToHostException._load} (static class initializer method) */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.NoRouteToHostException._load) */
  }
}
/*
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_rmi_NoRouteToHostException__ctor"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.NoRouteToHostException._ctor) */
  /* Insert-Code-Here {sidl.rmi.NoRouteToHostException._ctor} (constructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.NoRouteToHostException._ctor) */
  }
}
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_rmi_NoRouteToHostException__ctor2"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.NoRouteToHostException._ctor2) */
  /* Insert-Code-Here {sidl.rmi.NoRouteToHostException._ctor2} (special constructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.NoRouteToHostException._ctor2) */
  }
}
/*
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_rmi_NoRouteToHostException__dtor"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.NoRouteToHostException._dtor) */
  /* Insert-Code-Here {sidl.rmi.NoRouteToHostException._dtor} (destructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.NoRouteToHostException._dtor) */
  }
}
...
struct sidl_rmi_NoRouteToHostException__object* 
  ...
  return sidl_rmi_NoRouteToHostException__connectI(url, ar, _ex);
}
struct sidl_rmi_NoRouteToHostException__object* 
  impl_sidl_rmi_NoRouteToHostException_fcast_sidl_rmi_NoRouteToHostException(
  void* bi, sidl_BaseInterface* _ex) {
  return sidl_rmi_NoRouteToHostException__cast(bi, _ex);
}
