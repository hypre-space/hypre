 ...
 * Revision:      @(#) $Id: sidl_rmi_InstanceRegistry_Stub.c,v 1.6 2007/09/27 19:35:46 painter Exp $
...
sidl_rmi_InstanceRegistry
sidl_rmi_InstanceRegistry__createRemote(const char* url, sidl_BaseInterface 
  *_ex)
{
...
{
  char* _result;
  _result = (_getSEPV()->f_registerInstance)(
    instance,
    _ex);
  return _result;
}
...
{
  char* _result;
  _result = (_getSEPV()->f_registerInstanceByString)(
    instance,
    instanceID,
    _ex);
  return _result;
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  ...
  _result = (_getSEPV()->f_getInstanceByString)(
    instanceID,
    _ex);
  return _result;
}
...
{
  char* _result;
  _result = (_getSEPV()->f_getInstanceByClass)(
    instance,
    _ex);
  return _result;
}
...
{
  sidl_BaseClass _result;
  _result = (_getSEPV()->f_removeInstanceByString)(
    instanceID,
    _ex);
  return _result;
}
...
{
  char* _result;
  _result = (_getSEPV()->f_removeInstanceByClass)(
    instance,
    _ex);
  return _result;
}
