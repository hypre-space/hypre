 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_Skel.c,v 1.2 2007/09/27 19:35:46 painter Exp $
...
void
sidl_rmi_ConnectException__set_epv(struct sidl_rmi_ConnectException__epv *epv)
{
  epv->f__ctor = impl_sidl_rmi_ConnectException__ctor;
  epv->f__ctor2 = impl_sidl_rmi_ConnectException__ctor2;
  epv->f__dtor = impl_sidl_rmi_ConnectException__dtor;
...
void sidl_rmi_ConnectException__call_load(void) { 
...
sidl_rmi_ConnectException__get_data(sidl_rmi_ConnectException self)
{
  return (struct sidl_rmi_ConnectException__data*)(self ? self->d_data : NULL);
}

void sidl_rmi_ConnectException__set_data(
  sidl_rmi_ConnectException self,
  struct sidl_rmi_ConnectException__data* data)
{
  if (self) {
    self->d_data = data;
  }
