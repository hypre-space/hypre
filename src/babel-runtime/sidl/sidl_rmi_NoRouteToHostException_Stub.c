/*
 * File:          sidl_rmi_NoRouteToHostException_Stub.c
 * Symbol:        sidl.rmi.NoRouteToHostException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.4
 * Release:       $Name: V2-4-0b $
 * Revision:      @(#) $Id: sidl_rmi_NoRouteToHostException_Stub.c,v 1.2 2007/09/27 19:35:47 painter Exp $
...
static const struct sidl_rmi_NoRouteToHostException__external *_externals = 
  NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_rmi_NoRouteToHostException__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_rmi_NoRouteToHostException__externals();
  return _externals;
}
...
static sidl_rmi_NoRouteToHostException 
...
sidl_rmi_NoRouteToHostException__createRemote(const char* url, 
  sidl_BaseInterface *_ex)
{
  return sidl_rmi_NoRouteToHostException__remoteCreate(url, _ex);
}
...
sidl_rmi_NoRouteToHostException
sidl_rmi_NoRouteToHostException__connect(const char* url, sidl_BaseInterface 
  *_ex)
{
  return sidl_rmi_NoRouteToHostException__remoteConnect(url, TRUE, _ex);
}
...
sidl_rmi_NoRouteToHostException__cast(
  ...
  sidl_BaseInterface* _ex)
{
  sidl_rmi_NoRouteToHostException cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.NoRouteToHostException", 
      (void*)sidl_rmi_NoRouteToHostException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_rmi_NoRouteToHostException) (*base->d_epv->f__cast)(
      base->d_object,
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_NoRouteToHostException__set_hooks(
  /* in */ sidl_rmi_NoRouteToHostException self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
sidl_rmi_NoRouteToHostException__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_NoRouteToHostException__isRemote(self,_ex);
}
...
{
  return (struct 
    sidl_rmi_NoRouteToHostException__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
{
  return (struct 
    sidl_rmi_NoRouteToHostException__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct 
    sidl_rmi_NoRouteToHostException__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidl_rmi_NoRouteToHostException__array*)sidl_interface__array_create1dInit(
...
{
  return (struct 
    sidl_rmi_NoRouteToHostException__array*)sidl_interface__array_create2dCol(m,
    n);
}
...
{
  return (struct 
    sidl_rmi_NoRouteToHostException__array*)sidl_interface__array_create2dRow(m,
    n);
}
...
{
  return (struct 
    sidl_rmi_NoRouteToHostException__array*)sidl_interface__array_borrow(
...
{
  return (struct sidl_rmi_NoRouteToHostException__array*)
...
sidl_rmi_NoRouteToHostException__array_get1(
  ...
  const int32_t i1)
{
  return (sidl_rmi_NoRouteToHostException)
