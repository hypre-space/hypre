/*
 * File:          sidl_rmi_ConnectException_Impl.h
 * Symbol:        sidl.rmi.ConnectException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name: V1-13-0b $
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_Impl.h,v 1.1 2006/08/29 23:25:28 painter Exp $
...
#ifndef included_sidl_rmi_ConnectException_Impl_h
#define included_sidl_rmi_ConnectException_Impl_h
...
/* Insert-Code-Here {sidl.rmi.ConnectException._includes} (include files) */
/* DO-NOT-DELETE splicer.end(sidl.rmi.ConnectException._includes) */

/*
 * Private data for class sidl.rmi.ConnectException
 */

struct sidl_rmi_ConnectException__data {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.ConnectException._data) */
  /* Insert-Code-Here {sidl.rmi.ConnectException._data} (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.ConnectException._data) */
};
...
extern struct sidl_rmi_ConnectException__data*
sidl_rmi_ConnectException__get_data(
  sidl_rmi_ConnectException);

extern void
sidl_rmi_ConnectException__set_data(
  sidl_rmi_ConnectException,
  struct sidl_rmi_ConnectException__data*);
