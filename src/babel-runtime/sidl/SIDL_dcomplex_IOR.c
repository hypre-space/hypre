...
SIDL_dcomplex__array_borrowSmartCp(struct SIDL_dcomplex__array* array)
{
  ...
  if (array) {
    if (SIDL_dcomplex__array_isColumnOrder(array)) {
      copy = SIDL_dcomplex__array_createCol(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
    else {
      copy = SIDL_dcomplex__array_createRow(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
...
static const struct SIDL_dcomplex__vtable normal_dcomplex_vtable = {
  SIDL_dcomplex__array_destroy,
...
static const struct SIDL_dcomplex__vtable borrowed_dcomplex_vtable = {
  SIDL_dcomplex__array_bdestroy,
...
static const struct SIDL_dcomplex__vtable sliced_dcomplex_vtable = {
  SIDL_dcomplex__array_sdestroy,
  SIDL_dcomplex__array_smartCp
};
/**
...
static const struct SIDL_dcomplex__vtable bsliced_dcomplex_vtable = {
  SIDL_dcomplex__array_sdestroy,
  SIDL_dcomplex__array_borrowSmartCp
};
/**
         ...
         struct SIDL_dcomplex__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    ...
    result->d_vtable = &sliced_dcomplex_vtable;
  }
  else {
    result->d_vtable = &normal_dcomplex_vtable;
  }
  ...
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_vtable->d_smartcopy ==
        ...
        result->d_vtable = &bsliced_dcomplex_vtable;
      }
    }
  }
  return result;
                            ...
                            const int32_t  stride[])
{
  ...
  result->d_vtable = &borrowed_dcomplex_vtable;
  return result;
}
