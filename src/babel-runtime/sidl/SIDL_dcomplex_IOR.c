/*
 * File:        sidl_dcomplex_IOR.c
 * Copyright:   (c) 2001 The Regents of the University of California
 * Revision:    @(#) $Revision: 1.8 $
 * Date:        $Date: 2007/09/27 19:35:45 $
 * Description: dcomplex array implementation
...
static struct sidl_dcomplex const sidl_dcomplex__array_zero = {0, 0};
 ...
 */
static void
sidl_dcomplex__array_bdestroy(struct sidl_dcomplex__array* array)
{
  if (array) {
#ifdef SIDL_DEBUG_REFCOUNT
    sidl__array_remove((struct sidl__array *)array);
#endif
    memset(array, 0, sizeof(struct sidl_dcomplex__array) +
 ...
 */
static void
sidl_dcomplex__array_destroy(struct sidl_dcomplex__array* array)
{
  if (array) {
#ifdef DESTROY_VALUES_TOO
    struct sidl_dcomplex *ptr = array->d_firstElement;
    int32_t i;
    int32_t size = 1;
    HELPER_VARIABLE;
    ...
    sidl_dcomplex__array_bdestroy(array);
  }
}
 ...
 */
static void
sidl_dcomplex__array_rdestroy(struct sidl_dcomplex__array* array)
{
#ifdef SIDL_DEBUG_REFCOUNT
 ...
 */
static void
sidl_dcomplex__array_sdestroy(struct sidl_dcomplex__array* array)
{
  if (array) {
    static const int arraySize = sizeof(struct sidl_dcomplex__array)
      + (sizeof(int32_t) - (sizeof(struct sidl_dcomplex__array)
                        % sizeof(int32_t))) % sizeof(int32_t);
    struct sidl_dcomplex__array **orig;
    orig = (struct sidl_dcomplex__array **)((char *)array + arraySize +
      3 * sizeof(int32_t)*array->d_metadata.d_dimen);
    if (*orig) {
      sidl_dcomplex__array_deleteRef(*orig);
      *orig = NULL;
    }
    sidl_dcomplex__array_bdestroy(array);
  }
...
sidl_dcomplex__array_smartCp(struct sidl_dcomplex__array* array)
{
 ...
 */
static struct sidl_dcomplex__array*
sidl_dcomplex__array_borrowSmartCp(struct sidl_dcomplex__array* array)
{
  struct sidl_dcomplex__array* copy = NULL;
  if (array) {
    if (sidl_dcomplex__array_isColumnOrder(array)) {
      copy = sidl_dcomplex__array_createCol(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    else {
      copy = sidl_dcomplex__array_createRow(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    sidl_dcomplex__array_copy(array, copy);
  }
  return copy;
}
 ...
 */
static int32_t
dcomplex_arrayType(void)
{
  return sidl_dcomplex_array;
}
/**
 * Virtual function table for rarrays.
 */

static const struct sidl__array_vtable rarray_dcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_dcomplex__array_rdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_dcomplex__array_borrowSmartCp,
  dcomplex_arrayType
};
/**
...
static const struct sidl__array_vtable normal_dcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_dcomplex__array_destroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_dcomplex__array_smartCp,
  dcomplex_arrayType
};
/**
...
static const struct sidl__array_vtable borrowed_dcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_dcomplex__array_bdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_dcomplex__array_borrowSmartCp,
  dcomplex_arrayType
};
...
static const struct sidl__array_vtable sliced_dcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_dcomplex__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_dcomplex__array_smartCp,
  dcomplex_arrayType
};
...
static const struct sidl__array_vtable bsliced_dcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_dcomplex__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_dcomplex__array_borrowSmartCp,
  dcomplex_arrayType
         ...
         struct sidl_dcomplex__array *orig)
{
  static const int arraySize = sizeof(struct sidl_dcomplex__array)
    + (sizeof(int32_t) - (sizeof(struct sidl_dcomplex__array)
                      % sizeof(int32_t))) % sizeof(int32_t);
  struct sidl_dcomplex__array *result = (struct sidl_dcomplex__array *)
    malloc(arraySize + 3 * sizeof(int32_t) * dimen +
           (orig ? sizeof(struct sidl_dcomplex__array *) : 0));
  ...
  if (orig) {
    struct sidl_dcomplex__array **ref;
    ref = (struct sidl_dcomplex__array **)
      ((char *)result + arraySize + 3 * sizeof(int32_t)*dimen);
    *ref = orig;
    sidl_dcomplex__array_addRef(orig);
    result->d_metadata.d_vtable = &sliced_dcomplex_vtable;
  }
  else {
    result->d_metadata.d_vtable = &normal_dcomplex_vtable;
  }
...
/**
 * Create a dense dcomplex array of the given dimension with specified
...
sidl_dcomplex__array_createCol(int32_t       dimen,
                               const int32_t lower[],
                               const int32_t upper[])
{
  int32_t size=1, i;
  struct sidl_dcomplex__array *result = newArray(dimen, lower, upper, NULL);
  for(i = 0; i < dimen; ++i) {
    result->d_metadata.d_stride[i] = size;
    size *= (1 + upper[i] - lower[i]);
  }
  size *= sizeof(struct sidl_dcomplex);
  result->d_firstElement = (struct sidl_dcomplex *)malloc(size);
 ...
 */
struct sidl_dcomplex__array *
sidl_dcomplex__array_createRow(int32_t       dimen,
                               const int32_t lower[],
                               const int32_t upper[])
{
  int32_t size=1, i;
 ...
 */
void
sidl_dcomplex__array_init(const struct sidl_dcomplex* c_array,
struct sidl_dcomplex__array* sidl_array, int32_t dim,
int32_t lower[], int32_t upper[], int32_t stride[])
{
  ...
  sidl_array->d_metadata.d_lower = lower;
  sidl_array->d_metadata.d_vtable = &rarray_dcomplex_vtable;
  sidl_array->d_metadata.d_refcount = 1;
  sidl_array->d_firstElement = (struct sidl_dcomplex *)c_array;
#ifdef SIDL_DEBUG_REFCOUNT
...
/**
 * Create a dense one-dimensional vector of dcomplexs with a lower
 * index of 0 and an upper index of len-1. This array owns and manages
 * its data.
 * This function does not initialize the contents of the array.
 */
struct sidl_dcomplex__array *
sidl_dcomplex__array_create1d(int32_t len)
{
  static const int32_t zero = 0;
  --len;
  return sidl_dcomplex__array_createCol(1, &zero, &len);
}
 ...
 */
struct sidl_dcomplex__array *
sidl_dcomplex__array_create1dInit(int32_t len,
                                  const struct sidl_dcomplex* data)
{
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      const struct sidl_dcomplex * restrict src =
        (const struct sidl_dcomplex * restrict)data;
      struct sidl_dcomplex * restrict dest;
      HELPER_VARIABLE;
      result->d_metadata.d_stride[0] = 1;
      result->d_firstElement =
        (struct sidl_dcomplex *)malloc(len*sizeof(struct sidl_dcomplex));
      dest = (struct sidl_dcomplex * restrict)(result->d_firstElement);
      while (len--) {
        *dest = COPY_VALUE(*src);
        ++dest;
        ++src;
    ...
    result = sidl_dcomplex__array_create1d(len);
  }
  return result;
}

/**
 * Create a dense two-dimensional array of dcomplexs with a lower
 * indices of (0,0) and an upper indices of (m-1,n-1). The array is
 * stored in column-major order, and it owns and manages its data.
 * This function does not initialize the contents of the array.
 */
struct sidl_dcomplex__array *
sidl_dcomplex__array_create2dCol(int32_t m, int32_t n)
{
  static const int32_t zero[2] = {0, 0};
  int32_t upper[2];
  upper[0] = m-1;
  upper[1] = n-1;
  return sidl_dcomplex__array_createCol(2, zero, upper);
}
 ...
 */
struct sidl_dcomplex__array *
sidl_dcomplex__array_create2dRow(int32_t m, int32_t n)
{
  static const int32_t zero[2] = {0, 0};
  int32_t upper[2];
  upper[0] = m-1;
  upper[1] = n-1;
  return sidl_dcomplex__array_createRow(2, zero, upper);
}
 ...
 */
static int
goodSliceArgs(struct sidl_dcomplex__array* src,
               int32_t       dimen,
...
sidl_dcomplex__array_slice(struct sidl_dcomplex__array *src,
                           ...
                           const int32_t *newStart)
{
  struct sidl_dcomplex__array *result = NULL;
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_metadata.d_vtable->d_smartcopy ==
        ...
        result->d_metadata.d_vtable = &bsliced_dcomplex_vtable;
      }
    }
  }
  return result;
 ...
 */
struct sidl_dcomplex__array *
sidl_dcomplex__array_borrow(struct sidl_dcomplex* firstElement,
                            int32_t        dimen,
                            const int32_t  lower[],
                            const int32_t  upper[],
                            const int32_t  stride[])
{
  ...
  result->d_metadata.d_vtable = &borrowed_dcomplex_vtable;
  return result;
}
 ...
 */
struct sidl_dcomplex__array *
sidl_dcomplex__array_smartCopy(struct sidl_dcomplex__array *array)
{
  return (struct sidl_dcomplex__array *)
 ...
 */
void
sidl_dcomplex__array_addRef(struct sidl_dcomplex__array* array)
{
 ...
 */
void
sidl_dcomplex__array_deleteRef(struct sidl_dcomplex__array* array)
{
  sidl__array_deleteRef((struct sidl__array*)array);
}

/**
 * Attempt to cast a generic array reference to an dcomplex
 * array. A non-NULL return value indicates that the cast was
 * successful, and the returned pointer is a valid dcomplex
 * array. A NULL return value indicates that the cast failed.
 * This function never alters the reference count of array.
 * 
 */
struct sidl_dcomplex__array*
sidl_dcomplex__array_cast(struct sidl__array* array)
{
  return (array &&
          (sidl_dcomplex_array == ((array->d_vtable->d_arraytype)())))
...
sidl_dcomplex__array_get1(const struct sidl_dcomplex__array* array,
                          const int32_t i1)
{
  ...
  return sidl_dcomplex__array_zero;
}
 ...
 */
struct sidl_dcomplex
sidl_dcomplex__array_get2(const struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2)
{
 ...
 */
struct sidl_dcomplex
sidl_dcomplex__array_get3(const struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3)
{
 ...
 */
struct sidl_dcomplex
sidl_dcomplex__array_get4(const struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const int32_t i4)
 ...
 */
struct sidl_dcomplex
sidl_dcomplex__array_get5(const struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const int32_t i4,
 ...
 */
struct sidl_dcomplex
sidl_dcomplex__array_get6(const struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const int32_t i4,
 ...
 */
struct sidl_dcomplex
sidl_dcomplex__array_get7(const struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const int32_t i4,
                          ...
                          const int32_t i7)
{
  if (array) {
    ...
    case 1: return sidl_dcomplex__array_get1(array, i1);
    case 2: return sidl_dcomplex__array_get2(array, i1, i2);
    case 3: return sidl_dcomplex__array_get3(array, i1, i2, i3);
    case 4: return sidl_dcomplex__array_get4(array, i1, i2, i3, i4);
    case 5: return sidl_dcomplex__array_get5(array, i1, i2, i3, i4, i5);
    case 6: return sidl_dcomplex__array_get6(array, i1, i2, i3, i4, i5, i6);
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
 ...
 */
struct sidl_dcomplex
sidl_dcomplex__array_get(const struct sidl_dcomplex__array* array,
                         const int32_t indices[])
{
  if (array) {
    struct sidl_dcomplex *result = array->d_firstElement;
    int32_t i = 0;
    HELPER_VARIABLE;
 ...
 */
void
sidl_dcomplex__array_set1(struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const struct sidl_dcomplex value)
{
  if (array && (1 == array->d_metadata.d_dimen) &&
      ((array->d_metadata.d_lower[0] <= i1) &&
       (array->d_metadata.d_upper[0] >= i1))) {
 ...
 */
void
sidl_dcomplex__array_set2(struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const struct sidl_dcomplex value)
{
 ...
 */
void
sidl_dcomplex__array_set3(struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const struct sidl_dcomplex value)
 ...
 */
void
sidl_dcomplex__array_set4(struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const int32_t i4,
 ...
 */
void
sidl_dcomplex__array_set5(struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const int32_t i4,
 ...
 */
void
sidl_dcomplex__array_set6(struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const int32_t i4,
 ...
 */
void
sidl_dcomplex__array_set7(struct sidl_dcomplex__array* array,
                          const int32_t i1,
                          const int32_t i2,
                          const int32_t i3,
                          const int32_t i4,
                          ...
                          const struct sidl_dcomplex value)
{
  if (array) {
    switch(array->d_metadata.d_dimen) {
    case 1: sidl_dcomplex__array_set1(array, i1, value); break;
    case 2: sidl_dcomplex__array_set2(array, i1, i2, value); break;
    case 3: sidl_dcomplex__array_set3(array, i1, i2, i3, value); break;
    case 4: sidl_dcomplex__array_set4(array, i1, i2, i3, i4, value); break;
    case 5: sidl_dcomplex__array_set5(array, i1, i2, i3, i4, i5, value); break;
    case 6: sidl_dcomplex__array_set6(array, i1, i2, i3, i4, i5, i6, value); break;
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
 ...
 */
void
sidl_dcomplex__array_set(struct sidl_dcomplex__array* array,
                         const int32_t indices[],
                         const struct sidl_dcomplex value)
{
  if (array) {
 ...
 */
int32_t
sidl_dcomplex__array_dimen(const struct sidl_dcomplex__array* array)
{
 ...
 */
int32_t
sidl_dcomplex__array_lower(const struct sidl_dcomplex__array* array,
                           const int32_t ind)
{
 ...
 */
int32_t
sidl_dcomplex__array_upper(const struct sidl_dcomplex__array* array,
                           const int32_t ind)
{
 ...
 */
int32_t
sidl_dcomplex__array_length(const struct sidl_dcomplex__array* array,
                            const int32_t ind)
{
 ...
 */
int32_t
sidl_dcomplex__array_stride(const struct sidl_dcomplex__array* array,
                            const int32_t ind)
{
 ...
 */
sidl_bool
sidl_dcomplex__array_isColumnOrder(const struct sidl_dcomplex__array* array)
{
 ...
 */
sidl_bool
sidl_dcomplex__array_isRowOrder(const struct sidl_dcomplex__array* array)
{
                                ...
                                struct sidl_dcomplex__array* dest)
{
  if (src && dest && (src != dest) &&
    ...
    HELPER_VARIABLE;
    if (overlap) {
      register struct sidl_dcomplex const * restrict srcFirst =
        src->d_firstElement;
      register struct sidl_dcomplex * restrict destFirst =
        dest->d_firstElement;
      register int32_t i;
                            ...
                            int                    ordering)
{
  ...
  if (src && (src->d_metadata.d_dimen == dimen)) {
    ...
    case sidl_column_major_order:
      if (sidl_dcomplex__array_isColumnOrder(src)) {
        sidl_dcomplex__array_addRef(src);
        result = src;
      }
      else {
        result = sidl_dcomplex__array_createCol
          (dimen, src->d_metadata.d_lower, src->d_metadata.d_upper);
        sidl_dcomplex__array_copy(src, result);
      }
      break;
    case sidl_row_major_order:
      if (sidl_dcomplex__array_isRowOrder(src)) {
        sidl_dcomplex__array_addRef(src);
        result = src;
      }
      else {
        result = sidl_dcomplex__array_createRow
          (dimen, src->d_metadata.d_lower, src->d_metadata.d_upper);
        sidl_dcomplex__array_copy(src, result);
      }
      break;
 ...
 */
struct sidl_dcomplex *
sidl_dcomplex__array_first(const struct sidl_dcomplex__array* array)
{
