 ...
 * Revision:      @(#) $Id: sidl_NotImplementedException_IOR.c,v 1.1 2006/08/29 23:31:42 painter Exp $
 ...
 */
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_NotImplementedException__object*,const char*,
...
static struct sidl_SIDLException__epv* 
  sidl_NotImplementedException__super(void) {
