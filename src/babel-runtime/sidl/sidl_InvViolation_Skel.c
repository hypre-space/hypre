 ...
 * Revision:      @(#) $Id: sidl_InvViolation_Skel.c,v 1.6 2007/09/27 19:35:43 painter Exp $
...
extern struct sidl_BaseClass__object* 
  impl_sidl_InvViolation_fcast_sidl_BaseClass(void* bi, sidl_BaseInterface* 
  _ex);
extern struct sidl_BaseException__object* 
  impl_sidl_InvViolation_fconnect_sidl_BaseException(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex);
extern struct sidl_BaseException__object* 
  impl_sidl_InvViolation_fcast_sidl_BaseException(void* bi, sidl_BaseInterface* 
  _ex);
extern struct sidl_BaseInterface__object* 
  impl_sidl_InvViolation_fconnect_sidl_BaseInterface(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex);
extern struct sidl_BaseInterface__object* 
  impl_sidl_InvViolation_fcast_sidl_BaseInterface(void* bi, sidl_BaseInterface* 
  _ex);
extern struct sidl_ClassInfo__object* 
  impl_sidl_InvViolation_fconnect_sidl_ClassInfo(const char* url, sidl_bool ar, 
  sidl_BaseInterface *_ex);
extern struct sidl_ClassInfo__object* 
  impl_sidl_InvViolation_fcast_sidl_ClassInfo(void* bi, sidl_BaseInterface* 
  _ex);
extern struct sidl_InvViolation__object* 
  impl_sidl_InvViolation_fconnect_sidl_InvViolation(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex);
extern struct sidl_InvViolation__object* 
  impl_sidl_InvViolation_fcast_sidl_InvViolation(void* bi, sidl_BaseInterface* 
  _ex);
...
extern struct sidl_SIDLException__object* 
  impl_sidl_InvViolation_fconnect_sidl_SIDLException(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex);
extern struct sidl_SIDLException__object* 
  impl_sidl_InvViolation_fcast_sidl_SIDLException(void* bi, sidl_BaseInterface* 
  _ex);
...
extern struct sidl_io_Serializer__object* 
  ...
  ar, sidl_BaseInterface *_ex);
extern struct sidl_io_Serializer__object* 
  impl_sidl_InvViolation_fcast_sidl_io_Serializer(void* bi, sidl_BaseInterface* 
  _ex);
extern struct sidl_BaseClass__object* 
  impl_sidl_InvViolation_fconnect_sidl_BaseClass(const char* url, sidl_bool ar, 
  sidl_BaseInterface *_ex);
...
struct sidl_BaseClass__object* skel_sidl_InvViolation_fconnect_sidl_BaseClass(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fconnect_sidl_BaseClass(url, ar, _ex);
}

struct sidl_BaseClass__object* skel_sidl_InvViolation_fcast_sidl_BaseClass(
  void* bi, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fcast_sidl_BaseClass(bi, _ex);
}

struct sidl_BaseException__object* 
  skel_sidl_InvViolation_fconnect_sidl_BaseException(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fconnect_sidl_BaseException(url, ar, _ex);
}

struct sidl_BaseException__object* 
  skel_sidl_InvViolation_fcast_sidl_BaseException(void* bi, sidl_BaseInterface 
  *_ex) { 
  return impl_sidl_InvViolation_fcast_sidl_BaseException(bi, _ex);
}

struct sidl_BaseInterface__object* 
  skel_sidl_InvViolation_fconnect_sidl_BaseInterface(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fconnect_sidl_BaseInterface(url, ar, _ex);
}

struct sidl_BaseInterface__object* 
  skel_sidl_InvViolation_fcast_sidl_BaseInterface(void* bi, sidl_BaseInterface 
  *_ex) { 
  return impl_sidl_InvViolation_fcast_sidl_BaseInterface(bi, _ex);
}

struct sidl_ClassInfo__object* skel_sidl_InvViolation_fconnect_sidl_ClassInfo(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fconnect_sidl_ClassInfo(url, ar, _ex);
}

struct sidl_ClassInfo__object* skel_sidl_InvViolation_fcast_sidl_ClassInfo(
  void* bi, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fcast_sidl_ClassInfo(bi, _ex);
}

struct sidl_InvViolation__object* 
  skel_sidl_InvViolation_fconnect_sidl_InvViolation(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fconnect_sidl_InvViolation(url, ar, _ex);
}

struct sidl_InvViolation__object* 
  skel_sidl_InvViolation_fcast_sidl_InvViolation(void* bi, sidl_BaseInterface 
  *_ex) { 
...
struct sidl_SIDLException__object* 
  skel_sidl_InvViolation_fconnect_sidl_SIDLException(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fconnect_sidl_SIDLException(url, ar, _ex);
}

struct sidl_SIDLException__object* 
  skel_sidl_InvViolation_fcast_sidl_SIDLException(void* bi, sidl_BaseInterface 
  *_ex) { 
...
struct sidl_io_Serializer__object* 
  skel_sidl_InvViolation_fconnect_sidl_io_Serializer(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_InvViolation_fconnect_sidl_io_Serializer(url, ar, _ex);
}

struct sidl_io_Serializer__object* 
  skel_sidl_InvViolation_fcast_sidl_io_Serializer(void* bi, sidl_BaseInterface 
  *_ex) { 
