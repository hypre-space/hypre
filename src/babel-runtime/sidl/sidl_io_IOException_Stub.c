 ...
 * Revision:      @(#) $Id: sidl_io_IOException_Stub.c,v 1.6 2007/09/27 19:35:45 painter Exp $
...
static sidl_io_IOException sidl_io_IOException__remoteCreate(const char* url, 
...
{
  return sidl_io_IOException__remoteCreate(url, _ex);
}
...
{
  return sidl_io_IOException__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.io.IOException", (
      void*)sidl_io_IOException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
SIDL_C_INLINE_DEFN
void
sidl_io_IOException__set_hooks(
  /* in */ sidl_io_IOException self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
sidl_io_IOException__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_io_IOException__isRemote(self,_ex);
}
...
sidl_io_IOException__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct sidl_io_IOException__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
sidl_io_IOException__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct sidl_io_IOException__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct sidl_io_IOException__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct sidl_io_IOException__array*)sidl_interface__array_create1dInit(
...
{
  return (struct sidl_io_IOException__array*)sidl_interface__array_create2dCol(
    m, n);
}
...
{
  return (struct sidl_io_IOException__array*)sidl_interface__array_create2dRow(
    m, n);
}
