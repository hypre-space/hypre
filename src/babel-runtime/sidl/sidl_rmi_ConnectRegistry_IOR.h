 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectRegistry_IOR.h,v 1.6 2007/09/27 19:35:46 painter Exp $
...
struct sidl_rmi_ConnectRegistry__sepv {
  ...
  /* Methods introduced in sidl.rmi.ConnectRegistry-v0.9.15 */
...
struct sidl_rmi_ConnectRegistry__controls {
  int     use_hooks;
};
/*
...
sidl_rmi_ConnectRegistry__new(void* ddata,struct sidl_BaseInterface__object ** 
  _ex);
...
extern void sidl_rmi_ConnectRegistry__init(
  struct sidl_rmi_ConnectRegistry__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidl_rmi_ConnectRegistry__getEPVs(
  ...
  extern void sidl_rmi_ConnectRegistry__fini(
    struct sidl_rmi_ConnectRegistry__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void sidl_rmi_ConnectRegistry__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct sidl_BaseClass__object* 
    skel_sidl_rmi_ConnectRegistry_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidl_rmi_ConnectRegistry_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidl_rmi_ConnectRegistry_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_RuntimeException__object* 
    skel_sidl_rmi_ConnectRegistry_fconnect_sidl_RuntimeException(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_sidl_rmi_ConnectRegistry_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_rmi_ConnectRegistry__remote{
    int d_refcount;
