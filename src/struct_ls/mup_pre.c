...
HYPRE_StructBiCGSTABGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructBiCGSTABGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructBiCGSTABGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructBiCGSTABGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructBiCGSTABSetAbsoluteTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructBiCGSTABSetAbsoluteTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructBiCGSTABSetAbsoluteTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructBiCGSTABSetAbsoluteTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructBiCGSTABSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructBiCGSTABSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructBiCGSTABSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructBiCGSTABSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructFlexGMRESGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructFlexGMRESGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructFlexGMRESGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructFlexGMRESGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructFlexGMRESSetAbsoluteTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructFlexGMRESSetAbsoluteTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructFlexGMRESSetAbsoluteTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructFlexGMRESSetAbsoluteTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructFlexGMRESSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructFlexGMRESSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructFlexGMRESSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructFlexGMRESSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructGMRESGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructGMRESGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructGMRESGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructGMRESGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructGMRESSetAbsoluteTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructGMRESSetAbsoluteTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructGMRESSetAbsoluteTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructGMRESSetAbsoluteTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructGMRESSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructGMRESSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructGMRESSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructGMRESSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructHybridGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructHybridGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructHybridGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructHybridGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructHybridSetConvergenceTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double cf_tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructHybridSetConvergenceTol_flt( solver, (hypre_float)cf_tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructHybridSetConvergenceTol_dbl( solver, (hypre_double)cf_tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructHybridSetConvergenceTol_long_dbl( solver, (hypre_long_double)cf_tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructHybridSetPCGAbsoluteTolFactor_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double pcg_atolf )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructHybridSetPCGAbsoluteTolFactor_flt( solver, (hypre_float)pcg_atolf );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructHybridSetPCGAbsoluteTolFactor_dbl( solver, (hypre_double)pcg_atolf );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructHybridSetPCGAbsoluteTolFactor_long_dbl( solver, (hypre_long_double)pcg_atolf );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructHybridSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructHybridSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructHybridSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructHybridSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructJacobiGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructJacobiGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructJacobiGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructJacobiGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructJacobiGetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructJacobiGetTol_flt( solver, (hypre_float *)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructJacobiGetTol_dbl( solver, (hypre_double *)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructJacobiGetTol_long_dbl( solver, (hypre_long_double *)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructJacobiSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructJacobiSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructJacobiSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructJacobiSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructLGMRESGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructLGMRESGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructLGMRESGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructLGMRESGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructLGMRESSetAbsoluteTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructLGMRESSetAbsoluteTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructLGMRESSetAbsoluteTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructLGMRESSetAbsoluteTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructLGMRESSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructLGMRESSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructLGMRESSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructLGMRESSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecCreate_pre( HYPRE_Precision precision, MPI_Comm comm, HYPRE_StructSolver *solver_ptr )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecCreate_flt( comm, solver_ptr );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecCreate_dbl( comm, solver_ptr );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecCreate_long_dbl( comm, solver_ptr );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecDestroy_pre( HYPRE_Precision precision, HYPRE_StructSolver solver )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecDestroy_flt( solver );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecDestroy_dbl( solver );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecDestroy_long_dbl( solver );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecGetLogging_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_Int *logging )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecGetLogging_flt( solver, logging );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecGetLogging_dbl( solver, logging );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecGetLogging_long_dbl( solver, logging );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecGetMaxIter_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_Int *max_iter )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecGetMaxIter_flt( solver, max_iter );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecGetMaxIter_dbl( solver, max_iter );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecGetMaxIter_long_dbl( solver, max_iter );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecGetNumIterations_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_Int *num_iterations )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecGetNumIterations_flt( solver, num_iterations );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecGetNumIterations_dbl( solver, num_iterations );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecGetNumIterations_long_dbl( solver, num_iterations );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecGetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecGetTol_flt( solver, (hypre_float *)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecGetTol_dbl( solver, (hypre_double *)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecGetTol_long_dbl( solver, (hypre_long_double *)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecGetZeroGuess_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_Int *zero_guess )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecGetZeroGuess_flt( solver, zero_guess );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecGetZeroGuess_dbl( solver, zero_guess );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecGetZeroGuess_long_dbl( solver, zero_guess );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSetChebyshev_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_Int steps )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSetChebyshev_flt( solver, steps );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSetChebyshev_dbl( solver, steps );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSetChebyshev_long_dbl( solver, steps );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSetJacobi_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_Int steps, hypre_long_double weight )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSetJacobi_flt( solver, steps, (hypre_float)weight );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSetJacobi_dbl( solver, steps, (hypre_double)weight );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSetJacobi_long_dbl( solver, steps, (hypre_long_double)weight );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSetLogging_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_Int logging )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSetLogging_flt( solver, logging );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSetLogging_dbl( solver, logging );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSetLogging_long_dbl( solver, logging );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSetMaxIter_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_Int max_iter )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSetMaxIter_flt( solver, max_iter );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSetMaxIter_dbl( solver, max_iter );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSetMaxIter_long_dbl( solver, max_iter );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSetNonZeroGuess_pre( HYPRE_Precision precision, HYPRE_StructSolver solver )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSetNonZeroGuess_flt( solver );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSetNonZeroGuess_dbl( solver );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSetNonZeroGuess_long_dbl( solver );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSetZeroGuess_pre( HYPRE_Precision precision, HYPRE_StructSolver solver )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSetZeroGuess_flt( solver );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSetZeroGuess_dbl( solver );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSetZeroGuess_long_dbl( solver );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSetup_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_StructMatrix A, HYPRE_StructVector b, HYPRE_StructVector x )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSetup_flt( solver, A, b, x );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSetup_dbl( solver, A, b, x );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSetup_long_dbl( solver, A, b, x );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructMatPrecSolve_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, HYPRE_StructMatrix A, HYPRE_StructVector b, HYPRE_StructVector x )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructMatPrecSolve_flt( solver, A, b, x );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructMatPrecSolve_dbl( solver, A, b, x );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructMatPrecSolve_long_dbl( solver, A, b, x );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPCGGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPCGGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPCGGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPCGGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPCGSetAbsoluteTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPCGSetAbsoluteTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPCGSetAbsoluteTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPCGSetAbsoluteTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPCGSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPCGSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPCGSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPCGSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPFMGGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPFMGGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPFMGGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPFMGGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPFMGGetJacobiWeight_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *weight )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPFMGGetJacobiWeight_flt( solver, (hypre_float *)weight );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPFMGGetJacobiWeight_dbl( solver, (hypre_double *)weight );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPFMGGetJacobiWeight_long_dbl( solver, (hypre_long_double *)weight );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPFMGGetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPFMGGetTol_flt( solver, (hypre_float *)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPFMGGetTol_dbl( solver, (hypre_double *)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPFMGGetTol_long_dbl( solver, (hypre_long_double *)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPFMGSetDxyz_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *dxyz )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPFMGSetDxyz_flt( solver, (hypre_float *)dxyz );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPFMGSetDxyz_dbl( solver, (hypre_double *)dxyz );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPFMGSetDxyz_long_dbl( solver, (hypre_long_double *)dxyz );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPFMGSetJacobiWeight_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double weight )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPFMGSetJacobiWeight_flt( solver, (hypre_float)weight );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPFMGSetJacobiWeight_dbl( solver, (hypre_double)weight );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPFMGSetJacobiWeight_long_dbl( solver, (hypre_long_double)weight );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructPFMGSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructPFMGSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructPFMGSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructPFMGSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructSMGGetFinalRelativeResidualNorm_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *norm )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructSMGGetFinalRelativeResidualNorm_flt( solver, (hypre_float *)norm );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructSMGGetFinalRelativeResidualNorm_dbl( solver, (hypre_double *)norm );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructSMGGetFinalRelativeResidualNorm_long_dbl( solver, (hypre_long_double *)norm );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructSMGGetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, void *tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructSMGGetTol_flt( solver, (hypre_float *)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructSMGGetTol_dbl( solver, (hypre_double *)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructSMGGetTol_long_dbl( solver, (hypre_long_double *)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
...
HYPRE_StructSMGSetTol_pre( HYPRE_Precision precision, HYPRE_StructSolver solver, hypre_long_double tol )
{
   ...
   {
      case HYPRE_REAL_SINGLE:
         return HYPRE_StructSMGSetTol_flt( solver, (hypre_float)tol );
      case HYPRE_REAL_DOUBLE:
         return HYPRE_StructSMGSetTol_dbl( solver, (hypre_double)tol );
      case HYPRE_REAL_LONGDOUBLE:
         return HYPRE_StructSMGSetTol_long_dbl( solver, (hypre_long_double)tol );
      default:
         { HYPRE_Int value = 0; hypre_error_w_msg(HYPRE_ERROR_GENERIC, "Unknown solver precision"); return value; }
   }
}
