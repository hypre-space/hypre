...
hypre_StructMatrix *
hypre_BAMG3CreateRAPOp( hypre_StructMatrix *R,
 ...
 *
 * I've written a two routines - hypre_BAMG3BuildRAPSym to build the lower
 * triangular part of RAP (including the diagonal) and
 * hypre_BAMG3BuildRAPNoSym to build the upper triangular part of RAP
...
HYPRE_Int
hypre_BAMG3BuildRAPSym( hypre_StructMatrix *A,
                        hypre_StructMatrix *P,
   ...
   hypre_ForBoxI(ci, cgrid_boxes)
   {
      ...
      switch (fine_stencil_size)
      {
         ...
         case 7:
            ...
            if ( constant_coefficient==1 )
            {
               hypre_BAMG3BuildRAPSym_onebox_FSS07_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }

            else
            {
               hypre_BAMG3BuildRAPSym_onebox_FSS07_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            break;
         ...
         case 19:
            ...
            if ( constant_coefficient==1 )
            {
               hypre_BAMG3BuildRAPSym_onebox_FSS19_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            else
            {
               hypre_BAMG3BuildRAPSym_onebox_FSS19_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            break;
         ...
         default:
            ...
            if ( constant_coefficient==1 )
            {
               hypre_BAMG3BuildRAPSym_onebox_FSS27_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            else
            {
               hypre_BAMG3BuildRAPSym_onebox_FSS27_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            break;
...
/* core part of hypre_BAMG3BuildRAPSym, for one box, one value of fine_stencil_size
...
HYPRE_Int
hypre_BAMG3BuildRAPNoSym( hypre_StructMatrix *A,
                          hypre_StructMatrix *P,
                          hypre_StructMatrix *R,
                          HYPRE_Int           cdir,
                          hypre_Index         cindex,
   ...
   hypre_ForBoxI(ci, cgrid_boxes)
   {
      ...
      switch (fine_stencil_size)
      {
         ...
         case 7:
            ...
            if ( constant_coefficient == 1 )
            {
               hypre_BAMG3BuildRAPNoSym_onebox_FSS07_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            else
            {
               hypre_BAMG3BuildRAPNoSym_onebox_FSS07_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
         ...
         case 19:
            ...
            if ( constant_coefficient == 1 )
            {
               hypre_BAMG3BuildRAPNoSym_onebox_FSS19_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            else
            {
               hypre_BAMG3BuildRAPNoSym_onebox_FSS19_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
         ...
         default:
            ...
            if ( constant_coefficient == 1 )
            {
               hypre_BAMG3BuildRAPNoSym_onebox_FSS27_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            else
            {
               hypre_BAMG3BuildRAPNoSym_onebox_FSS27_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
...
/* core part of hypre_BAMG3BuildRAPNoSym, for one box, one value of fine_stencil_size
