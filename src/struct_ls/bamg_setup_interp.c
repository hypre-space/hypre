 ...
 *--------------------------------------------------------------------------*/
  ...
  hypre_StructMatrix *
hypre_BAMGCreateInterpOp( hypre_StructMatrix *A,
 ...
 *--------------------------------------------------------------------------*/
  ...
  HYPRE_Int
hypre_BAMGSetupInterpOp( hypre_StructMatrix *A,
    HYPRE_Int           cdir,
    hypre_Index         findex,
    hypre_Index         stride,
    hypre_StructMatrix *P )
