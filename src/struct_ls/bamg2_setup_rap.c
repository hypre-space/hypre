...
hypre_StructMatrix *
hypre_BAMG2CreateRAPOp( hypre_StructMatrix *R,
 ...
 *
 * I've written two routines - hypre_BAMG2BuildRAPSym to build the
 * lower triangular part of RAP (including the diagonal) and
 * hypre_BAMG2BuildRAPNoSym to build the upper triangular part of RAP
...
HYPRE_Int
hypre_BAMG2BuildRAPSym( hypre_StructMatrix *A,
                        hypre_StructMatrix *P,
   ...
   hypre_ForBoxI(ci, cgrid_boxes)
   {
      ...
      switch (fine_stencil_size)
      {
         ...
         case 5:
            ...
            if ( constant_coefficient==1 )
            {
               hypre_BAMG2BuildRAPSym_onebox_FSS5_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
            else
            {
               hypre_BAMG2BuildRAPSym_onebox_FSS5_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
         ...
         default:
            ...
            if ( constant_coefficient==1 )
            {
               hypre_BAMG2BuildRAPSym_onebox_FSS9_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }

            else
            {
               hypre_BAMG2BuildRAPSym_onebox_FSS9_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
...
HYPRE_Int
hypre_BAMG2BuildRAPNoSym( hypre_StructMatrix *A,
                          hypre_StructMatrix *P,
                          hypre_StructMatrix *R,
                          HYPRE_Int           cdir,
                          hypre_Index         cindex,
   ...
   hypre_ForBoxI(ci, cgrid_boxes)
   {
      ...
      switch (fine_stencil_size)
      {
         ...
         case 5:
            ...
            if ( constant_coefficient==1 )
            {
               hypre_BAMG2BuildRAPNoSym_onebox_FSS5_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }

            else
            {
               hypre_BAMG2BuildRAPNoSym_onebox_FSS5_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
         ...
         default:
            ...
            if ( constant_coefficient==1 )
            {
               hypre_BAMG2BuildRAPNoSym_onebox_FSS9_CC1(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }

            else
            {
               hypre_BAMG2BuildRAPNoSym_onebox_FSS9_CC0(
                  ci, fi, A, P, R, cdir, cindex, cstride, RAP );
            }
