...
#define hypre_dasum   hypre_F90_NAME_BLAS(sasum ,DASUM )
#define hypre_daxpy   hypre_F90_NAME_BLAS(saxpy ,DAXPY )
#define hypre_dcopy   hypre_F90_NAME_BLAS(scopy ,DCOPY )
#define hypre_ddot    hypre_F90_NAME_BLAS(sdot  ,DDOT  )
#define hypre_dgemm   hypre_F90_NAME_BLAS(sgemm ,DGEMM )
#define hypre_dgemv   hypre_F90_NAME_BLAS(sgemv ,DGEMV )
#define hypre_dger    hypre_F90_NAME_BLAS(sger  ,DGER  )
#define hypre_dnrm2   hypre_F90_NAME_BLAS(snrm2 ,DNRM2 )
#define hypre_drot    hypre_F90_NAME_BLAS(srot  ,DROT  )
#define hypre_dscal   hypre_F90_NAME_BLAS(sscal ,DSCAL )
#define hypre_dswap   hypre_F90_NAME_BLAS(sswap ,DSWAP )
#define hypre_dsymm   hypre_F90_NAME_BLAS(ssymm ,DSYMM )
#define hypre_dsymv   hypre_F90_NAME_BLAS(ssymv ,DSYMV )
#define hypre_dsyr2   hypre_F90_NAME_BLAS(ssyr2 ,DSYR2 )
#define hypre_dsyr2k  hypre_F90_NAME_BLAS(ssyr2k,DSYR2K)
#define hypre_dsyrk   hypre_F90_NAME_BLAS(ssyrk ,DSYRK )
#define hypre_dtrmm   hypre_F90_NAME_BLAS(strmm ,DTRMM )
#define hypre_dtrmv   hypre_F90_NAME_BLAS(strmv ,DTRMV )
#define hypre_dtrsm   hypre_F90_NAME_BLAS(strsm ,DTRSM )
#define hypre_dtrsv   hypre_F90_NAME_BLAS(strsv ,DTRSV )
#define hypre_idamax  hypre_F90_NAME_BLAS(isamax,IDAMAX)
#else
