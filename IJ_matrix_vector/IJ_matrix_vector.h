...
int HYPRE_SetIJVectorLocalComponentsInBlock P((HYPRE_IJVector IJvector , int glob_vec_index_start , int glob_vec_index_stop , int *value_indices , double *values ));
...
int hypre_SetIJVectorParLocalComponents P((hypre_IJVector *vector , int num_values , int *glob_vec_indices , int *value_indices , double *values ));
int hypre_SetIJVectorParLocalComponentsInBlock P((hypre_IJVector *vector , int glob_vec_index_start , int glob_vec_index_stop , int *value_indices , double *values ));
