...
int hypre_SetStructInterfaceMatrixBoxValues P((hypre_StructInterfaceMatrix *matrix , hypre_Index *lower_grid_index , int *upper_grid_index, int num_stencil_indices, int *stencil_indices, double *coeffs ));
int hypre_AssembleStructInterfaceMatrix P((hypre_StructInterfaceMatrix *matrix ));
int hypre_PrintStructInterfaceMatrix P((hypre_StructInterfaceMatrix *matrix ));
...
int hypre_SetStructInterfaceVectorBoxValues P((hypre_StructInterfaceVector *vector , hypre_Index *lower_grid_index , int *upper_grid_index, double *coeffs ));
int hypre_SetStructInterfaceVector P((hypre_StructInterfaceVector *vector , double *val ));
int hypre_AssembleStructInterfaceVector P((hypre_StructInterfaceVector *vector ));
