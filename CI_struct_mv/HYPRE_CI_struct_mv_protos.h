...
int HYPRE_SetStructInterfaceMatrixBoxValues P((HYPRE_StructInterfaceMatrix matrix , int *lower_grid_index , 
    int *upper_grid_index , int num_indices, int *stencil_indices, double *coeffs ));
