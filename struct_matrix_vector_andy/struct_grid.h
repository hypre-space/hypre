...
#ifndef hypre_GRID_HEADER
#define hypre_GRID_HEADER
...
#define hypre_StructGridProcess(grid, i)    (hypre_StructGridProcesses(grid)[i])
...
#define hypre_StructGridBoxRank(grid, i)    (hypre_StructGridBoxRanks(grid)[i])
