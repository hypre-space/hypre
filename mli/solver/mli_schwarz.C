...
MLI_SolverSchwarz::MLI_SolverSchwarz()
{
   Amat           = NULL;
   nblocks        = 0;
   block_lengths  = NULL;
...
int MLI_SolverSchwarz::setup(MLI_Matrix *Amat_in)
{
...
int MLI_SolverSchwarz::solve(MLI_Vector *f_in, MLI_Vector *u_in)
{
   hypre_ParCSRMatrix   *A;
...
int MLI_SolverSchwarz::composedOverlappedMatrix(void *A_in,
