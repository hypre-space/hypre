...
MLI_SolverParaSails::MLI_SolverParaSails()
{
#ifdef PARASAILS
   Amat       = NULL;
   ps         = NULL;
...
int MLI_SolverParaSails::setup(MLI_Matrix *Amat_in)
{
#ifdef PARASAILS
...
int MLI_SolverParaSails::solve(MLI_Vector *f_in, MLI_Vector *u_in)
{
#ifdef PARASAILS
...
int MLI_SolverParaSails::applyParaSails(MLI_Vector *f_in, MLI_Vector *u_in)
{
#ifdef PARASAILS
   hypre_ParCSRMatrix *A;
...
int MLI_SolverParaSails::applyParaSailsTrans(MLI_Vector *f_in, 
                                               MLI_Vector *u_in)
{
#ifdef PARASAILS
   hypre_ParCSRMatrix *A;
...
int MLI_SolverParaSails::setNumLevels( int levels )
{
   if ( levels < 0 )
   {
      cerr << "MLI_SolverParaSails::setNumLevels WARNING : nlevels = 0." << endl;
      nlevels = 0;
   }
   else nlevels = levels;
   return 0;
...
int MLI_SolverParaSails::setSymmetric()
{
   symmetric = 1;
   return 0;
}
...
int MLI_SolverParaSails::setUnSymmetric()
{
   symmetric = 0;
   return 0;
}
...
int MLI_SolverParaSails::setThreshold( double thresh )
{
   if ( thresh < 0 || thresh > 1. )
   {
      cerr << "MLI_SolverParaSails::setThreshold WARNING : thresh = 0." << endl;
      threshold = 0.;
   }
...
int MLI_SolverParaSails::setFilter( double data )
{
   if ( data < 0 || data > 1. )
   {
      cerr << "MLI_SolverParaSails::setThreshold WARNING : filter = 0." << endl;
      filter = 0.;
   }
   else filter = data;
   return 0;
...
int MLI_SolverParaSails::setLoadBal()
{
   loadbal = 1;
   return 0;
}
...
int MLI_SolverParaSails::setFactorized()
{
   factorized = 1;
   return 0;
}
...
int MLI_SolverParaSails::setTranspose()
{
   transpose = 1;
   return 0;
}
