...
MLI_SolverSuperLU::MLI_SolverSuperLU()
{
   perm_r     = NULL;
   perm_c     = NULL;
   mli_Amat   = NULL;
...
int MLI_SolverSuperLU::setup( MLI_Matrix *Amat )
{
   ...
   {
      cout << "MLI_SolverSuperLU setup ERROR : not HYPRE_ParCSR." << endl;
      exit(1);
   }
...
int MLI_SolverSuperLU::solve( MLI_Vector *f_in, MLI_Vector *u_in )
{
   ...
   if ( ! factorized )
   {
      cout << "SolverSuperLU Solve ERROR : not factorized yet." << endl;
      exit(1);
   }
