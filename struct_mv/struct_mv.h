...
int hypre_CommPkgCreate( hypre_CommInfo *comm_info , hypre_BoxArray *send_data_space , hypre_BoxArray *recv_data_space , int num_values , int diag_rank , MPI_Comm comm , hypre_CommPkg **comm_pkg_ptr );
