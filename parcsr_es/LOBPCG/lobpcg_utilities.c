...
* 
* Revision 1.10 by Merico Argentati February 28, 2004 to prevent extra information 
* from being printed to stderr and stdout in HYPRE_Load_IJAMatrix and 
* HYPRE_Load_IJAMatrix2. 
...
{ 
   ...
   /* Modified by Merico Argentati February 28, 2004 */ 
