...
/* 
//  declarations for iterateToSolve() call
*/
    int solveStatus;
/* 
...
*/
	...
	mySysNum = 0;
	FEI_create(mySysNum+1, MPI_COMM_WORLD, 0);
...
*/
    ...
    myErrorCode = FEI_initSolveStep(mySysNum, 
                                myNumElemBlocks, 
                                mySolvType); 
    if (myErrorCode) printf("error in FEI_initSolveStep\n");

/* 
//  FE interface call ----------------------------------------------
*/
    myErrorCode = FEI_initFields(mySysNum, 
                             myNumFields, 
                             myCardFields,
                             myFieldIDs); 
    if (myErrorCode) printf("error in FEI_initFields\n");
...
*/
    ...
    myErrorCode = FEI_beginInitElemBlock(mySysNum, 
                                     myElemBlockID, 
                                     myNumNodesPerElem,
                                     myNumElemFields,
                                     myElemFieldIDs,
                                     ...
                                     myNumElemSets,
                                     myNumElemTotal);
    if (myErrorCode) printf("error in FEI_beginInitElemBlock\n");
...
*/
    ...
    myErrorCode = FEI_initElemSet(mySysNum, myNumElems, myElemIDs, 
                                           myElemConn);
    if (myErrorCode) printf("error in FEI_initElemSet\n");
...
*/
    ...
    myErrorCode = FEI_endInitElemBlock(mySysNum);
    if (myErrorCode) printf("error in FEI_endInitElemBlock\n");
...
*/
    ...
    myErrorCode = FEI_beginInitNodeSets(mySysNum, 
                                    myNumSharedNodeSets,
                                    myNumExtNodeSets);
    if (myErrorCode) printf("error in FEI_beginInitNodeSets\n");
...
*/
		...
		myErrorCode = FEI_initSharedNodeSet(mySysNum, mySharedNodes,
                                	             myLenSharedNodeSet,
                                	             mySharedProcIDs,
                                	             myLenSharedProcIDs);
		if (myErrorCode) printf("error in FEI_initSharedNodeSet\n");
...
*/
    ...
    myErrorCode = FEI_endInitNodeSets(mySysNum);
    if (myErrorCode) printf("error in FEI_endInitNodeSets\n");
...
*/
    ...
    myErrorCode = FEI_beginInitCREqns(mySysNum,
                                      myNumCRMultSets, myNumCRPenSets); 
    if (myErrorCode) printf("error in FEI_beginInitCREqns\n");
...
*/
    ...
    myErrorCode = FEI_endInitCREqns(mySysNum);
    if (myErrorCode) printf("error in FEI_endInitCREqns\n");
...
*/
	...
	printf("processor %d ready to call FEI_initComplete\n", localRank); 
    MPI_Barrier(MPI_COMM_WORLD);
...
*/
    ...
    myErrorCode = FEI_initComplete(mySysNum);
    if (myErrorCode) printf("error in FEI_initComplete\n");
    

    printf("processor %d back from FEI_initComplete\n", localRank);
    MPI_Barrier(MPI_COMM_WORLD);
...
*/
    ...
    myErrorCode = FEI_beginLoadNodeSets(mySysNum, myNumBCNodeSets);
    if (myErrorCode) printf("error in FEI_beginLoadNodeSets\n");
...
*/
    ...
    if (localRank == masterRank) {
        myErrorCode = FEI_loadBCSet(mySysNum, 
                                myBCNodeSet, 
                                myLenBCNodeSet,
                                myBCFieldID,
                                myAlphaTable, 
                                myBetaTable, 
                                myGammaTable);
        if (myErrorCode) printf("error in FEI_loadBCSet\n");
    }
...
*/
    ...
    myErrorCode = FEI_endLoadNodeSets(mySysNum);
    if (myErrorCode) printf("error in FEI_endLoadNodeSets\n");
...
*/
    ...
    myErrorCode = FEI_beginLoadElemBlock(mySysNum, 
                                     myElemBlockID,
                                     myNumElemSets,
                                     myNumElemTotal);
    if (myErrorCode) printf("error in FEI_beginLoadElemBlock\n");
...
*/
    ...
    myErrorCode = FEI_loadElemSet(mySysNum, 
                              myElemSetID, 
                              myNumElems, 
                              myElemIDs, 
                              myElemConn,
                              ...
                              myElemLoads, 
                              myElemFormat);
    if (myErrorCode) printf("error in FEI_loadElementData\n");
...
*/
    ...
    myErrorCode = FEI_endLoadElemBlock(mySysNum);
    if (myErrorCode) printf("error in FEI_endLoadElemBlock\n");
...
*/
    ...
    myErrorCode = FEI_beginLoadCREqns(mySysNum, myNumCRMultSets, myNumCRPenSets);
...
*/
    ...
    myErrorCode = FEI_endLoadCREqns(mySysNum);
    if (myErrorCode) printf("error in FEI_endLoadCREqns\n");
...
*/
    ...
    myErrorCode = FEI_loadComplete(mySysNum);
    if (myErrorCode) printf("error in FEI_loadComplete\n");

    MPI_Barrier(MPI_COMM_WORLD);
    printf("processor %d finished FEI_loadComplete\n", localRank);
    MPI_Barrier(MPI_COMM_WORLD);
...
*/
    ...
    FEI_parameters(mySysNum, numParams, paramStrings);
...
*/
    ...
    FEI_iterateToSolve(mySysNum, solveStatus);

    MPI_Barrier(MPI_COMM_WORLD);
    printf("processor %d finished FEI_iterateToSolve\n", localRank);
    MPI_Barrier(MPI_COMM_WORLD);
...
*/
    ...
    myNumBlkActNodes = FEI_getNumBlockActNodes(mySysNum, j);
    myNumBlkActEqns = FEI_getNumBlockActEqns(mySysNum, j);
...
//  FE interface call ----------------------------------------------
*/
    FEI_getBlockNodeSolution(mySysNum, j, myNodeList, &myLenList,
