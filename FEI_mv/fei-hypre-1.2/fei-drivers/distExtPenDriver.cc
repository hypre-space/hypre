...
//  FE interface call ----------------------------------------------
                ...
                myErrorCode = fei->initCRPen(myCRNodeTable,
                                                     myCRPenFieldIDList, 
                                                     myNumCRs, 
                                                     myLenCRList,
                                                     myCRPenIDList[countCR]);
                if (myErrorCode) cout << "error in fei->initCRPen" << endl;
...
//  FE interface call ----------------------------------------------
                ...
                myErrorCode = fei->loadCRPen(myCRPenIDList[j],
                                                     myNumCRs, 
                                                     myCRNodeTable, 
                                                     myCRPenFieldIDList, 
                                                     myCRWeightTable, 
                                                     ...
                                                     myPenValues,
                                                     myLenCRList);
                if (myErrorCode) cout << "error in fei->loadCRPen" 
                                      << endl;
