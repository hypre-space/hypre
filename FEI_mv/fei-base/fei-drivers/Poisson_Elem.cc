...
//
    ...
    int elemsPerSide = (int)ceil(totalLength_/elemLength_);
...
//==============================================================================
void Poisson_Elem::messageAbort(char* str) {
    cerr << "Poisson_Elem: ERROR: " << str << " Aborting." << endl;
    abort();
}
...
void Poisson_Elem::dumpToScreen() {
    ...
    cout << endl;
    cout << " the " << numElemRows_ << " load vector terms: ";
