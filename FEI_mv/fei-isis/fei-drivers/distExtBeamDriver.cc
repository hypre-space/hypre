...
//  declare the FEInterface Object first 
    ...
    linearSystem.parameters(1, &param1);
    delete [] param1;
...
//  FE interface call ----------------------------------------------
                ...
                myErrorCode = linearSystem.initCRMult(myCRNodeTable,
                                                      myCRMultFieldIDList, 
                                                      myNumCRs, 
                                                      myLenCRList,
                                                      myCRMultIDList[countCR]);
                if (myErrorCode) cout << "error in linearSystem.initCRMult" << endl;
...
//  FE interface call ----------------------------------------------
                ...
                myErrorCode = linearSystem.loadCRMult(myCRMultIDList[countCR],
                                                      myNumCRs, 
                                                      myCRNodeTable, 
                                                      myCRMultFieldIDList, 
                                                      myCRWeightTable, 
                                                      myCRValueList,
                                                      myLenCRList);
                if (myErrorCode) cout << "error in linearSystem.loadCRMult" 
                                      << endl;
