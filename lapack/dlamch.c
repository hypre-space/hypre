...
nding   
    ...
    if (hypre_lsame_(cmach, "E")) {
	rmach = eps;
    } else if (hypre_lsame_(cmach, "S")) {
	rmach = sfmin;
    } else if (hypre_lsame_(cmach, "B")) {
	rmach = base;
    } else if (hypre_lsame_(cmach, "P")) {
	rmach = prec;
    } else if (hypre_lsame_(cmach, "N")) {
	rmach = t;
    } else if (hypre_lsame_(cmach, "R")) {
	rmach = rnd;
    } else if (hypre_lsame_(cmach, "M")) {
	rmach = emin;
    } else if (hypre_lsame_(cmach, "U")) {
	rmach = rmin;
    } else if (hypre_lsame_(cmach, "L")) {
	rmach = emax;
    } else if (hypre_lsame_(cmach, "O")) {
	rmach = rmax;
    }
