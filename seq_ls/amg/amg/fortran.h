...
/* rsdl */
#define CALL_RESIDUAL(energy, residual_nrm, resv,\
                      U_array, F_array, A_array, amg_data) \
NAME_FORTRAN_FOR_C(rsdl)(&energy,\
			 &residual_nrm,\
			 &AMGDataNumUnknowns(amg_data),\
			 resv,\
...
void NAME_FORTRAN_FOR_C(rsdl)(double *, double *, int *,
...
NAME_FORTRAN_FOR_C(cycle)(&Solve_err_flag,\
			  &AMGDataNumLevels(amg_data),\
			  AMGDataMU(amg_data),\
			  &Fcycle_flag,\
			  &Vstar_flag,\
...
void NAME_FORTRAN_FOR_C(cycle)(int *, int *, int *,
			       int *, int *, int *, int *, 
			       int *, int *,
			       int *, int *, int *, int *,
...
NAME_FORTRAN_FOR_C(relax)(&Solve_err_flag,\
...
void NAME_FORTRAN_FOR_C(relax)(int *, int *, int *, int *, int *,
			       int *, int *, 
...
/* intad */
#define CALL_INTAD(coarse_grid, fine_grid, numv,\
		   Vstar_flag, F_array, U_array,amg_data) \
NAME_FORTRAN_FOR_C(intad)(VectorData(U_array[fine_grid]),\
...
void NAME_FORTRAN_FOR_C(intad)(double *, double *, int *, int *, int *,
			       double *, double *, double *, double *, 
			       int *, int *, int *, int *, int *, int *);

/* rscali */ 
#define CALL_RSCALI(coarse_grid, fine_grid, numv, F_array, U_array, amg_data) \
NAME_FORTRAN_FOR_C(rscali)(VectorData(F_array[coarse_grid]),\
			   &numv[coarse_grid],\
...
void NAME_FORTRAN_FOR_C(rscali)(double *, int *, double *, double *, double *,
				double *, int *, int *, 
				double *, int *, int *, int *); 
