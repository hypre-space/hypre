      ...
      char *argv[] )
{
  ...
  HYPRE_Real  grid_complexity, operator_complexity;
  ...
  /*
  element_node_file = "/home/panayot/linear_solvers/seq_ls/amge/toni/el_node_1";
  element_matrix_file = "/home/panayot/linear_solvers/seq_ls/amge/toni/el_matrix_1";

  coordinates_file = "/home/panayot/linear_solvers/seq_ls/amge/toni/coord_1"; 

  node_on_boundary_file = "/home/panayot/linear_solvers/seq_ls/amge/toni/node_on_bdr_1";
  */

  /*
  element_node_file = "/home/panayot/meshes/element_node_001_4";
  element_matrix_file = "/home/panayot/meshes/element_matrix_001_4";
  coordinates_file = "/home/panayot/meshes/coordinati_001_4";
  node_on_boundary_file = NULL;
  */


  element_node_file = "/home/panayot/new_AMGe_code/element_node_001_5";

  element_matrix_file = "/home/panayot/new_AMGe_code/element_matrix_001_5";


  node_on_boundary_file = NULL;

  coordinates_file = "/home/panayot/new_AMGe_code/coordinati_001_5";
  ...
  if (coordinates_file)
    ierr = hypre_AMGeTriangInitialGraphsWithCoord(&i_element_node_0,
						  &j_element_node_0,
  ...
  ind = -1;
  for (j=0; j < i_element_node_0[num_elements]; j++)
    if (j_element_node_0[j] < 1) 
      {
	ind = 0;
	break;
      }
  ...
  ierr =
    hypre_AMGeSpectralInterpolationSetup(&P,
  ...
  /* GS solve pre--smoothing, GS solve post--smoothing; ===================== */
  ...
  for (l=0; l < level+1; l++)
    if (Num_dofs[l] > 0) /*  && l != 1) */
      {
	grid_complexity+= Num_dofs[l];
	operator_complexity+=Num_chords[l];
      }
