                                       ...
                                       int                  action )
{
   ...
   double                  *tvalues = NULL;
   int                      nfrentries, ntoentries, frpart, topart;
   int                      entry, sentry, ei, fri, toi, i, j, k, vi, tvi, vistart;
   int                      vnx, vny, vnz, inx, iny, inz, idx, idy, idz;
