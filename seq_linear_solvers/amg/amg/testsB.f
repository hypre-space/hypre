...
c
      ...
      do 110 jj=jjlo,jjhi
ccjwr >>>>>  1/24/95  test (don't count connections to S-points)
...
c     write(6,5432) i,ic
c5432 format('  ftest1 -- i=',i3,2x,i3,' forced')
...
c
  170 icg(i)=4
      icg(ic)=-2
c     write(6,5433) i,ic
c5433 format('  ftest1 -- i=',i3,2x,i3,' forced  ',i3,' unforced')
      ic=i
      go to 210
  190 ifg(ii0)=-999
  200 continue
...
290   continue
300   continue
c     write(6,1000) k,ntest,npts,nnewpt
c     write(6,2000) (j,ntu(j),nfu(j),j=1,3)
c     flush(6)
