...
HYPRE_Int hypre_NonGalerkinSparsityPattern ( hypre_ParCSRMatrix *R_IAP, hypre_ParCSRMatrix *RAP, HYPRE_Int row, HYPRE_Int * CF_marker_coarse, HYPRE_Real droptol, HYPRE_Int sym_collapse, HYPRE_Int collapse_beta, HYPRE_Int * patt_diag, HYPRE_Int  * patt_diag_len, HYPRE_Int * patt_offd, HYPRE_Int  * patt_offd_len);
