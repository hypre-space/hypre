...
int hypre_SchwarzSolve( hypre_ParCSRMatrix *par_A , hypre_Vector *rhs_vector , int num_domains , int *i_domain_dof , int *j_domain_dof , double *domain_matrixinverse , hypre_ParVector *par_x , hypre_Vector *aux_vector );
