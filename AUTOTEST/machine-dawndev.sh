...
case $1 in
   ...
   **** Only run this script on the DawnDev machine ****
   ...
   This script runs a number of tests suitable for the DawnDev machine.
...
# Don't run runtest tests because DawnDev only uses a batch system
