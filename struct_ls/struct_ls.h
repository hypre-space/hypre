...
int hypre_HybridSetPCGAbsoluteTolFactor ( void *hybrid_vdata , double pcg_atolf );
int hypre_HybridSetTwoNorm ( void *hybrid_vdata , int two_norm );
int hypre_HybridSetStopCrit ( void *hybrid_vdata , int stop_crit );
int hypre_HybridSetRelChange ( void *hybrid_vdata , int rel_change );
int hypre_HybridSetSolverType ( void *hybrid_vdata , int solver_type );
...
int hypre_HybridSetPrintLevel ( void *hybrid_vdata , int print_level );
...
int HYPRE_StructHybridSetPCGAbsoluteTolFactor ( HYPRE_StructSolver solver , double pcg_atolf );
int HYPRE_StructHybridSetTwoNorm ( HYPRE_StructSolver solver , int two_norm );
int HYPRE_StructHybridSetStopCrit ( HYPRE_StructSolver solver , int stop_crit );
int HYPRE_StructHybridSetRelChange ( HYPRE_StructSolver solver , int rel_change );
int HYPRE_StructHybridSetSolverType ( HYPRE_StructSolver solver , int solver_type );
...
/* HYPRE_struct_int.c */
int hypre_StructVectorSetRandomValues ( hypre_StructVector *vector , int seed );
int hypre_StructSetRandomValues ( void *v , int seed );
...
int HYPRE_StructPFMGGetTol ( HYPRE_StructSolver solver , double *tol );
int HYPRE_StructPFMGSetMaxIter ( HYPRE_StructSolver solver , int max_iter );
int HYPRE_StructPFMGGetMaxIter ( HYPRE_StructSolver solver , int *max_iter );
int HYPRE_StructPFMGSetMaxLevels ( HYPRE_StructSolver solver , int max_levels );
int HYPRE_StructPFMGGetMaxLevels ( HYPRE_StructSolver solver , int *max_levels );
int HYPRE_StructPFMGSetRelChange ( HYPRE_StructSolver solver , int rel_change );
int HYPRE_StructPFMGGetRelChange ( HYPRE_StructSolver solver , int *rel_change );
int HYPRE_StructPFMGSetZeroGuess ( HYPRE_StructSolver solver );
int HYPRE_StructPFMGGetZeroGuess ( HYPRE_StructSolver solver , int *zeroguess );
...
int HYPRE_StructPFMGGetNumPreRelax ( HYPRE_StructSolver solver , int *num_pre_relax );
int HYPRE_StructPFMGSetNumPostRelax ( HYPRE_StructSolver solver , int num_post_relax );
int HYPRE_StructPFMGGetNumPostRelax ( HYPRE_StructSolver solver , int *num_post_relax );
int HYPRE_StructPFMGSetSkipRelax ( HYPRE_StructSolver solver , int skip_relax );
int HYPRE_StructPFMGGetSkipRelax ( HYPRE_StructSolver solver , int *skip_relax );
...
int HYPRE_StructPFMGGetLogging ( HYPRE_StructSolver solver , int *logging );
int HYPRE_StructPFMGSetPrintLevel ( HYPRE_StructSolver solver , int print_level );
int HYPRE_StructPFMGGetPrintLevel ( HYPRE_StructSolver solver , int *print_level );
...
int HYPRE_StructSMGGetMemoryUse ( HYPRE_StructSolver solver , int *memory_use );
int HYPRE_StructSMGSetTol ( HYPRE_StructSolver solver , double tol );
int HYPRE_StructSMGGetTol ( HYPRE_StructSolver solver , double *tol );
int HYPRE_StructSMGSetMaxIter ( HYPRE_StructSolver solver , int max_iter );
int HYPRE_StructSMGGetMaxIter ( HYPRE_StructSolver solver , int *max_iter );
int HYPRE_StructSMGSetRelChange ( HYPRE_StructSolver solver , int rel_change );
int HYPRE_StructSMGGetRelChange ( HYPRE_StructSolver solver , int *rel_change );
int HYPRE_StructSMGSetZeroGuess ( HYPRE_StructSolver solver );
int HYPRE_StructSMGGetZeroGuess ( HYPRE_StructSolver solver , int *zeroguess );
...
int HYPRE_StructSMGGetNumPreRelax ( HYPRE_StructSolver solver , int *num_pre_relax );
int HYPRE_StructSMGSetNumPostRelax ( HYPRE_StructSolver solver , int num_post_relax );
int HYPRE_StructSMGGetNumPostRelax ( HYPRE_StructSolver solver , int *num_post_relax );
int HYPRE_StructSMGSetLogging ( HYPRE_StructSolver solver , int logging );
int HYPRE_StructSMGGetLogging ( HYPRE_StructSolver solver , int *logging );
int HYPRE_StructSMGSetPrintLevel ( HYPRE_StructSolver solver , int print_level );
int HYPRE_StructSMGGetPrintLevel ( HYPRE_StructSolver solver , int *print_level );
...
int hypre_PFMGGetTol ( void *pfmg_vdata , double *tol );
int hypre_PFMGSetMaxIter ( void *pfmg_vdata , int max_iter );
int hypre_PFMGGetMaxIter ( void *pfmg_vdata , int *max_iter );
int hypre_PFMGSetMaxLevels ( void *pfmg_vdata , int max_levels );
int hypre_PFMGGetMaxLevels ( void *pfmg_vdata , int *max_levels );
int hypre_PFMGSetRelChange ( void *pfmg_vdata , int rel_change );
int hypre_PFMGGetRelChange ( void *pfmg_vdata , int *rel_change );
...
int hypre_PFMGGetNumPreRelax ( void *pfmg_vdata , int *num_pre_relax );
int hypre_PFMGSetNumPostRelax ( void *pfmg_vdata , int num_post_relax );
int hypre_PFMGGetNumPostRelax ( void *pfmg_vdata , int *num_post_relax );
int hypre_PFMGSetSkipRelax ( void *pfmg_vdata , int skip_relax );
int hypre_PFMGGetSkipRelax ( void *pfmg_vdata , int *skip_relax );
int hypre_PFMGSetDxyz ( void *pfmg_vdata , double *dxyz );
int hypre_PFMGSetLogging ( void *pfmg_vdata , int logging );
int hypre_PFMGGetLogging ( void *pfmg_vdata , int *logging );
int hypre_PFMGSetPrintLevel ( void *pfmg_vdata , int print_level );
int hypre_PFMGGetPrintLevel ( void *pfmg_vdata , int *print_level );
...
int hypre_SMGGetMemoryUse ( void *smg_vdata , int *memory_use );
int hypre_SMGSetTol ( void *smg_vdata , double tol );
int hypre_SMGGetTol ( void *smg_vdata , double *tol );
int hypre_SMGSetMaxIter ( void *smg_vdata , int max_iter );
int hypre_SMGGetMaxIter ( void *smg_vdata , int *max_iter );
int hypre_SMGSetRelChange ( void *smg_vdata , int rel_change );
int hypre_SMGGetRelChange ( void *smg_vdata , int *rel_change );
int hypre_SMGSetZeroGuess ( void *smg_vdata , int zero_guess );
int hypre_SMGGetZeroGuess ( void *smg_vdata , int *zero_guess );
int hypre_SMGSetNumPreRelax ( void *smg_vdata , int num_pre_relax );
int hypre_SMGGetNumPreRelax ( void *smg_vdata , int *num_pre_relax );
int hypre_SMGSetNumPostRelax ( void *smg_vdata , int num_post_relax );
int hypre_SMGGetNumPostRelax ( void *smg_vdata , int *num_post_relax );
...
int hypre_SMGGetLogging ( void *smg_vdata , int *logging );
int hypre_SMGSetPrintLevel ( void *smg_vdata , int print_level );
int hypre_SMGGetPrintLevel ( void *smg_vdata , int *print_level );
