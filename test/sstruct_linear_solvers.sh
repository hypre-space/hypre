...
TestCase[4]="$MPIRUN -np 1 $DRIVER -in sstruct.in.default_2D -r 2 2 1 -solver 19"
TestCase[5]="$MPIRUN -np 1 $DRIVER -in sstruct.in.default_2D -b 2 2 1 -solver 19"
TestCase[6]="$MPIRUN -np 2 $DRIVER -in sstruct.in.default_2D -P 1 2 1 -r 2 1 1 -solver 19"
