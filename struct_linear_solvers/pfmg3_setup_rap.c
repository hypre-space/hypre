   ...
   hypre_ForBoxI(i, cgrid_boxes)
      {
         ...
         hypre_PFMGMapCoarseToFine(cstart, cindex, cstride, fstart);
         ...
         pa = hypre_StructMatrixExtractPointerByIndex(P, i, index);

         hypre_SetIndex(index_temp,0,0,1);
         MapIndex(index_temp, cdir, index);
         pb = hypre_StructMatrixExtractPointerByIndex(P, i, index) -
            hypre_BoxOffsetDistance(P_data_box, index);
         ...
         hypre_SetIndex(index_temp,0,0,-1);
         MapIndex(index_temp, cdir, index);
         ra = hypre_StructMatrixExtractPointerByIndex(R, i, index);

         hypre_SetIndex(index_temp,0,0,1);
         MapIndex(index_temp, cdir, index);
         rb = hypre_StructMatrixExtractPointerByIndex(R, i, index) -
            hypre_BoxOffsetDistance(R_data_box, index);
         ...
         hypre_SetIndex(index_temp,0,0,0);
         MapIndex(index_temp, cdir, index);
         rap_cc = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,-1,0,0);
         MapIndex(index_temp, cdir, index);
         rap_cw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,0,-1,0);
         MapIndex(index_temp, cdir, index);
         rap_cs = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,0,0,-1);
         MapIndex(index_temp, cdir, index);
         rap_bc = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,-1,0,-1);
         MapIndex(index_temp, cdir, index);
         rap_bw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,1,0,-1);
         MapIndex(index_temp, cdir, index);
         rap_be = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,0,-1,-1);
         MapIndex(index_temp, cdir, index);
         rap_bs = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,0,1,-1);
         MapIndex(index_temp, cdir, index);
         rap_bn = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,-1,-1,0);
         MapIndex(index_temp, cdir, index);
         rap_csw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);
         
         hypre_SetIndex(index_temp,1,-1,0);
         MapIndex(index_temp, cdir, index);
         rap_cse = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);
         ...
         if (fine_stencil_size > 7)
         {
            hypre_SetIndex(index_temp,-1,-1,-1);
            MapIndex(index_temp, cdir, index);
            rap_bsw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

            hypre_SetIndex(index_temp,1,-1,-1);
            MapIndex(index_temp, cdir, index);
            rap_bse = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

            hypre_SetIndex(index_temp,-1,1,-1);
            MapIndex(index_temp, cdir, index);
            rap_bnw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

            hypre_SetIndex(index_temp,1,1,-1);
            MapIndex(index_temp, cdir, index);
            rap_bne = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);
         }
         ...
         hypre_SetIndex(index_temp,0,0,1);
         MapIndex(index_temp, cdir, index);
         zOffsetA = hypre_BoxOffsetDistance(A_data_box,index); 
         zOffsetP = hypre_BoxOffsetDistance(P_data_box,index); 
         hypre_SetIndex(index_temp,0,1,0);
         MapIndex(index_temp, cdir, index);
         yOffsetP = hypre_BoxOffsetDistance(P_data_box,index); 
         hypre_SetIndex(index_temp,1,0,0);
         MapIndex(index_temp, cdir, index);
         xOffsetP = hypre_BoxOffsetDistance(P_data_box,index); 
   ...
   hypre_ForBoxI(i, cgrid_boxes)
      {
         ...
         hypre_SetIndex(index_temp,1,0,0);
         MapIndex(index_temp, cdir, index);
         rap_ce = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,0,1,0);
         MapIndex(index_temp, cdir, index);
         rap_cn = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,0,0,1);
         MapIndex(index_temp, cdir, index);
         rap_ac = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,-1,0,1);
         MapIndex(index_temp, cdir, index);
         rap_aw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,1,0,1);
         MapIndex(index_temp, cdir, index);
         rap_ae = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,0,-1,1);
         MapIndex(index_temp, cdir, index);
         rap_as = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,0,1,1);
         MapIndex(index_temp, cdir, index);
         rap_an = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

         hypre_SetIndex(index_temp,-1,1,0);
         MapIndex(index_temp, cdir, index);
         rap_cnw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);
         
         hypre_SetIndex(index_temp,1,1,0);
         MapIndex(index_temp, cdir, index);
         rap_cne = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);
         ...
         if (fine_stencil_size > 7)
         {
            hypre_SetIndex(index_temp,-1,-1,1);
            MapIndex(index_temp, cdir, index);
            rap_asw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

            hypre_SetIndex(index_temp,1,-1,1);
            MapIndex(index_temp, cdir, index);
            rap_ase = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

            hypre_SetIndex(index_temp,-1,1,1);
            MapIndex(index_temp, cdir, index);
            rap_anw = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);

            hypre_SetIndex(index_temp,1,1,1);
            MapIndex(index_temp, cdir, index);
            rap_ane = hypre_StructMatrixExtractPointerByIndex(RAP, i, index);
         }
