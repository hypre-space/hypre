...
#ifndef zzz_GRID_HEADER
#define zzz_GRID_HEADER
...
#define zzz_StructGridProcess(grid, i)    (zzz_StructGridProcesses(grid)[i])
#define zzz_StructGridBox(grid, i)        (zzz_BoxArrayBox(zzz_StructGridBoxes(grid), i))
#define zzz_StructGridNumBoxes(grid)      (zzz_BoxArraySize(zzz_StructGridBoxes(grid)))
#define zzz_StructGridBoxRank(grid, i)    (zzz_StructGridBoxRanks(grid)[i])

/*--------------------------------------------------------------------------
 * Looping macros:
 *--------------------------------------------------------------------------*/
 
#define zzz_ForStructGridBoxI(i, grid)  zzz_ForBoxI(i, zzz_StructGridBoxes(grid))
