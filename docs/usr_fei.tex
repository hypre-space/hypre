...
\section{Solvers and preconditioners available}
...
To choose between these solvers and
preconditioners as well as the parameters specific to them,
the {\tt FEI\_parameters} function is used, as described
above.
