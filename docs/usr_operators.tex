...
etc. The fundamental "use" function of an Operator is the \code{Apply} function. For
components that 
encapsulate "matrices", the \code{Apply} function corresponds to the traditional
matrix-vector multiplication. For 
solvers, \code{Apply} is the traditional "solve" function. Preconditioners are also
referred to as being "applied", 
and the \code{Apply} function quite naturally corresponds to this application. Thus,
use of matrices, solvers, and 
preconditioners are done through the \code{Apply} function.
