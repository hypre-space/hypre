...
\item \code{cycle_type=8}: additive solver $(010+020)$
\end{itemize}
...
as a preconditioner.
In our experience the choices \code{cycle_type=1} and \code{cycle_type=5} often produced
...
method \cite{VaMB96, VaBM01}.  There are two main algorithms in this module - the original
