/*
 * File:          sidlx_rmi_SimpleTicketBook_IOR.h
...
#define included_sidlx_rmi_SimpleTicketBook_IOR_h
...
struct sidlx_rmi_SimpleTicketBook__epv {
  ...
  struct sidl_rmi_Response__object* (*f_getResponse)(
    /* in */ struct sidlx_rmi_SimpleTicketBook__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidl.rmi.TicketBook-v0.9.15 */
  void (*f_insertWithID)(
    /* in */ struct sidlx_rmi_SimpleTicketBook__object* self,
  ...
  sidl_bool (*f_isEmpty)(
    /* in */ struct sidlx_rmi_SimpleTicketBook__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidlx.rmi.SimpleTicketBook-v0.1 */
};
...
struct sidlx_rmi_SimpleTicketBook__controls {
  int     use_hooks;
};
/*
...
struct sidlx_rmi_SimpleTicketBook__object {
  ...
  struct sidl_rmi_TicketBook__object      d_sidl_rmi_ticketbook;
  struct sidlx_rmi_SimpleTicketBook__epv* d_epv;
  void*                                   d_data;
};

struct sidlx_rmi_SimpleTicketBook__external {
  struct sidlx_rmi_SimpleTicketBook__object*
...
extern void sidlx_rmi_SimpleTicketBook__init(
  struct sidlx_rmi_SimpleTicketBook__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidlx_rmi_SimpleTicketBook__getEPVs(
  ...
  extern void sidlx_rmi_SimpleTicketBook__fini(
    struct sidlx_rmi_SimpleTicketBook__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void sidlx_rmi_SimpleTicketBook__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct sidl_BaseClass__object* 
    skel_sidlx_rmi_SimpleTicketBook_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidlx_rmi_SimpleTicketBook_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidlx_rmi_SimpleTicketBook_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_rmi_Response__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_Response__object* 
    skel_sidlx_rmi_SimpleTicketBook_fcast_sidl_rmi_Response(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_rmi_Ticket__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_Ticket__object* 
    skel_sidlx_rmi_SimpleTicketBook_fcast_sidl_rmi_Ticket(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidl_rmi_TicketBook__object* 
    skel_sidlx_rmi_SimpleTicketBook_fconnect_sidl_rmi_TicketBook(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_TicketBook__object* 
    skel_sidlx_rmi_SimpleTicketBook_fcast_sidl_rmi_TicketBook(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidlx_rmi_SimpleTicketBook__remote{
    int d_refcount;
