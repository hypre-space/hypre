...
static PyObject *
pStub_TimeOutException__connect(PyObject *_ignored, PyObject *_args, PyObject \
  *_kwdict) {
...
static PyObject *
pStub_TimeOutException__exec(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_TimeOutException__getURL(PyObject *_self, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_TimeOutException__object *_self_ior =
    ((struct sidl_rmi_TimeOutException__object *)
...
static PyObject *
pStub_TimeOutException__isLocal(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_TimeOutException__object *_self_ior =
    ((struct sidl_rmi_TimeOutException__object *)
...
static PyObject *
pStub_TimeOutException__isRemote(PyObject *_self, PyObject *_args, PyObject   \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_TimeOutException__object *_self_ior =
    ((struct sidl_rmi_TimeOutException__object *)
...
static PyObject *
pStub_TimeOutException__set_hooks(PyObject *_self, PyObject *_args, PyObject  \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_TimeOutException__object *_self_ior =
    ((struct sidl_rmi_TimeOutException__object *)
...
static int
sidl_rmi_TimeOutException_createCast(PyObject *self, PyObject *args, PyObject \
  *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidl_rmi_TimeOutException__convert, &optarg, &url, &implObj);
  if (_okay) {
...
sidl_rmi_TimeOutException__wrap sidl_rmi_TimeOutException__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidl_rmi_TimeOutExceptionType.tp_new(                           \
      &_sidl_rmi_TimeOutExceptionType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
times out. "
  ...
  PyTuple_SetItem(_sidl_rmi_TimeOutExceptionType.tp_bases,0, (PyObject        \
  ...
  Py_INCREF(&_sidl_rmi_TimeOutExceptionType);
  PyDict_SetItemString(dict, "TimeOutException", (PyObject                    \
    *)&_sidl_rmi_TimeOutExceptionType);
