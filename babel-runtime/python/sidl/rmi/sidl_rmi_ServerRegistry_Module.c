...
static PyObject *
pStub_ServerRegistry__connect(PyObject *_ignored, PyObject *_args, PyObject   \
  *_kwdict) {
...
static PyObject *
pStub_ServerRegistry__exec(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_ServerRegistry__getURL(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ServerRegistry__object *_self_ior =
    ((struct sidl_rmi_ServerRegistry__object *)
...
static PyObject *
pStub_ServerRegistry__isLocal(PyObject *_self, PyObject *_args, PyObject      \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ServerRegistry__object *_self_ior =
    ((struct sidl_rmi_ServerRegistry__object *)
...
static PyObject *
pStub_ServerRegistry__isRemote(PyObject *_self, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ServerRegistry__object *_self_ior =
    ((struct sidl_rmi_ServerRegistry__object *)
...
static PyObject *
pStub_ServerRegistry__set_hooks(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_ServerRegistry__object *_self_ior =
    ((struct sidl_rmi_ServerRegistry__object *)
...
static int
sidl_rmi_ServerRegistry_createCast(PyObject *self, PyObject *args, PyObject   \
  *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidl_rmi_ServerRegistry__convert, &optarg, &url, &implObj);
  if (_okay) {
...
sidl_rmi_ServerRegistry__wrap sidl_rmi_ServerRegistry__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidl_rmi_ServerRegistryType.tp_new(                             \
      &_sidl_rmi_ServerRegistryType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
one server is assumed per Babel process)"
  ...
  PyTuple_SetItem(_sidl_rmi_ServerRegistryType.tp_bases,0, (PyObject          \
  ...
  Py_INCREF(&_sidl_rmi_ServerRegistryType);
  PyDict_SetItemString(dict, "ServerRegistry", (PyObject                      \
    *)&_sidl_rmi_ServerRegistryType);
