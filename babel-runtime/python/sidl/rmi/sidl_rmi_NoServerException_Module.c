/*
 * File:          sidl_rmi_NoServerException_Module.c
...
#define sidl_rmi_NoServerException_INTERNAL 1
#include "sidl_rmi_NoServerException_Module.h"
...
#define LANG_SPECIFIC_INIT() if(!lang_inited) { \
  ...
  sidl_rmi_NoServerException__import(); \
...
static struct sidl_rmi_NoServerException__object*
sidl_rmi_NoServerException__remoteCreate(const char *url, sidl_BaseInterface  \
  *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance( \
    url, "sidl.rmi.NoServerException", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_rmi_NoServerException__object*) malloc(
      sizeof(struct sidl_rmi_NoServerException__object));
  ...
  sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL;
  ...
  if (obj != NULL) {
    ...
    cast = (struct sidl_rmi_NoServerException__object*) (                     \
      *base->d_epv->f__cast)(
      base->d_object,
...
pStub_NoServerException__connect(PyObject *_ignored, PyObject *_args,         \
  ...
  struct sidl_rmi_NoServerException__object* self = NULL;
  char* url = NULL;
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &url);
  if (_okay) {
    self = sidl_rmi_NoServerException__remoteConnect(url,1,&_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidl_rmi_NoServerException__wrap, self);
    }
  }
  return _return_value;
}

staticforward PyTypeObject _sidl_rmi_NoServerExceptionType;

static const struct sidl_rmi_NoServerException__external *_implEPV = NULL;

static PyObject *
pStub_NoServerException__exec(PyObject *_self, PyObject *_args, PyObject      \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoServerException__object *_self_ior =
    ((struct sidl_rmi_NoServerException__object *)
     sidl_Cast(_self, "sidl.rmi.NoServerException"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidl.rmi.NoServerException");
  }
  return _return_value;
}
...
static int
sidl_rmi_NoServerException_createCast(PyObject *self, PyObject *args,         \
  PyObject *kwds) {
  struct sidl_rmi_NoServerException__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidl_rmi_NoServerException__convert, &optarg, &url, &implObj);
  if (_okay) {
    ...
    struct sidl_BaseInterface__object *_exception = NULL;
    optarg = sidl_rmi_NoServerException__remoteCreate(url,&_exception);
    if (_exception) {
      sidl_rmi_NetworkException__import();
      struct sidl_rmi_NetworkException__object *_ex0;
      if ((_ex0 = (struct sidl_rmi_NetworkException__object *)
...
RETURNS\n\
   ( out sidl.rmi.NoServerException self)\n\
RAISES\n\
...
static PyTypeObject _sidl_rmi_NoServerExceptionType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidl.rmi.NoServerException.NoServerException", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
...
\
This exception thrown when one attempts to pass a local object remotely but \n\
there is no local server running to serve the object", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  0,       /* tp_weaklistoffset */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidl_rmi_NoServerException_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

sidl_rmi_NoServerException__wrap_RETURN
sidl_rmi_NoServerException__wrap sidl_rmi_NoServerException__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidl_rmi_NoServerExceptionType.tp_new(                          \
      &_sidl_rmi_NoServerExceptionType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidl_rmi_NoServerException__weakRef_RETURN
sidl_rmi_NoServerException__weakRef sidl_rmi_NoServerException__weakRef_PROTO \
  {
  PyObject *result;
  if (sidlobj) {
    result = _sidl_rmi_NoServerExceptionType.tp_new(                          \
...
sidl_rmi_NoServerException_deref_RETURN
sidl_rmi_NoServerException_deref sidl_rmi_NoServerException_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidl_rmi_NoServerException__newRef_RETURN
sidl_rmi_NoServerException__newRef sidl_rmi_NoServerException__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidl_rmi_NoServerExceptionType.tp_new(                          \
      &_sidl_rmi_NoServerExceptionType, NULL, NULL);
...
sidl_rmi_NoServerException__addRef_RETURN
sidl_rmi_NoServerException__addRef sidl_rmi_NoServerException__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidl_rmi_NoServerException_PyType_RETURN
sidl_rmi_NoServerException_PyType sidl_rmi_NoServerException_PyType_PROTO {
  Py_INCREF(&_sidl_rmi_NoServerExceptionType);
  return &_sidl_rmi_NoServerExceptionType;
}

sidl_rmi_NoServerException__convert_RETURN
sidl_rmi_NoServerException__convert sidl_rmi_NoServerException__convert_PROTO \
  {
  *sidlobj = sidl_Cast(obj, "sidl.rmi.NoServerException");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidl.rmi.NoServerException");
    return 0;
  }
  return 1;
}
...
{
  struct sidl_rmi_NoServerException__object *sidlobj;
  if (sidl_rmi_NoServerException__convert(pyobj, &sidlobj)) {
...
sidl_rmi_NoServerException__convert_python_array_RETURN
sidl_rmi_NoServerException__convert_python_array                              \
  sidl_rmi_NoServerException__convert_python_array_PROTO {
  int result = 0;
  *sidlarray = NULL;
  if (obj == Py_None) {
    result = TRUE;
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              sidl_rmi_NoServerException__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct sidl_rmi_NoServerException__object *sidlobj = (struct                \
    sidl_rmi_NoServerException__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidl_rmi_NoServerException__wrap(sidlobj);
  return (*dest == NULL);
}

sidl_rmi_NoServerException__convert_sidl_array_RETURN
sidl_rmi_NoServerException__convert_sidl_array                                \
  sidl_rmi_NoServerException__convert_sidl_array_PROTO {
  PyObject *pya = NULL;
  if (sidlarray) {
...
initNoServerException(void) {
  ...
  static void *ExternalAPI[sidl_rmi_NoServerException__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
...
there is no local server running to serve the object"
  ...
  ExternalAPI[sidl_rmi_NoServerException__wrap_NUM] = (                       \
    void*)sidl_rmi_NoServerException__wrap;
  ExternalAPI[sidl_rmi_NoServerException__convert_NUM] = (                    \
    void*)sidl_rmi_NoServerException__convert;
  ExternalAPI[sidl_rmi_NoServerException__convert_python_array_NUM] = (       \
    void*)sidl_rmi_NoServerException__convert_python_array;
  ExternalAPI[sidl_rmi_NoServerException__convert_sidl_array_NUM] = (         \
    void*)sidl_rmi_NoServerException__convert_sidl_array;
  ExternalAPI[sidl_rmi_NoServerException__weakRef_NUM] = (                    \
    void*)sidl_rmi_NoServerException__weakRef;
  ExternalAPI[sidl_rmi_NoServerException_deref_NUM] = (                       \
    void*)sidl_rmi_NoServerException_deref;
  ExternalAPI[sidl_rmi_NoServerException__newRef_NUM] = (                     \
    void*)sidl_rmi_NoServerException__newRef;
  ExternalAPI[sidl_rmi_NoServerException__addRef_NUM] = (                     \
    void*)sidl_rmi_NoServerException__addRef;
  ExternalAPI[sidl_rmi_NoServerException_PyType_NUM] = (                      \
    void*)sidl_rmi_NoServerException_PyType;
  ExternalAPI[sidl_rmi_NoServerException__connectI_NUM] = (                   \
    void*)sidl_rmi_NoServerException__connectI;
  ExternalAPI[sidl_rmi_NoServerException__rmicast_NUM] = (                    \
    void*)sidl_rmi_NoServerException__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  Py_INCREF(Py_None);
  ExternalAPI[sidl_rmi_NoServerException__type_NUM] = Py_None;
  ...
  sidl_rmi_NetworkException__import();
  _sidl_rmi_NoServerExceptionType.tp_base = sidl_rmi_NetworkException_PyType( \
    );
  _sidl_rmi_NoServerExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidl_rmi_NoServerExceptionType.tp_bases,0, (PyObject       \
    *)sidl_rmi_NetworkException_PyType());
  if (PyType_Ready(&_sidl_rmi_NoServerExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidl.rmi.NoServerException failed.\n");
    return;
  }
  Py_INCREF(&_sidl_rmi_NoServerExceptionType);
  PyDict_SetItemString(dict, "NoServerException", (PyObject                   \
    *)&_sidl_rmi_NoServerExceptionType);
  ...
  PyDict_SetItemString(_exceptionDict, "__module__",
    PyString_InternFromString("sidl.rmi.NoServerException"));
  _exceptionName = PyString_InternFromString("_Exception");
  sidl_rmi_NoServerException__type = PyClass_New(_exceptionBases,             \
    _exceptionDict, _exceptionName);
  Py_XDECREF(_exceptionBases);
  Py_XDECREF(_exceptionDict);
  Py_XDECREF(_exceptionName);
  Py_XINCREF(sidl_rmi_NoServerException__type);
  PyDict_SetItemString(dict, "_Exception", sidl_rmi_NoServerException__type);
  ExternalAPI[sidl_rmi_NoServerException__type_NUM] =                         \
    sidl_rmi_NoServerException__type;
  /*
  ...
  if (!PyDict_GetItemString(dict, "Exception")) {
    Py_XINCREF(sidl_rmi_NoServerException__type);
    PyDict_SetItemString(dict, "Exception", sidl_rmi_NoServerException__type);
  }
  _implEPV = sidl_rmi_NoServerException__externals();
  if (!_implEPV) {
  ...
  sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.NoServerException", (    \
    void*)sidl_rmi_NoServerException__IHConnect, &throwaway_exception);
}
