...
static PyObject *
pStub_NoServerException__exec(PyObject *_self, PyObject *_args,               \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_NoServerException__getURL(PyObject *_self, PyObject *_args,             \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoServerException__object *_self_ior =
    ((struct sidl_rmi_NoServerException__object *)
...
static PyObject *
pStub_NoServerException__isLocal(PyObject *_self, PyObject *_args,            \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoServerException__object *_self_ior =
    ((struct sidl_rmi_NoServerException__object *)
...
static PyObject *
pStub_NoServerException__isRemote(PyObject *_self, PyObject *_args,           \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoServerException__object *_self_ior =
    ((struct sidl_rmi_NoServerException__object *)
...
static PyObject *
pStub_NoServerException__set_hooks(PyObject *_self, PyObject *_args,          \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NoServerException__object *_self_ior =
    ((struct sidl_rmi_NoServerException__object *)
...
sidl_rmi_NoServerException_createCast(PyObject *self, PyObject *args,         \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidl_rmi_NoServerException__convert, &optarg, &url, &implObj);
  if (_okay) {
...
sidl_rmi_NoServerException__wrap sidl_rmi_NoServerException__wrap_PROTO {
  ...
  if (sidlobj) {
    result =                                                                  \
      _sidl_rmi_NoServerExceptionType.tp_new(&_sidl_rmi_NoServerExceptionType,\
      NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
there is no local server running to serve the object"
  ...
  sidl_rmi_NetworkException__import();
  _sidl_rmi_NoServerExceptionType.tp_base =                                   \
    sidl_rmi_NetworkException_PyType();
  _sidl_rmi_NoServerExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidl_rmi_NoServerExceptionType.tp_bases,0,                 \
  ...
  Py_INCREF(&_sidl_rmi_NoServerExceptionType);
  PyDict_SetItemString(dict, "NoServerException",                             \
    (PyObject *)&_sidl_rmi_NoServerExceptionType);
