...
static PyObject *
pStub_LangSpecificException__exec(PyObject *_self, PyObject *_args,           \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
...
sidl_LangSpecificException_createCast(PyObject *self, PyObject *args,         \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidl_LangSpecificException__convert, &optarg, &url, &implObj);
  if (_okay) {
...
sidl_LangSpecificException__wrap sidl_LangSpecificException__wrap_PROTO {
  ...
  if (sidlobj) {
    result =                                                                  \
      _sidl_LangSpecificExceptionType.tp_new(&_sidl_LangSpecificExceptionType,\
      NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
C++ or Java."
  ...
  PyTuple_SetItem(_sidl_LangSpecificExceptionType.tp_bases,0,                 \
    (PyObject *)sidl_SIDLException_PyType());
  PyTuple_SetItem(_sidl_LangSpecificExceptionType.tp_bases,1,                 \
  ...
  Py_INCREF(&_sidl_LangSpecificExceptionType);
  PyDict_SetItemString(dict, "LangSpecificException",                         \
    (PyObject *)&_sidl_LangSpecificExceptionType);
