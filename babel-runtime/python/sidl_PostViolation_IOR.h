...
struct sidl_PostViolation__epv {
  ...
  /* Methods introduced in sidl.PostViolation-v0.9.15 */
};
...
struct sidl_PostViolation__controls {
  int     use_hooks;
};
/*
...
extern void sidl_PostViolation__init(
  struct sidl_PostViolation__object* self, void* ddata,
...
extern void sidl_PostViolation__getEPVs(
  ...
  struct sidl_BaseClass__object* 
    skel_sidl_PostViolation_fconnect_sidl_BaseClass(const char* url,
  ...
  struct sidl_ClassInfo__object* 
    skel_sidl_PostViolation_fconnect_sidl_ClassInfo(const char* url,
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
