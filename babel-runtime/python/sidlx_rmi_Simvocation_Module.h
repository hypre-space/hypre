...
#define sidlx_rmi_Simvocation__wrap_PROTO (struct sidlx_rmi_Simvocation__object *sidlobj)
...
#define sidlx_rmi_Simvocation__rmicast_NUM 10
#define sidlx_rmi_Simvocation__rmicast_RETURN struct sidlx_rmi_Simvocation__object* 
#define sidlx_rmi_Simvocation__rmicast_PROTO (void* bi, struct sidl_BaseInterface__object ** _ex)

#define sidlx_rmi_Simvocation__API_NUM 11
...
#define sidlx_rmi_Simvocation__rmicast \
  (*((sidlx_rmi_Simvocation__rmicast_RETURN (*) \
  sidlx_rmi_Simvocation__rmicast_PROTO) \
  (sidlx_rmi_Simvocation__API \
  [sidlx_rmi_Simvocation__rmicast_NUM])))
