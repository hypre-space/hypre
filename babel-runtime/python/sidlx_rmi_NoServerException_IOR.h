...
#define included_sidlx_rmi_NoServerException_IOR_h
...
struct sidlx_rmi_NoServerException__epv {
  ...
  int32_t (*f_getHopCount)(
    /* in */ struct sidlx_rmi_NoServerException__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidlx.rmi.NoServerException-v0.1 */
};
...
struct sidlx_rmi_NoServerException__controls {
  int     use_hooks;
};
/*
...
struct sidlx_rmi_NoServerException__object {
  ...
  struct sidlx_rmi_NoServerException__epv* d_epv;
  void*                                    d_data;
};

struct sidlx_rmi_NoServerException__external {
  struct sidlx_rmi_NoServerException__object*
...
extern void sidlx_rmi_NoServerException__getEPVs(
  ...
  struct sidlx_rmi_NoServerException__remote{
    int d_refcount;
