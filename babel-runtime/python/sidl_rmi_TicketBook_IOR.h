/*
 * File:          sidl_rmi_TicketBook_IOR.h
 * Symbol:        sidl.rmi.TicketBook-v0.9.15
 * Symbol Type:   interface
 * Babel Version: 1.0.4
 * Release:       $Name$
 * Revision:      @(#) $Id$
 * Description:   Intermediate Object Representation for sidl.rmi.TicketBook
 * 
...
#define included_sidl_rmi_TicketBook_IOR_h
...
struct sidl_rmi_TicketBook__epv {
...
struct sidl_rmi_TicketBook__object {
  struct sidl_rmi_TicketBook__epv* d_epv;
  void*                            d_object;
};
 ...
 */
/*
 * Symbol "sidl.rmi._TicketBook" (version 1.0)
 */

struct sidl_rmi__TicketBook__array;
struct sidl_rmi__TicketBook__object;

/*
 * Declare the method entry point vector.
 */

struct sidl_rmi__TicketBook__epv {
  /* Implicit builtin methods */
  void* (*f__cast)(
  ...
  sidl_bool (*f_isEmpty)(
    /* in */ struct sidl_rmi__TicketBook__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidl.rmi._TicketBook-v1.0 */
};
...
struct sidl_rmi__TicketBook__object {
  ...
  struct sidl_rmi__TicketBook__epv*  d_epv;
  void*                              d_data;
};


struct sidl_rmi__TicketBook__remote{
  int d_refcount;
