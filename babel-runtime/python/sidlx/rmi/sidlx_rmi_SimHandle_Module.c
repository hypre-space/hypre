/*
 * File:          sidlx_rmi_SimHandle_Module.c
...
#define sidlx_rmi_SimHandle_INTERNAL 1
#include "sidlx_rmi_SimHandle_Module.h"
...
static PyObject *
pStub_SimHandle__connect(PyObject *_ignored, PyObject *_args,                 \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object* self = NULL;
  char* url = NULL;
  ...
  _okay = PyArg_ParseTupleAndKeywords(
    ...
    &url);
  if (_okay) {
    self = sidlx_rmi_SimHandle__remoteConnect(url,1,&_exception);
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_SimHandle__wrap, self);
    }
  }
  return _return_value;
}

staticforward PyTypeObject _sidlx_rmi_SimHandleType;

static const struct sidlx_rmi_SimHandle__external *_implEPV = NULL;

static PyObject *
pStub_SimHandle__exec(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object *_self_ior =
    ((struct sidlx_rmi_SimHandle__object *)
     sidl_Cast(_self, "sidlx.rmi.SimHandle"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.SimHandle");
  }
  return _return_value;
}

static PyObject *
pStub_SimHandle__getURL(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object *_self_ior =
    ((struct sidlx_rmi_SimHandle__object *)
     sidl_Cast(_self, "sidlx.rmi.SimHandle"));
...
static PyObject *
pStub_SimHandle__isLocal(PyObject *_self, PyObject *_args,                    \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object *_self_ior =
    ((struct sidlx_rmi_SimHandle__object *)
...
static PyObject *
pStub_SimHandle__isRemote(PyObject *_self, PyObject *_args,                   \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object *_self_ior =
    ((struct sidlx_rmi_SimHandle__object *)
...
static PyObject *
pStub_SimHandle__set_hooks(PyObject *_self, PyObject *_args,                  \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object *_self_ior =
    ((struct sidlx_rmi_SimHandle__object *)
...
static int
sidlx_rmi_SimHandle_createCast(PyObject *self, PyObject *args,                \
  PyObject *kwds) {
  struct sidlx_rmi_SimHandle__object *optarg = NULL;
  char* url = NULL;
  PyObject * implObj = NULL;
  static char *_kwlist[] = {"sobj",  "url", "impl", NULL };
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist,       \
    (void *)sidlx_rmi_SimHandle__convert, &optarg, &url, &implObj);
  if (_okay) {
    ...
    struct sidl_BaseInterface__object *_exception = NULL;
    optarg = sidlx_rmi_SimHandle__remoteCreate(url,&_exception);
    if (_exception) {
      sidl_rmi_NetworkException__import();
      struct sidl_rmi_NetworkException__object *_ex0;
      if ((_ex0 = (struct sidl_rmi_NetworkException__object *)
...
static PyMethodDef _SimHandleModuleMethods[] = {
  { "_connect", (PyCFunction)pStub_SimHandle__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out sidlx.rmi.SimHandle self)\n\
RAISES\n\
...
static PyMethodDef _SimHandleObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_SimHandle__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_SimHandle__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_SimHandle__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_SimHandle__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_SimHandle__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _sidlx_rmi_SimHandleType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.SimHandle.SimHandle", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
\
implementation of InstanceHandle using the Simhandle Protocol (written by Jim)", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  0,       /* tp_weaklistoffset */
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _SimHandleObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_SimHandle_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

sidlx_rmi_SimHandle__wrap_RETURN
sidlx_rmi_SimHandle__wrap sidlx_rmi_SimHandle__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimHandleType.tp_new(&_sidlx_rmi_SimHandleType, NULL, \
      NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidlx_rmi_SimHandle__weakRef_RETURN
sidlx_rmi_SimHandle__weakRef sidlx_rmi_SimHandle__weakRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimHandleType.tp_new(&_sidlx_rmi_SimHandleType, NULL, \
      NULL);
...
sidlx_rmi_SimHandle_deref_RETURN
sidlx_rmi_SimHandle_deref sidlx_rmi_SimHandle_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_SimHandle__newRef_RETURN
sidlx_rmi_SimHandle__newRef sidlx_rmi_SimHandle__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimHandleType.tp_new(&_sidlx_rmi_SimHandleType, NULL, \
      NULL);
...
sidlx_rmi_SimHandle__addRef_RETURN
sidlx_rmi_SimHandle__addRef sidlx_rmi_SimHandle__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_SimHandle_PyType_RETURN
sidlx_rmi_SimHandle_PyType sidlx_rmi_SimHandle_PyType_PROTO {
  Py_INCREF(&_sidlx_rmi_SimHandleType);
  return &_sidlx_rmi_SimHandleType;
}

sidlx_rmi_SimHandle__convert_RETURN
sidlx_rmi_SimHandle__convert sidlx_rmi_SimHandle__convert_PROTO {
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.SimHandle");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.SimHandle");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_SimHandle__object *sidlobj;
  if (sidlx_rmi_SimHandle__convert(pyobj, &sidlobj)) {
...
sidlx_rmi_SimHandle__convert_python_array_RETURN
sidlx_rmi_SimHandle__convert_python_array                                     \
  sidlx_rmi_SimHandle__convert_python_array_PROTO {
  int result = 0;
  *sidlarray = NULL;
  if (obj == Py_None) {
    result = TRUE;
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              sidlx_rmi_SimHandle__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct sidlx_rmi_SimHandle__object *sidlobj = (struct                       \
    sidlx_rmi_SimHandle__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_SimHandle__wrap(sidlobj);
  return (*dest == NULL);
}

sidlx_rmi_SimHandle__convert_sidl_array_RETURN
sidlx_rmi_SimHandle__convert_sidl_array                                       \
  sidlx_rmi_SimHandle__convert_sidl_array_PROTO {
  PyObject *pya = NULL;
  if (sidlarray) {
...
initSimHandle(void) {
  ...
  static void *ExternalAPI[sidlx_rmi_SimHandle__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  sidl_DLL dll = NULL;
  struct sidlx_rmi_SimHandle__external*(*_extFunc)(void) = NULL;
  module = Py_InitModule3("SimHandle", _SimHandleModuleMethods, "\
\
implementation of InstanceHandle using the Simhandle Protocol (written by Jim)"
  );
  dict = PyModule_GetDict(module);
  ExternalAPI[sidlx_rmi_SimHandle__wrap_NUM] =                                \
    (void*)sidlx_rmi_SimHandle__wrap;
  ExternalAPI[sidlx_rmi_SimHandle__convert_NUM] =                             \
    (void*)sidlx_rmi_SimHandle__convert;
  ExternalAPI[sidlx_rmi_SimHandle__convert_python_array_NUM] =                \
    (void*)sidlx_rmi_SimHandle__convert_python_array;
  ExternalAPI[sidlx_rmi_SimHandle__convert_sidl_array_NUM] =                  \
    (void*)sidlx_rmi_SimHandle__convert_sidl_array;
  ExternalAPI[sidlx_rmi_SimHandle__weakRef_NUM] =                             \
    (void*)sidlx_rmi_SimHandle__weakRef;
  ExternalAPI[sidlx_rmi_SimHandle_deref_NUM] =                                \
    (void*)sidlx_rmi_SimHandle_deref;
  ExternalAPI[sidlx_rmi_SimHandle__newRef_NUM] =                              \
    (void*)sidlx_rmi_SimHandle__newRef;
  ExternalAPI[sidlx_rmi_SimHandle__addRef_NUM] =                              \
    (void*)sidlx_rmi_SimHandle__addRef;
  ExternalAPI[sidlx_rmi_SimHandle_PyType_NUM] =                               \
    (void*)sidlx_rmi_SimHandle_PyType;
  ExternalAPI[sidlx_rmi_SimHandle__connectI_NUM] =                            \
    (void*)sidlx_rmi_SimHandle__connectI;
  ExternalAPI[sidlx_rmi_SimHandle__rmicast_NUM] =                             \
    (void*)sidlx_rmi_SimHandle__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  sidl_BaseClass__import();
  sidl_rmi_InstanceHandle__import();
  _sidlx_rmi_SimHandleType.tp_base = sidl_BaseClass_PyType();
  _sidlx_rmi_SimHandleType.tp_bases = PyTuple_New(2);
  PyTuple_SetItem(_sidlx_rmi_SimHandleType.tp_bases,0,                        \
    (PyObject *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_sidlx_rmi_SimHandleType.tp_bases,1,                        \
    (PyObject *)sidl_rmi_InstanceHandle_PyType());
  if (PyType_Ready(&_sidlx_rmi_SimHandleType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidlx.rmi.SimHandle failed.\n");
    return;
  }
  Py_INCREF(&_sidlx_rmi_SimHandleType);
  PyDict_SetItemString(dict, "SimHandle",                                     \
    (PyObject *)&_sidlx_rmi_SimHandleType);
  ...
  if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                  \
    &throwaway_exception)) {
    _extFunc = (struct sidlx_rmi_SimHandle__external*(*)(void))
      sidl_DLL_lookupSymbol(dll, "sidlx_rmi_SimHandle__externals",            \
        &throwaway_exception);
    if (_extFunc) {
      _implEPV = (*_extFunc)();
    }
  ...
  if (!_implEPV) {
    dll = sidl_Loader_findLibrary("sidlx.rmi.SimHandle",
  ...
  sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.SimHandle",             \
    (void*)sidlx_rmi_SimHandle__IHConnect, &throwaway_exception);
}
