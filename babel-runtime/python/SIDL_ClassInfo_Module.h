...
#define SIDL_ClassInfo__convert_sidl_array_PROTO (struct SIDL_ClassInfo__array *sidlarray)

#define SIDL_ClassInfo__destroy_sidl_array_NUM 4
#define SIDL_ClassInfo__destroy_sidl_array_RETURN void
#define SIDL_ClassInfo__destroy_sidl_array_PROTO (struct SIDL_ClassInfo__array *sidlarray)

#define SIDL_ClassInfo__weakRef_NUM 5
#define SIDL_ClassInfo__weakRef_RETURN PyObject *
#define SIDL_ClassInfo__weakRef_PROTO (struct SIDL_ClassInfo__object *sidlobj)

#define SIDL_ClassInfo_deref_NUM 6
#define SIDL_ClassInfo_deref_RETURN void
#define SIDL_ClassInfo_deref_PROTO (struct SIDL_ClassInfo__object *sidlobj)

#define SIDL_ClassInfo__newRef_NUM 7
#define SIDL_ClassInfo__newRef_RETURN PyObject *
#define SIDL_ClassInfo__newRef_PROTO (struct SIDL_ClassInfo__object *sidlobj)

#define SIDL_ClassInfo__addRef_NUM 8
...
static SIDL_ClassInfo__destroy_sidl_array_RETURN
SIDL_ClassInfo__destroy_sidl_array
SIDL_ClassInfo__destroy_sidl_array_PROTO;
...
#define SIDL_ClassInfo__destroy_sidl_array \
  (*((SIDL_ClassInfo__destroy_sidl_array_RETURN (*) \
  SIDL_ClassInfo__destroy_sidl_array_PROTO) \
  (SIDL_ClassInfo__API \
  [SIDL_ClassInfo__destroy_sidl_array_NUM])))
