...
#define sidlx_rmi_Socket__wrap_PROTO (struct sidlx_rmi_Socket__object *sidlobj)
...
#define sidlx_rmi_Socket__rmicast_NUM 10
#define sidlx_rmi_Socket__rmicast_RETURN struct sidlx_rmi_Socket__object* 
#define sidlx_rmi_Socket__rmicast_PROTO (void* bi, struct sidl_BaseInterface__object ** _ex)

#define sidlx_rmi_Socket__API_NUM 11
...
#define sidlx_rmi_Socket__rmicast \
  (*((sidlx_rmi_Socket__rmicast_RETURN (*) \
  sidlx_rmi_Socket__rmicast_PROTO) \
  (sidlx_rmi_Socket__API \
  [sidlx_rmi_Socket__rmicast_NUM])))
...
{ \
  ...
  if (!sidlx_rmi_Socket__API) { \
    PyObject *module = PyImport_ImportModule("sidlx.rmi.Socket"); \
    if (module != NULL) { \
