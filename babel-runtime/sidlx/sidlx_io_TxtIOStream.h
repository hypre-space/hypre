...
#define included_sidlx_io_TxtIOStream_h
...
typedef struct sidlx_io_TxtIOStream__object* sidlx_io_TxtIOStream;
 ...
 */
struct sidlx_io_TxtIOStream__object*
sidlx_io_TxtIOStream__create(void);

/**
 * RMI constructor function for the class.
 */
sidlx_io_TxtIOStream
sidlx_io_TxtIOStream__createRemote(const char *, sidl_BaseInterface *_ex);

/**
 * RMI connector function for the class.
 */
sidlx_io_TxtIOStream
sidlx_io_TxtIOStream__connect(const char *, sidl_BaseInterface *_ex);
/**
 * <p>
