...
static void
sidlx_rmi_SimCall_queryInt__exec(
        struct sidlx_rmi_SimCall__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
...
static void
sidlx_rmi_SimCall_getClassName__exec(
        struct sidlx_rmi_SimCall__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
...
ior_sidlx_rmi_SimCall__exec(
  ...
  static const struct sidlx_rmi_SimCall__method  s_methods[] = {
    ...
    { "getClassName", sidlx_rmi_SimCall_getClassName__exec },
    ...
    { "queryInt", sidlx_rmi_SimCall_queryInt__exec },
...
static void sidlx_rmi_SimCall__init_epv(
  struct sidlx_rmi_SimCall__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                   = (void (*)(struct 
    sidlx_rmi_SimCall__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                = (void (*)(struct 
    sidlx_rmi_SimCall__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidlx_rmi_SimCall__object*,
    struct sidl_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                 = (struct sidl_BaseInterface__object* 
    (*)(struct sidlx_rmi_SimCall__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidlx_rmi_SimCall__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    sidlx_rmi_SimCall__object*)) s1->d_epv->f_getClassInfo;
  epv->f_init                     = NULL;
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidlx.rmi.SimCall");
...
static void
initMetadata(struct sidlx_rmi_SimCall__object* self)
{
  if (self) {
  ...
  struct sidlx_rmi_SimCall__object* self)
{
  ...
  if (!s_method_initialized) {
    sidlx_rmi_SimCall__init_epv(s0);
  }
  UNLOCK_STATIC_GLOBALS;
