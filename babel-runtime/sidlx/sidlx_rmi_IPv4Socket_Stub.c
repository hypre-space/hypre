...
#else
  _externals = (struct 
    sidlx_rmi_IPv4Socket__external*)sidl_dynamicLoadIOR("sidlx.rmi.IPv4Socket",
    "sidlx_rmi_IPv4Socket__externals") ;
#endif
  return _externals;
}
...
sidlx_rmi_IPv4Socket__create()
{
  return (*(_getExternals()->createObject))();
}

static sidlx_rmi_IPv4Socket sidlx_rmi_IPv4Socket__remote(const char* url,
...
{
  return sidlx_rmi_IPv4Socket__remote(url, _ex);
}

static struct sidlx_rmi_IPv4Socket__object* 
  sidlx_rmi_IPv4Socket__remoteConnect(const char* url, sidl_BaseInterface *_ex);
static struct sidlx_rmi_IPv4Socket__object* 
...
{
  return sidlx_rmi_IPv4Socket__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.IPv4Socket",
      (void*)sidlx_rmi_IPv4Socket__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
{
  return (struct 
    sidlx_rmi_IPv4Socket__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidlx_rmi_IPv4Socket__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidlx_rmi_IPv4Socket__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidlx_rmi_IPv4Socket__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidlx_rmi_IPv4Socket__array*)sidl_interface__array_create2dRow(m, n);
}
...
const char* name)
{
  ...
  else if(sidlx_rmi_IPv4Socket_isType(self, name)) {
...
remote_sidlx_rmi_IPv4Socket_addRef(
  /* in */ struct sidlx_rmi_IPv4Socket__object* self /* TLD */)
{
...
remote_sidlx_rmi_IPv4Socket_queryInt(
  /* in */ struct sidlx_rmi_IPv4Socket__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void sidlx_rmi_IPv4Socket__init_remote_epv(void)
{
  ...
  epv->f_queryInt               = remote_sidlx_rmi_IPv4Socket_queryInt;
...
static struct sidlx_rmi_IPv4Socket__object*
sidlx_rmi_IPv4Socket__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_IPv4Socket__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "sidlx.rmi.IPv4Socket", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidlx_rmi_IPv4Socket__object*) malloc(
      sizeof(struct sidlx_rmi_IPv4Socket__object));
