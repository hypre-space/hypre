...
struct sidl_BaseClass__object* skel_sidlx_rmi_SimpleServer_fcast_sidl_BaseClass(
...
struct sidl_ClassInfo__object* skel_sidlx_rmi_SimpleServer_fcast_sidl_ClassInfo(
  void* bi, sidl_BaseInterface *_ex) { 
