 ...
 */
  ...
  epv->f_getsockname              = (int32_t (*)(struct 
    sidlx_rmi_ServerSocket__object*,int32_t*,int32_t*,struct 
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidlx_rmi_ServerSocket__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidlx_rmi_ServerSocket__object*,const char*,struct 
  ...
  epv->f_readn                    = (int32_t (*)(struct 
    sidlx_rmi_ServerSocket__object*,int32_t,struct sidl_char__array**,struct 
  ...
  epv->f_readstring_alloc         = (int32_t (*)(struct 
    sidlx_rmi_ServerSocket__object*,struct sidl_char__array**,struct 
    sidl_BaseInterface__object **)) s1->f_readstring_alloc;
  epv->f_readint                  = (int32_t (*)(struct 
    sidlx_rmi_ServerSocket__object*,int32_t*,struct sidl_BaseInterface__object 
    **)) s1->f_readint;
...
static void
initMetadata(struct sidlx_rmi_ServerSocket__object* self, sidl_BaseInterface* 
  _ex)
{
