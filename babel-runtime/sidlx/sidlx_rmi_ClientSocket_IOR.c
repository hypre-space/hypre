...
sidlx_rmi_ClientSocket_init__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "hostname", &hostname, _ex);SIDL_CHECK(
    *_ex);
 ...
 */
  ...
  epv->f_getsockname              = (int32_t (*)(struct 
    sidlx_rmi_ClientSocket__object*,int32_t*,int32_t*,struct 
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidlx_rmi_ClientSocket__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidlx_rmi_ClientSocket__object*,const char*,struct 
  ...
  epv->f_readn                    = (int32_t (*)(struct 
    sidlx_rmi_ClientSocket__object*,int32_t,struct sidl_char__array**,struct 
  ...
  epv->f_readstring_alloc         = (int32_t (*)(struct 
    sidlx_rmi_ClientSocket__object*,struct sidl_char__array**,struct 
    sidl_BaseInterface__object **)) s1->f_readstring_alloc;
  epv->f_readint                  = (int32_t (*)(struct 
    sidlx_rmi_ClientSocket__object*,int32_t*,struct sidl_BaseInterface__object 
    **)) s1->f_readint;
...
void sidlx_rmi_ClientSocket__getEPVs(
  ...
  struct sidlx_rmi_ClientSocket__epv **s_arg_epv__sidlx_rmi_clientsocket,struct 
    sidlx_rmi_ClientSocket__epv **s_arg_epv_hooks__sidlx_rmi_clientsocket)
{
  LOCK_STATIC_GLOBALS;
...
static void
initMetadata(struct sidlx_rmi_ClientSocket__object* self, sidl_BaseInterface* 
  _ex)
{
...
sidlx_rmi_ClientSocket__new(void* ddata, struct sidl_BaseInterface__object ** 
  _ex)
{
  struct sidlx_rmi_ClientSocket__object* self =
