...
static void
sidlx_rmi_ClientSocket_queryInt__exec(
        struct sidlx_rmi_ClientSocket__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  ...
  const char* name)
{
  ...
  if (!strcmp(name, "sidlx.rmi.ClientSocket")) {
    cast = (void*) s0;
...
static void ior_sidlx_rmi_ClientSocket__delete(
  struct sidlx_rmi_ClientSocket__object* self)
{
  sidlx_rmi_ClientSocket__fini(self);
...
ior_sidlx_rmi_ClientSocket__exec(
  ...
  static const struct sidlx_rmi_ClientSocket__method  s_methods[] = {
    ...
    { "queryInt", sidlx_rmi_ClientSocket_queryInt__exec },
...
static void sidlx_rmi_ClientSocket__init_epv(
  struct sidlx_rmi_ClientSocket__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                   = (void (*)(struct 
    sidlx_rmi_ClientSocket__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                = (void (*)(struct 
    sidlx_rmi_ClientSocket__object*)) s1->d_epv->f_deleteRef;
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidlx_rmi_ClientSocket__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    sidlx_rmi_ClientSocket__object*)) s1->d_epv->f_getClassInfo;
...
sidlx_rmi_ClientSocket__new(void)
{
  ...
  sidlx_rmi_ClientSocket__init(self);
  initMetadata(self);
  return self;
}
  ...
  struct sidlx_rmi_ClientSocket__object* self)
{
  ...
  if (!s_method_initialized) {
    sidlx_rmi_ClientSocket__init_epv(s0);
  }
  UNLOCK_STATIC_GLOBALS;
