...
#define included_sidlx_rmi_ChildSocket_h
...
typedef struct sidlx_rmi_ChildSocket__object* sidlx_rmi_ChildSocket;
 ...
 */
struct sidlx_rmi_ChildSocket__object*
sidlx_rmi_ChildSocket__create(sidl_BaseInterface* _ex);
...
/**
 * Wraps up the private data struct pointer (struct sidlx_rmi_ChildSocket__data) passed in rather than running the constructor.
 */
sidlx_rmi_ChildSocket
sidlx_rmi_ChildSocket__wrapObj(void * data, sidl_BaseInterface *_ex);

/**
 * RMI connector function for the class.(addrefs)
 */
sidlx_rmi_ChildSocket
sidlx_rmi_ChildSocket__connect(const char *, sidl_BaseInterface *_ex);
...
SIDL_C_INLINE_DECL
void
sidlx_rmi_ChildSocket__raddRef(
  /* in */ sidlx_rmi_ChildSocket self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_C_HAS_INLINE
{
...
SIDL_C_INLINE_DECL
sidl_bool
sidlx_rmi_ChildSocket__isRemote(
  /* in */ sidlx_rmi_ChildSocket self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_C_HAS_INLINE
{
 ...
 */
sidl_bool
sidlx_rmi_ChildSocket__isLocal(
  /* in */ sidlx_rmi_ChildSocket self,
  /* out */ sidl_BaseInterface *_ex);
/**
...
#pragma weak sidlx_rmi_ChildSocket__connectI

#pragma weak sidlx_rmi_ChildSocket__rmicast
