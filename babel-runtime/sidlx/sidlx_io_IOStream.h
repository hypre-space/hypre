...
#define included_sidlx_io_IOStream_h
...
typedef struct sidlx_io_IOStream__object* sidlx_io_IOStream;
 ...
 */
sidlx_io_IOStream
sidlx_io_IOStream__connect(const char *, sidl_BaseInterface *_ex);
/**
 * <p>
