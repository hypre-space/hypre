  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  ...
  if (s_connect( sockfd, (struct sockaddr *) &(client_data.d_serv_addr), 
                 client_data.addrlen, _ex) < 0) {
...
struct sidl_BaseClass__object* impl_sidlx_rmi_ClientSocket_fcast_sidl_BaseClass(
...
struct sidl_ClassInfo__object* impl_sidlx_rmi_ClientSocket_fcast_sidl_ClassInfo(
  void* bi, sidl_BaseInterface* _ex) {
