...
sidlx_rmi_SimpleOrb
sidlx_rmi_SimpleOrb__create()
{
  return (*(_getExternals()->createObject))();
}

static sidlx_rmi_SimpleOrb sidlx_rmi_SimpleOrb__remote(const char* url,
...
{
  return sidlx_rmi_SimpleOrb__remote(url, _ex);
}

static struct sidlx_rmi_SimpleOrb__object* 
  sidlx_rmi_SimpleOrb__remoteConnect(const char* url, sidl_BaseInterface *_ex);
static struct sidlx_rmi_SimpleOrb__object* 
...
{
  return sidlx_rmi_SimpleOrb__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.SimpleOrb",
      (void*)sidlx_rmi_SimpleOrb__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  else if(sidlx_rmi_SimpleOrb_isType(self, name)) {
...
remote_sidlx_rmi_SimpleOrb_addRef(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self /* TLD */)
{
...
remote_sidlx_rmi_SimpleOrb_queryInt(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void
remote_sidlx_rmi_SimpleOrb_setPort(
  /* in */ struct sidlx_rmi_SimpleOrb__object* self /* TLD */,
  /* in */ int32_t port,
...
static struct sidlx_rmi_SimpleOrb__object*
sidlx_rmi_SimpleOrb__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_SimpleOrb__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "sidlx.rmi.SimpleOrb", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidlx_rmi_SimpleOrb__object*) malloc(
      sizeof(struct sidlx_rmi_SimpleOrb__object));
