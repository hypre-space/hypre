...
sidlx_rmi_JimEchoServer__create()
{
  return (*(_getExternals()->createObject))();
}

static sidlx_rmi_JimEchoServer sidlx_rmi_JimEchoServer__remote(const char* url,
...
{
  return sidlx_rmi_JimEchoServer__remote(url, _ex);
}

static struct sidlx_rmi_JimEchoServer__object* 
  sidlx_rmi_JimEchoServer__remoteConnect(const char* url,
  sidl_BaseInterface *_ex);
static struct sidlx_rmi_JimEchoServer__object* 
...
{
  return sidlx_rmi_JimEchoServer__remoteConnect(url, _ex);
}
...
sidl_BaseInterface
sidlx_rmi_JimEchoServer_queryInt(
  /* in */ sidlx_rmi_JimEchoServer self,
  /* in */ const char* name)
{
...
void
sidlx_rmi_JimEchoServer_setPort(
  /* in */ sidlx_rmi_JimEchoServer self,
  /* in */ int32_t port,
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.JimEchoServer",
      (void*)sidlx_rmi_JimEchoServer__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  else if(sidlx_rmi_JimEchoServer_isType(self, name)) {
...
remote_sidlx_rmi_JimEchoServer_addRef(
  /* in */ struct sidlx_rmi_JimEchoServer__object* self /* TLD */)
{
...
remote_sidlx_rmi_JimEchoServer_queryInt(
  /* in */ struct sidlx_rmi_JimEchoServer__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void
remote_sidlx_rmi_JimEchoServer_setPort(
  /* in */ struct sidlx_rmi_JimEchoServer__object* self /* TLD */,
  /* in */ int32_t port,
...
static void sidlx_rmi_JimEchoServer__init_remote_epv(void)
{
  ...
  struct sidlx_rmi_SimpleServer__epv*  e2  = &s_rem_epv__sidlx_rmi_simpleserver;
  ...
  epv->f_queryInt            = remote_sidlx_rmi_JimEchoServer_queryInt;
  epv->f_isType              = remote_sidlx_rmi_JimEchoServer_isType;
  epv->f_getClassInfo        = remote_sidlx_rmi_JimEchoServer_getClassInfo;
  epv->f_setPort             = remote_sidlx_rmi_JimEchoServer_setPort;
  epv->f_run                 = remote_sidlx_rmi_JimEchoServer_run;
  epv->f_serviceRequest      = remote_sidlx_rmi_JimEchoServer_serviceRequest;
  ...
  e2->f__cast          = (void* (*)(struct sidlx_rmi_SimpleServer__object*,
    const char*)) epv->f__cast;
  e2->f__delete        = (void (*)(struct sidlx_rmi_SimpleServer__object*)) 
    epv->f__delete;
  e2->f__exec          = (void (*)(struct sidlx_rmi_SimpleServer__object*,
    const char*,struct sidl_io_Deserializer__object*,
    struct sidl_io_Serializer__object*)) epv->f__exec;
  e2->f_addRef         = (void (*)(struct sidlx_rmi_SimpleServer__object*)) 
    epv->f_addRef;
  e2->f_deleteRef      = (void (*)(struct sidlx_rmi_SimpleServer__object*)) 
    epv->f_deleteRef;
  e2->f_isSame         = (sidl_bool (*)(struct sidlx_rmi_SimpleServer__object*,
    struct sidl_BaseInterface__object*)) epv->f_isSame;
  e2->f_queryInt       = (struct sidl_BaseInterface__object* (*)(struct 
    sidlx_rmi_SimpleServer__object*,const char*)) epv->f_queryInt;
  e2->f_isType         = (sidl_bool (*)(struct sidlx_rmi_SimpleServer__object*,
    const char*)) epv->f_isType;
...
static struct sidlx_rmi_JimEchoServer__object*
sidlx_rmi_JimEchoServer__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_JimEchoServer__object* self;
...
static struct sidlx_rmi_JimEchoServer__object*
sidlx_rmi_JimEchoServer__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_JimEchoServer__object* self;
