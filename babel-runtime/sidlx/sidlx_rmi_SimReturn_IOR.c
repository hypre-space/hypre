...
static void
sidlx_rmi_SimReturn_queryInt__exec(
        struct sidlx_rmi_SimReturn__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
...
static void ior_sidlx_rmi_SimReturn__delete(
  struct sidlx_rmi_SimReturn__object* self)
{
  sidlx_rmi_SimReturn__fini(self);
...
ior_sidlx_rmi_SimReturn__exec(
  ...
  static const struct sidlx_rmi_SimReturn__method  s_methods[] = {
    ...
    { "queryInt", sidlx_rmi_SimReturn_queryInt__exec }
  };
  int i, cmp, l = 0;
...
static void sidlx_rmi_SimReturn__init_epv(
  struct sidlx_rmi_SimReturn__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                   = (void (*)(struct 
    sidlx_rmi_SimReturn__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                = (void (*)(struct 
    sidlx_rmi_SimReturn__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidlx_rmi_SimReturn__object*,
    struct sidl_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                 = (struct sidl_BaseInterface__object* 
    (*)(struct sidlx_rmi_SimReturn__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidlx_rmi_SimReturn__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    sidlx_rmi_SimReturn__object*)) s1->d_epv->f_getClassInfo;
  epv->f_init                     = NULL;
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidlx.rmi.SimReturn");
...
static void
initMetadata(struct sidlx_rmi_SimReturn__object* self)
{
  if (self) {
...
sidlx_rmi_SimReturn__new(void)
{
  ...
  sidlx_rmi_SimReturn__init(self);
  initMetadata(self);
  return self;
}
  ...
  struct sidlx_rmi_SimReturn__object* self)
{
  ...
  if (!s_method_initialized) {
    sidlx_rmi_SimReturn__init_epv(s0);
  }
  UNLOCK_STATIC_GLOBALS;
