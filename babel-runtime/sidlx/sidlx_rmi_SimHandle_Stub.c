...
{
  return (struct 
    sidlx_rmi_SimHandle__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidlx_rmi_SimHandle__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidlx_rmi_SimHandle__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidlx_rmi_SimHandle__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct 
    sidlx_rmi_SimHandle__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidlx_rmi_SimHandle__array*)sidl_interface__array_create2dRow(m, n);
}
