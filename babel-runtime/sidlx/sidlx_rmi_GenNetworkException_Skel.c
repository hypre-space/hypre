...
struct sidl_BaseException__object* 
  ...
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidlx_rmi_GenNetworkException_fconnect_sidl_BaseException(url, ar,
    _ex);
}
...
struct sidl_BaseInterface__object* 
  ...
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidlx_rmi_GenNetworkException_fconnect_sidl_BaseInterface(url, ar,
    _ex);
}
...
struct sidl_SIDLException__object* 
  ...
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidlx_rmi_GenNetworkException_fconnect_sidl_SIDLException(url, ar,
    _ex);
}
...
struct sidl_io_Serializer__object* 
  ...
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidlx_rmi_GenNetworkException_fconnect_sidl_io_Serializer(url, ar,
    _ex);
}
