...
{
  return (struct sidlx_rmi_CallType__array*)sidl_int__array_create1d(len);
}
...
{
  return (struct sidlx_rmi_CallType__array*)sidl_int__array_create2dCol(m, n);
}
...
{
  return (struct sidlx_rmi_CallType__array*)sidl_int__array_create2dRow(m, n);
}
...
{
  return (struct sidlx_rmi_CallType__array*)sidl_int__array_borrow(
...
{
  return (struct sidlx_rmi_CallType__array*)
...
sidlx_rmi_CallType__array_get1(
  ...
  const int32_t i1)
{
  return (enum sidlx_rmi_CallType__enum)
