...
struct sidl_BaseClass__object* impl_sidlx_rmi_Simvocation_fcast_sidl_BaseClass(
...
struct sidl_ClassInfo__object* impl_sidlx_rmi_Simvocation_fcast_sidl_ClassInfo(
  void* bi, sidl_BaseInterface* _ex) {
