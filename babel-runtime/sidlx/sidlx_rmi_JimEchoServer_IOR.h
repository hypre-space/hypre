...
struct sidlx_rmi_JimEchoServer__controls {
  int     use_hooks;
};
/*
...
extern void sidlx_rmi_JimEchoServer__init(
  struct sidlx_rmi_JimEchoServer__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);
extern void sidlx_rmi_JimEchoServer__getEPVs(
  ...
  extern void sidlx_rmi_JimEchoServer__fini(
    struct sidlx_rmi_JimEchoServer__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void sidlx_rmi_JimEchoServer__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct sidl_BaseClass__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializable__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializable__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidl_io_Serializable(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_rmi_ServerInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_ServerInfo__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidl_rmi_ServerInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidlx_rmi_JimEchoServer__object* 
    skel_sidlx_rmi_JimEchoServer_fconnect_sidlx_rmi_JimEchoServer(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidlx_rmi_JimEchoServer__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidlx_rmi_JimEchoServer(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidlx_rmi_SimpleServer__object* 
    skel_sidlx_rmi_JimEchoServer_fconnect_sidlx_rmi_SimpleServer(const char* 
    url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidlx_rmi_SimpleServer__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidlx_rmi_SimpleServer(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidlx_rmi_Socket__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidlx_rmi_Socket__object* 
    skel_sidlx_rmi_JimEchoServer_fcast_sidlx_rmi_Socket(void *bi, struct 
    sidl_BaseInterface__object **_ex);

  struct sidlx_rmi_JimEchoServer__remote{
    int d_refcount;
