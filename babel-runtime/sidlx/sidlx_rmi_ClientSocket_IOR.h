...
extern void sidlx_rmi_ClientSocket__init(
  struct sidlx_rmi_ClientSocket__object* self, void* ddata,
    struct sidl_BaseInterface__object ** _ex);
extern void sidlx_rmi_ClientSocket__getEPVs(
  ...
  extern void sidlx_rmi_ClientSocket__fini(
    struct sidlx_rmi_ClientSocket__object* self,
      struct sidl_BaseInterface__object ** _ex);
  extern void sidlx_rmi_ClientSocket__IOR_version(int32_t *major,
    int32_t *minor);
  ...
  struct sidl_BaseClass__object* 
    skel_sidlx_rmi_ClientSocket_fcast_sidl_BaseClass(void *bi,
    struct sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidlx_rmi_ClientSocket_fcast_sidl_ClassInfo(void *bi,
    struct sidl_BaseInterface__object **_ex);
