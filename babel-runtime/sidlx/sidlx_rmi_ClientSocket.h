 ...
 */
struct sidlx_rmi_ClientSocket__object*
sidlx_rmi_ClientSocket__create(void);

/**
 * RMI constructor function for the class.
 */
sidlx_rmi_ClientSocket
sidlx_rmi_ClientSocket__createRemote(const char *, sidl_BaseInterface *_ex);
 ...
 */
sidl_BaseInterface
sidlx_rmi_ClientSocket_queryInt(
  /* in */ sidlx_rmi_ClientSocket self,
  /* in */ const char* name);
