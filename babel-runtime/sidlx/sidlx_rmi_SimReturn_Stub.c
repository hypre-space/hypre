...
#else
  _externals = (struct 
    sidlx_rmi_SimReturn__external*)sidl_dynamicLoadIOR("sidlx.rmi.SimReturn",
    "sidlx_rmi_SimReturn__externals") ;
...
static struct sidlx_rmi_SimReturn__object* 
  ...
  sidl_BaseInterface *_ex);
static struct sidlx_rmi_SimReturn__object* 
  sidlx_rmi_SimReturn__IHConnect(struct sidl_rmi_InstanceHandle__object* 
...
{
  return (struct 
    sidlx_rmi_SimReturn__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidlx_rmi_SimReturn__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidlx_rmi_SimReturn__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidlx_rmi_SimReturn__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct 
    sidlx_rmi_SimReturn__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidlx_rmi_SimReturn__array*)sidl_interface__array_create2dRow(m, n);
}
