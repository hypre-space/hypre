...
#define included_sidlx_io_IOException_h
...
typedef struct sidlx_io_IOException__object* sidlx_io_IOException;
 ...
 */
struct sidlx_io_IOException__object*
sidlx_io_IOException__create(void);

/**
 * RMI constructor function for the class.
 */
sidlx_io_IOException
sidlx_io_IOException__createRemote(const char *, sidl_BaseInterface *_ex);

/**
 * RMI connector function for the class.
 */
sidlx_io_IOException
sidlx_io_IOException__connect(const char *, sidl_BaseInterface *_ex);
/**
 * <p>
