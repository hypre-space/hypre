...
static void
sidlx_rmi_ChildSocket_queryInt__exec(
        struct sidlx_rmi_ChildSocket__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
...
sidlx_rmi_ChildSocket_init__exec(
  ...
  sidl_BaseInterface *_ex2 = &_ex;
  /* unpack in and inout argments */
  sidl_io_Deserializer_unpackInt( inArgs, "fileDes", &fileDes, _ex2);
...
static void ior_sidlx_rmi_ChildSocket__delete(
  struct sidlx_rmi_ChildSocket__object* self)
{
  sidlx_rmi_ChildSocket__fini(self);
...
ior_sidlx_rmi_ChildSocket__exec(
  ...
  static const struct sidlx_rmi_ChildSocket__method  s_methods[] = {
    ...
    { "queryInt", sidlx_rmi_ChildSocket_queryInt__exec },
...
static void sidlx_rmi_ChildSocket__init_epv(
  struct sidlx_rmi_ChildSocket__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                   = (void (*)(struct 
    sidlx_rmi_ChildSocket__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                = (void (*)(struct 
    sidlx_rmi_ChildSocket__object*)) s1->d_epv->f_deleteRef;
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidlx_rmi_ChildSocket__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    sidlx_rmi_ChildSocket__object*)) s1->d_epv->f_getClassInfo;
  epv->f_getsockname              = (int32_t (*)(struct 
    sidlx_rmi_ChildSocket__object*,int32_t*,int32_t*,
  ...
  epv->f_readn                    = (int32_t (*)(struct 
    sidlx_rmi_ChildSocket__object*,int32_t,struct sidl_char__array**,
  ...
  epv->f_readstring_alloc         = (int32_t (*)(struct 
    sidlx_rmi_ChildSocket__object*,struct sidl_char__array**,
    struct sidl_BaseInterface__object **)) s1->d_epv->f_readstring_alloc;
  epv->f_readint                  = (int32_t (*)(struct 
    sidlx_rmi_ChildSocket__object*,int32_t*,
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidlx.rmi.ChildSocket");
...
static void
initMetadata(struct sidlx_rmi_ChildSocket__object* self)
{
  if (self) {
...
sidlx_rmi_ChildSocket__new(void)
{
  ...
  sidlx_rmi_ChildSocket__init(self);
  initMetadata(self);
  return self;
}
  ...
  struct sidlx_rmi_ChildSocket__object* self)
{
  ...
  if (!s_method_initialized) {
    sidlx_rmi_ChildSocket__init_epv(s0);
  }
  UNLOCK_STATIC_GLOBALS;
