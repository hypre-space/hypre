...
static struct sidlx_rmi_Simvocation__epv s_new_epv_hooks__sidlx_rmi_simvocation;
...
static struct sidl_rmi_Invocation__epv s_new_epv_hooks__sidl_rmi_invocation;
 ...
 */
  ...
  struct sidlx_rmi_Simvocation__epv*  hepv = 
    &s_new_epv_hooks__sidlx_rmi_simvocation;
  ...
  struct sidl_io_Serializer__epv*     he2  = 
    &s_new_epv_hooks__sidl_io_serializer;
  struct sidl_rmi_Invocation__epv*    e3   = &s_new_epv__sidl_rmi_invocation;
  struct sidl_rmi_Invocation__epv*    he3  = 
    &s_new_epv_hooks__sidl_rmi_invocation;
  ...
  epv->f_isSame                     = (sidl_bool (*)(struct 
    sidlx_rmi_Simvocation__object*,struct sidl_BaseInterface__object*,
    struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                     = (sidl_bool (*)(struct 
    sidlx_rmi_Simvocation__object*,const char*,
  ...
  memcpy((void*)hepv, epv, sizeof(struct sidlx_rmi_Simvocation__epv));
  ...
  memcpy((void*) he3, e3, sizeof(struct sidl_rmi_Invocation__epv));
    ...
    struct sidlx_rmi_Simvocation__epv **s_arg_epv_hooks__sidlx_rmi_simvocation)
{
  ...
  *s_arg_epv__sidl_rmi_invocation = &s_new_epv__sidl_rmi_invocation;
  *s_arg_epv_hooks__sidl_rmi_invocation = &s_new_epv_hooks__sidl_rmi_invocation;
  *s_arg_epv__sidlx_rmi_simvocation = &s_new_epv__sidlx_rmi_simvocation;
  *s_arg_epv_hooks__sidlx_rmi_simvocation = 
    &s_new_epv_hooks__sidlx_rmi_simvocation;
}
/*
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_sidlx_rmi_Simvocation__set_hooks(s0, FALSE, _ex);
