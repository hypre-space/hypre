...
extern void sidlx_rmi_Simvocation__getEPVs(
  ...
  extern void sidlx_rmi_Simvocation__fini(
    struct sidlx_rmi_Simvocation__object* self, struct 
      sidl_BaseInterface__object ** _ex);
  extern void sidlx_rmi_Simvocation__IOR_version(int32_t *major, int32_t 
    *minor);
  ...
  struct sidl_BaseClass__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_BaseClass(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_BaseInterface__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_BaseInterface__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_BaseInterface(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_ClassInfo__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_ClassInfo__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_ClassInfo(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_RuntimeException__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_RuntimeException__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_RuntimeException(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializable__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializable__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_io_Serializable(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_io_Serializer__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializer__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_io_Serializer(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_rmi_Invocation__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_Invocation__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_rmi_Invocation(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_rmi_Response__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_Response__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_rmi_Response(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidl_rmi_Ticket__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_Ticket__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidl_rmi_Ticket(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidlx_rmi_Simvocation__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidlx_rmi_Simvocation__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidlx_rmi_Simvocation(void *bi, struct 
    sidl_BaseInterface__object **_ex);
  ...
  struct sidlx_rmi_Socket__object* 
    ...
    sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidlx_rmi_Socket__object* 
    skel_sidlx_rmi_Simvocation_fcast_sidlx_rmi_Socket(void *bi, struct 
    sidl_BaseInterface__object **_ex);
