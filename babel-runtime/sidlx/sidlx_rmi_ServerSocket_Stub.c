...
#else
  _externals = (struct 
    sidlx_rmi_ServerSocket__external*)sidl_dynamicLoadIOR(
...
sidlx_rmi_ServerSocket__create()
{
  return (*(_getExternals()->createObject))();
}

static sidlx_rmi_ServerSocket sidlx_rmi_ServerSocket__remote(const char* url,
...
{
  return sidlx_rmi_ServerSocket__remote(url, _ex);
}

static struct sidlx_rmi_ServerSocket__object* 
  sidlx_rmi_ServerSocket__remoteConnect(const char* url,
  sidl_BaseInterface *_ex);
static struct sidlx_rmi_ServerSocket__object* 
...
{
  return sidlx_rmi_ServerSocket__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.ServerSocket",
      (void*)sidlx_rmi_ServerSocket__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
{
  return (struct 
    sidlx_rmi_ServerSocket__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidlx_rmi_ServerSocket__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidlx_rmi_ServerSocket__array*)sidl_interface__array_create1d(len);
}
...
const char* name)
{
  ...
  else if(sidlx_rmi_ServerSocket_isType(self, name)) {
...
remote_sidlx_rmi_ServerSocket_addRef(
  /* in */ struct sidlx_rmi_ServerSocket__object* self /* TLD */)
{
...
remote_sidlx_rmi_ServerSocket_queryInt(
  /* in */ struct sidlx_rmi_ServerSocket__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
  ...
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  struct sidlx_rmi_Socket__object* _retval = NULL;
  ...
  _retval = sidlx_rmi_Socket__connect(_retval_str, _ex2);
...
static void sidlx_rmi_ServerSocket__init_remote_epv(void)
{
  ...
  epv->f_queryInt               = remote_sidlx_rmi_ServerSocket_queryInt;
...
static struct sidlx_rmi_ServerSocket__object*
sidlx_rmi_ServerSocket__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_ServerSocket__object* self;
...
static struct sidlx_rmi_ServerSocket__object*
sidlx_rmi_ServerSocket__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_ServerSocket__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "sidlx.rmi.ServerSocket",
    _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidlx_rmi_ServerSocket__object*) malloc(
