...
sidlx_rmi_ClientSocket__create()
{
  return (*(_getExternals()->createObject))();
}

static sidlx_rmi_ClientSocket sidlx_rmi_ClientSocket__remote(const char* url,
...
{
  return sidlx_rmi_ClientSocket__remote(url, _ex);
}

static struct sidlx_rmi_ClientSocket__object* 
  sidlx_rmi_ClientSocket__remoteConnect(const char* url,
  sidl_BaseInterface *_ex);
static struct sidlx_rmi_ClientSocket__object* 
...
{
  return sidlx_rmi_ClientSocket__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.ClientSocket",
      (void*)sidlx_rmi_ClientSocket__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  else if(sidlx_rmi_ClientSocket_isType(self, name)) {
...
remote_sidlx_rmi_ClientSocket_addRef(
  /* in */ struct sidlx_rmi_ClientSocket__object* self /* TLD */)
{
...
remote_sidlx_rmi_ClientSocket_queryInt(
  /* in */ struct sidlx_rmi_ClientSocket__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
  ...
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  ...
  /* pack in and inout arguments */
  sidl_rmi_Invocation_packString( _inv, "hostname", hostname, _ex2);
  sidl_rmi_Invocation_packInt( _inv, "port", port, _ex2);
...
static void sidlx_rmi_ClientSocket__init_remote_epv(void)
{
  ...
  epv->f_queryInt               = remote_sidlx_rmi_ClientSocket_queryInt;
...
static struct sidlx_rmi_ClientSocket__object*
sidlx_rmi_ClientSocket__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_ClientSocket__object* self;
...
static struct sidlx_rmi_ClientSocket__object*
sidlx_rmi_ClientSocket__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidlx_rmi_ClientSocket__object* self;
