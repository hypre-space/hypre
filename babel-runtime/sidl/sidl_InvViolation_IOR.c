...
static void
sidl_InvViolation_queryInt__exec(
        struct sidl_InvViolation__object* self,
        struct sidl_io_Deserializer__object* inArgs,
        struct sidl_io_Serializer__object* outArgs) {
  /* stack space for arguments */
  ...
  const char* name)
{
  ...
  if (!strcmp(name, "sidl.InvViolation")) {
    cast = (void*) s0;
...
ior_sidl_InvViolation__exec(
  ...
  static const struct sidl_InvViolation__method  s_methods[] = {
    ...
    { "queryInt", sidl_InvViolation_queryInt__exec },
...
static void sidl_InvViolation__init_epv(
  struct sidl_InvViolation__object* self)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  epv->f_addRef                   = (void (*)(struct 
    sidl_InvViolation__object*)) s1->d_epv->f_addRef;
  epv->f_deleteRef                = (void (*)(struct 
    sidl_InvViolation__object*)) s1->d_epv->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_InvViolation__object*,
    struct sidl_BaseInterface__object*)) s1->d_epv->f_isSame;
  epv->f_queryInt                 = (struct sidl_BaseInterface__object* 
    (*)(struct sidl_InvViolation__object*,const char*)) s1->d_epv->f_queryInt;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_InvViolation__object*,const char*)) s1->d_epv->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    sidl_InvViolation__object*)) s1->d_epv->f_getClassInfo;
  epv->f_getNote                  = (char* (*)(struct 
    sidl_InvViolation__object*)) s1->d_epv->f_getNote;
  epv->f_setNote                  = (void (*)(struct sidl_InvViolation__object*,
    const char*)) s1->d_epv->f_setNote;
  epv->f_getTrace                 = (char* (*)(struct 
    sidl_InvViolation__object*)) s1->d_epv->f_getTrace;
  epv->f_addLine                  = (void (*)(struct sidl_InvViolation__object*,
    const char*)) s1->d_epv->f_addLine;
  epv->f_add                      = (void (*)(struct sidl_InvViolation__object*,
    const char*,int32_t,const char*)) s1->d_epv->f_add;
...
initClassInfo(sidl_ClassInfo *info)
{
  ...
  if (s_classInfo_init) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidl.InvViolation");
...
static void
initMetadata(struct sidl_InvViolation__object* self)
{
  if (self) {
  ...
  struct sidl_InvViolation__object* self)
{
  ...
  if (!s_method_initialized) {
    sidl_InvViolation__init_epv(s0);
  }
  UNLOCK_STATIC_GLOBALS;
