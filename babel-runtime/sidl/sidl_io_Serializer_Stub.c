...
static struct sidl_io_Serializer__object* sidl_io_Serializer__remoteConnect(
...
{
  return sidl_io_Serializer__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.io.Serializer", (
      void*)sidl_io_Serializer__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
sidl_io_Serializer__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_io_Serializer__isRemote(self,_ex);
}
...
sidl_io_Serializer__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct sidl_io_Serializer__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
sidl_io_Serializer__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct sidl_io_Serializer__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct sidl_io_Serializer__array*)sidl_interface__array_create1dInit(
