...
struct sidl_io_Deserializer__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_rmi_ObjectDoesNotExistException_fconnect_sidl_io_Deserializer(url,
    ar, _ex);
}
...
struct sidl_io_Serializable__object* 
  skel_sidl_rmi_ObjectDoesNotExistException_fconnect_sidl_io_Serializable(const 
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_rmi_ObjectDoesNotExistException_fconnect_sidl_io_Serializable(url,
    ar, _ex);
}
