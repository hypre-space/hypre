/*
 * File:          sidl_rmi_BindException_Stub.c
...
static const struct sidl_rmi_BindException__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_rmi_BindException__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_rmi_BindException__externals();
  return _externals;
}
...
sidl_rmi_BindException
sidl_rmi_BindException__create(sidl_BaseInterface* _ex)
{
  return (*(_getExternals()->createObject))(NULL,_ex);
}

static sidl_rmi_BindException sidl_rmi_BindException__remoteCreate(const char* 
...
sidl_rmi_BindException
sidl_rmi_BindException__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_BindException__remoteCreate(url, _ex);
}

static struct sidl_rmi_BindException__object* 
  sidl_rmi_BindException__remoteConnect(const char* url, sidl_bool ar, 
  sidl_BaseInterface *_ex);
static struct sidl_rmi_BindException__object* sidl_rmi_BindException__IHConnect(
...
sidl_rmi_BindException
sidl_rmi_BindException__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_BindException__remoteConnect(url, TRUE, _ex);
}
...
SIDL_C_INLINE_DEFN
int32_t
sidl_rmi_BindException_getHopCount(
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_BindException_deleteRef(
  /* in */ sidl_rmi_BindException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
sidl_ClassInfo
sidl_rmi_BindException_getClassInfo(
  /* in */ sidl_rmi_BindException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
char*
sidl_rmi_BindException_getNote(
  /* in */ sidl_rmi_BindException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_BindException_setNote(
  /* in */ sidl_rmi_BindException self,
...
SIDL_C_INLINE_DEFN
char*
sidl_rmi_BindException_getTrace(
  /* in */ sidl_rmi_BindException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_BindException_addLine(
  /* in */ sidl_rmi_BindException self,
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_BindException_packObj(
  /* in */ sidl_rmi_BindException self,
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_BindException_unpackObj(
  /* in */ sidl_rmi_BindException self,
...
sidl_rmi_BindException
sidl_rmi_BindException__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidl_rmi_BindException cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.BindException", (
      void*)sidl_rmi_BindException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_rmi_BindException) (*base->d_epv->f__cast)(
      base->d_object,
...
SIDL_C_INLINE_DEFN
char*
sidl_rmi_BindException__getURL(
  /* in */ sidl_rmi_BindException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_BindException__raddRef(
  /* in */ sidl_rmi_BindException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_BindException__set_hooks(
  /* in */ sidl_rmi_BindException self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
SIDL_C_INLINE_DEFN
sidl_bool
sidl_rmi_BindException__isRemote(
  /* in */ sidl_rmi_BindException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_bool
sidl_rmi_BindException__isLocal(
  /* in */ sidl_rmi_BindException self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_BindException__isRemote(self,_ex);
}
 ...
 * NULL.
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_rmi_BindException__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_rmi_BindException__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_create1d(int32_t len)
{
  return (struct sidl_rmi_BindException__array*)sidl_interface__array_create1d(
    len);
}
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_create1dInit(
  int32_t len, 
  sidl_rmi_BindException* data)
{
  return (struct 
    sidl_rmi_BindException__array*)sidl_interface__array_create1dInit(len, (
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_create2dCol(int32_t m, int32_t n)
{
  return (struct 
    sidl_rmi_BindException__array*)sidl_interface__array_create2dCol(m, n);
}
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_create2dRow(int32_t m, int32_t n)
{
  return (struct 
    sidl_rmi_BindException__array*)sidl_interface__array_create2dRow(m, n);
}
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_borrow(
  sidl_rmi_BindException* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_rmi_BindException__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_smartCopy(
  struct sidl_rmi_BindException__array *array)
{
  return (struct sidl_rmi_BindException__array*)
 ...
 */
void
sidl_rmi_BindException__array_addRef(
  struct sidl_rmi_BindException__array* array)
{
 ...
 */
void
sidl_rmi_BindException__array_deleteRef(
  struct sidl_rmi_BindException__array* array)
{
 ...
 */
sidl_rmi_BindException
sidl_rmi_BindException__array_get1(
  const struct sidl_rmi_BindException__array* array,
  const int32_t i1)
{
  return (sidl_rmi_BindException)
 ...
 */
sidl_rmi_BindException
sidl_rmi_BindException__array_get2(
  const struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2)
{
 ...
 */
sidl_rmi_BindException
sidl_rmi_BindException__array_get3(
  const struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3)
 ...
 */
sidl_rmi_BindException
sidl_rmi_BindException__array_get4(
  const struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_rmi_BindException
sidl_rmi_BindException__array_get5(
  const struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_rmi_BindException
sidl_rmi_BindException__array_get6(
  const struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_rmi_BindException
sidl_rmi_BindException__array_get7(
  const struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_rmi_BindException
sidl_rmi_BindException__array_get(
  const struct sidl_rmi_BindException__array* array,
 ...
 */
void
sidl_rmi_BindException__array_set1(
  struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  sidl_rmi_BindException const value)
{
 ...
 */
void
sidl_rmi_BindException__array_set2(
  struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  sidl_rmi_BindException const value)
 ...
 */
void
sidl_rmi_BindException__array_set3(
  struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_BindException__array_set4(
  struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_BindException__array_set5(
  struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_BindException__array_set6(
  struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_BindException__array_set7(
  struct sidl_rmi_BindException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_rmi_BindException__array_set(
  struct sidl_rmi_BindException__array* array,
  const int32_t indices[],
  sidl_rmi_BindException const value)
{
 ...
 */
int32_t
sidl_rmi_BindException__array_dimen(
  const struct sidl_rmi_BindException__array* array)
{
 ...
 */
int32_t
sidl_rmi_BindException__array_lower(
  const struct sidl_rmi_BindException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_rmi_BindException__array_upper(
  const struct sidl_rmi_BindException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_rmi_BindException__array_length(
  const struct sidl_rmi_BindException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_rmi_BindException__array_stride(
  const struct sidl_rmi_BindException__array* array,
  const int32_t ind)
{
 ...
 */
int
sidl_rmi_BindException__array_isColumnOrder(
  const struct sidl_rmi_BindException__array* array)
{
 ...
 */
int
sidl_rmi_BindException__array_isRowOrder(
  const struct sidl_rmi_BindException__array* array)
{
 ...
 */
void
sidl_rmi_BindException__array_copy(
  const struct sidl_rmi_BindException__array* src,
  struct sidl_rmi_BindException__array* dest)
{
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_slice(
  struct sidl_rmi_BindException__array* src,
  int32_t        dimen,
 ...
 */
struct sidl_rmi_BindException__array*
sidl_rmi_BindException__array_ensure(
  struct sidl_rmi_BindException__array* src,
  int32_t dimen,
  int     ordering)
{
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    if (!cmp1) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = ((struct sidl_rmi_BindException__object*)self);
      return cast;
    }
    else if (cmp1 < 0) {
...
sidl_rmi_BindException__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "sidl.rmi.BindException", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_rmi_BindException__object*) malloc(
      sizeof(struct sidl_rmi_BindException__object));
