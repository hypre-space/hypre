...
extern struct sidl_BaseClass__object* 
  impl_sidl_PostViolation_fcast_sidl_BaseClass(void* bi, sidl_BaseInterface* 
  _ex);
...
extern struct sidl_ClassInfo__object* 
  ...
  sidl_BaseInterface *_ex);
extern struct sidl_ClassInfo__object* 
  impl_sidl_PostViolation_fcast_sidl_ClassInfo(void* bi, sidl_BaseInterface* 
  _ex);
...
struct sidl_BaseClass__object* skel_sidl_PostViolation_fconnect_sidl_BaseClass(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_PostViolation_fconnect_sidl_BaseClass(url, ar, _ex);
}

struct sidl_BaseClass__object* skel_sidl_PostViolation_fcast_sidl_BaseClass(
...
struct sidl_BaseException__object* 
  skel_sidl_PostViolation_fcast_sidl_BaseException(void* bi, sidl_BaseInterface 
  *_ex) { 
...
struct sidl_BaseInterface__object* 
  skel_sidl_PostViolation_fcast_sidl_BaseInterface(void* bi, sidl_BaseInterface 
  *_ex) { 
  return impl_sidl_PostViolation_fcast_sidl_BaseInterface(bi, _ex);
}

struct sidl_ClassInfo__object* skel_sidl_PostViolation_fconnect_sidl_ClassInfo(
  const char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_PostViolation_fconnect_sidl_ClassInfo(url, ar, _ex);
}

struct sidl_ClassInfo__object* skel_sidl_PostViolation_fcast_sidl_ClassInfo(
  void* bi, sidl_BaseInterface *_ex) { 
...
struct sidl_PostViolation__object* 
  skel_sidl_PostViolation_fcast_sidl_PostViolation(void* bi, sidl_BaseInterface 
  *_ex) { 
...
struct sidl_SIDLException__object* 
  skel_sidl_PostViolation_fcast_sidl_SIDLException(void* bi, sidl_BaseInterface 
  *_ex) { 
...
struct sidl_io_Serializer__object* 
  skel_sidl_PostViolation_fcast_sidl_io_Serializer(void* bi, sidl_BaseInterface 
  *_ex) { 
