...
SIDL_opaque__array_sdestroy(struct SIDL_opaque__array* array)
{
  if (array) {
    ...
    if (*orig) {
      SIDL_opaque__array_deleteReference(*orig);
      *orig = NULL;
    }
    SIDL_opaque__array_bdestroy(array);
  }
...
{
  SIDL_opaque__array_addReference(array);
  return array;
}
         ...
         struct SIDL_opaque__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    SIDL_opaque__array_addReference(orig);
 ...
 */
void
SIDL_opaque__array_addReference(struct SIDL_opaque__array* array)
{
  if (array) {
    ++(array->d_refcount);
  }
 ...
 */
void
SIDL_opaque__array_deleteReference(struct SIDL_opaque__array* array)
{
  ...
  if (src && (src->d_dimen == dimen)) {
    ...
    case SIDL_column_major_order:
      if (SIDL_opaque__array_isColumnOrder(src)) {
        SIDL_opaque__array_addReference(src);
        result = src;
      }
      else {
