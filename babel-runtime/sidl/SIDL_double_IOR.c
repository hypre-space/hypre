...
SIDL_double__array_sdestroy(struct SIDL_double__array* array)
{
  if (array) {
    ...
    if (*orig) {
      SIDL_double__array_deleteReference(*orig);
      *orig = NULL;
    }
    SIDL_double__array_bdestroy(array);
  }
...
{
  SIDL_double__array_addReference(array);
  return array;
}
...
SIDL_double__array_borrowSmartCp(struct SIDL_double__array* array)
{
  ...
  if (array) {
    if (SIDL_double__array_isColumnOrder(array)) {
      copy = SIDL_double__array_createCol(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
    else {
      copy = SIDL_double__array_createRow(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
...
static const struct SIDL_double__vtable normal_double_vtable = {
  SIDL_double__array_destroy,
...
static const struct SIDL_double__vtable borrowed_double_vtable = {
  SIDL_double__array_bdestroy,
...
static const struct SIDL_double__vtable sliced_double_vtable = {
  SIDL_double__array_sdestroy,
  SIDL_double__array_smartCp
};
/**
...
static const struct SIDL_double__vtable bsliced_double_vtable = {
  SIDL_double__array_sdestroy,
  SIDL_double__array_borrowSmartCp
};
/**
         ...
         struct SIDL_double__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    SIDL_double__array_addReference(orig);
    result->d_vtable = &sliced_double_vtable;
  }
  else {
    result->d_vtable = &normal_double_vtable;
  }
  ...
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_vtable->d_smartcopy ==
        ...
        result->d_vtable = &bsliced_double_vtable;
      }
    }
  }
  return result;
                          ...
                          const int32_t  stride[])
{
  ...
  result->d_vtable = &borrowed_double_vtable;
  return result;
}
 ...
 */
void
SIDL_double__array_addReference(struct SIDL_double__array* array)
{
  if (array) {
    ++(array->d_refcount);
  }
 ...
 */
void
SIDL_double__array_deleteReference(struct SIDL_double__array* array)
{
  ...
  if (src && (src->d_dimen == dimen)) {
    ...
    case SIDL_column_major_order:
      if (SIDL_double__array_isColumnOrder(src)) {
        SIDL_double__array_addReference(src);
        result = src;
      }
      else {
