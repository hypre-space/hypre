/*
 * File:          sidl_RuntimeException_Stub.c
...
static struct sidl_RuntimeException__object* sidl_RuntimeException__IHConnect(
  struct sidl_rmi_InstanceHandle__object* instance, sidl_BaseInterface *_ex);
/*
 * RMI connector function for the class.
 */

sidl_RuntimeException
sidl_RuntimeException__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_RuntimeException__remoteConnect(url, TRUE, _ex);
}
...
SIDL_C_INLINE_DEFN
char*
sidl_RuntimeException_getNote(
  /* in */ sidl_RuntimeException self,
...
SIDL_C_INLINE_DEFN
char*
sidl_RuntimeException_getTrace(
  /* in */ sidl_RuntimeException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
void
sidl_RuntimeException_unpackObj(
  /* in */ sidl_RuntimeException self,
...
SIDL_C_INLINE_DEFN
void
sidl_RuntimeException_deleteRef(
  /* in */ sidl_RuntimeException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
sidl_ClassInfo
sidl_RuntimeException_getClassInfo(
  /* in */ sidl_RuntimeException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_RuntimeException
sidl_RuntimeException__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidl_RuntimeException cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.RuntimeException", (
      void*)sidl_RuntimeException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_RuntimeException) (*base->d_epv->f__cast)(
      base->d_object,
...
SIDL_C_INLINE_DEFN
void
sidl_RuntimeException__raddRef(
  /* in */ sidl_RuntimeException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
SIDL_C_INLINE_DEFN
void
sidl_RuntimeException__set_hooks(
  /* in */ sidl_RuntimeException self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
SIDL_C_INLINE_DEFN
sidl_bool
sidl_RuntimeException__isRemote(
  /* in */ sidl_RuntimeException self,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
{
...
sidl_bool
sidl_RuntimeException__isLocal(
  /* in */ sidl_RuntimeException self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_RuntimeException__isRemote(self,_ex);
}
...
sidl_RuntimeException__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_RuntimeException__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_RuntimeException__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_create1d(int32_t len)
{
  return (struct sidl_RuntimeException__array*)sidl_interface__array_create1d(
    len);
}
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_create1dInit(
  int32_t len, 
  sidl_RuntimeException* data)
{
  return (struct 
    sidl_RuntimeException__array*)sidl_interface__array_create1dInit(len, (
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_create2dCol(int32_t m, int32_t n)
{
  return (struct 
    sidl_RuntimeException__array*)sidl_interface__array_create2dCol(m, n);
}
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_create2dRow(int32_t m, int32_t n)
{
  return (struct 
    sidl_RuntimeException__array*)sidl_interface__array_create2dRow(m, n);
}
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_borrow(
  sidl_RuntimeException* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_RuntimeException__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_smartCopy(
  struct sidl_RuntimeException__array *array)
{
  return (struct sidl_RuntimeException__array*)
 ...
 */
void
sidl_RuntimeException__array_addRef(
  struct sidl_RuntimeException__array* array)
{
 ...
 */
void
sidl_RuntimeException__array_deleteRef(
  struct sidl_RuntimeException__array* array)
{
 ...
 */
sidl_RuntimeException
sidl_RuntimeException__array_get1(
  const struct sidl_RuntimeException__array* array,
  const int32_t i1)
{
  return (sidl_RuntimeException)
 ...
 */
sidl_RuntimeException
sidl_RuntimeException__array_get2(
  const struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2)
{
 ...
 */
sidl_RuntimeException
sidl_RuntimeException__array_get3(
  const struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3)
 ...
 */
sidl_RuntimeException
sidl_RuntimeException__array_get4(
  const struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_RuntimeException
sidl_RuntimeException__array_get5(
  const struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_RuntimeException
sidl_RuntimeException__array_get6(
  const struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_RuntimeException
sidl_RuntimeException__array_get7(
  const struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_RuntimeException
sidl_RuntimeException__array_get(
  const struct sidl_RuntimeException__array* array,
 ...
 */
void
sidl_RuntimeException__array_set1(
  struct sidl_RuntimeException__array* array,
  const int32_t i1,
  sidl_RuntimeException const value)
{
 ...
 */
void
sidl_RuntimeException__array_set2(
  struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  sidl_RuntimeException const value)
 ...
 */
void
sidl_RuntimeException__array_set3(
  struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_RuntimeException__array_set4(
  struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_RuntimeException__array_set5(
  struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_RuntimeException__array_set6(
  struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_RuntimeException__array_set7(
  struct sidl_RuntimeException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_RuntimeException__array_set(
  struct sidl_RuntimeException__array* array,
  const int32_t indices[],
  sidl_RuntimeException const value)
{
 ...
 */
int32_t
sidl_RuntimeException__array_dimen(
  const struct sidl_RuntimeException__array* array)
{
 ...
 */
int32_t
sidl_RuntimeException__array_lower(
  const struct sidl_RuntimeException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_RuntimeException__array_upper(
  const struct sidl_RuntimeException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_RuntimeException__array_length(
  const struct sidl_RuntimeException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_RuntimeException__array_stride(
  const struct sidl_RuntimeException__array* array,
  const int32_t ind)
{
 ...
 */
int
sidl_RuntimeException__array_isColumnOrder(
  const struct sidl_RuntimeException__array* array)
{
 ...
 */
int
sidl_RuntimeException__array_isRowOrder(
  const struct sidl_RuntimeException__array* array)
{
 ...
 */
void
sidl_RuntimeException__array_copy(
  const struct sidl_RuntimeException__array* src,
  struct sidl_RuntimeException__array* dest)
{
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_slice(
  struct sidl_RuntimeException__array* src,
  int32_t        dimen,
 ...
 */
struct sidl_RuntimeException__array*
sidl_RuntimeException__array_ensure(
  struct sidl_RuntimeException__array* src,
  int32_t dimen,
  int     ordering)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp0) {
    ...
    if (!cmp1) {
      ...
      if (!cmp2) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = ((struct sidl__RuntimeException__object*)self);
        return cast;
      }
    }
  }
...
static void sidl__RuntimeException__init_remote_epv(void)
{
  ...
  e2->f__exec        = (void (*)(void*,const char*,struct 
    sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
    sidl_BaseInterface__object **)) epv->f__exec;
  e2->f_getNote      = (char* (*)(void*,struct sidl_BaseInterface__object **)) 
    epv->f_getNote;
  e2->f_setNote      = (void (*)(void*,const char*,struct 
    sidl_BaseInterface__object **)) epv->f_setNote;
  e2->f_getTrace     = (char* (*)(void*,struct sidl_BaseInterface__object **)) 
    epv->f_getTrace;
  e2->f_addLine      = (void (*)(void*,const char*,struct 
    sidl_BaseInterface__object **)) epv->f_addLine;
  e2->f_add          = (void (*)(void*,const char*,int32_t,const char*,struct 
    sidl_BaseInterface__object **)) epv->f_add;
