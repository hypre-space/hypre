...
static struct sidl_rmi_Invocation__object* 
  sidl_rmi_Invocation__remoteConnect(const char* url, sidl_BaseInterface *_ex);
static struct sidl_rmi_Invocation__object* 
...
{
  return sidl_rmi_Invocation__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.Invocation",
      (void*)sidl_rmi_Invocation__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
{
  return (struct 
    sidl_rmi_Invocation__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_rmi_Invocation__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_rmi_Invocation__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidl_rmi_Invocation__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct 
    sidl_rmi_Invocation__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidl_rmi_Invocation__array*)sidl_interface__array_create2dRow(m, n);
}
...
const char* name)
{
  ...
  if (!strcmp(name, "sidl.rmi._Invocation")) {
    cast = (void*) s0;
...
remote_sidl_rmi__Invocation_addRef(
  /* in */ struct sidl_rmi__Invocation__object* self /* TLD */)
{
...
remote_sidl_rmi__Invocation_queryInt(
  /* in */ struct sidl_rmi__Invocation__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void sidl_rmi__Invocation__init_remote_epv(void)
{
  ...
  epv->f_queryInt          = remote_sidl_rmi__Invocation_queryInt;
...
sidl_rmi_Invocation__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  ...
  return sidl_rmi_Invocation__cast(self);
}
