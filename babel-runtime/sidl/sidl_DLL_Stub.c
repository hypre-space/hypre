...
static sidl_DLL sidl_DLL__remoteCreate(const char* url, sidl_BaseInterface 
  *_ex);
/*
...
{
  return sidl_DLL__remoteCreate(url, _ex);
}
...
{
  return sidl_DLL__remoteConnect(url, TRUE, _ex);
}
...
{
  sidl_bool _result;
  _result = (*self->d_epv->f_loadLibrary)(
    self,
    uri,
    loadGlobally,
    loadLazy,
...
{
  void* _result;
  _result = (*self->d_epv->f_lookupSymbol)(
    self,
    linker_name,
    _ex);
  return _result;
...
#if SIDL_C_INLINE_REPEAT_DEFN
{
  sidl_BaseClass _result;
  _result = (*self->d_epv->f_createClass)(
    self,
    sidl_name,
    _ex);
  return _result;
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.DLL", (
      void*)sidl_DLL__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
sidl_DLL__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_DLL__isRemote(self,_ex);
}
  ...
  *_ex = NULL;
  {
    ...
    sidl_rmi_Invocation_packBool( _inv, "loadGlobally", loadGlobally, 
      _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Invocation_packBool( _inv, "loadLazy", loadLazy, _ex);SIDL_CHECK(
      *_ex);
...
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.DLL.lookupSymbol.", &throwaway_exception);
    ...
    /* extract return value */
    sidl_rmi_Response_unpackOpaque( _rsvp, "_retval", &_retval, _ex);SIDL_CHECK(
      *_ex);
...
sidl_BaseException_addLine(_be, "Exception unserialized from sidl.DLL.createClass.", &throwaway_exception);
    ...
    sidl_rmi_Response_unpackString( _rsvp, "_retval", &_retval_str, 
      _ex);SIDL_CHECK(*_ex);
    _retval = sidl_BaseClass__connectI(_retval_str, FALSE, _ex);SIDL_CHECK(
      *_ex);
...
sidl_DLL__remoteCreate(const char *url, sidl_BaseInterface *_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "sidl.DLL", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_DLL__object*) malloc(
      sizeof(struct sidl_DLL__object));
