...
#define included_sidl_rmi_ObjectDoesNotExistException_IOR_h
...
struct sidl_rmi_ObjectDoesNotExistException__epv {
  ...
  int32_t (*f_getHopCount)(
    /* in */ struct sidl_rmi_ObjectDoesNotExistException__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidl.rmi.ObjectDoesNotExistException-v0.9.15 */
};
...
struct sidl_rmi_ObjectDoesNotExistException__controls {
  int     use_hooks;
};
/*
...
struct sidl_rmi_ObjectDoesNotExistException__object {
  ...
  struct sidl_rmi_ObjectDoesNotExistException__epv* d_epv;
  void*                                             d_data;
};

struct sidl_rmi_ObjectDoesNotExistException__external {
  struct sidl_rmi_ObjectDoesNotExistException__object*
...
extern void sidl_rmi_ObjectDoesNotExistException__getEPVs(
  ...
  struct sidl_RuntimeException__object* 
    skel_sidl_rmi_ObjectDoesNotExistException_fconnect_sidl_RuntimeException(
  ...
  struct sidl_io_Deserializer__object* 
    ...
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Deserializer__object* 
    skel_sidl_rmi_ObjectDoesNotExistException_fcast_sidl_io_Deserializer(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_io_IOException__object* 
    skel_sidl_rmi_ObjectDoesNotExistException_fconnect_sidl_io_IOException(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_IOException__object* 
    skel_sidl_rmi_ObjectDoesNotExistException_fcast_sidl_io_IOException(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_io_Serializable__object* 
    skel_sidl_rmi_ObjectDoesNotExistException_fconnect_sidl_io_Serializable(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_io_Serializable__object* 
    skel_sidl_rmi_ObjectDoesNotExistException_fcast_sidl_io_Serializable(void 
    *bi, struct sidl_BaseInterface__object **_ex);
