...
extern
void
impl_sidl_rmi_UnexpectedCloseException__load(
  /* out */ sidl_BaseInterface *_ex);

extern
void
impl_sidl_rmi_UnexpectedCloseException__ctor(
  /* in */ sidl_rmi_UnexpectedCloseException self,
  /* out */ sidl_BaseInterface *_ex);

extern
void
impl_sidl_rmi_UnexpectedCloseException__ctor2(
  /* in */ sidl_rmi_UnexpectedCloseException self,
...
extern
void
impl_sidl_rmi_UnexpectedCloseException__dtor(
  /* in */ sidl_rmi_UnexpectedCloseException self,
  /* out */ sidl_BaseInterface *_ex);
...
void
sidl_rmi_UnexpectedCloseException__set_epv(struct 
  sidl_rmi_UnexpectedCloseException__epv *epv)
{
  epv->f__ctor = impl_sidl_rmi_UnexpectedCloseException__ctor;
  epv->f__ctor2 = impl_sidl_rmi_UnexpectedCloseException__ctor2;
  epv->f__dtor = impl_sidl_rmi_UnexpectedCloseException__dtor;
...
void sidl_rmi_UnexpectedCloseException__call_load(void) { 
  sidl_BaseInterface _throwaway_exception = NULL;
  impl_sidl_rmi_UnexpectedCloseException__load(&_throwaway_exception);
}
struct sidl_BaseClass__object* 
  skel_sidl_rmi_UnexpectedCloseException_fconnect_sidl_BaseClass(const char* 
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_UnexpectedCloseException_fconnect_sidl_BaseClass(url, ar,
    _ex);
}
...
struct sidl_BaseException__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_UnexpectedCloseException_fconnect_sidl_BaseException(url,
    ar, _ex);
}
...
struct sidl_BaseInterface__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_UnexpectedCloseException_fconnect_sidl_BaseInterface(url,
    ar, _ex);
}
...
struct sidl_ClassInfo__object* 
  ...
  url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_UnexpectedCloseException_fconnect_sidl_ClassInfo(url, ar,
    _ex);
}
...
struct sidl_SIDLException__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_UnexpectedCloseException_fconnect_sidl_SIDLException(url,
    ar, _ex);
}
...
struct sidl_io_Serializer__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_rmi_UnexpectedCloseException_fconnect_sidl_io_Serializer(url,
    ar, _ex);
}
...
sidl_rmi_UnexpectedCloseException__get_data(sidl_rmi_UnexpectedCloseException 
  self)
{
  return (struct sidl_rmi_UnexpectedCloseException__data*)(self ? self->d_data 
    : NULL);
}

void sidl_rmi_UnexpectedCloseException__set_data(
  sidl_rmi_UnexpectedCloseException self,
  struct sidl_rmi_UnexpectedCloseException__data* data)
{
  if (self) {
    self->d_data = data;
  }
