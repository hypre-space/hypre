/*
 * File:          sidl_rmi_ProtocolFactory_IOR.c
...
static struct sidl_rmi_ProtocolFactory__epv  
  s_new_epv__sidl_rmi_protocolfactory;
static struct sidl_rmi_ProtocolFactory__sepv 
  s_stc_epv__sidl_rmi_protocolfactory;

static struct sidl_rmi_ProtocolFactory__epv  
  s_new_epv_hooks__sidl_rmi_protocolfactory;
static struct sidl_rmi_ProtocolFactory__sepv 
  s_stc_epv_hooks__sidl_rmi_protocolfactory;
...
extern void sidl_rmi_ProtocolFactory__set_epv(
  struct sidl_rmi_ProtocolFactory__epv* epv);
extern void sidl_rmi_ProtocolFactory__set_sepv(
  struct sidl_rmi_ProtocolFactory__sepv* sepv);
extern void sidl_rmi_ProtocolFactory__call_load(void);
#ifdef __cplusplus
}
#endif

static void
sidl_rmi_ProtocolFactory_addRef__exec(
...
static void
sidl_rmi_ProtocolFactory_deleteRef__exec(
        struct sidl_rmi_ProtocolFactory__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_rmi_ProtocolFactory_isSame__exec(
        struct sidl_rmi_ProtocolFactory__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_sidl_rmi_ProtocolFactory_fconnect_sidl_BaseInterface(iobj_str,
...
static void
sidl_rmi_ProtocolFactory_isType__exec(
        struct sidl_rmi_ProtocolFactory__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_rmi_ProtocolFactory_getClassInfo__exec(
        struct sidl_rmi_ProtocolFactory__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidl_rmi_ProtocolFactory__ensure_load_called(void) {
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */

  if (! s_load_called ) {
    sidl_rmi_ProtocolFactory__call_load();
    s_load_called=1;
  }
}

/* CAST: dynamic type casting support. */
static void* ior_sidl_rmi_ProtocolFactory__cast(
  struct sidl_rmi_ProtocolFactory__object* self,
...
static void ior_sidl_rmi_ProtocolFactory__set_hooks_static(
...
static void ior_sidl_rmi_ProtocolFactory__set_hooks(
  struct sidl_rmi_ProtocolFactory__object* self,
  int on, struct sidl_BaseInterface__object **_ex ) { 
  *_ex = NULL;
  /*
...
static void ior_sidl_rmi_ProtocolFactory__delete(
  struct sidl_rmi_ProtocolFactory__object* self,
    struct sidl_BaseInterface__object **_ex)
{
  *_ex = NULL; /* default to no exception */
  sidl_rmi_ProtocolFactory__fini(self,_ex);
  memset((void*)self, 0, sizeof(struct sidl_rmi_ProtocolFactory__object));
  free((void*) self);
}

static char*
ior_sidl_rmi_ProtocolFactory__getURL(
    struct sidl_rmi_ProtocolFactory__object* self,
    struct sidl_BaseInterface__object **_ex) {
  char* ret = NULL;
  char* objid = 
...
static void
ior_sidl_rmi_ProtocolFactory__raddRef(
    struct sidl_rmi_ProtocolFactory__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_sidl_rmi_ProtocolFactory__isRemote(
    struct sidl_rmi_ProtocolFactory__object* self, sidl_BaseInterface* _ex) {
  *_ex = NULL; /* default to no exception */
  return FALSE;
}

struct sidl_rmi_ProtocolFactory__method {
  const char *d_name;
  void (*d_func)(struct sidl_rmi_ProtocolFactory__object*,
...
static void
ior_sidl_rmi_ProtocolFactory__exec(
    struct sidl_rmi_ProtocolFactory__object* self,
    const char* methodName,
    struct sidl_rmi_Call__object* inArgs,
    struct sidl_rmi_Return__object* outArgs,
    struct sidl_BaseInterface__object **_ex ) { 
  static const struct sidl_rmi_ProtocolFactory__method  s_methods[] = {
    { "addRef", sidl_rmi_ProtocolFactory_addRef__exec },
    { "deleteRef", sidl_rmi_ProtocolFactory_deleteRef__exec },
    { "getClassInfo", sidl_rmi_ProtocolFactory_getClassInfo__exec },
    { "isSame", sidl_rmi_ProtocolFactory_isSame__exec },
    { "isType", sidl_rmi_ProtocolFactory_isType__exec },
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct sidl_rmi_ProtocolFactory__method);
  *_ex = NULL; /* default to no exception */
  if (methodName) {
...
static void sidl_rmi_ProtocolFactory__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct sidl_rmi_ProtocolFactory__epv*  epv  = 
    &s_new_epv__sidl_rmi_protocolfactory;
  struct sidl_rmi_ProtocolFactory__epv*  hepv = 
    &s_new_epv_hooks__sidl_rmi_protocolfactory;
  ...
  epv->f__cast                    = ior_sidl_rmi_ProtocolFactory__cast;
  epv->f__delete                  = ior_sidl_rmi_ProtocolFactory__delete;
  epv->f__exec                    = ior_sidl_rmi_ProtocolFactory__exec;
  epv->f__getURL                  = ior_sidl_rmi_ProtocolFactory__getURL;
  epv->f__raddRef                 = ior_sidl_rmi_ProtocolFactory__raddRef;
  epv->f__isRemote                = ior_sidl_rmi_ProtocolFactory__isRemote;
  epv->f__set_hooks               = ior_sidl_rmi_ProtocolFactory__set_hooks;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_rmi_ProtocolFactory__object*,struct sidl_BaseInterface__object*,
    struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_ProtocolFactory__object*,const char*,
    struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    sidl_rmi_ProtocolFactory__object*,
    struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  sidl_rmi_ProtocolFactory__set_epv(epv);

  memcpy((void*)hepv, epv, sizeof(struct sidl_rmi_ProtocolFactory__epv));
  ...
  ior_sidl_rmi_ProtocolFactory__ensure_load_called();
}
...
static void sidl_rmi_ProtocolFactory__init_sepv(void)
{
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */
  ...
  struct sidl_rmi_ProtocolFactory__sepv*  s = 
    &s_stc_epv__sidl_rmi_protocolfactory;
  struct sidl_rmi_ProtocolFactory__sepv* hs = 
    &s_stc_epv_hooks__sidl_rmi_protocolfactory;

  s->f__set_hooks_static                     = 
    ior_sidl_rmi_ProtocolFactory__set_hooks_static;
  s->f_addProtocol                 = NULL;
  s->f_getProtocol                 = NULL;
  s->f_deleteProtocol              = NULL;
  s->f_createInstance              = NULL;
  s->f_connectInstance             = NULL;
  s->f_unserializeInstance         = NULL;

  sidl_rmi_ProtocolFactory__set_sepv(s);

  memcpy((void*)hs, s, sizeof(struct sidl_rmi_ProtocolFactory__sepv));

  ior_sidl_rmi_ProtocolFactory__set_hooks_static(FALSE, &throwaway_exception);
  s_static_initialized = 1;
  ior_sidl_rmi_ProtocolFactory__ensure_load_called();
}

void sidl_rmi_ProtocolFactory__getEPVs(
    ...
    **s_arg_epv_hooks__sidl_rmi_protocolfactory)
{
  ...
  if (!s_method_initialized) {
    sidl_rmi_ProtocolFactory__init_epv();
  }
  ...
  *s_arg_epv__sidl_rmi_protocolfactory = &s_new_epv__sidl_rmi_protocolfactory;
  *s_arg_epv_hooks__sidl_rmi_protocolfactory = 
    &s_new_epv_hooks__sidl_rmi_protocolfactory;
}
/*
...
sidl_rmi_ProtocolFactory__statics(void)
{
  ...
  if (!s_static_initialized) {
    sidl_rmi_ProtocolFactory__init_sepv();
  }
  UNLOCK_STATIC_GLOBALS;
  return &s_stc_epv__sidl_rmi_protocolfactory;
}
...
static struct sidl_BaseClass__epv* sidl_rmi_ProtocolFactory__super(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidl.rmi.ProtocolFactory",_ex);
...
static void
initMetadata(struct sidl_rmi_ProtocolFactory__object* self,
...
sidl_rmi_ProtocolFactory__new(void* ddata,
  struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_rmi_ProtocolFactory__object* self =
  ...
  *_ex = NULL; /* default to no exception */
  sidl_rmi_ProtocolFactory__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void sidl_rmi_ProtocolFactory__init(
  struct sidl_rmi_ProtocolFactory__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidl_rmi_ProtocolFactory__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_new_epv__sidl_rmi_protocolfactory;

  s0->d_data = NULL;

  ior_sidl_rmi_ProtocolFactory__set_hooks(s0, FALSE, _ex);
...
void sidl_rmi_ProtocolFactory__fini(
  struct sidl_rmi_ProtocolFactory__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidl_rmi_ProtocolFactory__object* s0 = self;
...
void
sidl_rmi_ProtocolFactory__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct sidl_rmi_ProtocolFactory__external
s_externalEntryPoints = {
  sidl_rmi_ProtocolFactory__new,
  sidl_rmi_ProtocolFactory__statics,
  sidl_rmi_ProtocolFactory__super,
  0, 
  10
};
