...
{
  return sidl_rmi_InstanceHandle__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.InstanceHandle", (
      void*)sidl_rmi_InstanceHandle__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
sidl_rmi_InstanceHandle__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_InstanceHandle__isRemote(self,_ex);
}
...
{
  return (struct sidl_rmi_InstanceHandle__array*)sidl_interface__array_create1d(
    len);
}
...
static void sidl_rmi__InstanceHandle__init_remote_epv(void)
{
  ...
  e1->f__exec            = (void (*)(void*,const char*,struct 
    sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
    sidl_BaseInterface__object **)) epv->f__exec;
  e1->f_initCreate       = (sidl_bool (*)(void*,const char*,const char*,struct 
  ...
  e1->f_getObjectURL     = (char* (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getObjectURL;
  e1->f_createInvocation = (struct sidl_rmi_Invocation__object* (*)(void*,const 
