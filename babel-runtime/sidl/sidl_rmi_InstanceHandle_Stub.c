...
static struct sidl_rmi_InstanceHandle__object* 
  sidl_rmi_InstanceHandle__remoteConnect(const char* url,
...
sidl_rmi_InstanceHandle__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_InstanceHandle__remoteConnect(url, _ex);
}
...
sidl_BaseInterface
sidl_rmi_InstanceHandle_queryInt(
  /* in */ sidl_rmi_InstanceHandle self,
  /* in */ const char* name)
{
...
char*
sidl_rmi_InstanceHandle_getURL(
  /* in */ sidl_rmi_InstanceHandle self,
  /* out */ sidl_BaseInterface *_ex)
{
...
sidl_rmi_InstanceHandle__cast(
  void* obj)
{
  sidl_rmi_InstanceHandle cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.InstanceHandle",
      (void*)sidl_rmi_InstanceHandle__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_rmi_InstanceHandle) (*base->d_epv->f__cast)(
      base->d_object,
...
{
  return (struct 
    sidl_rmi_InstanceHandle__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
{
  return (struct 
    sidl_rmi_InstanceHandle__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct 
    sidl_rmi_InstanceHandle__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidl_rmi_InstanceHandle__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct 
    sidl_rmi_InstanceHandle__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidl_rmi_InstanceHandle__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct sidl_rmi_InstanceHandle__array*)sidl_interface__array_borrow(
...
{
  return (struct sidl_rmi_InstanceHandle__array*)
...
sidl_rmi_InstanceHandle__array_get1(
  ...
  const int32_t i1)
{
  return (sidl_rmi_InstanceHandle)
...
const char* name)
{
  ...
  if (!strcmp(name, "sidl.rmi._InstanceHandle")) {
    cast = (void*) s0;
...
remote_sidl_rmi__InstanceHandle_addRef(
  /* in */ struct sidl_rmi__InstanceHandle__object* self /* TLD */)
{
...
remote_sidl_rmi__InstanceHandle_queryInt(
  /* in */ struct sidl_rmi__InstanceHandle__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static char*
remote_sidl_rmi__InstanceHandle_getURL(
  /* in */ struct sidl_rmi__InstanceHandle__object* self /* TLD */,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  sidl_BaseInterface *_ex2 =_ex;
...
static void sidl_rmi__InstanceHandle__init_remote_epv(void)
{
  ...
  epv->f_queryInt              = remote_sidl_rmi__InstanceHandle_queryInt;
  ...
  epv->f_getURL                = remote_sidl_rmi__InstanceHandle_getURL;
  ...
  e1->f_initConnect      = (sidl_bool (*)(void*,const char*,
...
static struct sidl_rmi_InstanceHandle__object*
sidl_rmi_InstanceHandle__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct sidl_rmi__InstanceHandle__object* self;
  ...
  return sidl_rmi_InstanceHandle__cast(self);
}
