...
sidl_rmi_UnexpectedCloseException
sidl_rmi_UnexpectedCloseException__connect(const char* url, sidl_BaseInterface 
  *_ex)
{
...
{
  return (struct 
    sidl_rmi_UnexpectedCloseException__array*)sidl_interface__array_create1dInit
