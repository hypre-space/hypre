/*
 * File:          sidl_rmi_UnexpectedCloseException_Stub.c
...
static const struct sidl_rmi_UnexpectedCloseException__external *_externals = 
  NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_rmi_UnexpectedCloseException__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_rmi_UnexpectedCloseException__externals();
  return _externals;
}
...
static sidl_rmi_UnexpectedCloseException 
...
sidl_rmi_UnexpectedCloseException__createRemote(const char* url,
  sidl_BaseInterface *_ex)
{
  return sidl_rmi_UnexpectedCloseException__remoteCreate(url, _ex);
}
...
sidl_rmi_UnexpectedCloseException
sidl_rmi_UnexpectedCloseException__connect(const char* url,
  sidl_BaseInterface *_ex)
{
  return sidl_rmi_UnexpectedCloseException__remoteConnect(url, TRUE, _ex);
}
...
sidl_rmi_UnexpectedCloseException__cast(
  ...
  sidl_BaseInterface* _ex)
{
  sidl_rmi_UnexpectedCloseException cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect(
      "sidl.rmi.UnexpectedCloseException",
      (void*)sidl_rmi_UnexpectedCloseException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_rmi_UnexpectedCloseException) (*base->d_epv->f__cast)(
      base->d_object,
...
SIDL_C_INLINE_DEFN
void
sidl_rmi_UnexpectedCloseException__set_hooks(
  /* in */ sidl_rmi_UnexpectedCloseException self,
  /* in */ sidl_bool on,
  /* out */ sidl_BaseInterface *_ex)
#if SIDL_C_INLINE_REPEAT_DEFN
...
sidl_rmi_UnexpectedCloseException__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_UnexpectedCloseException__isRemote(self,_ex);
}
...
{
  return (struct 
    sidl_rmi_UnexpectedCloseException__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
{
  return (struct 
    sidl_rmi_UnexpectedCloseException__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct 
    sidl_rmi_UnexpectedCloseException__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct 
    sidl_rmi_UnexpectedCloseException__array*)sidl_interface__array_create1dInit(len, (struct sidl_BaseInterface__object **)data);
}
...
{
  return (struct 
    sidl_rmi_UnexpectedCloseException__array*)sidl_interface__array_create2dCol(
    m, n);
}
...
{
  return (struct 
    sidl_rmi_UnexpectedCloseException__array*)sidl_interface__array_create2dRow(
    m, n);
}
...
{
  return (struct 
    sidl_rmi_UnexpectedCloseException__array*)sidl_interface__array_borrow(
...
{
  return (struct sidl_rmi_UnexpectedCloseException__array*)
...
sidl_rmi_UnexpectedCloseException__array_get1(
  ...
  const int32_t i1)
{
  return (sidl_rmi_UnexpectedCloseException)
