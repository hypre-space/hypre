...
void
sidl_NotImplementedException__set_epv(struct sidl_NotImplementedException__epv 
  *epv)
{
  epv->f__ctor = impl_sidl_NotImplementedException__ctor;
  epv->f__ctor2 = impl_sidl_NotImplementedException__ctor2;
  epv->f__dtor = impl_sidl_NotImplementedException__dtor;
...
void sidl_NotImplementedException__call_load(void) { 
...
struct sidl_NotImplementedException__object* 
  skel_sidl_NotImplementedException_fconnect_sidl_NotImplementedException(const 
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_NotImplementedException_fconnect_sidl_NotImplementedException(url,
    ar, _ex);
}
...
sidl_NotImplementedException__get_data(sidl_NotImplementedException self)
{
  return (struct sidl_NotImplementedException__data*)(self ? self->d_data : 
    NULL);
}

void sidl_NotImplementedException__set_data(
  sidl_NotImplementedException self,
  struct sidl_NotImplementedException__data* data)
{
  if (self) {
    self->d_data = data;
  }
