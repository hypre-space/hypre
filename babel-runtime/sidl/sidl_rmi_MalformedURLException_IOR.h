...
#define included_sidl_rmi_MalformedURLException_IOR_h
...
struct sidl_rmi_MalformedURLException__epv {
  ...
  int32_t (*f_getHopCount)(
    /* in */ struct sidl_rmi_MalformedURLException__object* self,
    /* out */ struct sidl_BaseInterface__object* *_ex);
  /* Methods introduced in sidl.rmi.MalformedURLException-v0.9.15 */
};
...
struct sidl_rmi_MalformedURLException__controls {
  int     use_hooks;
};
/*
...
struct sidl_rmi_MalformedURLException__object {
  ...
  struct sidl_rmi_MalformedURLException__epv* d_epv;
  void*                                       d_data;
};

struct sidl_rmi_MalformedURLException__external {
  struct sidl_rmi_MalformedURLException__object*
...
extern void sidl_rmi_MalformedURLException__getEPVs(
  ...
  struct sidl_rmi_MalformedURLException__object* 
    skel_sidl_rmi_MalformedURLException_fconnect_sidl_rmi_MalformedURLException(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_MalformedURLException__object* 
    skel_sidl_rmi_MalformedURLException_fcast_sidl_rmi_MalformedURLException(
    void *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_rmi_NetworkException__object* 
    skel_sidl_rmi_MalformedURLException_fconnect_sidl_rmi_NetworkException(
    const char* url, sidl_bool ar, struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_NetworkException__object* 
    skel_sidl_rmi_MalformedURLException_fcast_sidl_rmi_NetworkException(void 
    *bi, struct sidl_BaseInterface__object **_ex);

  struct sidl_rmi_MalformedURLException__remote{
    int d_refcount;
