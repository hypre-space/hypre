...
SIDL_float__array_sdestroy(struct SIDL_float__array* array)
{
  if (array) {
    ...
    if (*orig) {
      SIDL_float__array_deleteReference(*orig);
      *orig = NULL;
    }
    SIDL_float__array_bdestroy(array);
  }
...
{
  SIDL_float__array_addReference(array);
  return array;
}
         ...
         struct SIDL_float__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    SIDL_float__array_addReference(orig);
 ...
 */
void
SIDL_float__array_addReference(struct SIDL_float__array* array)
{
  if (array) {
    ++(array->d_refcount);
  }
 ...
 */
void
SIDL_float__array_deleteReference(struct SIDL_float__array* array)
{
  ...
  if (src && (src->d_dimen == dimen)) {
    ...
    case SIDL_column_major_order:
      if (SIDL_float__array_isColumnOrder(src)) {
        SIDL_float__array_addReference(src);
        result = src;
      }
      else {
