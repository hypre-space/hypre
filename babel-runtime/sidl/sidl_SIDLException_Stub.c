...
sidl_SIDLException
sidl_SIDLException__create()
{
  return (*(_getExternals()->createObject))();
}

static sidl_SIDLException sidl_SIDLException__remote(const char* url,
...
{
  return sidl_SIDLException__remote(url, _ex);
}

static struct sidl_SIDLException__object* 
  sidl_SIDLException__remoteConnect(const char* url, sidl_BaseInterface *_ex);
static struct sidl_SIDLException__object* 
...
{
  return sidl_SIDLException__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.SIDLException",
      (void*)sidl_SIDLException__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  else if(sidl_SIDLException_isType(self, name)) {
...
remote_sidl_SIDLException_addRef(
  /* in */ struct sidl_SIDLException__object* self /* TLD */)
{
...
static struct sidl_SIDLException__object*
sidl_SIDLException__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidl_SIDLException__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "sidl.SIDLException", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_SIDLException__object*) malloc(
      sizeof(struct sidl_SIDLException__object));
