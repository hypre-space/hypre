...
static const struct sidl_SIDLException__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_SIDLException__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_SIDLException__externals();
  return _externals;
}
...
sidl_SIDLException
sidl_SIDLException__create(sidl_BaseInterface* _ex)
{
  return (*(_getExternals()->createObject))(NULL,_ex);
}

static sidl_SIDLException sidl_SIDLException__remoteCreate(const char* url,
...
sidl_SIDLException
sidl_SIDLException__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_SIDLException__remoteCreate(url, _ex);
}
...
sidl_SIDLException
sidl_SIDLException__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_SIDLException__remoteConnect(url, TRUE, _ex);
}
...
sidl_SIDLException__cast(
  ...
  sidl_BaseInterface* _ex)
{
  sidl_SIDLException cast = NULL;

  if(!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.SIDLException",
      (void*)sidl_SIDLException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_SIDLException) (*base->d_epv->f__cast)(
      base->d_object,
...
sidl_bool
sidl_SIDLException__isLocal(
  /* in */ sidl_SIDLException self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_SIDLException__isRemote(self,_ex);
}
...
{
  return (struct 
    sidl_SIDLException__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_SIDLException__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct sidl_SIDLException__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidl_SIDLException__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct sidl_SIDLException__array*)sidl_interface__array_create2dCol(m,
    n);
}
...
{
  return (struct sidl_SIDLException__array*)sidl_interface__array_create2dRow(m,
    n);
}
...
{
  return (struct sidl_SIDLException__array*)sidl_interface__array_borrow(
...
{
  return (struct sidl_SIDLException__array*)
