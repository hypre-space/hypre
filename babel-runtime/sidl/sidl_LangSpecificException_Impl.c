/*
 * File:          sidl_LangSpecificException_Impl.c
...
#include "sidl_LangSpecificException_Impl.h"
#include "sidl_NotImplementedException.h"
#include "sidl_Exception.h"

/* DO-NOT-DELETE splicer.begin(sidl.LangSpecificException._includes) */
/* Insert-Code-Here {sidl.LangSpecificException._includes} (includes and arbitrary code) */
/* DO-NOT-DELETE splicer.end(sidl.LangSpecificException._includes) */
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_LangSpecificException__load"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.LangSpecificException._load) */
  /* Insert-Code-Here {sidl.LangSpecificException._load} (static class initializer method) */
  /* DO-NOT-DELETE splicer.end(sidl.LangSpecificException._load) */
  }
}
/*
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_LangSpecificException__ctor"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.LangSpecificException._ctor) */
  /* Insert-Code-Here {sidl.LangSpecificException._ctor} (constructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.LangSpecificException._ctor) */
  }
}
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_LangSpecificException__ctor2"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.LangSpecificException._ctor2) */
  /* Insert-Code-Here {sidl.LangSpecificException._ctor2} (special constructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.LangSpecificException._ctor2) */
  }
}
/*
...
#undef __FUNC__
#define __FUNC__ "impl_sidl_LangSpecificException__dtor"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  {
  /* DO-NOT-DELETE splicer.begin(sidl.LangSpecificException._dtor) */
  /* Insert-Code-Here {sidl.LangSpecificException._dtor} (destructor method) */
  /* DO-NOT-DELETE splicer.end(sidl.LangSpecificException._dtor) */
  }
}
...
struct sidl_LangSpecificException__object* 
  ...
  return sidl_LangSpecificException__connectI(url, ar, _ex);
}
struct sidl_LangSpecificException__object* 
  impl_sidl_LangSpecificException_fcast_sidl_LangSpecificException(void* bi,
  sidl_BaseInterface* _ex) {
  return sidl_LangSpecificException__cast(bi, _ex);
}
