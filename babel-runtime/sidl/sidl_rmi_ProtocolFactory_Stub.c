...
static sidl_rmi_ProtocolFactory sidl_rmi_ProtocolFactory__remoteCreate(const 
...
{
  return sidl_rmi_ProtocolFactory__remoteCreate(url, _ex);
}
...
{
  return sidl_rmi_ProtocolFactory__remoteConnect(url, TRUE, _ex);
}
...
{
  sidl_bool _result;
  _result = (_getSEPV()->f_addProtocol)(
    prefix,
    typeName,
    _ex);
  return _result;
...
{
  char* _result;
  _result = (_getSEPV()->f_getProtocol)(
    prefix,
    _ex);
  return _result;
}
...
{
  sidl_bool _result;
  _result = (_getSEPV()->f_deleteProtocol)(
    prefix,
    _ex);
  return _result;
}
...
sidl_rmi_ProtocolFactory_createInstance(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  sidl_rmi_InstanceHandle _result;
  _result = (_getSEPV()->f_createInstance)(
    url,
    typeName,
    _ex);
  return _result;
...
{
  sidl_rmi_InstanceHandle _result;
  _result = (_getSEPV()->f_connectInstance)(
    url,
    ar,
    _ex);
  return _result;
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  ...
  _result = (_getSEPV()->f_unserializeInstance)(
    url,
    _ex);
  return _result;
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if(!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.ProtocolFactory", (
      void*)sidl_rmi_ProtocolFactory__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
  if (obj != NULL) {
...
sidl_rmi_ProtocolFactory__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_rmi_ProtocolFactory__isRemote(self,_ex);
}
