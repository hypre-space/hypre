...
static const struct sidl_rmi_ProtocolFactory__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidl_rmi_ProtocolFactory__external* _loadIOR(void)
/*
 * Return pointer to internal IOR functions.
 */

{
  _externals = sidl_rmi_ProtocolFactory__externals();
  return _externals;
}
...
sidl_rmi_ProtocolFactory__create()
{
  return (*(_getExternals()->createObject))();
}

static sidl_rmi_ProtocolFactory sidl_rmi_ProtocolFactory__remote(const char* 
...
sidl_rmi_ProtocolFactory
sidl_rmi_ProtocolFactory__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_ProtocolFactory__remote(url, _ex);
}

static struct sidl_rmi_ProtocolFactory__object* 
  sidl_rmi_ProtocolFactory__remoteConnect(const char* url,
...
sidl_rmi_ProtocolFactory
sidl_rmi_ProtocolFactory__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_rmi_ProtocolFactory__remoteConnect(url, _ex);
}
...
sidl_rmi_ProtocolFactory_deleteProtocol(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return (_getSEPV()->f_deleteProtocol)(
    prefix,
    _ex);
}
...
sidl_rmi_ProtocolFactory_createInstance(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return (_getSEPV()->f_createInstance)(
    url,
    typeName,
    _ex);
}
...
sidl_rmi_ProtocolFactory_connectInstance(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return (_getSEPV()->f_connectInstance)(
    url,
    _ex);
}
...
sidl_rmi_ProtocolFactory__cast(
  void* obj)
{
  sidl_rmi_ProtocolFactory cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.ProtocolFactory",
      (void*)sidl_rmi_ProtocolFactory__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_rmi_ProtocolFactory) (*base->d_epv->f__cast)(
      base->d_object,
...
{
  return (struct 
    sidl_rmi_ProtocolFactory__array*)sidl_interface__array_createCol(dimen,
    lower, upper);
}
...
{
  return (struct 
    sidl_rmi_ProtocolFactory__array*)sidl_interface__array_createRow(dimen,
    lower, upper);
}
...
{
  return (struct 
    sidl_rmi_ProtocolFactory__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidl_rmi_ProtocolFactory__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct 
    sidl_rmi_ProtocolFactory__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    sidl_rmi_ProtocolFactory__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct sidl_rmi_ProtocolFactory__array*)sidl_interface__array_borrow(
...
{
  return (struct sidl_rmi_ProtocolFactory__array*)
...
sidl_rmi_ProtocolFactory__array_get1(
  ...
  const int32_t i1)
{
  return (sidl_rmi_ProtocolFactory)
...
const char* name)
{
  ...
  else if(sidl_rmi_ProtocolFactory_isType(self, name)) {
...
remote_sidl_rmi_ProtocolFactory_addRef(
  /* in */ struct sidl_rmi_ProtocolFactory__object* self /* TLD */)
{
...
remote_sidl_rmi_ProtocolFactory_queryInt(
  /* in */ struct sidl_rmi_ProtocolFactory__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void sidl_rmi_ProtocolFactory__init_remote_epv(void)
{
  ...
  epv->f_queryInt          = remote_sidl_rmi_ProtocolFactory_queryInt;
...
static struct sidl_rmi_ProtocolFactory__object*
sidl_rmi_ProtocolFactory__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidl_rmi_ProtocolFactory__object* self;
