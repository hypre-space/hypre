/*
 * File:          sidl_rmi_UnexpectedCloseException_Impl.h
 * Symbol:        sidl.rmi.UnexpectedCloseException-v0.9.15
 * Symbol Type:   class
 * Babel Version: 1.0.0
 * Release:       $Name$
 * Revision:      @(#) $Id$
 * Description:   Server-side implementation for sidl.rmi.UnexpectedCloseException
 * 
...
#ifndef included_sidl_rmi_UnexpectedCloseException_Impl_h
#define included_sidl_rmi_UnexpectedCloseException_Impl_h
...
/* DO-NOT-DELETE splicer.begin(sidl.rmi.UnexpectedCloseException._includes) */
/* Insert-Code-Here {sidl.rmi.UnexpectedCloseException._includes} (include files) */
/* DO-NOT-DELETE splicer.end(sidl.rmi.UnexpectedCloseException._includes) */

/*
 * Private data for class sidl.rmi.UnexpectedCloseException
 */

struct sidl_rmi_UnexpectedCloseException__data {
  /* DO-NOT-DELETE splicer.begin(sidl.rmi.UnexpectedCloseException._data) */
  /* Insert-Code-Here {sidl.rmi.UnexpectedCloseException._data} (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidl.rmi.UnexpectedCloseException._data) */
};
...
extern struct sidl_rmi_UnexpectedCloseException__data*
sidl_rmi_UnexpectedCloseException__get_data(
  sidl_rmi_UnexpectedCloseException);

extern void
sidl_rmi_UnexpectedCloseException__set_data(
  sidl_rmi_UnexpectedCloseException,
  struct sidl_rmi_UnexpectedCloseException__data*);
