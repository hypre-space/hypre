...
#define included_sidl_io_Deserializer_h
...
typedef struct sidl_io_Deserializer__object* sidl_io_Deserializer;
...
sidl_io_Deserializer__connect(const char *, sidl_BaseInterface *_ex);
/**
 * <p>
