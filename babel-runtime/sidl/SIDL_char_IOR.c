...
SIDL_char__array_sdestroy(struct SIDL_char__array* array)
{
  if (array) {
    ...
    if (*orig) {
      SIDL_char__array_deleteReference(*orig);
      *orig = NULL;
    }
    SIDL_char__array_bdestroy(array);
  }
...
{
  SIDL_char__array_addReference(array);
  return array;
}
         ...
         struct SIDL_char__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    SIDL_char__array_addReference(orig);
 ...
 */
void
SIDL_char__array_addReference(struct SIDL_char__array* array)
{
  if (array) {
    ++(array->d_refcount);
  }
 ...
 */
void
SIDL_char__array_deleteReference(struct SIDL_char__array* array)
{
  ...
  if (src && (src->d_dimen == dimen)) {
    ...
    case SIDL_column_major_order:
      if (SIDL_char__array_isColumnOrder(src)) {
        SIDL_char__array_addReference(src);
        result = src;
      }
      else {
