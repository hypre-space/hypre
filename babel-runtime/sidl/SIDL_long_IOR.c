...
SIDL_long__array_sdestroy(struct SIDL_long__array* array)
{
  if (array) {
    ...
    if (*orig) {
      SIDL_long__array_deleteReference(*orig);
      *orig = NULL;
    }
    SIDL_long__array_bdestroy(array);
  }
...
{
  SIDL_long__array_addReference(array);
  return array;
}
...
SIDL_long__array_borrowSmartCp(struct SIDL_long__array* array)
{
  ...
  if (array) {
    if (SIDL_long__array_isColumnOrder(array)) {
      copy = SIDL_long__array_createCol(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
    else {
      copy = SIDL_long__array_createRow(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
...
static const struct SIDL_long__vtable normal_long_vtable = {
  SIDL_long__array_destroy,
...
static const struct SIDL_long__vtable borrowed_long_vtable = {
  SIDL_long__array_bdestroy,
...
static const struct SIDL_long__vtable sliced_long_vtable = {
  SIDL_long__array_sdestroy,
  SIDL_long__array_smartCp
};
/**
...
static const struct SIDL_long__vtable bsliced_long_vtable = {
  SIDL_long__array_sdestroy,
  SIDL_long__array_borrowSmartCp
};
/**
         ...
         struct SIDL_long__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    SIDL_long__array_addReference(orig);
    result->d_vtable = &sliced_long_vtable;
  }
  else {
    result->d_vtable = &normal_long_vtable;
  }
  ...
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_vtable->d_smartcopy ==
        ...
        result->d_vtable = &bsliced_long_vtable;
      }
    }
  }
  return result;
                        ...
                        const int32_t  stride[])
{
  ...
  result->d_vtable = &borrowed_long_vtable;
  return result;
}
  ...
  if (src && (src->d_dimen == dimen)) {
    ...
    case SIDL_column_major_order:
      if (SIDL_long__array_isColumnOrder(src)) {
        SIDL_long__array_addReference(src);
        result = src;
      }
      else {
