                                  ...
                                  const struct sidl_dcomplex* data)
{
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      const struct sidl_dcomplex * restrict src = (const struct sidl_dcomplex * restrict)data;
      struct sidl_dcomplex * restrict dest;
      result->d_stride[0] = 1;
      result->d_firstElement = (struct sidl_dcomplex *)malloc(len*sizeof(struct sidl_dcomplex));
