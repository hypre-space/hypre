...
#define included_sidl_rmi_ServerInfo_h
...
typedef struct sidl_rmi_ServerInfo__object* sidl_rmi_ServerInfo;
 ...
 */
sidl_rmi_ServerInfo
sidl_rmi_ServerInfo__connect(const char *, sidl_BaseInterface *_ex);
