                                  ...
                                  const struct sidl_fcomplex* data)
{
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      const struct sidl_fcomplex * restrict src = (const struct sidl_fcomplex * restrict)data;
      struct sidl_fcomplex * restrict dest;
      result->d_stride[0] = 1;
      result->d_firstElement = (struct sidl_fcomplex *)malloc(len*sizeof(struct sidl_fcomplex));
