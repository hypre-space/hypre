...
/* forward declaration of struct SIDL_dcomplex__array */
...
struct SIDL_dcomplex__vtable {
   ...
   */
  void (*d_destroy)(struct SIDL_dcomplex__array *);
   ...
   */
  struct SIDL_dcomplex__array *(*d_smartcopy)(struct SIDL_dcomplex__array *);
};
...
struct SIDL_dcomplex__array {
  ...
  int32_t        d_dimen;
  int32_t        d_refcount;
  const struct SIDL_dcomplex__vtable *d_vtable;
};
 ...
 */
void
SIDL_dcomplex__array_addReference(struct SIDL_dcomplex__array* array);
 ...
 */
void
SIDL_dcomplex__array_deleteReference(struct SIDL_dcomplex__array* array);
