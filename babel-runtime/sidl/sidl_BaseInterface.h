 ...
 */
struct sidl_BaseInterface__array*
sidl_BaseInterface__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[]);
 ...
 */
struct sidl_BaseInterface__array*
sidl_BaseInterface__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[]);
 ...
 */
struct sidl_BaseInterface__array*
sidl_BaseInterface__array_create1dInit(
  int32_t len, 
 ...
 */
struct sidl_BaseInterface__array*
sidl_BaseInterface__array_borrow(
  sidl_BaseInterface* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
 ...
 */
struct sidl_BaseInterface__array*
sidl_BaseInterface__array_smartCopy(
 ...
 */
void
sidl_BaseInterface__array_addRef(
  struct sidl_BaseInterface__array* array);
 ...
 */
void
sidl_BaseInterface__array_deleteRef(
  struct sidl_BaseInterface__array* array);
 ...
 */
sidl_BaseInterface
sidl_BaseInterface__array_get1(
  const struct sidl_BaseInterface__array* array,
  const int32_t i1);
 ...
 */
sidl_BaseInterface
sidl_BaseInterface__array_get2(
  const struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2);
 ...
 */
sidl_BaseInterface
sidl_BaseInterface__array_get3(
  const struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3);
 ...
 */
sidl_BaseInterface
sidl_BaseInterface__array_get4(
  const struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_BaseInterface
sidl_BaseInterface__array_get5(
  const struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_BaseInterface
sidl_BaseInterface__array_get6(
  const struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_BaseInterface
sidl_BaseInterface__array_get7(
  const struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_BaseInterface__array_set1(
  struct sidl_BaseInterface__array* array,
  const int32_t i1,
 ...
 */
void
sidl_BaseInterface__array_set2(
  struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  sidl_BaseInterface const value);
 ...
 */
void
sidl_BaseInterface__array_set3(
  struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_BaseInterface__array_set4(
  struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_BaseInterface__array_set5(
  struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_BaseInterface__array_set6(
  struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_BaseInterface__array_set7(
  struct sidl_BaseInterface__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
int32_t
sidl_BaseInterface__array_dimen(
  const struct sidl_BaseInterface__array* array);
 ...
 */
int32_t
sidl_BaseInterface__array_lower(
  const struct sidl_BaseInterface__array* array,
  const int32_t ind);
 ...
 */
int32_t
sidl_BaseInterface__array_upper(
  const struct sidl_BaseInterface__array* array,
  const int32_t ind);
 ...
 */
int32_t
sidl_BaseInterface__array_length(
  const struct sidl_BaseInterface__array* array,
  const int32_t ind);
 ...
 */
int32_t
sidl_BaseInterface__array_stride(
  const struct sidl_BaseInterface__array* array,
  const int32_t ind);
 ...
 */
int
sidl_BaseInterface__array_isColumnOrder(
  const struct sidl_BaseInterface__array* array);
 ...
 */
int
sidl_BaseInterface__array_isRowOrder(
  const struct sidl_BaseInterface__array* array);
 ...
 */
struct sidl_BaseInterface__array*
sidl_BaseInterface__array_slice(
  struct sidl_BaseInterface__array* src,
  int32_t        dimen,
 ...
 */
struct sidl_BaseInterface__array*
sidl_BaseInterface__array_ensure(
  struct sidl_BaseInterface__array* src,
  int32_t dimen,
  int     ordering);
