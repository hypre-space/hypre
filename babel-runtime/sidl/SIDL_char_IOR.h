...
/* forward declaration of struct SIDL_char__array */
...
struct SIDL_char__vtable {
   ...
   */
  void (*d_destroy)(struct SIDL_char__array *);
   ...
   */
  struct SIDL_char__array *(*d_smartcopy)(struct SIDL_char__array *);
};
...
struct SIDL_char__array {
  ...
  int32_t        d_dimen;
  int32_t        d_refcount;
  const struct SIDL_char__vtable *d_vtable;
};
