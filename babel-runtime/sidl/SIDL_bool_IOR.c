...
{
  if (array) {
    static const int arraySize = sizeof(struct SIDL_bool__array)
      + (sizeof(int32_t) - (sizeof(struct SIDL_bool__array)
                        % sizeof(int32_t))) % sizeof(int32_t);
    struct SIDL_bool__array **orig;
    orig = (struct SIDL_bool__array **)((char *)array + arraySize +
      3 * sizeof(int32_t)*array->d_dimen);
    if (*orig) {
      SIDL_bool__array_deleteReference(*orig);
      *orig = NULL;
    }
    SIDL_bool__array_bdestroy(array);
  }
...
{
  SIDL_bool__array_addReference(array);
  return array;
}
...
SIDL_bool__array_borrowSmartCp(struct SIDL_bool__array* array)
{
  ...
  if (array) {
    if (SIDL_bool__array_isColumnOrder(array)) {
      copy = SIDL_bool__array_createCol(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
    else {
      copy = SIDL_bool__array_createRow(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
...
static const struct SIDL_bool__vtable normal_bool_vtable = {
  SIDL_bool__array_destroy,
...
static const struct SIDL_bool__vtable borrowed_bool_vtable = {
  SIDL_bool__array_bdestroy,
...
static const struct SIDL_bool__vtable sliced_bool_vtable = {
  SIDL_bool__array_sdestroy,
  SIDL_bool__array_smartCp
};
/**
...
static const struct SIDL_bool__vtable bsliced_bool_vtable = {
  SIDL_bool__array_sdestroy,
  SIDL_bool__array_borrowSmartCp
};
/**
         ...
         struct SIDL_bool__array *orig)
{
  static const int arraySize = sizeof(struct SIDL_bool__array)
    + (sizeof(int32_t) - (sizeof(struct SIDL_bool__array)
                      % sizeof(int32_t))) % sizeof(int32_t);
  struct SIDL_bool__array *result = (struct SIDL_bool__array *)
  ...
  if (orig) {
    ...
    ref = (struct SIDL_bool__array **)
      ((char *)result + arraySize + 3 * sizeof(int32_t)*dimen);
    *ref = orig;
    SIDL_bool__array_addReference(orig);
    result->d_vtable = &sliced_bool_vtable;
  }
  else {
    result->d_vtable = &normal_bool_vtable;
  }
...
/**
 * Create a dense bool array of the given dimension with specified
...
/**
 * Create a dense one-dimensional vector of bools with a lower
...
/**
 * Create a dense two-dimensional array of bools with a lower
  ...
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_vtable->d_smartcopy ==
        ...
        result->d_vtable = &bsliced_bool_vtable;
      }
    }
  }
  return result;
                        ...
                        const int32_t  stride[])
{
  ...
  result->d_vtable = &borrowed_bool_vtable;
  return result;
}
 ...
 */
void
SIDL_bool__array_addReference(struct SIDL_bool__array* array)
{
  if (array) {
    ++(array->d_refcount);
  }
 ...
 */
void
SIDL_bool__array_deleteReference(struct SIDL_bool__array* array)
{
  ...
  if (src && (src->d_dimen == dimen)) {
    ...
    case SIDL_column_major_order:
      if (SIDL_bool__array_isColumnOrder(src)) {
        SIDL_bool__array_addReference(src);
        result = src;
      }
      else {
