...
SIDL_DLL_getLibraryName(
  SIDL_DLL self)
{
  return (*self->d_epv->f_getLibraryName)(
    self);
}
...
SIDL_DLL__array_createCol(int32_t        dimen,
                          const int32_t lower[],
                          const int32_t upper[])
{
 ...
 */
struct SIDL_DLL__array*
SIDL_DLL__array_createRow(int32_t        dimen,
                          const int32_t lower[],
                          const int32_t upper[])
{
 ...
 */
struct SIDL_DLL__array*
SIDL_DLL__array_borrow(SIDL_DLL*firstElement,
                       int32_t       dimen,
const int32_t lower[],
const int32_t upper[],
 ...
 */
struct SIDL_DLL__array*
SIDL_DLL__array_smartCopy(struct SIDL_DLL__array *array)
{
 ...
 */
SIDL_DLL
SIDL_DLL__array_get1(const struct SIDL_DLL__array* array,
                     const int32_t i1)
{
  return (SIDL_DLL)
 ...
 */
SIDL_DLL
SIDL_DLL__array_get2(const struct SIDL_DLL__array* array,
                     const int32_t i1,
                     const int32_t i2)
{
  return (SIDL_DLL)
 ...
 */
SIDL_DLL
SIDL_DLL__array_get3(const struct SIDL_DLL__array* array,
                     const int32_t i1,
                     const int32_t i2,
                     const int32_t i3)
{
 ...
 */
SIDL_DLL
SIDL_DLL__array_get4(const struct SIDL_DLL__array* array,
                     const int32_t i1,
                     const int32_t i2,
                     const int32_t i3,
                     const int32_t i4)
 ...
 */
SIDL_DLL
SIDL_DLL__array_get(const struct SIDL_DLL__array* array,
 ...
 */
void
SIDL_DLL__array_set1(struct SIDL_DLL__array* array,
                     const int32_t i1,
 ...
 */
void
SIDL_DLL__array_set2(struct SIDL_DLL__array* array,
                     const int32_t i1,
                     const int32_t i2,
                     SIDL_DLL const value)
{
 ...
 */
void
SIDL_DLL__array_set3(struct SIDL_DLL__array* array,
                     const int32_t i1,
                     const int32_t i2,
                     const int32_t i3,
                     SIDL_DLL const value)
 ...
 */
void
SIDL_DLL__array_set4(struct SIDL_DLL__array* array,
                     const int32_t i1,
                     const int32_t i2,
                     const int32_t i3,
                     const int32_t i4,
 ...
 */
void
SIDL_DLL__array_set(struct SIDL_DLL__array* array,
                    const int32_t indices[],
                    SIDL_DLL const value)
{
 ...
 */
int32_t
SIDL_DLL__array_dimen(const struct SIDL_DLL__array* array)
{
 ...
 */
int32_t
SIDL_DLL__array_lower(const struct SIDL_DLL__array* array,
                      const int32_t ind)
{
 ...
 */
int32_t
SIDL_DLL__array_upper(const struct SIDL_DLL__array* array,
                      const int32_t ind)
{
 ...
 */
int32_t
SIDL_DLL__array_stride(const struct SIDL_DLL__array* array,
                       const int32_t ind)
{
 ...
 */
int
SIDL_DLL__array_isColumnOrder(const struct SIDL_DLL__array* array)
{
 ...
 */
int
SIDL_DLL__array_isRowOrder(const struct SIDL_DLL__array* array)
{
 ...
 */
void
SIDL_DLL__array_copy(const struct SIDL_DLL__array* src,
 ...
 */
struct SIDL_DLL__array*
SIDL_DLL__array_ensure(struct SIDL_DLL__array* src,
                       int32_t dimen,
int     ordering)
{
  return (struct SIDL_DLL__array*)
