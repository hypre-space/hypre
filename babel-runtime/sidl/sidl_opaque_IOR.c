...
sidl_opaque__array_borrowSmartCp(struct sidl_opaque__array* array)
{
  ...
  if (array) {
    if (sidl_opaque__array_isColumnOrder(array)) {
      copy = sidl_opaque__array_createCol(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
    else {
      copy = sidl_opaque__array_createRow(array->d_dimen,
                                                array->d_lower,
                                                array->d_upper);
    }
...
static const struct sidl_opaque__vtable normal_opaque_vtable = {
  sidl_opaque__array_destroy,
...
static const struct sidl_opaque__vtable borrowed_opaque_vtable = {
  sidl_opaque__array_bdestroy,
...
static const struct sidl_opaque__vtable sliced_opaque_vtable = {
  sidl_opaque__array_sdestroy,
  sidl_opaque__array_smartCp
};
/**
...
static const struct sidl_opaque__vtable bsliced_opaque_vtable = {
  sidl_opaque__array_sdestroy,
  sidl_opaque__array_borrowSmartCp
};
/**
         ...
         struct sidl_opaque__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    ...
    result->d_vtable = &sliced_opaque_vtable;
  }
  else {
    result->d_vtable = &normal_opaque_vtable;
  }
                                ...
                                void * const* data)
{
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      void * const * restrict src = (void * const * restrict)data;
      void * * restrict dest;
      result->d_stride[0] = 1;
      result->d_firstElement = (void * *)malloc(len*sizeof(void *));
  ...
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_vtable->d_smartcopy ==
        ...
        result->d_vtable = &bsliced_opaque_vtable;
      }
    }
  }
  return result;
                          ...
                          const int32_t  stride[])
{
  ...
  result->d_vtable = &borrowed_opaque_vtable;
  return result;
}
