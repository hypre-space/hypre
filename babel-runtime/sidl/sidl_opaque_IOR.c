/*
 * File:        sidl_opaque_IOR.c
 * Copyright:   (c) 2001 The Regents of the University of California
 * Revision:    @(#) $Revision$
 * Date:        $Date$
 * Description: opaque array implementation
...
static void * const sidl_opaque__array_zero = NULL;
 ...
 */
static void
sidl_opaque__array_bdestroy(struct sidl_opaque__array* array)
{
  if (array) {
    memset(array, 0, sizeof(struct sidl_opaque__array) +
 ...
 */
static void
sidl_opaque__array_destroy(struct sidl_opaque__array* array)
{
  if (array) {
#ifdef DESTROY_VALUES_TOO
    void * *ptr = array->d_firstElement;
    int32_t i;
    int32_t size = 1;
    ...
    sidl_opaque__array_bdestroy(array);
  }
}
 ...
 */
static void
sidl_opaque__array_rdestroy(struct sidl_opaque__array* array)
{ }
/**
 ...
 */
static void
sidl_opaque__array_sdestroy(struct sidl_opaque__array* array)
{
  if (array) {
    static const int arraySize = sizeof(struct sidl_opaque__array)
      + (sizeof(int32_t) - (sizeof(struct sidl_opaque__array)
                        % sizeof(int32_t))) % sizeof(int32_t);
    struct sidl_opaque__array **orig;
    orig = (struct sidl_opaque__array **)((char *)array + arraySize +
      3 * sizeof(int32_t)*array->d_metadata.d_dimen);
    if (*orig) {
      sidl_opaque__array_deleteRef(*orig);
      *orig = NULL;
    }
    sidl_opaque__array_bdestroy(array);
  }
...
sidl_opaque__array_smartCp(struct sidl_opaque__array* array)
{
 ...
 */
static struct sidl_opaque__array*
sidl_opaque__array_borrowSmartCp(struct sidl_opaque__array* array)
{
  struct sidl_opaque__array* copy = NULL;
  if (array) {
    if (sidl_opaque__array_isColumnOrder(array)) {
      copy = sidl_opaque__array_createCol(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    else {
      copy = sidl_opaque__array_createRow(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    sidl_opaque__array_copy(array, copy);
  }
  return copy;
}
 ...
 */
static int32_t
opaque_arrayType(void)
{
  return sidl_opaque_array;
}
/**
 * Virtual function table for rarrays.
 */

static const struct sidl__array_vtable rarray_opaque_vtable = {
  (void (*)(struct sidl__array *))sidl_opaque__array_rdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_opaque__array_borrowSmartCp,
  opaque_arrayType
};
/**
...
static const struct sidl__array_vtable normal_opaque_vtable = {
  (void (*)(struct sidl__array *))sidl_opaque__array_destroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_opaque__array_smartCp,
  opaque_arrayType
};
/**
...
static const struct sidl__array_vtable borrowed_opaque_vtable = {
  (void (*)(struct sidl__array *))sidl_opaque__array_bdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_opaque__array_borrowSmartCp,
  opaque_arrayType
};
...
static const struct sidl__array_vtable sliced_opaque_vtable = {
  (void (*)(struct sidl__array *))sidl_opaque__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_opaque__array_smartCp,
  opaque_arrayType
};
...
static const struct sidl__array_vtable bsliced_opaque_vtable = {
  (void (*)(struct sidl__array *))sidl_opaque__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_opaque__array_borrowSmartCp,
  opaque_arrayType
         ...
         struct sidl_opaque__array *orig)
{
  static const int arraySize = sizeof(struct sidl_opaque__array)
    + (sizeof(int32_t) - (sizeof(struct sidl_opaque__array)
                      % sizeof(int32_t))) % sizeof(int32_t);
  struct sidl_opaque__array *result = (struct sidl_opaque__array *)
    malloc(arraySize + 3 * sizeof(int32_t) * dimen +
           (orig ? sizeof(struct sidl_opaque__array *) : 0));
  ...
  if (orig) {
    struct sidl_opaque__array **ref;
    ref = (struct sidl_opaque__array **)
      ((char *)result + arraySize + 3 * sizeof(int32_t)*dimen);
    *ref = orig;
    sidl_opaque__array_addRef(orig);
    result->d_metadata.d_vtable = &sliced_opaque_vtable;
  }
  else {
    result->d_metadata.d_vtable = &normal_opaque_vtable;
  }
...
/**
 * Create a dense opaque array of the given dimension with specified
...
sidl_opaque__array_createCol(int32_t       dimen,
                             const int32_t lower[],
                             const int32_t upper[])
{
  int32_t size=1, i;
  struct sidl_opaque__array *result = newArray(dimen, lower, upper, NULL);
  for(i = 0; i < dimen; ++i) {
    result->d_metadata.d_stride[i] = size;
    size *= (1 + upper[i] - lower[i]);
  }
  size *= sizeof(void *);
  result->d_firstElement = (void * *)malloc(size);
 ...
 */
struct sidl_opaque__array *
sidl_opaque__array_createRow(int32_t       dimen,
                             const int32_t lower[],
                             const int32_t upper[])
{
  int32_t size=1, i;
 ...
 */
void
sidl_opaque__array_init(void * const* c_array,
struct sidl_opaque__array* sidl_array, int32_t dim,
int32_t lower[], int32_t upper[], int32_t stride[])
{
  ...
  sidl_array->d_metadata.d_lower = lower;
  sidl_array->d_metadata.d_vtable = &rarray_opaque_vtable;
  sidl_array->d_metadata.d_refcount = 1;
  sidl_array->d_firstElement = (void * *)c_array; 
}

/**
 * Create a dense one-dimensional vector of opaques with a lower
 * index of 0 and an upper index of len-1. This array owns and manages
 * its data.
 * This function does not initialize the contents of the array.
 */
struct sidl_opaque__array *
sidl_opaque__array_create1d(int32_t len)
{
  static const int32_t zero = 0;
  --len;
  return sidl_opaque__array_createCol(1, &zero, &len);
}
 ...
 */
struct sidl_opaque__array *
sidl_opaque__array_create1dInit(int32_t len,
                                void * const* data)
{
  struct sidl_opaque__array *result;
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (void * *)malloc(len*sizeof(void *));
      dest = (void * * restrict)(result->d_firstElement);
      while (len--) {
        *dest = COPY_VALUE(*src);
        ++dest;
        ++src;
    ...
    result = sidl_opaque__array_create1d(len);
  }
  return result;
}

/**
 * Create a dense two-dimensional array of opaques with a lower
 * indices of (0,0) and an upper indices of (m-1,n-1). The array is
 * stored in column-major order, and it owns and manages its data.
 * This function does not initialize the contents of the array.
 */
struct sidl_opaque__array *
sidl_opaque__array_create2dCol(int32_t m, int32_t n)
{
  static const int32_t zero[2] = {0, 0};
  int32_t upper[2];
  upper[0] = m-1;
  upper[1] = n-1;
  return sidl_opaque__array_createCol(2, zero, upper);
}
 ...
 */
struct sidl_opaque__array *
sidl_opaque__array_create2dRow(int32_t m, int32_t n)
{
  static const int32_t zero[2] = {0, 0};
  int32_t upper[2];
  upper[0] = m-1;
  upper[1] = n-1;
  return sidl_opaque__array_createRow(2, zero, upper);
}
 ...
 */
static int
goodSliceArgs(struct sidl_opaque__array* src,
               int32_t       dimen,
...
sidl_opaque__array_slice(struct sidl_opaque__array *src,
                         ...
                         const int32_t *newStart)
{
  struct sidl_opaque__array *result = NULL;
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_metadata.d_vtable->d_smartcopy ==
        ...
        result->d_metadata.d_vtable = &bsliced_opaque_vtable;
      }
    }
  }
  return result;
 ...
 */
struct sidl_opaque__array *
sidl_opaque__array_borrow(void ** firstElement,
                          int32_t        dimen,
                          const int32_t  lower[],
                          const int32_t  upper[],
                          const int32_t  stride[])
{
  ...
  result->d_metadata.d_vtable = &borrowed_opaque_vtable;
  return result;
}
 ...
 */
struct sidl_opaque__array *
sidl_opaque__array_smartCopy(struct sidl_opaque__array *array)
{
  return (struct sidl_opaque__array *)
 ...
 */
void
sidl_opaque__array_addRef(struct sidl_opaque__array* array)
{
 ...
 */
void
sidl_opaque__array_deleteRef(struct sidl_opaque__array* array)
{
  sidl__array_deleteRef((struct sidl__array*)array);
}

/**
 * Attempt to cast a generic array reference to an opaque
 * array. A non-NULL return value indicates that the cast was
 * successful, and the returned pointer is a valid opaque
 * array. A NULL return value indicates that the cast failed.
 * This function never alters the reference count of array.
 * 
 */
struct sidl_opaque__array*
sidl_opaque__array_cast(struct sidl__array* array)
{
  return (array &&
          (sidl_opaque_array == ((array->d_vtable->d_arraytype)())))
 ...
 */
void *
sidl_opaque__array_get1(const struct sidl_opaque__array* array,
                        const int32_t i1)
{
  ...
  return sidl_opaque__array_zero;
}
 ...
 */
void *
sidl_opaque__array_get2(const struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2)
{
 ...
 */
void *
sidl_opaque__array_get3(const struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3)
{
 ...
 */
void *
sidl_opaque__array_get4(const struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        const int32_t i4)
 ...
 */
void *
sidl_opaque__array_get5(const struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        const int32_t i4,
 ...
 */
void *
sidl_opaque__array_get6(const struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        const int32_t i4,
 ...
 */
void *
sidl_opaque__array_get7(const struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        const int32_t i4,
                        ...
                        const int32_t i7)
{
  if (array) {
    ...
    case 1: return sidl_opaque__array_get1(array, i1);
    case 2: return sidl_opaque__array_get2(array, i1, i2);
    case 3: return sidl_opaque__array_get3(array, i1, i2, i3);
    case 4: return sidl_opaque__array_get4(array, i1, i2, i3, i4);
    case 5: return sidl_opaque__array_get5(array, i1, i2, i3, i4, i5);
    case 6: return sidl_opaque__array_get6(array, i1, i2, i3, i4, i5, i6);
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
 ...
 */
void *
sidl_opaque__array_get(const struct sidl_opaque__array* array,
                       const int32_t indices[])
{
  if (array) {
    void * *result = array->d_firstElement;
    int32_t i = 0;
 ...
 */
void
sidl_opaque__array_set1(struct sidl_opaque__array* array,
                        const int32_t i1,
                        void * const value)
{
  if (array && (1 == array->d_metadata.d_dimen) &&
 ...
 */
void
sidl_opaque__array_set2(struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        void * const value)
{
 ...
 */
void
sidl_opaque__array_set3(struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        void * const value)
 ...
 */
void
sidl_opaque__array_set4(struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        const int32_t i4,
 ...
 */
void
sidl_opaque__array_set5(struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        const int32_t i4,
 ...
 */
void
sidl_opaque__array_set6(struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        const int32_t i4,
 ...
 */
void
sidl_opaque__array_set7(struct sidl_opaque__array* array,
                        const int32_t i1,
                        const int32_t i2,
                        const int32_t i3,
                        const int32_t i4,
                        ...
                        void * const value)
{
  if (array) {
    switch(array->d_metadata.d_dimen) {
    case 1: sidl_opaque__array_set1(array, i1, value); break;
    case 2: sidl_opaque__array_set2(array, i1, i2, value); break;
    case 3: sidl_opaque__array_set3(array, i1, i2, i3, value); break;
    case 4: sidl_opaque__array_set4(array, i1, i2, i3, i4, value); break;
    case 5: sidl_opaque__array_set5(array, i1, i2, i3, i4, i5, value); break;
    case 6: sidl_opaque__array_set6(array, i1, i2, i3, i4, i5, i6, value); break;
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
 ...
 */
int32_t
sidl_opaque__array_dimen(const struct sidl_opaque__array* array)
{
 ...
 */
int32_t
sidl_opaque__array_lower(const struct sidl_opaque__array* array,
                         const int32_t ind)
{
 ...
 */
int32_t
sidl_opaque__array_upper(const struct sidl_opaque__array* array,
                         const int32_t ind)
{
 ...
 */
int32_t
sidl_opaque__array_length(const struct sidl_opaque__array* array,
                          const int32_t ind)
{
 ...
 */
int32_t
sidl_opaque__array_stride(const struct sidl_opaque__array* array,
                          const int32_t ind)
{
 ...
 */
sidl_bool
sidl_opaque__array_isColumnOrder(const struct sidl_opaque__array* array)
{
 ...
 */
sidl_bool
sidl_opaque__array_isRowOrder(const struct sidl_opaque__array* array)
{
                              ...
                              struct sidl_opaque__array* dest)
{
  if (src && dest && (src != dest) &&
    ...
    if (overlap) {
      register void * const * restrict srcFirst =
        src->d_firstElement;
      register void * * restrict destFirst =
        dest->d_firstElement;
      register int32_t i;
                          ...
                          int                    ordering)
{
  ...
  if (src && (src->d_metadata.d_dimen == dimen)) {
    ...
    case sidl_column_major_order:
      if (sidl_opaque__array_isColumnOrder(src)) {
        sidl_opaque__array_addRef(src);
        result = src;
      }
      else {
        result = sidl_opaque__array_createCol
          (dimen, src->d_metadata.d_lower, src->d_metadata.d_upper);
        sidl_opaque__array_copy(src, result);
      }
      break;
    case sidl_row_major_order:
      if (sidl_opaque__array_isRowOrder(src)) {
        sidl_opaque__array_addRef(src);
        result = src;
      }
      else {
        result = sidl_opaque__array_createRow
          (dimen, src->d_metadata.d_lower, src->d_metadata.d_upper);
        sidl_opaque__array_copy(src, result);
      }
      break;
 ...
 */
void * *
sidl_opaque__array_first(const struct sidl_opaque__array* array)
{
