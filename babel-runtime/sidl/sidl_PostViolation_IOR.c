...
static struct sidl_PostViolation__epv s_new_epv_hooks__sidl_postviolation;
...
sidl_PostViolation_isSame__exec(
  ...
  iobj = skel_sidl_PostViolation_fconnect_sidl_BaseInterface(iobj_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
static void
sidl_PostViolation_packObj__exec(
        struct sidl_PostViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  ser = skel_sidl_PostViolation_fconnect_sidl_io_Serializer(ser_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
static void
sidl_PostViolation_unpackObj__exec(
        struct sidl_PostViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  des = skel_sidl_PostViolation_fconnect_sidl_io_Deserializer(des_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
...
static void ior_sidl_PostViolation__set_hooks(
  struct sidl_PostViolation__object* self,
...
{
  *_ex = NULL; /* default to no exception */
  sidl_PostViolation__fini(self,_ex);
...
ior_sidl_PostViolation__exec(
  ...
  static const struct sidl_PostViolation__method  s_methods[] = {
    ...
    { "packObj", sidl_PostViolation_packObj__exec },
    { "setNote", sidl_PostViolation_setNote__exec },
    { "unpackObj", sidl_PostViolation_unpackObj__exec }
  };
  int i, cmp, l = 0;
...
static void sidl_PostViolation__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */
  ...
  struct sidl_PostViolation__epv*    hepv = 
    &s_new_epv_hooks__sidl_postviolation;
  ...
  epv->f__raddRef                 = ior_sidl_PostViolation__raddRef;
  epv->f__isRemote                = ior_sidl_PostViolation__isRemote;
  epv->f__set_hooks               = ior_sidl_PostViolation__set_hooks;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_PostViolation__object*,struct sidl_BaseInterface__object*,
    struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_PostViolation__object*,const char*,
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_PostViolation__object*,const char*,int32_t,const char*,
    struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj                  = (void (*)(struct 
    sidl_PostViolation__object*,struct sidl_io_Serializer__object*,
    struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj                = (void (*)(struct 
    sidl_PostViolation__object*,struct sidl_io_Deserializer__object*,
    struct sidl_BaseInterface__object **)) s1->f_unpackObj;

  sidl_PostViolation__set_epv(epv);

  memcpy((void*)hepv, epv, sizeof(struct sidl_PostViolation__epv));
...
void sidl_PostViolation__getEPVs(
  ...
  struct sidl_PostViolation__epv **s_arg_epv__sidl_postviolation,
    struct sidl_PostViolation__epv **s_arg_epv_hooks__sidl_postviolation)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    sidl_PostViolation__init_epv();
  }
  ...
  *s_arg_epv_hooks__sidl_runtimeexception = 
    &s_new_epv_hooks__sidl_runtimeexception;
  *s_arg_epv__sidl_postviolation = &s_new_epv__sidl_postviolation;
  *s_arg_epv_hooks__sidl_postviolation = &s_new_epv_hooks__sidl_postviolation;
}
/*
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidl.PostViolation",_ex);
...
static void
initMetadata(struct sidl_PostViolation__object* self, sidl_BaseInterface* _ex)
{
...
sidl_PostViolation__new(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_PostViolation__object* self =
    (struct sidl_PostViolation__object*) malloc(
      sizeof(struct sidl_PostViolation__object));
  *_ex = NULL; /* default to no exception */
  sidl_PostViolation__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_sidl_PostViolation__set_hooks(s0, FALSE, _ex);
