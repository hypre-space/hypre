...
sidl_rmi_UnknownHostException_isSame__exec(
  ...
  iobj = 
    skel_sidl_rmi_UnknownHostException_fconnect_sidl_BaseInterface(iobj_str,
...
sidl_rmi_UnknownHostException_unpackObj__exec(
  ...
  des = 
    skel_sidl_rmi_UnknownHostException_fconnect_sidl_io_Deserializer(des_str,
    TRUE, _ex);SIDL_CHECK(*_ex);
 ...
 */
  ...
  epv->f_getHopCount              = (int32_t (*)(struct 
    sidl_rmi_UnknownHostException__object*,
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_UnknownHostException__object*,const char*,
...
sidl_rmi_UnknownHostException__new(void* ddata,
  struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_rmi_UnknownHostException__object* self =
