...
sidl_rmi_MalformedURLException_isSame__exec(
  ...
  iobj = 
    skel_sidl_rmi_MalformedURLException_fconnect_sidl_BaseInterface(iobj_str,
...
sidl_rmi_MalformedURLException_unpackObj__exec(
  ...
  des = 
    skel_sidl_rmi_MalformedURLException_fconnect_sidl_io_Deserializer(des_str,
    TRUE, _ex);SIDL_CHECK(*_ex);
 ...
 */
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_MalformedURLException__object*,const char*,
