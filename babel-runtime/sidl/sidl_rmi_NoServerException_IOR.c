 ...
 */
  ...
  epv->f_getHopCount              = (int32_t (*)(struct 
    sidl_rmi_NoServerException__object*,
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_NoServerException__object*,const char*,
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_rmi_NoServerException__object*,const char*,int32_t,const char*,
...
static struct sidl_rmi_NetworkException__epv* 
  sidl_rmi_NoServerException__super(void) {
...
sidl_rmi_NoServerException__new(void* ddata,
  struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_rmi_NoServerException__object* self =
