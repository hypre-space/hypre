...
/**
 * Class <code>Opaque</code> contains inner classes that
...
public class Opaque {
  ...
  /**
   * Define a one dimensional array of type <code>long</code>
  ...
  public static class Array extends gov.llnl.sidl.BaseArray {
     ...
     */
    static {
      gov.llnl.sidl.BaseClass._registerNatives("sidl.Opaque");
    }
    ...
    public native void _set(
      int i, int j, int k, int l, int m, int n, int o, long value);
  ...
  public Array _dcast() {
    try{ 
      int dimen = _dim();
      sidl.Opaque.Array ret = null;
      switch (dimen) {
      case 1: 

	ret = (Array) new sidl.Opaque.Array1(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 2:
        ret = (Array) new sidl.Opaque.Array2(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 3:
        ret = (Array) new sidl.Opaque.Array3(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 4:
        ret = (Array) new sidl.Opaque.Array4(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 5:
        ret = (Array) new sidl.Opaque.Array5(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 6:
        ret = (Array) new sidl.Opaque.Array6(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 7:
        ret = (Array) new sidl.Opaque.Array7(get_ior_pointer(),true);
         _addRef();
        return ret;
      default:
        return null;
  ...
  /**
   * Define a two dimensional array of type <code>long</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  /**
   * Define a three dimensional array of type <code>long</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array3 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public long _get(int i, int j, int k) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, long value) {
  ...
  /**
   * Define a four dimensional array of type <code>long</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array4 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public long _get(int i, int j, int k, int l) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, long value) {
 ...
 /**
   * Define a five dimensional array of type <code>long</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array5 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public long _get(int i, int j, int k, int l, int m) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, long value) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new long[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
		array[i][j][k][l] = new long[u4-l4+1];
		for (int m = l4; m <= u4; m++) {
...
/**
   * Define a six dimensional array of type <code>long</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array6 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public long _get(int i, int j, int k, int l, int m, int n) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, int n, long value) {
	...
	int l5 = _lower(5);
		...
		array[i][j][k] = new long[u3-l3+1][][];
		  ...
		  array[i][j][k][l] = new long[u4-l4+1][];
		for (int m = l4; m <= u4; m++) {
		    array[i][j][k][l][m] = new long[u4-l4+1];
		    for (int n = l5; n <= u5; n++) {
...
/**
   * Define a seven dimensional array of type <code>long</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
    ...
    */
	...
	int l6 = _lower(6);
		...
		for (int m = l4; m <= u4; m++) {
		  array[i][j][k][l][m] = new long[u4-l4+1][];
		  for (int n = l5; n <= u5; n++) {
		    array[i][j][k][l][m][n] = new long[u5-l5+1];
		    for (int o = l6; o <= u6; o++) {
