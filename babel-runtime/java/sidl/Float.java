...
public class Float {
  ...
  public static class Array extends gov.llnl.sidl.BaseArray {
    ...
    public native void _set(
      int i, int j, int k, int l, int m, int n, int o, float value);
  ...
  public Array _dcast() {
    try{ 
      int dimen = _dim();
      sidl.Float.Array ret = null;
      switch (dimen) {
      case 1: 

	ret = (Array) new sidl.Float.Array1(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 2:
        ret = (Array) new sidl.Float.Array2(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 3:
        ret = (Array) new sidl.Float.Array3(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 4:
        ret = (Array) new sidl.Float.Array4(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 5:
        ret = (Array) new sidl.Float.Array5(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 6:
        ret = (Array) new sidl.Float.Array6(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 7:
        ret = (Array) new sidl.Float.Array7(get_ior_pointer(),true);
         _addRef();
        return ret;
      default:
        return null;
 ...
 /**
   * Define a five dimensional array of type <code>float</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array5 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public float _get(int i, int j, int k, int l, int m) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, float value) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new float[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
		array[i][j][k][l] = new float[u4-l4+1];
		for (int m = l4; m <= u4; m++) {
...
/**
   * Define a six dimensional array of type <code>float</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array6 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public float _get(int i, int j, int k, int l, int m, int n) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, int n, float value) {
	...
	int l5 = _lower(5);
		...
		array[i][j][k] = new float[u3-l3+1][][];
		  ...
		  array[i][j][k][l] = new float[u4-l4+1][];
		for (int m = l4; m <= u4; m++) {
		    array[i][j][k][l][m] = new float[u4-l4+1];
		    for (int n = l5; n <= u5; n++) {
...
/**
   * Define a seven dimensional array of type <code>float</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array7 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public float _get(int i, int j, int k, int l, int m, int n, int o) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, int n, int o, float value) {
	...
	int l6 = _lower(6);
		...
		for (int m = l4; m <= u4; m++) {
		  array[i][j][k][l][m] = new float[u4-l4+1][];
		  for (int n = l5; n <= u5; n++) {
		    array[i][j][k][l][m][n] = new float[u5-l5+1];
		    for (int o = l6; o <= u6; o++) {
