...
/* communication.c */
void hypre_GetCommInfo P((hypre_BoxArrayArray **send_boxes_ptr , hypre_BoxArrayArray **recv_boxes_ptr , int ***send_box_ranks_ptr , int ***recv_box_ranks_ptr , hypre_StructGrid *grid , hypre_StructStencil *stencil ));
void hypre_GetSBoxType P((hypre_SBox *comm_sbox , hypre_Box *data_box , int num_values , MPI_Datatype *comm_sbox_type ));
hypre_CommPkg *hypre_NewCommPkg P((hypre_SBoxArrayArray *send_sboxes , hypre_SBoxArrayArray *recv_sboxes , int **send_box_ranks , int **recv_box_ranks , hypre_StructGrid *grid , hypre_BoxArray *data_space , int num_values ));
...
hypre_CommHandle *hypre_InitializeCommunication P((hypre_CommPkg *comm_pkg , double *data ));
void hypre_FinalizeCommunication P((hypre_CommHandle *comm_handle ));

/* computation.c */
void hypre_GetComputeInfo P((hypre_BoxArrayArray **send_boxes_ptr , hypre_BoxArrayArray **recv_boxes_ptr , int ***send_box_ranks_ptr , int ***recv_box_ranks_ptr , hypre_BoxArrayArray **indt_boxes_ptr , hypre_BoxArrayArray **dept_boxes_ptr , hypre_StructGrid *grid , hypre_StructStencil *stencil ));
hypre_ComputePkg *hypre_NewComputePkg P((hypre_SBoxArrayArray *send_sboxes , hypre_SBoxArrayArray *recv_sboxes , int **send_box_ranks , int **recv_box_ranks , hypre_SBoxArrayArray *indt_sboxes , hypre_SBoxArrayArray *dept_sboxes , hypre_StructGrid *grid , hypre_BoxArray *data_space , int num_values ));
...
/* neighbors.c */
void hypre_FindBoxNeighbors P((hypre_BoxArray *boxes , hypre_BoxArray *all_boxes , hypre_StructStencil *stencil , int transpose , hypre_BoxArray **neighbors_ptr , int **neighbor_ranks_ptr ));
void hypre_FindBoxApproxNeighbors P((hypre_BoxArray *boxes , hypre_BoxArray *all_boxes , hypre_StructStencil *stencil , int transpose , hypre_BoxArray **neighbors_ptr , int **neighbor_ranks_ptr ));
